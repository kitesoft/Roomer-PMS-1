object frmLocations: TfrmLocations
  ...
  object grData: TcxGrid
    ...
    object tvData: TcxGridDBTableView
      ...
      object tvDataChannelManagerName: TcxGridDBColumn
        ...
        Properties.OnButtonClick = tvDataChannelManagerNamePropertiesButtonClick
        Options.ShowEditButtons = isebAlways
        Width = 106
      end
      object tvDataAccountdepartment: TcxGridDBColumn
        DataBinding.FieldName = 'Accountdepartment'
      end
    end
  ...
  object m_: TdxMemData
    ...
    object m_channelManager: TIntegerField
      FieldName = 'channelManager'
    end
    object m_Accountdepartment: TStringField
      FieldName = 'Accountdepartment'
      Size = 24
    end
  end
  object FormStore: TcxPropertiesStore
    ...
    StorageName = 'Software\Roomer\FormStatus\Locations'
