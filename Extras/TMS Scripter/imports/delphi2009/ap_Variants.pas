...
type
  TatVariantsLibrary = class(TatScripterLibrary)
    ...
    procedure __GetOleVariantInt64AsDouble(AMachine: TatVirtualMachine);
    procedure __SetOleVariantInt64AsDouble(AMachine: TatVirtualMachine);
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomVariantTypeClass(CurrentClass.ClassRef).Create);
...
begin
  with AMachine do
  begin
Param2 := TVarCompareResult(VarToInteger(GetInputArg(2)));
...
if not Assigned(Param0Rec) or not (Param0Rec is TVarDataWrapper) then 
  Param0Rec := TVarDataWrapper.Create(Param0);
Param0 := TVarDataWrapper(Param0Rec).ObjToRec;
AResult := TInvokeableVariantType(CurrentObject).GetProperty(Param0,TVarDataWrapper(integer(GetInputArg(1))).ObjToRec,VarToStr(GetInputArg(2)));
    ReturnOutputArg(AResult);
    SetInputArg(0,integer(TVarDataWrapper.Create(Param0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TInvokeableVariantType(CurrentObject).SetProperty(TVarDataWrapper(integer(GetInputArg(0))).ObjToRec,VarToStr(GetInputArg(1)),TVarDataWrapper(integer(GetInputArg(2))).ObjToRec);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(Variants.VarToStr(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(Variants.VarToStrDef(GetInputArg(0),VarToStr(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Variants.VarCompareValue(GetInputArg(0),GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
Param1 := TCustomVariantType(VarToObject(GetInputArg(1)));
...
begin
  with AMachine do
  begin
AResult := string(Variants.VarTypeAsText(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(Variants.NullEqualityRule));
  end;
end;
...
begin
  with AMachine do
  begin
    Variants.NullEqualityRule:=TNullCompareRule(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(Variants.NullMagnitudeRule));
  end;
end;
...
begin
  with AMachine do
  begin
    Variants.NullMagnitudeRule:=TNullCompareRule(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(Variants.NullAsStringValue));
  end;
end;
...
begin
  with AMachine do
  begin
    Variants.NullAsStringValue:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(Variants.BooleanToStringRule));
  end;
end;
...
begin
  with AMachine do
  begin
    Variants.BooleanToStringRule:=TBooleanToStringRule(VarToInteger(GetInputArg(0)));
  end;
end;

procedure TatVariantsLibrary.__GetOleVariantInt64AsDouble(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(Variants.OleVariantInt64AsDouble);
  end;
end;

procedure TatVariantsLibrary.__SetOleVariantInt64AsDouble(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    Variants.OleVariantInt64AsDouble:=GetInputArg(0);
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('IsClear',1,tkVariant,nil,__TCustomVariantTypeIsClear,false,0,'V: TVarData');
    DefineMethod('Cast',2,tkNone,nil,__TCustomVariantTypeCast,false,0,'Dest: TVarData; Source: TVarData').SetVarArgs([0]);
    DefineMethod('CastTo',3,tkNone,nil,__TCustomVariantTypeCastTo,false,0,'Dest: TVarData; Source: TVarData; AVarType: TVarType').SetVarArgs([0]);
    DefineMethod('CastToOle',2,tkNone,nil,__TCustomVariantTypeCastToOle,false,0,'Dest: TVarData; Source: TVarData').SetVarArgs([0]);
    DefineMethod('Clear',1,tkNone,nil,__TCustomVariantTypeClear,false,0,'V: TVarData').SetVarArgs([0]);
    DefineMethod('Copy',3,tkNone,nil,__TCustomVariantTypeCopy,false,0,'Dest: TVarData; Source: TVarData; Indirect: Boolean').SetVarArgs([0]);
    DefineMethod('BinaryOp',3,tkNone,nil,__TCustomVariantTypeBinaryOp,false,0,'Left: TVarData; Right: TVarData; Operator: TVarOp').SetVarArgs([0]);
    DefineMethod('UnaryOp',2,tkNone,nil,__TCustomVariantTypeUnaryOp,false,0,'Right: TVarData; Operator: TVarOp').SetVarArgs([0]);
    DefineMethod('CompareOp',3,tkVariant,nil,__TCustomVariantTypeCompareOp,false,0,'Left: TVarData; Right: TVarData; Operator: TVarOp');
    DefineMethod('Compare',3,tkNone,nil,__TCustomVariantTypeCompare,false,0,'Left: TVarData; Right: TVarData; Relationship: TVarCompareResult').SetVarArgs([2]);
  ...
  begin
    DefineMethod('GetProperty',3,tkVariant,nil,__TInvokeableVariantTypeGetProperty,false,0,'Dest: TVarData; V: TVarData; Name: string').SetVarArgs([0]);
    DefineMethod('SetProperty',3,tkVariant,nil,__TInvokeableVariantTypeSetProperty,false,0,'V: TVarData; Name: string; Value: TVarData');
  end;
  ...
  begin
    DefineMethod('VarType',1,tkInteger,nil,__VarType,false,0,'V: Variant');
    DefineMethod('VarAsType',2,tkVariant,nil,__VarAsType,false,0,'V: Variant; AVarType: TVarType');
    DefineMethod('VarIsType',2,tkVariant,nil,__VarIsType,false,0,'V: Variant; AVarType: TVarType');
    DefineMethod('VarIsByRef',1,tkVariant,nil,__VarIsByRef,false,0,'V: Variant');
    DefineMethod('VarIsEmpty',1,tkVariant,nil,__VarIsEmpty,false,0,'V: Variant');
    DefineMethod('VarCheckEmpty',1,tkNone,nil,__VarCheckEmpty,false,0,'V: Variant');
    DefineMethod('VarIsNull',1,tkVariant,nil,__VarIsNull,false,0,'V: Variant');
    DefineMethod('VarIsClear',1,tkVariant,nil,__VarIsClear,false,0,'V: Variant');
    DefineMethod('VarIsCustom',1,tkVariant,nil,__VarIsCustom,false,0,'V: Variant');
    DefineMethod('VarIsOrdinal',1,tkVariant,nil,__VarIsOrdinal,false,0,'V: Variant');
    DefineMethod('VarIsFloat',1,tkVariant,nil,__VarIsFloat,false,0,'V: Variant');
    DefineMethod('VarIsNumeric',1,tkVariant,nil,__VarIsNumeric,false,0,'V: Variant');
    DefineMethod('VarIsStr',1,tkVariant,nil,__VarIsStr,false,0,'V: Variant');
    DefineMethod('VarToStr',1,tkVariant,nil,__VarToStr,false,0,'V: Variant');
    DefineMethod('VarToStrDef',2,tkVariant,nil,__VarToStrDef,false,0,'V: Variant; ADefault: string');
    DefineMethod('VarToWideStr',1,tkVariant,nil,__VarToWideStr,false,0,'V: Variant');
    DefineMethod('VarToWideStrDef',2,tkVariant,nil,__VarToWideStrDef,false,0,'V: Variant; ADefault: WideString');
    DefineMethod('VarToDateTime',1,tkVariant,nil,__VarToDateTime,false,0,'V: Variant');
    DefineMethod('VarFromDateTime',1,tkVariant,nil,__VarFromDateTime,false,0,'DateTime: TDateTime');
    DefineMethod('VarInRange',3,tkVariant,nil,__VarInRange,false,0,'AValue: Variant; AMin: Variant; AMax: Variant');
    DefineMethod('VarEnsureRange',3,tkVariant,nil,__VarEnsureRange,false,0,'AValue: Variant; AMin: Variant; AMax: Variant');
    DefineMethod('VarSameValue',2,tkVariant,nil,__VarSameValue,false,0,'A: Variant; B: Variant');
    DefineMethod('VarCompareValue',2,tkEnumeration,nil,__VarCompareValue,false,0,'A: Variant; B: Variant');
    DefineMethod('VarIsEmptyParam',1,tkVariant,nil,__VarIsEmptyParam,false,0,'V: Variant');
    DefineMethod('VarIsError',2,tkVariant,nil,__VarIsError,false,0,'V: Variant; AResult: HRESULT').SetVarArgs([1]);
    DefineMethod('VarAsError',1,tkVariant,nil,__VarAsError,false,0,'AResult: HRESULT');
    DefineMethod('VarSupports',3,tkVariant,nil,__VarSupports,false,0,'V: Variant; IID: TGUID; Intf').SetVarArgs([2]);
    DefineMethod('VarCopyNoInd',2,tkNone,nil,__VarCopyNoInd,false,0,'Dest: Variant; Source: Variant').SetVarArgs([0]);
    DefineMethod('VarIsArray',1,tkVariant,nil,__VarIsArray,false,0,'A: Variant');
    DefineMethod('VarArrayRef',1,tkVariant,nil,__VarArrayRef,false,0,'A: Variant');
    DefineMethod('VarTypeIsValidArrayType',1,tkVariant,nil,__VarTypeIsValidArrayType,false,0,'AVarType: TVarType');
    DefineMethod('VarTypeIsValidElementType',1,tkVariant,nil,__VarTypeIsValidElementType,false,0,'AVarType: TVarType');
    DefineMethod('VarArrayDimCount',1,tkInteger,nil,__VarArrayDimCount,false,0,'A: Variant');
    DefineMethod('VarArrayLowBound',2,tkInteger,nil,__VarArrayLowBound,false,0,'A: Variant; Dim: Integer');
    DefineMethod('VarArrayHighBound',2,tkInteger,nil,__VarArrayHighBound,false,0,'A: Variant; Dim: Integer');
    DefineMethod('VarArrayUnlock',1,tkNone,nil,__VarArrayUnlock,false,0,'A: Variant');
    DefineMethod('Unassigned',0,tkVariant,nil,__Unassigned,false,0,'');
    DefineMethod('Null',0,tkVariant,nil,__Null,false,0,'');
    DefineMethod('FindCustomVariantType',2,tkVariant,nil,__FindCustomVariantType,false,0,'AVarType: TVarType; CustomVariantType: TCustomVariantType').SetVarArgs([1]);
    ...
    DefineMethod('VarOverflowError',2,tkNone,nil,__VarOverflowError,false,0,'ASourceType: TVarType; ADestType: TVarType');
    DefineMethod('VarRangeCheckError',2,tkNone,nil,__VarRangeCheckError,false,0,'ASourceType: TVarType; ADestType: TVarType');
    DefineMethod('VarArrayCreateError',0,tkNone,nil,__VarArrayCreateError,false,0,'');
    DefineMethod('VarResultCheck',1,tkNone,nil,__VarResultCheck,false,0,'AResult: HRESULT');
    DefineMethod('HandleConversionException',2,tkNone,nil,__HandleConversionException,false,0,'ASourceType: TVarType; ADestType: TVarType');
    DefineMethod('VarTypeAsText',1,tkVariant,nil,__VarTypeAsText,false,0,'AType: TVarType');
    ...
    DefineProp('OleVariantInt64AsDouble',tkVariant,__GetOleVariantInt64AsDouble,__SetOleVariantInt64AsDouble,nil,false,0);
