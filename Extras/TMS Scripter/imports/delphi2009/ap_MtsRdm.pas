...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TMtsDataModuleClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
...
begin
  ...
  begin
    DefineMethod('Create',1,tkClass,TMtsDataModule,__TMtsDataModuleCreate,true,0,'AOwner: TComponent');
    ...
    DefineMethod('IsCallerInRole',1,tkVariant,nil,__TMtsDataModuleIsCallerInRole,false,0,'Role: WideString');
  end;
