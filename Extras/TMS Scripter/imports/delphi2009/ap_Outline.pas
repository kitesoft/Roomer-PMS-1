...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TOutlineNodeClass(CurrentClass.ClassRef).Create(TCustomOutline(VarToObject(GetInputArg(0)))));
...
begin
  with AMachine do
  begin
    TOutlineNode(CurrentObject).ChangeLevelBy(TChangeRange(VarToInteger(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TOutlineNode(CurrentObject).MoveTo(VarToInteger(GetInputArg(0)),TAttachMode(VarToInteger(GetInputArg(1))));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TOutlineNode(CurrentObject).Parent));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TOutlineNode(CurrentObject).Text));
  end;
end;
...
begin
  with AMachine do
  begin
    TOutlineNode(CurrentObject).Text:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TOutlineNode(CurrentObject).FullPath));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomOutlineClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TCustomOutline(CurrentObject).Add(VarToInteger(GetInputArg(0)),VarToStr(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TCustomOutline(CurrentObject).AddChild(VarToInteger(GetInputArg(0)),VarToStr(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TCustomOutline(CurrentObject).Insert(VarToInteger(GetInputArg(0)),VarToStr(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TCustomOutline(CurrentObject).GetNodeDisplayWidth(TOutlineNode(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TCustomOutline(CurrentObject).GetTextItem(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomOutline(CurrentObject).GetVisibleNode(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomOutline(CurrentObject).LoadFromFile(VarToStr(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomOutline(CurrentObject).LoadFromStream(TStream(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomOutline(CurrentObject).SaveToFile(VarToStr(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomOutline(CurrentObject).SaveToStream(TStream(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomOutline(CurrentObject).Items[VarToInteger(GetArrayIndex(0))]));
  end;
end;
...
begin
  ...
  begin
    DefineMethod('Create',1,tkClass,TOutlineNode,__TOutlineNodeCreate,true,0,'AOwner: TCustomOutline');
    DefineMethod('Destroy',0,tkNone,nil,__TOutlineNodeDestroy,false,0,'');
    DefineMethod('ChangeLevelBy',1,tkNone,nil,__TOutlineNodeChangeLevelBy,false,0,'Value: TChangeRange');
    ...
    DefineMethod('GetNextChild',1,tkInteger,nil,__TOutlineNodeGetNextChild,false,0,'Value: LongInt');
    DefineMethod('GetPrevChild',1,tkInteger,nil,__TOutlineNodeGetPrevChild,false,0,'Value: LongInt');
    DefineMethod('MoveTo',2,tkNone,nil,__TOutlineNodeMoveTo,false,0,'Destination: LongInt; AttachMode: TAttachMode');
  ...
  begin
    DefineMethod('Create',1,tkClass,TCustomOutline,__TCustomOutlineCreate,true,0,'AOwner: TComponent');
    DefineMethod('Destroy',0,tkNone,nil,__TCustomOutlineDestroy,false,0,'');
    DefineMethod('Add',2,tkInteger,nil,__TCustomOutlineAdd,false,0,'Index: LongInt; Text: string');
    DefineMethod('AddChild',2,tkInteger,nil,__TCustomOutlineAddChild,false,0,'Index: LongInt; Text: string');
    DefineMethod('Insert',2,tkInteger,nil,__TCustomOutlineInsert,false,0,'Index: LongInt; Text: string');
    DefineMethod('Delete',1,tkNone,nil,__TCustomOutlineDelete,false,0,'Index: LongInt');
    DefineMethod('GetItem',2,tkInteger,nil,__TCustomOutlineGetItem,false,0,'X: Integer; Y: Integer');
    DefineMethod('GetNodeDisplayWidth',1,tkInteger,nil,__TCustomOutlineGetNodeDisplayWidth,false,0,'Node: TOutlineNode');
    DefineMethod('GetTextItem',1,tkInteger,nil,__TCustomOutlineGetTextItem,false,0,'Value: string');
    DefineMethod('GetVisibleNode',1,tkClass,TOutlineNode,__TCustomOutlineGetVisibleNode,false,0,'Index: LongInt');
    ...
    DefineMethod('LoadFromFile',1,tkNone,nil,__TCustomOutlineLoadFromFile,false,0,'FileName: string');
    DefineMethod('LoadFromStream',1,tkNone,nil,__TCustomOutlineLoadFromStream,false,0,'Stream: TStream');
    DefineMethod('SaveToFile',1,tkNone,nil,__TCustomOutlineSaveToFile,false,0,'FileName: string');
    DefineMethod('SaveToStream',1,tkNone,nil,__TCustomOutlineSaveToStream,false,0,'Stream: TStream');
    ...
    DefineMethod('SetUpdateState',1,tkNone,nil,__TCustomOutlineSetUpdateState,false,0,'Value: Boolean');
