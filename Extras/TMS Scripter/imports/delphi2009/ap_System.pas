...
type
  TatDelphiSystemLibrary = class(TatScripterLibrary)
    ...
    procedure __TObjectUnitName(AMachine: TatVirtualMachine);
    procedure __TObjectEquals(AMachine: TatVirtualMachine);
    procedure __TObjectGetHashCode(AMachine: TatVirtualMachine);
    procedure __TObjectToString(AMachine: TatVirtualMachine);
    ...
    procedure __MonitorEnter(AMachine: TatVirtualMachine);
    procedure __MonitorTryEnter(AMachine: TatVirtualMachine);
    procedure __MonitorExit(AMachine: TatVirtualMachine);
    procedure __MonitorWait(AMachine: TatVirtualMachine);
    procedure __MonitorPulse(AMachine: TatVirtualMachine);
    procedure __MonitorPulseAll(AMachine: TatVirtualMachine);
    procedure __MemoryBarrier(AMachine: TatVirtualMachine);
    procedure __YieldProcessor(AMachine: TatVirtualMachine);
    ...
    procedure __GetMemoryManagerState(AMachine: TatVirtualMachine);
    procedure __GetMinimumBlockAlignment(AMachine: TatVirtualMachine);
    procedure __SetMinimumBlockAlignment(AMachine: TatVirtualMachine);
    procedure __AttemptToUseSharedMemoryManager(AMachine: TatVirtualMachine);
    procedure __ShareMemoryManager(AMachine: TatVirtualMachine);
    ...
    procedure __MoveChars(AMachine: TatVirtualMachine);
    ...
    procedure __UTF8EncodeToShortString(AMachine: TatVirtualMachine);
    procedure __UTF8Decode(AMachine: TatVirtualMachine);
    procedure __UTF8ToWideString(AMachine: TatVirtualMachine);
    procedure __UTF8ToUnicodeString(AMachine: TatVirtualMachine);
    procedure __UTF8ToString(AMachine: TatVirtualMachine);
    ...
    procedure __Frac(AMachine: TatVirtualMachine);
    procedure __Exp(AMachine: TatVirtualMachine);
    procedure __Cos(AMachine: TatVirtualMachine);
    procedure __Sin(AMachine: TatVirtualMachine);
    procedure __Ln(AMachine: TatVirtualMachine);
    procedure __ArcTan(AMachine: TatVirtualMachine);
    procedure __Sqrt(AMachine: TatVirtualMachine);
    ...
    procedure __StringElementSize(AMachine: TatVirtualMachine);
    procedure __StringCodePage(AMachine: TatVirtualMachine);
    procedure __StringRefCount(AMachine: TatVirtualMachine);
    procedure __SetCodePage(AMachine: TatVirtualMachine);
    procedure __Pos(AMachine: TatVirtualMachine);
    ...
    procedure __StringOfChar(AMachine: TatVirtualMachine);
    ...
    procedure __SetMultiByteConversionCodePage(AMachine: TatVirtualMachine);
    ...
    procedure __GetCPUCount(AMachine: TatVirtualMachine);
    procedure __SetCPUCount(AMachine: TatVirtualMachine);
    ...
    procedure __GetDefaultSystemCodePage(AMachine: TatVirtualMachine);
    procedure __SetDefaultSystemCodePage(AMachine: TatVirtualMachine);
    procedure __GetDefaultUnicodeCodePage(AMachine: TatVirtualMachine);
    procedure __SetDefaultUnicodeCodePage(AMachine: TatVirtualMachine);
    procedure __GetUTF8CompareLocale(AMachine: TatVirtualMachine);
    procedure __SetUTF8CompareLocale(AMachine: TatVirtualMachine);
    ...
    procedure __GetReportMemoryLeaksOnShutdown(AMachine: TatVirtualMachine);
    procedure __SetReportMemoryLeaksOnShutdown(AMachine: TatVirtualMachine);
    procedure __GetNeverSleepOnMMThreadContention(AMachine: TatVirtualMachine);
    procedure __SetNeverSleepOnMMThreadContention(AMachine: TatVirtualMachine);
  ...
  published
    ...
    property VError: HRESULT read FVError write FVError;
    ...
    property VUInt64: UInt64 read FVUInt64 write FVUInt64;
  end;
  ...
  published
    ...
    property VChar: AnsiChar read FVChar write FVChar;
  ...
  TMemoryManagerExWrapper = class(TatRecordWrapper)
  private
  public
    constructor Create(ARecord: TMemoryManagerEx);
    function ObjToRec: TMemoryManagerEx;
  published
  end;
  ...
  TSmallBlockTypeStateWrapper = class(TatRecordWrapper)
  private
    FInternalBlockSize: Cardinal;
    FUseableBlockSize: Cardinal;
    FAllocatedBlockCount: Cardinal;
    FReservedAddressSpace: Cardinal;
  public
    constructor Create(ARecord: TSmallBlockTypeState);
    function ObjToRec: TSmallBlockTypeState;
  published
    property InternalBlockSize: Cardinal read FInternalBlockSize write FInternalBlockSize;
    property UseableBlockSize: Cardinal read FUseableBlockSize write FUseableBlockSize;
    property AllocatedBlockCount: Cardinal read FAllocatedBlockCount write FAllocatedBlockCount;
    property ReservedAddressSpace: Cardinal read FReservedAddressSpace write FReservedAddressSpace;
  end;
  
  TMemoryManagerStateWrapper = class(TatRecordWrapper)
  private
    FAllocatedMediumBlockCount: Cardinal;
    FTotalAllocatedMediumBlockSize: Cardinal;
    FReservedMediumBlockAddressSpace: Cardinal;
    FAllocatedLargeBlockCount: Cardinal;
    FTotalAllocatedLargeBlockSize: Cardinal;
    FReservedLargeBlockAddressSpace: Cardinal;
  public
    constructor Create(ARecord: TMemoryManagerState);
    function ObjToRec: TMemoryManagerState;
  published
    property AllocatedMediumBlockCount: Cardinal read FAllocatedMediumBlockCount write FAllocatedMediumBlockCount;
    property TotalAllocatedMediumBlockSize: Cardinal read FTotalAllocatedMediumBlockSize write FTotalAllocatedMediumBlockSize;
    property ReservedMediumBlockAddressSpace: Cardinal read FReservedMediumBlockAddressSpace write FReservedMediumBlockAddressSpace;
    property AllocatedLargeBlockCount: Cardinal read FAllocatedLargeBlockCount write FAllocatedLargeBlockCount;
    property TotalAllocatedLargeBlockSize: Cardinal read FTotalAllocatedLargeBlockSize write FTotalAllocatedLargeBlockSize;
    property ReservedLargeBlockAddressSpace: Cardinal read FReservedLargeBlockAddressSpace write FReservedLargeBlockAddressSpace;
  end;
  
  TMonitorSupportWrapper = class(TatRecordWrapper)
  private
  public
    constructor Create(ARecord: TMonitorSupport);
    function ObjToRec: TMonitorSupport;
  published
  end;
  ...
  TCVModInfoWrapper = class(TatRecordWrapper)
  private
  public
    constructor Create(ARecord: TCVModInfo);
    function ObjToRec: TCVModInfo;
  published
  end;
...
constructor TMemoryManagerExWrapper.Create(ARecord: TMemoryManagerEx);
begin
  inherited Create;
end;

function TMemoryManagerExWrapper.ObjToRec: TMemoryManagerEx;
begin
end;
...
constructor TSmallBlockTypeStateWrapper.Create(ARecord: TSmallBlockTypeState);
begin
  inherited Create;
  FInternalBlockSize := ARecord.InternalBlockSize;
  FUseableBlockSize := ARecord.UseableBlockSize;
  FAllocatedBlockCount := ARecord.AllocatedBlockCount;
  FReservedAddressSpace := ARecord.ReservedAddressSpace;
end;

function TSmallBlockTypeStateWrapper.ObjToRec: TSmallBlockTypeState;
begin
  result.InternalBlockSize := FInternalBlockSize;
  result.UseableBlockSize := FUseableBlockSize;
  result.AllocatedBlockCount := FAllocatedBlockCount;
  result.ReservedAddressSpace := FReservedAddressSpace;
end;

constructor TMemoryManagerStateWrapper.Create(ARecord: TMemoryManagerState);
begin
  inherited Create;
  FAllocatedMediumBlockCount := ARecord.AllocatedMediumBlockCount;
  FTotalAllocatedMediumBlockSize := ARecord.TotalAllocatedMediumBlockSize;
  FReservedMediumBlockAddressSpace := ARecord.ReservedMediumBlockAddressSpace;
  FAllocatedLargeBlockCount := ARecord.AllocatedLargeBlockCount;
  FTotalAllocatedLargeBlockSize := ARecord.TotalAllocatedLargeBlockSize;
  FReservedLargeBlockAddressSpace := ARecord.ReservedLargeBlockAddressSpace;
end;

function TMemoryManagerStateWrapper.ObjToRec: TMemoryManagerState;
begin
  result.AllocatedMediumBlockCount := FAllocatedMediumBlockCount;
  result.TotalAllocatedMediumBlockSize := FTotalAllocatedMediumBlockSize;
  result.ReservedMediumBlockAddressSpace := FReservedMediumBlockAddressSpace;
  result.AllocatedLargeBlockCount := FAllocatedLargeBlockCount;
  result.TotalAllocatedLargeBlockSize := FTotalAllocatedLargeBlockSize;
  result.ReservedLargeBlockAddressSpace := FReservedLargeBlockAddressSpace;
end;

constructor TMonitorSupportWrapper.Create(ARecord: TMonitorSupport);
begin
  inherited Create;
end;

function TMonitorSupportWrapper.ObjToRec: TMonitorSupport;
begin
end;
...
constructor TCVModInfoWrapper.Create(ARecord: TCVModInfo);
begin
  inherited Create;
end;

function TCVModInfoWrapper.ObjToRec: TCVModInfo;
begin
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TObjectClass(CurrentClass.ClassRef).Create);
...
begin
  with AMachine do
  begin
AResult := string(TObjectClass(CurrentClass.ClassRef).ClassName);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TObjectClass(CurrentClass.ClassRef).ClassNameIs(VarToStr(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatDelphiSystemLibrary.__TObjectUnitName(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := string(TObjectClass(CurrentClass.ClassRef).UnitName);
    ReturnOutputArg(AResult);
  end;
end;

procedure TatDelphiSystemLibrary.__TObjectEquals(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := TObject(CurrentObject).Equals(TObject(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatDelphiSystemLibrary.__TObjectGetHashCode(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(TObject(CurrentObject).GetHashCode);
    ReturnOutputArg(AResult);
  end;
end;

procedure TatDelphiSystemLibrary.__TObjectToString(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := string(TObject(CurrentObject).ToString);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TObjectClass(CurrentClass.ClassRef).NewInstance);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TInterfacedObjectClass(CurrentClass.ClassRef).NewInstance);
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatDelphiSystemLibrary.__MonitorEnter(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
...
1: AResult := System.MonitorEnter(TObject(VarToObject(GetInputArg(0))));
2: AResult := System.MonitorEnter(TObject(VarToObject(GetInputArg(0))),VarToInteger(GetInputArg(1)));
end;
    ReturnOutputArg(AResult);
  end;
end;

procedure TatDelphiSystemLibrary.__MonitorTryEnter(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := System.MonitorTryEnter(TObject(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatDelphiSystemLibrary.__MonitorExit(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    System.MonitorExit(TObject(VarToObject(GetInputArg(0))));
  end;
end;

procedure TatDelphiSystemLibrary.__MonitorWait(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := System.MonitorWait(TObject(VarToObject(GetInputArg(0))),VarToInteger(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatDelphiSystemLibrary.__MonitorPulse(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    System.MonitorPulse(TObject(VarToObject(GetInputArg(0))));
  end;
end;

procedure TatDelphiSystemLibrary.__MonitorPulseAll(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    System.MonitorPulseAll(TObject(VarToObject(GetInputArg(0))));
  end;
end;

procedure TatDelphiSystemLibrary.__MemoryBarrier(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
...
procedure TatDelphiSystemLibrary.__YieldProcessor(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(System.ExceptObject);
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatDelphiSystemLibrary.__GetMemoryManagerState(AMachine: TatVirtualMachine);
  var
  Param0Rec: TObject;
  Param0: TMemoryManagerState;
begin
  with AMachine do
  begin
Param0Rec := TObject(integer(GetInputArg(0)));
if not Assigned(Param0Rec) or not (Param0Rec is TMemoryManagerStateWrapper) then 
  Param0Rec := TMemoryManagerStateWrapper.Create(Param0);
Param0 := TMemoryManagerStateWrapper(Param0Rec).ObjToRec;
    System.GetMemoryManagerState(Param0);
    SetInputArg(0,integer(TMemoryManagerStateWrapper.Create(Param0)));
  end;
end;

procedure TatDelphiSystemLibrary.__GetMinimumBlockAlignment(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(System.GetMinimumBlockAlignment);
    ReturnOutputArg(AResult);
  end;
end;

procedure TatDelphiSystemLibrary.__SetMinimumBlockAlignment(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    System.SetMinimumBlockAlignment(TMinimumBlockAlignment(VarToInteger(GetInputArg(0))));
  end;
end;

procedure TatDelphiSystemLibrary.__AttemptToUseSharedMemoryManager(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := System.AttemptToUseSharedMemoryManager;
    ReturnOutputArg(AResult);
  end;
end;

procedure TatDelphiSystemLibrary.__ShareMemoryManager(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := System.ShareMemoryManager;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    System.ChDir(VarToStr(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    System.MkDir(VarToStr(GetInputArg(0)));
  end;
end;
...
procedure TatDelphiSystemLibrary.__MoveChars(AMachine: TatVirtualMachine);
  var
  Param0: Variant;
  Param1: Variant;
begin
...
Param0 := GetInputArg(0);
Param1 := GetInputArg(1);
    System.MoveChars(Param0,Param1,VarToInteger(GetInputArg(2)));
    SetInputArg(1,Param1);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(System.ParamStr(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    System.RmDir(VarToStr(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := System.UpCase(AnsiString(VarToStr(GetInputArg(0)))[1]);
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := System.WideCharToString(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := System.WideCharLenToString(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
Param1 := GetInputArg(1);
    System.WideCharToStrVar(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),Param1);
    SetInputArg(1,Param1);
  end;
end;
...
Param2 := GetInputArg(2);
    System.WideCharLenToStrVar(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)),Param2);
...
AResult := WideCharToString(System.StringToWideChar(GetInputArg(0),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(System.UnicodeToUtf8(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Integer(System.Utf8ToUnicode(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatDelphiSystemLibrary.__UTF8EncodeToShortString(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := System.UTF8EncodeToShortString(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatDelphiSystemLibrary.__UTF8ToWideString(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := System.UTF8ToWideString(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatDelphiSystemLibrary.__UTF8ToUnicodeString(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := System.UTF8ToUnicodeString(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatDelphiSystemLibrary.__UTF8ToString(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := string(System.UTF8ToString(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := System.AnsiToUtf8(VarToStr(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(System.Utf8ToAnsi(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := System.OleStrToString(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
Param1 := GetInputArg(1);
    System.OleStrToStrVar(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),Param1);
    SetInputArg(1,Param1);
  end;
end;
...
procedure TatDelphiSystemLibrary.__Int(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := System.Int(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatDelphiSystemLibrary.__Frac(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := System.Frac(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatDelphiSystemLibrary.__Exp(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := System.Exp(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatDelphiSystemLibrary.__Cos(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := System.Cos(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatDelphiSystemLibrary.__Sin(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := System.Sin(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatDelphiSystemLibrary.__Ln(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := System.Ln(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatDelphiSystemLibrary.__ArcTan(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := System.ArcTan(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatDelphiSystemLibrary.__Sqrt(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := System.Sqrt(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatDelphiSystemLibrary.__StringElementSize(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(System.StringElementSize(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatDelphiSystemLibrary.__StringCodePage(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(System.StringCodePage(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatDelphiSystemLibrary.__StringRefCount(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(System.StringRefCount(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatDelphiSystemLibrary.__SetCodePage(AMachine: TatVirtualMachine);
  var
...
Param0 := GetInputArg(0);
    Case InputArgCount of
      2: System.SetCodePage(Param0,VarToInteger(GetInputArg(1)));
      3: System.SetCodePage(Param0,VarToInteger(GetInputArg(1)),GetInputArg(2));
    end;
    SetInputArg(0,Param0);
  end;
end;

procedure TatDelphiSystemLibrary.__Pos(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(System.Pos(GetInputArg(0),GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatDelphiSystemLibrary.__StringOfChar(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := System.StringOfChar(AnsiString(VarToStr(GetInputArg(0)))[1],VarToInteger(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    System.Error(TRuntimeError(VarToInteger(GetInputArg(0))));
  end;
end;
...
procedure TatDelphiSystemLibrary.__SetMultiByteConversionCodePage(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    System.SetMultiByteConversionCodePage(VarToInteger(GetInputArg(0)));
  end;
end;
...
procedure TatDelphiSystemLibrary.__GetCPUCount(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(System.CPUCount));
  end;
end;

procedure TatDelphiSystemLibrary.__SetCPUCount(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    System.CPUCount:=VarToInteger(GetInputArg(0));
  end;
end;
...
procedure TatDelphiSystemLibrary.__GetDefaultSystemCodePage(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(System.DefaultSystemCodePage));
  end;
end;

procedure TatDelphiSystemLibrary.__SetDefaultSystemCodePage(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    System.DefaultSystemCodePage:=VarToInteger(GetInputArg(0));
  end;
end;

procedure TatDelphiSystemLibrary.__GetDefaultUnicodeCodePage(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(System.DefaultUnicodeCodePage));
  end;
end;

procedure TatDelphiSystemLibrary.__SetDefaultUnicodeCodePage(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    System.DefaultUnicodeCodePage:=VarToInteger(GetInputArg(0));
  end;
end;

procedure TatDelphiSystemLibrary.__GetUTF8CompareLocale(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(System.UTF8CompareLocale));
  end;
end;

procedure TatDelphiSystemLibrary.__SetUTF8CompareLocale(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    System.UTF8CompareLocale:=VarToInteger(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(System.DefaultTextLineBreakStyle));
  end;
end;
...
begin
  with AMachine do
  begin
    System.DefaultTextLineBreakStyle:=TTextLineBreakStyle(VarToInteger(GetInputArg(0)));
  end;
end;
...
procedure TatDelphiSystemLibrary.__GetReportMemoryLeaksOnShutdown(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(System.ReportMemoryLeaksOnShutdown);
  end;
end;

procedure TatDelphiSystemLibrary.__SetReportMemoryLeaksOnShutdown(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    System.ReportMemoryLeaksOnShutdown:=GetInputArg(0);
  end;
end;

procedure TatDelphiSystemLibrary.__GetNeverSleepOnMMThreadContention(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(System.NeverSleepOnMMThreadContention);
  end;
end;

procedure TatDelphiSystemLibrary.__SetNeverSleepOnMMThreadContention(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    System.NeverSleepOnMMThreadContention:=GetInputArg(0);
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('ClassNameIs',1,tkVariant,nil,__TObjectClassNameIs,true,0,'Name: string');
    DefineMethod('InstanceSize',0,tkInteger,nil,__TObjectInstanceSize,true,0,'');
    DefineMethod('GetInterface',2,tkVariant,nil,__TObjectGetInterface,false,0,'IID: TGUID; Obj').SetVarArgs([1]);
    DefineMethod('UnitName',0,tkVariant,nil,__TObjectUnitName,true,0,'');
    DefineMethod('Equals',1,tkVariant,nil,__TObjectEquals,false,0,'Obj: TObject');
    DefineMethod('GetHashCode',0,tkInteger,nil,__TObjectGetHashCode,false,0,'');
    DefineMethod('ToString',0,tkVariant,nil,__TObjectToString,false,0,'');
    ...
    DefineMethod('Dispatch',1,tkNone,nil,__TObjectDispatch,false,0,'Message').SetVarArgs([0]);
    DefineMethod('DefaultHandler',1,tkNone,nil,__TObjectDefaultHandler,false,0,'Message').SetVarArgs([0]);
  ...
  With Scripter.DefineClass(TClassHelperBase) do
  begin
  end;
  With Scripter.DefineClass(ClassType) do
  begin
    DefineMethod('MonitorEnter',2,tkVariant,nil,__MonitorEnter,false,1,'AObject: TObject; Timeout: Cardinal = INFINITE');
    DefineMethod('MonitorTryEnter',1,tkVariant,nil,__MonitorTryEnter,false,0,'AObject: TObject');
    DefineMethod('MonitorExit',1,tkNone,nil,__MonitorExit,false,0,'AObject: TObject');
    DefineMethod('MonitorWait',2,tkVariant,nil,__MonitorWait,false,0,'AObject: TObject; Timeout: Cardinal');
    DefineMethod('MonitorPulse',1,tkNone,nil,__MonitorPulse,false,0,'AObject: TObject');
    DefineMethod('MonitorPulseAll',1,tkNone,nil,__MonitorPulseAll,false,0,'AObject: TObject');
    DefineMethod('MemoryBarrier',0,tkNone,nil,__MemoryBarrier,false,0,'');
    DefineMethod('YieldProcessor',0,tkNone,nil,__YieldProcessor,false,0,'');
    ...
    DefineMethod('SetInOutRes',1,tkNone,nil,__SetInOutRes,false,0,'NewValue: Integer');
    DefineMethod('GetMemoryManager',1,tkNone,nil,__GetMemoryManager,false,0,'MemMgr: TMemoryManager').SetVarArgs([0]);
    DefineMethod('SetMemoryManager',1,tkNone,nil,__SetMemoryManager,false,0,'MemMgr: TMemoryManager');
    ...
    DefineMethod('GetMemoryManagerState',1,tkNone,nil,__GetMemoryManagerState,false,0,'AMemoryManagerState: TMemoryManagerState').SetVarArgs([0]);
    DefineMethod('GetMinimumBlockAlignment',0,tkEnumeration,nil,__GetMinimumBlockAlignment,false,0,'');
    DefineMethod('SetMinimumBlockAlignment',1,tkNone,nil,__SetMinimumBlockAlignment,false,0,'AMinimumBlockAlignment: TMinimumBlockAlignment');
    DefineMethod('AttemptToUseSharedMemoryManager',0,tkVariant,nil,__AttemptToUseSharedMemoryManager,false,0,'');
    DefineMethod('ShareMemoryManager',0,tkVariant,nil,__ShareMemoryManager,false,0,'');
    DefineMethod('EndThread',1,tkNone,nil,__EndThread,false,0,'ExitCode: Integer');
    DefineMethod('ChDir',1,tkNone,nil,__ChDir,false,0,'S: string');
    DefineMethod('IOResult',0,tkInteger,nil,__IOResult,false,0,'');
    DefineMethod('MkDir',1,tkNone,nil,__MkDir,false,0,'S: string');
    DefineMethod('Move',3,tkNone,nil,__Move,false,0,'Source; Dest; Count: Integer').SetVarArgs([1]);
    DefineMethod('MoveChars',3,tkNone,nil,__MoveChars,false,0,'Source; Dest; Length: Integer').SetVarArgs([1]);
    DefineMethod('ParamCount',0,tkInteger,nil,__ParamCount,false,0,'');
    DefineMethod('ParamStr',1,tkVariant,nil,__ParamStr,false,0,'Index: Integer');
    DefineMethod('RmDir',1,tkNone,nil,__RmDir,false,0,'S: string');
    DefineMethod('UpCase',1,tkVariant,nil,__UpCase,false,0,'Ch: AnsiChar');
    DefineMethod('Randomize',0,tkNone,nil,__Randomize,false,0,'');
    DefineMethod('Set8087CW',1,tkNone,nil,__Set8087CW,false,0,'NewCW: Word');
    DefineMethod('Get8087CW',0,tkInteger,nil,__Get8087CW,false,0,'');
    DefineMethod('WideCharToString',1,tkVariant,nil,__WideCharToString,false,0,'Source: PWideChar');
    DefineMethod('WideCharLenToString',2,tkVariant,nil,__WideCharLenToString,false,0,'Source: PWideChar; SourceLen: Integer');
    DefineMethod('WideCharToStrVar',2,tkNone,nil,__WideCharToStrVar,false,0,'Source: PWideChar; Dest: UnicodeString').SetVarArgs([1]);
    DefineMethod('WideCharLenToStrVar',3,tkNone,nil,__WideCharLenToStrVar,false,0,'Source: PWideChar; SourceLen: Integer; Dest: UnicodeString').SetVarArgs([2]);
    DefineMethod('StringToWideChar',3,tkVariant,nil,__StringToWideChar,false,0,'Source: UnicodeString; Dest: PWideChar; DestSize: Integer');
    DefineMethod('UnicodeToUtf8',3,tkInteger,nil,__UnicodeToUtf8,false,0,'Dest: PAnsiChar; Source: PWideChar; MaxBytes: Integer');
    DefineMethod('Utf8ToUnicode',3,tkInteger,nil,__Utf8ToUnicode,false,0,'Dest: PWideChar; Source: PAnsiChar; MaxChars: Integer');
    DefineMethod('UTF8Encode',1,tkVariant,nil,__UTF8Encode,false,0,'WS: WideString');
    DefineMethod('UTF8EncodeToShortString',1,tkVariant,nil,__UTF8EncodeToShortString,false,0,'WS: WideString');
    DefineMethod('UTF8Decode',1,tkVariant,nil,__UTF8Decode,false,0,'S: RawByteString');
    DefineMethod('UTF8ToWideString',1,tkVariant,nil,__UTF8ToWideString,false,0,'S: RawByteString');
    DefineMethod('UTF8ToUnicodeString',1,tkVariant,nil,__UTF8ToUnicodeString,false,0,'S: RawByteString');
    DefineMethod('UTF8ToString',1,tkVariant,nil,__UTF8ToString,false,0,'S: RawByteString');
    DefineMethod('AnsiToUtf8',1,tkVariant,nil,__AnsiToUtf8,false,0,'S: string');
    DefineMethod('Utf8ToAnsi',1,tkVariant,nil,__Utf8ToAnsi,false,0,'S: RawByteString');
    DefineMethod('OleStrToString',1,tkVariant,nil,__OleStrToString,false,0,'Source: PWideChar');
    DefineMethod('OleStrToStrVar',2,tkNone,nil,__OleStrToStrVar,false,0,'Source: PWideChar; Dest: AnsiString').SetVarArgs([1]);
    DefineMethod('StringToOleStr',1,tkVariant,nil,__StringToOleStr,false,0,'Source: AnsiString');
    DefineMethod('GetVariantManager',1,tkNone,nil,__GetVariantManager,false,0,'VarMgr: TVariantManager').SetVarArgs([0]);
    DefineMethod('SetVariantManager',1,tkNone,nil,__SetVariantManager,false,0,'VarMgr: TVariantManager');
    DefineMethod('IsVariantManagerSet',0,tkVariant,nil,__IsVariantManagerSet,false,0,'');
    DefineMethod('FindResourceHInstance',1,tkInteger,nil,__FindResourceHInstance,false,0,'Instance: LongWord');
    DefineMethod('LoadResourceModule',2,tkInteger,nil,__LoadResourceModule,false,1,'ModuleName: PChar; CheckOwner: Boolean = True');
    DefineMethod('Int',1,tkVariant,nil,__Int,false,0,'X: Extended');
    DefineMethod('Frac',1,tkVariant,nil,__Frac,false,0,'X: Extended');
    DefineMethod('Exp',1,tkVariant,nil,__Exp,false,0,'X: Extended');
    DefineMethod('Cos',1,tkVariant,nil,__Cos,false,0,'X: Extended');
    DefineMethod('Sin',1,tkVariant,nil,__Sin,false,0,'X: Extended');
    DefineMethod('Ln',1,tkVariant,nil,__Ln,false,0,'X: Extended');
    DefineMethod('ArcTan',1,tkVariant,nil,__ArcTan,false,0,'X: Extended');
    DefineMethod('Sqrt',1,tkVariant,nil,__Sqrt,false,0,'X: Extended');
    DefineMethod('Mark',0,tkNone,nil,__Mark,false,0,'');
    DefineMethod('Release',0,tkNone,nil,__Release,false,0,'');
    DefineMethod('UniqueString',1,tkNone,nil,__UniqueString,false,0,'str: AnsiString').SetVarArgs([0]);
    DefineMethod('StringElementSize',1,tkInteger,nil,__StringElementSize,false,0,'S: UnicodeString');
    DefineMethod('StringCodePage',1,tkInteger,nil,__StringCodePage,false,0,'S: UnicodeString');
    DefineMethod('StringRefCount',1,tkInteger,nil,__StringRefCount,false,0,'S: UnicodeString');
    DefineMethod('SetCodePage',3,tkNone,nil,__SetCodePage,false,1,'S: RawByteString; CodePage: Word; Convert: Boolean = True').SetVarArgs([0]);
    DefineMethod('Pos',2,tkInteger,nil,__Pos,false,0,'substr: UnicodeString; str: UnicodeString');
    DefineMethod('FPower10',0,tkNone,nil,__FPower10,false,0,'');
    DefineMethod('TextStart',0,tkNone,nil,__TextStart,false,0,'');
    DefineMethod('CompToDouble',1,tkVariant,nil,__CompToDouble,false,0,'Value: Comp');
    DefineMethod('DoubleToComp',2,tkNone,nil,__DoubleToComp,false,0,'Value: Double; Result: Comp').SetVarArgs([1]);
    DefineMethod('CompToCurrency',1,tkVariant,nil,__CompToCurrency,false,0,'Value: Comp');
    DefineMethod('CurrencyToComp',2,tkNone,nil,__CurrencyToComp,false,0,'Value: Currency; Result: Comp').SetVarArgs([1]);
    DefineMethod('StringOfChar',2,tkVariant,nil,__StringOfChar,false,0,'ch: AnsiChar; Count: Integer');
    DefineMethod('Error',1,tkNone,nil,__Error,false,0,'errorCode: TRuntimeError');
    DefineMethod('GetLastError',0,tkInteger,nil,__GetLastError,false,0,'');
    DefineMethod('SetLastError',1,tkNone,nil,__SetLastError,false,0,'ErrorCode: Integer');
    DefineMethod('SetMultiByteConversionCodePage',1,tkNone,nil,__SetMultiByteConversionCodePage,false,0,'CodePage: Integer');
    ...
    DefineProp('CPUCount',tkInteger,__GetCPUCount,__SetCPUCount,nil,false,0);
    ...
    DefineProp('DefaultSystemCodePage',tkInteger,__GetDefaultSystemCodePage,__SetDefaultSystemCodePage,nil,false,0);
    DefineProp('DefaultUnicodeCodePage',tkInteger,__GetDefaultUnicodeCodePage,__SetDefaultUnicodeCodePage,nil,false,0);
    DefineProp('UTF8CompareLocale',tkInteger,__GetUTF8CompareLocale,__SetUTF8CompareLocale,nil,false,0);
    ...
    DefineProp('ReportMemoryLeaksOnShutdown',tkVariant,__GetReportMemoryLeaksOnShutdown,__SetReportMemoryLeaksOnShutdown,nil,false,0);
    DefineProp('NeverSleepOnMMThreadContention',tkVariant,__GetNeverSleepOnMMThreadContention,__SetNeverSleepOnMMThreadContention,nil,false,0);
    AddConstant('csUnallocated',csUnallocated);
    AddConstant('csAllocated',csAllocated);
    AddConstant('csReserved',csReserved);
    AddConstant('csSysAllocated',csSysAllocated);
    AddConstant('csSysReserved',csSysReserved);
    AddConstant('mba8Byte',mba8Byte);
    AddConstant('mba16Byte',mba16Byte);
    ...
    AddConstant('reMonitorNotLocked',reMonitorNotLocked);
    AddConstant('reNoMonitorSupport',reNoMonitorSupport);
    ...
    AddConstant('vtUnicodeString',vtUnicodeString);
    ...
    AddConstant('vmtEquals',vmtEquals);
    AddConstant('vmtGetHashCode',vmtGetHashCode);
    AddConstant('vmtToString',vmtToString);
    ...
    AddConstant('hfFieldSize',hfFieldSize);
    AddConstant('hfMonitorOffset',hfMonitorOffset);
    AddConstant('INFINITE',INFINITE);
    ...
    AddConstant('NumSmallBlockTypes',NumSmallBlockTypes);
