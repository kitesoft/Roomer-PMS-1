...
type
  TatControlsLibrary = class(TatScripterLibrary)
    ...
    procedure __GetAlignControlList(AMachine: TatVirtualMachine);
...
procedure TatControlsLibrary.__GetAlignControlList(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := ObjectToVar(Controls.GetAlignControlList(TWinControl(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('GetAlignControlList',1,tkClass,TList,__GetAlignControlList,false,0,'AControl: TWinControl');
