...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TButtonGroupClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
...
begin
  with AMachine do
  begin
    TButtonGroup(CurrentObject).Assign(TPersistent(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TButtonGroup(CurrentObject).DragDrop(TObject(VarToObject(GetInputArg(0))),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TButtonGroup(CurrentObject).GetDragImages);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TButtonGroup(CurrentObject).DragImageList));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TGrpButtonItem(CurrentObject).Collection));
  end;
end;
...
begin
  with AMachine do
  begin
    TGrpButtonItem(CurrentObject).Collection:=TGrpButtonItems(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TGrpButtonItemsClass(CurrentClass.ClassRef).Create(TButtonGroup(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TGrpButtonItems(CurrentObject).Add);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TGrpButtonItems(CurrentObject).AddItem(TGrpButtonItem(VarToObject(GetInputArg(0))),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TGrpButtonItems(CurrentObject).Insert(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TGrpButtonItems(CurrentObject).Items[VarToInteger(GetArrayIndex(0))]));
  end;
end;
...
begin
  with AMachine do
  begin
    TGrpButtonItems(CurrentObject).Items[VarToInteger(GetArrayIndex(0))]:=TGrpButtonItem(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TGrpButtonItems(CurrentObject).ButtonGroup));
  end;
end;
...
begin
  ...
  begin
    DefineMethod('Create',1,tkClass,TButtonGroup,__TButtonGroupCreate,true,0,'AOwner: TComponent');
    DefineMethod('Destroy',0,tkNone,nil,__TButtonGroupDestroy,false,0,'');
    DefineMethod('Assign',1,tkNone,nil,__TButtonGroupAssign,false,0,'Source: TPersistent');
    DefineMethod('DragDrop',3,tkNone,nil,__TButtonGroupDragDrop,false,0,'Source: TObject; X: Integer; Y: Integer');
    DefineMethod('GetButtonRect',1,tkVariant,nil,__TButtonGroupGetButtonRect,false,0,'Index: Integer');
    DefineMethod('GetDragImages',0,tkClass,TDragImageList,__TButtonGroupGetDragImages,false,0,'');
    DefineMethod('IndexOfButtonAt',2,tkInteger,nil,__TButtonGroupIndexOfButtonAt,false,0,'X: Integer; Y: Integer');
    DefineMethod('RemoveInsertionPoints',0,tkNone,nil,__TButtonGroupRemoveInsertionPoints,false,0,'');
    DefineMethod('ScrollIntoView',1,tkNone,nil,__TButtonGroupScrollIntoView,false,0,'Index: Integer');
    DefineMethod('SetInsertionPoints',1,tkNone,nil,__TButtonGroupSetInsertionPoints,false,0,'InsertionIndex: Integer');
    DefineMethod('TargetIndexAt',2,tkInteger,nil,__TButtonGroupTargetIndexAt,false,0,'X: Integer; Y: Integer');
  ...
  begin
    DefineMethod('Create',1,tkClass,TGrpButtonItems,__TGrpButtonItemsCreate,true,0,'ButtonGroup: TButtonGroup');
    DefineMethod('Add',0,tkClass,TGrpButtonItem,__TGrpButtonItemsAdd,false,0,'');
    DefineMethod('AddItem',2,tkClass,TGrpButtonItem,__TGrpButtonItemsAddItem,false,0,'Item: TGrpButtonItem; Index: Integer');
    DefineMethod('BeginUpdate',0,tkNone,nil,__TGrpButtonItemsBeginUpdate,false,0,'');
    DefineMethod('Insert',1,tkClass,TGrpButtonItem,__TGrpButtonItemsInsert,false,0,'Index: Integer');
