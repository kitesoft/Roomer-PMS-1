...
begin
  ...
  begin
    ...
    DefineMethod('DwmEnableBlurBehindWindow',2,tkInteger,nil,__DwmEnableBlurBehindWindow,false,0,'hWnd: HWND; pBlurBehind: TDWMBlurBehind');
    ...
    DefineMethod('DwmRegisterThumbnail',3,tkInteger,nil,__DwmRegisterThumbnail,false,0,'hwndDestination: HWND; hwndSource: HWND; phThumbnailId: HTHUMBNAIL').SetVarArgs([2]);
    ...
    DefineMethod('DwmUpdateThumbnailProperties',2,tkInteger,nil,__DwmUpdateThumbnailProperties,false,0,'hThumbnailId: HTHUMBNAIL; ptnProperties: TDWMThumbnailProperties');
