...
type
  ...
  private
    Fncb_command: AnsiChar;
    Fncb_retcode: AnsiChar;
    Fncb_lsn: AnsiChar;
    Fncb_num: AnsiChar;
    Fncb_length: Word;
    Fncb_rto: AnsiChar;
    Fncb_sto: AnsiChar;
    Fncb_lana_num: AnsiChar;
    Fncb_cmd_cplt: AnsiChar;
    Fncb_event: THandle;
  public
    constructor Create(ARecord: TNCB);
    function ObjToRec: TNCB;
  published
    property ncb_command: AnsiChar read Fncb_command write Fncb_command;
    property ncb_retcode: AnsiChar read Fncb_retcode write Fncb_retcode;
    property ncb_lsn: AnsiChar read Fncb_lsn write Fncb_lsn;
    property ncb_num: AnsiChar read Fncb_num write Fncb_num;
    property ncb_length: Word read Fncb_length write Fncb_length;
    property ncb_rto: AnsiChar read Fncb_rto write Fncb_rto;
    property ncb_sto: AnsiChar read Fncb_sto write Fncb_sto;
    property ncb_lana_num: AnsiChar read Fncb_lana_num write Fncb_lana_num;
    property ncb_cmd_cplt: AnsiChar read Fncb_cmd_cplt write Fncb_cmd_cplt;
  ...
  published
    property rev_major: AnsiChar read Frev_major write Frev_major;
    property reserved0: AnsiChar read Freserved0 write Freserved0;
    property adapter_type: AnsiChar read Fadapter_type write Fadapter_type;
    property rev_minor: AnsiChar read Frev_minor write Frev_minor;
  ...
  private
    Fname_num: AnsiChar;
    Fname_flags: AnsiChar;
  public
    constructor Create(ARecord: TNameBuffer);
    function ObjToRec: TNameBuffer;
  published
    property name_num: AnsiChar read Fname_num write Fname_num;
    property name_flags: AnsiChar read Fname_flags write Fname_flags;
  end;
  ...
  private
    Fsess_name: AnsiChar;
    Fnum_sess: AnsiChar;
    Frcv_dg_outstanding: AnsiChar;
    Frcv_any_outstanding: AnsiChar;
  public
    constructor Create(ARecord: TSessionHeader);
    function ObjToRec: TSessionHeader;
  published
    property sess_name: AnsiChar read Fsess_name write Fsess_name;
    property num_sess: AnsiChar read Fnum_sess write Fnum_sess;
    property rcv_dg_outstanding: AnsiChar read Frcv_dg_outstanding write Frcv_dg_outstanding;
    property rcv_any_outstanding: AnsiChar read Frcv_any_outstanding write Frcv_any_outstanding;
  end;
  ...
  private
    Flsn: AnsiChar;
    Fstate: AnsiChar;
    Frcvs_outstanding: AnsiChar;
    Fsends_outstanding: AnsiChar;
  public
    constructor Create(ARecord: TSessionBuffer);
    function ObjToRec: TSessionBuffer;
  published
    property lsn: AnsiChar read Flsn write Flsn;
    property state: AnsiChar read Fstate write Fstate;
    property rcvs_outstanding: AnsiChar read Frcvs_outstanding write Frcvs_outstanding;
    property sends_outstanding: AnsiChar read Fsends_outstanding write Fsends_outstanding;
  end;
  ...
  published
    property length: AnsiChar read Flength write Flength;
  end;
  ...
  published
    ...
    property reserved: AnsiChar read Freserved write Freserved;
    property unique_group: AnsiChar read Funique_group write Funique_group;
  end;
  
  TFindNameBufferWrapper = class(TatRecordWrapper)
  private
    Flength: AnsiChar;
    Faccess_control: AnsiChar;
    Fframe_control: AnsiChar;
  public
    constructor Create(ARecord: TFindNameBuffer);
    function ObjToRec: TFindNameBuffer;
  published
    property length: AnsiChar read Flength write Flength;
    property access_control: AnsiChar read Faccess_control write Faccess_control;
    property frame_control: AnsiChar read Fframe_control write Fframe_control;
  end;
