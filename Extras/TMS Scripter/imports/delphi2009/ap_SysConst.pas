...
begin
  ...
  begin
    ...
    AddConstant('SMonitorLockException',SMonitorLockException);
    AddConstant('SNoMonitorSupportException',SNoMonitorSupportException);
    ...
    AddConstant('SInvalidSourceArray',SInvalidSourceArray);
    AddConstant('SInvalidDestinationArray',SInvalidDestinationArray);
    AddConstant('SCharIndexOutOfBounds',SCharIndexOutOfBounds);
    AddConstant('SByteIndexOutOfBounds',SByteIndexOutOfBounds);
    AddConstant('SInvalidCharCount',SInvalidCharCount);
    AddConstant('SInvalidDestinationIndex',SInvalidDestinationIndex);
    AddConstant('SInvalidCodePage',SInvalidCodePage);
  end;
end;
