...
AResult := Integer(MMSystem.OpenDriver(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := MMSystem.sndPlaySound(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := MMSystem.sndPlaySoundA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),VarToInteger(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := MMSystem.sndPlaySoundW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := MMSystem.PlaySound(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := MMSystem.PlaySoundA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := MMSystem.PlaySoundW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(MMSystem.waveOutGetErrorText(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(MMSystem.waveOutGetErrorTextA(VarToInteger(GetInputArg(0)),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(MMSystem.waveOutGetErrorTextW(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(MMSystem.waveInGetErrorText(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(MMSystem.waveInGetErrorTextA(VarToInteger(GetInputArg(0)),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(MMSystem.waveInGetErrorTextW(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(MMSystem.midiOutGetErrorText(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(MMSystem.midiOutGetErrorTextA(VarToInteger(GetInputArg(0)),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(MMSystem.midiOutGetErrorTextW(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(MMSystem.midiInGetErrorText(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(MMSystem.midiInGetErrorTextA(VarToInteger(GetInputArg(0)),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(MMSystem.midiInGetErrorTextW(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Integer(MMSystem.mmioStringToFOURCC(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(MMSystem.mmioStringToFOURCCA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Integer(MMSystem.mmioStringToFOURCCW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(MMSystem.mmioRead(VarToInteger(GetInputArg(0)),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(MMSystem.mmioWrite(VarToInteger(GetInputArg(0)),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(MMSystem.mmioSetBuffer(VarToInteger(GetInputArg(0)),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(MMSystem.mciSendString(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(MMSystem.mciSendStringA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(MMSystem.mciSendStringW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Integer(MMSystem.mciGetDeviceID(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(MMSystem.mciGetDeviceIDA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Integer(MMSystem.mciGetDeviceIDW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(MMSystem.mciGetDeviceIDFromElementID(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(MMSystem.mciGetDeviceIDFromElementIDA(VarToInteger(GetInputArg(0)),PAnsiChar(AnsiString(VarToStr(GetInputArg(1))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(MMSystem.mciGetDeviceIDFromElementIDW(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := MMSystem.mciGetErrorString(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := MMSystem.mciGetErrorStringA(VarToInteger(GetInputArg(0)),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := MMSystem.mciGetErrorStringW(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := MMSystem.mciExecute(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  With Scripter.DefineClass(ClassType) do
  begin
    DefineMethod('CloseDriver',3,tkInteger,nil,__CloseDriver,false,0,'hDriver: HDRVR; lParam1: Longint; lParam2: Longint');
    DefineMethod('OpenDriver',3,tkInteger,nil,__OpenDriver,false,0,'szDriverName: PWideChar; szSectionName: PWideChar; lParam2: Longint');
    DefineMethod('SendDriverMessage',4,tkInteger,nil,__SendDriverMessage,false,0,'hDriver: HDRVR; message: UINT; lParam1: Longint; lParam2: Longint');
    DefineMethod('DrvGetModuleHandle',1,tkInteger,nil,__DrvGetModuleHandle,false,0,'hDriver: HDRVR');
    DefineMethod('GetDriverModuleHandle',1,tkInteger,nil,__GetDriverModuleHandle,false,0,'hDriver: HDRVR');
    DefineMethod('DefDriverProc',5,tkInteger,nil,__DefDriverProc,false,0,'dwDriverIdentifier: DWORD; hdrvr: HDRVR; uMsg: UINT; lParam1: LPARAM; lParam2: LPARAM');
    DefineMethod('mmsystemGetVersion',0,tkInteger,nil,__mmsystemGetVersion,false,0,'');
    DefineMethod('sndPlaySound',2,tkVariant,nil,__sndPlaySound,false,0,'lpszSoundName: PWideChar; uFlags: UINT');
    DefineMethod('sndPlaySoundA',2,tkVariant,nil,__sndPlaySoundA,false,0,'lpszSoundName: PAnsiChar; uFlags: UINT');
    DefineMethod('sndPlaySoundW',2,tkVariant,nil,__sndPlaySoundW,false,0,'lpszSoundName: PWideChar; uFlags: UINT');
    DefineMethod('PlaySound',3,tkVariant,nil,__PlaySound,false,0,'pszSound: PWideChar; hmod: HMODULE; fdwSound: DWORD');
    DefineMethod('PlaySoundA',3,tkVariant,nil,__PlaySoundA,false,0,'pszSound: PAnsiChar; hmod: HMODULE; fdwSound: DWORD');
    DefineMethod('PlaySoundW',3,tkVariant,nil,__PlaySoundW,false,0,'pszSound: PWideChar; hmod: HMODULE; fdwSound: DWORD');
    DefineMethod('waveOutGetNumDevs',0,tkInteger,nil,__waveOutGetNumDevs,false,0,'');
    DefineMethod('waveOutSetVolume',2,tkInteger,nil,__waveOutSetVolume,false,0,'hwo: HWAVEOUT; dwVolume: DWORD');
    DefineMethod('waveOutGetErrorText',3,tkInteger,nil,__waveOutGetErrorText,false,0,'mmrError: MMRESULT; lpText: PWideChar; uSize: UINT');
    DefineMethod('waveOutGetErrorTextA',3,tkInteger,nil,__waveOutGetErrorTextA,false,0,'mmrError: MMRESULT; lpText: PAnsiChar; uSize: UINT');
    DefineMethod('waveOutGetErrorTextW',3,tkInteger,nil,__waveOutGetErrorTextW,false,0,'mmrError: MMRESULT; lpText: PWideChar; uSize: UINT');
    DefineMethod('waveOutClose',1,tkInteger,nil,__waveOutClose,false,0,'hWaveOut: HWAVEOUT');
    DefineMethod('waveOutPause',1,tkInteger,nil,__waveOutPause,false,0,'hWaveOut: HWAVEOUT');
    DefineMethod('waveOutRestart',1,tkInteger,nil,__waveOutRestart,false,0,'hWaveOut: HWAVEOUT');
    DefineMethod('waveOutReset',1,tkInteger,nil,__waveOutReset,false,0,'hWaveOut: HWAVEOUT');
    DefineMethod('waveOutBreakLoop',1,tkInteger,nil,__waveOutBreakLoop,false,0,'hWaveOut: HWAVEOUT');
    DefineMethod('waveOutSetPitch',2,tkInteger,nil,__waveOutSetPitch,false,0,'hWaveOut: HWAVEOUT; dwPitch: DWORD');
    DefineMethod('waveOutSetPlaybackRate',2,tkInteger,nil,__waveOutSetPlaybackRate,false,0,'hWaveOut: HWAVEOUT; dwRate: DWORD');
    DefineMethod('waveOutMessage',4,tkInteger,nil,__waveOutMessage,false,0,'hWaveOut: HWAVEOUT; uMessage: UINT; dw1: DWORD; dw2: DWORD');
    DefineMethod('waveInGetNumDevs',0,tkInteger,nil,__waveInGetNumDevs,false,0,'');
    DefineMethod('waveInGetErrorText',3,tkInteger,nil,__waveInGetErrorText,false,0,'mmrError: MMRESULT; lpText: PWideChar; uSize: UINT');
    DefineMethod('waveInGetErrorTextA',3,tkInteger,nil,__waveInGetErrorTextA,false,0,'mmrError: MMRESULT; lpText: PAnsiChar; uSize: UINT');
    DefineMethod('waveInGetErrorTextW',3,tkInteger,nil,__waveInGetErrorTextW,false,0,'mmrError: MMRESULT; lpText: PWideChar; uSize: UINT');
    DefineMethod('waveInClose',1,tkInteger,nil,__waveInClose,false,0,'hWaveIn: HWAVEIN');
    DefineMethod('waveInStart',1,tkInteger,nil,__waveInStart,false,0,'hWaveIn: HWAVEIN');
    DefineMethod('waveInStop',1,tkInteger,nil,__waveInStop,false,0,'hWaveIn: HWAVEIN');
    DefineMethod('waveInReset',1,tkInteger,nil,__waveInReset,false,0,'hWaveIn: HWAVEIN');
    DefineMethod('waveInMessage',4,tkInteger,nil,__waveInMessage,false,0,'hWaveIn: HWAVEIN; uMessage: UINT; dw1: DWORD; dw2: DWORD');
    DefineMethod('midiOutGetNumDevs',0,tkInteger,nil,__midiOutGetNumDevs,false,0,'');
    DefineMethod('midiStreamClose',1,tkInteger,nil,__midiStreamClose,false,0,'hms: HMIDISTRM');
    DefineMethod('midiStreamPause',1,tkInteger,nil,__midiStreamPause,false,0,'hms: HMIDISTRM');
    DefineMethod('midiStreamRestart',1,tkInteger,nil,__midiStreamRestart,false,0,'hms: HMIDISTRM');
    DefineMethod('midiStreamStop',1,tkInteger,nil,__midiStreamStop,false,0,'hms: HMIDISTRM');
    DefineMethod('midiOutSetVolume',2,tkInteger,nil,__midiOutSetVolume,false,0,'hmo: HMIDIOUT; dwVolume: DWORD');
    DefineMethod('midiOutGetErrorText',3,tkInteger,nil,__midiOutGetErrorText,false,0,'mmrError: MMRESULT; pszText: PWideChar; uSize: UINT');
    DefineMethod('midiOutGetErrorTextA',3,tkInteger,nil,__midiOutGetErrorTextA,false,0,'mmrError: MMRESULT; pszText: PAnsiChar; uSize: UINT');
    DefineMethod('midiOutGetErrorTextW',3,tkInteger,nil,__midiOutGetErrorTextW,false,0,'mmrError: MMRESULT; pszText: PWideChar; uSize: UINT');
    DefineMethod('midiOutClose',1,tkInteger,nil,__midiOutClose,false,0,'hMidiOut: HMIDIOUT');
    DefineMethod('midiOutShortMsg',2,tkInteger,nil,__midiOutShortMsg,false,0,'hMidiOut: HMIDIOUT; dwMsg: DWORD');
    DefineMethod('midiOutReset',1,tkInteger,nil,__midiOutReset,false,0,'hMidiOut: HMIDIOUT');
    DefineMethod('midiOutMessage',4,tkInteger,nil,__midiOutMessage,false,0,'hMidiOut: HMIDIOUT; uMessage: UINT; dw1: DWORD; dw2: DWORD');
    DefineMethod('midiInGetNumDevs',0,tkInteger,nil,__midiInGetNumDevs,false,0,'');
    DefineMethod('midiInGetErrorText',3,tkInteger,nil,__midiInGetErrorText,false,0,'mmrError: MMRESULT; pszText: PWideChar; uSize: UINT');
    DefineMethod('midiInGetErrorTextA',3,tkInteger,nil,__midiInGetErrorTextA,false,0,'mmrError: MMRESULT; pszText: PAnsiChar; uSize: UINT');
    DefineMethod('midiInGetErrorTextW',3,tkInteger,nil,__midiInGetErrorTextW,false,0,'mmrError: MMRESULT; pszText: PWideChar; uSize: UINT');
    DefineMethod('midiInClose',1,tkInteger,nil,__midiInClose,false,0,'hMidiIn: HMIDIIN');
    DefineMethod('midiInStart',1,tkInteger,nil,__midiInStart,false,0,'hMidiIn: HMIDIIN');
    DefineMethod('midiInStop',1,tkInteger,nil,__midiInStop,false,0,'hMidiIn: HMIDIIN');
    DefineMethod('midiInReset',1,tkInteger,nil,__midiInReset,false,0,'hMidiIn: HMIDIIN');
    DefineMethod('midiInMessage',4,tkInteger,nil,__midiInMessage,false,0,'hMidiIn: HMIDIIN; uMessage: UINT; dw1: DWORD; dw2: DWORD');
    DefineMethod('auxGetNumDevs',0,tkInteger,nil,__auxGetNumDevs,false,0,'');
    DefineMethod('auxSetVolume',2,tkInteger,nil,__auxSetVolume,false,0,'uDeviceID: UINT; dwVolume: DWORD');
    DefineMethod('auxOutMessage',4,tkInteger,nil,__auxOutMessage,false,0,'uDeviceID: UINT; uMessage: UINT; dw1: DWORD; dw2: DWORD');
    DefineMethod('mixerGetNumDevs',0,tkInteger,nil,__mixerGetNumDevs,false,0,'');
    DefineMethod('mixerClose',1,tkInteger,nil,__mixerClose,false,0,'hmx: HMIXER');
    DefineMethod('mixerMessage',4,tkInteger,nil,__mixerMessage,false,0,'hmx: HMIXER; uMsg: UINT; dwParam1: DWORD; dwParam2: DWORD');
    DefineMethod('mixerGetID',3,tkInteger,nil,__mixerGetID,false,0,'hmxobj: HMIXEROBJ; puMxId: UINT; fdwId: DWORD').SetVarArgs([1]);
    DefineMethod('timeGetTime',0,tkInteger,nil,__timeGetTime,false,0,'');
    DefineMethod('timeKillEvent',1,tkInteger,nil,__timeKillEvent,false,0,'uTimerID: UINT');
    DefineMethod('timeBeginPeriod',1,tkInteger,nil,__timeBeginPeriod,false,0,'uPeriod: UINT');
    DefineMethod('timeEndPeriod',1,tkInteger,nil,__timeEndPeriod,false,0,'uPeriod: UINT');
    DefineMethod('joyGetNumDevs',0,tkInteger,nil,__joyGetNumDevs,false,0,'');
    DefineMethod('joyReleaseCapture',1,tkInteger,nil,__joyReleaseCapture,false,0,'uJoyID: UINT');
    DefineMethod('joySetCapture',4,tkInteger,nil,__joySetCapture,false,0,'Handle: HWND; uJoyID: UINT; uPeriod: UINT; bChanged: BOOL');
    DefineMethod('joySetThreshold',2,tkInteger,nil,__joySetThreshold,false,0,'uJoyID: UINT; uThreshold: UINT');
    DefineMethod('mmioStringToFOURCC',2,tkInteger,nil,__mmioStringToFOURCC,false,0,'sz: PWideChar; uFlags: UINT');
    DefineMethod('mmioStringToFOURCCA',2,tkInteger,nil,__mmioStringToFOURCCA,false,0,'sz: PAnsiChar; uFlags: UINT');
    DefineMethod('mmioStringToFOURCCW',2,tkInteger,nil,__mmioStringToFOURCCW,false,0,'sz: PWideChar; uFlags: UINT');
    DefineMethod('mmioClose',2,tkInteger,nil,__mmioClose,false,0,'hmmio: HMMIO; uFlags: UINT');
    DefineMethod('mmioRead',3,tkInteger,nil,__mmioRead,false,0,'hmmio: HMMIO; pch: PAnsiChar; cch: Longint');
    DefineMethod('mmioWrite',3,tkInteger,nil,__mmioWrite,false,0,'hmmio: HMMIO; pch: PAnsiChar; cch: Longint');
    DefineMethod('mmioSeek',3,tkInteger,nil,__mmioSeek,false,0,'hmmio: HMMIO; lOffset: Longint; iOrigin: Integer');
    DefineMethod('mmioSetBuffer',4,tkInteger,nil,__mmioSetBuffer,false,0,'hmmio: HMMIO; pchBuffer: PAnsiChar; cchBuffer: Longint; uFlags: Word');
    DefineMethod('mmioFlush',2,tkInteger,nil,__mmioFlush,false,0,'hmmio: HMMIO; uFlags: UINT');
    DefineMethod('mmioSendMessage',4,tkInteger,nil,__mmioSendMessage,false,0,'hmmio: HMMIO; uMessage: UINT; lParam1: DWORD; lParam2: DWORD');
    DefineMethod('mciSendCommand',4,tkInteger,nil,__mciSendCommand,false,0,'mciId: MCIDEVICEID; uMessage: UINT; dwParam1: DWORD; dwParam2: DWORD');
    DefineMethod('mciSendCommandA',4,tkInteger,nil,__mciSendCommandA,false,0,'mciId: MCIDEVICEID; uMessage: UINT; dwParam1: DWORD; dwParam2: DWORD');
    DefineMethod('mciSendCommandW',4,tkInteger,nil,__mciSendCommandW,false,0,'mciId: MCIDEVICEID; uMessage: UINT; dwParam1: DWORD; dwParam2: DWORD');
    DefineMethod('mciSendString',4,tkInteger,nil,__mciSendString,false,0,'lpstrCommand: PWideChar; lpstrReturnString: PWideChar; uReturnLength: UINT; hWndCallback: HWND');
    DefineMethod('mciSendStringA',4,tkInteger,nil,__mciSendStringA,false,0,'lpstrCommand: PAnsiChar; lpstrReturnString: PAnsiChar; uReturnLength: UINT; hWndCallback: HWND');
    DefineMethod('mciSendStringW',4,tkInteger,nil,__mciSendStringW,false,0,'lpstrCommand: PWideChar; lpstrReturnString: PWideChar; uReturnLength: UINT; hWndCallback: HWND');
    DefineMethod('mciGetDeviceID',1,tkInteger,nil,__mciGetDeviceID,false,0,'pszDevice: PWideChar');
    DefineMethod('mciGetDeviceIDA',1,tkInteger,nil,__mciGetDeviceIDA,false,0,'pszDevice: PAnsiChar');
    DefineMethod('mciGetDeviceIDW',1,tkInteger,nil,__mciGetDeviceIDW,false,0,'pszDevice: PWideChar');
    DefineMethod('mciGetDeviceIDFromElementID',2,tkInteger,nil,__mciGetDeviceIDFromElementID,false,0,'dwElementID: DWORD; lpstrType: PWideChar');
    DefineMethod('mciGetDeviceIDFromElementIDA',2,tkInteger,nil,__mciGetDeviceIDFromElementIDA,false,0,'dwElementID: DWORD; lpstrType: PAnsiChar');
    DefineMethod('mciGetDeviceIDFromElementIDW',2,tkInteger,nil,__mciGetDeviceIDFromElementIDW,false,0,'dwElementID: DWORD; lpstrType: PWideChar');
    DefineMethod('mciGetErrorString',3,tkVariant,nil,__mciGetErrorString,false,0,'mcierr: MCIERROR; pszText: PWideChar; uLength: UINT');
    DefineMethod('mciGetErrorStringA',3,tkVariant,nil,__mciGetErrorStringA,false,0,'mcierr: MCIERROR; pszText: PAnsiChar; uLength: UINT');
    DefineMethod('mciGetErrorStringW',3,tkVariant,nil,__mciGetErrorStringW,false,0,'mcierr: MCIERROR; pszText: PWideChar; uLength: UINT');
    DefineMethod('mciGetCreatorTask',1,tkInteger,nil,__mciGetCreatorTask,false,0,'mciId: MCIDEVICEID');
    DefineMethod('mciExecute',1,tkVariant,nil,__mciExecute,false,0,'pszCommand: LPCSTR');
    DefineMethod('mci_MSF_Minute',1,tkInteger,nil,__mci_MSF_Minute,false,0,'msf: Longint');
    DefineMethod('mci_MSF_Second',1,tkInteger,nil,__mci_MSF_Second,false,0,'msf: Longint');
    DefineMethod('mci_MSF_Frame',1,tkInteger,nil,__mci_MSF_Frame,false,0,'msf: Longint');
    DefineMethod('mci_Make_MSF',3,tkInteger,nil,__mci_Make_MSF,false,0,'m: Byte; s: Byte; f: Byte');
    DefineMethod('mci_TMSF_Track',1,tkInteger,nil,__mci_TMSF_Track,false,0,'tmsf: Longint');
    DefineMethod('mci_TMSF_Minute',1,tkInteger,nil,__mci_TMSF_Minute,false,0,'tmsf: Longint');
    DefineMethod('mci_TMSF_Second',1,tkInteger,nil,__mci_TMSF_Second,false,0,'tmsf: Longint');
    DefineMethod('mci_TMSF_Frame',1,tkInteger,nil,__mci_TMSF_Frame,false,0,'tmsf: Longint');
    DefineMethod('mci_Make_TMSF',4,tkInteger,nil,__mci_Make_TMSF,false,0,'t: Byte; m: Byte; s: Byte; f: Byte');
    DefineMethod('mci_HMS_Hour',1,tkInteger,nil,__mci_HMS_Hour,false,0,'hms: Longint');
    DefineMethod('mci_HMS_Minute',1,tkInteger,nil,__mci_HMS_Minute,false,0,'hms: Longint');
    DefineMethod('mci_HMS_Second',1,tkInteger,nil,__mci_HMS_Second,false,0,'hms: Longint');
    DefineMethod('mci_Make_HMS',3,tkInteger,nil,__mci_Make_HMS,false,0,'h: Byte; m: Byte; s: Byte');
    DefineMethod('DIBIndex',1,tkInteger,nil,__DIBIndex,false,0,'N: Integer');
  AddConsts1;
  AddConsts2;
  AddConsts3;
  end;
