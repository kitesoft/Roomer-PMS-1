...
begin
  ...
  begin
    DefineMethod('VariantClear',1,tkNone,nil,__VariantClear,false,0,'V: Variant').SetVarArgs([0]);
    DefineMethod('VariantArrayRedim',2,tkNone,nil,__VariantArrayRedim,false,0,'V: Variant; High: Integer').SetVarArgs([0]);
    DefineMethod('VariantCast',3,tkNone,nil,__VariantCast,false,0,'src: Variant; dst: Variant; vt: Integer').SetVarArgs([1]);
    DefineMethod('VariantCpy',2,tkNone,nil,__VariantCpy,false,0,'src: Variant; dst: Variant').SetVarArgs([1]);
    DefineMethod('VariantAdd',2,tkNone,nil,__VariantAdd,false,0,'src: Variant; dst: Variant').SetVarArgs([1]);
    DefineMethod('VariantSub',2,tkNone,nil,__VariantSub,false,0,'src: Variant; dst: Variant').SetVarArgs([1]);
    DefineMethod('VariantMul',2,tkNone,nil,__VariantMul,false,0,'src: Variant; dst: Variant').SetVarArgs([1]);
    DefineMethod('VariantDiv',2,tkNone,nil,__VariantDiv,false,0,'src: Variant; dst: Variant').SetVarArgs([1]);
    DefineMethod('VariantMod',2,tkNone,nil,__VariantMod,false,0,'src: Variant; dst: Variant').SetVarArgs([1]);
    DefineMethod('VariantAnd',2,tkNone,nil,__VariantAnd,false,0,'src: Variant; dst: Variant').SetVarArgs([1]);
    DefineMethod('VariantOr',2,tkNone,nil,__VariantOr,false,0,'src: Variant; dst: Variant').SetVarArgs([1]);
    DefineMethod('VariantXor',2,tkNone,nil,__VariantXor,false,0,'src: Variant; dst: Variant').SetVarArgs([1]);
    DefineMethod('VariantShl',2,tkNone,nil,__VariantShl,false,0,'src: Variant; dst: Variant').SetVarArgs([1]);
    DefineMethod('VariantShr',2,tkNone,nil,__VariantShr,false,0,'src: Variant; dst: Variant').SetVarArgs([1]);
    DefineMethod('VariantAdd2',2,tkVariant,nil,__VariantAdd2,false,0,'V1: Variant; V2: Variant');
    DefineMethod('VariantSub2',2,tkVariant,nil,__VariantSub2,false,0,'V1: Variant; V2: Variant');
    DefineMethod('VariantMul2',2,tkVariant,nil,__VariantMul2,false,0,'V1: Variant; V2: Variant');
    DefineMethod('VariantDiv2',2,tkVariant,nil,__VariantDiv2,false,0,'V1: Variant; V2: Variant');
    DefineMethod('VariantMod2',2,tkVariant,nil,__VariantMod2,false,0,'V1: Variant; V2: Variant');
    DefineMethod('VariantAnd2',2,tkVariant,nil,__VariantAnd2,false,0,'V1: Variant; V2: Variant');
    DefineMethod('VariantOr2',2,tkVariant,nil,__VariantOr2,false,0,'V1: Variant; V2: Variant');
    DefineMethod('VariantXor2',2,tkVariant,nil,__VariantXor2,false,0,'V1: Variant; V2: Variant');
    DefineMethod('VariantShl2',2,tkVariant,nil,__VariantShl2,false,0,'V1: Variant; V2: Variant');
    DefineMethod('VariantShr2',2,tkVariant,nil,__VariantShr2,false,0,'V1: Variant; V2: Variant');
    DefineMethod('VariantNot',1,tkVariant,nil,__VariantNot,false,0,'V1: Variant');
    DefineMethod('VariantNeg',1,tkVariant,nil,__VariantNeg,false,0,'V1: Variant');
    DefineMethod('VariantGetElement',2,tkVariant,nil,__VariantGetElement,false,0,'V: Variant; i1: integer');
    DefineMethod('VariantPutElement',3,tkNone,nil,__VariantPutElement,false,0,'V: Variant; data: Variant; i1: integer').SetVarArgs([0]);
    DefineMethod('VariantFromUnicodeString',2,tkNone,nil,__VariantFromUnicodeString,false,0,'V: Variant; Str: UnicodeString').SetVarArgs([0]);
    DefineMethod('VariantToUnicodeString',2,tkNone,nil,__VariantToUnicodeString,false,0,'V: Variant; Str: UnicodeString').SetVarArgs([1]);
  end;
end;
