...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TButtonCategories(CurrentObject).ButtonGroup));
  end;
end;
...
begin
  ...
  begin
    DefineMethod('Create',1,tkClass,TButtonCategories,__TButtonCategoriesCreate,true,0,'ButtonGroup: TCategoryButtons');
