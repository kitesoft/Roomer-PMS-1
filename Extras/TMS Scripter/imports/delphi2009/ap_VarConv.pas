...
begin
  ...
  begin
    DefineMethod('VarConvertCreate',2,tkVariant,nil,__VarConvertCreate,false,0,'AValue: Double; AType: TConvType');
    DefineMethod('VarConvert',0,tkInteger,nil,__VarConvert,false,0,'');
    DefineMethod('VarIsConvert',1,tkVariant,nil,__VarIsConvert,false,0,'AValue: Variant');
    DefineMethod('VarAsConvert',1,tkVariant,nil,__VarAsConvert,false,0,'AValue: Variant');
  end;
end;
