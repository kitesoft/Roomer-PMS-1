...
type
  ...
  tagNMTVDISPINFOEXAWrapper = class(TatRecordWrapper)
  private
  public
    constructor Create(ARecord: tagNMTVDISPINFOEXA);
    function ObjToRec: tagNMTVDISPINFOEXA;
  published
  end;
  
  tagNMTVDISPINFOEXWWrapper = class(TatRecordWrapper)
  private
  public
    constructor Create(ARecord: tagNMTVDISPINFOEXW);
    function ObjToRec: tagNMTVDISPINFOEXW;
  published
  end;
...
constructor tagNMTVDISPINFOEXAWrapper.Create(ARecord: tagNMTVDISPINFOEXA);
begin
  inherited Create;
end;

function tagNMTVDISPINFOEXAWrapper.ObjToRec: tagNMTVDISPINFOEXA;
begin
end;

constructor tagNMTVDISPINFOEXWWrapper.Create(ARecord: tagNMTVDISPINFOEXW);
begin
  inherited Create;
end;

function tagNMTVDISPINFOEXWWrapper.ObjToRec: tagNMTVDISPINFOEXW;
begin
end;
