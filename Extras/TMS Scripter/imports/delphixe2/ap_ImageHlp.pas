...
type
  TatImageHlpLibrary = class(TatScripterLibrary)
    ...
    procedure __ImageGetCertificateHeader(AMachine: TatVirtualMachine);
...
AResult := Integer(ImageHlp.MapFileAndCheckSum(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),Param1,Param2));
...
Param1 := VarToInteger(GetInputArg(1));
Param2 := VarToInteger(GetInputArg(2));
AResult := Integer(ImageHlp.MapFileAndCheckSumA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),Param1,Param2));
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
    SetInputArg(2,Integer(Param2));
  end;
...
Param1 := VarToInteger(GetInputArg(1));
Param2 := VarToInteger(GetInputArg(2));
AResult := Integer(ImageHlp.MapFileAndCheckSumW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),Param1,Param2));
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
    SetInputArg(2,Integer(Param2));
  end;
...
begin
  with AMachine do
  begin
AResult := ImageHlp.SplitSymbols(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(2)))),VarToInteger(GetInputArg(3)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(ImageHlp.FindDebugInfoFile(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(2))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(ImageHlp.FindExecutableImage(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(2))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ImageHlp.BindImage(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(2)))));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := ImageHlp.ReBaseImage(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),GetInputArg(2),GetInputArg(3),GetInputArg(4),VarToInteger(GetInputArg(5)),Param6,Param7,Param8,Param9,VarToInteger(GetInputArg(10)));
    ReturnOutputArg(AResult);
...
begin
  with AMachine do
  begin
AResult := ImageHlp.SearchTreeForFile(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(2)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ImageHlp.MakeSureDirectoryPathExists(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(ImageHlp.UnDecorateSymbolName(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ImageHlp.SymInitialize(VarToInteger(GetInputArg(0)),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),GetInputArg(2));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ImageHlp.SymGetSearchPath(VarToInteger(GetInputArg(0)),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ImageHlp.SymSetSearchPath(VarToInteger(GetInputArg(0)),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(ImageHlp.SymLoadModule(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),PAnsiChar(AnsiString(VarToStr(GetInputArg(2)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(3)))),VarToInteger(GetInputArg(4)),VarToInteger(GetInputArg(5))));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatImageHlpLibrary.__ImageGetCertificateHeader(AMachine: TatVirtualMachine);
  var
  Param2Rec: TObject;
  Param2: TWinCertificate;
  AResult: variant;
begin
  with AMachine do
  begin
Param2Rec := TObject(integer(GetInputArg(2)));
if not Assigned(Param2Rec) or not (Param2Rec is _WIN_CERTIFICATEWrapper) then 
  Param2Rec := _WIN_CERTIFICATEWrapper.Create(Param2);
Param2 := _WIN_CERTIFICATEWrapper(Param2Rec).ObjToRec;
AResult := ImageHlp.ImageGetCertificateHeader(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,integer(_WIN_CERTIFICATEWrapper.Create(Param2)));
  end;
end;
...
begin
  ...
  begin
    DefineMethod('MapFileAndCheckSum',3,tkInteger,nil,__MapFileAndCheckSum,false,0,'Filename: PWideChar; HeaderSum: DWORD; CheckSum: DWORD').SetVarArgs([1,2]);
    DefineMethod('MapFileAndCheckSumA',3,tkInteger,nil,__MapFileAndCheckSumA,false,0,'Filename: PAnsiChar; HeaderSum: DWORD; CheckSum: DWORD').SetVarArgs([1,2]);
    DefineMethod('MapFileAndCheckSumW',3,tkInteger,nil,__MapFileAndCheckSumW,false,0,'Filename: PWideChar; HeaderSum: DWORD; CheckSum: DWORD').SetVarArgs([1,2]);
    DefineMethod('TouchFileTimes',2,tkVariant,nil,__TouchFileTimes,false,0,'FileHandle: THandle; lpSystemTime: TSystemTime');
    DefineMethod('SplitSymbols',4,tkVariant,nil,__SplitSymbols,false,0,'ImageName: LPSTR; SymbolsPath: LPSTR; SymbolFilePath: LPSTR; Flags: DWORD');
    DefineMethod('FindDebugInfoFile',3,tkInteger,nil,__FindDebugInfoFile,false,0,'FileName: LPSTR; SymbolPath: LPSTR; DebugFilePath: LPSTR');
    DefineMethod('FindExecutableImage',3,tkInteger,nil,__FindExecutableImage,false,0,'FileName: LPSTR; SymbolPath: LPSTR; ImageFilePath: LPSTR');
    DefineMethod('BindImage',3,tkVariant,nil,__BindImage,false,0,'ImageName: LPSTR; DllPath: LPSTR; SymbolPath: LPSTR');
    DefineMethod('ReBaseImage',11,tkVariant,nil,__ReBaseImage,false,0,'CurrentImageName: LPSTR; SymbolPath: LPSTR; fReBase: Bool; fRebaseSysfileOk: Bool; fGoingDown: Bool; CheckImageSize: ULONG; OldImageSize: ULONG; OldImageBase: ULONG; NewImageSize: ULONG; NewImageBase: ULONG; TimeStamp: ULONG').SetVarArgs([6,7,8,9]);
    DefineMethod('SearchTreeForFile',3,tkVariant,nil,__SearchTreeForFile,false,0,'RootPath: LPSTR; InputPathName: LPSTR; OutputPathBuffer: LPSTR');
    DefineMethod('MakeSureDirectoryPathExists',1,tkVariant,nil,__MakeSureDirectoryPathExists,false,0,'DirPath: LPCSTR');
    DefineMethod('UnDecorateSymbolName',4,tkInteger,nil,__UnDecorateSymbolName,false,0,'DecoratedName: LPSTR; UnDecoratedName: LPSTR; UndecoratedLength: DWORD; Flags: DWORD');
    DefineMethod('GetTimestampForLoadedLibrary',1,tkInteger,nil,__GetTimestampForLoadedLibrary,false,0,'Module: HMODULE');
    DefineMethod('RemovePrivateCvSymbolic',3,tkVariant,nil,__RemovePrivateCvSymbolic,false,0,'DebugData: PChar; NewDebugData: PChar; NewDebugSize: ULONG').SetVarArgs([1,2]);
    DefineMethod('RemoveRelocations',1,tkNone,nil,__RemoveRelocations,false,0,'ImageName: PChar');
    DefineMethod('SymSetOptions',1,tkInteger,nil,__SymSetOptions,false,0,'SymOptions: DWORD');
    DefineMethod('SymGetOptions',0,tkInteger,nil,__SymGetOptions,false,0,'');
    DefineMethod('SymCleanup',1,tkVariant,nil,__SymCleanup,false,0,'hProcess: THandle');
    DefineMethod('SymGetModuleInfo',3,tkVariant,nil,__SymGetModuleInfo,false,0,'hProcess: THandle; dwAddr: DWORD; ModuleInfo: TImagehlpModule').SetVarArgs([2]);
    DefineMethod('SymGetModuleBase',2,tkInteger,nil,__SymGetModuleBase,false,0,'hProcess: THandle; dwAddr: DWORD');
    DefineMethod('SymInitialize',3,tkVariant,nil,__SymInitialize,false,0,'hProcess: THandle; UserSearchPath: LPSTR; fInvadeProcess: Bool');
    DefineMethod('SymGetSearchPath',3,tkVariant,nil,__SymGetSearchPath,false,0,'hProcess: THandle; SearchPath: LPSTR; SearchPathLength: DWORD');
    DefineMethod('SymSetSearchPath',2,tkVariant,nil,__SymSetSearchPath,false,0,'hProcess: THandle; SearchPath: LPSTR');
    DefineMethod('SymLoadModule',6,tkInteger,nil,__SymLoadModule,false,0,'hProcess: THandle; hFile: THandle; ImageName: LPSTR; ModuleName: LPSTR; BaseOfDll: DWORD; SizeOfDll: DWORD');
    DefineMethod('SymUnloadModule',2,tkVariant,nil,__SymUnloadModule,false,0,'hProcess: THandle; BaseOfDll: DWORD');
    DefineMethod('ImageRemoveCertificate',2,tkVariant,nil,__ImageRemoveCertificate,false,0,'FileHandle: THandle; Index: DWORD');
    DefineMethod('ImageGetCertificateHeader',3,tkVariant,nil,__ImageGetCertificateHeader,false,0,'FileHandle: THandle; CertificateIndex: DWORD; Certificateheader: TWinCertificate').SetVarArgs([2]);
