...
type
  TatRttiLibrary = class(TatScripterLibrary)
    ...
    procedure __TMethodImplementationCreate(AMachine: TatVirtualMachine);
    procedure __TMethodImplementationDestroy(AMachine: TatVirtualMachine);
    procedure __TRttiMethodDestroy(AMachine: TatVirtualMachine);
    ...
    procedure __TVirtualMethodInterceptorDestroy(AMachine: TatVirtualMachine);
    procedure __TVirtualMethodInterceptorProxify(AMachine: TatVirtualMachine);
  ...
  TMethodImplementationClass = class of TMethodImplementation;
  ...
  TVirtualMethodInterceptorClass = class of TVirtualMethodInterceptor;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TRttiObject(CurrentObject).Parent));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TRttiObject(CurrentObject).Package));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TRttiNamedObject(CurrentObject).Name));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(TRttiType(CurrentObject).ToString);
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TRttiType(CurrentObject).GetMethod(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TRttiType(CurrentObject).GetField(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TRttiType(CurrentObject).GetProperty(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TRttiType(CurrentObject).QualifiedName));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TRttiType(CurrentObject).TypeKind));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TRttiType(CurrentObject).BaseType));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TRttiType(CurrentObject).AsInstance));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TRttiType(CurrentObject).AsOrdinal));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TRttiType(CurrentObject).AsRecord));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TRttiType(CurrentObject).AsSet));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TRttiMember(CurrentObject).Parent));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TRttiMember(CurrentObject).Visibility));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(TRttiField(CurrentObject).ToString);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TRttiField(CurrentObject).FieldType));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TRttiManagedField(CurrentObject).FieldType));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TRttiProperty(CurrentObject).PropertyType));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(TRttiInstanceProperty(CurrentObject).ToString);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TRttiInstanceProperty(CurrentObject).PropertyType));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(TRttiParameter(CurrentObject).ToString);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TRttiParameter(CurrentObject).ParamType));
  end;
end;

procedure TatRttiLibrary.__TMethodImplementationCreate(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := ObjectToVar(TMethodImplementationClass(CurrentClass.ClassRef).Create);
    ReturnOutputArg(AResult);
  end;
end;

procedure TatRttiLibrary.__TMethodImplementationDestroy(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TMethodImplementation(CurrentObject).Destroy;
  end;
end;

procedure TatRttiLibrary.__TRttiMethodDestroy(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TRttiMethod(CurrentObject).Destroy;
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(TRttiMethod(CurrentObject).ToString);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TRttiMethod(CurrentObject).ReturnType));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TRttiMethod(CurrentObject).MethodKind));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TRttiMethod(CurrentObject).DispatchKind));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TRttiMethod(CurrentObject).CallingConvention));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TRttiInstanceType(CurrentObject).BaseType));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TRttiInstanceType(CurrentObject).DeclaringUnitName));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TRttiInterfaceType(CurrentObject).BaseType));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TRttiInterfaceType(CurrentObject).DeclaringUnitName));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TRttiOrdinalType(CurrentObject).OrdType));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TRttiMethodType(CurrentObject).MethodKind));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TRttiClassRefType(CurrentObject).InstanceType));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TRttiEnumerationType(CurrentObject).UnderlyingType));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TRttiSetType(CurrentObject).ElementType));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TRttiStringType(CurrentObject).StringKind));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TRttiFloatType(CurrentObject).FloatType));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TRttiArrayType(CurrentObject).ElementType));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TRttiArrayType(CurrentObject).Dimensions[VarToInteger(GetArrayIndex(0))]));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TRttiDynamicArrayType(CurrentObject).ElementType));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TRttiDynamicArrayType(CurrentObject).DeclaringUnitName));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TRttiPointerType(CurrentObject).ReferredType));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TRttiPackage(CurrentObject).FindType(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TRttiPackage(CurrentObject).Handle));
  end;
end;

procedure TatRttiLibrary.__TVirtualMethodInterceptorDestroy(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TVirtualMethodInterceptor(CurrentObject).Destroy;
  end;
end;

procedure TatRttiLibrary.__TVirtualMethodInterceptorProxify(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TVirtualMethodInterceptor(CurrentObject).Proxify(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('GetMethod',1,tkClass,TRttiMethod,__TRttiTypeGetMethod,false,0,'AName: string');
    DefineMethod('GetField',1,tkClass,TRttiField,__TRttiTypeGetField,false,0,'AName: string');
    DefineMethod('GetProperty',1,tkClass,TRttiProperty,__TRttiTypeGetProperty,false,0,'AName: string');
  ...
  With Scripter.DefineClass(TMethodImplementation) do
  begin
    DefineMethod('Create',0,tkClass,TMethodImplementation,__TMethodImplementationCreate,true,0,'');
    DefineMethod('Destroy',0,tkNone,nil,__TMethodImplementationDestroy,false,0,'');
  end;
  With Scripter.DefineClass(TRttiMethod) do
  begin
    DefineMethod('Destroy',0,tkNone,nil,__TRttiMethodDestroy,false,0,'');
  ...
  begin
    ...
    DefineMethod('FindType',1,tkClass,TRttiType,__TRttiPackageFindType,false,0,'AQualifiedName: string');
    DefineProp('Handle',tkInteger,__GetTRttiPackageHandle,nil,nil,false,0);
  end;
  With Scripter.DefineClass(TVirtualMethodInterceptor) do
  begin
    DefineMethod('Destroy',0,tkNone,nil,__TVirtualMethodInterceptorDestroy,false,0,'');
    DefineMethod('Proxify',1,tkNone,nil,__TVirtualMethodInterceptorProxify,false,0,'AInstance: TObject');
  end;
