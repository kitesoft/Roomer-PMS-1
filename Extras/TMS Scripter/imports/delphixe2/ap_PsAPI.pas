...
AResult := Integer(PsAPI.GetModuleBaseName(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)),VarToInteger(GetInputArg(3))));
...
begin
  with AMachine do
  begin
AResult := Integer(PsAPI.GetModuleBaseNameA(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),PAnsiChar(AnsiString(VarToStr(GetInputArg(2)))),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
AResult := Integer(PsAPI.GetModuleBaseNameW(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
AResult := Integer(PsAPI.GetModuleFileNameEx(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(PsAPI.GetModuleFileNameExA(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),PAnsiChar(AnsiString(VarToStr(GetInputArg(2)))),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
AResult := Integer(PsAPI.GetModuleFileNameExW(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    DefineMethod('GetModuleBaseName',4,tkInteger,nil,__GetModuleBaseName,false,0,'hProcess: THandle; hModule: HMODULE; lpBaseName: PWideChar; nSize: DWORD');
    DefineMethod('GetModuleBaseNameA',4,tkInteger,nil,__GetModuleBaseNameA,false,0,'hProcess: THandle; hModule: HMODULE; lpBaseName: PAnsiChar; nSize: DWORD');
    DefineMethod('GetModuleBaseNameW',4,tkInteger,nil,__GetModuleBaseNameW,false,0,'hProcess: THandle; hModule: HMODULE; lpBaseName: PWideChar; nSize: DWORD');
    DefineMethod('GetModuleFileNameEx',4,tkInteger,nil,__GetModuleFileNameEx,false,0,'hProcess: THandle; hModule: HMODULE; lpFilename: PWideChar; nSize: DWORD');
    DefineMethod('GetModuleFileNameExA',4,tkInteger,nil,__GetModuleFileNameExA,false,0,'hProcess: THandle; hModule: HMODULE; lpFilename: PAnsiChar; nSize: DWORD');
    DefineMethod('GetModuleFileNameExW',4,tkInteger,nil,__GetModuleFileNameExW,false,0,'hProcess: THandle; hModule: HMODULE; lpFilename: PWideChar; nSize: DWORD');
    DefineMethod('EmptyWorkingSet',1,tkVariant,nil,__EmptyWorkingSet,false,0,'hProcess: THandle');
    DefineMethod('InitializeProcessForWsWatch',1,tkVariant,nil,__InitializeProcessForWsWatch,false,0,'hProcess: THandle');
  end;
end;
