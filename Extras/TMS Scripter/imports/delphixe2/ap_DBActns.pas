...
begin
  with AMachine do
  begin
AResult := TDataSetAction(CurrentObject).HandlesTarget(TObject(VarToObject(GetInputArg(0))));
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TDataSetAction(CurrentObject).DataSource));
  end;
end;
...
begin
  with AMachine do
  begin
    TDataSetAction(CurrentObject).DataSource:=TDataSource(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    TDataSetFirst(CurrentObject).ExecuteTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TDataSetFirst(CurrentObject).UpdateTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TDataSetPrior(CurrentObject).ExecuteTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TDataSetPrior(CurrentObject).UpdateTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TDataSetNext(CurrentObject).ExecuteTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TDataSetNext(CurrentObject).UpdateTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TDataSetLast(CurrentObject).ExecuteTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TDataSetLast(CurrentObject).UpdateTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TDataSetInsert(CurrentObject).ExecuteTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TDataSetInsert(CurrentObject).UpdateTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TDataSetDelete(CurrentObject).ExecuteTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TDataSetDelete(CurrentObject).UpdateTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TDataSetEdit(CurrentObject).ExecuteTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TDataSetEdit(CurrentObject).UpdateTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TDataSetPost(CurrentObject).ExecuteTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TDataSetPost(CurrentObject).UpdateTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TDataSetCancel(CurrentObject).ExecuteTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TDataSetCancel(CurrentObject).UpdateTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TDataSetRefresh(CurrentObject).ExecuteTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TDataSetRefresh(CurrentObject).UpdateTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  ...
  begin
    DefineMethod('HandlesTarget',1,tkVariant,nil,__TDataSetActionHandlesTarget,false,0,'Target: TObject');
  ...
  begin
    DefineMethod('ExecuteTarget',1,tkNone,nil,__TDataSetFirstExecuteTarget,false,0,'Target: TObject');
    DefineMethod('UpdateTarget',1,tkNone,nil,__TDataSetFirstUpdateTarget,false,0,'Target: TObject');
  end;
  With Scripter.DefineClass(TDataSetPrior) do
  begin
    DefineMethod('ExecuteTarget',1,tkNone,nil,__TDataSetPriorExecuteTarget,false,0,'Target: TObject');
    DefineMethod('UpdateTarget',1,tkNone,nil,__TDataSetPriorUpdateTarget,false,0,'Target: TObject');
  end;
  With Scripter.DefineClass(TDataSetNext) do
  begin
    DefineMethod('ExecuteTarget',1,tkNone,nil,__TDataSetNextExecuteTarget,false,0,'Target: TObject');
    DefineMethod('UpdateTarget',1,tkNone,nil,__TDataSetNextUpdateTarget,false,0,'Target: TObject');
  end;
  With Scripter.DefineClass(TDataSetLast) do
  begin
    DefineMethod('ExecuteTarget',1,tkNone,nil,__TDataSetLastExecuteTarget,false,0,'Target: TObject');
    DefineMethod('UpdateTarget',1,tkNone,nil,__TDataSetLastUpdateTarget,false,0,'Target: TObject');
  end;
  With Scripter.DefineClass(TDataSetInsert) do
  begin
    DefineMethod('ExecuteTarget',1,tkNone,nil,__TDataSetInsertExecuteTarget,false,0,'Target: TObject');
    DefineMethod('UpdateTarget',1,tkNone,nil,__TDataSetInsertUpdateTarget,false,0,'Target: TObject');
  end;
  With Scripter.DefineClass(TDataSetDelete) do
  begin
    DefineMethod('ExecuteTarget',1,tkNone,nil,__TDataSetDeleteExecuteTarget,false,0,'Target: TObject');
    DefineMethod('UpdateTarget',1,tkNone,nil,__TDataSetDeleteUpdateTarget,false,0,'Target: TObject');
  end;
  With Scripter.DefineClass(TDataSetEdit) do
  begin
    DefineMethod('ExecuteTarget',1,tkNone,nil,__TDataSetEditExecuteTarget,false,0,'Target: TObject');
    DefineMethod('UpdateTarget',1,tkNone,nil,__TDataSetEditUpdateTarget,false,0,'Target: TObject');
  end;
  With Scripter.DefineClass(TDataSetPost) do
  begin
    DefineMethod('ExecuteTarget',1,tkNone,nil,__TDataSetPostExecuteTarget,false,0,'Target: TObject');
    DefineMethod('UpdateTarget',1,tkNone,nil,__TDataSetPostUpdateTarget,false,0,'Target: TObject');
  end;
  With Scripter.DefineClass(TDataSetCancel) do
  begin
    DefineMethod('ExecuteTarget',1,tkNone,nil,__TDataSetCancelExecuteTarget,false,0,'Target: TObject');
    DefineMethod('UpdateTarget',1,tkNone,nil,__TDataSetCancelUpdateTarget,false,0,'Target: TObject');
  end;
  With Scripter.DefineClass(TDataSetRefresh) do
  begin
    DefineMethod('ExecuteTarget',1,tkNone,nil,__TDataSetRefreshExecuteTarget,false,0,'Target: TObject');
    DefineMethod('UpdateTarget',1,tkNone,nil,__TDataSetRefreshUpdateTarget,false,0,'Target: TObject');
  end;
