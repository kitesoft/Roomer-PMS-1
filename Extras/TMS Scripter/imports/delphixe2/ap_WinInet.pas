...
begin
  with AMachine do
  begin
AResult := WinInet.InternetTimeFromSystemTime(_SYSTEMTIMEWrapper(integer(GetInputArg(0))).ObjToRec,VarToInteger(GetInputArg(1)),PAnsiChar(AnsiString(VarToStr(GetInputArg(2)))),VarToInteger(GetInputArg(3)));
...
AResult := WinInet.InternetCrackUrl(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),Param3);
    ReturnOutputArg(AResult);
...
if not Assigned(Param3Rec) or not (Param3Rec is URL_COMPONENTSWrapper) then 
  Param3Rec := URL_COMPONENTSWrapper.Create(Param3);
Param3 := URL_COMPONENTSWrapper(Param3Rec).ObjToRec;
AResult := WinInet.InternetCrackUrlA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),Param3);
    ReturnOutputArg(AResult);
    SetInputArg(3,integer(URL_COMPONENTSWrapper.Create(Param3)));
  end;
end;
...
if not Assigned(Param3Rec) or not (Param3Rec is URL_COMPONENTSWrapper) then 
  Param3Rec := URL_COMPONENTSWrapper.Create(Param3);
Param3 := URL_COMPONENTSWrapper(Param3Rec).ObjToRec;
AResult := WinInet.InternetCrackUrlW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),Param3);
    ReturnOutputArg(AResult);
    SetInputArg(3,integer(URL_COMPONENTSWrapper.Create(Param3)));
  end;
end;
...
AResult := WinInet.InternetCreateUrl(Param0,VarToInteger(GetInputArg(1)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)),Param3);
    ReturnOutputArg(AResult);
...
Param0 := URL_COMPONENTSWrapper(Param0Rec).ObjToRec;
Param3 := VarToInteger(GetInputArg(3));
AResult := WinInet.InternetCreateUrlA(Param0,VarToInteger(GetInputArg(1)),PAnsiChar(AnsiString(VarToStr(GetInputArg(2)))),Param3);
    ReturnOutputArg(AResult);
    SetInputArg(0,integer(URL_COMPONENTSWrapper.Create(Param0)));
    SetInputArg(3,Integer(Param3));
  end;
...
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
Param3 := VarToInteger(GetInputArg(3));
AResult := WinInet.InternetCreateUrlW(Param0,VarToInteger(GetInputArg(1)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)),Param3);
    ReturnOutputArg(AResult);
    SetInputArg(0,integer(URL_COMPONENTSWrapper.Create(Param0)));
    SetInputArg(3,Integer(Param3));
  end;
...
AResult := WinInet.InternetCanonicalizeUrl(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),Param2,VarToInteger(GetInputArg(3)));
    ReturnOutputArg(AResult);
...
begin
  ...
  begin
Param2 := VarToInteger(GetInputArg(2));
AResult := WinInet.InternetCanonicalizeUrlA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),Param2,VarToInteger(GetInputArg(3)));
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
  end;
end;
...
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
Param2 := VarToInteger(GetInputArg(2));
AResult := WinInet.InternetCanonicalizeUrlW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),Param2,VarToInteger(GetInputArg(3)));
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
  end;
end;
...
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
Param3 := VarToInteger(GetInputArg(3));
AResult := WinInet.InternetCombineUrl(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)),Param3,VarToInteger(GetInputArg(4)));
    ReturnOutputArg(AResult);
    SetInputArg(3,Integer(Param3));
  end;
end;
...
begin
  ...
  begin
Param3 := VarToInteger(GetInputArg(3));
AResult := WinInet.InternetCombineUrlA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(2)))),Param3,VarToInteger(GetInputArg(4)));
    ReturnOutputArg(AResult);
    SetInputArg(3,Integer(Param3));
  end;
end;
...
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
Param3 := VarToInteger(GetInputArg(3));
AResult := WinInet.InternetCombineUrlW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)),Param3,VarToInteger(GetInputArg(4)));
    ReturnOutputArg(AResult);
    SetInputArg(3,Integer(Param3));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := WinInet.InternetUnlockRequestFile(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
Param2 := VarToInteger(GetInputArg(2));
AResult := WinInet.InternetGetLastResponseInfo(Param0,StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),Param2);
    ReturnOutputArg(AResult);
...
Param0 := VarToInteger(GetInputArg(0));
Param2 := VarToInteger(GetInputArg(2));
AResult := WinInet.InternetGetLastResponseInfoA(Param0,PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
    SetInputArg(2,Integer(Param2));
  end;
...
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
Param2 := VarToInteger(GetInputArg(2));
AResult := WinInet.InternetGetLastResponseInfoW(Param0,StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
    SetInputArg(2,Integer(Param2));
  end;
...
SetLength(Param5Buf, Length(VarToStr(GetInputArg(5))) + 1);
Param6 := VarToInteger(GetInputArg(6));
AResult := WinInet.GopherCreateLocator(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)),StringToWideChar(VarToStr(GetInputArg(3)),@Param3Buf[0],Length(Param3Buf)),VarToInteger(GetInputArg(4)),StringToWideChar(VarToStr(GetInputArg(5)),@Param5Buf[0],Length(Param5Buf)),Param6);
    ReturnOutputArg(AResult);
...
begin
  ...
  begin
Param6 := VarToInteger(GetInputArg(6));
AResult := WinInet.GopherCreateLocatorA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),VarToInteger(GetInputArg(1)),PAnsiChar(AnsiString(VarToStr(GetInputArg(2)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(3)))),VarToInteger(GetInputArg(4)),PAnsiChar(AnsiString(VarToStr(GetInputArg(5)))),Param6);
    ReturnOutputArg(AResult);
    SetInputArg(6,Integer(Param6));
  end;
end;
...
SetLength(Param5Buf, Length(VarToStr(GetInputArg(5))) + 1);
Param6 := VarToInteger(GetInputArg(6));
AResult := WinInet.GopherCreateLocatorW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)),StringToWideChar(VarToStr(GetInputArg(3)),@Param3Buf[0],Length(Param3Buf)),VarToInteger(GetInputArg(4)),StringToWideChar(VarToStr(GetInputArg(5)),@Param5Buf[0],Length(Param5Buf)),Param6);
    ReturnOutputArg(AResult);
    SetInputArg(6,Integer(Param6));
  end;
end;
...
AResult := WinInet.GopherGetLocatorType(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),Param1);
    ReturnOutputArg(AResult);
...
begin
  ...
  begin
Param1 := VarToInteger(GetInputArg(1));
AResult := WinInet.GopherGetLocatorTypeA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
Param1 := VarToInteger(GetInputArg(1));
AResult := WinInet.GopherGetLocatorTypeW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
AResult := WinInet.InternetSetCookie(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := WinInet.InternetSetCookieA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(2)))));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
AResult := WinInet.InternetSetCookieW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
Param3 := VarToInteger(GetInputArg(3));
AResult := WinInet.InternetGetCookie(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)),Param3);
    ReturnOutputArg(AResult);
    SetInputArg(3,Integer(Param3));
  end;
end;
...
begin
  ...
  begin
Param3 := VarToInteger(GetInputArg(3));
AResult := WinInet.InternetGetCookieA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(2)))),Param3);
    ReturnOutputArg(AResult);
    SetInputArg(3,Integer(Param3));
  end;
end;
...
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
Param3 := VarToInteger(GetInputArg(3));
AResult := WinInet.InternetGetCookieW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)),Param3);
    ReturnOutputArg(AResult);
    SetInputArg(3,Integer(Param3));
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := WinInet.InternetCheckConnection(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := WinInet.InternetCheckConnectionA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := WinInet.InternetCheckConnectionW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(WinInet.InternetConfirmZoneCrossing(VarToInteger(GetInputArg(0)),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(2)))),GetInputArg(3)));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
SetLength(Param3Buf, Length(VarToStr(GetInputArg(3))) + 1);
AResult := WinInet.CreateUrlCacheEntry(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)),StringToWideChar(VarToStr(GetInputArg(3)),@Param3Buf[0],Length(Param3Buf)),VarToInteger(GetInputArg(4)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := WinInet.CreateUrlCacheEntryA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),VarToInteger(GetInputArg(1)),PAnsiChar(AnsiString(VarToStr(GetInputArg(2)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(3)))),VarToInteger(GetInputArg(4)));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
SetLength(Param3Buf, Length(VarToStr(GetInputArg(3))) + 1);
AResult := WinInet.CreateUrlCacheEntryW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)),StringToWideChar(VarToStr(GetInputArg(3)),@Param3Buf[0],Length(Param3Buf)),VarToInteger(GetInputArg(4)));
    ReturnOutputArg(AResult);
  end;
end;
...
Param2 := VarToInteger(GetInputArg(2));
AResult := WinInet.RetrieveUrlCacheEntryFile(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),Param1,Param2,VarToInteger(GetInputArg(3)));
    ReturnOutputArg(AResult);
...
Param1 := INTERNET_CACHE_ENTRY_INFOWWrapper(Param1Rec).ObjToRec;
Param2 := VarToInteger(GetInputArg(2));
AResult := WinInet.RetrieveUrlCacheEntryFileA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),Param1,Param2,VarToInteger(GetInputArg(3)));
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(INTERNET_CACHE_ENTRY_INFOWWrapper.Create(Param1)));
    SetInputArg(2,Integer(Param2));
  end;
...
Param1 := INTERNET_CACHE_ENTRY_INFOWWrapper(Param1Rec).ObjToRec;
Param2 := VarToInteger(GetInputArg(2));
AResult := WinInet.RetrieveUrlCacheEntryFileW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),Param1,Param2,VarToInteger(GetInputArg(3)));
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(INTERNET_CACHE_ENTRY_INFOWWrapper.Create(Param1)));
    SetInputArg(2,Integer(Param2));
  end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := WinInet.UnlockUrlCacheEntryFile(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := WinInet.UnlockUrlCacheEntryFileA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),VarToInteger(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := WinInet.UnlockUrlCacheEntryFileW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
Param1 := INTERNET_CACHE_ENTRY_INFOWWrapper(Param1Rec).ObjToRec;
Param2 := VarToInteger(GetInputArg(2));
AResult := Integer(WinInet.RetrieveUrlCacheEntryStream(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),Param1,Param2,GetInputArg(3),VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(INTERNET_CACHE_ENTRY_INFOWWrapper.Create(Param1)));
    SetInputArg(2,Integer(Param2));
  end;
...
Param1 := INTERNET_CACHE_ENTRY_INFOWWrapper(Param1Rec).ObjToRec;
Param2 := VarToInteger(GetInputArg(2));
AResult := Integer(WinInet.RetrieveUrlCacheEntryStreamA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),Param1,Param2,GetInputArg(3),VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(INTERNET_CACHE_ENTRY_INFOWWrapper.Create(Param1)));
    SetInputArg(2,Integer(Param2));
  end;
...
Param1 := INTERNET_CACHE_ENTRY_INFOWWrapper(Param1Rec).ObjToRec;
Param2 := VarToInteger(GetInputArg(2));
AResult := Integer(WinInet.RetrieveUrlCacheEntryStreamW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),Param1,Param2,GetInputArg(3),VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(INTERNET_CACHE_ENTRY_INFOWWrapper.Create(Param1)));
    SetInputArg(2,Integer(Param2));
  end;
...
begin
  with AMachine do
  begin
AResult := WinInet.UnlockUrlCacheEntryStream(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
Param1 := INTERNET_CACHE_ENTRY_INFOWWrapper(Param1Rec).ObjToRec;
Param2 := VarToInteger(GetInputArg(2));
AResult := WinInet.GetUrlCacheEntryInfo(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),Param1,Param2);
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(INTERNET_CACHE_ENTRY_INFOWWrapper.Create(Param1)));
    SetInputArg(2,Integer(Param2));
  end;
...
Param1 := INTERNET_CACHE_ENTRY_INFOWWrapper(Param1Rec).ObjToRec;
Param2 := VarToInteger(GetInputArg(2));
AResult := WinInet.GetUrlCacheEntryInfoA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),Param1,Param2);
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(INTERNET_CACHE_ENTRY_INFOWWrapper.Create(Param1)));
    SetInputArg(2,Integer(Param2));
  end;
...
Param1 := INTERNET_CACHE_ENTRY_INFOWWrapper(Param1Rec).ObjToRec;
Param2 := VarToInteger(GetInputArg(2));
AResult := WinInet.GetUrlCacheEntryInfoW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),Param1,Param2);
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(INTERNET_CACHE_ENTRY_INFOWWrapper.Create(Param1)));
    SetInputArg(2,Integer(Param2));
  end;
...
if not Assigned(Param1Rec) or not (Param1Rec is INTERNET_CACHE_ENTRY_INFOWWrapper) then 
  Param1Rec := INTERNET_CACHE_ENTRY_INFOWWrapper.Create(Param1);
Param1 := INTERNET_CACHE_ENTRY_INFOWWrapper(Param1Rec).ObjToRec;
AResult := WinInet.SetUrlCacheEntryInfo(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),Param1,VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(INTERNET_CACHE_ENTRY_INFOWWrapper.Create(Param1)));
  end;
end;
...
if not Assigned(Param1Rec) or not (Param1Rec is INTERNET_CACHE_ENTRY_INFOWWrapper) then 
  Param1Rec := INTERNET_CACHE_ENTRY_INFOWWrapper.Create(Param1);
Param1 := INTERNET_CACHE_ENTRY_INFOWWrapper(Param1Rec).ObjToRec;
AResult := WinInet.SetUrlCacheEntryInfoA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),Param1,VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(INTERNET_CACHE_ENTRY_INFOWWrapper.Create(Param1)));
  end;
end;
...
if not Assigned(Param1Rec) or not (Param1Rec is INTERNET_CACHE_ENTRY_INFOWWrapper) then 
  Param1Rec := INTERNET_CACHE_ENTRY_INFOWWrapper.Create(Param1);
Param1 := INTERNET_CACHE_ENTRY_INFOWWrapper(Param1Rec).ObjToRec;
AResult := WinInet.SetUrlCacheEntryInfoW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),Param1,VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(INTERNET_CACHE_ENTRY_INFOWWrapper.Create(Param1)));
  end;
end;
...
Param1 := INTERNET_CACHE_ENTRY_INFOWWrapper(Param1Rec).ObjToRec;
Param2 := VarToInteger(GetInputArg(2));
AResult := Integer(WinInet.FindFirstUrlCacheEntry(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),Param1,Param2));
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(INTERNET_CACHE_ENTRY_INFOWWrapper.Create(Param1)));
    SetInputArg(2,Integer(Param2));
  end;
...
Param2 := VarToInteger(GetInputArg(2));
AResult := Integer(WinInet.FindFirstUrlCacheEntryA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),Param1,Param2));
    ReturnOutputArg(AResult);
...
Param1 := INTERNET_CACHE_ENTRY_INFOWWrapper(Param1Rec).ObjToRec;
Param2 := VarToInteger(GetInputArg(2));
AResult := Integer(WinInet.FindFirstUrlCacheEntryW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),Param1,Param2));
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(INTERNET_CACHE_ENTRY_INFOWWrapper.Create(Param1)));
    SetInputArg(2,Integer(Param2));
  end;
...
Param1 := INTERNET_CACHE_ENTRY_INFOWWrapper(Param1Rec).ObjToRec;
Param2 := VarToInteger(GetInputArg(2));
AResult := WinInet.FindNextUrlCacheEntry(VarToInteger(GetInputArg(0)),Param1,Param2);
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(INTERNET_CACHE_ENTRY_INFOWWrapper.Create(Param1)));
    SetInputArg(2,Integer(Param2));
  end;
...
Param1 := INTERNET_CACHE_ENTRY_INFOAWrapper(Param1Rec).ObjToRec;
Param2 := VarToInteger(GetInputArg(2));
AResult := WinInet.FindNextUrlCacheEntryA(VarToInteger(GetInputArg(0)),Param1,Param2);
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(INTERNET_CACHE_ENTRY_INFOAWrapper.Create(Param1)));
    SetInputArg(2,Integer(Param2));
  end;
...
Param1 := INTERNET_CACHE_ENTRY_INFOWWrapper(Param1Rec).ObjToRec;
Param2 := VarToInteger(GetInputArg(2));
AResult := WinInet.FindNextUrlCacheEntryW(VarToInteger(GetInputArg(0)),Param1,Param2);
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(INTERNET_CACHE_ENTRY_INFOWWrapper.Create(Param1)));
    SetInputArg(2,Integer(Param2));
  end;
...
begin
  with AMachine do
  begin
AResult := WinInet.FindCloseUrlCache(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := WinInet.DeleteUrlCacheEntry(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := WinInet.DeleteUrlCacheEntryA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := WinInet.DeleteUrlCacheEntryW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := WinInet.InternetGoOnline(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := WinInet.InternetSetDialState(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  With Scripter.DefineClass(ClassType) do
  begin
    DefineMethod('InternetTimeFromSystemTime',4,tkVariant,nil,__InternetTimeFromSystemTime,false,0,'pst: TSystemTime; dwRFC: DWORD; lpszTime: LPSTR; cbTime: DWORD');
    DefineMethod('InternetCrackUrl',4,tkVariant,nil,__InternetCrackUrl,false,0,'lpszUrl: PWideChar; dwUrlLength: DWORD; dwFlags: DWORD; lpUrlComponents: TURLComponents').SetVarArgs([3]);
    DefineMethod('InternetCrackUrlA',4,tkVariant,nil,__InternetCrackUrlA,false,0,'lpszUrl: PAnsiChar; dwUrlLength: DWORD; dwFlags: DWORD; lpUrlComponents: TURLComponents').SetVarArgs([3]);
    DefineMethod('InternetCrackUrlW',4,tkVariant,nil,__InternetCrackUrlW,false,0,'lpszUrl: PWideChar; dwUrlLength: DWORD; dwFlags: DWORD; lpUrlComponents: TURLComponents').SetVarArgs([3]);
    DefineMethod('InternetCreateUrl',4,tkVariant,nil,__InternetCreateUrl,false,0,'lpUrlComponents: TURLComponents; dwFlags: DWORD; lpszUrl: PWideChar; dwUrlLength: DWORD').SetVarArgs([0,3]);
    DefineMethod('InternetCreateUrlA',4,tkVariant,nil,__InternetCreateUrlA,false,0,'lpUrlComponents: TURLComponents; dwFlags: DWORD; lpszUrl: PAnsiChar; dwUrlLength: DWORD').SetVarArgs([0,3]);
    DefineMethod('InternetCreateUrlW',4,tkVariant,nil,__InternetCreateUrlW,false,0,'lpUrlComponents: TURLComponents; dwFlags: DWORD; lpszUrl: PWideChar; dwUrlLength: DWORD').SetVarArgs([0,3]);
    DefineMethod('InternetCanonicalizeUrl',4,tkVariant,nil,__InternetCanonicalizeUrl,false,0,'lpszUrl: PWideChar; lpszBuffer: PWideChar; lpdwBufferLength: DWORD; dwFlags: DWORD').SetVarArgs([2]);
    DefineMethod('InternetCanonicalizeUrlA',4,tkVariant,nil,__InternetCanonicalizeUrlA,false,0,'lpszUrl: PAnsiChar; lpszBuffer: PAnsiChar; lpdwBufferLength: DWORD; dwFlags: DWORD').SetVarArgs([2]);
    DefineMethod('InternetCanonicalizeUrlW',4,tkVariant,nil,__InternetCanonicalizeUrlW,false,0,'lpszUrl: PWideChar; lpszBuffer: PWideChar; lpdwBufferLength: DWORD; dwFlags: DWORD').SetVarArgs([2]);
    DefineMethod('InternetCombineUrl',5,tkVariant,nil,__InternetCombineUrl,false,0,'lpszBaseUrl: PWideChar; lpszRelativeUrl: PWideChar; lpszBuffer: PWideChar; lpdwBufferLength: DWORD; dwFlags: DWORD').SetVarArgs([3]);
    DefineMethod('InternetCombineUrlA',5,tkVariant,nil,__InternetCombineUrlA,false,0,'lpszBaseUrl: PAnsiChar; lpszRelativeUrl: PAnsiChar; lpszBuffer: PAnsiChar; lpdwBufferLength: DWORD; dwFlags: DWORD').SetVarArgs([3]);
    DefineMethod('InternetCombineUrlW',5,tkVariant,nil,__InternetCombineUrlW,false,0,'lpszBaseUrl: PWideChar; lpszRelativeUrl: PWideChar; lpszBuffer: PWideChar; lpdwBufferLength: DWORD; dwFlags: DWORD').SetVarArgs([3]);
    DefineMethod('InternetUnlockRequestFile',1,tkVariant,nil,__InternetUnlockRequestFile,false,0,'hLockRequestInfo: THANDLE');
    DefineMethod('InternetGetLastResponseInfo',3,tkVariant,nil,__InternetGetLastResponseInfo,false,0,'lpdwError: DWORD; lpszBuffer: PWideChar; lpdwBufferLength: DWORD').SetVarArgs([0,2]);
    DefineMethod('InternetGetLastResponseInfoA',3,tkVariant,nil,__InternetGetLastResponseInfoA,false,0,'lpdwError: DWORD; lpszBuffer: PAnsiChar; lpdwBufferLength: DWORD').SetVarArgs([0,2]);
    DefineMethod('InternetGetLastResponseInfoW',3,tkVariant,nil,__InternetGetLastResponseInfoW,false,0,'lpdwError: DWORD; lpszBuffer: PWideChar; lpdwBufferLength: DWORD').SetVarArgs([0,2]);
    DefineMethod('IS_GOPHER_FILE',1,tkVariant,nil,__IS_GOPHER_FILE,false,0,'GopherType: DWORD');
    DefineMethod('IS_GOPHER_DIRECTORY',1,tkVariant,nil,__IS_GOPHER_DIRECTORY,false,0,'GopherType: DWORD');
    DefineMethod('IS_GOPHER_PHONE_SERVER',1,tkVariant,nil,__IS_GOPHER_PHONE_SERVER,false,0,'GopherType: DWORD');
    DefineMethod('IS_GOPHER_ERROR',1,tkVariant,nil,__IS_GOPHER_ERROR,false,0,'GopherType: DWORD');
    DefineMethod('IS_GOPHER_INDEX_SERVER',1,tkVariant,nil,__IS_GOPHER_INDEX_SERVER,false,0,'GopherType: DWORD');
    DefineMethod('IS_GOPHER_TELNET_SESSION',1,tkVariant,nil,__IS_GOPHER_TELNET_SESSION,false,0,'GopherType: DWORD');
    DefineMethod('IS_GOPHER_BACKUP_SERVER',1,tkVariant,nil,__IS_GOPHER_BACKUP_SERVER,false,0,'GopherType: DWORD');
    DefineMethod('IS_GOPHER_TN3270_SESSION',1,tkVariant,nil,__IS_GOPHER_TN3270_SESSION,false,0,'GopherType: DWORD');
    DefineMethod('IS_GOPHER_ASK',1,tkVariant,nil,__IS_GOPHER_ASK,false,0,'GopherType: DWORD');
    DefineMethod('IS_GOPHER_PLUS',1,tkVariant,nil,__IS_GOPHER_PLUS,false,0,'GopherType: DWORD');
    DefineMethod('IS_GOPHER_TYPE_KNOWN',1,tkVariant,nil,__IS_GOPHER_TYPE_KNOWN,false,0,'GopherType: DWORD');
    DefineMethod('GopherCreateLocator',7,tkVariant,nil,__GopherCreateLocator,false,0,'lpszHost: PWideChar; nServerPort: INTERNET_PORT; lpszDisplayString: PWideChar; lpszSelectorString: PWideChar; dwGopherType: DWORD; lpszLocator: PWideChar; lpdwBufferLength: DWORD').SetVarArgs([6]);
    DefineMethod('GopherCreateLocatorA',7,tkVariant,nil,__GopherCreateLocatorA,false,0,'lpszHost: PAnsiChar; nServerPort: INTERNET_PORT; lpszDisplayString: PAnsiChar; lpszSelectorString: PAnsiChar; dwGopherType: DWORD; lpszLocator: PAnsiChar; lpdwBufferLength: DWORD').SetVarArgs([6]);
    DefineMethod('GopherCreateLocatorW',7,tkVariant,nil,__GopherCreateLocatorW,false,0,'lpszHost: PWideChar; nServerPort: INTERNET_PORT; lpszDisplayString: PWideChar; lpszSelectorString: PWideChar; dwGopherType: DWORD; lpszLocator: PWideChar; lpdwBufferLength: DWORD').SetVarArgs([6]);
    DefineMethod('GopherGetLocatorType',2,tkVariant,nil,__GopherGetLocatorType,false,0,'lpszLocator: PWideChar; lpdwGopherType: DWORD').SetVarArgs([1]);
    DefineMethod('GopherGetLocatorTypeA',2,tkVariant,nil,__GopherGetLocatorTypeA,false,0,'lpszLocator: PAnsiChar; lpdwGopherType: DWORD').SetVarArgs([1]);
    DefineMethod('GopherGetLocatorTypeW',2,tkVariant,nil,__GopherGetLocatorTypeW,false,0,'lpszLocator: PWideChar; lpdwGopherType: DWORD').SetVarArgs([1]);
    DefineMethod('InternetSetCookie',3,tkVariant,nil,__InternetSetCookie,false,0,'lpszUrl: PWideChar; lpszCookieName: PWideChar; lpszCookieData: PWideChar');
    DefineMethod('InternetSetCookieA',3,tkVariant,nil,__InternetSetCookieA,false,0,'lpszUrl: PAnsiChar; lpszCookieName: PAnsiChar; lpszCookieData: PAnsiChar');
    DefineMethod('InternetSetCookieW',3,tkVariant,nil,__InternetSetCookieW,false,0,'lpszUrl: PWideChar; lpszCookieName: PWideChar; lpszCookieData: PWideChar');
    DefineMethod('InternetGetCookie',4,tkVariant,nil,__InternetGetCookie,false,0,'lpszUrl: PWideChar; lpszCookieName: PWideChar; lpszCookieData: PWideChar; lpdwSize: DWORD').SetVarArgs([3]);
    DefineMethod('InternetGetCookieA',4,tkVariant,nil,__InternetGetCookieA,false,0,'lpszUrl: PAnsiChar; lpszCookieName: PAnsiChar; lpszCookieData: PAnsiChar; lpdwSize: DWORD').SetVarArgs([3]);
    DefineMethod('InternetGetCookieW',4,tkVariant,nil,__InternetGetCookieW,false,0,'lpszUrl: PWideChar; lpszCookieName: PWideChar; lpszCookieData: PWideChar; lpdwSize: DWORD').SetVarArgs([3]);
    DefineMethod('InternetAttemptConnect',1,tkInteger,nil,__InternetAttemptConnect,false,0,'dwReserved: DWORD');
    DefineMethod('InternetCheckConnection',3,tkVariant,nil,__InternetCheckConnection,false,0,'lpszUrl: PWideChar; dwFlags: DWORD; dwReserved: DWORD');
    DefineMethod('InternetCheckConnectionA',3,tkVariant,nil,__InternetCheckConnectionA,false,0,'lpszUrl: PAnsiChar; dwFlags: DWORD; dwReserved: DWORD');
    DefineMethod('InternetCheckConnectionW',3,tkVariant,nil,__InternetCheckConnectionW,false,0,'lpszUrl: PWideChar; dwFlags: DWORD; dwReserved: DWORD');
    DefineMethod('InternetConfirmZoneCrossing',4,tkInteger,nil,__InternetConfirmZoneCrossing,false,0,'hWnd: HWND; szUrlPrev: LPSTR; szUrlNew: LPSTR; bPost: BOOL');
    DefineMethod('CreateUrlCacheEntry',5,tkVariant,nil,__CreateUrlCacheEntry,false,0,'lpszUrlName: PWideChar; dwExpectedFileSize: DWORD; lpszFileExtension: PWideChar; lpszFileName: PWideChar; dwReserved: DWORD');
    DefineMethod('CreateUrlCacheEntryA',5,tkVariant,nil,__CreateUrlCacheEntryA,false,0,'lpszUrlName: PAnsiChar; dwExpectedFileSize: DWORD; lpszFileExtension: PAnsiChar; lpszFileName: PAnsiChar; dwReserved: DWORD');
    DefineMethod('CreateUrlCacheEntryW',5,tkVariant,nil,__CreateUrlCacheEntryW,false,0,'lpszUrlName: PWideChar; dwExpectedFileSize: DWORD; lpszFileExtension: PWideChar; lpszFileName: PWideChar; dwReserved: DWORD');
    DefineMethod('RetrieveUrlCacheEntryFile',4,tkVariant,nil,__RetrieveUrlCacheEntryFile,false,0,'lpszUrlName: PWideChar; lpCacheEntryInfo: TInternetCacheEntryInfo; lpdwCacheEntryInfoBufferSize: DWORD; dwReserved: DWORD').SetVarArgs([1,2]);
    DefineMethod('RetrieveUrlCacheEntryFileA',4,tkVariant,nil,__RetrieveUrlCacheEntryFileA,false,0,'lpszUrlName: PAnsiChar; lpCacheEntryInfo: TInternetCacheEntryInfo; lpdwCacheEntryInfoBufferSize: DWORD; dwReserved: DWORD').SetVarArgs([1,2]);
    DefineMethod('RetrieveUrlCacheEntryFileW',4,tkVariant,nil,__RetrieveUrlCacheEntryFileW,false,0,'lpszUrlName: PWideChar; lpCacheEntryInfo: TInternetCacheEntryInfo; lpdwCacheEntryInfoBufferSize: DWORD; dwReserved: DWORD').SetVarArgs([1,2]);
    DefineMethod('UnlockUrlCacheEntryFile',2,tkVariant,nil,__UnlockUrlCacheEntryFile,false,0,'lpszUrlName: PWideChar; dwReserved: DWORD');
    DefineMethod('UnlockUrlCacheEntryFileA',2,tkVariant,nil,__UnlockUrlCacheEntryFileA,false,0,'lpszUrlName: PAnsiChar; dwReserved: DWORD');
    DefineMethod('UnlockUrlCacheEntryFileW',2,tkVariant,nil,__UnlockUrlCacheEntryFileW,false,0,'lpszUrlName: PWideChar; dwReserved: DWORD');
    DefineMethod('RetrieveUrlCacheEntryStream',5,tkInteger,nil,__RetrieveUrlCacheEntryStream,false,0,'lpszUrlName: PWideChar; lpCacheEntryInfo: TInternetCacheEntryInfo; lpdwCacheEntryInfoBufferSize: DWORD; fRandomRead: BOOL; dwReserved: DWORD').SetVarArgs([1,2]);
    DefineMethod('RetrieveUrlCacheEntryStreamA',5,tkInteger,nil,__RetrieveUrlCacheEntryStreamA,false,0,'lpszUrlName: PAnsiChar; lpCacheEntryInfo: TInternetCacheEntryInfo; lpdwCacheEntryInfoBufferSize: DWORD; fRandomRead: BOOL; dwReserved: DWORD').SetVarArgs([1,2]);
    DefineMethod('RetrieveUrlCacheEntryStreamW',5,tkInteger,nil,__RetrieveUrlCacheEntryStreamW,false,0,'lpszUrlName: PWideChar; lpCacheEntryInfo: TInternetCacheEntryInfo; lpdwCacheEntryInfoBufferSize: DWORD; fRandomRead: BOOL; dwReserved: DWORD').SetVarArgs([1,2]);
    DefineMethod('UnlockUrlCacheEntryStream',2,tkVariant,nil,__UnlockUrlCacheEntryStream,false,0,'hUrlCacheStream: THandle; Reserved: DWORD');
    DefineMethod('GetUrlCacheEntryInfo',3,tkVariant,nil,__GetUrlCacheEntryInfo,false,0,'lpszUrlName: PWideChar; lpCacheEntryInfo: TInternetCacheEntryInfo; lpdwCacheEntryInfoBufferSize: DWORD').SetVarArgs([1,2]);
    DefineMethod('GetUrlCacheEntryInfoA',3,tkVariant,nil,__GetUrlCacheEntryInfoA,false,0,'lpszUrlName: PAnsiChar; lpCacheEntryInfo: TInternetCacheEntryInfo; lpdwCacheEntryInfoBufferSize: DWORD').SetVarArgs([1,2]);
    DefineMethod('GetUrlCacheEntryInfoW',3,tkVariant,nil,__GetUrlCacheEntryInfoW,false,0,'lpszUrlName: PWideChar; lpCacheEntryInfo: TInternetCacheEntryInfo; lpdwCacheEntryInfoBufferSize: DWORD').SetVarArgs([1,2]);
    DefineMethod('SetUrlCacheEntryInfo',3,tkVariant,nil,__SetUrlCacheEntryInfo,false,0,'lpszUrlName: PWideChar; lpCacheEntryInfo: TInternetCacheEntryInfo; dwFieldControl: DWORD').SetVarArgs([1]);
    DefineMethod('SetUrlCacheEntryInfoA',3,tkVariant,nil,__SetUrlCacheEntryInfoA,false,0,'lpszUrlName: PAnsiChar; lpCacheEntryInfo: TInternetCacheEntryInfo; dwFieldControl: DWORD').SetVarArgs([1]);
    DefineMethod('SetUrlCacheEntryInfoW',3,tkVariant,nil,__SetUrlCacheEntryInfoW,false,0,'lpszUrlName: PWideChar; lpCacheEntryInfo: TInternetCacheEntryInfo; dwFieldControl: DWORD').SetVarArgs([1]);
    DefineMethod('FindFirstUrlCacheEntry',3,tkInteger,nil,__FindFirstUrlCacheEntry,false,0,'lpszUrlSearchPattern: PWideChar; lpFirstCacheEntryInfo: TInternetCacheEntryInfo; lpdwFirstCacheEntryInfoBufferSize: DWORD').SetVarArgs([1,2]);
    DefineMethod('FindFirstUrlCacheEntryA',3,tkInteger,nil,__FindFirstUrlCacheEntryA,false,0,'lpszUrlSearchPattern: PAnsiChar; lpFirstCacheEntryInfo: TInternetCacheEntryInfoA; lpdwFirstCacheEntryInfoBufferSize: DWORD').SetVarArgs([1,2]);
    DefineMethod('FindFirstUrlCacheEntryW',3,tkInteger,nil,__FindFirstUrlCacheEntryW,false,0,'lpszUrlSearchPattern: PWideChar; lpFirstCacheEntryInfo: TInternetCacheEntryInfoW; lpdwFirstCacheEntryInfoBufferSize: DWORD').SetVarArgs([1,2]);
    DefineMethod('FindNextUrlCacheEntry',3,tkVariant,nil,__FindNextUrlCacheEntry,false,0,'hEnumHandle: THandle; lpNextCacheEntryInfo: TInternetCacheEntryInfo; lpdwNextCacheEntryInfoBufferSize: DWORD').SetVarArgs([1,2]);
    DefineMethod('FindNextUrlCacheEntryA',3,tkVariant,nil,__FindNextUrlCacheEntryA,false,0,'hEnumHandle: THandle; lpNextCacheEntryInfo: TInternetCacheEntryInfoA; lpdwNextCacheEntryInfoBufferSize: DWORD').SetVarArgs([1,2]);
    DefineMethod('FindNextUrlCacheEntryW',3,tkVariant,nil,__FindNextUrlCacheEntryW,false,0,'hEnumHandle: THandle; lpNextCacheEntryInfo: TInternetCacheEntryInfoW; lpdwNextCacheEntryInfoBufferSize: DWORD').SetVarArgs([1,2]);
    DefineMethod('FindCloseUrlCache',1,tkVariant,nil,__FindCloseUrlCache,false,0,'hEnumHandle: THandle');
    DefineMethod('DeleteUrlCacheEntry',1,tkVariant,nil,__DeleteUrlCacheEntry,false,0,'lpszUrlName: PWideChar');
    DefineMethod('DeleteUrlCacheEntryA',1,tkVariant,nil,__DeleteUrlCacheEntryA,false,0,'lpszUrlName: PAnsiChar');
    DefineMethod('DeleteUrlCacheEntryW',1,tkVariant,nil,__DeleteUrlCacheEntryW,false,0,'lpszUrlName: PWideChar');
    DefineMethod('InternetHangUp',2,tkInteger,nil,__InternetHangUp,false,0,'dwConnection: DWORD; dwReserved: DWORD');
    DefineMethod('InternetGoOnline',3,tkVariant,nil,__InternetGoOnline,false,0,'lpszURL: LPTSTR; hwndParent: HWND; dwFlags: DWORD');
    DefineMethod('InternetAutodial',2,tkVariant,nil,__InternetAutodial,false,0,'dwFlags: DWORD; dwReserved: DWORD');
    DefineMethod('InternetAutodialHangup',1,tkVariant,nil,__InternetAutodialHangup,false,0,'dwReserved: DWORD');
    DefineMethod('InternetSetDialState',3,tkVariant,nil,__InternetSetDialState,false,0,'lpszConnectoid: LPCTSTR; dwState: DWORD; dwReserved: DWORD');
  AddConsts1;
  AddConsts2;
  end;
end;
