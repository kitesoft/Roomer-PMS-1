...
begin
  with AMachine do
  begin
    TADOConnection(CurrentObject).GetProcedureNames(TWideStrings(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TADOConnection(CurrentObject).GetFieldNames(GetInputArg(0),TWideStrings(VarToObject(GetInputArg(1))));
  end;
end;
...
begin
  ...
  begin
    Case InputArgCount of
      1: TADOConnection(CurrentObject).GetTableNames(TWideStrings(VarToObject(GetInputArg(0))));
      2: TADOConnection(CurrentObject).GetTableNames(TWideStrings(VarToObject(GetInputArg(0))),GetInputArg(1));
    end;
  end;
end;
...
begin
  with AMachine do
  begin
    ADODB.GetProviderNames(TWideStrings(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  ...
  begin
case InputArgCount of
1: AResult := Integer(ADODB.GetDataLinkFiles(TWideStrings(VarToObject(GetInputArg(0)))));
2: AResult := Integer(ADODB.GetDataLinkFiles(TWideStrings(VarToObject(GetInputArg(0))),VarToStr(GetInputArg(1))));
end;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('GetProcedureNames',1,tkNone,nil,__TADOConnectionGetProcedureNames,false,0,'List: TWideStrings');
    DefineMethod('GetFieldNames',2,tkNone,nil,__TADOConnectionGetFieldNames,false,0,'TableName: WideString; List: TWideStrings');
    DefineMethod('GetTableNames',2,tkNone,nil,__TADOConnectionGetTableNames,false,1,'List: TWideStrings; SystemTables: Boolean = False');
  ...
  begin
    ...
    DefineMethod('ParseSQL',2,tkVariant,nil,__TParametersParseSQL,false,0,'SQL: WideString; DoCreate: Boolean');
  ...
  begin
    ...
    DefineMethod('GetProviderNames',1,tkNone,nil,__GetProviderNames,false,0,'Names: TWideStrings');
    ...
    DefineMethod('GetDataLinkFiles',2,tkInteger,nil,__GetDataLinkFiles,false,1,'FileNames: TWideStrings; Directory: string = ''');
