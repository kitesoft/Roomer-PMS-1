...
AResult := WinSvc.GetServiceKeyName(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)),Param3);
    ReturnOutputArg(AResult);
...
begin
  ...
  begin
Param3 := VarToInteger(GetInputArg(3));
AResult := WinSvc.GetServiceKeyNameA(VarToInteger(GetInputArg(0)),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(2)))),Param3);
    ReturnOutputArg(AResult);
    SetInputArg(3,Integer(Param3));
  end;
end;
...
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
Param3 := VarToInteger(GetInputArg(3));
AResult := WinSvc.GetServiceKeyNameW(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)),Param3);
    ReturnOutputArg(AResult);
    SetInputArg(3,Integer(Param3));
  end;
end;
...
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
Param3 := VarToInteger(GetInputArg(3));
AResult := WinSvc.GetServiceDisplayName(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)),Param3);
    ReturnOutputArg(AResult);
    SetInputArg(3,Integer(Param3));
  end;
end;
...
begin
  ...
  begin
Param3 := VarToInteger(GetInputArg(3));
AResult := WinSvc.GetServiceDisplayNameA(VarToInteger(GetInputArg(0)),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(2)))),Param3);
    ReturnOutputArg(AResult);
    SetInputArg(3,Integer(Param3));
  end;
end;
...
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
Param3 := VarToInteger(GetInputArg(3));
AResult := WinSvc.GetServiceDisplayNameW(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)),Param3);
    ReturnOutputArg(AResult);
    SetInputArg(3,Integer(Param3));
  end;
end;
...
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(WinSvc.OpenSCManager(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(WinSvc.OpenSCManagerA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(WinSvc.OpenSCManagerW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(WinSvc.OpenService(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(WinSvc.OpenServiceA(VarToInteger(GetInputArg(0)),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(WinSvc.OpenServiceW(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
Param2 := PAnsiChar(AnsiString(VarToStr(GetInputArg(2))));
...
begin
  ...
  begin
    DefineMethod('CloseServiceHandle',1,tkVariant,nil,__CloseServiceHandle,false,0,'hSCObject: SC_HANDLE');
    DefineMethod('ControlService',3,tkVariant,nil,__ControlService,false,0,'hService: SC_HANDLE; dwControl: DWORD; lpServiceStatus: TServiceStatus').SetVarArgs([2]);
    DefineMethod('DeleteService',1,tkVariant,nil,__DeleteService,false,0,'hService: SC_HANDLE');
    DefineMethod('EnumDependentServices',6,tkVariant,nil,__EnumDependentServices,false,0,'hService: SC_HANDLE; dwServiceState: DWORD; lpServices: TEnumServiceStatus; cbBufSize: DWORD; pcbBytesNeeded: DWORD; lpServicesReturned: DWORD').SetVarArgs([2,4,5]);
    DefineMethod('EnumDependentServicesA',6,tkVariant,nil,__EnumDependentServicesA,false,0,'hService: SC_HANDLE; dwServiceState: DWORD; lpServices: TEnumServiceStatusA; cbBufSize: DWORD; pcbBytesNeeded: DWORD; lpServicesReturned: DWORD').SetVarArgs([2,4,5]);
    DefineMethod('EnumDependentServicesW',6,tkVariant,nil,__EnumDependentServicesW,false,0,'hService: SC_HANDLE; dwServiceState: DWORD; lpServices: TEnumServiceStatusW; cbBufSize: DWORD; pcbBytesNeeded: DWORD; lpServicesReturned: DWORD').SetVarArgs([2,4,5]);
    DefineMethod('EnumServicesStatus',8,tkVariant,nil,__EnumServicesStatus,false,0,'hSCManager: SC_HANDLE; dwServiceType: DWORD; dwServiceState: DWORD; lpServices: TEnumServiceStatus; cbBufSize: DWORD; pcbBytesNeeded: DWORD; lpServicesReturned: DWORD; lpResumeHandle: DWORD').SetVarArgs([3,5,6,7]);
    DefineMethod('EnumServicesStatusA',8,tkVariant,nil,__EnumServicesStatusA,false,0,'hSCManager: SC_HANDLE; dwServiceType: DWORD; dwServiceState: DWORD; lpServices: TEnumServiceStatusA; cbBufSize: DWORD; pcbBytesNeeded: DWORD; lpServicesReturned: DWORD; lpResumeHandle: DWORD').SetVarArgs([3,5,6,7]);
    DefineMethod('EnumServicesStatusW',8,tkVariant,nil,__EnumServicesStatusW,false,0,'hSCManager: SC_HANDLE; dwServiceType: DWORD; dwServiceState: DWORD; lpServices: TEnumServiceStatusW; cbBufSize: DWORD; pcbBytesNeeded: DWORD; lpServicesReturned: DWORD; lpResumeHandle: DWORD').SetVarArgs([3,5,6,7]);
    DefineMethod('GetServiceKeyName',4,tkVariant,nil,__GetServiceKeyName,false,0,'hSCManager: SC_HANDLE; lpDisplayName: PWideChar; lpServiceName: PWideChar; lpcchBuffer: DWORD').SetVarArgs([3]);
    DefineMethod('GetServiceKeyNameA',4,tkVariant,nil,__GetServiceKeyNameA,false,0,'hSCManager: SC_HANDLE; lpDisplayName: PAnsiChar; lpServiceName: PAnsiChar; lpcchBuffer: DWORD').SetVarArgs([3]);
    DefineMethod('GetServiceKeyNameW',4,tkVariant,nil,__GetServiceKeyNameW,false,0,'hSCManager: SC_HANDLE; lpDisplayName: PWideChar; lpServiceName: PWideChar; lpcchBuffer: DWORD').SetVarArgs([3]);
    DefineMethod('GetServiceDisplayName',4,tkVariant,nil,__GetServiceDisplayName,false,0,'hSCManager: SC_HANDLE; lpServiceName: PWideChar; lpDisplayName: PWideChar; lpcchBuffer: DWORD').SetVarArgs([3]);
    DefineMethod('GetServiceDisplayNameA',4,tkVariant,nil,__GetServiceDisplayNameA,false,0,'hSCManager: SC_HANDLE; lpServiceName: PAnsiChar; lpDisplayName: PAnsiChar; lpcchBuffer: DWORD').SetVarArgs([3]);
    DefineMethod('GetServiceDisplayNameW',4,tkVariant,nil,__GetServiceDisplayNameW,false,0,'hSCManager: SC_HANDLE; lpServiceName: PWideChar; lpDisplayName: PWideChar; lpcchBuffer: DWORD').SetVarArgs([3]);
    DefineMethod('NotifyBootConfigStatus',1,tkVariant,nil,__NotifyBootConfigStatus,false,0,'BootAcceptable: BOOL');
    DefineMethod('OpenSCManager',3,tkInteger,nil,__OpenSCManager,false,0,'lpMachineName: PWideChar; lpDatabaseName: PWideChar; dwDesiredAccess: DWORD');
    DefineMethod('OpenSCManagerA',3,tkInteger,nil,__OpenSCManagerA,false,0,'lpMachineName: PAnsiChar; lpDatabaseName: PAnsiChar; dwDesiredAccess: DWORD');
    DefineMethod('OpenSCManagerW',3,tkInteger,nil,__OpenSCManagerW,false,0,'lpMachineName: PWideChar; lpDatabaseName: PWideChar; dwDesiredAccess: DWORD');
    DefineMethod('OpenService',3,tkInteger,nil,__OpenService,false,0,'hSCManager: SC_HANDLE; lpServiceName: PWideChar; dwDesiredAccess: DWORD');
    DefineMethod('OpenServiceA',3,tkInteger,nil,__OpenServiceA,false,0,'hSCManager: SC_HANDLE; lpServiceName: PAnsiChar; dwDesiredAccess: DWORD');
    DefineMethod('OpenServiceW',3,tkInteger,nil,__OpenServiceW,false,0,'hSCManager: SC_HANDLE; lpServiceName: PWideChar; dwDesiredAccess: DWORD');
    DefineMethod('QueryServiceLockStatus',4,tkVariant,nil,__QueryServiceLockStatus,false,0,'hSCManager: SC_HANDLE; lpLockStatus: TQueryServiceLockStatus; cbBufSize: DWORD; pcbBytesNeeded: DWORD').SetVarArgs([1,3]);
    DefineMethod('QueryServiceLockStatusA',4,tkVariant,nil,__QueryServiceLockStatusA,false,0,'hSCManager: SC_HANDLE; lpLockStatus: TQueryServiceLockStatusA; cbBufSize: DWORD; pcbBytesNeeded: DWORD').SetVarArgs([1,3]);
    DefineMethod('QueryServiceLockStatusW',4,tkVariant,nil,__QueryServiceLockStatusW,false,0,'hSCManager: SC_HANDLE; lpLockStatus: TQueryServiceLockStatusW; cbBufSize: DWORD; pcbBytesNeeded: DWORD').SetVarArgs([1,3]);
    DefineMethod('QueryServiceStatus',2,tkVariant,nil,__QueryServiceStatus,false,0,'hService: SC_HANDLE; lpServiceStatus: TServiceStatus').SetVarArgs([1]);
    DefineMethod('SetServiceStatus',2,tkVariant,nil,__SetServiceStatus,false,0,'hServiceStatus: SERVICE_STATUS_HANDLE; lpServiceStatus: TServiceStatus').SetVarArgs([1]);
    DefineMethod('StartServiceCtrlDispatcher',1,tkVariant,nil,__StartServiceCtrlDispatcher,false,0,'lpServiceStartTable: TServiceTableEntry').SetVarArgs([0]);
    DefineMethod('StartServiceCtrlDispatcherA',1,tkVariant,nil,__StartServiceCtrlDispatcherA,false,0,'lpServiceStartTable: TServiceTableEntryA').SetVarArgs([0]);
    DefineMethod('StartServiceCtrlDispatcherW',1,tkVariant,nil,__StartServiceCtrlDispatcherW,false,0,'lpServiceStartTable: TServiceTableEntryW').SetVarArgs([0]);
    DefineMethod('StartService',3,tkVariant,nil,__StartService,false,0,'hService: SC_HANDLE; dwNumServiceArgs: DWORD; lpServiceArgVectors: PWideChar').SetVarArgs([2]);
    DefineMethod('StartServiceA',3,tkVariant,nil,__StartServiceA,false,0,'hService: SC_HANDLE; dwNumServiceArgs: DWORD; lpServiceArgVectors: PAnsiChar').SetVarArgs([2]);
    DefineMethod('StartServiceW',3,tkVariant,nil,__StartServiceW,false,0,'hService: SC_HANDLE; dwNumServiceArgs: DWORD; lpServiceArgVectors: PWideChar').SetVarArgs([2]);
    AddConstant('SC_STATUS_PROCESS_INFO',SC_STATUS_PROCESS_INFO);
