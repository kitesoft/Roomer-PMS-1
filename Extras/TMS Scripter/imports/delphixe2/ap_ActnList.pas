...
type
  TatActnListLibrary = class(TatScripterLibrary)
    ...
    procedure __TContainedActionSetParentComponent(AMachine: TatVirtualMachine);
    ...
    procedure __TActionListEnumeratorCreate(AMachine: TatVirtualMachine);
    procedure __TActionListEnumeratorGetCurrent(AMachine: TatVirtualMachine);
    procedure __TActionListEnumeratorMoveNext(AMachine: TatVirtualMachine);
    procedure __GetTActionListEnumeratorCurrent(AMachine: TatVirtualMachine);
    ...
    procedure __TCustomActionListGetEnumerator(AMachine: TatVirtualMachine);
  ...
  TActionListEnumeratorClass = class of TActionListEnumerator;
...
procedure TatActnListLibrary.__TContainedActionSetParentComponent(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TContainedAction(CurrentObject).SetParentComponent(TComponent(VarToObject(GetInputArg(0))));
  end;
end;
...
procedure TatActnListLibrary.__TActionListEnumeratorCreate(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := ObjectToVar(TActionListEnumeratorClass(CurrentClass.ClassRef).Create(TCustomActionList(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatActnListLibrary.__TActionListEnumeratorGetCurrent(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := ObjectToVar(TActionListEnumerator(CurrentObject).GetCurrent);
    ReturnOutputArg(AResult);
  end;
end;

procedure TatActnListLibrary.__TActionListEnumeratorMoveNext(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := TActionListEnumerator(CurrentObject).MoveNext;
    ReturnOutputArg(AResult);
  end;
end;

procedure TatActnListLibrary.__GetTActionListEnumeratorCurrent(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TActionListEnumerator(CurrentObject).Current));
  end;
end;
...
procedure TatActnListLibrary.__TCustomActionListGetEnumerator(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomActionList(CurrentObject).GetEnumerator);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('SetParentComponent',1,tkNone,nil,__TContainedActionSetParentComponent,false,0,'AParent: TComponent');
  ...
  With Scripter.DefineClass(TActionListEnumerator) do
  begin
    DefineMethod('Create',1,tkClass,TActionListEnumerator,__TActionListEnumeratorCreate,true,0,'AActionList: TCustomActionList');
    DefineMethod('GetCurrent',0,tkClass,TContainedAction,__TActionListEnumeratorGetCurrent,false,0,'');
    DefineMethod('MoveNext',0,tkVariant,nil,__TActionListEnumeratorMoveNext,false,0,'');
    DefineProp('Current',tkClass,__GetTActionListEnumeratorCurrent,nil,TContainedAction,false,0);
  end;
  ...
  begin
    ...
    DefineMethod('GetEnumerator',0,tkClass,TActionListEnumerator,__TCustomActionListGetEnumerator,false,0,'');
