...
AResult := TPublishableVariantType(CurrentObject).GetProperty(Param0,TVarDataWrapper(integer(GetInputArg(1))).ObjToRec,VarToStr(GetInputArg(2)));
...
begin
  with AMachine do
  begin
AResult := TPublishableVariantType(CurrentObject).SetProperty(TVarDataWrapper(integer(GetInputArg(0))).ObjToRec,VarToStr(GetInputArg(1)),TVarDataWrapper(integer(GetInputArg(2))).ObjToRec);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TypInfo.PropType(TObject(VarToObject(GetInputArg(0))),VarToStr(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TypInfo.PropIsType(TObject(VarToObject(GetInputArg(0))),VarToStr(GetInputArg(1)),TTypeKind(VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TypInfo.IsStoredProp(TObject(VarToObject(GetInputArg(0))),VarToStr(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TypInfo.IsPublishedProp(TObject(VarToObject(GetInputArg(0))),VarToStr(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TypInfo.GetOrdProp(TObject(VarToObject(GetInputArg(0))),VarToStr(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TypInfo.SetOrdProp(TObject(VarToObject(GetInputArg(0))),VarToStr(GetInputArg(1)),VarToInteger(GetInputArg(2)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(TypInfo.GetEnumProp(TObject(VarToObject(GetInputArg(0))),VarToStr(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TypInfo.SetEnumProp(TObject(VarToObject(GetInputArg(0))),VarToStr(GetInputArg(1)),VarToStr(GetInputArg(2)));
  end;
end;
...
2: AResult := string(TypInfo.GetSetProp(TObject(VarToObject(GetInputArg(0))),VarToStr(GetInputArg(1))));
3: AResult := string(TypInfo.GetSetProp(TObject(VarToObject(GetInputArg(0))),VarToStr(GetInputArg(1)),GetInputArg(2)));
end;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TypInfo.SetSetProp(TObject(VarToObject(GetInputArg(0))),VarToStr(GetInputArg(1)),VarToStr(GetInputArg(2)));
  end;
end;
...
begin
  with AMachine do
  begin
    TypInfo.SetObjectProp(TObject(VarToObject(GetInputArg(0))),VarToStr(GetInputArg(1)),TObject(VarToObject(GetInputArg(2))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(TypInfo.GetStrProp(TObject(VarToObject(GetInputArg(0))),VarToStr(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TypInfo.SetStrProp(TObject(VarToObject(GetInputArg(0))),VarToStr(GetInputArg(1)),VarToStr(GetInputArg(2)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TypInfo.GetAnsiStrProp(TObject(VarToObject(GetInputArg(0))),VarToStr(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TypInfo.SetAnsiStrProp(TObject(VarToObject(GetInputArg(0))),VarToStr(GetInputArg(1)),GetInputArg(2));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TypInfo.GetWideStrProp(TObject(VarToObject(GetInputArg(0))),VarToStr(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TypInfo.SetWideStrProp(TObject(VarToObject(GetInputArg(0))),VarToStr(GetInputArg(1)),GetInputArg(2));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TypInfo.GetUnicodeStrProp(TObject(VarToObject(GetInputArg(0))),VarToStr(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TypInfo.SetUnicodeStrProp(TObject(VarToObject(GetInputArg(0))),VarToStr(GetInputArg(1)),GetInputArg(2));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TypInfo.GetFloatProp(TObject(VarToObject(GetInputArg(0))),VarToStr(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TypInfo.SetFloatProp(TObject(VarToObject(GetInputArg(0))),VarToStr(GetInputArg(1)),GetInputArg(2));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TypInfo.GetVariantProp(TObject(VarToObject(GetInputArg(0))),VarToStr(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TypInfo.SetVariantProp(TObject(VarToObject(GetInputArg(0))),VarToStr(GetInputArg(1)),GetInputArg(2));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := integer(TMethodWrapper.Create(TypInfo.GetMethodProp(TObject(VarToObject(GetInputArg(0))),VarToStr(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TypInfo.SetMethodProp(TObject(VarToObject(GetInputArg(0))),VarToStr(GetInputArg(1)),TMethodWrapper(integer(GetInputArg(2))).ObjToRec);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TypInfo.GetInt64Prop(TObject(VarToObject(GetInputArg(0))),VarToStr(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TypInfo.SetInt64Prop(TObject(VarToObject(GetInputArg(0))),VarToStr(GetInputArg(1)),VarToInteger(GetInputArg(2)));
  end;
end;
...
begin
  ...
  begin
case InputArgCount of
2: AResult := TypInfo.GetPropValue(TObject(VarToObject(GetInputArg(0))),VarToStr(GetInputArg(1)));
3: AResult := TypInfo.GetPropValue(TObject(VarToObject(GetInputArg(0))),VarToStr(GetInputArg(1)),GetInputArg(2));
end;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TypInfo.SetPropValue(TObject(VarToObject(GetInputArg(0))),VarToStr(GetInputArg(1)),GetInputArg(2));
  end;
end;
...
begin
  with AMachine do
  begin
    TypInfo.FreeAndNilProperties(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TypInfo.DotSep));
  end;
end;
...
begin
  with AMachine do
  begin
    TypInfo.DotSep:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  ...
  begin
    DefineMethod('GetProperty',3,tkVariant,nil,__TPublishableVariantTypeGetProperty,false,0,'Dest: TVarData; V: TVarData; Name: string').SetVarArgs([0]);
    DefineMethod('SetProperty',3,tkVariant,nil,__TPublishableVariantTypeSetProperty,false,0,'V: TVarData; Name: string; Value: TVarData');
  end;
  ...
  begin
    DefineMethod('PropType',2,tkEnumeration,nil,__PropType,false,0,'Instance: TObject; PropName: string');
    DefineMethod('PropIsType',3,tkVariant,nil,__PropIsType,false,0,'Instance: TObject; PropName: string; TypeKind: TTypeKind');
    DefineMethod('IsStoredProp',2,tkVariant,nil,__IsStoredProp,false,0,'Instance: TObject; PropName: string');
    DefineMethod('IsPublishedProp',2,tkVariant,nil,__IsPublishedProp,false,0,'Instance: TObject; PropName: string');
    DefineMethod('GetOrdProp',2,tkInteger,nil,__GetOrdProp,false,0,'Instance: TObject; PropName: string');
    DefineMethod('SetOrdProp',3,tkNone,nil,__SetOrdProp,false,0,'Instance: TObject; PropName: string; Value: Longint');
    DefineMethod('GetEnumProp',2,tkVariant,nil,__GetEnumProp,false,0,'Instance: TObject; PropName: string');
    DefineMethod('SetEnumProp',3,tkNone,nil,__SetEnumProp,false,0,'Instance: TObject; PropName: string; Value: string');
    DefineMethod('GetSetProp',3,tkVariant,nil,__GetSetProp,false,1,'Instance: TObject; PropName: string; Brackets: Boolean = False');
    DefineMethod('SetSetProp',3,tkNone,nil,__SetSetProp,false,0,'Instance: TObject; PropName: string; Value: string');
    DefineMethod('SetObjectProp',3,tkNone,nil,__SetObjectProp,false,0,'Instance: TObject; PropName: string; Value: TObject');
    DefineMethod('GetStrProp',2,tkVariant,nil,__GetStrProp,false,0,'Instance: TObject; PropName: string');
    DefineMethod('SetStrProp',3,tkNone,nil,__SetStrProp,false,0,'Instance: TObject; PropName: string; Value: string');
    DefineMethod('GetAnsiStrProp',2,tkVariant,nil,__GetAnsiStrProp,false,0,'Instance: TObject; PropName: string');
    DefineMethod('SetAnsiStrProp',3,tkNone,nil,__SetAnsiStrProp,false,0,'Instance: TObject; PropName: string; Value: AnsiString');
    DefineMethod('GetWideStrProp',2,tkVariant,nil,__GetWideStrProp,false,0,'Instance: TObject; PropName: string');
    DefineMethod('SetWideStrProp',3,tkNone,nil,__SetWideStrProp,false,0,'Instance: TObject; PropName: string; Value: WideString');
    DefineMethod('GetUnicodeStrProp',2,tkVariant,nil,__GetUnicodeStrProp,false,0,'Instance: TObject; PropName: string');
    DefineMethod('SetUnicodeStrProp',3,tkNone,nil,__SetUnicodeStrProp,false,0,'Instance: TObject; PropName: string; Value: UnicodeString');
    DefineMethod('GetFloatProp',2,tkVariant,nil,__GetFloatProp,false,0,'Instance: TObject; PropName: string');
    DefineMethod('SetFloatProp',3,tkNone,nil,__SetFloatProp,false,0,'Instance: TObject; PropName: string; Value: Extended');
    DefineMethod('GetVariantProp',2,tkVariant,nil,__GetVariantProp,false,0,'Instance: TObject; PropName: string');
    DefineMethod('SetVariantProp',3,tkNone,nil,__SetVariantProp,false,0,'Instance: TObject; PropName: string; Value: Variant');
    DefineMethod('GetMethodProp',2,tkVariant,nil,__GetMethodProp,false,0,'Instance: TObject; PropName: string');
    DefineMethod('SetMethodProp',3,tkNone,nil,__SetMethodProp,false,0,'Instance: TObject; PropName: string; Value: TMethod');
    DefineMethod('GetInt64Prop',2,tkVariant,nil,__GetInt64Prop,false,0,'Instance: TObject; PropName: string');
    DefineMethod('SetInt64Prop',3,tkNone,nil,__SetInt64Prop,false,0,'Instance: TObject; PropName: string; Value: Int64');
    DefineMethod('GetPropValue',3,tkVariant,nil,__GetPropValue,false,1,'Instance: TObject; PropName: string; PreferStrings: Boolean = True');
    DefineMethod('SetPropValue',3,tkNone,nil,__SetPropValue,false,0,'Instance: TObject; PropName: string; Value: Variant');
    DefineMethod('FreeAndNilProperties',1,tkNone,nil,__FreeAndNilProperties,false,0,'AObject: TObject');
    DefineMethod('SamePropTypeName',2,tkVariant,nil,__SamePropTypeName,false,0,'Name1: ShortString; Name2: ShortString');
