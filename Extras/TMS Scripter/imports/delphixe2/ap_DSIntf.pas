...
begin
  ...
  begin
    DefineMethod('CreateDbClientObject',3,tkNone,nil,__CreateDbClientObject,false,0,'CLSID: TGUID; IID: TGUID; Obj').SetVarArgs([2]);
    DefineMethod('VariantArrayToString',1,tkVariant,nil,__VariantArrayToString,false,0,'V: OleVariant');
    DefineMethod('StringToVariantArray',1,tkVariant,nil,__StringToVariantArray,false,0,'S: RawByteString');
    ...
    AddConstant('dspropUTF8METADATA',dspropUTF8METADATA);
    AddConstant('dspropUTF8ERRORMSG',dspropUTF8ERRORMSG);
    AddConstant('dspropANSICODEPAGE',dspropANSICODEPAGE);
    ...
    AddConstant('dsfldSINGLE',dsfldSINGLE);
    AddConstant('dsfldDATETIMEOFFSET',dsfldDATETIMEOFFSET);
    ...
    AddConstant('fldINT8',fldINT8);
    AddConstant('fldUINT8',fldUINT8);
    AddConstant('fldSINGLE',fldSINGLE);
    AddConstant('fldDATETIMEOFFSET',fldDATETIMEOFFSET);
