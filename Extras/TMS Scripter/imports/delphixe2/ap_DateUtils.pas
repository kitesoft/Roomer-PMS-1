...
type
  TatDateUtilsLibrary = class(TatScripterLibrary)
    procedure __TTimeZoneToUniversalTime(AMachine: TatVirtualMachine);
    procedure __TTimeZoneToLocalTime(AMachine: TatVirtualMachine);
    procedure __TTimeZoneGetDisplayName(AMachine: TatVirtualMachine);
    procedure __TTimeZoneGetAbbreviation(AMachine: TatVirtualMachine);
    procedure __TTimeZoneGetLocalTimeType(AMachine: TatVirtualMachine);
    procedure __TTimeZoneIsStandardTime(AMachine: TatVirtualMachine);
    procedure __TTimeZoneIsInvalidTime(AMachine: TatVirtualMachine);
    procedure __TTimeZoneIsAmbiguousTime(AMachine: TatVirtualMachine);
    procedure __TTimeZoneIsDaylightTime(AMachine: TatVirtualMachine);
    procedure __GetTTimeZoneID(AMachine: TatVirtualMachine);
    procedure __GetTTimeZoneDisplayName(AMachine: TatVirtualMachine);
    procedure __GetTTimeZoneAbbreviation(AMachine: TatVirtualMachine);
    procedure __GetTTimeZoneLocal(AMachine: TatVirtualMachine);
    ...
    procedure __IsAM(AMachine: TatVirtualMachine);
    ...
    procedure __DateTimeInRange(AMachine: TatVirtualMachine);
    procedure __DateInRange(AMachine: TatVirtualMachine);
    procedure __TimeInRange(AMachine: TatVirtualMachine);
  ...
  ELocalTimeInvalidClass = class of ELocalTimeInvalid;
  TTimeZoneClass = class of TTimeZone;
...
procedure TatDateUtilsLibrary.__TTimeZoneToUniversalTime(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
...
1: AResult := TTimeZone(CurrentObject).ToUniversalTime(GetInputArg(0));
2: AResult := TTimeZone(CurrentObject).ToUniversalTime(GetInputArg(0),GetInputArg(1));
end;
    ReturnOutputArg(AResult);
  end;
end;

procedure TatDateUtilsLibrary.__TTimeZoneToLocalTime(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := TTimeZone(CurrentObject).ToLocalTime(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatDateUtilsLibrary.__TTimeZoneGetDisplayName(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
case InputArgCount of
1: AResult := string(TTimeZone(CurrentObject).GetDisplayName(GetInputArg(0)));
2: AResult := string(TTimeZone(CurrentObject).GetDisplayName(GetInputArg(0),GetInputArg(1)));
end;
    ReturnOutputArg(AResult);
  end;
end;

procedure TatDateUtilsLibrary.__TTimeZoneGetAbbreviation(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
case InputArgCount of
1: AResult := string(TTimeZone(CurrentObject).GetAbbreviation(GetInputArg(0)));
2: AResult := string(TTimeZone(CurrentObject).GetAbbreviation(GetInputArg(0),GetInputArg(1)));
end;
    ReturnOutputArg(AResult);
  end;
end;

procedure TatDateUtilsLibrary.__TTimeZoneGetLocalTimeType(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(TTimeZone(CurrentObject).GetLocalTimeType(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatDateUtilsLibrary.__TTimeZoneIsStandardTime(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
case InputArgCount of
1: AResult := TTimeZone(CurrentObject).IsStandardTime(GetInputArg(0));
2: AResult := TTimeZone(CurrentObject).IsStandardTime(GetInputArg(0),GetInputArg(1));
end;
    ReturnOutputArg(AResult);
  end;
end;

procedure TatDateUtilsLibrary.__TTimeZoneIsInvalidTime(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := TTimeZone(CurrentObject).IsInvalidTime(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatDateUtilsLibrary.__TTimeZoneIsAmbiguousTime(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := TTimeZone(CurrentObject).IsAmbiguousTime(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatDateUtilsLibrary.__TTimeZoneIsDaylightTime(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
case InputArgCount of
1: AResult := TTimeZone(CurrentObject).IsDaylightTime(GetInputArg(0));
2: AResult := TTimeZone(CurrentObject).IsDaylightTime(GetInputArg(0),GetInputArg(1));
end;
    ReturnOutputArg(AResult);
  end;
end;

procedure TatDateUtilsLibrary.__GetTTimeZoneID(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TTimeZone(CurrentObject).ID));
  end;
end;

procedure TatDateUtilsLibrary.__GetTTimeZoneDisplayName(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TTimeZone(CurrentObject).DisplayName));
  end;
end;

procedure TatDateUtilsLibrary.__GetTTimeZoneAbbreviation(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TTimeZone(CurrentObject).Abbreviation));
  end;
end;

procedure TatDateUtilsLibrary.__GetTTimeZoneLocal(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TTimeZone(CurrentObject).Local));
  end;
end;
...
procedure TatDateUtilsLibrary.__IsAM(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := DateUtils.IsAM(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatDateUtilsLibrary.__DateTimeInRange(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
case InputArgCount of
3: AResult := DateUtils.DateTimeInRange(GetInputArg(0),GetInputArg(1),GetInputArg(2));
4: AResult := DateUtils.DateTimeInRange(GetInputArg(0),GetInputArg(1),GetInputArg(2),GetInputArg(3));
end;
    ReturnOutputArg(AResult);
  end;
end;

procedure TatDateUtilsLibrary.__DateInRange(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
case InputArgCount of
3: AResult := DateUtils.DateInRange(GetInputArg(0),GetInputArg(1),GetInputArg(2));
4: AResult := DateUtils.DateInRange(GetInputArg(0),GetInputArg(1),GetInputArg(2),GetInputArg(3));
end;
    ReturnOutputArg(AResult);
  end;
end;

procedure TatDateUtilsLibrary.__TimeInRange(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
case InputArgCount of
3: AResult := DateUtils.TimeInRange(GetInputArg(0),GetInputArg(1),GetInputArg(2));
4: AResult := DateUtils.TimeInRange(GetInputArg(0),GetInputArg(1),GetInputArg(2),GetInputArg(3));
end;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(DateUtils.CompareDateTime(GetInputArg(0),GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(DateUtils.CompareDate(GetInputArg(0),GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(DateUtils.CompareTime(GetInputArg(0),GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  With Scripter.DefineClass(ELocalTimeInvalid) do
  begin
  end;
  With Scripter.DefineClass(TTimeZone) do
  begin
    DefineMethod('ToUniversalTime',2,tkVariant,nil,__TTimeZoneToUniversalTime,false,1,'ADateTime: TDateTime; ForceDaylight: Boolean = False');
    DefineMethod('ToLocalTime',1,tkVariant,nil,__TTimeZoneToLocalTime,false,0,'ADateTime: TDateTime');
    DefineMethod('GetDisplayName',2,tkVariant,nil,__TTimeZoneGetDisplayName,false,1,'ADateTime: TDateTime; ForceDaylight: Boolean = False');
    DefineMethod('GetAbbreviation',2,tkVariant,nil,__TTimeZoneGetAbbreviation,false,1,'ADateTime: TDateTime; ForceDaylight: Boolean = False');
    DefineMethod('GetLocalTimeType',1,tkEnumeration,nil,__TTimeZoneGetLocalTimeType,false,0,'ADateTime: TDateTime');
    DefineMethod('IsStandardTime',2,tkVariant,nil,__TTimeZoneIsStandardTime,false,1,'ADateTime: TDateTime; ForceDaylight: Boolean = False');
    DefineMethod('IsInvalidTime',1,tkVariant,nil,__TTimeZoneIsInvalidTime,false,0,'ADateTime: TDateTime');
    DefineMethod('IsAmbiguousTime',1,tkVariant,nil,__TTimeZoneIsAmbiguousTime,false,0,'ADateTime: TDateTime');
    DefineMethod('IsDaylightTime',2,tkVariant,nil,__TTimeZoneIsDaylightTime,false,1,'ADateTime: TDateTime; ForceDaylight: Boolean = False');
    DefineProp('ID',tkVariant,__GetTTimeZoneID,nil,nil,false,0);
    DefineProp('DisplayName',tkVariant,__GetTTimeZoneDisplayName,nil,nil,false,0);
    DefineProp('Abbreviation',tkVariant,__GetTTimeZoneAbbreviation,nil,nil,false,0);
    DefineProp('Local',tkClass,__GetTTimeZoneLocal,nil,TTimeZone,false,0);
  end;
  With Scripter.DefineClass(ClassType) do
  begin
    DefineMethod('DateOf',1,tkVariant,nil,__DateOf,false,0,'AValue: TDateTime');
    DefineMethod('TimeOf',1,tkVariant,nil,__TimeOf,false,0,'AValue: TDateTime');
    DefineMethod('IsInLeapYear',1,tkVariant,nil,__IsInLeapYear,false,0,'AValue: TDateTime');
    DefineMethod('IsPM',1,tkVariant,nil,__IsPM,false,0,'AValue: TDateTime');
    DefineMethod('IsAM',1,tkVariant,nil,__IsAM,false,0,'AValue: TDateTime');
    DefineMethod('IsValidDate',3,tkVariant,nil,__IsValidDate,false,0,'AYear: Word; AMonth: Word; ADay: Word');
    DefineMethod('IsValidTime',4,tkVariant,nil,__IsValidTime,false,0,'AHour: Word; AMinute: Word; ASecond: Word; AMilliSecond: Word');
    DefineMethod('IsValidDateTime',7,tkVariant,nil,__IsValidDateTime,false,0,'AYear: Word; AMonth: Word; ADay: Word; AHour: Word; AMinute: Word; ASecond: Word; AMilliSecond: Word');
    DefineMethod('IsValidDateDay',2,tkVariant,nil,__IsValidDateDay,false,0,'AYear: Word; ADayOfYear: Word');
    DefineMethod('IsValidDateWeek',3,tkVariant,nil,__IsValidDateWeek,false,0,'AYear: Word; AWeekOfYear: Word; ADayOfWeek: Word');
    DefineMethod('IsValidDateMonthWeek',4,tkVariant,nil,__IsValidDateMonthWeek,false,0,'AYear: Word; AMonth: Word; AWeekOfMonth: Word; ADayOfWeek: Word');
    DefineMethod('WeeksInYear',1,tkInteger,nil,__WeeksInYear,false,0,'AValue: TDateTime');
    DefineMethod('WeeksInAYear',1,tkInteger,nil,__WeeksInAYear,false,0,'AYear: Word');
    DefineMethod('DaysInYear',1,tkInteger,nil,__DaysInYear,false,0,'AValue: TDateTime');
    DefineMethod('DaysInAYear',1,tkInteger,nil,__DaysInAYear,false,0,'AYear: Word');
    DefineMethod('DaysInMonth',1,tkInteger,nil,__DaysInMonth,false,0,'AValue: TDateTime');
    DefineMethod('DaysInAMonth',2,tkInteger,nil,__DaysInAMonth,false,0,'AYear: Word; AMonth: Word');
    ...
    DefineMethod('IsToday',1,tkVariant,nil,__IsToday,false,0,'AValue: TDateTime');
    DefineMethod('IsSameDay',2,tkVariant,nil,__IsSameDay,false,0,'AValue: TDateTime; ABasis: TDateTime');
    DefineMethod('YearOf',1,tkInteger,nil,__YearOf,false,0,'AValue: TDateTime');
    DefineMethod('MonthOf',1,tkInteger,nil,__MonthOf,false,0,'AValue: TDateTime');
    DefineMethod('WeekOf',1,tkInteger,nil,__WeekOf,false,0,'AValue: TDateTime');
    DefineMethod('DayOf',1,tkInteger,nil,__DayOf,false,0,'AValue: TDateTime');
    DefineMethod('HourOf',1,tkInteger,nil,__HourOf,false,0,'AValue: TDateTime');
    DefineMethod('MinuteOf',1,tkInteger,nil,__MinuteOf,false,0,'AValue: TDateTime');
    DefineMethod('SecondOf',1,tkInteger,nil,__SecondOf,false,0,'AValue: TDateTime');
    DefineMethod('MilliSecondOf',1,tkInteger,nil,__MilliSecondOf,false,0,'AValue: TDateTime');
    DefineMethod('StartOfTheYear',1,tkVariant,nil,__StartOfTheYear,false,0,'AValue: TDateTime');
    DefineMethod('EndOfTheYear',1,tkVariant,nil,__EndOfTheYear,false,0,'AValue: TDateTime');
    DefineMethod('StartOfAYear',1,tkVariant,nil,__StartOfAYear,false,0,'AYear: Word');
    DefineMethod('EndOfAYear',1,tkVariant,nil,__EndOfAYear,false,0,'AYear: Word');
    DefineMethod('StartOfTheMonth',1,tkVariant,nil,__StartOfTheMonth,false,0,'AValue: TDateTime');
    DefineMethod('EndOfTheMonth',1,tkVariant,nil,__EndOfTheMonth,false,0,'AValue: TDateTime');
    DefineMethod('StartOfAMonth',2,tkVariant,nil,__StartOfAMonth,false,0,'AYear: Word; AMonth: Word');
    DefineMethod('EndOfAMonth',2,tkVariant,nil,__EndOfAMonth,false,0,'AYear: Word; AMonth: Word');
    DefineMethod('StartOfTheWeek',1,tkVariant,nil,__StartOfTheWeek,false,0,'AValue: TDateTime');
    DefineMethod('EndOfTheWeek',1,tkVariant,nil,__EndOfTheWeek,false,0,'AValue: TDateTime');
    DefineMethod('StartOfAWeek',3,tkVariant,nil,__StartOfAWeek,false,1,'AYear: Word; AWeekOfYear: Word; ADayOfWeek: Word = 1');
    DefineMethod('EndOfAWeek',3,tkVariant,nil,__EndOfAWeek,false,1,'AYear: Word; AWeekOfYear: Word; ADayOfWeek: Word = 7');
    DefineMethod('StartOfTheDay',1,tkVariant,nil,__StartOfTheDay,false,0,'AValue: TDateTime');
    DefineMethod('EndOfTheDay',1,tkVariant,nil,__EndOfTheDay,false,0,'AValue: TDateTime');
    DefineMethod('StartOfADay',3,tkVariant,nil,__StartOfADay,false,0,'AYear: Word; AMonth: Word; ADay: Word');
    DefineMethod('EndOfADay',3,tkVariant,nil,__EndOfADay,false,0,'AYear: Word; AMonth: Word; ADay: Word');
    DefineMethod('MonthOfTheYear',1,tkInteger,nil,__MonthOfTheYear,false,0,'AValue: TDateTime');
    DefineMethod('WeekOfTheYear',1,tkInteger,nil,__WeekOfTheYear,false,0,'AValue: TDateTime');
    DefineMethod('DayOfTheYear',1,tkInteger,nil,__DayOfTheYear,false,0,'AValue: TDateTime');
    DefineMethod('HourOfTheYear',1,tkInteger,nil,__HourOfTheYear,false,0,'AValue: TDateTime');
    DefineMethod('MinuteOfTheYear',1,tkInteger,nil,__MinuteOfTheYear,false,0,'AValue: TDateTime');
    DefineMethod('SecondOfTheYear',1,tkInteger,nil,__SecondOfTheYear,false,0,'AValue: TDateTime');
    DefineMethod('MilliSecondOfTheYear',1,tkVariant,nil,__MilliSecondOfTheYear,false,0,'AValue: TDateTime');
    DefineMethod('WeekOfTheMonth',1,tkInteger,nil,__WeekOfTheMonth,false,0,'AValue: TDateTime');
    DefineMethod('DayOfTheMonth',1,tkInteger,nil,__DayOfTheMonth,false,0,'AValue: TDateTime');
    DefineMethod('HourOfTheMonth',1,tkInteger,nil,__HourOfTheMonth,false,0,'AValue: TDateTime');
    DefineMethod('MinuteOfTheMonth',1,tkInteger,nil,__MinuteOfTheMonth,false,0,'AValue: TDateTime');
    DefineMethod('SecondOfTheMonth',1,tkInteger,nil,__SecondOfTheMonth,false,0,'AValue: TDateTime');
    DefineMethod('MilliSecondOfTheMonth',1,tkInteger,nil,__MilliSecondOfTheMonth,false,0,'AValue: TDateTime');
    DefineMethod('DayOfTheWeek',1,tkInteger,nil,__DayOfTheWeek,false,0,'AValue: TDateTime');
    DefineMethod('HourOfTheWeek',1,tkInteger,nil,__HourOfTheWeek,false,0,'AValue: TDateTime');
    DefineMethod('MinuteOfTheWeek',1,tkInteger,nil,__MinuteOfTheWeek,false,0,'AValue: TDateTime');
    DefineMethod('SecondOfTheWeek',1,tkInteger,nil,__SecondOfTheWeek,false,0,'AValue: TDateTime');
    DefineMethod('MilliSecondOfTheWeek',1,tkInteger,nil,__MilliSecondOfTheWeek,false,0,'AValue: TDateTime');
    DefineMethod('HourOfTheDay',1,tkInteger,nil,__HourOfTheDay,false,0,'AValue: TDateTime');
    DefineMethod('MinuteOfTheDay',1,tkInteger,nil,__MinuteOfTheDay,false,0,'AValue: TDateTime');
    DefineMethod('SecondOfTheDay',1,tkInteger,nil,__SecondOfTheDay,false,0,'AValue: TDateTime');
    DefineMethod('MilliSecondOfTheDay',1,tkInteger,nil,__MilliSecondOfTheDay,false,0,'AValue: TDateTime');
    DefineMethod('MinuteOfTheHour',1,tkInteger,nil,__MinuteOfTheHour,false,0,'AValue: TDateTime');
    DefineMethod('SecondOfTheHour',1,tkInteger,nil,__SecondOfTheHour,false,0,'AValue: TDateTime');
    DefineMethod('MilliSecondOfTheHour',1,tkInteger,nil,__MilliSecondOfTheHour,false,0,'AValue: TDateTime');
    DefineMethod('SecondOfTheMinute',1,tkInteger,nil,__SecondOfTheMinute,false,0,'AValue: TDateTime');
    DefineMethod('MilliSecondOfTheMinute',1,tkInteger,nil,__MilliSecondOfTheMinute,false,0,'AValue: TDateTime');
    DefineMethod('MilliSecondOfTheSecond',1,tkInteger,nil,__MilliSecondOfTheSecond,false,0,'AValue: TDateTime');
    DefineMethod('WithinPastYears',3,tkVariant,nil,__WithinPastYears,false,0,'ANow: TDateTime; AThen: TDateTime; AYears: Integer');
    DefineMethod('WithinPastMonths',3,tkVariant,nil,__WithinPastMonths,false,0,'ANow: TDateTime; AThen: TDateTime; AMonths: Integer');
    DefineMethod('WithinPastWeeks',3,tkVariant,nil,__WithinPastWeeks,false,0,'ANow: TDateTime; AThen: TDateTime; AWeeks: Integer');
    DefineMethod('WithinPastDays',3,tkVariant,nil,__WithinPastDays,false,0,'ANow: TDateTime; AThen: TDateTime; ADays: Integer');
    DefineMethod('WithinPastHours',3,tkVariant,nil,__WithinPastHours,false,0,'ANow: TDateTime; AThen: TDateTime; AHours: Int64');
    DefineMethod('WithinPastMinutes',3,tkVariant,nil,__WithinPastMinutes,false,0,'ANow: TDateTime; AThen: TDateTime; AMinutes: Int64');
    DefineMethod('WithinPastSeconds',3,tkVariant,nil,__WithinPastSeconds,false,0,'ANow: TDateTime; AThen: TDateTime; ASeconds: Int64');
    DefineMethod('WithinPastMilliSeconds',3,tkVariant,nil,__WithinPastMilliSeconds,false,0,'ANow: TDateTime; AThen: TDateTime; AMilliSeconds: Int64');
    DefineMethod('YearsBetween',2,tkInteger,nil,__YearsBetween,false,0,'ANow: TDateTime; AThen: TDateTime');
    DefineMethod('MonthsBetween',2,tkInteger,nil,__MonthsBetween,false,0,'ANow: TDateTime; AThen: TDateTime');
    DefineMethod('WeeksBetween',2,tkInteger,nil,__WeeksBetween,false,0,'ANow: TDateTime; AThen: TDateTime');
    DefineMethod('DaysBetween',2,tkInteger,nil,__DaysBetween,false,0,'ANow: TDateTime; AThen: TDateTime');
    DefineMethod('HoursBetween',2,tkVariant,nil,__HoursBetween,false,0,'ANow: TDateTime; AThen: TDateTime');
    DefineMethod('MinutesBetween',2,tkVariant,nil,__MinutesBetween,false,0,'ANow: TDateTime; AThen: TDateTime');
    DefineMethod('SecondsBetween',2,tkVariant,nil,__SecondsBetween,false,0,'ANow: TDateTime; AThen: TDateTime');
    DefineMethod('MilliSecondsBetween',2,tkVariant,nil,__MilliSecondsBetween,false,0,'ANow: TDateTime; AThen: TDateTime');
    DefineMethod('DateTimeInRange',4,tkVariant,nil,__DateTimeInRange,false,1,'ADateTime: TDateTime; AStartDateTime: TDateTime; AEndDateTime: TDateTime; aInclusive: Boolean = True');
    DefineMethod('DateInRange',4,tkVariant,nil,__DateInRange,false,1,'ADate: TDate; AStartDate: TDate; AEndDate: TDate; AInclusive: Boolean = True');
    DefineMethod('TimeInRange',4,tkVariant,nil,__TimeInRange,false,1,'ATime: TTime; AStartTime: TTime; AEndTime: TTime; AInclusive: Boolean = True');
    DefineMethod('YearSpan',2,tkVariant,nil,__YearSpan,false,0,'ANow: TDateTime; AThen: TDateTime');
    DefineMethod('MonthSpan',2,tkVariant,nil,__MonthSpan,false,0,'ANow: TDateTime; AThen: TDateTime');
    DefineMethod('WeekSpan',2,tkVariant,nil,__WeekSpan,false,0,'ANow: TDateTime; AThen: TDateTime');
    DefineMethod('DaySpan',2,tkVariant,nil,__DaySpan,false,0,'ANow: TDateTime; AThen: TDateTime');
    DefineMethod('HourSpan',2,tkVariant,nil,__HourSpan,false,0,'ANow: TDateTime; AThen: TDateTime');
    DefineMethod('MinuteSpan',2,tkVariant,nil,__MinuteSpan,false,0,'ANow: TDateTime; AThen: TDateTime');
    DefineMethod('SecondSpan',2,tkVariant,nil,__SecondSpan,false,0,'ANow: TDateTime; AThen: TDateTime');
    DefineMethod('MilliSecondSpan',2,tkVariant,nil,__MilliSecondSpan,false,0,'ANow: TDateTime; AThen: TDateTime');
    DefineMethod('IncYear',2,tkVariant,nil,__IncYear,false,1,'AValue: TDateTime; ANumberOfYears: Integer = 1');
    DefineMethod('IncWeek',2,tkVariant,nil,__IncWeek,false,1,'AValue: TDateTime; ANumberOfWeeks: Integer = 1');
    DefineMethod('IncDay',2,tkVariant,nil,__IncDay,false,1,'AValue: TDateTime; ANumberOfDays: Integer = 1');
    DefineMethod('IncHour',2,tkVariant,nil,__IncHour,false,1,'AValue: TDateTime; ANumberOfHours: Int64 = 1');
    DefineMethod('IncMinute',2,tkVariant,nil,__IncMinute,false,1,'AValue: TDateTime; ANumberOfMinutes: Int64 = 1');
    DefineMethod('IncSecond',2,tkVariant,nil,__IncSecond,false,1,'AValue: TDateTime; ANumberOfSeconds: Int64 = 1');
    DefineMethod('IncMilliSecond',2,tkVariant,nil,__IncMilliSecond,false,1,'AValue: TDateTime; ANumberOfMilliSeconds: Int64 = 1');
    DefineMethod('EncodeDateTime',7,tkVariant,nil,__EncodeDateTime,false,0,'AYear: Word; AMonth: Word; ADay: Word; AHour: Word; AMinute: Word; ASecond: Word; AMilliSecond: Word');
    DefineMethod('DecodeDateTime',8,tkNone,nil,__DecodeDateTime,false,0,'AValue: TDateTime; AYear: Word; AMonth: Word; ADay: Word; AHour: Word; AMinute: Word; ASecond: Word; AMilliSecond: Word').SetVarArgs([1,2,3,4,5,6,7]);
    DefineMethod('EncodeDateWeek',3,tkVariant,nil,__EncodeDateWeek,false,1,'AYear: Word; AWeekOfYear: Word; ADayOfWeek: Word = 1');
    DefineMethod('DecodeDateWeek',4,tkNone,nil,__DecodeDateWeek,false,0,'AValue: TDateTime; AYear: Word; AWeekOfYear: Word; ADayOfWeek: Word').SetVarArgs([1,2,3]);
    DefineMethod('EncodeDateDay',2,tkVariant,nil,__EncodeDateDay,false,0,'AYear: Word; ADayOfYear: Word');
    DefineMethod('DecodeDateDay',3,tkNone,nil,__DecodeDateDay,false,0,'AValue: TDateTime; AYear: Word; ADayOfYear: Word').SetVarArgs([1,2]);
    DefineMethod('EncodeDateMonthWeek',4,tkVariant,nil,__EncodeDateMonthWeek,false,0,'AYear: Word; AMonth: Word; AWeekOfMonth: Word; ADayOfWeek: Word');
    DefineMethod('DecodeDateMonthWeek',5,tkNone,nil,__DecodeDateMonthWeek,false,0,'AValue: TDateTime; AYear: Word; AMonth: Word; AWeekOfMonth: Word; ADayOfWeek: Word').SetVarArgs([1,2,3,4]);
    DefineMethod('TryEncodeDateTime',8,tkVariant,nil,__TryEncodeDateTime,false,0,'AYear: Word; AMonth: Word; ADay: Word; AHour: Word; AMinute: Word; ASecond: Word; AMilliSecond: Word; AValue: TDateTime').SetVarArgs([7]);
    DefineMethod('TryEncodeDateWeek',4,tkVariant,nil,__TryEncodeDateWeek,false,1,'AYear: Word; AWeekOfYear: Word; AValue: TDateTime; ADayOfWeek: Word = 1').SetVarArgs([2]);
    DefineMethod('TryEncodeDateDay',3,tkVariant,nil,__TryEncodeDateDay,false,0,'AYear: Word; ADayOfYear: Word; AValue: TDateTime').SetVarArgs([2]);
    DefineMethod('TryEncodeDateMonthWeek',5,tkVariant,nil,__TryEncodeDateMonthWeek,false,0,'AYear: Word; AMonth: Word; AWeekOfMonth: Word; ADayOfWeek: Word; AValue: TDateTime').SetVarArgs([4]);
    DefineMethod('RecodeYear',2,tkVariant,nil,__RecodeYear,false,0,'AValue: TDateTime; AYear: Word');
    DefineMethod('RecodeMonth',2,tkVariant,nil,__RecodeMonth,false,0,'AValue: TDateTime; AMonth: Word');
    DefineMethod('RecodeDay',2,tkVariant,nil,__RecodeDay,false,0,'AValue: TDateTime; ADay: Word');
    DefineMethod('RecodeHour',2,tkVariant,nil,__RecodeHour,false,0,'AValue: TDateTime; AHour: Word');
    DefineMethod('RecodeMinute',2,tkVariant,nil,__RecodeMinute,false,0,'AValue: TDateTime; AMinute: Word');
    DefineMethod('RecodeSecond',2,tkVariant,nil,__RecodeSecond,false,0,'AValue: TDateTime; ASecond: Word');
    DefineMethod('RecodeMilliSecond',2,tkVariant,nil,__RecodeMilliSecond,false,0,'AValue: TDateTime; AMilliSecond: Word');
    DefineMethod('RecodeDate',4,tkVariant,nil,__RecodeDate,false,0,'AValue: TDateTime; AYear: Word; AMonth: Word; ADay: Word');
    DefineMethod('RecodeTime',5,tkVariant,nil,__RecodeTime,false,0,'AValue: TDateTime; AHour: Word; AMinute: Word; ASecond: Word; AMilliSecond: Word');
    DefineMethod('RecodeDateTime',8,tkVariant,nil,__RecodeDateTime,false,0,'AValue: TDateTime; AYear: Word; AMonth: Word; ADay: Word; AHour: Word; AMinute: Word; ASecond: Word; AMilliSecond: Word');
    DefineMethod('TryRecodeDateTime',9,tkVariant,nil,__TryRecodeDateTime,false,0,'AValue: TDateTime; AYear: Word; AMonth: Word; ADay: Word; AHour: Word; AMinute: Word; ASecond: Word; AMilliSecond: Word; AResult: TDateTime').SetVarArgs([8]);
    DefineMethod('CompareDateTime',2,tkEnumeration,nil,__CompareDateTime,false,0,'A: TDateTime; B: TDateTime');
    DefineMethod('SameDateTime',2,tkVariant,nil,__SameDateTime,false,0,'A: TDateTime; B: TDateTime');
    DefineMethod('CompareDate',2,tkEnumeration,nil,__CompareDate,false,0,'A: TDateTime; B: TDateTime');
    DefineMethod('SameDate',2,tkVariant,nil,__SameDate,false,0,'A: TDateTime; B: TDateTime');
    DefineMethod('CompareTime',2,tkEnumeration,nil,__CompareTime,false,0,'A: TDateTime; B: TDateTime');
    DefineMethod('SameTime',2,tkVariant,nil,__SameTime,false,0,'A: TDateTime; B: TDateTime');
    DefineMethod('NthDayOfWeek',1,tkInteger,nil,__NthDayOfWeek,false,0,'AValue: TDateTime');
    DefineMethod('DecodeDayOfWeekInMonth',5,tkNone,nil,__DecodeDayOfWeekInMonth,false,0,'AValue: TDateTime; AYear: Word; AMonth: Word; ANthDayOfWeek: Word; ADayOfWeek: Word').SetVarArgs([1,2,3,4]);
    DefineMethod('EncodeDayOfWeekInMonth',4,tkVariant,nil,__EncodeDayOfWeekInMonth,false,0,'AYear: Word; AMonth: Word; ANthDayOfWeek: Word; ADayOfWeek: Word');
    DefineMethod('TryEncodeDayOfWeekInMonth',5,tkVariant,nil,__TryEncodeDayOfWeekInMonth,false,0,'AYear: Word; AMonth: Word; ANthDayOfWeek: Word; ADayOfWeek: Word; AValue: TDateTime').SetVarArgs([4]);
    DefineMethod('InvalidDateTimeError',8,tkNone,nil,__InvalidDateTimeError,false,1,'AYear: Word; AMonth: Word; ADay: Word; AHour: Word; AMinute: Word; ASecond: Word; AMilliSecond: Word; ABaseDate: TDateTime = 0');
    DefineMethod('InvalidDateWeekError',3,tkNone,nil,__InvalidDateWeekError,false,0,'AYear: Word; AWeekOfYear: Word; ADayOfWeek: Word');
    DefineMethod('InvalidDateDayError',2,tkNone,nil,__InvalidDateDayError,false,0,'AYear: Word; ADayOfYear: Word');
    DefineMethod('InvalidDateMonthWeekError',4,tkNone,nil,__InvalidDateMonthWeekError,false,0,'AYear: Word; AMonth: Word; AWeekOfMonth: Word; ADayOfWeek: Word');
    DefineMethod('InvalidDayOfWeekInMonthError',4,tkNone,nil,__InvalidDayOfWeekInMonthError,false,0,'AYear: Word; AMonth: Word; ANthDayOfWeek: Word; ADayOfWeek: Word');
    DefineMethod('DateTimeToJulianDate',1,tkVariant,nil,__DateTimeToJulianDate,false,0,'AValue: TDateTime');
    DefineMethod('JulianDateToDateTime',1,tkVariant,nil,__JulianDateToDateTime,false,0,'AValue: Double');
    DefineMethod('TryJulianDateToDateTime',2,tkVariant,nil,__TryJulianDateToDateTime,false,0,'AValue: Double; ADateTime: TDateTime').SetVarArgs([1]);
    DefineMethod('DateTimeToModifiedJulianDate',1,tkVariant,nil,__DateTimeToModifiedJulianDate,false,0,'AValue: TDateTime');
    DefineMethod('ModifiedJulianDateToDateTime',1,tkVariant,nil,__ModifiedJulianDateToDateTime,false,0,'AValue: Double');
    DefineMethod('TryModifiedJulianDateToDateTime',2,tkVariant,nil,__TryModifiedJulianDateToDateTime,false,0,'AValue: Double; ADateTime: TDateTime').SetVarArgs([1]);
    DefineMethod('DateTimeToUnix',1,tkVariant,nil,__DateTimeToUnix,false,0,'AValue: TDateTime');
    DefineMethod('UnixToDateTime',1,tkVariant,nil,__UnixToDateTime,false,0,'AValue: Int64');
    ...
    AddConstant('lttStandard',lttStandard);
    AddConstant('lttDaylight',lttDaylight);
    AddConstant('lttAmbiguous',lttAmbiguous);
    AddConstant('lttInvalid',lttInvalid);
    ...
    AddConstant('MonthJanuary',MonthJanuary);
    AddConstant('MonthFebruary',MonthFebruary);
    AddConstant('MonthMarch',MonthMarch);
    AddConstant('MonthApril',MonthApril);
    AddConstant('MonthMay',MonthMay);
    AddConstant('MonthJune',MonthJune);
    AddConstant('MonthJuly',MonthJuly);
    AddConstant('MonthAugust',MonthAugust);
    AddConstant('MonthSeptember',MonthSeptember);
    AddConstant('MonthOctober',MonthOctober);
    AddConstant('MonthNovember',MonthNovember);
    AddConstant('MonthDecember',MonthDecember);
    ...
    AddConstant('EpochAsJulianDate',EpochAsJulianDate);
    AddConstant('EpochAsUnixDate',EpochAsUnixDate);
