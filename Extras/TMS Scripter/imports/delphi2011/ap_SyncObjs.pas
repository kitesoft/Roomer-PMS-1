...
0: AResult := Integer(TSynchroObject(CurrentObject).WaitFor);
1: AResult := Integer(TSynchroObject(CurrentObject).WaitFor(VarToInteger(GetInputArg(0))));
end;
...
begin
  ...
  begin
case InputArgCount of
0: AResult := ObjectToVar(THandleObjectClass(CurrentClass.ClassRef).Create);
1: AResult := ObjectToVar(THandleObjectClass(CurrentClass.ClassRef).Create(GetInputArg(0)));
end;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(THandleObject(CurrentObject).WaitFor(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
case InputArgCount of
0: AResult := ObjectToVar(TEventClass(CurrentClass.ClassRef).Create);
1: AResult := ObjectToVar(TEventClass(CurrentClass.ClassRef).Create(GetInputArg(0)));
end;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
case InputArgCount of
0: AResult := ObjectToVar(TMutexClass(CurrentClass.ClassRef).Create);
1: AResult := ObjectToVar(TMutexClass(CurrentClass.ClassRef).Create(GetInputArg(0)));
end;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
case InputArgCount of
0: AResult := ObjectToVar(TSemaphoreClass(CurrentClass.ClassRef).Create);
1: AResult := ObjectToVar(TSemaphoreClass(CurrentClass.ClassRef).Create(GetInputArg(0)));
end;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCriticalSectionClass(CurrentClass.ClassRef).Create);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TConditionVariableMutexClass(CurrentClass.ClassRef).Create);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
case InputArgCount of
1: AResult := Integer(TConditionVariableMutex(CurrentObject).WaitFor(TMutex(VarToObject(GetInputArg(0)))));
2: AResult := Integer(TConditionVariableMutex(CurrentObject).WaitFor(TMutex(VarToObject(GetInputArg(0))),VarToInteger(GetInputArg(1))));
end;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
case InputArgCount of
1: AResult := Integer(TConditionVariableCS(CurrentObject).WaitFor(TCriticalSection(VarToObject(GetInputArg(0)))));
2: AResult := Integer(TConditionVariableCS(CurrentObject).WaitFor(TCriticalSection(VarToObject(GetInputArg(0))),VarToInteger(GetInputArg(1))));
end;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TLightweightEventClass(CurrentClass.ClassRef).Create);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
case InputArgCount of
0: AResult := Integer(TLightweightEvent(CurrentObject).WaitFor);
1: AResult := Integer(TLightweightEvent(CurrentObject).WaitFor(VarToInteger(GetInputArg(0))));
end;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
case InputArgCount of
1: AResult := ObjectToVar(TLightweightSemaphoreClass(CurrentClass.ClassRef).Create(VarToInteger(GetInputArg(0))));
2: AResult := ObjectToVar(TLightweightSemaphoreClass(CurrentClass.ClassRef).Create(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1))));
end;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
case InputArgCount of
0: AResult := Integer(TLightweightSemaphore(CurrentObject).WaitFor);
1: AResult := Integer(TLightweightSemaphore(CurrentObject).WaitFor(VarToInteger(GetInputArg(0))));
end;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCountdownEventClass(CurrentClass.ClassRef).Create(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
case InputArgCount of
0: AResult := Integer(TCountdownEvent(CurrentObject).WaitFor);
1: AResult := Integer(TCountdownEvent(CurrentObject).WaitFor(VarToInteger(GetInputArg(0))));
end;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param0 := VarToInteger(GetInputArg(0));
AResult := TInterlockedClass(CurrentClass.ClassRef).BitTestAndSet(Param0,TBitOffset(VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
begin
  ...
  begin
Param0 := VarToInteger(GetInputArg(0));
AResult := TInterlockedClass(CurrentClass.ClassRef).BitTestAndClear(Param0,TBitOffset(VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('WaitFor',1,tkEnumeration,nil,__TSynchroObjectWaitFor,false,1,'Timeout: LongWord = INFINITE');
  end;
  With Scripter.DefineClass(THandleObject) do
  begin
    DefineMethod('Create',1,tkClass,THandleObject,__THandleObjectCreate,true,1,'UseCOMWait: Boolean = False');
    DefineMethod('Destroy',0,tkNone,nil,__THandleObjectDestroy,false,0,'');
    DefineMethod('WaitFor',1,tkEnumeration,nil,__THandleObjectWaitFor,false,0,'Timeout: LongWord');
  ...
  begin
    DefineMethod('Create',1,tkClass,TEvent,__TEventCreate,true,1,'UseCOMWait: Boolean = False');
  ...
  begin
    DefineMethod('Create',1,tkClass,TMutex,__TMutexCreate,true,1,'UseCOMWait: Boolean = False');
  ...
  begin
    DefineMethod('Create',1,tkClass,TSemaphore,__TSemaphoreCreate,true,1,'UseCOMWait: Boolean = False');
  ...
  begin
    ...
    DefineMethod('WaitFor',2,tkEnumeration,nil,__TConditionVariableMutexWaitFor,false,1,'AExternalMutex: TMutex; TimeOut: LongWord = INFINITE');
  end;
  ...
  begin
    ...
    DefineMethod('WaitFor',2,tkEnumeration,nil,__TConditionVariableCSWaitFor,false,1,'CriticalSection: TCriticalSection; TimeOut: LongWord = INFINITE');
  end;
  ...
  begin
    ...
    DefineMethod('WaitFor',1,tkEnumeration,nil,__TLightweightEventWaitFor,false,1,'Timeout: LongWord = INFINITE');
  ...
  begin
    DefineMethod('Create',2,tkClass,TLightweightSemaphore,__TLightweightSemaphoreCreate,true,1,'AInitialCount: Integer; AMaxCount: Integer = MaxInt');
    DefineMethod('Destroy',0,tkNone,nil,__TLightweightSemaphoreDestroy,false,0,'');
    DefineMethod('Release',1,tkInteger,nil,__TLightweightSemaphoreRelease,false,1,'AReleaseCount: Integer = 1');
    DefineMethod('WaitFor',1,tkEnumeration,nil,__TLightweightSemaphoreWaitFor,false,1,'Timeout: LongWord = INFINITE');
  ...
  begin
    DefineMethod('Create',1,tkClass,TCountdownEvent,__TCountdownEventCreate,true,0,'Count: Integer');
    DefineMethod('Destroy',0,tkNone,nil,__TCountdownEventDestroy,false,0,'');
    DefineMethod('Signal',1,tkVariant,nil,__TCountdownEventSignal,false,1,'Count: Integer = 1');
    DefineMethod('AddCount',1,tkNone,nil,__TCountdownEventAddCount,false,1,'Count: Integer = 1');
    DefineMethod('Reset',0,tkNone,nil,__TCountdownEventReset,false,0,'');
    DefineMethod('TryAddCount',1,tkVariant,nil,__TCountdownEventTryAddCount,false,1,'Count: Integer = 1');
    DefineMethod('WaitFor',1,tkEnumeration,nil,__TCountdownEventWaitFor,false,1,'Timeout: LongWord = INFINITE');
  ...
  begin
    DefineMethod('Increment',1,tkInteger,nil,__TInterlockedIncrement,true,0,'Target: Integer').SetVarArgs([0]);
    DefineMethod('Decrement',1,tkInteger,nil,__TInterlockedDecrement,true,0,'Target: Integer').SetVarArgs([0]);
    DefineMethod('Add',2,tkInteger,nil,__TInterlockedAdd,true,0,'Target: Integer; Increment: Integer').SetVarArgs([0]);
    DefineMethod('BitTestAndSet',2,tkVariant,nil,__TInterlockedBitTestAndSet,true,0,'Target: Integer; BitOffset: TBitOffset').SetVarArgs([0]);
    DefineMethod('BitTestAndClear',2,tkVariant,nil,__TInterlockedBitTestAndClear,true,0,'Target: Integer; BitOffset: TBitOffset').SetVarArgs([0]);
    DefineMethod('Exchange',2,tkInteger,nil,__TInterlockedExchange,true,0,'Target: Integer; Value: Integer').SetVarArgs([0]);
    DefineMethod('CompareExchange',3,tkInteger,nil,__TInterlockedCompareExchange,true,0,'Target: Integer; Value: Integer; Comparand: Integer').SetVarArgs([0]);
  end;
