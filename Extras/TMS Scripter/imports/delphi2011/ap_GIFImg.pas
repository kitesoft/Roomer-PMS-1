...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TGIFItemClass(CurrentClass.ClassRef).Create(TGIFImage(VarToObject(GetInputArg(0)))));
...
begin
  with AMachine do
  begin
    TGIFItem(CurrentObject).SaveToStream(TStream(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFItem(CurrentObject).LoadFromStream(TStream(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFItem(CurrentObject).SaveToFile(VarToStr(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFItem(CurrentObject).LoadFromFile(VarToStr(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TGIFItem(CurrentObject).Version));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TGIFItem(CurrentObject).Image));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TGIFListClass(CurrentClass.ClassRef).Create);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TGIFList(CurrentObject).Add(TGIFItem(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TGIFList(CurrentObject).First);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TGIFList(CurrentObject).IndexOf(TGIFItem(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFList(CurrentObject).Insert(VarToInteger(GetInputArg(0)),TGIFItem(VarToObject(GetInputArg(1))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TGIFList(CurrentObject).Last);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TGIFList(CurrentObject).Remove(TGIFItem(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFList(CurrentObject).SaveToStream(TStream(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFList(CurrentObject).LoadFromStream(TStream(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TGIFList(CurrentObject).Items[VarToInteger(GetArrayIndex(0))]));
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFList(CurrentObject).Items[VarToInteger(GetArrayIndex(0))]:=TGIFItem(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TGIFList(CurrentObject).List));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TGIFList(CurrentObject).Image));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TGIFColorMapClass(CurrentClass.ClassRef).Create);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := integer(TGIFColorWrapper.Create(TGIFColorMapClass(CurrentClass.ClassRef).Color2RGB(TColor(VarToInteger(GetInputArg(0))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TGIFColorMapClass(CurrentClass.ClassRef).RGB2Color(TGIFColorWrapper(integer(GetInputArg(0))).ObjToRec));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFColorMap(CurrentObject).SaveToStream(TStream(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFColorMap(CurrentObject).LoadFromStream(TStream(VarToObject(GetInputArg(0))),VarToInteger(GetInputArg(1)));
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFColorMap(CurrentObject).Assign(TPersistent(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TGIFColorMap(CurrentObject).IndexOf(TColor(VarToInteger(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TGIFColorMap(CurrentObject).Add(TColor(VarToInteger(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TGIFColorMap(CurrentObject).AddUnique(TColor(VarToInteger(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TGIFColorMap(CurrentObject).Colors[VarToInteger(GetArrayIndex(0))]));
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFColorMap(CurrentObject).Colors[VarToInteger(GetArrayIndex(0))]:=TColor(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TGIFHeaderClass(CurrentClass.ClassRef).Create(TGIFImage(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFHeader(CurrentObject).Assign(TPersistent(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFHeader(CurrentObject).SaveToStream(TStream(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFHeader(CurrentObject).LoadFromStream(TStream(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TGIFHeader(CurrentObject).Version));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TGIFHeader(CurrentObject).BackgroundColor));
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFHeader(CurrentObject).BackgroundColor:=TColor(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TGIFHeader(CurrentObject).ColorMap));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TGIFExtensionClass(CurrentClass.ClassRef).Create(TGIFFrame(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFExtension(CurrentObject).Assign(TPersistent(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFExtension(CurrentObject).SaveToStream(TStream(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFExtension(CurrentObject).LoadFromStream(TStream(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TGIFExtension(CurrentObject).Frame));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TGIFExtensionListClass(CurrentClass.ClassRef).Create(TGIFFrame(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFExtensionList(CurrentObject).Assign(TPersistent(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFExtensionList(CurrentObject).LoadFromStream(TStream(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TGIFExtensionList(CurrentObject).Extensions[VarToInteger(GetArrayIndex(0))]));
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFExtensionList(CurrentObject).Extensions[VarToInteger(GetArrayIndex(0))]:=TGIFExtension(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TGIFExtensionList(CurrentObject).Frame));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TGIFFrameClass(CurrentClass.ClassRef).Create(TGIFImage(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFFrame(CurrentObject).SaveToStream(TStream(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFFrame(CurrentObject).LoadFromStream(TStream(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFFrame(CurrentObject).Assign(TPersistent(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFFrame(CurrentObject).Draw(TCanvas(VarToObject(GetInputArg(0))),TRectWrapper(integer(GetInputArg(1))).ObjToRec,GetInputArg(2),GetInputArg(3));
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFFrame(CurrentObject).StretchDraw(TCanvas(VarToObject(GetInputArg(0))),TRectWrapper(integer(GetInputArg(1))).ObjToRec,GetInputArg(2),GetInputArg(3));
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFFrame(CurrentObject).Merge(TGIFFrame(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TGIFFrame(CurrentObject).ColorMap));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TGIFFrame(CurrentObject).ActiveColorMap));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TGIFFrame(CurrentObject).Extensions));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TGIFFrame(CurrentObject).Version));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TGIFFrame(CurrentObject).Bitmap));
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFFrame(CurrentObject).Bitmap:=TBitmap(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TGIFFrame(CurrentObject).GraphicControlExtension));
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFTrailer(CurrentObject).SaveToStream(TStream(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFTrailer(CurrentObject).LoadFromStream(TStream(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TGIFGraphicControlExtensionClass(CurrentClass.ClassRef).Create(TGIFFrame(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFGraphicControlExtension(CurrentObject).SaveToStream(TStream(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFGraphicControlExtension(CurrentObject).LoadFromStream(TStream(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TGIFGraphicControlExtension(CurrentObject).TransparentColor));
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFGraphicControlExtension(CurrentObject).TransparentColor:=TColor(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TGIFGraphicControlExtension(CurrentObject).Disposal));
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFGraphicControlExtension(CurrentObject).Disposal:=TDisposalMethod(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TGIFTextExtensionClass(CurrentClass.ClassRef).Create(TGIFFrame(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFTextExtension(CurrentObject).SaveToStream(TStream(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFTextExtension(CurrentObject).LoadFromStream(TStream(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TGIFTextExtension(CurrentObject).ForegroundColor));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TGIFTextExtension(CurrentObject).BackgroundColor));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TGIFTextExtension(CurrentObject).Text));
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFTextExtension(CurrentObject).Text:=TStrings(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TGIFCommentExtensionClass(CurrentClass.ClassRef).Create(TGIFFrame(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFCommentExtension(CurrentObject).SaveToStream(TStream(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFCommentExtension(CurrentObject).LoadFromStream(TStream(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TGIFCommentExtension(CurrentObject).Text));
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFCommentExtension(CurrentObject).Text:=TStrings(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TGIFApplicationExtensionClass(CurrentClass.ClassRef).Create(TGIFFrame(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFApplicationExtension(CurrentObject).SaveToStream(TStream(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFApplicationExtension(CurrentObject).LoadFromStream(TStream(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TGIFApplicationExtension(CurrentObject).Identifier));
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFApplicationExtension(CurrentObject).Identifier:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TGIFApplicationExtension(CurrentObject).Authentication));
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFApplicationExtension(CurrentObject).Authentication:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TGIFBlockClass(CurrentClass.ClassRef).Create(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFBlock(CurrentObject).SaveToStream(TStream(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFBlock(CurrentObject).LoadFromStream(TStream(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TGIFUnknownAppExtensionClass(CurrentClass.ClassRef).Create(TGIFFrame(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TGIFUnknownAppExtension(CurrentObject).Blocks));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TGIFAppExtNSLoopClass(CurrentClass.ClassRef).Create(TGIFFrame(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TGIFImageListClass(CurrentClass.ClassRef).Create(TGIFImage(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFImageList(CurrentObject).LoadFromStream(TStream(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFImageList(CurrentObject).SaveToStream(TStream(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TGIFImageList(CurrentObject).Frames[VarToInteger(GetArrayIndex(0))]));
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFImageList(CurrentObject).Frames[VarToInteger(GetArrayIndex(0))]:=TGIFFrame(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TGIFImageClass(CurrentClass.ClassRef).Create);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFImage(CurrentObject).SaveToStream(TStream(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFImage(CurrentObject).LoadFromStream(TStream(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TGIFImage(CurrentObject).Add(TPersistent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
IntToSet(Param0, VarToInteger(GetInputArg(0)), SizeOf(Param0));
    Case InputArgCount of
      ...
      2: TGIFImage(CurrentObject).Optimize(Param0,TColorReduction(VarToInteger(GetInputArg(1))));
      3: TGIFImage(CurrentObject).Optimize(Param0,TColorReduction(VarToInteger(GetInputArg(1))),TDitherMode(VarToInteger(GetInputArg(2))));
      4: TGIFImage(CurrentObject).Optimize(Param0,TColorReduction(VarToInteger(GetInputArg(1))),TDitherMode(VarToInteger(GetInputArg(2))),VarToInteger(GetInputArg(3)));
    end;
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFImage(CurrentObject).Warning(TObject(VarToObject(GetInputArg(0))),TGIFSeverity(VarToInteger(GetInputArg(1))),VarToStr(GetInputArg(2)));
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFImage(CurrentObject).Assign(TPersistent(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFImage(CurrentObject).LoadFromClipboardFormat(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TGIFImage(CurrentObject).EffectiveBackgroundColor);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TGIFImage(CurrentObject).GlobalColorMap));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TGIFImage(CurrentObject).Version));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TGIFImage(CurrentObject).Images));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TGIFImage(CurrentObject).BackgroundColor));
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFImage(CurrentObject).BackgroundColor:=TColor(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TGIFImage(CurrentObject).DrawBackgroundColor));
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFImage(CurrentObject).DrawBackgroundColor:=TColor(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TGIFImage(CurrentObject).ColorReduction));
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFImage(CurrentObject).ColorReduction:=TColorReduction(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TGIFImage(CurrentObject).DitherMode));
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFImage(CurrentObject).DitherMode:=TDitherMode(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TGIFImage(CurrentObject).Bitmap));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TGIFImage(CurrentObject).AnimateLoop));
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFImage(CurrentObject).AnimateLoop:=TGIFAnimationLoop(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TGIFImage(CurrentObject).Dithering));
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFImage(CurrentObject).Dithering:=TGIFDithering(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomGIFRendererClass(CurrentClass.ClassRef).Create(TGIFImage(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomGIFRenderer(CurrentObject).Draw(TCanvas(VarToObject(GetInputArg(0))),TRectWrapper(integer(GetInputArg(1))).ObjToRec);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomGIFRenderer(CurrentObject).BackgroundColor));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomGIFRenderer(CurrentObject).BackgroundColor:=TColor(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomGIFRenderer(CurrentObject).Image));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomGIFRenderer(CurrentObject).TargetCanvas));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomGIFRenderer(CurrentObject).Frame));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomGIFRenderer(CurrentObject).Bitmap));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TGIFRendererClass(CurrentClass.ClassRef).Create(TGIFImage(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TGIFRenderer(CurrentObject).Draw(TCanvas(VarToObject(GetInputArg(0))),TRectWrapper(integer(GetInputArg(1))).ObjToRec);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TGIFRenderer(CurrentObject).Background));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TGIFRenderer(CurrentObject).Disposal));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TGIFRenderer(CurrentObject).PrevDisposal));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TGIFRenderer(CurrentObject).PrevFrame));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TColorLookupClass(CurrentClass.ClassRef).Create(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TFastColorLookupClass(CurrentClass.ClassRef).Create(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TSlowColorLookupClass(CurrentClass.ClassRef).Create(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TNetscapeColorLookupClass(CurrentClass.ClassRef).Create(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TGrayWindowsLookupClass(CurrentClass.ClassRef).Create(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TGrayScaleLookupClass(CurrentClass.ClassRef).Create(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TMonochromeLookupClass(CurrentClass.ClassRef).Create(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(GIFImg.ReduceColors(TBitmap(VarToObject(GetInputArg(0))),TColorReduction(VarToInteger(GetInputArg(1))),TDitherMode(VarToInteger(GetInputArg(2))),VarToInteger(GetInputArg(3)),VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(GIFImg.CreateOptimizedPaletteFromManyBitmaps(TList(VarToObject(GetInputArg(0))),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),GetInputArg(3)));
    ReturnOutputArg(AResult);
  end;
end;
...
Param1 := VarToInteger(GetInputArg(1));
Param2 := VarToInteger(GetInputArg(2));
    GIFImg.InternalGetDIBSizes(VarToInteger(GetInputArg(0)),Param1,Param2,TPixelFormat(VarToInteger(GetInputArg(3))));
    SetInputArg(1,Integer(Param1));
    SetInputArg(2,Integer(Param2));
  end;
end;
...
AResult := GIFImg.InternalGetDIB(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),Param2,Param3,TPixelFormat(VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(GIFImg.GIFImageDefaultAnimationLoop));
  end;
end;
...
begin
  with AMachine do
  begin
    GIFImg.GIFImageDefaultAnimationLoop:=TGIFAnimationLoop(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(GIFImg.GIFImageDefaultDithering));
  end;
end;
...
begin
  with AMachine do
  begin
    GIFImg.GIFImageDefaultDithering:=TGIFDithering(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(GIFImg.GIFImageDefaultColorReduction));
  end;
end;
...
begin
  with AMachine do
  begin
    GIFImg.GIFImageDefaultColorReduction:=TColorReduction(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(GIFImg.GIFImageDefaultDitherMode));
  end;
end;
...
begin
  with AMachine do
  begin
    GIFImg.GIFImageDefaultDitherMode:=TDitherMode(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(GIFImg.GIFDefaultTransparentColor));
  end;
end;
...
begin
  with AMachine do
  begin
    GIFImg.GIFDefaultTransparentColor:=TColor(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  ...
  begin
    DefineMethod('Create',1,tkClass,TGIFItem,__TGIFItemCreate,true,0,'AImage: TGIFImage');
    DefineMethod('SaveToStream',1,tkNone,nil,__TGIFItemSaveToStream,false,0,'Stream: TStream');
    DefineMethod('LoadFromStream',1,tkNone,nil,__TGIFItemLoadFromStream,false,0,'Stream: TStream');
    DefineMethod('SaveToFile',1,tkNone,nil,__TGIFItemSaveToFile,false,0,'Filename: string');
    DefineMethod('LoadFromFile',1,tkNone,nil,__TGIFItemLoadFromFile,false,0,'Filename: string');
  ...
  begin
    ...
    DefineMethod('Add',1,tkInteger,nil,__TGIFListAdd,false,0,'Item: TGIFItem');
    DefineMethod('Clear',0,tkNone,nil,__TGIFListClear,false,0,'');
    DefineMethod('Delete',1,tkNone,nil,__TGIFListDelete,false,0,'Index: Integer');
    DefineMethod('Exchange',2,tkNone,nil,__TGIFListExchange,false,0,'Index1: Integer; Index2: Integer');
    DefineMethod('First',0,tkClass,TGIFItem,__TGIFListFirst,false,0,'');
    DefineMethod('IndexOf',1,tkInteger,nil,__TGIFListIndexOf,false,0,'Item: TGIFItem');
    DefineMethod('Insert',2,tkNone,nil,__TGIFListInsert,false,0,'Index: Integer; Item: TGIFItem');
    DefineMethod('Last',0,tkClass,TGIFItem,__TGIFListLast,false,0,'');
    DefineMethod('Move',2,tkNone,nil,__TGIFListMove,false,0,'CurIndex: Integer; NewIndex: Integer');
    DefineMethod('Remove',1,tkInteger,nil,__TGIFListRemove,false,0,'Item: TGIFItem');
    DefineMethod('SaveToStream',1,tkNone,nil,__TGIFListSaveToStream,false,0,'Stream: TStream');
    DefineMethod('LoadFromStream',1,tkNone,nil,__TGIFListLoadFromStream,false,0,'Stream: TStream');
  ...
  begin
    ...
    DefineMethod('Color2RGB',1,tkVariant,nil,__TGIFColorMapColor2RGB,true,0,'Color: TColor');
    DefineMethod('RGB2Color',1,tkEnumeration,nil,__TGIFColorMapRGB2Color,true,0,'Color: TGIFColor');
    DefineMethod('SaveToStream',1,tkNone,nil,__TGIFColorMapSaveToStream,false,0,'Stream: TStream');
    DefineMethod('LoadFromStream',2,tkNone,nil,__TGIFColorMapLoadFromStream,false,0,'Stream: TStream; ACount: integer');
    DefineMethod('Assign',1,tkNone,nil,__TGIFColorMapAssign,false,0,'Source: TPersistent');
    DefineMethod('IndexOf',1,tkInteger,nil,__TGIFColorMapIndexOf,false,0,'Color: TColor');
    DefineMethod('Add',1,tkInteger,nil,__TGIFColorMapAdd,false,0,'Color: TColor');
    DefineMethod('AddUnique',1,tkInteger,nil,__TGIFColorMapAddUnique,false,0,'Color: TColor');
    DefineMethod('Delete',1,tkNone,nil,__TGIFColorMapDelete,false,0,'Index: integer');
    ...
    DefineMethod('ImportPalette',1,tkNone,nil,__TGIFColorMapImportPalette,false,0,'Palette: HPalette');
    DefineMethod('ImportDIBColors',1,tkNone,nil,__TGIFColorMapImportDIBColors,false,0,'Handle: HDC');
  ...
  begin
    DefineMethod('Create',1,tkClass,TGIFHeader,__TGIFHeaderCreate,true,0,'GIFImage: TGIFImage');
    DefineMethod('Destroy',0,tkNone,nil,__TGIFHeaderDestroy,false,0,'');
    DefineMethod('Assign',1,tkNone,nil,__TGIFHeaderAssign,false,0,'Source: TPersistent');
    DefineMethod('SaveToStream',1,tkNone,nil,__TGIFHeaderSaveToStream,false,0,'Stream: TStream');
    DefineMethod('LoadFromStream',1,tkNone,nil,__TGIFHeaderLoadFromStream,false,0,'Stream: TStream');
  ...
  begin
    DefineMethod('Create',1,tkClass,TGIFExtension,__TGIFExtensionCreate,true,0,'AFrame: TGIFFrame');
    DefineMethod('Destroy',0,tkNone,nil,__TGIFExtensionDestroy,false,0,'');
    DefineMethod('Assign',1,tkNone,nil,__TGIFExtensionAssign,false,0,'Source: TPersistent');
    DefineMethod('SaveToStream',1,tkNone,nil,__TGIFExtensionSaveToStream,false,0,'Stream: TStream');
    DefineMethod('LoadFromStream',1,tkNone,nil,__TGIFExtensionLoadFromStream,false,0,'Stream: TStream');
  ...
  begin
    DefineMethod('Create',1,tkClass,TGIFExtensionList,__TGIFExtensionListCreate,true,0,'AFrame: TGIFFrame');
    DefineMethod('Assign',1,tkNone,nil,__TGIFExtensionListAssign,false,0,'Source: TPersistent');
    DefineMethod('LoadFromStream',1,tkNone,nil,__TGIFExtensionListLoadFromStream,false,0,'Stream: TStream');
  ...
  begin
    DefineMethod('Create',1,tkClass,TGIFFrame,__TGIFFrameCreate,true,0,'GIFImage: TGIFImage');
    ...
    DefineMethod('SaveToStream',1,tkNone,nil,__TGIFFrameSaveToStream,false,0,'Stream: TStream');
    DefineMethod('LoadFromStream',1,tkNone,nil,__TGIFFrameLoadFromStream,false,0,'Stream: TStream');
    DefineMethod('Assign',1,tkNone,nil,__TGIFFrameAssign,false,0,'Source: TPersistent');
    DefineMethod('Draw',4,tkNone,nil,__TGIFFrameDraw,false,0,'ACanvas: TCanvas; Rect: TRect; DoTransparent: boolean; DoTile: boolean');
    DefineMethod('StretchDraw',4,tkNone,nil,__TGIFFrameStretchDraw,false,0,'ACanvas: TCanvas; Rect: TRect; DoTransparent: boolean; DoTile: boolean');
    DefineMethod('Crop',0,tkNone,nil,__TGIFFrameCrop,false,0,'');
    DefineMethod('Merge',1,tkNone,nil,__TGIFFrameMerge,false,0,'Previous: TGIFFrame');
    DefineMethod('ScaleRect',1,tkVariant,nil,__TGIFFrameScaleRect,false,0,'DestRect: TRect');
  ...
  begin
    DefineMethod('SaveToStream',1,tkNone,nil,__TGIFTrailerSaveToStream,false,0,'Stream: TStream');
    DefineMethod('LoadFromStream',1,tkNone,nil,__TGIFTrailerLoadFromStream,false,0,'Stream: TStream');
  end;
  With Scripter.DefineClass(TGIFGraphicControlExtension) do
  begin
    DefineMethod('Create',1,tkClass,TGIFGraphicControlExtension,__TGIFGraphicControlExtensionCreate,true,0,'AFrame: TGIFFrame');
    DefineMethod('Destroy',0,tkNone,nil,__TGIFGraphicControlExtensionDestroy,false,0,'');
    DefineMethod('SaveToStream',1,tkNone,nil,__TGIFGraphicControlExtensionSaveToStream,false,0,'Stream: TStream');
    DefineMethod('LoadFromStream',1,tkNone,nil,__TGIFGraphicControlExtensionLoadFromStream,false,0,'Stream: TStream');
  ...
  begin
    DefineMethod('Create',1,tkClass,TGIFTextExtension,__TGIFTextExtensionCreate,true,0,'ASubImage: TGIFFrame');
    DefineMethod('Destroy',0,tkNone,nil,__TGIFTextExtensionDestroy,false,0,'');
    DefineMethod('SaveToStream',1,tkNone,nil,__TGIFTextExtensionSaveToStream,false,0,'Stream: TStream');
    DefineMethod('LoadFromStream',1,tkNone,nil,__TGIFTextExtensionLoadFromStream,false,0,'Stream: TStream');
  ...
  begin
    DefineMethod('Create',1,tkClass,TGIFCommentExtension,__TGIFCommentExtensionCreate,true,0,'AFrame: TGIFFrame');
    DefineMethod('Destroy',0,tkNone,nil,__TGIFCommentExtensionDestroy,false,0,'');
    DefineMethod('SaveToStream',1,tkNone,nil,__TGIFCommentExtensionSaveToStream,false,0,'Stream: TStream');
    DefineMethod('LoadFromStream',1,tkNone,nil,__TGIFCommentExtensionLoadFromStream,false,0,'Stream: TStream');
  ...
  begin
    DefineMethod('Create',1,tkClass,TGIFApplicationExtension,__TGIFApplicationExtensionCreate,true,0,'ASubImage: TGIFFrame');
    DefineMethod('Destroy',0,tkNone,nil,__TGIFApplicationExtensionDestroy,false,0,'');
    DefineMethod('SaveToStream',1,tkNone,nil,__TGIFApplicationExtensionSaveToStream,false,0,'Stream: TStream');
    DefineMethod('LoadFromStream',1,tkNone,nil,__TGIFApplicationExtensionLoadFromStream,false,0,'Stream: TStream');
  ...
  begin
    DefineMethod('Create',1,tkClass,TGIFBlock,__TGIFBlockCreate,true,0,'ASize: integer');
    DefineMethod('Destroy',0,tkNone,nil,__TGIFBlockDestroy,false,0,'');
    DefineMethod('SaveToStream',1,tkNone,nil,__TGIFBlockSaveToStream,false,0,'Stream: TStream');
    DefineMethod('LoadFromStream',1,tkNone,nil,__TGIFBlockLoadFromStream,false,0,'Stream: TStream');
    DefineProp('Size',tkInteger,__GetTGIFBlockSize,nil,nil,false,0);
  end;
  With Scripter.DefineClass(TGIFUnknownAppExtension) do
  begin
    DefineMethod('Create',1,tkClass,TGIFUnknownAppExtension,__TGIFUnknownAppExtensionCreate,true,0,'ASubImage: TGIFFrame');
  ...
  begin
    DefineMethod('Create',1,tkClass,TGIFAppExtNSLoop,__TGIFAppExtNSLoopCreate,true,0,'AFrame: TGIFFrame');
  ...
  begin
    DefineMethod('Create',1,tkClass,TGIFImageList,__TGIFImageListCreate,true,0,'AImage: TGIFImage');
    DefineMethod('LoadFromStream',1,tkNone,nil,__TGIFImageListLoadFromStream,false,0,'Stream: TStream');
    DefineMethod('SaveToStream',1,tkNone,nil,__TGIFImageListSaveToStream,false,0,'Stream: TStream');
  ...
  begin
    ...
    DefineMethod('SaveToStream',1,tkNone,nil,__TGIFImageSaveToStream,false,0,'Stream: TStream');
    DefineMethod('LoadFromStream',1,tkNone,nil,__TGIFImageLoadFromStream,false,0,'Stream: TStream');
    DefineMethod('Add',1,tkClass,TGIFFrame,__TGIFImageAdd,false,0,'Source: TPersistent');
    ...
    DefineMethod('Optimize',4,tkNone,nil,__TGIFImageOptimize,false,3,'Options: TGIFOptimizeOptions; ColorReduction: TColorReduction = rmNone; DitherMode: TDitherMode = dmNearest; ReductionBits: integer = 8');
    DefineMethod('Clear',0,tkNone,nil,__TGIFImageClear,false,0,'');
    DefineMethod('Warning',3,tkNone,nil,__TGIFImageWarning,false,0,'Sender: TObject; Severity: TGIFSeverity; Msg: string');
    DefineMethod('Assign',1,tkNone,nil,__TGIFImageAssign,false,0,'Source: TPersistent');
    DefineMethod('LoadFromClipboardFormat',3,tkNone,nil,__TGIFImageLoadFromClipboardFormat,false,0,'AFormat: Word; AData: THandle; APalette: HPALETTE');
    DefineMethod('SaveToClipboardFormat',3,tkNone,nil,__TGIFImageSaveToClipboardFormat,false,0,'AFormat: Word; AData: THandle; APalette: HPALETTE').SetVarArgs([0,1,2]);
  ...
  begin
    DefineMethod('Create',1,tkClass,TCustomGIFRenderer,__TCustomGIFRendererCreate,true,0,'AImage: TGIFImage');
    DefineMethod('Draw',2,tkNone,nil,__TCustomGIFRendererDraw,false,0,'ACanvas: TCanvas; Rect: TRect');
  ...
  begin
    DefineMethod('Create',1,tkClass,TGIFRenderer,__TGIFRendererCreate,true,0,'AImage: TGIFImage');
    DefineMethod('Destroy',0,tkNone,nil,__TGIFRendererDestroy,false,0,'');
    DefineMethod('Draw',2,tkNone,nil,__TGIFRendererDraw,false,0,'ACanvas: TCanvas; Rect: TRect');
  ...
  begin
    DefineMethod('Create',1,tkClass,TColorLookup,__TColorLookupCreate,true,0,'Palette: hPalette');
    DefineMethod('Lookup',6,tkInteger,nil,__TColorLookupLookup,false,0,'Red: BYTE; Green: BYTE; Blue: BYTE; R: BYTE; G: BYTE; B: BYTE').SetVarArgs([3,4,5]);
    DefineProp('Colors',tkInteger,__GetTColorLookupColors,nil,nil,false,0);
  end;
  With Scripter.DefineClass(TFastColorLookup) do
  begin
    DefineMethod('Create',1,tkClass,TFastColorLookup,__TFastColorLookupCreate,true,0,'Palette: hPalette');
    DefineMethod('Destroy',0,tkNone,nil,__TFastColorLookupDestroy,false,0,'');
    DefineMethod('Lookup',6,tkInteger,nil,__TFastColorLookupLookup,false,0,'Red: BYTE; Green: BYTE; Blue: BYTE; R: BYTE; G: BYTE; B: BYTE').SetVarArgs([3,4,5]);
  end;
  With Scripter.DefineClass(TSlowColorLookup) do
  begin
    DefineMethod('Create',1,tkClass,TSlowColorLookup,__TSlowColorLookupCreate,true,0,'Palette: hPalette');
    DefineMethod('Destroy',0,tkNone,nil,__TSlowColorLookupDestroy,false,0,'');
    DefineMethod('Lookup',6,tkInteger,nil,__TSlowColorLookupLookup,false,0,'Red: BYTE; Green: BYTE; Blue: BYTE; R: BYTE; G: BYTE; B: BYTE').SetVarArgs([3,4,5]);
  end;
  With Scripter.DefineClass(TNetscapeColorLookup) do
  begin
    DefineMethod('Create',1,tkClass,TNetscapeColorLookup,__TNetscapeColorLookupCreate,true,0,'Palette: hPalette');
    DefineMethod('Lookup',6,tkInteger,nil,__TNetscapeColorLookupLookup,false,0,'Red: BYTE; Green: BYTE; Blue: BYTE; R: BYTE; G: BYTE; B: BYTE').SetVarArgs([3,4,5]);
  end;
  With Scripter.DefineClass(TGrayWindowsLookup) do
  begin
    DefineMethod('Create',1,tkClass,TGrayWindowsLookup,__TGrayWindowsLookupCreate,true,0,'Palette: hPalette');
    DefineMethod('Lookup',6,tkInteger,nil,__TGrayWindowsLookupLookup,false,0,'Red: BYTE; Green: BYTE; Blue: BYTE; R: BYTE; G: BYTE; B: BYTE').SetVarArgs([3,4,5]);
  end;
  With Scripter.DefineClass(TGrayScaleLookup) do
  begin
    DefineMethod('Create',1,tkClass,TGrayScaleLookup,__TGrayScaleLookupCreate,true,0,'Palette: hPalette');
    DefineMethod('Lookup',6,tkInteger,nil,__TGrayScaleLookupLookup,false,0,'Red: BYTE; Green: BYTE; Blue: BYTE; R: BYTE; G: BYTE; B: BYTE').SetVarArgs([3,4,5]);
  end;
  With Scripter.DefineClass(TMonochromeLookup) do
  begin
    DefineMethod('Create',1,tkClass,TMonochromeLookup,__TMonochromeLookupCreate,true,0,'Palette: hPalette');
    DefineMethod('Lookup',6,tkInteger,nil,__TMonochromeLookupLookup,false,0,'Red: BYTE; Green: BYTE; Blue: BYTE; R: BYTE; G: BYTE; B: BYTE').SetVarArgs([3,4,5]);
  end;
  ...
  begin
    ...
    DefineMethod('ReduceColors',5,tkClass,TBitmap,__ReduceColors,false,0,'Bitmap: TBitmap; ColorReduction: TColorReduction; DitherMode: TDitherMode; ReductionBits: integer; CustomPalette: hPalette');
    DefineMethod('CreateOptimizedPaletteFromManyBitmaps',4,tkInteger,nil,__CreateOptimizedPaletteFromManyBitmaps,false,0,'Bitmaps: TList; Colors: integer; ColorBits: integer; Windows: boolean');
    DefineMethod('InternalGetDIBSizes',4,tkNone,nil,__InternalGetDIBSizes,false,0,'Bitmap: HBITMAP; InfoHeaderSize: Integer; ImageSize: longInt; PixelFormat: TPixelFormat').SetVarArgs([1,2]);
    DefineMethod('InternalGetDIB',5,tkVariant,nil,__InternalGetDIB,false,0,'Bitmap: HBITMAP; Palette: HPALETTE; BitmapInfo; Bits; PixelFormat: TPixelFormat').SetVarArgs([2,3]);
