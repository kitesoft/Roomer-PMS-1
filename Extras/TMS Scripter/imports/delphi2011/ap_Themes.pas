...
type
  TatThemesLibrary = class(TatScripterLibrary)
    ...
    procedure __TThemeServicesColorToRGB(AMachine: TatVirtualMachine);
    procedure __TThemeServicesContentRect(AMachine: TatVirtualMachine);
    procedure __TThemeServicesDrawEdge(AMachine: TatVirtualMachine);
    procedure __TThemeServicesDrawElement(AMachine: TatVirtualMachine);
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TThemeServicesClass(CurrentClass.ClassRef).Create);
...
procedure TatThemesLibrary.__TThemeServicesColorToRGB(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(TThemeServices(CurrentObject).ColorToRGB(TColor(VarToInteger(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatThemesLibrary.__TThemeServicesDrawEdge(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TThemeServices(CurrentObject).DrawEdge(VarToInteger(GetInputArg(0)),TThemedElementDetailsWrapper(integer(GetInputArg(1))).ObjToRec,TRectWrapper(integer(GetInputArg(2))).ObjToRec,VarToInteger(GetInputArg(3)),VarToInteger(GetInputArg(4)));
  end;
end;

procedure TatThemesLibrary.__TThemeServicesDrawElement(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TThemeServices(CurrentObject).DrawElement(VarToInteger(GetInputArg(0)),TThemedElementDetailsWrapper(integer(GetInputArg(1))).ObjToRec,TRectWrapper(integer(GetInputArg(2))).ObjToRec);
  end;
end;
...
begin
  with AMachine do
  begin
    TThemeServices(CurrentObject).PaintBorder(TWinControl(VarToObject(GetInputArg(0))),GetInputArg(1));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TThemeServices(CurrentObject).Theme[TThemedElement(VarToInteger(GetArrayIndex(0)))]));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(Themes.ThemeServices);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Themes.ThemeControl(TControl(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Themes.UnthemedDesigner(TControl(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('ColorToRGB',1,tkInteger,nil,__TThemeServicesColorToRGB,false,0,'Color: TColor');
    DefineMethod('ContentRect',3,tkVariant,nil,__TThemeServicesContentRect,false,0,'DC: HDC; Details: TThemedElementDetails; BoundingRect: TRect');
    DefineMethod('DrawEdge',5,tkNone,nil,__TThemeServicesDrawEdge,false,0,'DC: HDC; Details: TThemedElementDetails; R: TRect; Edge: Cardinal; Flags: Cardinal');
    DefineMethod('DrawElement',3,tkNone,nil,__TThemeServicesDrawElement,false,0,'DC: HDC; Details: TThemedElementDetails; R: TRect');
    DefineMethod('DrawIcon',5,tkNone,nil,__TThemeServicesDrawIcon,false,0,'DC: HDC; Details: TThemedElementDetails; R: TRect; himl: HIMAGELIST; Index: Integer');
    DefineMethod('DrawText',6,tkNone,nil,__TThemeServicesDrawText,false,0,'DC: HDC; Details: TThemedElementDetails; S: WideString; R: TRect; Flags: Cardinal; Flags2: Cardinal');
    DefineMethod('HasTransparentParts',1,tkVariant,nil,__TThemeServicesHasTransparentParts,false,0,'Details: TThemedElementDetails');
    DefineMethod('PaintBorder',2,tkNone,nil,__TThemeServicesPaintBorder,false,0,'Control: TWinControl; EraseLRCorner: Boolean');
  ...
  begin
    ...
    DefineMethod('ThemeControl',1,tkVariant,nil,__ThemeControl,false,0,'AControl: TControl');
    DefineMethod('UnthemedDesigner',1,tkVariant,nil,__UnthemedDesigner,false,0,'AControl: TControl');
    ...
    AddConstant('tttBaloonStemUpLeft',tttBaloonStemUpLeft);
    AddConstant('tttBaloonStemDownLeft',tttBaloonStemDownLeft);
