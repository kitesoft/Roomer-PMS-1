...
type
  TatUrlMonLibrary = class(TatScripterLibrary)
    ...
    procedure __GetIID_IInternetSecurityManagerEx(AMachine: TatVirtualMachine);
    ...
    procedure __GetSID_IInternetSecurityManagerEx(AMachine: TatVirtualMachine);
    ...
    procedure __GetIID_IInternetZoneManagerEx(AMachine: TatVirtualMachine);
...
AResult := Integer(UrlMon.GetClassURL(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),TGUIDWrapper(integer(GetInputArg(1))).ObjToRec));
...
begin
  with AMachine do
  begin
AResult := Integer(UrlMon.RegisterMediaTypes(VarToInteger(GetInputArg(0)),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := Integer(UrlMon.ObtainUserAgentString(VarToInteger(GetInputArg(0)),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),Param2));
    ReturnOutputArg(AResult);
...
AResult := Integer(UrlMon.CoInternetParseUrl(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),StringToWideChar(VarToStr(GetInputArg(3)),@Param3Buf[0],Length(Param3Buf)),VarToInteger(GetInputArg(4)),Param5,VarToInteger(GetInputArg(6))));
    ReturnOutputArg(AResult);
...
SetLength(Param3Buf, Length(VarToStr(GetInputArg(3))) + 1);
Param5 := VarToInteger(GetInputArg(5));
AResult := Integer(UrlMon.CoInternetCombineUrl(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2)),StringToWideChar(VarToStr(GetInputArg(3)),@Param3Buf[0],Length(Param3Buf)),VarToInteger(GetInputArg(4)),Param5,VarToInteger(GetInputArg(6))));
    ReturnOutputArg(AResult);
    SetInputArg(5,Integer(Param5));
  end;
end;
...
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(UrlMon.CoInternetCompareUrl(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := Integer(UrlMon.CoInternetGetProtocolFlags(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),Param1,VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
...
AResult := Integer(UrlMon.CoInternetGetSecurityUrl(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),Param1,VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
...
SetLength(Param3Buf, Length(VarToStr(GetInputArg(3))) + 1);
Param5 := VarToInteger(GetInputArg(5));
AResult := Integer(UrlMon.OInetParseUrl(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),StringToWideChar(VarToStr(GetInputArg(3)),@Param3Buf[0],Length(Param3Buf)),VarToInteger(GetInputArg(4)),Param5,VarToInteger(GetInputArg(6))));
    ReturnOutputArg(AResult);
    SetInputArg(5,Integer(Param5));
  end;
end;
...
SetLength(Param3Buf, Length(VarToStr(GetInputArg(3))) + 1);
Param5 := VarToInteger(GetInputArg(5));
AResult := Integer(UrlMon.OInetCombineUrl(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2)),StringToWideChar(VarToStr(GetInputArg(3)),@Param3Buf[0],Length(Param3Buf)),VarToInteger(GetInputArg(4)),Param5,VarToInteger(GetInputArg(6))));
    ReturnOutputArg(AResult);
    SetInputArg(5,Integer(Param5));
  end;
end;
...
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(UrlMon.OInetCompareUrl(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := Integer(UrlMon.GetSoftwareUpdateInfo(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),Param1));
    ReturnOutputArg(AResult);
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Integer(UrlMon.SetSoftwareUpdateAdvertisementState(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := UrlMon.IsLoggingEnabled(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := UrlMon.IsLoggingEnabledA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := UrlMon.IsLoggingEnabledW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatUrlMonLibrary.__GetIID_IInternetSecurityManagerEx(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(integer(TGUIDWrapper.Create(UrlMon.IID_IInternetSecurityManagerEx)));
  end;
end;
...
procedure TatUrlMonLibrary.__GetSID_IInternetSecurityManagerEx(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(integer(TGUIDWrapper.Create(UrlMon.SID_IInternetSecurityManagerEx)));
  end;
end;
...
procedure TatUrlMonLibrary.__GetIID_IInternetZoneManagerEx(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(integer(TGUIDWrapper.Create(UrlMon.IID_IInternetZoneManagerEx)));
  end;
end;
...
procedure TatUrlMonLibrary.Init;
  ...
  begin
    ...
    begin
      ...
      AddConstant('URLMON_OPTION_URL_ENCODING',URLMON_OPTION_URL_ENCODING);
      AddConstant('URLMON_OPTION_USE_BINDSTRINGCREDS',URLMON_OPTION_USE_BINDSTRINGCREDS);
      ...
      AddConstant('INET_E_USE_EXTEND_BINDING',INET_E_USE_EXTEND_BINDING);
      AddConstant('INET_E_TERMINATED_BIND',INET_E_TERMINATED_BIND);
      AddConstant('INET_E_CODE_DOWNLOAD_DECLINED',INET_E_CODE_DOWNLOAD_DECLINED);
      AddConstant('INET_E_RESULT_DISPATCHED',INET_E_RESULT_DISPATCHED);
      AddConstant('INET_E_CANNOT_REPLACE_SFP_FILE',INET_E_CANNOT_REPLACE_SFP_FILE);
      AddConstant('INET_E_CODE_INSTALL_SUPPRESSED',INET_E_CODE_INSTALL_SUPPRESSED);
      ...
      AddConstant('BINDSTATUS_CONTENTDISPOSITIONATTACH',BINDSTATUS_CONTENTDISPOSITIONATTACH);
      AddConstant('BINDSTATUS_FILTERREPORTMIMETYPE',BINDSTATUS_FILTERREPORTMIMETYPE);
      AddConstant('BINDSTATUS_CLSIDCANINSTANTIATE',BINDSTATUS_CLSIDCANINSTANTIATE);
      AddConstant('BINDSTATUS_IUNKNOWNAVAILABLE',BINDSTATUS_IUNKNOWNAVAILABLE);
      AddConstant('BINDSTATUS_DIRECTBIND',BINDSTATUS_DIRECTBIND);
      AddConstant('BINDSTATUS_RAWMIMETYPE',BINDSTATUS_RAWMIMETYPE);
      AddConstant('BINDSTATUS_PROXYDETECTING',BINDSTATUS_PROXYDETECTING);
      AddConstant('BINDSTATUS_ACCEPTRANGES',BINDSTATUS_ACCEPTRANGES);
      AddConstant('BINDSTATUS_COOKIE_SENT',BINDSTATUS_COOKIE_SENT);
      AddConstant('BINDSTATUS_COMPACT_POLICY_RECEIVED',BINDSTATUS_COMPACT_POLICY_RECEIVED);
      AddConstant('BINDSTATUS_COOKIE_SUPPRESSED',BINDSTATUS_COOKIE_SUPPRESSED);
      AddConstant('BINDSTATUS_COOKIE_STATE_UNKNOWN',BINDSTATUS_COOKIE_STATE_UNKNOWN);
      AddConstant('BINDSTATUS_COOKIE_STATE_ACCEPT',BINDSTATUS_COOKIE_STATE_ACCEPT);
      AddConstant('BINDSTATUS_COOKIE_STATE_REJECT',BINDSTATUS_COOKIE_STATE_REJECT);
      AddConstant('BINDSTATUS_COOKIE_STATE_PROMPT',BINDSTATUS_COOKIE_STATE_PROMPT);
      AddConstant('BINDSTATUS_COOKIE_STATE_LEASH',BINDSTATUS_COOKIE_STATE_LEASH);
      AddConstant('BINDSTATUS_COOKIE_STATE_DOWNGRADE',BINDSTATUS_COOKIE_STATE_DOWNGRADE);
      AddConstant('BINDSTATUS_POLICY_HREF',BINDSTATUS_POLICY_HREF);
      AddConstant('BINDSTATUS_P3P_HEADER',BINDSTATUS_P3P_HEADER);
      AddConstant('BINDSTATUS_SESSION_COOKIE_RECEIVED',BINDSTATUS_SESSION_COOKIE_RECEIVED);
      AddConstant('BINDSTATUS_PERSISTENT_COOKIE_RECEIVED',BINDSTATUS_PERSISTENT_COOKIE_RECEIVED);
      AddConstant('BINDSTATUS_SESSION_COOKIES_ALLOWED',BINDSTATUS_SESSION_COOKIES_ALLOWED);
      AddConstant('BINDSTATUS_CACHECONTROL',BINDSTATUS_CACHECONTROL);
      AddConstant('BINDSTATUS_CONTENTDISPOSITIONFILENAME',BINDSTATUS_CONTENTDISPOSITIONFILENAME);
      AddConstant('BINDSTATUS_MIMETEXTPLAINMISMATCH',BINDSTATUS_MIMETEXTPLAINMISMATCH);
      AddConstant('BINDSTATUS_PUBLISHERAVAILABLE',BINDSTATUS_PUBLISHERAVAILABLE);
      AddConstant('BINDSTATUS_DISPLAYNAMEAVAILABLE',BINDSTATUS_DISPLAYNAMEAVAILABLE);
      ...
      AddConstant('CIP_NEED_REBOOT_UI_PERMISSION',CIP_NEED_REBOOT_UI_PERMISSION);
      ...
      AddConstant('QUERY_IS_SECURE',QUERY_IS_SECURE);
      AddConstant('QUERY_IS_SAFE',QUERY_IS_SAFE);
      ...
      AddConstant('MUTZ_NOSAVEDFILECHECK',MUTZ_NOSAVEDFILECHECK);
      AddConstant('MUTZ_ISFILE',MUTZ_ISFILE);
      AddConstant('MUTZ_ACCEPT_WILDCARD_SCHEME',MUTZ_ACCEPT_WILDCARD_SCHEME);
      AddConstant('MUTZ_ENFORCERESTRICTED',MUTZ_ENFORCERESTRICTED);
      AddConstant('MUTZ_REQUIRESAVEDFILECHECK',MUTZ_REQUIRESAVEDFILECHECK);
      ...
      AddConstant('PUAF_DONTCHECKBOXINDIALOG',PUAF_DONTCHECKBOXINDIALOG);
      AddConstant('PUAF_TRUSTED',PUAF_TRUSTED);
      AddConstant('PUAF_ACCEPT_WILDCARD_SCHEME',PUAF_ACCEPT_WILDCARD_SCHEME);
      AddConstant('PUAF_ENFORCERESTRICTED',PUAF_ENFORCERESTRICTED);
      AddConstant('PUAF_NOSAVEDFILECHECK',PUAF_NOSAVEDFILECHECK);
      AddConstant('PUAF_REQUIRESAVEDFILECHECK',PUAF_REQUIRESAVEDFILECHECK);
      AddConstant('PUAF_LMZ_UNLOCKED',PUAF_LMZ_UNLOCKED);
      AddConstant('PUAF_LMZ_LOCKED',PUAF_LMZ_LOCKED);
      AddConstant('PUAF_DEFAULTZONEPOL',PUAF_DEFAULTZONEPOL);
      AddConstant('PUAF_NPL_USE_LOCKED_IF_RESTRICTED',PUAF_NPL_USE_LOCKED_IF_RESTRICTED);
      AddConstant('PUAF_NOUIIFLOCKED',PUAF_NOUIIFLOCKED);
      AddConstant('PUAFOUT_DEFAULT',PUAFOUT_DEFAULT);
      AddConstant('PUAFOUT_ISLOCKZONEPOLICY',PUAFOUT_ISLOCKZONEPOLICY);
      ...
      AddConstant('URLACTION_ACTIVEX_NO_WEBOC_SCRIPT',URLACTION_ACTIVEX_NO_WEBOC_SCRIPT);
      ...
      AddConstant('URLACTION_SHELL_SHELLEXECUTE',URLACTION_SHELL_SHELLEXECUTE);
      AddConstant('URLACTION_SHELL_EXECUTE_HIGHRISK',URLACTION_SHELL_EXECUTE_HIGHRISK);
    end;
  end;
  ...
  begin
    With Scripter.DefineClass(ClassType) do
    begin
      AddConstant('URLACTION_SHELL_EXECUTE_MODRISK',URLACTION_SHELL_EXECUTE_MODRISK);
      AddConstant('URLACTION_SHELL_EXECUTE_LOWRISK',URLACTION_SHELL_EXECUTE_LOWRISK);
      AddConstant('URLACTION_SHELL_POPUPMGR',URLACTION_SHELL_POPUPMGR);
      ...
      AddConstant('URLACTION_BEHAVIOR_MIN',URLACTION_BEHAVIOR_MIN);
      AddConstant('URLACTION_BEHAVIOR_RUN',URLACTION_BEHAVIOR_RUN);
      AddConstant('URLPOLICY_BEHAVIOR_CHECK_LIST',URLPOLICY_BEHAVIOR_CHECK_LIST);
      AddConstant('URLACTION_FEATURE_MIN',URLACTION_FEATURE_MIN);
      AddConstant('URLACTION_FEATURE_MIME_SNIFFING',URLACTION_FEATURE_MIME_SNIFFING);
      AddConstant('URLACTION_FEATURE_ZONE_ELEVATION',URLACTION_FEATURE_ZONE_ELEVATION);
      AddConstant('URLACTION_FEATURE_WINDOW_RESTRICTIONS',URLACTION_FEATURE_WINDOW_RESTRICTIONS);
      AddConstant('URLACTION_AUTOMATIC_DOWNLOAD_UI_MIN',URLACTION_AUTOMATIC_DOWNLOAD_UI_MIN);
      AddConstant('URLACTION_AUTOMATIC_DOWNLOAD_UI',URLACTION_AUTOMATIC_DOWNLOAD_UI);
      AddConstant('URLACTION_AUTOMATIC_ACTIVEX_UI',URLACTION_AUTOMATIC_ACTIVEX_UI);
      AddConstant('URLACTION_ALLOW_RESTRICTEDPROTOCOLS',URLACTION_ALLOW_RESTRICTEDPROTOCOLS);
      ...
      AddConstant('ZAFLAGS_USE_LOCKED_ZONES',ZAFLAGS_USE_LOCKED_ZONES);
...
begin
  With Scripter.DefineClass(ClassType) do
  begin
    DefineMethod('GetClassURL',2,tkInteger,nil,__GetClassURL,false,0,'szURL: LPCWSTR; ClsID: TCLSID');
    DefineMethod('RegisterMediaTypes',3,tkInteger,nil,__RegisterMediaTypes,false,0,'ctypes: UINT; rgszTypes: LPCSTR; rgcfTypes: TClipFormat');
    DefineMethod('ObtainUserAgentString',3,tkInteger,nil,__ObtainUserAgentString,false,0,'dwOption: DWORD; pszUAOut: LPSTR; cbSize: DWORD').SetVarArgs([2]);
    DefineMethod('CoInternetParseUrl',7,tkInteger,nil,__CoInternetParseUrl,false,0,'pwzUrl: LPCWSTR; ParseAction: TParseAction; dwFlags: DWORD; pszResult: LPWSTR; cchResult: DWORD; pcchResult: DWORD; dwReserved: DWORD').SetVarArgs([5]);
    DefineMethod('CoInternetCombineUrl',7,tkInteger,nil,__CoInternetCombineUrl,false,0,'pwzBaseUrl: LPCWSTR; pwzRelativeUrl: LPCWSTR; dwCombineFlags: DWORD; pszResult: LPWSTR; cchResult: DWORD; pcchResult: DWORD; dwReserved: DWORD').SetVarArgs([5]);
    DefineMethod('CoInternetCompareUrl',3,tkInteger,nil,__CoInternetCompareUrl,false,0,'pwzUrl1: LPCWSTR; pwzUrl2: LPCWSTR; dwFlags: DWORD');
    DefineMethod('CoInternetGetProtocolFlags',3,tkInteger,nil,__CoInternetGetProtocolFlags,false,0,'pwzUrl: LPCWSTR; dwFlags: DWORD; dwReserved: DWORD').SetVarArgs([1]);
    DefineMethod('CoInternetGetSecurityUrl',4,tkInteger,nil,__CoInternetGetSecurityUrl,false,0,'pwzUrl: LPCWSTR; pwzSecUrl: LPWSTR; psuAction: TPSUAction; dwReserved: DWORD').SetVarArgs([1]);
    DefineMethod('OInetParseUrl',7,tkInteger,nil,__OInetParseUrl,false,0,'pwzUrl: LPCWSTR; ParseAction: TParseAction; dwFlags: DWORD; pszResult: LPWSTR; cchResult: DWORD; pcchResult: DWORD; dwReserved: DWORD').SetVarArgs([5]);
    DefineMethod('OInetCombineUrl',7,tkInteger,nil,__OInetCombineUrl,false,0,'pwzBaseUrl: LPCWSTR; pwzRelativeUrl: LPCWSTR; dwCombineFlags: DWORD; pszResult: LPWSTR; cchResult: DWORD; pcchResult: DWORD; dwReserved: DWORD').SetVarArgs([5]);
    DefineMethod('OInetCompareUrl',3,tkInteger,nil,__OInetCompareUrl,false,0,'pwzUrl1: LPCWSTR; pwzUrl2: LPCWSTR; dwFlags: DWORD');
    DefineMethod('CopyStgMedium',2,tkInteger,nil,__CopyStgMedium,false,0,'cstgmedSrc: TStgMedium; stgmedDest: TStgMedium').SetVarArgs([1]);
    DefineMethod('CopyBindInfo',2,tkInteger,nil,__CopyBindInfo,false,0,'cbiSrc: TBindInfo; biDest: TBindInfo').SetVarArgs([1]);
    DefineMethod('ReleaseBindInfo',1,tkNone,nil,__ReleaseBindInfo,false,0,'bindinfo: TBindInfo');
    DefineMethod('GetUrlPolicyPermissions',1,tkInteger,nil,__GetUrlPolicyPermissions,false,0,'dw: DWORD');
    DefineMethod('SetUrlPolicyPermissions',2,tkInteger,nil,__SetUrlPolicyPermissions,false,0,'dw: DWORD; dw2: DWORD');
    DefineMethod('GetSoftwareUpdateInfo',2,tkInteger,nil,__GetSoftwareUpdateInfo,false,0,'szDistUnit: LPCWSTR; dsi: TSoftDistInfo').SetVarArgs([1]);
    DefineMethod('SetSoftwareUpdateAdvertisementState',4,tkInteger,nil,__SetSoftwareUpdateAdvertisementState,false,0,'szDistUnit: LPCWSTR; dwAdState: DWORD; dwAdvertisedVersionMS: DWORD; dwAdvertisedVersionLS: DWORD');
    DefineMethod('IsLoggingEnabled',1,tkVariant,nil,__IsLoggingEnabled,false,0,'pszUrl: PWideChar');
    DefineMethod('IsLoggingEnabledA',1,tkVariant,nil,__IsLoggingEnabledA,false,0,'pszUrl: PAnsiChar');
    DefineMethod('IsLoggingEnabledW',1,tkVariant,nil,__IsLoggingEnabledW,false,0,'pszUrl: PWideChar');
    DefineMethod('WriteHitLogging',1,tkVariant,nil,__WriteHitLogging,false,0,'Logginginfo: THitLoggingInfo');
    ...
    DefineProp('IID_IInternetSecurityManagerEx',tkVariant,__GetIID_IInternetSecurityManagerEx,nil,nil,false,0);
    ...
    DefineProp('SID_IInternetSecurityManagerEx',tkVariant,__GetSID_IInternetSecurityManagerEx,nil,nil,false,0);
    ...
    DefineProp('IID_IInternetZoneManagerEx',tkVariant,__GetIID_IInternetZoneManagerEx,nil,nil,false,0);
