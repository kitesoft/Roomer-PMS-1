...
type
  TatImgListLibrary = class(TatScripterLibrary)
    ...
    procedure __TCustomImageListAddImage(AMachine: TatVirtualMachine);
    ...
    procedure __TCustomImageListBeginUpdate(AMachine: TatVirtualMachine);
    ...
    procedure __TCustomImageListEndUpdate(AMachine: TatVirtualMachine);
    ...
    procedure __TCustomImageListSetSize(AMachine: TatVirtualMachine);
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TChangeLink(CurrentObject).Sender));
  end;
end;
...
begin
  with AMachine do
  begin
    TChangeLink(CurrentObject).Sender:=TCustomImageList(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomImageListClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomImageListClass(CurrentClass.ClassRef).CreateSize(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomImageList(CurrentObject).Assign(TPersistent(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TCustomImageList(CurrentObject).Add(TBitmap(VarToObject(GetInputArg(0))),TBitmap(VarToObject(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TCustomImageList(CurrentObject).AddIcon(TIcon(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatImgListLibrary.__TCustomImageListAddImage(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(TCustomImageList(CurrentObject).AddImage(TCustomImageList(VarToObject(GetInputArg(0))),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomImageList(CurrentObject).AddImages(TCustomImageList(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TCustomImageList(CurrentObject).AddMasked(TBitmap(VarToObject(GetInputArg(0))),TColor(VarToInteger(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatImgListLibrary.__TCustomImageListBeginUpdate(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomImageList(CurrentObject).BeginUpdate;
  end;
end;
...
begin
  ...
  begin
    Case InputArgCount of
      4: TCustomImageList(CurrentObject).Draw(TCanvas(VarToObject(GetInputArg(0))),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)));
      5: TCustomImageList(CurrentObject).Draw(TCanvas(VarToObject(GetInputArg(0))),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)),GetInputArg(4));
    end;
  end;
end;
...
begin
  ...
  begin
    Case InputArgCount of
      5: TCustomImageList(CurrentObject).DrawOverlay(TCanvas(VarToObject(GetInputArg(0))),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)),TOverlay(VarToInteger(GetInputArg(4))));
      6: TCustomImageList(CurrentObject).DrawOverlay(TCanvas(VarToObject(GetInputArg(0))),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)),TOverlay(VarToInteger(GetInputArg(4))),GetInputArg(5));
    end;
  end;
end;

procedure TatImgListLibrary.__TCustomImageListEndUpdate(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomImageList(CurrentObject).EndUpdate;
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TCustomImageList(CurrentObject).FileLoad(TResType(VarToInteger(GetInputArg(0))),VarToStr(GetInputArg(1)),TColor(VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TCustomImageList(CurrentObject).GetBitmap(VarToInteger(GetInputArg(0)),TBitmap(VarToObject(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomImageList(CurrentObject).GetIcon(VarToInteger(GetInputArg(0)),TIcon(VarToObject(GetInputArg(1))));
  end;
end;
...
AResult := TCustomImageList(CurrentObject).GetResource(TResType(VarToInteger(GetInputArg(0))),VarToStr(GetInputArg(1)),VarToInteger(GetInputArg(2)),Param3,TColor(VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomImageList(CurrentObject).Insert(VarToInteger(GetInputArg(0)),TBitmap(VarToObject(GetInputArg(1))),TBitmap(VarToObject(GetInputArg(2))));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomImageList(CurrentObject).InsertIcon(VarToInteger(GetInputArg(0)),TIcon(VarToObject(GetInputArg(1))));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomImageList(CurrentObject).InsertMasked(VarToInteger(GetInputArg(0)),TBitmap(VarToObject(GetInputArg(1))),TColor(VarToInteger(GetInputArg(2))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TCustomImageList(CurrentObject).Overlay(VarToInteger(GetInputArg(0)),TOverlay(VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomImageList(CurrentObject).RegisterChanges(TChangeLink(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TCustomImageList(CurrentObject).ResourceLoad(TResType(VarToInteger(GetInputArg(0))),VarToStr(GetInputArg(1)),TColor(VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TCustomImageList(CurrentObject).ResInstLoad(VarToInteger(GetInputArg(0)),TResType(VarToInteger(GetInputArg(1))),VarToStr(GetInputArg(2)),TColor(VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomImageList(CurrentObject).Replace(VarToInteger(GetInputArg(0)),TBitmap(VarToObject(GetInputArg(1))),TBitmap(VarToObject(GetInputArg(2))));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomImageList(CurrentObject).ReplaceIcon(VarToInteger(GetInputArg(0)),TIcon(VarToObject(GetInputArg(1))));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomImageList(CurrentObject).ReplaceMasked(VarToInteger(GetInputArg(0)),TBitmap(VarToObject(GetInputArg(1))),TColor(VarToInteger(GetInputArg(2))));
  end;
end;

procedure TatImgListLibrary.__TCustomImageListSetSize(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomImageList(CurrentObject).SetSize(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomImageList(CurrentObject).UnRegisterChanges(TChangeLink(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomImageList(CurrentObject).BlendColor));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomImageList(CurrentObject).BlendColor:=TColor(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomImageList(CurrentObject).BkColor));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomImageList(CurrentObject).BkColor:=TColor(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomImageList(CurrentObject).DrawingStyle));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomImageList(CurrentObject).DrawingStyle:=TDrawingStyle(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomImageList(CurrentObject).ImageType));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomImageList(CurrentObject).ImageType:=TImageType(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  ...
  begin
    DefineMethod('Create',1,tkClass,TCustomImageList,__TCustomImageListCreate,true,0,'AOwner: TComponent');
    DefineMethod('CreateSize',2,tkClass,TCustomImageList,__TCustomImageListCreateSize,true,0,'AWidth: Integer; AHeight: Integer');
    DefineMethod('Destroy',0,tkNone,nil,__TCustomImageListDestroy,false,0,'');
    DefineMethod('Assign',1,tkNone,nil,__TCustomImageListAssign,false,0,'Source: TPersistent');
    DefineMethod('Add',2,tkInteger,nil,__TCustomImageListAdd,false,0,'Image: TBitmap; Mask: TBitmap');
    DefineMethod('AddIcon',1,tkInteger,nil,__TCustomImageListAddIcon,false,0,'Image: TIcon');
    DefineMethod('AddImage',2,tkInteger,nil,__TCustomImageListAddImage,false,0,'Value: TCustomImageList; Index: Integer');
    DefineMethod('AddImages',1,tkNone,nil,__TCustomImageListAddImages,false,0,'Value: TCustomImageList');
    DefineMethod('AddMasked',2,tkInteger,nil,__TCustomImageListAddMasked,false,0,'Image: TBitmap; MaskColor: TColor');
    DefineMethod('BeginUpdate',0,tkNone,nil,__TCustomImageListBeginUpdate,false,0,'');
    DefineMethod('Clear',0,tkNone,nil,__TCustomImageListClear,false,0,'');
    DefineMethod('Delete',1,tkNone,nil,__TCustomImageListDelete,false,0,'Index: Integer');
    DefineMethod('Draw',5,tkNone,nil,__TCustomImageListDraw,false,1,'Canvas: TCanvas; X: Integer; Y: Integer; Index: Integer; Enabled: Boolean = True');
    DefineMethod('DrawOverlay',6,tkNone,nil,__TCustomImageListDrawOverlay,false,1,'Canvas: TCanvas; X: Integer; Y: Integer; ImageIndex: Integer; Overlay: TOverlay; Enabled: Boolean = True');
    DefineMethod('EndUpdate',0,tkNone,nil,__TCustomImageListEndUpdate,false,0,'');
    DefineMethod('FileLoad',3,tkVariant,nil,__TCustomImageListFileLoad,false,0,'ResType: TResType; Name: string; MaskColor: TColor');
    DefineMethod('GetBitmap',2,tkVariant,nil,__TCustomImageListGetBitmap,false,0,'Index: Integer; Image: TBitmap');
    DefineMethod('GetHotSpot',0,tkVariant,nil,__TCustomImageListGetHotSpot,false,0,'');
    DefineMethod('GetIcon',2,tkNone,nil,__TCustomImageListGetIcon,false,0,'Index: Integer; Image: TIcon');
    ...
    DefineMethod('GetResource',5,tkVariant,nil,__TCustomImageListGetResource,false,0,'ResType: TResType; Name: string; Width: Integer; LoadFlags: TLoadResources; MaskColor: TColor');
    DefineMethod('HandleAllocated',0,tkVariant,nil,__TCustomImageListHandleAllocated,false,0,'');
    DefineMethod('Insert',3,tkNone,nil,__TCustomImageListInsert,false,0,'Index: Integer; Image: TBitmap; Mask: TBitmap');
    DefineMethod('InsertIcon',2,tkNone,nil,__TCustomImageListInsertIcon,false,0,'Index: Integer; Image: TIcon');
    DefineMethod('InsertMasked',3,tkNone,nil,__TCustomImageListInsertMasked,false,0,'Index: Integer; Image: TBitmap; MaskColor: TColor');
    DefineMethod('Move',2,tkNone,nil,__TCustomImageListMove,false,0,'CurIndex: Integer; NewIndex: Integer');
    DefineMethod('Overlay',2,tkVariant,nil,__TCustomImageListOverlay,false,0,'ImageIndex: Integer; Overlay: TOverlay');
    DefineMethod('RegisterChanges',1,tkNone,nil,__TCustomImageListRegisterChanges,false,0,'Value: TChangeLink');
    DefineMethod('ResourceLoad',3,tkVariant,nil,__TCustomImageListResourceLoad,false,0,'ResType: TResType; Name: string; MaskColor: TColor');
    DefineMethod('ResInstLoad',4,tkVariant,nil,__TCustomImageListResInstLoad,false,0,'Instance: THandle; ResType: TResType; Name: string; MaskColor: TColor');
    DefineMethod('Replace',3,tkNone,nil,__TCustomImageListReplace,false,0,'Index: Integer; Image: TBitmap; Mask: TBitmap');
    DefineMethod('ReplaceIcon',2,tkNone,nil,__TCustomImageListReplaceIcon,false,0,'Index: Integer; Image: TIcon');
    DefineMethod('ReplaceMasked',3,tkNone,nil,__TCustomImageListReplaceMasked,false,0,'Index: Integer; NewImage: TBitmap; MaskColor: TColor');
    DefineMethod('SetSize',2,tkNone,nil,__TCustomImageListSetSize,false,0,'AWidth: Integer; AHeight: Integer');
    DefineMethod('UnRegisterChanges',1,tkNone,nil,__TCustomImageListUnRegisterChanges,false,0,'Value: TChangeLink');
  ...
  begin
    ...
    AddConstant('cdDefault',cdDefault);
    AddConstant('cdDeviceDependent',cdDeviceDependent);
    AddConstant('cd4Bit',cd4Bit);
    AddConstant('cd8Bit',cd8Bit);
    AddConstant('cd16Bit',cd16Bit);
    AddConstant('cd24Bit',cd24Bit);
    AddConstant('cd32Bit',cd32Bit);
  end;
end;
