...
AResult := Integer(IClassFactory(CurrentObject).CreateInstance(IUnknown(VarToObject(GetInputArg(0))),TGUIDWrapper(integer(GetInputArg(1))).ObjToRec,Param2));
    ReturnOutputArg(AResult);
...
begin
  ...
  begin
Param2 := GetInputArg(2);
AResult := Integer(IMarshal(CurrentObject).UnmarshalInterface(IStream(VarToObject(GetInputArg(0))),TGUIDWrapper(integer(GetInputArg(1))).ObjToRec,Param2));
    ReturnOutputArg(AResult);
    SetInputArg(2,Param2);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(IMarshal(CurrentObject).ReleaseMarshalData(IStream(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(IWeakRef(CurrentObject).ReleaseKeepAlive(IUnknown(VarToObject(GetInputArg(0))),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
Param0 := IEnumUnknown(VarToObject(GetInputArg(0)));
AResult := Integer(IEnumUnknown(CurrentObject).Clone(Param0));
    ReturnOutputArg(AResult);
    SetInputArg(0,ObjectToVar(Param0));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(IBindCtx(CurrentObject).RegisterObjectBound(IUnknown(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(IBindCtx(CurrentObject).RevokeObjectBound(IUnknown(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
Param0 := IRunningObjectTable(VarToObject(GetInputArg(0)));
...
AResult := Integer(IBindCtx(CurrentObject).RegisterObjectParam(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),IUnknown(VarToObject(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
Param1 := IUnknown(VarToObject(GetInputArg(1)));
AResult := Integer(IBindCtx(CurrentObject).GetObjectParam(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),Param1));
    ReturnOutputArg(AResult);
...
begin
  with AMachine do
  begin
Param0 := IEnumString(VarToObject(GetInputArg(0)));
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Integer(IBindCtx(CurrentObject).RevokeObjectParam(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
Param0 := IEnumMoniker(VarToObject(GetInputArg(0)));
...
begin
  with AMachine do
  begin
AResult := Integer(IRunnableObject(CurrentObject).Run(IBindCtx(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := Integer(IRunningObjectTable(CurrentObject).Register(VarToInteger(GetInputArg(0)),Param1,IMoniker(VarToObject(GetInputArg(2))),Param3));
    ReturnOutputArg(AResult);
    SetInputArg(1,ObjectToVar(Param1));
...
begin
  with AMachine do
  begin
AResult := Integer(IRunningObjectTable(CurrentObject).IsRunning(IMoniker(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param1 := IUnknown(VarToObject(GetInputArg(1)));
AResult := Integer(IRunningObjectTable(CurrentObject).GetObject(IMoniker(VarToObject(GetInputArg(0))),Param1));
    ReturnOutputArg(AResult);
    SetInputArg(1,ObjectToVar(Param1));
  end;
end;
...
if not Assigned(Param1Rec) or not (Param1Rec is _FILETIMEWrapper) then 
  Param1Rec := _FILETIMEWrapper.Create(Param1);
Param1 := _FILETIMEWrapper(Param1Rec).ObjToRec;
AResult := Integer(IRunningObjectTable(CurrentObject).GetTimeOfLastChange(IMoniker(VarToObject(GetInputArg(0))),Param1));
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(_FILETIMEWrapper.Create(Param1)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(IPersistStream(CurrentObject).Load(IStream(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(IPersistStream(CurrentObject).Save(IStream(VarToObject(GetInputArg(0))),GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := Integer(IMoniker(CurrentObject).BindToObject(IBindCtx(VarToObject(GetInputArg(0))),IMoniker(VarToObject(GetInputArg(1))),TGUIDWrapper(integer(GetInputArg(2))).ObjToRec,Param3));
    ReturnOutputArg(AResult);
...
begin
  ...
  begin
Param3 := GetInputArg(3);
AResult := Integer(IMoniker(CurrentObject).BindToStorage(IBindCtx(VarToObject(GetInputArg(0))),IMoniker(VarToObject(GetInputArg(1))),TGUIDWrapper(integer(GetInputArg(2))).ObjToRec,Param3));
    ReturnOutputArg(AResult);
    SetInputArg(3,Param3);
  end;
end;
...
begin
  with AMachine do
  begin
Param2 := IMoniker(VarToObject(GetInputArg(2)));
Param3 := IMoniker(VarToObject(GetInputArg(3)));
AResult := Integer(IMoniker(CurrentObject).Reduce(IBindCtx(VarToObject(GetInputArg(0))),VarToInteger(GetInputArg(1)),Param2,Param3));
    ReturnOutputArg(AResult);
    SetInputArg(2,ObjectToVar(Param2));
    SetInputArg(3,ObjectToVar(Param3));
  end;
end;
...
begin
  ...
  begin
Param2 := IMoniker(VarToObject(GetInputArg(2)));
AResult := Integer(IMoniker(CurrentObject).ComposeWith(IMoniker(VarToObject(GetInputArg(0))),GetInputArg(1),Param2));
    ReturnOutputArg(AResult);
    SetInputArg(2,ObjectToVar(Param2));
  end;
end;
...
begin
  with AMachine do
  begin
Param1 := IEnumMoniker(VarToObject(GetInputArg(1)));
...
begin
  with AMachine do
  begin
AResult := Integer(IMoniker(CurrentObject).IsEqual(IMoniker(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(IMoniker(CurrentObject).IsRunning(IBindCtx(VarToObject(GetInputArg(0))),IMoniker(VarToObject(GetInputArg(1))),IMoniker(VarToObject(GetInputArg(2)))));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := Integer(IMoniker(CurrentObject).GetTimeOfLastChange(IBindCtx(VarToObject(GetInputArg(0))),IMoniker(VarToObject(GetInputArg(1))),Param2));
    ReturnOutputArg(AResult);
...
begin
  with AMachine do
  begin
Param0 := IMoniker(VarToObject(GetInputArg(0)));
...
begin
  with AMachine do
  begin
Param1 := IMoniker(VarToObject(GetInputArg(1)));
AResult := Integer(IMoniker(CurrentObject).CommonPrefixWith(IMoniker(VarToObject(GetInputArg(0))),Param1));
    ReturnOutputArg(AResult);
    SetInputArg(1,ObjectToVar(Param1));
  end;
end;
...
begin
  ...
  begin
Param1 := IMoniker(VarToObject(GetInputArg(1)));
AResult := Integer(IMoniker(CurrentObject).RelativePathTo(IMoniker(VarToObject(GetInputArg(0))),Param1));
    ReturnOutputArg(AResult);
    SetInputArg(1,ObjectToVar(Param1));
  end;
end;
...
Param2 := StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf));
AResult := Integer(IMoniker(CurrentObject).GetDisplayName(IBindCtx(VarToObject(GetInputArg(0))),IMoniker(VarToObject(GetInputArg(1))),Param2));
    ReturnOutputArg(AResult);
...
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
Param3 := VarToInteger(GetInputArg(3));
Param4 := IMoniker(VarToObject(GetInputArg(4)));
AResult := Integer(IMoniker(CurrentObject).ParseDisplayName(IBindCtx(VarToObject(GetInputArg(0))),IMoniker(VarToObject(GetInputArg(1))),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)),Param3,Param4));
    ReturnOutputArg(AResult);
    SetInputArg(3,Integer(Param3));
    SetInputArg(4,ObjectToVar(Param4));
  end;
end;
...
Param2 := GetInputArg(2);
Param3 := GetInputArg(3);
AResult := Integer(IStream(CurrentObject).CopyTo(IStream(VarToObject(GetInputArg(0))),GetInputArg(1),Param2,Param3));
    ReturnOutputArg(AResult);
    SetInputArg(2,Param2);
    SetInputArg(3,Param3);
  end;
...
begin
  with AMachine do
  begin
Param0 := IStream(VarToObject(GetInputArg(0)));
...
begin
  with AMachine do
  begin
Param0 := IEnumStatStg(VarToObject(GetInputArg(0)));
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
Param4 := IStream(VarToObject(GetInputArg(4)));
AResult := Integer(IStorage(CurrentObject).CreateStream(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)),Param4));
    ReturnOutputArg(AResult);
    SetInputArg(4,ObjectToVar(Param4));
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
Param4 := IStorage(VarToObject(GetInputArg(4)));
AResult := Integer(IStorage(CurrentObject).CreateStorage(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)),Param4));
    ReturnOutputArg(AResult);
    SetInputArg(4,ObjectToVar(Param4));
  end;
end;
...
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
AResult := Integer(IStorage(CurrentObject).MoveElementTo(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),IStorage(VarToObject(GetInputArg(1))),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Integer(IStorage(CurrentObject).DestroyElement(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := Integer(IStorage(CurrentObject).RenameElement(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Integer(IStorage(CurrentObject).SetElementTimes(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),_FILETIMEWrapper(integer(GetInputArg(1))).ObjToRec,_FILETIMEWrapper(integer(GetInputArg(2))).ObjToRec,_FILETIMEWrapper(integer(GetInputArg(3))).ObjToRec));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Integer(IPersistFile(CurrentObject).Load(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Integer(IPersistFile(CurrentObject).Save(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Integer(IPersistFile(CurrentObject).SaveCompleted(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(IPersistStorage(CurrentObject).InitNew(IStorage(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(IPersistStorage(CurrentObject).Load(IStorage(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(IPersistStorage(CurrentObject).Save(IStorage(VarToObject(GetInputArg(0))),GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(IPersistStorage(CurrentObject).SaveCompleted(IStorage(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
Param0 := IEnumFormatEtc(VarToObject(GetInputArg(0)));
...
begin
  with AMachine do
  begin
Param0 := IEnumStatData(VarToObject(GetInputArg(0)));
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Integer(IRootStorage(CurrentObject).SwitchToFile(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    IAdviseSink(CurrentObject).OnRename(IMoniker(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    IAdviseSink2(CurrentObject).OnLinkSrcChange(IMoniker(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
Param1 := IEnumFormatEtc(VarToObject(GetInputArg(1)));
...
Param0 := tagFORMATETCWrapper(Param0Rec).ObjToRec;
Param3 := VarToInteger(GetInputArg(3));
AResult := Integer(IDataObject(CurrentObject).DAdvise(Param0,VarToInteger(GetInputArg(1)),IAdviseSink(VarToObject(GetInputArg(2))),Param3));
    ReturnOutputArg(AResult);
    SetInputArg(0,integer(tagFORMATETCWrapper.Create(Param0)));
    SetInputArg(3,Integer(Param3));
  end;
...
AResult := Integer(IDataAdviseHolder(CurrentObject).Advise(IDataObject(VarToObject(GetInputArg(0))),Param1,VarToInteger(GetInputArg(2)),IAdviseSink(VarToObject(GetInputArg(3))),Param4));
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(tagFORMATETCWrapper.Create(Param1)));
...
begin
  with AMachine do
  begin
AResult := Integer(IDataAdviseHolder(CurrentObject).SendOnDataChange(IDataObject(VarToObject(GetInputArg(0))),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(IRpcProxyBuffer(CurrentObject).Connect(IRpcChannelBuffer(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(IRpcStubBuffer(CurrentObject).Connect(IUnknown(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
if not Assigned(Param0Rec) or not (Param0Rec is tagRPCOLEMESSAGEWrapper) then 
  Param0Rec := tagRPCOLEMESSAGEWrapper.Create(Param0);
Param0 := tagRPCOLEMESSAGEWrapper(Param0Rec).ObjToRec;
AResult := Integer(IRpcStubBuffer(CurrentObject).Invoke(Param0,IRpcChannelBuffer(VarToObject(GetInputArg(1)))));
    ReturnOutputArg(AResult);
    SetInputArg(0,integer(tagRPCOLEMESSAGEWrapper.Create(Param0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(IRpcStubBuffer(CurrentObject).IsIIDSupported(TGUIDWrapper(integer(GetInputArg(0))).ObjToRec));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
Param2 := IRpcProxyBuffer(VarToObject(GetInputArg(2)));
Param3 := GetInputArg(3);
AResult := Integer(IPSFactoryBuffer(CurrentObject).CreateProxy(IUnknown(VarToObject(GetInputArg(0))),TGUIDWrapper(integer(GetInputArg(1))).ObjToRec,Param2,Param3));
    ReturnOutputArg(AResult);
    SetInputArg(2,ObjectToVar(Param2));
    SetInputArg(3,Param3);
  end;
...
begin
  with AMachine do
  begin
Param2 := IRpcStubBuffer(VarToObject(GetInputArg(2)));
AResult := Integer(IPSFactoryBuffer(CurrentObject).CreateStub(TGUIDWrapper(integer(GetInputArg(0))).ObjToRec,IUnknown(VarToObject(GetInputArg(1))),Param2));
    ReturnOutputArg(AResult);
    SetInputArg(2,ObjectToVar(Param2));
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Integer(ICreateTypeInfo(CurrentObject).SetDocString(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param1 := VarToInteger(GetInputArg(1));
AResult := Integer(ICreateTypeInfo(CurrentObject).AddRefTypeInfo(ITypeInfo(VarToObject(GetInputArg(0))),Param1));
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Integer(ICreateTypeInfo(CurrentObject).SetSchema(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(ICreateTypeInfo(CurrentObject).SetVarName(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
AResult := Integer(ICreateTypeInfo(CurrentObject).DefineFuncAsDllEntry(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(ICreateTypeInfo(CurrentObject).SetFuncDocString(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(ICreateTypeInfo(CurrentObject).SetVarDocString(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(ICreateTypeInfo(CurrentObject).SetMops(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
Param2 := ICreateTypeInfo(VarToObject(GetInputArg(2)));
AResult := Integer(ICreateTypeLib(CurrentObject).CreateTypeInfo(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)),Param2));
    ReturnOutputArg(AResult);
    SetInputArg(2,ObjectToVar(Param2));
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Integer(ICreateTypeLib(CurrentObject).SetName(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Integer(ICreateTypeLib(CurrentObject).SetDocString(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Integer(ICreateTypeLib(CurrentObject).SetHelpFileName(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
Param2 := ITypeInfo(VarToObject(GetInputArg(2)));
...
begin
  with AMachine do
  begin
Param0 := IEnumVariant(VarToObject(GetInputArg(0)));
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
Param3 := ITypeInfo(VarToObject(GetInputArg(3)));
Param4 := VarToInteger(GetInputArg(4));
...
AResult := Integer(ITypeComp(CurrentObject).Bind(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),Param3,Param4,Param5));
    ReturnOutputArg(AResult);
    SetInputArg(3,ObjectToVar(Param3));
    SetInputArg(4,Integer(Param4));
...
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
Param2 := ITypeInfo(VarToObject(GetInputArg(2)));
Param3 := ITypeComp(VarToObject(GetInputArg(3)));
AResult := Integer(ITypeComp(CurrentObject).BindType(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)),Param2,Param3));
    ReturnOutputArg(AResult);
    SetInputArg(2,ObjectToVar(Param2));
    SetInputArg(3,ObjectToVar(Param3));
  end;
...
begin
  with AMachine do
  begin
Param0 := ITypeComp(VarToObject(GetInputArg(0)));
...
begin
  with AMachine do
  begin
Param1 := ITypeInfo(VarToObject(GetInputArg(1)));
...
begin
  ...
  begin
Param2 := GetInputArg(2);
AResult := Integer(ITypeInfo(CurrentObject).CreateInstance(IUnknown(VarToObject(GetInputArg(0))),TGUIDWrapper(integer(GetInputArg(1))).ObjToRec,Param2));
    ReturnOutputArg(AResult);
    SetInputArg(2,Param2);
  end;
end;
...
begin
  with AMachine do
  begin
Param0 := ITypeLib(VarToObject(GetInputArg(0)));
Param1 := VarToInteger(GetInputArg(1));
...
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
Param2 := GetInputArg(2);
AResult := Integer(ITypeLib(CurrentObject).IsName(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)),Param2));
    ReturnOutputArg(AResult);
    SetInputArg(2,Param2);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Integer(ICreateErrorInfo(CurrentObject).SetSource(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Integer(ICreateErrorInfo(CurrentObject).SetDescription(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Integer(ICreateErrorInfo(CurrentObject).SetHelpFile(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param1 := VarToInteger(GetInputArg(1));
AResult := Integer(IOleAdviseHolder(CurrentObject).Advise(IAdviseSink(VarToObject(GetInputArg(0))),Param1));
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(IOleAdviseHolder(CurrentObject).SendOnRename(IMoniker(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(IOleCache(CurrentObject).InitCache(IDataObject(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(IOleCacheControl(CurrentObject).OnRun(IDataObject(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
Param2 := VarToInteger(GetInputArg(2));
Param3 := IMoniker(VarToObject(GetInputArg(3)));
AResult := Integer(IParseDisplayName(CurrentObject).ParseDisplayName(IBindCtx(VarToObject(GetInputArg(0))),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),Param2,Param3));
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
    SetInputArg(3,ObjectToVar(Param3));
  end;
...
begin
  with AMachine do
  begin
Param1 := IEnumUnknown(VarToObject(GetInputArg(1)));
...
begin
  with AMachine do
  begin
Param0 := IOleContainer(VarToObject(GetInputArg(0)));
...
begin
  with AMachine do
  begin
AResult := Integer(IOleObject(CurrentObject).SetClientSite(IOleClientSite(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
Param0 := IOleClientSite(VarToObject(GetInputArg(0)));
...
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(IOleObject(CurrentObject).SetHostNames(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(IOleObject(CurrentObject).SetMoniker(VarToInteger(GetInputArg(0)),IMoniker(VarToObject(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(IOleObject(CurrentObject).InitFromData(IDataObject(VarToObject(GetInputArg(0))),GetInputArg(1),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
Param1 := IDataObject(VarToObject(GetInputArg(1)));
...
begin
  with AMachine do
  begin
Param0 := IEnumOleVerb(VarToObject(GetInputArg(0)));
...
begin
  ...
  begin
Param1 := VarToInteger(GetInputArg(1));
AResult := Integer(IOleObject(CurrentObject).Advise(IAdviseSink(VarToObject(GetInputArg(0))),Param1));
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(IOleLink(CurrentObject).SetSourceMoniker(IMoniker(VarToObject(GetInputArg(0))),TGUIDWrapper(integer(GetInputArg(1))).ObjToRec));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Integer(IOleLink(CurrentObject).SetSourceDisplayName(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(IOleLink(CurrentObject).BindToSource(VarToInteger(GetInputArg(0)),IBindCtx(VarToObject(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
Param0 := IUnknown(VarToObject(GetInputArg(0)));
...
begin
  with AMachine do
  begin
AResult := Integer(IOleLink(CurrentObject).Update(IBindCtx(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := Integer(IOleItemContainer(CurrentObject).GetObject(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)),IBindCtx(VarToObject(GetInputArg(2))),TGUIDWrapper(integer(GetInputArg(3))).ObjToRec,Param4));
    ReturnOutputArg(AResult);
...
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
Param3 := GetInputArg(3);
AResult := Integer(IOleItemContainer(CurrentObject).GetObjectStorage(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),IBindCtx(VarToObject(GetInputArg(1))),TGUIDWrapper(integer(GetInputArg(2))).ObjToRec,Param3));
    ReturnOutputArg(AResult);
    SetInputArg(3,Param3);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Integer(IOleItemContainer(CurrentObject).IsRunning(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(IOleInPlaceUIWindow(CurrentObject).SetActiveObject(IOleInPlaceActiveObject(VarToObject(GetInputArg(0))),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(IOleInPlaceActiveObject(CurrentObject).ResizeBorder(TRectWrapper(integer(GetInputArg(0))).ObjToRec,IOleInPlaceUIWindow(VarToObject(GetInputArg(1))),GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Integer(IOleInPlaceFrame(CurrentObject).SetStatusText(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
Param0 := IOleInPlaceFrame(VarToObject(GetInputArg(0)));
Param1 := IOleInPlaceUIWindow(VarToObject(GetInputArg(1)));
Param2Rec := TObject(integer(GetInputArg(2)));
...
begin
  with AMachine do
  begin
AResult := Integer(IViewObject(CurrentObject).SetAdvise(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),IAdviseSink(VarToObject(GetInputArg(2)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param3 := VarToInteger(GetInputArg(3));
AResult := Integer(IDropTarget(CurrentObject).DragEnter(IDataObject(VarToObject(GetInputArg(0))),VarToInteger(GetInputArg(1)),TPointWrapper(integer(GetInputArg(2))).ObjToRec,Param3));
    ReturnOutputArg(AResult);
    SetInputArg(3,Integer(Param3));
  end;
end;
...
begin
  ...
  begin
Param3 := VarToInteger(GetInputArg(3));
AResult := Integer(IDropTarget(CurrentObject).Drop(IDataObject(VarToObject(GetInputArg(0))),VarToInteger(GetInputArg(1)),TPointWrapper(integer(GetInputArg(2))).ObjToRec,Param3));
    ReturnOutputArg(AResult);
    SetInputArg(3,Integer(Param3));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(IOleDocumentView(CurrentObject).SetInPlaceSite(IOleInPlaceSite(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
Param0 := IOleInPlaceSite(VarToObject(GetInputArg(0)));
...
begin
  with AMachine do
  begin
AResult := Integer(IOleDocumentView(CurrentObject).SaveViewState(IStream(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(IOleDocumentView(CurrentObject).ApplyViewState(IStream(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
Param1 := IOleDocumentView(VarToObject(GetInputArg(1)));
AResult := Integer(IOleDocumentView(CurrentObject).Clone(IOleInPlaceSite(VarToObject(GetInputArg(0))),Param1));
    ReturnOutputArg(AResult);
    SetInputArg(1,ObjectToVar(Param1));
  end;
end;
...
begin
  with AMachine do
  begin
Param0 := IEnumOleDocumentViews(VarToObject(GetInputArg(0)));
...
begin
  with AMachine do
  begin
Param3 := IOleDocumentView(VarToObject(GetInputArg(3)));
AResult := Integer(IOleDocument(CurrentObject).CreateView(IOleInPlaceSite(VarToObject(GetInputArg(0))),IStream(VarToObject(GetInputArg(1))),VarToInteger(GetInputArg(2)),Param3));
    ReturnOutputArg(AResult);
    SetInputArg(3,ObjectToVar(Param3));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(IOleDocumentSite(CurrentObject).ActivateMe(IOleDocumentView(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
Param1 := IMalloc(VarToObject(GetInputArg(1)));
...
begin
  with AMachine do
  begin
AResult := Integer(Ole2.CoRegisterMallocSpy(IMallocSpy(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param4 := VarToInteger(GetInputArg(4));
AResult := Integer(Ole2.CoRegisterClassObject(TGUIDWrapper(integer(GetInputArg(0))).ObjToRec,IUnknown(VarToObject(GetInputArg(1))),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)),Param4));
    ReturnOutputArg(AResult);
    SetInputArg(4,Integer(Param4));
  end;
end;
...
begin
  ...
  begin
Param2 := GetInputArg(2);
AResult := Integer(Ole2.CoUnmarshalInterface(IStream(VarToObject(GetInputArg(0))),TGUIDWrapper(integer(GetInputArg(1))).ObjToRec,Param2));
    ReturnOutputArg(AResult);
    SetInputArg(2,Param2);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Ole2.CoReleaseMarshalData(IStream(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Ole2.CoDisconnectObject(IUnknown(VarToObject(GetInputArg(0))),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Ole2.CoLockObjectExternal(IUnknown(VarToObject(GetInputArg(0))),GetInputArg(1),GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Ole2.CoIsHandlerConnected(IUnknown(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
Param2 := IStream(VarToObject(GetInputArg(2)));
AResult := Integer(Ole2.CoMarshalInterThreadInterfaceInStream(TGUIDWrapper(integer(GetInputArg(0))).ObjToRec,IUnknown(VarToObject(GetInputArg(1))),Param2));
    ReturnOutputArg(AResult);
    SetInputArg(2,ObjectToVar(Param2));
  end;
end;
...
begin
  ...
  begin
Param2 := GetInputArg(2);
AResult := Integer(Ole2.CoGetInterfaceAndReleaseStream(IStream(VarToObject(GetInputArg(0))),TGUIDWrapper(integer(GetInputArg(1))).ObjToRec,Param2));
    ReturnOutputArg(AResult);
    SetInputArg(2,Param2);
  end;
end;
...
begin
  ...
  begin
Param1 := IUnknown(VarToObject(GetInputArg(1)));
AResult := Integer(Ole2.CoCreateFreeThreadedMarshaler(IUnknown(VarToObject(GetInputArg(0))),Param1));
    ReturnOutputArg(AResult);
    SetInputArg(1,ObjectToVar(Param1));
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Integer(Ole2.CoLoadLibrary(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param4 := GetInputArg(4);
AResult := Integer(Ole2.CoCreateInstance(TGUIDWrapper(integer(GetInputArg(0))).ObjToRec,IUnknown(VarToObject(GetInputArg(1))),VarToInteger(GetInputArg(2)),TGUIDWrapper(integer(GetInputArg(3))).ObjToRec,Param4));
    ReturnOutputArg(AResult);
    SetInputArg(4,Param4);
  end;
end;
...
AResult := Integer(Ole2.CLSIDFromString(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),Param1));
    ReturnOutputArg(AResult);
...
if not Assigned(Param1Rec) or not (Param1Rec is TGUIDWrapper) then 
  Param1Rec := TGUIDWrapper.Create(Param1);
Param1 := TGUIDWrapper(Param1Rec).ObjToRec;
AResult := Integer(Ole2.IIDFromString(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),Param1));
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(TGUIDWrapper.Create(Param1)));
  end;
end;
...
if not Assigned(Param1Rec) or not (Param1Rec is TGUIDWrapper) then 
  Param1Rec := TGUIDWrapper.Create(Param1);
Param1 := TGUIDWrapper(Param1Rec).ObjToRec;
AResult := Integer(Ole2.CLSIDFromProgID(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),Param1));
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(TGUIDWrapper.Create(Param1)));
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(Ole2.StringFromGUID2(TGUIDWrapper(integer(GetInputArg(0))).ObjToRec,StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
Param1 := IMessageFilter(VarToObject(GetInputArg(1)));
AResult := Integer(Ole2.CoRegisterMessageFilter(IMessageFilter(VarToObject(GetInputArg(0))),Param1));
    ReturnOutputArg(AResult);
    SetInputArg(1,ObjectToVar(Param1));
  end;
end;
...
begin
  with AMachine do
  begin
Param0 := IDataAdviseHolder(VarToObject(GetInputArg(0)));
...
begin
  ...
  begin
Param3 := GetInputArg(3);
AResult := Integer(Ole2.CreateDataCache(IUnknown(VarToObject(GetInputArg(0))),TGUIDWrapper(integer(GetInputArg(1))).ObjToRec,TGUIDWrapper(integer(GetInputArg(2))).ObjToRec,Param3));
    ReturnOutputArg(AResult);
    SetInputArg(3,Param3);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
Param3 := IStorage(VarToObject(GetInputArg(3)));
AResult := Integer(Ole2.StgCreateDocfile(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),Param3));
    ReturnOutputArg(AResult);
    SetInputArg(3,ObjectToVar(Param3));
  end;
end;
...
begin
  ...
  begin
Param3 := IStorage(VarToObject(GetInputArg(3)));
AResult := Integer(Ole2.StgCreateDocfileOnILockBytes(ILockBytes(VarToObject(GetInputArg(0))),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),Param3));
    ReturnOutputArg(AResult);
    SetInputArg(3,ObjectToVar(Param3));
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Integer(Ole2.StgIsStorageFile(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Ole2.StgIsStorageILockBytes(ILockBytes(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Integer(Ole2.StgSetTimes(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),_FILETIMEWrapper(integer(GetInputArg(1))).ObjToRec,_FILETIMEWrapper(integer(GetInputArg(2))).ObjToRec,_FILETIMEWrapper(integer(GetInputArg(3))).ObjToRec));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param3 := GetInputArg(3);
AResult := Integer(Ole2.BindMoniker(IMoniker(VarToObject(GetInputArg(0))),VarToInteger(GetInputArg(1)),TGUIDWrapper(integer(GetInputArg(2))).ObjToRec,Param3));
    ReturnOutputArg(AResult);
    SetInputArg(3,Param3);
  end;
end;
...
Param2 := VarToInteger(GetInputArg(2));
Param3 := IMoniker(VarToObject(GetInputArg(3)));
AResult := Integer(Ole2.MkParseDisplayName(IBindCtx(VarToObject(GetInputArg(0))),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),Param2,Param3));
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
    SetInputArg(3,ObjectToVar(Param3));
  end;
...
begin
  ...
  begin
Param2 := IMoniker(VarToObject(GetInputArg(2)));
AResult := Integer(Ole2.MonikerRelativePathTo(IMoniker(VarToObject(GetInputArg(0))),IMoniker(VarToObject(GetInputArg(1))),Param2,GetInputArg(3)));
    ReturnOutputArg(AResult);
    SetInputArg(2,ObjectToVar(Param2));
  end;
end;
...
begin
  ...
  begin
Param2 := IMoniker(VarToObject(GetInputArg(2)));
AResult := Integer(Ole2.MonikerCommonPrefixWith(IMoniker(VarToObject(GetInputArg(0))),IMoniker(VarToObject(GetInputArg(1))),Param2));
    ReturnOutputArg(AResult);
    SetInputArg(2,ObjectToVar(Param2));
  end;
end;
...
begin
  with AMachine do
  begin
Param1 := IBindCtx(VarToObject(GetInputArg(1)));
...
begin
  ...
  begin
Param2 := IMoniker(VarToObject(GetInputArg(2)));
AResult := Integer(Ole2.CreateGenericComposite(IMoniker(VarToObject(GetInputArg(0))),IMoniker(VarToObject(GetInputArg(1))),Param2));
    ReturnOutputArg(AResult);
    SetInputArg(2,ObjectToVar(Param2));
  end;
end;
...
if not Assigned(Param1Rec) or not (Param1Rec is TGUIDWrapper) then 
  Param1Rec := TGUIDWrapper.Create(Param1);
Param1 := TGUIDWrapper(Param1Rec).ObjToRec;
AResult := Integer(Ole2.GetClassFile(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),Param1));
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(TGUIDWrapper.Create(Param1)));
  end;
end;
...
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
Param1 := IMoniker(VarToObject(GetInputArg(1)));
AResult := Integer(Ole2.CreateFileMoniker(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),Param1));
    ReturnOutputArg(AResult);
    SetInputArg(1,ObjectToVar(Param1));
  end;
end;
...
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
Param2 := IMoniker(VarToObject(GetInputArg(2)));
AResult := Integer(Ole2.CreateItemMoniker(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),Param2));
    ReturnOutputArg(AResult);
    SetInputArg(2,ObjectToVar(Param2));
  end;
end;
...
begin
  ...
  begin
Param1 := IMoniker(VarToObject(GetInputArg(1)));
AResult := Integer(Ole2.CreatePointerMoniker(IUnknown(VarToObject(GetInputArg(0))),Param1));
    ReturnOutputArg(AResult);
    SetInputArg(1,ObjectToVar(Param1));
  end;
end;
...
begin
  with AMachine do
  begin
Param1 := IRunningObjectTable(VarToObject(GetInputArg(1)));
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := WideCharToString(Ole2.SysAllocString(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
Param0 := StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf));
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(Ole2.SysReAllocString(Param0,StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf))));
    ReturnOutputArg(AResult);
    SetInputArg(0,WideCharToString(Param0));
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := WideCharToString(Ole2.SysAllocStringLen(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
Param0 := StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf));
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(Ole2.SysReAllocStringLen(Param0,StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
    SetInputArg(0,WideCharToString(Param0));
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
    Ole2.SysFreeString(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)));
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Integer(Ole2.SysStringLen(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Integer(Ole2.SysStringByteLen(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
Param3 := VarToInteger(GetInputArg(3));
AResult := Integer(Ole2.VarUI1FromStr(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),Param3));
    ReturnOutputArg(AResult);
    SetInputArg(3,Integer(Param3));
  end;
end;
...
begin
  ...
  begin
Param2 := VarToInteger(GetInputArg(2));
AResult := Integer(Ole2.VarUI1FromDisp(IDispatch(VarToObject(GetInputArg(0))),VarToInteger(GetInputArg(1)),Param2));
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
  end;
end;
...
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
Param3 := VarToInteger(GetInputArg(3));
AResult := Integer(Ole2.VarI2FromStr(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),Param3));
    ReturnOutputArg(AResult);
    SetInputArg(3,Integer(Param3));
  end;
end;
...
begin
  ...
  begin
Param2 := VarToInteger(GetInputArg(2));
AResult := Integer(Ole2.VarI2FromDisp(IDispatch(VarToObject(GetInputArg(0))),VarToInteger(GetInputArg(1)),Param2));
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
  end;
end;
...
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
Param3 := VarToInteger(GetInputArg(3));
AResult := Integer(Ole2.VarI4FromStr(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),Param3));
    ReturnOutputArg(AResult);
    SetInputArg(3,Integer(Param3));
  end;
end;
...
begin
  ...
  begin
Param2 := VarToInteger(GetInputArg(2));
AResult := Integer(Ole2.VarI4FromDisp(IDispatch(VarToObject(GetInputArg(0))),VarToInteger(GetInputArg(1)),Param2));
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
  end;
end;
...
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
Param3 := GetInputArg(3);
AResult := Integer(Ole2.VarR4FromStr(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),Param3));
    ReturnOutputArg(AResult);
    SetInputArg(3,Param3);
  end;
end;
...
begin
  ...
  begin
Param2 := GetInputArg(2);
AResult := Integer(Ole2.VarR4FromDisp(IDispatch(VarToObject(GetInputArg(0))),VarToInteger(GetInputArg(1)),Param2));
    ReturnOutputArg(AResult);
    SetInputArg(2,Param2);
  end;
end;
...
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
Param3 := GetInputArg(3);
AResult := Integer(Ole2.VarR8FromStr(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),Param3));
    ReturnOutputArg(AResult);
    SetInputArg(3,Param3);
  end;
end;
...
begin
  ...
  begin
Param2 := GetInputArg(2);
AResult := Integer(Ole2.VarR8FromDisp(IDispatch(VarToObject(GetInputArg(0))),VarToInteger(GetInputArg(1)),Param2));
    ReturnOutputArg(AResult);
    SetInputArg(2,Param2);
  end;
end;
...
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
Param3 := GetInputArg(3);
AResult := Integer(Ole2.VarDateFromStr(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),Param3));
    ReturnOutputArg(AResult);
    SetInputArg(3,Param3);
  end;
end;
...
begin
  ...
  begin
Param2 := GetInputArg(2);
AResult := Integer(Ole2.VarDateFromDisp(IDispatch(VarToObject(GetInputArg(0))),VarToInteger(GetInputArg(1)),Param2));
    ReturnOutputArg(AResult);
    SetInputArg(2,Param2);
  end;
end;
...
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
Param3 := GetInputArg(3);
AResult := Integer(Ole2.VarCyFromStr(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),Param3));
    ReturnOutputArg(AResult);
    SetInputArg(3,Param3);
  end;
end;
...
begin
  ...
  begin
Param2 := GetInputArg(2);
AResult := Integer(Ole2.VarCyFromDisp(IDispatch(VarToObject(GetInputArg(0))),VarToInteger(GetInputArg(1)),Param2));
    ReturnOutputArg(AResult);
    SetInputArg(2,Param2);
  end;
end;
...
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
Param3 := GetInputArg(3);
AResult := Integer(Ole2.VarBoolFromStr(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),Param3));
    ReturnOutputArg(AResult);
    SetInputArg(3,Param3);
  end;
end;
...
begin
  ...
  begin
Param2 := GetInputArg(2);
AResult := Integer(Ole2.VarBoolFromDisp(IDispatch(VarToObject(GetInputArg(0))),VarToInteger(GetInputArg(1)),Param2));
    ReturnOutputArg(AResult);
    SetInputArg(2,Param2);
  end;
end;
...
begin
  ...
  begin
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
AResult := Integer(Ole2.LHashValOfNameSys(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(Ole2.LHashValOfName(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
Param1 := ITypeLib(VarToObject(GetInputArg(1)));
AResult := Integer(Ole2.LoadTypeLib(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),Param1));
    ReturnOutputArg(AResult);
    SetInputArg(1,ObjectToVar(Param1));
  end;
end;
...
begin
  with AMachine do
  begin
Param4 := ITypeLib(VarToObject(GetInputArg(4)));
...
Param4 := StringToWideChar(VarToStr(GetInputArg(4)),@Param4Buf[0],Length(Param4Buf));
...
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
AResult := Integer(Ole2.RegisterTypeLib(ITypeLib(VarToObject(GetInputArg(0))),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
Param2 := ICreateTypeLib(VarToObject(GetInputArg(2)));
AResult := Integer(Ole2.CreateTypeLib(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),Param2));
    ReturnOutputArg(AResult);
    SetInputArg(2,ObjectToVar(Param2));
  end;
end;
...
Param1 := GetInputArg(1);
Param3 := GetInputArg(3);
AResult := Integer(Ole2.DispGetIDsOfNames(ITypeInfo(VarToObject(GetInputArg(0))),Param1,VarToInteger(GetInputArg(2)),Param3));
    ReturnOutputArg(AResult);
    SetInputArg(1,Param1);
    SetInputArg(3,Param3);
  end;
...
begin
  ...
  begin
Param3 := VarToInteger(GetInputArg(3));
AResult := Integer(Ole2.RegisterActiveObject(IUnknown(VarToObject(GetInputArg(0))),TGUIDWrapper(integer(GetInputArg(1))).ObjToRec,VarToInteger(GetInputArg(2)),Param3));
    ReturnOutputArg(AResult);
    SetInputArg(3,Integer(Param3));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Ole2.SetErrorInfo(VarToInteger(GetInputArg(0)),IErrorInfo(VarToObject(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
Param1 := IErrorInfo(VarToObject(GetInputArg(1)));
...
begin
  with AMachine do
  begin
Param0 := ICreateErrorInfo(VarToObject(GetInputArg(0)));
...
if not Assigned(Param1Rec) or not (Param1Rec is TGUIDWrapper) then 
  Param1Rec := TGUIDWrapper.Create(Param1);
Param1 := TGUIDWrapper(Param1Rec).ObjToRec;
AResult := Integer(Ole2.ReadClassStg(IStorage(VarToObject(GetInputArg(0))),Param1));
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(TGUIDWrapper.Create(Param1)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Ole2.WriteClassStg(IStorage(VarToObject(GetInputArg(0))),TGUIDWrapper(integer(GetInputArg(1))).ObjToRec));
    ReturnOutputArg(AResult);
  end;
end;
...
if not Assigned(Param1Rec) or not (Param1Rec is TGUIDWrapper) then 
  Param1Rec := TGUIDWrapper.Create(Param1);
Param1 := TGUIDWrapper(Param1Rec).ObjToRec;
AResult := Integer(Ole2.ReadClassStm(IStream(VarToObject(GetInputArg(0))),Param1));
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(TGUIDWrapper.Create(Param1)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Ole2.WriteClassStm(IStream(VarToObject(GetInputArg(0))),TGUIDWrapper(integer(GetInputArg(1))).ObjToRec));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
AResult := Integer(Ole2.WriteFmtUserTypeStg(IStorage(VarToObject(GetInputArg(0))),VarToInteger(GetInputArg(1)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
Param2 := StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf));
AResult := Integer(Ole2.ReadFmtUserTypeStg(IStorage(VarToObject(GetInputArg(0))),Param1,Param2));
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
    SetInputArg(2,WideCharToString(Param2));
  end;
...
begin
  with AMachine do
  begin
AResult := Integer(Ole2.OleQueryLinkFromData(IDataObject(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Ole2.OleQueryCreateFromData(IDataObject(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param3 := GetInputArg(3);
AResult := Integer(Ole2.OleLoad(IStorage(VarToObject(GetInputArg(0))),TGUIDWrapper(integer(GetInputArg(1))).ObjToRec,IOleClientSite(VarToObject(GetInputArg(2))),Param3));
    ReturnOutputArg(AResult);
    SetInputArg(3,Param3);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Ole2.OleSave(IPersistStorage(VarToObject(GetInputArg(0))),IStorage(VarToObject(GetInputArg(1))),GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param2 := GetInputArg(2);
AResult := Integer(Ole2.OleLoadFromStream(IStream(VarToObject(GetInputArg(0))),TGUIDWrapper(integer(GetInputArg(1))).ObjToRec,Param2));
    ReturnOutputArg(AResult);
    SetInputArg(2,Param2);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Ole2.OleSaveToStream(IPersistStream(VarToObject(GetInputArg(0))),IStream(VarToObject(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Ole2.OleSetContainedObject(IUnknown(VarToObject(GetInputArg(0))),GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Ole2.OleNoteObjectVisible(IUnknown(VarToObject(GetInputArg(0))),GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Ole2.RegisterDragDrop(VarToInteger(GetInputArg(0)),IDropTarget(VarToObject(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param3 := VarToInteger(GetInputArg(3));
AResult := Integer(Ole2.DoDragDrop(IDataObject(VarToObject(GetInputArg(0))),IDropSource(VarToObject(GetInputArg(1))),VarToInteger(GetInputArg(2)),Param3));
    ReturnOutputArg(AResult);
    SetInputArg(3,Integer(Param3));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Ole2.OleSetClipboard(IDataObject(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
Param0 := IDataObject(VarToObject(GetInputArg(0)));
...
begin
  with AMachine do
  begin
AResult := Integer(Ole2.OleIsCurrentClipboard(IDataObject(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Ole2.OleSetMenuDescriptor(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),IOleInPlaceFrame(VarToObject(GetInputArg(3))),IOleInPlaceActiveObject(VarToObject(GetInputArg(4)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Ole2.OleDraw(IUnknown(VarToObject(GetInputArg(0))),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),TRectWrapper(integer(GetInputArg(3))).ObjToRec));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Ole2.OleRun(IUnknown(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Ole2.OleIsRunning(IOleObject(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Ole2.OleLockRunning(IUnknown(VarToObject(GetInputArg(0))),GetInputArg(1),GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
Param0 := IOleAdviseHolder(VarToObject(GetInputArg(0)));
...
begin
  ...
  begin
Param3 := GetInputArg(3);
AResult := Integer(Ole2.OleCreateDefaultHandler(TGUIDWrapper(integer(GetInputArg(0))).ObjToRec,IUnknown(VarToObject(GetInputArg(1))),TGUIDWrapper(integer(GetInputArg(2))).ObjToRec,Param3));
    ReturnOutputArg(AResult);
    SetInputArg(3,Param3);
  end;
end;
...
AResult := Integer(Ole2.OleCreateEmbeddingHelper(TGUIDWrapper(integer(GetInputArg(0))).ObjToRec,IUnknown(VarToObject(GetInputArg(1))),VarToInteger(GetInputArg(2)),IClassFactory(VarToObject(GetInputArg(3))),TGUIDWrapper(integer(GetInputArg(4))).ObjToRec,Param5));
    ReturnOutputArg(AResult);
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Integer(Ole2.OleGetIconOfFile(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(Ole2.OleGetIconOfClass(TGUIDWrapper(integer(GetInputArg(0))).ObjToRec,StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
AResult := Integer(Ole2.OleMetafilePictFromIconAndLabel(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
Param2 := IEnumFormatEtc(VarToObject(GetInputArg(2)));
...
begin
  with AMachine do
  begin
Param1 := IEnumOleVerb(VarToObject(GetInputArg(1)));
...
begin
  ...
  begin
Param1 := VarToInteger(GetInputArg(1));
AResult := Integer(Ole2.GetHGlobalFromILockBytes(ILockBytes(VarToObject(GetInputArg(0))),Param1));
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
begin
  with AMachine do
  begin
Param2 := ILockBytes(VarToObject(GetInputArg(2)));
...
begin
  ...
  begin
Param1 := VarToInteger(GetInputArg(1));
AResult := Integer(Ole2.GetHGlobalFromStream(IStream(VarToObject(GetInputArg(0))),Param1));
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
if not Assigned(Param1Rec) or not (Param1Rec is TGUIDWrapper) then 
  Param1Rec := TGUIDWrapper.Create(Param1);
Param1 := TGUIDWrapper(Param1Rec).ObjToRec;
AResult := Integer(Ole2.OleDoAutoConvert(IStorage(VarToObject(GetInputArg(0))),Param1));
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(TGUIDWrapper.Create(Param1)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Ole2.GetConvertStg(IStorage(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Ole2.SetConvertStg(IStorage(VarToObject(GetInputArg(0))),GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    DefineMethod('QueryInterface',2,tkInteger,nil,__IUnknownQueryInterface,false,0,'iid: TIID; obj').SetVarArgs([1]);
  ...
  begin
    DefineMethod('CreateInstance',3,tkInteger,nil,__IClassFactoryCreateInstance,false,0,'unkOuter: IUnknown; iid: TIID; obj').SetVarArgs([2]);
    DefineMethod('LockServer',1,tkInteger,nil,__IClassFactoryLockServer,false,0,'fLock: BOOL');
  end;
  With Scripter.DefineClass(IMarshal) do
  begin
    DefineMethod('UnmarshalInterface',3,tkInteger,nil,__IMarshalUnmarshalInterface,false,0,'stm: IStream; iid: TIID; pv').SetVarArgs([2]);
    DefineMethod('ReleaseMarshalData',1,tkInteger,nil,__IMarshalReleaseMarshalData,false,0,'stm: IStream');
    DefineMethod('DisconnectObject',1,tkInteger,nil,__IMarshalDisconnectObject,false,0,'dwReserved: Longint');
  end;
  ...
  begin
    DefineMethod('PreAlloc',1,tkInteger,nil,__IMallocSpyPreAlloc,false,0,'cbRequest: Longint');
    DefineMethod('PostFree',1,tkNone,nil,__IMallocSpyPostFree,false,0,'fSpyed: BOOL');
  ...
  begin
    DefineMethod('AddConnection',2,tkInteger,nil,__IExternalConnectionAddConnection,false,0,'extconn: Longint; reserved: Longint');
    DefineMethod('ReleaseConnection',3,tkInteger,nil,__IExternalConnectionReleaseConnection,false,0,'extconn: Longint; reserved: Longint; fLastReleaseCloses: BOOL');
  end;
  With Scripter.DefineClass(IWeakRef) do
  begin
    DefineMethod('ChangeWeakCount',1,tkInteger,nil,__IWeakRefChangeWeakCount,false,0,'delta: Longint');
    DefineMethod('ReleaseKeepAlive',2,tkInteger,nil,__IWeakRefReleaseKeepAlive,false,0,'unkReleased: IUnknown; reserved: Longint');
  end;
  With Scripter.DefineClass(IEnumUnknown) do
  begin
    DefineMethod('Skip',1,tkInteger,nil,__IEnumUnknownSkip,false,0,'celt: Longint');
    DefineMethod('Reset',0,tkInteger,nil,__IEnumUnknownReset,false,0,'');
    DefineMethod('Clone',1,tkInteger,nil,__IEnumUnknownClone,false,0,'enm: IEnumUnknown').SetVarArgs([0]);
  end;
  With Scripter.DefineClass(IBindCtx) do
  begin
    DefineMethod('RegisterObjectBound',1,tkInteger,nil,__IBindCtxRegisterObjectBound,false,0,'unk: IUnknown');
    DefineMethod('RevokeObjectBound',1,tkInteger,nil,__IBindCtxRevokeObjectBound,false,0,'unk: IUnknown');
    DefineMethod('ReleaseBoundObjects',0,tkInteger,nil,__IBindCtxReleaseBoundObjects,false,0,'');
    DefineMethod('SetBindOptions',1,tkInteger,nil,__IBindCtxSetBindOptions,false,0,'bindopts: TBindOpts').SetVarArgs([0]);
    DefineMethod('GetBindOptions',1,tkInteger,nil,__IBindCtxGetBindOptions,false,0,'bindopts: TBindOpts').SetVarArgs([0]);
    DefineMethod('GetRunningObjectTable',1,tkInteger,nil,__IBindCtxGetRunningObjectTable,false,0,'rot: IRunningObjectTable').SetVarArgs([0]);
    DefineMethod('RegisterObjectParam',2,tkInteger,nil,__IBindCtxRegisterObjectParam,false,0,'pszKey: POleStr; unk: IUnknown');
    DefineMethod('GetObjectParam',2,tkInteger,nil,__IBindCtxGetObjectParam,false,0,'pszKey: POleStr; unk: IUnknown').SetVarArgs([1]);
    DefineMethod('EnumObjectParam',1,tkInteger,nil,__IBindCtxEnumObjectParam,false,0,'Enum: IEnumString').SetVarArgs([0]);
    DefineMethod('RevokeObjectParam',1,tkInteger,nil,__IBindCtxRevokeObjectParam,false,0,'pszKey: POleStr');
  end;
  With Scripter.DefineClass(IEnumMoniker) do
  begin
    DefineMethod('Skip',1,tkInteger,nil,__IEnumMonikerSkip,false,0,'celt: Longint');
    DefineMethod('Reset',0,tkInteger,nil,__IEnumMonikerReset,false,0,'');
    DefineMethod('Clone',1,tkInteger,nil,__IEnumMonikerClone,false,0,'enm: IEnumMoniker').SetVarArgs([0]);
  end;
  With Scripter.DefineClass(IRunnableObject) do
  begin
    DefineMethod('GetRunningClass',1,tkInteger,nil,__IRunnableObjectGetRunningClass,false,0,'clsid: TCLSID').SetVarArgs([0]);
    DefineMethod('Run',1,tkInteger,nil,__IRunnableObjectRun,false,0,'bc: IBindCtx');
    DefineMethod('IsRunning',0,tkVariant,nil,__IRunnableObjectIsRunning,false,0,'');
    DefineMethod('LockRunning',2,tkInteger,nil,__IRunnableObjectLockRunning,false,0,'fLock: BOOL; fLastUnlockCloses: BOOL');
    DefineMethod('SetContainedObject',1,tkInteger,nil,__IRunnableObjectSetContainedObject,false,0,'fContained: BOOL');
  end;
  With Scripter.DefineClass(IRunningObjectTable) do
  begin
    DefineMethod('Register',4,tkInteger,nil,__IRunningObjectTableRegister,false,0,'grfFlags: Longint; unkObject: IUnknown; mkObjectName: IMoniker; dwRegister: Longint').SetVarArgs([1,3]);
    DefineMethod('Revoke',1,tkInteger,nil,__IRunningObjectTableRevoke,false,0,'dwRegister: Longint');
    DefineMethod('IsRunning',1,tkInteger,nil,__IRunningObjectTableIsRunning,false,0,'mkObjectName: IMoniker');
    DefineMethod('GetObject',2,tkInteger,nil,__IRunningObjectTableGetObject,false,0,'mkObjectName: IMoniker; unkObject: IUnknown').SetVarArgs([1]);
    DefineMethod('NoteChangeTime',2,tkInteger,nil,__IRunningObjectTableNoteChangeTime,false,0,'dwRegister: Longint; filetime: TFileTime').SetVarArgs([1]);
    DefineMethod('GetTimeOfLastChange',2,tkInteger,nil,__IRunningObjectTableGetTimeOfLastChange,false,0,'mkObjectName: IMoniker; filetime: TFileTime').SetVarArgs([1]);
    DefineMethod('EnumRunning',1,tkInteger,nil,__IRunningObjectTableEnumRunning,false,0,'enumMoniker: IEnumMoniker').SetVarArgs([0]);
  end;
  With Scripter.DefineClass(IPersist) do
  begin
    DefineMethod('GetClassID',1,tkInteger,nil,__IPersistGetClassID,false,0,'classID: TCLSID').SetVarArgs([0]);
  end;
  With Scripter.DefineClass(IPersistStream) do
  begin
    DefineMethod('IsDirty',0,tkInteger,nil,__IPersistStreamIsDirty,false,0,'');
    DefineMethod('Load',1,tkInteger,nil,__IPersistStreamLoad,false,0,'stm: IStream');
    DefineMethod('Save',2,tkInteger,nil,__IPersistStreamSave,false,0,'stm: IStream; fClearDirty: BOOL');
    DefineMethod('GetSizeMax',1,tkInteger,nil,__IPersistStreamGetSizeMax,false,0,'cbSize: Largeint').SetVarArgs([0]);
  end;
  With Scripter.DefineClass(IMoniker) do
  begin
    DefineMethod('BindToObject',4,tkInteger,nil,__IMonikerBindToObject,false,0,'bc: IBindCtx; mkToLeft: IMoniker; iidResult: TIID; vResult').SetVarArgs([3]);
    DefineMethod('BindToStorage',4,tkInteger,nil,__IMonikerBindToStorage,false,0,'bc: IBindCtx; mkToLeft: IMoniker; iid: TIID; vObj').SetVarArgs([3]);
    DefineMethod('Reduce',4,tkInteger,nil,__IMonikerReduce,false,0,'bc: IBindCtx; dwReduceHowFar: Longint; mkToLeft: IMoniker; mkReduced: IMoniker').SetVarArgs([2,3]);
    DefineMethod('ComposeWith',3,tkInteger,nil,__IMonikerComposeWith,false,0,'mkRight: IMoniker; fOnlyIfNotGeneric: BOOL; mkComposite: IMoniker').SetVarArgs([2]);
    DefineMethod('Enum',2,tkInteger,nil,__IMonikerEnum,false,0,'fForward: BOOL; enumMoniker: IEnumMoniker').SetVarArgs([1]);
    DefineMethod('IsEqual',1,tkInteger,nil,__IMonikerIsEqual,false,0,'mkOtherMoniker: IMoniker');
    DefineMethod('Hash',1,tkInteger,nil,__IMonikerHash,false,0,'dwHash: Longint').SetVarArgs([0]);
    DefineMethod('IsRunning',3,tkInteger,nil,__IMonikerIsRunning,false,0,'bc: IBindCtx; mkToLeft: IMoniker; mkNewlyRunning: IMoniker');
    DefineMethod('GetTimeOfLastChange',3,tkInteger,nil,__IMonikerGetTimeOfLastChange,false,0,'bc: IBindCtx; mkToLeft: IMoniker; filetime: TFileTime').SetVarArgs([2]);
    DefineMethod('Inverse',1,tkInteger,nil,__IMonikerInverse,false,0,'mk: IMoniker').SetVarArgs([0]);
    DefineMethod('CommonPrefixWith',2,tkInteger,nil,__IMonikerCommonPrefixWith,false,0,'mkOther: IMoniker; mkPrefix: IMoniker').SetVarArgs([1]);
    DefineMethod('RelativePathTo',2,tkInteger,nil,__IMonikerRelativePathTo,false,0,'mkOther: IMoniker; mkRelPath: IMoniker').SetVarArgs([1]);
    DefineMethod('GetDisplayName',3,tkInteger,nil,__IMonikerGetDisplayName,false,0,'bc: IBindCtx; mkToLeft: IMoniker; pszDisplayName: POleStr').SetVarArgs([2]);
    DefineMethod('ParseDisplayName',5,tkInteger,nil,__IMonikerParseDisplayName,false,0,'bc: IBindCtx; mkToLeft: IMoniker; pszDisplayName: POleStr; chEaten: Longint; mkOut: IMoniker').SetVarArgs([3,4]);
    DefineMethod('IsSystemMoniker',1,tkInteger,nil,__IMonikerIsSystemMoniker,false,0,'dwMksys: Longint').SetVarArgs([0]);
  end;
  With Scripter.DefineClass(IEnumString) do
  begin
    DefineMethod('Skip',1,tkInteger,nil,__IEnumStringSkip,false,0,'celt: Longint');
    DefineMethod('Reset',0,tkInteger,nil,__IEnumStringReset,false,0,'');
    DefineMethod('Clone',1,tkInteger,nil,__IEnumStringClone,false,0,'enm: IEnumString').SetVarArgs([0]);
  end;
  With Scripter.DefineClass(IStream) do
  begin
    DefineMethod('Seek',3,tkInteger,nil,__IStreamSeek,false,0,'dlibMove: Largeint; dwOrigin: Longint; libNewPosition: Largeint').SetVarArgs([2]);
    DefineMethod('SetSize',1,tkInteger,nil,__IStreamSetSize,false,0,'libNewSize: Largeint');
    DefineMethod('CopyTo',4,tkInteger,nil,__IStreamCopyTo,false,0,'stm: IStream; cb: Largeint; cbRead: Largeint; cbWritten: Largeint').SetVarArgs([2,3]);
    DefineMethod('Commit',1,tkInteger,nil,__IStreamCommit,false,0,'grfCommitFlags: Longint');
    DefineMethod('Revert',0,tkInteger,nil,__IStreamRevert,false,0,'');
    DefineMethod('LockRegion',3,tkInteger,nil,__IStreamLockRegion,false,0,'libOffset: Largeint; cb: Largeint; dwLockType: Longint');
    DefineMethod('UnlockRegion',3,tkInteger,nil,__IStreamUnlockRegion,false,0,'libOffset: Largeint; cb: Largeint; dwLockType: Longint');
    DefineMethod('Stat',2,tkInteger,nil,__IStreamStat,false,0,'statstg: TStatStg; grfStatFlag: Longint').SetVarArgs([0]);
    DefineMethod('Clone',1,tkInteger,nil,__IStreamClone,false,0,'stm: IStream').SetVarArgs([0]);
  end;
  With Scripter.DefineClass(IEnumStatStg) do
  begin
    DefineMethod('Skip',1,tkInteger,nil,__IEnumStatStgSkip,false,0,'celt: Longint');
    DefineMethod('Reset',0,tkInteger,nil,__IEnumStatStgReset,false,0,'');
    DefineMethod('Clone',1,tkInteger,nil,__IEnumStatStgClone,false,0,'enm: IEnumStatStg').SetVarArgs([0]);
  end;
  With Scripter.DefineClass(IStorage) do
  begin
    DefineMethod('CreateStream',5,tkInteger,nil,__IStorageCreateStream,false,0,'pwcsName: POleStr; grfMode: Longint; reserved1: Longint; reserved2: Longint; stm: IStream').SetVarArgs([4]);
    DefineMethod('CreateStorage',5,tkInteger,nil,__IStorageCreateStorage,false,0,'pwcsName: POleStr; grfMode: Longint; dwStgFmt: Longint; reserved2: Longint; stg: IStorage').SetVarArgs([4]);
    DefineMethod('MoveElementTo',4,tkInteger,nil,__IStorageMoveElementTo,false,0,'pwcsName: POleStr; stgDest: IStorage; pwcsNewName: POleStr; grfFlags: Longint');
    DefineMethod('Commit',1,tkInteger,nil,__IStorageCommit,false,0,'grfCommitFlags: Longint');
    DefineMethod('Revert',0,tkInteger,nil,__IStorageRevert,false,0,'');
    DefineMethod('DestroyElement',1,tkInteger,nil,__IStorageDestroyElement,false,0,'pwcsName: POleStr');
    DefineMethod('RenameElement',2,tkInteger,nil,__IStorageRenameElement,false,0,'pwcsOldName: POleStr; pwcsNewName: POleStr');
    DefineMethod('SetElementTimes',4,tkInteger,nil,__IStorageSetElementTimes,false,0,'pwcsName: POleStr; ctime: TFileTime; atime: TFileTime; mtime: TFileTime');
    DefineMethod('SetClass',1,tkInteger,nil,__IStorageSetClass,false,0,'clsid: TCLSID');
    DefineMethod('SetStateBits',2,tkInteger,nil,__IStorageSetStateBits,false,0,'grfStateBits: Longint; grfMask: Longint');
    DefineMethod('Stat',2,tkInteger,nil,__IStorageStat,false,0,'statstg: TStatStg; grfStatFlag: Longint').SetVarArgs([0]);
  end;
  With Scripter.DefineClass(IPersistFile) do
  begin
    DefineMethod('IsDirty',0,tkInteger,nil,__IPersistFileIsDirty,false,0,'');
    DefineMethod('Load',2,tkInteger,nil,__IPersistFileLoad,false,0,'pszFileName: POleStr; dwMode: Longint');
    DefineMethod('Save',2,tkInteger,nil,__IPersistFileSave,false,0,'pszFileName: POleStr; fRemember: BOOL');
    DefineMethod('SaveCompleted',1,tkInteger,nil,__IPersistFileSaveCompleted,false,0,'pszFileName: POleStr');
    DefineMethod('GetCurFile',1,tkInteger,nil,__IPersistFileGetCurFile,false,0,'pszFileName: POleStr').SetVarArgs([0]);
  end;
  With Scripter.DefineClass(IPersistStorage) do
  begin
    DefineMethod('IsDirty',0,tkInteger,nil,__IPersistStorageIsDirty,false,0,'');
    DefineMethod('InitNew',1,tkInteger,nil,__IPersistStorageInitNew,false,0,'stg: IStorage');
    DefineMethod('Load',1,tkInteger,nil,__IPersistStorageLoad,false,0,'stg: IStorage');
    DefineMethod('Save',2,tkInteger,nil,__IPersistStorageSave,false,0,'stgSave: IStorage; fSameAsLoad: BOOL');
    DefineMethod('SaveCompleted',1,tkInteger,nil,__IPersistStorageSaveCompleted,false,0,'stgNew: IStorage');
  ...
  begin
    ...
    DefineMethod('SetSize',1,tkInteger,nil,__ILockBytesSetSize,false,0,'cb: Largeint');
    DefineMethod('LockRegion',3,tkInteger,nil,__ILockBytesLockRegion,false,0,'libOffset: Largeint; cb: Largeint; dwLockType: Longint');
    DefineMethod('UnlockRegion',3,tkInteger,nil,__ILockBytesUnlockRegion,false,0,'libOffset: Largeint; cb: Largeint; dwLockType: Longint');
    DefineMethod('Stat',2,tkInteger,nil,__ILockBytesStat,false,0,'statstg: TStatStg; grfStatFlag: Longint').SetVarArgs([0]);
  end;
  With Scripter.DefineClass(IEnumFormatEtc) do
  begin
    DefineMethod('Skip',1,tkInteger,nil,__IEnumFormatEtcSkip,false,0,'celt: Longint');
    DefineMethod('Reset',0,tkInteger,nil,__IEnumFormatEtcReset,false,0,'');
    DefineMethod('Clone',1,tkInteger,nil,__IEnumFormatEtcClone,false,0,'Enum: IEnumFormatEtc').SetVarArgs([0]);
  end;
  With Scripter.DefineClass(IEnumStatData) do
  begin
    DefineMethod('Skip',1,tkInteger,nil,__IEnumStatDataSkip,false,0,'celt: Longint');
    DefineMethod('Reset',0,tkInteger,nil,__IEnumStatDataReset,false,0,'');
    DefineMethod('Clone',1,tkInteger,nil,__IEnumStatDataClone,false,0,'Enum: IEnumStatData').SetVarArgs([0]);
  end;
  With Scripter.DefineClass(IRootStorage) do
  begin
    DefineMethod('SwitchToFile',1,tkInteger,nil,__IRootStorageSwitchToFile,false,0,'pszFile: POleStr');
  end;
  With Scripter.DefineClass(IAdviseSink) do
  begin
    DefineMethod('OnDataChange',2,tkNone,nil,__IAdviseSinkOnDataChange,false,0,'formatetc: TFormatEtc; stgmed: TStgMedium').SetVarArgs([0,1]);
    DefineMethod('OnViewChange',2,tkNone,nil,__IAdviseSinkOnViewChange,false,0,'dwAspect: Longint; lindex: Longint');
    DefineMethod('OnRename',1,tkNone,nil,__IAdviseSinkOnRename,false,0,'mk: IMoniker');
  ...
  begin
    DefineMethod('OnLinkSrcChange',1,tkNone,nil,__IAdviseSink2OnLinkSrcChange,false,0,'mk: IMoniker');
  end;
  With Scripter.DefineClass(IDataObject) do
  begin
    DefineMethod('GetData',2,tkInteger,nil,__IDataObjectGetData,false,0,'formatetcIn: TFormatEtc; medium: TStgMedium').SetVarArgs([0,1]);
    DefineMethod('GetDataHere',2,tkInteger,nil,__IDataObjectGetDataHere,false,0,'formatetc: TFormatEtc; medium: TStgMedium').SetVarArgs([0,1]);
    DefineMethod('QueryGetData',1,tkInteger,nil,__IDataObjectQueryGetData,false,0,'formatetc: TFormatEtc').SetVarArgs([0]);
    DefineMethod('GetCanonicalFormatEtc',2,tkInteger,nil,__IDataObjectGetCanonicalFormatEtc,false,0,'formatetc: TFormatEtc; formatetcOut: TFormatEtc').SetVarArgs([0,1]);
    DefineMethod('SetData',3,tkInteger,nil,__IDataObjectSetData,false,0,'formatetc: TFormatEtc; medium: TStgMedium; fRelease: BOOL').SetVarArgs([0,1]);
    DefineMethod('EnumFormatEtc',2,tkInteger,nil,__IDataObjectEnumFormatEtc,false,0,'dwDirection: Longint; enumFormatEtc: IEnumFormatEtc').SetVarArgs([1]);
    DefineMethod('DAdvise',4,tkInteger,nil,__IDataObjectDAdvise,false,0,'formatetc: TFormatEtc; advf: Longint; advSink: IAdviseSink; dwConnection: Longint').SetVarArgs([0,3]);
    DefineMethod('DUnadvise',1,tkInteger,nil,__IDataObjectDUnadvise,false,0,'dwConnection: Longint');
    DefineMethod('EnumDAdvise',1,tkInteger,nil,__IDataObjectEnumDAdvise,false,0,'enumAdvise: IEnumStatData').SetVarArgs([0]);
  end;
  With Scripter.DefineClass(IDataAdviseHolder) do
  begin
    DefineMethod('Advise',5,tkInteger,nil,__IDataAdviseHolderAdvise,false,0,'dataObject: IDataObject; fetc: TFormatEtc; advf: Longint; advise: IAdviseSink; pdwConnection: Longint').SetVarArgs([1,4]);
    DefineMethod('Unadvise',1,tkInteger,nil,__IDataAdviseHolderUnadvise,false,0,'dwConnection: Longint');
    DefineMethod('EnumAdvise',1,tkInteger,nil,__IDataAdviseHolderEnumAdvise,false,0,'enumAdvise: IEnumStatData').SetVarArgs([0]);
    DefineMethod('SendOnDataChange',3,tkInteger,nil,__IDataAdviseHolderSendOnDataChange,false,0,'dataObject: IDataObject; dwReserved: Longint; advf: Longint');
  end;
  With Scripter.DefineClass(IMessageFilter) do
  begin
    DefineMethod('RetryRejectedCall',3,tkInteger,nil,__IMessageFilterRetryRejectedCall,false,0,'htaskCallee: HTask; dwTickCount: Longint; dwRejectType: Longint');
    DefineMethod('MessagePending',3,tkInteger,nil,__IMessageFilterMessagePending,false,0,'htaskCallee: HTask; dwTickCount: Longint; dwPendingType: Longint');
  end;
  With Scripter.DefineClass(IRpcChannelBuffer) do
  begin
    DefineMethod('GetBuffer',2,tkInteger,nil,__IRpcChannelBufferGetBuffer,false,0,'message: TRpcOleMessage; iid: TIID').SetVarArgs([0]);
    DefineMethod('SendReceive',2,tkInteger,nil,__IRpcChannelBufferSendReceive,false,0,'message: TRpcOleMessage; status: Longint').SetVarArgs([0,1]);
    DefineMethod('FreeBuffer',1,tkInteger,nil,__IRpcChannelBufferFreeBuffer,false,0,'message: TRpcOleMessage').SetVarArgs([0]);
    DefineMethod('GetDestCtx',2,tkInteger,nil,__IRpcChannelBufferGetDestCtx,false,0,'dwDestContext: Longint; pvDestContext').SetVarArgs([0,1]);
  ...
  begin
    DefineMethod('Connect',1,tkInteger,nil,__IRpcProxyBufferConnect,false,0,'rpcChannelBuffer: IRpcChannelBuffer');
    DefineMethod('Disconnect',0,tkNone,nil,__IRpcProxyBufferDisconnect,false,0,'');
  end;
  With Scripter.DefineClass(IRpcStubBuffer) do
  begin
    DefineMethod('Connect',1,tkInteger,nil,__IRpcStubBufferConnect,false,0,'unkServer: IUnknown');
    DefineMethod('Disconnect',0,tkNone,nil,__IRpcStubBufferDisconnect,false,0,'');
    DefineMethod('Invoke',2,tkInteger,nil,__IRpcStubBufferInvoke,false,0,'rpcmsg: TRpcOleMessage; rpcChannelBuffer: IRpcChannelBuffer').SetVarArgs([0]);
    DefineMethod('IsIIDSupported',1,tkClass,IRpcStubBuffer,__IRpcStubBufferIsIIDSupported,false,0,'iid: TIID');
    DefineMethod('CountRefs',0,tkInteger,nil,__IRpcStubBufferCountRefs,false,0,'');
    DefineMethod('DebugServerQueryInterface',1,tkInteger,nil,__IRpcStubBufferDebugServerQueryInterface,false,0,'pv').SetVarArgs([0]);
  end;
  With Scripter.DefineClass(IPSFactoryBuffer) do
  begin
    DefineMethod('CreateProxy',4,tkInteger,nil,__IPSFactoryBufferCreateProxy,false,0,'unkOuter: IUnknown; iid: TIID; proxy: IRpcProxyBuffer; pv').SetVarArgs([2,3]);
    DefineMethod('CreateStub',3,tkInteger,nil,__IPSFactoryBufferCreateStub,false,0,'iid: TIID; unkServer: IUnknown; stub: IRpcStubBuffer').SetVarArgs([2]);
  end;
  With Scripter.DefineClass(ICreateTypeInfo) do
  begin
    DefineMethod('SetGuid',1,tkInteger,nil,__ICreateTypeInfoSetGuid,false,0,'guid: TGUID');
    DefineMethod('SetTypeFlags',1,tkInteger,nil,__ICreateTypeInfoSetTypeFlags,false,0,'uTypeFlags: Integer');
    DefineMethod('SetDocString',1,tkInteger,nil,__ICreateTypeInfoSetDocString,false,0,'pstrDoc: POleStr');
    DefineMethod('SetHelpContext',1,tkInteger,nil,__ICreateTypeInfoSetHelpContext,false,0,'dwHelpContext: Longint');
    DefineMethod('SetVersion',2,tkInteger,nil,__ICreateTypeInfoSetVersion,false,0,'wMajorVerNum: Word; wMinorVerNum: Word');
    DefineMethod('AddRefTypeInfo',2,tkInteger,nil,__ICreateTypeInfoAddRefTypeInfo,false,0,'tinfo: ITypeInfo; reftype: HRefType').SetVarArgs([1]);
    DefineMethod('AddFuncDesc',2,tkInteger,nil,__ICreateTypeInfoAddFuncDesc,false,0,'index: Integer; funcdesc: TFuncDesc').SetVarArgs([1]);
    DefineMethod('AddImplType',2,tkInteger,nil,__ICreateTypeInfoAddImplType,false,0,'index: Integer; reftype: HRefType');
    DefineMethod('SetImplTypeFlags',2,tkInteger,nil,__ICreateTypeInfoSetImplTypeFlags,false,0,'index: Integer; impltypeflags: Integer');
    DefineMethod('SetAlignment',1,tkInteger,nil,__ICreateTypeInfoSetAlignment,false,0,'cbAlignment: Word');
    DefineMethod('SetSchema',1,tkInteger,nil,__ICreateTypeInfoSetSchema,false,0,'lpstrSchema: POleStr');
    DefineMethod('AddVarDesc',2,tkInteger,nil,__ICreateTypeInfoAddVarDesc,false,0,'index: Integer; vardesc: TVarDesc').SetVarArgs([1]);
    DefineMethod('SetVarName',2,tkInteger,nil,__ICreateTypeInfoSetVarName,false,0,'index: Integer; szName: POleStr');
    DefineMethod('SetTypeDescAlias',1,tkInteger,nil,__ICreateTypeInfoSetTypeDescAlias,false,0,'descAlias: TTypeDesc').SetVarArgs([0]);
    DefineMethod('DefineFuncAsDllEntry',3,tkInteger,nil,__ICreateTypeInfoDefineFuncAsDllEntry,false,0,'index: Integer; szDllName: POleStr; szProcName: POleStr');
    DefineMethod('SetFuncDocString',2,tkInteger,nil,__ICreateTypeInfoSetFuncDocString,false,0,'index: Integer; szDocString: POleStr');
    DefineMethod('SetVarDocString',2,tkInteger,nil,__ICreateTypeInfoSetVarDocString,false,0,'index: Integer; szDocString: POleStr');
    DefineMethod('SetFuncHelpContext',2,tkInteger,nil,__ICreateTypeInfoSetFuncHelpContext,false,0,'index: Integer; dwHelpContext: Longint');
    DefineMethod('SetVarHelpContext',2,tkInteger,nil,__ICreateTypeInfoSetVarHelpContext,false,0,'index: Integer; dwHelpContext: Longint');
    DefineMethod('SetMops',2,tkInteger,nil,__ICreateTypeInfoSetMops,false,0,'index: Integer; bstrMops: TBStr');
    DefineMethod('SetTypeIdldesc',1,tkInteger,nil,__ICreateTypeInfoSetTypeIdldesc,false,0,'idldesc: TIDLDesc').SetVarArgs([0]);
    DefineMethod('LayOut',0,tkInteger,nil,__ICreateTypeInfoLayOut,false,0,'');
  end;
  With Scripter.DefineClass(ICreateTypeLib) do
  begin
    DefineMethod('CreateTypeInfo',3,tkInteger,nil,__ICreateTypeLibCreateTypeInfo,false,0,'szName: POleStr; tkind: TTypeKind; ictinfo: ICreateTypeInfo').SetVarArgs([2]);
    DefineMethod('SetName',1,tkInteger,nil,__ICreateTypeLibSetName,false,0,'szName: POleStr');
    DefineMethod('SetVersion',2,tkInteger,nil,__ICreateTypeLibSetVersion,false,0,'wMajorVerNum: Word; wMinorVerNum: Word');
    DefineMethod('SetGuid',1,tkInteger,nil,__ICreateTypeLibSetGuid,false,0,'guid: TGUID');
    DefineMethod('SetDocString',1,tkInteger,nil,__ICreateTypeLibSetDocString,false,0,'szDoc: POleStr');
    DefineMethod('SetHelpFileName',1,tkInteger,nil,__ICreateTypeLibSetHelpFileName,false,0,'szHelpFileName: POleStr');
    DefineMethod('SetHelpContext',1,tkInteger,nil,__ICreateTypeLibSetHelpContext,false,0,'dwHelpContext: Longint');
    DefineMethod('SetLcid',1,tkInteger,nil,__ICreateTypeLibSetLcid,false,0,'lcid: TLCID');
    DefineMethod('SetLibFlags',1,tkInteger,nil,__ICreateTypeLibSetLibFlags,false,0,'uLibFlags: Integer');
    DefineMethod('SaveAllChanges',0,tkInteger,nil,__ICreateTypeLibSaveAllChanges,false,0,'');
  end;
  With Scripter.DefineClass(IDispatch) do
  begin
    DefineMethod('GetTypeInfoCount',1,tkInteger,nil,__IDispatchGetTypeInfoCount,false,0,'ctinfo: Integer').SetVarArgs([0]);
    DefineMethod('GetTypeInfo',3,tkInteger,nil,__IDispatchGetTypeInfo,false,0,'itinfo: Integer; lcid: TLCID; tinfo: ITypeInfo').SetVarArgs([2]);
  end;
  With Scripter.DefineClass(IEnumVariant) do
  begin
    DefineMethod('Next',3,tkInteger,nil,__IEnumVariantNext,false,0,'celt: Longint; elt; pceltFetched: Longint').SetVarArgs([1,2]);
    DefineMethod('Skip',1,tkInteger,nil,__IEnumVariantSkip,false,0,'celt: Longint');
    DefineMethod('Reset',0,tkInteger,nil,__IEnumVariantReset,false,0,'');
    DefineMethod('Clone',1,tkInteger,nil,__IEnumVariantClone,false,0,'Enum: IEnumVariant').SetVarArgs([0]);
  end;
  With Scripter.DefineClass(ITypeComp) do
  begin
    DefineMethod('Bind',6,tkInteger,nil,__ITypeCompBind,false,0,'szName: POleStr; lHashVal: Longint; wflags: Word; tinfo: ITypeInfo; desckind: TDescKind; bindptr: TBindPtr').SetVarArgs([3,4,5]);
    DefineMethod('BindType',4,tkInteger,nil,__ITypeCompBindType,false,0,'szName: POleStr; lHashVal: Longint; tinfo: ITypeInfo; tcomp: ITypeComp').SetVarArgs([2,3]);
  end;
  With Scripter.DefineClass(ITypeInfo) do
  begin
    DefineMethod('GetTypeComp',1,tkInteger,nil,__ITypeInfoGetTypeComp,false,0,'tcomp: ITypeComp').SetVarArgs([0]);
    DefineMethod('GetRefTypeOfImplType',2,tkInteger,nil,__ITypeInfoGetRefTypeOfImplType,false,0,'index: Integer; reftype: HRefType').SetVarArgs([1]);
    DefineMethod('GetImplTypeFlags',2,tkInteger,nil,__ITypeInfoGetImplTypeFlags,false,0,'index: Integer; impltypeflags: Integer').SetVarArgs([1]);
    DefineMethod('GetDllEntry',5,tkInteger,nil,__ITypeInfoGetDllEntry,false,0,'memid: TMemberID; invkind: TInvokeKind; bstrDllName: TBStr; bstrName: TBStr; wOrdinal: Word').SetVarArgs([2,3,4]);
    DefineMethod('GetRefTypeInfo',2,tkInteger,nil,__ITypeInfoGetRefTypeInfo,false,0,'reftype: HRefType; tinfo: ITypeInfo').SetVarArgs([1]);
    DefineMethod('CreateInstance',3,tkInteger,nil,__ITypeInfoCreateInstance,false,0,'unkOuter: IUnknown; iid: TIID; vObj').SetVarArgs([2]);
    DefineMethod('GetMops',2,tkInteger,nil,__ITypeInfoGetMops,false,0,'memid: TMemberID; bstrMops: TBStr').SetVarArgs([1]);
    DefineMethod('GetContainingTypeLib',2,tkInteger,nil,__ITypeInfoGetContainingTypeLib,false,0,'tlib: ITypeLib; pindex: Integer').SetVarArgs([0,1]);
  end;
  With Scripter.DefineClass(ITypeLib) do
  begin
    DefineMethod('GetTypeInfoCount',0,tkInteger,nil,__ITypeLibGetTypeInfoCount,false,0,'');
    DefineMethod('GetTypeInfo',2,tkInteger,nil,__ITypeLibGetTypeInfo,false,0,'index: Integer; tinfo: ITypeInfo').SetVarArgs([1]);
    DefineMethod('GetTypeInfoType',2,tkInteger,nil,__ITypeLibGetTypeInfoType,false,0,'index: Integer; tkind: TTypeKind').SetVarArgs([1]);
    DefineMethod('GetTypeInfoOfGuid',2,tkInteger,nil,__ITypeLibGetTypeInfoOfGuid,false,0,'guid: TGUID; tinfo: ITypeInfo').SetVarArgs([1]);
    DefineMethod('GetTypeComp',1,tkInteger,nil,__ITypeLibGetTypeComp,false,0,'tcomp: ITypeComp').SetVarArgs([0]);
    DefineMethod('IsName',3,tkInteger,nil,__ITypeLibIsName,false,0,'szNameBuf: POleStr; lHashVal: Longint; fName: BOOL').SetVarArgs([2]);
  end;
  With Scripter.DefineClass(IErrorInfo) do
  begin
    DefineMethod('GetGUID',1,tkInteger,nil,__IErrorInfoGetGUID,false,0,'guid: TGUID').SetVarArgs([0]);
    DefineMethod('GetSource',1,tkInteger,nil,__IErrorInfoGetSource,false,0,'bstrSource: TBStr').SetVarArgs([0]);
    DefineMethod('GetDescription',1,tkInteger,nil,__IErrorInfoGetDescription,false,0,'bstrDescription: TBStr').SetVarArgs([0]);
    DefineMethod('GetHelpFile',1,tkInteger,nil,__IErrorInfoGetHelpFile,false,0,'bstrHelpFile: TBStr').SetVarArgs([0]);
    DefineMethod('GetHelpContext',1,tkInteger,nil,__IErrorInfoGetHelpContext,false,0,'dwHelpContext: Longint').SetVarArgs([0]);
  end;
  With Scripter.DefineClass(ICreateErrorInfo) do
  begin
    DefineMethod('SetGUID',1,tkInteger,nil,__ICreateErrorInfoSetGUID,false,0,'guid: TGUID');
    DefineMethod('SetSource',1,tkInteger,nil,__ICreateErrorInfoSetSource,false,0,'szSource: POleStr');
    DefineMethod('SetDescription',1,tkInteger,nil,__ICreateErrorInfoSetDescription,false,0,'szDescription: POleStr');
    DefineMethod('SetHelpFile',1,tkInteger,nil,__ICreateErrorInfoSetHelpFile,false,0,'szHelpFile: POleStr');
    DefineMethod('SetHelpContext',1,tkInteger,nil,__ICreateErrorInfoSetHelpContext,false,0,'dwHelpContext: Longint');
  end;
  With Scripter.DefineClass(ISupportErrorInfo) do
  begin
    DefineMethod('InterfaceSupportsErrorInfo',1,tkInteger,nil,__ISupportErrorInfoInterfaceSupportsErrorInfo,false,0,'iid: TIID');
  end;
  With Scripter.DefineClass(IOleAdviseHolder) do
  begin
    DefineMethod('Advise',2,tkInteger,nil,__IOleAdviseHolderAdvise,false,0,'advise: IAdviseSink; dwConnection: Longint').SetVarArgs([1]);
    DefineMethod('Unadvise',1,tkInteger,nil,__IOleAdviseHolderUnadvise,false,0,'dwConnection: Longint');
    DefineMethod('EnumAdvise',1,tkInteger,nil,__IOleAdviseHolderEnumAdvise,false,0,'enumAdvise: IEnumStatData').SetVarArgs([0]);
    DefineMethod('SendOnRename',1,tkInteger,nil,__IOleAdviseHolderSendOnRename,false,0,'mk: IMoniker');
  ...
  begin
    DefineMethod('Cache',3,tkInteger,nil,__IOleCacheCache,false,0,'formatetc: TFormatEtc; advf: Longint; dwConnection: Longint').SetVarArgs([0,2]);
    DefineMethod('Uncache',1,tkInteger,nil,__IOleCacheUncache,false,0,'dwConnection: Longint');
    DefineMethod('EnumCache',1,tkInteger,nil,__IOleCacheEnumCache,false,0,'enumStatData: IEnumStatData').SetVarArgs([0]);
    DefineMethod('InitCache',1,tkInteger,nil,__IOleCacheInitCache,false,0,'dataObject: IDataObject');
    DefineMethod('SetData',3,tkInteger,nil,__IOleCacheSetData,false,0,'formatetc: TFormatEtc; medium: TStgMedium; fRelease: BOOL').SetVarArgs([0,1]);
  end;
  With Scripter.DefineClass(IOleCache2) do
  begin
    DefineMethod('DiscardCache',1,tkInteger,nil,__IOleCache2DiscardCache,false,0,'dwDiscardOptions: Longint');
  end;
  With Scripter.DefineClass(IOleCacheControl) do
  begin
    DefineMethod('OnRun',1,tkInteger,nil,__IOleCacheControlOnRun,false,0,'dataObject: IDataObject');
    DefineMethod('OnStop',0,tkInteger,nil,__IOleCacheControlOnStop,false,0,'');
  end;
  With Scripter.DefineClass(IParseDisplayName) do
  begin
    DefineMethod('ParseDisplayName',4,tkInteger,nil,__IParseDisplayNameParseDisplayName,false,0,'bc: IBindCtx; pszDisplayName: POleStr; chEaten: Longint; mkOut: IMoniker').SetVarArgs([2,3]);
  end;
  With Scripter.DefineClass(IOleContainer) do
  begin
    DefineMethod('EnumObjects',2,tkInteger,nil,__IOleContainerEnumObjects,false,0,'grfFlags: Longint; Enum: IEnumUnknown').SetVarArgs([1]);
    DefineMethod('LockContainer',1,tkInteger,nil,__IOleContainerLockContainer,false,0,'fLock: BOOL');
  end;
  With Scripter.DefineClass(IOleClientSite) do
  begin
    DefineMethod('SaveObject',0,tkInteger,nil,__IOleClientSiteSaveObject,false,0,'');
    DefineMethod('GetMoniker',3,tkInteger,nil,__IOleClientSiteGetMoniker,false,0,'dwAssign: Longint; dwWhichMoniker: Longint; mk: IMoniker').SetVarArgs([2]);
    DefineMethod('GetContainer',1,tkInteger,nil,__IOleClientSiteGetContainer,false,0,'container: IOleContainer').SetVarArgs([0]);
    DefineMethod('ShowObject',0,tkInteger,nil,__IOleClientSiteShowObject,false,0,'');
    DefineMethod('OnShowWindow',1,tkInteger,nil,__IOleClientSiteOnShowWindow,false,0,'fShow: BOOL');
  ...
  begin
    DefineMethod('SetClientSite',1,tkInteger,nil,__IOleObjectSetClientSite,false,0,'clientSite: IOleClientSite');
    DefineMethod('GetClientSite',1,tkInteger,nil,__IOleObjectGetClientSite,false,0,'clientSite: IOleClientSite').SetVarArgs([0]);
    DefineMethod('SetHostNames',2,tkInteger,nil,__IOleObjectSetHostNames,false,0,'szContainerApp: POleStr; szContainerObj: POleStr');
    DefineMethod('Close',1,tkInteger,nil,__IOleObjectClose,false,0,'dwSaveOption: Longint');
    DefineMethod('SetMoniker',2,tkInteger,nil,__IOleObjectSetMoniker,false,0,'dwWhichMoniker: Longint; mk: IMoniker');
    DefineMethod('GetMoniker',3,tkInteger,nil,__IOleObjectGetMoniker,false,0,'dwAssign: Longint; dwWhichMoniker: Longint; mk: IMoniker').SetVarArgs([2]);
    DefineMethod('InitFromData',3,tkInteger,nil,__IOleObjectInitFromData,false,0,'dataObject: IDataObject; fCreation: BOOL; dwReserved: Longint');
    DefineMethod('GetClipboardData',2,tkInteger,nil,__IOleObjectGetClipboardData,false,0,'dwReserved: Longint; dataObject: IDataObject').SetVarArgs([1]);
    DefineMethod('EnumVerbs',1,tkInteger,nil,__IOleObjectEnumVerbs,false,0,'enumOleVerb: IEnumOleVerb').SetVarArgs([0]);
    ...
    DefineMethod('GetUserClassID',1,tkInteger,nil,__IOleObjectGetUserClassID,false,0,'clsid: TCLSID').SetVarArgs([0]);
    DefineMethod('GetUserType',2,tkInteger,nil,__IOleObjectGetUserType,false,0,'dwFormOfType: Longint; pszUserType: POleStr').SetVarArgs([1]);
    DefineMethod('SetExtent',2,tkInteger,nil,__IOleObjectSetExtent,false,0,'dwDrawAspect: Longint; size: TPoint');
    DefineMethod('GetExtent',2,tkInteger,nil,__IOleObjectGetExtent,false,0,'dwDrawAspect: Longint; size: TPoint').SetVarArgs([1]);
    DefineMethod('Advise',2,tkInteger,nil,__IOleObjectAdvise,false,0,'advSink: IAdviseSink; dwConnection: Longint').SetVarArgs([1]);
    DefineMethod('Unadvise',1,tkInteger,nil,__IOleObjectUnadvise,false,0,'dwConnection: Longint');
    DefineMethod('EnumAdvise',1,tkInteger,nil,__IOleObjectEnumAdvise,false,0,'enumAdvise: IEnumStatData').SetVarArgs([0]);
    DefineMethod('GetMiscStatus',2,tkInteger,nil,__IOleObjectGetMiscStatus,false,0,'dwAspect: Longint; dwStatus: Longint').SetVarArgs([1]);
    DefineMethod('SetColorScheme',1,tkInteger,nil,__IOleObjectSetColorScheme,false,0,'logpal: TLogPalette').SetVarArgs([0]);
  end;
  With Scripter.DefineClass(IOleWindow) do
  begin
    DefineMethod('GetWindow',1,tkInteger,nil,__IOleWindowGetWindow,false,0,'wnd: HWnd').SetVarArgs([0]);
    DefineMethod('ContextSensitiveHelp',1,tkInteger,nil,__IOleWindowContextSensitiveHelp,false,0,'fEnterMode: BOOL');
  end;
  With Scripter.DefineClass(IOleLink) do
  begin
    DefineMethod('SetUpdateOptions',1,tkInteger,nil,__IOleLinkSetUpdateOptions,false,0,'dwUpdateOpt: Longint');
    DefineMethod('GetUpdateOptions',1,tkInteger,nil,__IOleLinkGetUpdateOptions,false,0,'dwUpdateOpt: Longint').SetVarArgs([0]);
    DefineMethod('SetSourceMoniker',2,tkInteger,nil,__IOleLinkSetSourceMoniker,false,0,'mk: IMoniker; clsid: TCLSID');
    DefineMethod('GetSourceMoniker',1,tkInteger,nil,__IOleLinkGetSourceMoniker,false,0,'mk: IMoniker').SetVarArgs([0]);
    DefineMethod('SetSourceDisplayName',1,tkInteger,nil,__IOleLinkSetSourceDisplayName,false,0,'pszDisplayName: POleStr');
    DefineMethod('GetSourceDisplayName',1,tkInteger,nil,__IOleLinkGetSourceDisplayName,false,0,'pszDisplayName: POleStr').SetVarArgs([0]);
    DefineMethod('BindToSource',2,tkInteger,nil,__IOleLinkBindToSource,false,0,'bindflags: Longint; bc: IBindCtx');
    DefineMethod('BindIfRunning',0,tkInteger,nil,__IOleLinkBindIfRunning,false,0,'');
    DefineMethod('GetBoundSource',1,tkInteger,nil,__IOleLinkGetBoundSource,false,0,'unk: IUnknown').SetVarArgs([0]);
    DefineMethod('UnbindSource',0,tkInteger,nil,__IOleLinkUnbindSource,false,0,'');
    DefineMethod('Update',1,tkInteger,nil,__IOleLinkUpdate,false,0,'bc: IBindCtx');
  end;
  With Scripter.DefineClass(IOleItemContainer) do
  begin
    DefineMethod('GetObject',5,tkInteger,nil,__IOleItemContainerGetObject,false,0,'pszItem: POleStr; dwSpeedNeeded: Longint; bc: IBindCtx; iid: TIID; vObject').SetVarArgs([4]);
    DefineMethod('GetObjectStorage',4,tkInteger,nil,__IOleItemContainerGetObjectStorage,false,0,'pszItem: POleStr; bc: IBindCtx; iid: TIID; vStorage').SetVarArgs([3]);
    DefineMethod('IsRunning',1,tkInteger,nil,__IOleItemContainerIsRunning,false,0,'pszItem: POleStr');
  end;
  With Scripter.DefineClass(IOleInPlaceUIWindow) do
  begin
    DefineMethod('GetBorder',1,tkInteger,nil,__IOleInPlaceUIWindowGetBorder,false,0,'rectBorder: TRect').SetVarArgs([0]);
    DefineMethod('RequestBorderSpace',1,tkInteger,nil,__IOleInPlaceUIWindowRequestBorderSpace,false,0,'borderwidths: TRect');
    DefineMethod('SetActiveObject',2,tkInteger,nil,__IOleInPlaceUIWindowSetActiveObject,false,0,'activeObject: IOleInPlaceActiveObject; pszObjName: POleStr');
  end;
  With Scripter.DefineClass(IOleInPlaceActiveObject) do
  begin
    DefineMethod('TranslateAccelerator',1,tkInteger,nil,__IOleInPlaceActiveObjectTranslateAccelerator,false,0,'msg: TMsg').SetVarArgs([0]);
    DefineMethod('OnFrameWindowActivate',1,tkInteger,nil,__IOleInPlaceActiveObjectOnFrameWindowActivate,false,0,'fActivate: BOOL');
    DefineMethod('OnDocWindowActivate',1,tkInteger,nil,__IOleInPlaceActiveObjectOnDocWindowActivate,false,0,'fActivate: BOOL');
    DefineMethod('ResizeBorder',3,tkInteger,nil,__IOleInPlaceActiveObjectResizeBorder,false,0,'rcBorder: TRect; uiWindow: IOleInPlaceUIWindow; fFrameWindow: BOOL');
    DefineMethod('EnableModeless',1,tkInteger,nil,__IOleInPlaceActiveObjectEnableModeless,false,0,'fEnable: BOOL');
  end;
  With Scripter.DefineClass(IOleInPlaceFrame) do
  begin
    DefineMethod('InsertMenus',2,tkInteger,nil,__IOleInPlaceFrameInsertMenus,false,0,'hmenuShared: HMenu; menuWidths: TOleMenuGroupWidths').SetVarArgs([1]);
    DefineMethod('SetMenu',3,tkInteger,nil,__IOleInPlaceFrameSetMenu,false,0,'hmenuShared: HMenu; holemenu: HMenu; hwndActiveObject: HWnd');
    DefineMethod('RemoveMenus',1,tkInteger,nil,__IOleInPlaceFrameRemoveMenus,false,0,'hmenuShared: HMenu');
    DefineMethod('SetStatusText',1,tkInteger,nil,__IOleInPlaceFrameSetStatusText,false,0,'pszStatusText: POleStr');
    DefineMethod('EnableModeless',1,tkInteger,nil,__IOleInPlaceFrameEnableModeless,false,0,'fEnable: BOOL');
    DefineMethod('TranslateAccelerator',2,tkInteger,nil,__IOleInPlaceFrameTranslateAccelerator,false,0,'msg: TMsg; wID: Word').SetVarArgs([0]);
  end;
  ...
  begin
    ...
    DefineMethod('SetObjectRects',2,tkInteger,nil,__IOleInPlaceObjectSetObjectRects,false,0,'rcPosRect: TRect; rcClipRect: TRect');
  ...
  begin
    ...
    DefineMethod('GetWindowContext',5,tkInteger,nil,__IOleInPlaceSiteGetWindowContext,false,0,'frame: IOleInPlaceFrame; doc: IOleInPlaceUIWindow; rcPosRect: TRect; rcClipRect: TRect; frameInfo: TOleInPlaceFrameInfo').SetVarArgs([0,1,2,3,4]);
    DefineMethod('Scroll',1,tkInteger,nil,__IOleInPlaceSiteScroll,false,0,'scrollExtent: TPoint');
    DefineMethod('OnUIDeactivate',1,tkInteger,nil,__IOleInPlaceSiteOnUIDeactivate,false,0,'fUndoable: BOOL');
    ...
    DefineMethod('OnPosRectChange',1,tkInteger,nil,__IOleInPlaceSiteOnPosRectChange,false,0,'rcPosRect: TRect');
  end;
  With Scripter.DefineClass(IViewObject) do
  begin
    DefineMethod('Unfreeze',1,tkInteger,nil,__IViewObjectUnfreeze,false,0,'dwFreeze: Longint');
    DefineMethod('SetAdvise',3,tkInteger,nil,__IViewObjectSetAdvise,false,0,'aspects: Longint; advf: Longint; advSink: IAdviseSink');
  end;
  ...
  begin
    DefineMethod('QueryContinueDrag',2,tkInteger,nil,__IDropSourceQueryContinueDrag,false,0,'fEscapePressed: BOOL; grfKeyState: Longint');
    DefineMethod('GiveFeedback',1,tkInteger,nil,__IDropSourceGiveFeedback,false,0,'dwEffect: Longint');
  end;
  With Scripter.DefineClass(IDropTarget) do
  begin
    DefineMethod('DragEnter',4,tkInteger,nil,__IDropTargetDragEnter,false,0,'dataObj: IDataObject; grfKeyState: Longint; pt: TPoint; dwEffect: Longint').SetVarArgs([3]);
    DefineMethod('DragOver',3,tkInteger,nil,__IDropTargetDragOver,false,0,'grfKeyState: Longint; pt: TPoint; dwEffect: Longint').SetVarArgs([2]);
    DefineMethod('DragLeave',0,tkInteger,nil,__IDropTargetDragLeave,false,0,'');
    DefineMethod('Drop',4,tkInteger,nil,__IDropTargetDrop,false,0,'dataObj: IDataObject; grfKeyState: Longint; pt: TPoint; dwEffect: Longint').SetVarArgs([3]);
  end;
  With Scripter.DefineClass(IEnumOleVerb) do
  begin
    DefineMethod('Skip',1,tkInteger,nil,__IEnumOleVerbSkip,false,0,'celt: Longint');
    DefineMethod('Reset',0,tkInteger,nil,__IEnumOleVerbReset,false,0,'');
    DefineMethod('Clone',1,tkInteger,nil,__IEnumOleVerbClone,false,0,'enm: IEnumOleVerb').SetVarArgs([0]);
  end;
  With Scripter.DefineClass(IOleDocumentView) do
  begin
    DefineMethod('SetInPlaceSite',1,tkInteger,nil,__IOleDocumentViewSetInPlaceSite,false,0,'Site: IOleInPlaceSite');
    DefineMethod('GetInPlaceSite',1,tkInteger,nil,__IOleDocumentViewGetInPlaceSite,false,0,'Site: IOleInPlaceSite').SetVarArgs([0]);
    DefineMethod('GetDocument',1,tkInteger,nil,__IOleDocumentViewGetDocument,false,0,'P: IUnknown').SetVarArgs([0]);
    DefineMethod('SetRect',1,tkInteger,nil,__IOleDocumentViewSetRect,false,0,'View: TRECT');
    DefineMethod('GetRect',1,tkInteger,nil,__IOleDocumentViewGetRect,false,0,'View: TRECT').SetVarArgs([0]);
    DefineMethod('SetRectComplex',4,tkInteger,nil,__IOleDocumentViewSetRectComplex,false,0,'View; HScroll; VScroll; SizeBox');
    DefineMethod('Show',1,tkInteger,nil,__IOleDocumentViewShow,false,0,'fShow: BOOL');
    DefineMethod('UIActivate',1,tkInteger,nil,__IOleDocumentViewUIActivate,false,0,'fUIActivate: BOOL');
    DefineMethod('Open',0,tkInteger,nil,__IOleDocumentViewOpen,false,0,'');
    DefineMethod('CloseView',1,tkInteger,nil,__IOleDocumentViewCloseView,false,0,'dwReserved: DWORD');
    DefineMethod('SaveViewState',1,tkInteger,nil,__IOleDocumentViewSaveViewState,false,0,'pstm: IStream');
    DefineMethod('ApplyViewState',1,tkInteger,nil,__IOleDocumentViewApplyViewState,false,0,'pstm: IStream');
    DefineMethod('Clone',2,tkInteger,nil,__IOleDocumentViewClone,false,0,'NewSite: IOleInPlaceSite; NewView: IOleDocumentView').SetVarArgs([1]);
  end;
  With Scripter.DefineClass(IEnumOleDocumentViews) do
  begin
    DefineMethod('Next',3,tkInteger,nil,__IEnumOleDocumentViewsNext,false,0,'Count: Longint; View: IOleDocumentView; Fetched: Longint').SetVarArgs([1,2]);
    DefineMethod('Skip',1,tkInteger,nil,__IEnumOleDocumentViewsSkip,false,0,'Count: Longint');
    DefineMethod('Reset',0,tkInteger,nil,__IEnumOleDocumentViewsReset,false,0,'');
    DefineMethod('Clone',1,tkInteger,nil,__IEnumOleDocumentViewsClone,false,0,'Enum: IEnumOleDocumentViews').SetVarArgs([0]);
  end;
  With Scripter.DefineClass(IOleDocument) do
  begin
    DefineMethod('CreateView',4,tkInteger,nil,__IOleDocumentCreateView,false,0,'Site: IOleInPlaceSite; Stream: IStream; rsrvd: DWORD; View: IOleDocumentView').SetVarArgs([3]);
    DefineMethod('GetDocMiscStatus',1,tkInteger,nil,__IOleDocumentGetDocMiscStatus,false,0,'Status: DWORD').SetVarArgs([0]);
    DefineMethod('EnumViews',2,tkInteger,nil,__IOleDocumentEnumViews,false,0,'Enum: IEnumOleDocumentViews; View: IOleDocumentView').SetVarArgs([0,1]);
  end;
  With Scripter.DefineClass(IOleDocumentSite) do
  begin
    DefineMethod('ActivateMe',1,tkInteger,nil,__IOleDocumentSiteActivateMe,false,0,'View: IOleDocumentView');
  end;
  With Scripter.DefineClass(ClassType) do
  begin
    DefineMethod('Succeeded',1,tkVariant,nil,__Succeeded,false,0,'Res: HResult');
    DefineMethod('Failed',1,tkVariant,nil,__Failed,false,0,'Res: HResult');
    DefineMethod('ResultCode',1,tkInteger,nil,__ResultCode,false,0,'Res: HResult');
    DefineMethod('ResultFacility',1,tkInteger,nil,__ResultFacility,false,0,'Res: HResult');
    DefineMethod('ResultSeverity',1,tkInteger,nil,__ResultSeverity,false,0,'Res: HResult');
    DefineMethod('MakeResult',3,tkInteger,nil,__MakeResult,false,0,'Severity: Integer; Facility: Integer; Code: Integer');
    DefineMethod('IsEqualGUID',2,tkVariant,nil,__IsEqualGUID,false,0,'guid1: TGUID; guid2: TGUID');
    DefineMethod('IsEqualIID',2,tkVariant,nil,__IsEqualIID,false,0,'iid1: TIID; iid2: TIID');
    DefineMethod('IsEqualCLSID',2,tkVariant,nil,__IsEqualCLSID,false,0,'clsid1: TCLSID; clsid2: TCLSID');
    ...
    DefineMethod('CoGetMalloc',2,tkInteger,nil,__CoGetMalloc,false,0,'dwMemContext: Longint; malloc: IMalloc').SetVarArgs([1]);
    DefineMethod('CoGetCurrentProcess',0,tkInteger,nil,__CoGetCurrentProcess,false,0,'');
    DefineMethod('CoRegisterMallocSpy',1,tkInteger,nil,__CoRegisterMallocSpy,false,0,'mallocSpy: IMallocSpy');
    DefineMethod('CoRevokeMallocSpy',0,tkInteger,nil,__CoRevokeMallocSpy,false,0,'');
    DefineMethod('CoRegisterClassObject',5,tkInteger,nil,__CoRegisterClassObject,false,0,'clsid: TCLSID; unk: IUnknown; dwClsContext: Longint; flags: Longint; dwRegister: Longint').SetVarArgs([4]);
    DefineMethod('CoRevokeClassObject',1,tkInteger,nil,__CoRevokeClassObject,false,0,'dwRegister: Longint');
    DefineMethod('CoUnmarshalInterface',3,tkInteger,nil,__CoUnmarshalInterface,false,0,'stm: IStream; iid: TIID; pv').SetVarArgs([2]);
    DefineMethod('CoReleaseMarshalData',1,tkInteger,nil,__CoReleaseMarshalData,false,0,'stm: IStream');
    DefineMethod('CoDisconnectObject',2,tkInteger,nil,__CoDisconnectObject,false,0,'unk: IUnknown; dwReserved: Longint');
    DefineMethod('CoLockObjectExternal',3,tkInteger,nil,__CoLockObjectExternal,false,0,'unk: IUnknown; fLock: BOOL; fLastUnlockReleases: BOOL');
    DefineMethod('CoIsHandlerConnected',1,tkVariant,nil,__CoIsHandlerConnected,false,0,'unk: IUnknown');
    DefineMethod('CoMarshalInterThreadInterfaceInStream',3,tkInteger,nil,__CoMarshalInterThreadInterfaceInStream,false,0,'iid: TIID; unk: IUnknown; stm: IStream').SetVarArgs([2]);
    DefineMethod('CoGetInterfaceAndReleaseStream',3,tkInteger,nil,__CoGetInterfaceAndReleaseStream,false,0,'stm: IStream; iid: TIID; pv').SetVarArgs([2]);
    DefineMethod('CoCreateFreeThreadedMarshaler',2,tkInteger,nil,__CoCreateFreeThreadedMarshaler,false,0,'unkOuter: IUnknown; unkMarshal: IUnknown').SetVarArgs([1]);
    DefineMethod('CoLoadLibrary',2,tkInteger,nil,__CoLoadLibrary,false,0,'pszLibName: POleStr; bAutoFree: BOOL');
    DefineMethod('CoFreeLibrary',1,tkNone,nil,__CoFreeLibrary,false,0,'hInst: THandle');
    ...
    DefineMethod('CoCreateInstance',5,tkInteger,nil,__CoCreateInstance,false,0,'clsid: TCLSID; unkOuter: IUnknown; dwClsContext: Longint; iid: TIID; pv').SetVarArgs([4]);
    DefineMethod('StringFromCLSID',2,tkInteger,nil,__StringFromCLSID,false,0,'clsid: TCLSID; psz: POleStr').SetVarArgs([1]);
    DefineMethod('CLSIDFromString',2,tkInteger,nil,__CLSIDFromString,false,0,'psz: POleStr; clsid: TCLSID').SetVarArgs([1]);
    DefineMethod('StringFromIID',2,tkInteger,nil,__StringFromIID,false,0,'iid: TIID; psz: POleStr').SetVarArgs([1]);
    DefineMethod('IIDFromString',2,tkInteger,nil,__IIDFromString,false,0,'psz: POleStr; iid: TIID').SetVarArgs([1]);
    DefineMethod('CoIsOle1Class',1,tkVariant,nil,__CoIsOle1Class,false,0,'clsid: TCLSID');
    DefineMethod('ProgIDFromCLSID',2,tkInteger,nil,__ProgIDFromCLSID,false,0,'clsid: TCLSID; pszProgID: POleStr').SetVarArgs([1]);
    DefineMethod('CLSIDFromProgID',2,tkInteger,nil,__CLSIDFromProgID,false,0,'pszProgID: POleStr; clsid: TCLSID').SetVarArgs([1]);
    DefineMethod('StringFromGUID2',3,tkInteger,nil,__StringFromGUID2,false,0,'guid: TGUID; psz: POleStr; cbMax: Integer');
    DefineMethod('CoCreateGuid',1,tkInteger,nil,__CoCreateGuid,false,0,'guid: TGUID').SetVarArgs([0]);
    DefineMethod('CoFileTimeToDosDateTime',3,tkVariant,nil,__CoFileTimeToDosDateTime,false,0,'filetime: TFileTime; dosDate: Word; dosTime: Word').SetVarArgs([0,1,2]);
    DefineMethod('CoDosDateTimeToFileTime',3,tkVariant,nil,__CoDosDateTimeToFileTime,false,0,'nDosDate: Word; nDosTime: Word; filetime: TFileTime').SetVarArgs([2]);
    DefineMethod('CoFileTimeNow',1,tkInteger,nil,__CoFileTimeNow,false,0,'filetime: TFileTime').SetVarArgs([0]);
    DefineMethod('CoRegisterMessageFilter',2,tkInteger,nil,__CoRegisterMessageFilter,false,0,'messageFilter: IMessageFilter; pMessageFilter: IMessageFilter').SetVarArgs([1]);
    DefineMethod('CoGetTreatAsClass',2,tkInteger,nil,__CoGetTreatAsClass,false,0,'clsidOld: TCLSID; clsidNew: TCLSID').SetVarArgs([1]);
    DefineMethod('CoTreatAsClass',2,tkInteger,nil,__CoTreatAsClass,false,0,'clsidOld: TCLSID; clsidNew: TCLSID');
    DefineMethod('CreateDataAdviseHolder',1,tkInteger,nil,__CreateDataAdviseHolder,false,0,'DAHolder: IDataAdviseHolder').SetVarArgs([0]);
    DefineMethod('CreateDataCache',4,tkInteger,nil,__CreateDataCache,false,0,'unkOuter: IUnknown; clsid: TCLSID; iid: TIID; pv').SetVarArgs([3]);
    DefineMethod('StgCreateDocfile',4,tkInteger,nil,__StgCreateDocfile,false,0,'pwcsName: POleStr; grfMode: Longint; reserved: Longint; stgOpen: IStorage').SetVarArgs([3]);
    DefineMethod('StgCreateDocfileOnILockBytes',4,tkInteger,nil,__StgCreateDocfileOnILockBytes,false,0,'lkbyt: ILockBytes; grfMode: Longint; reserved: Longint; stgOpen: IStorage').SetVarArgs([3]);
    DefineMethod('StgIsStorageFile',1,tkInteger,nil,__StgIsStorageFile,false,0,'pwcsName: POleStr');
    DefineMethod('StgIsStorageILockBytes',1,tkInteger,nil,__StgIsStorageILockBytes,false,0,'lkbyt: ILockBytes');
    DefineMethod('StgSetTimes',4,tkInteger,nil,__StgSetTimes,false,0,'pszName: POleStr; ctime: TFileTime; atime: TFileTime; mtime: TFileTime');
    DefineMethod('BindMoniker',4,tkInteger,nil,__BindMoniker,false,0,'mk: IMoniker; grfOpt: Longint; iidResult: TIID; pvResult').SetVarArgs([3]);
    DefineMethod('MkParseDisplayName',4,tkInteger,nil,__MkParseDisplayName,false,0,'bc: IBindCtx; szUserName: POleStr; chEaten: Longint; mk: IMoniker').SetVarArgs([2,3]);
    DefineMethod('MonikerRelativePathTo',4,tkInteger,nil,__MonikerRelativePathTo,false,0,'mkSrc: IMoniker; mkDest: IMoniker; mkRelPath: IMoniker; dwReserved: BOOL').SetVarArgs([2]);
    DefineMethod('MonikerCommonPrefixWith',3,tkInteger,nil,__MonikerCommonPrefixWith,false,0,'mkThis: IMoniker; mkOther: IMoniker; mkCommon: IMoniker').SetVarArgs([2]);
    DefineMethod('CreateBindCtx',2,tkInteger,nil,__CreateBindCtx,false,0,'reserved: Longint; bc: IBindCtx').SetVarArgs([1]);
    DefineMethod('CreateGenericComposite',3,tkInteger,nil,__CreateGenericComposite,false,0,'mkFirst: IMoniker; mkRest: IMoniker; mkComposite: IMoniker').SetVarArgs([2]);
    DefineMethod('GetClassFile',2,tkInteger,nil,__GetClassFile,false,0,'szFilename: POleStr; clsid: TCLSID').SetVarArgs([1]);
    DefineMethod('CreateFileMoniker',2,tkInteger,nil,__CreateFileMoniker,false,0,'pszPathName: POleStr; mk: IMoniker').SetVarArgs([1]);
    DefineMethod('CreateItemMoniker',3,tkInteger,nil,__CreateItemMoniker,false,0,'pszDelim: POleStr; pszItem: POleStr; mk: IMoniker').SetVarArgs([2]);
    DefineMethod('CreateAntiMoniker',1,tkInteger,nil,__CreateAntiMoniker,false,0,'mk: IMoniker').SetVarArgs([0]);
    DefineMethod('CreatePointerMoniker',2,tkInteger,nil,__CreatePointerMoniker,false,0,'unk: IUnknown; mk: IMoniker').SetVarArgs([1]);
    DefineMethod('GetRunningObjectTable',2,tkInteger,nil,__GetRunningObjectTable,false,0,'reserved: Longint; rot: IRunningObjectTable').SetVarArgs([1]);
    DefineMethod('SysAllocString',1,tkVariant,nil,__SysAllocString,false,0,'psz: POleStr');
    DefineMethod('SysReAllocString',2,tkInteger,nil,__SysReAllocString,false,0,'bstr: TBStr; psz: POleStr').SetVarArgs([0]);
    DefineMethod('SysAllocStringLen',2,tkVariant,nil,__SysAllocStringLen,false,0,'psz: POleStr; len: Integer');
    DefineMethod('SysReAllocStringLen',3,tkInteger,nil,__SysReAllocStringLen,false,0,'bstr: TBStr; psz: POleStr; len: Integer').SetVarArgs([0]);
    DefineMethod('SysFreeString',1,tkNone,nil,__SysFreeString,false,0,'bstr: TBStr');
    DefineMethod('SysStringLen',1,tkInteger,nil,__SysStringLen,false,0,'bstr: TBStr');
    DefineMethod('SysStringByteLen',1,tkInteger,nil,__SysStringByteLen,false,0,'bstr: TBStr');
    DefineMethod('SysAllocStringByteLen',2,tkVariant,nil,__SysAllocStringByteLen,false,0,'psz: PChar; len: Integer');
    DefineMethod('DosDateTimeToVariantTime',3,tkInteger,nil,__DosDateTimeToVariantTime,false,0,'wDosDate: Word; wDosTime: Word; vtime: TOleDate').SetVarArgs([2]);
    DefineMethod('VariantTimeToDosDateTime',3,tkInteger,nil,__VariantTimeToDosDateTime,false,0,'vtime: TOleDate; wDosDate: Word; wDosTime: Word').SetVarArgs([1,2]);
    DefineMethod('VariantInit',1,tkNone,nil,__VariantInit,false,0,'varg: Variant').SetVarArgs([0]);
    DefineMethod('VariantClear',1,tkInteger,nil,__VariantClear,false,0,'varg: Variant').SetVarArgs([0]);
    DefineMethod('VariantCopy',2,tkInteger,nil,__VariantCopy,false,0,'vargDest: Variant; vargSrc: Variant').SetVarArgs([0]);
    DefineMethod('VariantCopyInd',2,tkInteger,nil,__VariantCopyInd,false,0,'varDest: Variant; vargSrc: Variant').SetVarArgs([0]);
    DefineMethod('VariantChangeType',4,tkInteger,nil,__VariantChangeType,false,0,'vargDest: Variant; vargSrc: Variant; wFlags: Word; vt: TVarType').SetVarArgs([0]);
    DefineMethod('VariantChangeTypeEx',5,tkInteger,nil,__VariantChangeTypeEx,false,0,'vargDest: Variant; vargSrc: Variant; lcid: TLCID; wFlags: Word; vt: TVarType').SetVarArgs([0]);
    DefineMethod('VarUI1FromI2',2,tkInteger,nil,__VarUI1FromI2,false,0,'sIn: Smallint; bOut: Byte').SetVarArgs([1]);
    DefineMethod('VarUI1FromI4',2,tkInteger,nil,__VarUI1FromI4,false,0,'lIn: Longint; bOut: Byte').SetVarArgs([1]);
    DefineMethod('VarUI1FromR4',2,tkInteger,nil,__VarUI1FromR4,false,0,'fltIn: Single; bOut: Byte').SetVarArgs([1]);
    DefineMethod('VarUI1FromR8',2,tkInteger,nil,__VarUI1FromR8,false,0,'dblIn: Double; bOut: Byte').SetVarArgs([1]);
    DefineMethod('VarUI1FromCy',2,tkInteger,nil,__VarUI1FromCy,false,0,'cyIn: TCurrency; bOut: Byte').SetVarArgs([1]);
    DefineMethod('VarUI1FromDate',2,tkInteger,nil,__VarUI1FromDate,false,0,'dateIn: TOleDate; bOut: Byte').SetVarArgs([1]);
    DefineMethod('VarUI1FromStr',4,tkInteger,nil,__VarUI1FromStr,false,0,'strIn: TBStr; lcid: TLCID; dwFlags: Longint; bOut: Byte').SetVarArgs([3]);
    DefineMethod('VarUI1FromDisp',3,tkInteger,nil,__VarUI1FromDisp,false,0,'dispIn: IDispatch; lcid: TLCID; bOut: Byte').SetVarArgs([2]);
    DefineMethod('VarUI1FromBool',2,tkInteger,nil,__VarUI1FromBool,false,0,'boolIn: TOleBool; bOut: Byte').SetVarArgs([1]);
    DefineMethod('VarI2FromUI1',2,tkInteger,nil,__VarI2FromUI1,false,0,'bIn: Byte; sOut: Smallint').SetVarArgs([1]);
    DefineMethod('VarI2FromI4',2,tkInteger,nil,__VarI2FromI4,false,0,'lIn: Longint; sOut: Smallint').SetVarArgs([1]);
    DefineMethod('VarI2FromR4',2,tkInteger,nil,__VarI2FromR4,false,0,'fltIn: Single; sOut: Smallint').SetVarArgs([1]);
    DefineMethod('VarI2FromR8',2,tkInteger,nil,__VarI2FromR8,false,0,'dblIn: Double; sOut: Smallint').SetVarArgs([1]);
    DefineMethod('VarI2FromCy',2,tkInteger,nil,__VarI2FromCy,false,0,'cyIn: TCurrency; sOut: Smallint').SetVarArgs([1]);
    DefineMethod('VarI2FromDate',2,tkInteger,nil,__VarI2FromDate,false,0,'dateIn: TOleDate; sOut: Smallint').SetVarArgs([1]);
    DefineMethod('VarI2FromStr',4,tkInteger,nil,__VarI2FromStr,false,0,'strIn: TBStr; lcid: TLCID; dwFlags: Longint; sOut: Smallint').SetVarArgs([3]);
    DefineMethod('VarI2FromDisp',3,tkInteger,nil,__VarI2FromDisp,false,0,'dispIn: IDispatch; lcid: TLCID; sOut: Smallint').SetVarArgs([2]);
    DefineMethod('VarI2FromBool',2,tkInteger,nil,__VarI2FromBool,false,0,'boolIn: TOleBool; sOut: Smallint').SetVarArgs([1]);
    DefineMethod('VarI4FromUI1',2,tkInteger,nil,__VarI4FromUI1,false,0,'bIn: Byte; lOut: Longint').SetVarArgs([1]);
    DefineMethod('VarI4FromI2',2,tkInteger,nil,__VarI4FromI2,false,0,'sIn: Smallint; lOut: Longint').SetVarArgs([1]);
    DefineMethod('VarI4FromR4',2,tkInteger,nil,__VarI4FromR4,false,0,'fltIn: Single; lOut: Longint').SetVarArgs([1]);
    DefineMethod('VarI4FromR8',2,tkInteger,nil,__VarI4FromR8,false,0,'dblIn: Double; lOut: Longint').SetVarArgs([1]);
    DefineMethod('VarI4FromCy',2,tkInteger,nil,__VarI4FromCy,false,0,'cyIn: TCurrency; lOut: Longint').SetVarArgs([1]);
    DefineMethod('VarI4FromDate',2,tkInteger,nil,__VarI4FromDate,false,0,'dateIn: TOleDate; lOut: Longint').SetVarArgs([1]);
    DefineMethod('VarI4FromStr',4,tkInteger,nil,__VarI4FromStr,false,0,'strIn: TBStr; lcid: TLCID; dwFlags: Longint; lOut: Longint').SetVarArgs([3]);
    DefineMethod('VarI4FromDisp',3,tkInteger,nil,__VarI4FromDisp,false,0,'dispIn: IDispatch; lcid: TLCID; lOut: Longint').SetVarArgs([2]);
    DefineMethod('VarI4FromBool',2,tkInteger,nil,__VarI4FromBool,false,0,'boolIn: TOleBool; lOut: Longint').SetVarArgs([1]);
    DefineMethod('VarR4FromUI1',2,tkInteger,nil,__VarR4FromUI1,false,0,'bIn: Byte; fltOut: Single').SetVarArgs([1]);
    DefineMethod('VarR4FromI2',2,tkInteger,nil,__VarR4FromI2,false,0,'sIn: Smallint; fltOut: Single').SetVarArgs([1]);
    DefineMethod('VarR4FromI4',2,tkInteger,nil,__VarR4FromI4,false,0,'lIn: Longint; fltOut: Single').SetVarArgs([1]);
    DefineMethod('VarR4FromR8',2,tkInteger,nil,__VarR4FromR8,false,0,'dblIn: Double; fltOut: Single').SetVarArgs([1]);
    DefineMethod('VarR4FromCy',2,tkInteger,nil,__VarR4FromCy,false,0,'cyIn: TCurrency; fltOut: Single').SetVarArgs([1]);
    DefineMethod('VarR4FromDate',2,tkInteger,nil,__VarR4FromDate,false,0,'dateIn: TOleDate; fltOut: Single').SetVarArgs([1]);
    DefineMethod('VarR4FromStr',4,tkInteger,nil,__VarR4FromStr,false,0,'strIn: TBStr; lcid: TLCID; dwFlags: Longint; fltOut: Single').SetVarArgs([3]);
    DefineMethod('VarR4FromDisp',3,tkInteger,nil,__VarR4FromDisp,false,0,'dispIn: IDispatch; lcid: TLCID; fltOut: Single').SetVarArgs([2]);
    DefineMethod('VarR4FromBool',2,tkInteger,nil,__VarR4FromBool,false,0,'boolIn: TOleBool; fltOut: Single').SetVarArgs([1]);
    DefineMethod('VarR8FromUI1',2,tkInteger,nil,__VarR8FromUI1,false,0,'bIn: Byte; dblOut: Double').SetVarArgs([1]);
    DefineMethod('VarR8FromI2',2,tkInteger,nil,__VarR8FromI2,false,0,'sIn: Smallint; dblOut: Double').SetVarArgs([1]);
    DefineMethod('VarR8FromI4',2,tkInteger,nil,__VarR8FromI4,false,0,'lIn: Longint; dblOut: Double').SetVarArgs([1]);
    DefineMethod('VarR8FromR4',2,tkInteger,nil,__VarR8FromR4,false,0,'fltIn: Single; dblOut: Double').SetVarArgs([1]);
    DefineMethod('VarR8FromCy',2,tkInteger,nil,__VarR8FromCy,false,0,'cyIn: TCurrency; dblOut: Double').SetVarArgs([1]);
    DefineMethod('VarR8FromDate',2,tkInteger,nil,__VarR8FromDate,false,0,'dateIn: TOleDate; dblOut: Double').SetVarArgs([1]);
    DefineMethod('VarR8FromStr',4,tkInteger,nil,__VarR8FromStr,false,0,'strIn: TBStr; lcid: TLCID; dwFlags: Longint; dblOut: Double').SetVarArgs([3]);
    DefineMethod('VarR8FromDisp',3,tkInteger,nil,__VarR8FromDisp,false,0,'dispIn: IDispatch; lcid: TLCID; dblOut: Double').SetVarArgs([2]);
    DefineMethod('VarR8FromBool',2,tkInteger,nil,__VarR8FromBool,false,0,'boolIn: TOleBool; dblOut: Double').SetVarArgs([1]);
    DefineMethod('VarDateFromUI1',2,tkInteger,nil,__VarDateFromUI1,false,0,'bIn: Byte; dateOut: TOleDate').SetVarArgs([1]);
    DefineMethod('VarDateFromI2',2,tkInteger,nil,__VarDateFromI2,false,0,'sIn: Smallint; dateOut: TOleDate').SetVarArgs([1]);
    DefineMethod('VarDateFromI4',2,tkInteger,nil,__VarDateFromI4,false,0,'lIn: Longint; dateOut: TOleDate').SetVarArgs([1]);
    DefineMethod('VarDateFromR4',2,tkInteger,nil,__VarDateFromR4,false,0,'fltIn: Single; dateOut: TOleDate').SetVarArgs([1]);
    DefineMethod('VarDateFromR8',2,tkInteger,nil,__VarDateFromR8,false,0,'dblIn: Double; dateOut: TOleDate').SetVarArgs([1]);
    DefineMethod('VarDateFromCy',2,tkInteger,nil,__VarDateFromCy,false,0,'cyIn: TCurrency; dateOut: TOleDate').SetVarArgs([1]);
    DefineMethod('VarDateFromStr',4,tkInteger,nil,__VarDateFromStr,false,0,'strIn: TBStr; lcid: TLCID; dwFlags: Longint; dateOut: TOleDate').SetVarArgs([3]);
    DefineMethod('VarDateFromDisp',3,tkInteger,nil,__VarDateFromDisp,false,0,'dispIn: IDispatch; lcid: TLCID; dateOut: TOleDate').SetVarArgs([2]);
    DefineMethod('VarDateFromBool',2,tkInteger,nil,__VarDateFromBool,false,0,'boolIn: TOleBool; dateOut: TOleDate').SetVarArgs([1]);
    DefineMethod('VarCyFromUI1',2,tkInteger,nil,__VarCyFromUI1,false,0,'bIn: Byte; cyOut: TCurrency').SetVarArgs([1]);
    DefineMethod('VarCyFromI2',2,tkInteger,nil,__VarCyFromI2,false,0,'sIn: Smallint; cyOut: TCurrency').SetVarArgs([1]);
    DefineMethod('VarCyFromI4',2,tkInteger,nil,__VarCyFromI4,false,0,'lIn: Longint; cyOut: TCurrency').SetVarArgs([1]);
    DefineMethod('VarCyFromR4',2,tkInteger,nil,__VarCyFromR4,false,0,'fltIn: Single; cyOut: TCurrency').SetVarArgs([1]);
    DefineMethod('VarCyFromR8',2,tkInteger,nil,__VarCyFromR8,false,0,'dblIn: Double; cyOut: TCurrency').SetVarArgs([1]);
    DefineMethod('VarCyFromDate',2,tkInteger,nil,__VarCyFromDate,false,0,'dateIn: TOleDate; cyOut: TCurrency').SetVarArgs([1]);
    DefineMethod('VarCyFromStr',4,tkInteger,nil,__VarCyFromStr,false,0,'strIn: TBStr; lcid: TLCID; dwFlags: Longint; cyOut: TCurrency').SetVarArgs([3]);
    DefineMethod('VarCyFromDisp',3,tkInteger,nil,__VarCyFromDisp,false,0,'dispIn: IDispatch; lcid: TLCID; cyOut: TCurrency').SetVarArgs([2]);
    DefineMethod('VarCyFromBool',2,tkInteger,nil,__VarCyFromBool,false,0,'boolIn: TOleBool; cyOut: TCurrency').SetVarArgs([1]);
    DefineMethod('VarBoolFromUI1',2,tkInteger,nil,__VarBoolFromUI1,false,0,'bIn: Byte; boolOut: TOleBool').SetVarArgs([1]);
    DefineMethod('VarBoolFromI2',2,tkInteger,nil,__VarBoolFromI2,false,0,'sIn: Smallint; boolOut: TOleBool').SetVarArgs([1]);
    DefineMethod('VarBoolFromI4',2,tkInteger,nil,__VarBoolFromI4,false,0,'lIn: Longint; boolOut: TOleBool').SetVarArgs([1]);
    DefineMethod('VarBoolFromR4',2,tkInteger,nil,__VarBoolFromR4,false,0,'fltIn: Single; boolOut: TOleBool').SetVarArgs([1]);
    DefineMethod('VarBoolFromR8',2,tkInteger,nil,__VarBoolFromR8,false,0,'dblIn: Double; boolOut: TOleBool').SetVarArgs([1]);
    DefineMethod('VarBoolFromDate',2,tkInteger,nil,__VarBoolFromDate,false,0,'dateIn: TOleDate; boolOut: TOleBool').SetVarArgs([1]);
    DefineMethod('VarBoolFromCy',2,tkInteger,nil,__VarBoolFromCy,false,0,'cyIn: TCurrency; boolOut: TOleBool').SetVarArgs([1]);
    DefineMethod('VarBoolFromStr',4,tkInteger,nil,__VarBoolFromStr,false,0,'strIn: TBStr; lcid: TLCID; dwFlags: Longint; boolOut: TOleBool').SetVarArgs([3]);
    DefineMethod('VarBoolFromDisp',3,tkInteger,nil,__VarBoolFromDisp,false,0,'dispIn: IDispatch; lcid: TLCID; boolOut: TOleBool').SetVarArgs([2]);
    DefineMethod('LHashValOfNameSys',3,tkInteger,nil,__LHashValOfNameSys,false,0,'syskind: TSysKind; lcid: TLCID; szName: POleStr');
    DefineMethod('LHashValOfNameSysA',3,tkInteger,nil,__LHashValOfNameSysA,false,0,'syskind: TSysKind; lcid: TLCID; szName: PChar');
    DefineMethod('LHashValOfName',2,tkInteger,nil,__LHashValOfName,false,0,'lcid: TLCID; szName: POleStr');
    DefineMethod('WHashValOfLHashVal',1,tkInteger,nil,__WHashValOfLHashVal,false,0,'lhashval: Longint');
    DefineMethod('IsHashValCompatible',2,tkVariant,nil,__IsHashValCompatible,false,0,'lhashval1: Longint; lhashval2: Longint');
    DefineMethod('LoadTypeLib',2,tkInteger,nil,__LoadTypeLib,false,0,'szFile: POleStr; tlib: ITypeLib').SetVarArgs([1]);
    DefineMethod('LoadRegTypeLib',5,tkInteger,nil,__LoadRegTypeLib,false,0,'guid: TGUID; wVerMajor: Word; wVerMinor: Word; lcid: TLCID; tlib: ITypeLib').SetVarArgs([4]);
    DefineMethod('QueryPathOfRegTypeLib',5,tkInteger,nil,__QueryPathOfRegTypeLib,false,0,'guid: TGUID; wMaj: Word; wMin: Word; lcid: TLCID; bstrPathName: TBStr').SetVarArgs([4]);
    DefineMethod('RegisterTypeLib',3,tkInteger,nil,__RegisterTypeLib,false,0,'tlib: ITypeLib; szFullPath: POleStr; szHelpDir: POleStr');
    DefineMethod('CreateTypeLib',3,tkInteger,nil,__CreateTypeLib,false,0,'syskind: TSysKind; szFile: POleStr; ctlib: ICreateTypeLib').SetVarArgs([2]);
    DefineMethod('DispGetParam',5,tkInteger,nil,__DispGetParam,false,0,'dispparams: TDispParams; position: Integer; vtTarg: TVarType; varResult: Variant; puArgErr: Integer').SetVarArgs([0,3,4]);
    DefineMethod('DispGetIDsOfNames',4,tkInteger,nil,__DispGetIDsOfNames,false,0,'tinfo: ITypeInfo; rgszNames; cNames: Integer; rgdispid').SetVarArgs([1,3]);
    DefineMethod('CreateDispTypeInfo',3,tkInteger,nil,__CreateDispTypeInfo,false,0,'idata: TInterfaceData; lcid: TLCID; tinfo: ITypeInfo').SetVarArgs([0,2]);
    DefineMethod('RegisterActiveObject',4,tkInteger,nil,__RegisterActiveObject,false,0,'unk: IUnknown; clsid: TCLSID; dwFlags: Longint; dwRegister: Longint').SetVarArgs([3]);
    DefineMethod('SetErrorInfo',2,tkInteger,nil,__SetErrorInfo,false,0,'dwReserved: Longint; errinfo: IErrorInfo');
    DefineMethod('GetErrorInfo',2,tkInteger,nil,__GetErrorInfo,false,0,'dwReserved: Longint; errinfo: IErrorInfo').SetVarArgs([1]);
    DefineMethod('CreateErrorInfo',1,tkInteger,nil,__CreateErrorInfo,false,0,'errinfo: ICreateErrorInfo').SetVarArgs([0]);
    ...
    DefineMethod('ReadClassStg',2,tkInteger,nil,__ReadClassStg,false,0,'stg: IStorage; clsid: TCLSID').SetVarArgs([1]);
    DefineMethod('WriteClassStg',2,tkInteger,nil,__WriteClassStg,false,0,'stg: IStorage; clsid: TIID');
    DefineMethod('ReadClassStm',2,tkInteger,nil,__ReadClassStm,false,0,'stm: IStream; clsid: TCLSID').SetVarArgs([1]);
    DefineMethod('WriteClassStm',2,tkInteger,nil,__WriteClassStm,false,0,'stm: IStream; clsid: TIID');
    DefineMethod('WriteFmtUserTypeStg',3,tkInteger,nil,__WriteFmtUserTypeStg,false,0,'stg: IStorage; cf: TClipFormat; pszUserType: POleStr');
    DefineMethod('ReadFmtUserTypeStg',3,tkInteger,nil,__ReadFmtUserTypeStg,false,0,'stg: IStorage; cf: TClipFormat; pszUserType: POleStr').SetVarArgs([1,2]);
    DefineMethod('OleUninitialize',0,tkNone,nil,__OleUninitialize,false,0,'');
    DefineMethod('OleQueryLinkFromData',1,tkInteger,nil,__OleQueryLinkFromData,false,0,'srcDataObject: IDataObject');
    DefineMethod('OleQueryCreateFromData',1,tkInteger,nil,__OleQueryCreateFromData,false,0,'srcDataObject: IDataObject');
    DefineMethod('OleLoad',4,tkInteger,nil,__OleLoad,false,0,'stg: IStorage; iid: TIID; clientSite: IOleClientSite; vObj').SetVarArgs([3]);
    DefineMethod('OleSave',3,tkInteger,nil,__OleSave,false,0,'ps: IPersistStorage; stg: IStorage; fSameAsLoad: BOOL');
    DefineMethod('OleLoadFromStream',3,tkInteger,nil,__OleLoadFromStream,false,0,'stm: IStream; iidInterface: TIID; vObj').SetVarArgs([2]);
    DefineMethod('OleSaveToStream',2,tkInteger,nil,__OleSaveToStream,false,0,'pstm: IPersistStream; stm: IStream');
    DefineMethod('OleSetContainedObject',2,tkInteger,nil,__OleSetContainedObject,false,0,'unknown: IUnknown; fContained: BOOL');
    DefineMethod('OleNoteObjectVisible',2,tkInteger,nil,__OleNoteObjectVisible,false,0,'unknown: IUnknown; fVisible: BOOL');
    DefineMethod('RegisterDragDrop',2,tkInteger,nil,__RegisterDragDrop,false,0,'wnd: HWnd; dropTarget: IDropTarget');
    DefineMethod('RevokeDragDrop',1,tkInteger,nil,__RevokeDragDrop,false,0,'wnd: HWnd');
    DefineMethod('DoDragDrop',4,tkInteger,nil,__DoDragDrop,false,0,'dataObj: IDataObject; dropSource: IDropSource; dwOKEffects: Longint; dwEffect: Longint').SetVarArgs([3]);
    DefineMethod('OleSetClipboard',1,tkInteger,nil,__OleSetClipboard,false,0,'dataObj: IDataObject');
    DefineMethod('OleGetClipboard',1,tkInteger,nil,__OleGetClipboard,false,0,'dataObj: IDataObject').SetVarArgs([0]);
    DefineMethod('OleFlushClipboard',0,tkInteger,nil,__OleFlushClipboard,false,0,'');
    DefineMethod('OleIsCurrentClipboard',1,tkInteger,nil,__OleIsCurrentClipboard,false,0,'dataObj: IDataObject');
    DefineMethod('OleCreateMenuDescriptor',2,tkInteger,nil,__OleCreateMenuDescriptor,false,0,'hmenuCombined: HMenu; menuWidths: TOleMenuGroupWidths').SetVarArgs([1]);
    DefineMethod('OleSetMenuDescriptor',5,tkInteger,nil,__OleSetMenuDescriptor,false,0,'holemenu: HMenu; hwndFrame: HWnd; hwndActiveObject: HWnd; frame: IOleInPlaceFrame; activeObj: IOleInPlaceActiveObject');
    DefineMethod('OleDestroyMenuDescriptor',1,tkInteger,nil,__OleDestroyMenuDescriptor,false,0,'holemenu: HMenu');
    DefineMethod('OleDuplicateData',3,tkInteger,nil,__OleDuplicateData,false,0,'hSrc: THandle; cfFormat: TClipFormat; uiFlags: Integer');
    DefineMethod('OleDraw',4,tkInteger,nil,__OleDraw,false,0,'unknown: IUnknown; dwAspect: Longint; hdcDraw: HDC; rcBounds: TRect');
    DefineMethod('OleRun',1,tkInteger,nil,__OleRun,false,0,'unknown: IUnknown');
    DefineMethod('OleIsRunning',1,tkVariant,nil,__OleIsRunning,false,0,'obj: IOleObject');
    DefineMethod('OleLockRunning',3,tkInteger,nil,__OleLockRunning,false,0,'unknown: IUnknown; fLock: BOOL; fLastUnlockCloses: BOOL');
    DefineMethod('ReleaseStgMedium',1,tkNone,nil,__ReleaseStgMedium,false,0,'medium: TStgMedium').SetVarArgs([0]);
    DefineMethod('CreateOleAdviseHolder',1,tkInteger,nil,__CreateOleAdviseHolder,false,0,'OAHolder: IOleAdviseHolder').SetVarArgs([0]);
    DefineMethod('OleCreateDefaultHandler',4,tkInteger,nil,__OleCreateDefaultHandler,false,0,'clsid: TCLSID; unkOuter: IUnknown; iid: TIID; vObj').SetVarArgs([3]);
    DefineMethod('OleCreateEmbeddingHelper',6,tkInteger,nil,__OleCreateEmbeddingHelper,false,0,'clsid: TCLSID; unkOuter: IUnknown; flags: Longint; cf: IClassFactory; iid: TIID; vObj').SetVarArgs([5]);
    DefineMethod('OleGetIconOfFile',2,tkInteger,nil,__OleGetIconOfFile,false,0,'pszPath: POleStr; fUseFileAsLabel: BOOL');
    DefineMethod('OleGetIconOfClass',3,tkInteger,nil,__OleGetIconOfClass,false,0,'clsid: TCLSID; pszLabel: POleStr; fUseTypeAsLabel: BOOL');
    DefineMethod('OleMetafilePictFromIconAndLabel',4,tkInteger,nil,__OleMetafilePictFromIconAndLabel,false,0,'icon: HIcon; pszLabel: POleStr; pszSourceFile: POleStr; iIconIndex: Integer');
    DefineMethod('OleRegGetUserType',3,tkInteger,nil,__OleRegGetUserType,false,0,'clsid: TCLSID; dwFormOfType: Longint; pszUserType: POleStr').SetVarArgs([2]);
    DefineMethod('OleRegGetMiscStatus',3,tkInteger,nil,__OleRegGetMiscStatus,false,0,'clsid: TCLSID; dwAspect: Longint; dwStatus: Longint').SetVarArgs([2]);
    DefineMethod('OleRegEnumFormatEtc',3,tkInteger,nil,__OleRegEnumFormatEtc,false,0,'clsid: TCLSID; dwDirection: Longint; Enum: IEnumFormatEtc').SetVarArgs([2]);
    DefineMethod('OleRegEnumVerbs',2,tkInteger,nil,__OleRegEnumVerbs,false,0,'clsid: TCLSID; Enum: IEnumOleVerb').SetVarArgs([1]);
    DefineMethod('GetHGlobalFromILockBytes',2,tkInteger,nil,__GetHGlobalFromILockBytes,false,0,'lkbyt: ILockBytes; hglob: HGlobal').SetVarArgs([1]);
    DefineMethod('CreateILockBytesOnHGlobal',3,tkInteger,nil,__CreateILockBytesOnHGlobal,false,0,'hglob: HGlobal; fDeleteOnRelease: BOOL; lkbyt: ILockBytes').SetVarArgs([2]);
    DefineMethod('GetHGlobalFromStream',2,tkInteger,nil,__GetHGlobalFromStream,false,0,'stm: IStream; hglob: HGlobal').SetVarArgs([1]);
    DefineMethod('CreateStreamOnHGlobal',3,tkInteger,nil,__CreateStreamOnHGlobal,false,0,'hglob: HGlobal; fDeleteOnRelease: BOOL; stm: IStream').SetVarArgs([2]);
    DefineMethod('OleDoAutoConvert',2,tkInteger,nil,__OleDoAutoConvert,false,0,'stg: IStorage; clsidNew: TCLSID').SetVarArgs([1]);
    DefineMethod('OleGetAutoConvert',2,tkInteger,nil,__OleGetAutoConvert,false,0,'clsidOld: TCLSID; clsidNew: TCLSID').SetVarArgs([1]);
    DefineMethod('OleSetAutoConvert',2,tkInteger,nil,__OleSetAutoConvert,false,0,'clsidOld: TCLSID; clsidNew: TCLSID');
    DefineMethod('GetConvertStg',1,tkInteger,nil,__GetConvertStg,false,0,'stg: IStorage');
    DefineMethod('SetConvertStg',2,tkInteger,nil,__SetConvertStg,false,0,'stg: IStorage; fConvert: BOOL');
