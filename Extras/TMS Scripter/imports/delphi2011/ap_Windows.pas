...
type
  TatWindowsLibrary = class(TatScripterLibrary)
    procedure __MAKELANGID(AMachine: TatVirtualMachine);
    procedure __PRIMARYLANGID(AMachine: TatVirtualMachine);
    procedure __SUBLANGID(AMachine: TatVirtualMachine);
    procedure __MAKELCID(AMachine: TatVirtualMachine);
    procedure __MAKESORTLCID(AMachine: TatVirtualMachine);
    procedure __LANGIDFROMLCID(AMachine: TatVirtualMachine);
    procedure __SORTIDFROMLCID(AMachine: TatVirtualMachine);
    procedure __SORTVERSIONFROMLCID(AMachine: TatVirtualMachine);
    ...
    procedure __GlobalMemoryStatusEx(AMachine: TatVirtualMachine);
    procedure __GetLongPathName(AMachine: TatVirtualMachine);
    procedure __GetLongPathNameA(AMachine: TatVirtualMachine);
    procedure __GetLongPathNameW(AMachine: TatVirtualMachine);
    procedure __GetLongPathNameTransacted(AMachine: TatVirtualMachine);
    procedure __GetLongPathNameTransactedA(AMachine: TatVirtualMachine);
    procedure __GetLongPathNameTransactedW(AMachine: TatVirtualMachine);
    procedure __GetProcessHandleCount(AMachine: TatVirtualMachine);
    procedure __ExitProcess(AMachine: TatVirtualMachine);
    procedure __GetThreadIOPendingFlag(AMachine: TatVirtualMachine);
    procedure __ExitThread(AMachine: TatVirtualMachine);
    procedure __CheckRemoteDebuggerPresent(AMachine: TatVirtualMachine);
    ...
    procedure __GetSystemRegistryQuota(AMachine: TatVirtualMachine);
    procedure __GetSystemTimes(AMachine: TatVirtualMachine);
    procedure __GetNativeSystemInfo(AMachine: TatVirtualMachine);
    procedure __GetDynamicTimeZoneInformation(AMachine: TatVirtualMachine);
    procedure __SetDynamicTimeZoneInformation(AMachine: TatVirtualMachine);
    ...
    procedure __UnregisterWait(AMachine: TatVirtualMachine);
    procedure __UnregisterWaitEx(AMachine: TatVirtualMachine);
    procedure __WT_SET_MAX_THREADPOOL_THREADS(AMachine: TatVirtualMachine);
    procedure __CreateTimerQueue(AMachine: TatVirtualMachine);
    procedure __ChangeTimerQueueTimer(AMachine: TatVirtualMachine);
    procedure __DeleteTimerQueueTimer(AMachine: TatVirtualMachine);
    procedure __DeleteTimerQueueEx(AMachine: TatVirtualMachine);
    procedure __CancelTimerQueueTimer(AMachine: TatVirtualMachine);
    procedure __DeleteTimerQueue(AMachine: TatVirtualMachine);
    procedure __LoadLibrary(AMachine: TatVirtualMachine);
    procedure __GetCommandLine(AMachine: TatVirtualMachine);
    procedure __IsDebuggerPresent(AMachine: TatVirtualMachine);
    ...
    procedure __SetDllDirectory(AMachine: TatVirtualMachine);
    procedure __SetDllDirectoryA(AMachine: TatVirtualMachine);
    procedure __SetDllDirectoryW(AMachine: TatVirtualMachine);
    procedure __GetDllDirectory(AMachine: TatVirtualMachine);
    procedure __GetDllDirectoryA(AMachine: TatVirtualMachine);
    procedure __GetDllDirectoryW(AMachine: TatVirtualMachine);
    procedure __RemoveDirectory(AMachine: TatVirtualMachine);
    procedure __RemoveDirectoryTransacted(AMachine: TatVirtualMachine);
    procedure __RemoveDirectoryTransactedA(AMachine: TatVirtualMachine);
    procedure __RemoveDirectoryTransactedW(AMachine: TatVirtualMachine);
    procedure __GetFullPathNameTransacted(AMachine: TatVirtualMachine);
    procedure __GetFullPathNameTransactedA(AMachine: TatVirtualMachine);
    procedure __GetFullPathNameTransactedW(AMachine: TatVirtualMachine);
    procedure __SetFileAttributesTransacted(AMachine: TatVirtualMachine);
    procedure __SetFileAttributesTransactedA(AMachine: TatVirtualMachine);
    procedure __SetFileAttributesTransactedW(AMachine: TatVirtualMachine);
    procedure __GetFileAttributes(AMachine: TatVirtualMachine);
    procedure __DeleteFile(AMachine: TatVirtualMachine);
    procedure __DeleteFileTransacted(AMachine: TatVirtualMachine);
    procedure __DeleteFileTransactedA(AMachine: TatVirtualMachine);
    procedure __DeleteFileTransactedW(AMachine: TatVirtualMachine);
    ...
    procedure __MoveFileTransacted(AMachine: TatVirtualMachine);
    procedure __MoveFileTransactedA(AMachine: TatVirtualMachine);
    procedure __MoveFileTransactedW(AMachine: TatVirtualMachine);
    procedure __CreateHardLinkTransacted(AMachine: TatVirtualMachine);
    procedure __CreateHardLinkTransactedA(AMachine: TatVirtualMachine);
    procedure __CreateHardLinkTransactedW(AMachine: TatVirtualMachine);
    procedure __CreateSymbolicLink(AMachine: TatVirtualMachine);
    procedure __CreateSymbolicLinkA(AMachine: TatVirtualMachine);
    procedure __CreateSymbolicLinkW(AMachine: TatVirtualMachine);
    procedure __CreateSymbolicLinkTransacted(AMachine: TatVirtualMachine);
    procedure __CreateSymbolicLinkTransactedA(AMachine: TatVirtualMachine);
    procedure __CreateSymbolicLinkTransactedW(AMachine: TatVirtualMachine);
    procedure __GetFinalPathNameByHandle(AMachine: TatVirtualMachine);
    procedure __GetFinalPathNameByHandleA(AMachine: TatVirtualMachine);
    procedure __GetFinalPathNameByHandleW(AMachine: TatVirtualMachine);
    procedure __AdjustTokenPrivileges(AMachine: TatVirtualMachine);
    procedure __GetComputerNameEx(AMachine: TatVirtualMachine);
    procedure __GetComputerNameExA(AMachine: TatVirtualMachine);
    procedure __GetComputerNameExW(AMachine: TatVirtualMachine);
    procedure __VerifyVersionInfo(AMachine: TatVirtualMachine);
    procedure __VerifyVersionInfoA(AMachine: TatVirtualMachine);
    procedure __VerifyVersionInfoW(AMachine: TatVirtualMachine);
    procedure __CopyMetaFile(AMachine: TatVirtualMachine);
    procedure __GetRandomRgn(AMachine: TatVirtualMachine);
    ...
    procedure __GET_APPCOMMAND_LPARAM(AMachine: TatVirtualMachine);
    procedure __GET_DEVICE_LPARAM(AMachine: TatVirtualMachine);
    procedure __GET_MOUSEORKEY_LPARAM(AMachine: TatVirtualMachine);
    procedure __GET_FLAGS_LPARAM(AMachine: TatVirtualMachine);
    procedure __GET_KEYSTATE_LPARAM(AMachine: TatVirtualMachine);
    procedure __GetMouseMovePointsEx(AMachine: TatVirtualMachine);
    procedure __PointToLParam(AMachine: TatVirtualMachine);
    ...
    procedure __GetWindowPlacement(AMachine: TatVirtualMachine);
    procedure __SetWindowPlacement(AMachine: TatVirtualMachine);
    procedure __GetWindowDisplayAffinity(AMachine: TatVirtualMachine);
    procedure __SetWindowDisplayAffinity(AMachine: TatVirtualMachine);
    ...
    procedure __AddClipboardFormatListener(AMachine: TatVirtualMachine);
    procedure __RemoveClipboardFormatListener(AMachine: TatVirtualMachine);
    ...
    procedure __CloseTouchInputHandle(AMachine: TatVirtualMachine);
    procedure __RegisterTouchWindow(AMachine: TatVirtualMachine);
    procedure __UnregisterTouchWindow(AMachine: TatVirtualMachine);
    procedure __CalculatePopupWindowPosition(AMachine: TatVirtualMachine);
    procedure __GetWindowDC(AMachine: TatVirtualMachine);
    procedure __InvalidateRect(AMachine: TatVirtualMachine);
    procedure __ValidateRect(AMachine: TatVirtualMachine);
    procedure __RedrawWindow(AMachine: TatVirtualMachine);
    ...
    procedure __SetPhysicalCursorPos(AMachine: TatVirtualMachine);
    procedure __GetPhysicalCursorPos(AMachine: TatVirtualMachine);
    ...
    procedure __LogicalToPhysicalPoint(AMachine: TatVirtualMachine);
    procedure __PhysicalToLogicalPoint(AMachine: TatVirtualMachine);
    procedure __WindowFromPhysicalPoint(AMachine: TatVirtualMachine);
    ...
    procedure __SystemParametersInfo(AMachine: TatVirtualMachine);
    procedure __BlockInput(AMachine: TatVirtualMachine);
    procedure __SetProcessDPIAware(AMachine: TatVirtualMachine);
    procedure __IsProcessDPIAware(AMachine: TatVirtualMachine);
    procedure __GetCPInfoEx(AMachine: TatVirtualMachine);
    procedure __GetCPInfoExA(AMachine: TatVirtualMachine);
    procedure __GetCPInfoExW(AMachine: TatVirtualMachine);
    procedure __LCIDToLocaleName(AMachine: TatVirtualMachine);
    procedure __LocaleNameToLCID(AMachine: TatVirtualMachine);
    procedure __GetLocaleInfoEx(AMachine: TatVirtualMachine);
    ...
    procedure __GetWindowLongPtr(AMachine: TatVirtualMachine);
    procedure __SetWindowLongPtr(AMachine: TatVirtualMachine);
    procedure __GetWindowLongPtrA(AMachine: TatVirtualMachine);
    procedure __SetWindowLongPtrA(AMachine: TatVirtualMachine);
    procedure __GetWindowLongPtrW(AMachine: TatVirtualMachine);
    procedure __SetWindowLongPtrW(AMachine: TatVirtualMachine);
    procedure __GID_ROTATE_ANGLE_TO_ARGUMENT(AMachine: TatVirtualMachine);
    procedure __GID_ROTATE_ANGLE_FROM_ARGUMENT(AMachine: TatVirtualMachine);
    procedure __GetGestureInfo(AMachine: TatVirtualMachine);
    procedure __CloseGestureInfoHandle(AMachine: TatVirtualMachine);
    procedure __RotateAngleFromArgument(AMachine: TatVirtualMachine);
    procedure __InertiaVectorFromArgument(AMachine: TatVirtualMachine);
  ...
  published
    ...
    property QuadPart: ULONGLONG read FQuadPart write FQuadPart;
  end;
  ...
  _LUIDWrapper = class(TatRecordWrapper)
  private
    FLowPart: DWORD;
    FHighPart: INT32;
  public
    constructor Create(ARecord: _LUID);
    function ObjToRec: _LUID;
  published
    property LowPart: DWORD read FLowPart write FLowPart;
    property HighPart: INT32 read FHighPart write FHighPart;
  end;
  ...
  _TOKEN_USERWrapper = class(TatRecordWrapper)
  private
  public
    constructor Create(ARecord: _TOKEN_USER);
    function ObjToRec: _TOKEN_USER;
  published
  end;
  
  _TOKEN_ELEVATIONWrapper = class(TatRecordWrapper)
  private
    FTokenIsElevated: DWORD;
  public
    constructor Create(ARecord: _TOKEN_ELEVATION);
    function ObjToRec: _TOKEN_ELEVATION;
  published
    property TokenIsElevated: DWORD read FTokenIsElevated write FTokenIsElevated;
  end;
  ...
  _TOKEN_OWNERWrapper = class(TatRecordWrapper)
  private
  public
    constructor Create(ARecord: _TOKEN_OWNER);
    function ObjToRec: _TOKEN_OWNER;
  published
  end;
  
  _TOKEN_PRIMARY_GROUPWrapper = class(TatRecordWrapper)
  private
  public
    constructor Create(ARecord: _TOKEN_PRIMARY_GROUP);
    function ObjToRec: _TOKEN_PRIMARY_GROUP;
  published
  end;
  
  _TOKEN_DEFAULT_DACLWrapper = class(TatRecordWrapper)
  private
  public
    constructor Create(ARecord: _TOKEN_DEFAULT_DACL);
    function ObjToRec: _TOKEN_DEFAULT_DACL;
  published
  end;
  
  _TOKEN_SOURCEWrapper = class(TatRecordWrapper)
  private
  public
    constructor Create(ARecord: _TOKEN_SOURCE);
    function ObjToRec: _TOKEN_SOURCE;
  published
  end;
  
  _TOKEN_STATISTICSWrapper = class(TatRecordWrapper)
  private
    ...
    FPrivilegeCount: DWORD;
  public
    constructor Create(ARecord: _TOKEN_STATISTICS);
    function ObjToRec: _TOKEN_STATISTICS;
  published
    ...
    property DynamicCharged: DWORD read FDynamicCharged write FDynamicCharged;
    property DynamicAvailable: DWORD read FDynamicAvailable write FDynamicAvailable;
    property GroupCount: DWORD read FGroupCount write FGroupCount;
    property PrivilegeCount: DWORD read FPrivilegeCount write FPrivilegeCount;
  end;
  
  _TOKEN_GROUPS_AND_PRIVILEGESWrapper = class(TatRecordWrapper)
  private
    FSidcount: ULONG;
    FSidLength: ULONG;
    FRestrictedSidCount: ULONG;
    FRestrictedSidLength: ULONG;
    FPrivilegeCount: ULONG;
    FPrivilegeLength: ULONG;
  public
    constructor Create(ARecord: _TOKEN_GROUPS_AND_PRIVILEGES);
    function ObjToRec: _TOKEN_GROUPS_AND_PRIVILEGES;
  published
    property Sidcount: ULONG read FSidcount write FSidcount;
    property SidLength: ULONG read FSidLength write FSidLength;
    property RestrictedSidCount: ULONG read FRestrictedSidCount write FRestrictedSidCount;
    property RestrictedSidLength: ULONG read FRestrictedSidLength write FRestrictedSidLength;
    property PrivilegeCount: ULONG read FPrivilegeCount write FPrivilegeCount;
    property PrivilegeLength: ULONG read FPrivilegeLength write FPrivilegeLength;
  end;
  ...
  _TOKEN_AUDIT_POLICYWrapper = class(TatRecordWrapper)
  private
  public
    constructor Create(ARecord: _TOKEN_AUDIT_POLICY);
    function ObjToRec: _TOKEN_AUDIT_POLICY;
  published
  end;
  
  _TOKEN_ORIGINWrapper = class(TatRecordWrapper)
  private
  public
    constructor Create(ARecord: _TOKEN_ORIGIN);
    function ObjToRec: _TOKEN_ORIGIN;
  published
  end;
  
  _TOKEN_LINKED_TOKENWrapper = class(TatRecordWrapper)
  private
  public
    constructor Create(ARecord: _TOKEN_LINKED_TOKEN);
    function ObjToRec: _TOKEN_LINKED_TOKEN;
  published
  end;
  
  _TOKEN_MANDATORY_POLICYWrapper = class(TatRecordWrapper)
  private
    FPolicy: DWORD;
  public
    constructor Create(ARecord: _TOKEN_MANDATORY_POLICY);
    function ObjToRec: _TOKEN_MANDATORY_POLICY;
  published
    property Policy: DWORD read FPolicy write FPolicy;
  end;
  
  _TOKEN_ACCESS_INFORMATIONWrapper = class(TatRecordWrapper)
  private
    FTokenType: TTokenType;
    FImpersonationLevel: TSecurityImpersonationLevel;
    FFlags: DWORD;
  public
    constructor Create(ARecord: _TOKEN_ACCESS_INFORMATION);
    function ObjToRec: _TOKEN_ACCESS_INFORMATION;
  published
    property TokenType: TTokenType read FTokenType write FTokenType;
    property ImpersonationLevel: TSecurityImpersonationLevel read FImpersonationLevel write FImpersonationLevel;
  ...
  _IMAGE_IMPORT_BY_NAMEWrapper = class(TatRecordWrapper)
  private
    FHint: Word;
  public
    constructor Create(ARecord: _IMAGE_IMPORT_BY_NAME);
    function ObjToRec: _IMAGE_IMPORT_BY_NAME;
  published
    property Hint: Word read FHint write FHint;
  end;
  
  _IMAGE_THUNK_DATA64Wrapper = class(TatRecordWrapper)
  private
    FForwarderString: ULONGLONG;
    F_Function: ULONGLONG;
    FOrdinal: ULONGLONG;
    FAddressOfData: ULONGLONG;
  public
    constructor Create(ARecord: _IMAGE_THUNK_DATA64);
    function ObjToRec: _IMAGE_THUNK_DATA64;
  published
    property ForwarderString: ULONGLONG read FForwarderString write FForwarderString;
    property _Function: ULONGLONG read F_Function write F_Function;
    property Ordinal: ULONGLONG read FOrdinal write FOrdinal;
    property AddressOfData: ULONGLONG read FAddressOfData write FAddressOfData;
  end;
  
  _IMAGE_THUNK_DATA32Wrapper = class(TatRecordWrapper)
  private
    FForwarderString: DWORD;
    F_Function: DWORD;
    FOrdinal: DWORD;
    FAddressOfData: DWORD;
  public
    constructor Create(ARecord: _IMAGE_THUNK_DATA32);
    function ObjToRec: _IMAGE_THUNK_DATA32;
  published
    property ForwarderString: DWORD read FForwarderString write FForwarderString;
    property _Function: DWORD read F_Function write F_Function;
    property Ordinal: DWORD read FOrdinal write FOrdinal;
    property AddressOfData: DWORD read FAddressOfData write FAddressOfData;
  end;
  
  _IMAGE_TLS_DIRECTORY64Wrapper = class(TatRecordWrapper)
  private
    ...
    FCharacteristics: DWORD;
  public
    constructor Create(ARecord: _IMAGE_TLS_DIRECTORY64);
    function ObjToRec: _IMAGE_TLS_DIRECTORY64;
  published
    property StartAddressOfRawData: ULONGLONG read FStartAddressOfRawData write FStartAddressOfRawData;
    property EndAddressOfRawData: ULONGLONG read FEndAddressOfRawData write FEndAddressOfRawData;
    property AddressOfIndex: ULONGLONG read FAddressOfIndex write FAddressOfIndex;
    property AddressOfCallBacks: ULONGLONG read FAddressOfCallBacks write FAddressOfCallBacks;
    property SizeOfZeroFill: DWORD read FSizeOfZeroFill write FSizeOfZeroFill;
    property Characteristics: DWORD read FCharacteristics write FCharacteristics;
  end;
  
  _IMAGE_TLS_DIRECTORY32Wrapper = class(TatRecordWrapper)
  private
    ...
    FCharacteristics: DWORD;
  public
    constructor Create(ARecord: _IMAGE_TLS_DIRECTORY32);
    function ObjToRec: _IMAGE_TLS_DIRECTORY32;
  published
    property StartAddressOfRawData: DWORD read FStartAddressOfRawData write FStartAddressOfRawData;
    property EndAddressOfRawData: DWORD read FEndAddressOfRawData write FEndAddressOfRawData;
    property AddressOfIndex: DWORD read FAddressOfIndex write FAddressOfIndex;
    property AddressOfCallBacks: DWORD read FAddressOfCallBacks write FAddressOfCallBacks;
    property SizeOfZeroFill: DWORD read FSizeOfZeroFill write FSizeOfZeroFill;
    property Characteristics: DWORD read FCharacteristics write FCharacteristics;
  end;
  
  _IMAGE_IMPORT_DESCRIPTORWrapper = class(TatRecordWrapper)
  private
    FCharacteristics: DWORD;
    FOriginalFirstThunk: DWORD;
    FTimeDateStamp: DWORD;
    FForwarderChain: DWORD;
    FName: DWORD;
    FFirstThunk: DWORD;
  public
    constructor Create(ARecord: _IMAGE_IMPORT_DESCRIPTOR);
    function ObjToRec: _IMAGE_IMPORT_DESCRIPTOR;
  published
    property Characteristics: DWORD read FCharacteristics write FCharacteristics;
    property OriginalFirstThunk: DWORD read FOriginalFirstThunk write FOriginalFirstThunk;
    property TimeDateStamp: DWORD read FTimeDateStamp write FTimeDateStamp;
    property ForwarderChain: DWORD read FForwarderChain write FForwarderChain;
    property Name: DWORD read FName write FName;
    property FirstThunk: DWORD read FFirstThunk write FFirstThunk;
  end;
  
  _IMAGE_BOUND_IMPORT_DESCRIPTORWrapper = class(TatRecordWrapper)
  private
    FTimeDateStamp: DWORD;
    FOffsetModuleName: Word;
    FNumberOfModuleForwarderRefs: Word;
  public
    constructor Create(ARecord: _IMAGE_BOUND_IMPORT_DESCRIPTOR);
    function ObjToRec: _IMAGE_BOUND_IMPORT_DESCRIPTOR;
  published
    property TimeDateStamp: DWORD read FTimeDateStamp write FTimeDateStamp;
    property OffsetModuleName: Word read FOffsetModuleName write FOffsetModuleName;
    property NumberOfModuleForwarderRefs: Word read FNumberOfModuleForwarderRefs write FNumberOfModuleForwarderRefs;
  end;
  
  _IMAGE_BOUND_FORWARDER_REFWrapper = class(TatRecordWrapper)
  private
    FTimeDateStamp: DWORD;
    FOffsetModuleName: Word;
    FReserved: Word;
  public
    constructor Create(ARecord: _IMAGE_BOUND_FORWARDER_REF);
    function ObjToRec: _IMAGE_BOUND_FORWARDER_REF;
  published
    property TimeDateStamp: DWORD read FTimeDateStamp write FTimeDateStamp;
    property OffsetModuleName: Word read FOffsetModuleName write FOffsetModuleName;
  ...
  _RTL_CONDITION_VARIABLEWrapper = class(TatRecordWrapper)
  private
  public
    constructor Create(ARecord: _RTL_CONDITION_VARIABLE);
    function ObjToRec: _RTL_CONDITION_VARIABLE;
  published
  end;
  ...
  published
    ...
    property ErrorChar: AnsiChar read FErrorChar write FErrorChar;
    property EofChar: AnsiChar read FEofChar write FEofChar;
    property EvtChar: AnsiChar read FEvtChar write FEvtChar;
  ...
  _MEMORYSTATUSEXWrapper = class(TatRecordWrapper)
  private
    FdwLength: DWORD;
    FdwMemoryLoad: DWORD;
  ...
  public
    constructor Create(ARecord: _MEMORYSTATUSEX);
    function ObjToRec: _MEMORYSTATUSEX;
  published
    property dwLength: DWORD read FdwLength write FdwLength;
    property dwMemoryLoad: DWORD read FdwMemoryLoad write FdwMemoryLoad;
    property ullTotalPhys: DWORDLONG read FullTotalPhys write FullTotalPhys;
    property ullAvailPhys: DWORDLONG read FullAvailPhys write FullAvailPhys;
    property ullTotalPageFile: DWORDLONG read FullTotalPageFile write FullTotalPageFile;
    property ullAvailPageFile: DWORDLONG read FullAvailPageFile write FullAvailPageFile;
    property ullTotalVirtual: DWORDLONG read FullTotalVirtual write FullTotalVirtual;
    property ullAvailVirtual: DWORDLONG read FullAvailVirtual write FullAvailVirtual;
    property ullAvailExtendedVirtual: DWORDLONG read FullAvailExtendedVirtual write FullAvailExtendedVirtual;
  end;
  ...
  _TIME_DYNAMIC_ZONE_INFORMATIONWrapper = class(TatRecordWrapper)
  private
    FBias: Longint;
    FStandardBias: Longint;
    FDaylightBias: Longint;
  ...
  public
    constructor Create(ARecord: _TIME_DYNAMIC_ZONE_INFORMATION);
    function ObjToRec: _TIME_DYNAMIC_ZONE_INFORMATION;
  published
    property Bias: Longint read FBias write FBias;
    property StandardBias: Longint read FStandardBias write FStandardBias;
    property DaylightBias: Longint read FDaylightBias write FDaylightBias;
    property DynamicDaylightTimeDisabled: Boolean read FDynamicDaylightTimeDisabled write FDynamicDaylightTimeDisabled;
  end;
  ...
  _OSVERSIONINFOEXAWrapper = class(TatRecordWrapper)
  private
    FdwOSVersionInfoSize: DWORD;
    FdwMajorVersion: DWORD;
    FdwMinorVersion: DWORD;
    ...
    FwReserved: BYTE;
  public
    constructor Create(ARecord: _OSVERSIONINFOEXA);
    function ObjToRec: _OSVERSIONINFOEXA;
  published
    property dwOSVersionInfoSize: DWORD read FdwOSVersionInfoSize write FdwOSVersionInfoSize;
    property dwMajorVersion: DWORD read FdwMajorVersion write FdwMajorVersion;
    property dwMinorVersion: DWORD read FdwMinorVersion write FdwMinorVersion;
    property dwBuildNumber: DWORD read FdwBuildNumber write FdwBuildNumber;
    property dwPlatformId: DWORD read FdwPlatformId write FdwPlatformId;
    property wServicePackMajor: WORD read FwServicePackMajor write FwServicePackMajor;
    property wServicePackMinor: WORD read FwServicePackMinor write FwServicePackMinor;
    property wSuiteMask: WORD read FwSuiteMask write FwSuiteMask;
    property wProductType: BYTE read FwProductType write FwProductType;
    property wReserved: BYTE read FwReserved write FwReserved;
  end;
  
  _OSVERSIONINFOEXWWrapper = class(TatRecordWrapper)
  private
    FdwOSVersionInfoSize: DWORD;
    FdwMajorVersion: DWORD;
    FdwMinorVersion: DWORD;
    ...
    FwReserved: BYTE;
  public
    constructor Create(ARecord: _OSVERSIONINFOEXW);
    function ObjToRec: _OSVERSIONINFOEXW;
  published
    property dwOSVersionInfoSize: DWORD read FdwOSVersionInfoSize write FdwOSVersionInfoSize;
    property dwMajorVersion: DWORD read FdwMajorVersion write FdwMajorVersion;
    property dwMinorVersion: DWORD read FdwMinorVersion write FdwMinorVersion;
  ...
  tagMOUSEHOOKSTRUCTEXWrapper = class(TatRecordWrapper)
  private
    FmouseData: DWORD;
  public
    constructor Create(ARecord: tagMOUSEHOOKSTRUCTEX);
    function ObjToRec: tagMOUSEHOOKSTRUCTEX;
  published
  ...
  POWERBROADCAST_SETTINGWrapper = class(TatRecordWrapper)
  private
    FDataLength: DWORD;
  public
    constructor Create(ARecord: POWERBROADCAST_SETTING);
    function ObjToRec: POWERBROADCAST_SETTING;
  published
    property DataLength: DWORD read FDataLength write FDataLength;
  end;
  ...
  TOUCHINPUTWrapper = class(TatRecordWrapper)
  private
    Fx: Integer;
    Fy: Integer;
    FhSource: THandle;
    ...
    FcyContact: DWORD;
  public
    constructor Create(ARecord: TOUCHINPUT);
    function ObjToRec: TOUCHINPUT;
  published
    property x: Integer read Fx write Fx;
    property y: Integer read Fy write Fy;
    property hSource: THandle read FhSource write FhSource;
    ...
    property dwExtraInfo: ULONG_PTR read FdwExtraInfo write FdwExtraInfo;
    property cxContact: DWORD read FcxContact write FcxContact;
    property cyContact: DWORD read FcyContact write FcyContact;
  end;
  ...
  ICONINFOEXAWrapper = class(TatRecordWrapper)
  private
    FcbSize: DWORD;
    FfIcon: BOOL;
    FxHotspot: DWORD;
    ...
    FwResID: Word;
  public
    constructor Create(ARecord: ICONINFOEXA);
    function ObjToRec: ICONINFOEXA;
  published
    property cbSize: DWORD read FcbSize write FcbSize;
    property fIcon: BOOL read FfIcon write FfIcon;
    property xHotspot: DWORD read FxHotspot write FxHotspot;
    ...
    property hbmMask: HBITMAP read FhbmMask write FhbmMask;
    property hbmColor: HBITMAP read FhbmColor write FhbmColor;
    property wResID: Word read FwResID write FwResID;
  end;
  
  ICONINFOEXWWrapper = class(TatRecordWrapper)
  private
    FcbSize: DWORD;
    FfIcon: BOOL;
    FxHotspot: DWORD;
    ...
    FwResID: Word;
  public
    constructor Create(ARecord: ICONINFOEXW);
    function ObjToRec: ICONINFOEXW;
  published
    property cbSize: DWORD read FcbSize write FcbSize;
    property fIcon: BOOL read FfIcon write FfIcon;
    property xHotspot: DWORD read FxHotspot write FxHotspot;
  ...
  published
    property cbStruct: Integer read FcbStruct write FcbStruct;
    property fReserved: BOOL read FfReserved write FfReserved;
    property fIndexOnFail: BOOL read FfIndexOnFail write FfIndexOnFail;
  end;
  ...
  _HH_FTS_QUERYAWrapper = class(TatRecordWrapper)
  private
    FcbStruct: Integer;
    FfUniCodeStrings: BOOL;
    FiProximity: longint;
    FfStemmedSearch: BOOL;
    FfTitleOnly: BOOL;
    FfExecute: BOOL;
  public
    constructor Create(ARecord: _HH_FTS_QUERYA);
    function ObjToRec: _HH_FTS_QUERYA;
  published
    property cbStruct: Integer read FcbStruct write FcbStruct;
    property fUniCodeStrings: BOOL read FfUniCodeStrings write FfUniCodeStrings;
    property iProximity: longint read FiProximity write FiProximity;
    property fStemmedSearch: BOOL read FfStemmedSearch write FfStemmedSearch;
    property fTitleOnly: BOOL read FfTitleOnly write FfTitleOnly;
    property fExecute: BOOL read FfExecute write FfExecute;
  end;
  
  _HH_FTS_QUERYWWrapper = class(TatRecordWrapper)
  private
    FcbStruct: Integer;
    FfUniCodeStrings: BOOL;
    FiProximity: longint;
    ...
    FfExecute: BOOL;
  public
    constructor Create(ARecord: _HH_FTS_QUERYW);
    function ObjToRec: _HH_FTS_QUERYW;
  published
    property cbStruct: Integer read FcbStruct write FcbStruct;
    property fUniCodeStrings: BOOL read FfUniCodeStrings write FfUniCodeStrings;
    property iProximity: longint read FiProximity write FiProximity;
  ...
  published
    ...
    property fNotExpanded: BOOL read FfNotExpanded write FfNotExpanded;
  ...
  published
    ...
    property iPaddedBorderWidth: Integer read FiPaddedBorderWidth write FiPaddedBorderWidth;
  end;
  ...
  AUDIODESCRIPTIONWrapper = class(TatRecordWrapper)
  private
    FcbSize: UINT;
    FEnabled: BOOL;
    FLocale: LCID;
  public
    constructor Create(ARecord: AUDIODESCRIPTION);
    function ObjToRec: AUDIODESCRIPTION;
  published
    property cbSize: UINT read FcbSize write FcbSize;
    property Enabled: BOOL read FEnabled write FEnabled;
    property Locale: LCID read FLocale write FLocale;
  end;
  ...
  tagTITLEBARINFOEXWrapper = class(TatRecordWrapper)
  private
    FcbSize: DWORD;
  public
    constructor Create(ARecord: tagTITLEBARINFOEX);
    function ObjToRec: tagTITLEBARINFOEX;
  published
    property cbSize: DWORD read FcbSize write FcbSize;
  end;
  ...
  _cpinfoExAWrapper = class(TatRecordWrapper)
  private
    FMaxCharSize: UINT;
    FCodepage: UINT;
  public
    constructor Create(ARecord: _cpinfoExA);
    function ObjToRec: _cpinfoExA;
  published
    property MaxCharSize: UINT read FMaxCharSize write FMaxCharSize;
    property Codepage: UINT read FCodepage write FCodepage;
  end;
  
  _cpinfoExWWrapper = class(TatRecordWrapper)
  private
    FMaxCharSize: UINT;
    FCodepage: UINT;
  public
    constructor Create(ARecord: _cpinfoExW);
    function ObjToRec: _cpinfoExW;
  published
    property MaxCharSize: UINT read FMaxCharSize write FMaxCharSize;
    property Codepage: UINT read FCodepage write FCodepage;
  end;
  ...
  published
    ...
    property AsciiChar: AnsiChar read FAsciiChar write FAsciiChar;
  end;
  ...
  GESTUREINFOWrapper = class(TatRecordWrapper)
  private
    FcbSize: UINT;
    FdwFlags: DWORD;
    FdwID: DWORD;
    ...
    FcbExtraArgs: UINT;
  public
    constructor Create(ARecord: GESTUREINFO);
    function ObjToRec: GESTUREINFO;
  published
    property cbSize: UINT read FcbSize write FcbSize;
    property dwFlags: DWORD read FdwFlags write FdwFlags;
    property dwID: DWORD read FdwID write FdwID;
    property hwndTarget: HWND read FhwndTarget write FhwndTarget;
    property dwInstanceID: DWORD read FdwInstanceID write FdwInstanceID;
    property dwSequenceID: DWORD read FdwSequenceID write FdwSequenceID;
    property ullArguments: ULONGLONG read FullArguments write FullArguments;
    property cbExtraArgs: UINT read FcbExtraArgs write FcbExtraArgs;
  end;
  
  GESTURENOTIFYSTRUCTWrapper = class(TatRecordWrapper)
  private
    FcbSize: UINT;
    FdwFlags: DWORD;
    FhwndTarget: HWND;
    FdwInstanceID: DWORD;
  public
    constructor Create(ARecord: GESTURENOTIFYSTRUCT);
    function ObjToRec: GESTURENOTIFYSTRUCT;
  published
    property cbSize: UINT read FcbSize write FcbSize;
    property dwFlags: DWORD read FdwFlags write FdwFlags;
    property hwndTarget: HWND read FhwndTarget write FhwndTarget;
  ...
  GESTURECONFIGWrapper = class(TatRecordWrapper)
  private
    FdwID: DWORD;
    FdwWant: DWORD;
    FdwBlock: DWORD;
  public
    constructor Create(ARecord: GESTURECONFIG);
    function ObjToRec: GESTURECONFIG;
  published
    property dwID: DWORD read FdwID write FdwID;
    property dwWant: DWORD read FdwWant write FdwWant;
    property dwBlock: DWORD read FdwBlock write FdwBlock;
  end;
...
constructor _LUIDWrapper.Create(ARecord: _LUID);
begin
  inherited Create;
  FLowPart := ARecord.LowPart;
  FHighPart := ARecord.HighPart;
...
function _LUIDWrapper.ObjToRec: _LUID;
begin
  result.LowPart := FLowPart;
  result.HighPart := FHighPart;
end;
...
constructor _TOKEN_USERWrapper.Create(ARecord: _TOKEN_USER);
begin
  inherited Create;
end;

function _TOKEN_USERWrapper.ObjToRec: _TOKEN_USER;
begin
end;

constructor _TOKEN_ELEVATIONWrapper.Create(ARecord: _TOKEN_ELEVATION);
begin
  inherited Create;
  FTokenIsElevated := ARecord.TokenIsElevated;
end;

function _TOKEN_ELEVATIONWrapper.ObjToRec: _TOKEN_ELEVATION;
begin
  result.TokenIsElevated := FTokenIsElevated;
end;
...
constructor _TOKEN_OWNERWrapper.Create(ARecord: _TOKEN_OWNER);
begin
  inherited Create;
end;

function _TOKEN_OWNERWrapper.ObjToRec: _TOKEN_OWNER;
begin
end;

constructor _TOKEN_PRIMARY_GROUPWrapper.Create(ARecord: _TOKEN_PRIMARY_GROUP);
begin
  inherited Create;
end;

function _TOKEN_PRIMARY_GROUPWrapper.ObjToRec: _TOKEN_PRIMARY_GROUP;
begin
end;

constructor _TOKEN_DEFAULT_DACLWrapper.Create(ARecord: _TOKEN_DEFAULT_DACL);
begin
  inherited Create;
end;

function _TOKEN_DEFAULT_DACLWrapper.ObjToRec: _TOKEN_DEFAULT_DACL;
begin
end;

constructor _TOKEN_SOURCEWrapper.Create(ARecord: _TOKEN_SOURCE);
begin
  inherited Create;
end;

function _TOKEN_SOURCEWrapper.ObjToRec: _TOKEN_SOURCE;
begin
end;

constructor _TOKEN_STATISTICSWrapper.Create(ARecord: _TOKEN_STATISTICS);
begin
  inherited Create;
  FTokenType := ARecord.TokenType;
  FImpersonationLevel := ARecord.ImpersonationLevel;
  FDynamicCharged := ARecord.DynamicCharged;
  FDynamicAvailable := ARecord.DynamicAvailable;
  FGroupCount := ARecord.GroupCount;
  FPrivilegeCount := ARecord.PrivilegeCount;
end;

function _TOKEN_STATISTICSWrapper.ObjToRec: _TOKEN_STATISTICS;
begin
  result.TokenType := FTokenType;
  result.ImpersonationLevel := FImpersonationLevel;
  result.DynamicCharged := FDynamicCharged;
  result.DynamicAvailable := FDynamicAvailable;
  result.GroupCount := FGroupCount;
  result.PrivilegeCount := FPrivilegeCount;
end;

constructor _TOKEN_GROUPS_AND_PRIVILEGESWrapper.Create(ARecord: _TOKEN_GROUPS_AND_PRIVILEGES);
begin
  inherited Create;
  FSidcount := ARecord.Sidcount;
  FSidLength := ARecord.SidLength;
  FRestrictedSidCount := ARecord.RestrictedSidCount;
  FRestrictedSidLength := ARecord.RestrictedSidLength;
  FPrivilegeCount := ARecord.PrivilegeCount;
  FPrivilegeLength := ARecord.PrivilegeLength;
end;

function _TOKEN_GROUPS_AND_PRIVILEGESWrapper.ObjToRec: _TOKEN_GROUPS_AND_PRIVILEGES;
begin
  result.Sidcount := FSidcount;
  result.SidLength := FSidLength;
  result.RestrictedSidCount := FRestrictedSidCount;
  result.RestrictedSidLength := FRestrictedSidLength;
  result.PrivilegeCount := FPrivilegeCount;
  result.PrivilegeLength := FPrivilegeLength;
end;
...
constructor _TOKEN_AUDIT_POLICYWrapper.Create(ARecord: _TOKEN_AUDIT_POLICY);
begin
  inherited Create;
end;

function _TOKEN_AUDIT_POLICYWrapper.ObjToRec: _TOKEN_AUDIT_POLICY;
begin
end;

constructor _TOKEN_ORIGINWrapper.Create(ARecord: _TOKEN_ORIGIN);
begin
  inherited Create;
end;

function _TOKEN_ORIGINWrapper.ObjToRec: _TOKEN_ORIGIN;
begin
end;

constructor _TOKEN_LINKED_TOKENWrapper.Create(ARecord: _TOKEN_LINKED_TOKEN);
begin
  inherited Create;
end;

function _TOKEN_LINKED_TOKENWrapper.ObjToRec: _TOKEN_LINKED_TOKEN;
begin
end;

constructor _TOKEN_MANDATORY_POLICYWrapper.Create(ARecord: _TOKEN_MANDATORY_POLICY);
begin
  inherited Create;
  FPolicy := ARecord.Policy;
end;

function _TOKEN_MANDATORY_POLICYWrapper.ObjToRec: _TOKEN_MANDATORY_POLICY;
begin
  result.Policy := FPolicy;
end;

constructor _TOKEN_ACCESS_INFORMATIONWrapper.Create(ARecord: _TOKEN_ACCESS_INFORMATION);
begin
  inherited Create;
  FTokenType := ARecord.TokenType;
  FImpersonationLevel := ARecord.ImpersonationLevel;
...
function _TOKEN_ACCESS_INFORMATIONWrapper.ObjToRec: _TOKEN_ACCESS_INFORMATION;
begin
  result.TokenType := FTokenType;
  result.ImpersonationLevel := FImpersonationLevel;
  result.Flags := FFlags;
...
constructor _IMAGE_IMPORT_BY_NAMEWrapper.Create(ARecord: _IMAGE_IMPORT_BY_NAME);
begin
  inherited Create;
  FHint := ARecord.Hint;
end;

function _IMAGE_IMPORT_BY_NAMEWrapper.ObjToRec: _IMAGE_IMPORT_BY_NAME;
begin
  result.Hint := FHint;
end;

constructor _IMAGE_THUNK_DATA64Wrapper.Create(ARecord: _IMAGE_THUNK_DATA64);
begin
  inherited Create;
  FForwarderString := ARecord.ForwarderString;
  F_Function := ARecord._Function;
  FOrdinal := ARecord.Ordinal;
  FAddressOfData := ARecord.AddressOfData;
end;

function _IMAGE_THUNK_DATA64Wrapper.ObjToRec: _IMAGE_THUNK_DATA64;
begin
  result.ForwarderString := FForwarderString;
  result._Function := F_Function;
  result.Ordinal := FOrdinal;
  result.AddressOfData := FAddressOfData;
end;

constructor _IMAGE_THUNK_DATA32Wrapper.Create(ARecord: _IMAGE_THUNK_DATA32);
begin
  inherited Create;
  FForwarderString := ARecord.ForwarderString;
  F_Function := ARecord._Function;
...
function _IMAGE_THUNK_DATA32Wrapper.ObjToRec: _IMAGE_THUNK_DATA32;
begin
  result.ForwarderString := FForwarderString;
  result._Function := F_Function;
  result.Ordinal := FOrdinal;
...
constructor _IMAGE_TLS_DIRECTORY64Wrapper.Create(ARecord: _IMAGE_TLS_DIRECTORY64);
begin
  inherited Create;
  FStartAddressOfRawData := ARecord.StartAddressOfRawData;
  FEndAddressOfRawData := ARecord.EndAddressOfRawData;
  FAddressOfIndex := ARecord.AddressOfIndex;
  FAddressOfCallBacks := ARecord.AddressOfCallBacks;
  FSizeOfZeroFill := ARecord.SizeOfZeroFill;
  FCharacteristics := ARecord.Characteristics;
end;

function _IMAGE_TLS_DIRECTORY64Wrapper.ObjToRec: _IMAGE_TLS_DIRECTORY64;
begin
  result.StartAddressOfRawData := FStartAddressOfRawData;
  result.EndAddressOfRawData := FEndAddressOfRawData;
  result.AddressOfIndex := FAddressOfIndex;
  result.AddressOfCallBacks := FAddressOfCallBacks;
  result.SizeOfZeroFill := FSizeOfZeroFill;
  result.Characteristics := FCharacteristics;
end;

constructor _IMAGE_TLS_DIRECTORY32Wrapper.Create(ARecord: _IMAGE_TLS_DIRECTORY32);
begin
  inherited Create;
  FStartAddressOfRawData := ARecord.StartAddressOfRawData;
  FEndAddressOfRawData := ARecord.EndAddressOfRawData;
...
function _IMAGE_TLS_DIRECTORY32Wrapper.ObjToRec: _IMAGE_TLS_DIRECTORY32;
begin
  result.StartAddressOfRawData := FStartAddressOfRawData;
  result.EndAddressOfRawData := FEndAddressOfRawData;
  result.AddressOfIndex := FAddressOfIndex;
...
constructor _IMAGE_IMPORT_DESCRIPTORWrapper.Create(ARecord: _IMAGE_IMPORT_DESCRIPTOR);
begin
  inherited Create;
  FCharacteristics := ARecord.Characteristics;
  FOriginalFirstThunk := ARecord.OriginalFirstThunk;
  FTimeDateStamp := ARecord.TimeDateStamp;
  FForwarderChain := ARecord.ForwarderChain;
  FName := ARecord.Name;
  FFirstThunk := ARecord.FirstThunk;
end;

function _IMAGE_IMPORT_DESCRIPTORWrapper.ObjToRec: _IMAGE_IMPORT_DESCRIPTOR;
begin
  result.Characteristics := FCharacteristics;
  result.OriginalFirstThunk := FOriginalFirstThunk;
  result.TimeDateStamp := FTimeDateStamp;
  result.ForwarderChain := FForwarderChain;
  result.Name := FName;
  result.FirstThunk := FFirstThunk;
end;

constructor _IMAGE_BOUND_IMPORT_DESCRIPTORWrapper.Create(ARecord: _IMAGE_BOUND_IMPORT_DESCRIPTOR);
begin
  inherited Create;
  FTimeDateStamp := ARecord.TimeDateStamp;
  FOffsetModuleName := ARecord.OffsetModuleName;
  FNumberOfModuleForwarderRefs := ARecord.NumberOfModuleForwarderRefs;
end;

function _IMAGE_BOUND_IMPORT_DESCRIPTORWrapper.ObjToRec: _IMAGE_BOUND_IMPORT_DESCRIPTOR;
begin
  result.TimeDateStamp := FTimeDateStamp;
  result.OffsetModuleName := FOffsetModuleName;
  result.NumberOfModuleForwarderRefs := FNumberOfModuleForwarderRefs;
end;

constructor _IMAGE_BOUND_FORWARDER_REFWrapper.Create(ARecord: _IMAGE_BOUND_FORWARDER_REF);
begin
  inherited Create;
  FTimeDateStamp := ARecord.TimeDateStamp;
  FOffsetModuleName := ARecord.OffsetModuleName;
...
function _IMAGE_BOUND_FORWARDER_REFWrapper.ObjToRec: _IMAGE_BOUND_FORWARDER_REF;
begin
  result.TimeDateStamp := FTimeDateStamp;
  result.OffsetModuleName := FOffsetModuleName;
...
constructor _RTL_CONDITION_VARIABLEWrapper.Create(ARecord: _RTL_CONDITION_VARIABLE);
begin
  inherited Create;
end;

function _RTL_CONDITION_VARIABLEWrapper.ObjToRec: _RTL_CONDITION_VARIABLE;
begin
end;
...
constructor _MEMORYSTATUSEXWrapper.Create(ARecord: _MEMORYSTATUSEX);
begin
  inherited Create;
  FdwLength := ARecord.dwLength;
  FdwMemoryLoad := ARecord.dwMemoryLoad;
  FullTotalPhys := ARecord.ullTotalPhys;
  FullAvailPhys := ARecord.ullAvailPhys;
  FullTotalPageFile := ARecord.ullTotalPageFile;
  FullAvailPageFile := ARecord.ullAvailPageFile;
  FullTotalVirtual := ARecord.ullTotalVirtual;
  FullAvailVirtual := ARecord.ullAvailVirtual;
  FullAvailExtendedVirtual := ARecord.ullAvailExtendedVirtual;
end;

function _MEMORYSTATUSEXWrapper.ObjToRec: _MEMORYSTATUSEX;
begin
  result.dwLength := FdwLength;
  result.dwMemoryLoad := FdwMemoryLoad;
  result.ullTotalPhys := FullTotalPhys;
  result.ullAvailPhys := FullAvailPhys;
  result.ullTotalPageFile := FullTotalPageFile;
  result.ullAvailPageFile := FullAvailPageFile;
  result.ullTotalVirtual := FullTotalVirtual;
  result.ullAvailVirtual := FullAvailVirtual;
  result.ullAvailExtendedVirtual := FullAvailExtendedVirtual;
end;
...
constructor _TIME_DYNAMIC_ZONE_INFORMATIONWrapper.Create(ARecord: _TIME_DYNAMIC_ZONE_INFORMATION);
begin
  inherited Create;
  FBias := ARecord.Bias;
  FStandardBias := ARecord.StandardBias;
  FDaylightBias := ARecord.DaylightBias;
  FDynamicDaylightTimeDisabled := ARecord.DynamicDaylightTimeDisabled;
end;

function _TIME_DYNAMIC_ZONE_INFORMATIONWrapper.ObjToRec: _TIME_DYNAMIC_ZONE_INFORMATION;
begin
  result.Bias := FBias;
  result.StandardBias := FStandardBias;
  result.DaylightBias := FDaylightBias;
  result.DynamicDaylightTimeDisabled := FDynamicDaylightTimeDisabled;
end;
...
constructor _OSVERSIONINFOEXAWrapper.Create(ARecord: _OSVERSIONINFOEXA);
begin
  inherited Create;
  FdwOSVersionInfoSize := ARecord.dwOSVersionInfoSize;
  FdwMajorVersion := ARecord.dwMajorVersion;
  ...
  FdwBuildNumber := ARecord.dwBuildNumber;
  FdwPlatformId := ARecord.dwPlatformId;
  FwServicePackMajor := ARecord.wServicePackMajor;
  FwServicePackMinor := ARecord.wServicePackMinor;
  FwSuiteMask := ARecord.wSuiteMask;
  FwProductType := ARecord.wProductType;
  FwReserved := ARecord.wReserved;
end;

function _OSVERSIONINFOEXAWrapper.ObjToRec: _OSVERSIONINFOEXA;
begin
  result.dwOSVersionInfoSize := FdwOSVersionInfoSize;
  result.dwMajorVersion := FdwMajorVersion;
  result.dwMinorVersion := FdwMinorVersion;
  result.dwBuildNumber := FdwBuildNumber;
  result.dwPlatformId := FdwPlatformId;
  result.wServicePackMajor := FwServicePackMajor;
  result.wServicePackMinor := FwServicePackMinor;
  result.wSuiteMask := FwSuiteMask;
  result.wProductType := FwProductType;
  result.wReserved := FwReserved;
end;

constructor _OSVERSIONINFOEXWWrapper.Create(ARecord: _OSVERSIONINFOEXW);
begin
  inherited Create;
  FdwOSVersionInfoSize := ARecord.dwOSVersionInfoSize;
  FdwMajorVersion := ARecord.dwMajorVersion;
...
function _OSVERSIONINFOEXWWrapper.ObjToRec: _OSVERSIONINFOEXW;
begin
  result.dwOSVersionInfoSize := FdwOSVersionInfoSize;
  result.dwMajorVersion := FdwMajorVersion;
  result.dwMinorVersion := FdwMinorVersion;
...
constructor tagMOUSEHOOKSTRUCTEXWrapper.Create(ARecord: tagMOUSEHOOKSTRUCTEX);
begin
  inherited Create;
  FmouseData := ARecord.mouseData;
end;

function tagMOUSEHOOKSTRUCTEXWrapper.ObjToRec: tagMOUSEHOOKSTRUCTEX;
begin
...
constructor POWERBROADCAST_SETTINGWrapper.Create(ARecord: POWERBROADCAST_SETTING);
begin
  inherited Create;
  FDataLength := ARecord.DataLength;
end;

function POWERBROADCAST_SETTINGWrapper.ObjToRec: POWERBROADCAST_SETTING;
begin
  result.DataLength := FDataLength;
end;
...
constructor TOUCHINPUTWrapper.Create(ARecord: TOUCHINPUT);
begin
  inherited Create;
  Fx := ARecord.x;
  Fy := ARecord.y;
  FhSource := ARecord.hSource;
  FdwID := ARecord.dwID;
  FdwFlags := ARecord.dwFlags;
  FdwMask := ARecord.dwMask;
  FdwTime := ARecord.dwTime;
  FdwExtraInfo := ARecord.dwExtraInfo;
  FcxContact := ARecord.cxContact;
  FcyContact := ARecord.cyContact;
end;

function TOUCHINPUTWrapper.ObjToRec: TOUCHINPUT;
begin
  result.x := Fx;
  result.y := Fy;
  result.hSource := FhSource;
  result.dwID := FdwID;
  result.dwFlags := FdwFlags;
  result.dwMask := FdwMask;
  result.dwTime := FdwTime;
  result.dwExtraInfo := FdwExtraInfo;
  result.cxContact := FcxContact;
  result.cyContact := FcyContact;
end;
...
constructor ICONINFOEXAWrapper.Create(ARecord: ICONINFOEXA);
begin
  inherited Create;
  FcbSize := ARecord.cbSize;
  FfIcon := ARecord.fIcon;
  ...
  FhbmMask := ARecord.hbmMask;
  FhbmColor := ARecord.hbmColor;
  FwResID := ARecord.wResID;
end;

function ICONINFOEXAWrapper.ObjToRec: ICONINFOEXA;
begin
  result.cbSize := FcbSize;
  result.fIcon := FfIcon;
  result.xHotspot := FxHotspot;
  ...
  result.hbmMask := FhbmMask;
  result.hbmColor := FhbmColor;
  result.wResID := FwResID;
end;

constructor ICONINFOEXWWrapper.Create(ARecord: ICONINFOEXW);
begin
  inherited Create;
  FcbSize := ARecord.cbSize;
  FfIcon := ARecord.fIcon;
...
function ICONINFOEXWWrapper.ObjToRec: ICONINFOEXW;
begin
  result.cbSize := FcbSize;
  result.fIcon := FfIcon;
  result.xHotspot := FxHotspot;
...
constructor _HH_FTS_QUERYAWrapper.Create(ARecord: _HH_FTS_QUERYA);
begin
  inherited Create;
  FcbStruct := ARecord.cbStruct;
...
function _HH_FTS_QUERYAWrapper.ObjToRec: _HH_FTS_QUERYA;
begin
  result.cbStruct := FcbStruct;
...
constructor _HH_FTS_QUERYWWrapper.Create(ARecord: _HH_FTS_QUERYW);
begin
  inherited Create;
  FcbStruct := ARecord.cbStruct;
  FfUniCodeStrings := ARecord.fUniCodeStrings;
...
function _HH_FTS_QUERYWWrapper.ObjToRec: _HH_FTS_QUERYW;
begin
  result.cbStruct := FcbStruct;
  result.fUniCodeStrings := FfUniCodeStrings;
  result.iProximity := FiProximity;
...
begin
  ...
  FiPaddedBorderWidth := ARecord.iPaddedBorderWidth;
end;
...
begin
  ...
  result.iPaddedBorderWidth := FiPaddedBorderWidth;
end;
...
constructor AUDIODESCRIPTIONWrapper.Create(ARecord: AUDIODESCRIPTION);
begin
  inherited Create;
  FcbSize := ARecord.cbSize;
  FEnabled := ARecord.Enabled;
  FLocale := ARecord.Locale;
end;

function AUDIODESCRIPTIONWrapper.ObjToRec: AUDIODESCRIPTION;
begin
  result.cbSize := FcbSize;
  result.Enabled := FEnabled;
  result.Locale := FLocale;
end;
...
constructor tagTITLEBARINFOEXWrapper.Create(ARecord: tagTITLEBARINFOEX);
begin
  inherited Create;
  FcbSize := ARecord.cbSize;
end;

function tagTITLEBARINFOEXWrapper.ObjToRec: tagTITLEBARINFOEX;
begin
  result.cbSize := FcbSize;
end;
...
constructor _cpinfoExAWrapper.Create(ARecord: _cpinfoExA);
begin
  inherited Create;
  FMaxCharSize := ARecord.MaxCharSize;
...
function _cpinfoExAWrapper.ObjToRec: _cpinfoExA;
begin
  result.MaxCharSize := FMaxCharSize;
  result.Codepage := FCodepage;
end;

constructor _cpinfoExWWrapper.Create(ARecord: _cpinfoExW);
begin
  inherited Create;
  FMaxCharSize := ARecord.MaxCharSize;
  FCodepage := ARecord.Codepage;
...
function _cpinfoExWWrapper.ObjToRec: _cpinfoExW;
begin
  result.MaxCharSize := FMaxCharSize;
  result.Codepage := FCodepage;
end;
...
constructor GESTUREINFOWrapper.Create(ARecord: GESTUREINFO);
begin
  inherited Create;
  FcbSize := ARecord.cbSize;
  FdwFlags := ARecord.dwFlags;
  FdwID := ARecord.dwID;
  FhwndTarget := ARecord.hwndTarget;
  FdwInstanceID := ARecord.dwInstanceID;
  FdwSequenceID := ARecord.dwSequenceID;
  FullArguments := ARecord.ullArguments;
  FcbExtraArgs := ARecord.cbExtraArgs;
end;

function GESTUREINFOWrapper.ObjToRec: GESTUREINFO;
begin
  result.cbSize := FcbSize;
  result.dwFlags := FdwFlags;
  result.dwID := FdwID;
  result.hwndTarget := FhwndTarget;
  result.dwInstanceID := FdwInstanceID;
  result.dwSequenceID := FdwSequenceID;
  result.ullArguments := FullArguments;
  result.cbExtraArgs := FcbExtraArgs;
end;

constructor GESTURENOTIFYSTRUCTWrapper.Create(ARecord: GESTURENOTIFYSTRUCT);
begin
  inherited Create;
  FcbSize := ARecord.cbSize;
  FdwFlags := ARecord.dwFlags;
...
function GESTURENOTIFYSTRUCTWrapper.ObjToRec: GESTURENOTIFYSTRUCT;
begin
  result.cbSize := FcbSize;
  result.dwFlags := FdwFlags;
  result.hwndTarget := FhwndTarget;
...
constructor GESTURECONFIGWrapper.Create(ARecord: GESTURECONFIG);
begin
  inherited Create;
  FdwID := ARecord.dwID;
  FdwWant := ARecord.dwWant;
  FdwBlock := ARecord.dwBlock;
end;

function GESTURECONFIGWrapper.ObjToRec: GESTURECONFIG;
begin
  result.dwID := FdwID;
  result.dwWant := FdwWant;
  result.dwBlock := FdwBlock;
end;



procedure TatWindowsLibrary.__MAKELANGID(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(Windows.MAKELANGID(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__PRIMARYLANGID(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(Windows.PRIMARYLANGID(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__SUBLANGID(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(Windows.SUBLANGID(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__MAKELCID(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(Windows.MAKELCID(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__MAKESORTLCID(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(Windows.MAKESORTLCID(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__LANGIDFROMLCID(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(Windows.LANGIDFROMLCID(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__SORTIDFROMLCID(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(Windows.SORTIDFROMLCID(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__SORTVERSIONFROMLCID(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(Windows.SORTVERSIONFROMLCID(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatWindowsLibrary.__GlobalMemoryStatusEx(AMachine: TatVirtualMachine);
  var
  Param0Rec: TObject;
  Param0: TMEMORYSTATUSEX;
  AResult: variant;
begin
  with AMachine do
  begin
Param0Rec := TObject(integer(GetInputArg(0)));
if not Assigned(Param0Rec) or not (Param0Rec is _MEMORYSTATUSEXWrapper) then 
  Param0Rec := _MEMORYSTATUSEXWrapper.Create(Param0);
Param0 := _MEMORYSTATUSEXWrapper(Param0Rec).ObjToRec;
AResult := Windows.GlobalMemoryStatusEx(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,integer(_MEMORYSTATUSEXWrapper.Create(Param0)));
  end;
end;

procedure TatWindowsLibrary.__GetLongPathName(AMachine: TatVirtualMachine);
  var
...
AResult := Integer(Windows.GetLongPathName(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__GetLongPathNameA(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(Windows.GetLongPathNameA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__GetLongPathNameW(AMachine: TatVirtualMachine);
  var
  Param0Buf: array of WideChar;
  Param1Buf: array of WideChar;
  AResult: variant;
...
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(Windows.GetLongPathNameW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__GetLongPathNameTransacted(AMachine: TatVirtualMachine);
  var
  Param0Buf: array of WideChar;
  Param1Buf: array of WideChar;
  AResult: variant;
...
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(Windows.GetLongPathNameTransacted(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__GetLongPathNameTransactedA(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(Windows.GetLongPathNameTransactedA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__GetLongPathNameTransactedW(AMachine: TatVirtualMachine);
  var
  Param0Buf: array of WideChar;
  Param1Buf: array of WideChar;
  AResult: variant;
...
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(Windows.GetLongPathNameTransactedW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__GetProcessHandleCount(AMachine: TatVirtualMachine);
  var
  Param1: DWORD;
  AResult: variant;
begin
...
AResult := Windows.GetProcessHandleCount(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
...
procedure TatWindowsLibrary.__GetThreadIOPendingFlag(AMachine: TatVirtualMachine);
  var
  Param1: BOOL;
  AResult: variant;
begin
...
AResult := Windows.GetThreadIOPendingFlag(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
...
procedure TatWindowsLibrary.__CheckRemoteDebuggerPresent(AMachine: TatVirtualMachine);
  var
  Param1: BOOL;
  AResult: variant;
begin
  ...
  begin
Param1 := GetInputArg(1);
AResult := Windows.CheckRemoteDebuggerPresent(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Param1);
  end;
end;
...
procedure TatWindowsLibrary.__GetSystemRegistryQuota(AMachine: TatVirtualMachine);
  var
  Param0: DWORD;
  Param1: DWORD;
  AResult: variant;
...
Param0 := VarToInteger(GetInputArg(0));
Param1 := VarToInteger(GetInputArg(1));
AResult := Windows.GetSystemRegistryQuota(Param0,Param1);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
    SetInputArg(1,Integer(Param1));
  end;
...
procedure TatWindowsLibrary.__GetSystemTimes(AMachine: TatVirtualMachine);
  var
  Param0Rec: TObject;
  Param0: TFileTime;
  Param1Rec: TObject;
...
AResult := Windows.GetSystemTimes(Param0,Param1,Param2);
    ReturnOutputArg(AResult);
...
procedure TatWindowsLibrary.__GetNativeSystemInfo(AMachine: TatVirtualMachine);
  var
  Param0Rec: TObject;
  Param0: TSystemInfo;
begin
  ...
  begin
Param0Rec := TObject(integer(GetInputArg(0)));
if not Assigned(Param0Rec) or not (Param0Rec is _SYSTEM_INFOWrapper) then 
  Param0Rec := _SYSTEM_INFOWrapper.Create(Param0);
Param0 := _SYSTEM_INFOWrapper(Param0Rec).ObjToRec;
    Windows.GetNativeSystemInfo(Param0);
    SetInputArg(0,integer(_SYSTEM_INFOWrapper.Create(Param0)));
  end;
end;

procedure TatWindowsLibrary.__GetDynamicTimeZoneInformation(AMachine: TatVirtualMachine);
  var
  Param0Rec: TObject;
  Param0: TDynamicTimeZoneInformation;
  AResult: variant;
begin
  with AMachine do
  begin
Param0Rec := TObject(integer(GetInputArg(0)));
if not Assigned(Param0Rec) or not (Param0Rec is _TIME_DYNAMIC_ZONE_INFORMATIONWrapper) then 
  Param0Rec := _TIME_DYNAMIC_ZONE_INFORMATIONWrapper.Create(Param0);
Param0 := _TIME_DYNAMIC_ZONE_INFORMATIONWrapper(Param0Rec).ObjToRec;
AResult := Integer(Windows.GetDynamicTimeZoneInformation(Param0));
    ReturnOutputArg(AResult);
    SetInputArg(0,integer(_TIME_DYNAMIC_ZONE_INFORMATIONWrapper.Create(Param0)));
  end;
end;

procedure TatWindowsLibrary.__SetDynamicTimeZoneInformation(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(Windows.SetDynamicTimeZoneInformation(_TIME_DYNAMIC_ZONE_INFORMATIONWrapper(integer(GetInputArg(0))).ObjToRec));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := Integer(Windows.OpenFile(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),Param1,VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(_OFSTRUCTWrapper.Create(Param1)));
  end;
end;

procedure TatWindowsLibrary.__UnregisterWait(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Windows.UnregisterWait(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__UnregisterWaitEx(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Windows.UnregisterWaitEx(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__WT_SET_MAX_THREADPOOL_THREADS(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(Windows.WT_SET_MAX_THREADPOOL_THREADS(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__CreateTimerQueue(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(Windows.CreateTimerQueue);
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__ChangeTimerQueueTimer(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Windows.ChangeTimerQueueTimer(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__DeleteTimerQueueTimer(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Windows.DeleteTimerQueueTimer(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__DeleteTimerQueueEx(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Windows.DeleteTimerQueueEx(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__CancelTimerQueueTimer(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Windows.CancelTimerQueueTimer(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__DeleteTimerQueue(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Windows.DeleteTimerQueue(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Integer(Windows.LoadLibrary(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := WideCharToString(Windows.GetCommandLine);
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__IsDebuggerPresent(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Windows.IsDebuggerPresent;
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := Integer(Windows.FindResource(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Windows.SetCurrentDirectory(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(Windows.GetCurrentDirectory(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__SetDllDirectory(AMachine: TatVirtualMachine);
  var
  Param0Buf: array of WideChar;
  AResult: variant;
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Windows.SetDllDirectory(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__SetDllDirectoryA(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Windows.SetDllDirectoryA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__SetDllDirectoryW(AMachine: TatVirtualMachine);
  var
  Param0Buf: array of WideChar;
  AResult: variant;
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Windows.SetDllDirectoryW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__GetDllDirectory(AMachine: TatVirtualMachine);
  var
  Param1Buf: array of WideChar;
  AResult: variant;
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Windows.GetDllDirectory(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__GetDllDirectoryA(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Windows.GetDllDirectoryA(VarToInteger(GetInputArg(0)),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__GetDllDirectoryW(AMachine: TatVirtualMachine);
  var
  Param1Buf: array of WideChar;
  AResult: variant;
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Windows.GetDllDirectoryW(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Windows.RemoveDirectory(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__RemoveDirectoryTransacted(AMachine: TatVirtualMachine);
  var
  Param0Buf: array of WideChar;
  AResult: variant;
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Windows.RemoveDirectoryTransacted(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__RemoveDirectoryTransactedA(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Windows.RemoveDirectoryTransactedA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),VarToInteger(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__RemoveDirectoryTransactedW(AMachine: TatVirtualMachine);
  var
  Param0Buf: array of WideChar;
  AResult: variant;
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Windows.RemoveDirectoryTransactedW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__GetFullPathNameTransacted(AMachine: TatVirtualMachine);
  var
  Param0Buf: array of WideChar;
  Param2Buf: array of WideChar;
...
Param3 := StringToWideChar(VarToStr(GetInputArg(3)),@Param3Buf[0],Length(Param3Buf));
AResult := Integer(Windows.GetFullPathNameTransacted(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)),Param3,VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
    SetInputArg(3,WideCharToString(Param3));
  end;
end;

procedure TatWindowsLibrary.__GetFullPathNameTransactedA(AMachine: TatVirtualMachine);
  var
  Param3: PAnsiChar;
  AResult: variant;
begin
  with AMachine do
  begin
Param3 := PAnsiChar(AnsiString(VarToStr(GetInputArg(3))));
AResult := Integer(Windows.GetFullPathNameTransactedA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),VarToInteger(GetInputArg(1)),PAnsiChar(AnsiString(VarToStr(GetInputArg(2)))),Param3,VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
    SetInputArg(3,string(Param3));
  end;
end;

procedure TatWindowsLibrary.__GetFullPathNameTransactedW(AMachine: TatVirtualMachine);
  var
  Param0Buf: array of WideChar;
  Param2Buf: array of WideChar;
  Param3Buf: array of WideChar;
...
SetLength(Param3Buf, Length(VarToStr(GetInputArg(3))) + 1);
Param3 := StringToWideChar(VarToStr(GetInputArg(3)),@Param3Buf[0],Length(Param3Buf));
AResult := Integer(Windows.GetFullPathNameTransactedW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)),Param3,VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
    SetInputArg(3,WideCharToString(Param3));
  end;
end;

procedure TatWindowsLibrary.__SetFileAttributesTransacted(AMachine: TatVirtualMachine);
  var
  Param0Buf: array of WideChar;
  AResult: variant;
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Windows.SetFileAttributesTransacted(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__SetFileAttributesTransactedA(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Windows.SetFileAttributesTransactedA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__SetFileAttributesTransactedW(AMachine: TatVirtualMachine);
  var
  Param0Buf: array of WideChar;
  AResult: variant;
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Windows.SetFileAttributesTransactedW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Integer(Windows.GetFileAttributes(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Windows.DeleteFile(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__DeleteFileTransacted(AMachine: TatVirtualMachine);
  var
  Param0Buf: array of WideChar;
  AResult: variant;
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Windows.DeleteFileTransacted(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__DeleteFileTransactedA(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Windows.DeleteFileTransactedA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),VarToInteger(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__DeleteFileTransactedW(AMachine: TatVirtualMachine);
  var
  Param0Buf: array of WideChar;
  AResult: variant;
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Windows.DeleteFileTransactedW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
Param1Rec := TObject(integer(GetInputArg(1)));
if not Assigned(Param1Rec) or not (Param1Rec is _WIN32_FIND_DATAWWrapper) then 
  Param1Rec := _WIN32_FIND_DATAWWrapper.Create(Param1);
Param1 := _WIN32_FIND_DATAWWrapper(Param1Rec).ObjToRec;
AResult := Integer(Windows.FindFirstFile(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),Param1));
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(_WIN32_FIND_DATAWWrapper.Create(Param1)));
  end;
end;
...
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Windows.CopyFile(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),GetInputArg(2));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Windows.MoveFile(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__MoveFileTransacted(AMachine: TatVirtualMachine);
  var
  Param0Buf: array of WideChar;
  Param1Buf: array of WideChar;
  AResult: variant;
...
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Windows.MoveFileTransacted(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__MoveFileTransactedA(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Windows.MoveFileTransactedA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__MoveFileTransactedW(AMachine: TatVirtualMachine);
  var
  Param0Buf: array of WideChar;
  Param1Buf: array of WideChar;
  AResult: variant;
...
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Windows.MoveFileTransactedW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__CreateHardLinkTransacted(AMachine: TatVirtualMachine);
  var
  Param0Buf: array of WideChar;
  Param1Buf: array of WideChar;
  AResult: variant;
...
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Windows.CreateHardLinkTransacted(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),_SECURITY_ATTRIBUTESWrapper(integer(GetInputArg(2))).ObjToRec,VarToInteger(GetInputArg(3)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__CreateHardLinkTransactedA(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Windows.CreateHardLinkTransactedA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),_SECURITY_ATTRIBUTESWrapper(integer(GetInputArg(2))).ObjToRec,VarToInteger(GetInputArg(3)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__CreateHardLinkTransactedW(AMachine: TatVirtualMachine);
  var
  Param0Buf: array of WideChar;
  Param1Buf: array of WideChar;
  AResult: variant;
...
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Windows.CreateHardLinkTransactedW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),_SECURITY_ATTRIBUTESWrapper(integer(GetInputArg(2))).ObjToRec,VarToInteger(GetInputArg(3)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__CreateSymbolicLink(AMachine: TatVirtualMachine);
  var
  Param0Buf: array of WideChar;
  Param1Buf: array of WideChar;
  AResult: variant;
...
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Windows.CreateSymbolicLink(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__CreateSymbolicLinkA(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Windows.CreateSymbolicLinkA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__CreateSymbolicLinkW(AMachine: TatVirtualMachine);
  var
  Param0Buf: array of WideChar;
  Param1Buf: array of WideChar;
  AResult: variant;
...
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Windows.CreateSymbolicLinkW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__CreateSymbolicLinkTransacted(AMachine: TatVirtualMachine);
  var
  Param0Buf: array of WideChar;
  Param1Buf: array of WideChar;
  AResult: variant;
...
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Windows.CreateSymbolicLinkTransacted(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__CreateSymbolicLinkTransactedA(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Windows.CreateSymbolicLinkTransactedA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__CreateSymbolicLinkTransactedW(AMachine: TatVirtualMachine);
  var
  Param0Buf: array of WideChar;
  Param1Buf: array of WideChar;
  AResult: variant;
...
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Windows.CreateSymbolicLinkTransactedW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__GetFinalPathNameByHandle(AMachine: TatVirtualMachine);
  var
  Param1Buf: array of WideChar;
  AResult: variant;
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(Windows.GetFinalPathNameByHandle(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__GetFinalPathNameByHandleA(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(Windows.GetFinalPathNameByHandleA(VarToInteger(GetInputArg(0)),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__GetFinalPathNameByHandleW(AMachine: TatVirtualMachine);
  var
  Param1Buf: array of WideChar;
  AResult: variant;
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(Windows.GetFinalPathNameByHandleW(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatWindowsLibrary.__GetComputerNameEx(AMachine: TatVirtualMachine);
  var
  Param1Buf: array of WideChar;
  Param2: DWORD;
  AResult: variant;
...
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
Param2 := VarToInteger(GetInputArg(2));
AResult := Windows.GetComputerNameEx(_COMPUTER_NAME_FORMAT(VarToInteger(GetInputArg(0))),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
  end;
end;

procedure TatWindowsLibrary.__GetComputerNameExA(AMachine: TatVirtualMachine);
  var
  Param2: DWORD;
  AResult: variant;
begin
  ...
  begin
Param2 := VarToInteger(GetInputArg(2));
AResult := Windows.GetComputerNameExA(_COMPUTER_NAME_FORMAT(VarToInteger(GetInputArg(0))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
  end;
end;

procedure TatWindowsLibrary.__GetComputerNameExW(AMachine: TatVirtualMachine);
  var
  Param1Buf: array of WideChar;
  Param2: DWORD;
  AResult: variant;
...
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
Param2 := VarToInteger(GetInputArg(2));
AResult := Windows.GetComputerNameExW(_COMPUTER_NAME_FORMAT(VarToInteger(GetInputArg(0))),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
  end;
end;

procedure TatWindowsLibrary.__VerifyVersionInfo(AMachine: TatVirtualMachine);
  var
  Param0Rec: TObject;
  Param0: TOSVersionInfo;
  AResult: variant;
begin
  with AMachine do
  begin
Param0Rec := TObject(integer(GetInputArg(0)));
if not Assigned(Param0Rec) or not (Param0Rec is _OSVERSIONINFOWWrapper) then 
  Param0Rec := _OSVERSIONINFOWWrapper.Create(Param0);
Param0 := _OSVERSIONINFOWWrapper(Param0Rec).ObjToRec;
AResult := Windows.VerifyVersionInfo(Param0,VarToInteger(GetInputArg(1)),GetInputArg(2));
    ReturnOutputArg(AResult);
    SetInputArg(0,integer(_OSVERSIONINFOWWrapper.Create(Param0)));
  end;
end;

procedure TatWindowsLibrary.__VerifyVersionInfoA(AMachine: TatVirtualMachine);
  var
  Param0Rec: TObject;
  Param0: TOSVersionInfoA;
  AResult: variant;
begin
  with AMachine do
  begin
Param0Rec := TObject(integer(GetInputArg(0)));
if not Assigned(Param0Rec) or not (Param0Rec is _OSVERSIONINFOAWrapper) then 
  Param0Rec := _OSVERSIONINFOAWrapper.Create(Param0);
Param0 := _OSVERSIONINFOAWrapper(Param0Rec).ObjToRec;
AResult := Windows.VerifyVersionInfoA(Param0,VarToInteger(GetInputArg(1)),GetInputArg(2));
    ReturnOutputArg(AResult);
    SetInputArg(0,integer(_OSVERSIONINFOAWrapper.Create(Param0)));
  end;
end;

procedure TatWindowsLibrary.__VerifyVersionInfoW(AMachine: TatVirtualMachine);
  var
  Param0Rec: TObject;
  Param0: TOSVersionInfoW;
  AResult: variant;
begin
  with AMachine do
  begin
...
if not Assigned(Param0Rec) or not (Param0Rec is _OSVERSIONINFOWWrapper) then 
  Param0Rec := _OSVERSIONINFOWWrapper.Create(Param0);
Param0 := _OSVERSIONINFOWWrapper(Param0Rec).ObjToRec;
AResult := Windows.VerifyVersionInfoW(Param0,VarToInteger(GetInputArg(1)),GetInputArg(2));
    ReturnOutputArg(AResult);
    SetInputArg(0,integer(_OSVERSIONINFOWWrapper.Create(Param0)));
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(Windows.CopyMetaFile(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__GetRandomRgn(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(Windows.GetRandomRgn(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(Windows.CopyEnhMetaFile(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatWindowsLibrary.__GET_APPCOMMAND_LPARAM(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(Windows.GET_APPCOMMAND_LPARAM(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__GET_DEVICE_LPARAM(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(Windows.GET_DEVICE_LPARAM(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__GET_MOUSEORKEY_LPARAM(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(Windows.GET_MOUSEORKEY_LPARAM(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__GET_FLAGS_LPARAM(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(Windows.GET_FLAGS_LPARAM(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__GET_KEYSTATE_LPARAM(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(Windows.GET_KEYSTATE_LPARAM(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__GetMouseMovePointsEx(AMachine: TatVirtualMachine);
  var
  Param1Rec: TObject;
  Param1: TMouseMovePoint;
  Param2Rec: TObject;
  Param2: TMouseMovePoint;
  AResult: variant;
begin
  with AMachine do
  begin
Param1Rec := TObject(integer(GetInputArg(1)));
if not Assigned(Param1Rec) or not (Param1Rec is tagMOUSEMOVEPOINTWrapper) then 
  Param1Rec := tagMOUSEMOVEPOINTWrapper.Create(Param1);
Param1 := tagMOUSEMOVEPOINTWrapper(Param1Rec).ObjToRec;
Param2Rec := TObject(integer(GetInputArg(2)));
if not Assigned(Param2Rec) or not (Param2Rec is tagMOUSEMOVEPOINTWrapper) then 
  Param2Rec := tagMOUSEMOVEPOINTWrapper.Create(Param2);
Param2 := tagMOUSEMOVEPOINTWrapper(Param2Rec).ObjToRec;
AResult := Integer(Windows.GetMouseMovePointsEx(VarToInteger(GetInputArg(0)),Param1,Param2,VarToInteger(GetInputArg(3)),VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(tagMOUSEMOVEPOINTWrapper.Create(Param1)));
    SetInputArg(2,integer(tagMOUSEMOVEPOINTWrapper.Create(Param2)));
  end;
end;

procedure TatWindowsLibrary.__PointToLParam(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(Windows.PointToLParam(TPointWrapper(integer(GetInputArg(0))).ObjToRec));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatWindowsLibrary.__GetWindowPlacement(AMachine: TatVirtualMachine);
  var
  Param1Rec: TObject;
  Param1: TWindowPlacement;
  AResult: variant;
begin
  with AMachine do
  begin
Param1Rec := TObject(integer(GetInputArg(1)));
if not Assigned(Param1Rec) or not (Param1Rec is tagWINDOWPLACEMENTWrapper) then 
  Param1Rec := tagWINDOWPLACEMENTWrapper.Create(Param1);
Param1 := tagWINDOWPLACEMENTWrapper(Param1Rec).ObjToRec;
AResult := Windows.GetWindowPlacement(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(tagWINDOWPLACEMENTWrapper.Create(Param1)));
  end;
end;

procedure TatWindowsLibrary.__SetWindowPlacement(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Windows.SetWindowPlacement(VarToInteger(GetInputArg(0)),tagWINDOWPLACEMENTWrapper(integer(GetInputArg(1))).ObjToRec);
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__GetWindowDisplayAffinity(AMachine: TatVirtualMachine);
  var
  Param1: DWORD;
  AResult: variant;
begin
  ...
  begin
Param1 := VarToInteger(GetInputArg(1));
AResult := Windows.GetWindowDisplayAffinity(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;

procedure TatWindowsLibrary.__SetWindowDisplayAffinity(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Windows.SetWindowDisplayAffinity(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(Windows.GetClipboardFormatName(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__AddClipboardFormatListener(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Windows.AddClipboardFormatListener(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__RemoveClipboardFormatListener(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Windows.RemoveClipboardFormatListener(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Windows.CharToOem(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.CharToOemA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Windows.CharToOemW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Windows.OemToChar(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Windows.CharToOemBuff(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.CharToOemBuffA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Windows.CharToOemBuffW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := WideCharToString(Windows.CharUpper(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(Windows.CharUpperA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := WideCharToString(Windows.CharUpperW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Integer(Windows.CharUpperBuff(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Windows.CharUpperBuffA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Integer(Windows.CharUpperBuffW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := WideCharToString(Windows.CharLower(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(Windows.CharLowerA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := WideCharToString(Windows.CharLowerW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Integer(Windows.CharLowerBuff(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Windows.CharLowerBuffA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Integer(Windows.CharLowerBuffW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := WideCharToString(Windows.CharNext(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(Windows.CharNextA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := WideCharToString(Windows.CharNextW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := WideCharToString(Windows.CharPrev(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(Windows.CharPrevA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1))))));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := WideCharToString(Windows.CharPrevW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(Windows.CharNextExA(VarToInteger(GetInputArg(0)),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(Windows.CharNextEx(VarToInteger(GetInputArg(0)),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(Windows.CharPrevEx(VarToInteger(GetInputArg(0)),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(2)))),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(Windows.CharPrevExA(VarToInteger(GetInputArg(0)),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(2)))),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.AnsiToOem(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.OemToAnsi(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Windows.AnsiToOemBuff(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(Windows.AnsiUpper(PAnsiChar(AnsiString(VarToStr(GetInputArg(0))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Windows.AnsiUpperBuff(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(Windows.AnsiLower(PAnsiChar(AnsiString(VarToStr(GetInputArg(0))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Windows.AnsiLowerBuff(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(Windows.AnsiNext(PAnsiChar(AnsiString(VarToStr(GetInputArg(0))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(Windows.AnsiPrev(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1))))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__CloseTouchInputHandle(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Windows.CloseTouchInputHandle(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__RegisterTouchWindow(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Windows.RegisterTouchWindow(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__UnregisterTouchWindow(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Windows.UnregisterTouchWindow(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__CalculatePopupWindowPosition(AMachine: TatVirtualMachine);
  var
  Param4Rec: TObject;
  Param4: TRect;
  AResult: variant;
begin
  ...
  begin
Param4Rec := TObject(integer(GetInputArg(4)));
if not Assigned(Param4Rec) or not (Param4Rec is TRectWrapper) then 
  Param4Rec := TRectWrapper.Create(Param4);
Param4 := TRectWrapper(Param4Rec).ObjToRec;
AResult := Windows.CalculatePopupWindowPosition(TPointWrapper(integer(GetInputArg(0))).ObjToRec,tagSIZEWrapper(integer(GetInputArg(1))).ObjToRec,VarToInteger(GetInputArg(2)),TRectWrapper(integer(GetInputArg(3))).ObjToRec,Param4);
    ReturnOutputArg(AResult);
    SetInputArg(4,integer(TRectWrapper.Create(Param4)));
  end;
end;
...
procedure TatWindowsLibrary.__InvalidateRect(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Windows.InvalidateRect(VarToInteger(GetInputArg(0)),TRectWrapper(integer(GetInputArg(1))).ObjToRec,GetInputArg(2));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__ValidateRect(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Windows.ValidateRect(VarToInteger(GetInputArg(0)),TRectWrapper(integer(GetInputArg(1))).ObjToRec);
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__RedrawWindow(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Windows.RedrawWindow(VarToInteger(GetInputArg(0)),TRectWrapper(integer(GetInputArg(1))).ObjToRec,VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
AResult := Integer(Windows.MessageBox(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
AResult := Integer(Windows.MessageBoxEx(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)),VarToInteger(GetInputArg(3)),VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatWindowsLibrary.__SetPhysicalCursorPos(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Windows.SetPhysicalCursorPos(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__GetPhysicalCursorPos(AMachine: TatVirtualMachine);
  var
  Param0Rec: TObject;
  Param0: TPoint;
  AResult: variant;
...
AResult := Windows.GetPhysicalCursorPos(Param0);
    ReturnOutputArg(AResult);
...
procedure TatWindowsLibrary.__LogicalToPhysicalPoint(AMachine: TatVirtualMachine);
  var
  Param1Rec: TObject;
  Param1: TPoint;
  AResult: variant;
...
if not Assigned(Param1Rec) or not (Param1Rec is TPointWrapper) then 
  Param1Rec := TPointWrapper.Create(Param1);
Param1 := TPointWrapper(Param1Rec).ObjToRec;
AResult := Windows.LogicalToPhysicalPoint(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(TPointWrapper.Create(Param1)));
  end;
end;

procedure TatWindowsLibrary.__PhysicalToLogicalPoint(AMachine: TatVirtualMachine);
  var
  Param1Rec: TObject;
  Param1: TPoint;
  AResult: variant;
...
if not Assigned(Param1Rec) or not (Param1Rec is TPointWrapper) then 
  Param1Rec := TPointWrapper.Create(Param1);
Param1 := TPointWrapper(Param1Rec).ObjToRec;
AResult := Windows.PhysicalToLogicalPoint(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(TPointWrapper.Create(Param1)));
  end;
end;

procedure TatWindowsLibrary.__WindowFromPhysicalPoint(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(Windows.WindowFromPhysicalPoint(TPointWrapper(integer(GetInputArg(0))).ObjToRec));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(Windows.FindWindow(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
AResult := Integer(Windows.LoadString(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(Windows.HtmlHelp(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Windows.HtmlHelpA(VarToInteger(GetInputArg(0)),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(Windows.HtmlHelpW(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__SystemParametersInfo(AMachine: TatVirtualMachine);
  var
  Param2: Integer;
  AResult: variant;
begin
  ...
  begin
Param2 := VarToInteger(GetInputArg(2));
AResult := Windows.SystemParametersInfo(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),Param2,VarToInteger(GetInputArg(3)));
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
  end;
end;

procedure TatWindowsLibrary.__BlockInput(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Windows.BlockInput(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__SetProcessDPIAware(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Windows.SetProcessDPIAware;
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__IsProcessDPIAware(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Windows.IsProcessDPIAware;
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__GetCPInfoEx(AMachine: TatVirtualMachine);
  var
  Param2Rec: TObject;
  Param2: TCPInfoEx;
  AResult: variant;
begin
  ...
  begin
Param2Rec := TObject(integer(GetInputArg(2)));
if not Assigned(Param2Rec) or not (Param2Rec is _cpinfoExWWrapper) then 
  Param2Rec := _cpinfoExWWrapper.Create(Param2);
Param2 := _cpinfoExWWrapper(Param2Rec).ObjToRec;
AResult := Windows.GetCPInfoEx(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,integer(_cpinfoExWWrapper.Create(Param2)));
  end;
end;

procedure TatWindowsLibrary.__GetCPInfoExA(AMachine: TatVirtualMachine);
  var
  Param2Rec: TObject;
  Param2: TCPInfoExA;
  AResult: variant;
begin
  ...
  begin
Param2Rec := TObject(integer(GetInputArg(2)));
if not Assigned(Param2Rec) or not (Param2Rec is _cpinfoExAWrapper) then 
  Param2Rec := _cpinfoExAWrapper.Create(Param2);
Param2 := _cpinfoExAWrapper(Param2Rec).ObjToRec;
AResult := Windows.GetCPInfoExA(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,integer(_cpinfoExAWrapper.Create(Param2)));
  end;
end;

procedure TatWindowsLibrary.__GetCPInfoExW(AMachine: TatVirtualMachine);
  var
  Param2Rec: TObject;
  Param2: TCPInfoExW;
  AResult: variant;
...
if not Assigned(Param2Rec) or not (Param2Rec is _cpinfoExWWrapper) then 
  Param2Rec := _cpinfoExWWrapper.Create(Param2);
Param2 := _cpinfoExWWrapper(Param2Rec).ObjToRec;
AResult := Windows.GetCPInfoExW(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,integer(_cpinfoExWWrapper.Create(Param2)));
  end;
end;

procedure TatWindowsLibrary.__LCIDToLocaleName(AMachine: TatVirtualMachine);
  var
  Param1Buf: array of WideChar;
  AResult: variant;
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(Windows.LCIDToLocaleName(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__LocaleNameToLCID(AMachine: TatVirtualMachine);
  var
  Param0Buf: array of WideChar;
  AResult: variant;
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Integer(Windows.LocaleNameToLCID(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__GetLocaleInfoEx(AMachine: TatVirtualMachine);
  var
  Param0Buf: array of WideChar;
  Param2Buf: array of WideChar;
  AResult: variant;
...
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
AResult := Integer(Windows.GetLocaleInfoEx(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
SetLength(Param3Buf, Length(VarToStr(GetInputArg(3))) + 1);
AResult := Integer(Windows.FoldString(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2)),StringToWideChar(VarToStr(GetInputArg(3)),@Param3Buf[0],Length(Param3Buf)),VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatWindowsLibrary.__GetWindowLongPtr(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(Windows.GetWindowLongPtr(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__SetWindowLongPtr(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(Windows.SetWindowLongPtr(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__GetWindowLongPtrA(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(Windows.GetWindowLongPtrA(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__SetWindowLongPtrA(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(Windows.SetWindowLongPtrA(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__GetWindowLongPtrW(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(Windows.GetWindowLongPtrW(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__SetWindowLongPtrW(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(Windows.SetWindowLongPtrW(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__GID_ROTATE_ANGLE_TO_ARGUMENT(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(Windows.GID_ROTATE_ANGLE_TO_ARGUMENT(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__GID_ROTATE_ANGLE_FROM_ARGUMENT(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Windows.GID_ROTATE_ANGLE_FROM_ARGUMENT(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__GetGestureInfo(AMachine: TatVirtualMachine);
  var
  Param1Rec: TObject;
  Param1: GestureInfo;
  AResult: variant;
begin
  ...
  begin
Param1Rec := TObject(integer(GetInputArg(1)));
if not Assigned(Param1Rec) or not (Param1Rec is GESTUREINFOWrapper) then 
  Param1Rec := GESTUREINFOWrapper.Create(Param1);
Param1 := GESTUREINFOWrapper(Param1Rec).ObjToRec;
AResult := Windows.GetGestureInfo(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(GESTUREINFOWrapper.Create(Param1)));
  end;
end;

procedure TatWindowsLibrary.__CloseGestureInfoHandle(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Windows.CloseGestureInfoHandle(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__RotateAngleFromArgument(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Windows.RotateAngleFromArgument(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatWindowsLibrary.__InertiaVectorFromArgument(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := integer(TSmallPointWrapper.Create(Windows.InertiaVectorFromArgument(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatWindowsLibrary.Init;
  ...
  begin
    ...
    begin
      AddConstant('LANG_INVARIANT',LANG_INVARIANT);
      AddConstant('SUBLANG_CUSTOM_DEFAULT',SUBLANG_CUSTOM_DEFAULT);
      AddConstant('SUBLANG_CUSTOM_UNSPECIFIED',SUBLANG_CUSTOM_UNSPECIFIED);
      AddConstant('SUBLANG_UI_CUSTOM_DEFAULT',SUBLANG_UI_CUSTOM_DEFAULT);
      AddConstant('LOCALE_NAME_MAX_LENGTH',LOCALE_NAME_MAX_LENGTH);
      AddConstant('NLS_VALID_LOCALE_MASK',NLS_VALID_LOCALE_MASK);
      AddConstant('LOCALE_CUSTOM_DEFAULT',LOCALE_CUSTOM_DEFAULT);
      AddConstant('LOCALE_CUSTOM_UNSPECIFIED',LOCALE_CUSTOM_UNSPECIFIED);
      AddConstant('LOCALE_CUSTOM_UI_DEFAULT',LOCALE_CUSTOM_UI_DEFAULT);
      AddConstant('LOCALE_NEUTRAL',LOCALE_NEUTRAL);
      AddConstant('LOCALE_INVARIANT',LOCALE_INVARIANT);
      AddConstant('SEMAPHORE_MODIFY_STATE',SEMAPHORE_MODIFY_STATE);
      AddConstant('SEMAPHORE_ALL_ACCESS',SEMAPHORE_ALL_ACCESS);
      AddConstant('FILE_READ_DATA',FILE_READ_DATA);
      AddConstant('FILE_LIST_DIRECTORY',FILE_LIST_DIRECTORY);
      AddConstant('FILE_WRITE_DATA',FILE_WRITE_DATA);
      AddConstant('FILE_ADD_FILE',FILE_ADD_FILE);
      AddConstant('FILE_APPEND_DATA',FILE_APPEND_DATA);
      AddConstant('FILE_ADD_SUBDIRECTORY',FILE_ADD_SUBDIRECTORY);
      AddConstant('FILE_CREATE_PIPE_INSTANCE',FILE_CREATE_PIPE_INSTANCE);
      AddConstant('FILE_READ_EA',FILE_READ_EA);
      AddConstant('FILE_WRITE_EA',FILE_WRITE_EA);
      AddConstant('FILE_EXECUTE',FILE_EXECUTE);
      AddConstant('FILE_TRAVERSE',FILE_TRAVERSE);
      AddConstant('FILE_DELETE_CHILD',FILE_DELETE_CHILD);
      AddConstant('FILE_READ_ATTRIBUTES',FILE_READ_ATTRIBUTES);
      AddConstant('FILE_WRITE_ATTRIBUTES',FILE_WRITE_ATTRIBUTES);
      AddConstant('FILE_ATTRIBUTE_DEVICE',FILE_ATTRIBUTE_DEVICE);
      AddConstant('FILE_ATTRIBUTE_SPARSE_FILE',FILE_ATTRIBUTE_SPARSE_FILE);
      AddConstant('FILE_ATTRIBUTE_REPARSE_POINT',FILE_ATTRIBUTE_REPARSE_POINT);
      AddConstant('FILE_ATTRIBUTE_NOT_CONTENT_INDEXED',FILE_ATTRIBUTE_NOT_CONTENT_INDEXED);
      AddConstant('FILE_ATTRIBUTE_ENCRYPTED',FILE_ATTRIBUTE_ENCRYPTED);
      AddConstant('FILE_ATTRIBUTE_VIRTUAL',FILE_ATTRIBUTE_VIRTUAL);
      AddConstant('INVALID_FILE_ATTRIBUTES',INVALID_FILE_ATTRIBUTES);
      AddConstant('FILE_VOLUME_QUOTAS',FILE_VOLUME_QUOTAS);
      AddConstant('FILE_SUPPORTS_SPARSE_FILES',FILE_SUPPORTS_SPARSE_FILES);
      AddConstant('FILE_SUPPORTS_REPARSE_POINTS',FILE_SUPPORTS_REPARSE_POINTS);
      AddConstant('FILE_SUPPORTS_REMOTE_STORAGE',FILE_SUPPORTS_REMOTE_STORAGE);
      AddConstant('FILE_SUPPORTS_OBJECT_IDS',FILE_SUPPORTS_OBJECT_IDS);
      AddConstant('FILE_SUPPORTS_ENCRYPTION',FILE_SUPPORTS_ENCRYPTION);
      AddConstant('FILE_NAMED_STREAMS',FILE_NAMED_STREAMS);
      AddConstant('FILE_READ_ONLY_VOLUME',FILE_READ_ONLY_VOLUME);
      AddConstant('FILE_SEQUENTIAL_WRITE_ONCE',FILE_SEQUENTIAL_WRITE_ONCE);
      AddConstant('FILE_SUPPORTS_TRANSACTIONS',FILE_SUPPORTS_TRANSACTIONS);
      AddConstant('FILE_SUPPORTS_HARD_LINKS',FILE_SUPPORTS_HARD_LINKS);
      AddConstant('FILE_SUPPORTS_EXTENDED_ATTRIBUTES',FILE_SUPPORTS_EXTENDED_ATTRIBUTES);
      AddConstant('FILE_SUPPORTS_OPEN_BY_FILE_ID',FILE_SUPPORTS_OPEN_BY_FILE_ID);
      AddConstant('FILE_SUPPORTS_USN_JOURNAL',FILE_SUPPORTS_USN_JOURNAL);
      AddConstant('TOKEN_SOURCE_LENGTH',TOKEN_SOURCE_LENGTH);
      AddConstant('POLICY_AUDIT_SUBCATEGORY_COUNT',POLICY_AUDIT_SUBCATEGORY_COUNT);
      AddConstant('IMAGE_ORDINAL_FLAG64',IMAGE_ORDINAL_FLAG64);
      AddConstant('IMAGE_ORDINAL_FLAG32',IMAGE_ORDINAL_FLAG32);
      AddConstant('IMAGE_ORDINAL_FLAG',IMAGE_ORDINAL_FLAG);
      AddConstant('IMAGE_FILE_LARGE_ADDRESS_AWARE',IMAGE_FILE_LARGE_ADDRESS_AWARE);
      ...
      AddConstant('WT_EXECUTEDEFAULT',WT_EXECUTEDEFAULT);
      AddConstant('WT_EXECUTEINIOTHREAD',WT_EXECUTEINIOTHREAD);
      AddConstant('WT_EXECUTEINUITHREAD',WT_EXECUTEINUITHREAD);
      AddConstant('WT_EXECUTEINWAITTHREAD',WT_EXECUTEINWAITTHREAD);
      AddConstant('WT_EXECUTEONLYONCE',WT_EXECUTEONLYONCE);
      AddConstant('WT_EXECUTEINTIMERTHREAD',WT_EXECUTEINTIMERTHREAD);
      AddConstant('WT_EXECUTELONGFUNCTION',WT_EXECUTELONGFUNCTION);
      AddConstant('WT_EXECUTEINPERSISTENTIOTHREAD',WT_EXECUTEINPERSISTENTIOTHREAD);
      AddConstant('WT_EXECUTEINPERSISTENTTHREAD',WT_EXECUTEINPERSISTENTTHREAD);
      AddConstant('WT_TRANSFER_IMPERSONATION',WT_TRANSFER_IMPERSONATION);
      AddConstant('KEY_WOW64_32KEY',KEY_WOW64_32KEY);
      AddConstant('KEY_WOW64_64KEY',KEY_WOW64_64KEY);
      AddConstant('KEY_WOW64_RES',KEY_WOW64_RES);
      AddConstant('FILE_FLAG_OPEN_REPARSE_POINT',FILE_FLAG_OPEN_REPARSE_POINT);
      AddConstant('FILE_FLAG_OPEN_NO_RECALL',FILE_FLAG_OPEN_NO_RECALL);
      AddConstant('FILE_FLAG_FIRST_PIPE_INSTANCE',FILE_FLAG_FIRST_PIPE_INSTANCE);
      AddConstant('COPY_FILE_OPEN_SOURCE_FOR_WRITE',COPY_FILE_OPEN_SOURCE_FOR_WRITE);
      AddConstant('COPY_FILE_ALLOW_DECRYPTED_DESTINATION',COPY_FILE_ALLOW_DECRYPTED_DESTINATION);
      AddConstant('COPY_FILE_COPY_SYMLINK',COPY_FILE_COPY_SYMLINK);
      AddConstant('COPY_FILE_NO_BUFFERING',COPY_FILE_NO_BUFFERING);
      AddConstant('REPLACEFILE_WRITE_THROUGH',REPLACEFILE_WRITE_THROUGH);
      AddConstant('REPLACEFILE_IGNORE_MERGE_ERRORS',REPLACEFILE_IGNORE_MERGE_ERRORS);
      ...
      AddConstant('FILE_DEVICE_BEEP',FILE_DEVICE_BEEP);
      AddConstant('FILE_DEVICE_CD_ROM',FILE_DEVICE_CD_ROM);
      AddConstant('FILE_DEVICE_CD_ROM_FILE_SYSTEM',FILE_DEVICE_CD_ROM_FILE_SYSTEM);
      AddConstant('FILE_DEVICE_CONTROLLER',FILE_DEVICE_CONTROLLER);
      AddConstant('FILE_DEVICE_DATALINK',FILE_DEVICE_DATALINK);
      AddConstant('FILE_DEVICE_DFS',FILE_DEVICE_DFS);
      AddConstant('FILE_DEVICE_DISK',FILE_DEVICE_DISK);
      AddConstant('FILE_DEVICE_DISK_FILE_SYSTEM',FILE_DEVICE_DISK_FILE_SYSTEM);
      AddConstant('FILE_DEVICE_FILE_SYSTEM',FILE_DEVICE_FILE_SYSTEM);
      AddConstant('FILE_DEVICE_INPORT_PORT',FILE_DEVICE_INPORT_PORT);
      AddConstant('FILE_DEVICE_KEYBOARD',FILE_DEVICE_KEYBOARD);
      AddConstant('FILE_DEVICE_MAILSLOT',FILE_DEVICE_MAILSLOT);
      AddConstant('FILE_DEVICE_MIDI_IN',FILE_DEVICE_MIDI_IN);
      AddConstant('FILE_DEVICE_MIDI_OUT',FILE_DEVICE_MIDI_OUT);
      AddConstant('FILE_DEVICE_MOUSE',FILE_DEVICE_MOUSE);
      AddConstant('FILE_DEVICE_MULTI_UNC_PROVIDER',FILE_DEVICE_MULTI_UNC_PROVIDER);
      AddConstant('FILE_DEVICE_NAMED_PIPE',FILE_DEVICE_NAMED_PIPE);
      AddConstant('FILE_DEVICE_NETWORK',FILE_DEVICE_NETWORK);
      AddConstant('FILE_DEVICE_NETWORK_BROWSER',FILE_DEVICE_NETWORK_BROWSER);
      AddConstant('FILE_DEVICE_NETWORK_FILE_SYSTEM',FILE_DEVICE_NETWORK_FILE_SYSTEM);
      AddConstant('FILE_DEVICE_NULL',FILE_DEVICE_NULL);
      AddConstant('FILE_DEVICE_PARALLEL_PORT',FILE_DEVICE_PARALLEL_PORT);
      AddConstant('FILE_DEVICE_PHYSICAL_NETCARD',FILE_DEVICE_PHYSICAL_NETCARD);
      AddConstant('FILE_DEVICE_PRINTER',FILE_DEVICE_PRINTER);
      AddConstant('FILE_DEVICE_SCANNER',FILE_DEVICE_SCANNER);
      AddConstant('FILE_DEVICE_SERIAL_MOUSE_PORT',FILE_DEVICE_SERIAL_MOUSE_PORT);
      AddConstant('FILE_DEVICE_SERIAL_PORT',FILE_DEVICE_SERIAL_PORT);
      AddConstant('FILE_DEVICE_SCREEN',FILE_DEVICE_SCREEN);
      AddConstant('FILE_DEVICE_SOUND',FILE_DEVICE_SOUND);
      AddConstant('FILE_DEVICE_STREAMS',FILE_DEVICE_STREAMS);
      AddConstant('FILE_DEVICE_TAPE',FILE_DEVICE_TAPE);
      AddConstant('FILE_DEVICE_TAPE_FILE_SYSTEM',FILE_DEVICE_TAPE_FILE_SYSTEM);
      AddConstant('FILE_DEVICE_TRANSPORT',FILE_DEVICE_TRANSPORT);
      AddConstant('FILE_DEVICE_UNKNOWN',FILE_DEVICE_UNKNOWN);
      AddConstant('FILE_DEVICE_VIDEO',FILE_DEVICE_VIDEO);
      AddConstant('FILE_DEVICE_VIRTUAL_DISK',FILE_DEVICE_VIRTUAL_DISK);
      AddConstant('FILE_DEVICE_WAVE_IN',FILE_DEVICE_WAVE_IN);
      AddConstant('FILE_DEVICE_WAVE_OUT',FILE_DEVICE_WAVE_OUT);
      AddConstant('FILE_DEVICE_8042_PORT',FILE_DEVICE_8042_PORT);
      AddConstant('FILE_DEVICE_NETWORK_REDIRECTOR',FILE_DEVICE_NETWORK_REDIRECTOR);
      AddConstant('FILE_DEVICE_BATTERY',FILE_DEVICE_BATTERY);
      AddConstant('FILE_DEVICE_BUS_EXTENDER',FILE_DEVICE_BUS_EXTENDER);
      AddConstant('FILE_DEVICE_MODEM',FILE_DEVICE_MODEM);
      AddConstant('FILE_DEVICE_VDM',FILE_DEVICE_VDM);
      AddConstant('FILE_DEVICE_MASS_STORAGE',FILE_DEVICE_MASS_STORAGE);
      AddConstant('FILE_DEVICE_SMB',FILE_DEVICE_SMB);
      AddConstant('FILE_DEVICE_KS',FILE_DEVICE_KS);
      AddConstant('FILE_DEVICE_CHANGER',FILE_DEVICE_CHANGER);
      AddConstant('FILE_DEVICE_SMARTCARD',FILE_DEVICE_SMARTCARD);
      AddConstant('FILE_DEVICE_ACPI',FILE_DEVICE_ACPI);
      AddConstant('FILE_DEVICE_DVD',FILE_DEVICE_DVD);
      AddConstant('FILE_DEVICE_FULLSCREEN_VIDEO',FILE_DEVICE_FULLSCREEN_VIDEO);
      AddConstant('FILE_DEVICE_DFS_FILE_SYSTEM',FILE_DEVICE_DFS_FILE_SYSTEM);
      AddConstant('FILE_DEVICE_DFS_VOLUME',FILE_DEVICE_DFS_VOLUME);
      AddConstant('FILE_DEVICE_SERENUM',FILE_DEVICE_SERENUM);
      AddConstant('FILE_DEVICE_TERMSRV',FILE_DEVICE_TERMSRV);
      AddConstant('FILE_DEVICE_KSEC',FILE_DEVICE_KSEC);
      AddConstant('FILE_DEVICE_FIPS',FILE_DEVICE_FIPS);
      AddConstant('FILE_DEVICE_INFINIBAND',FILE_DEVICE_INFINIBAND);
      AddConstant('FILE_DEVICE_VMBUS',FILE_DEVICE_VMBUS);
      AddConstant('FILE_DEVICE_CRYPT_PROVIDER',FILE_DEVICE_CRYPT_PROVIDER);
      AddConstant('FILE_DEVICE_WPD',FILE_DEVICE_WPD);
      AddConstant('FILE_DEVICE_BLUETOOTH',FILE_DEVICE_BLUETOOTH);
      AddConstant('FILE_DEVICE_MT_COMPOSITE',FILE_DEVICE_MT_COMPOSITE);
      AddConstant('FILE_DEVICE_MT_TRANSPORT',FILE_DEVICE_MT_TRANSPORT);
      AddConstant('FILE_DEVICE_BIOMETRIC',FILE_DEVICE_BIOMETRIC);
      AddConstant('FILE_DEVICE_PMI',FILE_DEVICE_PMI);
      AddConstant('FILE_ANY_ACCESS',FILE_ANY_ACCESS);
      AddConstant('FILE_SPECIAL_ACCESS',FILE_SPECIAL_ACCESS);
      AddConstant('FILE_READ_ACCESS',FILE_READ_ACCESS);
      AddConstant('FILE_WRITE_ACCESS',FILE_WRITE_ACCESS);
      AddConstant('METHOD_BUFFERED',METHOD_BUFFERED);
      AddConstant('METHOD_IN_DIRECT',METHOD_IN_DIRECT);
      AddConstant('METHOD_OUT_DIRECT',METHOD_OUT_DIRECT);
      AddConstant('METHOD_NEITHER',METHOD_NEITHER);
      AddConstant('METHOD_DIRECT_TO_HARDWARE',METHOD_DIRECT_TO_HARDWARE);
      AddConstant('METHOD_DIRECT_FROM_HARDWARE',METHOD_DIRECT_FROM_HARDWARE);
      AddConstant('IOCTL_STORAGE_BASE',IOCTL_STORAGE_BASE);
      AddConstant('IOCTL_STORAGE_CHECK_VERIFY',IOCTL_STORAGE_CHECK_VERIFY);
      AddConstant('IOCTL_STORAGE_CHECK_VERIFY2',IOCTL_STORAGE_CHECK_VERIFY2);
      AddConstant('IOCTL_STORAGE_MEDIA_REMOVAL',IOCTL_STORAGE_MEDIA_REMOVAL);
      AddConstant('IOCTL_STORAGE_EJECT_MEDIA',IOCTL_STORAGE_EJECT_MEDIA);
      AddConstant('IOCTL_STORAGE_LOAD_MEDIA',IOCTL_STORAGE_LOAD_MEDIA);
      AddConstant('IOCTL_STORAGE_LOAD_MEDIA2',IOCTL_STORAGE_LOAD_MEDIA2);
      AddConstant('IOCTL_STORAGE_RESERVE',IOCTL_STORAGE_RESERVE);
      AddConstant('IOCTL_STORAGE_RELEASE',IOCTL_STORAGE_RELEASE);
      AddConstant('IOCTL_STORAGE_FIND_NEW_DEVICES',IOCTL_STORAGE_FIND_NEW_DEVICES);
      AddConstant('IOCTL_STORAGE_EJECTION_CONTROL',IOCTL_STORAGE_EJECTION_CONTROL);
      AddConstant('IOCTL_STORAGE_MCN_CONTROL',IOCTL_STORAGE_MCN_CONTROL);
      AddConstant('IOCTL_STORAGE_GET_MEDIA_TYPES',IOCTL_STORAGE_GET_MEDIA_TYPES);
      AddConstant('IOCTL_STORAGE_GET_MEDIA_TYPES_EX',IOCTL_STORAGE_GET_MEDIA_TYPES_EX);
      AddConstant('IOCTL_STORAGE_GET_MEDIA_SERIAL_NUMBER',IOCTL_STORAGE_GET_MEDIA_SERIAL_NUMBER);
      AddConstant('IOCTL_STORAGE_GET_HOTPLUG_INFO',IOCTL_STORAGE_GET_HOTPLUG_INFO);
      AddConstant('IOCTL_STORAGE_SET_HOTPLUG_INFO',IOCTL_STORAGE_SET_HOTPLUG_INFO);
      AddConstant('IOCTL_STORAGE_RESET_BUS',IOCTL_STORAGE_RESET_BUS);
      AddConstant('IOCTL_STORAGE_RESET_DEVICE',IOCTL_STORAGE_RESET_DEVICE);
      AddConstant('IOCTL_STORAGE_BREAK_RESERVATION',IOCTL_STORAGE_BREAK_RESERVATION);
      AddConstant('IOCTL_STORAGE_PERSISTENT_RESERVE_IN',IOCTL_STORAGE_PERSISTENT_RESERVE_IN);
      AddConstant('IOCTL_STORAGE_PERSISTENT_RESERVE_OUT',IOCTL_STORAGE_PERSISTENT_RESERVE_OUT);
      AddConstant('IOCTL_STORAGE_GET_DEVICE_NUMBER',IOCTL_STORAGE_GET_DEVICE_NUMBER);
      AddConstant('IOCTL_STORAGE_PREDICT_FAILURE',IOCTL_STORAGE_PREDICT_FAILURE);
      AddConstant('IOCTL_STORAGE_READ_CAPACITY',IOCTL_STORAGE_READ_CAPACITY);
      AddConstant('IOCTL_STORAGE_QUERY_PROPERTY',IOCTL_STORAGE_QUERY_PROPERTY);
      AddConstant('IOCTL_STORAGE_MANAGE_DATA_SET_ATTRIBUTES',IOCTL_STORAGE_MANAGE_DATA_SET_ATTRIBUTES);
      AddConstant('IOCTL_STORAGE_GET_BC_PROPERTIES',IOCTL_STORAGE_GET_BC_PROPERTIES);
      AddConstant('IOCTL_STORAGE_ALLOCATE_BC_STREAM',IOCTL_STORAGE_ALLOCATE_BC_STREAM);
      AddConstant('IOCTL_STORAGE_FREE_BC_STREAM',IOCTL_STORAGE_FREE_BC_STREAM);
      AddConstant('IOCTL_STORAGE_CHECK_PRIORITY_HINT_SUPPORT',IOCTL_STORAGE_CHECK_PRIORITY_HINT_SUPPORT);
      AddConstant('OBSOLETE_IOCTL_STORAGE_RESET_BUS',OBSOLETE_IOCTL_STORAGE_RESET_BUS);
      AddConstant('OBSOLETE_IOCTL_STORAGE_RESET_DEVICE',OBSOLETE_IOCTL_STORAGE_RESET_DEVICE);
      AddConstant('IOCTL_DISK_BASE',IOCTL_DISK_BASE);
      AddConstant('IOCTL_DISK_GET_DRIVE_GEOMETRY',IOCTL_DISK_GET_DRIVE_GEOMETRY);
      AddConstant('IOCTL_DISK_GET_PARTITION_INFO',IOCTL_DISK_GET_PARTITION_INFO);
      AddConstant('IOCTL_DISK_SET_PARTITION_INFO',IOCTL_DISK_SET_PARTITION_INFO);
      AddConstant('IOCTL_DISK_GET_DRIVE_LAYOUT',IOCTL_DISK_GET_DRIVE_LAYOUT);
      AddConstant('IOCTL_DISK_SET_DRIVE_LAYOUT',IOCTL_DISK_SET_DRIVE_LAYOUT);
      AddConstant('IOCTL_DISK_VERIFY',IOCTL_DISK_VERIFY);
      AddConstant('IOCTL_DISK_FORMAT_TRACKS',IOCTL_DISK_FORMAT_TRACKS);
      AddConstant('IOCTL_DISK_REASSIGN_BLOCKS',IOCTL_DISK_REASSIGN_BLOCKS);
      AddConstant('IOCTL_DISK_PERFORMANCE',IOCTL_DISK_PERFORMANCE);
      AddConstant('IOCTL_DISK_IS_WRITABLE',IOCTL_DISK_IS_WRITABLE);
      AddConstant('IOCTL_DISK_LOGGING',IOCTL_DISK_LOGGING);
      AddConstant('IOCTL_DISK_FORMAT_TRACKS_EX',IOCTL_DISK_FORMAT_TRACKS_EX);
      AddConstant('IOCTL_DISK_HISTOGRAM_STRUCTURE',IOCTL_DISK_HISTOGRAM_STRUCTURE);
      AddConstant('IOCTL_DISK_HISTOGRAM_DATA',IOCTL_DISK_HISTOGRAM_DATA);
      AddConstant('IOCTL_DISK_HISTOGRAM_RESET',IOCTL_DISK_HISTOGRAM_RESET);
      AddConstant('IOCTL_DISK_REQUEST_STRUCTURE',IOCTL_DISK_REQUEST_STRUCTURE);
      AddConstant('IOCTL_DISK_REQUEST_DATA',IOCTL_DISK_REQUEST_DATA);
      AddConstant('IOCTL_DISK_PERFORMANCE_OFF',IOCTL_DISK_PERFORMANCE_OFF);
      AddConstant('IOCTL_DISK_CONTROLLER_NUMBER',IOCTL_DISK_CONTROLLER_NUMBER);
      AddConstant('SMART_GET_VERSION',SMART_GET_VERSION);
      AddConstant('SMART_SEND_DRIVE_COMMAND',SMART_SEND_DRIVE_COMMAND);
      AddConstant('SMART_RCV_DRIVE_DATA',SMART_RCV_DRIVE_DATA);
      AddConstant('IOCTL_DISK_GET_PARTITION_INFO_EX',IOCTL_DISK_GET_PARTITION_INFO_EX);
      AddConstant('IOCTL_DISK_SET_PARTITION_INFO_EX',IOCTL_DISK_SET_PARTITION_INFO_EX);
      AddConstant('IOCTL_DISK_GET_DRIVE_LAYOUT_EX',IOCTL_DISK_GET_DRIVE_LAYOUT_EX);
      AddConstant('IOCTL_DISK_SET_DRIVE_LAYOUT_EX',IOCTL_DISK_SET_DRIVE_LAYOUT_EX);
      AddConstant('IOCTL_DISK_CREATE_DISK',IOCTL_DISK_CREATE_DISK);
      AddConstant('IOCTL_DISK_GET_LENGTH_INFO',IOCTL_DISK_GET_LENGTH_INFO);
      AddConstant('IOCTL_DISK_GET_DRIVE_GEOMETRY_EX',IOCTL_DISK_GET_DRIVE_GEOMETRY_EX);
      AddConstant('IOCTL_DISK_REASSIGN_BLOCKS_EX',IOCTL_DISK_REASSIGN_BLOCKS_EX);
      AddConstant('IOCTL_DISK_UPDATE_DRIVE_SIZE',IOCTL_DISK_UPDATE_DRIVE_SIZE);
      AddConstant('IOCTL_DISK_GROW_PARTITION',IOCTL_DISK_GROW_PARTITION);
      AddConstant('IOCTL_DISK_GET_CACHE_INFORMATION',IOCTL_DISK_GET_CACHE_INFORMATION);
      AddConstant('IOCTL_DISK_SET_CACHE_INFORMATION',IOCTL_DISK_SET_CACHE_INFORMATION);
      AddConstant('IOCTL_DISK_GET_WRITE_CACHE_STATE',IOCTL_DISK_GET_WRITE_CACHE_STATE);
      AddConstant('OBSOLETE_DISK_GET_WRITE_CACHE_STATE',OBSOLETE_DISK_GET_WRITE_CACHE_STATE);
      AddConstant('IOCTL_DISK_DELETE_DRIVE_LAYOUT',IOCTL_DISK_DELETE_DRIVE_LAYOUT);
      AddConstant('IOCTL_DISK_UPDATE_PROPERTIES',IOCTL_DISK_UPDATE_PROPERTIES);
      AddConstant('IOCTL_DISK_FORMAT_DRIVE',IOCTL_DISK_FORMAT_DRIVE);
      AddConstant('IOCTL_DISK_SENSE_DEVICE',IOCTL_DISK_SENSE_DEVICE);
      AddConstant('IOCTL_DISK_CHECK_VERIFY',IOCTL_DISK_CHECK_VERIFY);
      AddConstant('IOCTL_DISK_MEDIA_REMOVAL',IOCTL_DISK_MEDIA_REMOVAL);
      AddConstant('IOCTL_DISK_EJECT_MEDIA',IOCTL_DISK_EJECT_MEDIA);
      AddConstant('IOCTL_DISK_LOAD_MEDIA',IOCTL_DISK_LOAD_MEDIA);
      AddConstant('IOCTL_DISK_RESERVE',IOCTL_DISK_RESERVE);
      AddConstant('IOCTL_DISK_RELEASE',IOCTL_DISK_RELEASE);
      AddConstant('IOCTL_DISK_FIND_NEW_DEVICES',IOCTL_DISK_FIND_NEW_DEVICES);
      AddConstant('IOCTL_DISK_GET_MEDIA_TYPES',IOCTL_DISK_GET_MEDIA_TYPES);
      AddConstant('IOCTL_CHANGER_BASE',IOCTL_CHANGER_BASE);
      AddConstant('IOCTL_CHANGER_GET_PARAMETERS',IOCTL_CHANGER_GET_PARAMETERS);
      AddConstant('IOCTL_CHANGER_GET_STATUS',IOCTL_CHANGER_GET_STATUS);
      AddConstant('IOCTL_CHANGER_GET_PRODUCT_DATA',IOCTL_CHANGER_GET_PRODUCT_DATA);
      AddConstant('IOCTL_CHANGER_SET_ACCESS',IOCTL_CHANGER_SET_ACCESS);
      AddConstant('IOCTL_CHANGER_GET_ELEMENT_STATUS',IOCTL_CHANGER_GET_ELEMENT_STATUS);
      AddConstant('IOCTL_CHANGER_INITIALIZE_ELEMENT_STATUS',IOCTL_CHANGER_INITIALIZE_ELEMENT_STATUS);
      AddConstant('IOCTL_CHANGER_SET_POSITION',IOCTL_CHANGER_SET_POSITION);
      AddConstant('IOCTL_CHANGER_EXCHANGE_MEDIUM',IOCTL_CHANGER_EXCHANGE_MEDIUM);
      AddConstant('IOCTL_CHANGER_MOVE_MEDIUM',IOCTL_CHANGER_MOVE_MEDIUM);
      AddConstant('IOCTL_CHANGER_REINITIALIZE_TRANSPORT',IOCTL_CHANGER_REINITIALIZE_TRANSPORT);
      AddConstant('IOCTL_CHANGER_QUERY_VOLUME_TAGS',IOCTL_CHANGER_QUERY_VOLUME_TAGS);
      AddConstant('IOCTL_SERIAL_LSRMST_INSERT',IOCTL_SERIAL_LSRMST_INSERT);
      AddConstant('IOCTL_SERENUM_EXPOSE_HARDWARE',IOCTL_SERENUM_EXPOSE_HARDWARE);
      AddConstant('IOCTL_SERENUM_REMOVE_HARDWARE',IOCTL_SERENUM_REMOVE_HARDWARE);
      AddConstant('IOCTL_SERENUM_PORT_DESC',IOCTL_SERENUM_PORT_DESC);
      AddConstant('IOCTL_SERENUM_GET_PORT_NAME',IOCTL_SERENUM_GET_PORT_NAME);
      AddConstant('FSCTL_REQUEST_OPLOCK_LEVEL_1',FSCTL_REQUEST_OPLOCK_LEVEL_1);
      AddConstant('FSCTL_REQUEST_OPLOCK_LEVEL_2',FSCTL_REQUEST_OPLOCK_LEVEL_2);
      AddConstant('FSCTL_REQUEST_BATCH_OPLOCK',FSCTL_REQUEST_BATCH_OPLOCK);
      AddConstant('FSCTL_OPLOCK_BREAK_ACKNOWLEDGE',FSCTL_OPLOCK_BREAK_ACKNOWLEDGE);
      AddConstant('FSCTL_OPBATCH_ACK_CLOSE_PENDING',FSCTL_OPBATCH_ACK_CLOSE_PENDING);
      AddConstant('FSCTL_OPLOCK_BREAK_NOTIFY',FSCTL_OPLOCK_BREAK_NOTIFY);
      AddConstant('FSCTL_LOCK_VOLUME',FSCTL_LOCK_VOLUME);
      AddConstant('FSCTL_UNLOCK_VOLUME',FSCTL_UNLOCK_VOLUME);
      AddConstant('FSCTL_DISMOUNT_VOLUME',FSCTL_DISMOUNT_VOLUME);
      AddConstant('FSCTL_IS_VOLUME_MOUNTED',FSCTL_IS_VOLUME_MOUNTED);
      AddConstant('FSCTL_IS_PATHNAME_VALID',FSCTL_IS_PATHNAME_VALID);
      AddConstant('FSCTL_MARK_VOLUME_DIRTY',FSCTL_MARK_VOLUME_DIRTY);
      AddConstant('FSCTL_QUERY_RETRIEVAL_POINTERS',FSCTL_QUERY_RETRIEVAL_POINTERS);
      AddConstant('FSCTL_GET_COMPRESSION',FSCTL_GET_COMPRESSION);
      AddConstant('FSCTL_SET_COMPRESSION',FSCTL_SET_COMPRESSION);
      AddConstant('FSCTL_SET_BOOTLOADER_ACCESSED',FSCTL_SET_BOOTLOADER_ACCESSED);
      AddConstant('FSCTL_OPLOCK_BREAK_ACK_NO_2',FSCTL_OPLOCK_BREAK_ACK_NO_2);
      AddConstant('FSCTL_INVALIDATE_VOLUMES',FSCTL_INVALIDATE_VOLUMES);
      AddConstant('FSCTL_QUERY_FAT_BPB',FSCTL_QUERY_FAT_BPB);
      AddConstant('FSCTL_REQUEST_FILTER_OPLOCK',FSCTL_REQUEST_FILTER_OPLOCK);
      AddConstant('FSCTL_FILESYSTEM_GET_STATISTICS',FSCTL_FILESYSTEM_GET_STATISTICS);
    end;
  end;
  ...
  begin
    With Scripter.DefineClass(ClassType) do
    begin
      AddConstant('FSCTL_GET_NTFS_VOLUME_DATA',FSCTL_GET_NTFS_VOLUME_DATA);
      AddConstant('FSCTL_GET_NTFS_FILE_RECORD',FSCTL_GET_NTFS_FILE_RECORD);
      AddConstant('FSCTL_GET_VOLUME_BITMAP',FSCTL_GET_VOLUME_BITMAP);
      AddConstant('FSCTL_GET_RETRIEVAL_POINTERS',FSCTL_GET_RETRIEVAL_POINTERS);
      AddConstant('FSCTL_MOVE_FILE',FSCTL_MOVE_FILE);
      AddConstant('FSCTL_IS_VOLUME_DIRTY',FSCTL_IS_VOLUME_DIRTY);
      AddConstant('FSCTL_ALLOW_EXTENDED_DASD_IO',FSCTL_ALLOW_EXTENDED_DASD_IO);
      AddConstant('FSCTL_FIND_FILES_BY_SID',FSCTL_FIND_FILES_BY_SID);
      AddConstant('FSCTL_SET_OBJECT_ID',FSCTL_SET_OBJECT_ID);
      AddConstant('FSCTL_GET_OBJECT_ID',FSCTL_GET_OBJECT_ID);
      AddConstant('FSCTL_DELETE_OBJECT_ID',FSCTL_DELETE_OBJECT_ID);
      AddConstant('FSCTL_SET_REPARSE_POINT',FSCTL_SET_REPARSE_POINT);
      AddConstant('FSCTL_GET_REPARSE_POINT',FSCTL_GET_REPARSE_POINT);
      AddConstant('FSCTL_DELETE_REPARSE_POINT',FSCTL_DELETE_REPARSE_POINT);
      AddConstant('FSCTL_ENUM_USN_DATA',FSCTL_ENUM_USN_DATA);
      AddConstant('FSCTL_SECURITY_ID_CHECK',FSCTL_SECURITY_ID_CHECK);
      AddConstant('FSCTL_READ_USN_JOURNAL',FSCTL_READ_USN_JOURNAL);
      AddConstant('FSCTL_SET_OBJECT_ID_EXTENDED',FSCTL_SET_OBJECT_ID_EXTENDED);
      AddConstant('FSCTL_CREATE_OR_GET_OBJECT_ID',FSCTL_CREATE_OR_GET_OBJECT_ID);
      AddConstant('FSCTL_SET_SPARSE',FSCTL_SET_SPARSE);
      AddConstant('FSCTL_SET_ZERO_DATA',FSCTL_SET_ZERO_DATA);
      AddConstant('FSCTL_QUERY_ALLOCATED_RANGES',FSCTL_QUERY_ALLOCATED_RANGES);
      AddConstant('FSCTL_ENABLE_UPGRADE',FSCTL_ENABLE_UPGRADE);
      AddConstant('FSCTL_SET_ENCRYPTION',FSCTL_SET_ENCRYPTION);
      AddConstant('FSCTL_ENCRYPTION_FSCTL_IO',FSCTL_ENCRYPTION_FSCTL_IO);
      AddConstant('FSCTL_WRITE_RAW_ENCRYPTED',FSCTL_WRITE_RAW_ENCRYPTED);
      AddConstant('FSCTL_READ_RAW_ENCRYPTED',FSCTL_READ_RAW_ENCRYPTED);
      AddConstant('FSCTL_CREATE_USN_JOURNAL',FSCTL_CREATE_USN_JOURNAL);
      AddConstant('FSCTL_READ_FILE_USN_DATA',FSCTL_READ_FILE_USN_DATA);
      AddConstant('FSCTL_WRITE_USN_CLOSE_RECORD',FSCTL_WRITE_USN_CLOSE_RECORD);
      AddConstant('FSCTL_EXTEND_VOLUME',FSCTL_EXTEND_VOLUME);
      AddConstant('FSCTL_QUERY_USN_JOURNAL',FSCTL_QUERY_USN_JOURNAL);
      AddConstant('FSCTL_DELETE_USN_JOURNAL',FSCTL_DELETE_USN_JOURNAL);
      AddConstant('FSCTL_MARK_HANDLE',FSCTL_MARK_HANDLE);
      AddConstant('FSCTL_SIS_COPYFILE',FSCTL_SIS_COPYFILE);
      AddConstant('FSCTL_SIS_LINK_FILES',FSCTL_SIS_LINK_FILES);
      AddConstant('FSCTL_RECALL_FILE',FSCTL_RECALL_FILE);
      AddConstant('FSCTL_READ_FROM_PLEX',FSCTL_READ_FROM_PLEX);
      AddConstant('FSCTL_FILE_PREFETCH',FSCTL_FILE_PREFETCH);
      AddConstant('FSCTL_MAKE_MEDIA_COMPATIBLE',FSCTL_MAKE_MEDIA_COMPATIBLE);
      AddConstant('FSCTL_SET_DEFECT_MANAGEMENT',FSCTL_SET_DEFECT_MANAGEMENT);
      AddConstant('FSCTL_QUERY_SPARING_INFO',FSCTL_QUERY_SPARING_INFO);
      AddConstant('FSCTL_QUERY_ON_DISK_VOLUME_INFO',FSCTL_QUERY_ON_DISK_VOLUME_INFO);
      AddConstant('FSCTL_SET_VOLUME_COMPRESSION_STATE',FSCTL_SET_VOLUME_COMPRESSION_STATE);
      AddConstant('FSCTL_TXFS_MODIFY_RM',FSCTL_TXFS_MODIFY_RM);
      AddConstant('FSCTL_TXFS_QUERY_RM_INFORMATION',FSCTL_TXFS_QUERY_RM_INFORMATION);
      AddConstant('FSCTL_TXFS_ROLLFORWARD_REDO',FSCTL_TXFS_ROLLFORWARD_REDO);
      AddConstant('FSCTL_TXFS_ROLLFORWARD_UNDO',FSCTL_TXFS_ROLLFORWARD_UNDO);
      AddConstant('FSCTL_TXFS_START_RM',FSCTL_TXFS_START_RM);
      AddConstant('FSCTL_TXFS_SHUTDOWN_RM',FSCTL_TXFS_SHUTDOWN_RM);
      AddConstant('FSCTL_TXFS_READ_BACKUP_INFORMATION',FSCTL_TXFS_READ_BACKUP_INFORMATION);
      AddConstant('FSCTL_TXFS_WRITE_BACKUP_INFORMATION',FSCTL_TXFS_WRITE_BACKUP_INFORMATION);
      AddConstant('FSCTL_TXFS_CREATE_SECONDARY_RM',FSCTL_TXFS_CREATE_SECONDARY_RM);
      AddConstant('FSCTL_TXFS_GET_METADATA_INFO',FSCTL_TXFS_GET_METADATA_INFO);
      AddConstant('FSCTL_TXFS_GET_TRANSACTED_VERSION',FSCTL_TXFS_GET_TRANSACTED_VERSION);
      AddConstant('FSCTL_TXFS_SAVEPOINT_INFORMATION',FSCTL_TXFS_SAVEPOINT_INFORMATION);
      AddConstant('FSCTL_TXFS_CREATE_MINIVERSION',FSCTL_TXFS_CREATE_MINIVERSION);
      AddConstant('FSCTL_TXFS_TRANSACTION_ACTIVE',FSCTL_TXFS_TRANSACTION_ACTIVE);
      AddConstant('FSCTL_SET_ZERO_ON_DEALLOCATION',FSCTL_SET_ZERO_ON_DEALLOCATION);
      AddConstant('FSCTL_SET_REPAIR',FSCTL_SET_REPAIR);
      AddConstant('FSCTL_GET_REPAIR',FSCTL_GET_REPAIR);
      AddConstant('FSCTL_WAIT_FOR_REPAIR',FSCTL_WAIT_FOR_REPAIR);
      AddConstant('FSCTL_INITIATE_REPAIR',FSCTL_INITIATE_REPAIR);
      AddConstant('FSCTL_CSC_INTERNAL',FSCTL_CSC_INTERNAL);
      AddConstant('FSCTL_SHRINK_VOLUME',FSCTL_SHRINK_VOLUME);
      AddConstant('FSCTL_SET_SHORT_NAME_BEHAVIOR',FSCTL_SET_SHORT_NAME_BEHAVIOR);
      AddConstant('FSCTL_DFSR_SET_GHOST_HANDLE_STATE',FSCTL_DFSR_SET_GHOST_HANDLE_STATE);
      AddConstant('FSCTL_TXFS_LIST_TRANSACTION_LOCKED_FILES',FSCTL_TXFS_LIST_TRANSACTION_LOCKED_FILES);
      AddConstant('FSCTL_TXFS_LIST_TRANSACTIONS',FSCTL_TXFS_LIST_TRANSACTIONS);
      AddConstant('FSCTL_QUERY_PAGEFILE_ENCRYPTION',FSCTL_QUERY_PAGEFILE_ENCRYPTION);
      AddConstant('FSCTL_RESET_VOLUME_ALLOCATION_HINTS',FSCTL_RESET_VOLUME_ALLOCATION_HINTS);
      AddConstant('FSCTL_QUERY_DEPENDENT_VOLUME',FSCTL_QUERY_DEPENDENT_VOLUME);
      AddConstant('FSCTL_SD_GLOBAL_CHANGE',FSCTL_SD_GLOBAL_CHANGE);
      AddConstant('FSCTL_TXFS_READ_BACKUP_INFORMATION2',FSCTL_TXFS_READ_BACKUP_INFORMATION2);
      AddConstant('FSCTL_LOOKUP_STREAM_FROM_CLUSTER',FSCTL_LOOKUP_STREAM_FROM_CLUSTER);
      AddConstant('FSCTL_TXFS_WRITE_BACKUP_INFORMATION2',FSCTL_TXFS_WRITE_BACKUP_INFORMATION2);
      AddConstant('FSCTL_FILE_TYPE_NOTIFICATION',FSCTL_FILE_TYPE_NOTIFICATION);
      AddConstant('FSCTL_GET_BOOT_AREA_INFO',FSCTL_GET_BOOT_AREA_INFO);
      AddConstant('FSCTL_GET_RETRIEVAL_POINTER_BASE',FSCTL_GET_RETRIEVAL_POINTER_BASE);
      AddConstant('FSCTL_SET_PERSISTENT_VOLUME_STATE',FSCTL_SET_PERSISTENT_VOLUME_STATE);
      AddConstant('FSCTL_QUERY_PERSISTENT_VOLUME_STATE',FSCTL_QUERY_PERSISTENT_VOLUME_STATE);
      AddConstant('FSCTL_REQUEST_OPLOCK',FSCTL_REQUEST_OPLOCK);
      AddConstant('FSCTL_CSV_TUNNEL_REQUEST',FSCTL_CSV_TUNNEL_REQUEST);
      AddConstant('FSCTL_IS_CSV_FILE',FSCTL_IS_CSV_FILE);
      AddConstant('FSCTL_QUERY_FILE_SYSTEM_RECOGNITION',FSCTL_QUERY_FILE_SYSTEM_RECOGNITION);
      AddConstant('FSCTL_CSV_GET_VOLUME_PATH_NAME',FSCTL_CSV_GET_VOLUME_PATH_NAME);
      AddConstant('FSCTL_CSV_GET_VOLUME_NAME_FOR_VOLUME_MOUNT_POINT',FSCTL_CSV_GET_VOLUME_NAME_FOR_VOLUME_MOUNT_POINT);
      AddConstant('FSCTL_CSV_GET_VOLUME_PATH_NAMES_FOR_VOLUME_NAME',FSCTL_CSV_GET_VOLUME_PATH_NAMES_FOR_VOLUME_NAME);
      AddConstant('FSCTL_IS_FILE_ON_CSV_VOLUME',FSCTL_IS_FILE_ON_CSV_VOLUME);
      AddConstant('FSCTL_MARK_AS_SYSTEM_HIVE',FSCTL_MARK_AS_SYSTEM_HIVE);
      AddConstant('IOCTL_VOLUME_BASE',IOCTL_VOLUME_BASE);
      AddConstant('IOCTL_VOLUME_GET_VOLUME_DISK_EXTENTS',IOCTL_VOLUME_GET_VOLUME_DISK_EXTENTS);
      AddConstant('IOCTL_VOLUME_ONLINE',IOCTL_VOLUME_ONLINE);
      AddConstant('IOCTL_VOLUME_OFFLINE',IOCTL_VOLUME_OFFLINE);
      AddConstant('IOCTL_VOLUME_IS_CLUSTERED',IOCTL_VOLUME_IS_CLUSTERED);
      AddConstant('IOCTL_VOLUME_GET_GPT_ATTRIBUTES',IOCTL_VOLUME_GET_GPT_ATTRIBUTES);
      AddConstant('IOCTL_BATTERY_QUERY_TAG',IOCTL_BATTERY_QUERY_TAG);
      AddConstant('IOCTL_BATTERY_QUERY_INFORMATION',IOCTL_BATTERY_QUERY_INFORMATION);
      AddConstant('IOCTL_BATTERY_QUERY_STATUS',IOCTL_BATTERY_QUERY_STATUS);
      AddConstant('IOCTL_BATTERY_SET_INFORMATION',IOCTL_BATTERY_SET_INFORMATION);
      AddConstant('IS_TEXT_UNICODE_ASCII16',IS_TEXT_UNICODE_ASCII16);
      AddConstant('IS_TEXT_UNICODE_REVERSE_ASCII16',IS_TEXT_UNICODE_REVERSE_ASCII16);
      AddConstant('IS_TEXT_UNICODE_STATISTICS',IS_TEXT_UNICODE_STATISTICS);
      AddConstant('IS_TEXT_UNICODE_REVERSE_STATISTICS',IS_TEXT_UNICODE_REVERSE_STATISTICS);
      AddConstant('IS_TEXT_UNICODE_CONTROLS',IS_TEXT_UNICODE_CONTROLS);
      AddConstant('IS_TEXT_UNICODE_REVERSE_CONTROLS',IS_TEXT_UNICODE_REVERSE_CONTROLS);
      AddConstant('IS_TEXT_UNICODE_SIGNATURE',IS_TEXT_UNICODE_SIGNATURE);
      AddConstant('IS_TEXT_UNICODE_REVERSE_SIGNATURE',IS_TEXT_UNICODE_REVERSE_SIGNATURE);
      AddConstant('IS_TEXT_UNICODE_ILLEGAL_CHARS',IS_TEXT_UNICODE_ILLEGAL_CHARS);
      AddConstant('IS_TEXT_UNICODE_ODD_LENGTH',IS_TEXT_UNICODE_ODD_LENGTH);
      AddConstant('IS_TEXT_UNICODE_DBCS_LEADBYTE',IS_TEXT_UNICODE_DBCS_LEADBYTE);
      AddConstant('IS_TEXT_UNICODE_NULL_BYTES',IS_TEXT_UNICODE_NULL_BYTES);
      AddConstant('IS_TEXT_UNICODE_UNICODE_MASK',IS_TEXT_UNICODE_UNICODE_MASK);
      AddConstant('IS_TEXT_UNICODE_REVERSE_MASK',IS_TEXT_UNICODE_REVERSE_MASK);
      AddConstant('IS_TEXT_UNICODE_NOT_UNICODE_MASK',IS_TEXT_UNICODE_NOT_UNICODE_MASK);
      AddConstant('IS_TEXT_UNICODE_NOT_ASCII_MASK',IS_TEXT_UNICODE_NOT_ASCII_MASK);
      AddConstant('SYMBOLIC_LINK_FLAG_DIRECTORY',SYMBOLIC_LINK_FLAG_DIRECTORY);
      AddConstant('VOLUME_NAME_DOS',VOLUME_NAME_DOS);
      AddConstant('VOLUME_NAME_GUID',VOLUME_NAME_GUID);
      AddConstant('VOLUME_NAME_NT',VOLUME_NAME_NT);
      AddConstant('VOLUME_NAME_NONE',VOLUME_NAME_NONE);
      AddConstant('FILE_NAME_NORMALIZED',FILE_NAME_NORMALIZED);
      AddConstant('FILE_NAME_OPENED',FILE_NAME_OPENED);
      AddConstant('VER_PLATFORM_WIN32_CE',VER_PLATFORM_WIN32_CE);
      AddConstant('VER_BUILDNUMBER',VER_BUILDNUMBER);
      AddConstant('VER_MAJORVERSION',VER_MAJORVERSION);
      AddConstant('VER_MINORVERSION',VER_MINORVERSION);
      AddConstant('VER_PLATFORMID',VER_PLATFORMID);
      AddConstant('VER_SERVICEPACKMAJOR',VER_SERVICEPACKMAJOR);
      AddConstant('VER_SERVICEPACKMINOR',VER_SERVICEPACKMINOR);
      AddConstant('VER_SUITENAME',VER_SUITENAME);
      AddConstant('VER_PRODUCT_TYPE',VER_PRODUCT_TYPE);
      AddConstant('RPC_E_NO_CONTEXT',RPC_E_NO_CONTEXT);
      AddConstant('RPC_E_TIMEOUT',RPC_E_TIMEOUT);
      AddConstant('CERT_E_VALIDITYPERIODNESTING',CERT_E_VALIDITYPERIODNESTING);
      AddConstant('TRUST_E_FAIL',TRUST_E_FAIL);
      AddConstant('CERT_E_REVOKED',CERT_E_REVOKED);
      AddConstant('CERT_E_UNTRUSTEDTESTROOT',CERT_E_UNTRUSTEDTESTROOT);
      AddConstant('CERT_E_REVOCATION_FAILURE',CERT_E_REVOCATION_FAILURE);
      AddConstant('CERT_E_CN_NO_MATCH',CERT_E_CN_NO_MATCH);
      AddConstant('CERT_E_WRONG_USAGE',CERT_E_WRONG_USAGE);
      AddConstant('TRUST_E_EXPLICIT_DISTRUST',TRUST_E_EXPLICIT_DISTRUST);
      AddConstant('CERT_E_UNTRUSTEDCA',CERT_E_UNTRUSTEDCA);
      AddConstant('CERT_E_INVALID_POLICY',CERT_E_INVALID_POLICY);
      AddConstant('CERT_E_INVALID_NAME',CERT_E_INVALID_NAME);
      AddConstant('SYSRGN',SYSRGN);
      AddConstant('CLEARTYPE_QUALITY',CLEARTYPE_QUALITY);
      AddConstant('CLEARTYPE_NATURAL_QUALITY',CLEARTYPE_NATURAL_QUALITY);
      AddConstant('DC_STAPLE',DC_STAPLE);
      AddConstant('DC_PRINTRATEPPM',DC_PRINTRATEPPM);
      AddConstant('DC_MEDIATYPENAMES',DC_MEDIATYPENAMES);
      AddConstant('DC_MEDIATYPES',DC_MEDIATYPES);
      ...
      AddConstant('WH_KEYBOARD_LL',WH_KEYBOARD_LL);
      AddConstant('WH_MOUSE_LL',WH_MOUSE_LL);
  ...
  begin
    ...
    begin
      ...
      AddConstant('APPCOMMAND_BROWSER_BACKWARD',APPCOMMAND_BROWSER_BACKWARD);
      AddConstant('APPCOMMAND_BROWSER_FORWARD',APPCOMMAND_BROWSER_FORWARD);
      AddConstant('APPCOMMAND_BROWSER_REFRESH',APPCOMMAND_BROWSER_REFRESH);
      AddConstant('APPCOMMAND_BROWSER_STOP',APPCOMMAND_BROWSER_STOP);
      AddConstant('APPCOMMAND_BROWSER_SEARCH',APPCOMMAND_BROWSER_SEARCH);
      AddConstant('APPCOMMAND_BROWSER_FAVORITES',APPCOMMAND_BROWSER_FAVORITES);
      AddConstant('APPCOMMAND_BROWSER_HOME',APPCOMMAND_BROWSER_HOME);
      AddConstant('APPCOMMAND_VOLUME_MUTE',APPCOMMAND_VOLUME_MUTE);
      AddConstant('APPCOMMAND_VOLUME_DOWN',APPCOMMAND_VOLUME_DOWN);
      AddConstant('APPCOMMAND_VOLUME_UP',APPCOMMAND_VOLUME_UP);
      AddConstant('APPCOMMAND_MEDIA_NEXTTRACK',APPCOMMAND_MEDIA_NEXTTRACK);
      AddConstant('APPCOMMAND_MEDIA_PREVIOUSTRACK',APPCOMMAND_MEDIA_PREVIOUSTRACK);
      AddConstant('APPCOMMAND_MEDIA_STOP',APPCOMMAND_MEDIA_STOP);
      AddConstant('APPCOMMAND_MEDIA_PLAY_PAUSE',APPCOMMAND_MEDIA_PLAY_PAUSE);
      AddConstant('APPCOMMAND_LAUNCH_MAIL',APPCOMMAND_LAUNCH_MAIL);
      AddConstant('APPCOMMAND_LAUNCH_MEDIA_SELECT',APPCOMMAND_LAUNCH_MEDIA_SELECT);
      AddConstant('APPCOMMAND_LAUNCH_APP1',APPCOMMAND_LAUNCH_APP1);
      AddConstant('APPCOMMAND_LAUNCH_APP2',APPCOMMAND_LAUNCH_APP2);
      AddConstant('APPCOMMAND_BASS_DOWN',APPCOMMAND_BASS_DOWN);
      AddConstant('APPCOMMAND_BASS_BOOST',APPCOMMAND_BASS_BOOST);
      AddConstant('APPCOMMAND_BASS_UP',APPCOMMAND_BASS_UP);
      AddConstant('APPCOMMAND_TREBLE_DOWN',APPCOMMAND_TREBLE_DOWN);
      AddConstant('APPCOMMAND_TREBLE_UP',APPCOMMAND_TREBLE_UP);
      AddConstant('APPCOMMAND_MICROPHONE_VOLUME_MUTE',APPCOMMAND_MICROPHONE_VOLUME_MUTE);
      AddConstant('APPCOMMAND_MICROPHONE_VOLUME_DOWN',APPCOMMAND_MICROPHONE_VOLUME_DOWN);
      AddConstant('APPCOMMAND_MICROPHONE_VOLUME_UP',APPCOMMAND_MICROPHONE_VOLUME_UP);
      AddConstant('APPCOMMAND_HELP',APPCOMMAND_HELP);
      AddConstant('APPCOMMAND_FIND',APPCOMMAND_FIND);
      AddConstant('APPCOMMAND_NEW',APPCOMMAND_NEW);
      AddConstant('APPCOMMAND_OPEN',APPCOMMAND_OPEN);
      AddConstant('APPCOMMAND_CLOSE',APPCOMMAND_CLOSE);
      AddConstant('APPCOMMAND_SAVE',APPCOMMAND_SAVE);
      AddConstant('APPCOMMAND_PRINT',APPCOMMAND_PRINT);
      AddConstant('APPCOMMAND_UNDO',APPCOMMAND_UNDO);
      AddConstant('APPCOMMAND_REDO',APPCOMMAND_REDO);
      AddConstant('APPCOMMAND_COPY',APPCOMMAND_COPY);
      AddConstant('APPCOMMAND_CUT',APPCOMMAND_CUT);
      AddConstant('APPCOMMAND_PASTE',APPCOMMAND_PASTE);
      AddConstant('APPCOMMAND_REPLY_TO_MAIL',APPCOMMAND_REPLY_TO_MAIL);
      AddConstant('APPCOMMAND_FORWARD_MAIL',APPCOMMAND_FORWARD_MAIL);
      AddConstant('APPCOMMAND_SEND_MAIL',APPCOMMAND_SEND_MAIL);
      AddConstant('APPCOMMAND_SPELL_CHECK',APPCOMMAND_SPELL_CHECK);
      AddConstant('APPCOMMAND_DICTATE_OR_COMMAND_CONTROL_TOGGLE',APPCOMMAND_DICTATE_OR_COMMAND_CONTROL_TOGGLE);
      AddConstant('APPCOMMAND_MIC_ON_OFF_TOGGLE',APPCOMMAND_MIC_ON_OFF_TOGGLE);
      AddConstant('APPCOMMAND_CORRECTION_LIST',APPCOMMAND_CORRECTION_LIST);
      AddConstant('APPCOMMAND_MEDIA_PLAY',APPCOMMAND_MEDIA_PLAY);
      AddConstant('APPCOMMAND_MEDIA_PAUSE',APPCOMMAND_MEDIA_PAUSE);
      AddConstant('APPCOMMAND_MEDIA_RECORD',APPCOMMAND_MEDIA_RECORD);
      AddConstant('APPCOMMAND_MEDIA_FAST_FORWARD',APPCOMMAND_MEDIA_FAST_FORWARD);
      AddConstant('APPCOMMAND_MEDIA_REWIND',APPCOMMAND_MEDIA_REWIND);
      AddConstant('APPCOMMAND_MEDIA_CHANNEL_UP',APPCOMMAND_MEDIA_CHANNEL_UP);
      AddConstant('APPCOMMAND_MEDIA_CHANNEL_DOWN',APPCOMMAND_MEDIA_CHANNEL_DOWN);
      AddConstant('APPCOMMAND_DELETE',APPCOMMAND_DELETE);
      AddConstant('APPCOMMAND_DWM_FLIP3D',APPCOMMAND_DWM_FLIP3D);
      AddConstant('FAPPCOMMAND_MOUSE',FAPPCOMMAND_MOUSE);
      AddConstant('FAPPCOMMAND_KEY',FAPPCOMMAND_KEY);
      AddConstant('FAPPCOMMAND_OEM',FAPPCOMMAND_OEM);
      AddConstant('FAPPCOMMAND_MASK',FAPPCOMMAND_MASK);
      AddConstant('UOI_HEAPSIZE',UOI_HEAPSIZE);
      AddConstant('UOI_IO',UOI_IO);
      ...
      AddConstant('PBT_POWERSETTINGCHANGE',PBT_POWERSETTINGCHANGE);
      AddConstant('SMTO_ERRORONEXIT',SMTO_ERRORONEXIT);
      AddConstant('ICON_SMALL2',ICON_SMALL2);
      AddConstant('TME_NONCLIENT',TME_NONCLIENT);
      ...
      AddConstant('CF_DIBV5',CF_DIBV5);
      AddConstant('CF_MAX_XP',CF_MAX_XP);
      AddConstant('MOD_NOREPEAT',MOD_NOREPEAT);
      AddConstant('ENDSESSION_CRITICAL',ENDSESSION_CRITICAL);
      AddConstant('ENDSESSION_CLOSEAPP',ENDSESSION_CLOSEAPP);
      AddConstant('EWX_QUICKRESOLVE',EWX_QUICKRESOLVE);
      AddConstant('EWX_RESTARTAPPS',EWX_RESTARTAPPS);
      ...
      AddConstant('WDA_NONE',WDA_NONE);
      AddConstant('WDA_MONITOR',WDA_MONITOR);
      AddConstant('KEYEVENTF_UNICODE',KEYEVENTF_UNICODE);
      AddConstant('KEYEVENTF_SCANCODE',KEYEVENTF_SCANCODE);
      AddConstant('MOUSEEVENTF_HWHEEL',MOUSEEVENTF_HWHEEL);
      AddConstant('MOUSEEVENTF_MOVE_NOCOALESCE',MOUSEEVENTF_MOVE_NOCOALESCE);
      AddConstant('TOUCHEVENTF_MOVE',TOUCHEVENTF_MOVE);
      AddConstant('TOUCHEVENTF_DOWN',TOUCHEVENTF_DOWN);
      AddConstant('TOUCHEVENTF_UP',TOUCHEVENTF_UP);
      AddConstant('TOUCHEVENTF_INRANGE',TOUCHEVENTF_INRANGE);
      AddConstant('TOUCHEVENTF_PRIMARY',TOUCHEVENTF_PRIMARY);
      AddConstant('TOUCHEVENTF_NOCOALESCE',TOUCHEVENTF_NOCOALESCE);
      AddConstant('TOUCHEVENTF_PEN',TOUCHEVENTF_PEN);
      AddConstant('TOUCHEVENTF_PALM',TOUCHEVENTF_PALM);
      AddConstant('TOUCHINPUTMASKF_TIMEFROMSYSTEM',TOUCHINPUTMASKF_TIMEFROMSYSTEM);
      AddConstant('TOUCHINPUTMASKF_EXTRAINFO',TOUCHINPUTMASKF_EXTRAINFO);
      AddConstant('TOUCHINPUTMASKF_CONTACTAREA',TOUCHINPUTMASKF_CONTACTAREA);
      AddConstant('TWF_FINETOUCH',TWF_FINETOUCH);
      AddConstant('TWF_WANTPALM',TWF_WANTPALM);
      AddConstant('MAPVK_VK_TO_VSC',MAPVK_VK_TO_VSC);
      AddConstant('MAPVK_VSC_TO_VK',MAPVK_VSC_TO_VK);
      AddConstant('MAPVK_VK_TO_CHAR',MAPVK_VK_TO_CHAR);
      AddConstant('MAPVK_VSC_TO_VK_EX',MAPVK_VSC_TO_VK_EX);
      AddConstant('MAPVK_VK_TO_VSC_EX',MAPVK_VK_TO_VSC_EX);
      ...
      AddConstant('SM_TABLETPC',SM_TABLETPC);
      AddConstant('SM_MEDIACENTER',SM_MEDIACENTER);
      AddConstant('SM_STARTER',SM_STARTER);
      AddConstant('SM_SERVERR2',SM_SERVERR2);
      AddConstant('SM_MOUSEHORIZONTALWHEELPRESENT',SM_MOUSEHORIZONTALWHEELPRESENT);
      AddConstant('SM_CXPADDEDBORDER',SM_CXPADDEDBORDER);
      AddConstant('SM_DIGITIZER',SM_DIGITIZER);
      AddConstant('SM_MAXIMUMTOUCHES',SM_MAXIMUMTOUCHES);
      AddConstant('SM_REMOTESESSION',SM_REMOTESESSION);
      AddConstant('SM_SHUTTINGDOWN',SM_SHUTTINGDOWN);
      AddConstant('SM_REMOTECONTROL',SM_REMOTECONTROL);
      AddConstant('SM_CARETBLINKINGENABLED',SM_CARETBLINKINGENABLED);
      AddConstant('TPM_LAYOUTRTL',TPM_LAYOUTRTL);
      AddConstant('TPM_WORKAREA',TPM_WORKAREA);
      AddConstant('COLOR_MENUHILIGHT',COLOR_MENUHILIGHT);
      AddConstant('COLOR_MENUBAR',COLOR_MENUBAR);
      AddConstant('SCF_ISSECURE',SCF_ISSECURE);
      AddConstant('OIC_SHIELD',OIC_SHIELD);
      ...
      AddConstant('GR_GDIOBJECTS_PEAK',GR_GDIOBJECTS_PEAK);
      AddConstant('GR_USEROBJECTS_PEAK',GR_USEROBJECTS_PEAK);
      AddConstant('GR_GLOBAL',GR_GLOBAL);
      AddConstant('SPI_SETSCREENSAVERRUNNING',SPI_SETSCREENSAVERRUNNING);
      AddConstant('SPI_GETMENUSHOWDELAY',SPI_GETMENUSHOWDELAY);
      AddConstant('SPI_SETMENUSHOWDELAY',SPI_SETMENUSHOWDELAY);
      AddConstant('SPI_GETWHEELSCROLLCHARS',SPI_GETWHEELSCROLLCHARS);
      AddConstant('SPI_SETWHEELSCROLLCHARS',SPI_SETWHEELSCROLLCHARS);
      AddConstant('SPI_GETDESKWALLPAPER',SPI_GETDESKWALLPAPER);
      AddConstant('SPI_GETAUDIODESCRIPTION',SPI_GETAUDIODESCRIPTION);
    end;
  end;

  procedure AddConsts4;
  begin
    With Scripter.DefineClass(ClassType) do
    begin
      AddConstant('SPI_SETAUDIODESCRIPTION',SPI_SETAUDIODESCRIPTION);
      AddConstant('SPI_GETSCREENSAVESECURE',SPI_GETSCREENSAVESECURE);
      AddConstant('SPI_SETSCREENSAVESECURE',SPI_SETSCREENSAVESECURE);
      AddConstant('SPI_GETHUNGAPPTIMEOUT',SPI_GETHUNGAPPTIMEOUT);
      AddConstant('SPI_SETHUNGAPPTIMEOUT',SPI_SETHUNGAPPTIMEOUT);
      AddConstant('SPI_GETWAITTOKILLTIMEOUT',SPI_GETWAITTOKILLTIMEOUT);
      AddConstant('SPI_SETWAITTOKILLTIMEOUT',SPI_SETWAITTOKILLTIMEOUT);
      AddConstant('SPI_GETWAITTOKILLSERVICETIMEOUT',SPI_GETWAITTOKILLSERVICETIMEOUT);
      AddConstant('SPI_SETWAITTOKILLSERVICETIMEOUT',SPI_SETWAITTOKILLSERVICETIMEOUT);
      AddConstant('SPI_GETMOUSEDOCKTHRESHOLD',SPI_GETMOUSEDOCKTHRESHOLD);
      AddConstant('SPI_SETMOUSEDOCKTHRESHOLD',SPI_SETMOUSEDOCKTHRESHOLD);
      AddConstant('SPI_GETPENDOCKTHRESHOLD',SPI_GETPENDOCKTHRESHOLD);
      AddConstant('SPI_SETPENDOCKTHRESHOLD',SPI_SETPENDOCKTHRESHOLD);
      AddConstant('SPI_GETWINARRANGING',SPI_GETWINARRANGING);
      AddConstant('SPI_SETWINARRANGING',SPI_SETWINARRANGING);
      AddConstant('SPI_GETMOUSEDRAGOUTTHRESHOLD',SPI_GETMOUSEDRAGOUTTHRESHOLD);
      AddConstant('SPI_SETMOUSEDRAGOUTTHRESHOLD',SPI_SETMOUSEDRAGOUTTHRESHOLD);
      AddConstant('SPI_GETPENDRAGOUTTHRESHOLD',SPI_GETPENDRAGOUTTHRESHOLD);
      AddConstant('SPI_SETPENDRAGOUTTHRESHOLD',SPI_SETPENDRAGOUTTHRESHOLD);
      AddConstant('SPI_GETMOUSESIDEMOVETHRESHOLD',SPI_GETMOUSESIDEMOVETHRESHOLD);
      AddConstant('SPI_SETMOUSESIDEMOVETHRESHOLD',SPI_SETMOUSESIDEMOVETHRESHOLD);
      AddConstant('SPI_GETPENSIDEMOVETHRESHOLD',SPI_GETPENSIDEMOVETHRESHOLD);
      AddConstant('SPI_SETPENSIDEMOVETHRESHOLD',SPI_SETPENSIDEMOVETHRESHOLD);
      AddConstant('SPI_GETDRAGFROMMAXIMIZE',SPI_GETDRAGFROMMAXIMIZE);
      AddConstant('SPI_SETDRAGFROMMAXIMIZE',SPI_SETDRAGFROMMAXIMIZE);
      AddConstant('SPI_GETSNAPSIZING',SPI_GETSNAPSIZING);
      AddConstant('SPI_SETSNAPSIZING',SPI_SETSNAPSIZING);
      AddConstant('SPI_GETDOCKMOVING',SPI_GETDOCKMOVING);
      AddConstant('SPI_SETDOCKMOVING',SPI_SETDOCKMOVING);
      ...
      AddConstant('SPI_GETBLOCKSENDINPUTRESETS',SPI_GETBLOCKSENDINPUTRESETS);
      AddConstant('SPI_SETBLOCKSENDINPUTRESETS',SPI_SETBLOCKSENDINPUTRESETS);
      AddConstant('SPI_GETUIEFFECTS',SPI_GETUIEFFECTS);
      AddConstant('SPI_SETUIEFFECTS',SPI_SETUIEFFECTS);
      AddConstant('SPI_GETDISABLEOVERLAPPEDCONTENT',SPI_GETDISABLEOVERLAPPEDCONTENT);
      AddConstant('SPI_SETDISABLEOVERLAPPEDCONTENT',SPI_SETDISABLEOVERLAPPEDCONTENT);
      AddConstant('SPI_GETCLIENTAREAANIMATION',SPI_GETCLIENTAREAANIMATION);
      AddConstant('SPI_SETCLIENTAREAANIMATION',SPI_SETCLIENTAREAANIMATION);
      AddConstant('SPI_GETCLEARTYPE',SPI_GETCLEARTYPE);
      AddConstant('SPI_SETCLEARTYPE',SPI_SETCLEARTYPE);
      AddConstant('SPI_GETSPEECHRECOGNITION',SPI_GETSPEECHRECOGNITION);
      AddConstant('SPI_SETSPEECHRECOGNITION',SPI_SETSPEECHRECOGNITION);
      ...
      AddConstant('SPI_GETFONTSMOOTHINGORIENTATION',SPI_GETFONTSMOOTHINGORIENTATION);
      AddConstant('SPI_SETFONTSMOOTHINGORIENTATION',SPI_SETFONTSMOOTHINGORIENTATION);
      AddConstant('FE_FONTSMOOTHINGORIENTATIONBGR',FE_FONTSMOOTHINGORIENTATIONBGR);
      AddConstant('FE_FONTSMOOTHINGORIENTATIONRGB',FE_FONTSMOOTHINGORIENTATIONRGB);
      AddConstant('SPI_GETMINIMUMHITRADIUS',SPI_GETMINIMUMHITRADIUS);
      AddConstant('SPI_SETMINIMUMHITRADIUS',SPI_SETMINIMUMHITRADIUS);
      AddConstant('SPI_GETMESSAGEDURATION',SPI_GETMESSAGEDURATION);
      AddConstant('SPI_SETMESSAGEDURATION',SPI_SETMESSAGEDURATION);
      AddConstant('HCF_LOGONDESKTOP',HCF_LOGONDESKTOP);
      AddConstant('HCF_DEFAULTDESKTOP',HCF_DEFAULTDESKTOP);
      AddConstant('CDS_VIDEOPARAMETERS',CDS_VIDEOPARAMETERS);
      AddConstant('CDS_ENABLE_UNSAFE_MODES',CDS_ENABLE_UNSAFE_MODES);
      AddConstant('CDS_DISABLE_UNSAFE_MODES',CDS_DISABLE_UNSAFE_MODES);
      AddConstant('CDS_RESET_EX',CDS_RESET_EX);
      AddConstant('EDD_GET_DEVICE_INTERFACE_NAME',EDD_GET_DEVICE_INTERFACE_NAME);
      AddConstant('EVENT_SYSTEM_DESKTOPSWITCH',EVENT_SYSTEM_DESKTOPSWITCH);
      AddConstant('EVENT_SYSTEM_END',EVENT_SYSTEM_END);
      AddConstant('EVENT_OEM_DEFINED_START',EVENT_OEM_DEFINED_START);
      AddConstant('EVENT_OEM_DEFINED_END',EVENT_OEM_DEFINED_END);
      AddConstant('EVENT_UIA_EVENTID_START',EVENT_UIA_EVENTID_START);
      AddConstant('EVENT_UIA_EVENTID_END',EVENT_UIA_EVENTID_END);
      AddConstant('EVENT_UIA_PROPID_START',EVENT_UIA_PROPID_START);
      AddConstant('EVENT_UIA_PROPID_END',EVENT_UIA_PROPID_END);
      AddConstant('EVENT_CONSOLE_CARET',EVENT_CONSOLE_CARET);
      AddConstant('EVENT_CONSOLE_UPDATE_REGION',EVENT_CONSOLE_UPDATE_REGION);
      AddConstant('EVENT_CONSOLE_UPDATE_SIMPLE',EVENT_CONSOLE_UPDATE_SIMPLE);
      AddConstant('EVENT_CONSOLE_UPDATE_SCROLL',EVENT_CONSOLE_UPDATE_SCROLL);
      AddConstant('EVENT_CONSOLE_LAYOUT',EVENT_CONSOLE_LAYOUT);
      AddConstant('EVENT_CONSOLE_START_APPLICATION',EVENT_CONSOLE_START_APPLICATION);
      AddConstant('EVENT_CONSOLE_END_APPLICATION',EVENT_CONSOLE_END_APPLICATION);
      AddConstant('CONSOLE_APPLICATION_16BIT',CONSOLE_APPLICATION_16BIT);
      AddConstant('CONSOLE_CARET_SELECTION',CONSOLE_CARET_SELECTION);
      AddConstant('CONSOLE_CARET_VISIBLE',CONSOLE_CARET_VISIBLE);
      AddConstant('EVENT_CONSOLE_END',EVENT_CONSOLE_END);
      AddConstant('EVENT_OBJECT_INVOKED',EVENT_OBJECT_INVOKED);
      AddConstant('EVENT_OBJECT_TEXTSELECTIONCHANGED',EVENT_OBJECT_TEXTSELECTIONCHANGED);
      AddConstant('EVENT_OBJECT_CONTENTSCROLLED',EVENT_OBJECT_CONTENTSCROLLED);
      AddConstant('EVENT_SYSTEM_ARRANGMENTPREVIEW',EVENT_SYSTEM_ARRANGMENTPREVIEW);
      AddConstant('EVENT_OBJECT_END',EVENT_OBJECT_END);
      AddConstant('EVENT_AIA_START',EVENT_AIA_START);
      AddConstant('EVENT_AIA_END',EVENT_AIA_END);
      AddConstant('GUI_16BITTASK',GUI_16BITTASK);
      AddConstant('USER_DEFAULT_SCREEN_DPI',USER_DEFAULT_SCREEN_DPI);
      AddConstant('MB_ERR_INVALID_CHARS',MB_ERR_INVALID_CHARS);
      AddConstant('WC_NO_BEST_FIT_CHARS',WC_NO_BEST_FIT_CHARS);
      AddConstant('WC_ERR_INVALID_CHARS',WC_ERR_INVALID_CHARS);
      ...
      AddConstant('GWLP_WNDPROC',GWLP_WNDPROC);
      AddConstant('GWLP_HINSTANCE',GWLP_HINSTANCE);
      AddConstant('GWLP_HWNDPARENT',GWLP_HWNDPARENT);
      AddConstant('GWLP_USERDATA',GWLP_USERDATA);
      AddConstant('GWLP_ID',GWLP_ID);
      AddConstant('GF_BEGIN',GF_BEGIN);
      AddConstant('GF_INERTIA',GF_INERTIA);
      AddConstant('GF_END',GF_END);
      AddConstant('GID_BEGIN',GID_BEGIN);
      AddConstant('GID_END',GID_END);
      AddConstant('GID_ZOOM',GID_ZOOM);
      AddConstant('GID_PAN',GID_PAN);
      AddConstant('GID_ROTATE',GID_ROTATE);
      AddConstant('GID_TWOFINGERTAP',GID_TWOFINGERTAP);
      AddConstant('GID_PRESSANDTAP',GID_PRESSANDTAP);
      AddConstant('GID_ROLLOVER',GID_ROLLOVER);
      AddConstant('GC_ALLGESTURES',GC_ALLGESTURES);
      AddConstant('GC_ZOOM',GC_ZOOM);
      AddConstant('GC_PAN',GC_PAN);
      AddConstant('GC_PAN_WITH_SINGLE_FINGER_VERTICALLY',GC_PAN_WITH_SINGLE_FINGER_VERTICALLY);
      AddConstant('GC_PAN_WITH_SINGLE_FINGER_HORIZONTALLY',GC_PAN_WITH_SINGLE_FINGER_HORIZONTALLY);
      AddConstant('GC_PAN_WITH_GUTTER',GC_PAN_WITH_GUTTER);
      AddConstant('GC_PAN_WITH_INERTIA',GC_PAN_WITH_INERTIA);
      AddConstant('GC_ROTATE',GC_ROTATE);
      AddConstant('GC_TWOFINGERTAP',GC_TWOFINGERTAP);
      AddConstant('GC_PRESSANDTAP',GC_PRESSANDTAP);
      AddConstant('GC_ROLLOVER',GC_ROLLOVER);
      AddConstant('GESTURECONFIGMAXCOUNT',GESTURECONFIGMAXCOUNT);
      AddConstant('GCF_INCLUDE_ANCESTORS',GCF_INCLUDE_ANCESTORS);
      AddConstant('NID_INTEGRATED_TOUCH',NID_INTEGRATED_TOUCH);
      AddConstant('NID_EXTERNAL_TOUCH',NID_EXTERNAL_TOUCH);
      AddConstant('NID_INTEGRATED_PEN',NID_INTEGRATED_PEN);
      AddConstant('NID_EXTERNAL_PEN',NID_EXTERNAL_PEN);
      AddConstant('NID_MULTI_INPUT',NID_MULTI_INPUT);
      AddConstant('NID_READY',NID_READY);
    end;
  end;
begin
  With Scripter.DefineClass(ClassType) do
  begin
    DefineMethod('MAKELANGID',2,tkInteger,nil,__MAKELANGID,false,0,'p: WORD; s: WORD');
    DefineMethod('PRIMARYLANGID',1,tkInteger,nil,__PRIMARYLANGID,false,0,'lgid: WORD');
    DefineMethod('SUBLANGID',1,tkInteger,nil,__SUBLANGID,false,0,'lgid: WORD');
    DefineMethod('MAKELCID',2,tkInteger,nil,__MAKELCID,false,0,'lgid: WORD; srtid: WORD');
    DefineMethod('MAKESORTLCID',3,tkInteger,nil,__MAKESORTLCID,false,0,'lgid: WORD; srtid: WORD; ver: WORD');
    DefineMethod('LANGIDFROMLCID',1,tkInteger,nil,__LANGIDFROMLCID,false,0,'lcid: DWORD');
    DefineMethod('SORTIDFROMLCID',1,tkInteger,nil,__SORTIDFROMLCID,false,0,'lcid: DWORD');
    DefineMethod('SORTVERSIONFROMLCID',1,tkInteger,nil,__SORTVERSIONFROMLCID,false,0,'lcid: DWORD');
    DefineMethod('GetCurrentTime',0,tkInteger,nil,__GetCurrentTime,false,0,'');
    DefineMethod('FreeModule',1,tkVariant,nil,__FreeModule,false,0,'hLibModule: HINST').SetVarArgs([0]);
    DefineMethod('InterlockedCompareExchange',3,tkInteger,nil,__InterlockedCompareExchange,false,0,'Destination: Longint; Exchange: Longint; Comperand: Longint').SetVarArgs([0]);
    DefineMethod('InterlockedExchangeAdd',2,tkInteger,nil,__InterlockedExchangeAdd,false,0,'Addend: Longint; Value: Longint').SetVarArgs([0]);
    DefineMethod('FreeLibrary',1,tkVariant,nil,__FreeLibrary,false,0,'hLibModule: HMODULE');
    DefineMethod('GetVersion',0,tkInteger,nil,__GetVersion,false,0,'');
    DefineMethod('GlobalMemoryStatusEx',1,tkVariant,nil,__GlobalMemoryStatusEx,false,0,'lpBuffer: TMEMORYSTATUSEX').SetVarArgs([0]);
    DefineMethod('GetLongPathName',3,tkInteger,nil,__GetLongPathName,false,0,'lpszShortPath: PWideChar; lpszLongPath: PWideChar; cchBuffer: DWORD');
    DefineMethod('GetLongPathNameA',3,tkInteger,nil,__GetLongPathNameA,false,0,'lpszShortPath: PAnsiChar; lpszLongPath: PAnsiChar; cchBuffer: DWORD');
    DefineMethod('GetLongPathNameW',3,tkInteger,nil,__GetLongPathNameW,false,0,'lpszShortPath: PWideChar; lpszLongPath: PWideChar; cchBuffer: DWORD');
    DefineMethod('GetLongPathNameTransacted',4,tkInteger,nil,__GetLongPathNameTransacted,false,0,'lpszShortPath: PWideChar; lpszLongPath: PWideChar; cchBuffer: DWORD; hTransaction: THandle');
    DefineMethod('GetLongPathNameTransactedA',4,tkInteger,nil,__GetLongPathNameTransactedA,false,0,'lpszShortPath: PAnsiChar; lpszLongPath: PAnsiChar; cchBuffer: DWORD; hTransaction: THandle');
    DefineMethod('GetLongPathNameTransactedW',4,tkInteger,nil,__GetLongPathNameTransactedW,false,0,'lpszShortPath: PWideChar; lpszLongPath: PWideChar; cchBuffer: DWORD; hTransaction: THandle');
    DefineMethod('GetProcessHandleCount',2,tkVariant,nil,__GetProcessHandleCount,false,0,'hProcess: THandle; pdwHandleCount: DWORD').SetVarArgs([1]);
    DefineMethod('ExitProcess',1,tkNone,nil,__ExitProcess,false,0,'uExitCode: UINT');
    DefineMethod('GetThreadIOPendingFlag',2,tkVariant,nil,__GetThreadIOPendingFlag,false,0,'hThread: THandle; lpIOIsPending: BOOL').SetVarArgs([1]);
    DefineMethod('ExitThread',1,tkNone,nil,__ExitThread,false,0,'dwExitCode: DWORD');
    DefineMethod('CheckRemoteDebuggerPresent',2,tkVariant,nil,__CheckRemoteDebuggerPresent,false,0,'hProcess: THandle; pbDebuggerPResent: BOOL').SetVarArgs([1]);
    DefineMethod('LockFile',5,tkVariant,nil,__LockFile,false,0,'hFile: THandle; dwFileOffsetLow: DWORD; dwFileOffsetHigh: DWORD; nNumberOfBytesToLockLow: DWORD; nNumberOfBytesToLockHigh: DWORD');
    DefineMethod('UnlockFile',5,tkVariant,nil,__UnlockFile,false,0,'hFile: THandle; dwFileOffsetLow: DWORD; dwFileOffsetHigh: DWORD; nNumberOfBytesToUnlockLow: DWORD; nNumberOfBytesToUnlockHigh: DWORD');
    DefineMethod('GetFileType',1,tkInteger,nil,__GetFileType,false,0,'hFile: THandle');
    DefineMethod('FindClose',1,tkVariant,nil,__FindClose,false,0,'hFindFile: THandle');
    DefineMethod('CloseHandle',1,tkVariant,nil,__CloseHandle,false,0,'hObject: THandle');
    DefineMethod('GetSystemRegistryQuota',2,tkVariant,nil,__GetSystemRegistryQuota,false,0,'pdwQuotaAllowed: DWORD; pdwQuotaUsed: DWORD').SetVarArgs([0,1]);
    DefineMethod('GetSystemTimes',3,tkVariant,nil,__GetSystemTimes,false,0,'lpIdleTime: TFileTime; lpKernelTime: TFileTime; lpUserTime: TFileTime').SetVarArgs([0,1,2]);
    DefineMethod('GetNativeSystemInfo',1,tkNone,nil,__GetNativeSystemInfo,false,0,'lpSystemInformation: TSystemInfo').SetVarArgs([0]);
    DefineMethod('GetDynamicTimeZoneInformation',1,tkInteger,nil,__GetDynamicTimeZoneInformation,false,0,'pTimeZoneInformation: TDynamicTimeZoneInformation').SetVarArgs([0]);
    DefineMethod('SetDynamicTimeZoneInformation',1,tkInteger,nil,__SetDynamicTimeZoneInformation,false,0,'lpTimeZoneInformation: TDynamicTimeZoneInformation');
    DefineMethod('FileTimeToLocalFileTime',2,tkVariant,nil,__FileTimeToLocalFileTime,false,0,'lpFileTime: TFileTime; lpLocalFileTime: TFileTime').SetVarArgs([1]);
    DefineMethod('FileTimeToSystemTime',2,tkVariant,nil,__FileTimeToSystemTime,false,0,'lpFileTime: TFileTime; lpSystemTime: TSystemTime').SetVarArgs([1]);
    DefineMethod('FileTimeToDosDateTime',3,tkVariant,nil,__FileTimeToDosDateTime,false,0,'lpFileTime: TFileTime; lpFatDate: Word; lpFatTime: Word').SetVarArgs([1,2]);
    DefineMethod('GetTickCount',0,tkInteger,nil,__GetTickCount,false,0,'');
    DefineMethod('OpenFile',3,tkInteger,nil,__OpenFile,false,0,'lpFileName: LPCSTR; lpReOpenBuff: TOFStruct; uStyle: UINT').SetVarArgs([1]);
    DefineMethod('UnregisterWait',1,tkVariant,nil,__UnregisterWait,false,0,'WaitHandle: THandle');
    DefineMethod('UnregisterWaitEx',2,tkVariant,nil,__UnregisterWaitEx,false,0,'WaitHandle: THandle; CompletionEvent: THandle');
    DefineMethod('WT_SET_MAX_THREADPOOL_THREADS',2,tkInteger,nil,__WT_SET_MAX_THREADPOOL_THREADS,false,0,'Flags: ULONG; Limit: ULONG');
    DefineMethod('CreateTimerQueue',0,tkInteger,nil,__CreateTimerQueue,false,0,'');
    DefineMethod('ChangeTimerQueueTimer',4,tkVariant,nil,__ChangeTimerQueueTimer,false,0,'TimerQueue: THandle; Timer: THandle; DueTime: ULONG; Period: ULONG');
    DefineMethod('DeleteTimerQueueTimer',3,tkVariant,nil,__DeleteTimerQueueTimer,false,0,'TimerQueue: THandle; Timer: THandle; CompletionEvent: THandle');
    DefineMethod('DeleteTimerQueueEx',2,tkVariant,nil,__DeleteTimerQueueEx,false,0,'TimerQueue: THandle; CompletionEvent: THandle');
    DefineMethod('CancelTimerQueueTimer',2,tkVariant,nil,__CancelTimerQueueTimer,false,0,'TimerQueue: THandle; Timer: THandle');
    DefineMethod('DeleteTimerQueue',1,tkVariant,nil,__DeleteTimerQueue,false,0,'TimerQueue: THandle');
    DefineMethod('LoadLibrary',1,tkInteger,nil,__LoadLibrary,false,0,'lpLibFileName: PWideChar');
    DefineMethod('GetCommandLine',0,tkVariant,nil,__GetCommandLine,false,0,'');
    DefineMethod('IsDebuggerPresent',0,tkVariant,nil,__IsDebuggerPresent,false,0,'');
    DefineMethod('FindResource',3,tkInteger,nil,__FindResource,false,0,'hModule: HMODULE; lpName: PWideChar; lpType: PWideChar');
    DefineMethod('SetCurrentDirectory',1,tkVariant,nil,__SetCurrentDirectory,false,0,'lpPathName: PWideChar');
    DefineMethod('GetCurrentDirectory',2,tkInteger,nil,__GetCurrentDirectory,false,0,'nBufferLength: DWORD; lpBuffer: PWideChar');
    DefineMethod('SetDllDirectory',1,tkVariant,nil,__SetDllDirectory,false,0,'lpPathName: PWideChar');
    DefineMethod('SetDllDirectoryA',1,tkVariant,nil,__SetDllDirectoryA,false,0,'lpPathName: PAnsiChar');
    DefineMethod('SetDllDirectoryW',1,tkVariant,nil,__SetDllDirectoryW,false,0,'lpPathName: PWideChar');
    DefineMethod('GetDllDirectory',2,tkVariant,nil,__GetDllDirectory,false,0,'nBufferLength: DWORD; lpBuffer: PWideChar');
    DefineMethod('GetDllDirectoryA',2,tkVariant,nil,__GetDllDirectoryA,false,0,'nBufferLength: DWORD; lpBuffer: PAnsiChar');
    DefineMethod('GetDllDirectoryW',2,tkVariant,nil,__GetDllDirectoryW,false,0,'nBufferLength: DWORD; lpBuffer: PWideChar');
    DefineMethod('RemoveDirectory',1,tkVariant,nil,__RemoveDirectory,false,0,'lpPathName: PWideChar');
    DefineMethod('RemoveDirectoryTransacted',2,tkVariant,nil,__RemoveDirectoryTransacted,false,0,'lpPathName: PWideChar; hTransaction: THandle');
    DefineMethod('RemoveDirectoryTransactedA',2,tkVariant,nil,__RemoveDirectoryTransactedA,false,0,'lpPathName: PAnsiChar; hTransaction: THandle');
    DefineMethod('RemoveDirectoryTransactedW',2,tkVariant,nil,__RemoveDirectoryTransactedW,false,0,'lpPathName: PWideChar; hTransaction: THandle');
    DefineMethod('GetFullPathNameTransacted',5,tkInteger,nil,__GetFullPathNameTransacted,false,0,'lpFileName: PWideChar; nBufferLength: DWORD; lpBuffer: PWideChar; lpFilePart: PWideChar; hTransaction: THandle').SetVarArgs([3]);
    DefineMethod('GetFullPathNameTransactedA',5,tkInteger,nil,__GetFullPathNameTransactedA,false,0,'lpFileName: PAnsiChar; nBufferLength: DWORD; lpBuffer: PAnsiChar; lpFilePart: PAnsiChar; hTransaction: THandle').SetVarArgs([3]);
    DefineMethod('GetFullPathNameTransactedW',5,tkInteger,nil,__GetFullPathNameTransactedW,false,0,'lpFileName: PWideChar; nBufferLength: DWORD; lpBuffer: PWideChar; lpFilePart: PWideChar; hTransaction: THandle').SetVarArgs([3]);
    DefineMethod('SetFileAttributesTransacted',3,tkVariant,nil,__SetFileAttributesTransacted,false,0,'lpFileName: PWideChar; dwFileAttributes: DWORD; hTransaction: THandle');
    DefineMethod('SetFileAttributesTransactedA',3,tkVariant,nil,__SetFileAttributesTransactedA,false,0,'lpFileName: PAnsiChar; dwFileAttributes: DWORD; hTransaction: THandle');
    DefineMethod('SetFileAttributesTransactedW',3,tkVariant,nil,__SetFileAttributesTransactedW,false,0,'lpFileName: PWideChar; dwFileAttributes: DWORD; hTransaction: THandle');
    DefineMethod('GetFileAttributes',1,tkInteger,nil,__GetFileAttributes,false,0,'lpFileName: PWideChar');
    DefineMethod('DeleteFile',1,tkVariant,nil,__DeleteFile,false,0,'lpFileName: PWideChar');
    DefineMethod('DeleteFileTransacted',2,tkVariant,nil,__DeleteFileTransacted,false,0,'lpFileName: PWideChar; hTransaction: THandle');
    DefineMethod('DeleteFileTransactedA',2,tkVariant,nil,__DeleteFileTransactedA,false,0,'lpFileName: PAnsiChar; hTransaction: THandle');
    DefineMethod('DeleteFileTransactedW',2,tkVariant,nil,__DeleteFileTransactedW,false,0,'lpFileName: PWideChar; hTransaction: THandle');
    DefineMethod('FindFirstFile',2,tkInteger,nil,__FindFirstFile,false,0,'lpFileName: PWideChar; lpFindFileData: TWIN32FindData').SetVarArgs([1]);
    DefineMethod('FindNextFile',2,tkVariant,nil,__FindNextFile,false,0,'hFindFile: THandle; lpFindFileData: TWIN32FindData').SetVarArgs([1]);
    DefineMethod('CopyFile',3,tkVariant,nil,__CopyFile,false,0,'lpExistingFileName: PWideChar; lpNewFileName: PWideChar; bFailIfExists: BOOL');
    DefineMethod('MoveFile',2,tkVariant,nil,__MoveFile,false,0,'lpExistingFileName: PWideChar; lpNewFileName: PWideChar');
    DefineMethod('MoveFileTransacted',4,tkVariant,nil,__MoveFileTransacted,false,0,'lpExistingFileName: PWideChar; lpNewFileName: PWideChar; dwFlags: DWORD; hTransaction: THandle');
    DefineMethod('MoveFileTransactedA',4,tkVariant,nil,__MoveFileTransactedA,false,0,'lpExistingFileName: PAnsiChar; lpNewFileName: PAnsiChar; dwFlags: DWORD; hTransaction: THandle');
    DefineMethod('MoveFileTransactedW',4,tkVariant,nil,__MoveFileTransactedW,false,0,'lpExistingFileName: PWideChar; lpNewFileName: PWideChar; dwFlags: DWORD; hTransaction: THandle');
    DefineMethod('CreateHardLinkTransacted',4,tkVariant,nil,__CreateHardLinkTransacted,false,0,'lpFileName: PWideChar; lpExistingFileName: PWideChar; lpSecurityAttributes: _SECURITY_ATTRIBUTES; hTransaction: THandle');
    DefineMethod('CreateHardLinkTransactedA',4,tkVariant,nil,__CreateHardLinkTransactedA,false,0,'lpFileName: PAnsiChar; lpExistingFileName: PAnsiChar; lpSecurityAttributes: _SECURITY_ATTRIBUTES; hTransaction: THandle');
    DefineMethod('CreateHardLinkTransactedW',4,tkVariant,nil,__CreateHardLinkTransactedW,false,0,'lpFileName: PWideChar; lpExistingFileName: PWideChar; lpSecurityAttributes: _SECURITY_ATTRIBUTES; hTransaction: THandle');
    DefineMethod('CreateSymbolicLink',3,tkVariant,nil,__CreateSymbolicLink,false,0,'lpSymlinkFileName: PWideChar; lpTargetFileName: PWideChar; dwFlags: DWORD');
    DefineMethod('CreateSymbolicLinkA',3,tkVariant,nil,__CreateSymbolicLinkA,false,0,'lpSymlinkFileName: PAnsiChar; lpTargetFileName: PAnsiChar; dwFlags: DWORD');
    DefineMethod('CreateSymbolicLinkW',3,tkVariant,nil,__CreateSymbolicLinkW,false,0,'lpSymlinkFileName: PWideChar; lpTargetFileName: PWideChar; dwFlags: DWORD');
    DefineMethod('CreateSymbolicLinkTransacted',4,tkVariant,nil,__CreateSymbolicLinkTransacted,false,0,'lpSymlinkFileName: PWideChar; lpTargetFileName: PWideChar; dwFlags: DWORD; hTransaction: THandle');
    DefineMethod('CreateSymbolicLinkTransactedA',4,tkVariant,nil,__CreateSymbolicLinkTransactedA,false,0,'lpSymlinkFileName: PAnsiChar; lpTargetFileName: PAnsiChar; dwFlags: DWORD; hTransaction: THandle');
    DefineMethod('CreateSymbolicLinkTransactedW',4,tkVariant,nil,__CreateSymbolicLinkTransactedW,false,0,'lpSymlinkFileName: PWideChar; lpTargetFileName: PWideChar; dwFlags: DWORD; hTransaction: THandle');
    DefineMethod('GetFinalPathNameByHandle',4,tkInteger,nil,__GetFinalPathNameByHandle,false,0,'hFile: THandle; lpszFilePath: PWideChar; cchFilePath: DWORD; dwFlags: DWORD');
    DefineMethod('GetFinalPathNameByHandleA',4,tkInteger,nil,__GetFinalPathNameByHandleA,false,0,'hFile: THandle; lpszFilePath: PAnsiChar; cchFilePath: DWORD; dwFlags: DWORD');
    DefineMethod('GetFinalPathNameByHandleW',4,tkInteger,nil,__GetFinalPathNameByHandleW,false,0,'hFile: THandle; lpszFilePath: PWideChar; cchFilePath: DWORD; dwFlags: DWORD');
    DefineMethod('AdjustTokenPrivileges',6,tkVariant,nil,__AdjustTokenPrivileges,false,0,'TokenHandle: THandle; DisableAllPrivileges: BOOL; NewState: TTokenPrivileges; BufferLength: DWORD; PreviousState: TTokenPrivileges; ReturnLength: DWORD').SetVarArgs([4,5]);
    DefineMethod('GetComputerNameEx',3,tkVariant,nil,__GetComputerNameEx,false,0,'NameType: TComputerNameFormat; lpBuffer: PWideChar; nSize: DWORD').SetVarArgs([2]);
    DefineMethod('GetComputerNameExA',3,tkVariant,nil,__GetComputerNameExA,false,0,'NameType: TComputerNameFormat; lpBuffer: PAnsiChar; nSize: DWORD').SetVarArgs([2]);
    DefineMethod('GetComputerNameExW',3,tkVariant,nil,__GetComputerNameExW,false,0,'NameType: TComputerNameFormat; lpBuffer: PWideChar; nSize: DWORD').SetVarArgs([2]);
    DefineMethod('VerifyVersionInfo',3,tkVariant,nil,__VerifyVersionInfo,false,0,'lpVersionInformation: TOSVersionInfo; dwTypeMask: DWORD; dwlConditionMask: DWORDLONG').SetVarArgs([0]);
    DefineMethod('VerifyVersionInfoA',3,tkVariant,nil,__VerifyVersionInfoA,false,0,'lpVersionInformation: TOSVersionInfoA; dwTypeMask: DWORD; dwlConditionMask: DWORDLONG').SetVarArgs([0]);
    DefineMethod('VerifyVersionInfoW',3,tkVariant,nil,__VerifyVersionInfoW,false,0,'lpVersionInformation: TOSVersionInfoW; dwTypeMask: DWORD; dwlConditionMask: DWORDLONG').SetVarArgs([0]);
    DefineMethod('CopyMetaFile',2,tkInteger,nil,__CopyMetaFile,false,0,'p1: HMETAFILE; p2: PWideChar');
    DefineMethod('GetRandomRgn',3,tkInteger,nil,__GetRandomRgn,false,0,'hdc: HDC; hrgn: HRGN; iNum: Integer');
    DefineMethod('CopyEnhMetaFile',2,tkInteger,nil,__CopyEnhMetaFile,false,0,'p1: HENHMETAFILE; p2: PWideChar');
    DefineMethod('EndPath',1,tkVariant,nil,__EndPath,false,0,'DC: HDC');
    DefineMethod('OffsetViewportOrgEx',4,tkVariant,nil,__OffsetViewportOrgEx,false,0,'DC: HDC; X: Integer; Y: Integer; Points').SetVarArgs([3]);
    DefineMethod('OffsetWindowOrgEx',4,tkVariant,nil,__OffsetWindowOrgEx,false,0,'DC: HDC; X: Integer; Y: Integer; Points').SetVarArgs([3]);
    DefineMethod('GET_APPCOMMAND_LPARAM',1,tkInteger,nil,__GET_APPCOMMAND_LPARAM,false,0,'lParam: LongInt');
    DefineMethod('GET_DEVICE_LPARAM',1,tkInteger,nil,__GET_DEVICE_LPARAM,false,0,'lParam: LongInt');
    DefineMethod('GET_MOUSEORKEY_LPARAM',1,tkInteger,nil,__GET_MOUSEORKEY_LPARAM,false,0,'lParam: LongInt');
    DefineMethod('GET_FLAGS_LPARAM',1,tkInteger,nil,__GET_FLAGS_LPARAM,false,0,'lParam: LongInt');
    DefineMethod('GET_KEYSTATE_LPARAM',1,tkInteger,nil,__GET_KEYSTATE_LPARAM,false,0,'lParam: LongInt');
    DefineMethod('GetMouseMovePointsEx',5,tkInteger,nil,__GetMouseMovePointsEx,false,0,'cbSize: UINT; lppt: TMouseMovePoint; lpptBuf: TMouseMovePoint; nBufPoints: Integer; resolution: DWORD').SetVarArgs([1,2]);
    DefineMethod('PointToLParam',1,tkInteger,nil,__PointToLParam,false,0,'P: TPoint');
    DefineMethod('ExitWindows',2,tkVariant,nil,__ExitWindows,false,0,'dwReserved: DWORD; Code: Word');
    DefineMethod('FlashWindow',2,tkVariant,nil,__FlashWindow,false,0,'hWnd: HWND; bInvert: BOOL');
    DefineMethod('CloseWindow',1,tkVariant,nil,__CloseWindow,false,0,'hWnd: HWND');
    DefineMethod('GetWindowPlacement',2,tkVariant,nil,__GetWindowPlacement,false,0,'hWnd: HWND; WindowPlacement: TWindowPlacement').SetVarArgs([1]);
    DefineMethod('SetWindowPlacement',2,tkVariant,nil,__SetWindowPlacement,false,0,'hWnd: HWND; WindowPlacement: TWindowPlacement');
    DefineMethod('GetWindowDisplayAffinity',2,tkVariant,nil,__GetWindowDisplayAffinity,false,0,'hWnd: HWND; pdwAffinity: DWORD').SetVarArgs([1]);
    DefineMethod('SetWindowDisplayAffinity',2,tkVariant,nil,__SetWindowDisplayAffinity,false,0,'hWnd: HWND; dwAffinity: DWORD');
    DefineMethod('EndDialog',2,tkVariant,nil,__EndDialog,false,0,'hDlg: HWND; nResult: Integer');
    DefineMethod('OpenClipboard',1,tkVariant,nil,__OpenClipboard,false,0,'hWndNewOwner: HWND');
    DefineMethod('CloseClipboard',0,tkVariant,nil,__CloseClipboard,false,0,'');
    DefineMethod('GetClipboardFormatName',3,tkInteger,nil,__GetClipboardFormatName,false,0,'format: UINT; lpszFormatName: PWideChar; cchMaxCount: Integer');
    DefineMethod('AddClipboardFormatListener',1,tkVariant,nil,__AddClipboardFormatListener,false,0,'hwnd: HWND');
    DefineMethod('RemoveClipboardFormatListener',1,tkVariant,nil,__RemoveClipboardFormatListener,false,0,'hwnd: HWND');
    DefineMethod('CharToOem',2,tkVariant,nil,__CharToOem,false,0,'lpszSrc: PWideChar; lpszDst: PAnsiChar');
    DefineMethod('CharToOemA',2,tkVariant,nil,__CharToOemA,false,0,'lpszSrc: PAnsiChar; lpszDst: PAnsiChar');
    DefineMethod('CharToOemW',2,tkVariant,nil,__CharToOemW,false,0,'lpszSrc: PWideChar; lpszDst: PAnsiChar');
    DefineMethod('OemToChar',2,tkVariant,nil,__OemToChar,false,0,'lpszSrc: PAnsiChar; lpszDst: PWideChar');
    DefineMethod('CharToOemBuff',3,tkVariant,nil,__CharToOemBuff,false,0,'lpszSrc: PWideChar; lpszDst: PAnsiChar; cchDstLength: DWORD');
    DefineMethod('CharToOemBuffA',3,tkVariant,nil,__CharToOemBuffA,false,0,'lpszSrc: PAnsiChar; lpszDst: PAnsiChar; cchDstLength: DWORD');
    DefineMethod('CharToOemBuffW',3,tkVariant,nil,__CharToOemBuffW,false,0,'lpszSrc: PWideChar; lpszDst: PAnsiChar; cchDstLength: DWORD');
    DefineMethod('CharUpper',1,tkVariant,nil,__CharUpper,false,0,'lpsz: PWideChar');
    DefineMethod('CharUpperA',1,tkVariant,nil,__CharUpperA,false,0,'lpsz: PAnsiChar');
    DefineMethod('CharUpperW',1,tkVariant,nil,__CharUpperW,false,0,'lpsz: PWideChar');
    DefineMethod('CharUpperBuff',2,tkInteger,nil,__CharUpperBuff,false,0,'lpsz: PWideChar; cchLength: DWORD');
    DefineMethod('CharUpperBuffA',2,tkInteger,nil,__CharUpperBuffA,false,0,'lpsz: PAnsiChar; cchLength: DWORD');
    DefineMethod('CharUpperBuffW',2,tkInteger,nil,__CharUpperBuffW,false,0,'lpsz: PWideChar; cchLength: DWORD');
    DefineMethod('CharLower',1,tkVariant,nil,__CharLower,false,0,'lpsz: PWideChar');
    DefineMethod('CharLowerA',1,tkVariant,nil,__CharLowerA,false,0,'lpsz: PAnsiChar');
    DefineMethod('CharLowerW',1,tkVariant,nil,__CharLowerW,false,0,'lpsz: PWideChar');
    DefineMethod('CharLowerBuff',2,tkInteger,nil,__CharLowerBuff,false,0,'lpsz: PWideChar; cchLength: DWORD');
    DefineMethod('CharLowerBuffA',2,tkInteger,nil,__CharLowerBuffA,false,0,'lpsz: PAnsiChar; cchLength: DWORD');
    DefineMethod('CharLowerBuffW',2,tkInteger,nil,__CharLowerBuffW,false,0,'lpsz: PWideChar; cchLength: DWORD');
    DefineMethod('CharNext',1,tkVariant,nil,__CharNext,false,0,'lpsz: PWideChar');
    DefineMethod('CharNextA',1,tkVariant,nil,__CharNextA,false,0,'lpsz: PAnsiChar');
    DefineMethod('CharNextW',1,tkVariant,nil,__CharNextW,false,0,'lpsz: PWideChar');
    DefineMethod('CharPrev',2,tkVariant,nil,__CharPrev,false,0,'lpszStart: PWideChar; lpszCurrent: PWideChar');
    DefineMethod('CharPrevA',2,tkVariant,nil,__CharPrevA,false,0,'lpszStart: PAnsiChar; lpszCurrent: PAnsiChar');
    DefineMethod('CharPrevW',2,tkVariant,nil,__CharPrevW,false,0,'lpszStart: PWideChar; lpszCurrent: PWideChar');
    DefineMethod('CharNextExA',3,tkVariant,nil,__CharNextExA,false,0,'CodePage: Word; lpCurrentChar: LPCSTR; dwFlags: DWORD');
    DefineMethod('CharNextEx',3,tkVariant,nil,__CharNextEx,false,0,'CodePage: Word; lpCurrentChar: LPCSTR; dwFlags: DWORD');
    DefineMethod('CharPrevEx',4,tkVariant,nil,__CharPrevEx,false,0,'CodePage: Word; lpStart: LPCSTR; lpCurrentChar: LPCSTR; dwFlags: DWORD');
    DefineMethod('CharPrevExA',4,tkVariant,nil,__CharPrevExA,false,0,'CodePage: Word; lpStart: LPCSTR; lpCurrentChar: LPCSTR; dwFlags: DWORD');
    DefineMethod('AnsiToOem',2,tkVariant,nil,__AnsiToOem,false,0,'lpszSrc: LPCSTR; lpszDst: LPSTR');
    DefineMethod('OemToAnsi',2,tkVariant,nil,__OemToAnsi,false,0,'lpszSrc: LPCSTR; lpszDst: LPSTR');
    DefineMethod('AnsiToOemBuff',3,tkVariant,nil,__AnsiToOemBuff,false,0,'lpszSrc: LPCSTR; lpszDst: LPSTR; cchDstLength: DWORD');
    DefineMethod('AnsiUpper',1,tkVariant,nil,__AnsiUpper,false,0,'lpsz: LPSTR');
    DefineMethod('AnsiUpperBuff',2,tkInteger,nil,__AnsiUpperBuff,false,0,'lpsz: LPSTR; cchLength: DWORD');
    DefineMethod('AnsiLower',1,tkVariant,nil,__AnsiLower,false,0,'lpsz: LPSTR');
    DefineMethod('AnsiLowerBuff',2,tkInteger,nil,__AnsiLowerBuff,false,0,'lpsz: LPSTR; cchLength: DWORD');
    DefineMethod('AnsiNext',1,tkVariant,nil,__AnsiNext,false,0,'lpsz: LPCSTR');
    DefineMethod('AnsiPrev',2,tkVariant,nil,__AnsiPrev,false,0,'lpszStart: LPCSTR; lpszCurrent: LPCSTR');
    DefineMethod('CloseTouchInputHandle',1,tkVariant,nil,__CloseTouchInputHandle,false,0,'hTouchInput: HTOUCHINPUT');
    DefineMethod('RegisterTouchWindow',2,tkVariant,nil,__RegisterTouchWindow,false,0,'hwnd: HWND; ulFlags: Cardinal');
    DefineMethod('UnregisterTouchWindow',1,tkVariant,nil,__UnregisterTouchWindow,false,0,'hwnd: HWND');
    DefineMethod('CalculatePopupWindowPosition',5,tkVariant,nil,__CalculatePopupWindowPosition,false,0,'anchorPoint: TPoint; windowSize: TSize; flags: UINT; excludeRect: TRect; popupWindowPosition: TRect').SetVarArgs([4]);
    DefineMethod('GetWindowDC',1,tkInteger,nil,__GetWindowDC,false,0,'hWnd: HWND');
    DefineMethod('InvalidateRect',3,tkVariant,nil,__InvalidateRect,false,0,'hWnd: HWND; lpRect: TRect; bErase: BOOL');
    DefineMethod('ValidateRect',2,tkVariant,nil,__ValidateRect,false,0,'hWnd: HWND; lpRect: TRect');
    DefineMethod('RedrawWindow',4,tkVariant,nil,__RedrawWindow,false,0,'hWnd: HWND; lprcUpdate: TRect; hrgnUpdate: HRGN; flags: UINT');
    DefineMethod('MessageBox',4,tkInteger,nil,__MessageBox,false,0,'hWnd: HWND; lpText: PWideChar; lpCaption: PWideChar; uType: UINT');
    DefineMethod('MessageBoxEx',5,tkInteger,nil,__MessageBoxEx,false,0,'hWnd: HWND; lpText: PWideChar; lpCaption: PWideChar; uType: UINT; wLanguageId: Word');
    DefineMethod('MessageBeep',1,tkVariant,nil,__MessageBeep,false,0,'uType: UINT');
    DefineMethod('SetPhysicalCursorPos',2,tkVariant,nil,__SetPhysicalCursorPos,false,0,'X: Integer; Y: Integer');
    DefineMethod('GetPhysicalCursorPos',1,tkVariant,nil,__GetPhysicalCursorPos,false,0,'lpPoint: TPoint').SetVarArgs([0]);
    DefineMethod('GetCaretPos',1,tkVariant,nil,__GetCaretPos,false,0,'lpPoint: TPoint').SetVarArgs([0]);
    DefineMethod('ClientToScreen',2,tkVariant,nil,__ClientToScreen,false,0,'hWnd: HWND; lpPoint: TPoint').SetVarArgs([1]);
    DefineMethod('ScreenToClient',2,tkVariant,nil,__ScreenToClient,false,0,'hWnd: HWND; lpPoint: TPoint').SetVarArgs([1]);
    DefineMethod('LogicalToPhysicalPoint',2,tkVariant,nil,__LogicalToPhysicalPoint,false,0,'hWnd: HWND; lpPoint: TPoint').SetVarArgs([1]);
    DefineMethod('PhysicalToLogicalPoint',2,tkVariant,nil,__PhysicalToLogicalPoint,false,0,'hWnd: HWND; lpPoint: TPoint').SetVarArgs([1]);
    DefineMethod('WindowFromPhysicalPoint',1,tkInteger,nil,__WindowFromPhysicalPoint,false,0,'Point: TPoint');
    DefineMethod('FrameRect',3,tkInteger,nil,__FrameRect,false,0,'hDC: HDC; lprc: TRect; hbr: HBRUSH');
    DefineMethod('CopyRect',2,tkVariant,nil,__CopyRect,false,0,'lprcDst: TRect; lprcSrc: TRect').SetVarArgs([0]);
    DefineMethod('FindWindow',2,tkInteger,nil,__FindWindow,false,0,'lpClassName: PWideChar; lpWindowName: PWideChar');
    DefineMethod('GetWindowThreadProcessId',2,tkInteger,nil,__GetWindowThreadProcessId,false,0,'hWnd: HWND; dwProcessId: DWORD').SetVarArgs([1]);
    DefineMethod('CopyImage',5,tkInteger,nil,__CopyImage,false,0,'hImage: THandle; ImageType: UINT; X: Integer; Y: Integer; Flags: UINT');
    DefineMethod('CopyIcon',1,tkInteger,nil,__CopyIcon,false,0,'hIcon: HICON');
    DefineMethod('LoadString',4,tkInteger,nil,__LoadString,false,0,'hInstance: HINST; uID: UINT; lpBuffer: PWideChar; nBufferMax: Integer');
    DefineMethod('HtmlHelp',4,tkInteger,nil,__HtmlHelp,false,0,'hWndCaller: HWND; pszFile: PWideChar; uCommand: UINT; dwData: DWORD');
    DefineMethod('HtmlHelpA',4,tkInteger,nil,__HtmlHelpA,false,0,'hWndCaller: HWND; pszFile: PAnsiChar; uCommand: UINT; dwData: DWORD');
    DefineMethod('HtmlHelpW',4,tkInteger,nil,__HtmlHelpW,false,0,'hWndCaller: HWND; pszFile: PWideChar; uCommand: UINT; dwData: DWORD');
    DefineMethod('SystemParametersInfo',4,tkVariant,nil,__SystemParametersInfo,false,0,'uiAction: UINT; uiParam: UINT; pvParam: Integer; fWinIni: UINT').SetVarArgs([2]);
    DefineMethod('BlockInput',1,tkVariant,nil,__BlockInput,false,0,'fBlockIt: BOOL');
    DefineMethod('SetProcessDPIAware',0,tkVariant,nil,__SetProcessDPIAware,false,0,'');
    DefineMethod('IsProcessDPIAware',0,tkVariant,nil,__IsProcessDPIAware,false,0,'');
    DefineMethod('GetCPInfoEx',3,tkVariant,nil,__GetCPInfoEx,false,0,'CodePage: UINT; dwFlags: DWORD; lpCPInfoEx: TCPInfoEx').SetVarArgs([2]);
    DefineMethod('GetCPInfoExA',3,tkVariant,nil,__GetCPInfoExA,false,0,'CodePage: UINT; dwFlags: DWORD; lpCPInfoEx: TCPInfoExA').SetVarArgs([2]);
    DefineMethod('GetCPInfoExW',3,tkVariant,nil,__GetCPInfoExW,false,0,'CodePage: UINT; dwFlags: DWORD; lpCPInfoEx: TCPInfoExW').SetVarArgs([2]);
    DefineMethod('LCIDToLocaleName',4,tkInteger,nil,__LCIDToLocaleName,false,0,'Locale: LCID; lpName: LPWSTR; cchName: Integer; dwFlags: DWORD');
    DefineMethod('LocaleNameToLCID',2,tkInteger,nil,__LocaleNameToLCID,false,0,'lpName: LPCWSTR; dwFlags: DWORD');
    DefineMethod('GetLocaleInfoEx',4,tkInteger,nil,__GetLocaleInfoEx,false,0,'lpLocaleName: PWideChar; LCType: LCTYPE; lpLCData: PWideChar; cchData: Integer');
    DefineMethod('FoldString',5,tkInteger,nil,__FoldString,false,0,'dwMapFlags: DWORD; lpSrcStr: PWideChar; cchSrc: Integer; lpDestStr: PWideChar; cchDest: Integer');
    DefineMethod('RegOverridePredefKey',2,tkInteger,nil,__RegOverridePredefKey,false,0,'hKey: HKEY; hNewHKey: HKEY');
    DefineMethod('RegOpenUserClassesRoot',4,tkInteger,nil,__RegOpenUserClassesRoot,false,0,'hToken: THandle; dwOptions: DWORD; samDesired: REGSAM; phkResult: HKEY').SetVarArgs([3]);
    DefineMethod('RegOpenCurrentUser',2,tkInteger,nil,__RegOpenCurrentUser,false,0,'samDesired: REGSAM; phkResult: HKEY').SetVarArgs([1]);
    DefineMethod('RegDisablePredefinedCache',0,tkInteger,nil,__RegDisablePredefinedCache,false,0,'');
    DefineMethod('GetWindowLongPtr',2,tkInteger,nil,__GetWindowLongPtr,false,0,'hWnd: HWND; nIndex: Integer');
    DefineMethod('SetWindowLongPtr',3,tkInteger,nil,__SetWindowLongPtr,false,0,'hWnd: HWND; nIndex: Integer; dwNewLong: LONG_PTR');
    DefineMethod('GetWindowLongPtrA',2,tkInteger,nil,__GetWindowLongPtrA,false,0,'hWnd: HWND; nIndex: Integer');
    DefineMethod('SetWindowLongPtrA',3,tkInteger,nil,__SetWindowLongPtrA,false,0,'hWnd: HWND; nIndex: Integer; dwNewLong: LONG_PTR');
    DefineMethod('GetWindowLongPtrW',2,tkInteger,nil,__GetWindowLongPtrW,false,0,'hWnd: HWND; nIndex: Integer');
    DefineMethod('SetWindowLongPtrW',3,tkInteger,nil,__SetWindowLongPtrW,false,0,'hWnd: HWND; nIndex: Integer; dwNewLong: LONG_PTR');
    DefineMethod('GID_ROTATE_ANGLE_TO_ARGUMENT',1,tkInteger,nil,__GID_ROTATE_ANGLE_TO_ARGUMENT,false,0,'Arg: Double');
    DefineMethod('GID_ROTATE_ANGLE_FROM_ARGUMENT',1,tkVariant,nil,__GID_ROTATE_ANGLE_FROM_ARGUMENT,false,0,'Arg: USHORT');
    DefineMethod('GetGestureInfo',2,tkVariant,nil,__GetGestureInfo,false,0,'hGestureInfo: HGESTUREINFO; pGestureInfo: GestureInfo').SetVarArgs([1]);
    DefineMethod('CloseGestureInfoHandle',1,tkVariant,nil,__CloseGestureInfoHandle,false,0,'hGestureInfo: HGESTUREINFO');
    DefineMethod('RotateAngleFromArgument',1,tkVariant,nil,__RotateAngleFromArgument,false,0,'Arg: Word');
    DefineMethod('InertiaVectorFromArgument',1,tkVariant,nil,__InertiaVectorFromArgument,false,0,'Arg: UInt64');
    ...
    AddConstant('TokenRestrictedSids',TokenRestrictedSids);
    AddConstant('TokenSessionId',TokenSessionId);
    AddConstant('TokenGroupsAndPrivileges',TokenGroupsAndPrivileges);
    AddConstant('TokenSessionReference',TokenSessionReference);
    AddConstant('TokenSandBoxInert',TokenSandBoxInert);
    AddConstant('TokenAuditPolicy',TokenAuditPolicy);
    AddConstant('TokenOrigin',TokenOrigin);
    AddConstant('TokenElevationType',TokenElevationType);
    AddConstant('TokenLinkedToken',TokenLinkedToken);
    AddConstant('TokenElevation',TokenElevation);
    AddConstant('TokenHasRestrictions',TokenHasRestrictions);
    AddConstant('TokenAccessInformation',TokenAccessInformation);
    AddConstant('TokenVirtualizationAllowed',TokenVirtualizationAllowed);
    AddConstant('TokenVirtualizationEnabled',TokenVirtualizationEnabled);
    AddConstant('TokenIntegrityLevel',TokenIntegrityLevel);
    AddConstant('TokenUIAccess',TokenUIAccess);
    AddConstant('TokenMandatoryPolicy',TokenMandatoryPolicy);
    AddConstant('TokenLogonSid',TokenLogonSid);
    AddConstant('vMaxTokenInfoClass',vMaxTokenInfoClass);
    AddConstant('TokenElevationTypeDefault',TokenElevationTypeDefault);
    AddConstant('TokenElevationTypeFull',TokenElevationTypeFull);
    AddConstant('TokenElevationTypeLimited',TokenElevationTypeLimited);
    ...
    AddConstant('ComputerNameNetBIOS',ComputerNameNetBIOS);
    AddConstant('ComputerNameDnsHostname',ComputerNameDnsHostname);
    AddConstant('ComputerNameDnsDomain',ComputerNameDnsDomain);
    AddConstant('ComputerNameDnsFullyQualified',ComputerNameDnsFullyQualified);
    AddConstant('ComputerNamePhysicalNetBIOS',ComputerNamePhysicalNetBIOS);
    AddConstant('ComputerNamePhysicalDnsHostname',ComputerNamePhysicalDnsHostname);
    AddConstant('ComputerNamePhysicalDnsDomain',ComputerNamePhysicalDnsDomain);
    AddConstant('ComputerNamePhysicalDnsFullyQualified',ComputerNamePhysicalDnsFullyQualified);
    AddConstant('ComputerNameMax',ComputerNameMax);
  AddConsts1;
  AddConsts2;
  AddConsts3;
  AddConsts4;
