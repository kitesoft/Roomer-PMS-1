...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TMidasConnectionClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
...
begin
  ...
  begin
    DefineMethod('Create',1,tkClass,TMidasConnection,__TMidasConnectionCreate,true,0,'AOwner: TComponent');
  end;
