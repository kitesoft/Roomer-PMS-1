...
begin
  with AMachine do
  begin
AResult := Integer(BDE.DbiLoadDriver(PAnsiChar(AnsiString(VarToStr(GetInputArg(0))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(BDE.DbiSetPrivateDir(PAnsiChar(AnsiString(VarToStr(GetInputArg(0))))));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := Integer(BDE.DbiGetDriverDesc(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),Param1));
    ReturnOutputArg(AResult);
...
AResult := Integer(BDE.DbiGetTableTypeDesc(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),Param2));
    ReturnOutputArg(AResult);
...
AResult := Integer(BDE.DbiGetFieldTypeDesc(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(2)))),Param3));
    ReturnOutputArg(AResult);
...
AResult := Integer(BDE.DbiGetIndexTypeDesc(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),Param2));
    ReturnOutputArg(AResult);
...
AResult := Integer(BDE.DbiGetErrorEntry(VarToInteger(GetInputArg(0)),Param1,PAnsiChar(AnsiString(VarToStr(GetInputArg(2))))));
    ReturnOutputArg(AResult);
...
begin
  with AMachine do
  begin
AResult := Integer(BDE.DbiGetErrorString(VarToInteger(GetInputArg(0)),PAnsiChar(AnsiString(VarToStr(GetInputArg(1))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(BDE.DbiGetErrorContext(VarToInteger(GetInputArg(0)),PAnsiChar(AnsiString(VarToStr(GetInputArg(1))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(BDE.DbiGetLdName(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(2))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(BDE.DbiAddPassword(PAnsiChar(AnsiString(VarToStr(GetInputArg(0))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(BDE.DbiDropPassword(PAnsiChar(AnsiString(VarToStr(GetInputArg(0))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(BDE.DbiGetNetUserName(PAnsiChar(AnsiString(VarToStr(GetInputArg(0))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(BDE.DbiDebugLayerOptions(VarToInteger(GetInputArg(0)),PAnsiChar(AnsiString(VarToStr(GetInputArg(1))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(BDE.OsLdInit(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(BDE.DbiDRDelete(PAnsiChar(AnsiString(VarToStr(GetInputArg(0))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(BDE.DbiDRDrop(PAnsiChar(AnsiString(VarToStr(GetInputArg(0))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(BDE.DbiSetDefaultRepository(PAnsiChar(AnsiString(VarToStr(GetInputArg(0))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(BDE.DbiGetDefaultRepository(PAnsiChar(AnsiString(VarToStr(GetInputArg(0))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  With Scripter.DefineClass(ClassType) do
  begin
    DefineMethod('ErrCat',1,tkInteger,nil,__ErrCat,false,0,'rslt: Word');
    DefineMethod('ErrCode',1,tkInteger,nil,__ErrCode,false,0,'rslt: Word');
    DefineMethod('DbiExit',0,tkInteger,nil,__DbiExit,false,0,'');
    DefineMethod('DbiDLLExit',0,tkInteger,nil,__DbiDLLExit,false,0,'');
    DefineMethod('DbiGetSysVersion',1,tkInteger,nil,__DbiGetSysVersion,false,0,'sysVersion: SYSVersion').SetVarArgs([0]);
    DefineMethod('DbiGetSysConfig',1,tkInteger,nil,__DbiGetSysConfig,false,0,'sysConfig: SYSConfig').SetVarArgs([0]);
    DefineMethod('DbiGetClientInfo',1,tkInteger,nil,__DbiGetClientInfo,false,0,'clientInfo: CLIENTInfo').SetVarArgs([0]);
    DefineMethod('DbiGetSysInfo',1,tkInteger,nil,__DbiGetSysInfo,false,0,'sysInfo: SYSInfo').SetVarArgs([0]);
    DefineMethod('DbiLoadDriver',1,tkInteger,nil,__DbiLoadDriver,false,0,'pszDriverType: PAnsiChar');
    DefineMethod('DbiGetSesInfo',1,tkInteger,nil,__DbiGetSesInfo,false,0,'sesInfo: SESInfo').SetVarArgs([0]);
    DefineMethod('DbiSetPrivateDir',1,tkInteger,nil,__DbiSetPrivateDir,false,0,'pszDir: PAnsiChar');
    DefineMethod('DbiGetDriverDesc',2,tkInteger,nil,__DbiGetDriverDesc,false,0,'pszDriverType: PAnsiChar; drvType: DRVType').SetVarArgs([1]);
    DefineMethod('DbiGetTableTypeDesc',3,tkInteger,nil,__DbiGetTableTypeDesc,false,0,'pszDriverType: PAnsiChar; pszTableType: PAnsiChar; tblType: TBLType').SetVarArgs([2]);
    DefineMethod('DbiGetFieldTypeDesc',4,tkInteger,nil,__DbiGetFieldTypeDesc,false,0,'pszDriverType: PAnsiChar; pszTableType: PAnsiChar; pszFieldType: PAnsiChar; fldType: FLDType').SetVarArgs([3]);
    DefineMethod('DbiGetIndexTypeDesc',3,tkInteger,nil,__DbiGetIndexTypeDesc,false,0,'pszDriverType: PAnsiChar; pszIndexType: PAnsiChar; idxType: IDXType').SetVarArgs([2]);
    DefineMethod('DbiCheckRefresh',0,tkInteger,nil,__DbiCheckRefresh,false,0,'');
    DefineMethod('DbiSetLockRetry',1,tkInteger,nil,__DbiSetLockRetry,false,0,'iWait: SmallInt');
    DefineMethod('DbiGetErrorEntry',3,tkInteger,nil,__DbiGetErrorEntry,false,0,'uEntry: Word; ulNativeError: Longint; pszError: PAnsiChar').SetVarArgs([1]);
    DefineMethod('DbiGetErrorInfo',2,tkInteger,nil,__DbiGetErrorInfo,false,0,'bFull: Bool; ErrInfo: DBIErrInfo').SetVarArgs([1]);
    DefineMethod('DbiGetErrorString',2,tkInteger,nil,__DbiGetErrorString,false,0,'rslt: DBIResult; pszError: PAnsiChar');
    DefineMethod('DbiGetErrorContext',2,tkInteger,nil,__DbiGetErrorContext,false,0,'eContext: SmallInt; pszContext: PAnsiChar');
    DefineMethod('DbiDateEncode',4,tkInteger,nil,__DbiDateEncode,false,0,'iMon: Word; iDay: Word; iYear: SmallInt; dateD: DBIDATE').SetVarArgs([3]);
    DefineMethod('DbiDateDecode',4,tkInteger,nil,__DbiDateDecode,false,0,'dateD: DBIDATE; iMon: Word; iDay: Word; iYear: SmallInt').SetVarArgs([1,2,3]);
    DefineMethod('DbiTimeEncode',4,tkInteger,nil,__DbiTimeEncode,false,0,'iHour: Word; iMin: Word; iMilSec: Word; timeT: Time').SetVarArgs([3]);
    DefineMethod('DbiTimeDecode',4,tkInteger,nil,__DbiTimeDecode,false,0,'timeT: Time; iHour: Word; iMin: Word; iMilSec: Word').SetVarArgs([1,2,3]);
    DefineMethod('DbiTimeStampEncode',3,tkInteger,nil,__DbiTimeStampEncode,false,0,'dateD: DBIDATE; timeT: Time; tsTS: TimeStamp').SetVarArgs([2]);
    DefineMethod('DbiTimeStampDecode',3,tkInteger,nil,__DbiTimeStampDecode,false,0,'tsTS: TIMESTAMP; dateD: DBIDATE; timeT: Time').SetVarArgs([1,2]);
    DefineMethod('DbiBcdFromFloat',4,tkInteger,nil,__DbiBcdFromFloat,false,0,'iVal: Double; iPrecision: Word; iPlaces: Word; Bcd: FMTBcd').SetVarArgs([0,3]);
    DefineMethod('DbiBcdToFloat',2,tkInteger,nil,__DbiBcdToFloat,false,0,'Bcd: FMTBcd; iVal: Double').SetVarArgs([0,1]);
    DefineMethod('DbiGetDateFormat',1,tkInteger,nil,__DbiGetDateFormat,false,0,'fmtDate: FMTDate').SetVarArgs([0]);
    DefineMethod('DbiSetDateFormat',1,tkInteger,nil,__DbiSetDateFormat,false,0,'fmtDate: FMTDate').SetVarArgs([0]);
    DefineMethod('DbiGetTimeFormat',1,tkInteger,nil,__DbiGetTimeFormat,false,0,'fmtTime: FMTTime').SetVarArgs([0]);
    DefineMethod('DbiSetTimeFormat',1,tkInteger,nil,__DbiSetTimeFormat,false,0,'fmtTime: FMTTime').SetVarArgs([0]);
    DefineMethod('DbiGetNumberFormat',1,tkInteger,nil,__DbiGetNumberFormat,false,0,'fmtNumber: FMTNumber').SetVarArgs([0]);
    DefineMethod('DbiSetNumberFormat',1,tkInteger,nil,__DbiSetNumberFormat,false,0,'fmtNumber: FMTNumber').SetVarArgs([0]);
    DefineMethod('DbiUseIdleTime',0,tkInteger,nil,__DbiUseIdleTime,false,0,'');
    DefineMethod('DbiGetLdName',3,tkInteger,nil,__DbiGetLdName,false,0,'pszDriver: PAnsiChar; pObjName: PAnsiChar; pLdName: PAnsiChar');
    DefineMethod('DbiAddPassword',1,tkInteger,nil,__DbiAddPassword,false,0,'pszPassword: PAnsiChar');
    DefineMethod('DbiDropPassword',1,tkInteger,nil,__DbiDropPassword,false,0,'pszPassword: PAnsiChar');
    DefineMethod('DbiGetNetUserName',1,tkInteger,nil,__DbiGetNetUserName,false,0,'pszNetUserName: PAnsiChar');
    DefineMethod('DbiDebugLayerOptions',2,tkInteger,nil,__DbiDebugLayerOptions,false,0,'iOption: Word; pDebugFile: PAnsiChar');
    DefineMethod('OsLdInit',2,tkInteger,nil,__OsLdInit,false,0,'pDefDir: PAnsiChar; pDefLangDr: PAnsiChar');
    DefineMethod('OsLdExit',0,tkInteger,nil,__OsLdExit,false,0,'');
    DefineMethod('OsLdSetConvChars',2,tkInteger,nil,__OsLdSetConvChars,false,0,'o2a: Shortint; a2o: Shortint');
    DefineMethod('DbiDRDelete',1,tkInteger,nil,__DbiDRDelete,false,0,'pszDrName: PAnsiChar');
    DefineMethod('DbiDRDrop',1,tkInteger,nil,__DbiDRDrop,false,0,'pszDrName: PAnsiChar');
    DefineMethod('DbiSetDefaultRepository',1,tkInteger,nil,__DbiSetDefaultRepository,false,0,'pszDRName: PAnsiChar');
    DefineMethod('DbiGetDefaultRepository',1,tkInteger,nil,__DbiGetDefaultRepository,false,0,'pszDRName: PAnsiChar');
