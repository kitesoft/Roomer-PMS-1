...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TComServerObject(CurrentObject).HelpFileName));
  end;
end;
...
begin
  with AMachine do
  begin
    TComServerObject(CurrentObject).HelpFileName:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TComServerObject(CurrentObject).ServerFileName));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TComServerObject(CurrentObject).ServerKey));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TComServerObject(CurrentObject).ServerName));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TComClassManagerClass(CurrentClass.ClassRef).Create);
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TComClassManager(CurrentObject).GetFactoryFromClassID(TGUIDWrapper(integer(GetInputArg(0))).ObjToRec));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TComObjectClass(CurrentClass.ClassRef).Create);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TComObject(CurrentObject).Error(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TComObject(CurrentObject).Factory));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TComObjectFactory(CurrentObject).ClassName));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TComObjectFactory(CurrentObject).ComServer));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TComObjectFactory(CurrentObject).Description));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TComObjectFactory(CurrentObject).ProgID));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TComObjectFactory(CurrentObject).Instancing));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TComObjectFactory(CurrentObject).ThreadingModel));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TTypedComObjectClass(CurrentClass.ClassRef).Create);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TAutoObjectClass(CurrentClass.ClassRef).Create);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TConnectionPoint(CurrentObject).SinkList));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TAutoObjectEventClass(CurrentClass.ClassRef).Create);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TAutoObjectEvent(CurrentObject).ConnectionPoint));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(EOleSysErrorClass(CurrentClass.ClassRef).Create(GetInputArg(0),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(EOleExceptionClass(CurrentClass.ClassRef).Create(VarToStr(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToStr(GetInputArg(2)),VarToStr(GetInputArg(3)),VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(EOleException(CurrentObject).HelpFile));
  end;
end;
...
begin
  with AMachine do
  begin
    EOleException(CurrentObject).HelpFile:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(EOleException(CurrentObject).Source));
  end;
end;
...
begin
  with AMachine do
  begin
    EOleException(CurrentObject).Source:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := integer(TGUIDWrapper.Create(ComObj.StringToGUID(VarToStr(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(ComObj.GUIDToString(TGUIDWrapper(integer(GetInputArg(0))).ObjToRec));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := integer(TGUIDWrapper.Create(ComObj.ProgIDToClassID(VarToStr(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(ComObj.ClassIDToProgID(TGUIDWrapper(integer(GetInputArg(0))).ObjToRec));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    Case InputArgCount of
      3: ComObj.CreateRegKey(VarToStr(GetInputArg(0)),VarToStr(GetInputArg(1)),VarToStr(GetInputArg(2)));
      4: ComObj.CreateRegKey(VarToStr(GetInputArg(0)),VarToStr(GetInputArg(1)),VarToStr(GetInputArg(2)),VarToInteger(GetInputArg(3)));
    end;
  end;
end;
...
begin
  ...
  begin
    Case InputArgCount of
      1: ComObj.DeleteRegKey(VarToStr(GetInputArg(0)));
      2: ComObj.DeleteRegKey(VarToStr(GetInputArg(0)),VarToInteger(GetInputArg(1)));
    end;
  end;
end;
...
begin
  ...
  begin
case InputArgCount of
2: AResult := string(ComObj.GetRegStringValue(VarToStr(GetInputArg(0)),VarToStr(GetInputArg(1))));
3: AResult := string(ComObj.GetRegStringValue(VarToStr(GetInputArg(0)),VarToStr(GetInputArg(1)),VarToInteger(GetInputArg(2))));
end;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := WideCharToString(ComObj.StringToLPOLESTR(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ComObj.RegisterComServer(VarToStr(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ComObj.RegisterAsService(VarToStr(GetInputArg(0)),VarToStr(GetInputArg(1)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(ComObj.CreateClassID);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(ComObj.ComClassManager);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    DefineMethod('GetRegRootAndPrefix',2,tkNone,nil,__TComServerObjectGetRegRootAndPrefix,true,0,'RootKey: HKEY; RootPrefix: string').SetVarArgs([0,1]);
  ...
  begin
    ...
    DefineMethod('GetFactoryFromClassID',1,tkClass,TComObjectFactory,__TComClassManagerGetFactoryFromClassID,false,0,'ClassID: TGUID');
  end;
  ...
  begin
    ...
    DefineMethod('ObjQueryInterface',2,tkInteger,nil,__TComObjectObjQueryInterface,false,0,'IID: TGUID; Obj').SetVarArgs([1]);
    DefineMethod('ObjRelease',0,tkInteger,nil,__TComObjectObjRelease,false,0,'');
    DefineMethod('Error',1,tkInteger,nil,__TComObjectError,false,0,'Msg: string');
  ...
  begin
    ...
    DefineMethod('UpdateRegistry',1,tkNone,nil,__TComObjectFactoryUpdateRegistry,false,0,'Register: Boolean');
  ...
  begin
    DefineMethod('UpdateRegistry',1,tkNone,nil,__TTypedComObjectFactoryUpdateRegistry,false,0,'Register: Boolean');
  end;
  ...
  begin
    DefineMethod('Create',3,tkClass,EOleSysError,__EOleSysErrorCreate,true,0,'Message: UnicodeString; ErrorCode: HRESULT; HelpContext: Integer');
  ...
  begin
    DefineMethod('Create',5,tkClass,EOleException,__EOleExceptionCreate,true,0,'Message: string; ErrorCode: HRESULT; Source: string; HelpFile: string; HelpContext: Integer');
  ...
  begin
    DefineMethod('DispatchInvokeError',2,tkNone,nil,__DispatchInvokeError,false,0,'Status: Integer; ExcepInfo: TExcepInfo');
    DefineMethod('OleError',1,tkNone,nil,__OleError,false,0,'ErrorCode: HResult');
    DefineMethod('OleCheck',1,tkNone,nil,__OleCheck,false,0,'Result: HResult');
    DefineMethod('StringToGUID',1,tkVariant,nil,__StringToGUID,false,0,'S: string');
    DefineMethod('GUIDToString',1,tkVariant,nil,__GUIDToString,false,0,'ClassID: TGUID');
    DefineMethod('ProgIDToClassID',1,tkVariant,nil,__ProgIDToClassID,false,0,'ProgID: string');
    DefineMethod('ClassIDToProgID',1,tkVariant,nil,__ClassIDToProgID,false,0,'ClassID: TGUID');
    DefineMethod('CreateRegKey',4,tkNone,nil,__CreateRegKey,false,1,'Key: string; ValueName: string; Value: string; RootKey: DWord = HKEY_CLASSES_ROOT');
    DefineMethod('DeleteRegKey',2,tkNone,nil,__DeleteRegKey,false,1,'Key: string; RootKey: DWord = HKEY_CLASSES_ROOT');
    DefineMethod('GetRegStringValue',3,tkVariant,nil,__GetRegStringValue,false,1,'Key: string; ValueName: string; RootKey: DWord = HKEY_CLASSES_ROOT');
    DefineMethod('StringToLPOLESTR',1,tkVariant,nil,__StringToLPOLESTR,false,0,'Source: string');
    DefineMethod('RegisterComServer',1,tkNone,nil,__RegisterComServer,false,0,'DLLName: string');
    DefineMethod('RegisterAsService',2,tkNone,nil,__RegisterAsService,false,0,'ClassID: string; ServiceName: string');
