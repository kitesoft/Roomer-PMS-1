...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomTreeView(CurrentObject).GetDragImages);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TConversionClass(CurrentClass.ClassRef).Create);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TListGroupClass(CurrentClass.ClassRef).Create(TCollection(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TListGroup(CurrentObject).Assign(TPersistent(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TListGroupsClass(CurrentClass.ClassRef).Create(TCustomListView(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TListGroups(CurrentObject).Add);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TListGroups(CurrentObject).Owner);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TListGroups(CurrentObject).Items[VarToInteger(GetArrayIndex(0))]));
  end;
end;
...
begin
  with AMachine do
  begin
    TListGroups(CurrentObject).Items[VarToInteger(GetArrayIndex(0))]:=TListGroup(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomListView(CurrentObject).GetDragImages);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomListView(CurrentObject).Items));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomListView(CurrentObject).Items:=TListItems(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  ...
  begin
    DefineMethod('Create',1,tkClass,TListGroup,__TListGroupCreate,true,0,'Collection: TCollection');
    DefineMethod('Destroy',0,tkNone,nil,__TListGroupDestroy,false,0,'');
    DefineMethod('Assign',1,tkNone,nil,__TListGroupAssign,false,0,'Source: TPersistent');
  end;
  With Scripter.DefineClass(TListGroups) do
  begin
    DefineMethod('Create',1,tkClass,TListGroups,__TListGroupsCreate,true,0,'AOwner: TCustomListView');
