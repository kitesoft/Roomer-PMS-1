...
type
  TatStrHlprLibrary = class(TatScripterLibrary)
    ...
    procedure __UnicodeFromUTF8(AMachine: TatVirtualMachine);
    procedure __WideFromUTF8(AMachine: TatVirtualMachine);
...
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
    StrHlpr.AnsiFromPWideChar(Param0,StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)));
    SetInputArg(0,Param0);
  end;
end;
...
Param0 := GetInputArg(0);
    Case InputArgCount of
      2: StrHlpr.WideFromPChar(Param0,PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))));
      3: StrHlpr.WideFromPChar(Param0,PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),GetInputArg(2));
    end;
    SetInputArg(0,Param0);
  end;
end;
...
Param0 := GetInputArg(0);
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
    StrHlpr.UnicodeFromPWideChar(Param0,StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)));
    SetInputArg(0,Param0);
  end;
end;
...
Param0 := GetInputArg(0);
    Case InputArgCount of
      2: StrHlpr.UnicodeFromPChar(Param0,PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))));
      3: StrHlpr.UnicodeFromPChar(Param0,PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),GetInputArg(2));
    end;
    SetInputArg(0,Param0);
  end;
end;
...
procedure TatStrHlprLibrary.__UnicodeFromUTF8(AMachine: TatVirtualMachine);
  var
  Param0: UnicodeString;
begin
  with AMachine do
  begin
Param0 := GetInputArg(0);
    StrHlpr.UnicodeFromUTF8(Param0,PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))));
    SetInputArg(0,Param0);
  end;
end;

procedure TatStrHlprLibrary.__WideFromUTF8(AMachine: TatVirtualMachine);
  var
  Param0: WideString;
begin
  with AMachine do
  begin
Param0 := GetInputArg(0);
    StrHlpr.WideFromUTF8(Param0,PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))));
    SetInputArg(0,Param0);
  end;
end;
...
begin
  ...
  begin
    DefineMethod('AnsiCat',2,tkVariant,nil,__AnsiCat,false,0,'x: RawByteString; y: RawByteString').SetVarArgs([0,1]);
    DefineMethod('AnsiCopy',3,tkVariant,nil,__AnsiCopy,false,0,'src: RawByteString; index: Integer; count: Integer').SetVarArgs([0]);
    DefineMethod('AnsiPos',2,tkInteger,nil,__AnsiPos,false,0,'src: RawByteString; sub: RawByteString').SetVarArgs([0,1]);
    DefineMethod('AnsiAppend',2,tkNone,nil,__AnsiAppend,false,0,'dst: RawByteString; src: RawByteString').SetVarArgs([0,1]);
    DefineMethod('AnsiFromWide',2,tkNone,nil,__AnsiFromWide,false,0,'dst: RawByteString; src: WideString').SetVarArgs([0,1]);
    DefineMethod('AnsiFromUnicode',2,tkNone,nil,__AnsiFromUnicode,false,0,'dst: RawByteString; src: UnicodeString').SetVarArgs([0,1]);
    DefineMethod('AnsiInsert',3,tkNone,nil,__AnsiInsert,false,0,'dst: RawByteString; src: RawByteString; index: Integer').SetVarArgs([0,1]);
    DefineMethod('AnsiEqual',2,tkVariant,nil,__AnsiEqual,false,0,'x: RawByteString; y: RawByteString').SetVarArgs([0,1]);
    DefineMethod('AnsiFromPWideChar',2,tkNone,nil,__AnsiFromPWideChar,false,0,'dst: RawByteString; src: PWideChar').SetVarArgs([0]);
    DefineMethod('AnsiDelete',3,tkNone,nil,__AnsiDelete,false,0,'dst: RawByteString; index: Integer; count: Integer').SetVarArgs([0]);
    DefineMethod('AnsiSetLength',2,tkNone,nil,__AnsiSetLength,false,0,'dst: RawByteString; len: Integer').SetVarArgs([0]);
    DefineMethod('AnsiFree',1,tkNone,nil,__AnsiFree,false,0,'s: RawByteString').SetVarArgs([0]);
    DefineMethod('AnsiAssign',2,tkNone,nil,__AnsiAssign,false,0,'dst: RawByteString; src: RawByteString').SetVarArgs([0,1]);
    DefineMethod('WideAppend',2,tkNone,nil,__WideAppend,false,0,'dst: WideString; src: WideString').SetVarArgs([0,1]);
    DefineMethod('WideCat',2,tkVariant,nil,__WideCat,false,0,'x: WideString; y: WideString').SetVarArgs([0,1]);
    DefineMethod('WideCopy',3,tkVariant,nil,__WideCopy,false,0,'src: WideString; index: Integer; count: Integer').SetVarArgs([0]);
    DefineMethod('WideEqual',2,tkVariant,nil,__WideEqual,false,0,'x: WideString; y: WideString').SetVarArgs([0,1]);
    DefineMethod('WideGreater',2,tkVariant,nil,__WideGreater,false,0,'x: WideString; y: WideString').SetVarArgs([0,1]);
    DefineMethod('WideLength',1,tkInteger,nil,__WideLength,false,0,'src: WideString').SetVarArgs([0]);
    DefineMethod('WideLess',2,tkVariant,nil,__WideLess,false,0,'x: WideString; y: WideString').SetVarArgs([0,1]);
    DefineMethod('WidePos',2,tkInteger,nil,__WidePos,false,0,'src: WideString; sub: WideString').SetVarArgs([0,1]);
    DefineMethod('WideFromAnsi',2,tkNone,nil,__WideFromAnsi,false,0,'dst: WideString; src: RawByteString').SetVarArgs([0,1]);
    DefineMethod('WideFromUnicode',2,tkNone,nil,__WideFromUnicode,false,0,'dst: WideString; src: UnicodeString').SetVarArgs([0,1]);
    DefineMethod('WideInsert',3,tkNone,nil,__WideInsert,false,0,'dst: WideString; src: WideString; index: Integer').SetVarArgs([0,1]);
    DefineMethod('WideFromPChar',3,tkNone,nil,__WideFromPChar,false,1,'dst: WideString; src: PAnsiChar; IsUTF8: Boolean = False').SetVarArgs([0]);
    DefineMethod('WideDelete',3,tkNone,nil,__WideDelete,false,0,'dst: WideString; index: Integer; count: Integer').SetVarArgs([0]);
    DefineMethod('WideSetLength',2,tkNone,nil,__WideSetLength,false,0,'dst: WideString; len: Integer').SetVarArgs([0]);
    DefineMethod('WideFree',1,tkNone,nil,__WideFree,false,0,'s: WideString').SetVarArgs([0]);
    DefineMethod('WideAssign',2,tkNone,nil,__WideAssign,false,0,'dst: WideString; src: WideString').SetVarArgs([0,1]);
    DefineMethod('UnicodeCat',2,tkVariant,nil,__UnicodeCat,false,0,'x: UnicodeString; y: UnicodeString').SetVarArgs([0,1]);
    DefineMethod('UnicodeCopy',3,tkVariant,nil,__UnicodeCopy,false,0,'src: UnicodeString; index: Integer; count: Integer').SetVarArgs([0]);
    DefineMethod('UnicodePos',2,tkInteger,nil,__UnicodePos,false,0,'src: UnicodeString; sub: UnicodeString').SetVarArgs([0,1]);
    DefineMethod('UnicodeAppend',2,tkNone,nil,__UnicodeAppend,false,0,'dst: UnicodeString; src: UnicodeString').SetVarArgs([0,1]);
    DefineMethod('UnicodeDelete',3,tkNone,nil,__UnicodeDelete,false,0,'dst: UnicodeString; index: Integer; count: Integer').SetVarArgs([0]);
    DefineMethod('UnicodeFromAnsi',2,tkNone,nil,__UnicodeFromAnsi,false,0,'dst: UnicodeString; src: RawByteString').SetVarArgs([0,1]);
    DefineMethod('UnicodeFromWide',2,tkNone,nil,__UnicodeFromWide,false,0,'dst: UnicodeString; src: WideString').SetVarArgs([0,1]);
    DefineMethod('UnicodeInsert',3,tkNone,nil,__UnicodeInsert,false,0,'dst: UnicodeString; src: UnicodeString; index: Integer').SetVarArgs([0,1]);
    DefineMethod('UnicodeEqual',2,tkVariant,nil,__UnicodeEqual,false,0,'x: UnicodeString; y: UnicodeString').SetVarArgs([0,1]);
    DefineMethod('UnicodeGreater',2,tkVariant,nil,__UnicodeGreater,false,0,'x: UnicodeString; y: UnicodeString').SetVarArgs([0,1]);
    DefineMethod('UnicodeLess',2,tkVariant,nil,__UnicodeLess,false,0,'x: UnicodeString; y: UnicodeString').SetVarArgs([0,1]);
    DefineMethod('UnicodeFromPWideChar',2,tkNone,nil,__UnicodeFromPWideChar,false,0,'dst: UnicodeString; src: PWideChar').SetVarArgs([0]);
    DefineMethod('UnicodeFromPChar',3,tkNone,nil,__UnicodeFromPChar,false,1,'dst: UnicodeString; src: PAnsiChar; IsUTF8: Boolean = False').SetVarArgs([0]);
    DefineMethod('UnicodeSetLength',2,tkNone,nil,__UnicodeSetLength,false,0,'dst: UnicodeString; len: Integer').SetVarArgs([0]);
    DefineMethod('UnicodeFree',1,tkNone,nil,__UnicodeFree,false,0,'s: UnicodeString').SetVarArgs([0]);
    DefineMethod('UnicodeAssign',2,tkNone,nil,__UnicodeAssign,false,0,'dst: UnicodeString; src: UnicodeString').SetVarArgs([0,1]);
    DefineMethod('UnicodeFromUTF8',2,tkNone,nil,__UnicodeFromUTF8,false,0,'dst: UnicodeString; src: PAnsiChar').SetVarArgs([0]);
    DefineMethod('WideFromUTF8',2,tkNone,nil,__WideFromUTF8,false,0,'dst: WideString; src: PAnsiChar').SetVarArgs([0]);
  end;
end;
