...
begin
  with AMachine do
  begin
AResult := Math.RoundTo(GetInputArg(0),TRoundToEXRangeExtended(VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('SinCos',3,tkNone,nil,__SinCos,false,0,'Theta: Single; Sin: Single; Cos: Single').SetVarArgs([1,2]);
    DefineMethod('Tan',1,tkVariant,nil,__Tan,false,0,'X: Single');
    DefineMethod('Cotan',1,tkVariant,nil,__Cotan,false,0,'X: Single');
    DefineMethod('Secant',1,tkVariant,nil,__Secant,false,0,'X: Single');
    DefineMethod('Cosecant',1,tkVariant,nil,__Cosecant,false,0,'X: Single');
    DefineMethod('Hypot',2,tkVariant,nil,__Hypot,false,0,'X: Single; Y: Single');
    DefineMethod('RadToDeg',1,tkVariant,nil,__RadToDeg,false,0,'Radians: Single');
    DefineMethod('RadToGrad',1,tkVariant,nil,__RadToGrad,false,0,'Radians: Single');
    DefineMethod('RadToCycle',1,tkVariant,nil,__RadToCycle,false,0,'Radians: Single');
    DefineMethod('DegToRad',1,tkVariant,nil,__DegToRad,false,0,'Degrees: Single');
    DefineMethod('DegToGrad',1,tkVariant,nil,__DegToGrad,false,0,'Degrees: Single');
    DefineMethod('DegToCycle',1,tkVariant,nil,__DegToCycle,false,0,'Degrees: Single');
    DefineMethod('GradToRad',1,tkVariant,nil,__GradToRad,false,0,'Grads: Single');
    DefineMethod('GradToDeg',1,tkVariant,nil,__GradToDeg,false,0,'Grads: Single');
    DefineMethod('GradToCycle',1,tkVariant,nil,__GradToCycle,false,0,'Grads: Single');
    DefineMethod('CycleToRad',1,tkVariant,nil,__CycleToRad,false,0,'Cycles: Single');
    DefineMethod('CycleToDeg',1,tkVariant,nil,__CycleToDeg,false,0,'Cycles: Single');
    DefineMethod('CycleToGrad',1,tkVariant,nil,__CycleToGrad,false,0,'Cycles: Single');
    DefineMethod('Cot',1,tkVariant,nil,__Cot,false,0,'X: Single');
    DefineMethod('Sec',1,tkVariant,nil,__Sec,false,0,'X: Single');
    DefineMethod('Csc',1,tkVariant,nil,__Csc,false,0,'X: Single');
    DefineMethod('Cosh',1,tkVariant,nil,__Cosh,false,0,'X: Single');
    DefineMethod('Sinh',1,tkVariant,nil,__Sinh,false,0,'X: Single');
    DefineMethod('Tanh',1,tkVariant,nil,__Tanh,false,0,'X: Single');
    DefineMethod('CotH',1,tkVariant,nil,__CotH,false,0,'X: Single');
    DefineMethod('SecH',1,tkVariant,nil,__SecH,false,0,'X: Single');
    DefineMethod('CscH',1,tkVariant,nil,__CscH,false,0,'X: Single');
    DefineMethod('ArcCot',1,tkVariant,nil,__ArcCot,false,0,'X: Single');
    DefineMethod('ArcSec',1,tkVariant,nil,__ArcSec,false,0,'X: Single');
    DefineMethod('ArcCsc',1,tkVariant,nil,__ArcCsc,false,0,'X: Single');
    DefineMethod('ArcCosh',1,tkVariant,nil,__ArcCosh,false,0,'X: Single');
    DefineMethod('ArcSinh',1,tkVariant,nil,__ArcSinh,false,0,'X: Single');
    DefineMethod('ArcTanh',1,tkVariant,nil,__ArcTanh,false,0,'X: Single');
    DefineMethod('ArcCotH',1,tkVariant,nil,__ArcCotH,false,0,'X: Single');
    DefineMethod('ArcSecH',1,tkVariant,nil,__ArcSecH,false,0,'X: Single');
    DefineMethod('ArcCscH',1,tkVariant,nil,__ArcCscH,false,0,'X: Single');
    DefineMethod('LnXP1',1,tkVariant,nil,__LnXP1,false,0,'X: Single');
    DefineMethod('Log10',1,tkVariant,nil,__Log10,false,0,'X: Single');
    DefineMethod('Log2',1,tkVariant,nil,__Log2,false,0,'X: Single');
    DefineMethod('LogN',2,tkVariant,nil,__LogN,false,0,'Base: Single; X: Single');
    DefineMethod('IntPower',2,tkVariant,nil,__IntPower,false,0,'Base: Single; Exponent: Integer');
    ...
    DefineMethod('Ldexp',2,tkVariant,nil,__Ldexp,false,0,'X: Single; P: Integer');
    DefineMethod('Ceil',1,tkInteger,nil,__Ceil,false,0,'X: Single');
    DefineMethod('Floor',1,tkInteger,nil,__Floor,false,0,'X: Single');
    ...
    DefineMethod('RandG',2,tkVariant,nil,__RandG,false,0,'Mean: Single; StdDev: Single');
    DefineMethod('IsNan',1,tkVariant,nil,__IsNan,false,0,'AValue: Double');
    DefineMethod('IsInfinite',1,tkVariant,nil,__IsInfinite,false,0,'AValue: Single');
    ...
    DefineMethod('RoundTo',2,tkVariant,nil,__RoundTo,false,0,'AValue: Extended; ADigit: TRoundToEXRangeExtended');
    DefineMethod('SimpleRoundTo',2,tkVariant,nil,__SimpleRoundTo,false,1,'AValue: Single; ADigit: TRoundToRange = -2');
