...
type
  TatActnManLibrary = class(TatScripterLibrary)
    ...
    procedure __TCommandPropertiesCreate(AMachine: TatVirtualMachine);
    procedure __TCommandPropertiesAssign(AMachine: TatVirtualMachine);
    procedure __GetTCommandPropertiesControl(AMachine: TatVirtualMachine);
    procedure __GetTCommandPropertiesActionClientItem(AMachine: TatVirtualMachine);
    procedure __SetTCommandPropertiesActionClientItem(AMachine: TatVirtualMachine);
    ...
    procedure __TButtonPropertiesCreate(AMachine: TatVirtualMachine);
    procedure __TButtonPropertiesAssign(AMachine: TatVirtualMachine);
    procedure __TGalleryPropertiesCreate(AMachine: TatVirtualMachine);
    procedure __TGalleryPropertiesAssign(AMachine: TatVirtualMachine);
    procedure __TGalleryPropertiesGetGalleryType(AMachine: TatVirtualMachine);
    procedure __TGalleryPropertiesSetGalleryType(AMachine: TatVirtualMachine);
    procedure __TGalleryPropertiesGetItemsPerRow(AMachine: TatVirtualMachine);
    procedure __TGalleryPropertiesSetItemsPerRow(AMachine: TatVirtualMachine);
...
begin
  with AMachine do
  begin
AResult := string(TActionBarStyle(CurrentObject).GetStyleName);
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomActionManagerClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
2: AResult := ObjectToVar(TCustomActionManager(CurrentObject).AddAction(TCustomAction(VarToObject(GetInputArg(0))),TActionClient(VarToObject(GetInputArg(1)))));
3: AResult := ObjectToVar(TCustomActionManager(CurrentObject).AddAction(TCustomAction(VarToObject(GetInputArg(0))),TActionClient(VarToObject(GetInputArg(1))),GetInputArg(2)));
end;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
case InputArgCount of
2: AResult := ObjectToVar(TCustomActionManager(CurrentObject).AddCategory(VarToStr(GetInputArg(0)),TActionClient(VarToObject(GetInputArg(1)))));
3: AResult := ObjectToVar(TCustomActionManager(CurrentObject).AddCategory(VarToStr(GetInputArg(0)),TActionClient(VarToObject(GetInputArg(1))),GetInputArg(2)));
end;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
case InputArgCount of
1: AResult := ObjectToVar(TCustomActionManager(CurrentObject).AddSeparator(TActionClientItem(VarToObject(GetInputArg(0)))));
2: AResult := ObjectToVar(TCustomActionManager(CurrentObject).AddSeparator(TActionClientItem(VarToObject(GetInputArg(0))),GetInputArg(1)));
end;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomActionManager(CurrentObject).Assign(TPersistent(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomActionManager(CurrentObject).DeleteItem(VarToStr(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomActionManager(CurrentObject).FindItemByCaption(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomActionManager(CurrentObject).FindItemByAction(TCustomAction(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomActionManager(CurrentObject).LoadFromFile(VarToStr(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomActionManager(CurrentObject).LoadFromStream(TStream(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomActionManager(CurrentObject).SaveToFile(VarToStr(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomActionManager(CurrentObject).SaveToStream(TStream(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomActionManager(CurrentObject).ActionBars));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomActionManager(CurrentObject).ActionBars:=TActionBars(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomActionManager(CurrentObject).DefaultActionBars));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomActionManager(CurrentObject).DisabledImages));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomActionManager(CurrentObject).DisabledImages:=TCustomImageList(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomActionManager(CurrentObject).LargeDisabledImages));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomActionManager(CurrentObject).LargeDisabledImages:=TCustomImageList(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomActionManager(CurrentObject).LargeImages));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomActionManager(CurrentObject).LargeImages:=TCustomImageList(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomActionManager(CurrentObject).LinkedActionLists));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomActionManager(CurrentObject).LinkedActionLists:=TActionListCollection(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TCustomActionManager(CurrentObject).FileName));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomActionManager(CurrentObject).FileName:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomActionManager(CurrentObject).PrioritySchedule));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomActionManager(CurrentObject).PrioritySchedule:=TStringList(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomActionManager(CurrentObject).Style));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomActionManager(CurrentObject).Style:=TActionBarStyle(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    TActionListItem(CurrentObject).Assign(TPersistent(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TActionListCollection(CurrentObject).ActionManager));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TActionListCollection(CurrentObject).ListItems[VarToInteger(GetArrayIndex(0))]));
  end;
end;
...
begin
  with AMachine do
  begin
    TActionListCollection(CurrentObject).ListItems[VarToInteger(GetArrayIndex(0))]:=TActionListItem(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TActionClientsCollection(CurrentObject).ActionManager));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TActionClientClass(CurrentClass.ClassRef).Create(TCollection(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TActionClient(CurrentObject).Assign(TPersistent(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TActionClient(CurrentObject).ActionBar));
  end;
end;
...
begin
  with AMachine do
  begin
    TActionClient(CurrentObject).ActionBar:=TCustomActionBar(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TActionClient(CurrentObject).ChildActionBar));
  end;
end;
...
begin
  with AMachine do
  begin
    TActionClient(CurrentObject).ChildActionBar:=TCustomActionBar(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TActionClient(CurrentObject).OwningCollection));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TActionBarItemClass(CurrentClass.ClassRef).Create(TCollection(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TActionBars(CurrentObject).Add);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TActionBars(CurrentObject).ActionBars[VarToInteger(GetArrayIndex(0))]));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TActionClients(CurrentObject).Add);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TActionClients(CurrentObject).Assign(TPersistent(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TActionClients(CurrentObject).ActionClients[VarToInteger(GetArrayIndex(0))]));
  end;
end;
...
begin
  with AMachine do
  begin
    TActionClients(CurrentObject).ActionClients[VarToInteger(GetArrayIndex(0))]:=TActionClientItem(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TActionClients(CurrentObject).ActionManager));
  end;
end;

procedure TatActnManLibrary.__TCommandPropertiesCreate(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCommandPropertiesClass(CurrentClass.ClassRef).Create(TActionClientItem(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatActnManLibrary.__TCommandPropertiesAssign(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCommandProperties(CurrentObject).Assign(TPersistent(VarToObject(GetInputArg(0))));
  end;
end;

procedure TatActnManLibrary.__GetTCommandPropertiesControl(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCommandProperties(CurrentObject).Control));
  end;
end;

procedure TatActnManLibrary.__GetTCommandPropertiesActionClientItem(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCommandProperties(CurrentObject).ActionClientItem));
  end;
end;

procedure TatActnManLibrary.__SetTCommandPropertiesActionClientItem(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCommandProperties(CurrentObject).ActionClientItem:=TActionClientItem(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCheckBoxPropertiesClass(CurrentClass.ClassRef).Create(TActionClientItem(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TCheckBoxProperties(CurrentObject).Assign(TPersistent(VarToObject(GetInputArg(0))));
  end;
end;

procedure TatActnManLibrary.__TButtonPropertiesCreate(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := ObjectToVar(TButtonPropertiesClass(CurrentClass.ClassRef).Create(TActionClientItem(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatActnManLibrary.__TButtonPropertiesAssign(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TButtonProperties(CurrentObject).Assign(TPersistent(VarToObject(GetInputArg(0))));
  end;
end;

procedure TatActnManLibrary.__TGalleryPropertiesCreate(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := ObjectToVar(TGalleryPropertiesClass(CurrentClass.ClassRef).Create(TActionClientItem(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatActnManLibrary.__TGalleryPropertiesAssign(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TGalleryProperties(CurrentObject).Assign(TPersistent(VarToObject(GetInputArg(0))));
  end;
end;

procedure TatActnManLibrary.__TGalleryPropertiesGetGalleryType(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := TGalleryProperties(CurrentObject).GetGalleryType;
    ReturnOutputArg(AResult);
  end;
end;

procedure TatActnManLibrary.__TGalleryPropertiesSetGalleryType(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TGalleryProperties(CurrentObject).SetGalleryType(GetInputArg(0));
  end;
end;

procedure TatActnManLibrary.__TGalleryPropertiesGetItemsPerRow(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(TGalleryProperties(CurrentObject).GetItemsPerRow);
    ReturnOutputArg(AResult);
  end;
end;

procedure TatActnManLibrary.__TGalleryPropertiesSetItemsPerRow(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TGalleryProperties(CurrentObject).SetItemsPerRow(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TTextPropertiesClass(CurrentClass.ClassRef).Create(TActionClientItem(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TTextProperties(CurrentObject).Assign(TPersistent(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TControlPropertiesClass(CurrentClass.ClassRef).Create(TActionClientItem(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TControlProperties(CurrentObject).Assign(TPersistent(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TMenuPropertiesClass(CurrentClass.ClassRef).Create(TActionClientItem(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TMenuProperties(CurrentObject).Assign(TPersistent(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TComboBoxPropertiesClass(CurrentClass.ClassRef).Create(TActionClientItem(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TActionClientItemClass(CurrentClass.ClassRef).Create(TCollection(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TActionClientItem(CurrentObject).Assign(TPersistent(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TActionClientItem(CurrentObject).ActionClients));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TActionClientItem(CurrentObject).ActionLink));
  end;
end;
...
begin
  with AMachine do
  begin
    TActionClientItem(CurrentObject).ActionLink:=TActionClientLink(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TActionClientItem(CurrentObject).Control));
  end;
end;
...
begin
  with AMachine do
  begin
    TActionClientItem(CurrentObject).Control:=TCustomActionControl(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TActionClientItem(CurrentObject).ParentItem));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TActionClientItem(CurrentObject).ShortCutText));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TActionDragBaseClass(CurrentObject).ActionManager));
  end;
end;
...
begin
  with AMachine do
  begin
    TActionDragBaseClass(CurrentObject).ActionManager:=TCustomActionManager(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TActionDragObjectClass(CurrentClass.ClassRef).Create);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TActionDragObject(CurrentObject).AddAction(TContainedAction(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TActionDragObject(CurrentObject).AddActionClass(TCustomActionClass(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TActionDragObject(CurrentObject).Actions[VarToInteger(GetArrayIndex(0))]));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCategoryDragObjectClass(CurrentClass.ClassRef).Create(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TCategoryDragObject(CurrentObject).Category));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TActionItemDragObject(CurrentObject).ClientItem));
  end;
end;
...
begin
  with AMachine do
  begin
    TActionItemDragObject(CurrentObject).ClientItem:=TActionClientItem(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomActionBarColorMapClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomActionBarColorMap(CurrentObject).Assign(TPersistent(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomActionBarColorMap(CurrentObject).BtnFrameColor));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomActionBarColorMap(CurrentObject).BtnFrameColor:=TColor(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomActionBarColorMap(CurrentObject).BtnSelectedColor));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomActionBarColorMap(CurrentObject).BtnSelectedColor:=TColor(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomActionBarColorMap(CurrentObject).BtnSelectedFont));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomActionBarColorMap(CurrentObject).BtnSelectedFont:=TColor(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomActionBarColorMap(CurrentObject).Color));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomActionBarColorMap(CurrentObject).Color:=TColor(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomActionBarColorMap(CurrentObject).DesignFocus));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomActionBarColorMap(CurrentObject).DesignFocus:=TColor(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomActionBarColorMap(CurrentObject).DisabledColor));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomActionBarColorMap(CurrentObject).DisabledColor:=TColor(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomActionBarColorMap(CurrentObject).DisabledFontColor));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomActionBarColorMap(CurrentObject).DisabledFontColor:=TColor(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomActionBarColorMap(CurrentObject).DisabledFontShadow));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomActionBarColorMap(CurrentObject).DisabledFontShadow:=TColor(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomActionBarColorMap(CurrentObject).FontColor));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomActionBarColorMap(CurrentObject).FontColor:=TColor(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomActionBarColorMap(CurrentObject).FrameTopLeftInner));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomActionBarColorMap(CurrentObject).FrameTopLeftInner:=TColor(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomActionBarColorMap(CurrentObject).FrameTopLeftOuter));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomActionBarColorMap(CurrentObject).FrameTopLeftOuter:=TColor(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomActionBarColorMap(CurrentObject).FrameBottomRightInner));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomActionBarColorMap(CurrentObject).FrameBottomRightInner:=TColor(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomActionBarColorMap(CurrentObject).FrameBottomRightOuter));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomActionBarColorMap(CurrentObject).FrameBottomRightOuter:=TColor(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomActionBarColorMap(CurrentObject).HighlightColor));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomActionBarColorMap(CurrentObject).HighlightColor:=TColor(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomActionBarColorMap(CurrentObject).HotColor));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomActionBarColorMap(CurrentObject).HotColor:=TColor(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomActionBarColorMap(CurrentObject).HotFontColor));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomActionBarColorMap(CurrentObject).HotFontColor:=TColor(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomActionBarColorMap(CurrentObject).MenuColor));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomActionBarColorMap(CurrentObject).MenuColor:=TColor(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomActionBarColorMap(CurrentObject).SelectedColor));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomActionBarColorMap(CurrentObject).SelectedColor:=TColor(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomActionBarColorMap(CurrentObject).SelectedFontColor));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomActionBarColorMap(CurrentObject).SelectedFontColor:=TColor(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomActionBarColorMap(CurrentObject).ShadowColor));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomActionBarColorMap(CurrentObject).ShadowColor:=TColor(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomActionBarColorMap(CurrentObject).UnusedColor));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomActionBarColorMap(CurrentObject).UnusedColor:=TColor(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomActionBarClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomActionBar(CurrentObject).CreateControl(TActionClientItem(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomActionBar(CurrentObject).DoDropCategory(TCategoryDragObject(VarToObject(GetInputArg(0))),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomActionBar(CurrentObject).FindAccelItem(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomActionBar(CurrentObject).DragDrop(TObject(VarToObject(GetInputArg(0))),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomActionBar(CurrentObject).FindFirst);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomActionBar(CurrentObject).FindFirstVisibleItem);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomActionBar(CurrentObject).FindLastVisibleItem);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomActionBar(CurrentObject).Style);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomActionBar(CurrentObject).ActionManager));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomActionBar(CurrentObject).ActionManager:=TCustomActionManager(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomActionBar(CurrentObject).ActionClient));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomActionBar(CurrentObject).ActionClient:=TActionClient(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomActionBar(CurrentObject).Canvas));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomActionBar(CurrentObject).ColorMap));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomActionBar(CurrentObject).ColorMap:=TCustomActionBarColorMap(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomActionBar(CurrentObject).Orientation));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomActionBar(CurrentObject).Orientation:=TBarOrientation(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomActionBar(CurrentObject).ActionControls[VarToInteger(GetArrayIndex(0))]));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomActionControlClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomActionControl(CurrentObject).DragDrop(TObject(VarToObject(GetInputArg(0))),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomActionControl(CurrentObject).ActionBar));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomActionControl(CurrentObject).ActionClient));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomActionControl(CurrentObject).ActionClient:=TActionClientItem(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomActionControl(CurrentObject).GlyphLayout));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomActionControl(CurrentObject).GlyphLayout:=TButtonLayout(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TActionBarStyleList(CurrentObject).Style[VarToInteger(GetArrayIndex(0))]));
  end;
end;
...
begin
  ...
  begin
    ...
    ControlTemp := ObjectToVar(Control);
    if Assigned(Scripter) and (RoutineName > '') then
      Scripter.ExecuteSubroutine(RoutineName, [Sender,ControlTemp]);
    Control := TCustomActionControl(VarToObject(ControlTemp));
    if AssignedMethod(AfterCall) then
...
begin
  with AMachine do
  begin
    ActnMan.NotifyDesigner(TCustomActionBar(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(ActnMan.cDefaultSchedule));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(ActnMan.ActionBarStyles));
  end;
end;
...
begin
  with AMachine do
  begin
    ActnMan.ActionBarStyles:=TActionBarStyleList(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(ActnMan.DefaultActnBarStyle));
  end;
end;
...
begin
  with AMachine do
  begin
    ActnMan.DefaultActnBarStyle:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  ...
  begin
    DefineMethod('Create',1,tkClass,TCustomActionManager,__TCustomActionManagerCreate,true,0,'AOwner: TComponent');
    DefineMethod('Destroy',0,tkNone,nil,__TCustomActionManagerDestroy,false,0,'');
    DefineMethod('AddAction',3,tkClass,TActionClientItem,__TCustomActionManagerAddAction,false,1,'AnAction: TCustomAction; AClient: TActionClient; After: Boolean = True');
    DefineMethod('AddCategory',3,tkClass,TActionClientItem,__TCustomActionManagerAddCategory,false,1,'ACategory: string; AClient: TActionClient; After: Boolean = True');
    DefineMethod('AddSeparator',2,tkClass,TActionClientItem,__TCustomActionManagerAddSeparator,false,1,'AnItem: TActionClientItem; After: Boolean = True');
    DefineMethod('Assign',1,tkNone,nil,__TCustomActionManagerAssign,false,0,'Source: TPersistent');
    DefineMethod('DeleteItem',1,tkNone,nil,__TCustomActionManagerDeleteItem,false,0,'Caption: string');
    DefineMethod('FindItemByCaption',1,tkClass,TActionClientItem,__TCustomActionManagerFindItemByCaption,false,0,'ACaption: string');
    DefineMethod('FindItemByAction',1,tkClass,TActionClientItem,__TCustomActionManagerFindItemByAction,false,0,'Action: TCustomAction');
    DefineMethod('LoadFromFile',1,tkNone,nil,__TCustomActionManagerLoadFromFile,false,0,'Filename: string');
    DefineMethod('LoadFromStream',1,tkNone,nil,__TCustomActionManagerLoadFromStream,false,0,'S: TStream');
    DefineMethod('ResetActionBar',1,tkNone,nil,__TCustomActionManagerResetActionBar,false,0,'Index: Integer');
    DefineMethod('ResetUsageData',0,tkNone,nil,__TCustomActionManagerResetUsageData,false,0,'');
    DefineMethod('SaveToFile',1,tkNone,nil,__TCustomActionManagerSaveToFile,false,0,'Filename: string');
    DefineMethod('SaveToStream',1,tkNone,nil,__TCustomActionManagerSaveToStream,false,0,'S: TStream');
  ...
  begin
    DefineMethod('Assign',1,tkNone,nil,__TActionListItemAssign,false,0,'Source: TPersistent');
  end;
  ...
  begin
    DefineMethod('Create',1,tkClass,TActionClient,__TActionClientCreate,true,0,'Collection: TCollection');
    DefineMethod('Destroy',0,tkNone,nil,__TActionClientDestroy,false,0,'');
    DefineMethod('Assign',1,tkNone,nil,__TActionClientAssign,false,0,'Source: TPersistent');
  ...
  begin
    DefineMethod('Create',1,tkClass,TActionBarItem,__TActionBarItemCreate,true,0,'Collection: TCollection');
  ...
  begin
    ...
    DefineMethod('Assign',1,tkNone,nil,__TActionClientsAssign,false,0,'Source: TPersistent');
  ...
  begin
    DefineMethod('Create',1,tkClass,TCommandProperties,__TCommandPropertiesCreate,true,0,'AItem: TActionClientItem');
    DefineMethod('Assign',1,tkNone,nil,__TCommandPropertiesAssign,false,0,'Source: TPersistent');
    DefineProp('Control',tkClass,__GetTCommandPropertiesControl,nil,TCustomActionControl,false,0);
    DefineProp('ActionClientItem',tkClass,__GetTCommandPropertiesActionClientItem,__SetTCommandPropertiesActionClientItem,TActionClientItem,false,0);
  end;
  With Scripter.DefineClass(TCheckBoxProperties) do
  begin
    DefineMethod('Create',1,tkClass,TCheckBoxProperties,__TCheckBoxPropertiesCreate,true,0,'AItem: TActionClientItem');
    DefineMethod('Assign',1,tkNone,nil,__TCheckBoxPropertiesAssign,false,0,'Source: TPersistent');
  end;
  With Scripter.DefineClass(TButtonProperties) do
  begin
    DefineMethod('Create',1,tkClass,TButtonProperties,__TButtonPropertiesCreate,true,0,'AItem: TActionClientItem');
    DefineMethod('Assign',1,tkNone,nil,__TButtonPropertiesAssign,false,0,'Source: TPersistent');
  end;
  With Scripter.DefineClass(TGalleryProperties) do
  begin
    DefineMethod('Create',1,tkClass,TGalleryProperties,__TGalleryPropertiesCreate,true,0,'AItem: TActionClientItem');
    DefineMethod('Assign',1,tkNone,nil,__TGalleryPropertiesAssign,false,0,'Source: TPersistent');
    DefineMethod('GetGalleryType',0,tkVariant,nil,__TGalleryPropertiesGetGalleryType,false,0,'');
    DefineMethod('SetGalleryType',1,tkNone,nil,__TGalleryPropertiesSetGalleryType,false,0,'Value: TGalleryType');
    DefineMethod('GetItemsPerRow',0,tkInteger,nil,__TGalleryPropertiesGetItemsPerRow,false,0,'');
    DefineMethod('SetItemsPerRow',1,tkNone,nil,__TGalleryPropertiesSetItemsPerRow,false,0,'Value: Integer');
  end;
  With Scripter.DefineClass(TTextProperties) do
  begin
    DefineMethod('Create',1,tkClass,TTextProperties,__TTextPropertiesCreate,true,0,'AItem: TActionClientItem');
    DefineMethod('Destroy',0,tkNone,nil,__TTextPropertiesDestroy,false,0,'');
    DefineMethod('Assign',1,tkNone,nil,__TTextPropertiesAssign,false,0,'Source: TPersistent');
  end;
  With Scripter.DefineClass(TControlProperties) do
  begin
    DefineMethod('Create',1,tkClass,TControlProperties,__TControlPropertiesCreate,true,0,'AItem: TActionClientItem');
    DefineMethod('Assign',1,tkNone,nil,__TControlPropertiesAssign,false,0,'Source: TPersistent');
  end;
  With Scripter.DefineClass(TMenuProperties) do
  begin
    DefineMethod('Create',1,tkClass,TMenuProperties,__TMenuPropertiesCreate,true,0,'AItem: TActionClientItem');
    DefineMethod('Destroy',0,tkNone,nil,__TMenuPropertiesDestroy,false,0,'');
    DefineMethod('Assign',1,tkNone,nil,__TMenuPropertiesAssign,false,0,'Source: TPersistent');
  end;
  With Scripter.DefineClass(TComboBoxProperties) do
  begin
    DefineMethod('Create',1,tkClass,TComboBoxProperties,__TComboBoxPropertiesCreate,true,0,'AItem: TActionClientItem');
  end;
  ...
  begin
    ...
    DefineMethod('Create',1,tkClass,TActionClientItem,__TActionClientItemCreate,true,0,'Collection: TCollection');
    DefineMethod('Destroy',0,tkNone,nil,__TActionClientItemDestroy,false,0,'');
    DefineMethod('Assign',1,tkNone,nil,__TActionClientItemAssign,false,0,'Source: TPersistent');
  ...
  begin
    ...
    DefineMethod('AddAction',1,tkNone,nil,__TActionDragObjectAddAction,false,0,'AnAction: TContainedAction');
    DefineMethod('AddActionClass',1,tkNone,nil,__TActionDragObjectAddActionClass,false,0,'AnActionClass: TCustomActionClass');
  ...
  begin
    DefineMethod('Create',1,tkClass,TCategoryDragObject,__TCategoryDragObjectCreate,true,0,'ACategory: string');
  ...
  begin
    DefineMethod('Create',1,tkClass,TCustomActionBarColorMap,__TCustomActionBarColorMapCreate,true,0,'AOwner: TComponent');
    DefineMethod('Destroy',0,tkNone,nil,__TCustomActionBarColorMapDestroy,false,0,'');
    DefineMethod('Assign',1,tkNone,nil,__TCustomActionBarColorMapAssign,false,0,'Source: TPersistent');
  ...
  begin
    DefineMethod('Create',1,tkClass,TCustomActionBar,__TCustomActionBarCreate,true,0,'AOwner: TComponent');
    DefineMethod('Destroy',0,tkNone,nil,__TCustomActionBarDestroy,false,0,'');
    DefineMethod('CreateControl',1,tkClass,TCustomActionControl,__TCustomActionBarCreateControl,false,0,'AnItem: TActionClientItem');
    DefineMethod('DesignWndProc',1,tkVariant,nil,__TCustomActionBarDesignWndProc,false,0,'Message: TMessage').SetVarArgs([0]);
    DefineMethod('DoDropCategory',3,tkNone,nil,__TCustomActionBarDoDropCategory,false,0,'Source: TCategoryDragObject; X: Integer; Y: Integer');
    DefineMethod('FindAccelItem',1,tkClass,TActionClientItem,__TCustomActionBarFindAccelItem,false,0,'Accel: Word');
    DefineMethod('DragDrop',3,tkNone,nil,__TCustomActionBarDragDrop,false,0,'Source: TObject; X: Integer; Y: Integer');
    ...
    DefineMethod('SetBounds',4,tkNone,nil,__TCustomActionBarSetBounds,false,0,'ALeft: Integer; ATop: Integer; AWidth: Integer; AHeight: Integer');
  ...
  begin
    DefineMethod('Create',1,tkClass,TCustomActionControl,__TCustomActionControlCreate,true,0,'AOwner: TComponent');
    DefineMethod('Destroy',0,tkNone,nil,__TCustomActionControlDestroy,false,0,'');
    DefineMethod('DesignWndProc',1,tkVariant,nil,__TCustomActionControlDesignWndProc,false,0,'Message: TMessage').SetVarArgs([0]);
    ...
    DefineMethod('DragDrop',3,tkNone,nil,__TCustomActionControlDragDrop,false,0,'Source: TObject; X: Integer; Y: Integer');
  ...
  begin
    DefineMethod('NotifyDesigner',1,tkNone,nil,__NotifyDesigner,false,0,'ActionBar: TCustomActionBar');
    ...
    AddConstant('CM_SPLITITEMCLICKED',CM_SPLITITEMCLICKED);
