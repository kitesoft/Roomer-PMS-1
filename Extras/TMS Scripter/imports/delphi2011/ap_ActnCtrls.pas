...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomButtonControlClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomButtonControl(CurrentObject).State));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomButtonControl(CurrentObject).State:=TButtonState(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomButtonControl(CurrentObject).TrackButton));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomButtonControl(CurrentObject).TrackButton:=TMouseButton(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomUtilityButtonClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomUtilityButton(CurrentObject).ArrowType));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomUtilityButton(CurrentObject).ArrowType:=TArrowType(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomUtilityButton(CurrentObject).Direction));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomUtilityButton(CurrentObject).Direction:=TScrollDirection(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomToolScrollBtnClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomActionCombo(CurrentObject).DragDrop(TObject(VarToObject(GetInputArg(0))),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomComboControlClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomComboControl(CurrentObject).ComboBox));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomActionDockBarClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomActionDockBar(CurrentObject).Dock(TWinControl(VarToObject(GetInputArg(0))),TRectWrapper(integer(GetInputArg(1))).ObjToRec);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomActionToolBarClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomActionToolBar(CurrentObject).CreateControl(TActionClientItem(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomActionToolBar(CurrentObject).DoDropCategory(TCategoryDragObject(VarToObject(GetInputArg(0))),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomActionToolBar(CurrentObject).DragDrop(TObject(VarToObject(GetInputArg(0))),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)));
  end;
end;
...
begin
  ...
  begin
    DefineMethod('Create',1,tkClass,TCustomButtonControl,__TCustomButtonControlCreate,true,0,'AOwner: TComponent');
    ...
    DefineMethod('SetBounds',4,tkNone,nil,__TCustomButtonControlSetBounds,false,0,'ALeft: Integer; ATop: Integer; AWidth: Integer; AHeight: Integer');
  ...
  begin
    DefineMethod('Create',1,tkClass,TCustomUtilityButton,__TCustomUtilityButtonCreate,true,0,'AOwner: TComponent');
  ...
  begin
    DefineMethod('Create',1,tkClass,TCustomToolScrollBtn,__TCustomToolScrollBtnCreate,true,0,'AOwner: TComponent');
  ...
  begin
    DefineMethod('DesignWndProc',1,tkVariant,nil,__TCustomActionComboDesignWndProc,false,0,'Message: TMessage').SetVarArgs([0]);
    DefineMethod('DragDrop',3,tkNone,nil,__TCustomActionComboDragDrop,false,0,'Source: TObject; X: Integer; Y: Integer');
  end;
  With Scripter.DefineClass(TCustomComboControl) do
  begin
    DefineMethod('Create',1,tkClass,TCustomComboControl,__TCustomComboControlCreate,true,0,'AOwner: TComponent');
    ...
    DefineMethod('SetBounds',4,tkNone,nil,__TCustomComboControlSetBounds,false,0,'ALeft: Integer; ATop: Integer; AWidth: Integer; AHeight: Integer');
  ...
  begin
    DefineMethod('Create',1,tkClass,TCustomActionDockBar,__TCustomActionDockBarCreate,true,0,'AOwner: TComponent');
    DefineMethod('CalcDockedWidth',0,tkInteger,nil,__TCustomActionDockBarCalcDockedWidth,false,0,'');
    DefineMethod('Dock',2,tkNone,nil,__TCustomActionDockBarDock,false,0,'NewDockSite: TWinControl; ARect: TRect');
  end;
  With Scripter.DefineClass(TCustomActionToolBar) do
  begin
    DefineMethod('Create',1,tkClass,TCustomActionToolBar,__TCustomActionToolBarCreate,true,0,'AOwner: TComponent');
    ...
    DefineMethod('CreateControl',1,tkClass,TCustomActionControl,__TCustomActionToolBarCreateControl,false,0,'AnItem: TActionClientItem');
    DefineMethod('DoDropCategory',3,tkNone,nil,__TCustomActionToolBarDoDropCategory,false,0,'Source: TCategoryDragObject; X: Integer; Y: Integer');
    DefineMethod('DragDrop',3,tkNone,nil,__TCustomActionToolBarDragDrop,false,0,'Source: TObject; X: Integer; Y: Integer');
    DefineMethod('SetBounds',4,tkNone,nil,__TCustomActionToolBarSetBounds,false,0,'ALeft: Integer; ATop: Integer; AWidth: Integer; AHeight: Integer');
