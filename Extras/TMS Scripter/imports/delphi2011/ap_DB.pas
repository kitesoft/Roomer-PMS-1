...
type
  TatDBLibrary = class(TatScripterLibrary)
    ...
    procedure __TFieldsEnumeratorCreate(AMachine: TatVirtualMachine);
    procedure __TFieldsEnumeratorGetCurrent(AMachine: TatVirtualMachine);
    procedure __TFieldsEnumeratorMoveNext(AMachine: TatVirtualMachine);
    procedure __GetTFieldsEnumeratorCurrent(AMachine: TatVirtualMachine);
    ...
    procedure __TFieldsGetEnumerator(AMachine: TatVirtualMachine);
    ...
    procedure __TDefaultLookupListCreate(AMachine: TatVirtualMachine);
    procedure __TDefaultLookupListDestroy(AMachine: TatVirtualMachine);
    procedure __TDefaultLookupListAdd(AMachine: TatVirtualMachine);
    procedure __TDefaultLookupListClear(AMachine: TatVirtualMachine);
    procedure __TDefaultLookupListValueOfKey(AMachine: TatVirtualMachine);
    ...
    procedure __TFieldSetParentComponent(AMachine: TatVirtualMachine);
    ...
    procedure __GetTFieldAsSQLTimeStampOffset(AMachine: TatVirtualMachine);
    procedure __SetTFieldAsSQLTimeStampOffset(AMachine: TatVirtualMachine);
    procedure __GetTFieldAsSingle(AMachine: TatVirtualMachine);
    procedure __SetTFieldAsSingle(AMachine: TatVirtualMachine);
    procedure __GetTFieldAsFloat(AMachine: TatVirtualMachine);
    procedure __SetTFieldAsFloat(AMachine: TatVirtualMachine);
    procedure __GetTFieldAsExtended(AMachine: TatVirtualMachine);
    procedure __SetTFieldAsExtended(AMachine: TatVirtualMachine);
    procedure __GetTFieldAsInteger(AMachine: TatVirtualMachine);
    procedure __SetTFieldAsInteger(AMachine: TatVirtualMachine);
    procedure __GetTFieldAsLargeInt(AMachine: TatVirtualMachine);
    procedure __SetTFieldAsLargeInt(AMachine: TatVirtualMachine);
    procedure __GetTFieldAsString(AMachine: TatVirtualMachine);
    procedure __SetTFieldAsString(AMachine: TatVirtualMachine);
    procedure __GetTFieldAsWideString(AMachine: TatVirtualMachine);
    procedure __SetTFieldAsWideString(AMachine: TatVirtualMachine);
    procedure __GetTFieldAsAnsiString(AMachine: TatVirtualMachine);
    procedure __SetTFieldAsAnsiString(AMachine: TatVirtualMachine);
    ...
    procedure __TLongWordFieldCreate(AMachine: TatVirtualMachine);
    procedure __GetTLongWordFieldValue(AMachine: TatVirtualMachine);
    procedure __SetTLongWordFieldValue(AMachine: TatVirtualMachine);
    procedure __TSmallintFieldCreate(AMachine: TatVirtualMachine);
    procedure __TShortintFieldCreate(AMachine: TatVirtualMachine);
    procedure __TByteFieldCreate(AMachine: TatVirtualMachine);
    ...
    procedure __TUnsignedAutoIncFieldCreate(AMachine: TatVirtualMachine);
    ...
    procedure __TSingleFieldCreate(AMachine: TatVirtualMachine);
    procedure __GetTSingleFieldValue(AMachine: TatVirtualMachine);
    procedure __SetTSingleFieldValue(AMachine: TatVirtualMachine);
    procedure __TCurrencyFieldCreate(AMachine: TatVirtualMachine);
    procedure __TExtendedFieldCreate(AMachine: TatVirtualMachine);
    procedure __GetTExtendedFieldValue(AMachine: TatVirtualMachine);
    procedure __SetTExtendedFieldValue(AMachine: TatVirtualMachine);
    ...
    procedure __TSQLTimeStampOffsetFieldCreate(AMachine: TatVirtualMachine);
    procedure __GetTSQLTimeStampOffsetFieldValue(AMachine: TatVirtualMachine);
    procedure __SetTSQLTimeStampOffsetFieldValue(AMachine: TatVirtualMachine);
    ...
    procedure __TMemoFieldGetAsString(AMachine: TatVirtualMachine);
    procedure __TMemoFieldGetAsWideString(AMachine: TatVirtualMachine);
    procedure __TMemoFieldGetAsVariant(AMachine: TatVirtualMachine);
    procedure __TMemoFieldSetAsString(AMachine: TatVirtualMachine);
    procedure __TMemoFieldSetAsWideString(AMachine: TatVirtualMachine);
    procedure __GetTMemoFieldValue(AMachine: TatVirtualMachine);
    procedure __SetTMemoFieldValue(AMachine: TatVirtualMachine);
    procedure __TWideMemoFieldCreate(AMachine: TatVirtualMachine);
    procedure __GetTWideMemoFieldValue(AMachine: TatVirtualMachine);
    procedure __SetTWideMemoFieldValue(AMachine: TatVirtualMachine);
    ...
    procedure __TDataSetFieldAssign(AMachine: TatVirtualMachine);
    ...
    procedure __TParamSetDataSet(AMachine: TatVirtualMachine);
    procedure __TParamSetParams(AMachine: TatVirtualMachine);
    procedure __TParamSetStream(AMachine: TatVirtualMachine);
    ...
    procedure __GetTParamAsSingle(AMachine: TatVirtualMachine);
    procedure __SetTParamAsSingle(AMachine: TatVirtualMachine);
    ...
    procedure __GetTParamAsShortInt(AMachine: TatVirtualMachine);
    procedure __SetTParamAsShortInt(AMachine: TatVirtualMachine);
    procedure __GetTParamAsByte(AMachine: TatVirtualMachine);
    procedure __SetTParamAsByte(AMachine: TatVirtualMachine);
    procedure __GetTParamAsLongWord(AMachine: TatVirtualMachine);
    procedure __SetTParamAsLongWord(AMachine: TatVirtualMachine);
    procedure __GetTParamAsLargeInt(AMachine: TatVirtualMachine);
    procedure __SetTParamAsLargeInt(AMachine: TatVirtualMachine);
    ...
    procedure __GetTParamAsSQLTimeStampOffset(AMachine: TatVirtualMachine);
    procedure __SetTParamAsSQLTimeStampOffset(AMachine: TatVirtualMachine);
    ...
    procedure __GetTParamAsWideString(AMachine: TatVirtualMachine);
    procedure __SetTParamAsWideString(AMachine: TatVirtualMachine);
    procedure __GetTParamAsAnsiString(AMachine: TatVirtualMachine);
    procedure __SetTParamAsAnsiString(AMachine: TatVirtualMachine);
    ...
    procedure __GetTParamAsDataSet(AMachine: TatVirtualMachine);
    procedure __SetTParamAsDataSet(AMachine: TatVirtualMachine);
    procedure __GetTParamAsObject(AMachine: TatVirtualMachine);
    procedure __SetTParamAsObject(AMachine: TatVirtualMachine);
    procedure __GetTParamAsParams(AMachine: TatVirtualMachine);
    procedure __SetTParamAsParams(AMachine: TatVirtualMachine);
    procedure __GetTParamAsStream(AMachine: TatVirtualMachine);
    procedure __SetTParamAsStream(AMachine: TatVirtualMachine);
    ...
    procedure __TParamsAddParameter(AMachine: TatVirtualMachine);
    ...
    procedure __TParamObjectCreate(AMachine: TatVirtualMachine);
    procedure __TParamObjectDestroy(AMachine: TatVirtualMachine);
    ...
    procedure __TDataSetCopyFields(AMachine: TatVirtualMachine);
  ...
  TFieldsEnumeratorClass = class of TFieldsEnumerator;
  TFieldsClass = class of TFields;
  TLookupListClass = class of TLookupList;
  TDefaultLookupListClass = class of TDefaultLookupList;
  ...
  TLongWordFieldClass = class of TLongWordField;
  TSmallintFieldClass = class of TSmallintField;
  TShortintFieldClass = class of TShortintField;
  TByteFieldClass = class of TByteField;
  TLargeintFieldClass = class of TLargeintField;
  TWordFieldClass = class of TWordField;
  TAutoIncFieldClass = class of TAutoIncField;
  TUnsignedAutoIncFieldClass = class of TUnsignedAutoIncField;
  TFloatFieldClass = class of TFloatField;
  TSingleFieldClass = class of TSingleField;
  TCurrencyFieldClass = class of TCurrencyField;
  TExtendedFieldClass = class of TExtendedField;
  ...
  TSQLTimeStampOffsetFieldClass = class of TSQLTimeStampOffsetField;
  ...
  TWideMemoFieldClass = class of TWideMemoField;
  ...
  TParamStreamObjectClass = class of TParamStreamObject;
  TDataSetClass = class of TDataSet;
  TWideDataSetClass = class of TWideDataSet;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(EUpdateErrorClass(CurrentClass.ClassRef).Create(VarToStr(GetInputArg(0)),VarToStr(GetInputArg(1)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)),Exception(VarToObject(GetInputArg(4)))));
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(EUpdateError(CurrentObject).Context));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(EUpdateError(CurrentObject).OriginalException));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomConnectionClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomConnection(CurrentObject).DataSets[VarToInteger(GetArrayIndex(0))]));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TDefCollection(CurrentObject).Find(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TDefCollection(CurrentObject).GetItemNames(TStrings(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TDefCollection(CurrentObject).IndexOf(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TDefCollection(CurrentObject).DataSet));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TFieldDefClass(CurrentClass.ClassRef).Create(TFieldDefs(VarToObject(GetInputArg(0))),VarToStr(GetInputArg(1)),TFieldType(VarToInteger(GetInputArg(2))),VarToInteger(GetInputArg(3)),GetInputArg(4),VarToInteger(GetInputArg(5))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TFieldDef(CurrentObject).AddChild);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TFieldDef(CurrentObject).Assign(TPersistent(VarToObject(GetInputArg(0))));
  end;
end;
...
1: AResult := ObjectToVar(TFieldDef(CurrentObject).CreateField(TComponent(VarToObject(GetInputArg(0)))));
2: AResult := ObjectToVar(TFieldDef(CurrentObject).CreateField(TComponent(VarToObject(GetInputArg(0))),TObjectField(VarToObject(GetInputArg(1)))));
3: AResult := ObjectToVar(TFieldDef(CurrentObject).CreateField(TComponent(VarToObject(GetInputArg(0))),TObjectField(VarToObject(GetInputArg(1))),VarToStr(GetInputArg(2))));
4: AResult := ObjectToVar(TFieldDef(CurrentObject).CreateField(TComponent(VarToObject(GetInputArg(0))),TObjectField(VarToObject(GetInputArg(1))),VarToStr(GetInputArg(2)),GetInputArg(3)));
end;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TFieldDef(CurrentObject).ParentDef));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TFieldDefsClass(CurrentClass.ClassRef).Create(TPersistent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TFieldDefs(CurrentObject).AddFieldDef);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TFieldDefs(CurrentObject).Find(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    Case InputArgCount of
      2: TFieldDefs(CurrentObject).Add(VarToStr(GetInputArg(0)),TFieldType(VarToInteger(GetInputArg(1))));
      3: TFieldDefs(CurrentObject).Add(VarToStr(GetInputArg(0)),TFieldType(VarToInteger(GetInputArg(1))),VarToInteger(GetInputArg(2)));
      4: TFieldDefs(CurrentObject).Add(VarToStr(GetInputArg(0)),TFieldType(VarToInteger(GetInputArg(1))),VarToInteger(GetInputArg(2)),GetInputArg(3));
    end;
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TFieldDefs(CurrentObject).Items[VarToInteger(GetArrayIndex(0))]));
  end;
end;
...
begin
  with AMachine do
  begin
    TFieldDefs(CurrentObject).Items[VarToInteger(GetArrayIndex(0))]:=TFieldDef(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TFieldDefs(CurrentObject).ParentDef));
  end;
end;
...
AResult := ObjectToVar(TIndexDefClass(CurrentClass.ClassRef).Create(TIndexDefs(VarToObject(GetInputArg(0))),VarToStr(GetInputArg(1)),VarToStr(GetInputArg(2)),Param3));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TIndexDef(CurrentObject).Assign(TPersistent(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TIndexDef(CurrentObject).FieldExpression));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TIndexDefsClass(CurrentClass.ClassRef).Create(TDataSet(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TIndexDefs(CurrentObject).AddIndexDef);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TIndexDefs(CurrentObject).Find(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TIndexDefs(CurrentObject).FindIndexForFields(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TIndexDefs(CurrentObject).GetIndexForFields(VarToStr(GetInputArg(0)),GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
IntToSet(Param2, VarToInteger(GetInputArg(2)), SizeOf(Param2));
    TIndexDefs(CurrentObject).Add(VarToStr(GetInputArg(0)),VarToStr(GetInputArg(1)),Param2);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TIndexDefs(CurrentObject).Items[VarToInteger(GetArrayIndex(0))]));
  end;
end;
...
begin
  with AMachine do
  begin
    TIndexDefs(CurrentObject).Items[VarToInteger(GetArrayIndex(0))]:=TIndexDef(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TFlatListClass(CurrentClass.ClassRef).Create(TDataSet(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TFlatList(CurrentObject).DataSet));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TFieldDefList(CurrentObject).FieldByName(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TFieldDefList(CurrentObject).Find(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TFieldDefList(CurrentObject).FieldDefs[VarToInteger(GetArrayIndex(0))]));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TFieldList(CurrentObject).FieldByName(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TFieldList(CurrentObject).Find(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TFieldList(CurrentObject).Fields[VarToInteger(GetArrayIndex(0))]));
  end;
end;

procedure TatDBLibrary.__TFieldsEnumeratorCreate(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := ObjectToVar(TFieldsEnumeratorClass(CurrentClass.ClassRef).Create(TFields(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatDBLibrary.__TFieldsEnumeratorGetCurrent(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := ObjectToVar(TFieldsEnumerator(CurrentObject).GetCurrent);
    ReturnOutputArg(AResult);
  end;
end;

procedure TatDBLibrary.__TFieldsEnumeratorMoveNext(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := TFieldsEnumerator(CurrentObject).MoveNext;
    ReturnOutputArg(AResult);
  end;
end;

procedure TatDBLibrary.__GetTFieldsEnumeratorCurrent(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TFieldsEnumerator(CurrentObject).Current));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TFieldsClass(CurrentClass.ClassRef).Create(TDataSet(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TFields(CurrentObject).Add(TField(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TFields(CurrentObject).CheckFieldName(VarToStr(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    TFields(CurrentObject).CheckFieldNames(VarToStr(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TFields(CurrentObject).FindField(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TFields(CurrentObject).FieldByName(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TFields(CurrentObject).FieldByNumber(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatDBLibrary.__TFieldsGetEnumerator(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := ObjectToVar(TFields(CurrentObject).GetEnumerator);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TFields(CurrentObject).GetFieldNames(TStrings(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TFields(CurrentObject).IndexOf(TField(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TFields(CurrentObject).Remove(TField(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TFields(CurrentObject).DataSet));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TFields(CurrentObject).Fields[VarToInteger(GetArrayIndex(0))]));
  end;
end;
...
begin
  with AMachine do
  begin
    TFields(CurrentObject).Fields[VarToInteger(GetArrayIndex(0))]:=TField(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TLookupListClass(CurrentClass.ClassRef).Create);
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatDBLibrary.__TDefaultLookupListCreate(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := ObjectToVar(TDefaultLookupListClass(CurrentClass.ClassRef).Create);
    ReturnOutputArg(AResult);
  end;
end;

procedure TatDBLibrary.__TDefaultLookupListDestroy(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TDefaultLookupList(CurrentObject).Destroy;
  end;
end;

procedure TatDBLibrary.__TDefaultLookupListAdd(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TDefaultLookupList(CurrentObject).Add(GetInputArg(0),GetInputArg(1));
  end;
end;

procedure TatDBLibrary.__TDefaultLookupListClear(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TDefaultLookupList(CurrentObject).Clear;
  end;
end;

procedure TatDBLibrary.__TDefaultLookupListValueOfKey(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := TDefaultLookupList(CurrentObject).ValueOfKey(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TFieldClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TField(CurrentObject).Assign(TPersistent(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TField(CurrentObject).GetParentComponent);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TField(CurrentObject).SetFieldType(TFieldType(VarToInteger(GetInputArg(0))));
  end;
end;

procedure TatDBLibrary.__TFieldSetParentComponent(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TField(CurrentObject).SetParentComponent(TComponent(VarToObject(GetInputArg(0))));
  end;
end;
...
procedure TatDBLibrary.__GetTFieldAsSQLTimeStampOffset(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(integer(TSQLTimeStampOffsetWrapper.Create(TField(CurrentObject).AsSQLTimeStampOffset)));
  end;
end;

procedure TatDBLibrary.__SetTFieldAsSQLTimeStampOffset(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TField(CurrentObject).AsSQLTimeStampOffset:=TSQLTimeStampOffsetWrapper(integer(GetInputArg(0))).ObjToRec;
  end;
end;

procedure TatDBLibrary.__GetTFieldAsSingle(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(TField(CurrentObject).AsSingle);
  end;
end;

procedure TatDBLibrary.__SetTFieldAsSingle(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TField(CurrentObject).AsSingle:=GetInputArg(0);
  end;
end;
...
procedure TatDBLibrary.__GetTFieldAsExtended(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(TField(CurrentObject).AsExtended);
  end;
end;

procedure TatDBLibrary.__SetTFieldAsExtended(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TField(CurrentObject).AsExtended:=GetInputArg(0);
  end;
end;
...
procedure TatDBLibrary.__GetTFieldAsLargeInt(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TField(CurrentObject).AsLargeInt));
  end;
end;

procedure TatDBLibrary.__SetTFieldAsLargeInt(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TField(CurrentObject).AsLargeInt:=VarToInteger(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TField(CurrentObject).AsString));
  end;
end;
...
begin
  with AMachine do
  begin
    TField(CurrentObject).AsString:=VarToStr(GetInputArg(0));
  end;
end;

procedure TatDBLibrary.__GetTFieldAsWideString(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(TField(CurrentObject).AsWideString);
  end;
end;

procedure TatDBLibrary.__SetTFieldAsWideString(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TField(CurrentObject).AsWideString:=GetInputArg(0);
  end;
end;

procedure TatDBLibrary.__GetTFieldAsAnsiString(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(TField(CurrentObject).AsAnsiString);
  end;
end;

procedure TatDBLibrary.__SetTFieldAsAnsiString(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TField(CurrentObject).AsAnsiString:=GetInputArg(0);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TField(CurrentObject).AttributeSet));
  end;
end;
...
begin
  with AMachine do
  begin
    TField(CurrentObject).AttributeSet:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TField(CurrentObject).DataSet));
  end;
end;
...
begin
  with AMachine do
  begin
    TField(CurrentObject).DataSet:=TDataSet(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TField(CurrentObject).DataType));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TField(CurrentObject).DisplayName));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TField(CurrentObject).DisplayText));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TField(CurrentObject).EditMask));
  end;
end;
...
begin
  with AMachine do
  begin
    TField(CurrentObject).EditMask:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TField(CurrentObject).EditMaskPtr));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TField(CurrentObject).FullName));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TField(CurrentObject).LookupList));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TField(CurrentObject).ParentField));
  end;
end;
...
begin
  with AMachine do
  begin
    TField(CurrentObject).ParentField:=TObjectField(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TField(CurrentObject).Text));
  end;
end;
...
begin
  with AMachine do
  begin
    TField(CurrentObject).Text:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TStringFieldClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TWideStringFieldClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TNumericFieldClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TIntegerFieldClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatDBLibrary.__TLongWordFieldCreate(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := ObjectToVar(TLongWordFieldClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatDBLibrary.__GetTLongWordFieldValue(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TLongWordField(CurrentObject).Value));
  end;
end;

procedure TatDBLibrary.__SetTLongWordFieldValue(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TLongWordField(CurrentObject).Value:=VarToInteger(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TSmallintFieldClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatDBLibrary.__TShortintFieldCreate(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := ObjectToVar(TShortintFieldClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatDBLibrary.__TByteFieldCreate(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := ObjectToVar(TByteFieldClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TLargeintFieldClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TWordFieldClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TAutoIncFieldClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatDBLibrary.__TUnsignedAutoIncFieldCreate(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := ObjectToVar(TUnsignedAutoIncFieldClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TFloatFieldClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatDBLibrary.__TSingleFieldCreate(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := ObjectToVar(TSingleFieldClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatDBLibrary.__GetTSingleFieldValue(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(TSingleField(CurrentObject).Value);
  end;
end;

procedure TatDBLibrary.__SetTSingleFieldValue(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TSingleField(CurrentObject).Value:=GetInputArg(0);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCurrencyFieldClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatDBLibrary.__TExtendedFieldCreate(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := ObjectToVar(TExtendedFieldClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatDBLibrary.__GetTExtendedFieldValue(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(TExtendedField(CurrentObject).Value);
  end;
end;

procedure TatDBLibrary.__SetTExtendedFieldValue(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TExtendedField(CurrentObject).Value:=GetInputArg(0);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TBooleanFieldClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TDateTimeFieldClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TSQLTimeStampFieldClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatDBLibrary.__TSQLTimeStampOffsetFieldCreate(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := ObjectToVar(TSQLTimeStampOffsetFieldClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatDBLibrary.__GetTSQLTimeStampOffsetFieldValue(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(integer(TSQLTimeStampOffsetWrapper.Create(TSQLTimeStampOffsetField(CurrentObject).Value)));
  end;
end;

procedure TatDBLibrary.__SetTSQLTimeStampOffsetFieldValue(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TSQLTimeStampOffsetField(CurrentObject).Value:=TSQLTimeStampOffsetWrapper(integer(GetInputArg(0))).ObjToRec;
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TDateFieldClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TTimeFieldClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TBinaryFieldClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TBytesFieldClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TVarBytesFieldClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TBCDFieldClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TFMTBCDFieldClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TBlobFieldClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TBlobField(CurrentObject).Assign(TPersistent(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TBlobField(CurrentObject).LoadFromFile(VarToStr(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    TBlobField(CurrentObject).LoadFromStream(TStream(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TBlobField(CurrentObject).SaveToFile(VarToStr(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    TBlobField(CurrentObject).SaveToStream(TStream(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TBlobField(CurrentObject).SetFieldType(TFieldType(VarToInteger(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TMemoFieldClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatDBLibrary.__TMemoFieldGetAsString(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := string(TMemoField(CurrentObject).GetAsString);
    ReturnOutputArg(AResult);
  end;
end;

procedure TatDBLibrary.__TMemoFieldGetAsWideString(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := TMemoField(CurrentObject).GetAsWideString;
    ReturnOutputArg(AResult);
  end;
end;

procedure TatDBLibrary.__TMemoFieldGetAsVariant(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := TMemoField(CurrentObject).GetAsVariant;
    ReturnOutputArg(AResult);
  end;
end;

procedure TatDBLibrary.__TMemoFieldSetAsString(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TMemoField(CurrentObject).SetAsString(VarToStr(GetInputArg(0)));
  end;
end;

procedure TatDBLibrary.__TMemoFieldSetAsWideString(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TMemoField(CurrentObject).SetAsWideString(GetInputArg(0));
  end;
end;

procedure TatDBLibrary.__GetTMemoFieldValue(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(TMemoField(CurrentObject).Value);
  end;
end;

procedure TatDBLibrary.__SetTMemoFieldValue(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TMemoField(CurrentObject).Value:=GetInputArg(0);
  end;
end;

procedure TatDBLibrary.__TWideMemoFieldCreate(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := ObjectToVar(TWideMemoFieldClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatDBLibrary.__GetTWideMemoFieldValue(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(TWideMemoField(CurrentObject).Value);
  end;
end;

procedure TatDBLibrary.__SetTWideMemoFieldValue(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TWideMemoField(CurrentObject).Value:=GetInputArg(0);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TGraphicFieldClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TObjectFieldClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TObjectField(CurrentObject).Fields));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TADTFieldClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TArrayFieldClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TDataSetFieldClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatDBLibrary.__TDataSetFieldAssign(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TDataSetField(CurrentObject).Assign(TPersistent(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TDataSetField(CurrentObject).NestedDataSet));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TReferenceFieldClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TReferenceField(CurrentObject).Assign(TPersistent(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TVariantFieldClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TInterfaceFieldClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TIDispatchFieldClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TGuidFieldClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TAggregateFieldClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TAggregateField(CurrentObject).ResultType));
  end;
end;
...
begin
  with AMachine do
  begin
    TAggregateField(CurrentObject).ResultType:=TFieldType(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TDataLinkClass(CurrentClass.ClassRef).Create);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TDataLink(CurrentObject).ExecuteAction(TBasicAction(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TDataLink(CurrentObject).UpdateAction(TBasicAction(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TDataLink(CurrentObject).DataSet));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TDataLink(CurrentObject).DataSource));
  end;
end;
...
begin
  with AMachine do
  begin
    TDataLink(CurrentObject).DataSource:=TDataSource(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TDetailDataLink(CurrentObject).DetailDataSet));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TMasterDataLinkClass(CurrentClass.ClassRef).Create(TDataSet(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TMasterDataLink(CurrentObject).FieldNames));
  end;
end;
...
begin
  with AMachine do
  begin
    TMasterDataLink(CurrentObject).FieldNames:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TMasterDataLink(CurrentObject).Fields));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TDataSourceClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TDataSource(CurrentObject).IsLinkedTo(TDataSet(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TDataSource(CurrentObject).State));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TDataSetDesignerClass(CurrentClass.ClassRef).Create(TDataSet(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TDataSetDesigner(CurrentObject).DataEvent(TDataEvent(VarToInteger(GetInputArg(0))),VarToInteger(GetInputArg(1)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TDataSetDesigner(CurrentObject).DataSet));
  end;
end;
...
begin
  with AMachine do
  begin
    TCheckConstraint(CurrentObject).Assign(TPersistent(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(TCheckConstraint(CurrentObject).GetDisplayName);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCheckConstraintsClass(CurrentClass.ClassRef).Create(TPersistent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCheckConstraints(CurrentObject).Add);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCheckConstraints(CurrentObject).Items[VarToInteger(GetArrayIndex(0))]));
  end;
end;
...
begin
  with AMachine do
  begin
    TCheckConstraints(CurrentObject).Items[VarToInteger(GetArrayIndex(0))]:=TCheckConstraint(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TParamClass(CurrentClass.ClassRef).Create(TCollection(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TParam(CurrentObject).Assign(TPersistent(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TParam(CurrentObject).AssignField(TField(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TParam(CurrentObject).AssignFieldValue(TField(VarToObject(GetInputArg(0))),GetInputArg(1));
  end;
end;
...
begin
  with AMachine do
  begin
    TParam(CurrentObject).LoadFromFile(VarToStr(GetInputArg(0)),TBlobType(VarToInteger(GetInputArg(1))));
  end;
end;
...
begin
  with AMachine do
  begin
    TParam(CurrentObject).LoadFromStream(TStream(VarToObject(GetInputArg(0))),TBlobType(VarToInteger(GetInputArg(1))));
  end;
end;

procedure TatDBLibrary.__TParamSetDataSet(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TParam(CurrentObject).SetDataSet(TDataSet(VarToObject(GetInputArg(0))),GetInputArg(1));
  end;
end;

procedure TatDBLibrary.__TParamSetParams(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TParam(CurrentObject).SetParams(TParams(VarToObject(GetInputArg(0))),GetInputArg(1));
  end;
end;

procedure TatDBLibrary.__TParamSetStream(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    Case InputArgCount of
      2: TParam(CurrentObject).SetStream(TStream(VarToObject(GetInputArg(0))),GetInputArg(1));
      3: TParam(CurrentObject).SetStream(TStream(VarToObject(GetInputArg(0))),GetInputArg(1),VarToInteger(GetInputArg(2)));
    end;
  end;
end;
...
procedure TatDBLibrary.__GetTParamAsSingle(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(TParam(CurrentObject).AsSingle);
  end;
end;

procedure TatDBLibrary.__SetTParamAsSingle(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TParam(CurrentObject).AsSingle:=GetInputArg(0);
  end;
end;
...
procedure TatDBLibrary.__GetTParamAsShortInt(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TParam(CurrentObject).AsShortInt));
  end;
end;

procedure TatDBLibrary.__SetTParamAsShortInt(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TParam(CurrentObject).AsShortInt:=VarToInteger(GetInputArg(0));
  end;
end;

procedure TatDBLibrary.__GetTParamAsByte(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TParam(CurrentObject).AsByte));
  end;
end;

procedure TatDBLibrary.__SetTParamAsByte(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TParam(CurrentObject).AsByte:=VarToInteger(GetInputArg(0));
  end;
end;

procedure TatDBLibrary.__GetTParamAsLongWord(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TParam(CurrentObject).AsLongWord));
  end;
end;

procedure TatDBLibrary.__SetTParamAsLongWord(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TParam(CurrentObject).AsLongWord:=VarToInteger(GetInputArg(0));
  end;
end;

procedure TatDBLibrary.__GetTParamAsLargeInt(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TParam(CurrentObject).AsLargeInt));
  end;
end;

procedure TatDBLibrary.__SetTParamAsLargeInt(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TParam(CurrentObject).AsLargeInt:=VarToInteger(GetInputArg(0));
  end;
end;
...
procedure TatDBLibrary.__GetTParamAsSQLTimeStampOffset(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(integer(TSQLTimeStampOffsetWrapper.Create(TParam(CurrentObject).AsSQLTimeStampOffset)));
  end;
end;

procedure TatDBLibrary.__SetTParamAsSQLTimeStampOffset(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TParam(CurrentObject).AsSQLTimeStampOffset:=TSQLTimeStampOffsetWrapper(integer(GetInputArg(0))).ObjToRec;
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TParam(CurrentObject).AsMemo));
  end;
end;
...
begin
  with AMachine do
  begin
    TParam(CurrentObject).AsMemo:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TParam(CurrentObject).AsString));
  end;
end;
...
begin
  with AMachine do
  begin
    TParam(CurrentObject).AsString:=VarToStr(GetInputArg(0));
  end;
end;

procedure TatDBLibrary.__GetTParamAsWideString(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(TParam(CurrentObject).AsWideString);
  end;
end;

procedure TatDBLibrary.__SetTParamAsWideString(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TParam(CurrentObject).AsWideString:=GetInputArg(0);
  end;
end;

procedure TatDBLibrary.__GetTParamAsAnsiString(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(TParam(CurrentObject).AsAnsiString);
  end;
end;

procedure TatDBLibrary.__SetTParamAsAnsiString(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TParam(CurrentObject).AsAnsiString:=GetInputArg(0);
  end;
end;
...
procedure TatDBLibrary.__GetTParamAsDataSet(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TParam(CurrentObject).AsDataSet));
  end;
end;

procedure TatDBLibrary.__SetTParamAsDataSet(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TParam(CurrentObject).AsDataSet:=TDataSet(VarToObject(GetInputArg(0)));
  end;
end;

procedure TatDBLibrary.__GetTParamAsObject(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TParam(CurrentObject).AsObject));
  end;
end;

procedure TatDBLibrary.__SetTParamAsObject(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TParam(CurrentObject).AsObject:=TObject(VarToObject(GetInputArg(0)));
  end;
end;

procedure TatDBLibrary.__GetTParamAsParams(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TParam(CurrentObject).AsParams));
  end;
end;

procedure TatDBLibrary.__SetTParamAsParams(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TParam(CurrentObject).AsParams:=TParams(VarToObject(GetInputArg(0)));
  end;
end;

procedure TatDBLibrary.__GetTParamAsStream(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TParam(CurrentObject).AsStream));
  end;
end;

procedure TatDBLibrary.__SetTParamAsStream(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TParam(CurrentObject).AsStream:=TStream(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TParam(CurrentObject).NativeStr));
  end;
end;
...
begin
  with AMachine do
  begin
    TParam(CurrentObject).NativeStr:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TParam(CurrentObject).Text));
  end;
end;
...
begin
  with AMachine do
  begin
    TParam(CurrentObject).Text:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TParamsClass(CurrentClass.ClassRef).Create(TPersistent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatDBLibrary.__TParamsAddParameter(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := ObjectToVar(TParams(CurrentObject).AddParameter);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TParams(CurrentObject).AssignValues(TParams(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TParams(CurrentObject).AddParam(TParam(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TParams(CurrentObject).RemoveParam(TParam(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TParams(CurrentObject).CreateParam(TFieldType(VarToInteger(GetInputArg(0))),VarToStr(GetInputArg(1)),TParamType(VarToInteger(GetInputArg(2)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TParams(CurrentObject).GetParamList(TList(VarToObject(GetInputArg(0))),VarToStr(GetInputArg(1)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TParams(CurrentObject).IsEqual(TParams(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(TParams(CurrentObject).ParseSQL(VarToStr(GetInputArg(0)),GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TParams(CurrentObject).ParamByName(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TParams(CurrentObject).FindParam(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TParams(CurrentObject).Items[VarToInteger(GetArrayIndex(0))]));
  end;
end;
...
begin
  with AMachine do
  begin
    TParams(CurrentObject).Items[VarToInteger(GetArrayIndex(0))]:=TParam(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(TParams(CurrentObject).ParamValues[VarToStr(GetArrayIndex(0))]);
  end;
end;
...
begin
  with AMachine do
  begin
    TParams(CurrentObject).ParamValues[VarToStr(GetArrayIndex(0))]:=GetInputArg(0);
  end;
end;

procedure TatDBLibrary.__TParamObjectCreate(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := ObjectToVar(TParamObjectClass(CurrentClass.ClassRef).Create(TObject(VarToObject(GetInputArg(0))),TFieldType(VarToInteger(GetInputArg(1))),GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatDBLibrary.__TParamObjectDestroy(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TParamObject(CurrentObject).Destroy;
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TDataSetClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TDataSet(CurrentObject).CreateBlobStream(TField(VarToObject(GetInputArg(0))),TBlobStreamMode(VarToInteger(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TDataSet(CurrentObject).FieldByName(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TDataSet(CurrentObject).FindField(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TDataSet(CurrentObject).GetDetailDataSets(TList(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TDataSet(CurrentObject).GetDetailLinkFields(TList(VarToObject(GetInputArg(0))),TList(VarToObject(GetInputArg(1))));
  end;
end;
...
begin
  with AMachine do
  begin
    TDataSet(CurrentObject).GetFieldList(TList(VarToObject(GetInputArg(0))),VarToStr(GetInputArg(1)));
  end;
end;
...
begin
  with AMachine do
  begin
    TDataSet(CurrentObject).GetFieldNames(TStrings(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TDataSet(CurrentObject).IsLinkedTo(TDataSource(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
IntToSet(Param2, VarToInteger(GetInputArg(2)), SizeOf(Param2));
AResult := TDataSet(CurrentObject).Locate(VarToStr(GetInputArg(0)),GetInputArg(1),Param2);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TDataSet(CurrentObject).Lookup(VarToStr(GetInputArg(0)),GetInputArg(1),VarToStr(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatDBLibrary.__TDataSetCopyFields(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(TDataSet(CurrentObject).CopyFields(TDataSet(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TDataSet(CurrentObject).Translate(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TDataSet(CurrentObject).UpdateStatus);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TDataSet(CurrentObject).AggFields));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TDataSet(CurrentObject).DataSetField));
  end;
end;
...
begin
  with AMachine do
  begin
    TDataSet(CurrentObject).DataSetField:=TDataSetField(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TDataSet(CurrentObject).DataSource));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TDataSet(CurrentObject).Designer));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TDataSet(CurrentObject).FieldDefs));
  end;
end;
...
begin
  with AMachine do
  begin
    TDataSet(CurrentObject).FieldDefs:=TFieldDefs(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TDataSet(CurrentObject).FieldDefList));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TDataSet(CurrentObject).Fields));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TDataSet(CurrentObject).FieldList));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(TDataSet(CurrentObject).FieldValues[VarToStr(GetArrayIndex(0))]);
  end;
end;
...
begin
  with AMachine do
  begin
    TDataSet(CurrentObject).FieldValues[VarToStr(GetArrayIndex(0))]:=GetInputArg(0);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TDataSet(CurrentObject).State));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TDataSet(CurrentObject).Filter));
  end;
end;
...
begin
  with AMachine do
  begin
    TDataSet(CurrentObject).Filter:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  ...
  begin
    ...
    UpdateKindTemp := Integer(UpdateKind);
    ...
    UpdateAction := TUpdateAction(VarToInteger(UpdateActionTemp));
...
begin
  ...
  begin
    ...
    Action := TDataAction(VarToInteger(ActionTemp));
    if AssignedMethod(AfterCall) then
...
AResult := string(DB.ExtractFieldName(VarToStr(GetInputArg(0)),Param1));
    ReturnOutputArg(AResult);
...
begin
  ...
  begin
    Case InputArgCount of
      1: DB.DatabaseError(VarToStr(GetInputArg(0)));
      2: DB.DatabaseError(VarToStr(GetInputArg(0)),TComponent(VarToObject(GetInputArg(1))));
    end;
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(DB.GetFieldProperty(TDataSet(VarToObject(GetInputArg(0))),TComponent(VarToObject(GetInputArg(1))),VarToStr(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := Integer(DB.VarTypeToDataType(Param0));
    ReturnOutputArg(AResult);
...
begin
  ...
  begin
    DefineMethod('Create',5,tkClass,EUpdateError,__EUpdateErrorCreate,true,0,'NativeError: string; Context: string; ErrCode: Integer; PrevError: Integer; E: Exception');
  ...
  begin
    DefineMethod('Create',1,tkClass,TCustomConnection,__TCustomConnectionCreate,true,0,'AOwner: TComponent');
  ...
  begin
    DefineMethod('Find',1,tkClass,TNamedItem,__TDefCollectionFind,false,0,'AName: string');
    DefineMethod('GetItemNames',1,tkNone,nil,__TDefCollectionGetItemNames,false,0,'List: TStrings');
    DefineMethod('IndexOf',1,tkInteger,nil,__TDefCollectionIndexOf,false,0,'AName: string');
  ...
  begin
    DefineMethod('Create',6,tkClass,TFieldDef,__TFieldDefCreate,true,0,'Owner: TFieldDefs; Name: string; DataType: TFieldType; Size: Integer; Required: Boolean; FieldNo: Integer');
    ...
    DefineMethod('Assign',1,tkNone,nil,__TFieldDefAssign,false,0,'Source: TPersistent');
    DefineMethod('CreateField',4,tkClass,TField,__TFieldDefCreateField,false,3,'Owner: TComponent; ParentField: TObjectField = nil; FieldName: string = ''; CreateChildren: Boolean = True');
  ...
  begin
    DefineMethod('Create',1,tkClass,TFieldDefs,__TFieldDefsCreate,true,0,'AOwner: TPersistent');
    DefineMethod('AddFieldDef',0,tkClass,TFieldDef,__TFieldDefsAddFieldDef,false,0,'');
    DefineMethod('Find',1,tkClass,TFieldDef,__TFieldDefsFind,false,0,'Name: string');
    DefineMethod('Update',0,tkNone,nil,__TFieldDefsUpdate,false,0,'');
    DefineMethod('Add',4,tkNone,nil,__TFieldDefsAdd,false,2,'Name: string; DataType: TFieldType; Size: Integer = 0; Required: Boolean = False');
  ...
  begin
    DefineMethod('Create',4,tkClass,TIndexDef,__TIndexDefCreate,true,0,'Owner: TIndexDefs; Name: string; Fields: string; Options: TIndexOptions');
    DefineMethod('Assign',1,tkNone,nil,__TIndexDefAssign,false,0,'ASource: TPersistent');
  ...
  begin
    DefineMethod('Create',1,tkClass,TIndexDefs,__TIndexDefsCreate,true,0,'ADataSet: TDataSet');
    DefineMethod('AddIndexDef',0,tkClass,TIndexDef,__TIndexDefsAddIndexDef,false,0,'');
    DefineMethod('Find',1,tkClass,TIndexDef,__TIndexDefsFind,false,0,'Name: string');
    DefineMethod('Update',0,tkNone,nil,__TIndexDefsUpdate,false,0,'');
    DefineMethod('FindIndexForFields',1,tkClass,TIndexDef,__TIndexDefsFindIndexForFields,false,0,'Fields: string');
    DefineMethod('GetIndexForFields',2,tkClass,TIndexDef,__TIndexDefsGetIndexForFields,false,0,'Fields: string; CaseInsensitive: Boolean');
    DefineMethod('Add',3,tkNone,nil,__TIndexDefsAdd,false,0,'Name: string; Fields: string; Options: TIndexOptions');
  ...
  begin
    DefineMethod('Create',1,tkClass,TFlatList,__TFlatListCreate,true,0,'ADataSet: TDataSet');
  ...
  begin
    DefineMethod('FieldByName',1,tkClass,TFieldDef,__TFieldDefListFieldByName,false,0,'Name: string');
    DefineMethod('Find',1,tkClass,TFieldDef,__TFieldDefListFind,false,0,'Name: string');
  ...
  begin
    DefineMethod('FieldByName',1,tkClass,TField,__TFieldListFieldByName,false,0,'Name: string');
    DefineMethod('Find',1,tkClass,TField,__TFieldListFind,false,0,'Name: string');
    DefaultProperty := DefineProp('Fields',tkClass,__GetTFieldListFields,nil,TField,false,1);
  end;
  With Scripter.DefineClass(TFieldsEnumerator) do
  begin
    DefineMethod('Create',1,tkClass,TFieldsEnumerator,__TFieldsEnumeratorCreate,true,0,'AFields: TFields');
    DefineMethod('GetCurrent',0,tkClass,TField,__TFieldsEnumeratorGetCurrent,false,0,'');
    DefineMethod('MoveNext',0,tkVariant,nil,__TFieldsEnumeratorMoveNext,false,0,'');
    DefineProp('Current',tkClass,__GetTFieldsEnumeratorCurrent,nil,TField,false,0);
  end;
  With Scripter.DefineClass(TFields) do
  begin
    DefineMethod('Create',1,tkClass,TFields,__TFieldsCreate,true,0,'ADataSet: TDataSet');
    DefineMethod('Destroy',0,tkNone,nil,__TFieldsDestroy,false,0,'');
    DefineMethod('Add',1,tkNone,nil,__TFieldsAdd,false,0,'Field: TField');
    DefineMethod('CheckFieldName',1,tkNone,nil,__TFieldsCheckFieldName,false,0,'FieldName: string');
    DefineMethod('CheckFieldNames',1,tkNone,nil,__TFieldsCheckFieldNames,false,0,'FieldNames: string');
    DefineMethod('Clear',0,tkNone,nil,__TFieldsClear,false,0,'');
    DefineMethod('FindField',1,tkClass,TField,__TFieldsFindField,false,0,'FieldName: string');
    DefineMethod('FieldByName',1,tkClass,TField,__TFieldsFieldByName,false,0,'FieldName: string');
    DefineMethod('FieldByNumber',1,tkClass,TField,__TFieldsFieldByNumber,false,0,'FieldNo: Integer');
    DefineMethod('GetEnumerator',0,tkClass,TFieldsEnumerator,__TFieldsGetEnumerator,false,0,'');
    DefineMethod('GetFieldNames',1,tkNone,nil,__TFieldsGetFieldNames,false,0,'List: TStrings');
    DefineMethod('IndexOf',1,tkInteger,nil,__TFieldsIndexOf,false,0,'Field: TField');
    DefineMethod('Remove',1,tkNone,nil,__TFieldsRemove,false,0,'Field: TField');
  ...
  begin
    ...
    DefineMethod('Add',2,tkNone,nil,__TLookupListAdd,false,0,'AKey: Variant; AValue: Variant');
    DefineMethod('Clear',0,tkNone,nil,__TLookupListClear,false,0,'');
    DefineMethod('ValueOfKey',1,tkVariant,nil,__TLookupListValueOfKey,false,0,'AKey: Variant');
  end;
  With Scripter.DefineClass(TDefaultLookupList) do
  begin
    DefineMethod('Create',0,tkClass,TDefaultLookupList,__TDefaultLookupListCreate,true,0,'');
    DefineMethod('Destroy',0,tkNone,nil,__TDefaultLookupListDestroy,false,0,'');
    DefineMethod('Add',2,tkNone,nil,__TDefaultLookupListAdd,false,0,'AKey: Variant; AValue: Variant');
    DefineMethod('Clear',0,tkNone,nil,__TDefaultLookupListClear,false,0,'');
    DefineMethod('ValueOfKey',1,tkVariant,nil,__TDefaultLookupListValueOfKey,false,0,'AKey: Variant');
  end;
  With Scripter.DefineClass(TField) do
  begin
    DefineMethod('Create',1,tkClass,TField,__TFieldCreate,true,0,'AOwner: TComponent');
    DefineMethod('Destroy',0,tkNone,nil,__TFieldDestroy,false,0,'');
    DefineMethod('Assign',1,tkNone,nil,__TFieldAssign,false,0,'Source: TPersistent');
    DefineMethod('AssignValue',1,tkNone,nil,__TFieldAssignValue,false,0,'Value: TVarRec');
    ...
    DefineMethod('IsValidChar',1,tkVariant,nil,__TFieldIsValidChar,false,0,'InputChar: Char');
    DefineMethod('RefreshLookupList',0,tkNone,nil,__TFieldRefreshLookupList,false,0,'');
    DefineMethod('SetFieldType',1,tkNone,nil,__TFieldSetFieldType,false,0,'Value: TFieldType');
    DefineMethod('SetParentComponent',1,tkNone,nil,__TFieldSetParentComponent,false,0,'AParent: TComponent');
    ...
    DefineProp('AsSQLTimeStampOffset',tkVariant,__GetTFieldAsSQLTimeStampOffset,__SetTFieldAsSQLTimeStampOffset,nil,false,0);
    DefineProp('AsSingle',tkVariant,__GetTFieldAsSingle,__SetTFieldAsSingle,nil,false,0);
    DefineProp('AsFloat',tkVariant,__GetTFieldAsFloat,__SetTFieldAsFloat,nil,false,0);
    DefineProp('AsExtended',tkVariant,__GetTFieldAsExtended,__SetTFieldAsExtended,nil,false,0);
    DefineProp('AsInteger',tkInteger,__GetTFieldAsInteger,__SetTFieldAsInteger,nil,false,0);
    DefineProp('AsLargeInt',tkVariant,__GetTFieldAsLargeInt,__SetTFieldAsLargeInt,nil,false,0);
    DefineProp('AsString',tkVariant,__GetTFieldAsString,__SetTFieldAsString,nil,false,0);
    DefineProp('AsWideString',tkVariant,__GetTFieldAsWideString,__SetTFieldAsWideString,nil,false,0);
    DefineProp('AsAnsiString',tkVariant,__GetTFieldAsAnsiString,__SetTFieldAsAnsiString,nil,false,0);
  ...
  begin
    DefineMethod('Create',1,tkClass,TStringField,__TStringFieldCreate,true,0,'AOwner: TComponent');
  ...
  begin
    DefineMethod('Create',1,tkClass,TWideStringField,__TWideStringFieldCreate,true,0,'AOwner: TComponent');
  ...
  begin
    DefineMethod('Create',1,tkClass,TNumericField,__TNumericFieldCreate,true,0,'AOwner: TComponent');
  end;
  With Scripter.DefineClass(TIntegerField) do
  begin
    DefineMethod('Create',1,tkClass,TIntegerField,__TIntegerFieldCreate,true,0,'AOwner: TComponent');
    DefineProp('Value',tkInteger,__GetTIntegerFieldValue,__SetTIntegerFieldValue,nil,false,0);
  end;
  With Scripter.DefineClass(TLongWordField) do
  begin
    DefineMethod('Create',1,tkClass,TLongWordField,__TLongWordFieldCreate,true,0,'AOwner: TComponent');
    DefineProp('Value',tkInteger,__GetTLongWordFieldValue,__SetTLongWordFieldValue,nil,false,0);
  end;
  With Scripter.DefineClass(TSmallintField) do
  begin
    DefineMethod('Create',1,tkClass,TSmallintField,__TSmallintFieldCreate,true,0,'AOwner: TComponent');
  end;
  With Scripter.DefineClass(TShortintField) do
  begin
    DefineMethod('Create',1,tkClass,TShortintField,__TShortintFieldCreate,true,0,'AOwner: TComponent');
  end;
  With Scripter.DefineClass(TByteField) do
  begin
    DefineMethod('Create',1,tkClass,TByteField,__TByteFieldCreate,true,0,'AOwner: TComponent');
  end;
  With Scripter.DefineClass(TLargeintField) do
  begin
    DefineMethod('Create',1,tkClass,TLargeintField,__TLargeintFieldCreate,true,0,'AOwner: TComponent');
  ...
  begin
    DefineMethod('Create',1,tkClass,TWordField,__TWordFieldCreate,true,0,'AOwner: TComponent');
  end;
  With Scripter.DefineClass(TAutoIncField) do
  begin
    DefineMethod('Create',1,tkClass,TAutoIncField,__TAutoIncFieldCreate,true,0,'AOwner: TComponent');
  end;
  With Scripter.DefineClass(TUnsignedAutoIncField) do
  begin
    DefineMethod('Create',1,tkClass,TUnsignedAutoIncField,__TUnsignedAutoIncFieldCreate,true,0,'AOwner: TComponent');
  end;
  With Scripter.DefineClass(TFloatField) do
  begin
    DefineMethod('Create',1,tkClass,TFloatField,__TFloatFieldCreate,true,0,'AOwner: TComponent');
    DefineProp('Value',tkVariant,__GetTFloatFieldValue,__SetTFloatFieldValue,nil,false,0);
  end;
  With Scripter.DefineClass(TSingleField) do
  begin
    DefineMethod('Create',1,tkClass,TSingleField,__TSingleFieldCreate,true,0,'AOwner: TComponent');
    DefineProp('Value',tkVariant,__GetTSingleFieldValue,__SetTSingleFieldValue,nil,false,0);
  end;
  With Scripter.DefineClass(TCurrencyField) do
  begin
    DefineMethod('Create',1,tkClass,TCurrencyField,__TCurrencyFieldCreate,true,0,'AOwner: TComponent');
  end;
  With Scripter.DefineClass(TExtendedField) do
  begin
    DefineMethod('Create',1,tkClass,TExtendedField,__TExtendedFieldCreate,true,0,'AOwner: TComponent');
    DefineProp('Value',tkVariant,__GetTExtendedFieldValue,__SetTExtendedFieldValue,nil,false,0);
  end;
  With Scripter.DefineClass(TBooleanField) do
  begin
    DefineMethod('Create',1,tkClass,TBooleanField,__TBooleanFieldCreate,true,0,'AOwner: TComponent');
  ...
  begin
    DefineMethod('Create',1,tkClass,TDateTimeField,__TDateTimeFieldCreate,true,0,'AOwner: TComponent');
  ...
  begin
    DefineMethod('Create',1,tkClass,TSQLTimeStampField,__TSQLTimeStampFieldCreate,true,0,'AOwner: TComponent');
    DefineProp('Value',tkVariant,__GetTSQLTimeStampFieldValue,__SetTSQLTimeStampFieldValue,nil,false,0);
  end;
  With Scripter.DefineClass(TSQLTimeStampOffsetField) do
  begin
    DefineMethod('Create',1,tkClass,TSQLTimeStampOffsetField,__TSQLTimeStampOffsetFieldCreate,true,0,'AOwner: TComponent');
    DefineProp('Value',tkVariant,__GetTSQLTimeStampOffsetFieldValue,__SetTSQLTimeStampOffsetFieldValue,nil,false,0);
  end;
  With Scripter.DefineClass(TDateField) do
  begin
    DefineMethod('Create',1,tkClass,TDateField,__TDateFieldCreate,true,0,'AOwner: TComponent');
  end;
  With Scripter.DefineClass(TTimeField) do
  begin
    DefineMethod('Create',1,tkClass,TTimeField,__TTimeFieldCreate,true,0,'AOwner: TComponent');
  end;
  With Scripter.DefineClass(TBinaryField) do
  begin
    DefineMethod('Create',1,tkClass,TBinaryField,__TBinaryFieldCreate,true,0,'AOwner: TComponent');
  end;
  With Scripter.DefineClass(TBytesField) do
  begin
    DefineMethod('Create',1,tkClass,TBytesField,__TBytesFieldCreate,true,0,'AOwner: TComponent');
  end;
  With Scripter.DefineClass(TVarBytesField) do
  begin
    DefineMethod('Create',1,tkClass,TVarBytesField,__TVarBytesFieldCreate,true,0,'AOwner: TComponent');
  end;
  With Scripter.DefineClass(TBCDField) do
  begin
    DefineMethod('Create',1,tkClass,TBCDField,__TBCDFieldCreate,true,0,'AOwner: TComponent');
    DefineProp('Value',tkVariant,__GetTBCDFieldValue,__SetTBCDFieldValue,nil,false,0);
  end;
  With Scripter.DefineClass(TFMTBCDField) do
  begin
    DefineMethod('Create',1,tkClass,TFMTBCDField,__TFMTBCDFieldCreate,true,0,'AOwner: TComponent');
  ...
  begin
    DefineMethod('Create',1,tkClass,TBlobField,__TBlobFieldCreate,true,0,'AOwner: TComponent');
    DefineMethod('Assign',1,tkNone,nil,__TBlobFieldAssign,false,0,'Source: TPersistent');
    DefineMethod('Clear',0,tkNone,nil,__TBlobFieldClear,false,0,'');
    DefineMethod('IsBlob',0,tkVariant,nil,__TBlobFieldIsBlob,true,0,'');
    DefineMethod('LoadFromFile',1,tkNone,nil,__TBlobFieldLoadFromFile,false,0,'FileName: string');
    DefineMethod('LoadFromStream',1,tkNone,nil,__TBlobFieldLoadFromStream,false,0,'Stream: TStream');
    DefineMethod('SaveToFile',1,tkNone,nil,__TBlobFieldSaveToFile,false,0,'FileName: string');
    DefineMethod('SaveToStream',1,tkNone,nil,__TBlobFieldSaveToStream,false,0,'Stream: TStream');
    DefineMethod('SetFieldType',1,tkNone,nil,__TBlobFieldSetFieldType,false,0,'Value: TFieldType');
  ...
  begin
    DefineMethod('Create',1,tkClass,TMemoField,__TMemoFieldCreate,true,0,'AOwner: TComponent');
    DefineMethod('GetAsString',0,tkVariant,nil,__TMemoFieldGetAsString,false,0,'');
    DefineMethod('GetAsWideString',0,tkVariant,nil,__TMemoFieldGetAsWideString,false,0,'');
    DefineMethod('GetAsVariant',0,tkVariant,nil,__TMemoFieldGetAsVariant,false,0,'');
    DefineMethod('SetAsString',1,tkNone,nil,__TMemoFieldSetAsString,false,0,'Value: string');
    DefineMethod('SetAsWideString',1,tkNone,nil,__TMemoFieldSetAsWideString,false,0,'Value: UnicodeString');
    DefineProp('Value',tkVariant,__GetTMemoFieldValue,__SetTMemoFieldValue,nil,false,0);
  end;
  With Scripter.DefineClass(TWideMemoField) do
  begin
    DefineMethod('Create',1,tkClass,TWideMemoField,__TWideMemoFieldCreate,true,0,'AOwner: TComponent');
    DefineProp('Value',tkVariant,__GetTWideMemoFieldValue,__SetTWideMemoFieldValue,nil,false,0);
  end;
  With Scripter.DefineClass(TGraphicField) do
  begin
    DefineMethod('Create',1,tkClass,TGraphicField,__TGraphicFieldCreate,true,0,'AOwner: TComponent');
  end;
  With Scripter.DefineClass(TObjectField) do
  begin
    DefineMethod('Create',1,tkClass,TObjectField,__TObjectFieldCreate,true,0,'AOwner: TComponent');
  ...
  begin
    DefineMethod('Create',1,tkClass,TADTField,__TADTFieldCreate,true,0,'AOwner: TComponent');
  end;
  With Scripter.DefineClass(TArrayField) do
  begin
    DefineMethod('Create',1,tkClass,TArrayField,__TArrayFieldCreate,true,0,'AOwner: TComponent');
    DefineProp('Size',tkVariant,nil,nil,nil,false,0);
  end;
  With Scripter.DefineClass(TDataSetField) do
  begin
    DefineMethod('Create',1,tkClass,TDataSetField,__TDataSetFieldCreate,true,0,'AOwner: TComponent');
    DefineMethod('Destroy',0,tkNone,nil,__TDataSetFieldDestroy,false,0,'');
    DefineMethod('Assign',1,tkNone,nil,__TDataSetFieldAssign,false,0,'Source: TPersistent');
  ...
  begin
    DefineMethod('Create',1,tkClass,TReferenceField,__TReferenceFieldCreate,true,0,'AOwner: TComponent');
    DefineMethod('Assign',1,tkNone,nil,__TReferenceFieldAssign,false,0,'Source: TPersistent');
  end;
  With Scripter.DefineClass(TVariantField) do
  begin
    DefineMethod('Create',1,tkClass,TVariantField,__TVariantFieldCreate,true,0,'AOwner: TComponent');
  end;
  With Scripter.DefineClass(TInterfaceField) do
  begin
    DefineMethod('Create',1,tkClass,TInterfaceField,__TInterfaceFieldCreate,true,0,'AOwner: TComponent');
  end;
  With Scripter.DefineClass(TIDispatchField) do
  begin
    DefineMethod('Create',1,tkClass,TIDispatchField,__TIDispatchFieldCreate,true,0,'AOwner: TComponent');
  end;
  With Scripter.DefineClass(TGuidField) do
  begin
    DefineMethod('Create',1,tkClass,TGuidField,__TGuidFieldCreate,true,0,'AOwner: TComponent');
  ...
  begin
    DefineMethod('Create',1,tkClass,TAggregateField,__TAggregateFieldCreate,true,0,'AOwner: TComponent');
  ...
  begin
    ...
    DefineMethod('ExecuteAction',1,tkVariant,nil,__TDataLinkExecuteAction,false,0,'Action: TBasicAction');
    DefineMethod('UpdateAction',1,tkVariant,nil,__TDataLinkUpdateAction,false,0,'Action: TBasicAction');
  ...
  begin
    DefineMethod('Create',1,tkClass,TMasterDataLink,__TMasterDataLinkCreate,true,0,'DataSet: TDataSet');
  ...
  begin
    DefineMethod('Create',1,tkClass,TDataSource,__TDataSourceCreate,true,0,'AOwner: TComponent');
    DefineMethod('Destroy',0,tkNone,nil,__TDataSourceDestroy,false,0,'');
    DefineMethod('Edit',0,tkNone,nil,__TDataSourceEdit,false,0,'');
    DefineMethod('IsLinkedTo',1,tkVariant,nil,__TDataSourceIsLinkedTo,false,0,'DataSet: TDataSet');
    DefineProp('State',tkEnumeration,__GetTDataSourceState,nil,nil,false,0);
  end;
  With Scripter.DefineClass(TDataSetDesigner) do
  begin
    DefineMethod('Create',1,tkClass,TDataSetDesigner,__TDataSetDesignerCreate,true,0,'DataSet: TDataSet');
    ...
    DefineMethod('DataEvent',2,tkNone,nil,__TDataSetDesignerDataEvent,false,0,'Event: TDataEvent; Info: Longint');
  ...
  begin
    DefineMethod('Assign',1,tkNone,nil,__TCheckConstraintAssign,false,0,'Source: TPersistent');
  ...
  begin
    DefineMethod('Create',1,tkClass,TCheckConstraints,__TCheckConstraintsCreate,true,0,'Owner: TPersistent');
  ...
  begin
    DefineMethod('Create',1,tkClass,TParam,__TParamCreate,true,0,'Collection: TCollection');
    DefineMethod('Assign',1,tkNone,nil,__TParamAssign,false,0,'Source: TPersistent');
    DefineMethod('AssignField',1,tkNone,nil,__TParamAssignField,false,0,'Field: TField');
    DefineMethod('AssignFieldValue',2,tkNone,nil,__TParamAssignFieldValue,false,0,'Field: TField; Value: Variant');
    ...
    DefineMethod('LoadFromFile',2,tkNone,nil,__TParamLoadFromFile,false,0,'FileName: string; BlobType: TBlobType');
    DefineMethod('LoadFromStream',2,tkNone,nil,__TParamLoadFromStream,false,0,'Stream: TStream; BlobType: TBlobType');
    DefineMethod('SetDataSet',2,tkNone,nil,__TParamSetDataSet,false,0,'Dataset: TDataSet; AInstanceOwner: Boolean');
    DefineMethod('SetParams',2,tkNone,nil,__TParamSetParams,false,0,'Params: TParams; AInstanceOwner: Boolean');
    DefineMethod('SetStream',3,tkNone,nil,__TParamSetStream,false,1,'Stream: TStream; AInstanceOwner: Boolean; KnownSize: Integer = 0');
    ...
    DefineProp('AsSingle',tkVariant,__GetTParamAsSingle,__SetTParamAsSingle,nil,false,0);
    ...
    DefineProp('AsShortInt',tkInteger,__GetTParamAsShortInt,__SetTParamAsShortInt,nil,false,0);
    DefineProp('AsByte',tkInteger,__GetTParamAsByte,__SetTParamAsByte,nil,false,0);
    DefineProp('AsLongWord',tkInteger,__GetTParamAsLongWord,__SetTParamAsLongWord,nil,false,0);
    DefineProp('AsLargeInt',tkVariant,__GetTParamAsLargeInt,__SetTParamAsLargeInt,nil,false,0);
    DefineProp('AsSQLTimeStamp',tkVariant,__GetTParamAsSQLTimeStamp,__SetTParamAsSQLTimeStamp,nil,false,0);
    DefineProp('AsSQLTimeStampOffset',tkVariant,__GetTParamAsSQLTimeStampOffset,__SetTParamAsSQLTimeStampOffset,nil,false,0);
    ...
    DefineProp('AsWideString',tkVariant,__GetTParamAsWideString,__SetTParamAsWideString,nil,false,0);
    DefineProp('AsAnsiString',tkVariant,__GetTParamAsAnsiString,__SetTParamAsAnsiString,nil,false,0);
    ...
    DefineProp('AsDataSet',tkClass,__GetTParamAsDataSet,__SetTParamAsDataSet,TDataSet,false,0);
    DefineProp('AsObject',tkClass,__GetTParamAsObject,__SetTParamAsObject,TObject,false,0);
    DefineProp('AsParams',tkClass,__GetTParamAsParams,__SetTParamAsParams,TParams,false,0);
    DefineProp('AsStream',tkClass,__GetTParamAsStream,__SetTParamAsStream,TStream,false,0);
  ...
  begin
    DefineMethod('Create',1,tkClass,TParams,__TParamsCreate,true,0,'Owner: TPersistent');
    DefineMethod('AddParameter',0,tkClass,TParam,__TParamsAddParameter,false,0,'');
    DefineMethod('AssignValues',1,tkNone,nil,__TParamsAssignValues,false,0,'Value: TParams');
    DefineMethod('AddParam',1,tkNone,nil,__TParamsAddParam,false,0,'Value: TParam');
    DefineMethod('RemoveParam',1,tkNone,nil,__TParamsRemoveParam,false,0,'Value: TParam');
    DefineMethod('CreateParam',3,tkClass,TParam,__TParamsCreateParam,false,0,'FldType: TFieldType; ParamName: string; ParamType: TParamType');
    DefineMethod('GetParamList',2,tkNone,nil,__TParamsGetParamList,false,0,'List: TList; ParamNames: string');
    DefineMethod('IsEqual',1,tkVariant,nil,__TParamsIsEqual,false,0,'Value: TParams');
    DefineMethod('ParseSQL',2,tkVariant,nil,__TParamsParseSQL,false,0,'SQL: string; DoCreate: Boolean');
    DefineMethod('ParamByName',1,tkClass,TParam,__TParamsParamByName,false,0,'Value: string');
    DefineMethod('FindParam',1,tkClass,TParam,__TParamsFindParam,false,0,'Value: string');
  ...
  With Scripter.DefineClass(TParamObject) do
  begin
    DefineMethod('Create',3,tkClass,TParamObject,__TParamObjectCreate,true,0,'AObject: TObject; ADataType: TFieldType; AInstanceOwner: Boolean');
    DefineMethod('Destroy',0,tkNone,nil,__TParamObjectDestroy,false,0,'');
  end;
  With Scripter.DefineClass(TParamStreamObject) do
  begin
  end;
  With Scripter.DefineClass(TDataSet) do
  begin
    DefineMethod('Create',1,tkClass,TDataSet,__TDataSetCreate,true,0,'AOwner: TComponent');
    ...
    DefineMethod('CreateBlobStream',2,tkClass,TStream,__TDataSetCreateBlobStream,false,0,'Field: TField; Mode: TBlobStreamMode');
    ...
    DefineMethod('FieldByName',1,tkClass,TField,__TDataSetFieldByName,false,0,'FieldName: string');
    DefineMethod('FindField',1,tkClass,TField,__TDataSetFindField,false,0,'FieldName: string');
    ...
    DefineMethod('GetDetailDataSets',1,tkNone,nil,__TDataSetGetDetailDataSets,false,0,'List: TList');
    DefineMethod('GetDetailLinkFields',2,tkNone,nil,__TDataSetGetDetailLinkFields,false,0,'MasterFields: TList; DetailFields: TList');
    DefineMethod('GetFieldList',2,tkNone,nil,__TDataSetGetFieldList,false,0,'List: TList; FieldNames: string');
    DefineMethod('GetFieldNames',1,tkNone,nil,__TDataSetGetFieldNames,false,0,'List: TStrings');
    DefineMethod('Insert',0,tkNone,nil,__TDataSetInsert,false,0,'');
    DefineMethod('IsEmpty',0,tkVariant,nil,__TDataSetIsEmpty,false,0,'');
    DefineMethod('IsLinkedTo',1,tkVariant,nil,__TDataSetIsLinkedTo,false,0,'DataSource: TDataSource');
    ...
    DefineMethod('Locate',3,tkVariant,nil,__TDataSetLocate,false,0,'KeyFields: string; KeyValues: Variant; Options: TLocateOptions');
    DefineMethod('Lookup',3,tkVariant,nil,__TDataSetLookup,false,0,'KeyFields: string; KeyValues: Variant; ResultFields: string');
    DefineMethod('MoveBy',1,tkInteger,nil,__TDataSetMoveBy,false,0,'Distance: Integer');
    ...
    DefineMethod('Resync',1,tkNone,nil,__TDataSetResync,false,0,'Mode: TResyncMode');
    DefineMethod('CopyFields',1,tkInteger,nil,__TDataSetCopyFields,false,0,'Source: TDataSet');
    DefineMethod('Translate',3,tkInteger,nil,__TDataSetTranslate,false,0,'Src: PAnsiChar; Dest: PAnsiChar; ToOem: Boolean');
  ...
  With Scripter.DefineClass(TWideDataSet) do
  begin
  end;
  ...
  begin
    DefineMethod('ExtractFieldName',2,tkVariant,nil,__ExtractFieldName,false,0,'Fields: string; Pos: Integer').SetVarArgs([1]);
    DefineMethod('DatabaseError',2,tkNone,nil,__DatabaseError,false,1,'Message: string; Component: TComponent = nil');
    DefineMethod('DisposeMem',2,tkNone,nil,__DisposeMem,false,0,'Buffer; Size: Integer').SetVarArgs([0]);
    DefineMethod('GetFieldProperty',3,tkClass,TField,__GetFieldProperty,false,0,'DataSet: TDataSet; Control: TComponent; FieldName: string');
    DefineMethod('VarTypeToDataType',1,tkEnumeration,nil,__VarTypeToDataType,false,0,'Type: Integer').SetVarArgs([0]);
    ...
    AddConstant('ftFixedWideChar',ftFixedWideChar);
    AddConstant('ftWideMemo',ftWideMemo);
    AddConstant('ftOraTimeStamp',ftOraTimeStamp);
    AddConstant('ftOraInterval',ftOraInterval);
    AddConstant('ftLongWord',ftLongWord);
    AddConstant('ftShortint',ftShortint);
    AddConstant('ftByte',ftByte);
    AddConstant('ftExtended',ftExtended);
    AddConstant('ftConnection',ftConnection);
    AddConstant('ftParams',ftParams);
    AddConstant('ftStream',ftStream);
    AddConstant('ftTimeStampOffset',ftTimeStampOffset);
    AddConstant('ftObject',ftObject);
    ...
    AddConstant('deReconcileError',deReconcileError);
    AddConstant('deDisabledStateChange',deDisabledStateChange);
    ...
    AddConstant('ctUnknown',ctUnknown);
    AddConstant('ctQuery',ctQuery);
    AddConstant('ctTable',ctTable);
    AddConstant('ctStoredProc',ctStoredProc);
    AddConstant('ctServerMethod',ctServerMethod);
    AddConstant('ctSelect',ctSelect);
    AddConstant('ctInsert',ctInsert);
    AddConstant('ctUpdate',ctUpdate);
    AddConstant('ctDelete',ctDelete);
    AddConstant('ctDDL',ctDDL);
