...
AResult := WinSpool.DeletePrinterDriver(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := WinSpool.DeletePrinterDriverA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(2)))));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
AResult := WinSpool.DeletePrinterDriverW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
AResult := WinSpool.DeletePrinterDriverEx(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)),VarToInteger(GetInputArg(3)),VarToInteger(GetInputArg(4)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := WinSpool.DeletePrinterDriverExA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(2)))),VarToInteger(GetInputArg(3)),VarToInteger(GetInputArg(4)));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
AResult := WinSpool.DeletePrinterDriverExW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)),VarToInteger(GetInputArg(3)),VarToInteger(GetInputArg(4)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(WinSpool.DeletePrinterKeyA(VarToInteger(GetInputArg(0)),PAnsiChar(AnsiString(VarToStr(GetInputArg(1))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(WinSpool.DeletePrinterKeyW(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := WinSpool.AddPrintProcessor(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)),StringToWideChar(VarToStr(GetInputArg(3)),@Param3Buf[0],Length(Param3Buf)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := WinSpool.AddPrintProcessorA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(2)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(3)))));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
SetLength(Param3Buf, Length(VarToStr(GetInputArg(3))) + 1);
AResult := WinSpool.AddPrintProcessorW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)),StringToWideChar(VarToStr(GetInputArg(3)),@Param3Buf[0],Length(Param3Buf)));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
AResult := WinSpool.DeletePrintProcessor(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := WinSpool.DeletePrintProcessorA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(2)))));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
AResult := WinSpool.DeletePrintProcessorW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := Integer(WinSpool.DocumentProperties(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)),_devicemodeWWrapper(integer(GetInputArg(3))).ObjToRec,Param4,VarToInteger(GetInputArg(5))));
    ReturnOutputArg(AResult);
...
AResult := Integer(WinSpool.DocumentPropertiesA(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),PAnsiChar(AnsiString(VarToStr(GetInputArg(2)))),_devicemodeAWrapper(integer(GetInputArg(3))).ObjToRec,Param4,VarToInteger(GetInputArg(5))));
    ReturnOutputArg(AResult);
...
if not Assigned(Param4Rec) or not (Param4Rec is _devicemodeWWrapper) then 
  Param4Rec := _devicemodeWWrapper.Create(Param4);
Param4 := _devicemodeWWrapper(Param4Rec).ObjToRec;
AResult := Integer(WinSpool.DocumentPropertiesW(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)),_devicemodeWWrapper(integer(GetInputArg(3))).ObjToRec,Param4,VarToInteger(GetInputArg(5))));
    ReturnOutputArg(AResult);
    SetInputArg(4,integer(_devicemodeWWrapper.Create(Param4)));
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(WinSpool.DeletePrinterData(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(WinSpool.DeletePrinterDataA(VarToInteger(GetInputArg(0)),PAnsiChar(AnsiString(VarToStr(GetInputArg(1))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(WinSpool.DeletePrinterDataW(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
AResult := Integer(WinSpool.DeletePrinterDataEx(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(WinSpool.DeletePrinterDataExA(VarToInteger(GetInputArg(0)),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(2))))));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
AResult := Integer(WinSpool.DeletePrinterDataExW(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := Integer(WinSpool.PrinterMessageBox(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),StringToWideChar(VarToStr(GetInputArg(3)),@Param3Buf[0],Length(Param3Buf)),StringToWideChar(VarToStr(GetInputArg(4)),@Param4Buf[0],Length(Param4Buf)),VarToInteger(GetInputArg(5))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(WinSpool.PrinterMessageBoxA(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),PAnsiChar(AnsiString(VarToStr(GetInputArg(3)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(4)))),VarToInteger(GetInputArg(5))));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param3Buf, Length(VarToStr(GetInputArg(3))) + 1);
SetLength(Param4Buf, Length(VarToStr(GetInputArg(4))) + 1);
AResult := Integer(WinSpool.PrinterMessageBoxW(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),StringToWideChar(VarToStr(GetInputArg(3)),@Param3Buf[0],Length(Param3Buf)),StringToWideChar(VarToStr(GetInputArg(4)),@Param4Buf[0],Length(Param4Buf)),VarToInteger(GetInputArg(5))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := WinSpool.DeleteForm(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := WinSpool.DeleteFormA(VarToInteger(GetInputArg(0)),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := WinSpool.DeleteFormW(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
AResult := WinSpool.DeleteMonitor(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := WinSpool.DeleteMonitorA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(2)))));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
AResult := WinSpool.DeleteMonitorW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
AResult := WinSpool.AddPort(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := WinSpool.AddPortA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),VarToInteger(GetInputArg(1)),PAnsiChar(AnsiString(VarToStr(GetInputArg(2)))));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
AResult := WinSpool.AddPortW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
AResult := WinSpool.ConfigurePort(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := WinSpool.ConfigurePortA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),VarToInteger(GetInputArg(1)),PAnsiChar(AnsiString(VarToStr(GetInputArg(2)))));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
AResult := WinSpool.ConfigurePortW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
AResult := WinSpool.DeletePort(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := WinSpool.DeletePortA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),VarToInteger(GetInputArg(1)),PAnsiChar(AnsiString(VarToStr(GetInputArg(2)))));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
AResult := WinSpool.DeletePortW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := WinSpool.AddPrinterConnection(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := WinSpool.AddPrinterConnectionA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := WinSpool.AddPrinterConnectionW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := WinSpool.DeletePrinterConnection(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := WinSpool.DeletePrinterConnectionA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := WinSpool.DeletePrinterConnectionW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
AResult := WinSpool.DeletePrintProvidor(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := WinSpool.DeletePrintProvidorA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(2)))));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
AResult := WinSpool.DeletePrintProvidorW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := WinSpool.CloseSpoolFileHandle(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(WinSpool.CommitSpoolData(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
AResult := Integer(WinSpool.DeletePrinterDriverPackage(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(WinSpool.DeletePrinterDriverPackageA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(2))))));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
AResult := Integer(WinSpool.DeletePrinterDriverPackageW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(WinSpool.GetSpoolFileHandle(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
SetLength(Param3Buf, Length(VarToStr(GetInputArg(3))) + 1);
AResult := Integer(WinSpool.InstallPrinterDriverFromPackage(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)),StringToWideChar(VarToStr(GetInputArg(3)),@Param3Buf[0],Length(Param3Buf)),VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(WinSpool.InstallPrinterDriverFromPackageA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(2)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(3)))),VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
SetLength(Param3Buf, Length(VarToStr(GetInputArg(3))) + 1);
AResult := Integer(WinSpool.InstallPrinterDriverFromPackageW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)),StringToWideChar(VarToStr(GetInputArg(3)),@Param3Buf[0],Length(Param3Buf)),VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(WinSpool.ReportJobProcessingProgress(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),TEPrintXPSJobOperation(VarToInteger(GetInputArg(2))),TEPrintXPSJobProgress(VarToInteger(GetInputArg(3)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := WinSpool.SetDefaultPrinter(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := WinSpool.SetDefaultPrinterA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := WinSpool.SetDefaultPrinterW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  With Scripter.DefineClass(ClassType) do
  begin
    DefineMethod('DeletePrinter',1,tkVariant,nil,__DeletePrinter,false,0,'hPrinter: THandle');
    DefineMethod('DeletePrinterDriver',3,tkVariant,nil,__DeletePrinterDriver,false,0,'pName: PWideChar; pEnvironment: PWideChar; pDriverName: PWideChar');
    DefineMethod('DeletePrinterDriverA',3,tkVariant,nil,__DeletePrinterDriverA,false,0,'pName: PAnsiChar; pEnvironment: PAnsiChar; pDriverName: PAnsiChar');
    DefineMethod('DeletePrinterDriverW',3,tkVariant,nil,__DeletePrinterDriverW,false,0,'pName: PWideChar; pEnvironment: PWideChar; pDriverName: PWideChar');
    DefineMethod('DeletePrinterDriverEx',5,tkVariant,nil,__DeletePrinterDriverEx,false,0,'pName: PWideChar; pEnvironment: PWideChar; pDriverName: PWideChar; dwDeleteFlag: DWORD; dwVersionFlag: DWORD');
    DefineMethod('DeletePrinterDriverExA',5,tkVariant,nil,__DeletePrinterDriverExA,false,0,'pName: PAnsiChar; pEnvironment: PAnsiChar; pDriverName: PAnsiChar; dwDeleteFlag: DWORD; dwVersionFlag: DWORD');
    DefineMethod('DeletePrinterDriverExW',5,tkVariant,nil,__DeletePrinterDriverExW,false,0,'pName: PWideChar; pEnvironment: PWideChar; pDriverName: PWideChar; dwDeleteFlag: DWORD; dwVersionFlag: DWORD');
    DefineMethod('DeletePrinterKeyA',2,tkInteger,nil,__DeletePrinterKeyA,false,0,'hPrinter: THandle; pKeyName: PAnsiChar');
    DefineMethod('DeletePrinterKeyW',2,tkInteger,nil,__DeletePrinterKeyW,false,0,'hPrinter: THandle; pKeyName: PWideChar');
    DefineMethod('AddPrintProcessor',4,tkVariant,nil,__AddPrintProcessor,false,0,'pName: PWideChar; pEnvironment: PWideChar; pPathName: PWideChar; pPrintProcessorName: PWideChar');
    DefineMethod('AddPrintProcessorA',4,tkVariant,nil,__AddPrintProcessorA,false,0,'pName: PAnsiChar; pEnvironment: PAnsiChar; pPathName: PAnsiChar; pPrintProcessorName: PAnsiChar');
    DefineMethod('AddPrintProcessorW',4,tkVariant,nil,__AddPrintProcessorW,false,0,'pName: PWideChar; pEnvironment: PWideChar; pPathName: PWideChar; pPrintProcessorName: PWideChar');
    DefineMethod('DeletePrintProcessor',3,tkVariant,nil,__DeletePrintProcessor,false,0,'pName: PWideChar; pEnvironment: PWideChar; pPrintProcessorName: PWideChar');
    DefineMethod('DeletePrintProcessorA',3,tkVariant,nil,__DeletePrintProcessorA,false,0,'pName: PAnsiChar; pEnvironment: PAnsiChar; pPrintProcessorName: PAnsiChar');
    DefineMethod('DeletePrintProcessorW',3,tkVariant,nil,__DeletePrintProcessorW,false,0,'pName: PWideChar; pEnvironment: PWideChar; pPrintProcessorName: PWideChar');
    DefineMethod('StartPagePrinter',1,tkVariant,nil,__StartPagePrinter,false,0,'hPrinter: THandle');
    DefineMethod('EndPagePrinter',1,tkVariant,nil,__EndPagePrinter,false,0,'hPrinter: THandle');
    DefineMethod('AbortPrinter',1,tkVariant,nil,__AbortPrinter,false,0,'hPrinter: THandle');
    DefineMethod('EndDocPrinter',1,tkVariant,nil,__EndDocPrinter,false,0,'hPrinter: THandle');
    DefineMethod('ScheduleJob',2,tkVariant,nil,__ScheduleJob,false,0,'hPrinter: THandle; JobId: DWORD');
    DefineMethod('PrinterProperties',2,tkVariant,nil,__PrinterProperties,false,0,'hWnd: HWND; hPrinter: THandle');
    DefineMethod('DocumentProperties',6,tkInteger,nil,__DocumentProperties,false,0,'hWnd: HWND; hPrinter: THandle; pDeviceName: PWideChar; pDevModeOutput: TDeviceMode; pDevModeInput: TDeviceMode; fMode: DWORD').SetVarArgs([4]);
    DefineMethod('DocumentPropertiesA',6,tkInteger,nil,__DocumentPropertiesA,false,0,'hWnd: HWND; hPrinter: THandle; pDeviceName: PAnsiChar; pDevModeOutput: TDeviceModeA; pDevModeInput: TDeviceModeA; fMode: DWORD').SetVarArgs([4]);
    DefineMethod('DocumentPropertiesW',6,tkInteger,nil,__DocumentPropertiesW,false,0,'hWnd: HWND; hPrinter: THandle; pDeviceName: PWideChar; pDevModeOutput: TDeviceModeW; pDevModeInput: TDeviceModeW; fMode: DWORD').SetVarArgs([4]);
    DefineMethod('DeletePrinterData',2,tkInteger,nil,__DeletePrinterData,false,0,'hPrinter: THandle; pValueName: PWideChar');
    DefineMethod('DeletePrinterDataA',2,tkInteger,nil,__DeletePrinterDataA,false,0,'hPrinter: THandle; pValueName: PAnsiChar');
    DefineMethod('DeletePrinterDataW',2,tkInteger,nil,__DeletePrinterDataW,false,0,'hPrinter: THandle; pValueName: PWideChar');
    DefineMethod('DeletePrinterDataEx',3,tkInteger,nil,__DeletePrinterDataEx,false,0,'hPrinter: THandle; pKeyName: PWideChar; pValueName: PWideChar');
    DefineMethod('DeletePrinterDataExA',3,tkInteger,nil,__DeletePrinterDataExA,false,0,'hPrinter: THandle; pKeyName: PAnsiChar; pValueName: PAnsiChar');
    DefineMethod('DeletePrinterDataExW',3,tkInteger,nil,__DeletePrinterDataExW,false,0,'hPrinter: THandle; pKeyName: PWideChar; pValueName: PWideChar');
    DefineMethod('WaitForPrinterChange',2,tkInteger,nil,__WaitForPrinterChange,false,0,'hPrinter: THandle; Flags: DWORD');
    DefineMethod('FindClosePrinterChangeNotification',1,tkVariant,nil,__FindClosePrinterChangeNotification,false,0,'hChange: THandle');
    DefineMethod('PrinterMessageBox',6,tkInteger,nil,__PrinterMessageBox,false,0,'hPrinter: THandle; Error: DWORD; hWnd: HWND; pText: PWideChar; pCaption: PWideChar; dwType: DWORD');
    DefineMethod('PrinterMessageBoxA',6,tkInteger,nil,__PrinterMessageBoxA,false,0,'hPrinter: THandle; Error: DWORD; hWnd: HWND; pText: PAnsiChar; pCaption: PAnsiChar; dwType: DWORD');
    DefineMethod('PrinterMessageBoxW',6,tkInteger,nil,__PrinterMessageBoxW,false,0,'hPrinter: THandle; Error: DWORD; hWnd: HWND; pText: PWideChar; pCaption: PWideChar; dwType: DWORD');
    DefineMethod('ClosePrinter',1,tkVariant,nil,__ClosePrinter,false,0,'hPrinter: THandle');
    DefineMethod('DeleteForm',2,tkVariant,nil,__DeleteForm,false,0,'hPrinter: THandle; pFormName: PWideChar');
    DefineMethod('DeleteFormA',2,tkVariant,nil,__DeleteFormA,false,0,'hPrinter: THandle; pFormName: PAnsiChar');
    DefineMethod('DeleteFormW',2,tkVariant,nil,__DeleteFormW,false,0,'hPrinter: THandle; pFormName: PWideChar');
    DefineMethod('DeleteMonitor',3,tkVariant,nil,__DeleteMonitor,false,0,'pName: PWideChar; pEnvironment: PWideChar; pMonitorName: PWideChar');
    DefineMethod('DeleteMonitorA',3,tkVariant,nil,__DeleteMonitorA,false,0,'pName: PAnsiChar; pEnvironment: PAnsiChar; pMonitorName: PAnsiChar');
    DefineMethod('DeleteMonitorW',3,tkVariant,nil,__DeleteMonitorW,false,0,'pName: PWideChar; pEnvironment: PWideChar; pMonitorName: PWideChar');
    DefineMethod('AddPort',3,tkVariant,nil,__AddPort,false,0,'pName: PWideChar; hWnd: HWND; pMonitorName: PWideChar');
    DefineMethod('AddPortA',3,tkVariant,nil,__AddPortA,false,0,'pName: PAnsiChar; hWnd: HWND; pMonitorName: PAnsiChar');
    DefineMethod('AddPortW',3,tkVariant,nil,__AddPortW,false,0,'pName: PWideChar; hWnd: HWND; pMonitorName: PWideChar');
    DefineMethod('ConfigurePort',3,tkVariant,nil,__ConfigurePort,false,0,'pName: PWideChar; hWnd: HWND; pPortName: PWideChar');
    DefineMethod('ConfigurePortA',3,tkVariant,nil,__ConfigurePortA,false,0,'pName: PAnsiChar; hWnd: HWND; pPortName: PAnsiChar');
    DefineMethod('ConfigurePortW',3,tkVariant,nil,__ConfigurePortW,false,0,'pName: PWideChar; hWnd: HWND; pPortName: PWideChar');
    DefineMethod('DeletePort',3,tkVariant,nil,__DeletePort,false,0,'pName: PWideChar; hWnd: HWND; pPortName: PWideChar');
    DefineMethod('DeletePortA',3,tkVariant,nil,__DeletePortA,false,0,'pName: PAnsiChar; hWnd: HWND; pPortName: PAnsiChar');
    DefineMethod('DeletePortW',3,tkVariant,nil,__DeletePortW,false,0,'pName: PWideChar; hWnd: HWND; pPortName: PWideChar');
    DefineMethod('AddPrinterConnection',1,tkVariant,nil,__AddPrinterConnection,false,0,'pName: PWideChar');
    DefineMethod('AddPrinterConnectionA',1,tkVariant,nil,__AddPrinterConnectionA,false,0,'pName: PAnsiChar');
    DefineMethod('AddPrinterConnectionW',1,tkVariant,nil,__AddPrinterConnectionW,false,0,'pName: PWideChar');
    DefineMethod('DeletePrinterConnection',1,tkVariant,nil,__DeletePrinterConnection,false,0,'pName: PWideChar');
    DefineMethod('DeletePrinterConnectionA',1,tkVariant,nil,__DeletePrinterConnectionA,false,0,'pName: PAnsiChar');
    DefineMethod('DeletePrinterConnectionW',1,tkVariant,nil,__DeletePrinterConnectionW,false,0,'pName: PWideChar');
    DefineMethod('ConnectToPrinterDlg',2,tkInteger,nil,__ConnectToPrinterDlg,false,0,'hwnd: HWND; Flags: DWORD');
    DefineMethod('DeletePrintProvidor',3,tkVariant,nil,__DeletePrintProvidor,false,0,'pName: PWideChar; pEnvironment: PWideChar; pPrintProvidorName: PWideChar');
    DefineMethod('DeletePrintProvidorA',3,tkVariant,nil,__DeletePrintProvidorA,false,0,'pName: PAnsiChar; pEnvironment: PAnsiChar; pPrintProvidorName: PAnsiChar');
    DefineMethod('DeletePrintProvidorW',3,tkVariant,nil,__DeletePrintProvidorW,false,0,'pName: PWideChar; pEnvironment: PWideChar; pPrintProvidorName: PWideChar');
    DefineMethod('CloseSpoolFileHandle',2,tkVariant,nil,__CloseSpoolFileHandle,false,0,'hPrinter: THandle; hSpoolFile: THandle');
    DefineMethod('CommitSpoolData',3,tkInteger,nil,__CommitSpoolData,false,0,'hPrinter: THandle; hSpoolFile: THandle; cbCommit: DWORD');
    DefineMethod('DeletePrinterDriverPackage',3,tkInteger,nil,__DeletePrinterDriverPackage,false,0,'pszServer: PWideChar; pszInfPath: PWideChar; pszEnvironment: PWideChar');
    DefineMethod('DeletePrinterDriverPackageA',3,tkInteger,nil,__DeletePrinterDriverPackageA,false,0,'pszServer: PAnsiChar; pszInfPath: PAnsiChar; pszEnvironment: PAnsiChar');
    DefineMethod('DeletePrinterDriverPackageW',3,tkInteger,nil,__DeletePrinterDriverPackageW,false,0,'pszServer: PWideChar; pszInfPath: PWideChar; pszEnvironment: PWideChar');
    DefineMethod('GetSpoolFileHandle',1,tkInteger,nil,__GetSpoolFileHandle,false,0,'hPrinter: THandle');
    DefineMethod('InstallPrinterDriverFromPackage',5,tkInteger,nil,__InstallPrinterDriverFromPackage,false,0,'pszServer: PWideChar; pszInfPath: PWideChar; pszDriverName: PWideChar; pszEnvironment: PWideChar; dwFlags: DWORD');
    DefineMethod('InstallPrinterDriverFromPackageA',5,tkInteger,nil,__InstallPrinterDriverFromPackageA,false,0,'pszServer: PAnsiChar; pszInfPath: PAnsiChar; pszDriverName: PAnsiChar; pszEnvironment: PAnsiChar; dwFlags: DWORD');
    DefineMethod('InstallPrinterDriverFromPackageW',5,tkInteger,nil,__InstallPrinterDriverFromPackageW,false,0,'pszServer: PWideChar; pszInfPath: PWideChar; pszDriverName: PWideChar; pszEnvironment: PWideChar; dwFlags: DWORD');
    DefineMethod('PrintWindow',3,tkVariant,nil,__PrintWindow,false,0,'hWnd: HWND; hdcBlt: HDC; nFlags: UINT');
    DefineMethod('ReportJobProcessingProgress',4,tkInteger,nil,__ReportJobProcessingProgress,false,0,'printerHandle: THandle; jobId: ULONG; jobOperation: TEPrintXPSJobOperation; jobProgress: TEPrintXPSJobProgress');
    DefineMethod('SetDefaultPrinter',1,tkVariant,nil,__SetDefaultPrinter,false,0,'pszPrinter: PWideChar');
    DefineMethod('SetDefaultPrinterA',1,tkVariant,nil,__SetDefaultPrinterA,false,0,'pszPrinter: PAnsiChar');
    DefineMethod('SetDefaultPrinterW',1,tkVariant,nil,__SetDefaultPrinterW,false,0,'pszPrinter: PWideChar');
