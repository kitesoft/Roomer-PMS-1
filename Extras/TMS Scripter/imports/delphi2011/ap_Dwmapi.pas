...
AResult := Integer(Dwmapi.DwmEnableBlurBehindWindow(VarToInteger(GetInputArg(0)),Param1));
    ReturnOutputArg(AResult);
...
AResult := Integer(Dwmapi.DwmUpdateThumbnailProperties(VarToInteger(GetInputArg(0)),Param1));
    ReturnOutputArg(AResult);
...
begin
  with AMachine do
  begin
AResult := Integer(Dwmapi.DwmSetIconicThumbnail(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := Integer(Dwmapi.DwmSetIconicLivePreviewBitmap(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),Param2,VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
...
begin
  with AMachine do
  begin
AResult := Integer(Dwmapi.DwmInvalidateIconicBitmaps(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Dwmapi.DwmAttachMilContent(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Dwmapi.DwmDetachMilContent(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Dwmapi.DwmFlush);
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := Integer(Dwmapi.DwmGetGraphicsStreamTransformHint(VarToInteger(GetInputArg(0)),Param1));
    ReturnOutputArg(AResult);
...
AResult := Integer(Dwmapi.DwmGetTransportAttributes(Param0,Param1,Param2));
    ReturnOutputArg(AResult);
    SetInputArg(0,Param0);
    SetInputArg(1,Param1);
...
begin
  ...
  begin
    DefineMethod('DwmDefWindowProc',5,tkVariant,nil,__DwmDefWindowProc,false,0,'hWnd: HWND; msg: UINT; wParam: WPARAM; lParam: LPARAM; plResult: LRESULT').SetVarArgs([4]);
    DefineMethod('DwmEnableBlurBehindWindow',2,tkInteger,nil,__DwmEnableBlurBehindWindow,false,0,'hWnd: HWND; pBlurBehind: TDwmBlurbehind').SetVarArgs([1]);
    DefineMethod('DwmEnableComposition',1,tkInteger,nil,__DwmEnableComposition,false,0,'uCompositionAction: UINT');
    DefineMethod('DwmEnableMMCSS',1,tkInteger,nil,__DwmEnableMMCSS,false,0,'fEnableMMCSS: BOOL');
    DefineMethod('DwmExtendFrameIntoClientArea',2,tkInteger,nil,__DwmExtendFrameIntoClientArea,false,0,'hWnd: HWND; pMarInset: TMargins');
    DefineMethod('DwmGetColorizationColor',2,tkInteger,nil,__DwmGetColorizationColor,false,0,'pcrColorization: DWORD; pfOpaqueBlend: BOOL').SetVarArgs([0,1]);
    DefineMethod('DwmGetCompositionTimingInfo',2,tkInteger,nil,__DwmGetCompositionTimingInfo,false,0,'hwnd: HWND; pTimingInfo: TDwmTimingInfo').SetVarArgs([1]);
    DefineMethod('DwmIsCompositionEnabled',1,tkInteger,nil,__DwmIsCompositionEnabled,false,0,'pfEnabled: BOOL').SetVarArgs([0]);
    DefineMethod('DwmModifyPreviousDxFrameDuration',3,tkInteger,nil,__DwmModifyPreviousDxFrameDuration,false,0,'hwnd: HWND; cRefreshes: Integer; fRelative: BOOL');
    DefineMethod('DwmSetDxFrameDuration',2,tkInteger,nil,__DwmSetDxFrameDuration,false,0,'hwnd: HWND; cRefreshes: Integer');
    DefineMethod('DwmSetPresentParameters',2,tkInteger,nil,__DwmSetPresentParameters,false,0,'hwnd: HWND; pPresentParams: TDwmPresentParameters').SetVarArgs([1]);
    DefineMethod('DwmUnregisterThumbnail',1,tkInteger,nil,__DwmUnregisterThumbnail,false,0,'hThumbnailId: HTHUMBNAIL');
    DefineMethod('DwmUpdateThumbnailProperties',2,tkInteger,nil,__DwmUpdateThumbnailProperties,false,0,'hThumbnailId: HTHUMBNAIL; ptnProperties: TDwmThumbnailProperties').SetVarArgs([1]);
    DefineMethod('DwmSetIconicThumbnail',3,tkInteger,nil,__DwmSetIconicThumbnail,false,0,'hwnd: HWND; hbmp: HBITMAP; dwSITFlags: DWORD');
    DefineMethod('DwmSetIconicLivePreviewBitmap',4,tkInteger,nil,__DwmSetIconicLivePreviewBitmap,false,0,'hwnd: HWND; hbmp: HBITMAP; pptClient: TPoint; dwSITFlags: DWORD').SetVarArgs([2]);
    DefineMethod('DwmInvalidateIconicBitmaps',1,tkInteger,nil,__DwmInvalidateIconicBitmaps,false,0,'hwnd: HWND');
    DefineMethod('DwmAttachMilContent',1,tkInteger,nil,__DwmAttachMilContent,false,0,'hwnd: HWND');
    DefineMethod('DwmDetachMilContent',1,tkInteger,nil,__DwmDetachMilContent,false,0,'hwnd: HWND');
    DefineMethod('DwmFlush',0,tkInteger,nil,__DwmFlush,false,0,'');
    DefineMethod('DwmGetGraphicsStreamTransformHint',2,tkInteger,nil,__DwmGetGraphicsStreamTransformHint,false,0,'uIndex: UINT; pTransform: TMilMatrix3x2D').SetVarArgs([1]);
    DefineMethod('DwmGetTransportAttributes',3,tkInteger,nil,__DwmGetTransportAttributes,false,0,'pfIsRemoting: BOOL; pfIsConnected: BOOL; pDwGeneration: DWORD').SetVarArgs([0,1,2]);
