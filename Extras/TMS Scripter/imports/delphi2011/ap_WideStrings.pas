...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TWideStringsEnumeratorClass(CurrentClass.ClassRef).Create(TWideStrings(VarToObject(GetInputArg(0)))));
...
begin
  with AMachine do
  begin
AResult := Integer(TWideStrings(CurrentObject).AddObject(GetInputArg(0),TObject(VarToObject(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TWideStrings(CurrentObject).AddStrings(TStrings(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TWideStrings(CurrentObject).Assign(TPersistent(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TWideStrings(CurrentObject).Equals(TWideStrings(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TWideStrings(CurrentObject).GetEnumerator);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TWideStrings(CurrentObject).IndexOfObject(TObject(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TWideStrings(CurrentObject).InsertObject(VarToInteger(GetInputArg(0)),GetInputArg(1),TObject(VarToObject(GetInputArg(2))));
  end;
end;
...
begin
  with AMachine do
  begin
    TWideStrings(CurrentObject).LoadFromStream(TStream(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TWideStrings(CurrentObject).SaveToStream(TStream(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(WideCharToString(PWideChar(WideString(TWideStrings(CurrentObject).Delimiter))));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TWideStrings(CurrentObject).Objects[VarToInteger(GetArrayIndex(0))]));
  end;
end;
...
begin
  with AMachine do
  begin
    TWideStrings(CurrentObject).Objects[VarToInteger(GetArrayIndex(0))]:=TObject(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(WideCharToString(PWideChar(WideString(TWideStrings(CurrentObject).QuoteChar))));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(WideCharToString(PWideChar(WideString(TWideStrings(CurrentObject).NameValueSeparator))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TWideStringListClass(CurrentClass.ClassRef).Create);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TWideStringList(CurrentObject).AddObject(GetInputArg(0),TObject(VarToObject(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TWideStringList(CurrentObject).InsertObject(VarToInteger(GetInputArg(0)),GetInputArg(1),TObject(VarToObject(GetInputArg(2))));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TWideStringList(CurrentObject).Duplicates));
  end;
end;
...
begin
  with AMachine do
  begin
    TWideStringList(CurrentObject).Duplicates:=TDuplicates(VarToInteger(GetInputArg(0)));
  end;
end;
