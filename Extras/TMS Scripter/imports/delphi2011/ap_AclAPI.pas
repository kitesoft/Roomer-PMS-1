...
AResult := WideCharToString(AclAPI.GetTrusteeName(Param0));
    ReturnOutputArg(AResult);
...
if not Assigned(Param0Rec) or not (Param0Rec is _TRUSTEE_WWrapper) then 
  Param0Rec := _TRUSTEE_WWrapper.Create(Param0);
Param0 := _TRUSTEE_WWrapper(Param0Rec).ObjToRec;
AResult := WideCharToString(AclAPI.GetTrusteeNameW(Param0));
    ReturnOutputArg(AResult);
    SetInputArg(0,integer(_TRUSTEE_WWrapper.Create(Param0)));
  end;
end;
...
if not Assigned(Param0Rec) or not (Param0Rec is _TRUSTEE_WWrapper) then 
  Param0Rec := _TRUSTEE_WWrapper.Create(Param0);
Param0 := _TRUSTEE_WWrapper(Param0Rec).ObjToRec;
AResult := Integer(AclAPI.GetTrusteeType(Param0));
    ReturnOutputArg(AResult);
    SetInputArg(0,integer(_TRUSTEE_WWrapper.Create(Param0)));
  end;
end;
...
if not Assigned(Param0Rec) or not (Param0Rec is _TRUSTEE_AWrapper) then 
  Param0Rec := _TRUSTEE_AWrapper.Create(Param0);
Param0 := _TRUSTEE_AWrapper(Param0Rec).ObjToRec;
AResult := Integer(AclAPI.GetTrusteeTypeA(Param0));
    ReturnOutputArg(AResult);
    SetInputArg(0,integer(_TRUSTEE_AWrapper.Create(Param0)));
  end;
end;
...
if not Assigned(Param0Rec) or not (Param0Rec is _TRUSTEE_WWrapper) then 
  Param0Rec := _TRUSTEE_WWrapper.Create(Param0);
Param0 := _TRUSTEE_WWrapper(Param0Rec).ObjToRec;
AResult := Integer(AclAPI.GetTrusteeTypeW(Param0));
    ReturnOutputArg(AResult);
    SetInputArg(0,integer(_TRUSTEE_WWrapper.Create(Param0)));
  end;
end;
...
if not Assigned(Param0Rec) or not (Param0Rec is _TRUSTEE_WWrapper) then 
  Param0Rec := _TRUSTEE_WWrapper.Create(Param0);
Param0 := _TRUSTEE_WWrapper(Param0Rec).ObjToRec;
AResult := Integer(AclAPI.GetTrusteeForm(Param0));
    ReturnOutputArg(AResult);
    SetInputArg(0,integer(_TRUSTEE_WWrapper.Create(Param0)));
  end;
end;
...
if not Assigned(Param0Rec) or not (Param0Rec is _TRUSTEE_AWrapper) then 
  Param0Rec := _TRUSTEE_AWrapper.Create(Param0);
Param0 := _TRUSTEE_AWrapper(Param0Rec).ObjToRec;
AResult := Integer(AclAPI.GetTrusteeFormA(Param0));
    ReturnOutputArg(AResult);
    SetInputArg(0,integer(_TRUSTEE_AWrapper.Create(Param0)));
  end;
end;
...
if not Assigned(Param0Rec) or not (Param0Rec is _TRUSTEE_WWrapper) then 
  Param0Rec := _TRUSTEE_WWrapper.Create(Param0);
Param0 := _TRUSTEE_WWrapper(Param0Rec).ObjToRec;
AResult := Integer(AclAPI.GetTrusteeFormW(Param0));
    ReturnOutputArg(AResult);
    SetInputArg(0,integer(_TRUSTEE_WWrapper.Create(Param0)));
  end;
end;
...
begin
  ...
  begin
    DefineMethod('GetEffectiveRightsFromAcl',3,tkInteger,nil,__GetEffectiveRightsFromAcl,false,0,'pacl: ACL; pTrustee: TRUSTEE_; pAccessRights: ACCESS_MASK').SetVarArgs([0,1,2]);
    DefineMethod('GetEffectiveRightsFromAclA',3,tkInteger,nil,__GetEffectiveRightsFromAclA,false,0,'pacl: ACL; pTrustee: TRUSTEE_A; pAccessRights: ACCESS_MASK').SetVarArgs([0,1,2]);
    DefineMethod('GetEffectiveRightsFromAclW',3,tkInteger,nil,__GetEffectiveRightsFromAclW,false,0,'pacl: ACL; pTrustee: TRUSTEE_W; pAccessRights: ACCESS_MASK').SetVarArgs([0,1,2]);
    DefineMethod('GetAuditedPermissionsFromAcl',4,tkInteger,nil,__GetAuditedPermissionsFromAcl,false,0,'pacl: ACL; pTrustee: TRUSTEE_; pSuccessfulAuditedRights: ACCESS_MASK; pFailedAuditRights: ACCESS_MASK').SetVarArgs([0,1,2,3]);
    DefineMethod('GetAuditedPermissionsFromAclA',4,tkInteger,nil,__GetAuditedPermissionsFromAclA,false,0,'pacl: ACL; pTrustee: TRUSTEE_A; pSuccessfulAuditedRights: ACCESS_MASK; pFailedAuditRights: ACCESS_MASK').SetVarArgs([0,1,2,3]);
    DefineMethod('GetAuditedPermissionsFromAclW',4,tkInteger,nil,__GetAuditedPermissionsFromAclW,false,0,'pacl: ACL; pTrustee: TRUSTEE_W; pSuccessfulAuditedRights: ACCESS_MASK; pFailedAuditRights: ACCESS_MASK').SetVarArgs([0,1,2,3]);
    DefineMethod('GetTrusteeName',1,tkVariant,nil,__GetTrusteeName,false,0,'pTrustee: TRUSTEE_').SetVarArgs([0]);
    DefineMethod('GetTrusteeNameA',1,tkVariant,nil,__GetTrusteeNameA,false,0,'pTrustee: TRUSTEE_A').SetVarArgs([0]);
    DefineMethod('GetTrusteeNameW',1,tkVariant,nil,__GetTrusteeNameW,false,0,'pTrustee: TRUSTEE_W').SetVarArgs([0]);
    DefineMethod('GetTrusteeType',1,tkEnumeration,nil,__GetTrusteeType,false,0,'pTrustee: TRUSTEE_').SetVarArgs([0]);
    DefineMethod('GetTrusteeTypeA',1,tkEnumeration,nil,__GetTrusteeTypeA,false,0,'pTrustee: TRUSTEE_A').SetVarArgs([0]);
    DefineMethod('GetTrusteeTypeW',1,tkEnumeration,nil,__GetTrusteeTypeW,false,0,'pTrustee: TRUSTEE_W').SetVarArgs([0]);
    DefineMethod('GetTrusteeForm',1,tkEnumeration,nil,__GetTrusteeForm,false,0,'pTrustee: TRUSTEE_').SetVarArgs([0]);
    DefineMethod('GetTrusteeFormA',1,tkEnumeration,nil,__GetTrusteeFormA,false,0,'pTrustee: TRUSTEE_A').SetVarArgs([0]);
    DefineMethod('GetTrusteeFormW',1,tkEnumeration,nil,__GetTrusteeFormW,false,0,'pTrustee: TRUSTEE_W').SetVarArgs([0]);
  end;
end;
