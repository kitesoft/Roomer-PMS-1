...
begin
  with AMachine do
  begin
AResult := string(TPlatformDefaultStyleActionBars(CurrentObject).GetStyleName);
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(PlatformDefaultStyleActnCtrls.PlatformDefaultStyle));
  end;
end;
...
begin
  with AMachine do
  begin
    PlatformDefaultStyleActnCtrls.PlatformDefaultStyle:=TPlatformDefaultStyleActionBars(VarToObject(GetInputArg(0)));
  end;
end;
