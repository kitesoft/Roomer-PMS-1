...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TScreenTipsWindowClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
...
begin
  with AMachine do
  begin
    TScreenTipsWindow(CurrentObject).ActivateToolTip(TRectWrapper(integer(GetInputArg(0))).ObjToRec,TScreenTipItem(VarToObject(GetInputArg(1))));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TScreenTipsWindow(CurrentObject).HintControl));
  end;
end;
...
begin
  with AMachine do
  begin
    TScreenTipsWindow(CurrentObject).HintControl:=TControl(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TScreenTipsWindow(CurrentObject).Image));
  end;
end;
...
begin
  with AMachine do
  begin
    TScreenTipsWindow(CurrentObject).Image:=TPicture(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TScreenTipsWindow(CurrentObject).GradientStartColor));
  end;
end;
...
begin
  with AMachine do
  begin
    TScreenTipsWindow(CurrentObject).GradientStartColor:=TColor(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TScreenTipsWindow(CurrentObject).GradientEndColor));
  end;
end;
...
begin
  with AMachine do
  begin
    TScreenTipsWindow(CurrentObject).GradientEndColor:=TColor(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TScreenTipsWindow(CurrentObject).Body));
  end;
end;
...
begin
  with AMachine do
  begin
    TScreenTipsWindow(CurrentObject).Body:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TScreenTipsWindow(CurrentObject).Footer));
  end;
end;
...
begin
  with AMachine do
  begin
    TScreenTipsWindow(CurrentObject).Footer:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TScreenTipsWindow(CurrentObject).FooterImage));
  end;
end;
...
begin
  with AMachine do
  begin
    TScreenTipsWindow(CurrentObject).FooterImage:=TBitmap(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TScreenTipsWindow(CurrentObject).ActiveItem));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TScreenTipsWindow(CurrentObject).TipBorderStyle));
  end;
end;
...
begin
  with AMachine do
  begin
    TScreenTipsWindow(CurrentObject).TipBorderStyle:=TTipBorderStyle(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TScreenTipItemClass(CurrentClass.ClassRef).Create(TCollection(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TScreenTipItem(CurrentObject).Assign(TPersistent(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TScreenTipItem(CurrentObject).SetManager(TCustomScreenTipsManager(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TScreenTipsCollectionClass(CurrentClass.ClassRef).Create(TCustomScreenTipsManager(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TScreenTipsCollection(CurrentObject).Add);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TScreenTipsCollection(CurrentObject).Insert(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TScreenTipsCollection(CurrentObject).Items[VarToInteger(GetArrayIndex(0))]));
  end;
end;
...
begin
  with AMachine do
  begin
    TScreenTipsCollection(CurrentObject).Items[VarToInteger(GetArrayIndex(0))]:=TScreenTipItem(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TScreenTipBorderStyleClass(CurrentClass.ClassRef).Create);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TDisplayOffsetClass(CurrentClass.ClassRef).Create);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TAllocatedActionsClass(CurrentClass.ClassRef).Create);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TAllocatedActions(CurrentObject).AddAction(VarToStr(GetInputArg(0)),TObject(VarToObject(GetInputArg(1))));
  end;
end;
...
AResult := TAllocatedActions(CurrentObject).Delete(VarToStr(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
...
begin
  with AMachine do
  begin
AResult := TAllocatedActions(CurrentObject).Exists(VarToStr(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param1 := VarToInteger(GetInputArg(1));
AResult := TAllocatedActions(CurrentObject).Find(VarToStr(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TAllocatedActions(CurrentObject).GetItem(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TAssociateItemClass(CurrentClass.ClassRef).Create(TControl(VarToObject(GetInputArg(0))),TControl(VarToObject(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TAssociateItem(CurrentObject).PopupTip));
  end;
end;
...
begin
  with AMachine do
  begin
    TAssociateItem(CurrentObject).PopupTip:=TControl(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TAssociateItem(CurrentObject).Associate));
  end;
end;
...
begin
  with AMachine do
  begin
    TAssociateItem(CurrentObject).Associate:=TControl(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TAssociateItemListClass(CurrentClass.ClassRef).Create);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TAssociateItemList(CurrentObject).Add(TControl(VarToObject(GetInputArg(0))),TControl(VarToObject(GetInputArg(1))));
  end;
end;
...
begin
  with AMachine do
  begin
    TAssociateItemList(CurrentObject).Remove(TControl(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TAssociateItemList(CurrentObject).Find(TControl(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TAssociateItemList(CurrentObject).Get(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomScreenTipsManagerClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomScreenTipsManager(CurrentObject).AddPopup(TCustomControl(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomScreenTipsManager(CurrentObject).CreateScreenTip(TBasicAction(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomScreenTipsManager(CurrentObject).GetScreenTip(TBasicAction(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomScreenTipsManager(CurrentObject).RemovePopup(TCustomControl(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TCustomScreenTipsManager(CurrentObject).RemoveScreenTip(TScreenTipItem(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomScreenTipsManager(CurrentObject).BorderStyle));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomScreenTipsManager(CurrentObject).BorderStyle:=TScreenTipBorderStyle(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomScreenTipsManager(CurrentObject).DisplayOffset));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomScreenTipsManager(CurrentObject).DisplayOffset:=TDisplayOffset(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomScreenTipsManager(CurrentObject).Font));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomScreenTipsManager(CurrentObject).Font:=TFont(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TCustomScreenTipsManager(CurrentObject).Footer));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomScreenTipsManager(CurrentObject).Footer:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomScreenTipsManager(CurrentObject).FooterImage));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomScreenTipsManager(CurrentObject).FooterImage:=TPicture(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomScreenTipsManager(CurrentObject).GradientEndColor));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomScreenTipsManager(CurrentObject).GradientEndColor:=TColor(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomScreenTipsManager(CurrentObject).GradientStartColor));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomScreenTipsManager(CurrentObject).GradientStartColor:=TColor(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomScreenTipsManager(CurrentObject).LinkedActionLists));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomScreenTipsManager(CurrentObject).LinkedActionLists:=TActionListCollection(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomScreenTipsManager(CurrentObject).ScreenTips));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomScreenTipsManager(CurrentObject).ScreenTips:=TScreenTipsCollection(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomScreenTipsPopupClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomScreenTipsPopup(CurrentObject).GetScreenTipItem);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomScreenTipsPopup(CurrentObject).Associate));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomScreenTipsPopup(CurrentObject).Associate:=TControl(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomScreenTipsPopup(CurrentObject).Glyph));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomScreenTipsPopup(CurrentObject).Glyph:=TPicture(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomScreenTipsPopup(CurrentObject).PopupType));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomScreenTipsPopup(CurrentObject).PopupType:=TScreenTipPopupType(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomScreenTipsPopup(CurrentObject).ScreenTip));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomScreenTipsPopup(CurrentObject).ScreenTip:=TScreenTipItem(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomScreenTipsPopup(CurrentObject).ScreenTipManager));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomScreenTipsPopup(CurrentObject).ScreenTipManager:=TCustomScreenTipsManager(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  ...
  begin
    DefineMethod('Create',1,tkClass,TScreenTipsWindow,__TScreenTipsWindowCreate,true,0,'AOwner: TComponent');
    DefineMethod('Destroy',0,tkNone,nil,__TScreenTipsWindowDestroy,false,0,'');
    DefineMethod('ActivateToolTip',2,tkNone,nil,__TScreenTipsWindowActivateToolTip,false,0,'Rect: TRect; Item: TScreenTipItem');
  ...
  begin
    DefineMethod('Create',1,tkClass,TScreenTipItem,__TScreenTipItemCreate,true,0,'Collection: TCollection');
    DefineMethod('Destroy',0,tkNone,nil,__TScreenTipItemDestroy,false,0,'');
    DefineMethod('Assign',1,tkNone,nil,__TScreenTipItemAssign,false,0,'Source: TPersistent');
    DefineMethod('SetManager',1,tkNone,nil,__TScreenTipItemSetManager,false,0,'AManager: TCustomScreenTipsManager');
  ...
  begin
    DefineMethod('Create',1,tkClass,TScreenTipsCollection,__TScreenTipsCollectionCreate,true,0,'Manager: TCustomScreenTipsManager');
    DefineMethod('Add',0,tkClass,TScreenTipItem,__TScreenTipsCollectionAdd,false,0,'');
    DefineMethod('Insert',1,tkClass,TScreenTipItem,__TScreenTipsCollectionInsert,false,0,'Index: Integer');
  ...
  begin
    ...
    DefineMethod('AddAction',2,tkNone,nil,__TAllocatedActionsAddAction,false,0,'aName: string; aScreenTipItem: TObject');
    DefineMethod('Clear',0,tkNone,nil,__TAllocatedActionsClear,false,0,'');
    DefineMethod('Delete',2,tkVariant,nil,__TAllocatedActionsDelete,false,0,'aName: string; aIndex: Integer').SetVarArgs([1]);
    DefineMethod('Exists',1,tkVariant,nil,__TAllocatedActionsExists,false,0,'aName: string');
    DefineMethod('Find',2,tkVariant,nil,__TAllocatedActionsFind,false,0,'aName: string; aIndex: Integer').SetVarArgs([1]);
    DefineMethod('GetItem',1,tkClass,TScreenTipItem,__TAllocatedActionsGetItem,false,0,'aName: string');
    DefineProp('Count',tkInteger,__GetTAllocatedActionsCount,nil,nil,false,0);
  end;
  With Scripter.DefineClass(TAssociateItem) do
  begin
    DefineMethod('Create',2,tkClass,TAssociateItem,__TAssociateItemCreate,true,0,'APopupTip: TControl; AAssociate: TControl');
  ...
  begin
    ...
    DefineMethod('Add',2,tkNone,nil,__TAssociateItemListAdd,false,0,'Popup: TControl; Associate: TControl');
    DefineMethod('Remove',1,tkNone,nil,__TAssociateItemListRemove,false,0,'Associate: TControl');
    DefineMethod('Find',1,tkInteger,nil,__TAssociateItemListFind,false,0,'Associate: TControl');
    DefineMethod('Get',1,tkClass,TAssociateItem,__TAssociateItemListGet,false,0,'Idx: Integer');
  end;
  With Scripter.DefineClass(TCustomScreenTipsManager) do
  begin
    DefineMethod('Create',1,tkClass,TCustomScreenTipsManager,__TCustomScreenTipsManagerCreate,true,0,'AOwner: TComponent');
    DefineMethod('Destroy',0,tkNone,nil,__TCustomScreenTipsManagerDestroy,false,0,'');
    DefineMethod('AddPopup',1,tkNone,nil,__TCustomScreenTipsManagerAddPopup,false,0,'AScreenTipPopup: TCustomControl');
    DefineMethod('ClearScreenTips',0,tkNone,nil,__TCustomScreenTipsManagerClearScreenTips,false,0,'');
    DefineMethod('CreateScreenTip',1,tkClass,TScreenTipItem,__TCustomScreenTipsManagerCreateScreenTip,false,0,'aAction: TBasicAction');
    DefineMethod('GenerateScreenTips',0,tkVariant,nil,__TCustomScreenTipsManagerGenerateScreenTips,false,0,'');
    DefineMethod('GetScreenTip',1,tkClass,TScreenTipItem,__TCustomScreenTipsManagerGetScreenTip,false,0,'aAction: TBasicAction');
    DefineMethod('RemovePopup',1,tkNone,nil,__TCustomScreenTipsManagerRemovePopup,false,0,'AScreenTipPopup: TCustomControl');
    DefineMethod('RemoveScreenTip',1,tkVariant,nil,__TCustomScreenTipsManagerRemoveScreenTip,false,0,'aScreenTip: TScreenTipItem');
  ...
  begin
    DefineMethod('Create',1,tkClass,TCustomScreenTipsPopup,__TCustomScreenTipsPopupCreate,true,0,'AOwner: TComponent');
