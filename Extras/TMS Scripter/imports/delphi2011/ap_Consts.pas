...
procedure TatConstsLibrary.Init;
  ...
  begin
    ...
    begin
      ...
      AddConstant('SChangeWicSize',SChangeWicSize);
      ...
      AddConstant('SVTIFFImages',SVTIFFImages);
      ...
      AddConstant('SMissingActionBarStyleName',SMissingActionBarStyleName);
      ...
      AddConstant('SActionManagerNotAssigned',SActionManagerNotAssigned);
  ...
  begin
    ...
    begin
      ...
      AddConstant('SInvalidCanvasOperation',SInvalidCanvasOperation);
      AddConstant('SNoOwner',SNoOwner);
      AddConstant('SRequireSameOwner',SRequireSameOwner);
      AddConstant('SDirect2DInvalidOwner',SDirect2DInvalidOwner);
      AddConstant('SDirect2DInvalidSolidBrush',SDirect2DInvalidSolidBrush);
      AddConstant('SDirect2DInvalidBrushStyle',SDirect2DInvalidBrushStyle);
      AddConstant('SKeyboardLocaleInfo',SKeyboardLocaleInfo);
      AddConstant('SKeyboardLangChange',SKeyboardLangChange);
      AddConstant('SOnlyWinControls',SOnlyWinControls);
      AddConstant('SNoKeyword',SNoKeyword);
      AddConstant('SNameBlack',SNameBlack);
      AddConstant('SNameMaroon',SNameMaroon);
      AddConstant('SNameGreen',SNameGreen);
      AddConstant('SNameOlive',SNameOlive);
      AddConstant('SNameNavy',SNameNavy);
      AddConstant('SNamePurple',SNamePurple);
      AddConstant('SNameTeal',SNameTeal);
      AddConstant('SNameGray',SNameGray);
      AddConstant('SNameSilver',SNameSilver);
      AddConstant('SNameRed',SNameRed);
      AddConstant('SNameLime',SNameLime);
      AddConstant('SNameYellow',SNameYellow);
      AddConstant('SNameBlue',SNameBlue);
      AddConstant('SNameFuchsia',SNameFuchsia);
      AddConstant('SNameAqua',SNameAqua);
      AddConstant('SNameWhite',SNameWhite);
      AddConstant('SNameMoneyGreen',SNameMoneyGreen);
      AddConstant('SNameSkyBlue',SNameSkyBlue);
      AddConstant('SNameCream',SNameCream);
      AddConstant('SNameMedGray',SNameMedGray);
      AddConstant('SNameActiveBorder',SNameActiveBorder);
      AddConstant('SNameActiveCaption',SNameActiveCaption);
      AddConstant('SNameAppWorkSpace',SNameAppWorkSpace);
      AddConstant('SNameBackground',SNameBackground);
      AddConstant('SNameBtnFace',SNameBtnFace);
      AddConstant('SNameBtnHighlight',SNameBtnHighlight);
      AddConstant('SNameBtnShadow',SNameBtnShadow);
      AddConstant('SNameBtnText',SNameBtnText);
      AddConstant('SNameCaptionText',SNameCaptionText);
      AddConstant('SNameDefault',SNameDefault);
      AddConstant('SNameGradientActiveCaption',SNameGradientActiveCaption);
      AddConstant('SNameGradientInactiveCaption',SNameGradientInactiveCaption);
      AddConstant('SNameGrayText',SNameGrayText);
      AddConstant('SNameHighlight',SNameHighlight);
      AddConstant('SNameHighlightText',SNameHighlightText);
      AddConstant('SNameHotLight',SNameHotLight);
      AddConstant('SNameInactiveBorder',SNameInactiveBorder);
      AddConstant('SNameInactiveCaption',SNameInactiveCaption);
      AddConstant('SNameInactiveCaptionText',SNameInactiveCaptionText);
      AddConstant('SNameInfoBk',SNameInfoBk);
      AddConstant('SNameInfoText',SNameInfoText);
      AddConstant('SNameMenu',SNameMenu);
      AddConstant('SNameMenuBar',SNameMenuBar);
      AddConstant('SNameMenuHighlight',SNameMenuHighlight);
      AddConstant('SNameMenuText',SNameMenuText);
      AddConstant('SNameNone',SNameNone);
      AddConstant('SNameScrollBar',SNameScrollBar);
      AddConstant('SName3DDkShadow',SName3DDkShadow);
      AddConstant('SName3DLight',SName3DLight);
      AddConstant('SNameWindow',SNameWindow);
      AddConstant('SNameWindowFrame',SNameWindowFrame);
      AddConstant('SNameWindowText',SNameWindowText);
    end;
  end;
begin
  With Scripter.DefineClass(ClassType) do
