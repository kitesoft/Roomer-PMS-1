...
type
  TatActnMenusLibrary = class(TatScripterLibrary)
    ...
    procedure __TCustomActionMenuBarCreateControl(AMachine: TatVirtualMachine);
    ...
    procedure __GetTCustomActionMenuBarPopupStack(AMachine: TatVirtualMachine);
    procedure __GetTCustomActionMenuBarResizing(AMachine: TatVirtualMachine);
    ...
    procedure __TCustomActionPopupMenuDesignWndProc(AMachine: TatVirtualMachine);
    procedure __TCustomActionPopupMenuCreateControl(AMachine: TatVirtualMachine);
    ...
    procedure __TCustomActionMainMenuBarCreateControl(AMachine: TatVirtualMachine);
    ...
    procedure __TCustomActionMainMenuBarDesignWndProc(AMachine: TatVirtualMachine);
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TMenuStackClass(CurrentClass.ClassRef).Create(TCustomActionMenuBar(VarToObject(GetInputArg(0)))));
...
begin
  with AMachine do
  begin
    TMenuStack(CurrentObject).Push(TCustomActionMenuBar(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TMenuStack(CurrentObject).Pop);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TMenuStack(CurrentObject).Peek);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomActionMenuBarClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatActnMenusLibrary.__TCustomActionMenuBarCreateControl(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomActionMenuBar(CurrentObject).CreateControl(TActionClientItem(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomActionMenuBar(CurrentObject).Style);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomActionMenuBar(CurrentObject).AnimationStyle));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomActionMenuBar(CurrentObject).AnimationStyle:=TAnimationStyle(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomActionMenuBar(CurrentObject).ParentControl));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomActionMenuBar(CurrentObject).ParentControl:=TCustomActionControl(VarToObject(GetInputArg(0)));
  end;
end;

procedure TatActnMenusLibrary.__GetTCustomActionMenuBarPopupStack(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomActionMenuBar(CurrentObject).PopupStack));
  end;
end;

procedure TatActnMenusLibrary.__GetTCustomActionMenuBarResizing(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(TCustomActionMenuBar(CurrentObject).Resizing);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomActionMenuBar(CurrentObject).RootMenu));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomActionMenuBar(CurrentObject).RootMenu:=TCustomActionMenuBar(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomMenuExpandBtnClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomActionPopupMenuClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatActnMenusLibrary.__TCustomActionPopupMenuDesignWndProc(AMachine: TatVirtualMachine);
  var
  Param0Rec: TObject;
  Param0: TMessage;
  AResult: variant;
...
AResult := TCustomActionPopupMenu(CurrentObject).DesignWndProc(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,integer(TMessageWrapper.Create(Param0)));
  end;
end;

procedure TatActnMenusLibrary.__TCustomActionPopupMenuCreateControl(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomActionPopupMenu(CurrentObject).CreateControl(TActionClientItem(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomActionPopupMenu(CurrentObject).ExpandBtn));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomActionPopupMenu(CurrentObject).ExpandBtn:=TCustomMenuExpandBtn(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomizeActionToolBarClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomizeActionToolBar(CurrentObject).AdditionalItem));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomMDIMenuButton(CurrentObject).ButtonStyle));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomMDIMenuButton(CurrentObject).ButtonStyle:=TMDIButtonStyle(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomActionMainMenuBarClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatActnMenusLibrary.__TCustomActionMainMenuBarCreateControl(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomActionMainMenuBar(CurrentObject).CreateControl(TActionClientItem(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatActnMenusLibrary.__TCustomActionMainMenuBarDesignWndProc(AMachine: TatVirtualMachine);
  var
  Param0Rec: TObject;
  Param0: TMessage;
  AResult: variant;
...
if not Assigned(Param0Rec) or not (Param0Rec is TMessageWrapper) then 
  Param0Rec := TMessageWrapper.Create(Param0);
Param0 := TMessageWrapper(Param0Rec).ObjToRec;
AResult := TCustomActionMainMenuBar(CurrentObject).DesignWndProc(Param0);
    ReturnOutputArg(AResult);
    SetInputArg(0,integer(TMessageWrapper.Create(Param0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TCustomActionMainMenuBar(CurrentObject).WindowMenu));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomActionMainMenuBar(CurrentObject).WindowMenu:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomMenuItemClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomMenuItem(CurrentObject).DragDrop(TObject(VarToObject(GetInputArg(0))),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomMenuButtonClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ActnMenus.RegisterActnBarStyle(TActionBarStyleEx(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    ActnMenus.UnRegisterActnBarStyle(TActionBarStyleEx(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  ...
  begin
    DefineMethod('Create',1,tkClass,TMenuStack,__TMenuStackCreate,true,0,'AMenu: TCustomActionMenuBar');
    DefineMethod('Push',1,tkNone,nil,__TMenuStackPush,false,0,'Container: TCustomActionMenuBar');
    ...
    DefineProp('List',tkVariant,nil,nil,nil,false,0);
  end;
  ...
  begin
    DefineMethod('Create',1,tkClass,TCustomActionMenuBar,__TCustomActionMenuBarCreate,true,0,'AOwner: TComponent');
    DefineMethod('Destroy',0,tkNone,nil,__TCustomActionMenuBarDestroy,false,0,'');
    DefineMethod('CreateControl',1,tkClass,TCustomActionControl,__TCustomActionMenuBarCreateControl,false,0,'AnItem: TActionClientItem');
    ...
    DefineProp('PopupStack',tkClass,__GetTCustomActionMenuBarPopupStack,nil,TMenuStack,false,0);
    DefineProp('Resizing',tkVariant,__GetTCustomActionMenuBarResizing,nil,nil,false,0);
  ...
  begin
    DefineMethod('Create',1,tkClass,TCustomMenuExpandBtn,__TCustomMenuExpandBtnCreate,true,0,'AOwner: TComponent');
  end;
  With Scripter.DefineClass(TCustomActionPopupMenu) do
  begin
    DefineMethod('Create',1,tkClass,TCustomActionPopupMenu,__TCustomActionPopupMenuCreate,true,0,'AOwner: TComponent');
    DefineMethod('Destroy',0,tkNone,nil,__TCustomActionPopupMenuDestroy,false,0,'');
    DefineMethod('DesignWndProc',1,tkVariant,nil,__TCustomActionPopupMenuDesignWndProc,false,0,'Message: TMessage').SetVarArgs([0]);
    DefineMethod('CreateControl',1,tkClass,TCustomActionControl,__TCustomActionPopupMenuCreateControl,false,0,'AnItem: TActionClientItem');
    DefineMethod('CloseMenu',0,tkNone,nil,__TCustomActionPopupMenuCloseMenu,false,0,'');
    DefineMethod('Expand',1,tkNone,nil,__TCustomActionPopupMenuExpand,false,0,'Full: Boolean');
    DefineMethod('Popup',2,tkNone,nil,__TCustomActionPopupMenuPopup,false,0,'X: Integer; Y: Integer');
  ...
  begin
    DefineMethod('Create',1,tkClass,TCustomizeActionToolBar,__TCustomizeActionToolBarCreate,true,0,'AOwner: TComponent');
  ...
  begin
    DefineMethod('Create',1,tkClass,TCustomActionMainMenuBar,__TCustomActionMainMenuBarCreate,true,0,'AOwner: TComponent');
    DefineMethod('Destroy',0,tkNone,nil,__TCustomActionMainMenuBarDestroy,false,0,'');
    DefineMethod('CreateControl',1,tkClass,TCustomActionControl,__TCustomActionMainMenuBarCreateControl,false,0,'AnItem: TActionClientItem');
    ...
    DefineMethod('DesignWndProc',1,tkVariant,nil,__TCustomActionMainMenuBarDesignWndProc,false,0,'Message: TMessage').SetVarArgs([0]);
  ...
  begin
    DefineMethod('Create',1,tkClass,TCustomMenuItem,__TCustomMenuItemCreate,true,0,'AOwner: TComponent');
    ...
    DefineMethod('DragDrop',3,tkNone,nil,__TCustomMenuItemDragDrop,false,0,'Source: TObject; X: Integer; Y: Integer');
  ...
  begin
    DefineMethod('Create',1,tkClass,TCustomMenuButton,__TCustomMenuButtonCreate,true,0,'AOwner: TComponent');
  ...
  begin
    DefineMethod('RegisterActnBarStyle',1,tkNone,nil,__RegisterActnBarStyle,false,0,'AStyle: TActionBarStyleEx');
    DefineMethod('UnRegisterActnBarStyle',1,tkNone,nil,__UnRegisterActnBarStyle,false,0,'AStyle: TActionBarStyleEx');
