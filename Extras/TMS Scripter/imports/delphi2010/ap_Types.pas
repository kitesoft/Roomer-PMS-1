...
type
  TatTypesLibrary = class(TatScripterLibrary)
    ...
    procedure __PtInCircle(AMachine: TatVirtualMachine);
    ...
    procedure __RectWidth(AMachine: TatVirtualMachine);
    procedure __RectHeight(AMachine: TatVirtualMachine);
    procedure __SplitRect(AMachine: TatVirtualMachine);
    procedure __CenteredRect(AMachine: TatVirtualMachine);
...
procedure TatTypesLibrary.__SmallPoint(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := integer(TSmallPointWrapper.Create(Types.SmallPoint(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatTypesLibrary.__PtInCircle(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Types.PtInCircle(TPointWrapper(integer(GetInputArg(0))).ObjToRec,TPointWrapper(integer(GetInputArg(1))).ObjToRec,VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatTypesLibrary.__RectWidth(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(Types.RectWidth(TRectWrapper(integer(GetInputArg(0))).ObjToRec));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatTypesLibrary.__RectHeight(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(Types.RectHeight(TRectWrapper(integer(GetInputArg(0))).ObjToRec));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatTypesLibrary.__SplitRect(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := integer(TRectWrapper.Create(Types.SplitRect(TRectWrapper(integer(GetInputArg(0))).ObjToRec,TSplitRectType(VarToInteger(GetInputArg(1))),VarToInteger(GetInputArg(2)))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatTypesLibrary.__CenteredRect(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := integer(TRectWrapper.Create(Types.CenteredRect(TRectWrapper(integer(GetInputArg(0))).ObjToRec,TRectWrapper(integer(GetInputArg(1))).ObjToRec)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    DefineMethod('EqualRect',2,tkVariant,nil,__EqualRect,false,0,'R1: TRect; R2: TRect');
    DefineMethod('Rect',4,tkVariant,nil,__Rect,false,0,'Left: Integer; Top: Integer; Right: Integer; Bottom: Integer');
    DefineMethod('Bounds',4,tkVariant,nil,__Bounds,false,0,'ALeft: Integer; ATop: Integer; AWidth: Integer; AHeight: Integer');
    DefineMethod('Point',2,tkVariant,nil,__Point,false,0,'X: Integer; Y: Integer');
    DefineMethod('SmallPoint',2,tkVariant,nil,__SmallPoint,false,0,'X: Integer; Y: Integer');
    DefineMethod('PtInRect',2,tkVariant,nil,__PtInRect,false,0,'Rect: TRect; P: TPoint');
    DefineMethod('PtInCircle',3,tkVariant,nil,__PtInCircle,false,0,'Point: TPoint; Center: TPoint; Radius: Integer');
    DefineMethod('IntersectRect',3,tkVariant,nil,__IntersectRect,false,0,'Rect: TRect; R1: TRect; R2: TRect').SetVarArgs([0]);
    DefineMethod('UnionRect',3,tkVariant,nil,__UnionRect,false,0,'Rect: TRect; R1: TRect; R2: TRect').SetVarArgs([0]);
    DefineMethod('IsRectEmpty',1,tkVariant,nil,__IsRectEmpty,false,0,'Rect: TRect');
    DefineMethod('OffsetRect',3,tkVariant,nil,__OffsetRect,false,0,'Rect: TRect; DX: Integer; DY: Integer').SetVarArgs([0]);
    DefineMethod('CenterPoint',1,tkVariant,nil,__CenterPoint,false,0,'Rect: TRect');
    DefineMethod('RectWidth',1,tkInteger,nil,__RectWidth,false,0,'Rect: TRect');
    DefineMethod('RectHeight',1,tkInteger,nil,__RectHeight,false,0,'Rect: TRect');
    DefineMethod('SplitRect',3,tkVariant,nil,__SplitRect,false,0,'Rect: TRect; SplitType: TSplitRectType; Size: Integer');
    DefineMethod('CenteredRect',2,tkVariant,nil,__CenteredRect,false,0,'SourceRect: TRect; CenteredRect: TRect');
    AddConstant('srLeft',srLeft);
    AddConstant('srRight',srRight);
    AddConstant('srTop',srTop);
    AddConstant('srBottom',srBottom);
