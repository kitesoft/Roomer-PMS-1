...
begin
  with AMachine do
  begin
    TCustomButtonedEdit(CurrentObject).Images:=TImageList(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomTrayIcon(CurrentObject).Icons:=TImageList(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomCategoryPanelGroup(CurrentObject).Images:=TImageList(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  ...
  begin
    ...
    DefineProp('Images',tkClass,__GetTCustomCategoryPanelGroupImages,__SetTCustomCategoryPanelGroupImages,TImageList,false,0);
