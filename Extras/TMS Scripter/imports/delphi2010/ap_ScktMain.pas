...
begin
  with AMachine do
  begin
    TSocketForm(CurrentObject).FormCreate(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TSocketForm(CurrentObject).FormDestroy(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TSocketForm(CurrentObject).miCloseClick(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TSocketForm(CurrentObject).miPropertiesClick(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TSocketForm(CurrentObject).FormShow(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
Param1 := GetInputArg(1);
    TSocketForm(CurrentObject).FormCloseQuery(TObject(VarToObject(GetInputArg(0))),Param1);
...
begin
  with AMachine do
  begin
    TSocketForm(CurrentObject).miDisconnectClick(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TSocketForm(CurrentObject).miExitClick(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TSocketForm(CurrentObject).ApplyActionExecute(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TSocketForm(CurrentObject).ApplyActionUpdate(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TSocketForm(CurrentObject).DisconnectActionUpdate(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TSocketForm(CurrentObject).ShowHostActionExecute(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TSocketForm(CurrentObject).miAddClick(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TSocketForm(CurrentObject).RemovePortActionUpdate(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TSocketForm(CurrentObject).RemovePortActionExecute(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TSocketForm(CurrentObject).UpDownClick(TObject(VarToObject(GetInputArg(0))),TUDBtnType(VarToInteger(GetInputArg(1))));
  end;
end;
...
begin
  with AMachine do
  begin
    TSocketForm(CurrentObject).PortListClick(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
Param4 := VarToInteger(GetInputArg(4));
    TSocketForm(CurrentObject).ConnectionListCompare(TObject(VarToObject(GetInputArg(0))),TListItem(VarToObject(GetInputArg(1))),TListItem(VarToObject(GetInputArg(2))),VarToInteger(GetInputArg(3)),Param4);
...
begin
  with AMachine do
  begin
    TSocketForm(CurrentObject).ConnectionListColumnClick(TObject(VarToObject(GetInputArg(0))),TListColumn(VarToObject(GetInputArg(1))));
  end;
end;
...
begin
  with AMachine do
  begin
    TSocketForm(CurrentObject).IntegerExit(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TSocketForm(CurrentObject).UpdateTimerTimer(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TSocketForm(CurrentObject).RegisteredActionExecute(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TSocketForm(CurrentObject).AllowXMLExecute(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TSocketForm(CurrentObject).SelectedSocket));
  end;
end;
...
1: AResult := ObjectToVar(TSocketServiceClass(CurrentClass.ClassRef).CreateNew(TComponent(VarToObject(GetInputArg(0)))));
2: AResult := ObjectToVar(TSocketServiceClass(CurrentClass.ClassRef).CreateNew(TComponent(VarToObject(GetInputArg(0))),VarToInteger(GetInputArg(1))));
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(ScktMain.SocketForm));
  end;
end;
...
begin
  with AMachine do
  begin
    ScktMain.SocketForm:=TSocketForm(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(ScktMain.SocketService));
  end;
end;
...
begin
  with AMachine do
  begin
    ScktMain.SocketService:=TSocketService(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  ...
  begin
    DefineMethod('FormCreate',1,tkNone,nil,__TSocketFormFormCreate,false,0,'Sender: TObject');
    DefineMethod('FormDestroy',1,tkNone,nil,__TSocketFormFormDestroy,false,0,'Sender: TObject');
    DefineMethod('miCloseClick',1,tkNone,nil,__TSocketFormmiCloseClick,false,0,'Sender: TObject');
    DefineMethod('miPropertiesClick',1,tkNone,nil,__TSocketFormmiPropertiesClick,false,0,'Sender: TObject');
    DefineMethod('FormShow',1,tkNone,nil,__TSocketFormFormShow,false,0,'Sender: TObject');
    DefineMethod('FormCloseQuery',2,tkNone,nil,__TSocketFormFormCloseQuery,false,0,'Sender: TObject; CanClose: Boolean').SetVarArgs([1]);
    DefineMethod('miDisconnectClick',1,tkNone,nil,__TSocketFormmiDisconnectClick,false,0,'Sender: TObject');
    DefineMethod('miExitClick',1,tkNone,nil,__TSocketFormmiExitClick,false,0,'Sender: TObject');
    DefineMethod('ApplyActionExecute',1,tkNone,nil,__TSocketFormApplyActionExecute,false,0,'Sender: TObject');
    DefineMethod('ApplyActionUpdate',1,tkNone,nil,__TSocketFormApplyActionUpdate,false,0,'Sender: TObject');
    DefineMethod('DisconnectActionUpdate',1,tkNone,nil,__TSocketFormDisconnectActionUpdate,false,0,'Sender: TObject');
    DefineMethod('ShowHostActionExecute',1,tkNone,nil,__TSocketFormShowHostActionExecute,false,0,'Sender: TObject');
    DefineMethod('miAddClick',1,tkNone,nil,__TSocketFormmiAddClick,false,0,'Sender: TObject');
    DefineMethod('RemovePortActionUpdate',1,tkNone,nil,__TSocketFormRemovePortActionUpdate,false,0,'Sender: TObject');
    DefineMethod('RemovePortActionExecute',1,tkNone,nil,__TSocketFormRemovePortActionExecute,false,0,'Sender: TObject');
    DefineMethod('UpDownClick',2,tkNone,nil,__TSocketFormUpDownClick,false,0,'Sender: TObject; Button: TUDBtnType');
    DefineMethod('PortListClick',1,tkNone,nil,__TSocketFormPortListClick,false,0,'Sender: TObject');
    DefineMethod('ConnectionListCompare',5,tkNone,nil,__TSocketFormConnectionListCompare,false,0,'Sender: TObject; Item1: TListItem; Item2: TListItem; Data: Integer; Compare: Integer').SetVarArgs([4]);
    DefineMethod('ConnectionListColumnClick',2,tkNone,nil,__TSocketFormConnectionListColumnClick,false,0,'Sender: TObject; Column: TListColumn');
    DefineMethod('IntegerExit',1,tkNone,nil,__TSocketFormIntegerExit,false,0,'Sender: TObject');
    DefineMethod('UpdateTimerTimer',1,tkNone,nil,__TSocketFormUpdateTimerTimer,false,0,'Sender: TObject');
    DefineMethod('RegisteredActionExecute',1,tkNone,nil,__TSocketFormRegisteredActionExecute,false,0,'Sender: TObject');
    DefineMethod('AllowXMLExecute',1,tkNone,nil,__TSocketFormAllowXMLExecute,false,0,'Sender: TObject');
    DefineMethod('Initialize',1,tkNone,nil,__TSocketFormInitialize,false,0,'FromService: Boolean');
  ...
  begin
    DefineMethod('CreateNew',2,tkClass,TSocketService,__TSocketServiceCreateNew,true,1,'AOwner: TComponent; Dummy: Integer = 0');
  end;
