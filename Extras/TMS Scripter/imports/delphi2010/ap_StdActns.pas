...
begin
  with AMachine do
  begin
AResult := ObjectToVar(THintActionClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
...
begin
  with AMachine do
  begin
AResult := TEditAction(CurrentObject).HandlesTarget(TObject(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TEditAction(CurrentObject).UpdateTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TEditAction(CurrentObject).Control));
  end;
end;
...
begin
  with AMachine do
  begin
    TEditAction(CurrentObject).Control:=TCustomEdit(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    TEditCut(CurrentObject).ExecuteTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TEditCopy(CurrentObject).ExecuteTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TEditPaste(CurrentObject).UpdateTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TEditPaste(CurrentObject).ExecuteTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TEditSelectAll(CurrentObject).ExecuteTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TEditSelectAll(CurrentObject).UpdateTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TEditUndo(CurrentObject).ExecuteTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TEditUndo(CurrentObject).UpdateTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TEditDelete(CurrentObject).ExecuteTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TEditDelete(CurrentObject).UpdateTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TWindowActionClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TWindowAction(CurrentObject).HandlesTarget(TObject(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TWindowAction(CurrentObject).UpdateTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TWindowAction(CurrentObject).Form));
  end;
end;
...
begin
  with AMachine do
  begin
    TWindowAction(CurrentObject).Form:=TCustomForm(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    TWindowClose(CurrentObject).ExecuteTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TWindowClose(CurrentObject).UpdateTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TWindowCascade(CurrentObject).ExecuteTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TWindowTileHorizontal(CurrentObject).ExecuteTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TWindowTileVertical(CurrentObject).ExecuteTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TWindowMinimizeAll(CurrentObject).ExecuteTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TWindowArrange(CurrentObject).ExecuteTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(THelpActionClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := THelpAction(CurrentObject).HandlesTarget(TObject(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    THelpAction(CurrentObject).UpdateTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    THelpContents(CurrentObject).ExecuteTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    THelpTopicSearch(CurrentObject).ExecuteTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    THelpOnHelp(CurrentObject).ExecuteTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    THelpContextAction(CurrentObject).ExecuteTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    THelpContextAction(CurrentObject).UpdateTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCommonDialogActionClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TCommonDialogAction(CurrentObject).HandlesTarget(TObject(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TCommonDialogAction(CurrentObject).ExecuteTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TFileOpenClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TFileOpen(CurrentObject).ExecuteTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TFileOpenWith(CurrentObject).ExecuteTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TFileSaveAsClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TFileExit(CurrentObject).HandlesTarget(TObject(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TFileExit(CurrentObject).ExecuteTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TSearchActionClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TSearchAction(CurrentObject).HandlesTarget(TObject(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TSearchAction(CurrentObject).Search(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TSearchAction(CurrentObject).UpdateTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TSearchAction(CurrentObject).ExecuteTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TSearchReplace(CurrentObject).ExecuteTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TSearchFindFirstClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TSearchFindNextClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TSearchFindNext(CurrentObject).HandlesTarget(TObject(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TSearchFindNext(CurrentObject).UpdateTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TSearchFindNext(CurrentObject).ExecuteTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TBrowseForFolder(CurrentObject).ExecuteTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TBrowseForFolder(CurrentObject).Folder));
  end;
end;
...
begin
  with AMachine do
  begin
    TBrowseForFolder(CurrentObject).Folder:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  ...
  begin
    DefineMethod('Create',1,tkClass,THintAction,__THintActionCreate,true,0,'AOwner: TComponent');
  end;
  With Scripter.DefineClass(TEditAction) do
  begin
    DefineMethod('Destroy',0,tkNone,nil,__TEditActionDestroy,false,0,'');
    DefineMethod('HandlesTarget',1,tkVariant,nil,__TEditActionHandlesTarget,false,0,'Target: TObject');
    DefineMethod('UpdateTarget',1,tkNone,nil,__TEditActionUpdateTarget,false,0,'Target: TObject');
  ...
  begin
    DefineMethod('ExecuteTarget',1,tkNone,nil,__TEditCutExecuteTarget,false,0,'Target: TObject');
  end;
  With Scripter.DefineClass(TEditCopy) do
  begin
    DefineMethod('ExecuteTarget',1,tkNone,nil,__TEditCopyExecuteTarget,false,0,'Target: TObject');
  end;
  With Scripter.DefineClass(TEditPaste) do
  begin
    DefineMethod('UpdateTarget',1,tkNone,nil,__TEditPasteUpdateTarget,false,0,'Target: TObject');
    DefineMethod('ExecuteTarget',1,tkNone,nil,__TEditPasteExecuteTarget,false,0,'Target: TObject');
  end;
  With Scripter.DefineClass(TEditSelectAll) do
  begin
    DefineMethod('ExecuteTarget',1,tkNone,nil,__TEditSelectAllExecuteTarget,false,0,'Target: TObject');
    DefineMethod('UpdateTarget',1,tkNone,nil,__TEditSelectAllUpdateTarget,false,0,'Target: TObject');
  end;
  With Scripter.DefineClass(TEditUndo) do
  begin
    DefineMethod('ExecuteTarget',1,tkNone,nil,__TEditUndoExecuteTarget,false,0,'Target: TObject');
    DefineMethod('UpdateTarget',1,tkNone,nil,__TEditUndoUpdateTarget,false,0,'Target: TObject');
  end;
  With Scripter.DefineClass(TEditDelete) do
  begin
    DefineMethod('ExecuteTarget',1,tkNone,nil,__TEditDeleteExecuteTarget,false,0,'Target: TObject');
    DefineMethod('UpdateTarget',1,tkNone,nil,__TEditDeleteUpdateTarget,false,0,'Target: TObject');
  end;
  With Scripter.DefineClass(TWindowAction) do
  begin
    DefineMethod('Create',1,tkClass,TWindowAction,__TWindowActionCreate,true,0,'AOwner: TComponent');
    DefineMethod('HandlesTarget',1,tkVariant,nil,__TWindowActionHandlesTarget,false,0,'Target: TObject');
    DefineMethod('UpdateTarget',1,tkNone,nil,__TWindowActionUpdateTarget,false,0,'Target: TObject');
  ...
  begin
    DefineMethod('ExecuteTarget',1,tkNone,nil,__TWindowCloseExecuteTarget,false,0,'Target: TObject');
    DefineMethod('UpdateTarget',1,tkNone,nil,__TWindowCloseUpdateTarget,false,0,'Target: TObject');
  end;
  With Scripter.DefineClass(TWindowCascade) do
  begin
    DefineMethod('ExecuteTarget',1,tkNone,nil,__TWindowCascadeExecuteTarget,false,0,'Target: TObject');
  end;
  With Scripter.DefineClass(TWindowTileHorizontal) do
  begin
    DefineMethod('ExecuteTarget',1,tkNone,nil,__TWindowTileHorizontalExecuteTarget,false,0,'Target: TObject');
  end;
  With Scripter.DefineClass(TWindowTileVertical) do
  begin
    DefineMethod('ExecuteTarget',1,tkNone,nil,__TWindowTileVerticalExecuteTarget,false,0,'Target: TObject');
  end;
  With Scripter.DefineClass(TWindowMinimizeAll) do
  begin
    DefineMethod('ExecuteTarget',1,tkNone,nil,__TWindowMinimizeAllExecuteTarget,false,0,'Target: TObject');
  end;
  With Scripter.DefineClass(TWindowArrange) do
  begin
    DefineMethod('ExecuteTarget',1,tkNone,nil,__TWindowArrangeExecuteTarget,false,0,'Target: TObject');
  end;
  With Scripter.DefineClass(THelpAction) do
  begin
    DefineMethod('Create',1,tkClass,THelpAction,__THelpActionCreate,true,0,'AOwner: TComponent');
    DefineMethod('HandlesTarget',1,tkVariant,nil,__THelpActionHandlesTarget,false,0,'Target: TObject');
    DefineMethod('UpdateTarget',1,tkNone,nil,__THelpActionUpdateTarget,false,0,'Target: TObject');
  end;
  With Scripter.DefineClass(THelpContents) do
  begin
    DefineMethod('ExecuteTarget',1,tkNone,nil,__THelpContentsExecuteTarget,false,0,'Target: TObject');
  end;
  With Scripter.DefineClass(THelpTopicSearch) do
  begin
    DefineMethod('ExecuteTarget',1,tkNone,nil,__THelpTopicSearchExecuteTarget,false,0,'Target: TObject');
  end;
  With Scripter.DefineClass(THelpOnHelp) do
  begin
    DefineMethod('ExecuteTarget',1,tkNone,nil,__THelpOnHelpExecuteTarget,false,0,'Target: TObject');
  end;
  With Scripter.DefineClass(THelpContextAction) do
  begin
    DefineMethod('ExecuteTarget',1,tkNone,nil,__THelpContextActionExecuteTarget,false,0,'Target: TObject');
    DefineMethod('UpdateTarget',1,tkNone,nil,__THelpContextActionUpdateTarget,false,0,'Target: TObject');
  end;
  With Scripter.DefineClass(TCommonDialogAction) do
  begin
    DefineMethod('Create',1,tkClass,TCommonDialogAction,__TCommonDialogActionCreate,true,0,'AOwner: TComponent');
    DefineMethod('Destroy',0,tkNone,nil,__TCommonDialogActionDestroy,false,0,'');
    DefineMethod('HandlesTarget',1,tkVariant,nil,__TCommonDialogActionHandlesTarget,false,0,'Target: TObject');
    DefineMethod('ExecuteTarget',1,tkNone,nil,__TCommonDialogActionExecuteTarget,false,0,'Target: TObject');
  ...
  begin
    DefineMethod('Create',1,tkClass,TFileOpen,__TFileOpenCreate,true,0,'AOwner: TComponent');
    DefineMethod('ExecuteTarget',1,tkNone,nil,__TFileOpenExecuteTarget,false,0,'Target: TObject');
  end;
  With Scripter.DefineClass(TFileOpenWith) do
  begin
    DefineMethod('ExecuteTarget',1,tkNone,nil,__TFileOpenWithExecuteTarget,false,0,'Target: TObject');
  end;
  With Scripter.DefineClass(TFileSaveAs) do
  begin
    DefineMethod('Create',1,tkClass,TFileSaveAs,__TFileSaveAsCreate,true,0,'AOwner: TComponent');
  end;
  ...
  begin
    DefineMethod('HandlesTarget',1,tkVariant,nil,__TFileExitHandlesTarget,false,0,'Target: TObject');
    DefineMethod('ExecuteTarget',1,tkNone,nil,__TFileExitExecuteTarget,false,0,'Target: TObject');
  end;
  With Scripter.DefineClass(TSearchAction) do
  begin
    DefineMethod('Create',1,tkClass,TSearchAction,__TSearchActionCreate,true,0,'AOwner: TComponent');
    DefineMethod('Destroy',0,tkNone,nil,__TSearchActionDestroy,false,0,'');
    DefineMethod('HandlesTarget',1,tkVariant,nil,__TSearchActionHandlesTarget,false,0,'Target: TObject');
    DefineMethod('Search',1,tkNone,nil,__TSearchActionSearch,false,0,'Sender: TObject');
    DefineMethod('UpdateTarget',1,tkNone,nil,__TSearchActionUpdateTarget,false,0,'Target: TObject');
    DefineMethod('ExecuteTarget',1,tkNone,nil,__TSearchActionExecuteTarget,false,0,'Target: TObject');
  end;
  ...
  begin
    DefineMethod('ExecuteTarget',1,tkNone,nil,__TSearchReplaceExecuteTarget,false,0,'Target: TObject');
  end;
  With Scripter.DefineClass(TSearchFindFirst) do
  begin
    DefineMethod('Create',1,tkClass,TSearchFindFirst,__TSearchFindFirstCreate,true,0,'AOwner: TComponent');
  end;
  With Scripter.DefineClass(TSearchFindNext) do
  begin
    DefineMethod('Create',1,tkClass,TSearchFindNext,__TSearchFindNextCreate,true,0,'AOwner: TComponent');
    DefineMethod('HandlesTarget',1,tkVariant,nil,__TSearchFindNextHandlesTarget,false,0,'Target: TObject');
    DefineMethod('UpdateTarget',1,tkNone,nil,__TSearchFindNextUpdateTarget,false,0,'Target: TObject');
    DefineMethod('ExecuteTarget',1,tkNone,nil,__TSearchFindNextExecuteTarget,false,0,'Target: TObject');
  end;
  ...
  begin
    DefineMethod('ExecuteTarget',1,tkNone,nil,__TBrowseForFolderExecuteTarget,false,0,'Target: TObject');
