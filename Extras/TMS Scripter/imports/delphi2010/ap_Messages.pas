...
type
  TatMessagesLibrary = class(TatScripterLibrary)
    procedure __SendTextMessage(AMachine: TatVirtualMachine);
    procedure __SendStructMessage(AMachine: TatVirtualMachine);
    procedure __SendGetStructMessage(AMachine: TatVirtualMachine);
    procedure __SendGetIntMessage(AMachine: TatVirtualMachine);
  ...
  TWMMovingWrapper = class(TatRecordWrapper)
  private
    FMsg: Cardinal;
    FEdge: Integer;
  public
    constructor Create(ARecord: TWMMoving);
    function ObjToRec: TWMMoving;
  published
    property Msg: Cardinal read FMsg write FMsg;
  ...
  published
    ...
    property HitTest: SmallInt read FHitTest write FHitTest;
    property MouseMsg: Word read FMouseMsg write FMouseMsg;
    property Result: Longint read FResult write FResult;
  end;
  ...
  TWMPrintWrapper = class(TatRecordWrapper)
  private
    FMsg: Cardinal;
    FDC: HDC;
    FFlags: Cardinal;
    FResult: Integer;
  public
    constructor Create(ARecord: TWMPrint);
    function ObjToRec: TWMPrint;
  published
    property Msg: Cardinal read FMsg write FMsg;
    property DC: HDC read FDC write FDC;
  ...
  TWMGestureNotifyWrapper = class(TatRecordWrapper)
  private
    FMsg: Cardinal;
    FUnused: WPARAM;
    FResult: Integer;
  public
    constructor Create(ARecord: TWMGestureNotify);
    function ObjToRec: TWMGestureNotify;
  published
    property Msg: Cardinal read FMsg write FMsg;
    property Unused: WPARAM read FUnused write FUnused;
    property Result: Integer read FResult write FResult;
  end;
...
constructor TWMMovingWrapper.Create(ARecord: TWMMoving);
begin
  inherited Create;
  FMsg := ARecord.Msg;
  FEdge := ARecord.Edge;
...
function TWMMovingWrapper.ObjToRec: TWMMoving;
begin
  result.Msg := FMsg;
  result.Edge := FEdge;
end;
...
constructor TWMPrintWrapper.Create(ARecord: TWMPrint);
begin
  inherited Create;
  FMsg := ARecord.Msg;
  FDC := ARecord.DC;
...
function TWMPrintWrapper.ObjToRec: TWMPrint;
begin
  result.Msg := FMsg;
  result.DC := FDC;
  result.Flags := FFlags;
...
constructor TWMGestureNotifyWrapper.Create(ARecord: TWMGestureNotify);
begin
  inherited Create;
  FMsg := ARecord.Msg;
  FUnused := ARecord.Unused;
...
function TWMGestureNotifyWrapper.ObjToRec: TWMGestureNotify;
begin
  result.Msg := FMsg;
  result.Unused := FUnused;
  result.Result := FResult;
...
procedure TatMessagesLibrary.__SendTextMessage(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(Messages.SendTextMessage(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),GetInputArg(3)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatMessagesLibrary.__SendStructMessage(AMachine: TatVirtualMachine);
  var
  Param3: Variant;
  AResult: variant;
begin
...
AResult := Integer(Messages.SendStructMessage(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),Param3));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatMessagesLibrary.__SendGetStructMessage(AMachine: TatVirtualMachine);
  var
  Param3: Variant;
  AResult: variant;
begin
...
4: AResult := Integer(Messages.SendGetStructMessage(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),Param3));
5: AResult := Integer(Messages.SendGetStructMessage(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),Param3,GetInputArg(4)));
end;
    ReturnOutputArg(AResult);
...
procedure TatMessagesLibrary.__SendGetIntMessage(AMachine: TatVirtualMachine);
  var
  Param2: Integer;
  Param3: Integer;
  AResult: variant;
...
AResult := Integer(Messages.SendGetIntMessage(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),Param2,Param3));
    ReturnOutputArg(AResult);
...
procedure TatMessagesLibrary.Init;
  ...
  begin
    ...
    begin
      ...
      AddConstant('WM_NCXBUTTONDOWN',WM_NCXBUTTONDOWN);
      AddConstant('WM_NCXBUTTONUP',WM_NCXBUTTONUP);
      AddConstant('WM_NCXBUTTONDBLCLK',WM_NCXBUTTONDBLCLK);
      AddConstant('WM_INPUT_DEVICE_CHANGE',WM_INPUT_DEVICE_CHANGE);
      AddConstant('WM_INPUT',WM_INPUT);
      ...
      AddConstant('WM_UNICHAR',WM_UNICHAR);
      ...
      AddConstant('WM_GESTURE',WM_GESTURE);
      AddConstant('WM_GESTURENOTIFY',WM_GESTURENOTIFY);
      ...
      AddConstant('WM_XBUTTONDOWN',WM_XBUTTONDOWN);
      AddConstant('WM_XBUTTONUP',WM_XBUTTONUP);
      AddConstant('WM_XBUTTONDBLCLK',WM_XBUTTONDBLCLK);
      AddConstant('WM_MOUSEHWHEEL',WM_MOUSEHWHEEL);
      ...
      AddConstant('WM_TOUCH',WM_TOUCH);
      AddConstant('WM_MOUSEHOVER',WM_MOUSEHOVER);
      AddConstant('WM_MOUSELEAVE',WM_MOUSELEAVE);
      AddConstant('WM_NCMOUSEHOVER',WM_NCMOUSEHOVER);
      AddConstant('WM_NCMOUSELEAVE',WM_NCMOUSELEAVE);
      AddConstant('WM_WTSSESSION_CHANGE',WM_WTSSESSION_CHANGE);
      AddConstant('WM_TABLET_FIRST',WM_TABLET_FIRST);
      AddConstant('WM_TABLET_LAST',WM_TABLET_LAST);
      ...
      AddConstant('WM_APPCOMMAND',WM_APPCOMMAND);
      AddConstant('WM_THEMECHANGED',WM_THEMECHANGED);
      AddConstant('WM_CLIPBOARDUPDATE',WM_CLIPBOARDUPDATE);
      ...
      AddConstant('WM_DWMCOMPOSITIONCHANGED',WM_DWMCOMPOSITIONCHANGED);
      AddConstant('WM_DWMNCRENDERINGCHANGED',WM_DWMNCRENDERINGCHANGED);
      AddConstant('WM_DWMCOLORIZATIONCOLORCHANGED',WM_DWMCOLORIZATIONCOLORCHANGED);
      AddConstant('WM_DWMWINDOWMAXIMIZEDCHANGE',WM_DWMWINDOWMAXIMIZEDCHANGE);
      AddConstant('WM_DWMSENDICONICTHUMBNAIL',WM_DWMSENDICONICTHUMBNAIL);
      AddConstant('WM_DWMSENDICONICLIVEPREVIEWBITMAP',WM_DWMSENDICONICLIVEPREVIEWBITMAP);
      AddConstant('WM_GETTITLEBARINFOEX',WM_GETTITLEBARINFOEX);
      AddConstant('WM_TABLET_DEFBASE',WM_TABLET_DEFBASE);
      AddConstant('WM_TABLET_MAXOFFSET',WM_TABLET_MAXOFFSET);
      AddConstant('WM_TABLET_ADDED',WM_TABLET_ADDED);
      AddConstant('WM_TABLET_DELETED',WM_TABLET_DELETED);
      AddConstant('WM_TABLET_FLICK',WM_TABLET_FLICK);
      AddConstant('WM_TABLET_QUERYSYSTEMGESTURESTATUS',WM_TABLET_QUERYSYSTEMGESTURESTATUS);
      ...
      AddConstant('BM_SETDONTCLICK',BM_SETDONTCLICK);
  ...
  begin
    ...
    begin
      ...
      AddConstant('SBM_GETSCROLLBARINFO',SBM_GETSCROLLBARINFO);
...
begin
  With Scripter.DefineClass(ClassType) do
  begin
    DefineMethod('SendTextMessage',4,tkInteger,nil,__SendTextMessage,false,0,'Handle: HWND; Msg: UINT; WParam: WPARAM; LParam: UnicodeString');
    DefineMethod('SendStructMessage',4,tkInteger,nil,__SendStructMessage,false,0,'Handle: HWND; Msg: UINT; WParam: WPARAM; LParam');
    DefineMethod('SendGetStructMessage',5,tkInteger,nil,__SendGetStructMessage,false,1,'Handle: HWND; Msg: UINT; WParam: WPARAM; LParam; Unused: Boolean = False').SetVarArgs([3]);
    DefineMethod('SendGetIntMessage',4,tkInteger,nil,__SendGetIntMessage,false,0,'Handle: HWND; Msg: UINT; WParam: Integer; LParam: Integer').SetVarArgs([2,3]);
  AddConsts1;
  AddConsts2;
  end;
end;
