...
begin
  with AMachine do
  begin
AResult := Integer(DDEml.DdeCreateStringHandleA(VarToInteger(GetInputArg(0)),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := Integer(DDEml.DdeCreateStringHandleW(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(DDEml.DdeQueryStringA(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),PAnsiChar(AnsiString(VarToStr(GetInputArg(2)))),VarToInteger(GetInputArg(3)),VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := Integer(DDEml.DdeQueryStringW(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)),VarToInteger(GetInputArg(3)),VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    DefineMethod('DdeUninitialize',1,tkVariant,nil,__DdeUninitialize,false,0,'Inst: DWORD');
    DefineMethod('DdeQueryNextServer',2,tkInteger,nil,__DdeQueryNextServer,false,0,'ConvList: HConvList; ConvPrev: HConv');
    DefineMethod('DdeDisconnectList',1,tkVariant,nil,__DdeDisconnectList,false,0,'ConvList: HConvList');
    DefineMethod('DdeDisconnect',1,tkVariant,nil,__DdeDisconnect,false,0,'Conv: HConv');
    DefineMethod('DdeReconnect',1,tkInteger,nil,__DdeReconnect,false,0,'Conv: HConv');
    DefineMethod('DdeSetUserHandle',3,tkVariant,nil,__DdeSetUserHandle,false,0,'Conv: HConv; ID: DWORD; User: DWORD');
    DefineMethod('DdeAbandonTransaction',3,tkVariant,nil,__DdeAbandonTransaction,false,0,'Inst: DWORD; Conv: HConv; Transaction: DWORD');
    DefineMethod('DdePostAdvise',3,tkVariant,nil,__DdePostAdvise,false,0,'Inst: DWORD; Topic: HSZ; Item: HSZ');
    DefineMethod('DdeEnableCallback',3,tkVariant,nil,__DdeEnableCallback,false,0,'Inst: DWORD; Conv: HConv; Cmd: UINT');
    DefineMethod('DdeNameService',4,tkInteger,nil,__DdeNameService,false,0,'Inst: DWORD; hsz1: HSZ; hsz2: HSZ; Cmd: UINT');
    DefineMethod('DdeUnaccessData',1,tkVariant,nil,__DdeUnaccessData,false,0,'Data: HDDEData');
    DefineMethod('DdeFreeDataHandle',1,tkVariant,nil,__DdeFreeDataHandle,false,0,'Data: HDDEData');
    DefineMethod('DdeGetLastError',1,tkInteger,nil,__DdeGetLastError,false,0,'Inst: DWORD');
    DefineMethod('DdeCreateStringHandleA',3,tkInteger,nil,__DdeCreateStringHandleA,false,0,'Inst: DWORD; psz: PAnsiChar; CodePage: Integer');
    DefineMethod('DdeCreateStringHandleW',3,tkInteger,nil,__DdeCreateStringHandleW,false,0,'Inst: DWORD; psz: PWideChar; CodePage: Integer');
    DefineMethod('DdeCreateStringHandle',3,tkInteger,nil,__DdeCreateStringHandle,false,0,'Inst: DWORD; psz: PChar; CodePage: Integer');
    DefineMethod('DdeQueryStringA',5,tkInteger,nil,__DdeQueryStringA,false,0,'Inst: DWORD; HSZ: HSZ; psz: PAnsiChar; Max: DWORD; CodePage: Integer');
    DefineMethod('DdeQueryStringW',5,tkInteger,nil,__DdeQueryStringW,false,0,'Inst: DWORD; HSZ: HSZ; psz: PWideChar; Max: DWORD; CodePage: Integer');
    DefineMethod('DdeQueryString',5,tkInteger,nil,__DdeQueryString,false,0,'Inst: DWORD; HSZ: HSZ; psz: PChar; Max: DWORD; CodePage: Integer');
    DefineMethod('DdeFreeStringHandle',2,tkVariant,nil,__DdeFreeStringHandle,false,0,'Inst: DWORD; HSZ: HSZ');
    DefineMethod('DdeKeepStringHandle',2,tkVariant,nil,__DdeKeepStringHandle,false,0,'Inst: DWORD; HSZ: HSZ');
    DefineMethod('DdeCmpStringHandles',2,tkInteger,nil,__DdeCmpStringHandles,false,0,'hsz1: HSZ; hsz2: HSZ');
