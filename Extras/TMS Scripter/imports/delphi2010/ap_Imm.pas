...
AResult := Integer(Imm.ImmInstallIME(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf))));
...
begin
  with AMachine do
  begin
AResult := Integer(Imm.ImmInstallIMEA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1))))));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(Imm.ImmInstallIMEW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(Imm.ImmGetDescription(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Imm.ImmGetDescriptionA(VarToInteger(GetInputArg(0)),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(Imm.ImmGetDescriptionW(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(Imm.ImmGetIMEFileName(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Imm.ImmGetIMEFileNameA(VarToInteger(GetInputArg(0)),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(Imm.ImmGetIMEFileNameW(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := Integer(Imm.ImmGetGuideLine(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Imm.ImmGetGuideLineA(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),PAnsiChar(AnsiString(VarToStr(GetInputArg(2)))),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
AResult := Integer(Imm.ImmGetGuideLineW(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := Imm.ImmRegisterWord(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2)),StringToWideChar(VarToStr(GetInputArg(3)),@Param3Buf[0],Length(Param3Buf)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Imm.ImmRegisterWordA(VarToInteger(GetInputArg(0)),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2)),PAnsiChar(AnsiString(VarToStr(GetInputArg(3)))));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
SetLength(Param3Buf, Length(VarToStr(GetInputArg(3))) + 1);
AResult := Imm.ImmRegisterWordW(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2)),StringToWideChar(VarToStr(GetInputArg(3)),@Param3Buf[0],Length(Param3Buf)));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
SetLength(Param3Buf, Length(VarToStr(GetInputArg(3))) + 1);
AResult := Imm.ImmUnregisterWord(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2)),StringToWideChar(VarToStr(GetInputArg(3)),@Param3Buf[0],Length(Param3Buf)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Imm.ImmUnregisterWordA(VarToInteger(GetInputArg(0)),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2)),PAnsiChar(AnsiString(VarToStr(GetInputArg(3)))));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
SetLength(Param3Buf, Length(VarToStr(GetInputArg(3))) + 1);
AResult := Imm.ImmUnregisterWordW(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2)),StringToWideChar(VarToStr(GetInputArg(3)),@Param3Buf[0],Length(Param3Buf)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    DefineMethod('ImmInstallIME',2,tkInteger,nil,__ImmInstallIME,false,0,'lpszIMEFileName: PWideChar; lpszLayoutText: PWideChar');
    DefineMethod('ImmInstallIMEA',2,tkInteger,nil,__ImmInstallIMEA,false,0,'lpszIMEFileName: PAnsiChar; lpszLayoutText: PAnsiChar');
    DefineMethod('ImmInstallIMEW',2,tkInteger,nil,__ImmInstallIMEW,false,0,'lpszIMEFileName: PWideChar; lpszLayoutText: PWideChar');
    DefineMethod('ImmGetDefaultIMEWnd',1,tkInteger,nil,__ImmGetDefaultIMEWnd,false,0,'hWnd: HWND');
    DefineMethod('ImmGetDescription',3,tkInteger,nil,__ImmGetDescription,false,0,'hKl: HKL; PWideChar: PWideChar; uBufLen: UINT');
    DefineMethod('ImmGetDescriptionA',3,tkInteger,nil,__ImmGetDescriptionA,false,0,'hKl: HKL; PAnsiChar: PAnsiChar; uBufLen: UINT');
    DefineMethod('ImmGetDescriptionW',3,tkInteger,nil,__ImmGetDescriptionW,false,0,'hKl: HKL; PWideChar: PWideChar; uBufLen: UINT');
    DefineMethod('ImmGetIMEFileName',3,tkInteger,nil,__ImmGetIMEFileName,false,0,'hKl: HKL; PWideChar: PWideChar; uBufLen: UINT');
    DefineMethod('ImmGetIMEFileNameA',3,tkInteger,nil,__ImmGetIMEFileNameA,false,0,'hKl: HKL; PAnsiChar: PAnsiChar; uBufLen: UINT');
    DefineMethod('ImmGetIMEFileNameW',3,tkInteger,nil,__ImmGetIMEFileNameW,false,0,'hKl: HKL; PWideChar: PWideChar; uBufLen: UINT');
    DefineMethod('ImmGetProperty',2,tkInteger,nil,__ImmGetProperty,false,0,'hKl: HKL; dWord: DWORD');
    DefineMethod('ImmIsIME',1,tkVariant,nil,__ImmIsIME,false,0,'hKl: HKL');
    DefineMethod('ImmSimulateHotKey',2,tkVariant,nil,__ImmSimulateHotKey,false,0,'hWnd: HWND; dWord: DWORD');
    DefineMethod('ImmCreateContext',0,tkInteger,nil,__ImmCreateContext,false,0,'');
    DefineMethod('ImmDestroyContext',1,tkVariant,nil,__ImmDestroyContext,false,0,'hImc: HIMC');
    DefineMethod('ImmGetContext',1,tkInteger,nil,__ImmGetContext,false,0,'hWnd: HWND');
    DefineMethod('ImmReleaseContext',2,tkVariant,nil,__ImmReleaseContext,false,0,'hWnd: HWND; hImc: HIMC');
    DefineMethod('ImmAssociateContext',2,tkInteger,nil,__ImmAssociateContext,false,0,'hWnd: HWND; hImc: HIMC');
    DefineMethod('ImmGetCandidateListCount',2,tkInteger,nil,__ImmGetCandidateListCount,false,0,'hImc: HIMC; ListCount: DWORD').SetVarArgs([1]);
    DefineMethod('ImmGetCandidateListCountA',2,tkInteger,nil,__ImmGetCandidateListCountA,false,0,'hImc: HIMC; ListCount: DWORD').SetVarArgs([1]);
    DefineMethod('ImmGetCandidateListCountW',2,tkInteger,nil,__ImmGetCandidateListCountW,false,0,'hImc: HIMC; ListCount: DWORD').SetVarArgs([1]);
    DefineMethod('ImmGetGuideLine',4,tkInteger,nil,__ImmGetGuideLine,false,0,'hImc: HIMC; dwIndex: DWORD; lpBuf: PWideChar; dwBufLen: DWORD');
    DefineMethod('ImmGetGuideLineA',4,tkInteger,nil,__ImmGetGuideLineA,false,0,'hImc: HIMC; dwIndex: DWORD; lpBuf: PAnsiChar; dwBufLen: DWORD');
    DefineMethod('ImmGetGuideLineW',4,tkInteger,nil,__ImmGetGuideLineW,false,0,'hImc: HIMC; dwIndex: DWORD; lpBuf: PWideChar; dwBufLen: DWORD');
    DefineMethod('ImmGetConversionStatus',3,tkVariant,nil,__ImmGetConversionStatus,false,0,'hImc: HIMC; Conversion: DWORD; Sentence: DWORD').SetVarArgs([1,2]);
    DefineMethod('ImmSetConversionStatus',3,tkVariant,nil,__ImmSetConversionStatus,false,0,'hImc: HIMC; Conversion: DWORD; Sentence: DWORD');
    DefineMethod('ImmGetOpenStatus',1,tkVariant,nil,__ImmGetOpenStatus,false,0,'hImc: HIMC');
    DefineMethod('ImmSetOpenStatus',2,tkVariant,nil,__ImmSetOpenStatus,false,0,'hImc: HIMC; fOpen: Boolean');
    DefineMethod('ImmNotifyIME',4,tkVariant,nil,__ImmNotifyIME,false,0,'hImc: HIMC; dwAction: DWORD; dwIndex: DWORD; dwValue: DWORD');
    DefineMethod('ImmGetStatusWindowPos',2,tkVariant,nil,__ImmGetStatusWindowPos,false,0,'hImc: HIMC; lpPoint: TPoint').SetVarArgs([1]);
    DefineMethod('ImmIsUIMessage',4,tkVariant,nil,__ImmIsUIMessage,false,0,'hWnd: HWND; msg: UINT; wParam: WPARAM; lParam: LPARAM');
    DefineMethod('ImmIsUIMessageA',4,tkVariant,nil,__ImmIsUIMessageA,false,0,'hWnd: HWND; msg: UINT; wParam: WPARAM; lParam: LPARAM');
    DefineMethod('ImmIsUIMessageW',4,tkVariant,nil,__ImmIsUIMessageW,false,0,'hWnd: HWND; msg: UINT; wParam: WPARAM; lParam: LPARAM');
    DefineMethod('ImmGetVirtualKey',1,tkInteger,nil,__ImmGetVirtualKey,false,0,'hWnd: HWND');
    DefineMethod('ImmRegisterWord',4,tkVariant,nil,__ImmRegisterWord,false,0,'hKl: HKL; lpszReading: PWideChar; dwStyle: DWORD; lpszRegister: PWideChar');
    DefineMethod('ImmRegisterWordA',4,tkVariant,nil,__ImmRegisterWordA,false,0,'hKl: HKL; lpszReading: PAnsiChar; dwStyle: DWORD; lpszRegister: PAnsiChar');
    DefineMethod('ImmRegisterWordW',4,tkVariant,nil,__ImmRegisterWordW,false,0,'hKl: HKL; lpszReading: PWideChar; dwStyle: DWORD; lpszRegister: PWideChar');
    DefineMethod('ImmUnregisterWord',4,tkVariant,nil,__ImmUnregisterWord,false,0,'hKl: HKL; lpszReading: PWideChar; dwStyle: DWORD; lpszUnregister: PWideChar');
    DefineMethod('ImmUnregisterWordA',4,tkVariant,nil,__ImmUnregisterWordA,false,0,'hKl: HKL; lpszReading: PAnsiChar; dwStyle: DWORD; lpszUnregister: PAnsiChar');
    DefineMethod('ImmUnregisterWordW',4,tkVariant,nil,__ImmUnregisterWordW,false,0,'hKl: HKL; lpszReading: PWideChar; dwStyle: DWORD; lpszUnregister: PWideChar');
