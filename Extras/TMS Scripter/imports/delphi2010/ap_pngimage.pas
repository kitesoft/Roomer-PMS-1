...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TPNGPointerListClass(CurrentClass.ClassRef).Create(TPngImage(VarToObject(GetInputArg(0)))));
...
begin
  with AMachine do
  begin
    TPNGList(CurrentObject).RemoveChunk(TChunk(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TPNGList(CurrentObject).Item[VarToInteger(GetArrayIndex(0))]));
  end;
end;
...
begin
  with AMachine do
  begin
    TPngImage(CurrentObject).LoadFromClipboardFormat(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)));
  end;
end;
...
begin
  with AMachine do
  begin
    TPngImage(CurrentObject).DrawUsingPixelInformation(TCanvas(VarToObject(GetInputArg(0))),TPointWrapper(integer(GetInputArg(1))).ObjToRec);
  end;
end;
...
begin
  with AMachine do
  begin
    TPngImage(CurrentObject).Assign(TPersistent(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TPngImage(CurrentObject).AssignTo(TPersistent(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TPngImage(CurrentObject).Draw(TCanvas(VarToObject(GetInputArg(0))),TRectWrapper(integer(GetInputArg(1))).ObjToRec);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TPngImageClass(CurrentClass.ClassRef).Create);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TPngImageClass(CurrentClass.ClassRef).CreateBlank(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TPngImage(CurrentObject).LoadFromStream(TStream(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TPngImage(CurrentObject).SaveToStream(TStream(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TPngImage(CurrentObject).LoadFromResourceName(VarToInteger(GetInputArg(0)),VarToStr(GetInputArg(1)));
  end;
end;
...
begin
  with AMachine do
  begin
    TPngImage(CurrentObject).LoadFromResourceID(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TPngImage(CurrentObject).TransparentColor));
  end;
end;
...
begin
  with AMachine do
  begin
    TPngImage(CurrentObject).TransparentColor:=TColor(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TPngImage(CurrentObject).PixelInformation));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TPngImage(CurrentObject).Canvas));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TPngImage(CurrentObject).Header));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TPngImage(CurrentObject).TransparencyMode));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TPngImage(CurrentObject).InterlaceMethod));
  end;
end;
...
begin
  with AMachine do
  begin
    TPngImage(CurrentObject).InterlaceMethod:=TInterlaceMethod(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TPngImage(CurrentObject).CompressionLevel));
  end;
end;
...
begin
  with AMachine do
  begin
    TPngImage(CurrentObject).CompressionLevel:=TCompressionLevel(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TPngImage(CurrentObject).Chunks));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TPngImage(CurrentObject).Pixels[VarToInteger(GetArrayIndex(0)),VarToInteger(GetArrayIndex(1))]));
  end;
end;
...
begin
  with AMachine do
  begin
    TPngImage(CurrentObject).Pixels[VarToInteger(GetArrayIndex(0)),VarToInteger(GetArrayIndex(1))]:=TColor(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TPngImage(CurrentObject).Version));
  end;
end;
...
begin
  with AMachine do
  begin
    TChunk(CurrentObject).Assign(TChunk(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TChunkClass(CurrentClass.ClassRef).Create(TPngImage(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TChunk(CurrentObject).SaveData(TStream(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TChunk(CurrentObject).SaveToStream(TStream(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TChunk(CurrentObject).Header));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TChunk(CurrentObject).Owner));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TChunkIHDR(CurrentObject).SaveToStream(TStream(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TChunkIHDRClass(CurrentClass.ClassRef).Create(TPngImage(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TChunkIHDR(CurrentObject).Assign(TChunk(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TChunkpHYs(CurrentObject).SaveToStream(TStream(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TChunkpHYs(CurrentObject).Assign(TChunk(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TChunkpHYs(CurrentObject).UnitType));
  end;
end;
...
begin
  with AMachine do
  begin
    TChunkpHYs(CurrentObject).UnitType:=TUnitType(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TChunkgAMAClass(CurrentClass.ClassRef).Create(TPngImage(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TChunkgAMA(CurrentObject).Assign(TChunk(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TChunkPLTE(CurrentObject).SaveToStream(TStream(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TChunkPLTE(CurrentObject).Assign(TChunk(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TChunktRNS(CurrentObject).SaveToStream(TStream(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TChunktRNS(CurrentObject).Assign(TChunk(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TChunkIDAT(CurrentObject).SaveToStream(TStream(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TChunktIME(CurrentObject).SaveToStream(TStream(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TChunktIME(CurrentObject).Assign(TChunk(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TChunktEXt(CurrentObject).SaveToStream(TStream(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TChunktEXt(CurrentObject).Assign(TChunk(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TChunkzTXt(CurrentObject).SaveToStream(TStream(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    DefineMethod('Create',1,tkClass,TPNGPointerList,__TPNGPointerListCreate,true,0,'AOwner: TPngImage');
  ...
  begin
    DefineMethod('RemoveChunk',1,tkNone,nil,__TPNGListRemoveChunk,false,0,'Chunk: TChunk');
    DefineProp('Item',tkClass,__GetTPNGListItem,nil,TChunk,false,1);
  end;
  With Scripter.DefineClass(TPngImage) do
  begin
    DefineMethod('Resize',2,tkNone,nil,__TPngImageResize,false,0,'CX: Integer; CY: Integer');
    ...
    DefineMethod('AddtEXt',2,tkNone,nil,__TPngImageAddtEXt,false,0,'Keyword: AnsiString; Text: AnsiString');
    DefineMethod('AddzTXt',2,tkNone,nil,__TPngImageAddzTXt,false,0,'Keyword: AnsiString; Text: AnsiString');
    DefineMethod('SaveToClipboardFormat',3,tkNone,nil,__TPngImageSaveToClipboardFormat,false,0,'AFormat: Word; AData: THandle; APalette: HPalette').SetVarArgs([0,1,2]);
    DefineMethod('LoadFromClipboardFormat',3,tkNone,nil,__TPngImageLoadFromClipboardFormat,false,0,'AFormat: Word; AData: THandle; APalette: HPalette');
    DefineMethod('HasPixelInformation',0,tkVariant,nil,__TPngImageHasPixelInformation,false,0,'');
    DefineMethod('DrawUsingPixelInformation',2,tkNone,nil,__TPngImageDrawUsingPixelInformation,false,0,'Canvas: TCanvas; Point: TPoint');
    DefineMethod('Assign',1,tkNone,nil,__TPngImageAssign,false,0,'Source: TPersistent');
    DefineMethod('AssignTo',1,tkNone,nil,__TPngImageAssignTo,false,0,'Dest: TPersistent');
    DefineMethod('AssignHandle',3,tkNone,nil,__TPngImageAssignHandle,false,0,'Handle: HBitmap; Transparent: Boolean; TransparentColor: ColorRef');
    DefineMethod('Draw',2,tkNone,nil,__TPngImageDraw,false,0,'ACanvas: TCanvas; Rect: TRect');
    DefineMethod('Create',0,tkClass,TPngImage,__TPngImageCreate,true,0,'');
    DefineMethod('CreateBlank',4,tkClass,TPngImage,__TPngImageCreateBlank,true,0,'ColorType: Cardinal; Bitdepth: Cardinal; cx: Integer; cy: Integer');
    DefineMethod('Destroy',0,tkNone,nil,__TPngImageDestroy,false,0,'');
    DefineMethod('LoadFromStream',1,tkNone,nil,__TPngImageLoadFromStream,false,0,'Stream: TStream');
    DefineMethod('SaveToStream',1,tkNone,nil,__TPngImageSaveToStream,false,0,'Stream: TStream');
    DefineMethod('LoadFromResourceName',2,tkNone,nil,__TPngImageLoadFromResourceName,false,0,'Instance: HInst; Name: String');
    DefineMethod('LoadFromResourceID',2,tkNone,nil,__TPngImageLoadFromResourceID,false,0,'Instance: HInst; ResID: Integer');
  ...
  begin
    DefineMethod('ResizeData',1,tkNone,nil,__TChunkResizeData,false,0,'NewSize: Cardinal');
    DefineMethod('Assign',1,tkNone,nil,__TChunkAssign,false,0,'Source: TChunk');
    DefineMethod('Create',1,tkClass,TChunk,__TChunkCreate,true,0,'Owner: TPngImage');
    DefineMethod('Destroy',0,tkNone,nil,__TChunkDestroy,false,0,'');
    DefineMethod('SaveData',1,tkVariant,nil,__TChunkSaveData,false,0,'Stream: TStream');
    DefineMethod('SaveToStream',1,tkVariant,nil,__TChunkSaveToStream,false,0,'Stream: TStream');
  ...
  begin
    DefineMethod('SaveToStream',1,tkVariant,nil,__TChunkIHDRSaveToStream,false,0,'Stream: TStream');
    DefineMethod('Create',1,tkClass,TChunkIHDR,__TChunkIHDRCreate,true,0,'Owner: TPngImage');
    DefineMethod('Destroy',0,tkNone,nil,__TChunkIHDRDestroy,false,0,'');
    DefineMethod('Assign',1,tkNone,nil,__TChunkIHDRAssign,false,0,'Source: TChunk');
  ...
  begin
    DefineMethod('SaveToStream',1,tkVariant,nil,__TChunkpHYsSaveToStream,false,0,'Stream: TStream');
    DefineMethod('Assign',1,tkNone,nil,__TChunkpHYsAssign,false,0,'Source: TChunk');
  ...
  begin
    DefineMethod('Create',1,tkClass,TChunkgAMA,__TChunkgAMACreate,true,0,'Owner: TPngImage');
    DefineMethod('Assign',1,tkNone,nil,__TChunkgAMAAssign,false,0,'Source: TChunk');
    DefineProp('Gamma',tkInteger,__GetTChunkgAMAGamma,__SetTChunkgAMAGamma,nil,false,0);
  end;
  With Scripter.DefineClass(TChunkPLTE) do
  begin
    DefineMethod('SaveToStream',1,tkVariant,nil,__TChunkPLTESaveToStream,false,0,'Stream: TStream');
    DefineMethod('Assign',1,tkNone,nil,__TChunkPLTEAssign,false,0,'Source: TChunk');
  ...
  begin
    DefineMethod('SaveToStream',1,tkVariant,nil,__TChunktRNSSaveToStream,false,0,'Stream: TStream');
    DefineMethod('Assign',1,tkNone,nil,__TChunktRNSAssign,false,0,'Source: TChunk');
  ...
  begin
    DefineMethod('SaveToStream',1,tkVariant,nil,__TChunkIDATSaveToStream,false,0,'Stream: TStream');
  end;
  With Scripter.DefineClass(TChunktIME) do
  begin
    DefineMethod('SaveToStream',1,tkVariant,nil,__TChunktIMESaveToStream,false,0,'Stream: TStream');
    DefineMethod('Assign',1,tkNone,nil,__TChunktIMEAssign,false,0,'Source: TChunk');
  ...
  begin
    DefineMethod('SaveToStream',1,tkVariant,nil,__TChunktEXtSaveToStream,false,0,'Stream: TStream');
    DefineMethod('Assign',1,tkNone,nil,__TChunktEXtAssign,false,0,'Source: TChunk');
  ...
  begin
    DefineMethod('SaveToStream',1,tkVariant,nil,__TChunkzTXtSaveToStream,false,0,'Stream: TStream');
  end;
  With Scripter.DefineClass(ClassType) do
  begin
    DefineMethod('ByteSwap',1,tkInteger,nil,__ByteSwap,false,0,'a: integer');
