...
begin
  with AMachine do
  begin
AResult := Integer(SqlTimSt.VarSQLTimeStampOffset);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(SqlTimSt.SQLTimeStampOffsetToStr(VarToStr(GetInputArg(0)),TSQLTimeStampOffsetWrapper(integer(GetInputArg(1))).ObjToRec));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := SqlTimSt.TryStrToSQLTimeStampOffset(VarToStr(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
...
begin
  with AMachine do
  begin
AResult := integer(TSQLTimeStampOffsetWrapper.Create(SqlTimSt.StrToSQLTimeStampOffset(VarToStr(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('VarSQLTimeStampOffsetCreate',2,tkNone,nil,__VarSQLTimeStampOffsetCreate,false,0,'aDest: Variant; ASQLTimeStampOffset: TSQLTimeStampOffset').SetVarArgs([0]);
    DefineMethod('VarSQLTimeStampOffset',0,tkInteger,nil,__VarSQLTimeStampOffset,false,0,'');
    DefineMethod('VarIsSQLTimeStampOffset',1,tkVariant,nil,__VarIsSQLTimeStampOffset,false,0,'aValue: Variant');
    DefineMethod('LocalToUTC',2,tkVariant,nil,__LocalToUTC,false,0,'TZInfo: TTimeZone; Value: TSQLTimeStamp').SetVarArgs([0,1]);
    DefineMethod('UTCToLocal',2,tkVariant,nil,__UTCToLocal,false,0,'TZInfo: TTimeZone; Value: TSQLTimeStamp').SetVarArgs([0,1]);
    ...
    DefineMethod('VarToSQLTimeStampOffset',1,tkVariant,nil,__VarToSQLTimeStampOffset,false,0,'aValue: Variant');
    DefineMethod('SQLTimeStampOffsetToStr',2,tkVariant,nil,__SQLTimeStampOffsetToStr,false,0,'Format: string; DateTime: TSQLTimeStampOffset');
    DefineMethod('DateTimeToSQLTimeStampOffset',1,tkVariant,nil,__DateTimeToSQLTimeStampOffset,false,0,'DateTime: TDateTime');
    DefineMethod('SQLTimeStampOffsetToDateTime',1,tkVariant,nil,__SQLTimeStampOffsetToDateTime,false,0,'DateTimeOffset: TSQLTimeStampOffset');
    DefineMethod('TryStrToSQLTimeStampOffset',2,tkVariant,nil,__TryStrToSQLTimeStampOffset,false,0,'S: string; TimeStampOffset: TSQLTimeStampOffset').SetVarArgs([1]);
    DefineMethod('StrToSQLTimeStampOffset',1,tkVariant,nil,__StrToSQLTimeStampOffset,false,0,'S: string');
    DefineMethod('CheckSqlTimeStamp',1,tkNone,nil,__CheckSqlTimeStamp,false,0,'ASQLTimeStamp: TSQLTimeStamp');
    DefineMethod('CheckSqlTimeStampOffset',1,tkNone,nil,__CheckSqlTimeStampOffset,false,0,'ASQLTimeStampOffset: TSQLTimeStampOffset');
