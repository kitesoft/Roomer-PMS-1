...
begin
  with AMachine do
  begin
AResult := Integer(VarCmplx.VarComplex);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(VarCmplx.ComplexNumberSymbol));
  end;
end;
...
begin
  with AMachine do
  begin
    VarCmplx.ComplexNumberSymbol:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('VarComplex',0,tkInteger,nil,__VarComplex,false,0,'');
    DefineMethod('VarIsComplex',1,tkVariant,nil,__VarIsComplex,false,0,'AValue: Variant');
    DefineMethod('VarAsComplex',1,tkVariant,nil,__VarAsComplex,false,0,'AValue: Variant');
    DefineMethod('VarComplexSimplify',1,tkVariant,nil,__VarComplexSimplify,false,0,'AValue: Variant');
    DefineMethod('VarComplexAbsSqr',1,tkVariant,nil,__VarComplexAbsSqr,false,0,'AValue: Variant');
    DefineMethod('VarComplexAbs',1,tkVariant,nil,__VarComplexAbs,false,0,'AValue: Variant');
    DefineMethod('VarComplexAngle',1,tkVariant,nil,__VarComplexAngle,false,0,'AValue: Variant');
    DefineMethod('VarComplexSign',1,tkVariant,nil,__VarComplexSign,false,0,'AValue: Variant');
    DefineMethod('VarComplexConjugate',1,tkVariant,nil,__VarComplexConjugate,false,0,'AValue: Variant');
    DefineMethod('VarComplexInverse',1,tkVariant,nil,__VarComplexInverse,false,0,'AValue: Variant');
    DefineMethod('VarComplexExp',1,tkVariant,nil,__VarComplexExp,false,0,'AValue: Variant');
    DefineMethod('VarComplexLn',1,tkVariant,nil,__VarComplexLn,false,0,'AValue: Variant');
    DefineMethod('VarComplexLog2',1,tkVariant,nil,__VarComplexLog2,false,0,'AValue: Variant');
    DefineMethod('VarComplexLog10',1,tkVariant,nil,__VarComplexLog10,false,0,'AValue: Variant');
    DefineMethod('VarComplexLogN',2,tkVariant,nil,__VarComplexLogN,false,0,'AValue: Variant; X: Double');
    DefineMethod('VarComplexSqr',1,tkVariant,nil,__VarComplexSqr,false,0,'AValue: Variant');
    DefineMethod('VarComplexSqrt',1,tkVariant,nil,__VarComplexSqrt,false,0,'AValue: Variant');
    DefineMethod('VarComplexPower',2,tkVariant,nil,__VarComplexPower,false,0,'AValue: Variant; APower: Variant');
    DefineMethod('VarComplexTimesPosI',1,tkVariant,nil,__VarComplexTimesPosI,false,0,'AValue: Variant');
    DefineMethod('VarComplexTimesNegI',1,tkVariant,nil,__VarComplexTimesNegI,false,0,'AValue: Variant');
    DefineMethod('VarComplexTimesImaginary',2,tkVariant,nil,__VarComplexTimesImaginary,false,0,'AValue: Variant; AFactor: Double');
    DefineMethod('VarComplexTimesReal',2,tkVariant,nil,__VarComplexTimesReal,false,0,'AValue: Variant; AFactor: Double');
    DefineMethod('VarComplexCos',1,tkVariant,nil,__VarComplexCos,false,0,'AValue: Variant');
    DefineMethod('VarComplexSin',1,tkVariant,nil,__VarComplexSin,false,0,'AValue: Variant');
    DefineMethod('VarComplexTan',1,tkVariant,nil,__VarComplexTan,false,0,'AValue: Variant');
    DefineMethod('VarComplexCot',1,tkVariant,nil,__VarComplexCot,false,0,'AValue: Variant');
    DefineMethod('VarComplexSec',1,tkVariant,nil,__VarComplexSec,false,0,'AValue: Variant');
    DefineMethod('VarComplexCsc',1,tkVariant,nil,__VarComplexCsc,false,0,'AValue: Variant');
    DefineMethod('VarComplexArcCos',1,tkVariant,nil,__VarComplexArcCos,false,0,'AValue: Variant');
    DefineMethod('VarComplexArcSin',1,tkVariant,nil,__VarComplexArcSin,false,0,'AValue: Variant');
    DefineMethod('VarComplexArcTan',1,tkVariant,nil,__VarComplexArcTan,false,0,'AValue: Variant');
    DefineMethod('VarComplexArcCot',1,tkVariant,nil,__VarComplexArcCot,false,0,'AValue: Variant');
    DefineMethod('VarComplexArcSec',1,tkVariant,nil,__VarComplexArcSec,false,0,'AValue: Variant');
    DefineMethod('VarComplexArcCsc',1,tkVariant,nil,__VarComplexArcCsc,false,0,'AValue: Variant');
    DefineMethod('VarComplexCosH',1,tkVariant,nil,__VarComplexCosH,false,0,'AValue: Variant');
    DefineMethod('VarComplexSinH',1,tkVariant,nil,__VarComplexSinH,false,0,'AValue: Variant');
    DefineMethod('VarComplexTanH',1,tkVariant,nil,__VarComplexTanH,false,0,'AValue: Variant');
    DefineMethod('VarComplexCotH',1,tkVariant,nil,__VarComplexCotH,false,0,'AValue: Variant');
    DefineMethod('VarComplexSecH',1,tkVariant,nil,__VarComplexSecH,false,0,'AValue: Variant');
    DefineMethod('VarComplexCscH',1,tkVariant,nil,__VarComplexCscH,false,0,'AValue: Variant');
    DefineMethod('VarComplexArcCosH',1,tkVariant,nil,__VarComplexArcCosH,false,0,'AValue: Variant');
    DefineMethod('VarComplexArcSinH',1,tkVariant,nil,__VarComplexArcSinH,false,0,'AValue: Variant');
    DefineMethod('VarComplexArcTanH',1,tkVariant,nil,__VarComplexArcTanH,false,0,'AValue: Variant');
    DefineMethod('VarComplexArcCotH',1,tkVariant,nil,__VarComplexArcCotH,false,0,'AValue: Variant');
    DefineMethod('VarComplexArcSecH',1,tkVariant,nil,__VarComplexArcSecH,false,0,'AValue: Variant');
    DefineMethod('VarComplexArcCscH',1,tkVariant,nil,__VarComplexArcCscH,false,0,'AValue: Variant');
    DefineMethod('VarComplexToPolar',4,tkNone,nil,__VarComplexToPolar,false,1,'AValue: Variant; ARadius: Double; ATheta: Double; AFixTheta: Boolean = True').SetVarArgs([1,2]);
    DefineMethod('VarComplexFromPolar',2,tkVariant,nil,__VarComplexFromPolar,false,0,'ARadius: Double; ATheta: Double');
