...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TDBLookupComboClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TDBLookupCombo(CurrentObject).Value));
  end;
end;
...
begin
  with AMachine do
  begin
    TDBLookupCombo(CurrentObject).Value:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TDBLookupCombo(CurrentObject).DisplayValue));
  end;
end;
...
begin
  with AMachine do
  begin
    TDBLookupCombo(CurrentObject).DisplayValue:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TDBLookupListClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TDBLookupList(CurrentObject).Value));
  end;
end;
...
begin
  with AMachine do
  begin
    TDBLookupList(CurrentObject).Value:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TDBLookupList(CurrentObject).DisplayValue));
  end;
end;
...
begin
  with AMachine do
  begin
    TDBLookupList(CurrentObject).DisplayValue:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TPopupGridClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    DefineMethod('Create',1,tkClass,TDBLookupCombo,__TDBLookupComboCreate,true,0,'AOwner: TComponent');
  ...
  begin
    DefineMethod('Create',1,tkClass,TDBLookupList,__TDBLookupListCreate,true,0,'AOwner: TComponent');
  ...
  begin
    DefineMethod('Create',1,tkClass,TPopupGrid,__TPopupGridCreate,true,0,'AOwner: TComponent');
