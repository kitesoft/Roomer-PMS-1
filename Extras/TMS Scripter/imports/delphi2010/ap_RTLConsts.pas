...
procedure TatRTLConstsLibrary.Init;
  ...
  begin
    ...
    begin
      ...
      AddConstant('SThreadStartError',SThreadStartError);
      AddConstant('SParamIsNil',SParamIsNil);
      AddConstant('SParamIsNegative',SParamIsNegative);
      AddConstant('SInputBufferExceed',SInputBufferExceed);
      AddConstant('SInvalidCharsInPath',SInvalidCharsInPath);
      AddConstant('SInvalidCharsInFileName',SInvalidCharsInFileName);
      AddConstant('SInvalidCharsInSearchPattern',SInvalidCharsInSearchPattern);
      AddConstant('SPathTooLong',SPathTooLong);
      AddConstant('SPathNotFound',SPathNotFound);
      AddConstant('SPathFormatNotSupported',SPathFormatNotSupported);
      AddConstant('SDirectoryNotEmpty',SDirectoryNotEmpty);
      AddConstant('SDirectoryAlreadyExists',SDirectoryAlreadyExists);
      AddConstant('SDirectoryInvalid',SDirectoryInvalid);
      AddConstant('SSourceDirIsDestDir',SSourceDirIsDestDir);
      AddConstant('SSourceFileIsDestFile',SSourceFileIsDestFile);
      AddConstant('SPathToFileNeeded',SPathToFileNeeded);
      AddConstant('SSameRootDrive',SSameRootDrive);
      AddConstant('SDriveNotFound',SDriveNotFound);
      AddConstant('SFileNotFound',SFileNotFound);
      AddConstant('SFileAlreadyExists',SFileAlreadyExists);
      ...
      AddConstant('sInvalidTimeoutValue',sInvalidTimeoutValue);
      AddConstant('sTimespanTooLong',sTimespanTooLong);
      AddConstant('sInvalidTimespanDuration',sInvalidTimespanDuration);
      AddConstant('sTimespanValueCannotBeNan',sTimespanValueCannotBeNan);
      AddConstant('sCannotNegateTimespan',sCannotNegateTimespan);
      AddConstant('sInvalidTimespanFormat',sInvalidTimespanFormat);
      AddConstant('sTimespanElementTooLong',sTimespanElementTooLong);
  ...
  begin
    ...
    begin
      ...
      AddConstant('SGUIDAlreadyDefined',SGUIDAlreadyDefined);
      AddConstant('SNoComComponent',SNoComComponent);
      AddConstant('SNoComClass',SNoComClass);
      AddConstant('SNoCOMClassSpecified',SNoCOMClassSpecified);
      AddConstant('SNoCOMClassesRegistered',SNoCOMClassesRegistered);
      AddConstant('SNoContext',SNoContext);
      AddConstant('SNoContextFound',SNoContextFound);
      AddConstant('SNoIndex',SNoIndex);
      AddConstant('SNoSearch',SNoSearch);
      AddConstant('SNoTableOfContents',SNoTableOfContents);
      AddConstant('SNoTopics',SNoTopics);
      AddConstant('SNothingFound',SNothingFound);
      AddConstant('SMethodNotFound',SMethodNotFound);
      AddConstant('STypeMisMatch',STypeMisMatch);
      AddConstant('SInvalidDispID',SInvalidDispID);
      AddConstant('SParamRequired',SParamRequired);
      AddConstant('SMethodOver',SMethodOver);
      AddConstant('STooManyParams',STooManyParams);
      AddConstant('SArgumentOutOfRange',SArgumentOutOfRange);
      AddConstant('SErrorCantModifyWhileIterating',SErrorCantModifyWhileIterating);
      AddConstant('SUnbalancedOperation',SUnbalancedOperation);
      AddConstant('SGenericItemNotFound',SGenericItemNotFound);
      AddConstant('SGenericDuplicateItem',SGenericDuplicateItem);
      AddConstant('SInsufficientRtti',SInsufficientRtti);
      AddConstant('SParameterCountMismatch',SParameterCountMismatch);
      AddConstant('SConversionError',SConversionError);
      AddConstant('SNonPublicType',SNonPublicType);
      AddConstant('SByRefArgMismatch',SByRefArgMismatch);
    end;
  end;
begin
  With Scripter.DefineClass(ClassType) do
