...
1: AResult := ObjectToVar(TZCompressionStreamClass(CurrentClass.ClassRef).Create(TStream(VarToObject(GetInputArg(0)))));
2: AResult := ObjectToVar(TZCompressionStreamClass(CurrentClass.ClassRef).Create(TStream(VarToObject(GetInputArg(0))),TZCompressionLevel(VarToInteger(GetInputArg(1)))));
end;
...
begin
  ...
  begin
    DefineMethod('Create',2,tkClass,TZCompressionStream,__TZCompressionStreamCreate,true,1,'dest: TStream; compressionLevel: TZCompressionLevel = zcDefault');
  ...
  begin
    ...
    DefineMethod('adler32',3,tkInteger,nil,__adler32,false,0,'adler: LongInt; buf: PChar; len: Integer');
    DefineMethod('MoveI32',3,tkNone,nil,__MoveI32,false,0,'Source; Dest; Count: Integer').SetVarArgs([1]);
    DefineMethod('ZSendToBrowser',1,tkNone,nil,__ZSendToBrowser,false,0,'s: string').SetVarArgs([0]);
    ...
    DefineMethod('DeflateInit2_',8,tkInteger,nil,__DeflateInit2_,false,0,'strm: TZStreamRec; level: integer; method: integer; windowBits: integer; memLevel: integer; strategy: integer; version: PChar; recsize: integer').SetVarArgs([0]);
    ...
    DefineMethod('inflateInit2_',4,tkInteger,nil,__inflateInit2_,false,0,'strm: TZStreamRec; windowBits: integer; version: PChar; recsize: integer').SetVarArgs([0]);
