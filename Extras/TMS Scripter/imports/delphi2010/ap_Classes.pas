...
begin
  ...
  begin
    Case InputArgCount of
      ...
      2: TThreadClass(CurrentClass.ClassRef).NameThreadForDebugging(GetInputArg(0),VarToInteger(GetInputArg(1)));
    end;
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('NameThreadForDebugging',2,tkNone,nil,__TThreadNameThreadForDebugging,true,1,'AThreadName: AnsiString; AThreadID: LongWord = $FFFFFFFF');
