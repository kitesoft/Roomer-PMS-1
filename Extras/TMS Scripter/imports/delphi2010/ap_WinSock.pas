...
AResult := Integer(WinSock.getsockopt(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),PAnsiChar(AnsiString(VarToStr(GetInputArg(3)))),Param4));
    ReturnOutputArg(AResult);
...
begin
  with AMachine do
  begin
AResult := Integer(WinSock.inet_addr(PAnsiChar(AnsiString(VarToStr(GetInputArg(0))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(WinSock.setsockopt(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),PAnsiChar(AnsiString(VarToStr(GetInputArg(3)))),VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(WinSock.gethostname(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(WinSock.WSAAsyncGetServByName(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),PAnsiChar(AnsiString(VarToStr(GetInputArg(2)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(3)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(4)))),VarToInteger(GetInputArg(5))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(WinSock.WSAAsyncGetServByPort(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),PAnsiChar(AnsiString(VarToStr(GetInputArg(3)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(4)))),VarToInteger(GetInputArg(5))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(WinSock.WSAAsyncGetProtoByName(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),PAnsiChar(AnsiString(VarToStr(GetInputArg(2)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(3)))),VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(WinSock.WSAAsyncGetProtoByNumber(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),PAnsiChar(AnsiString(VarToStr(GetInputArg(3)))),VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(WinSock.WSAAsyncGetHostByName(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),PAnsiChar(AnsiString(VarToStr(GetInputArg(2)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(3)))),VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(WinSock.WSAAsyncGetHostByAddr(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),PAnsiChar(AnsiString(VarToStr(GetInputArg(2)))),VarToInteger(GetInputArg(3)),VarToInteger(GetInputArg(4)),PAnsiChar(AnsiString(VarToStr(GetInputArg(5)))),VarToInteger(GetInputArg(6))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    DefineMethod('bind',3,tkInteger,nil,__bind,false,0,'s: TSocket; addr: TSockAddr; namelen: Integer').SetVarArgs([1]);
    ...
    DefineMethod('ioctlsocket',3,tkInteger,nil,__ioctlsocket,false,0,'s: TSocket; cmd: DWORD; arg: u_long').SetVarArgs([2]);
    ...
    DefineMethod('inet_ntoa',1,tkVariant,nil,__inet_ntoa,false,0,'inaddr: TInAddr');
    ...
    DefineMethod('send',4,tkInteger,nil,__send,false,0,'s: TSocket; Buf; len: Integer; flags: Integer').SetVarArgs([1]);
    DefineMethod('sendto',6,tkInteger,nil,__sendto,false,0,'s: TSocket; Buf; len: Integer; flags: Integer; addrto: TSockAddr; tolen: Integer').SetVarArgs([1,4]);
    ...
    DefineMethod('socket',3,tkInteger,nil,__socket,false,0,'af: Integer; Struct: Integer; protocol: Integer');
    DefineMethod('gethostname',2,tkInteger,nil,__gethostname,false,0,'name: PAnsiChar; len: Integer');
    DefineMethod('WSAStartup',2,tkInteger,nil,__WSAStartup,false,0,'wVersionRequired: word; WSData: TWSAData').SetVarArgs([1]);
    ...
    DefineMethod('WSAAsyncGetServByName',6,tkInteger,nil,__WSAAsyncGetServByName,false,0,'HWindow: HWND; wMsg: u_int; name: PAnsiChar; proto: PAnsiChar; buf: PAnsiChar; buflen: Integer');
    DefineMethod('WSAAsyncGetServByPort',6,tkInteger,nil,__WSAAsyncGetServByPort,false,0,'HWindow: HWND; wMsg: u_int; port: u_int; proto: PAnsiChar; buf: PAnsiChar; buflen: Integer');
    DefineMethod('WSAAsyncGetProtoByName',5,tkInteger,nil,__WSAAsyncGetProtoByName,false,0,'HWindow: HWND; wMsg: u_int; name: PAnsiChar; buf: PAnsiChar; buflen: Integer');
    DefineMethod('WSAAsyncGetProtoByNumber',5,tkInteger,nil,__WSAAsyncGetProtoByNumber,false,0,'HWindow: HWND; wMsg: u_int; number: Integer; buf: PAnsiChar; buflen: Integer');
    DefineMethod('WSAAsyncGetHostByName',5,tkInteger,nil,__WSAAsyncGetHostByName,false,0,'HWindow: HWND; wMsg: u_int; name: PAnsiChar; buf: PAnsiChar; buflen: Integer');
    DefineMethod('WSAAsyncGetHostByAddr',7,tkInteger,nil,__WSAAsyncGetHostByAddr,false,0,'HWindow: HWND; wMsg: u_int; addr: PAnsiChar; len: Integer; Struct: Integer; buf: PAnsiChar; buflen: Integer');
    DefineMethod('WSACancelAsyncRequest',1,tkInteger,nil,__WSACancelAsyncRequest,false,0,'hAsyncTaskHandle: THandle');
    DefineMethod('WSAAsyncSelect',4,tkInteger,nil,__WSAAsyncSelect,false,0,'s: TSocket; HWindow: HWND; wMsg: u_int; lEvent: Longint');
    DefineMethod('WSARecvEx',4,tkInteger,nil,__WSARecvEx,false,0,'s: TSocket; buf; len: Integer; flags: Integer').SetVarArgs([1,3]);
    DefineMethod('__WSAFDIsSet',2,tkVariant,nil,____WSAFDIsSet,false,0,'s: TSocket; FDSet: TFDSet').SetVarArgs([1]);
    DefineMethod('WSAMakeSyncReply',2,tkInteger,nil,__WSAMakeSyncReply,false,0,'Buflen: Word; Error: Word');
    DefineMethod('WSAMakeSelectReply',2,tkInteger,nil,__WSAMakeSelectReply,false,0,'Event: Word; Error: Word');
    DefineMethod('WSAGetAsyncBuflen',1,tkInteger,nil,__WSAGetAsyncBuflen,false,0,'Param: Longint');
    DefineMethod('WSAGetAsyncError',1,tkInteger,nil,__WSAGetAsyncError,false,0,'Param: Longint');
    DefineMethod('WSAGetSelectEvent',1,tkInteger,nil,__WSAGetSelectEvent,false,0,'Param: Longint');
    DefineMethod('WSAGetSelectError',1,tkInteger,nil,__WSAGetSelectError,false,0,'Param: Longint');
    DefineMethod('FD_CLR',2,tkNone,nil,__FD_CLR,false,0,'Socket: TSocket; FDSet: TFDSet').SetVarArgs([1]);
    DefineMethod('FD_ISSET',2,tkVariant,nil,__FD_ISSET,false,0,'Socket: TSocket; FDSet: TFDSet').SetVarArgs([1]);
    DefineMethod('FD_SET',2,tkNone,nil,__FD_SET,false,0,'Socket: TSocket; FDSet: TFDSet').SetVarArgs([1]);
