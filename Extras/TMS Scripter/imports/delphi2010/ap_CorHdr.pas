...
begin
  ...
  begin
    DefineMethod('IsTdNotPublic',1,tkVariant,nil,__IsTdNotPublic,false,0,'x: CorTypeAttr');
    DefineMethod('IsTdPublic',1,tkVariant,nil,__IsTdPublic,false,0,'x: CorTypeAttr');
    DefineMethod('IsTdNestedPublic',1,tkVariant,nil,__IsTdNestedPublic,false,0,'x: CorTypeAttr');
    DefineMethod('IsTdNestedPrivate',1,tkVariant,nil,__IsTdNestedPrivate,false,0,'x: CorTypeAttr');
    DefineMethod('IsTdNestedFamily',1,tkVariant,nil,__IsTdNestedFamily,false,0,'x: CorTypeAttr');
    DefineMethod('IsTdNestedAssembly',1,tkVariant,nil,__IsTdNestedAssembly,false,0,'x: CorTypeAttr');
    DefineMethod('IsTdNestedFamANDAssem',1,tkVariant,nil,__IsTdNestedFamANDAssem,false,0,'x: CorTypeAttr');
    DefineMethod('IsTdNestedFamORAssem',1,tkVariant,nil,__IsTdNestedFamORAssem,false,0,'x: CorTypeAttr');
    DefineMethod('IsTdNested',1,tkVariant,nil,__IsTdNested,false,0,'x: CorTypeAttr');
    DefineMethod('IsTdAutoLayout',1,tkVariant,nil,__IsTdAutoLayout,false,0,'x: CorTypeAttr');
    DefineMethod('IsTdSequentialLayout',1,tkVariant,nil,__IsTdSequentialLayout,false,0,'x: CorTypeAttr');
    DefineMethod('IsTdExplicitLayout',1,tkVariant,nil,__IsTdExplicitLayout,false,0,'x: CorTypeAttr');
    DefineMethod('IsTdClass',1,tkVariant,nil,__IsTdClass,false,0,'x: CorTypeAttr');
    DefineMethod('IsTdInterface',1,tkVariant,nil,__IsTdInterface,false,0,'x: CorTypeAttr');
    DefineMethod('IsTdAbstract',1,tkVariant,nil,__IsTdAbstract,false,0,'x: CorTypeAttr');
    DefineMethod('IsTdSealed',1,tkVariant,nil,__IsTdSealed,false,0,'x: CorTypeAttr');
    DefineMethod('IsTdSpecialName',1,tkVariant,nil,__IsTdSpecialName,false,0,'x: CorTypeAttr');
    DefineMethod('IsTdImport',1,tkVariant,nil,__IsTdImport,false,0,'x: CorTypeAttr');
    DefineMethod('IsTdSerializable',1,tkVariant,nil,__IsTdSerializable,false,0,'x: CorTypeAttr');
    DefineMethod('IsTdAnsiClass',1,tkVariant,nil,__IsTdAnsiClass,false,0,'x: CorTypeAttr');
    DefineMethod('IsTdUnicodeClass',1,tkVariant,nil,__IsTdUnicodeClass,false,0,'x: CorTypeAttr');
    DefineMethod('IsTdAutoClass',1,tkVariant,nil,__IsTdAutoClass,false,0,'x: CorTypeAttr');
    DefineMethod('IsTdCustomFormatClass',1,tkVariant,nil,__IsTdCustomFormatClass,false,0,'x: CorTypeAttr');
    DefineMethod('IsTdBeforeFieldInit',1,tkVariant,nil,__IsTdBeforeFieldInit,false,0,'x: CorTypeAttr');
    DefineMethod('IsTdForwarder',1,tkVariant,nil,__IsTdForwarder,false,0,'x: CorTypeAttr');
    DefineMethod('IsTdRTSpecialName',1,tkVariant,nil,__IsTdRTSpecialName,false,0,'x: CorTypeAttr');
    DefineMethod('IsTdHasSecurity',1,tkVariant,nil,__IsTdHasSecurity,false,0,'x: CorTypeAttr');
    DefineMethod('IsMdPrivateScope',1,tkVariant,nil,__IsMdPrivateScope,false,0,'x: CorMethodAttr');
    DefineMethod('IsMdPrivate',1,tkVariant,nil,__IsMdPrivate,false,0,'x: CorMethodAttr');
    DefineMethod('IsMdFamANDAssem',1,tkVariant,nil,__IsMdFamANDAssem,false,0,'x: CorMethodAttr');
    DefineMethod('IsMdAssem',1,tkVariant,nil,__IsMdAssem,false,0,'x: CorMethodAttr');
    DefineMethod('IsMdFamily',1,tkVariant,nil,__IsMdFamily,false,0,'x: CorMethodAttr');
    DefineMethod('IsMdFamORAssem',1,tkVariant,nil,__IsMdFamORAssem,false,0,'x: CorMethodAttr');
    DefineMethod('IsMdPublic',1,tkVariant,nil,__IsMdPublic,false,0,'x: CorMethodAttr');
    DefineMethod('IsMdStatic',1,tkVariant,nil,__IsMdStatic,false,0,'x: CorMethodAttr');
    DefineMethod('IsMdFinal',1,tkVariant,nil,__IsMdFinal,false,0,'x: CorMethodAttr');
    DefineMethod('IsMdVirtual',1,tkVariant,nil,__IsMdVirtual,false,0,'x: CorMethodAttr');
    DefineMethod('IsMdHideBySig',1,tkVariant,nil,__IsMdHideBySig,false,0,'x: CorMethodAttr');
    DefineMethod('IsMdReuseSlot',1,tkVariant,nil,__IsMdReuseSlot,false,0,'x: CorMethodAttr');
    DefineMethod('IsMdNewSlot',1,tkVariant,nil,__IsMdNewSlot,false,0,'x: CorMethodAttr');
    DefineMethod('IsMdCheckAccessOnOverride',1,tkVariant,nil,__IsMdCheckAccessOnOverride,false,0,'x: CorMethodAttr');
    DefineMethod('IsMdAbstract',1,tkVariant,nil,__IsMdAbstract,false,0,'x: CorMethodAttr');
    DefineMethod('IsMdSpecialName',1,tkVariant,nil,__IsMdSpecialName,false,0,'x: CorMethodAttr');
    DefineMethod('IsMdPinvokeImpl',1,tkVariant,nil,__IsMdPinvokeImpl,false,0,'x: CorMethodAttr');
    DefineMethod('IsMdUnmanagedExport',1,tkVariant,nil,__IsMdUnmanagedExport,false,0,'x: CorMethodAttr');
    DefineMethod('IsMdRTSpecialName',1,tkVariant,nil,__IsMdRTSpecialName,false,0,'x: CorMethodAttr');
    DefineMethod('IsMdHasSecurity',1,tkVariant,nil,__IsMdHasSecurity,false,0,'x: CorMethodAttr');
    DefineMethod('IsMdRequireSecObject',1,tkVariant,nil,__IsMdRequireSecObject,false,0,'x: CorMethodAttr');
    DefineMethod('IsFdPrivateScope',1,tkVariant,nil,__IsFdPrivateScope,false,0,'x: CorFieldAttr');
    DefineMethod('IsFdPrivate',1,tkVariant,nil,__IsFdPrivate,false,0,'x: CorFieldAttr');
    DefineMethod('IsFdFamANDAssem',1,tkVariant,nil,__IsFdFamANDAssem,false,0,'x: CorFieldAttr');
    DefineMethod('IsFdAssembly',1,tkVariant,nil,__IsFdAssembly,false,0,'x: CorFieldAttr');
    DefineMethod('IsFdFamily',1,tkVariant,nil,__IsFdFamily,false,0,'x: CorFieldAttr');
    DefineMethod('IsFdFamORAssem',1,tkVariant,nil,__IsFdFamORAssem,false,0,'x: CorFieldAttr');
    DefineMethod('IsFdPublic',1,tkVariant,nil,__IsFdPublic,false,0,'x: CorFieldAttr');
    DefineMethod('IsFdStatic',1,tkVariant,nil,__IsFdStatic,false,0,'x: CorFieldAttr');
    DefineMethod('IsFdInitOnly',1,tkVariant,nil,__IsFdInitOnly,false,0,'x: CorFieldAttr');
    DefineMethod('IsFdLiteral',1,tkVariant,nil,__IsFdLiteral,false,0,'x: CorFieldAttr');
    DefineMethod('IsFdNotSerialized',1,tkVariant,nil,__IsFdNotSerialized,false,0,'x: CorFieldAttr');
    DefineMethod('IsFdPinvokeImpl',1,tkVariant,nil,__IsFdPinvokeImpl,false,0,'x: CorFieldAttr');
    DefineMethod('IsFdSpecialName',1,tkVariant,nil,__IsFdSpecialName,false,0,'x: CorFieldAttr');
    DefineMethod('IsFdHasFieldRVA',1,tkVariant,nil,__IsFdHasFieldRVA,false,0,'x: CorFieldAttr');
    DefineMethod('IsFdRTSpecialName',1,tkVariant,nil,__IsFdRTSpecialName,false,0,'x: CorFieldAttr');
    DefineMethod('IsFdHasFieldMarshal',1,tkVariant,nil,__IsFdHasFieldMarshal,false,0,'x: CorFieldAttr');
    DefineMethod('IsFdHasDefault',1,tkVariant,nil,__IsFdHasDefault,false,0,'x: CorFieldAttr');
    DefineMethod('IsPdIn',1,tkVariant,nil,__IsPdIn,false,0,'x: CorParamAttr');
    DefineMethod('IsPdOut',1,tkVariant,nil,__IsPdOut,false,0,'x: CorParamAttr');
    DefineMethod('IsPdOptional',1,tkVariant,nil,__IsPdOptional,false,0,'x: CorParamAttr');
    DefineMethod('IsPdHasDefault',1,tkVariant,nil,__IsPdHasDefault,false,0,'x: CorParamAttr');
    DefineMethod('IsPdHasFieldMarshal',1,tkVariant,nil,__IsPdHasFieldMarshal,false,0,'x: CorParamAttr');
    DefineMethod('IsPrSpecialName',1,tkVariant,nil,__IsPrSpecialName,false,0,'x: CorPropertyAttr');
    DefineMethod('IsPrRTSpecialName',1,tkVariant,nil,__IsPrRTSpecialName,false,0,'x: CorPropertyAttr');
    DefineMethod('IsPrHasDefault',1,tkVariant,nil,__IsPrHasDefault,false,0,'x: CorPropertyAttr');
    DefineMethod('IsEvSpecialName',1,tkVariant,nil,__IsEvSpecialName,false,0,'x: CorEventAttr');
    DefineMethod('IsEvRTSpecialName',1,tkVariant,nil,__IsEvRTSpecialName,false,0,'x: CorEventAttr');
    DefineMethod('IsMsSetter',1,tkVariant,nil,__IsMsSetter,false,0,'x: CorMethodSemanticsAttr');
    DefineMethod('IsMsGetter',1,tkVariant,nil,__IsMsGetter,false,0,'x: CorMethodSemanticsAttr');
    DefineMethod('IsMsOther',1,tkVariant,nil,__IsMsOther,false,0,'x: CorMethodSemanticsAttr');
    DefineMethod('IsMsAddOn',1,tkVariant,nil,__IsMsAddOn,false,0,'x: CorMethodSemanticsAttr');
    DefineMethod('IsMsRemoveOn',1,tkVariant,nil,__IsMsRemoveOn,false,0,'x: CorMethodSemanticsAttr');
    DefineMethod('IsMsFire',1,tkVariant,nil,__IsMsFire,false,0,'x: CorMethodSemanticsAttr');
    DefineMethod('IsDclActionNil',1,tkVariant,nil,__IsDclActionNil,false,0,'x: CorDeclSecurity');
    DefineMethod('IsDclActionAnyStackModifier',1,tkVariant,nil,__IsDclActionAnyStackModifier,false,0,'x: CorDeclSecurity');
    DefineMethod('IsMiIL',1,tkVariant,nil,__IsMiIL,false,0,'x: CorMethodImpl');
    DefineMethod('IsMiNative',1,tkVariant,nil,__IsMiNative,false,0,'x: CorMethodImpl');
    DefineMethod('IsMiOPTIL',1,tkVariant,nil,__IsMiOPTIL,false,0,'x: CorMethodImpl');
    DefineMethod('IsMiRuntime',1,tkVariant,nil,__IsMiRuntime,false,0,'x: CorMethodImpl');
    DefineMethod('IsMiUnmanaged',1,tkVariant,nil,__IsMiUnmanaged,false,0,'x: CorMethodImpl');
    DefineMethod('IsMiManaged',1,tkVariant,nil,__IsMiManaged,false,0,'x: CorMethodImpl');
    DefineMethod('IsMiForwardRef',1,tkVariant,nil,__IsMiForwardRef,false,0,'x: CorMethodImpl');
    DefineMethod('IsMiPreserveSig',1,tkVariant,nil,__IsMiPreserveSig,false,0,'x: CorMethodImpl');
    DefineMethod('IsMiInternalCall',1,tkVariant,nil,__IsMiInternalCall,false,0,'x: CorMethodImpl');
    DefineMethod('IsMiSynchronized',1,tkVariant,nil,__IsMiSynchronized,false,0,'x: CorMethodImpl');
    DefineMethod('IsMiNoInlining',1,tkVariant,nil,__IsMiNoInlining,false,0,'x: CorMethodImpl');
    DefineMethod('IsPmNoMangle',1,tkVariant,nil,__IsPmNoMangle,false,0,'x: CorPInvokeMap');
    DefineMethod('IsPmCharSetNotSpec',1,tkVariant,nil,__IsPmCharSetNotSpec,false,0,'x: CorPInvokeMap');
    DefineMethod('IsPmCharSetAnsi',1,tkVariant,nil,__IsPmCharSetAnsi,false,0,'x: CorPInvokeMap');
    DefineMethod('IsPmCharSetUnicode',1,tkVariant,nil,__IsPmCharSetUnicode,false,0,'x: CorPInvokeMap');
    DefineMethod('IsPmCharSetAuto',1,tkVariant,nil,__IsPmCharSetAuto,false,0,'x: CorPInvokeMap');
    DefineMethod('IsPmSupportsLastError',1,tkVariant,nil,__IsPmSupportsLastError,false,0,'x: CorPInvokeMap');
    DefineMethod('IsPmCallConvWinapi',1,tkVariant,nil,__IsPmCallConvWinapi,false,0,'x: CorPInvokeMap');
    DefineMethod('IsPmCallConvCdecl',1,tkVariant,nil,__IsPmCallConvCdecl,false,0,'x: CorPInvokeMap');
    DefineMethod('IsPmCallConvStdcall',1,tkVariant,nil,__IsPmCallConvStdcall,false,0,'x: CorPInvokeMap');
    DefineMethod('IsPmCallConvThiscall',1,tkVariant,nil,__IsPmCallConvThiscall,false,0,'x: CorPInvokeMap');
    DefineMethod('IsPmCallConvFastcall',1,tkVariant,nil,__IsPmCallConvFastcall,false,0,'x: CorPInvokeMap');
    DefineMethod('IsPmBestFitEnabled',1,tkVariant,nil,__IsPmBestFitEnabled,false,0,'x: CorPInvokeMap');
    DefineMethod('IsPmBestFitDisabled',1,tkVariant,nil,__IsPmBestFitDisabled,false,0,'x: CorPInvokeMap');
    DefineMethod('IsPmBestFitUseAssem',1,tkVariant,nil,__IsPmBestFitUseAssem,false,0,'x: CorPInvokeMap');
    DefineMethod('IsPmThrowOnUnmappableCharEnabled',1,tkVariant,nil,__IsPmThrowOnUnmappableCharEnabled,false,0,'x: CorPInvokeMap');
    DefineMethod('IsPmThrowOnUnmappableCharDisabled',1,tkVariant,nil,__IsPmThrowOnUnmappableCharDisabled,false,0,'x: CorPInvokeMap');
    DefineMethod('IsPmThrowOnUnmappableCharUseAssem',1,tkVariant,nil,__IsPmThrowOnUnmappableCharUseAssem,false,0,'x: CorPInvokeMap');
    DefineMethod('IsAfRetargetable',1,tkVariant,nil,__IsAfRetargetable,false,0,'x: CorAssemblyFlags');
    DefineMethod('IsAfPA_MSIL',1,tkVariant,nil,__IsAfPA_MSIL,false,0,'x: CorAssemblyFlags');
    DefineMethod('IsAfPA_x86',1,tkVariant,nil,__IsAfPA_x86,false,0,'x: CorAssemblyFlags');
    DefineMethod('IsAfPA_IA64',1,tkVariant,nil,__IsAfPA_IA64,false,0,'x: CorAssemblyFlags');
    DefineMethod('IsAfPA_AMD64',1,tkVariant,nil,__IsAfPA_AMD64,false,0,'x: CorAssemblyFlags');
    DefineMethod('IsAfPA_Specified',1,tkVariant,nil,__IsAfPA_Specified,false,0,'x: CorAssemblyFlags');
    DefineMethod('PAIndex',1,tkInteger,nil,__PAIndex,false,0,'x: CorAssemblyFlags');
    DefineMethod('PAFlag',1,tkInteger,nil,__PAFlag,false,0,'x: CorAssemblyFlags');
    DefineMethod('IsAfEnableJITcompileTracking',1,tkVariant,nil,__IsAfEnableJITcompileTracking,false,0,'x: CorAssemblyFlags');
    DefineMethod('IsAfDisableJITcompileOptimizer',1,tkVariant,nil,__IsAfDisableJITcompileOptimizer,false,0,'x: CorAssemblyFlags');
    DefineMethod('IsAfPublicKey',1,tkVariant,nil,__IsAfPublicKey,false,0,'x: CorAssemblyFlags');
    DefineMethod('IsAfPublicKeyToken',1,tkVariant,nil,__IsAfPublicKeyToken,false,0,'x: CorAssemblyFlags');
    DefineMethod('IsMrPublic',1,tkVariant,nil,__IsMrPublic,false,0,'x: CorManifestResourceFlags');
    DefineMethod('IsMrPrivate',1,tkVariant,nil,__IsMrPrivate,false,0,'x: CorManifestResourceFlags');
    DefineMethod('IsFfContainsMetaData',1,tkVariant,nil,__IsFfContainsMetaData,false,0,'x: CorFileFlags');
    DefineMethod('IsFfContainsNoMetaData',1,tkVariant,nil,__IsFfContainsNoMetaData,false,0,'x: CorFileFlags');
    DefineMethod('RidToToken',2,tkInteger,nil,__RidToToken,false,0,'aRid: RID; tktype: mdToken');
    DefineMethod('TokenFromRid',2,tkInteger,nil,__TokenFromRid,false,0,'aRid: RID; tktype: mdToken');
    DefineMethod('RidFromToken',1,tkInteger,nil,__RidFromToken,false,0,'tk: mdToken');
    DefineMethod('TypeFromToken',1,tkInteger,nil,__TypeFromToken,false,0,'tk: mdToken');
    DefineMethod('IsNilToken',1,tkVariant,nil,__IsNilToken,false,0,'tk: mdToken');
    DefineMethod('IsOfRead',1,tkVariant,nil,__IsOfRead,false,0,'x: CorOpenFlags');
    DefineMethod('IsOfReadWrite',1,tkVariant,nil,__IsOfReadWrite,false,0,'x: CorOpenFlags');
    DefineMethod('IsOfCopyMemory',1,tkVariant,nil,__IsOfCopyMemory,false,0,'x: CorOpenFlags');
    DefineMethod('IsOfManifestMetadata',1,tkVariant,nil,__IsOfManifestMetadata,false,0,'x: CorOpenFlags');
    DefineMethod('IsOfReadOnly',1,tkVariant,nil,__IsOfReadOnly,false,0,'x: CorOpenFlags');
    DefineMethod('IsOfTakeOwnership',1,tkVariant,nil,__IsOfTakeOwnership,false,0,'x: CorOpenFlags');
    DefineMethod('IsOfReserved',1,tkVariant,nil,__IsOfReserved,false,0,'x: CorOpenFlags');
