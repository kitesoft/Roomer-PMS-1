...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomApplicationEventsClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
...
begin
  ...
  begin
    DefineMethod('Create',1,tkClass,TCustomApplicationEvents,__TCustomApplicationEventsCreate,true,0,'AOwner: TComponent');
