...
AResult := Integer(Winsock2.getsockopt(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),PAnsiChar(AnsiString(VarToStr(GetInputArg(3)))),Param4));
    ReturnOutputArg(AResult);
...
begin
  with AMachine do
  begin
AResult := Integer(Winsock2.inet_addr(PAnsiChar(AnsiString(VarToStr(GetInputArg(0))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Winsock2.setsockopt(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),PAnsiChar(AnsiString(VarToStr(GetInputArg(3)))),VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Winsock2.gethostname(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Winsock2.WSAAsyncGetServByName(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),PAnsiChar(AnsiString(VarToStr(GetInputArg(2)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(3)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(4)))),VarToInteger(GetInputArg(5))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Winsock2.WSAAsyncGetServByPort(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),PAnsiChar(AnsiString(VarToStr(GetInputArg(3)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(4)))),VarToInteger(GetInputArg(5))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Winsock2.WSAAsyncGetProtoByName(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),PAnsiChar(AnsiString(VarToStr(GetInputArg(2)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(3)))),VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Winsock2.WSAAsyncGetProtoByNumber(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),PAnsiChar(AnsiString(VarToStr(GetInputArg(3)))),VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Winsock2.WSAAsyncGetHostByName(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),PAnsiChar(AnsiString(VarToStr(GetInputArg(2)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(3)))),VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Winsock2.WSAAsyncGetHostByAddr(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),PAnsiChar(AnsiString(VarToStr(GetInputArg(2)))),VarToInteger(GetInputArg(3)),VarToInteger(GetInputArg(4)),PAnsiChar(AnsiString(VarToStr(GetInputArg(5)))),VarToInteger(GetInputArg(6))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Winsock2.WSACancelAsyncRequest(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Winsock2.WSACloseEvent(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Winsock2.WSACreateEvent);
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := Integer(Winsock2.WSAEnumNetworkEvents(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),Param2));
    ReturnOutputArg(AResult);
...
begin
  with AMachine do
  begin
AResult := Integer(Winsock2.WSAEventSelect(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Winsock2.WSAResetEvent(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Winsock2.WSASetEvent(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Winsock2.WSALookupServiceEnd(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param2 := VarToInteger(GetInputArg(2));
AResult := Integer(Winsock2.WSAGetServiceClassNameByClassIdA(TGUIDWrapper(integer(GetInputArg(0))).ObjToRec,PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),Param2));
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
  end;
end;
...
Param2 := VarToInteger(GetInputArg(2));
AResult := Integer(Winsock2.WSAGetServiceClassNameByClassIdW(TGUIDWrapper(integer(GetInputArg(0))).ObjToRec,StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),Param2));
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
  end;
end;
...
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
Param2 := VarToInteger(GetInputArg(2));
AResult := Integer(Winsock2.WSAGetServiceClassNameByClassId(TGUIDWrapper(integer(GetInputArg(0))).ObjToRec,StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),Param2));
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
  end;
end;
...
begin
  With Scripter.DefineClass(ClassType) do
  begin
    DefineMethod('__WSAFDIsSet',2,tkInteger,nil,____WSAFDIsSet,false,0,'s: TSocket; FDSet: TFDSet').SetVarArgs([1]);
    DefineMethod('FD_CLR',2,tkNone,nil,__FD_CLR,false,0,'fd: TSocket; fdset: TFdSet').SetVarArgs([1]);
    DefineMethod('_FD_SET',2,tkNone,nil,___FD_SET,false,0,'fd: TSocket; fdset: TFDSet').SetVarArgs([1]);
    DefineMethod('FD_ZERO',1,tkNone,nil,__FD_ZERO,false,0,'fdset: TFdSet').SetVarArgs([0]);
    DefineMethod('FD_ISSET',2,tkVariant,nil,__FD_ISSET,false,0,'fd: TSocket; fdset: TFdSet').SetVarArgs([1]);
    DefineMethod('timerisset',1,tkVariant,nil,__timerisset,false,0,'tvp: TTimeVal');
    DefineMethod('timerclear',1,tkNone,nil,__timerclear,false,0,'tvp: TTimeVal').SetVarArgs([0]);
    DefineMethod('_IO',2,tkInteger,nil,___IO,false,0,'x: DWORD; y: DWORD');
    DefineMethod('_IOR',3,tkInteger,nil,___IOR,false,0,'x: DWORD; y: DWORD; t: DWORD');
    DefineMethod('_IOW',3,tkInteger,nil,___IOW,false,0,'x: DWORD; y: DWORD; t: DWORD');
    DefineMethod('IN_CLASSA',1,tkVariant,nil,__IN_CLASSA,false,0,'i: DWORD');
    DefineMethod('IN_CLASSB',1,tkVariant,nil,__IN_CLASSB,false,0,'i: DWORD');
    DefineMethod('IN_CLASSC',1,tkVariant,nil,__IN_CLASSC,false,0,'i: DWORD');
    DefineMethod('IN_CLASSD',1,tkVariant,nil,__IN_CLASSD,false,0,'i: DWORD');
    DefineMethod('IN_MULTICAST',1,tkVariant,nil,__IN_MULTICAST,false,0,'i: DWORD');
    DefineMethod('h_errno',0,tkInteger,nil,__h_errno,false,0,'');
    DefineMethod('_WSAIO',2,tkInteger,nil,___WSAIO,false,0,'x: DWORD; y: DWORD');
    DefineMethod('_WSAIOR',2,tkInteger,nil,___WSAIOR,false,0,'x: DWORD; y: DWORD');
    DefineMethod('_WSAIOW',2,tkInteger,nil,___WSAIOW,false,0,'x: DWORD; y: DWORD');
    DefineMethod('_WSAIORW',2,tkInteger,nil,___WSAIORW,false,0,'x: DWORD; y: DWORD');
    DefineMethod('bind',3,tkInteger,nil,__bind,false,0,'s: TSocket; name: TSockAddr; namelen: Integer').SetVarArgs([1]);
    DefineMethod('closesocket',1,tkInteger,nil,__closesocket,false,0,'s: TSocket');
    DefineMethod('connect',3,tkInteger,nil,__connect,false,0,'s: TSocket; name: TSockAddr; namelen: Integer').SetVarArgs([1]);
    DefineMethod('ioctlsocket',3,tkInteger,nil,__ioctlsocket,false,0,'s: TSocket; cmd: Longint; argp: u_long').SetVarArgs([2]);
    DefineMethod('getpeername',3,tkInteger,nil,__getpeername,false,0,'s: TSocket; name: TSockAddr; namelen: Integer').SetVarArgs([1,2]);
    DefineMethod('getsockname',3,tkInteger,nil,__getsockname,false,0,'s: TSocket; name: TSockAddr; namelen: Integer').SetVarArgs([1,2]);
    DefineMethod('getsockopt',5,tkInteger,nil,__getsockopt,false,0,'s: TSocket; level: Integer; optname: Integer; optval: PAnsiChar; optlen: Integer').SetVarArgs([4]);
    DefineMethod('htonl',1,tkInteger,nil,__htonl,false,0,'hostlong: u_long');
    DefineMethod('htons',1,tkInteger,nil,__htons,false,0,'hostshort: u_short');
    DefineMethod('inet_addr',1,tkInteger,nil,__inet_addr,false,0,'cp: PAnsiChar');
    DefineMethod('inet_ntoa',1,tkVariant,nil,__inet_ntoa,false,0,'inaddr: in_addr');
    DefineMethod('listen',2,tkInteger,nil,__listen,false,0,'s: TSocket; backlog: Integer');
    DefineMethod('ntohl',1,tkInteger,nil,__ntohl,false,0,'netlong: u_long');
    DefineMethod('ntohs',1,tkInteger,nil,__ntohs,false,0,'netshort: u_short');
    DefineMethod('recv',4,tkInteger,nil,__recv,false,0,'s: TSocket; buf; len: Integer; flags: Integer').SetVarArgs([1]);
    DefineMethod('recvfrom',6,tkInteger,nil,__recvfrom,false,0,'s: TSocket; buf; len: Integer; flags: Integer; from: TSockAddr; fromlen: Integer').SetVarArgs([1,4,5]);
    DefineMethod('send',4,tkInteger,nil,__send,false,0,'s: TSocket; buf; len: Integer; flags: Integer');
    DefineMethod('setsockopt',5,tkInteger,nil,__setsockopt,false,0,'s: TSocket; level: Integer; optname: Integer; optval: PAnsiChar; optlen: Integer');
    DefineMethod('shutdown',2,tkInteger,nil,__shutdown,false,0,'s: TSocket; how: Integer');
    DefineMethod('socket',3,tkInteger,nil,__socket,false,0,'af: Integer; type_: Integer; protocol: Integer');
    DefineMethod('gethostname',2,tkInteger,nil,__gethostname,false,0,'name: PAnsiChar; namelen: Integer');
    DefineMethod('WSAStartup',2,tkInteger,nil,__WSAStartup,false,0,'wVersionRequired: WORD; lpWSAData: TWSAData').SetVarArgs([1]);
    DefineMethod('WSACleanup',0,tkInteger,nil,__WSACleanup,false,0,'');
    DefineMethod('WSASetLastError',1,tkNone,nil,__WSASetLastError,false,0,'iError: Integer');
    ...
    DefineMethod('WSAAsyncGetServByName',6,tkInteger,nil,__WSAAsyncGetServByName,false,0,'hWnd: HWND; wMsg: u_int; name: PAnsiChar; proto: PAnsiChar; buf: PAnsiChar; buflen: Integer');
    DefineMethod('WSAAsyncGetServByPort',6,tkInteger,nil,__WSAAsyncGetServByPort,false,0,'hWnd: HWND; wMsg: u_int; port: Integer; proto: PAnsiChar; buf: PAnsiChar; buflen: Integer');
    DefineMethod('WSAAsyncGetProtoByName',5,tkInteger,nil,__WSAAsyncGetProtoByName,false,0,'hWnd: HWND; wMsg: u_int; name: PAnsiChar; buf: PAnsiChar; buflen: Integer');
    DefineMethod('WSAAsyncGetProtoByNumber',5,tkInteger,nil,__WSAAsyncGetProtoByNumber,false,0,'hWnd: HWND; wMsg: u_int; number: Integer; buf: PAnsiChar; buflen: Integer');
    DefineMethod('WSAAsyncGetHostByName',5,tkInteger,nil,__WSAAsyncGetHostByName,false,0,'hWnd: HWND; wMsg: u_int; name: PAnsiChar; buf: PAnsiChar; buflen: Integer');
    DefineMethod('WSAAsyncGetHostByAddr',7,tkInteger,nil,__WSAAsyncGetHostByAddr,false,0,'hWnd: HWND; wMsg: u_int; addr: PAnsiChar; len: Integer; type_: Integer; buf: PAnsiChar; buflen: Integer');
    DefineMethod('WSACancelAsyncRequest',1,tkInteger,nil,__WSACancelAsyncRequest,false,0,'hAsyncTaskHandle: THandle');
    DefineMethod('WSAAsyncSelect',4,tkInteger,nil,__WSAAsyncSelect,false,0,'s: TSocket; hWnd: HWND; wMsg: u_int; lEvent: Longint');
    DefineMethod('WSACloseEvent',1,tkVariant,nil,__WSACloseEvent,false,0,'hEvent: WSAEVENT');
    DefineMethod('WSACreateEvent',0,tkInteger,nil,__WSACreateEvent,false,0,'');
    DefineMethod('WSADuplicateSocketA',3,tkInteger,nil,__WSADuplicateSocketA,false,0,'s: TSocket; dwProcessId: DWORD; lpProtocolInfo: WSAPROTOCOL_INFOA').SetVarArgs([2]);
    DefineMethod('WSADuplicateSocketW',3,tkInteger,nil,__WSADuplicateSocketW,false,0,'s: TSocket; dwProcessId: DWORD; lpProtocolInfo: WSAPROTOCOL_INFOW').SetVarArgs([2]);
    DefineMethod('WSADuplicateSocket',3,tkInteger,nil,__WSADuplicateSocket,false,0,'s: TSocket; dwProcessId: DWORD; lpProtocolInfo: WSAPROTOCOL_INFO').SetVarArgs([2]);
    DefineMethod('WSAEnumNetworkEvents',3,tkInteger,nil,__WSAEnumNetworkEvents,false,0,'s: TSocket; hEventObject: WSAEVENT; lpNetworkEvents: WSANETWORKEVENTS').SetVarArgs([2]);
    DefineMethod('WSAEventSelect',3,tkInteger,nil,__WSAEventSelect,false,0,'s: TSocket; hEventObject: WSAEVENT; lNetworkEvents: Longint');
    DefineMethod('WSAHtonl',3,tkInteger,nil,__WSAHtonl,false,0,'s: TSocket; hostlong: u_long; lpnetlong: u_long').SetVarArgs([2]);
    DefineMethod('WSAHtons',3,tkInteger,nil,__WSAHtons,false,0,'s: TSocket; hostshort: u_short; lpnetshort: u_short').SetVarArgs([2]);
    DefineMethod('WSANtohl',3,tkInteger,nil,__WSANtohl,false,0,'s: TSocket; netlong: u_long; lphostlong: u_long').SetVarArgs([2]);
    DefineMethod('WSANtohs',3,tkInteger,nil,__WSANtohs,false,0,'s: TSocket; netshort: u_short; lphostshort: u_short').SetVarArgs([2]);
    DefineMethod('WSAResetEvent',1,tkVariant,nil,__WSAResetEvent,false,0,'hEvent: WSAEVENT');
    DefineMethod('WSASetEvent',1,tkVariant,nil,__WSASetEvent,false,0,'hEvent: WSAEVENT');
    DefineMethod('WSALookupServiceEnd',1,tkInteger,nil,__WSALookupServiceEnd,false,0,'hLookup: THandle');
    DefineMethod('WSARemoveServiceClass',1,tkInteger,nil,__WSARemoveServiceClass,false,0,'lpServiceClassId: TGUID');
    DefineMethod('WSAGetServiceClassNameByClassIdA',3,tkInteger,nil,__WSAGetServiceClassNameByClassIdA,false,0,'lpServiceClassId: TGUID; lpszServiceClassName: LPSTR; lpdwBufferLength: DWORD').SetVarArgs([2]);
    DefineMethod('WSAGetServiceClassNameByClassIdW',3,tkInteger,nil,__WSAGetServiceClassNameByClassIdW,false,0,'lpServiceClassId: TGUID; lpszServiceClassName: LPWSTR; lpdwBufferLength: DWORD').SetVarArgs([2]);
    DefineMethod('WSAGetServiceClassNameByClassId',3,tkInteger,nil,__WSAGetServiceClassNameByClassId,false,0,'lpServiceClassId: TGUID; lpszServiceClassName: LPTSTR; lpdwBufferLength: DWORD').SetVarArgs([2]);
    DefineMethod('WSAMAKEASYNCREPLY',2,tkInteger,nil,__WSAMAKEASYNCREPLY,false,0,'buflen: WORD; error: WORD');
    DefineMethod('WSAMAKESELECTREPLY',2,tkInteger,nil,__WSAMAKESELECTREPLY,false,0,'event: WORD; error: WORD');
    DefineMethod('WSAGETASYNCBUFLEN',1,tkInteger,nil,__WSAGETASYNCBUFLEN,false,0,'lParam: DWORD');
    DefineMethod('WSAGETASYNCERROR',1,tkInteger,nil,__WSAGETASYNCERROR,false,0,'lParam: DWORD');
    DefineMethod('WSAGETSELECTEVENT',1,tkInteger,nil,__WSAGETSELECTEVENT,false,0,'lParam: DWORD');
    DefineMethod('WSAGETSELECTERROR',1,tkInteger,nil,__WSAGETSELECTERROR,false,0,'lParam: DWORD');
