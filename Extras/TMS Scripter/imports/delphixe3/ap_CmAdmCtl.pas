...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCOMAdminCatalogClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCOMAdminCatalog(CurrentObject).GetCollection(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCOMAdminCatalog(CurrentObject).ICOMAdminCatalog_Connect(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCOMAdminCatalogObjectClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCOMAdminCatalogCollectionClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCOMAdminCatalogCollection(CurrentObject).Get_Item(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCOMAdminCatalogCollection(CurrentObject).Add);
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := ObjectToVar(TCOMAdminCatalogCollection(CurrentObject).GetCollection(GetInputArg(0),Param1));
    ReturnOutputArg(AResult);
...
begin
  ...
  begin
    DefineMethod('Create',1,tkClass,TCOMAdminCatalog,__TCOMAdminCatalogCreate,true,0,'AOwner: TComponent');
    ...
    DefineMethod('GetCollection',1,tkClass,TCOMAdminCatalogCollection,__TCOMAdminCatalogGetCollection,false,0,'bstrCollName: WideString');
    DefineMethod('ICOMAdminCatalog_Connect',1,tkClass,TCOMAdminCatalogCollection,__TCOMAdminCatalogICOMAdminCatalog_Connect,false,0,'bstrConnectString: WideString');
    ...
    DefineMethod('ImportComponent',2,tkNone,nil,__TCOMAdminCatalogImportComponent,false,0,'bstrApplIdOrName: WideString; bstrCLSIDOrProgId: WideString');
    DefineMethod('InstallComponent',4,tkNone,nil,__TCOMAdminCatalogInstallComponent,false,0,'bstrApplIdOrName: WideString; bstrDLL: WideString; bstrTLB: WideString; bstrPSDLL: WideString');
    DefineMethod('ShutdownApplication',1,tkNone,nil,__TCOMAdminCatalogShutdownApplication,false,0,'bstrApplIdOrName: WideString');
    DefineMethod('ExportApplication',3,tkNone,nil,__TCOMAdminCatalogExportApplication,false,0,'bstrApplIdOrName: WideString; bstrApplicationFile: WideString; lOptions: Integer');
    DefineMethod('InstallApplication',6,tkNone,nil,__TCOMAdminCatalogInstallApplication,false,0,'bstrApplicationFile: WideString; bstrDestinationDirectory: WideString; lOptions: Integer; bstrUserId: WideString; bstrPassword: WideString; bstrRSN: WideString');
    ...
    DefineMethod('BackupREGDB',1,tkNone,nil,__TCOMAdminCatalogBackupREGDB,false,0,'bstrBackupFilePath: WideString');
    DefineMethod('RestoreREGDB',1,tkNone,nil,__TCOMAdminCatalogRestoreREGDB,false,0,'bstrBackupFilePath: WideString');
    DefineMethod('StartApplication',1,tkNone,nil,__TCOMAdminCatalogStartApplication,false,0,'bstrApplIdOrName: WideString');
    DefineMethod('ServiceCheck',1,tkInteger,nil,__TCOMAdminCatalogServiceCheck,false,0,'lService: Integer');
    DefineMethod('InstallEventClass',4,tkNone,nil,__TCOMAdminCatalogInstallEventClass,false,0,'bstrApplIdOrName: WideString; bstrDLL: WideString; bstrTLB: WideString; bstrPSDLL: WideString');
  ...
  begin
    DefineMethod('Create',1,tkClass,TCOMAdminCatalogObject,__TCOMAdminCatalogObjectCreate,true,0,'AOwner: TComponent');
    ...
    DefineMethod('Get_Value',1,tkVariant,nil,__TCOMAdminCatalogObjectGet_Value,false,0,'bstrPropName: WideString');
    DefineMethod('Set_Value',2,tkNone,nil,__TCOMAdminCatalogObjectSet_Value,false,0,'bstrPropName: WideString; retval: OleVariant');
    ...
    DefineMethod('IsPropertyReadOnly',1,tkVariant,nil,__TCOMAdminCatalogObjectIsPropertyReadOnly,false,0,'bstrPropName: WideString');
    DefineMethod('Get_Valid',0,tkVariant,nil,__TCOMAdminCatalogObjectGet_Valid,false,0,'');
    DefineMethod('IsPropertyWriteOnly',1,tkVariant,nil,__TCOMAdminCatalogObjectIsPropertyWriteOnly,false,0,'bstrPropName: WideString');
  ...
  begin
    DefineMethod('Create',1,tkClass,TCOMAdminCatalogCollection,__TCOMAdminCatalogCollectionCreate,true,0,'AOwner: TComponent');
    ...
    DefineMethod('Get_Item',1,tkClass,TCOMAdminCatalogObject,__TCOMAdminCatalogCollectionGet_Item,false,0,'lIndex: Integer');
    DefineMethod('Get_Count',0,tkInteger,nil,__TCOMAdminCatalogCollectionGet_Count,false,0,'');
    DefineMethod('Remove',1,tkNone,nil,__TCOMAdminCatalogCollectionRemove,false,0,'lIndex: Integer');
    ...
    DefineMethod('GetCollection',2,tkClass,TCOMAdminCatalogCollection,__TCOMAdminCatalogCollectionGetCollection,false,0,'bstrCollName: WideString; ObjectKey: OleVariant').SetVarArgs([1]);
    ...
    DefineMethod('PopulateByQuery',2,tkNone,nil,__TCOMAdminCatalogCollectionPopulateByQuery,false,0,'bstrQueryString: WideString; lQueryType: Integer');
