...
begin
  ...
  begin
    DefineMethod('UpperCase',1,tkVariant,nil,__UpperCase,false,0,'S: AnsiString');
    DefineMethod('LowerCase',1,tkVariant,nil,__LowerCase,false,0,'S: AnsiString');
    DefineMethod('CompareStr',2,tkInteger,nil,__CompareStr,false,0,'S1: AnsiString; S2: AnsiString');
    DefineMethod('SameStr',2,tkVariant,nil,__SameStr,false,0,'S1: AnsiString; S2: AnsiString');
    DefineMethod('CompareText',2,tkInteger,nil,__CompareText,false,0,'S1: AnsiString; S2: AnsiString');
    DefineMethod('SameText',2,tkVariant,nil,__SameText,false,0,'S1: AnsiString; S2: AnsiString');
    DefineMethod('AnsiUpperCase',1,tkVariant,nil,__AnsiUpperCase,false,0,'S: AnsiString');
    DefineMethod('AnsiLowerCase',1,tkVariant,nil,__AnsiLowerCase,false,0,'S: AnsiString');
    DefineMethod('AnsiCompareStr',2,tkInteger,nil,__AnsiCompareStr,false,0,'S1: AnsiString; S2: AnsiString');
    DefineMethod('AnsiSameStr',2,tkVariant,nil,__AnsiSameStr,false,0,'S1: AnsiString; S2: AnsiString');
    DefineMethod('AnsiCompareText',2,tkInteger,nil,__AnsiCompareText,false,0,'S1: AnsiString; S2: AnsiString');
    DefineMethod('AnsiSameText',2,tkVariant,nil,__AnsiSameText,false,0,'S1: AnsiString; S2: AnsiString');
    DefineMethod('AnsiLastChar',1,tkVariant,nil,__AnsiLastChar,false,0,'S: AnsiString');
    DefineMethod('Trim',1,tkVariant,nil,__Trim,false,0,'S: AnsiString');
    DefineMethod('TrimLeft',1,tkVariant,nil,__TrimLeft,false,0,'S: AnsiString');
    DefineMethod('TrimRight',1,tkVariant,nil,__TrimRight,false,0,'S: AnsiString');
    DefineMethod('QuotedStr',1,tkVariant,nil,__QuotedStr,false,0,'S: AnsiString');
    DefineMethod('CharLength',2,tkInteger,nil,__CharLength,false,0,'S: AnsiString; Index: Integer');
    DefineMethod('NextCharIndex',2,tkInteger,nil,__NextCharIndex,false,0,'S: AnsiString; Index: Integer');
    DefineMethod('AnsiCompareFileName',2,tkInteger,nil,__AnsiCompareFileName,false,0,'S1: AnsiString; S2: AnsiString');
    DefineMethod('SameFileName',2,tkVariant,nil,__SameFileName,false,0,'S1: AnsiString; S2: AnsiString');
    DefineMethod('AnsiLowerCaseFileName',1,tkVariant,nil,__AnsiLowerCaseFileName,false,0,'S: AnsiString');
    DefineMethod('AnsiUpperCaseFileName',1,tkVariant,nil,__AnsiUpperCaseFileName,false,0,'S: AnsiString');
    DefineMethod('AnsiPos',2,tkInteger,nil,__AnsiPos,false,0,'Substr: AnsiString; S: AnsiString');
    DefineMethod('ContainsText',2,tkVariant,nil,__ContainsText,false,0,'AText: AnsiString; ASubText: AnsiString');
    DefineMethod('AnsiContainsText',2,tkVariant,nil,__AnsiContainsText,false,0,'AText: AnsiString; ASubText: AnsiString');
    DefineMethod('StartsText',2,tkVariant,nil,__StartsText,false,0,'ASubText: AnsiString; AText: AnsiString');
    DefineMethod('AnsiStartsText',2,tkVariant,nil,__AnsiStartsText,false,0,'ASubText: AnsiString; AText: AnsiString');
    DefineMethod('EndsText',2,tkVariant,nil,__EndsText,false,0,'ASubText: AnsiString; AText: AnsiString');
    DefineMethod('AnsiEndsText',2,tkVariant,nil,__AnsiEndsText,false,0,'ASubText: AnsiString; AText: AnsiString');
    DefineMethod('ReplaceText',3,tkVariant,nil,__ReplaceText,false,0,'AText: AnsiString; AFromText: AnsiString; AToText: AnsiString');
    DefineMethod('AnsiReplaceText',3,tkVariant,nil,__AnsiReplaceText,false,0,'AText: AnsiString; AFromText: AnsiString; AToText: AnsiString');
    DefineMethod('ContainsStr',2,tkVariant,nil,__ContainsStr,false,0,'AText: AnsiString; ASubText: AnsiString');
    DefineMethod('AnsiContainsStr',2,tkVariant,nil,__AnsiContainsStr,false,0,'AText: AnsiString; ASubText: AnsiString');
    DefineMethod('StartsStr',2,tkVariant,nil,__StartsStr,false,0,'ASubText: AnsiString; AText: AnsiString');
    DefineMethod('AnsiStartsStr',2,tkVariant,nil,__AnsiStartsStr,false,0,'ASubText: AnsiString; AText: AnsiString');
    DefineMethod('EndsStr',2,tkVariant,nil,__EndsStr,false,0,'ASubText: AnsiString; AText: AnsiString');
    DefineMethod('AnsiEndsStr',2,tkVariant,nil,__AnsiEndsStr,false,0,'ASubText: AnsiString; AText: AnsiString');
    DefineMethod('ReplaceStr',3,tkVariant,nil,__ReplaceStr,false,0,'AText: AnsiString; AFromText: AnsiString; AToText: AnsiString');
    DefineMethod('AnsiReplaceStr',3,tkVariant,nil,__AnsiReplaceStr,false,0,'AText: AnsiString; AFromText: AnsiString; AToText: AnsiString');
    DefineMethod('DupeString',2,tkVariant,nil,__DupeString,false,0,'AText: AnsiString; ACount: Integer');
    DefineMethod('ReverseString',1,tkVariant,nil,__ReverseString,false,0,'AText: AnsiString');
    DefineMethod('AnsiReverseString',1,tkVariant,nil,__AnsiReverseString,false,0,'AText: AnsiString');
    DefineMethod('StuffString',4,tkVariant,nil,__StuffString,false,0,'AText: AnsiString; AStart: Cardinal; ALength: Cardinal; ASubText: AnsiString');
    DefineMethod('StringReplace',4,tkVariant,nil,__StringReplace,false,0,'S: AnsiString; OldPattern: AnsiString; NewPattern: AnsiString; Flags: TReplaceFlags');
    DefineMethod('ChangeFileExt',2,tkVariant,nil,__ChangeFileExt,false,0,'FileName: AnsiString; Extension: AnsiString');
    DefineMethod('ChangeFilePath',2,tkVariant,nil,__ChangeFilePath,false,0,'FileName: AnsiString; Path: AnsiString');
    DefineMethod('ExtractFilePath',1,tkVariant,nil,__ExtractFilePath,false,0,'FileName: AnsiString');
    DefineMethod('ExtractFileDir',1,tkVariant,nil,__ExtractFileDir,false,0,'FileName: AnsiString');
    DefineMethod('ExtractFileDrive',1,tkVariant,nil,__ExtractFileDrive,false,0,'FileName: AnsiString');
    DefineMethod('ExtractFileName',1,tkVariant,nil,__ExtractFileName,false,0,'FileName: AnsiString');
    DefineMethod('ExtractFileExt',1,tkVariant,nil,__ExtractFileExt,false,0,'FileName: AnsiString');
    DefineMethod('ExpandFileName',1,tkVariant,nil,__ExpandFileName,false,0,'FileName: AnsiString');
    DefineMethod('ExpandFileNameCase',2,tkVariant,nil,__ExpandFileNameCase,false,0,'FileName: AnsiString; MatchFound: TFilenameCaseMatch').SetVarArgs([1]);
    DefineMethod('ExpandUNCFileName',1,tkVariant,nil,__ExpandUNCFileName,false,0,'FileName: AnsiString');
    DefineMethod('ExtractRelativePath',2,tkVariant,nil,__ExtractRelativePath,false,0,'BaseName: AnsiString; DestName: AnsiString');
    DefineMethod('ExtractShortPathName',1,tkVariant,nil,__ExtractShortPathName,false,0,'FileName: AnsiString');
    DefineMethod('LastDelimiter',2,tkInteger,nil,__LastDelimiter,false,0,'Delimiters: AnsiString; S: AnsiString');
    DefineMethod('IsPathDelimiter',2,tkVariant,nil,__IsPathDelimiter,false,0,'S: AnsiString; Index: Integer');
    DefineMethod('IsDelimiter',3,tkVariant,nil,__IsDelimiter,false,0,'Delimiters: AnsiString; S: AnsiString; Index: Integer');
    DefineMethod('IncludeTrailingPathDelimiter',1,tkVariant,nil,__IncludeTrailingPathDelimiter,false,0,'S: AnsiString');
    DefineMethod('IncludeTrailingBackslash',1,tkVariant,nil,__IncludeTrailingBackslash,false,0,'S: AnsiString');
    DefineMethod('ExcludeTrailingPathDelimiter',1,tkVariant,nil,__ExcludeTrailingPathDelimiter,false,0,'S: AnsiString');
    DefineMethod('ExcludeTrailingBackslash',1,tkVariant,nil,__ExcludeTrailingBackslash,false,0,'S: AnsiString');
    DefineMethod('PosEx',3,tkInteger,nil,__PosEx,false,1,'SubStr: AnsiString; S: AnsiString; Offset: Integer = 1');
    DefineMethod('AnsiLeftStr',2,tkVariant,nil,__AnsiLeftStr,false,0,'AText: AnsiString; ACount: Integer');
    DefineMethod('AnsiRightStr',2,tkVariant,nil,__AnsiRightStr,false,0,'AText: AnsiString; ACount: Integer');
    DefineMethod('AnsiMidStr',3,tkVariant,nil,__AnsiMidStr,false,0,'AText: AnsiString; AStart: Integer; ACount: Integer');
