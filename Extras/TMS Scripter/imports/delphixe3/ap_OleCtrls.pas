...
type
  TatOleCtrlsLibrary = class(TatScripterLibrary)
    ...
    procedure __EmptyParam(AMachine: TatVirtualMachine);
...
procedure TatOleCtrlsLibrary.__EmptyParam(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := OleCtrls.EmptyParam;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('EmptyParam',0,tkVariant,nil,__EmptyParam,false,0,'');
  end;
end;
