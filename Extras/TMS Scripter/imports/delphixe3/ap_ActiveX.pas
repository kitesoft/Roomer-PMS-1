...
type
  ...
  _tagpropertykeyWrapper = class(TatRecordWrapper)
  private
    Fpid: DWORD;
  public
    constructor Create(ARecord: _tagpropertykey);
    function ObjToRec: _tagpropertykey;
  published
  ...
  published
    ...
    property cyVal: Currency read FcyVal write FcyVal;
    property date: TOleDate read Fdate write Fdate;
    property cVal: AnsiChar read FcVal write FcVal;
    property uiVal: Word read FuiVal write FuiVal;
    property ulVal: LongWord read FulVal write FulVal;
    property llVal: Int64 read FllVal write FllVal;
    property ullVal: UInt64 read FullVal write FullVal;
  ...
  tagPROPBAG2Wrapper = class(TatRecordWrapper)
  private
    FdwType: DWORD;
    Fvt: TVarType;
    FcfType: TClipFormat;
    FdwHint: DWORD;
  public
    constructor Create(ARecord: tagPROPBAG2);
    function ObjToRec: tagPROPBAG2;
  published
    property dwType: DWORD read FdwType write FdwType;
    property vt: TVarType read Fvt write Fvt;
    property cfType: TClipFormat read FcfType write FcfType;
    property dwHint: DWORD read FdwHint write FdwHint;
  end;
...
constructor _tagpropertykeyWrapper.Create(ARecord: _tagpropertykey);
begin
  inherited Create;
  Fpid := ARecord.pid;
end;

function _tagpropertykeyWrapper.ObjToRec: _tagpropertykey;
begin
  result.pid := Fpid;
end;
...
begin
  ...
  FuiVal := ARecord.uiVal;
  FulVal := ARecord.ulVal;
  FllVal := ARecord.llVal;
  FullVal := ARecord.ullVal;
...
constructor tagPROPBAG2Wrapper.Create(ARecord: tagPROPBAG2);
begin
  inherited Create;
  FdwType := ARecord.dwType;
  Fvt := ARecord.vt;
  FcfType := ARecord.cfType;
  FdwHint := ARecord.dwHint;
end;

function tagPROPBAG2Wrapper.ObjToRec: tagPROPBAG2;
begin
  result.dwType := FdwType;
  result.vt := Fvt;
  result.cfType := FcfType;
  result.dwHint := FdwHint;
end;
...
AResult := Integer(ActiveX.CoLoadLibrary(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
if not Assigned(Param1Rec) or not (Param1Rec is TGUIDWrapper) then 
  Param1Rec := TGUIDWrapper.Create(Param1);
Param1 := TGUIDWrapper(Param1Rec).ObjToRec;
AResult := Integer(ActiveX.CLSIDFromString(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),Param1));
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(TGUIDWrapper.Create(Param1)));
  end;
end;
...
if not Assigned(Param1Rec) or not (Param1Rec is TGUIDWrapper) then 
  Param1Rec := TGUIDWrapper.Create(Param1);
Param1 := TGUIDWrapper(Param1Rec).ObjToRec;
AResult := Integer(ActiveX.IIDFromString(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),Param1));
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(TGUIDWrapper.Create(Param1)));
  end;
end;
...
if not Assigned(Param1Rec) or not (Param1Rec is TGUIDWrapper) then 
  Param1Rec := TGUIDWrapper.Create(Param1);
Param1 := TGUIDWrapper(Param1Rec).ObjToRec;
AResult := Integer(ActiveX.CLSIDFromProgID(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),Param1));
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(TGUIDWrapper.Create(Param1)));
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(ActiveX.StringFromGUID2(TGUIDWrapper(integer(GetInputArg(0))).ObjToRec,StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Integer(ActiveX.StgIsStorageFile(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Integer(ActiveX.StgSetTimes(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),_FILETIMEWrapper(integer(GetInputArg(1))).ObjToRec,_FILETIMEWrapper(integer(GetInputArg(2))).ObjToRec,_FILETIMEWrapper(integer(GetInputArg(3))).ObjToRec));
    ReturnOutputArg(AResult);
  end;
end;
...
if not Assigned(Param1Rec) or not (Param1Rec is TGUIDWrapper) then 
  Param1Rec := TGUIDWrapper.Create(Param1);
Param1 := TGUIDWrapper(Param1Rec).ObjToRec;
AResult := Integer(ActiveX.GetClassFile(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),Param1));
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(TGUIDWrapper.Create(Param1)));
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := WideCharToString(ActiveX.SysAllocString(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(ActiveX.SysReAllocString(Param0,StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf))));
    ReturnOutputArg(AResult);
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := WideCharToString(ActiveX.SysAllocStringLen(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
Param0 := StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf));
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(ActiveX.SysReAllocStringLen(Param0,StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
    SetInputArg(0,WideCharToString(Param0));
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
    ActiveX.SysFreeString(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)));
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Integer(ActiveX.SysStringLen(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Integer(ActiveX.SysStringByteLen(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := WideCharToString(ActiveX.SysAllocStringByteLen(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := Integer(ActiveX.LHashValOfNameSys(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(ActiveX.LHashValOfNameSysA(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),PAnsiChar(AnsiString(VarToStr(GetInputArg(2))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(ActiveX.LHashValOfName(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Integer(ActiveX.OleGetIconOfFile(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(ActiveX.OleGetIconOfClass(TGUIDWrapper(integer(GetInputArg(0))).ObjToRec,StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
AResult := Integer(ActiveX.OleMetafilePictFromIconAndLabel(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatActiveXLibrary.Init;
  ...
  begin
    ...
    begin
      ...
      AddConstant('STGM_DIRECT_SWMR',STGM_DIRECT_SWMR);
      ...
      AddConstant('VT_RECORD',VT_RECORD);
      AddConstant('VT_INT_PTR',VT_INT_PTR);
      AddConstant('VT_UINT_PTR',VT_UINT_PTR);
      ...
      AddConstant('DISPID_WINDOWOBJECT',DISPID_WINDOWOBJECT);
      AddConstant('DISPID_LOCATIONOBJECT',DISPID_LOCATIONOBJECT);
      AddConstant('DISPID_HISTORYOBJECT',DISPID_HISTORYOBJECT);
      AddConstant('DISPID_NAVIGATOROBJECT',DISPID_NAVIGATOROBJECT);
      AddConstant('DISPID_SECURITYCTX',DISPID_SECURITYCTX);
      AddConstant('DISPID_AMBIENT_DLCONTROL',DISPID_AMBIENT_DLCONTROL);
      AddConstant('DISPID_AMBIENT_USERAGENT',DISPID_AMBIENT_USERAGENT);
      AddConstant('DISPID_SECURITYDOMAIN',DISPID_SECURITYDOMAIN);
...
begin
  ...
  begin
    ...
    DefineMethod('CoGetPSClsid',2,tkInteger,nil,__CoGetPSClsid,false,0,'iid: TIID; pClsid: TCLSID').SetVarArgs([1]);
    DefineMethod('CoRegisterPSClsid',2,tkInteger,nil,__CoRegisterPSClsid,false,0,'iid: TIID; clsid: TCLSID');
    ...
    DefineMethod('CoFileTimeToDosDateTime',3,tkVariant,nil,__CoFileTimeToDosDateTime,false,0,'filetime: TFileTime; dosDate: Word; dosTime: Word').SetVarArgs([1,2]);
    ...
    DefineMethod('SysAllocStringByteLen',2,tkVariant,nil,__SysAllocStringByteLen,false,0,'psz: PAnsiChar; len: Integer');
    ...
    DefineMethod('SystemTimeToVariantTime',2,tkInteger,nil,__SystemTimeToVariantTime,false,0,'SystemTime: TSystemTime; vtime: TOleDate').SetVarArgs([0,1]);
    DefineMethod('VariantTimeToSystemTime',2,tkInteger,nil,__VariantTimeToSystemTime,false,0,'vtime: TOleDate; SystemTime: TSystemTime').SetVarArgs([1]);
    DefineMethod('VariantInit',1,tkNone,nil,__VariantInit,false,0,'varg: OleVariant').SetVarArgs([0]);
    DefineMethod('VariantClear',1,tkInteger,nil,__VariantClear,false,0,'varg: OleVariant').SetVarArgs([0]);
    DefineMethod('VariantCopy',2,tkInteger,nil,__VariantCopy,false,0,'vargDest: OleVariant; vargSrc: OleVariant').SetVarArgs([0]);
    DefineMethod('VariantCopyInd',2,tkInteger,nil,__VariantCopyInd,false,0,'varDest: OleVariant; vargSrc: OleVariant').SetVarArgs([0]);
    DefineMethod('VariantChangeType',4,tkInteger,nil,__VariantChangeType,false,0,'vargDest: OleVariant; vargSrc: OleVariant; wFlags: Word; vt: TVarType').SetVarArgs([0]);
    DefineMethod('VariantChangeTypeEx',5,tkInteger,nil,__VariantChangeTypeEx,false,0,'vargDest: OleVariant; vargSrc: OleVariant; lcid: TLCID; wFlags: Word; vt: TVarType').SetVarArgs([0]);
    DefineMethod('LHashValOfNameSys',3,tkInteger,nil,__LHashValOfNameSys,false,0,'syskind: TSysKind; lcid: TLCID; szName: POleStr');
    DefineMethod('LHashValOfNameSysA',3,tkInteger,nil,__LHashValOfNameSysA,false,0,'syskind: TSysKind; lcid: TLCID; szName: PAnsiChar');
    ...
    DefineMethod('QueryPathOfRegTypeLib',5,tkInteger,nil,__QueryPathOfRegTypeLib,false,0,'guid: TGUID; wMaj: Word; wMin: Word; lcid: TLCID; bstrPathName: WideString').SetVarArgs([4]);
    DefineMethod('UnRegisterTypeLib',5,tkInteger,nil,__UnRegisterTypeLib,false,0,'libID: TGUID; wVerMajor: Word; wVerMinor: Word; lcid: TLCID; syskind: TSysKind');
    DefineMethod('DispGetParam',5,tkInteger,nil,__DispGetParam,false,0,'dispparams: TDispParams; position: Integer; vtTarg: TVarType; varResult: OleVariant; puArgErr: Integer').SetVarArgs([3,4]);
    DefineMethod('OaBuildVersion',0,tkInteger,nil,__OaBuildVersion,false,0,'');
    DefineMethod('ClearCustData',1,tkNone,nil,__ClearCustData,false,0,'pCustData: TCustData').SetVarArgs([0]);
    ...
    DefineMethod('OleCreatePropertyFrameIndirect',1,tkInteger,nil,__OleCreatePropertyFrameIndirect,false,0,'Params: TOCPFIParams');
    DefineMethod('OleTranslateColor',3,tkInteger,nil,__OleTranslateColor,false,0,'clr: TOleColor; hpal: HPalette; colorref: TColorRef').SetVarArgs([2]);
    DefineMethod('OleCreateFontIndirect',3,tkInteger,nil,__OleCreateFontIndirect,false,0,'FontDesc: TFontDesc; iid: TIID; vObject').SetVarArgs([2]);
    DefineMethod('OleCreatePictureIndirect',4,tkInteger,nil,__OleCreatePictureIndirect,false,0,'PictDesc: TPictDesc; iid: TIID; fOwn: BOOL; vObject').SetVarArgs([3]);
    DefineMethod('OleIconToCursor',2,tkInteger,nil,__OleIconToCursor,false,0,'hinstExe: THandle; hIcon: THandle');
    DefineMethod('PROPSETHDR_OSVER_KIND',1,tkInteger,nil,__PROPSETHDR_OSVER_KIND,false,0,'dwOSVer: DWORD');
    DefineMethod('PROPSETHDR_OSVER_MAJOR',1,tkInteger,nil,__PROPSETHDR_OSVER_MAJOR,false,0,'dwOSVer: DWORD');
    DefineMethod('PROPSETHDR_OSVER_MINOR',1,tkInteger,nil,__PROPSETHDR_OSVER_MINOR,false,0,'dwOSVer: DWORD');
