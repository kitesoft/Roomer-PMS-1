...
begin
  with AMachine do
  begin
    TCustomForm(CurrentObject).set_PopupParent(TCustomForm(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomForm(CurrentObject).GlassFrame));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomForm(CurrentObject).GlassFrame:=TGlassFrame(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TScreen(CurrentObject).MessageFont));
  end;
end;
...
begin
  with AMachine do
  begin
    TScreen(CurrentObject).MessageFont:=TFont(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TScreen(CurrentObject).CaptionFont));
  end;
end;
...
begin
  with AMachine do
  begin
    TScreen(CurrentObject).CaptionFont:=TFont(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TApplication(CurrentObject).DefaultFont));
  end;
end;
...
begin
  with AMachine do
  begin
    TApplication(CurrentObject).DefaultFont:=TFont(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('set_PopupParent',1,tkNone,nil,__TCustomFormset_PopupParent,false,0,'Value: TCustomForm');
