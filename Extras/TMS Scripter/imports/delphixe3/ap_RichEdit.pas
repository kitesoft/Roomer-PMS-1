...
type
  TatRichEditLibrary = class(TatScripterLibrary)
    procedure __SendEMGetTextExMessage(AMachine: TatVirtualMachine);
  ...
  CHARFORMATAWrapper = class(TatRecordWrapper)
  private
    FcbSize: UINT;
    FdwMask: Longint;
    FdwEffects: Longint;
  ...
  public
    constructor Create(ARecord: CHARFORMATA);
    function ObjToRec: CHARFORMATA;
  published
  ...
  CHARFORMATWWrapper = class(TatRecordWrapper)
  private
    FcbSize: UINT;
    FdwMask: Longint;
    FdwEffects: Longint;
    ...
    FbPitchAndFamily: Byte;
  public
    constructor Create(ARecord: CHARFORMATW);
    function ObjToRec: CHARFORMATW;
  published
    property cbSize: UINT read FcbSize write FcbSize;
    property dwMask: Longint read FdwMask write FdwMask;
    property dwEffects: Longint read FdwEffects write FdwEffects;
  ...
  CHARRANGEWrapper = class(TatRecordWrapper)
  private
    FcpMin: Longint;
    FcpMax: LongInt;
  public
    constructor Create(ARecord: CHARRANGE);
    function ObjToRec: CHARRANGE;
  published
  ...
  EDITSTREAMWrapper = class(TatRecordWrapper)
  private
    FdwCookie: DWORD_PTR;
    FdwError: Longint;
  public
    constructor Create(ARecord: EDITSTREAM);
    function ObjToRec: EDITSTREAM;
  published
    property dwCookie: DWORD_PTR read FdwCookie write FdwCookie;
  ...
  FORMATRANGEWrapper = class(TatRecordWrapper)
  private
    Fhdc: HDC;
    FhdcTarget: HDC;
  public
    constructor Create(ARecord: FORMATRANGE);
    function ObjToRec: FORMATRANGE;
  published
    property hdc: HDC read Fhdc write Fhdc;
    property hdcTarget: HDC read FhdcTarget write FhdcTarget;
  end;
  
  PARAFORMATWrapper = class(TatRecordWrapper)
  private
    FcbSize: UINT;
    FdwMask: DWORD;
    FwNumbering: Word;
    ...
    FcTabCount: Smallint;
  public
    constructor Create(ARecord: PARAFORMAT);
    function ObjToRec: PARAFORMAT;
  published
    property cbSize: UINT read FcbSize write FcbSize;
  ...
  _CHARFORMAT2AWrapper = class(TatRecordWrapper)
  private
    FcbSize: UINT;
    FdwMask: DWORD;
    FdwEffects: DWORD;
    ...
    FbReserved1: Byte;
  public
    constructor Create(ARecord: _CHARFORMAT2A);
    function ObjToRec: _CHARFORMAT2A;
  published
    property cbSize: UINT read FcbSize write FcbSize;
    property dwMask: DWORD read FdwMask write FdwMask;
  ...
  _CHARFORMAT2WWrapper = class(TatRecordWrapper)
  private
    FcbSize: UINT;
    FdwMask: DWORD;
    FdwEffects: DWORD;
    ...
    FbReserved1: Byte;
  public
    constructor Create(ARecord: _CHARFORMAT2W);
    function ObjToRec: _CHARFORMAT2W;
  published
    property cbSize: UINT read FcbSize write FcbSize;
    property dwMask: DWORD read FdwMask write FdwMask;
    property dwEffects: DWORD read FdwEffects write FdwEffects;
  ...
  MSGFILTERWrapper = class(TatRecordWrapper)
  private
    Fmsg: UINT;
    FwParam: WPARAM;
    FlParam: LPARAM;
  public
    constructor Create(ARecord: MSGFILTER);
    function ObjToRec: MSGFILTER;
  published
  ...
  SELCHANGEWrapper = class(TatRecordWrapper)
  private
    Fseltyp: Word;
  public
    constructor Create(ARecord: SELCHANGE);
    function ObjToRec: SELCHANGE;
  published
  ...
  ENPROTECTEDWrapper = class(TatRecordWrapper)
  private
    Fmsg: UINT;
    FwParam: WPARAM;
    FlParam: LPARAM;
  public
    constructor Create(ARecord: ENPROTECTED);
    function ObjToRec: ENPROTECTED;
  published
    property msg: UINT read Fmsg write Fmsg;
    property wParam: WPARAM read FwParam write FwParam;
    property lParam: LPARAM read FlParam write FlParam;
  ...
  ENSAVECLIPBOARDWrapper = class(TatRecordWrapper)
  private
    FcObjectCount: Longint;
    Fcch: Longint;
  public
    constructor Create(ARecord: ENSAVECLIPBOARD);
    function ObjToRec: ENSAVECLIPBOARD;
  published
  ...
  ENCORRECTTEXTWrapper = class(TatRecordWrapper)
  private
    Fseltyp: Word;
  public
    constructor Create(ARecord: ENCORRECTTEXT);
    function ObjToRec: ENCORRECTTEXT;
  published
    property seltyp: Word read Fseltyp write Fseltyp;
  end;
  
  PUNCTUATIONWrapper = class(TatRecordWrapper)
  private
    FiSize: UINT;
  public
    constructor Create(ARecord: PUNCTUATION);
    function ObjToRec: PUNCTUATION;
  published
    property iSize: UINT read FiSize write FiSize;
  end;
  
  COMPCOLORWrapper = class(TatRecordWrapper)
  private
    FcrText: TColorRef;
    FcrBackground: TColorRef;
    FdwEffects: Longint;
  public
    constructor Create(ARecord: COMPCOLOR);
    function ObjToRec: COMPCOLOR;
  published
  ...
  REPASTESPECIALWrapper = class(TatRecordWrapper)
  private
    FdwAspect: DWORD;
    FdwParam: DWORD_PTR;
  public
    constructor Create(ARecord: REPASTESPECIAL);
    function ObjToRec: REPASTESPECIAL;
  published
    property dwAspect: DWORD read FdwAspect write FdwAspect;
    property dwParam: DWORD_PTR read FdwParam write FdwParam;
  end;
  ...
  TWMNotifyREWrapper = class(TatRecordWrapper)
  private
    FMsg: Cardinal;
    FIDCtrl: WPARAM;
    FResult: LRESULT;
  public
    constructor Create(ARecord: TWMNotifyRE);
    function ObjToRec: TWMNotifyRE;
  published
    property Msg: Cardinal read FMsg write FMsg;
    property IDCtrl: WPARAM read FIDCtrl write FIDCtrl;
...
constructor CHARFORMATAWrapper.Create(ARecord: CHARFORMATA);
begin
  inherited Create;
...
function CHARFORMATAWrapper.ObjToRec: CHARFORMATA;
begin
...
constructor CHARFORMATWWrapper.Create(ARecord: CHARFORMATW);
begin
  inherited Create;
  FcbSize := ARecord.cbSize;
  FdwMask := ARecord.dwMask;
...
function CHARFORMATWWrapper.ObjToRec: CHARFORMATW;
begin
  result.cbSize := FcbSize;
  result.dwMask := FdwMask;
  result.dwEffects := FdwEffects;
...
constructor CHARRANGEWrapper.Create(ARecord: CHARRANGE);
begin
  inherited Create;
...
function CHARRANGEWrapper.ObjToRec: CHARRANGE;
begin
  result.cpMin := FcpMin;
  result.cpMax := FcpMax;
end;
...
constructor EDITSTREAMWrapper.Create(ARecord: EDITSTREAM);
begin
  inherited Create;
...
function EDITSTREAMWrapper.ObjToRec: EDITSTREAM;
begin
...
constructor FORMATRANGEWrapper.Create(ARecord: FORMATRANGE);
begin
  inherited Create;
  Fhdc := ARecord.hdc;
...
function FORMATRANGEWrapper.ObjToRec: FORMATRANGE;
begin
  result.hdc := Fhdc;
  result.hdcTarget := FhdcTarget;
end;

constructor PARAFORMATWrapper.Create(ARecord: PARAFORMAT);
begin
  inherited Create;
  FcbSize := ARecord.cbSize;
  FdwMask := ARecord.dwMask;
...
function PARAFORMATWrapper.ObjToRec: PARAFORMAT;
begin
  result.cbSize := FcbSize;
  result.dwMask := FdwMask;
...
constructor _CHARFORMAT2AWrapper.Create(ARecord: _CHARFORMAT2A);
begin
  inherited Create;
  FcbSize := ARecord.cbSize;
  FdwMask := ARecord.dwMask;
...
function _CHARFORMAT2AWrapper.ObjToRec: _CHARFORMAT2A;
begin
  result.cbSize := FcbSize;
  result.dwMask := FdwMask;
  result.dwEffects := FdwEffects;
...
constructor _CHARFORMAT2WWrapper.Create(ARecord: _CHARFORMAT2W);
begin
  inherited Create;
  FcbSize := ARecord.cbSize;
  FdwMask := ARecord.dwMask;
...
function _CHARFORMAT2WWrapper.ObjToRec: _CHARFORMAT2W;
begin
  result.cbSize := FcbSize;
  result.dwMask := FdwMask;
  result.dwEffects := FdwEffects;
...
constructor MSGFILTERWrapper.Create(ARecord: MSGFILTER);
begin
  inherited Create;
  Fmsg := ARecord.msg;
...
function MSGFILTERWrapper.ObjToRec: MSGFILTER;
begin
  result.msg := Fmsg;
...
constructor SELCHANGEWrapper.Create(ARecord: SELCHANGE);
begin
  inherited Create;
  Fseltyp := ARecord.seltyp;
end;

function SELCHANGEWrapper.ObjToRec: SELCHANGE;
begin
...
constructor ENPROTECTEDWrapper.Create(ARecord: ENPROTECTED);
begin
  inherited Create;
  Fmsg := ARecord.msg;
  FwParam := ARecord.wParam;
...
function ENPROTECTEDWrapper.ObjToRec: ENPROTECTED;
begin
  result.msg := Fmsg;
  result.wParam := FwParam;
  result.lParam := FlParam;
...
constructor ENSAVECLIPBOARDWrapper.Create(ARecord: ENSAVECLIPBOARD);
begin
  inherited Create;
...
function ENSAVECLIPBOARDWrapper.ObjToRec: ENSAVECLIPBOARD;
begin
...
constructor ENCORRECTTEXTWrapper.Create(ARecord: ENCORRECTTEXT);
begin
  inherited Create;
  Fseltyp := ARecord.seltyp;
end;

function ENCORRECTTEXTWrapper.ObjToRec: ENCORRECTTEXT;
begin
  result.seltyp := Fseltyp;
end;

constructor PUNCTUATIONWrapper.Create(ARecord: PUNCTUATION);
begin
  inherited Create;
  FiSize := ARecord.iSize;
end;

function PUNCTUATIONWrapper.ObjToRec: PUNCTUATION;
begin
  result.iSize := FiSize;
end;

constructor COMPCOLORWrapper.Create(ARecord: COMPCOLOR);
begin
  inherited Create;
...
function COMPCOLORWrapper.ObjToRec: COMPCOLOR;
begin
...
constructor REPASTESPECIALWrapper.Create(ARecord: REPASTESPECIAL);
begin
  inherited Create;
...
function REPASTESPECIALWrapper.ObjToRec: REPASTESPECIAL;
begin
...
constructor TWMNotifyREWrapper.Create(ARecord: TWMNotifyRE);
begin
  inherited Create;
  FMsg := ARecord.Msg;
...
function TWMNotifyREWrapper.ObjToRec: TWMNotifyRE;
begin
  result.Msg := FMsg;
...
procedure TatRichEditLibrary.__SendEMGetTextExMessage(AMachine: TatVirtualMachine);
  var
  Param3: string;
  AResult: variant;
begin
...
AResult := Integer(RichEdit.SendEMGetTextExMessage(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),GETTEXTEXWrapper(integer(GetInputArg(2))).ObjToRec,Param3));
...
procedure TatRichEditLibrary.Init;
  ...
  begin
    ...
    begin
      ...
      AddConstant('EM_FINDTEXTW',EM_FINDTEXTW);
      AddConstant('EM_FINDTEXTEXW',EM_FINDTEXTEXW);
      AddConstant('EM_RECONVERSION',EM_RECONVERSION);
      AddConstant('EM_SETIMEMODEBIAS',EM_SETIMEMODEBIAS);
      AddConstant('EM_GETIMEMODEBIAS',EM_GETIMEMODEBIAS);
      AddConstant('EM_SETBIDIOPTIONS',EM_SETBIDIOPTIONS);
      AddConstant('EM_GETBIDIOPTIONS',EM_GETBIDIOPTIONS);
      AddConstant('EM_SETTYPOGRAPHYOPTIONS',EM_SETTYPOGRAPHYOPTIONS);
      AddConstant('EM_GETTYPOGRAPHYOPTIONS',EM_GETTYPOGRAPHYOPTIONS);
      AddConstant('EM_SETEDITSTYLE',EM_SETEDITSTYLE);
      AddConstant('EM_GETEDITSTYLE',EM_GETEDITSTYLE);
      AddConstant('SES_EMULATESYSEDIT',SES_EMULATESYSEDIT);
      AddConstant('SES_BEEPONMAXTEXT',SES_BEEPONMAXTEXT);
      AddConstant('SES_EXTENDBACKCOLOR',SES_EXTENDBACKCOLOR);
      AddConstant('SES_MAPCPS',SES_MAPCPS);
      AddConstant('SES_EMULATE10',SES_EMULATE10);
      AddConstant('SES_USECRLF',SES_USECRLF);
      AddConstant('SES_NOXLTSYMBOLRANGE',SES_NOXLTSYMBOLRANGE);
      AddConstant('SES_USEAIMM',SES_USEAIMM);
      AddConstant('SES_NOIME',SES_NOIME);
      AddConstant('SES_ALLOWBEEPS',SES_ALLOWBEEPS);
      AddConstant('SES_UPPERCASE',SES_UPPERCASE);
      AddConstant('SES_LOWERCASE',SES_LOWERCASE);
      AddConstant('SES_NOINPUTSEQUENCECHK',SES_NOINPUTSEQUENCECHK);
      AddConstant('SES_BIDI',SES_BIDI);
      AddConstant('SES_SCROLLONKILLFOCUS',SES_SCROLLONKILLFOCUS);
      AddConstant('SES_XLTCRCRLFTOCR',SES_XLTCRCRLFTOCR);
      AddConstant('SES_DRAFTMODE',SES_DRAFTMODE);
      AddConstant('SES_USECTF',SES_USECTF);
      AddConstant('SES_HIDEGRIDLINES',SES_HIDEGRIDLINES);
      AddConstant('SES_USEATFONT',SES_USEATFONT);
      AddConstant('SES_CUSTOMLOOK',SES_CUSTOMLOOK);
      AddConstant('SES_LBSCROLLNOTIFY',SES_LBSCROLLNOTIFY);
      AddConstant('SES_CTFALLOWEMBED',SES_CTFALLOWEMBED);
      AddConstant('SES_CTFALLOWSMARTTAG',SES_CTFALLOWSMARTTAG);
      AddConstant('SES_CTFALLOWPROOFING',SES_CTFALLOWPROOFING);
  ...
  begin
    ...
    begin
      ...
      AddConstant('PFM_TEXTWRAPPINGBREAK',PFM_TEXTWRAPPINGBREAK);
      AddConstant('PFM_TABLEROWDELIMITER',PFM_TABLEROWDELIMITER);
      AddConstant('PFM_COLLAPSED',PFM_COLLAPSED);
      AddConstant('PFM_OUTLINELEVEL',PFM_OUTLINELEVEL);
      AddConstant('PFM_BOX',PFM_BOX);
      ...
      AddConstant('GT_SELECTION',GT_SELECTION);
      AddConstant('GT_RAWTEXT',GT_RAWTEXT);
      AddConstant('GT_NOHIDDENTEXT',GT_NOHIDDENTEXT);
...
begin
  With Scripter.DefineClass(ClassType) do
  begin
    DefineMethod('SendEMGetTextExMessage',4,tkInteger,nil,__SendEMGetTextExMessage,false,0,'hWnd: HWND; Msg: UINT; wParam: TGetTextEx; lParam: string').SetVarArgs([3]);
