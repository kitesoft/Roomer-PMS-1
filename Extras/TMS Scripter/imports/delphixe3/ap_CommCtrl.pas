...
type
  TatCommCtrlLibrary = class(TatScripterLibrary)
    ...
    procedure __ImageList_LoadBitmapA(AMachine: TatVirtualMachine);
    procedure __ImageList_LoadBitmapW(AMachine: TatVirtualMachine);
    ...
    procedure __Header_InsertItemA(AMachine: TatVirtualMachine);
    procedure __Header_InsertItemW(AMachine: TatVirtualMachine);
    procedure __Header_DeleteItem(AMachine: TatVirtualMachine);
    procedure __Header_GetItem(AMachine: TatVirtualMachine);
    procedure __Header_GetItemA(AMachine: TatVirtualMachine);
    procedure __Header_GetItemW(AMachine: TatVirtualMachine);
    procedure __Header_SetItem(AMachine: TatVirtualMachine);
    procedure __Header_SetItemA(AMachine: TatVirtualMachine);
    procedure __Header_SetItemW(AMachine: TatVirtualMachine);
    ...
    procedure __Header_SetBitmapMargin(AMachine: TatVirtualMachine);
    procedure __Header_GetBitmapMargin(AMachine: TatVirtualMachine);
    procedure __Header_SetFilterChangeTimeout(AMachine: TatVirtualMachine);
    procedure __Header_EditFilter(AMachine: TatVirtualMachine);
    procedure __Header_ClearFilter(AMachine: TatVirtualMachine);
    procedure __Header_ClearAllFilters(AMachine: TatVirtualMachine);
    procedure __Header_GetItemDropDownRect(AMachine: TatVirtualMachine);
    procedure __Header_GetOverflowRect(AMachine: TatVirtualMachine);
    procedure __Header_GetFocusedItem(AMachine: TatVirtualMachine);
    procedure __Header_SetFocusedItem(AMachine: TatVirtualMachine);
    ...
    procedure __ListView_SetSelectedColumn(AMachine: TatVirtualMachine);
    procedure __ListView_SetView(AMachine: TatVirtualMachine);
    procedure __ListView_GetView(AMachine: TatVirtualMachine);
    procedure __ListView_InsertGroup(AMachine: TatVirtualMachine);
    procedure __ListView_SetGroupInfo(AMachine: TatVirtualMachine);
    procedure __ListView_GetGroupInfo(AMachine: TatVirtualMachine);
    procedure __ListView_RemoveGroup(AMachine: TatVirtualMachine);
    procedure __ListView_MoveGroup(AMachine: TatVirtualMachine);
    procedure __ListView_GetGroupCount(AMachine: TatVirtualMachine);
    procedure __ListView_GetGroupInfoByIndex(AMachine: TatVirtualMachine);
    procedure __ListView_MoveItemToGroup(AMachine: TatVirtualMachine);
    procedure __ListView_GetGroupRect(AMachine: TatVirtualMachine);
    procedure __ListView_SetGroupMetrics(AMachine: TatVirtualMachine);
    procedure __ListView_GetGroupMetrics(AMachine: TatVirtualMachine);
    procedure __ListView_EnableGroupView(AMachine: TatVirtualMachine);
    procedure __ListView_InsertGroupSorted(AMachine: TatVirtualMachine);
    procedure __ListView_RemoveAllGroups(AMachine: TatVirtualMachine);
    procedure __ListView_HasGroup(AMachine: TatVirtualMachine);
    procedure __ListView_SetGroupState(AMachine: TatVirtualMachine);
    procedure __ListView_GetGroupState(AMachine: TatVirtualMachine);
    procedure __ListView_GetFocusedGroup(AMachine: TatVirtualMachine);
    procedure __ListView_SetTileViewInfo(AMachine: TatVirtualMachine);
    procedure __ListView_GetTileViewInfo(AMachine: TatVirtualMachine);
    procedure __ListView_SetTileInfo(AMachine: TatVirtualMachine);
    procedure __ListView_GetTileInfo(AMachine: TatVirtualMachine);
    procedure __ListView_SetInsertMark(AMachine: TatVirtualMachine);
    procedure __ListView_GetInsertMark(AMachine: TatVirtualMachine);
    procedure __ListView_InsertMarkHitTest(AMachine: TatVirtualMachine);
    procedure __ListView_GetInsertMarkRect(AMachine: TatVirtualMachine);
    procedure __ListView_SetInsertMarkColor(AMachine: TatVirtualMachine);
    procedure __ListView_GetInsertMarkColor(AMachine: TatVirtualMachine);
    procedure __ListView_SetInfoTip(AMachine: TatVirtualMachine);
    procedure __ListView_GetSelectedColumn(AMachine: TatVirtualMachine);
    procedure __ListView_IsGroupViewEnabled(AMachine: TatVirtualMachine);
    procedure __ListView_GetOutlineColor(AMachine: TatVirtualMachine);
    procedure __ListView_SetOutlineColor(AMachine: TatVirtualMachine);
    procedure __ListView_CancelEditLabel(AMachine: TatVirtualMachine);
    procedure __ListView_MapIndexToID(AMachine: TatVirtualMachine);
    procedure __ListView_MapIDToIndex(AMachine: TatVirtualMachine);
    procedure __ListView_IsItemVisible(AMachine: TatVirtualMachine);
    procedure __ListView_SetGroupHeaderImageList(AMachine: TatVirtualMachine);
    procedure __ListView_GetGroupHeaderImageList(AMachine: TatVirtualMachine);
    procedure __ListView_GetEmptyText(AMachine: TatVirtualMachine);
    procedure __ListView_GetFooterRect(AMachine: TatVirtualMachine);
    procedure __ListView_GetFooterInfo(AMachine: TatVirtualMachine);
    procedure __ListView_GetFooterItemRect(AMachine: TatVirtualMachine);
    procedure __ListView_GetFooterItem(AMachine: TatVirtualMachine);
    procedure __ListView_GetItemIndexRect(AMachine: TatVirtualMachine);
    procedure __ListView_SetItemIndexState(AMachine: TatVirtualMachine);
    procedure __ListView_GetNextItemIndex(AMachine: TatVirtualMachine);
    ...
    procedure __TreeView_SetLineColor(AMachine: TatVirtualMachine);
    procedure __TreeView_GetLineColor(AMachine: TatVirtualMachine);
    procedure __TreeView_SetExtendedStyle(AMachine: TatVirtualMachine);
    procedure __TreeView_GetExtendedStyle(AMachine: TatVirtualMachine);
    procedure __TreeView_SetAutoScrollInfo(AMachine: TatVirtualMachine);
    procedure __TreeView_GetSelectedCount(AMachine: TatVirtualMachine);
    procedure __TabCtrl_HitTest(AMachine: TatVirtualMachine);
    ...
    procedure __Button_GetIdealSize(AMachine: TatVirtualMachine);
    procedure __Button_SetImageList(AMachine: TatVirtualMachine);
    procedure __Button_GetImageList(AMachine: TatVirtualMachine);
    procedure __Button_SetTextMargin(AMachine: TatVirtualMachine);
    procedure __Button_GetTextMargin(AMachine: TatVirtualMachine);
    procedure __Button_SetDropDownState(AMachine: TatVirtualMachine);
    procedure __Button_SetSplitInfo(AMachine: TatVirtualMachine);
    procedure __Button_GetSplitInfo(AMachine: TatVirtualMachine);
    procedure __Button_SetNote(AMachine: TatVirtualMachine);
    procedure __Button_GetNote(AMachine: TatVirtualMachine);
    procedure __Button_GetNoteLength(AMachine: TatVirtualMachine);
    procedure __Button_SetElevationRequiredState(AMachine: TatVirtualMachine);
    procedure __Edit_SetCueBannerText(AMachine: TatVirtualMachine);
    procedure __Edit_GetCueBannerText(AMachine: TatVirtualMachine);
    procedure __Edit_ShowBalloonTip(AMachine: TatVirtualMachine);
    procedure __Edit_HideBalloonTip(AMachine: TatVirtualMachine);
    procedure __Edit_SetHilite(AMachine: TatVirtualMachine);
    procedure __Edit_GetHilite(AMachine: TatVirtualMachine);
    procedure __ComboBox_SetMinVisible(AMachine: TatVirtualMachine);
    procedure __ComboBox_GetMinVisible(AMachine: TatVirtualMachine);
    procedure __ComboBox_SetCueBannerText(AMachine: TatVirtualMachine);
    procedure __ComboBox_GetCueBannerText(AMachine: TatVirtualMachine);
    ...
    procedure __DefSubclassProc(AMachine: TatVirtualMachine);
    procedure __LoadIconMetric(AMachine: TatVirtualMachine);
    procedure __LoadIconWithScaleDown(AMachine: TatVirtualMachine);
    procedure __DrawShadowText(AMachine: TatVirtualMachine);
  ...
  tagNMCUSTOMTEXTWrapper = class(TatRecordWrapper)
  private
    FhDC: HDC;
    FnCount: Integer;
    FuFormat: UINT;
    FfLink: BOOL;
  public
    constructor Create(ARecord: tagNMCUSTOMTEXT);
    function ObjToRec: tagNMCUSTOMTEXT;
  published
    property hDC: HDC read FhDC write FhDC;
    property nCount: Integer read FnCount write FnCount;
    property uFormat: UINT read FuFormat write FuFormat;
  ...
  published
    ...
    property fState: DWORD read FfState write FfState;
    property Frame: DWORD read FFrame write FFrame;
    property crEffect: COLORREF read FcrEffect write FcrEffect;
  end;
  ...
  published
    ...
    property iListGap: Integer read FiListGap write FiListGap;
  end;
  ...
  TBMETRICSAWrapper = class(TatRecordWrapper)
  private
    FcbSize: Integer;
    FdwMask: DWORD;
    FcxPad: Integer;
    ...
    FcxBarPad: Integer;
    FcyBarPad: Integer;
    FcxButtonSpacing: Integer;
    FcyButtonSpacing: Integer;
  public
    constructor Create(ARecord: TBMETRICSA);
    function ObjToRec: TBMETRICSA;
  published
    property cbSize: Integer read FcbSize write FcbSize;
    property dwMask: DWORD read FdwMask write FdwMask;
    property cxPad: Integer read FcxPad write FcxPad;
    property cyPad: Integer read FcyPad write FcyPad;
    property cxBarPad: Integer read FcxBarPad write FcxBarPad;
    property cyBarPad: Integer read FcyBarPad write FcyBarPad;
    property cxButtonSpacing: Integer read FcxButtonSpacing write FcxButtonSpacing;
    property cyButtonSpacing: Integer read FcyButtonSpacing write FcyButtonSpacing;
  end;
  
  TBMETRICSWWrapper = class(TatRecordWrapper)
  private
    FcbSize: Integer;
    FdwMask: DWORD;
    FcxPad: Integer;
    ...
    FcyButtonSpacing: Integer;
  public
    constructor Create(ARecord: TBMETRICSW);
    function ObjToRec: TBMETRICSW;
  published
    property cbSize: Integer read FcbSize write FcbSize;
    property dwMask: DWORD read FdwMask write FdwMask;
    property cxPad: Integer read FcxPad write FcxPad;
  ...
  published
    ...
    property uChevronState: UINT read FuChevronState write FuChevronState;
  end;
  ...
  tagNMREBARCHEVRONWrapper = class(TatRecordWrapper)
  private
    FuBand: UINT;
    FwID: UINT;
    FlParam: LPARAM;
    FlParamNM: LPARAM;
  public
    constructor Create(ARecord: tagNMREBARCHEVRON);
    function ObjToRec: tagNMREBARCHEVRON;
  published
    property uBand: UINT read FuBand write FuBand;
    property wID: UINT read FwID write FwID;
    property lParam: LPARAM read FlParam write FlParam;
    property lParamNM: LPARAM read FlParamNM write FlParamNM;
  end;
  
  tagNMREBARSPLITTERWrapper = class(TatRecordWrapper)
  private
  public
    constructor Create(ARecord: tagNMREBARSPLITTER);
    function ObjToRec: tagNMREBARSPLITTER;
  published
  end;
  
  tagNMREBARAUTOBREAKWrapper = class(TatRecordWrapper)
  private
    FuBand: UINT;
    FwID: UINT;
    FlParam: LPARAM;
    ...
    FfAutoBreak: BOOL;
  public
    constructor Create(ARecord: tagNMREBARAUTOBREAK);
    function ObjToRec: tagNMREBARAUTOBREAK;
  published
    property uBand: UINT read FuBand write FuBand;
    property wID: UINT read FwID write FwID;
    property lParam: LPARAM read FlParam write FlParam;
    property uMsg: UINT read FuMsg write FuMsg;
    property fStyleCurrent: UINT read FfStyleCurrent write FfStyleCurrent;
    property fAutoBreak: BOOL read FfAutoBreak write FfAutoBreak;
  end;
  ...
  _TTGETTITLEWrapper = class(TatRecordWrapper)
  private
    FdwSize: DWORD;
    FuTitleBitmap: Integer;
    Fcch: Integer;
  public
    constructor Create(ARecord: _TTGETTITLE);
    function ObjToRec: _TTGETTITLE;
  published
    property dwSize: DWORD read FdwSize write FdwSize;
    property uTitleBitmap: Integer read FuTitleBitmap write FuTitleBitmap;
    property cch: Integer read Fcch write Fcch;
  end;
  ...
  tagLITEMWrapper = class(TatRecordWrapper)
  private
    Fmask: UINT;
    FiLink: Integer;
    Fstate: UINT;
    FstateMask: UINT;
  public
    constructor Create(ARecord: tagLITEM);
    function ObjToRec: tagLITEM;
  published
    property mask: UINT read Fmask write Fmask;
    property iLink: Integer read FiLink write FiLink;
    property state: UINT read Fstate write Fstate;
    property stateMask: UINT read FstateMask write FstateMask;
  end;
  
  tagLHITTESTINFOWrapper = class(TatRecordWrapper)
  private
  public
    constructor Create(ARecord: tagLHITTESTINFO);
    function ObjToRec: tagLHITTESTINFO;
  published
  end;
  
  tagNMLINKWrapper = class(TatRecordWrapper)
  private
  public
    constructor Create(ARecord: tagNMLINK);
    function ObjToRec: tagNMLINK;
  published
  end;
  ...
  published
    ...
    property iGroupId: Integer read FiGroupId write FiGroupId;
    property cColumns: Integer read FcColumns write FcColumns;
    property iGroup: Integer read FiGroup write FiGroup;
  end;
  ...
  published
    ...
    property iImage: Integer read FiImage write FiImage;
    property iOrder: Integer read FiOrder write FiOrder;
    property cxMin: Integer read FcxMin write FcxMin;
    property cxDefault: Integer read FcxDefault write FcxDefault;
    property cxIdeal: Integer read FcxIdeal write FcxIdeal;
  end;
  ...
  tagLVGROUPWrapper = class(TatRecordWrapper)
  private
    FcbSize: UINT;
    Fmask: UINT;
    FcchHeader: Integer;
    ...
    FcchSubtitle: UINT;
    FcchTask: UINT;
    FcchDescriptionTop: UINT;
    FcchDescriptionBottom: UINT;
    FiTitleImage: Integer;
    FiExtendedImage: Integer;
    FiFirstItem: Integer;
    FcItems: UINT;
    FcchSubsetTitle: UINT;
  public
    constructor Create(ARecord: tagLVGROUP);
    function ObjToRec: tagLVGROUP;
  published
    property cbSize: UINT read FcbSize write FcbSize;
    property mask: UINT read Fmask write Fmask;
    property cchHeader: Integer read FcchHeader write FcchHeader;
    property cchFooter: Integer read FcchFooter write FcchFooter;
    property iGroupId: Integer read FiGroupId write FiGroupId;
    property stateMask: UINT read FstateMask write FstateMask;
    property state: UINT read Fstate write Fstate;
    property uAlign: UINT read FuAlign write FuAlign;
    property cchSubtitle: UINT read FcchSubtitle write FcchSubtitle;
    property cchTask: UINT read FcchTask write FcchTask;
    property cchDescriptionTop: UINT read FcchDescriptionTop write FcchDescriptionTop;
    property cchDescriptionBottom: UINT read FcchDescriptionBottom write FcchDescriptionBottom;
    property iTitleImage: Integer read FiTitleImage write FiTitleImage;
    property iExtendedImage: Integer read FiExtendedImage write FiExtendedImage;
    property iFirstItem: Integer read FiFirstItem write FiFirstItem;
    property cItems: UINT read FcItems write FcItems;
    property cchSubsetTitle: UINT read FcchSubsetTitle write FcchSubsetTitle;
  end;
  
  tagLVGROUPMETRICSWrapper = class(TatRecordWrapper)
  private
    FcbSize: UINT;
    Fmask: UINT;
    FLeft: UINT;
    ...
    FcrFooter: COLORREF;
  public
    constructor Create(ARecord: tagLVGROUPMETRICS);
    function ObjToRec: tagLVGROUPMETRICS;
  published
    property cbSize: UINT read FcbSize write FcbSize;
    property mask: UINT read Fmask write Fmask;
    property Left: UINT read FLeft write FLeft;
    property Top: UINT read FTop write FTop;
    property Right: UINT read FRight write FRight;
    property Bottom: UINT read FBottom write FBottom;
    property crLeft: COLORREF read FcrLeft write FcrLeft;
    property crTop: COLORREF read FcrTop write FcrTop;
    property crRight: COLORREF read FcrRight write FcrRight;
    property crBottom: COLORREF read FcrBottom write FcrBottom;
    property crHeader: COLORREF read FcrHeader write FcrHeader;
    property crFooter: COLORREF read FcrFooter write FcrFooter;
  end;
  
  tagLVINSERTGROUPSORTEDWrapper = class(TatRecordWrapper)
  private
  public
    constructor Create(ARecord: tagLVINSERTGROUPSORTED);
    function ObjToRec: tagLVINSERTGROUPSORTED;
  published
  end;
  
  tagLVTILEVIEWINFOWrapper = class(TatRecordWrapper)
  private
    FcbSize: UINT;
    FdwMask: DWORD;
    FdwFlags: DWORD;
    FcLines: Integer;
  public
    constructor Create(ARecord: tagLVTILEVIEWINFO);
    function ObjToRec: tagLVTILEVIEWINFO;
  published
    property cbSize: UINT read FcbSize write FcbSize;
    property dwMask: DWORD read FdwMask write FdwMask;
    property dwFlags: DWORD read FdwFlags write FdwFlags;
    property cLines: Integer read FcLines write FcLines;
  end;
  
  tagLVTILEINFOWrapper = class(TatRecordWrapper)
  private
    FcbSize: UINT;
    FiItem: Integer;
    FcColumns: UINT;
  public
    constructor Create(ARecord: tagLVTILEINFO);
    function ObjToRec: tagLVTILEINFO;
  published
    property cbSize: UINT read FcbSize write FcbSize;
    property iItem: Integer read FiItem write FiItem;
    property cColumns: UINT read FcColumns write FcColumns;
  end;
  
  tagLVINSERTMARKWrapper = class(TatRecordWrapper)
  private
    FcbSize: UINT;
    FdwFlags: DWORD;
    FiItem: Integer;
    FdwReserved: DWORD;
  public
    constructor Create(ARecord: tagLVINSERTMARK);
    function ObjToRec: tagLVINSERTMARK;
  published
    property cbSize: UINT read FcbSize write FcbSize;
    property dwFlags: DWORD read FdwFlags write FdwFlags;
    property iItem: Integer read FiItem write FiItem;
  ...
  tagLVSETINFOTIPWrapper = class(TatRecordWrapper)
  private
    FcbSize: UINT;
    FdwFlags: DWORD;
    FiItem: Integer;
    FiSubItem: Integer;
  public
    constructor Create(ARecord: tagLVSETINFOTIP);
    function ObjToRec: tagLVSETINFOTIP;
  published
    property cbSize: UINT read FcbSize write FcbSize;
    property dwFlags: DWORD read FdwFlags write FdwFlags;
    property iItem: Integer read FiItem write FiItem;
  ...
  tagLVFOOTERINFOWrapper = class(TatRecordWrapper)
  private
    Fmask: UINT;
    FcchTextMax: Integer;
    FcItems: UINT;
  public
    constructor Create(ARecord: tagLVFOOTERINFO);
    function ObjToRec: tagLVFOOTERINFO;
  published
    property mask: UINT read Fmask write Fmask;
    property cchTextMax: Integer read FcchTextMax write FcchTextMax;
    property cItems: UINT read FcItems write FcItems;
  ...
  tagLVFOOTERITEMWrapper = class(TatRecordWrapper)
  private
    Fmask: UINT;
    FiItem: Integer;
    FcchTextMax: Integer;
    ...
    FstateMask: UINT;
  public
    constructor Create(ARecord: tagLVFOOTERITEM);
    function ObjToRec: tagLVFOOTERITEM;
  published
    property mask: UINT read Fmask write Fmask;
    property iItem: Integer read FiItem write FiItem;
    property cchTextMax: Integer read FcchTextMax write FcchTextMax;
  ...
  tagLVITEMINDEXWrapper = class(TatRecordWrapper)
  private
    FiItem: Integer;
    FiGroup: Integer;
  public
    constructor Create(ARecord: tagLVITEMINDEX);
    function ObjToRec: tagLVITEMINDEX;
  published
    property iItem: Integer read FiItem write FiItem;
    property iGroup: Integer read FiGroup write FiGroup;
  end;
  ...
  published
    ...
    property iSubItem: Integer read FiSubItem write FiSubItem;
    property dwItemType: DWORD read FdwItemType write FdwItemType;
    property clrFace: COLORREF read FclrFace write FclrFace;
    property iIconEffect: Integer read FiIconEffect write FiIconEffect;
    property iIconPhase: Integer read FiIconPhase write FiIconPhase;
    property iPartId: Integer read FiPartId write FiPartId;
  ...
  tagNMLVFINDITEMWWrapper = class(TatRecordWrapper)
  private
    FiStart: Integer;
  public
    constructor Create(ARecord: tagNMLVFINDITEMW);
    function ObjToRec: tagNMLVFINDITEMW;
  published
    property iStart: Integer read FiStart write FiStart;
  end;
  ...
  tagLVDISPINFOAWrapper = class(TatRecordWrapper)
  private
  public
    constructor Create(ARecord: tagLVDISPINFOA);
    function ObjToRec: tagLVDISPINFOA;
  published
  end;
  ...
  tagNMLVLINKWrapper = class(TatRecordWrapper)
  private
    FiItem: Integer;
    FiSubItem: Integer;
  public
    constructor Create(ARecord: tagNMLVLINK);
    function ObjToRec: tagNMLVLINK;
  published
    property iItem: Integer read FiItem write FiItem;
    property iSubItem: Integer read FiSubItem write FiSubItem;
  end;
  ...
  tagNMLVSCROLLWrapper = class(TatRecordWrapper)
  private
    Fdx: Integer;
    Fdy: Integer;
  public
    constructor Create(ARecord: tagNMLVSCROLL);
    function ObjToRec: tagNMLVSCROLL;
  published
    property dx: Integer read Fdx write Fdx;
    property dy: Integer read Fdy write Fdy;
  end;
  
  tagNMLVEMPTYMARKUPWrapper = class(TatRecordWrapper)
  private
    FdwFlags: DWORD;
  public
    constructor Create(ARecord: tagNMLVEMPTYMARKUP);
    function ObjToRec: tagNMLVEMPTYMARKUP;
  published
    property dwFlags: DWORD read FdwFlags write FdwFlags;
  end;
  ...
  tagNMTVSTATEIMAGECHANGINGWrapper = class(TatRecordWrapper)
  private
    FiOldStateImageIndex: Integer;
    FiNewStateImageIndex: Integer;
  public
    constructor Create(ARecord: tagNMTVSTATEIMAGECHANGING);
    function ObjToRec: tagNMTVSTATEIMAGECHANGING;
  published
    property iOldStateImageIndex: Integer read FiOldStateImageIndex write FiOldStateImageIndex;
    property iNewStateImageIndex: Integer read FiNewStateImageIndex write FiNewStateImageIndex;
  end;
  ...
  published
    ...
    property uStateEx: UINT read FuStateEx write FuStateEx;
    property hwnd: HWND read Fhwnd write Fhwnd;
    property iExpandedImage: Integer read FiExpandedImage write FiExpandedImage;
  end;
  ...
  tagTVGETITEMPARTRECTINFOWrapper = class(TatRecordWrapper)
  private
    FpartID: TVITEMPART;
  public
    constructor Create(ARecord: tagTVGETITEMPARTRECTINFO);
    function ObjToRec: tagTVGETITEMPARTRECTINFO;
  published
    property partID: TVITEMPART read FpartID write FpartID;
  end;
  ...
  tagTVDISPINFOEXAWrapper = class(TatRecordWrapper)
  private
  public
    constructor Create(ARecord: tagTVDISPINFOEXA);
    function ObjToRec: tagTVDISPINFOEXA;
  published
  end;
  
  tagTVDISPINFOEXWWrapper = class(TatRecordWrapper)
  private
  public
    constructor Create(ARecord: tagTVDISPINFOEXW);
    function ObjToRec: tagTVDISPINFOEXW;
  published
  end;
  ...
  tagNMTVITEMCHANGEWrapper = class(TatRecordWrapper)
  private
    FuChanged: UINT;
    FuStateNew: UINT;
    FuStateOld: UINT;
    FlParam: LPARAM;
  public
    constructor Create(ARecord: tagNMTVITEMCHANGE);
    function ObjToRec: tagNMTVITEMCHANGE;
  published
    property uChanged: UINT read FuChanged write FuChanged;
    property uStateNew: UINT read FuStateNew write FuStateNew;
    property uStateOld: UINT read FuStateOld write FuStateOld;
    property lParam: LPARAM read FlParam write FlParam;
  end;
  ...
  BUTTON_IMAGELISTWrapper = class(TatRecordWrapper)
  private
    Fhiml: HIMAGELIST;
    FuAlign: UINT;
  public
    constructor Create(ARecord: BUTTON_IMAGELIST);
    function ObjToRec: BUTTON_IMAGELIST;
  published
    property himl: HIMAGELIST read Fhiml write Fhiml;
    property uAlign: UINT read FuAlign write FuAlign;
  end;
  
  tagNMBCHOTITEMWrapper = class(TatRecordWrapper)
  private
    FdwFlags: DWORD;
  public
    constructor Create(ARecord: tagNMBCHOTITEM);
    function ObjToRec: tagNMBCHOTITEM;
  published
    property dwFlags: DWORD read FdwFlags write FdwFlags;
  end;
  
  tagBUTTON_SPLITINFOWrapper = class(TatRecordWrapper)
  private
    Fmask: UINT;
    FhimlGlyph: HIMAGELIST;
    FuSplitStyle: UINT;
  public
    constructor Create(ARecord: tagBUTTON_SPLITINFO);
    function ObjToRec: tagBUTTON_SPLITINFO;
  published
    property mask: UINT read Fmask write Fmask;
    property himlGlyph: HIMAGELIST read FhimlGlyph write FhimlGlyph;
    property uSplitStyle: UINT read FuSplitStyle write FuSplitStyle;
  end;
  
  tagNMBCDROPDOWNWrapper = class(TatRecordWrapper)
  private
  public
    constructor Create(ARecord: tagNMBCDROPDOWN);
    function ObjToRec: tagNMBCDROPDOWN;
  published
  end;
  
  _tagEDITBALLOONTIPWrapper = class(TatRecordWrapper)
  private
    FcbStruct: DWORD;
    FttiIcon: Integer;
  public
    constructor Create(ARecord: _tagEDITBALLOONTIP);
    function ObjToRec: _tagEDITBALLOONTIP;
  published
    property cbStruct: DWORD read FcbStruct write FcbStruct;
    property ttiIcon: Integer read FttiIcon write FttiIcon;
  end;
  
  TASKDIALOG_BUTTONWrapper = class(TatRecordWrapper)
  private
    FnButtonID: Integer;
  public
    constructor Create(ARecord: TASKDIALOG_BUTTON);
    function ObjToRec: TASKDIALOG_BUTTON;
  published
    property nButtonID: Integer read FnButtonID write FnButtonID;
  end;
  
  TASKDIALOGCONFIGWrapper = class(TatRecordWrapper)
  private
    FcbSize: UINT;
    FhwndParent: HWND;
    FhInstance: HINST;
    FdwFlags: DWORD;
    FdwCommonButtons: DWORD;
    FhMainIcon: HICON;
    FcButtons: UINT;
    FnDefaultButton: Integer;
    FcRadioButtons: UINT;
    FnDefaultRadioButton: Integer;
    FhFooterIcon: HICON;
    FlpCallbackData: LONG_PTR;
    FcxWidth: UINT;
  public
    constructor Create(ARecord: TASKDIALOGCONFIG);
    function ObjToRec: TASKDIALOGCONFIG;
  published
    property cbSize: UINT read FcbSize write FcbSize;
    property hwndParent: HWND read FhwndParent write FhwndParent;
    property hInstance: HINST read FhInstance write FhInstance;
    property dwFlags: DWORD read FdwFlags write FdwFlags;
    property dwCommonButtons: DWORD read FdwCommonButtons write FdwCommonButtons;
    property hMainIcon: HICON read FhMainIcon write FhMainIcon;
    property cButtons: UINT read FcButtons write FcButtons;
    property nDefaultButton: Integer read FnDefaultButton write FnDefaultButton;
    property cRadioButtons: UINT read FcRadioButtons write FcRadioButtons;
    property nDefaultRadioButton: Integer read FnDefaultRadioButton write FnDefaultRadioButton;
    property hFooterIcon: HICON read FhFooterIcon write FhFooterIcon;
    property lpCallbackData: LONG_PTR read FlpCallbackData write FlpCallbackData;
    property cxWidth: UINT read FcxWidth write FcxWidth;
  end;
  ...
  TWMNotifyHCWrapper = class(TatRecordWrapper)
  private
    FMsg: Cardinal;
    FIDCtrl: Longint;
    FResult: LRESULT;
  public
    constructor Create(ARecord: TWMNotifyHC);
    function ObjToRec: TWMNotifyHC;
  published
    property Msg: Cardinal read FMsg write FMsg;
    property IDCtrl: Longint read FIDCtrl write FIDCtrl;
    property Result: LRESULT read FResult write FResult;
  end;
  
  TWMNotifyTVWrapper = class(TatRecordWrapper)
  private
    FMsg: Cardinal;
    FIDCtrl: Longint;
    FResult: LRESULT;
  public
    constructor Create(ARecord: TWMNotifyTV);
    function ObjToRec: TWMNotifyTV;
  published
    property Msg: Cardinal read FMsg write FMsg;
    property IDCtrl: Longint read FIDCtrl write FIDCtrl;
    property Result: LRESULT read FResult write FResult;
  ...
  TWMNotifyTRBWrapper = class(TatRecordWrapper)
  private
    FMsg: Cardinal;
    FIDCtrl: Longint;
    FResult: LRESULT;
  public
    constructor Create(ARecord: TWMNotifyTRB);
    function ObjToRec: TWMNotifyTRB;
  published
    property Msg: Cardinal read FMsg write FMsg;
    property IDCtrl: Longint read FIDCtrl write FIDCtrl;
    property Result: LRESULT read FResult write FResult;
  ...
  TWMNotifyUDWrapper = class(TatRecordWrapper)
  private
    FMsg: Cardinal;
    FIDCtrl: Longint;
    FResult: LRESULT;
  public
    constructor Create(ARecord: TWMNotifyUD);
    function ObjToRec: TWMNotifyUD;
  published
    property Msg: Cardinal read FMsg write FMsg;
    property IDCtrl: Longint read FIDCtrl write FIDCtrl;
    property Result: LRESULT read FResult write FResult;
  ...
  TWMNotifyLVWrapper = class(TatRecordWrapper)
  private
    FMsg: Cardinal;
    FIDCtrl: Longint;
    FResult: LRESULT;
  public
    constructor Create(ARecord: TWMNotifyLV);
    function ObjToRec: TWMNotifyLV;
  published
    property Msg: Cardinal read FMsg write FMsg;
    property IDCtrl: Longint read FIDCtrl write FIDCtrl;
    property Result: LRESULT read FResult write FResult;
  ...
  TWMNotifyTLBWrapper = class(TatRecordWrapper)
  private
    FMsg: Cardinal;
    FIDCtrl: Longint;
    FResult: LRESULT;
  public
    constructor Create(ARecord: TWMNotifyTLB);
    function ObjToRec: TWMNotifyTLB;
  published
    property Msg: Cardinal read FMsg write FMsg;
    property IDCtrl: Longint read FIDCtrl write FIDCtrl;
    property Result: LRESULT read FResult write FResult;
  ...
  TWMNotifyMCWrapper = class(TatRecordWrapper)
  private
    FMsg: Cardinal;
    FIDCtrl: Longint;
    FResult: LRESULT;
  public
    constructor Create(ARecord: TWMNotifyMC);
    function ObjToRec: TWMNotifyMC;
  published
    property Msg: Cardinal read FMsg write FMsg;
    property IDCtrl: Longint read FIDCtrl write FIDCtrl;
    property Result: LRESULT read FResult write FResult;
  ...
  TWMNotifyDTWrapper = class(TatRecordWrapper)
  private
    FMsg: Cardinal;
    FIDCtrl: Longint;
    FResult: LRESULT;
  public
    constructor Create(ARecord: TWMNotifyDT);
    function ObjToRec: TWMNotifyDT;
  published
    property Msg: Cardinal read FMsg write FMsg;
    property IDCtrl: Longint read FIDCtrl write FIDCtrl;
    property Result: LRESULT read FResult write FResult;
  ...
  TWMNotifyPSWrapper = class(TatRecordWrapper)
  private
    FMsg: Cardinal;
    FIDCtrl: Longint;
    FResult: LRESULT;
  public
    constructor Create(ARecord: TWMNotifyPS);
    function ObjToRec: TWMNotifyPS;
  published
    property Msg: Cardinal read FMsg write FMsg;
    property IDCtrl: Longint read FIDCtrl write FIDCtrl;
    property Result: LRESULT read FResult write FResult;
  ...
  TTCMAdjustRectWrapper = class(TatRecordWrapper)
  private
    FMsg: Cardinal;
    FLarger: LongBool;
    FResult: LRESULT;
  public
    constructor Create(ARecord: TTCMAdjustRect);
    function ObjToRec: TTCMAdjustRect;
  published
    property Msg: Cardinal read FMsg write FMsg;
    property Larger: LongBool read FLarger write FLarger;
    property Result: LRESULT read FResult write FResult;
  end;
...
constructor tagNMCUSTOMTEXTWrapper.Create(ARecord: tagNMCUSTOMTEXT);
begin
  inherited Create;
  FhDC := ARecord.hDC;
  FnCount := ARecord.nCount;
  FuFormat := ARecord.uFormat;
  FfLink := ARecord.fLink;
end;

function tagNMCUSTOMTEXTWrapper.ObjToRec: tagNMCUSTOMTEXT;
begin
  result.hDC := FhDC;
  result.nCount := FnCount;
  result.uFormat := FuFormat;
  result.fLink := FfLink;
end;
...
constructor TBMETRICSAWrapper.Create(ARecord: TBMETRICSA);
begin
  inherited Create;
  FcbSize := ARecord.cbSize;
  FdwMask := ARecord.dwMask;
  FcxPad := ARecord.cxPad;
  FcyPad := ARecord.cyPad;
  FcxBarPad := ARecord.cxBarPad;
  FcyBarPad := ARecord.cyBarPad;
  FcxButtonSpacing := ARecord.cxButtonSpacing;
  FcyButtonSpacing := ARecord.cyButtonSpacing;
end;

function TBMETRICSAWrapper.ObjToRec: TBMETRICSA;
begin
  result.cbSize := FcbSize;
  result.dwMask := FdwMask;
  result.cxPad := FcxPad;
  result.cyPad := FcyPad;
  result.cxBarPad := FcxBarPad;
  result.cyBarPad := FcyBarPad;
  result.cxButtonSpacing := FcxButtonSpacing;
  result.cyButtonSpacing := FcyButtonSpacing;
end;

constructor TBMETRICSWWrapper.Create(ARecord: TBMETRICSW);
begin
  inherited Create;
  FcbSize := ARecord.cbSize;
  FdwMask := ARecord.dwMask;
...
function TBMETRICSWWrapper.ObjToRec: TBMETRICSW;
begin
  result.cbSize := FcbSize;
  result.dwMask := FdwMask;
  result.cxPad := FcxPad;
...
begin
  ...
  FuChevronState := ARecord.uChevronState;
end;
...
begin
  ...
  result.uChevronState := FuChevronState;
end;
...
constructor tagNMREBARCHEVRONWrapper.Create(ARecord: tagNMREBARCHEVRON);
begin
  inherited Create;
  FuBand := ARecord.uBand;
  FwID := ARecord.wID;
  FlParam := ARecord.lParam;
  FlParamNM := ARecord.lParamNM;
end;

function tagNMREBARCHEVRONWrapper.ObjToRec: tagNMREBARCHEVRON;
begin
  result.uBand := FuBand;
  result.wID := FwID;
  result.lParam := FlParam;
  result.lParamNM := FlParamNM;
end;

constructor tagNMREBARSPLITTERWrapper.Create(ARecord: tagNMREBARSPLITTER);
begin
  inherited Create;
end;

function tagNMREBARSPLITTERWrapper.ObjToRec: tagNMREBARSPLITTER;
begin
end;

constructor tagNMREBARAUTOBREAKWrapper.Create(ARecord: tagNMREBARAUTOBREAK);
begin
  inherited Create;
  FuBand := ARecord.uBand;
  FwID := ARecord.wID;
  FlParam := ARecord.lParam;
  FuMsg := ARecord.uMsg;
  FfStyleCurrent := ARecord.fStyleCurrent;
  FfAutoBreak := ARecord.fAutoBreak;
end;

function tagNMREBARAUTOBREAKWrapper.ObjToRec: tagNMREBARAUTOBREAK;
begin
  result.uBand := FuBand;
  result.wID := FwID;
  result.lParam := FlParam;
  result.uMsg := FuMsg;
  result.fStyleCurrent := FfStyleCurrent;
  result.fAutoBreak := FfAutoBreak;
end;
...
constructor _TTGETTITLEWrapper.Create(ARecord: _TTGETTITLE);
begin
  inherited Create;
  FdwSize := ARecord.dwSize;
  FuTitleBitmap := ARecord.uTitleBitmap;
  Fcch := ARecord.cch;
end;

function _TTGETTITLEWrapper.ObjToRec: _TTGETTITLE;
begin
  result.dwSize := FdwSize;
  result.uTitleBitmap := FuTitleBitmap;
  result.cch := Fcch;
end;
...
constructor tagLITEMWrapper.Create(ARecord: tagLITEM);
begin
  inherited Create;
  Fmask := ARecord.mask;
  FiLink := ARecord.iLink;
  Fstate := ARecord.state;
  FstateMask := ARecord.stateMask;
end;

function tagLITEMWrapper.ObjToRec: tagLITEM;
begin
  result.mask := Fmask;
  result.iLink := FiLink;
  result.state := Fstate;
...
constructor tagLHITTESTINFOWrapper.Create(ARecord: tagLHITTESTINFO);
begin
  inherited Create;
end;

function tagLHITTESTINFOWrapper.ObjToRec: tagLHITTESTINFO;
begin
end;

constructor tagNMLINKWrapper.Create(ARecord: tagNMLINK);
begin
  inherited Create;
end;

function tagNMLINKWrapper.ObjToRec: tagNMLINK;
begin
end;
...
begin
  ...
  FiGroupId := ARecord.iGroupId;
  FcColumns := ARecord.cColumns;
  FiGroup := ARecord.iGroup;
end;
...
begin
  ...
  result.iGroupId := FiGroupId;
  result.cColumns := FcColumns;
  result.iGroup := FiGroup;
end;
...
begin
  ...
  FiImage := ARecord.iImage;
  FiOrder := ARecord.iOrder;
  FcxMin := ARecord.cxMin;
  FcxDefault := ARecord.cxDefault;
  FcxIdeal := ARecord.cxIdeal;
end;
...
constructor tagLVGROUPWrapper.Create(ARecord: tagLVGROUP);
begin
  inherited Create;
  FcbSize := ARecord.cbSize;
  Fmask := ARecord.mask;
  FcchHeader := ARecord.cchHeader;
  FcchFooter := ARecord.cchFooter;
  FiGroupId := ARecord.iGroupId;
  FstateMask := ARecord.stateMask;
  Fstate := ARecord.state;
  FuAlign := ARecord.uAlign;
  FcchSubtitle := ARecord.cchSubtitle;
  FcchTask := ARecord.cchTask;
  FcchDescriptionTop := ARecord.cchDescriptionTop;
  FcchDescriptionBottom := ARecord.cchDescriptionBottom;
  FiTitleImage := ARecord.iTitleImage;
  FiExtendedImage := ARecord.iExtendedImage;
  FiFirstItem := ARecord.iFirstItem;
  FcItems := ARecord.cItems;
  FcchSubsetTitle := ARecord.cchSubsetTitle;
end;

function tagLVGROUPWrapper.ObjToRec: tagLVGROUP;
begin
  result.cbSize := FcbSize;
  result.mask := Fmask;
  result.cchHeader := FcchHeader;
  result.cchFooter := FcchFooter;
  result.iGroupId := FiGroupId;
  result.stateMask := FstateMask;
  result.state := Fstate;
  result.uAlign := FuAlign;
  result.cchSubtitle := FcchSubtitle;
  result.cchTask := FcchTask;
  result.cchDescriptionTop := FcchDescriptionTop;
  result.cchDescriptionBottom := FcchDescriptionBottom;
  result.iTitleImage := FiTitleImage;
  result.iExtendedImage := FiExtendedImage;
  result.iFirstItem := FiFirstItem;
  result.cItems := FcItems;
  result.cchSubsetTitle := FcchSubsetTitle;
end;

constructor tagLVGROUPMETRICSWrapper.Create(ARecord: tagLVGROUPMETRICS);
begin
  inherited Create;
  FcbSize := ARecord.cbSize;
  Fmask := ARecord.mask;
  ...
  FcrLeft := ARecord.crLeft;
  FcrTop := ARecord.crTop;
  FcrRight := ARecord.crRight;
  FcrBottom := ARecord.crBottom;
  FcrHeader := ARecord.crHeader;
  FcrFooter := ARecord.crFooter;
end;

function tagLVGROUPMETRICSWrapper.ObjToRec: tagLVGROUPMETRICS;
begin
  result.cbSize := FcbSize;
  result.mask := Fmask;
  result.Left := FLeft;
  ...
  result.crLeft := FcrLeft;
  result.crTop := FcrTop;
  result.crRight := FcrRight;
  result.crBottom := FcrBottom;
  result.crHeader := FcrHeader;
  result.crFooter := FcrFooter;
end;

constructor tagLVINSERTGROUPSORTEDWrapper.Create(ARecord: tagLVINSERTGROUPSORTED);
begin
  inherited Create;
end;

function tagLVINSERTGROUPSORTEDWrapper.ObjToRec: tagLVINSERTGROUPSORTED;
begin
end;

constructor tagLVTILEVIEWINFOWrapper.Create(ARecord: tagLVTILEVIEWINFO);
begin
  inherited Create;
  FcbSize := ARecord.cbSize;
  FdwMask := ARecord.dwMask;
  FdwFlags := ARecord.dwFlags;
  FcLines := ARecord.cLines;
end;

function tagLVTILEVIEWINFOWrapper.ObjToRec: tagLVTILEVIEWINFO;
begin
  result.cbSize := FcbSize;
  result.dwMask := FdwMask;
  result.dwFlags := FdwFlags;
  result.cLines := FcLines;
end;

constructor tagLVTILEINFOWrapper.Create(ARecord: tagLVTILEINFO);
begin
  inherited Create;
  FcbSize := ARecord.cbSize;
  FiItem := ARecord.iItem;
...
function tagLVTILEINFOWrapper.ObjToRec: tagLVTILEINFO;
begin
  result.cbSize := FcbSize;
  result.iItem := FiItem;
  result.cColumns := FcColumns;
...
constructor tagLVINSERTMARKWrapper.Create(ARecord: tagLVINSERTMARK);
begin
  inherited Create;
  FcbSize := ARecord.cbSize;
  FdwFlags := ARecord.dwFlags;
...
function tagLVINSERTMARKWrapper.ObjToRec: tagLVINSERTMARK;
begin
  result.cbSize := FcbSize;
  result.dwFlags := FdwFlags;
  result.iItem := FiItem;
...
constructor tagLVSETINFOTIPWrapper.Create(ARecord: tagLVSETINFOTIP);
begin
  inherited Create;
  FcbSize := ARecord.cbSize;
  FdwFlags := ARecord.dwFlags;
...
function tagLVSETINFOTIPWrapper.ObjToRec: tagLVSETINFOTIP;
begin
  result.cbSize := FcbSize;
  result.dwFlags := FdwFlags;
  result.iItem := FiItem;
...
constructor tagLVFOOTERINFOWrapper.Create(ARecord: tagLVFOOTERINFO);
begin
  inherited Create;
  Fmask := ARecord.mask;
  FcchTextMax := ARecord.cchTextMax;
...
function tagLVFOOTERINFOWrapper.ObjToRec: tagLVFOOTERINFO;
begin
  result.mask := Fmask;
  result.cchTextMax := FcchTextMax;
  result.cItems := FcItems;
...
constructor tagLVFOOTERITEMWrapper.Create(ARecord: tagLVFOOTERITEM);
begin
  inherited Create;
  Fmask := ARecord.mask;
  FiItem := ARecord.iItem;
...
function tagLVFOOTERITEMWrapper.ObjToRec: tagLVFOOTERITEM;
begin
  result.mask := Fmask;
  result.iItem := FiItem;
  result.cchTextMax := FcchTextMax;
...
constructor tagLVITEMINDEXWrapper.Create(ARecord: tagLVITEMINDEX);
begin
  inherited Create;
  FiItem := ARecord.iItem;
  FiGroup := ARecord.iGroup;
...
function tagLVITEMINDEXWrapper.ObjToRec: tagLVITEMINDEX;
begin
  result.iItem := FiItem;
  result.iGroup := FiGroup;
end;
...
begin
  ...
  FiSubItem := ARecord.iSubItem;
  FdwItemType := ARecord.dwItemType;
  FclrFace := ARecord.clrFace;
  FiIconEffect := ARecord.iIconEffect;
  FiIconPhase := ARecord.iIconPhase;
  FiPartId := ARecord.iPartId;
...
begin
  ...
  result.iSubItem := FiSubItem;
  result.dwItemType := FdwItemType;
  result.clrFace := FclrFace;
  result.iIconEffect := FiIconEffect;
  result.iIconPhase := FiIconPhase;
  result.iPartId := FiPartId;
...
constructor tagNMLVFINDITEMWWrapper.Create(ARecord: tagNMLVFINDITEMW);
begin
  inherited Create;
  FiStart := ARecord.iStart;
end;

function tagNMLVFINDITEMWWrapper.ObjToRec: tagNMLVFINDITEMW;
begin
  result.iStart := FiStart;
end;
...
constructor tagLVDISPINFOAWrapper.Create(ARecord: tagLVDISPINFOA);
begin
  inherited Create;
end;

function tagLVDISPINFOAWrapper.ObjToRec: tagLVDISPINFOA;
begin
end;
...
constructor tagNMLVLINKWrapper.Create(ARecord: tagNMLVLINK);
begin
  inherited Create;
  FiItem := ARecord.iItem;
  FiSubItem := ARecord.iSubItem;
...
function tagNMLVLINKWrapper.ObjToRec: tagNMLVLINK;
begin
  result.iItem := FiItem;
  result.iSubItem := FiSubItem;
end;
...
constructor tagNMLVSCROLLWrapper.Create(ARecord: tagNMLVSCROLL);
begin
  inherited Create;
  Fdx := ARecord.dx;
  Fdy := ARecord.dy;
...
function tagNMLVSCROLLWrapper.ObjToRec: tagNMLVSCROLL;
begin
  result.dx := Fdx;
  result.dy := Fdy;
end;

constructor tagNMLVEMPTYMARKUPWrapper.Create(ARecord: tagNMLVEMPTYMARKUP);
begin
  inherited Create;
  FdwFlags := ARecord.dwFlags;
end;

function tagNMLVEMPTYMARKUPWrapper.ObjToRec: tagNMLVEMPTYMARKUP;
begin
  result.dwFlags := FdwFlags;
end;
...
constructor tagNMTVSTATEIMAGECHANGINGWrapper.Create(ARecord: tagNMTVSTATEIMAGECHANGING);
begin
  inherited Create;
  FiOldStateImageIndex := ARecord.iOldStateImageIndex;
  FiNewStateImageIndex := ARecord.iNewStateImageIndex;
end;

function tagNMTVSTATEIMAGECHANGINGWrapper.ObjToRec: tagNMTVSTATEIMAGECHANGING;
begin
  result.iOldStateImageIndex := FiOldStateImageIndex;
  result.iNewStateImageIndex := FiNewStateImageIndex;
end;
...
begin
  ...
  FuStateEx := ARecord.uStateEx;
  Fhwnd := ARecord.hwnd;
  FiExpandedImage := ARecord.iExpandedImage;
end;
...
begin
  ...
  result.uStateEx := FuStateEx;
  result.hwnd := Fhwnd;
  result.iExpandedImage := FiExpandedImage;
end;
...
constructor tagTVGETITEMPARTRECTINFOWrapper.Create(ARecord: tagTVGETITEMPARTRECTINFO);
begin
  inherited Create;
  FpartID := ARecord.partID;
end;

function tagTVGETITEMPARTRECTINFOWrapper.ObjToRec: tagTVGETITEMPARTRECTINFO;
begin
  result.partID := FpartID;
end;
...
constructor tagTVDISPINFOEXAWrapper.Create(ARecord: tagTVDISPINFOEXA);
begin
  inherited Create;
end;

function tagTVDISPINFOEXAWrapper.ObjToRec: tagTVDISPINFOEXA;
begin
end;

constructor tagTVDISPINFOEXWWrapper.Create(ARecord: tagTVDISPINFOEXW);
begin
  inherited Create;
end;

function tagTVDISPINFOEXWWrapper.ObjToRec: tagTVDISPINFOEXW;
begin
end;
...
constructor tagNMTVITEMCHANGEWrapper.Create(ARecord: tagNMTVITEMCHANGE);
begin
  inherited Create;
  FuChanged := ARecord.uChanged;
  FuStateNew := ARecord.uStateNew;
  FuStateOld := ARecord.uStateOld;
  FlParam := ARecord.lParam;
end;

function tagNMTVITEMCHANGEWrapper.ObjToRec: tagNMTVITEMCHANGE;
begin
  result.uChanged := FuChanged;
  result.uStateNew := FuStateNew;
  result.uStateOld := FuStateOld;
  result.lParam := FlParam;
end;
...
constructor BUTTON_IMAGELISTWrapper.Create(ARecord: BUTTON_IMAGELIST);
begin
  inherited Create;
  Fhiml := ARecord.himl;
  FuAlign := ARecord.uAlign;
...
function BUTTON_IMAGELISTWrapper.ObjToRec: BUTTON_IMAGELIST;
begin
  result.himl := Fhiml;
  result.uAlign := FuAlign;
end;

constructor tagNMBCHOTITEMWrapper.Create(ARecord: tagNMBCHOTITEM);
begin
  inherited Create;
  FdwFlags := ARecord.dwFlags;
end;

function tagNMBCHOTITEMWrapper.ObjToRec: tagNMBCHOTITEM;
begin
  result.dwFlags := FdwFlags;
end;

constructor tagBUTTON_SPLITINFOWrapper.Create(ARecord: tagBUTTON_SPLITINFO);
begin
  inherited Create;
  Fmask := ARecord.mask;
  FhimlGlyph := ARecord.himlGlyph;
  FuSplitStyle := ARecord.uSplitStyle;
end;

function tagBUTTON_SPLITINFOWrapper.ObjToRec: tagBUTTON_SPLITINFO;
begin
  result.mask := Fmask;
  result.himlGlyph := FhimlGlyph;
  result.uSplitStyle := FuSplitStyle;
end;

constructor tagNMBCDROPDOWNWrapper.Create(ARecord: tagNMBCDROPDOWN);
begin
  inherited Create;
end;

function tagNMBCDROPDOWNWrapper.ObjToRec: tagNMBCDROPDOWN;
begin
end;

constructor _tagEDITBALLOONTIPWrapper.Create(ARecord: _tagEDITBALLOONTIP);
begin
  inherited Create;
  FcbStruct := ARecord.cbStruct;
  FttiIcon := ARecord.ttiIcon;
end;

function _tagEDITBALLOONTIPWrapper.ObjToRec: _tagEDITBALLOONTIP;
begin
  result.cbStruct := FcbStruct;
  result.ttiIcon := FttiIcon;
end;

constructor TASKDIALOG_BUTTONWrapper.Create(ARecord: TASKDIALOG_BUTTON);
begin
  inherited Create;
  FnButtonID := ARecord.nButtonID;
end;

function TASKDIALOG_BUTTONWrapper.ObjToRec: TASKDIALOG_BUTTON;
begin
  result.nButtonID := FnButtonID;
end;

constructor TASKDIALOGCONFIGWrapper.Create(ARecord: TASKDIALOGCONFIG);
begin
  inherited Create;
  FcbSize := ARecord.cbSize;
  FhwndParent := ARecord.hwndParent;
  FhInstance := ARecord.hInstance;
  FdwFlags := ARecord.dwFlags;
  FdwCommonButtons := ARecord.dwCommonButtons;
  FhMainIcon := ARecord.hMainIcon;
  FcButtons := ARecord.cButtons;
  FnDefaultButton := ARecord.nDefaultButton;
  FcRadioButtons := ARecord.cRadioButtons;
  FnDefaultRadioButton := ARecord.nDefaultRadioButton;
  FhFooterIcon := ARecord.hFooterIcon;
  FlpCallbackData := ARecord.lpCallbackData;
  FcxWidth := ARecord.cxWidth;
end;

function TASKDIALOGCONFIGWrapper.ObjToRec: TASKDIALOGCONFIG;
begin
  result.cbSize := FcbSize;
  result.hwndParent := FhwndParent;
  result.hInstance := FhInstance;
  result.dwFlags := FdwFlags;
  result.dwCommonButtons := FdwCommonButtons;
  result.hMainIcon := FhMainIcon;
  result.cButtons := FcButtons;
  result.nDefaultButton := FnDefaultButton;
  result.cRadioButtons := FcRadioButtons;
  result.nDefaultRadioButton := FnDefaultRadioButton;
  result.hFooterIcon := FhFooterIcon;
  result.lpCallbackData := FlpCallbackData;
  result.cxWidth := FcxWidth;
end;
...
constructor TWMNotifyHCWrapper.Create(ARecord: TWMNotifyHC);
begin
  inherited Create;
  FMsg := ARecord.Msg;
...
function TWMNotifyHCWrapper.ObjToRec: TWMNotifyHC;
begin
  result.Msg := FMsg;
...
constructor TWMNotifyTVWrapper.Create(ARecord: TWMNotifyTV);
begin
  inherited Create;
  FMsg := ARecord.Msg;
  FIDCtrl := ARecord.IDCtrl;
...
function TWMNotifyTVWrapper.ObjToRec: TWMNotifyTV;
begin
  result.Msg := FMsg;
  result.IDCtrl := FIDCtrl;
  result.Result := FResult;
...
constructor TWMNotifyTRBWrapper.Create(ARecord: TWMNotifyTRB);
begin
  inherited Create;
  FMsg := ARecord.Msg;
  FIDCtrl := ARecord.IDCtrl;
...
function TWMNotifyTRBWrapper.ObjToRec: TWMNotifyTRB;
begin
  result.Msg := FMsg;
  result.IDCtrl := FIDCtrl;
  result.Result := FResult;
...
constructor TWMNotifyUDWrapper.Create(ARecord: TWMNotifyUD);
begin
  inherited Create;
  FMsg := ARecord.Msg;
  FIDCtrl := ARecord.IDCtrl;
...
function TWMNotifyUDWrapper.ObjToRec: TWMNotifyUD;
begin
  result.Msg := FMsg;
  result.IDCtrl := FIDCtrl;
  result.Result := FResult;
...
constructor TWMNotifyLVWrapper.Create(ARecord: TWMNotifyLV);
begin
  inherited Create;
  FMsg := ARecord.Msg;
  FIDCtrl := ARecord.IDCtrl;
...
function TWMNotifyLVWrapper.ObjToRec: TWMNotifyLV;
begin
  result.Msg := FMsg;
  result.IDCtrl := FIDCtrl;
  result.Result := FResult;
...
constructor TWMNotifyTLBWrapper.Create(ARecord: TWMNotifyTLB);
begin
  inherited Create;
  FMsg := ARecord.Msg;
  FIDCtrl := ARecord.IDCtrl;
...
function TWMNotifyTLBWrapper.ObjToRec: TWMNotifyTLB;
begin
  result.Msg := FMsg;
  result.IDCtrl := FIDCtrl;
  result.Result := FResult;
...
constructor TWMNotifyMCWrapper.Create(ARecord: TWMNotifyMC);
begin
  inherited Create;
  FMsg := ARecord.Msg;
  FIDCtrl := ARecord.IDCtrl;
...
function TWMNotifyMCWrapper.ObjToRec: TWMNotifyMC;
begin
  result.Msg := FMsg;
  result.IDCtrl := FIDCtrl;
  result.Result := FResult;
...
constructor TWMNotifyDTWrapper.Create(ARecord: TWMNotifyDT);
begin
  inherited Create;
  FMsg := ARecord.Msg;
  FIDCtrl := ARecord.IDCtrl;
...
function TWMNotifyDTWrapper.ObjToRec: TWMNotifyDT;
begin
  result.Msg := FMsg;
  result.IDCtrl := FIDCtrl;
  result.Result := FResult;
...
constructor TWMNotifyPSWrapper.Create(ARecord: TWMNotifyPS);
begin
  inherited Create;
  FMsg := ARecord.Msg;
  FIDCtrl := ARecord.IDCtrl;
...
function TWMNotifyPSWrapper.ObjToRec: TWMNotifyPS;
begin
  result.Msg := FMsg;
  result.IDCtrl := FIDCtrl;
  result.Result := FResult;
...
constructor TTCMAdjustRectWrapper.Create(ARecord: TTCMAdjustRect);
begin
  inherited Create;
  FMsg := ARecord.Msg;
  FLarger := ARecord.Larger;
  FResult := ARecord.Result;
end;

function TTCMAdjustRectWrapper.ObjToRec: TTCMAdjustRect;
begin
  result.Msg := FMsg;
  result.Larger := FLarger;
  result.Result := FResult;
end;
...
AResult := Integer(CommCtrl.ImageList_LoadImage(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)),VarToInteger(GetInputArg(4)),VarToInteger(GetInputArg(5)),VarToInteger(GetInputArg(6))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.ImageList_LoadImageA(VarToInteger(GetInputArg(0)),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)),VarToInteger(GetInputArg(4)),VarToInteger(GetInputArg(5)),VarToInteger(GetInputArg(6))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(CommCtrl.ImageList_LoadImageW(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)),VarToInteger(GetInputArg(4)),VarToInteger(GetInputArg(5)),VarToInteger(GetInputArg(6))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(CommCtrl.ImageList_LoadBitmap(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)),VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__ImageList_LoadBitmapA(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.ImageList_LoadBitmapA(VarToInteger(GetInputArg(0)),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)),VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__ImageList_LoadBitmapW(AMachine: TatVirtualMachine);
  var
  Param1Buf: array of WideChar;
  AResult: variant;
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(CommCtrl.ImageList_LoadBitmapW(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)),VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.Header_InsertItem(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),_HD_ITEMWWrapper(integer(GetInputArg(2))).ObjToRec));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__Header_InsertItemA(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.Header_InsertItemA(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),_HD_ITEMAWrapper(integer(GetInputArg(2))).ObjToRec));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__Header_InsertItemW(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.Header_InsertItemW(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),_HD_ITEMWWrapper(integer(GetInputArg(2))).ObjToRec));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param2Rec := TObject(integer(GetInputArg(2)));
if not Assigned(Param2Rec) or not (Param2Rec is _HD_ITEMWWrapper) then 
  Param2Rec := _HD_ITEMWWrapper.Create(Param2);
Param2 := _HD_ITEMWWrapper(Param2Rec).ObjToRec;
AResult := CommCtrl.Header_GetItem(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,integer(_HD_ITEMWWrapper.Create(Param2)));
  end;
end;

procedure TatCommCtrlLibrary.__Header_GetItemA(AMachine: TatVirtualMachine);
  var
  Param2Rec: TObject;
  Param2: THDItemA;
  AResult: variant;
...
AResult := CommCtrl.Header_GetItemA(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,integer(_HD_ITEMAWrapper.Create(Param2)));
  end;
end;

procedure TatCommCtrlLibrary.__Header_GetItemW(AMachine: TatVirtualMachine);
  var
  Param2Rec: TObject;
  Param2: THDItemW;
  AResult: variant;
...
if not Assigned(Param2Rec) or not (Param2Rec is _HD_ITEMWWrapper) then 
  Param2Rec := _HD_ITEMWWrapper.Create(Param2);
Param2 := _HD_ITEMWWrapper(Param2Rec).ObjToRec;
AResult := CommCtrl.Header_GetItemW(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,integer(_HD_ITEMWWrapper.Create(Param2)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := CommCtrl.Header_SetItem(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),_HD_ITEMWWrapper(integer(GetInputArg(2))).ObjToRec);
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__Header_SetItemA(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := CommCtrl.Header_SetItemA(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),_HD_ITEMAWrapper(integer(GetInputArg(2))).ObjToRec);
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__Header_SetItemW(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := CommCtrl.Header_SetItemW(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),_HD_ITEMWWrapper(integer(GetInputArg(2))).ObjToRec);
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatCommCtrlLibrary.__Header_SetBitmapMargin(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.Header_SetBitmapMargin(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__Header_GetBitmapMargin(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.Header_GetBitmapMargin(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__Header_SetFilterChangeTimeout(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.Header_SetFilterChangeTimeout(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__Header_EditFilter(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.Header_EditFilter(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__Header_ClearFilter(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.Header_ClearFilter(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__Header_ClearAllFilters(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.Header_ClearAllFilters(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__Header_GetItemDropDownRect(AMachine: TatVirtualMachine);
  var
  Param2Rec: TObject;
  Param2: TRect;
  AResult: variant;
...
AResult := CommCtrl.Header_GetItemDropDownRect(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,integer(TRectWrapper.Create(Param2)));
  end;
end;

procedure TatCommCtrlLibrary.__Header_GetOverflowRect(AMachine: TatVirtualMachine);
  var
  Param1Rec: TObject;
  Param1: TRect;
  AResult: variant;
...
AResult := CommCtrl.Header_GetOverflowRect(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(TRectWrapper.Create(Param1)));
  end;
end;

procedure TatCommCtrlLibrary.__Header_GetFocusedItem(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.Header_GetFocusedItem(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__Header_SetFocusedItem(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := CommCtrl.Header_SetFocusedItem(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(CommCtrl.CreateStatusWindow(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.CreateStatusWindowA(VarToInteger(GetInputArg(0)),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(CommCtrl.CreateStatusWindowW(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := CommCtrl.ListView_SetUnicodeFormat(VarToInteger(GetInputArg(0)),GetInputArg(1));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := CommCtrl.ListView_SetItem(VarToInteger(GetInputArg(0)),tagLVITEMWWrapper(integer(GetInputArg(1))).ObjToRec);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.ListView_InsertItem(VarToInteger(GetInputArg(0)),tagLVITEMWWrapper(integer(GetInputArg(1))).ObjToRec));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.ListView_FindItem(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),tagLVFINDINFOWWrapper(integer(GetInputArg(2))).ObjToRec));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(CommCtrl.ListView_GetStringWidth(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.ListView_GetStringWidthA(VarToInteger(GetInputArg(0)),PAnsiChar(AnsiString(VarToStr(GetInputArg(1))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(CommCtrl.ListView_GetStringWidthW(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := CommCtrl.ListView_SetColumn(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),tagLVCOLUMNWWrapper(integer(GetInputArg(2))).ObjToRec);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.ListView_InsertColumn(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),tagLVCOLUMNWWrapper(integer(GetInputArg(2))).ObjToRec));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := Integer(CommCtrl.ListView_GetItemText(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),StringToWideChar(VarToStr(GetInputArg(3)),@Param3Buf[0],Length(Param3Buf)),VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.ListView_GetItemTextA(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),PAnsiChar(AnsiString(VarToStr(GetInputArg(3)))),VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param3Buf, Length(VarToStr(GetInputArg(3))) + 1);
AResult := Integer(CommCtrl.ListView_GetItemTextW(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),StringToWideChar(VarToStr(GetInputArg(3)),@Param3Buf[0],Length(Param3Buf)),VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param3Buf, Length(VarToStr(GetInputArg(3))) + 1);
AResult := CommCtrl.ListView_SetItemText(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),StringToWideChar(VarToStr(GetInputArg(3)),@Param3Buf[0],Length(Param3Buf)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := CommCtrl.ListView_SetItemTextA(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),PAnsiChar(AnsiString(VarToStr(GetInputArg(3)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param3Buf, Length(VarToStr(GetInputArg(3))) + 1);
AResult := CommCtrl.ListView_SetItemTextW(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),StringToWideChar(VarToStr(GetInputArg(3)),@Param3Buf[0],Length(Param3Buf)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := CommCtrl.ListView_GetISearchString(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := CommCtrl.ListView_GetISearchStringA(VarToInteger(GetInputArg(0)),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := CommCtrl.ListView_GetISearchStringW(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatCommCtrlLibrary.__ListView_SetSelectedColumn(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.ListView_SetSelectedColumn(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__ListView_SetView(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.ListView_SetView(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__ListView_GetView(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.ListView_GetView(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__ListView_InsertGroup(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.ListView_InsertGroup(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),tagLVGROUPWrapper(integer(GetInputArg(2))).ObjToRec));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__ListView_SetGroupInfo(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.ListView_SetGroupInfo(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),tagLVGROUPWrapper(integer(GetInputArg(2))).ObjToRec));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__ListView_GetGroupInfo(AMachine: TatVirtualMachine);
  var
  Param2Rec: TObject;
  Param2: TLVGroup;
  AResult: variant;
begin
  ...
  begin
Param2Rec := TObject(integer(GetInputArg(2)));
if not Assigned(Param2Rec) or not (Param2Rec is tagLVGROUPWrapper) then 
  Param2Rec := tagLVGROUPWrapper.Create(Param2);
Param2 := tagLVGROUPWrapper(Param2Rec).ObjToRec;
AResult := Integer(CommCtrl.ListView_GetGroupInfo(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),Param2));
    ReturnOutputArg(AResult);
    SetInputArg(2,integer(tagLVGROUPWrapper.Create(Param2)));
  end;
end;

procedure TatCommCtrlLibrary.__ListView_RemoveGroup(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.ListView_RemoveGroup(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__ListView_MoveGroup(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.ListView_MoveGroup(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__ListView_GetGroupCount(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.ListView_GetGroupCount(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__ListView_GetGroupInfoByIndex(AMachine: TatVirtualMachine);
  var
  Param2Rec: TObject;
  Param2: TLVGroup;
  AResult: variant;
...
if not Assigned(Param2Rec) or not (Param2Rec is tagLVGROUPWrapper) then 
  Param2Rec := tagLVGROUPWrapper.Create(Param2);
Param2 := tagLVGROUPWrapper(Param2Rec).ObjToRec;
AResult := Integer(CommCtrl.ListView_GetGroupInfoByIndex(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),Param2));
    ReturnOutputArg(AResult);
    SetInputArg(2,integer(tagLVGROUPWrapper.Create(Param2)));
  end;
end;

procedure TatCommCtrlLibrary.__ListView_MoveItemToGroup(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.ListView_MoveItemToGroup(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__ListView_GetGroupRect(AMachine: TatVirtualMachine);
  var
  Param3Rec: TObject;
  Param3: TRect;
  AResult: variant;
...
AResult := Integer(CommCtrl.ListView_GetGroupRect(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),Param3));
    ReturnOutputArg(AResult);
    SetInputArg(3,integer(TRectWrapper.Create(Param3)));
  end;
end;

procedure TatCommCtrlLibrary.__ListView_SetGroupMetrics(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.ListView_SetGroupMetrics(VarToInteger(GetInputArg(0)),tagLVGROUPMETRICSWrapper(integer(GetInputArg(1))).ObjToRec));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__ListView_GetGroupMetrics(AMachine: TatVirtualMachine);
  var
  Param1Rec: TObject;
  Param1: TLVGroupMetrics;
  AResult: variant;
begin
  with AMachine do
  begin
Param1Rec := TObject(integer(GetInputArg(1)));
if not Assigned(Param1Rec) or not (Param1Rec is tagLVGROUPMETRICSWrapper) then 
  Param1Rec := tagLVGROUPMETRICSWrapper.Create(Param1);
Param1 := tagLVGROUPMETRICSWrapper(Param1Rec).ObjToRec;
AResult := Integer(CommCtrl.ListView_GetGroupMetrics(VarToInteger(GetInputArg(0)),Param1));
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(tagLVGROUPMETRICSWrapper.Create(Param1)));
  end;
end;

procedure TatCommCtrlLibrary.__ListView_EnableGroupView(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.ListView_EnableGroupView(VarToInteger(GetInputArg(0)),GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__ListView_InsertGroupSorted(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.ListView_InsertGroupSorted(VarToInteger(GetInputArg(0)),tagLVINSERTGROUPSORTEDWrapper(integer(GetInputArg(1))).ObjToRec));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__ListView_RemoveAllGroups(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.ListView_RemoveAllGroups(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__ListView_HasGroup(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.ListView_HasGroup(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__ListView_SetGroupState(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.ListView_SetGroupState(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__ListView_GetGroupState(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.ListView_GetGroupState(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__ListView_GetFocusedGroup(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.ListView_GetFocusedGroup(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__ListView_SetTileViewInfo(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.ListView_SetTileViewInfo(VarToInteger(GetInputArg(0)),tagLVTILEVIEWINFOWrapper(integer(GetInputArg(1))).ObjToRec));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__ListView_GetTileViewInfo(AMachine: TatVirtualMachine);
  var
  Param1Rec: TObject;
  Param1: TLVTileViewInfo;
  AResult: variant;
begin
  with AMachine do
  begin
Param1Rec := TObject(integer(GetInputArg(1)));
if not Assigned(Param1Rec) or not (Param1Rec is tagLVTILEVIEWINFOWrapper) then 
  Param1Rec := tagLVTILEVIEWINFOWrapper.Create(Param1);
Param1 := tagLVTILEVIEWINFOWrapper(Param1Rec).ObjToRec;
AResult := Integer(CommCtrl.ListView_GetTileViewInfo(VarToInteger(GetInputArg(0)),Param1));
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(tagLVTILEVIEWINFOWrapper.Create(Param1)));
  end;
end;

procedure TatCommCtrlLibrary.__ListView_SetTileInfo(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.ListView_SetTileInfo(VarToInteger(GetInputArg(0)),tagLVTILEINFOWrapper(integer(GetInputArg(1))).ObjToRec));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__ListView_GetTileInfo(AMachine: TatVirtualMachine);
  var
  Param1Rec: TObject;
  Param1: TLVTileInfo;
  AResult: variant;
begin
  ...
  begin
Param1Rec := TObject(integer(GetInputArg(1)));
if not Assigned(Param1Rec) or not (Param1Rec is tagLVTILEINFOWrapper) then 
  Param1Rec := tagLVTILEINFOWrapper.Create(Param1);
Param1 := tagLVTILEINFOWrapper(Param1Rec).ObjToRec;
AResult := Integer(CommCtrl.ListView_GetTileInfo(VarToInteger(GetInputArg(0)),Param1));
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(tagLVTILEINFOWrapper.Create(Param1)));
  end;
end;

procedure TatCommCtrlLibrary.__ListView_SetInsertMark(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := CommCtrl.ListView_SetInsertMark(VarToInteger(GetInputArg(0)),tagLVINSERTMARKWrapper(integer(GetInputArg(1))).ObjToRec);
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__ListView_GetInsertMark(AMachine: TatVirtualMachine);
  var
  Param1Rec: TObject;
  Param1: TLVInsertMark;
  AResult: variant;
begin
  with AMachine do
  begin
Param1Rec := TObject(integer(GetInputArg(1)));
if not Assigned(Param1Rec) or not (Param1Rec is tagLVINSERTMARKWrapper) then 
  Param1Rec := tagLVINSERTMARKWrapper.Create(Param1);
Param1 := tagLVINSERTMARKWrapper(Param1Rec).ObjToRec;
AResult := CommCtrl.ListView_GetInsertMark(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(tagLVINSERTMARKWrapper.Create(Param1)));
  end;
end;

procedure TatCommCtrlLibrary.__ListView_InsertMarkHitTest(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.ListView_InsertMarkHitTest(VarToInteger(GetInputArg(0)),TPointWrapper(integer(GetInputArg(1))).ObjToRec,tagLVINSERTMARKWrapper(integer(GetInputArg(2))).ObjToRec));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__ListView_GetInsertMarkRect(AMachine: TatVirtualMachine);
  var
  Param1Rec: TObject;
  Param1: TRect;
  AResult: variant;
...
if not Assigned(Param1Rec) or not (Param1Rec is TRectWrapper) then 
  Param1Rec := TRectWrapper.Create(Param1);
Param1 := TRectWrapper(Param1Rec).ObjToRec;
AResult := Integer(CommCtrl.ListView_GetInsertMarkRect(VarToInteger(GetInputArg(0)),Param1));
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(TRectWrapper.Create(Param1)));
  end;
end;

procedure TatCommCtrlLibrary.__ListView_SetInsertMarkColor(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.ListView_SetInsertMarkColor(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__ListView_GetInsertMarkColor(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.ListView_GetInsertMarkColor(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__ListView_SetInfoTip(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := CommCtrl.ListView_SetInfoTip(VarToInteger(GetInputArg(0)),tagLVSETINFOTIPWrapper(integer(GetInputArg(1))).ObjToRec);
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__ListView_GetSelectedColumn(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.ListView_GetSelectedColumn(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__ListView_IsGroupViewEnabled(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := CommCtrl.ListView_IsGroupViewEnabled(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__ListView_GetOutlineColor(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.ListView_GetOutlineColor(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__ListView_SetOutlineColor(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.ListView_SetOutlineColor(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__ListView_CancelEditLabel(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.ListView_CancelEditLabel(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__ListView_MapIndexToID(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.ListView_MapIndexToID(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__ListView_MapIDToIndex(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.ListView_MapIDToIndex(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__ListView_IsItemVisible(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.ListView_IsItemVisible(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__ListView_SetGroupHeaderImageList(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.ListView_SetGroupHeaderImageList(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__ListView_GetGroupHeaderImageList(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.ListView_GetGroupHeaderImageList(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__ListView_GetEmptyText(AMachine: TatVirtualMachine);
  var
  Param1Buf: array of WideChar;
  AResult: variant;
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := CommCtrl.ListView_GetEmptyText(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__ListView_GetFooterRect(AMachine: TatVirtualMachine);
  var
  Param1Rec: TObject;
  Param1: TRect;
  AResult: variant;
...
if not Assigned(Param1Rec) or not (Param1Rec is TRectWrapper) then 
  Param1Rec := TRectWrapper.Create(Param1);
Param1 := TRectWrapper(Param1Rec).ObjToRec;
AResult := CommCtrl.ListView_GetFooterRect(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(TRectWrapper.Create(Param1)));
  end;
end;

procedure TatCommCtrlLibrary.__ListView_GetFooterInfo(AMachine: TatVirtualMachine);
  var
  Param1Rec: TObject;
  Param1: TLVFooterInfo;
  AResult: variant;
begin
  with AMachine do
  begin
Param1Rec := TObject(integer(GetInputArg(1)));
if not Assigned(Param1Rec) or not (Param1Rec is tagLVFOOTERINFOWrapper) then 
  Param1Rec := tagLVFOOTERINFOWrapper.Create(Param1);
Param1 := tagLVFOOTERINFOWrapper(Param1Rec).ObjToRec;
AResult := CommCtrl.ListView_GetFooterInfo(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(tagLVFOOTERINFOWrapper.Create(Param1)));
  end;
end;

procedure TatCommCtrlLibrary.__ListView_GetFooterItemRect(AMachine: TatVirtualMachine);
  var
  Param2Rec: TObject;
  Param2: TRect;
  AResult: variant;
...
if not Assigned(Param2Rec) or not (Param2Rec is TRectWrapper) then 
  Param2Rec := TRectWrapper.Create(Param2);
Param2 := TRectWrapper(Param2Rec).ObjToRec;
AResult := CommCtrl.ListView_GetFooterItemRect(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,integer(TRectWrapper.Create(Param2)));
  end;
end;

procedure TatCommCtrlLibrary.__ListView_GetFooterItem(AMachine: TatVirtualMachine);
  var
  Param2Rec: TObject;
  Param2: TLVFooterItem;
  AResult: variant;
begin
  with AMachine do
  begin
Param2Rec := TObject(integer(GetInputArg(2)));
if not Assigned(Param2Rec) or not (Param2Rec is tagLVFOOTERITEMWrapper) then 
  Param2Rec := tagLVFOOTERITEMWrapper.Create(Param2);
Param2 := tagLVFOOTERITEMWrapper(Param2Rec).ObjToRec;
AResult := CommCtrl.ListView_GetFooterItem(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,integer(tagLVFOOTERITEMWrapper.Create(Param2)));
  end;
end;

procedure TatCommCtrlLibrary.__ListView_GetItemIndexRect(AMachine: TatVirtualMachine);
  var
  Param4Rec: TObject;
  Param4: TRect;
  AResult: variant;
...
AResult := CommCtrl.ListView_GetItemIndexRect(VarToInteger(GetInputArg(0)),tagLVITEMINDEXWrapper(integer(GetInputArg(1))).ObjToRec,VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)),Param4);
    ReturnOutputArg(AResult);
    SetInputArg(4,integer(TRectWrapper.Create(Param4)));
  end;
end;

procedure TatCommCtrlLibrary.__ListView_SetItemIndexState(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.ListView_SetItemIndexState(VarToInteger(GetInputArg(0)),tagLVITEMINDEXWrapper(integer(GetInputArg(1))).ObjToRec,VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__ListView_GetNextItemIndex(AMachine: TatVirtualMachine);
  var
  Param1Rec: TObject;
  Param1: TLVItemIndex;
  AResult: variant;
begin
  ...
  begin
Param1Rec := TObject(integer(GetInputArg(1)));
if not Assigned(Param1Rec) or not (Param1Rec is tagLVITEMINDEXWrapper) then 
  Param1Rec := tagLVITEMINDEXWrapper.Create(Param1);
Param1 := tagLVITEMINDEXWrapper(Param1Rec).ObjToRec;
AResult := CommCtrl.ListView_GetNextItemIndex(VarToInteger(GetInputArg(0)),Param1,VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(tagLVITEMINDEXWrapper.Create(Param1)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := CommCtrl.TreeView_SetItem(VarToInteger(GetInputArg(0)),tagTVITEMWWrapper(integer(GetInputArg(1))).ObjToRec);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := CommCtrl.TreeView_GetISearchString(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := CommCtrl.TreeView_GetISearchStringA(VarToInteger(GetInputArg(0)),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := CommCtrl.TreeView_GetISearchStringW(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatCommCtrlLibrary.__TreeView_SetLineColor(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.TreeView_SetLineColor(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__TreeView_GetLineColor(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.TreeView_GetLineColor(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__TreeView_SetExtendedStyle(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.TreeView_SetExtendedStyle(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__TreeView_GetExtendedStyle(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.TreeView_GetExtendedStyle(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__TreeView_SetAutoScrollInfo(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.TreeView_SetAutoScrollInfo(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__TreeView_GetSelectedCount(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.TreeView_GetSelectedCount(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__TabCtrl_HitTest(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.TabCtrl_HitTest(VarToInteger(GetInputArg(0)),tagTCHITTESTINFOWrapper(integer(GetInputArg(1))).ObjToRec));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := CommCtrl.DateTime_SetFormat(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := CommCtrl.DateTime_SetFormatA(VarToInteger(GetInputArg(0)),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := CommCtrl.DateTime_SetFormatW(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatCommCtrlLibrary.__Button_GetIdealSize(AMachine: TatVirtualMachine);
  var
  Param1Rec: TObject;
  Param1: TSize;
  AResult: variant;
begin
  ...
  begin
Param1Rec := TObject(integer(GetInputArg(1)));
if not Assigned(Param1Rec) or not (Param1Rec is tagSIZEWrapper) then 
  Param1Rec := tagSIZEWrapper.Create(Param1);
Param1 := tagSIZEWrapper(Param1Rec).ObjToRec;
AResult := CommCtrl.Button_GetIdealSize(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(tagSIZEWrapper.Create(Param1)));
  end;
end;

procedure TatCommCtrlLibrary.__Button_SetImageList(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := CommCtrl.Button_SetImageList(VarToInteger(GetInputArg(0)),BUTTON_IMAGELISTWrapper(integer(GetInputArg(1))).ObjToRec);
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__Button_GetImageList(AMachine: TatVirtualMachine);
  var
  Param1Rec: TObject;
  Param1: TButtonImageList;
  AResult: variant;
begin
  with AMachine do
  begin
Param1Rec := TObject(integer(GetInputArg(1)));
if not Assigned(Param1Rec) or not (Param1Rec is BUTTON_IMAGELISTWrapper) then 
  Param1Rec := BUTTON_IMAGELISTWrapper.Create(Param1);
Param1 := BUTTON_IMAGELISTWrapper(Param1Rec).ObjToRec;
AResult := CommCtrl.Button_GetImageList(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(BUTTON_IMAGELISTWrapper.Create(Param1)));
  end;
end;

procedure TatCommCtrlLibrary.__Button_SetTextMargin(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := CommCtrl.Button_SetTextMargin(VarToInteger(GetInputArg(0)),TRectWrapper(integer(GetInputArg(1))).ObjToRec);
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__Button_GetTextMargin(AMachine: TatVirtualMachine);
  var
  Param1Rec: TObject;
  Param1: TRect;
  AResult: variant;
...
if not Assigned(Param1Rec) or not (Param1Rec is TRectWrapper) then 
  Param1Rec := TRectWrapper.Create(Param1);
Param1 := TRectWrapper(Param1Rec).ObjToRec;
AResult := CommCtrl.Button_GetTextMargin(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(TRectWrapper.Create(Param1)));
  end;
end;

procedure TatCommCtrlLibrary.__Button_SetDropDownState(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := CommCtrl.Button_SetDropDownState(VarToInteger(GetInputArg(0)),GetInputArg(1));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__Button_SetSplitInfo(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := CommCtrl.Button_SetSplitInfo(VarToInteger(GetInputArg(0)),tagBUTTON_SPLITINFOWrapper(integer(GetInputArg(1))).ObjToRec);
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__Button_GetSplitInfo(AMachine: TatVirtualMachine);
  var
  Param1Rec: TObject;
  Param1: TButtonSplitinfo;
  AResult: variant;
begin
  with AMachine do
  begin
Param1Rec := TObject(integer(GetInputArg(1)));
if not Assigned(Param1Rec) or not (Param1Rec is tagBUTTON_SPLITINFOWrapper) then 
  Param1Rec := tagBUTTON_SPLITINFOWrapper.Create(Param1);
Param1 := tagBUTTON_SPLITINFOWrapper(Param1Rec).ObjToRec;
AResult := CommCtrl.Button_GetSplitInfo(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(tagBUTTON_SPLITINFOWrapper.Create(Param1)));
  end;
end;

procedure TatCommCtrlLibrary.__Button_SetNote(AMachine: TatVirtualMachine);
  var
  Param1Buf: array of WideChar;
  AResult: variant;
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := CommCtrl.Button_SetNote(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__Button_GetNote(AMachine: TatVirtualMachine);
  var
  Param1Buf: array of WideChar;
  Param2: Integer;
  AResult: variant;
...
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
Param2 := VarToInteger(GetInputArg(2));
AResult := CommCtrl.Button_GetNote(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
  end;
end;

procedure TatCommCtrlLibrary.__Button_GetNoteLength(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.Button_GetNoteLength(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__Button_SetElevationRequiredState(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.Button_SetElevationRequiredState(VarToInteger(GetInputArg(0)),GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__Edit_SetCueBannerText(AMachine: TatVirtualMachine);
  var
  Param1Buf: array of WideChar;
  AResult: variant;
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := CommCtrl.Edit_SetCueBannerText(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__Edit_GetCueBannerText(AMachine: TatVirtualMachine);
  var
  Param1Buf: array of WideChar;
  AResult: variant;
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := CommCtrl.Edit_GetCueBannerText(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__Edit_ShowBalloonTip(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := CommCtrl.Edit_ShowBalloonTip(VarToInteger(GetInputArg(0)),_tagEDITBALLOONTIPWrapper(integer(GetInputArg(1))).ObjToRec);
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__Edit_HideBalloonTip(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := CommCtrl.Edit_HideBalloonTip(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__Edit_SetHilite(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    CommCtrl.Edit_SetHilite(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)));
  end;
end;

procedure TatCommCtrlLibrary.__Edit_GetHilite(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.Edit_GetHilite(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__ComboBox_SetMinVisible(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := CommCtrl.ComboBox_SetMinVisible(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__ComboBox_GetMinVisible(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.ComboBox_GetMinVisible(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__ComboBox_SetCueBannerText(AMachine: TatVirtualMachine);
  var
  Param1Buf: array of WideChar;
  AResult: variant;
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := CommCtrl.ComboBox_SetCueBannerText(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__ComboBox_GetCueBannerText(AMachine: TatVirtualMachine);
  var
  Param1Buf: array of WideChar;
  AResult: variant;
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := CommCtrl.ComboBox_GetCueBannerText(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatCommCtrlLibrary.__DefSubclassProc(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.DefSubclassProc(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatCommCtrlLibrary.__LoadIconMetric(AMachine: TatVirtualMachine);
  var
  Param1Buf: array of WideChar;
  Param3: HICON;
  AResult: variant;
...
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
Param3 := VarToInteger(GetInputArg(3));
AResult := Integer(CommCtrl.LoadIconMetric(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2)),Param3));
    ReturnOutputArg(AResult);
    SetInputArg(3,Integer(Param3));
  end;
end;

procedure TatCommCtrlLibrary.__LoadIconWithScaleDown(AMachine: TatVirtualMachine);
  var
  Param1Buf: array of WideChar;
  Param4: HICON;
  AResult: variant;
...
AResult := Integer(CommCtrl.LoadIconWithScaleDown(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)),Param4));
    ReturnOutputArg(AResult);
    SetInputArg(4,Integer(Param4));
  end;
end;

procedure TatCommCtrlLibrary.__DrawShadowText(AMachine: TatVirtualMachine);
  var
  Param1Buf: array of WideChar;
  AResult: variant;
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(CommCtrl.DrawShadowText(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2)),TRectWrapper(integer(GetInputArg(3))).ObjToRec,VarToInteger(GetInputArg(4)),VarToInteger(GetInputArg(5)),VarToInteger(GetInputArg(6)),VarToInteger(GetInputArg(7)),VarToInteger(GetInputArg(8))));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatCommCtrlLibrary.Init;
  ...
  begin
    ...
    begin
      ...
      AddConstant('ICC_STANDARD_CLASSES',ICC_STANDARD_CLASSES);
      AddConstant('ICC_LINK_CLASS',ICC_LINK_CLASS);
      ...
      AddConstant('ECM_FIRST',ECM_FIRST);
      AddConstant('BCM_FIRST',BCM_FIRST);
      AddConstant('CBM_FIRST',CBM_FIRST);
      AddConstant('CCM_FIRST',CCM_FIRST);
      AddConstant('CCM_LAST',CCM_LAST);
      ...
      AddConstant('CCM_SETVERSION',CCM_SETVERSION);
      AddConstant('CCM_GETVERSION',CCM_GETVERSION);
      AddConstant('CCM_SETNOTIFYWINDOW',CCM_SETNOTIFYWINDOW);
      AddConstant('CCM_SETWINDOWTHEME',CCM_SETWINDOWTHEME);
      AddConstant('CCM_DPISCALE',CCM_DPISCALE);
      ...
      AddConstant('WMN_FIRST',WMN_FIRST);
      AddConstant('WMN_LAST',WMN_LAST);
      AddConstant('BCN_FIRST',BCN_FIRST);
      AddConstant('BCN_LAST',BCN_LAST);
      AddConstant('TRBN_FIRST',TRBN_FIRST);
      AddConstant('TRBN_LAST',TRBN_LAST);
      ...
      AddConstant('NM_TOOLTIPSCREATED',NM_TOOLTIPSCREATED);
      AddConstant('NM_LDOWN',NM_LDOWN);
      AddConstant('NM_RDOWN',NM_RDOWN);
      AddConstant('NM_THEMECHANGED',NM_THEMECHANGED);
      AddConstant('NM_FONTCHANGED',NM_FONTCHANGED);
      AddConstant('NM_CUSTOMTEXT',NM_CUSTOMTEXT);
      AddConstant('NM_TVSTATEIMAGECHANGING',NM_TVSTATEIMAGECHANGING);
      ...
      AddConstant('CDIS_SHOWKEYBOARDCUES',CDIS_SHOWKEYBOARDCUES);
      AddConstant('CDIS_NEARHOT',CDIS_NEARHOT);
      AddConstant('CDIS_OTHERSIDEHOT',CDIS_OTHERSIDEHOT);
      AddConstant('CDIS_DROPHILITED',CDIS_DROPHILITED);
      ...
      AddConstant('ILC_MIRROR',ILC_MIRROR);
      AddConstant('ILC_PERITEMMIRROR',ILC_PERITEMMIRROR);
      AddConstant('ILC_ORIGINALSIZE',ILC_ORIGINALSIZE);
      AddConstant('ILC_HIGHQUALITYSCALE',ILC_HIGHQUALITYSCALE);
      ...
      AddConstant('ILD_PRESERVEALPHA',ILD_PRESERVEALPHA);
      AddConstant('ILD_SCALE',ILD_SCALE);
      AddConstant('ILD_DPISCALE',ILD_DPISCALE);
      AddConstant('ILD_ASYNC',ILD_ASYNC);
      ...
      AddConstant('ILS_NORMAL',ILS_NORMAL);
      AddConstant('ILS_GLOW',ILS_GLOW);
      AddConstant('ILS_SHADOW',ILS_SHADOW);
      AddConstant('ILS_SATURATE',ILS_SATURATE);
      AddConstant('ILS_ALPHA',ILS_ALPHA);
      AddConstant('ILGT_NORMAL',ILGT_NORMAL);
      AddConstant('ILGT_ASYNC',ILGT_ASYNC);
      AddConstant('HBITMAP_CALLBACK',HBITMAP_CALLBACK);
      AddConstant('ILCF_MOVE',ILCF_MOVE);
      AddConstant('ILCF_SWAP',ILCF_SWAP);
      AddConstant('ILP_NORMAL',ILP_NORMAL);
      AddConstant('ILP_DOWNLEVEL',ILP_DOWNLEVEL);
      ...
      AddConstant('HDS_FILTERBAR',HDS_FILTERBAR);
      AddConstant('HDS_FLAT',HDS_FLAT);
      AddConstant('HDS_CHECKBOXES',HDS_CHECKBOXES);
      AddConstant('HDS_NOSIZING',HDS_NOSIZING);
      AddConstant('HDS_OVERFLOW',HDS_OVERFLOW);
  ...
  begin
    ...
    begin
      ...
      AddConstant('HDI_FILTER',HDI_FILTER);
      AddConstant('HDI_STATE',HDI_STATE);
      ...
      AddConstant('HDF_SORTUP',HDF_SORTUP);
      AddConstant('HDF_SORTDOWN',HDF_SORTDOWN);
      AddConstant('HDF_CHECKBOX',HDF_CHECKBOX);
      AddConstant('HDF_CHECKED',HDF_CHECKED);
      AddConstant('HDF_FIXEDWIDTH',HDF_FIXEDWIDTH);
      AddConstant('HDF_SPLITBUTTON',HDF_SPLITBUTTON);
      AddConstant('HDIS_FOCUSED',HDIS_FOCUSED);
      ...
      AddConstant('HHT_ONITEMSTATEICON',HHT_ONITEMSTATEICON);
      AddConstant('HHT_ONDROPDOWN',HHT_ONDROPDOWN);
      AddConstant('HHT_ONOVERFLOW',HHT_ONOVERFLOW);
      AddConstant('HDSIL_NORMAL',HDSIL_NORMAL);
      AddConstant('HDSIL_STATE',HDSIL_STATE);
      ...
      AddConstant('HDM_SETBITMAPMARGIN',HDM_SETBITMAPMARGIN);
      AddConstant('HDM_GETBITMAPMARGIN',HDM_GETBITMAPMARGIN);
      AddConstant('HDM_SETFILTERCHANGETIMEOUT',HDM_SETFILTERCHANGETIMEOUT);
      AddConstant('HDM_EDITFILTER',HDM_EDITFILTER);
      AddConstant('HDM_CLEARFILTER',HDM_CLEARFILTER);
      AddConstant('HDM_GETITEMDROPDOWNRECT',HDM_GETITEMDROPDOWNRECT);
      AddConstant('HDM_GETOVERFLOWRECT',HDM_GETOVERFLOWRECT);
      AddConstant('HDM_GETFOCUSEDITEM',HDM_GETFOCUSEDITEM);
      AddConstant('HDM_SETFOCUSEDITEM',HDM_SETFOCUSEDITEM);
      ...
      AddConstant('HDN_FILTERCHANGE',HDN_FILTERCHANGE);
      AddConstant('HDN_FILTERBTNCLICK',HDN_FILTERBTNCLICK);
      AddConstant('HDN_BEGINFILTEREDIT',HDN_BEGINFILTEREDIT);
      AddConstant('HDN_ENDFILTEREDIT',HDN_ENDFILTEREDIT);
      AddConstant('HDN_ITEMSTATEICONCLICK',HDN_ITEMSTATEICONCLICK);
      AddConstant('HDN_ITEMKEYDOWN',HDN_ITEMKEYDOWN);
      AddConstant('HDN_DROPDOWN',HDN_DROPDOWN);
      AddConstant('HDN_OVERFLOWCLICK',HDN_OVERFLOWCLICK);
      ...
      AddConstant('BTNS_BUTTON',BTNS_BUTTON);
      AddConstant('BTNS_SEP',BTNS_SEP);
      AddConstant('BTNS_CHECK',BTNS_CHECK);
      AddConstant('BTNS_GROUP',BTNS_GROUP);
      AddConstant('BTNS_CHECKGROUP',BTNS_CHECKGROUP);
      AddConstant('BTNS_DROPDOWN',BTNS_DROPDOWN);
      AddConstant('BTNS_AUTOSIZE',BTNS_AUTOSIZE);
      AddConstant('BTNS_NOPREFIX',BTNS_NOPREFIX);
      AddConstant('BTNS_SHOWTEXT',BTNS_SHOWTEXT);
      AddConstant('BTNS_WHOLEDROPDOWN',BTNS_WHOLEDROPDOWN);
      AddConstant('TBSTYLE_EX_MIXEDBUTTONS',TBSTYLE_EX_MIXEDBUTTONS);
      AddConstant('TBSTYLE_EX_HIDECLIPPEDBUTTONS',TBSTYLE_EX_HIDECLIPPEDBUTTONS);
      AddConstant('TBSTYLE_EX_DOUBLEBUFFER',TBSTYLE_EX_DOUBLEBUFFER);
      ...
      AddConstant('TBCDRF_BLENDICON',TBCDRF_BLENDICON);
      AddConstant('TBCDRF_NOBACKGROUND',TBCDRF_NOBACKGROUND);
      AddConstant('TBCDRF_USECDCOLORS',TBCDRF_USECDCOLORS);
      ...
      AddConstant('IDB_HIST_NORMAL',IDB_HIST_NORMAL);
      AddConstant('IDB_HIST_HOT',IDB_HIST_HOT);
      AddConstant('IDB_HIST_DISABLED',IDB_HIST_DISABLED);
      AddConstant('IDB_HIST_PRESSED',IDB_HIST_PRESSED);
  ...
  begin
    ...
    begin
      ...
      AddConstant('TBIF_BYINDEX',TBIF_BYINDEX);
      ...
      AddConstant('TB_GETSTRINGW',TB_GETSTRINGW);
      AddConstant('TB_GETSTRINGA',TB_GETSTRINGA);
      AddConstant('TB_GETSTRING',TB_GETSTRING);
      AddConstant('TBMF_PAD',TBMF_PAD);
      AddConstant('TBMF_BARPAD',TBMF_BARPAD);
      AddConstant('TBMF_BUTTONSPACING',TBMF_BUTTONSPACING);
      AddConstant('TB_GETMETRICS',TB_GETMETRICS);
      AddConstant('TB_SETMETRICS',TB_SETMETRICS);
      AddConstant('TB_GETITEMDROPDOWNRECT',TB_GETITEMDROPDOWNRECT);
      AddConstant('TB_SETPRESSEDIMAGELIST',TB_SETPRESSEDIMAGELIST);
      AddConstant('TB_GETPRESSEDIMAGELIST',TB_GETPRESSEDIMAGELIST);
      AddConstant('TB_SETWINDOWTHEME',TB_SETWINDOWTHEME);
      ...
      AddConstant('TBN_RESTORE',TBN_RESTORE);
      AddConstant('TBN_SAVE',TBN_SAVE);
      ...
      AddConstant('RBBS_USECHEVRON',RBBS_USECHEVRON);
      AddConstant('RBBS_HIDETITLE',RBBS_HIDETITLE);
      AddConstant('RBBS_TOPALIGN',RBBS_TOPALIGN);
      ...
      AddConstant('RBBIM_CHEVRONLOCATION',RBBIM_CHEVRONLOCATION);
      AddConstant('RBBIM_CHEVRONSTATE',RBBIM_CHEVRONSTATE);
      ...
      AddConstant('RBSTR_CHANGERECT',RBSTR_CHANGERECT);
      AddConstant('RB_SETCOLORSCHEME',RB_SETCOLORSCHEME);
      AddConstant('RB_GETCOLORSCHEME',RB_GETCOLORSCHEME);
      ...
      AddConstant('RB_GETBANDMARGINS',RB_GETBANDMARGINS);
      AddConstant('RB_SETWINDOWTHEME',RB_SETWINDOWTHEME);
      AddConstant('RB_SETEXTENDEDSTYLE',RB_SETEXTENDEDSTYLE);
      AddConstant('RB_GETEXTENDEDSTYLE',RB_GETEXTENDEDSTYLE);
      AddConstant('RB_PUSHCHEVRON',RB_PUSHCHEVRON);
      AddConstant('RB_SETBANDWIDTH',RB_SETBANDWIDTH);
      ...
      AddConstant('RBN_CHEVRONPUSHED',RBN_CHEVRONPUSHED);
      AddConstant('RBN_SPLITTERDRAG',RBN_SPLITTERDRAG);
      AddConstant('RBN_MINMAX',RBN_MINMAX);
      AddConstant('RBN_AUTOBREAK',RBN_AUTOBREAK);
      AddConstant('RBNM_ID',RBNM_ID);
      AddConstant('RBNM_STYLE',RBNM_STYLE);
      AddConstant('RBNM_LPARAM',RBNM_LPARAM);
      AddConstant('RBAB_AUTOSIZE',RBAB_AUTOSIZE);
      AddConstant('RBAB_ADDBAND',RBAB_ADDBAND);
      ...
      AddConstant('RBHT_CHEVRON',RBHT_CHEVRON);
      AddConstant('RBHT_SPLITTER',RBHT_SPLITTER);
      AddConstant('TOOLTIPS_CLASS',TOOLTIPS_CLASS);
      AddConstant('TTS_ALWAYSTIP',TTS_ALWAYSTIP);
      AddConstant('TTS_NOPREFIX',TTS_NOPREFIX);
      AddConstant('TTS_NOANIMATE',TTS_NOANIMATE);
      AddConstant('TTS_NOFADE',TTS_NOFADE);
      AddConstant('TTS_BALLOON',TTS_BALLOON);
      AddConstant('TTS_CLOSE',TTS_CLOSE);
      AddConstant('TTS_USEVISUALSTYLE',TTS_USEVISUALSTYLE);
      ...
      AddConstant('TTF_PARSELINKS',TTF_PARSELINKS);
      ...
      AddConstant('TTI_NONE',TTI_NONE);
      AddConstant('TTI_INFO',TTI_INFO);
      AddConstant('TTI_WARNING',TTI_WARNING);
      AddConstant('TTI_ERROR',TTI_ERROR);
      AddConstant('TTI_INFO_LARGE',TTI_INFO_LARGE);
      AddConstant('TTI_WARNING_LARGE',TTI_WARNING_LARGE);
      AddConstant('TTI_ERROR_LARGE',TTI_ERROR_LARGE);
      ...
      AddConstant('TTM_GETBUBBLESIZE',TTM_GETBUBBLESIZE);
      AddConstant('TTM_ADJUSTRECT',TTM_ADJUSTRECT);
      AddConstant('TTM_SETTITLEA',TTM_SETTITLEA);
      AddConstant('TTM_SETTITLEW',TTM_SETTITLEW);
      AddConstant('TTM_POPUP',TTM_POPUP);
      AddConstant('TTM_GETTITLE',TTM_GETTITLE);
      ...
      AddConstant('TTM_SETTITLE',TTM_SETTITLE);
      AddConstant('TTM_SETWINDOWTHEME',TTM_SETWINDOWTHEME);
  ...
  begin
    ...
    begin
      ...
      AddConstant('TBS_REVERSED',TBS_REVERSED);
      AddConstant('TBS_DOWNISLEFT',TBS_DOWNISLEFT);
      AddConstant('TBS_NOTIFYBEFOREMOVE',TBS_NOTIFYBEFOREMOVE);
      AddConstant('TBS_TRANSPARENTBKGND',TBS_TRANSPARENTBKGND);
      ...
      AddConstant('TRBN_THUMBPOSCHANGING',TRBN_THUMBPOSCHANGING);
      ...
      AddConstant('UDM_SETPOS32',UDM_SETPOS32);
      AddConstant('UDM_GETPOS32',UDM_GETPOS32);
      ...
      AddConstant('PBS_MARQUEE',PBS_MARQUEE);
      AddConstant('PBM_SETMARQUEE',PBM_SETMARQUEE);
      AddConstant('PBS_SMOOTHREVERSE',PBS_SMOOTHREVERSE);
      AddConstant('PBM_GETSTEP',PBM_GETSTEP);
      AddConstant('PBM_GETBKCOLOR',PBM_GETBKCOLOR);
      AddConstant('PBM_GETBARCOLOR',PBM_GETBARCOLOR);
      AddConstant('PBM_SETSTATE',PBM_SETSTATE);
      AddConstant('PBM_GETSTATE',PBM_GETSTATE);
      AddConstant('PBST_NORMAL',PBST_NORMAL);
      AddConstant('PBST_ERROR',PBST_ERROR);
      AddConstant('PBST_PAUSED',PBST_PAUSED);
      ...
      AddConstant('INVALID_LINK_INDEX',INVALID_LINK_INDEX);
      AddConstant('MAX_LINKID_TEXT',MAX_LINKID_TEXT);
      AddConstant('L_MAX_URL_LENGTH',L_MAX_URL_LENGTH);
      AddConstant('WC_LINK',WC_LINK);
      AddConstant('LWS_TRANSPARENT',LWS_TRANSPARENT);
      AddConstant('LWS_IGNORERETURN',LWS_IGNORERETURN);
      AddConstant('LWS_NOPREFIX',LWS_NOPREFIX);
      AddConstant('LWS_USEVISUALSTYLE',LWS_USEVISUALSTYLE);
      AddConstant('LWS_USECUSTOMTEXT',LWS_USECUSTOMTEXT);
      AddConstant('LWS_RIGHT',LWS_RIGHT);
      AddConstant('LIF_ITEMINDEX',LIF_ITEMINDEX);
      AddConstant('LIF_STATE',LIF_STATE);
      AddConstant('LIF_ITEMID',LIF_ITEMID);
      AddConstant('LIF_URL',LIF_URL);
      AddConstant('LIS_FOCUSED',LIS_FOCUSED);
      AddConstant('LIS_ENABLED',LIS_ENABLED);
      AddConstant('LIS_VISITED',LIS_VISITED);
      AddConstant('LIS_HOTTRACK',LIS_HOTTRACK);
      AddConstant('LIS_DEFAULTCOLORS',LIS_DEFAULTCOLORS);
      AddConstant('LM_HITTEST',LM_HITTEST);
      AddConstant('LM_GETIDEALHEIGHT',LM_GETIDEALHEIGHT);
      AddConstant('LM_SETITEM',LM_SETITEM);
      AddConstant('LM_GETITEM',LM_GETITEM);
      AddConstant('LM_GETIDEALSIZE',LM_GETIDEALSIZE);
      ...
      AddConstant('LVS_EX_LABELTIP',LVS_EX_LABELTIP);
      AddConstant('LVS_EX_BORDERSELECT',LVS_EX_BORDERSELECT);
      AddConstant('LVS_EX_DOUBLEBUFFER',LVS_EX_DOUBLEBUFFER);
      AddConstant('LVS_EX_HIDELABELS',LVS_EX_HIDELABELS);
      AddConstant('LVS_EX_SINGLEROW',LVS_EX_SINGLEROW);
      AddConstant('LVS_EX_SNAPTOGRID',LVS_EX_SNAPTOGRID);
      AddConstant('LVS_EX_SIMPLESELECT',LVS_EX_SIMPLESELECT);
      AddConstant('LVS_EX_JUSTIFYCOLUMNS',LVS_EX_JUSTIFYCOLUMNS);
      AddConstant('LVS_EX_TRANSPARENTBKGND',LVS_EX_TRANSPARENTBKGND);
      AddConstant('LVS_EX_TRANSPARENTSHADOWTEXT',LVS_EX_TRANSPARENTSHADOWTEXT);
      AddConstant('LVS_EX_AUTOAUTOARRANGE',LVS_EX_AUTOAUTOARRANGE);
      AddConstant('LVS_EX_HEADERINALLVIEWS',LVS_EX_HEADERINALLVIEWS);
      AddConstant('LVS_EX_AUTOCHECKSELECT',LVS_EX_AUTOCHECKSELECT);
      AddConstant('LVS_EX_AUTOSIZECOLUMNS',LVS_EX_AUTOSIZECOLUMNS);
      AddConstant('LVS_EX_COLUMNSNAPPOINTS',LVS_EX_COLUMNSNAPPOINTS);
      AddConstant('LVS_EX_COLUMNOVERFLOW',LVS_EX_COLUMNOVERFLOW);
      ...
      AddConstant('LVSIL_GROUPHEADER',LVSIL_GROUPHEADER);
      ...
      AddConstant('LVIF_GROUPID',LVIF_GROUPID);
      AddConstant('LVIF_COLUMNS',LVIF_COLUMNS);
      AddConstant('LVIF_COLFMT',LVIF_COLFMT);
      ...
      AddConstant('I_IMAGENONE',I_IMAGENONE);
      AddConstant('I_COLUMNSCALLBACK',I_COLUMNSCALLBACK);
      AddConstant('I_GROUPIDCALLBACK',I_GROUPIDCALLBACK);
      AddConstant('I_GROUPIDNONE',I_GROUPIDNONE);
  ...
  begin
    ...
    begin
      ...
      AddConstant('LVFI_SUBSTRING',LVFI_SUBSTRING);
      ...
      AddConstant('LVCF_MINWIDTH',LVCF_MINWIDTH);
      AddConstant('LVCF_DEFAULTWIDTH',LVCF_DEFAULTWIDTH);
      AddConstant('LVCF_IDEALWIDTH',LVCF_IDEALWIDTH);
      ...
      AddConstant('LVCFMT_FIXED_WIDTH',LVCFMT_FIXED_WIDTH);
      AddConstant('LVCFMT_NO_DPI_SCALE',LVCFMT_NO_DPI_SCALE);
      AddConstant('LVCFMT_FIXED_RATIO',LVCFMT_FIXED_RATIO);
      AddConstant('LVCFMT_LINE_BREAK',LVCFMT_LINE_BREAK);
      AddConstant('LVCFMT_FILL',LVCFMT_FILL);
      AddConstant('LVCFMT_WRAP',LVCFMT_WRAP);
      AddConstant('LVCFMT_NO_TITLE',LVCFMT_NO_TITLE);
      AddConstant('LVCFMT_TILE_PLACEMENTMASK',LVCFMT_TILE_PLACEMENTMASK);
      AddConstant('LVCFMT_SPLITBUTTON',LVCFMT_SPLITBUTTON);
      ...
      AddConstant('LVBKIF_FLAG_TILEOFFSET',LVBKIF_FLAG_TILEOFFSET);
      AddConstant('LVBKIF_TYPE_WATERMARK',LVBKIF_TYPE_WATERMARK);
      AddConstant('LVBKIF_FLAG_ALPHABLEND',LVBKIF_FLAG_ALPHABLEND);
      ...
      AddConstant('LVM_SETSELECTEDCOLUMN',LVM_SETSELECTEDCOLUMN);
      AddConstant('LVM_SETVIEW',LVM_SETVIEW);
      AddConstant('LVM_GETVIEW',LVM_GETVIEW);
      AddConstant('LV_VIEW_ICON',LV_VIEW_ICON);
      AddConstant('LV_VIEW_DETAILS',LV_VIEW_DETAILS);
      AddConstant('LV_VIEW_SMALLICON',LV_VIEW_SMALLICON);
      AddConstant('LV_VIEW_LIST',LV_VIEW_LIST);
      AddConstant('LV_VIEW_TILE',LV_VIEW_TILE);
      AddConstant('LV_VIEW_MAX',LV_VIEW_MAX);
      AddConstant('LVGF_NONE',LVGF_NONE);
      AddConstant('LVGF_HEADER',LVGF_HEADER);
      AddConstant('LVGF_FOOTER',LVGF_FOOTER);
      AddConstant('LVGF_STATE',LVGF_STATE);
      AddConstant('LVGF_ALIGN',LVGF_ALIGN);
      AddConstant('LVGF_GROUPID',LVGF_GROUPID);
      AddConstant('LVGF_SUBTITLE',LVGF_SUBTITLE);
      AddConstant('LVGF_TASK',LVGF_TASK);
      AddConstant('LVGF_DESCRIPTIONTOP',LVGF_DESCRIPTIONTOP);
      AddConstant('LVGF_DESCRIPTIONBOTTOM',LVGF_DESCRIPTIONBOTTOM);
      AddConstant('LVGF_TITLEIMAGE',LVGF_TITLEIMAGE);
      AddConstant('LVGF_EXTENDEDIMAGE',LVGF_EXTENDEDIMAGE);
      AddConstant('LVGF_ITEMS',LVGF_ITEMS);
      AddConstant('LVGF_SUBSET',LVGF_SUBSET);
      AddConstant('LVGF_SUBSETITEMS',LVGF_SUBSETITEMS);
      AddConstant('LVGS_NORMAL',LVGS_NORMAL);
      AddConstant('LVGS_COLLAPSED',LVGS_COLLAPSED);
      AddConstant('LVGS_HIDDEN',LVGS_HIDDEN);
      AddConstant('LVGS_NOHEADER',LVGS_NOHEADER);
      AddConstant('LVGS_COLLAPSIBLE',LVGS_COLLAPSIBLE);
      AddConstant('LVGS_FOCUSED',LVGS_FOCUSED);
      AddConstant('LVGS_SELECTED',LVGS_SELECTED);
      AddConstant('LVGS_SUBSETED',LVGS_SUBSETED);
      AddConstant('LVGS_SUBSETLINKFOCUSED',LVGS_SUBSETLINKFOCUSED);
      AddConstant('LVGA_HEADER_LEFT',LVGA_HEADER_LEFT);
      AddConstant('LVGA_HEADER_CENTER',LVGA_HEADER_CENTER);
      AddConstant('LVGA_HEADER_RIGHT',LVGA_HEADER_RIGHT);
      AddConstant('LVGA_FOOTER_LEFT',LVGA_FOOTER_LEFT);
      AddConstant('LVGA_FOOTER_CENTER',LVGA_FOOTER_CENTER);
      AddConstant('LVGA_FOOTER_RIGHT',LVGA_FOOTER_RIGHT);
      AddConstant('LVM_INSERTGROUP',LVM_INSERTGROUP);
      AddConstant('LVM_SETGROUPINFO',LVM_SETGROUPINFO);
      AddConstant('LVM_GETGROUPINFO',LVM_GETGROUPINFO);
      AddConstant('LVM_REMOVEGROUP',LVM_REMOVEGROUP);
      AddConstant('LVM_MOVEGROUP',LVM_MOVEGROUP);
      AddConstant('LVM_GETGROUPCOUNT',LVM_GETGROUPCOUNT);
      AddConstant('LVM_GETGROUPINFOBYINDEX',LVM_GETGROUPINFOBYINDEX);
      AddConstant('LVM_MOVEITEMTOGROUP',LVM_MOVEITEMTOGROUP);
      AddConstant('LVGGR_GROUP',LVGGR_GROUP);
      AddConstant('LVGGR_HEADER',LVGGR_HEADER);
      AddConstant('LVGGR_LABEL',LVGGR_LABEL);
      AddConstant('LVGGR_SUBSETLINK',LVGGR_SUBSETLINK);
      AddConstant('LVM_GETGROUPRECT',LVM_GETGROUPRECT);
      AddConstant('LVGMF_NONE',LVGMF_NONE);
      AddConstant('LVGMF_BORDERSIZE',LVGMF_BORDERSIZE);
      AddConstant('LVGMF_BORDERCOLOR',LVGMF_BORDERCOLOR);
      AddConstant('LVGMF_TEXTCOLOR',LVGMF_TEXTCOLOR);
      AddConstant('LVM_SETGROUPMETRICS',LVM_SETGROUPMETRICS);
      AddConstant('LVM_GETGROUPMETRICS',LVM_GETGROUPMETRICS);
      AddConstant('LVM_ENABLEGROUPVIEW',LVM_ENABLEGROUPVIEW);
      AddConstant('LVM_SORTGROUPS',LVM_SORTGROUPS);
      AddConstant('LVM_INSERTGROUPSORTED',LVM_INSERTGROUPSORTED);
      AddConstant('LVM_REMOVEALLGROUPS',LVM_REMOVEALLGROUPS);
      AddConstant('LVM_HASGROUP',LVM_HASGROUP);
      AddConstant('LVM_GETGROUPSTATE',LVM_GETGROUPSTATE);
      AddConstant('LVM_GETFOCUSEDGROUP',LVM_GETFOCUSEDGROUP);
      AddConstant('LVTVIF_AUTOSIZE',LVTVIF_AUTOSIZE);
      AddConstant('LVTVIF_FIXEDWIDTH',LVTVIF_FIXEDWIDTH);
      AddConstant('LVTVIF_FIXEDHEIGHT',LVTVIF_FIXEDHEIGHT);
      AddConstant('LVTVIF_FIXEDSIZE',LVTVIF_FIXEDSIZE);
      AddConstant('LVTVIF_EXTENDED',LVTVIF_EXTENDED);
      AddConstant('LVTVIM_TILESIZE',LVTVIM_TILESIZE);
      AddConstant('LVTVIM_COLUMNS',LVTVIM_COLUMNS);
      AddConstant('LVTVIM_LABELMARGIN',LVTVIM_LABELMARGIN);
      AddConstant('LVM_SETTILEVIEWINFO',LVM_SETTILEVIEWINFO);
      AddConstant('LVM_GETTILEVIEWINFO',LVM_GETTILEVIEWINFO);
      AddConstant('LVM_SETTILEINFO',LVM_SETTILEINFO);
      AddConstant('LVM_GETTILEINFO',LVM_GETTILEINFO);
      AddConstant('LVIM_AFTER',LVIM_AFTER);
      AddConstant('LVM_SETINSERTMARK',LVM_SETINSERTMARK);
      AddConstant('LVM_GETINSERTMARK',LVM_GETINSERTMARK);
      AddConstant('LVM_INSERTMARKHITTEST',LVM_INSERTMARKHITTEST);
      AddConstant('LVM_GETINSERTMARKRECT',LVM_GETINSERTMARKRECT);
      AddConstant('LVM_SETINSERTMARKCOLOR',LVM_SETINSERTMARKCOLOR);
      AddConstant('LVM_GETINSERTMARKCOLOR',LVM_GETINSERTMARKCOLOR);
      AddConstant('LVM_SETINFOTIP',LVM_SETINFOTIP);
      AddConstant('LVM_GETSELECTEDCOLUMN',LVM_GETSELECTEDCOLUMN);
      AddConstant('LVM_ISGROUPVIEWENABLED',LVM_ISGROUPVIEWENABLED);
      AddConstant('LVM_GETOUTLINECOLOR',LVM_GETOUTLINECOLOR);
      AddConstant('LVM_SETOUTLINECOLOR',LVM_SETOUTLINECOLOR);
      AddConstant('LVM_CANCELEDITLABEL',LVM_CANCELEDITLABEL);
      AddConstant('LVM_MAPINDEXTOID',LVM_MAPINDEXTOID);
      AddConstant('LVM_MAPIDTOINDEX',LVM_MAPIDTOINDEX);
      AddConstant('LVM_ISITEMVISIBLE',LVM_ISITEMVISIBLE);
      AddConstant('LVM_GETEMPTYTEXT',LVM_GETEMPTYTEXT);
      AddConstant('LVM_GETFOOTERRECT',LVM_GETFOOTERRECT);
      AddConstant('LVFF_ITEMCOUNT',LVFF_ITEMCOUNT);
      AddConstant('LVM_GETFOOTERINFO',LVM_GETFOOTERINFO);
      AddConstant('LVM_GETFOOTERITEMRECT',LVM_GETFOOTERITEMRECT);
      AddConstant('LVFIF_TEXT',LVFIF_TEXT);
      AddConstant('LVFIF_STATE',LVFIF_STATE);
      AddConstant('LVFIS_FOCUSED',LVFIS_FOCUSED);
      AddConstant('LVM_GETFOOTERITEM',LVM_GETFOOTERITEM);
      AddConstant('LVM_GETITEMINDEXRECT',LVM_GETITEMINDEXRECT);
      AddConstant('LVM_SETITEMINDEXSTATE',LVM_SETITEMINDEXSTATE);
      AddConstant('LVM_GETNEXTITEMINDEX',LVM_GETNEXTITEMINDEX);
      ...
      AddConstant('LVCDI_ITEM',LVCDI_ITEM);
      AddConstant('LVCDI_GROUP',LVCDI_GROUP);
      AddConstant('LVCDI_ITEMSLIST',LVCDI_ITEMSLIST);
      AddConstant('LVCDRF_NOSELECT',LVCDRF_NOSELECT);
      AddConstant('LVCDRF_NOGROUPFRAME',LVCDRF_NOGROUPFRAME);
  ...
  begin
    ...
    begin
      ...
      AddConstant('LVNSCH_DEFAULT',LVNSCH_DEFAULT);
      AddConstant('LVNSCH_ERROR',LVNSCH_ERROR);
      AddConstant('LVNSCH_IGNORE',LVNSCH_IGNORE);
      AddConstant('LVN_INCREMENTALSEARCHA',LVN_INCREMENTALSEARCHA);
      AddConstant('LVN_INCREMENTALSEARCHW',LVN_INCREMENTALSEARCHW);
      AddConstant('LVN_INCREMENTALSEARCH',LVN_INCREMENTALSEARCH);
      AddConstant('LVN_COLUMNDROPDOWN',LVN_COLUMNDROPDOWN);
      AddConstant('LVN_COLUMNOVERFLOWCLICK',LVN_COLUMNOVERFLOWCLICK);
      AddConstant('LVN_BEGINSCROLL',LVN_BEGINSCROLL);
      AddConstant('LVN_ENDSCROLL',LVN_ENDSCROLL);
      AddConstant('LVN_LINKCLICK',LVN_LINKCLICK);
      AddConstant('EMF_CENTERED',EMF_CENTERED);
      AddConstant('LVN_GETEMPTYMARKUP',LVN_GETEMPTYMARKUP);
      ...
      AddConstant('TVS_NOHSCROLL',TVS_NOHSCROLL);
      AddConstant('TVS_EX_MULTISELECT',TVS_EX_MULTISELECT);
      AddConstant('TVS_EX_DOUBLEBUFFER',TVS_EX_DOUBLEBUFFER);
      AddConstant('TVS_EX_NOINDENTSTATE',TVS_EX_NOINDENTSTATE);
      AddConstant('TVS_EX_RICHTOOLTIP',TVS_EX_RICHTOOLTIP);
      AddConstant('TVS_EX_AUTOHSCROLL',TVS_EX_AUTOHSCROLL);
      AddConstant('TVS_EX_FADEINOUTEXPANDOS',TVS_EX_FADEINOUTEXPANDOS);
      AddConstant('TVS_EX_PARTIALCHECKBOXES',TVS_EX_PARTIALCHECKBOXES);
      AddConstant('TVS_EX_EXCLUSIONCHECKBOXES',TVS_EX_EXCLUSIONCHECKBOXES);
      AddConstant('TVS_EX_DIMMEDCHECKBOXES',TVS_EX_DIMMEDCHECKBOXES);
      AddConstant('TVS_EX_DRAWIMAGEASYNC',TVS_EX_DRAWIMAGEASYNC);
      ...
      AddConstant('TVIF_STATEEX',TVIF_STATEEX);
      AddConstant('TVIF_EXPANDEDIMAGE',TVIF_EXPANDEDIMAGE);
      ...
      AddConstant('TVIS_EX_FLAT',TVIS_EX_FLAT);
      AddConstant('TVIS_EX_ALL',TVIS_EX_ALL);
      AddConstant('TVIS_EX_DISABLED',TVIS_EX_DISABLED);
      ...
      AddConstant('TVGN_NEXTSELECTED',TVGN_NEXTSELECTED);
      AddConstant('TVSI_NOSINGLEEXPAND',TVSI_NOSINGLEEXPAND);
      ...
      AddConstant('TVM_GETITEMSTATE',TVM_GETITEMSTATE);
      AddConstant('TVM_SETLINECOLOR',TVM_SETLINECOLOR);
      AddConstant('TVM_GETLINECOLOR',TVM_GETLINECOLOR);
      AddConstant('TVM_MAPACCIDTOHTREEITEM',TVM_MAPACCIDTOHTREEITEM);
      AddConstant('TVM_MAPHTREEITEMTOACCID',TVM_MAPHTREEITEMTOACCID);
      AddConstant('TVM_SETEXTENDEDSTYLE',TVM_SETEXTENDEDSTYLE);
      AddConstant('TVM_GETEXTENDEDSTYLE',TVM_GETEXTENDEDSTYLE);
      AddConstant('TVM_SETAUTOSCROLLINFO',TVM_SETAUTOSCROLLINFO);
      AddConstant('TVM_GETSELECTEDCOUNT',TVM_GETSELECTEDCOUNT);
      AddConstant('TVM_SHOWINFOTIP',TVM_SHOWINFOTIP);
      AddConstant('TVM_GETITEMPARTRECT',TVM_GETITEMPARTRECT);
      ...
      AddConstant('TVNRET_DEFAULT',TVNRET_DEFAULT);
      AddConstant('TVNRET_SKIPOLD',TVNRET_SKIPOLD);
      AddConstant('TVNRET_SKIPNEW',TVNRET_SKIPNEW);
      AddConstant('TVN_ITEMCHANGINGA',TVN_ITEMCHANGINGA);
      AddConstant('TVN_ITEMCHANGINGW',TVN_ITEMCHANGINGW);
      AddConstant('TVN_ITEMCHANGEDA',TVN_ITEMCHANGEDA);
      AddConstant('TVN_ITEMCHANGEDW',TVN_ITEMCHANGEDW);
      AddConstant('TVN_ASYNCDRAW',TVN_ASYNCDRAW);
      AddConstant('TVN_ITEMCHANGING',TVN_ITEMCHANGING);
      AddConstant('TVN_ITEMCHANGED',TVN_ITEMCHANGED);
      ...
      AddConstant('CBEM_SETWINDOWTHEME',CBEM_SETWINDOWTHEME);
      ...
      AddConstant('CBES_EX_TEXTENDELLIPSIS',CBES_EX_TEXTENDELLIPSIS);
  ...
  begin
    ...
    begin
      ...
      AddConstant('WC_BUTTON',WC_BUTTON);
      AddConstant('BUTTON_IMAGELIST_ALIGN_LEFT',BUTTON_IMAGELIST_ALIGN_LEFT);
      AddConstant('BUTTON_IMAGELIST_ALIGN_RIGHT',BUTTON_IMAGELIST_ALIGN_RIGHT);
      AddConstant('BUTTON_IMAGELIST_ALIGN_TOP',BUTTON_IMAGELIST_ALIGN_TOP);
      AddConstant('BUTTON_IMAGELIST_ALIGN_BOTTOM',BUTTON_IMAGELIST_ALIGN_BOTTOM);
      AddConstant('BUTTON_IMAGELIST_ALIGN_CENTER',BUTTON_IMAGELIST_ALIGN_CENTER);
      AddConstant('BCM_GETIDEALSIZE',BCM_GETIDEALSIZE);
      AddConstant('BCM_SETIMAGELIST',BCM_SETIMAGELIST);
      AddConstant('BCM_GETIMAGELIST',BCM_GETIMAGELIST);
      AddConstant('BCM_SETTEXTMARGIN',BCM_SETTEXTMARGIN);
      AddConstant('BCM_GETTEXTMARGIN',BCM_GETTEXTMARGIN);
      AddConstant('BCN_HOTITEMCHANGE',BCN_HOTITEMCHANGE);
      AddConstant('BST_HOT',BST_HOT);
      AddConstant('BST_DROPDOWNPUSHED',BST_DROPDOWNPUSHED);
      AddConstant('BS_SPLITBUTTON',BS_SPLITBUTTON);
      AddConstant('BS_DEFSPLITBUTTON',BS_DEFSPLITBUTTON);
      AddConstant('BS_COMMANDLINK',BS_COMMANDLINK);
      AddConstant('BS_DEFCOMMANDLINK',BS_DEFCOMMANDLINK);
      AddConstant('BCSIF_GLYPH',BCSIF_GLYPH);
      AddConstant('BCSIF_IMAGE',BCSIF_IMAGE);
      AddConstant('BCSIF_STYLE',BCSIF_STYLE);
      AddConstant('BCSIF_SIZE',BCSIF_SIZE);
      AddConstant('BCSS_NOSPLIT',BCSS_NOSPLIT);
      AddConstant('BCSS_STRETCH',BCSS_STRETCH);
      AddConstant('BCSS_ALIGNLEFT',BCSS_ALIGNLEFT);
      AddConstant('BCSS_IMAGE',BCSS_IMAGE);
      AddConstant('BCM_SETDROPDOWNSTATE',BCM_SETDROPDOWNSTATE);
      AddConstant('BCM_SETSPLITINFO',BCM_SETSPLITINFO);
      AddConstant('BCM_GETSPLITINFO',BCM_GETSPLITINFO);
      AddConstant('BCM_SETNOTE',BCM_SETNOTE);
      AddConstant('BCM_GETNOTE',BCM_GETNOTE);
      AddConstant('BCM_GETNOTELENGTH',BCM_GETNOTELENGTH);
      AddConstant('BCM_SETSHIELD',BCM_SETSHIELD);
      AddConstant('BCCL_NOGLYPH',BCCL_NOGLYPH);
      AddConstant('BCN_DROPDOWN',BCN_DROPDOWN);
      AddConstant('WC_EDIT',WC_EDIT);
      AddConstant('EM_SETCUEBANNER',EM_SETCUEBANNER);
      AddConstant('EM_GETCUEBANNER',EM_GETCUEBANNER);
      AddConstant('EM_SHOWBALLOONTIP',EM_SHOWBALLOONTIP);
      AddConstant('EM_HIDEBALLOONTIP',EM_HIDEBALLOONTIP);
      AddConstant('EM_SETHILITE',EM_SETHILITE);
      AddConstant('EM_GETHILITE',EM_GETHILITE);
      AddConstant('WC_COMBOBOX',WC_COMBOBOX);
      AddConstant('CB_SETMINVISIBLE',CB_SETMINVISIBLE);
      AddConstant('CB_GETMINVISIBLE',CB_GETMINVISIBLE);
      AddConstant('CB_SETCUEBANNER',CB_SETCUEBANNER);
      AddConstant('CB_GETCUEBANNER',CB_GETCUEBANNER);
      AddConstant('TDF_ENABLE_HYPERLINKS',TDF_ENABLE_HYPERLINKS);
      AddConstant('TDF_USE_HICON_MAIN',TDF_USE_HICON_MAIN);
      AddConstant('TDF_USE_HICON_FOOTER',TDF_USE_HICON_FOOTER);
      AddConstant('TDF_ALLOW_DIALOG_CANCELLATION',TDF_ALLOW_DIALOG_CANCELLATION);
      AddConstant('TDF_USE_COMMAND_LINKS',TDF_USE_COMMAND_LINKS);
      AddConstant('TDF_USE_COMMAND_LINKS_NO_ICON',TDF_USE_COMMAND_LINKS_NO_ICON);
      AddConstant('TDF_EXPAND_FOOTER_AREA',TDF_EXPAND_FOOTER_AREA);
      AddConstant('TDF_EXPANDED_BY_DEFAULT',TDF_EXPANDED_BY_DEFAULT);
      AddConstant('TDF_VERIFICATION_FLAG_CHECKED',TDF_VERIFICATION_FLAG_CHECKED);
      AddConstant('TDF_SHOW_PROGRESS_BAR',TDF_SHOW_PROGRESS_BAR);
      AddConstant('TDF_SHOW_MARQUEE_PROGRESS_BAR',TDF_SHOW_MARQUEE_PROGRESS_BAR);
      AddConstant('TDF_CALLBACK_TIMER',TDF_CALLBACK_TIMER);
      AddConstant('TDF_POSITION_RELATIVE_TO_WINDOW',TDF_POSITION_RELATIVE_TO_WINDOW);
      AddConstant('TDF_RTL_LAYOUT',TDF_RTL_LAYOUT);
      AddConstant('TDF_NO_DEFAULT_RADIO_BUTTON',TDF_NO_DEFAULT_RADIO_BUTTON);
      AddConstant('TDF_CAN_BE_MINIMIZED',TDF_CAN_BE_MINIMIZED);
      AddConstant('TDM_NAVIGATE_PAGE',TDM_NAVIGATE_PAGE);
      AddConstant('TDM_CLICK_BUTTON',TDM_CLICK_BUTTON);
      AddConstant('TDM_SET_MARQUEE_PROGRESS_BAR',TDM_SET_MARQUEE_PROGRESS_BAR);
      AddConstant('TDM_SET_PROGRESS_BAR_STATE',TDM_SET_PROGRESS_BAR_STATE);
      AddConstant('TDM_SET_PROGRESS_BAR_RANGE',TDM_SET_PROGRESS_BAR_RANGE);
      AddConstant('TDM_SET_PROGRESS_BAR_POS',TDM_SET_PROGRESS_BAR_POS);
      AddConstant('TDM_SET_PROGRESS_BAR_MARQUEE',TDM_SET_PROGRESS_BAR_MARQUEE);
      AddConstant('TDM_SET_ELEMENT_TEXT',TDM_SET_ELEMENT_TEXT);
      AddConstant('TDM_CLICK_RADIO_BUTTON',TDM_CLICK_RADIO_BUTTON);
      AddConstant('TDM_ENABLE_BUTTON',TDM_ENABLE_BUTTON);
      AddConstant('TDM_ENABLE_RADIO_BUTTON',TDM_ENABLE_RADIO_BUTTON);
      AddConstant('TDM_CLICK_VERIFICATION',TDM_CLICK_VERIFICATION);
      AddConstant('TDM_UPDATE_ELEMENT_TEXT',TDM_UPDATE_ELEMENT_TEXT);
      AddConstant('TDM_SET_BUTTON_ELEVATION_REQUIRED_STATE',TDM_SET_BUTTON_ELEVATION_REQUIRED_STATE);
      AddConstant('TDM_UPDATE_ICON',TDM_UPDATE_ICON);
      AddConstant('TDN_CREATED',TDN_CREATED);
      AddConstant('TDN_NAVIGATED',TDN_NAVIGATED);
      AddConstant('TDN_BUTTON_CLICKED',TDN_BUTTON_CLICKED);
    end;
  end;

  procedure AddConsts8;
  begin
    With Scripter.DefineClass(ClassType) do
    begin
      AddConstant('TDN_HYPERLINK_CLICKED',TDN_HYPERLINK_CLICKED);
      AddConstant('TDN_TIMER',TDN_TIMER);
      AddConstant('TDN_DESTROYED',TDN_DESTROYED);
      AddConstant('TDN_RADIO_BUTTON_CLICKED',TDN_RADIO_BUTTON_CLICKED);
      AddConstant('TDN_DIALOG_CONSTRUCTED',TDN_DIALOG_CONSTRUCTED);
      AddConstant('TDN_VERIFICATION_CLICKED',TDN_VERIFICATION_CLICKED);
      AddConstant('TDN_HELP',TDN_HELP);
      AddConstant('TDN_EXPANDO_BUTTON_CLICKED',TDN_EXPANDO_BUTTON_CLICKED);
      AddConstant('TDE_CONTENT',TDE_CONTENT);
      AddConstant('TDE_EXPANDED_INFORMATION',TDE_EXPANDED_INFORMATION);
      AddConstant('TDE_FOOTER',TDE_FOOTER);
      AddConstant('TDE_MAIN_INSTRUCTION',TDE_MAIN_INSTRUCTION);
      AddConstant('TDIE_ICON_MAIN',TDIE_ICON_MAIN);
      AddConstant('TDIE_ICON_FOOTER',TDIE_ICON_FOOTER);
      AddConstant('TDCBF_OK_BUTTON',TDCBF_OK_BUTTON);
      AddConstant('TDCBF_YES_BUTTON',TDCBF_YES_BUTTON);
      AddConstant('TDCBF_NO_BUTTON',TDCBF_NO_BUTTON);
      AddConstant('TDCBF_CANCEL_BUTTON',TDCBF_CANCEL_BUTTON);
      AddConstant('TDCBF_RETRY_BUTTON',TDCBF_RETRY_BUTTON);
      AddConstant('TDCBF_CLOSE_BUTTON',TDCBF_CLOSE_BUTTON);
      ...
      AddConstant('LIM_SMALL',LIM_SMALL);
      AddConstant('LIM_LARGE',LIM_LARGE);
      AddConstant('DCHF_TOPALIGN',DCHF_TOPALIGN);
      AddConstant('DCHF_HORIZONTAL',DCHF_HORIZONTAL);
      AddConstant('DCHF_HOT',DCHF_HOT);
      AddConstant('DCHF_PUSHED',DCHF_PUSHED);
      AddConstant('DCHF_FLIPPED',DCHF_FLIPPED);
      AddConstant('DCHF_TRANSPARENT',DCHF_TRANSPARENT);
      AddConstant('DCHF_INACTIVE',DCHF_INACTIVE);
      AddConstant('DCHF_NOBORDER',DCHF_NOBORDER);
    end;
  end;
begin
  With Scripter.DefineClass(ClassType) do
  begin
    DefineMethod('PropertySheet',1,tkInteger,nil,__PropertySheet,false,0,'PSH: TPropSheetHeader').SetVarArgs([0]);
    DefineMethod('PropertySheetA',1,tkInteger,nil,__PropertySheetA,false,0,'PSH: TPropSheetHeaderA').SetVarArgs([0]);
    DefineMethod('PropertySheetW',1,tkInteger,nil,__PropertySheetW,false,0,'PSH: TPropSheetHeaderW').SetVarArgs([0]);
    DefineMethod('InitCommonControls',0,tkNone,nil,__InitCommonControls,false,0,'');
    DefineMethod('InitCommonControlsEx',1,tkVariant,nil,__InitCommonControlsEx,false,0,'ICC: TInitCommonControlsEx').SetVarArgs([0]);
    DefineMethod('ImageList_Create',5,tkInteger,nil,__ImageList_Create,false,0,'CX: Integer; CY: Integer; Flags: UINT; Initial: Integer; Grow: Integer');
    DefineMethod('ImageList_Destroy',1,tkVariant,nil,__ImageList_Destroy,false,0,'ImageList: HIMAGELIST');
    DefineMethod('ImageList_GetImageCount',1,tkInteger,nil,__ImageList_GetImageCount,false,0,'ImageList: HIMAGELIST');
    DefineMethod('ImageList_SetImageCount',2,tkInteger,nil,__ImageList_SetImageCount,false,0,'himl: HIMAGELIST; uNewCount: UINT');
    DefineMethod('ImageList_Add',3,tkInteger,nil,__ImageList_Add,false,0,'ImageList: HIMAGELIST; Image: HBitmap; Mask: HBitmap');
    DefineMethod('ImageList_ReplaceIcon',3,tkInteger,nil,__ImageList_ReplaceIcon,false,0,'ImageList: HIMAGELIST; Index: Integer; Icon: HIcon');
    DefineMethod('ImageList_SetBkColor',2,tkInteger,nil,__ImageList_SetBkColor,false,0,'ImageList: HIMAGELIST; ClrBk: TColorRef');
    DefineMethod('ImageList_GetBkColor',1,tkInteger,nil,__ImageList_GetBkColor,false,0,'ImageList: HIMAGELIST');
    DefineMethod('ImageList_SetOverlayImage',3,tkVariant,nil,__ImageList_SetOverlayImage,false,0,'ImageList: HIMAGELIST; Image: Integer; Overlay: Integer');
    DefineMethod('ImageList_AddIcon',2,tkInteger,nil,__ImageList_AddIcon,false,0,'ImageList: HIMAGELIST; Icon: HIcon');
    DefineMethod('IndexToOverlayMask',1,tkInteger,nil,__IndexToOverlayMask,false,0,'Index: Integer');
    DefineMethod('ImageList_Draw',6,tkVariant,nil,__ImageList_Draw,false,0,'ImageList: HIMAGELIST; Index: Integer; Dest: HDC; X: Integer; Y: Integer; Style: UINT');
    DefineMethod('ImageList_Replace',4,tkVariant,nil,__ImageList_Replace,false,0,'ImageList: HIMAGELIST; Index: Integer; Image: HBitmap; Mask: HBitmap');
    DefineMethod('ImageList_AddMasked',3,tkInteger,nil,__ImageList_AddMasked,false,0,'ImageList: HIMAGELIST; Image: HBitmap; Mask: TColorRef');
    DefineMethod('ImageList_DrawEx',10,tkVariant,nil,__ImageList_DrawEx,false,0,'ImageList: HIMAGELIST; Index: Integer; Dest: HDC; X: Integer; Y: Integer; DX: Integer; DY: Integer; Bk: TColorRef; Fg: TColorRef; Style: Cardinal');
    DefineMethod('ImageList_Remove',2,tkVariant,nil,__ImageList_Remove,false,0,'ImageList: HIMAGELIST; Index: Integer');
    DefineMethod('ImageList_GetIcon',3,tkInteger,nil,__ImageList_GetIcon,false,0,'ImageList: HIMAGELIST; Index: Integer; Flags: Cardinal');
    DefineMethod('ImageList_LoadImage',7,tkInteger,nil,__ImageList_LoadImage,false,0,'Instance: THandle; Bmp: PWideChar; CX: Integer; Grow: Integer; Mask: TColorRef; pType: Cardinal; Flags: Cardinal');
    DefineMethod('ImageList_LoadImageA',7,tkInteger,nil,__ImageList_LoadImageA,false,0,'Instance: THandle; Bmp: PAnsiChar; CX: Integer; Grow: Integer; Mask: TColorRef; pType: Cardinal; Flags: Cardinal');
    DefineMethod('ImageList_LoadImageW',7,tkInteger,nil,__ImageList_LoadImageW,false,0,'Instance: THandle; Bmp: PWideChar; CX: Integer; Grow: Integer; Mask: TColorRef; pType: Cardinal; Flags: Cardinal');
    DefineMethod('ImageList_Copy',5,tkInteger,nil,__ImageList_Copy,false,0,'himlDst: HIMAGELIST; iDst: Integer; himlSrc: HIMAGELIST; Src: Integer; uFlags: UINT');
    DefineMethod('ImageList_BeginDrag',4,tkVariant,nil,__ImageList_BeginDrag,false,0,'ImageList: HIMAGELIST; Track: Integer; XHotSpot: Integer; YHotSpot: Integer');
    DefineMethod('ImageList_EndDrag',0,tkVariant,nil,__ImageList_EndDrag,false,0,'');
    DefineMethod('ImageList_DragEnter',3,tkVariant,nil,__ImageList_DragEnter,false,0,'LockWnd: HWnd; X: Integer; Y: Integer');
    DefineMethod('ImageList_DragLeave',1,tkVariant,nil,__ImageList_DragLeave,false,0,'LockWnd: HWnd');
    DefineMethod('ImageList_DragMove',2,tkVariant,nil,__ImageList_DragMove,false,0,'X: Integer; Y: Integer');
    DefineMethod('ImageList_SetDragCursorImage',4,tkVariant,nil,__ImageList_SetDragCursorImage,false,0,'ImageList: HIMAGELIST; Drag: Integer; XHotSpot: Integer; YHotSpot: Integer');
    DefineMethod('ImageList_DragShowNolock',1,tkVariant,nil,__ImageList_DragShowNolock,false,0,'Show: Bool');
    DefineMethod('ImageList_RemoveAll',1,tkNone,nil,__ImageList_RemoveAll,false,0,'ImageList: HIMAGELIST');
    DefineMethod('ImageList_ExtractIcon',3,tkInteger,nil,__ImageList_ExtractIcon,false,0,'Instance: THandle; ImageList: HIMAGELIST; Image: Integer');
    DefineMethod('ImageList_LoadBitmap',5,tkInteger,nil,__ImageList_LoadBitmap,false,0,'Instance: THandle; Bmp: PWideChar; CX: Integer; Grow: Integer; MasK: TColorRef');
    DefineMethod('ImageList_LoadBitmapA',5,tkInteger,nil,__ImageList_LoadBitmapA,false,0,'Instance: THandle; Bmp: PAnsiChar; CX: Integer; Grow: Integer; MasK: TColorRef');
    DefineMethod('ImageList_LoadBitmapW',5,tkInteger,nil,__ImageList_LoadBitmapW,false,0,'Instance: THandle; Bmp: PWideChar; CX: Integer; Grow: Integer; MasK: TColorRef');
    DefineMethod('ImageList_GetIconSize',3,tkVariant,nil,__ImageList_GetIconSize,false,0,'ImageList: HIMAGELIST; CX: Integer; CY: Integer').SetVarArgs([1,2]);
    DefineMethod('ImageList_SetIconSize',3,tkVariant,nil,__ImageList_SetIconSize,false,0,'ImageList: HIMAGELIST; CX: Integer; CY: Integer');
    DefineMethod('ImageList_GetImageInfo',3,tkVariant,nil,__ImageList_GetImageInfo,false,0,'ImageList: HIMAGELIST; Index: Integer; ImageInfo: TImageInfo').SetVarArgs([2]);
    DefineMethod('ImageList_Merge',6,tkInteger,nil,__ImageList_Merge,false,0,'ImageList1: HIMAGELIST; Index1: Integer; ImageList2: HIMAGELIST; Index2: Integer; DX: Integer; DY: Integer');
    DefineMethod('ImageList_Duplicate',1,tkInteger,nil,__ImageList_Duplicate,false,0,'himl: HIMAGELIST');
    DefineMethod('Header_GetItemCount',1,tkInteger,nil,__Header_GetItemCount,false,0,'Header: HWnd');
    DefineMethod('Header_InsertItem',3,tkInteger,nil,__Header_InsertItem,false,0,'Header: HWnd; Index: Integer; Item: THDItem');
    DefineMethod('Header_InsertItemA',3,tkInteger,nil,__Header_InsertItemA,false,0,'Header: HWnd; Index: Integer; Item: THDItemA');
    DefineMethod('Header_InsertItemW',3,tkInteger,nil,__Header_InsertItemW,false,0,'Header: HWnd; Index: Integer; Item: THDItemW');
    DefineMethod('Header_DeleteItem',2,tkVariant,nil,__Header_DeleteItem,false,0,'Header: HWnd; Index: Integer');
    DefineMethod('Header_GetItem',3,tkVariant,nil,__Header_GetItem,false,0,'Header: HWnd; Index: Integer; Item: THDItem').SetVarArgs([2]);
    DefineMethod('Header_GetItemA',3,tkVariant,nil,__Header_GetItemA,false,0,'Header: HWnd; Index: Integer; Item: THDItemA').SetVarArgs([2]);
    DefineMethod('Header_GetItemW',3,tkVariant,nil,__Header_GetItemW,false,0,'Header: HWnd; Index: Integer; Item: THDItemW').SetVarArgs([2]);
    DefineMethod('Header_SetItem',3,tkVariant,nil,__Header_SetItem,false,0,'Header: HWnd; Index: Integer; Item: THDItem');
    DefineMethod('Header_SetItemA',3,tkVariant,nil,__Header_SetItemA,false,0,'Header: HWnd; Index: Integer; Item: THDItemA');
    DefineMethod('Header_SetItemW',3,tkVariant,nil,__Header_SetItemW,false,0,'Header: HWnd; Index: Integer; Item: THDItemW');
    DefineMethod('Header_SetImageList',2,tkInteger,nil,__Header_SetImageList,false,0,'hwnd: HWND; himl: HIMAGELIST');
    DefineMethod('Header_GetImageList',1,tkInteger,nil,__Header_GetImageList,false,0,'hwnd: HWND');
    DefineMethod('Header_OrderToIndex',2,tkInteger,nil,__Header_OrderToIndex,false,0,'hwnd: HWND; i: Integer');
    DefineMethod('Header_CreateDragImage',2,tkInteger,nil,__Header_CreateDragImage,false,0,'hwnd: HWND; i: Integer');
    DefineMethod('Header_SetHotDivider',3,tkInteger,nil,__Header_SetHotDivider,false,0,'hwnd: HWND; fPos: BOOL; dw: DWORD');
    DefineMethod('Header_SetUnicodeFormat',2,tkInteger,nil,__Header_SetUnicodeFormat,false,0,'hwnd: HWND; fUnicode: BOOL');
    DefineMethod('Header_GetUnicodeFormat',1,tkInteger,nil,__Header_GetUnicodeFormat,false,0,'hwnd: HWND');
    DefineMethod('Header_SetBitmapMargin',2,tkInteger,nil,__Header_SetBitmapMargin,false,0,'hwnd: HWND; iWidth: Integer');
    DefineMethod('Header_GetBitmapMargin',1,tkInteger,nil,__Header_GetBitmapMargin,false,0,'hwnd: HWND');
    DefineMethod('Header_SetFilterChangeTimeout',2,tkInteger,nil,__Header_SetFilterChangeTimeout,false,0,'hwnd: HWND; i: Integer');
    DefineMethod('Header_EditFilter',3,tkInteger,nil,__Header_EditFilter,false,0,'hwnd: HWND; i: Integer; fDiscardChanges: BOOL');
    DefineMethod('Header_ClearFilter',2,tkInteger,nil,__Header_ClearFilter,false,0,'hwnd: HWND; i: Integer');
    DefineMethod('Header_ClearAllFilters',1,tkInteger,nil,__Header_ClearAllFilters,false,0,'hwnd: HWND');
    DefineMethod('Header_GetItemDropDownRect',3,tkVariant,nil,__Header_GetItemDropDownRect,false,0,'hwnd: HWND; iItem: Integer; lprc: TRect').SetVarArgs([2]);
    DefineMethod('Header_GetOverflowRect',2,tkVariant,nil,__Header_GetOverflowRect,false,0,'hwnd: HWND; lprc: TRect').SetVarArgs([1]);
    DefineMethod('Header_GetFocusedItem',1,tkInteger,nil,__Header_GetFocusedItem,false,0,'hwnd: HWND');
    DefineMethod('Header_SetFocusedItem',2,tkVariant,nil,__Header_SetFocusedItem,false,0,'hwnd: HWND; iItem: Integer');
    DefineMethod('CreateStatusWindow',4,tkInteger,nil,__CreateStatusWindow,false,0,'Style: Longint; lpszText: PWideChar; hwndParent: HWND; wID: UINT');
    DefineMethod('CreateStatusWindowA',4,tkInteger,nil,__CreateStatusWindowA,false,0,'Style: Longint; lpszText: PAnsiChar; hwndParent: HWND; wID: UINT');
    DefineMethod('CreateStatusWindowW',4,tkInteger,nil,__CreateStatusWindowW,false,0,'Style: Longint; lpszText: PWideChar; hwndParent: HWND; wID: UINT');
    DefineMethod('MakeDragList',1,tkNone,nil,__MakeDragList,false,0,'hLB: HWND');
    DefineMethod('DrawInsert',3,tkNone,nil,__DrawInsert,false,0,'hwndParent: HWND; hLB: HWND; nItem: Integer');
    DefineMethod('LBItemFromPt',3,tkInteger,nil,__LBItemFromPt,false,0,'hLB: HWND; pt: TPoint; bAutoScroll: Bool');
    DefineMethod('CreateUpDownControl',12,tkInteger,nil,__CreateUpDownControl,false,0,'dwStyle: Longint; X: Integer; Y: Integer; CX: Integer; CY: Integer; hParent: HWND; nID: Integer; hInst: THandle; hBuddy: HWND; nUpper: Integer; nLower: Integer; nPos: Integer');
    DefineMethod('ListView_SetUnicodeFormat',2,tkVariant,nil,__ListView_SetUnicodeFormat,false,0,'hwnd: HWND; fUnicode: BOOL');
    DefineMethod('ListView_GetUnicodeFormat',1,tkVariant,nil,__ListView_GetUnicodeFormat,false,0,'hwnd: HWND');
    DefineMethod('ListView_GetBkColor',1,tkInteger,nil,__ListView_GetBkColor,false,0,'hWnd: HWND');
    DefineMethod('ListView_SetBkColor',2,tkVariant,nil,__ListView_SetBkColor,false,0,'hWnd: HWND; clrBk: TColorRef');
    DefineMethod('ListView_GetImageList',2,tkInteger,nil,__ListView_GetImageList,false,0,'hWnd: HWND; iImageList: Integer');
    DefineMethod('ListView_SetImageList',3,tkInteger,nil,__ListView_SetImageList,false,0,'hWnd: HWND; himl: HIMAGELIST; iImageList: Integer');
    DefineMethod('ListView_GetItemCount',1,tkInteger,nil,__ListView_GetItemCount,false,0,'hWnd: HWND');
    DefineMethod('IndexToStateImageMask',1,tkInteger,nil,__IndexToStateImageMask,false,0,'I: Longint');
    DefineMethod('ListView_GetItem',2,tkVariant,nil,__ListView_GetItem,false,0,'hWnd: HWND; pItem: TLVItem').SetVarArgs([1]);
    DefineMethod('ListView_GetItemA',2,tkVariant,nil,__ListView_GetItemA,false,0,'hWnd: HWND; pItem: TLVItemA').SetVarArgs([1]);
    DefineMethod('ListView_GetItemW',2,tkVariant,nil,__ListView_GetItemW,false,0,'hWnd: HWND; pItem: TLVItemW').SetVarArgs([1]);
    DefineMethod('ListView_SetItem',2,tkVariant,nil,__ListView_SetItem,false,0,'hWnd: HWND; pItem: TLVItem');
    DefineMethod('ListView_SetItemA',2,tkVariant,nil,__ListView_SetItemA,false,0,'hWnd: HWND; pItem: TLVItemA');
    DefineMethod('ListView_SetItemW',2,tkVariant,nil,__ListView_SetItemW,false,0,'hWnd: HWND; pItem: TLVItemW');
    DefineMethod('ListView_InsertItem',2,tkInteger,nil,__ListView_InsertItem,false,0,'hWnd: HWND; pItem: TLVItem');
    DefineMethod('ListView_InsertItemA',2,tkInteger,nil,__ListView_InsertItemA,false,0,'hWnd: HWND; pItem: TLVItemA');
    DefineMethod('ListView_InsertItemW',2,tkInteger,nil,__ListView_InsertItemW,false,0,'hWnd: HWND; pItem: TLVItemW');
    DefineMethod('ListView_DeleteItem',2,tkVariant,nil,__ListView_DeleteItem,false,0,'hWnd: HWND; i: Integer');
    DefineMethod('ListView_DeleteAllItems',1,tkVariant,nil,__ListView_DeleteAllItems,false,0,'hWnd: HWND');
    DefineMethod('ListView_GetCallbackMask',1,tkInteger,nil,__ListView_GetCallbackMask,false,0,'hWnd: HWND');
    DefineMethod('ListView_SetCallbackMask',2,tkVariant,nil,__ListView_SetCallbackMask,false,0,'hWnd: HWND; mask: UINT');
    DefineMethod('ListView_GetNextItem',3,tkInteger,nil,__ListView_GetNextItem,false,0,'hWnd: HWND; iStart: Integer; Flags: UINT');
    DefineMethod('ListView_FindItem',3,tkInteger,nil,__ListView_FindItem,false,0,'hWnd: HWND; iStart: Integer; plvfi: TLVFindInfo');
    DefineMethod('ListView_FindItemA',3,tkInteger,nil,__ListView_FindItemA,false,0,'hWnd: HWND; iStart: Integer; plvfi: TLVFindInfoA');
    DefineMethod('ListView_FindItemW',3,tkInteger,nil,__ListView_FindItemW,false,0,'hWnd: HWND; iStart: Integer; plvfi: TLVFindInfoW');
    DefineMethod('ListView_GetItemRect',4,tkVariant,nil,__ListView_GetItemRect,false,0,'hWnd: HWND; i: Integer; prc: TRect; Code: Integer').SetVarArgs([2]);
    DefineMethod('ListView_SetItemPosition',4,tkVariant,nil,__ListView_SetItemPosition,false,0,'hWnd: HWND; i: Integer; x: Integer; y: Integer');
    DefineMethod('ListView_GetItemPosition',3,tkVariant,nil,__ListView_GetItemPosition,false,0,'hwndLV: HWND; i: Integer; ppt: TPoint').SetVarArgs([2]);
    DefineMethod('ListView_GetStringWidth',2,tkInteger,nil,__ListView_GetStringWidth,false,0,'hwndLV: HWND; psz: PWideChar');
    DefineMethod('ListView_GetStringWidthA',2,tkInteger,nil,__ListView_GetStringWidthA,false,0,'hwndLV: HWND; psz: PAnsiChar');
    DefineMethod('ListView_GetStringWidthW',2,tkInteger,nil,__ListView_GetStringWidthW,false,0,'hwndLV: HWND; psz: PWideChar');
    DefineMethod('ListView_HitTest',2,tkInteger,nil,__ListView_HitTest,false,0,'hwndLV: HWND; pinfo: TLVHitTestInfo').SetVarArgs([1]);
    DefineMethod('ListView_EnsureVisible',3,tkVariant,nil,__ListView_EnsureVisible,false,0,'hwndLV: HWND; i: Integer; fPartialOK: Bool');
    DefineMethod('ListView_Scroll',3,tkVariant,nil,__ListView_Scroll,false,0,'hwndLV: HWnd; DX: Integer; DY: Integer');
    DefineMethod('ListView_RedrawItems',3,tkVariant,nil,__ListView_RedrawItems,false,0,'hwndLV: HWND; iFirst: Integer; iLast: Integer');
    DefineMethod('ListView_Arrange',2,tkVariant,nil,__ListView_Arrange,false,0,'hwndLV: HWND; Code: UINT');
    DefineMethod('ListView_EditLabel',2,tkInteger,nil,__ListView_EditLabel,false,0,'hwndLV: HWND; i: Integer');
    DefineMethod('ListView_EditLabelA',2,tkInteger,nil,__ListView_EditLabelA,false,0,'hwndLV: HWND; i: Integer');
    DefineMethod('ListView_EditLabelW',2,tkInteger,nil,__ListView_EditLabelW,false,0,'hwndLV: HWND; i: Integer');
    DefineMethod('ListView_GetEditControl',1,tkInteger,nil,__ListView_GetEditControl,false,0,'hwndLV: HWND');
    DefineMethod('ListView_GetColumn',3,tkVariant,nil,__ListView_GetColumn,false,0,'hwnd: HWND; iCol: Integer; pcol: TLVColumn').SetVarArgs([2]);
    DefineMethod('ListView_GetColumnA',3,tkVariant,nil,__ListView_GetColumnA,false,0,'hwnd: HWND; iCol: Integer; pcol: TLVColumnA').SetVarArgs([2]);
    DefineMethod('ListView_GetColumnW',3,tkVariant,nil,__ListView_GetColumnW,false,0,'hwnd: HWND; iCol: Integer; pcol: TLVColumnW').SetVarArgs([2]);
    DefineMethod('ListView_SetColumn',3,tkVariant,nil,__ListView_SetColumn,false,0,'hwnd: HWnd; iCol: Integer; pcol: TLVColumn');
    DefineMethod('ListView_SetColumnA',3,tkVariant,nil,__ListView_SetColumnA,false,0,'hwnd: HWnd; iCol: Integer; pcol: TLVColumnA');
    DefineMethod('ListView_SetColumnW',3,tkVariant,nil,__ListView_SetColumnW,false,0,'hwnd: HWnd; iCol: Integer; pcol: TLVColumnW');
    DefineMethod('ListView_InsertColumn',3,tkInteger,nil,__ListView_InsertColumn,false,0,'hwnd: HWND; iCol: Integer; pcol: TLVColumn');
    DefineMethod('ListView_InsertColumnA',3,tkInteger,nil,__ListView_InsertColumnA,false,0,'hwnd: HWND; iCol: Integer; pcol: TLVColumnA');
    DefineMethod('ListView_InsertColumnW',3,tkInteger,nil,__ListView_InsertColumnW,false,0,'hwnd: HWND; iCol: Integer; pcol: TLVColumnW');
    DefineMethod('ListView_DeleteColumn',2,tkVariant,nil,__ListView_DeleteColumn,false,0,'hwnd: HWND; iCol: Integer');
    DefineMethod('ListView_GetColumnWidth',2,tkInteger,nil,__ListView_GetColumnWidth,false,0,'hwnd: HWND; iCol: Integer');
    DefineMethod('ListView_SetColumnWidth',3,tkVariant,nil,__ListView_SetColumnWidth,false,0,'hwnd: HWnd; iCol: Integer; cx: Integer');
    DefineMethod('ListView_GetHeader',1,tkInteger,nil,__ListView_GetHeader,false,0,'hwnd: HWND');
    DefineMethod('ListView_CreateDragImage',3,tkInteger,nil,__ListView_CreateDragImage,false,0,'hwnd: HWND; i: Integer; lpptUpLeft: TPoint');
    DefineMethod('ListView_GetViewRect',2,tkVariant,nil,__ListView_GetViewRect,false,0,'hwnd: HWND; prc: TRect').SetVarArgs([1]);
    DefineMethod('ListView_GetTextColor',1,tkInteger,nil,__ListView_GetTextColor,false,0,'hwnd: HWND');
    DefineMethod('ListView_SetTextColor',2,tkVariant,nil,__ListView_SetTextColor,false,0,'hwnd: HWND; clrText: TColorRef');
    DefineMethod('ListView_GetTextBkColor',1,tkInteger,nil,__ListView_GetTextBkColor,false,0,'hwnd: HWND');
    DefineMethod('ListView_SetTextBkColor',2,tkVariant,nil,__ListView_SetTextBkColor,false,0,'hwnd: HWND; clrTextBk: TColorRef');
    DefineMethod('ListView_GetTopIndex',1,tkInteger,nil,__ListView_GetTopIndex,false,0,'hwndLV: HWND');
    DefineMethod('ListView_GetCountPerPage',1,tkInteger,nil,__ListView_GetCountPerPage,false,0,'hwndLV: HWND');
    DefineMethod('ListView_GetOrigin',2,tkVariant,nil,__ListView_GetOrigin,false,0,'hwndLV: HWND; ppt: TPoint').SetVarArgs([1]);
    DefineMethod('ListView_Update',2,tkVariant,nil,__ListView_Update,false,0,'hwndLV: HWND; i: Integer');
    DefineMethod('ListView_SetItemState',4,tkVariant,nil,__ListView_SetItemState,false,0,'hwndLV: HWND; i: Integer; data: UINT; mask: UINT');
    DefineMethod('ListView_GetItemState',3,tkInteger,nil,__ListView_GetItemState,false,0,'hwndLV: HWND; i: Integer; mask: Integer');
    DefineMethod('ListView_GetCheckState',2,tkInteger,nil,__ListView_GetCheckState,false,0,'hwndLV: HWND; i: Integer');
    DefineMethod('ListView_SetCheckState',3,tkNone,nil,__ListView_SetCheckState,false,0,'hwndLV: HWND; i: Integer; Checked: Boolean');
    DefineMethod('ListView_GetItemText',5,tkInteger,nil,__ListView_GetItemText,false,0,'hwndLV: HWND; i: Integer; iSubItem: Integer; pszText: PWideChar; cchTextMax: Integer');
    DefineMethod('ListView_GetItemTextA',5,tkInteger,nil,__ListView_GetItemTextA,false,0,'hwndLV: HWND; i: Integer; iSubItem: Integer; pszText: PAnsiChar; cchTextMax: Integer');
    DefineMethod('ListView_GetItemTextW',5,tkInteger,nil,__ListView_GetItemTextW,false,0,'hwndLV: HWND; i: Integer; iSubItem: Integer; pszText: PWideChar; cchTextMax: Integer');
    DefineMethod('ListView_SetItemText',4,tkVariant,nil,__ListView_SetItemText,false,0,'hwndLV: HWND; i: Integer; iSubItem: Integer; pszText: PWideChar');
    DefineMethod('ListView_SetItemTextA',4,tkVariant,nil,__ListView_SetItemTextA,false,0,'hwndLV: HWND; i: Integer; iSubItem: Integer; pszText: PAnsiChar');
    DefineMethod('ListView_SetItemTextW',4,tkVariant,nil,__ListView_SetItemTextW,false,0,'hwndLV: HWND; i: Integer; iSubItem: Integer; pszText: PWideChar');
    DefineMethod('ListView_SetItemCount',2,tkNone,nil,__ListView_SetItemCount,false,0,'hwndLV: HWND; cItems: Integer');
    DefineMethod('ListView_SetItemCountEx',3,tkNone,nil,__ListView_SetItemCountEx,false,0,'hwndLV: HWND; cItems: Integer; dwFlags: DWORD');
    DefineMethod('ListView_SetItemPosition32',4,tkNone,nil,__ListView_SetItemPosition32,false,0,'hwndLV: HWND; i: Integer; x: Integer; y: Integer');
    DefineMethod('ListView_GetSelectedCount',1,tkInteger,nil,__ListView_GetSelectedCount,false,0,'hwndLV: HWND');
    DefineMethod('ListView_GetItemSpacing',2,tkInteger,nil,__ListView_GetItemSpacing,false,0,'hwndLV: HWND; fSmall: Integer');
    DefineMethod('ListView_GetISearchString',2,tkVariant,nil,__ListView_GetISearchString,false,0,'hwndLV: HWND; lpsz: PWideChar');
    DefineMethod('ListView_GetISearchStringA',2,tkVariant,nil,__ListView_GetISearchStringA,false,0,'hwndLV: HWND; lpsz: PAnsiChar');
    DefineMethod('ListView_GetISearchStringW',2,tkVariant,nil,__ListView_GetISearchStringW,false,0,'hwndLV: HWND; lpsz: PWideChar');
    DefineMethod('ListView_SetIconSpacing',3,tkInteger,nil,__ListView_SetIconSpacing,false,0,'hwndLV: HWND; cx: Word; cy: Word');
    DefineMethod('ListView_SetExtendedListViewStyle',2,tkVariant,nil,__ListView_SetExtendedListViewStyle,false,0,'hwndLV: HWND; dw: DWORD');
    DefineMethod('ListView_GetExtendedListViewStyle',1,tkInteger,nil,__ListView_GetExtendedListViewStyle,false,0,'hwndLV: HWND');
    DefineMethod('ListView_SetHotItem',2,tkInteger,nil,__ListView_SetHotItem,false,0,'hwndLV: HWND; i: Integer');
    DefineMethod('ListView_GetHotItem',1,tkInteger,nil,__ListView_GetHotItem,false,0,'hwndLV: HWND');
    DefineMethod('ListView_SetHotCursor',2,tkInteger,nil,__ListView_SetHotCursor,false,0,'hwndLV: HWND; hcur: HCURSOR');
    DefineMethod('ListView_GetHotCursor',1,tkInteger,nil,__ListView_GetHotCursor,false,0,'hwndLV: HWND');
    DefineMethod('ListView_ApproximateViewRect',4,tkInteger,nil,__ListView_ApproximateViewRect,false,0,'hwndLV: HWND; iWidth: Word; iHeight: Word; iCount: Integer');
    DefineMethod('ListView_GetSelectionMark',1,tkInteger,nil,__ListView_GetSelectionMark,false,0,'hwnd: HWND');
    DefineMethod('ListView_SetSelectionMark',2,tkInteger,nil,__ListView_SetSelectionMark,false,0,'hwnd: HWND; i: Integer');
    DefineMethod('ListView_SetHoverTime',2,tkInteger,nil,__ListView_SetHoverTime,false,0,'hwndLV: HWND; dwHoverTimeMs: DWORD');
    DefineMethod('ListView_GetHoverTime',1,tkInteger,nil,__ListView_GetHoverTime,false,0,'hwndLV: HWND');
    DefineMethod('ListView_SetToolTips',2,tkInteger,nil,__ListView_SetToolTips,false,0,'hwndLV: HWND; hwndNewHwnd: HWND');
    DefineMethod('ListView_GetToolTips',1,tkInteger,nil,__ListView_GetToolTips,false,0,'hwndLV: HWND');
    DefineMethod('ListView_SetSelectedColumn',2,tkInteger,nil,__ListView_SetSelectedColumn,false,0,'hwnd: HWND; iCol: Integer');
    DefineMethod('ListView_SetView',2,tkInteger,nil,__ListView_SetView,false,0,'hwnd: HWND; iView: Integer');
    DefineMethod('ListView_GetView',1,tkInteger,nil,__ListView_GetView,false,0,'hwnd: HWND');
    DefineMethod('ListView_InsertGroup',3,tkInteger,nil,__ListView_InsertGroup,false,0,'hwnd: HWND; index: Integer; pgrp: TLVGroup');
    DefineMethod('ListView_SetGroupInfo',3,tkInteger,nil,__ListView_SetGroupInfo,false,0,'hwnd: HWND; iGroupId: Integer; pgrp: TLVGroup');
    DefineMethod('ListView_GetGroupInfo',3,tkInteger,nil,__ListView_GetGroupInfo,false,0,'hwnd: HWND; iGroupId: Integer; pgrp: TLVGroup').SetVarArgs([2]);
    DefineMethod('ListView_RemoveGroup',2,tkInteger,nil,__ListView_RemoveGroup,false,0,'hwnd: HWND; iGroupId: Integer');
    DefineMethod('ListView_MoveGroup',3,tkInteger,nil,__ListView_MoveGroup,false,0,'hwnd: HWND; iGroupId: Integer; toIndex: Integer');
    DefineMethod('ListView_GetGroupCount',1,tkInteger,nil,__ListView_GetGroupCount,false,0,'hwnd: HWND');
    DefineMethod('ListView_GetGroupInfoByIndex',3,tkInteger,nil,__ListView_GetGroupInfoByIndex,false,0,'hwnd: HWND; iIndex: Integer; pgrp: TLVGroup').SetVarArgs([2]);
    DefineMethod('ListView_MoveItemToGroup',3,tkInteger,nil,__ListView_MoveItemToGroup,false,0,'hwnd: HWND; idItemFrom: Integer; idGroupTo: Integer');
    DefineMethod('ListView_GetGroupRect',4,tkInteger,nil,__ListView_GetGroupRect,false,0,'hwnd: HWND; iGroupId: Integer; iType: Integer; prc: TRect').SetVarArgs([3]);
    DefineMethod('ListView_SetGroupMetrics',2,tkInteger,nil,__ListView_SetGroupMetrics,false,0,'hwnd: HWND; pGroupMetrics: TLVGroupMetrics');
    DefineMethod('ListView_GetGroupMetrics',2,tkInteger,nil,__ListView_GetGroupMetrics,false,0,'hwnd: HWND; pGroupMetrics: TLVGroupMetrics').SetVarArgs([1]);
    DefineMethod('ListView_EnableGroupView',2,tkInteger,nil,__ListView_EnableGroupView,false,0,'hwnd: HWND; fEnable: BOOL');
    DefineMethod('ListView_InsertGroupSorted',2,tkInteger,nil,__ListView_InsertGroupSorted,false,0,'hwnd: HWND; structInsert: TLVInsertGroupSorted');
    DefineMethod('ListView_RemoveAllGroups',1,tkInteger,nil,__ListView_RemoveAllGroups,false,0,'hwnd: HWND');
    DefineMethod('ListView_HasGroup',2,tkInteger,nil,__ListView_HasGroup,false,0,'hwnd: HWND; dwGroupId: Integer');
    DefineMethod('ListView_SetGroupState',4,tkInteger,nil,__ListView_SetGroupState,false,0,'hwnd: HWND; dwGroupId: UINT; dwMask: UINT; dwState: UINT');
    DefineMethod('ListView_GetGroupState',3,tkInteger,nil,__ListView_GetGroupState,false,0,'hwnd: HWND; dwGroupId: UINT; dwMask: UINT');
    DefineMethod('ListView_GetFocusedGroup',1,tkInteger,nil,__ListView_GetFocusedGroup,false,0,'hwnd: HWND');
    DefineMethod('ListView_SetTileViewInfo',2,tkInteger,nil,__ListView_SetTileViewInfo,false,0,'hwnd: HWND; ptvi: TLVTileViewInfo');
    DefineMethod('ListView_GetTileViewInfo',2,tkInteger,nil,__ListView_GetTileViewInfo,false,0,'hwnd: HWND; ptvi: TLVTileViewInfo').SetVarArgs([1]);
    DefineMethod('ListView_SetTileInfo',2,tkInteger,nil,__ListView_SetTileInfo,false,0,'hwnd: HWND; pti: TLVTileInfo');
    DefineMethod('ListView_GetTileInfo',2,tkInteger,nil,__ListView_GetTileInfo,false,0,'hwnd: HWND; pti: TLVTileInfo').SetVarArgs([1]);
    DefineMethod('ListView_SetInsertMark',2,tkVariant,nil,__ListView_SetInsertMark,false,0,'hwnd: HWND; lvim: TLVInsertMark');
    DefineMethod('ListView_GetInsertMark',2,tkVariant,nil,__ListView_GetInsertMark,false,0,'hwnd: HWND; lvim: TLVInsertMark').SetVarArgs([1]);
    DefineMethod('ListView_InsertMarkHitTest',3,tkInteger,nil,__ListView_InsertMarkHitTest,false,0,'hwnd: HWND; point: TPoint; lvim: TLVInsertMark');
    DefineMethod('ListView_GetInsertMarkRect',2,tkInteger,nil,__ListView_GetInsertMarkRect,false,0,'hwnd: HWND; rc: TRect').SetVarArgs([1]);
    DefineMethod('ListView_SetInsertMarkColor',2,tkInteger,nil,__ListView_SetInsertMarkColor,false,0,'hwnd: HWND; color: TColorRef');
    DefineMethod('ListView_GetInsertMarkColor',1,tkInteger,nil,__ListView_GetInsertMarkColor,false,0,'hwnd: HWND');
    DefineMethod('ListView_SetInfoTip',2,tkVariant,nil,__ListView_SetInfoTip,false,0,'hwndLV: HWND; plvInfoTip: TLVSetInfoTip');
    DefineMethod('ListView_GetSelectedColumn',1,tkInteger,nil,__ListView_GetSelectedColumn,false,0,'hwnd: HWND');
    DefineMethod('ListView_IsGroupViewEnabled',1,tkVariant,nil,__ListView_IsGroupViewEnabled,false,0,'hwnd: HWND');
    DefineMethod('ListView_GetOutlineColor',1,tkInteger,nil,__ListView_GetOutlineColor,false,0,'hwnd: HWND');
    DefineMethod('ListView_SetOutlineColor',2,tkInteger,nil,__ListView_SetOutlineColor,false,0,'hwnd: HWND; color: TColorRef');
    DefineMethod('ListView_CancelEditLabel',1,tkInteger,nil,__ListView_CancelEditLabel,false,0,'hwnd: HWND');
    DefineMethod('ListView_MapIndexToID',2,tkInteger,nil,__ListView_MapIndexToID,false,0,'hwnd: HWND; index: UINT');
    DefineMethod('ListView_MapIDToIndex',2,tkInteger,nil,__ListView_MapIDToIndex,false,0,'hwnd: HWND; id: UINT');
    DefineMethod('ListView_IsItemVisible',2,tkInteger,nil,__ListView_IsItemVisible,false,0,'hwnd: HWND; index: UINT');
    DefineMethod('ListView_SetGroupHeaderImageList',2,tkInteger,nil,__ListView_SetGroupHeaderImageList,false,0,'hwnd: HWND; himl: HIMAGELIST');
    DefineMethod('ListView_GetGroupHeaderImageList',1,tkInteger,nil,__ListView_GetGroupHeaderImageList,false,0,'hwnd: HWND');
    DefineMethod('ListView_GetEmptyText',3,tkVariant,nil,__ListView_GetEmptyText,false,0,'hwnd: HWND; pszText: LPWSTR; cchText: UINT');
    DefineMethod('ListView_GetFooterRect',2,tkVariant,nil,__ListView_GetFooterRect,false,0,'hwnd: HWND; prc: TRect').SetVarArgs([1]);
    DefineMethod('ListView_GetFooterInfo',2,tkVariant,nil,__ListView_GetFooterInfo,false,0,'hwnd: HWND; plvfi: TLVFooterInfo').SetVarArgs([1]);
    DefineMethod('ListView_GetFooterItemRect',3,tkVariant,nil,__ListView_GetFooterItemRect,false,0,'hwnd: HWND; iItem: UINT; prc: TRect').SetVarArgs([2]);
    DefineMethod('ListView_GetFooterItem',3,tkVariant,nil,__ListView_GetFooterItem,false,0,'hwnd: HWND; iItem: UINT; pfi: TLVFooterItem').SetVarArgs([2]);
    DefineMethod('ListView_GetItemIndexRect',5,tkVariant,nil,__ListView_GetItemIndexRect,false,0,'hwnd: HWND; plvii: TLVItemIndex; iSubItem: Integer; code: Integer; prc: TRect').SetVarArgs([4]);
    DefineMethod('ListView_SetItemIndexState',4,tkInteger,nil,__ListView_SetItemIndexState,false,0,'hwnd: HWND; plvii: TLVItemIndex; data: UINT; mask: UINT');
    DefineMethod('ListView_GetNextItemIndex',3,tkVariant,nil,__ListView_GetNextItemIndex,false,0,'hwnd: HWND; plvii: TLVItemIndex; flags: LPARAM').SetVarArgs([1]);
    DefineMethod('TreeView_DeleteAllItems',1,tkVariant,nil,__TreeView_DeleteAllItems,false,0,'hwnd: HWND');
    DefineMethod('TreeView_GetCount',1,tkInteger,nil,__TreeView_GetCount,false,0,'hwnd: HWND');
    DefineMethod('TreeView_GetIndent',1,tkInteger,nil,__TreeView_GetIndent,false,0,'hwnd: HWND');
    DefineMethod('TreeView_SetIndent',2,tkVariant,nil,__TreeView_SetIndent,false,0,'hwnd: HWND; indent: Integer');
    DefineMethod('TreeView_GetImageList',2,tkInteger,nil,__TreeView_GetImageList,false,0,'hwnd: HWND; iImage: Integer');
    DefineMethod('TreeView_SetImageList',3,tkInteger,nil,__TreeView_SetImageList,false,0,'hwnd: HWND; himl: HIMAGELIST; iImage: Integer');
    DefineMethod('TreeView_GetItem',2,tkVariant,nil,__TreeView_GetItem,false,0,'hwnd: HWND; pitem: TTVItem').SetVarArgs([1]);
    DefineMethod('TreeView_GetItemA',2,tkVariant,nil,__TreeView_GetItemA,false,0,'hwnd: HWND; pitem: TTVItemA').SetVarArgs([1]);
    DefineMethod('TreeView_GetItemW',2,tkVariant,nil,__TreeView_GetItemW,false,0,'hwnd: HWND; pitem: TTVItemW').SetVarArgs([1]);
    DefineMethod('TreeView_SetItem',2,tkVariant,nil,__TreeView_SetItem,false,0,'hwnd: HWND; pitem: TTVItem');
    DefineMethod('TreeView_SetItemA',2,tkVariant,nil,__TreeView_SetItemA,false,0,'hwnd: HWND; pitem: TTVItemA');
    DefineMethod('TreeView_SetItemW',2,tkVariant,nil,__TreeView_SetItemW,false,0,'hwnd: HWND; pitem: TTVItemW');
    DefineMethod('TreeView_GetEditControl',1,tkInteger,nil,__TreeView_GetEditControl,false,0,'hwnd: HWND');
    DefineMethod('TreeView_GetVisibleCount',1,tkInteger,nil,__TreeView_GetVisibleCount,false,0,'hwnd: HWND');
    DefineMethod('TreeView_SortChildrenCB',3,tkVariant,nil,__TreeView_SortChildrenCB,false,0,'hwnd: HWND; psort: TTVSortCB; recurse: Integer');
    DefineMethod('TreeView_EndEditLabelNow',2,tkVariant,nil,__TreeView_EndEditLabelNow,false,0,'hwnd: HWND; fCancel: Bool');
    DefineMethod('TreeView_GetISearchString',2,tkVariant,nil,__TreeView_GetISearchString,false,0,'hwndTV: HWND; lpsz: PWideChar');
    DefineMethod('TreeView_GetISearchStringA',2,tkVariant,nil,__TreeView_GetISearchStringA,false,0,'hwndTV: HWND; lpsz: PAnsiChar');
    DefineMethod('TreeView_GetISearchStringW',2,tkVariant,nil,__TreeView_GetISearchStringW,false,0,'hwndTV: HWND; lpsz: PWideChar');
    DefineMethod('TreeView_SetToolTips',2,tkInteger,nil,__TreeView_SetToolTips,false,0,'wnd: HWND; hwndTT: HWND');
    DefineMethod('TreeView_GetToolTips',1,tkInteger,nil,__TreeView_GetToolTips,false,0,'wnd: HWND');
    DefineMethod('TreeView_SetInsertMark',3,tkVariant,nil,__TreeView_SetInsertMark,false,0,'hwnd: HWND; hItem: Integer; fAfter: BOOL');
    DefineMethod('TreeView_SetUnicodeFormat',2,tkVariant,nil,__TreeView_SetUnicodeFormat,false,0,'hwnd: HWND; fUnicode: BOOL');
    DefineMethod('TreeView_GetUnicodeFormat',1,tkVariant,nil,__TreeView_GetUnicodeFormat,false,0,'hwnd: HWND');
    DefineMethod('TreeView_SetItemHeight',2,tkInteger,nil,__TreeView_SetItemHeight,false,0,'hwnd: HWND; iHeight: Integer');
    DefineMethod('TreeView_GetItemHeight',1,tkInteger,nil,__TreeView_GetItemHeight,false,0,'hwnd: HWND');
    DefineMethod('TreeView_SetBkColor',2,tkInteger,nil,__TreeView_SetBkColor,false,0,'hwnd: HWND; clr: COLORREF');
    DefineMethod('TreeView_SetTextColor',2,tkInteger,nil,__TreeView_SetTextColor,false,0,'hwnd: HWND; clr: COLORREF');
    DefineMethod('TreeView_GetBkColor',1,tkInteger,nil,__TreeView_GetBkColor,false,0,'hwnd: HWND');
    DefineMethod('TreeView_GetTextColor',1,tkInteger,nil,__TreeView_GetTextColor,false,0,'hwnd: HWND');
    DefineMethod('TreeView_SetScrollTime',2,tkInteger,nil,__TreeView_SetScrollTime,false,0,'hwnd: HWND; uTime: UINT');
    DefineMethod('TreeView_GetScrollTime',1,tkInteger,nil,__TreeView_GetScrollTime,false,0,'hwnd: HWND');
    DefineMethod('TreeView_SetInsertMarkColor',2,tkInteger,nil,__TreeView_SetInsertMarkColor,false,0,'hwnd: HWND; clr: COLORREF');
    DefineMethod('TreeView_GetInsertMarkColor',1,tkInteger,nil,__TreeView_GetInsertMarkColor,false,0,'hwnd: HWND');
    DefineMethod('TreeView_SetLineColor',2,tkInteger,nil,__TreeView_SetLineColor,false,0,'hwnd: HWND; clr: TColorRef');
    DefineMethod('TreeView_GetLineColor',1,tkInteger,nil,__TreeView_GetLineColor,false,0,'hwnd: HWND');
    DefineMethod('TreeView_SetExtendedStyle',3,tkInteger,nil,__TreeView_SetExtendedStyle,false,0,'hwnd: HWND; dw: DWORD; mask: UINT');
    DefineMethod('TreeView_GetExtendedStyle',1,tkInteger,nil,__TreeView_GetExtendedStyle,false,0,'hwnd: HWND');
    DefineMethod('TreeView_SetAutoScrollInfo',3,tkInteger,nil,__TreeView_SetAutoScrollInfo,false,0,'hwnd: HWND; uPixPerSec: UINT; uUpdateTime: UINT');
    DefineMethod('TreeView_GetSelectedCount',1,tkInteger,nil,__TreeView_GetSelectedCount,false,0,'hwnd: HWND');
    DefineMethod('TabCtrl_HitTest',2,tkInteger,nil,__TabCtrl_HitTest,false,0,'hwndTC: HWND; pinfo: TTCHitTestInfo');
    DefineMethod('TabCtrl_SetItemExtra',2,tkVariant,nil,__TabCtrl_SetItemExtra,false,0,'hwndTC: HWND; cb: Integer');
    DefineMethod('TabCtrl_SetItemSize',3,tkInteger,nil,__TabCtrl_SetItemSize,false,0,'hwnd: HWND; x: Integer; y: Integer');
    DefineMethod('TabCtrl_RemoveImage',2,tkNone,nil,__TabCtrl_RemoveImage,false,0,'hwnd: HWND; i: Integer');
    DefineMethod('TabCtrl_SetPadding',3,tkNone,nil,__TabCtrl_SetPadding,false,0,'hwnd: HWND; cx: Integer; cy: Integer');
    DefineMethod('TabCtrl_GetRowCount',1,tkInteger,nil,__TabCtrl_GetRowCount,false,0,'hwnd: HWND');
    DefineMethod('TabCtrl_GetToolTips',1,tkInteger,nil,__TabCtrl_GetToolTips,false,0,'wnd: HWND');
    DefineMethod('TabCtrl_SetToolTips',2,tkNone,nil,__TabCtrl_SetToolTips,false,0,'hwnd: HWND; hwndTT: HWND');
    DefineMethod('TabCtrl_GetCurFocus',1,tkInteger,nil,__TabCtrl_GetCurFocus,false,0,'hwnd: HWND');
    DefineMethod('TabCtrl_SetCurFocus',2,tkNone,nil,__TabCtrl_SetCurFocus,false,0,'hwnd: HWND; i: Integer');
    DefineMethod('TabCtrl_SetMinTabWidth',2,tkInteger,nil,__TabCtrl_SetMinTabWidth,false,0,'hwnd: HWND; x: Integer');
    DefineMethod('TabCtrl_DeselectAll',2,tkNone,nil,__TabCtrl_DeselectAll,false,0,'hwnd: HWND; fExcludeFocus: BOOL');
    DefineMethod('TabCtrl_HighlightItem',3,tkVariant,nil,__TabCtrl_HighlightItem,false,0,'hwnd: HWND; i: Integer; fHighlight: WordBool');
    DefineMethod('TabCtrl_SetExtendedStyle',2,tkInteger,nil,__TabCtrl_SetExtendedStyle,false,0,'hwnd: HWND; dw: DWORD');
    DefineMethod('TabCtrl_GetExtendedStyle',1,tkInteger,nil,__TabCtrl_GetExtendedStyle,false,0,'hwnd: HWND');
    DefineMethod('TabCtrl_SetUnicodeFormat',2,tkVariant,nil,__TabCtrl_SetUnicodeFormat,false,0,'hwnd: HWND; fUnicode: BOOL');
    DefineMethod('TabCtrl_GetUnicodeFormat',1,tkVariant,nil,__TabCtrl_GetUnicodeFormat,false,0,'hwnd: HWND');
    DefineMethod('TabCtrl_GetItemRect',3,tkVariant,nil,__TabCtrl_GetItemRect,false,0,'hwnd: HWND; i: Integer; prc: TRect').SetVarArgs([2]);
    DefineMethod('Animate_Create',4,tkInteger,nil,__Animate_Create,false,0,'hwndP: HWND; id: HMENU; dwStyle: DWORD; hInstance: HINST');
    DefineMethod('Animate_Open',2,tkVariant,nil,__Animate_Open,false,0,'hwnd: HWND; szName: PChar');
    DefineMethod('Animate_OpenEx',3,tkVariant,nil,__Animate_OpenEx,false,0,'hwnd: HWND; hInst: HINST; szName: PChar');
    DefineMethod('Animate_Play',4,tkVariant,nil,__Animate_Play,false,0,'hwnd: HWND; from: Word; _to: Word; rep: UINT');
    DefineMethod('Animate_Stop',1,tkVariant,nil,__Animate_Stop,false,0,'hwnd: HWND');
    DefineMethod('Animate_Close',1,tkVariant,nil,__Animate_Close,false,0,'hwnd: HWND');
    DefineMethod('Animate_Seek',2,tkVariant,nil,__Animate_Seek,false,0,'hwnd: HWND; frame: Word');
    DefineMethod('MonthCal_GetCurSel',2,tkVariant,nil,__MonthCal_GetCurSel,false,0,'hmc: HWND; pst: TSystemTime').SetVarArgs([1]);
    DefineMethod('MonthCal_SetCurSel',2,tkVariant,nil,__MonthCal_SetCurSel,false,0,'hmc: HWND; pst: TSystemTime');
    DefineMethod('MonthCal_GetMaxSelCount',1,tkInteger,nil,__MonthCal_GetMaxSelCount,false,0,'hmc: HWND');
    DefineMethod('MonthCal_SetMaxSelCount',2,tkVariant,nil,__MonthCal_SetMaxSelCount,false,0,'hmc: HWND; n: UINT');
    DefineMethod('MonthCal_SetDayState',3,tkVariant,nil,__MonthCal_SetDayState,false,0,'hmc: HWND; cbds: Integer; rgds: TNMDayState');
    DefineMethod('MonthCal_GetMinReqRect',2,tkVariant,nil,__MonthCal_GetMinReqRect,false,0,'hmc: HWND; prc: TRect').SetVarArgs([1]);
    DefineMethod('MonthCal_SetToday',2,tkVariant,nil,__MonthCal_SetToday,false,0,'hmc: HWND; pst: TSystemTime');
    DefineMethod('MonthCal_GetToday',2,tkVariant,nil,__MonthCal_GetToday,false,0,'hmc: HWND; pst: TSystemTime').SetVarArgs([1]);
    DefineMethod('MonthCal_HitTest',2,tkInteger,nil,__MonthCal_HitTest,false,0,'hmc: HWND; info: TMCHitTestInfo').SetVarArgs([1]);
    DefineMethod('MonthCal_SetColor',3,tkInteger,nil,__MonthCal_SetColor,false,0,'hmc: HWND; iColor: Integer; clr: TColorRef');
    DefineMethod('MonthCal_GetColor',2,tkInteger,nil,__MonthCal_GetColor,false,0,'hmc: HWND; iColor: Integer');
    DefineMethod('MonthCal_SetFirstDayOfWeek',2,tkInteger,nil,__MonthCal_SetFirstDayOfWeek,false,0,'hmc: HWND; iDay: Integer');
    DefineMethod('MonthCal_GetFirstDayOfWeek',1,tkInteger,nil,__MonthCal_GetFirstDayOfWeek,false,0,'hmc: HWND');
    DefineMethod('MonthCal_GetMonthDelta',1,tkInteger,nil,__MonthCal_GetMonthDelta,false,0,'hmc: HWND');
    DefineMethod('MonthCal_SetMonthDelta',2,tkInteger,nil,__MonthCal_SetMonthDelta,false,0,'hmc: HWND; n: Integer');
    DefineMethod('MonthCal_GetMaxTodayWidth',1,tkInteger,nil,__MonthCal_GetMaxTodayWidth,false,0,'hmc: HWND');
    DefineMethod('MonthCal_SetUnicodeFormat',2,tkVariant,nil,__MonthCal_SetUnicodeFormat,false,0,'hwnd: HWND; fUnicode: BOOL');
    DefineMethod('MonthCal_GetUnicodeFormat',1,tkVariant,nil,__MonthCal_GetUnicodeFormat,false,0,'hwnd: HWND');
    DefineMethod('DateTime_GetSystemTime',2,tkInteger,nil,__DateTime_GetSystemTime,false,0,'hdp: HWND; pst: TSystemTime').SetVarArgs([1]);
    DefineMethod('DateTime_SetSystemTime',3,tkVariant,nil,__DateTime_SetSystemTime,false,0,'hdp: HWND; gd: DWORD; pst: TSystemTime');
    DefineMethod('DateTime_SetFormat',2,tkVariant,nil,__DateTime_SetFormat,false,0,'hdp: HWND; sz: PWideChar');
    DefineMethod('DateTime_SetFormatA',2,tkVariant,nil,__DateTime_SetFormatA,false,0,'hdp: HWND; sz: PAnsiChar');
    DefineMethod('DateTime_SetFormatW',2,tkVariant,nil,__DateTime_SetFormatW,false,0,'hdp: HWND; sz: PWideChar');
    DefineMethod('DateTime_SetMonthCalColor',3,tkInteger,nil,__DateTime_SetMonthCalColor,false,0,'hdp: HWND; iColor: DWORD; clr: TColorRef');
    DefineMethod('DateTime_GetMonthCalColor',2,tkInteger,nil,__DateTime_GetMonthCalColor,false,0,'hdp: HWND; iColor: DWORD');
    DefineMethod('DateTime_GetMonthCal',1,tkInteger,nil,__DateTime_GetMonthCal,false,0,'hdp: HWND');
    DefineMethod('DateTime_SetMonthCalFont',3,tkNone,nil,__DateTime_SetMonthCalFont,false,0,'hdp: HWND; hfont: HFONT; fRedraw: BOOL');
    DefineMethod('DateTime_GetMonthCalFont',1,tkInteger,nil,__DateTime_GetMonthCalFont,false,0,'hdp: HWND');
    DefineMethod('MAKEIPRANGE',2,tkInteger,nil,__MAKEIPRANGE,false,0,'low: Byte; high: Byte');
    DefineMethod('MAKEIPADDRESS',4,tkInteger,nil,__MAKEIPADDRESS,false,0,'b1: DWORD; b2: DWORD; b3: DWORD; b4: DWORD');
    DefineMethod('FIRST_IPADDRESS',1,tkInteger,nil,__FIRST_IPADDRESS,false,0,'x: DWORD');
    DefineMethod('SECOND_IPADDRESS',1,tkInteger,nil,__SECOND_IPADDRESS,false,0,'x: DWORD');
    DefineMethod('THIRD_IPADDRESS',1,tkInteger,nil,__THIRD_IPADDRESS,false,0,'x: DWORD');
    DefineMethod('FOURTH_IPADDRESS',1,tkInteger,nil,__FOURTH_IPADDRESS,false,0,'x: DWORD');
    DefineMethod('Pager_SetChild',2,tkNone,nil,__Pager_SetChild,false,0,'hwnd: HWND; hwndChild: HWND');
    DefineMethod('Pager_RecalcSize',1,tkNone,nil,__Pager_RecalcSize,false,0,'hwnd: HWND');
    DefineMethod('Pager_ForwardMouse',2,tkNone,nil,__Pager_ForwardMouse,false,0,'hwnd: HWND; bForward: BOOL');
    DefineMethod('Pager_SetBkColor',2,tkInteger,nil,__Pager_SetBkColor,false,0,'hwnd: HWND; clr: COLORREF');
    DefineMethod('Pager_GetBkColor',1,tkInteger,nil,__Pager_GetBkColor,false,0,'hwnd: HWND');
    DefineMethod('Pager_SetBorder',2,tkInteger,nil,__Pager_SetBorder,false,0,'hwnd: HWND; iBorder: Integer');
    DefineMethod('Pager_GetBorder',1,tkInteger,nil,__Pager_GetBorder,false,0,'hwnd: HWND');
    DefineMethod('Pager_SetPos',2,tkInteger,nil,__Pager_SetPos,false,0,'hwnd: HWND; iPos: Integer');
    DefineMethod('Pager_GetPos',1,tkInteger,nil,__Pager_GetPos,false,0,'hwnd: HWND');
    DefineMethod('Pager_SetButtonSize',2,tkInteger,nil,__Pager_SetButtonSize,false,0,'hwnd: HWND; iSize: Integer');
    DefineMethod('Pager_GetButtonSize',1,tkInteger,nil,__Pager_GetButtonSize,false,0,'hwnd: HWND');
    DefineMethod('Pager_GetButtonState',2,tkInteger,nil,__Pager_GetButtonState,false,0,'hwnd: HWND; iButton: Integer');
    DefineMethod('Button_GetIdealSize',2,tkVariant,nil,__Button_GetIdealSize,false,0,'hwnd: HWND; psize: TSize').SetVarArgs([1]);
    DefineMethod('Button_SetImageList',2,tkVariant,nil,__Button_SetImageList,false,0,'hwnd: HWND; pbuttonImagelist: TButtonImageList');
    DefineMethod('Button_GetImageList',2,tkVariant,nil,__Button_GetImageList,false,0,'hwnd: HWND; pbuttonImagelist: TButtonImageList').SetVarArgs([1]);
    DefineMethod('Button_SetTextMargin',2,tkVariant,nil,__Button_SetTextMargin,false,0,'hwnd: HWND; pmargin: TRect');
    DefineMethod('Button_GetTextMargin',2,tkVariant,nil,__Button_GetTextMargin,false,0,'hwnd: HWND; pmargin: TRect').SetVarArgs([1]);
    DefineMethod('Button_SetDropDownState',2,tkVariant,nil,__Button_SetDropDownState,false,0,'hwnd: HWND; fDropDown: BOOL');
    DefineMethod('Button_SetSplitInfo',2,tkVariant,nil,__Button_SetSplitInfo,false,0,'hwnd: HWND; pInfo: TButtonSplitinfo');
    DefineMethod('Button_GetSplitInfo',2,tkVariant,nil,__Button_GetSplitInfo,false,0,'hwnd: HWND; pInfo: TButtonSplitinfo').SetVarArgs([1]);
    DefineMethod('Button_SetNote',2,tkVariant,nil,__Button_SetNote,false,0,'hwnd: HWND; psz: LPCWSTR');
    DefineMethod('Button_GetNote',3,tkVariant,nil,__Button_GetNote,false,0,'hwnd: HWND; psz: LPCWSTR; pcc: Integer').SetVarArgs([2]);
    DefineMethod('Button_GetNoteLength',1,tkInteger,nil,__Button_GetNoteLength,false,0,'hwnd: HWND');
    DefineMethod('Button_SetElevationRequiredState',2,tkInteger,nil,__Button_SetElevationRequiredState,false,0,'hwnd: HWND; fRequired: BOOL');
    DefineMethod('Edit_SetCueBannerText',2,tkVariant,nil,__Edit_SetCueBannerText,false,0,'hwnd: HWND; lpwText: LPCWSTR');
    DefineMethod('Edit_GetCueBannerText',3,tkVariant,nil,__Edit_GetCueBannerText,false,0,'hwnd: HWND; lpwText: LPCWSTR; cchText: Longint');
    DefineMethod('Edit_ShowBalloonTip',2,tkVariant,nil,__Edit_ShowBalloonTip,false,0,'hwnd: HWND; peditballoontip: TEditBalloonTip');
    DefineMethod('Edit_HideBalloonTip',1,tkVariant,nil,__Edit_HideBalloonTip,false,0,'hwnd: HWND');
    DefineMethod('Edit_SetHilite',3,tkNone,nil,__Edit_SetHilite,false,0,'hwndCtl: HWND; ichStart: Integer; ichEnd: Integer');
    DefineMethod('Edit_GetHilite',1,tkInteger,nil,__Edit_GetHilite,false,0,'hwndCtl: HWND');
    DefineMethod('ComboBox_SetMinVisible',2,tkVariant,nil,__ComboBox_SetMinVisible,false,0,'hwnd: HWND; iMinVisible: Integer');
    DefineMethod('ComboBox_GetMinVisible',1,tkInteger,nil,__ComboBox_GetMinVisible,false,0,'hwnd: HWND');
    DefineMethod('ComboBox_SetCueBannerText',2,tkVariant,nil,__ComboBox_SetCueBannerText,false,0,'hwnd: HWND; lpcwText: LPCWSTR');
    DefineMethod('ComboBox_GetCueBannerText',3,tkVariant,nil,__ComboBox_GetCueBannerText,false,0,'hwnd: HWND; lpwText: LPCWSTR; cchText: Integer');
    DefineMethod('FlatSB_EnableScrollBar',3,tkVariant,nil,__FlatSB_EnableScrollBar,false,0,'hWnd: HWND; wSBflags: UINT; wArrows: UINT');
    DefineMethod('FlatSB_ShowScrollBar',3,tkVariant,nil,__FlatSB_ShowScrollBar,false,0,'hWnd: HWND; wBar: Integer; bShow: BOOL');
    DefineMethod('FlatSB_GetScrollRange',4,tkVariant,nil,__FlatSB_GetScrollRange,false,0,'hWnd: HWND; nBar: Integer; lpMinPos: Integer; lpMaxPos: Integer').SetVarArgs([2,3]);
    DefineMethod('FlatSB_GetScrollInfo',3,tkVariant,nil,__FlatSB_GetScrollInfo,false,0,'hWnd: HWND; BarFlag: Integer; ScrollInfo: TScrollInfo').SetVarArgs([2]);
    DefineMethod('FlatSB_GetScrollPos',2,tkInteger,nil,__FlatSB_GetScrollPos,false,0,'hWnd: HWND; nBar: Integer');
    DefineMethod('FlatSB_SetScrollPos',4,tkInteger,nil,__FlatSB_SetScrollPos,false,0,'hWnd: HWND; nBar: Integer; nPos: Integer; bRedraw: BOOL');
    DefineMethod('FlatSB_SetScrollInfo',4,tkInteger,nil,__FlatSB_SetScrollInfo,false,0,'hWnd: HWND; BarFlag: Integer; ScrollInfo: TScrollInfo; Redraw: BOOL');
    DefineMethod('FlatSB_SetScrollRange',5,tkVariant,nil,__FlatSB_SetScrollRange,false,0,'hWnd: HWND; nBar: Integer; nMinPos: Integer; nMaxPos: Integer; bRedraw: BOOL');
    DefineMethod('FlatSB_SetScrollProp',4,tkVariant,nil,__FlatSB_SetScrollProp,false,0,'p1: HWND; index: Integer; newValue: Integer; p4: Bool');
    DefineMethod('InitializeFlatSB',1,tkVariant,nil,__InitializeFlatSB,false,0,'hWnd: HWND');
    DefineMethod('UninitializeFlatSB',1,tkNone,nil,__UninitializeFlatSB,false,0,'hWnd: HWND');
    DefineMethod('DefSubclassProc',4,tkInteger,nil,__DefSubclassProc,false,0,'hWnd: HWND; uMsg: UINT; wParam: WPARAM; lParam: LPARAM');
    DefineMethod('LoadIconMetric',4,tkInteger,nil,__LoadIconMetric,false,0,'hinst: HINST; pszName: LPCWSTR; lims: Integer; phico: HICON').SetVarArgs([3]);
    DefineMethod('LoadIconWithScaleDown',5,tkInteger,nil,__LoadIconWithScaleDown,false,0,'hinst: HINST; pszName: LPCWSTR; cx: Integer; cy: Integer; phico: HICON').SetVarArgs([4]);
    DefineMethod('DrawShadowText',9,tkInteger,nil,__DrawShadowText,false,0,'hdc: HDC; pszText: LPCWSTR; cch: UINT; prc: TRect; dwFlags: DWORD; crText: COLORREF; crShadow: COLORREF; ixOffset: Integer; iyOffset: Integer');
    AddConstant('TVGIPR_BUTTON',TVGIPR_BUTTON);
  AddConsts1;
  AddConsts2;
  AddConsts3;
  AddConsts4;
