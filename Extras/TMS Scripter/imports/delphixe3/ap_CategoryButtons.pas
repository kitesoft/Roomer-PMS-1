...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCategoryButtonsClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
...
begin
  with AMachine do
  begin
    TCategoryButtons(CurrentObject).Assign(TPersistent(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TCategoryButtons(CurrentObject).DragDrop(TObject(VarToObject(GetInputArg(0))),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)));
  end;
end;
...
2: AResult := ObjectToVar(TCategoryButtons(CurrentObject).GetButtonAt(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1))));
3: AResult := ObjectToVar(TCategoryButtons(CurrentObject).GetButtonAt(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),TButtonCategory(VarToObject(GetInputArg(2)))));
end;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := integer(TRectWrapper.Create(TCategoryButtons(CurrentObject).GetButtonRect(TBaseItem(VarToObject(GetInputArg(0))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCategoryButtons(CurrentObject).GetCategoryAt(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
case InputArgCount of
1: AResult := integer(TRectWrapper.Create(TCategoryButtons(CurrentObject).GetCategoryRect(TButtonCategory(VarToObject(GetInputArg(0))))));
2: AResult := integer(TRectWrapper.Create(TCategoryButtons(CurrentObject).GetCategoryRect(TButtonCategory(VarToObject(GetInputArg(0))),GetInputArg(1))));
end;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCategoryButtons(CurrentObject).GetDragImages);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
Param2 := TButtonItem(VarToObject(GetInputArg(2)));
Param3 := TButtonCategory(VarToObject(GetInputArg(3)));
...
begin
  with AMachine do
  begin
    TCategoryButtons(CurrentObject).ScrollIntoView(TBaseItem(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TCategoryButtons(CurrentObject).SetInsertionButton(TButtonItem(VarToObject(GetInputArg(0))),TButtonCategory(VarToObject(GetInputArg(1))));
  end;
end;
...
begin
  with AMachine do
  begin
    TCategoryButtons(CurrentObject).UpdateButton(TBaseItem(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCategoryButtons(CurrentObject).CurrentCategory));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCategoryButtons(CurrentObject).DragButton));
  end;
end;
...
begin
  with AMachine do
  begin
    TCategoryButtons(CurrentObject).DragButton:=TButtonItem(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCategoryButtons(CurrentObject).DragCategory));
  end;
end;
...
begin
  with AMachine do
  begin
    TCategoryButtons(CurrentObject).DragCategory:=TButtonCategory(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCategoryButtons(CurrentObject).DragImageList));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCategoryButtons(CurrentObject).SelectedItem));
  end;
end;
...
begin
  with AMachine do
  begin
    TCategoryButtons(CurrentObject).SelectedItem:=TBaseItem(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCategoryButtons(CurrentObject).FocusedItem));
  end;
end;
...
begin
  with AMachine do
  begin
    TCategoryButtons(CurrentObject).FocusedItem:=TBaseItem(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TBaseItem(CurrentObject).Caption));
  end;
end;
...
begin
  with AMachine do
  begin
    TBaseItem(CurrentObject).Caption:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TBaseButtonItemClass(CurrentClass.ClassRef).Create(TCollection(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TBaseButtonItem(CurrentObject).Assign(TPersistent(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TBaseButtonItem(CurrentObject).ActionLink));
  end;
end;
...
begin
  with AMachine do
  begin
    TBaseButtonItem(CurrentObject).ActionLink:=TButtonItemActionLink(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    TButtonItem(CurrentObject).Assign(TPersistent(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TButtonItem(CurrentObject).Category));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TItemCollection(CurrentObject).CategoryButtons));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TButtonCollectionClass(CurrentClass.ClassRef).Create(TButtonCategory(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TButtonCollection(CurrentObject).Add);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TButtonCollection(CurrentObject).AddItem(TButtonItem(VarToObject(GetInputArg(0))),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TButtonCollection(CurrentObject).Insert(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TButtonCollection(CurrentObject).Category));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TButtonCollection(CurrentObject).Items[VarToInteger(GetArrayIndex(0))]));
  end;
end;
...
begin
  with AMachine do
  begin
    TButtonCollection(CurrentObject).Items[VarToInteger(GetArrayIndex(0))]:=TButtonItem(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TButtonCategoryClass(CurrentClass.ClassRef).Create(TCollection(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TButtonCategory(CurrentObject).Assign(TPersistent(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TButtonCategory(CurrentObject).IndexOf(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TButtonCategory(CurrentObject).Categories));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TButtonCategoriesClass(CurrentClass.ClassRef).Create(TCategoryButtons(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TButtonCategories(CurrentObject).Add);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TButtonCategories(CurrentObject).AddItem(TButtonCategory(VarToObject(GetInputArg(0))),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TButtonCategories(CurrentObject).IndexOf(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TButtonCategories(CurrentObject).Insert(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TButtonCategories(CurrentObject).ItemAt(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TButtonCategories(CurrentObject).ItemIndex(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TButtonCategories(CurrentObject).Items[VarToInteger(GetArrayIndex(0))]));
  end;
end;
...
begin
  with AMachine do
  begin
    TButtonCategories(CurrentObject).Items[VarToInteger(GetArrayIndex(0))]:=TButtonCategory(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  ...
  begin
    DefineMethod('Create',1,tkClass,TCategoryButtons,__TCategoryButtonsCreate,true,0,'AOwner: TComponent');
    DefineMethod('Destroy',0,tkNone,nil,__TCategoryButtonsDestroy,false,0,'');
    DefineMethod('Assign',1,tkNone,nil,__TCategoryButtonsAssign,false,0,'Source: TPersistent');
    DefineMethod('DragDrop',3,tkNone,nil,__TCategoryButtonsDragDrop,false,0,'Source: TObject; X: Integer; Y: Integer');
    DefineMethod('GenerateDragImage',0,tkNone,nil,__TCategoryButtonsGenerateDragImage,false,0,'');
    DefineMethod('GetButtonAt',3,tkClass,TButtonItem,__TCategoryButtonsGetButtonAt,false,1,'X: Integer; Y: Integer; Category: TButtonCategory = nil');
    DefineMethod('GetButtonRect',1,tkVariant,nil,__TCategoryButtonsGetButtonRect,false,0,'Item: TBaseItem');
    DefineMethod('GetCategoryAt',2,tkClass,TButtonCategory,__TCategoryButtonsGetCategoryAt,false,0,'X: Integer; Y: Integer');
    DefineMethod('GetCategoryRect',2,tkVariant,nil,__TCategoryButtonsGetCategoryRect,false,1,'Category: TButtonCategory; ButtonOnly: Boolean = False');
    DefineMethod('GetDragImages',0,tkClass,TDragImageList,__TCategoryButtonsGetDragImages,false,0,'');
    DefineMethod('GetTargetAt',4,tkNone,nil,__TCategoryButtonsGetTargetAt,false,0,'X: Integer; Y: Integer; TargetButton: TButtonItem; TargetCategory: TButtonCategory').SetVarArgs([2,3]);
    ...
    DefineMethod('ScrollIntoView',1,tkNone,nil,__TCategoryButtonsScrollIntoView,false,0,'Item: TBaseItem');
    DefineMethod('SetInsertionButton',2,tkNone,nil,__TCategoryButtonsSetInsertionButton,false,0,'InsertionButton: TButtonItem; InsertionCategory: TButtonCategory');
    DefineMethod('UpdateAllButtons',0,tkNone,nil,__TCategoryButtonsUpdateAllButtons,false,0,'');
    DefineMethod('UpdateButton',1,tkNone,nil,__TCategoryButtonsUpdateButton,false,0,'Item: TBaseItem');
  ...
  begin
    ...
    DefineMethod('EndEdit',1,tkNone,nil,__TBaseItemEndEdit,false,0,'Cancel: Boolean');
  ...
  begin
    DefineMethod('Create',1,tkClass,TBaseButtonItem,__TBaseButtonItemCreate,true,0,'Collection: TCollection');
    DefineMethod('Destroy',0,tkNone,nil,__TBaseButtonItemDestroy,false,0,'');
    DefineMethod('Assign',1,tkNone,nil,__TBaseButtonItemAssign,false,0,'Source: TPersistent');
  ...
  begin
    DefineMethod('Assign',1,tkNone,nil,__TButtonItemAssign,false,0,'Source: TPersistent');
  ...
  begin
    DefineMethod('Create',1,tkClass,TButtonCollection,__TButtonCollectionCreate,true,0,'ACategory: TButtonCategory');
    DefineMethod('Add',0,tkClass,TButtonItem,__TButtonCollectionAdd,false,0,'');
    DefineMethod('AddItem',2,tkClass,TButtonItem,__TButtonCollectionAddItem,false,0,'Item: TButtonItem; Index: Integer');
    DefineMethod('Insert',1,tkClass,TButtonItem,__TButtonCollectionInsert,false,0,'Index: Integer');
  ...
  begin
    DefineMethod('Create',1,tkClass,TButtonCategory,__TButtonCategoryCreate,true,0,'Collection: TCollection');
    DefineMethod('Destroy',0,tkNone,nil,__TButtonCategoryDestroy,false,0,'');
    DefineMethod('Assign',1,tkNone,nil,__TButtonCategoryAssign,false,0,'Source: TPersistent');
    DefineMethod('GetButtonRect',1,tkVariant,nil,__TButtonCategoryGetButtonRect,false,0,'ButtonOnly: Boolean');
    DefineMethod('IndexOf',1,tkInteger,nil,__TButtonCategoryIndexOf,false,0,'Caption: string');
  ...
  begin
    DefineMethod('Create',1,tkClass,TButtonCategories,__TButtonCategoriesCreate,true,0,'CategoryButtons: TCategoryButtons');
    DefineMethod('Add',0,tkClass,TButtonCategory,__TButtonCategoriesAdd,false,0,'');
    DefineMethod('AddItem',2,tkClass,TButtonCategory,__TButtonCategoriesAddItem,false,0,'Item: TButtonCategory; Index: Integer');
    DefineMethod('BeginUpdate',0,tkNone,nil,__TButtonCategoriesBeginUpdate,false,0,'');
    DefineMethod('IndexOf',1,tkInteger,nil,__TButtonCategoriesIndexOf,false,0,'Caption: string');
    DefineMethod('Insert',1,tkClass,TButtonCategory,__TButtonCategoriesInsert,false,0,'Index: Integer');
    DefineMethod('ItemAt',1,tkClass,TBaseItem,__TButtonCategoriesItemAt,false,0,'Index: Integer');
    DefineMethod('ItemIndex',1,tkInteger,nil,__TButtonCategoriesItemIndex,false,0,'Caption: string');
  ...
  begin
    DefineMethod('DoShowHint',1,tkVariant,nil,__TButtonItemActionLinkDoShowHint,false,0,'HintStr: string').SetVarArgs([0]);
  end;
