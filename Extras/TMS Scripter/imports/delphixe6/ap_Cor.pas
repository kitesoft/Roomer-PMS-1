...
begin
  with AMachine do
  begin
AResult := Integer(Cor.CoInitializeEE(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Cor.CoInitializeCor(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    DefineMethod('IsRidType',1,tkVariant,nil,__IsRidType,false,0,'ix: ULONG');
    DefineMethod('IsCodedTokenType',1,tkVariant,nil,__IsCodedTokenType,false,0,'ix: ULONG');
    DefineMethod('IsRidOrToken',1,tkVariant,nil,__IsRidOrToken,false,0,'ix: ULONG');
    DefineMethod('IsHeapType',1,tkVariant,nil,__IsHeapType,false,0,'ix: ULONG');
    DefineMethod('IsFixedType',1,tkVariant,nil,__IsFixedType,false,0,'ix: ULONG');
    DefineMethod('_CorExeMain',0,tkInteger,nil,___CorExeMain,false,0,'');
    DefineMethod('CoInitializeEE',1,tkInteger,nil,__CoInitializeEE,false,0,'fFlags: DWORD');
    DefineMethod('CoUninitializeEE',1,tkNone,nil,__CoUninitializeEE,false,0,'fFlags: BOOL');
    DefineMethod('CoEEShutDownCOM',0,tkNone,nil,__CoEEShutDownCOM,false,0,'');
    DefineMethod('CoInitializeCor',1,tkInteger,nil,__CoInitializeCor,false,0,'fFlags: DWORD');
    DefineMethod('CoUninitializeCor',0,tkNone,nil,__CoUninitializeCor,false,0,'');
    DefineMethod('CorIsPrimitiveType',1,tkVariant,nil,__CorIsPrimitiveType,false,0,'elementtype: CorElementType');
    DefineMethod('CorIsModifierElementType',1,tkVariant,nil,__CorIsModifierElementType,false,0,'elementtype: CorElementType');
