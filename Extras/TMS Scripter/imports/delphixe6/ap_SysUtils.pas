...
type
  TatSysUtilsLibrary = class(TatScripterLibrary)
    ...
    procedure __ExceptionDestroy(AMachine: TatVirtualMachine);
    procedure __ExceptionGetBaseException(AMachine: TatVirtualMachine);
    procedure __ExceptionToString(AMachine: TatVirtualMachine);
    procedure __ExceptionRaiseOuterException(AMachine: TatVirtualMachine);
    procedure __ExceptionThrowOuterException(AMachine: TatVirtualMachine);
    procedure __GetExceptionBaseException(AMachine: TatVirtualMachine);
    ...
    procedure __GetExceptionInnerException(AMachine: TatVirtualMachine);
    procedure __GetExceptionMessage(AMachine: TatVirtualMachine);
    procedure __SetExceptionMessage(AMachine: TatVirtualMachine);
    procedure __GetExceptionStackTrace(AMachine: TatVirtualMachine);
    ...
    procedure __TEncodingFreeEncodings(AMachine: TatVirtualMachine);
    procedure __TEncodingIsStandardEncoding(AMachine: TatVirtualMachine);
    procedure __TEncodingGetByteCount(AMachine: TatVirtualMachine);
    procedure __TEncodingGetEncoding(AMachine: TatVirtualMachine);
    procedure __TEncodingGetMaxByteCount(AMachine: TatVirtualMachine);
    procedure __TEncodingGetMaxCharCount(AMachine: TatVirtualMachine);
    procedure __GetTEncodingASCII(AMachine: TatVirtualMachine);
    procedure __GetTEncodingBigEndianUnicode(AMachine: TatVirtualMachine);
    procedure __GetTEncodingDefault(AMachine: TatVirtualMachine);
    procedure __GetTEncodingIsSingleByte(AMachine: TatVirtualMachine);
    procedure __GetTEncodingUnicode(AMachine: TatVirtualMachine);
    procedure __GetTEncodingUTF7(AMachine: TatVirtualMachine);
    procedure __GetTEncodingUTF8(AMachine: TatVirtualMachine);
    procedure __TMBCSEncodingCreate(AMachine: TatVirtualMachine);
    procedure __TMBCSEncodingGetMaxByteCount(AMachine: TatVirtualMachine);
    procedure __TMBCSEncodingGetMaxCharCount(AMachine: TatVirtualMachine);
    procedure __TUTF7EncodingCreate(AMachine: TatVirtualMachine);
    procedure __TUTF7EncodingGetMaxByteCount(AMachine: TatVirtualMachine);
    procedure __TUTF7EncodingGetMaxCharCount(AMachine: TatVirtualMachine);
    procedure __TUTF8EncodingCreate(AMachine: TatVirtualMachine);
    procedure __TUTF8EncodingGetMaxByteCount(AMachine: TatVirtualMachine);
    procedure __TUTF8EncodingGetMaxCharCount(AMachine: TatVirtualMachine);
    procedure __TUnicodeEncodingCreate(AMachine: TatVirtualMachine);
    procedure __TUnicodeEncodingGetMaxByteCount(AMachine: TatVirtualMachine);
    procedure __TUnicodeEncodingGetMaxCharCount(AMachine: TatVirtualMachine);
    ...
    procedure __UIntToStr(AMachine: TatVirtualMachine);
    ...
    procedure __TextPos(AMachine: TatVirtualMachine);
    ...
    procedure __AnsiStrAlloc(AMachine: TatVirtualMachine);
    procedure __WideStrAlloc(AMachine: TatVirtualMachine);
    ...
    procedure __HashName(AMachine: TatVirtualMachine);
    ...
    procedure __ElementToCharLen(AMachine: TatVirtualMachine);
    procedure __CharToByteLen(AMachine: TatVirtualMachine);
    procedure __CharToElementLen(AMachine: TatVirtualMachine);
    procedure __ByteToCharIndex(AMachine: TatVirtualMachine);
    procedure __ElementToCharIndex(AMachine: TatVirtualMachine);
    procedure __CharToByteIndex(AMachine: TatVirtualMachine);
    procedure __CharToElementIndex(AMachine: TatVirtualMachine);
    ...
    procedure __IsLeadChar(AMachine: TatVirtualMachine);
    ...
    procedure __ByteLength(AMachine: TatVirtualMachine);
    ...
    procedure __GetEmptyAnsiStr(AMachine: TatVirtualMachine);
    procedure __SetEmptyAnsiStr(AMachine: TatVirtualMachine);
  ...
  EArgumentExceptionClass = class of EArgumentException;
  EArgumentOutOfRangeExceptionClass = class of EArgumentOutOfRangeException;
  ENoConstructExceptionClass = class of ENoConstructException;
  ...
  EMonitorClass = class of EMonitor;
  EMonitorLockExceptionClass = class of EMonitorLockException;
  ENoMonitorSupportExceptionClass = class of ENoMonitorSupportException;
  EProgrammerNotFoundClass = class of EProgrammerNotFound;
  ...
  EEncodingErrorClass = class of EEncodingError;
  TEncodingClass = class of TEncoding;
  TMBCSEncodingClass = class of TMBCSEncoding;
  TUTF7EncodingClass = class of TUTF7Encoding;
  TUTF8EncodingClass = class of TUTF8Encoding;
  TUnicodeEncodingClass = class of TUnicodeEncoding;
  TBigEndianUnicodeEncodingClass = class of TBigEndianUnicodeEncoding;
  ...
  TCharSearchWrapper = class(TatRecordWrapper)
  private
  public
    constructor Create(ARecord: TCharSearch);
    function ObjToRec: TCharSearch;
  published
  end;
...
constructor TCharSearchWrapper.Create(ARecord: TCharSearch);
begin
  inherited Create;
end;

function TCharSearchWrapper.ObjToRec: TCharSearch;
begin
end;
...
procedure TatSysUtilsLibrary.__ExceptionDestroy(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    Exception(CurrentObject).Destroy;
  end;
end;

procedure TatSysUtilsLibrary.__ExceptionGetBaseException(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := ObjectToVar(Exception(CurrentObject).GetBaseException);
    ReturnOutputArg(AResult);
  end;
end;

procedure TatSysUtilsLibrary.__ExceptionToString(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := string(Exception(CurrentObject).ToString);
    ReturnOutputArg(AResult);
  end;
end;

procedure TatSysUtilsLibrary.__ExceptionRaiseOuterException(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ExceptionClass(CurrentClass.ClassRef).RaiseOuterException(Exception(VarToObject(GetInputArg(0))));
  end;
end;

procedure TatSysUtilsLibrary.__ExceptionThrowOuterException(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ExceptionClass(CurrentClass.ClassRef).ThrowOuterException(Exception(VarToObject(GetInputArg(0))));
  end;
end;

procedure TatSysUtilsLibrary.__GetExceptionBaseException(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(Exception(CurrentObject).BaseException));
  end;
end;
...
procedure TatSysUtilsLibrary.__GetExceptionInnerException(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(Exception(CurrentObject).InnerException));
  end;
end;
...
procedure TatSysUtilsLibrary.__GetExceptionStackTrace(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(string(Exception(CurrentObject).StackTrace));
  end;
end;
...
procedure TatSysUtilsLibrary.__TEncodingFreeEncodings(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TEncodingClass(CurrentClass.ClassRef).FreeEncodings;
  end;
end;

procedure TatSysUtilsLibrary.__TEncodingIsStandardEncoding(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := TEncodingClass(CurrentClass.ClassRef).IsStandardEncoding(TEncoding(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatSysUtilsLibrary.__TEncodingGetByteCount(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(TEncoding(CurrentObject).GetByteCount(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatSysUtilsLibrary.__TEncodingGetEncoding(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := ObjectToVar(TEncodingClass(CurrentClass.ClassRef).GetEncoding(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatSysUtilsLibrary.__TEncodingGetMaxByteCount(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(TEncoding(CurrentObject).GetMaxByteCount(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatSysUtilsLibrary.__TEncodingGetMaxCharCount(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(TEncoding(CurrentObject).GetMaxCharCount(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatSysUtilsLibrary.__GetTEncodingASCII(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TEncoding(CurrentObject).ASCII));
  end;
end;

procedure TatSysUtilsLibrary.__GetTEncodingBigEndianUnicode(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TEncoding(CurrentObject).BigEndianUnicode));
  end;
end;

procedure TatSysUtilsLibrary.__GetTEncodingDefault(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TEncoding(CurrentObject).Default));
  end;
end;

procedure TatSysUtilsLibrary.__GetTEncodingIsSingleByte(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(TEncoding(CurrentObject).IsSingleByte);
  end;
end;

procedure TatSysUtilsLibrary.__GetTEncodingUnicode(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TEncoding(CurrentObject).Unicode));
  end;
end;

procedure TatSysUtilsLibrary.__GetTEncodingUTF7(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TEncoding(CurrentObject).UTF7));
  end;
end;

procedure TatSysUtilsLibrary.__GetTEncodingUTF8(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TEncoding(CurrentObject).UTF8));
  end;
end;

procedure TatSysUtilsLibrary.__TMBCSEncodingCreate(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := ObjectToVar(TMBCSEncodingClass(CurrentClass.ClassRef).Create);
    ReturnOutputArg(AResult);
  end;
end;

procedure TatSysUtilsLibrary.__TMBCSEncodingGetMaxByteCount(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(TMBCSEncoding(CurrentObject).GetMaxByteCount(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatSysUtilsLibrary.__TMBCSEncodingGetMaxCharCount(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(TMBCSEncoding(CurrentObject).GetMaxCharCount(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatSysUtilsLibrary.__TUTF7EncodingCreate(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := ObjectToVar(TUTF7EncodingClass(CurrentClass.ClassRef).Create);
    ReturnOutputArg(AResult);
  end;
end;

procedure TatSysUtilsLibrary.__TUTF7EncodingGetMaxByteCount(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(TUTF7Encoding(CurrentObject).GetMaxByteCount(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatSysUtilsLibrary.__TUTF7EncodingGetMaxCharCount(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(TUTF7Encoding(CurrentObject).GetMaxCharCount(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatSysUtilsLibrary.__TUTF8EncodingCreate(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := ObjectToVar(TUTF8EncodingClass(CurrentClass.ClassRef).Create);
    ReturnOutputArg(AResult);
  end;
end;

procedure TatSysUtilsLibrary.__TUTF8EncodingGetMaxByteCount(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(TUTF8Encoding(CurrentObject).GetMaxByteCount(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatSysUtilsLibrary.__TUTF8EncodingGetMaxCharCount(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(TUTF8Encoding(CurrentObject).GetMaxCharCount(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatSysUtilsLibrary.__TUnicodeEncodingCreate(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := ObjectToVar(TUnicodeEncodingClass(CurrentClass.ClassRef).Create);
    ReturnOutputArg(AResult);
  end;
end;

procedure TatSysUtilsLibrary.__TUnicodeEncodingGetMaxByteCount(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(TUnicodeEncoding(CurrentObject).GetMaxByteCount(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatSysUtilsLibrary.__TUnicodeEncodingGetMaxCharCount(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(TUnicodeEncoding(CurrentObject).GetMaxCharCount(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(SysUtils.AnsiStrComp(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(SysUtils.AnsiStrIComp(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(SysUtils.AnsiStrLComp(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(SysUtils.AnsiStrLIComp(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(SysUtils.AnsiStrLower(PAnsiChar(AnsiString(VarToStr(GetInputArg(0))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(SysUtils.AnsiStrUpper(PAnsiChar(AnsiString(VarToStr(GetInputArg(0))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(SysUtils.AnsiStrLastChar(PAnsiChar(AnsiString(VarToStr(GetInputArg(0))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
Param0 := PAnsiChar(AnsiString(VarToStr(GetInputArg(0))));
AResult := SysUtils.AnsiExtractQuotedStr(Param0,AnsiString(VarToStr(GetInputArg(1)))[1]);
    ReturnOutputArg(AResult);
...
procedure TatSysUtilsLibrary.__UIntToStr(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := string(SysUtils.UIntToStr(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(SysUtils.StrLen(PAnsiChar(AnsiString(VarToStr(GetInputArg(0))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(SysUtils.StrEnd(PAnsiChar(AnsiString(VarToStr(GetInputArg(0))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(SysUtils.StrMove(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(SysUtils.StrCopy(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(SysUtils.StrECopy(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(SysUtils.StrLCopy(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(SysUtils.StrPCopy(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(SysUtils.StrPLCopy(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),GetInputArg(1),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(SysUtils.StrCat(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(SysUtils.StrLCat(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(SysUtils.StrComp(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(SysUtils.StrIComp(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(SysUtils.StrLComp(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(SysUtils.StrLIComp(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(SysUtils.StrScan(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),AnsiString(VarToStr(GetInputArg(1)))[1]));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(SysUtils.StrRScan(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),AnsiString(VarToStr(GetInputArg(1)))[1]));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatSysUtilsLibrary.__TextPos(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := string(SysUtils.TextPos(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(SysUtils.StrPos(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(SysUtils.StrUpper(PAnsiChar(AnsiString(VarToStr(GetInputArg(0))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(SysUtils.StrLower(PAnsiChar(AnsiString(VarToStr(GetInputArg(0))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := SysUtils.StrPas(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatSysUtilsLibrary.__AnsiStrAlloc(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := string(SysUtils.AnsiStrAlloc(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatSysUtilsLibrary.__WideStrAlloc(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := WideCharToString(SysUtils.WideStrAlloc(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(SysUtils.StrBufSize(PAnsiChar(AnsiString(VarToStr(GetInputArg(0))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(SysUtils.StrNew(PAnsiChar(AnsiString(VarToStr(GetInputArg(0))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    SysUtils.StrDispose(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))));
  end;
end;
...
begin
  ...
  begin
Param1 := GetInputArg(1);
AResult := Integer(SysUtils.FloatToText(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),Param1,TFloatValue(VarToInteger(GetInputArg(2))),TFloatFormat(VarToInteger(GetInputArg(3))),VarToInteger(GetInputArg(4)),VarToInteger(GetInputArg(5))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param1 := GetInputArg(1);
AResult := Integer(SysUtils.FloatToTextFmt(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),Param1,TFloatValue(VarToInteger(GetInputArg(2))),PAnsiChar(AnsiString(VarToStr(GetInputArg(3))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param1 := GetInputArg(1);
AResult := SysUtils.TextToFloat(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),Param1,TFloatValue(VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
    SetInputArg(1,Param1);
  end;
end;

procedure TatSysUtilsLibrary.__HashName(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(SysUtils.HashName(PAnsiChar(AnsiString(VarToStr(GetInputArg(0))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(SysUtils.ByteType(GetInputArg(0),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(SysUtils.StrByteType(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatSysUtilsLibrary.__ElementToCharLen(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(SysUtils.ElementToCharLen(GetInputArg(0),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatSysUtilsLibrary.__CharToElementLen(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(SysUtils.CharToElementLen(GetInputArg(0),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatSysUtilsLibrary.__ElementToCharIndex(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(SysUtils.ElementToCharIndex(GetInputArg(0),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatSysUtilsLibrary.__CharToElementIndex(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(SysUtils.CharToElementIndex(GetInputArg(0),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(SysUtils.StrCharLength(PAnsiChar(AnsiString(VarToStr(GetInputArg(0))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(SysUtils.StrNextChar(PAnsiChar(AnsiString(VarToStr(GetInputArg(0))))));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatSysUtilsLibrary.__IsLeadChar(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := SysUtils.IsLeadChar(AnsiString(VarToStr(GetInputArg(0)))[1]);
    ReturnOutputArg(AResult);
  end;
end;

procedure TatSysUtilsLibrary.__CharInSet(AMachine: TatVirtualMachine);
  var
  Param1: TSysCharSet;
  AResult: variant;
begin
...
AResult := SysUtils.CharInSet(AnsiString(VarToStr(GetInputArg(0)))[1],Param1);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(SysUtils.AnsiStrPos(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(SysUtils.AnsiStrRScan(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),AnsiString(VarToStr(GetInputArg(1)))[1]));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(SysUtils.AnsiStrScan(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),AnsiString(VarToStr(GetInputArg(1)))[1]));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatSysUtilsLibrary.__ByteLength(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(SysUtils.ByteLength(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatSysUtilsLibrary.__GetEmptyAnsiStr(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(SysUtils.EmptyAnsiStr);
  end;
end;

procedure TatSysUtilsLibrary.__SetEmptyAnsiStr(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    SysUtils.EmptyAnsiStr:=GetInputArg(0);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(SysUtils.FormatSettings.CurrencyString));
  end;
end;
...
begin
  with AMachine do
  begin
    SysUtils.FormatSettings.CurrencyString:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(SysUtils.FormatSettings.CurrencyFormat));
  end;
end;
...
begin
  with AMachine do
  begin
    SysUtils.FormatSettings.CurrencyFormat:=VarToInteger(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(SysUtils.FormatSettings.NegCurrFormat));
  end;
end;
...
begin
  with AMachine do
  begin
    SysUtils.FormatSettings.NegCurrFormat:=VarToInteger(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(SysUtils.FormatSettings.ThousandSeparator);
  end;
end;
...
begin
  with AMachine do
  begin
    SysUtils.FormatSettings.ThousandSeparator:=VarToStr(GetInputArg(0))[1];
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(SysUtils.FormatSettings.DecimalSeparator);
  end;
end;
...
begin
  with AMachine do
  begin
    SysUtils.FormatSettings.DecimalSeparator:=VarToStr(GetInputArg(0))[1];
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(SysUtils.FormatSettings.CurrencyDecimals));
  end;
end;
...
begin
  with AMachine do
  begin
    SysUtils.FormatSettings.CurrencyDecimals:=VarToInteger(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(SysUtils.FormatSettings.DateSeparator);
  end;
end;
...
begin
  with AMachine do
  begin
    SysUtils.FormatSettings.DateSeparator:=VarToStr(GetInputArg(0))[1];
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(SysUtils.FormatSettings.ShortDateFormat));
  end;
end;
...
begin
  with AMachine do
  begin
    SysUtils.FormatSettings.ShortDateFormat:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(SysUtils.FormatSettings.LongDateFormat));
  end;
end;
...
begin
  with AMachine do
  begin
    SysUtils.FormatSettings.LongDateFormat:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(SysUtils.FormatSettings.TimeSeparator);
  end;
end;
...
begin
  with AMachine do
  begin
    SysUtils.FormatSettings.TimeSeparator:=VarToStr(GetInputArg(0))[1];
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(SysUtils.FormatSettings.TimeAMString));
  end;
end;
...
begin
  with AMachine do
  begin
    SysUtils.FormatSettings.TimeAMString:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(SysUtils.FormatSettings.TimePMString));
  end;
end;
...
begin
  with AMachine do
  begin
    SysUtils.FormatSettings.TimePMString:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(SysUtils.FormatSettings.ShortTimeFormat));
  end;
end;
...
begin
  with AMachine do
  begin
    SysUtils.FormatSettings.ShortTimeFormat:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(SysUtils.FormatSettings.LongTimeFormat));
  end;
end;
...
begin
  with AMachine do
  begin
    SysUtils.FormatSettings.LongTimeFormat:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(SysUtils.FormatSettings.TwoDigitYearCenturyWindow));
  end;
end;
...
begin
  with AMachine do
  begin
    SysUtils.FormatSettings.TwoDigitYearCenturyWindow:=VarToInteger(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(SysUtils.FormatSettings.ListSeparator);
  end;
end;
...
begin
  with AMachine do
  begin
    SysUtils.FormatSettings.ListSeparator:=VarToStr(GetInputArg(0))[1];
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('Destroy',0,tkNone,nil,__ExceptionDestroy,false,0,'');
    DefineMethod('GetBaseException',0,tkClass,Exception,__ExceptionGetBaseException,false,0,'');
    DefineMethod('ToString',0,tkVariant,nil,__ExceptionToString,false,0,'');
    DefineMethod('RaiseOuterException',1,tkNone,nil,__ExceptionRaiseOuterException,true,0,'E: Exception');
    DefineMethod('ThrowOuterException',1,tkNone,nil,__ExceptionThrowOuterException,true,0,'E: Exception');
    DefineProp('BaseException',tkClass,__GetExceptionBaseException,nil,Exception,false,0);
    DefineProp('HelpContext',tkInteger,__GetExceptionHelpContext,__SetExceptionHelpContext,nil,false,0);
    DefineProp('InnerException',tkClass,__GetExceptionInnerException,nil,Exception,false,0);
    DefineProp('Message',tkVariant,__GetExceptionMessage,__SetExceptionMessage,nil,false,0);
    DefineProp('StackTrace',tkVariant,__GetExceptionStackTrace,nil,nil,false,0);
  end;
  With Scripter.DefineClass(EArgumentException) do
  begin
  end;
  With Scripter.DefineClass(EArgumentOutOfRangeException) do
  begin
  end;
  With Scripter.DefineClass(ENoConstructException) do
  begin
  end;
  ...
  With Scripter.DefineClass(EMonitor) do
  begin
  end;
  With Scripter.DefineClass(EMonitorLockException) do
  begin
  end;
  With Scripter.DefineClass(ENoMonitorSupportException) do
  begin
  end;
  With Scripter.DefineClass(EProgrammerNotFound) do
  begin
  end;
  ...
  With Scripter.DefineClass(EEncodingError) do
  begin
  end;
  With Scripter.DefineClass(TEncoding) do
  begin
    DefineMethod('FreeEncodings',0,tkNone,nil,__TEncodingFreeEncodings,true,0,'');
    DefineMethod('IsStandardEncoding',1,tkVariant,nil,__TEncodingIsStandardEncoding,true,0,'AEncoding: TEncoding');
    DefineMethod('GetByteCount',1,tkInteger,nil,__TEncodingGetByteCount,false,0,'S: string');
    DefineMethod('GetEncoding',1,tkClass,TEncoding,__TEncodingGetEncoding,true,0,'CodePage: Integer');
    DefineMethod('GetMaxByteCount',1,tkInteger,nil,__TEncodingGetMaxByteCount,false,0,'CharCount: Integer');
    DefineMethod('GetMaxCharCount',1,tkInteger,nil,__TEncodingGetMaxCharCount,false,0,'ByteCount: Integer');
    DefineProp('ASCII',tkClass,__GetTEncodingASCII,nil,TEncoding,false,0);
    DefineProp('BigEndianUnicode',tkClass,__GetTEncodingBigEndianUnicode,nil,TEncoding,false,0);
    DefineProp('Default',tkClass,__GetTEncodingDefault,nil,TEncoding,false,0);
    DefineProp('IsSingleByte',tkVariant,__GetTEncodingIsSingleByte,nil,nil,false,0);
    DefineProp('Unicode',tkClass,__GetTEncodingUnicode,nil,TEncoding,false,0);
    DefineProp('UTF7',tkClass,__GetTEncodingUTF7,nil,TEncoding,false,0);
    DefineProp('UTF8',tkClass,__GetTEncodingUTF8,nil,TEncoding,false,0);
  end;
  With Scripter.DefineClass(TMBCSEncoding) do
  begin
    DefineMethod('Create',0,tkClass,TMBCSEncoding,__TMBCSEncodingCreate,true,0,'');
    DefineMethod('GetMaxByteCount',1,tkInteger,nil,__TMBCSEncodingGetMaxByteCount,false,0,'CharCount: Integer');
    DefineMethod('GetMaxCharCount',1,tkInteger,nil,__TMBCSEncodingGetMaxCharCount,false,0,'ByteCount: Integer');
  end;
  With Scripter.DefineClass(TUTF7Encoding) do
  begin
    DefineMethod('Create',0,tkClass,TUTF7Encoding,__TUTF7EncodingCreate,true,0,'');
    DefineMethod('GetMaxByteCount',1,tkInteger,nil,__TUTF7EncodingGetMaxByteCount,false,0,'CharCount: Integer');
    DefineMethod('GetMaxCharCount',1,tkInteger,nil,__TUTF7EncodingGetMaxCharCount,false,0,'ByteCount: Integer');
  end;
  With Scripter.DefineClass(TUTF8Encoding) do
  begin
    DefineMethod('Create',0,tkClass,TUTF8Encoding,__TUTF8EncodingCreate,true,0,'');
    DefineMethod('GetMaxByteCount',1,tkInteger,nil,__TUTF8EncodingGetMaxByteCount,false,0,'CharCount: Integer');
    DefineMethod('GetMaxCharCount',1,tkInteger,nil,__TUTF8EncodingGetMaxCharCount,false,0,'ByteCount: Integer');
  end;
  With Scripter.DefineClass(TUnicodeEncoding) do
  begin
    DefineMethod('Create',0,tkClass,TUnicodeEncoding,__TUnicodeEncodingCreate,true,0,'');
    DefineMethod('GetMaxByteCount',1,tkInteger,nil,__TUnicodeEncodingGetMaxByteCount,false,0,'CharCount: Integer');
    DefineMethod('GetMaxCharCount',1,tkInteger,nil,__TUnicodeEncodingGetMaxCharCount,false,0,'ByteCount: Integer');
  end;
  With Scripter.DefineClass(TBigEndianUnicodeEncoding) do
  begin
  end;
  ...
  begin
    ...
    DefineMethod('AppendStr',2,tkNone,nil,__AppendStr,false,0,'Dest: AnsiString; S: AnsiString').SetVarArgs([0]);
    ...
    DefineMethod('AnsiStrComp',2,tkInteger,nil,__AnsiStrComp,false,0,'S1: PAnsiChar; S2: PAnsiChar');
    DefineMethod('AnsiStrIComp',2,tkInteger,nil,__AnsiStrIComp,false,0,'S1: PAnsiChar; S2: PAnsiChar');
    DefineMethod('AnsiStrLComp',3,tkInteger,nil,__AnsiStrLComp,false,0,'S1: PAnsiChar; S2: PAnsiChar; MaxLen: Cardinal');
    DefineMethod('AnsiStrLIComp',3,tkInteger,nil,__AnsiStrLIComp,false,0,'S1: PAnsiChar; S2: PAnsiChar; MaxLen: Cardinal');
    DefineMethod('AnsiStrLower',1,tkVariant,nil,__AnsiStrLower,false,0,'Str: PAnsiChar');
    DefineMethod('AnsiStrUpper',1,tkVariant,nil,__AnsiStrUpper,false,0,'Str: PAnsiChar');
    DefineMethod('AnsiLastChar',1,tkVariant,nil,__AnsiLastChar,false,0,'S: AnsiString');
    DefineMethod('AnsiStrLastChar',1,tkVariant,nil,__AnsiStrLastChar,false,0,'P: PAnsiChar');
    ...
    DefineMethod('AnsiExtractQuotedStr',2,tkVariant,nil,__AnsiExtractQuotedStr,false,0,'Src: PAnsiChar; Quote: AnsiChar').SetVarArgs([0]);
    ...
    DefineMethod('UIntToStr',1,tkVariant,nil,__UIntToStr,false,0,'Value: Cardinal');
    ...
    DefineMethod('StrLen',1,tkInteger,nil,__StrLen,false,0,'Str: PAnsiChar');
    DefineMethod('StrEnd',1,tkVariant,nil,__StrEnd,false,0,'Str: PAnsiChar');
    DefineMethod('StrMove',3,tkVariant,nil,__StrMove,false,0,'Dest: PAnsiChar; Source: PAnsiChar; Count: Cardinal');
    DefineMethod('StrCopy',2,tkVariant,nil,__StrCopy,false,0,'Dest: PAnsiChar; Source: PAnsiChar');
    DefineMethod('StrECopy',2,tkVariant,nil,__StrECopy,false,0,'Dest: PAnsiChar; Source: PAnsiChar');
    DefineMethod('StrLCopy',3,tkVariant,nil,__StrLCopy,false,0,'Dest: PAnsiChar; Source: PAnsiChar; MaxLen: Cardinal');
    DefineMethod('StrPCopy',2,tkVariant,nil,__StrPCopy,false,0,'Dest: PAnsiChar; Source: AnsiString');
    DefineMethod('StrPLCopy',3,tkVariant,nil,__StrPLCopy,false,0,'Dest: PAnsiChar; Source: AnsiString; MaxLen: Cardinal');
    DefineMethod('StrCat',2,tkVariant,nil,__StrCat,false,0,'Dest: PAnsiChar; Source: PAnsiChar');
    DefineMethod('StrLCat',3,tkVariant,nil,__StrLCat,false,0,'Dest: PAnsiChar; Source: PAnsiChar; MaxLen: Cardinal');
    DefineMethod('StrComp',2,tkInteger,nil,__StrComp,false,0,'Str1: PAnsiChar; Str2: PAnsiChar');
    DefineMethod('StrIComp',2,tkInteger,nil,__StrIComp,false,0,'Str1: PAnsiChar; Str2: PAnsiChar');
    DefineMethod('StrLComp',3,tkInteger,nil,__StrLComp,false,0,'Str1: PAnsiChar; Str2: PAnsiChar; MaxLen: Cardinal');
    DefineMethod('StrLIComp',3,tkInteger,nil,__StrLIComp,false,0,'Str1: PAnsiChar; Str2: PAnsiChar; MaxLen: Cardinal');
    DefineMethod('StrScan',2,tkVariant,nil,__StrScan,false,0,'Str: PAnsiChar; Chr: AnsiChar');
    DefineMethod('StrRScan',2,tkVariant,nil,__StrRScan,false,0,'Str: PAnsiChar; Chr: AnsiChar');
    DefineMethod('TextPos',2,tkVariant,nil,__TextPos,false,0,'Str: PAnsiChar; SubStr: PAnsiChar');
    DefineMethod('StrPos',2,tkVariant,nil,__StrPos,false,0,'Str1: PAnsiChar; Str2: PAnsiChar');
    DefineMethod('StrUpper',1,tkVariant,nil,__StrUpper,false,0,'Str: PAnsiChar');
    DefineMethod('StrLower',1,tkVariant,nil,__StrLower,false,0,'Str: PAnsiChar');
    DefineMethod('StrPas',1,tkVariant,nil,__StrPas,false,0,'Str: PAnsiChar');
    DefineMethod('AnsiStrAlloc',1,tkVariant,nil,__AnsiStrAlloc,false,0,'Size: Cardinal');
    DefineMethod('WideStrAlloc',1,tkVariant,nil,__WideStrAlloc,false,0,'Size: Cardinal');
    DefineMethod('StrAlloc',1,tkVariant,nil,__StrAlloc,false,0,'Size: Cardinal');
    DefineMethod('StrBufSize',1,tkInteger,nil,__StrBufSize,false,0,'Str: PAnsiChar');
    DefineMethod('StrNew',1,tkVariant,nil,__StrNew,false,0,'Str: PAnsiChar');
    DefineMethod('StrDispose',1,tkNone,nil,__StrDispose,false,0,'Str: PAnsiChar');
    ...
    DefineMethod('FloatToText',6,tkInteger,nil,__FloatToText,false,0,'BufferArg: PAnsiChar; Value; ValueType: TFloatValue; Format: TFloatFormat; Precision: Integer; Digits: Integer');
    ...
    DefineMethod('FloatToTextFmt',4,tkInteger,nil,__FloatToTextFmt,false,0,'Buf: PAnsiChar; Value; ValueType: TFloatValue; Format: PAnsiChar');
    ...
    DefineMethod('TextToFloat',3,tkVariant,nil,__TextToFloat,false,0,'Buffer: PAnsiChar; Value; ValueType: TFloatValue').SetVarArgs([1]);
    DefineMethod('HashName',1,tkInteger,nil,__HashName,false,0,'Name: PAnsiChar');
    ...
    DefineMethod('SysErrorMessage',1,tkVariant,nil,__SysErrorMessage,false,0,'ErrorCode: Cardinal');
    ...
    DefineMethod('ByteType',2,tkEnumeration,nil,__ByteType,false,0,'S: AnsiString; Index: Integer');
    DefineMethod('StrByteType',2,tkEnumeration,nil,__StrByteType,false,0,'Str: PAnsiChar; Index: Cardinal');
    DefineMethod('ByteToCharLen',2,tkInteger,nil,__ByteToCharLen,false,0,'S: AnsiString; MaxLen: Integer');
    DefineMethod('ElementToCharLen',2,tkInteger,nil,__ElementToCharLen,false,0,'S: AnsiString; MaxLen: Integer');
    DefineMethod('CharToByteLen',2,tkInteger,nil,__CharToByteLen,false,0,'S: AnsiString; MaxLen: Integer');
    DefineMethod('CharToElementLen',2,tkInteger,nil,__CharToElementLen,false,0,'S: AnsiString; MaxLen: Integer');
    DefineMethod('ByteToCharIndex',2,tkInteger,nil,__ByteToCharIndex,false,0,'S: AnsiString; Index: Integer');
    DefineMethod('ElementToCharIndex',2,tkInteger,nil,__ElementToCharIndex,false,0,'S: AnsiString; Index: Integer');
    DefineMethod('CharToByteIndex',2,tkInteger,nil,__CharToByteIndex,false,0,'S: AnsiString; Index: Integer');
    DefineMethod('CharToElementIndex',2,tkInteger,nil,__CharToElementIndex,false,0,'S: AnsiString; Index: Integer');
    DefineMethod('StrCharLength',1,tkInteger,nil,__StrCharLength,false,0,'Str: PAnsiChar');
    DefineMethod('StrNextChar',1,tkVariant,nil,__StrNextChar,false,0,'Str: PAnsiChar');
    DefineMethod('CharLength',2,tkInteger,nil,__CharLength,false,0,'S: AnsiString; Index: Integer');
    DefineMethod('NextCharIndex',2,tkInteger,nil,__NextCharIndex,false,0,'S: UnicodeString; Index: Integer');
    DefineMethod('IsLeadChar',1,tkVariant,nil,__IsLeadChar,false,0,'C: AnsiChar');
    ...
    DefineMethod('AnsiStrPos',2,tkVariant,nil,__AnsiStrPos,false,0,'Str: PAnsiChar; SubStr: PAnsiChar');
    DefineMethod('AnsiStrRScan',2,tkVariant,nil,__AnsiStrRScan,false,0,'Str: PAnsiChar; Chr: AnsiChar');
    DefineMethod('AnsiStrScan',2,tkVariant,nil,__AnsiStrScan,false,0,'Str: PAnsiChar; Chr: AnsiChar');
    ...
    DefineMethod('ByteLength',1,tkInteger,nil,__ByteLength,false,0,'S: string');
    ...
    DefineProp('EmptyAnsiStr',tkVariant,__GetEmptyAnsiStr,__SetEmptyAnsiStr,nil,false,0);
    ...
    AddConstant('faNormal',faNormal);
    AddConstant('faTemporary',faTemporary);
    ...
    AddConstant('SecsPerHour',SecsPerHour);
