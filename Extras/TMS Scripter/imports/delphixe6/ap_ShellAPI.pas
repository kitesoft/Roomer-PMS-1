...
AResult := Integer(ShellAPI.DragQueryFile(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)),VarToInteger(GetInputArg(3))));
...
begin
  with AMachine do
  begin
AResult := Integer(ShellAPI.DragQueryFileA(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),PAnsiChar(AnsiString(VarToStr(GetInputArg(2)))),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
AResult := Integer(ShellAPI.DragQueryFileW(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := Integer(ShellAPI.ShellExecute(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)),StringToWideChar(VarToStr(GetInputArg(3)),@Param3Buf[0],Length(Param3Buf)),StringToWideChar(VarToStr(GetInputArg(4)),@Param4Buf[0],Length(Param4Buf)),VarToInteger(GetInputArg(5))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(ShellAPI.ShellExecuteA(VarToInteger(GetInputArg(0)),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(2)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(3)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(4)))),VarToInteger(GetInputArg(5))));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
AResult := Integer(ShellAPI.FindExecutable(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(ShellAPI.FindExecutableA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(2))))));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
AResult := Integer(ShellAPI.FindExecutableW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
AResult := Integer(ShellAPI.ShellAbout(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(ShellAPI.ShellAboutA(VarToInteger(GetInputArg(0)),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(2)))),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
AResult := Integer(ShellAPI.ShellAboutW(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := Integer(ShellAPI.ExtractAssociatedIcon(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),Param2));
    ReturnOutputArg(AResult);
...
begin
  ...
  begin
Param2 := VarToInteger(GetInputArg(2));
AResult := Integer(ShellAPI.ExtractAssociatedIconA(VarToInteger(GetInputArg(0)),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),Param2));
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
  end;
end;
...
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
Param2 := VarToInteger(GetInputArg(2));
AResult := Integer(ShellAPI.ExtractAssociatedIconW(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),Param2));
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
  end;
end;
...
AResult := Integer(ShellAPI.ExtractAssociatedIconEx(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),Param2,Param3));
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
...
Param2 := VarToInteger(GetInputArg(2));
Param3 := VarToInteger(GetInputArg(3));
AResult := Integer(ShellAPI.ExtractAssociatedIconExA(VarToInteger(GetInputArg(0)),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),Param2,Param3));
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
    SetInputArg(3,Integer(Param3));
  end;
...
Param2 := VarToInteger(GetInputArg(2));
Param3 := VarToInteger(GetInputArg(3));
AResult := Integer(ShellAPI.ExtractAssociatedIconExW(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),Param2,Param3));
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
    SetInputArg(3,Integer(Param3));
  end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(ShellAPI.ExtractIcon(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(ShellAPI.ExtractIconA(VarToInteger(GetInputArg(0)),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(ShellAPI.ExtractIconW(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Integer(ShellAPI.DoEnvironmentSubst(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(ShellAPI.DoEnvironmentSubstA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Integer(ShellAPI.DoEnvironmentSubstW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
Param2 := VarToInteger(GetInputArg(2));
Param3 := VarToInteger(GetInputArg(3));
AResult := Integer(ShellAPI.ExtractIconEx(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)),Param2,Param3,VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
    SetInputArg(3,Integer(Param3));
  end;
...
Param2 := VarToInteger(GetInputArg(2));
Param3 := VarToInteger(GetInputArg(3));
AResult := Integer(ShellAPI.ExtractIconExA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),VarToInteger(GetInputArg(1)),Param2,Param3,VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
    SetInputArg(3,Integer(Param3));
  end;
...
Param2 := VarToInteger(GetInputArg(2));
Param3 := VarToInteger(GetInputArg(3));
AResult := Integer(ShellAPI.ExtractIconExW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)),Param2,Param3,VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
    SetInputArg(3,Integer(Param3));
  end;
...
AResult := Integer(ShellAPI.SHEvaluateSystemCommandTemplate(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),Param1,Param2,Param3));
    ReturnOutputArg(AResult);
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(ShellAPI.SHEmptyRecycleBin(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(ShellAPI.SHEmptyRecycleBinA(VarToInteger(GetInputArg(0)),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(ShellAPI.SHEmptyRecycleBinW(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := Integer(ShellAPI.SHQueryUserNotificationState(Param0));
    ReturnOutputArg(AResult);
...
AResult := Integer(ShellAPI.Shell_NotifyIconGetRect(Param0,Param1));
    ReturnOutputArg(AResult);
...
AResult := Integer(ShellAPI.SHGetFileInfo(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)),Param2,VarToInteger(GetInputArg(3)),VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
...
AResult := Integer(ShellAPI.SHGetFileInfoA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),VarToInteger(GetInputArg(1)),Param2,VarToInteger(GetInputArg(3)),VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
...
if not Assigned(Param2Rec) or not (Param2Rec is _SHFILEINFOWWrapper) then 
  Param2Rec := _SHFILEINFOWWrapper.Create(Param2);
Param2 := _SHFILEINFOWWrapper(Param2Rec).ObjToRec;
AResult := Integer(ShellAPI.SHGetFileInfoW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)),Param2,VarToInteger(GetInputArg(3)),VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
    SetInputArg(2,integer(_SHFILEINFOWWrapper.Create(Param2)));
  end;
end;
...
AResult := Integer(ShellAPI.SHGetStockIconInfo(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),Param2));
    ReturnOutputArg(AResult);
...
AResult := ShellAPI.SHGetDiskFreeSpace(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),Param1,Param2,Param3);
    ReturnOutputArg(AResult);
...
if not Assigned(Param3Rec) or not (Param3Rec is ULARGE_INTEGERWrapper) then 
  Param3Rec := ULARGE_INTEGERWrapper.Create(Param3);
Param3 := ULARGE_INTEGERWrapper(Param3Rec).ObjToRec;
AResult := ShellAPI.SHGetDiskFreeSpaceA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),Param1,Param2,Param3);
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(ULARGE_INTEGERWrapper.Create(Param1)));
    SetInputArg(2,integer(ULARGE_INTEGERWrapper.Create(Param2)));
    SetInputArg(3,integer(ULARGE_INTEGERWrapper.Create(Param3)));
...
if not Assigned(Param3Rec) or not (Param3Rec is ULARGE_INTEGERWrapper) then 
  Param3Rec := ULARGE_INTEGERWrapper.Create(Param3);
Param3 := ULARGE_INTEGERWrapper(Param3Rec).ObjToRec;
AResult := ShellAPI.SHGetDiskFreeSpaceW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),Param1,Param2,Param3);
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(ULARGE_INTEGERWrapper.Create(Param1)));
    SetInputArg(2,integer(ULARGE_INTEGERWrapper.Create(Param2)));
    SetInputArg(3,integer(ULARGE_INTEGERWrapper.Create(Param3)));
...
if not Assigned(Param3Rec) or not (Param3Rec is ULARGE_INTEGERWrapper) then 
  Param3Rec := ULARGE_INTEGERWrapper.Create(Param3);
Param3 := ULARGE_INTEGERWrapper(Param3Rec).ObjToRec;
AResult := ShellAPI.SHGetDiskFreeSpaceEx(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),Param1,Param2,Param3);
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(ULARGE_INTEGERWrapper.Create(Param1)));
    SetInputArg(2,integer(ULARGE_INTEGERWrapper.Create(Param2)));
    SetInputArg(3,integer(ULARGE_INTEGERWrapper.Create(Param3)));
...
if not Assigned(Param3Rec) or not (Param3Rec is ULARGE_INTEGERWrapper) then 
  Param3Rec := ULARGE_INTEGERWrapper.Create(Param3);
Param3 := ULARGE_INTEGERWrapper(Param3Rec).ObjToRec;
AResult := ShellAPI.SHGetDiskFreeSpaceExA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),Param1,Param2,Param3);
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(ULARGE_INTEGERWrapper.Create(Param1)));
    SetInputArg(2,integer(ULARGE_INTEGERWrapper.Create(Param2)));
    SetInputArg(3,integer(ULARGE_INTEGERWrapper.Create(Param3)));
...
if not Assigned(Param3Rec) or not (Param3Rec is ULARGE_INTEGERWrapper) then 
  Param3Rec := ULARGE_INTEGERWrapper.Create(Param3);
Param3 := ULARGE_INTEGERWrapper(Param3Rec).ObjToRec;
AResult := ShellAPI.SHGetDiskFreeSpaceExW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),Param1,Param2,Param3);
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(ULARGE_INTEGERWrapper.Create(Param1)));
    SetInputArg(2,integer(ULARGE_INTEGERWrapper.Create(Param2)));
    SetInputArg(3,integer(ULARGE_INTEGERWrapper.Create(Param3)));
...
AResult := ShellAPI.SHGetNewLinkInfo(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)),Param3,VarToInteger(GetInputArg(4)));
    ReturnOutputArg(AResult);
...
begin
  ...
  begin
Param3 := GetInputArg(3);
AResult := ShellAPI.SHGetNewLinkInfoA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(2)))),Param3,VarToInteger(GetInputArg(4)));
    ReturnOutputArg(AResult);
    SetInputArg(3,Param3);
  end;
end;
...
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
Param3 := GetInputArg(3);
AResult := ShellAPI.SHGetNewLinkInfoW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)),Param3,VarToInteger(GetInputArg(4)));
    ReturnOutputArg(AResult);
    SetInputArg(3,Param3);
  end;
end;
...
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
SetLength(Param3Buf, Length(VarToStr(GetInputArg(3))) + 1);
AResult := ShellAPI.SHInvokePrinterCommand(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)),StringToWideChar(VarToStr(GetInputArg(3)),@Param3Buf[0],Length(Param3Buf)),GetInputArg(4));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ShellAPI.SHInvokePrinterCommandA(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),PAnsiChar(AnsiString(VarToStr(GetInputArg(2)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(3)))),GetInputArg(4));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
SetLength(Param3Buf, Length(VarToStr(GetInputArg(3))) + 1);
AResult := ShellAPI.SHInvokePrinterCommandW(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)),StringToWideChar(VarToStr(GetInputArg(3)),@Param3Buf[0],Length(Param3Buf)),GetInputArg(4));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(ShellAPI.SHLoadNonloadedIconOverlayIdentifiers);
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(ShellAPI.SHSetLocalizedName(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Integer(ShellAPI.SHRemoveLocalizedName(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
Param3 := VarToInteger(GetInputArg(3));
AResult := Integer(ShellAPI.SHGetLocalizedName(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2)),Param3));
    ReturnOutputArg(AResult);
    SetInputArg(3,Integer(Param3));
  end;
end;
...
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
SetLength(Param3Buf, Length(VarToStr(GetInputArg(3))) + 1);
AResult := Integer(ShellAPI.ShellMessageBox(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)),StringToWideChar(VarToStr(GetInputArg(3)),@Param3Buf[0],Length(Param3Buf)),VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(ShellAPI.ShellMessageBoxA(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),PAnsiChar(AnsiString(VarToStr(GetInputArg(2)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(3)))),VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
SetLength(Param3Buf, Length(VarToStr(GetInputArg(3))) + 1);
AResult := Integer(ShellAPI.ShellMessageBoxW(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)),StringToWideChar(VarToStr(GetInputArg(3)),@Param3Buf[0],Length(Param3Buf)),VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := ShellAPI.IsLFNDrive(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ShellAPI.IsLFNDriveA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := ShellAPI.IsLFNDriveW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
AResult := Integer(ShellAPI.SHEnumerateUnreadMailAccounts(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(ShellAPI.SHEnumerateUnreadMailAccountsA(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),PAnsiChar(AnsiString(VarToStr(GetInputArg(2)))),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
AResult := Integer(ShellAPI.SHEnumerateUnreadMailAccountsW(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param4Buf, Length(VarToStr(GetInputArg(4))) + 1);
AResult := Integer(ShellAPI.SHGetUnreadMailCount(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),Param2,Param3,StringToWideChar(VarToStr(GetInputArg(4)),@Param4Buf[0],Length(Param4Buf)),VarToInteger(GetInputArg(5))));
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
...
if not Assigned(Param3Rec) or not (Param3Rec is _FILETIMEWrapper) then 
  Param3Rec := _FILETIMEWrapper.Create(Param3);
Param3 := _FILETIMEWrapper(Param3Rec).ObjToRec;
AResult := Integer(ShellAPI.SHGetUnreadMailCountA(VarToInteger(GetInputArg(0)),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),Param2,Param3,PAnsiChar(AnsiString(VarToStr(GetInputArg(4)))),VarToInteger(GetInputArg(5))));
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
    SetInputArg(3,integer(_FILETIMEWrapper.Create(Param3)));
  end;
...
Param3 := _FILETIMEWrapper(Param3Rec).ObjToRec;
SetLength(Param4Buf, Length(VarToStr(GetInputArg(4))) + 1);
AResult := Integer(ShellAPI.SHGetUnreadMailCountW(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),Param2,Param3,StringToWideChar(VarToStr(GetInputArg(4)),@Param4Buf[0],Length(Param4Buf)),VarToInteger(GetInputArg(5))));
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
    SetInputArg(3,integer(_FILETIMEWrapper.Create(Param3)));
  end;
...
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
AResult := Integer(ShellAPI.SHSetUnreadMailCount(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(ShellAPI.SHSetUnreadMailCountA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),VarToInteger(GetInputArg(1)),PAnsiChar(AnsiString(VarToStr(GetInputArg(2))))));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
AResult := Integer(ShellAPI.SHSetUnreadMailCountW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(ShellAPI.SHTestTokenMembership(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := Integer(ShellAPI.SHGetDriveMedia(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),Param1));
    ReturnOutputArg(AResult);
...
begin
  ...
  begin
    DefineMethod('DragQueryFile',4,tkInteger,nil,__DragQueryFile,false,0,'Drop: HDROP; FileIndex: UINT; FileName: PWideChar; cb: UINT');
    DefineMethod('DragQueryFileA',4,tkInteger,nil,__DragQueryFileA,false,0,'Drop: HDROP; FileIndex: UINT; FileName: PAnsiChar; cb: UINT');
    DefineMethod('DragQueryFileW',4,tkInteger,nil,__DragQueryFileW,false,0,'Drop: HDROP; FileIndex: UINT; FileName: PWideChar; cb: UINT');
    DefineMethod('DragQueryPoint',2,tkVariant,nil,__DragQueryPoint,false,0,'Drop: HDROP; Point: TPoint').SetVarArgs([1]);
    DefineMethod('DragFinish',1,tkNone,nil,__DragFinish,false,0,'Drop: HDROP');
    DefineMethod('DragAcceptFiles',2,tkNone,nil,__DragAcceptFiles,false,0,'Wnd: HWND; Accept: BOOL');
    DefineMethod('ShellExecute',6,tkInteger,nil,__ShellExecute,false,0,'hWnd: HWND; Operation: PWideChar; FileName: PWideChar; Parameters: PWideChar; Directory: PWideChar; ShowCmd: Integer');
    DefineMethod('ShellExecuteA',6,tkInteger,nil,__ShellExecuteA,false,0,'hWnd: HWND; Operation: PAnsiChar; FileName: PAnsiChar; Parameters: PAnsiChar; Directory: PAnsiChar; ShowCmd: Integer');
    DefineMethod('ShellExecuteW',6,tkInteger,nil,__ShellExecuteW,false,0,'hWnd: HWND; Operation: PWideChar; FileName: PWideChar; Parameters: PWideChar; Directory: PWideChar; ShowCmd: Integer');
    DefineMethod('FindExecutable',3,tkInteger,nil,__FindExecutable,false,0,'FileName: PWideChar; Directory: PWideChar; Result: PWideChar');
    DefineMethod('FindExecutableA',3,tkInteger,nil,__FindExecutableA,false,0,'FileName: PAnsiChar; Directory: PAnsiChar; Result: PAnsiChar');
    DefineMethod('FindExecutableW',3,tkInteger,nil,__FindExecutableW,false,0,'FileName: PWideChar; Directory: PWideChar; Result: PWideChar');
    DefineMethod('ShellAbout',4,tkInteger,nil,__ShellAbout,false,0,'Wnd: HWND; szApp: PWideChar; szOtherStuff: PWideChar; Icon: HICON');
    DefineMethod('ShellAboutA',4,tkInteger,nil,__ShellAboutA,false,0,'Wnd: HWND; szApp: PAnsiChar; szOtherStuff: PAnsiChar; Icon: HICON');
    DefineMethod('ShellAboutW',4,tkInteger,nil,__ShellAboutW,false,0,'Wnd: HWND; szApp: PWideChar; szOtherStuff: PWideChar; Icon: HICON');
    DefineMethod('DuplicateIcon',2,tkInteger,nil,__DuplicateIcon,false,0,'hInst: HINST; Icon: HICON');
    DefineMethod('ExtractAssociatedIcon',3,tkInteger,nil,__ExtractAssociatedIcon,false,0,'hInst: HINST; lpIconPath: PWideChar; lpiIcon: Word').SetVarArgs([2]);
    DefineMethod('ExtractAssociatedIconA',3,tkInteger,nil,__ExtractAssociatedIconA,false,0,'hInst: HINST; lpIconPath: PAnsiChar; lpiIcon: Word').SetVarArgs([2]);
    DefineMethod('ExtractAssociatedIconW',3,tkInteger,nil,__ExtractAssociatedIconW,false,0,'hInst: HINST; lpIconPath: PWideChar; lpiIcon: Word').SetVarArgs([2]);
    DefineMethod('ExtractAssociatedIconEx',4,tkInteger,nil,__ExtractAssociatedIconEx,false,0,'hInst: HINST; pszIconPath: PWideChar; piIconIndex: WORD; piIconID: WORD').SetVarArgs([2,3]);
    DefineMethod('ExtractAssociatedIconExA',4,tkInteger,nil,__ExtractAssociatedIconExA,false,0,'hInst: HINST; pszIconPath: PAnsiChar; piIconIndex: WORD; piIconID: WORD').SetVarArgs([2,3]);
    DefineMethod('ExtractAssociatedIconExW',4,tkInteger,nil,__ExtractAssociatedIconExW,false,0,'hInst: HINST; pszIconPath: PWideChar; piIconIndex: WORD; piIconID: WORD').SetVarArgs([2,3]);
    DefineMethod('ExtractIcon',3,tkInteger,nil,__ExtractIcon,false,0,'hInst: HINST; lpszExeFileName: PWideChar; nIconIndex: UINT');
    DefineMethod('ExtractIconA',3,tkInteger,nil,__ExtractIconA,false,0,'hInst: HINST; lpszExeFileName: PAnsiChar; nIconIndex: UINT');
    DefineMethod('ExtractIconW',3,tkInteger,nil,__ExtractIconW,false,0,'hInst: HINST; lpszExeFileName: PWideChar; nIconIndex: UINT');
    DefineMethod('SHAppBarMessage',2,tkInteger,nil,__SHAppBarMessage,false,0,'dwMessage: DWORD; pData: TAppBarData').SetVarArgs([1]);
    DefineMethod('DoEnvironmentSubst',2,tkInteger,nil,__DoEnvironmentSubst,false,0,'szString: PWideChar; cbString: UINT');
    DefineMethod('DoEnvironmentSubstA',2,tkInteger,nil,__DoEnvironmentSubstA,false,0,'szString: PAnsiChar; cbString: UINT');
    DefineMethod('DoEnvironmentSubstW',2,tkInteger,nil,__DoEnvironmentSubstW,false,0,'szString: PWideChar; cbString: UINT');
    DefineMethod('ExtractIconEx',5,tkInteger,nil,__ExtractIconEx,false,0,'lpszFile: PWideChar; nIconIndex: Integer; phiconLarge: HICON; phiconSmall: HICON; nIcons: UINT').SetVarArgs([2,3]);
    DefineMethod('ExtractIconExA',5,tkInteger,nil,__ExtractIconExA,false,0,'lpszFile: PAnsiChar; nIconIndex: Integer; phiconLarge: HICON; phiconSmall: HICON; nIcons: UINT').SetVarArgs([2,3]);
    DefineMethod('ExtractIconExW',5,tkInteger,nil,__ExtractIconExW,false,0,'lpszFile: PWideChar; nIconIndex: Integer; phiconLarge: HICON; phiconSmall: HICON; nIcons: UINT').SetVarArgs([2,3]);
    DefineMethod('SHFileOperation',1,tkInteger,nil,__SHFileOperation,false,0,'lpFileOp: TSHFileOpStruct');
    DefineMethod('SHFileOperationA',1,tkInteger,nil,__SHFileOperationA,false,0,'lpFileOp: TSHFileOpStructA');
    DefineMethod('SHFileOperationW',1,tkInteger,nil,__SHFileOperationW,false,0,'lpFileOp: TSHFileOpStructW');
    DefineMethod('SHFreeNameMappings',1,tkNone,nil,__SHFreeNameMappings,false,0,'hNameMappings: THandle');
    DefineMethod('SHCreateProcessAsUserW',1,tkVariant,nil,__SHCreateProcessAsUserW,false,0,'pscpi: TSHCreateProcessInfoW').SetVarArgs([0]);
    DefineMethod('SHEvaluateSystemCommandTemplate',4,tkInteger,nil,__SHEvaluateSystemCommandTemplate,false,0,'pszCmdTemplate: LPCWSTR; ppszApplication: LPWSTR; ppszCommandLine: LPWSTR; ppszParameters: LPWSTR').SetVarArgs([1,2,3]);
    DefineMethod('SHEmptyRecycleBin',3,tkInteger,nil,__SHEmptyRecycleBin,false,0,'hwnd: HWND; pszRootPath: PWideChar; dwFlags: DWORD');
    DefineMethod('SHEmptyRecycleBinA',3,tkInteger,nil,__SHEmptyRecycleBinA,false,0,'hwnd: HWND; pszRootPath: PAnsiChar; dwFlags: DWORD');
    DefineMethod('SHEmptyRecycleBinW',3,tkInteger,nil,__SHEmptyRecycleBinW,false,0,'hwnd: HWND; pszRootPath: PWideChar; dwFlags: DWORD');
    DefineMethod('SHQueryUserNotificationState',1,tkInteger,nil,__SHQueryUserNotificationState,false,0,'pquns: QUERY_USER_NOTIFICATION_STATE').SetVarArgs([0]);
    DefineMethod('Shell_NotifyIconGetRect',2,tkInteger,nil,__Shell_NotifyIconGetRect,false,0,'identifier: NOTIFYICONIDENTIFIER; iconLocation: TRect').SetVarArgs([0,1]);
    DefineMethod('SHGetFileInfo',5,tkInteger,nil,__SHGetFileInfo,false,0,'pszPath: PWideChar; dwFileAttributes: DWORD; psfi: TSHFileInfo; cbFileInfo: UINT; uFlags: UINT').SetVarArgs([2]);
    DefineMethod('SHGetFileInfoA',5,tkInteger,nil,__SHGetFileInfoA,false,0,'pszPath: PAnsiChar; dwFileAttributes: DWORD; psfi: TSHFileInfoA; cbFileInfo: UINT; uFlags: UINT').SetVarArgs([2]);
    DefineMethod('SHGetFileInfoW',5,tkInteger,nil,__SHGetFileInfoW,false,0,'pszPath: PWideChar; dwFileAttributes: DWORD; psfi: TSHFileInfoW; cbFileInfo: UINT; uFlags: UINT').SetVarArgs([2]);
    DefineMethod('SHGetStockIconInfo',3,tkInteger,nil,__SHGetStockIconInfo,false,0,'siid: SHSTOCKICONID; uFlags: UINT; psii: TSHStockIconInfo').SetVarArgs([2]);
    DefineMethod('SHGetDiskFreeSpace',4,tkVariant,nil,__SHGetDiskFreeSpace,false,0,'pszDirectoryName: PWideChar; pulFreeBytesAvailableToCaller: ULARGE_INTEGER; pulTotalNumberOfBytes: ULARGE_INTEGER; pulTotalNumberOfFreeBytes: ULARGE_INTEGER').SetVarArgs([1,2,3]);
    DefineMethod('SHGetDiskFreeSpaceA',4,tkVariant,nil,__SHGetDiskFreeSpaceA,false,0,'pszDirectoryName: PAnsiChar; pulFreeBytesAvailableToCaller: ULARGE_INTEGER; pulTotalNumberOfBytes: ULARGE_INTEGER; pulTotalNumberOfFreeBytes: ULARGE_INTEGER').SetVarArgs([1,2,3]);
    DefineMethod('SHGetDiskFreeSpaceW',4,tkVariant,nil,__SHGetDiskFreeSpaceW,false,0,'pszDirectoryName: PWideChar; pulFreeBytesAvailableToCaller: ULARGE_INTEGER; pulTotalNumberOfBytes: ULARGE_INTEGER; pulTotalNumberOfFreeBytes: ULARGE_INTEGER').SetVarArgs([1,2,3]);
    DefineMethod('SHGetDiskFreeSpaceEx',4,tkVariant,nil,__SHGetDiskFreeSpaceEx,false,0,'pszDirectoryName: PWideChar; pulFreeBytesAvailableToCaller: ULARGE_INTEGER; pulTotalNumberOfBytes: ULARGE_INTEGER; pulTotalNumberOfFreeBytes: ULARGE_INTEGER').SetVarArgs([1,2,3]);
    DefineMethod('SHGetDiskFreeSpaceExA',4,tkVariant,nil,__SHGetDiskFreeSpaceExA,false,0,'pszDirectoryName: PAnsiChar; pulFreeBytesAvailableToCaller: ULARGE_INTEGER; pulTotalNumberOfBytes: ULARGE_INTEGER; pulTotalNumberOfFreeBytes: ULARGE_INTEGER').SetVarArgs([1,2,3]);
    DefineMethod('SHGetDiskFreeSpaceExW',4,tkVariant,nil,__SHGetDiskFreeSpaceExW,false,0,'pszDirectoryName: PWideChar; pulFreeBytesAvailableToCaller: ULARGE_INTEGER; pulTotalNumberOfBytes: ULARGE_INTEGER; pulTotalNumberOfFreeBytes: ULARGE_INTEGER').SetVarArgs([1,2,3]);
    DefineMethod('SHGetNewLinkInfo',5,tkVariant,nil,__SHGetNewLinkInfo,false,0,'pszLinkTo: PWideChar; pszDir: PWideChar; pszName: PWideChar; pfMustCopy: BOOL; uFlags: UINT').SetVarArgs([3]);
    DefineMethod('SHGetNewLinkInfoA',5,tkVariant,nil,__SHGetNewLinkInfoA,false,0,'pszLinkTo: PAnsiChar; pszDir: PAnsiChar; pszName: PAnsiChar; pfMustCopy: BOOL; uFlags: UINT').SetVarArgs([3]);
    DefineMethod('SHGetNewLinkInfoW',5,tkVariant,nil,__SHGetNewLinkInfoW,false,0,'pszLinkTo: PWideChar; pszDir: PWideChar; pszName: PWideChar; pfMustCopy: BOOL; uFlags: UINT').SetVarArgs([3]);
    DefineMethod('SHInvokePrinterCommand',5,tkVariant,nil,__SHInvokePrinterCommand,false,0,'hwnd: HWND; uAction: UINT; lpBuf1: PWideChar; lpBuf2: PWideChar; fModal: BOOL');
    DefineMethod('SHInvokePrinterCommandA',5,tkVariant,nil,__SHInvokePrinterCommandA,false,0,'hwnd: HWND; uAction: UINT; lpBuf1: PAnsiChar; lpBuf2: PAnsiChar; fModal: BOOL');
    DefineMethod('SHInvokePrinterCommandW',5,tkVariant,nil,__SHInvokePrinterCommandW,false,0,'hwnd: HWND; uAction: UINT; lpBuf1: PWideChar; lpBuf2: PWideChar; fModal: BOOL');
    DefineMethod('SHLoadNonloadedIconOverlayIdentifiers',0,tkInteger,nil,__SHLoadNonloadedIconOverlayIdentifiers,false,0,'');
    DefineMethod('SHSetLocalizedName',3,tkInteger,nil,__SHSetLocalizedName,false,0,'pszPath: LPCWSTR; pszResModule: LPCWSTR; idsRes: Integer');
    DefineMethod('SHRemoveLocalizedName',1,tkInteger,nil,__SHRemoveLocalizedName,false,0,'pszPath: LPCWSTR');
    DefineMethod('SHGetLocalizedName',4,tkInteger,nil,__SHGetLocalizedName,false,0,'pszPath: LPCWSTR; pszResModule: LPWSTR; cch: UINT; pidsRes: Integer').SetVarArgs([3]);
    DefineMethod('ShellMessageBox',5,tkInteger,nil,__ShellMessageBox,false,0,'hAppInst: HINST; hWnd: HWND; pcText: PWideChar; lpcTitle: PWideChar; fuStyle: UINT');
    DefineMethod('ShellMessageBoxA',5,tkInteger,nil,__ShellMessageBoxA,false,0,'hAppInst: HINST; hWnd: HWND; pcText: PAnsiChar; lpcTitle: PAnsiChar; fuStyle: UINT');
    DefineMethod('ShellMessageBoxW',5,tkInteger,nil,__ShellMessageBoxW,false,0,'hAppInst: HINST; hWnd: HWND; pcText: PWideChar; lpcTitle: PWideChar; fuStyle: UINT');
    DefineMethod('IsLFNDrive',1,tkVariant,nil,__IsLFNDrive,false,0,'pszPath: PWideChar');
    DefineMethod('IsLFNDriveA',1,tkVariant,nil,__IsLFNDriveA,false,0,'pszPath: PAnsiChar');
    DefineMethod('IsLFNDriveW',1,tkVariant,nil,__IsLFNDriveW,false,0,'pszPath: PWideChar');
    DefineMethod('SHEnumerateUnreadMailAccounts',4,tkInteger,nil,__SHEnumerateUnreadMailAccounts,false,0,'hKeyUser: HKEY; dwIndex: DWORD; pszMailAddress: PWideChar; cchMailAddress: Integer');
    DefineMethod('SHEnumerateUnreadMailAccountsA',4,tkInteger,nil,__SHEnumerateUnreadMailAccountsA,false,0,'hKeyUser: HKEY; dwIndex: DWORD; pszMailAddress: PAnsiChar; cchMailAddress: Integer');
    DefineMethod('SHEnumerateUnreadMailAccountsW',4,tkInteger,nil,__SHEnumerateUnreadMailAccountsW,false,0,'hKeyUser: HKEY; dwIndex: DWORD; pszMailAddress: PWideChar; cchMailAddress: Integer');
    DefineMethod('SHGetUnreadMailCount',6,tkInteger,nil,__SHGetUnreadMailCount,false,0,'hKeyUser: HKEY; pszMailAddress: PWideChar; pdwCount: DWORD; pFileTime: FILETIME; pszShellExecuteCommand: PWideChar; cchShellExecuteCommand: Integer').SetVarArgs([2,3]);
    DefineMethod('SHGetUnreadMailCountA',6,tkInteger,nil,__SHGetUnreadMailCountA,false,0,'hKeyUser: HKEY; pszMailAddress: PAnsiChar; pdwCount: DWORD; pFileTime: FILETIME; pszShellExecuteCommand: PAnsiChar; cchShellExecuteCommand: Integer').SetVarArgs([2,3]);
    DefineMethod('SHGetUnreadMailCountW',6,tkInteger,nil,__SHGetUnreadMailCountW,false,0,'hKeyUser: HKEY; pszMailAddress: PWideChar; pdwCount: DWORD; pFileTime: FILETIME; pszShellExecuteCommand: PWideChar; cchShellExecuteCommand: Integer').SetVarArgs([2,3]);
    DefineMethod('SHSetUnreadMailCount',3,tkInteger,nil,__SHSetUnreadMailCount,false,0,'pszMailAddress: PWideChar; dwCount: DWORD; pszShellExecuteCommand: PWideChar');
    DefineMethod('SHSetUnreadMailCountA',3,tkInteger,nil,__SHSetUnreadMailCountA,false,0,'pszMailAddress: PAnsiChar; dwCount: DWORD; pszShellExecuteCommand: PAnsiChar');
    DefineMethod('SHSetUnreadMailCountW',3,tkInteger,nil,__SHSetUnreadMailCountW,false,0,'pszMailAddress: PWideChar; dwCount: DWORD; pszShellExecuteCommand: PWideChar');
    DefineMethod('SHTestTokenMembership',2,tkInteger,nil,__SHTestTokenMembership,false,0,'hToken: THandle; ulRID: ULONG');
    DefineMethod('InitNetworkAddressControl',0,tkVariant,nil,__InitNetworkAddressControl,false,0,'');
    DefineMethod('SHGetDriveMedia',2,tkInteger,nil,__SHGetDriveMedia,false,0,'pszDrive: LPCWSTR; pdwMediaContent: DWORD').SetVarArgs([1]);
