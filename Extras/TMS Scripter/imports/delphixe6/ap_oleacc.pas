...
type
  TatoleaccLibrary = class(TatScripterLibrary)
    ...
    procedure __CreateStdAccessibleProxyA(AMachine: TatVirtualMachine);
    procedure __CreateStdAccessibleProxyW(AMachine: TatVirtualMachine);
...
AResult := Integer(oleacc.CreateStdAccessibleProxy(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2)),TGUIDWrapper(integer(GetInputArg(3))).ObjToRec,Param4));
    ReturnOutputArg(AResult);
    SetInputArg(4,Param4);
  end;
end;

procedure TatoleaccLibrary.__CreateStdAccessibleProxyA(AMachine: TatVirtualMachine);
  var
  Param4: Variant;
  AResult: variant;
begin
  ...
  begin
Param4 := GetInputArg(4);
AResult := Integer(oleacc.CreateStdAccessibleProxyA(VarToInteger(GetInputArg(0)),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2)),TGUIDWrapper(integer(GetInputArg(3))).ObjToRec,Param4));
    ReturnOutputArg(AResult);
    SetInputArg(4,Param4);
  end;
end;

procedure TatoleaccLibrary.__CreateStdAccessibleProxyW(AMachine: TatVirtualMachine);
  var
  Param1Buf: array of WideChar;
  Param4: Variant;
  AResult: variant;
...
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
Param4 := GetInputArg(4);
AResult := Integer(oleacc.CreateStdAccessibleProxyW(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2)),TGUIDWrapper(integer(GetInputArg(3))).ObjToRec,Param4));
    ReturnOutputArg(AResult);
    SetInputArg(4,Param4);
  end;
end;
...
begin
  ...
  begin
    DefineMethod('ObjectFromLresult',4,tkInteger,nil,__ObjectFromLresult,false,0,'lResult: LRESULT; riid: TGUID; wParam: WPARAM; ppvObject').SetVarArgs([3]);
    DefineMethod('AccessibleObjectFromWindow',4,tkInteger,nil,__AccessibleObjectFromWindow,false,0,'hwnd: THandle; dwId: DWORD; riid: TGUID; ppvObject').SetVarArgs([3]);
    DefineMethod('CreateStdAccessibleProxy',5,tkInteger,nil,__CreateStdAccessibleProxy,false,0,'hwnd: THandle; pClassName: PWideChar; idObject: LongInt; riid: TGUID; ppvObject').SetVarArgs([4]);
    DefineMethod('CreateStdAccessibleProxyA',5,tkInteger,nil,__CreateStdAccessibleProxyA,false,0,'hwnd: THandle; pClassName: PAnsiChar; idObject: LongInt; riid: TGUID; ppvObject').SetVarArgs([4]);
    DefineMethod('CreateStdAccessibleProxyW',5,tkInteger,nil,__CreateStdAccessibleProxyW,false,0,'hwnd: THandle; pClassName: PWideChar; idObject: LongInt; riid: TGUID; ppvObject').SetVarArgs([4]);
