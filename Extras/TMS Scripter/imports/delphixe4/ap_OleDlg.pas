...
begin
  ...
  begin
    DefineMethod('OleUIInsertObject',1,tkInteger,nil,__OleUIInsertObject,false,0,'Info: TOleUIInsertObject').SetVarArgs([0]);
    DefineMethod('OleUIInsertObjectA',1,tkInteger,nil,__OleUIInsertObjectA,false,0,'Info: TOleUIInsertObjectA').SetVarArgs([0]);
    DefineMethod('OleUIInsertObjectW',1,tkInteger,nil,__OleUIInsertObjectW,false,0,'Info: TOleUIInsertObjectW').SetVarArgs([0]);
    DefineMethod('OleUIPasteSpecial',1,tkInteger,nil,__OleUIPasteSpecial,false,0,'Info: TOleUIPasteSpecial').SetVarArgs([0]);
    DefineMethod('OleUIPasteSpecialA',1,tkInteger,nil,__OleUIPasteSpecialA,false,0,'Info: TOleUIPasteSpecialA').SetVarArgs([0]);
    DefineMethod('OleUIPasteSpecialW',1,tkInteger,nil,__OleUIPasteSpecialW,false,0,'Info: TOleUIPasteSpecialW').SetVarArgs([0]);
    DefineMethod('OleUIEditLinks',1,tkInteger,nil,__OleUIEditLinks,false,0,'Info: TOleUIEditLinks').SetVarArgs([0]);
    DefineMethod('OleUIEditLinksA',1,tkInteger,nil,__OleUIEditLinksA,false,0,'Info: TOleUIEditLinksA').SetVarArgs([0]);
    DefineMethod('OleUIEditLinksW',1,tkInteger,nil,__OleUIEditLinksW,false,0,'Info: TOleUIEditLinksW').SetVarArgs([0]);
    DefineMethod('OleUIChangeIcon',1,tkInteger,nil,__OleUIChangeIcon,false,0,'Info: TOleUIChangeIcon').SetVarArgs([0]);
    DefineMethod('OleUIChangeIconA',1,tkInteger,nil,__OleUIChangeIconA,false,0,'Info: TOleUIChangeIconA').SetVarArgs([0]);
    DefineMethod('OleUIChangeIconW',1,tkInteger,nil,__OleUIChangeIconW,false,0,'Info: TOleUIChangeIconW').SetVarArgs([0]);
    DefineMethod('OleUIConvert',1,tkInteger,nil,__OleUIConvert,false,0,'Info: TOleUIConvert').SetVarArgs([0]);
    DefineMethod('OleUIConvertA',1,tkInteger,nil,__OleUIConvertA,false,0,'Info: TOleUIConvertA').SetVarArgs([0]);
    DefineMethod('OleUIConvertW',1,tkInteger,nil,__OleUIConvertW,false,0,'Info: TOleUIConvertW').SetVarArgs([0]);
    DefineMethod('OleUICanConvertOrActivateAs',3,tkVariant,nil,__OleUICanConvertOrActivateAs,false,0,'clsid: TCLSID; fIsLinkedObject: BOOL; wFormat: Word');
    DefineMethod('OleUIBusy',1,tkInteger,nil,__OleUIBusy,false,0,'Info: TOleUIBusy').SetVarArgs([0]);
    DefineMethod('OleUIBusyA',1,tkInteger,nil,__OleUIBusyA,false,0,'Info: TOleUIBusyA').SetVarArgs([0]);
    DefineMethod('OleUIBusyW',1,tkInteger,nil,__OleUIBusyW,false,0,'Info: TOleUIBusyW').SetVarArgs([0]);
    DefineMethod('OleUIObjectProperties',1,tkInteger,nil,__OleUIObjectProperties,false,0,'Info: TOleUIObjectProps').SetVarArgs([0]);
    DefineMethod('OleUIObjectPropertiesA',1,tkInteger,nil,__OleUIObjectPropertiesA,false,0,'Info: TOleUIObjectPropsA').SetVarArgs([0]);
    DefineMethod('OleUIObjectPropertiesW',1,tkInteger,nil,__OleUIObjectPropertiesW,false,0,'Info: TOleUIObjectPropsW').SetVarArgs([0]);
