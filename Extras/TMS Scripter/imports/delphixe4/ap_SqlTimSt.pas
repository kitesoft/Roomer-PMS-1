...
begin
  ...
  begin
    ...
    DefineMethod('LocalToUTC',1,tkVariant,nil,__LocalToUTC,false,0,'Value: TSQLTimeStamp').SetVarArgs([0]);
    DefineMethod('UTCToLocal',1,tkVariant,nil,__UTCToLocal,false,0,'Value: TSQLTimeStamp').SetVarArgs([0]);
