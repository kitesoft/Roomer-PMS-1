...
begin
  with AMachine do
  begin
AResult := Integer(Mapi.MapiSendDocuments(VarToInteger(GetInputArg(0)),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(2)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(3)))),VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Mapi.MapiFindNext(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),PAnsiChar(AnsiString(VarToStr(GetInputArg(2)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(3)))),VarToInteger(GetInputArg(4)),VarToInteger(GetInputArg(5)),PAnsiChar(AnsiString(VarToStr(GetInputArg(6))))));
    ReturnOutputArg(AResult);
  end;
end;
...
if not Assigned(Param2Rec) or not (Param2Rec is MapiMessageWrapper) then 
  Param2Rec := MapiMessageWrapper.Create(Param2);
Param2 := MapiMessageWrapper(Param2Rec).ObjToRec;
AResult := Integer(Mapi.MapiSaveMail(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),Param2,VarToInteger(GetInputArg(3)),VarToInteger(GetInputArg(4)),PAnsiChar(AnsiString(VarToStr(GetInputArg(5))))));
    ReturnOutputArg(AResult);
    SetInputArg(2,integer(MapiMessageWrapper.Create(Param2)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Mapi.MapiDeleteMail(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),PAnsiChar(AnsiString(VarToStr(GetInputArg(2)))),VarToInteger(GetInputArg(3)),VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(Mapi.MAPIDLL));
  end;
end;
...
begin
  with AMachine do
  begin
    Mapi.MAPIDLL:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  ...
  begin
    DefineMethod('MapiLogOff',4,tkInteger,nil,__MapiLogOff,false,0,'lhSession: LHANDLE; ulUIParam: Cardinal; flFlags: FLAGS; ulReserved: Cardinal');
    DefineMethod('MapiSendMail',5,tkInteger,nil,__MapiSendMail,false,0,'lhSession: LHANDLE; ulUIParam: Cardinal; lpMessage: TMapiMessage; flFlags: FLAGS; ulReserved: Cardinal').SetVarArgs([2]);
    DefineMethod('MapiSendDocuments',5,tkInteger,nil,__MapiSendDocuments,false,0,'ulUIParam: Cardinal; lpszDelimChar: PAnsiChar; lpszFilePaths: PAnsiChar; lpszFileNames: PAnsiChar; ulReserved: Cardinal');
    DefineMethod('MapiFindNext',7,tkInteger,nil,__MapiFindNext,false,0,'lhSession: LHANDLE; ulUIParam: Cardinal; lpszMessageType: PAnsiChar; lpszSeedMessageID: PAnsiChar; flFlags: FLAGS; ulReserved: Cardinal; lpszMessageID: PAnsiChar');
    DefineMethod('MapiSaveMail',6,tkInteger,nil,__MapiSaveMail,false,0,'lhSession: LHANDLE; ulUIParam: Cardinal; lpMessage: TMapiMessage; flFlags: FLAGS; ulReserved: Cardinal; lpszMessageID: PAnsiChar').SetVarArgs([2]);
    DefineMethod('MapiDeleteMail',5,tkInteger,nil,__MapiDeleteMail,false,0,'lhSession: LHANDLE; ulUIParam: Cardinal; lpszMessageID: PAnsiChar; flFlags: FLAGS; ulReserved: Cardinal');
    DefineMethod('MapiDetails',5,tkInteger,nil,__MapiDetails,false,0,'lhSession: LHANDLE; ulUIParam: Cardinal; lpRecip: TMapiRecipDesc; flFlags: FLAGS; ulReserved: Cardinal').SetVarArgs([2]);
