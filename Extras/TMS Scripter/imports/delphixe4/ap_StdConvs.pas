...
begin
  ...
  begin
    DefineMethod('FahrenheitToCelsius',1,tkVariant,nil,__FahrenheitToCelsius,false,0,'AValue: Double');
    DefineMethod('CelsiusToFahrenheit',1,tkVariant,nil,__CelsiusToFahrenheit,false,0,'AValue: Double');
