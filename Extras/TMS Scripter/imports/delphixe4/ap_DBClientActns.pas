...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TReconcileActionLink(CurrentObject).ApplyAction));
  end;
end;
...
begin
  with AMachine do
  begin
    TReconcileActionLink(CurrentObject).ApplyAction:=TClientDataSetApply(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TClientDataSetApplyClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
...
begin
  with AMachine do
  begin
    TClientDataSetApply(CurrentObject).ExecuteTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TClientDataSetApply(CurrentObject).UpdateTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TClientDataSetRevert(CurrentObject).ExecuteTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TClientDataSetRevert(CurrentObject).UpdateTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TClientDataSetUndo(CurrentObject).ExecuteTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TClientDataSetUndo(CurrentObject).UpdateTarget(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  ...
  begin
    DefineMethod('Create',1,tkClass,TClientDataSetApply,__TClientDataSetApplyCreate,true,0,'Owner: TComponent');
    DefineMethod('Destroy',0,tkNone,nil,__TClientDataSetApplyDestroy,false,0,'');
    DefineMethod('ExecuteTarget',1,tkNone,nil,__TClientDataSetApplyExecuteTarget,false,0,'Target: TObject');
    DefineMethod('UpdateTarget',1,tkNone,nil,__TClientDataSetApplyUpdateTarget,false,0,'Target: TObject');
  end;
  With Scripter.DefineClass(TClientDataSetRevert) do
  begin
    DefineMethod('ExecuteTarget',1,tkNone,nil,__TClientDataSetRevertExecuteTarget,false,0,'Target: TObject');
    DefineMethod('UpdateTarget',1,tkNone,nil,__TClientDataSetRevertUpdateTarget,false,0,'Target: TObject');
  end;
  With Scripter.DefineClass(TClientDataSetUndo) do
  begin
    DefineMethod('ExecuteTarget',1,tkNone,nil,__TClientDataSetUndoExecuteTarget,false,0,'Target: TObject');
    DefineMethod('UpdateTarget',1,tkNone,nil,__TClientDataSetUndoUpdateTarget,false,0,'Target: TObject');
  end;
