...
type
  TatStdCtrlsLibrary = class(TatScripterLibrary)
    ...
    procedure __GetTCustomLabelGlowSize(AMachine: TatVirtualMachine);
    procedure __SetTCustomLabelGlowSize(AMachine: TatVirtualMachine);
    ...
    procedure __TCustomEditGetControlsAlignment(AMachine: TatVirtualMachine);
    ...
    procedure __TCustomEditSetSelText(AMachine: TatVirtualMachine);
    ...
    procedure __GetTCustomEditAlignment(AMachine: TatVirtualMachine);
    procedure __SetTCustomEditAlignment(AMachine: TatVirtualMachine);
    ...
    procedure __GetTCustomEditTextHint(AMachine: TatVirtualMachine);
    procedure __SetTCustomEditTextHint(AMachine: TatVirtualMachine);
    ...
    procedure __TCustomComboBoxStringsCreate(AMachine: TatVirtualMachine);
    procedure __TCustomComboBoxStringsDestroy(AMachine: TatVirtualMachine);
    ...
    procedure __TCustomComboGetCount(AMachine: TatVirtualMachine);
    ...
    procedure __GetTCustomComboBoxTextHint(AMachine: TatVirtualMachine);
    procedure __SetTCustomComboBoxTextHint(AMachine: TatVirtualMachine);
    procedure __TButtonControlCreate(AMachine: TatVirtualMachine);
    procedure __TImageMarginsAssign(AMachine: TatVirtualMachine);
    procedure __TCustomButtonCreate(AMachine: TatVirtualMachine);
    procedure __TCustomButtonDestroy(AMachine: TatVirtualMachine);
    procedure __TCustomButtonClick(AMachine: TatVirtualMachine);
    procedure __TCustomButtonUseRightToLeftAlignment(AMachine: TatVirtualMachine);
    procedure __GetTCustomButtonCancel(AMachine: TatVirtualMachine);
    procedure __SetTCustomButtonCancel(AMachine: TatVirtualMachine);
    procedure __GetTCustomButtonCommandLinkHint(AMachine: TatVirtualMachine);
    procedure __SetTCustomButtonCommandLinkHint(AMachine: TatVirtualMachine);
    procedure __GetTCustomButtonDefault(AMachine: TatVirtualMachine);
    procedure __SetTCustomButtonDefault(AMachine: TatVirtualMachine);
    procedure __GetTCustomButtonDisabledImageIndex(AMachine: TatVirtualMachine);
    procedure __SetTCustomButtonDisabledImageIndex(AMachine: TatVirtualMachine);
    procedure __GetTCustomButtonDropDownMenu(AMachine: TatVirtualMachine);
    procedure __SetTCustomButtonDropDownMenu(AMachine: TatVirtualMachine);
    procedure __GetTCustomButtonElevationRequired(AMachine: TatVirtualMachine);
    procedure __SetTCustomButtonElevationRequired(AMachine: TatVirtualMachine);
    procedure __GetTCustomButtonHotImageIndex(AMachine: TatVirtualMachine);
    procedure __SetTCustomButtonHotImageIndex(AMachine: TatVirtualMachine);
    procedure __GetTCustomButtonImages(AMachine: TatVirtualMachine);
    procedure __SetTCustomButtonImages(AMachine: TatVirtualMachine);
    procedure __GetTCustomButtonImageAlignment(AMachine: TatVirtualMachine);
    procedure __SetTCustomButtonImageAlignment(AMachine: TatVirtualMachine);
    procedure __GetTCustomButtonImageIndex(AMachine: TatVirtualMachine);
    procedure __SetTCustomButtonImageIndex(AMachine: TatVirtualMachine);
    procedure __GetTCustomButtonImageMargins(AMachine: TatVirtualMachine);
    procedure __SetTCustomButtonImageMargins(AMachine: TatVirtualMachine);
    procedure __GetTCustomButtonModalResult(AMachine: TatVirtualMachine);
    procedure __SetTCustomButtonModalResult(AMachine: TatVirtualMachine);
    procedure __GetTCustomButtonPressedImageIndex(AMachine: TatVirtualMachine);
    procedure __SetTCustomButtonPressedImageIndex(AMachine: TatVirtualMachine);
    procedure __GetTCustomButtonSelectedImageIndex(AMachine: TatVirtualMachine);
    procedure __SetTCustomButtonSelectedImageIndex(AMachine: TatVirtualMachine);
    procedure __GetTCustomButtonStyle(AMachine: TatVirtualMachine);
    procedure __SetTCustomButtonStyle(AMachine: TatVirtualMachine);
    procedure __GetTCustomButtonStylusHotImageIndex(AMachine: TatVirtualMachine);
    procedure __SetTCustomButtonStylusHotImageIndex(AMachine: TatVirtualMachine);
    ...
    procedure __TCustomListBoxGetCount(AMachine: TatVirtualMachine);
  ...
  TImageMarginsClass = class of TImageMargins;
  TPushButtonActionLinkClass = class of TPushButtonActionLink;
  TCustomButtonClass = class of TCustomButton;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomGroupBoxClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomLabelClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatStdCtrlsLibrary.__GetTCustomLabelGlowSize(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomLabel(CurrentObject).GlowSize));
  end;
end;

procedure TatStdCtrlsLibrary.__SetTCustomLabelGlowSize(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomLabel(CurrentObject).GlowSize:=VarToInteger(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomEditClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatStdCtrlsLibrary.__TCustomEditGetControlsAlignment(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(TCustomEdit(CurrentObject).GetControlsAlignment);
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatStdCtrlsLibrary.__TCustomEditSetSelText(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomEdit(CurrentObject).SetSelText(VarToStr(GetInputArg(0)));
  end;
end;
...
procedure TatStdCtrlsLibrary.__GetTCustomEditAlignment(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomEdit(CurrentObject).Alignment));
  end;
end;

procedure TatStdCtrlsLibrary.__SetTCustomEditAlignment(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomEdit(CurrentObject).Alignment:=TAlignment(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TCustomEdit(CurrentObject).SelText));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomEdit(CurrentObject).SelText:=VarToStr(GetInputArg(0));
  end;
end;

procedure TatStdCtrlsLibrary.__GetTCustomEditTextHint(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TCustomEdit(CurrentObject).TextHint));
  end;
end;

procedure TatStdCtrlsLibrary.__SetTCustomEditTextHint(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomEdit(CurrentObject).TextHint:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomMemoClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomMemo(CurrentObject).Lines));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomMemo(CurrentObject).Lines:=TStrings(VarToObject(GetInputArg(0)));
  end;
end;

procedure TatStdCtrlsLibrary.__TCustomComboBoxStringsCreate(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomComboBoxStringsClass(CurrentClass.ClassRef).Create);
    ReturnOutputArg(AResult);
  end;
end;

procedure TatStdCtrlsLibrary.__TCustomComboBoxStringsDestroy(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomComboBoxStrings(CurrentObject).Destroy;
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TCustomComboBoxStrings(CurrentObject).IndexOf(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomComboClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomCombo(CurrentObject).AddItem(VarToStr(GetInputArg(0)),TObject(VarToObject(GetInputArg(1))));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomCombo(CurrentObject).CopySelection(TCustomListControl(VarToObject(GetInputArg(0))));
  end;
end;
...
procedure TatStdCtrlsLibrary.__TCustomComboGetCount(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(TCustomCombo(CurrentObject).GetCount);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomCombo(CurrentObject).Canvas));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomCombo(CurrentObject).Items));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomCombo(CurrentObject).Items:=TStrings(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomComboBoxClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomComboBox(CurrentObject).CharCase));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomComboBox(CurrentObject).CharCase:=TEditCharCase(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TCustomComboBox(CurrentObject).SelText));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomComboBox(CurrentObject).SelText:=VarToStr(GetInputArg(0));
  end;
end;

procedure TatStdCtrlsLibrary.__GetTCustomComboBoxTextHint(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TCustomComboBox(CurrentObject).TextHint));
  end;
end;

procedure TatStdCtrlsLibrary.__SetTCustomComboBoxTextHint(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomComboBox(CurrentObject).TextHint:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TButtonControlClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatStdCtrlsLibrary.__TImageMarginsAssign(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TImageMargins(CurrentObject).Assign(TPersistent(VarToObject(GetInputArg(0))));
  end;
end;

procedure TatStdCtrlsLibrary.__TCustomButtonCreate(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomButtonClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatStdCtrlsLibrary.__TCustomButtonDestroy(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomButton(CurrentObject).Destroy;
  end;
end;

procedure TatStdCtrlsLibrary.__TCustomButtonClick(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomButton(CurrentObject).Click;
  end;
end;

procedure TatStdCtrlsLibrary.__TCustomButtonUseRightToLeftAlignment(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := TCustomButton(CurrentObject).UseRightToLeftAlignment;
    ReturnOutputArg(AResult);
  end;
end;

procedure TatStdCtrlsLibrary.__GetTCustomButtonCancel(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(TCustomButton(CurrentObject).Cancel);
  end;
end;

procedure TatStdCtrlsLibrary.__SetTCustomButtonCancel(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomButton(CurrentObject).Cancel:=GetInputArg(0);
  end;
end;

procedure TatStdCtrlsLibrary.__GetTCustomButtonCommandLinkHint(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TCustomButton(CurrentObject).CommandLinkHint));
  end;
end;

procedure TatStdCtrlsLibrary.__SetTCustomButtonCommandLinkHint(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomButton(CurrentObject).CommandLinkHint:=VarToStr(GetInputArg(0));
  end;
end;

procedure TatStdCtrlsLibrary.__GetTCustomButtonDefault(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(TCustomButton(CurrentObject).Default);
  end;
end;

procedure TatStdCtrlsLibrary.__SetTCustomButtonDefault(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomButton(CurrentObject).Default:=GetInputArg(0);
  end;
end;

procedure TatStdCtrlsLibrary.__GetTCustomButtonDisabledImageIndex(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomButton(CurrentObject).DisabledImageIndex));
  end;
end;

procedure TatStdCtrlsLibrary.__SetTCustomButtonDisabledImageIndex(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomButton(CurrentObject).DisabledImageIndex:=VarToInteger(GetInputArg(0));
  end;
end;

procedure TatStdCtrlsLibrary.__GetTCustomButtonDropDownMenu(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomButton(CurrentObject).DropDownMenu));
  end;
end;

procedure TatStdCtrlsLibrary.__SetTCustomButtonDropDownMenu(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomButton(CurrentObject).DropDownMenu:=TPopupMenu(VarToObject(GetInputArg(0)));
  end;
end;

procedure TatStdCtrlsLibrary.__GetTCustomButtonElevationRequired(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(TCustomButton(CurrentObject).ElevationRequired);
  end;
end;

procedure TatStdCtrlsLibrary.__SetTCustomButtonElevationRequired(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomButton(CurrentObject).ElevationRequired:=GetInputArg(0);
  end;
end;

procedure TatStdCtrlsLibrary.__GetTCustomButtonHotImageIndex(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomButton(CurrentObject).HotImageIndex));
  end;
end;

procedure TatStdCtrlsLibrary.__SetTCustomButtonHotImageIndex(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomButton(CurrentObject).HotImageIndex:=VarToInteger(GetInputArg(0));
  end;
end;

procedure TatStdCtrlsLibrary.__GetTCustomButtonImages(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomButton(CurrentObject).Images));
  end;
end;

procedure TatStdCtrlsLibrary.__SetTCustomButtonImages(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomButton(CurrentObject).Images:=TCustomImageList(VarToObject(GetInputArg(0)));
  end;
end;

procedure TatStdCtrlsLibrary.__GetTCustomButtonImageAlignment(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomButton(CurrentObject).ImageAlignment));
  end;
end;

procedure TatStdCtrlsLibrary.__SetTCustomButtonImageAlignment(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomButton(CurrentObject).ImageAlignment:=TImageAlignment(VarToInteger(GetInputArg(0)));
  end;
end;

procedure TatStdCtrlsLibrary.__GetTCustomButtonImageIndex(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomButton(CurrentObject).ImageIndex));
  end;
end;

procedure TatStdCtrlsLibrary.__SetTCustomButtonImageIndex(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomButton(CurrentObject).ImageIndex:=VarToInteger(GetInputArg(0));
  end;
end;

procedure TatStdCtrlsLibrary.__GetTCustomButtonImageMargins(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomButton(CurrentObject).ImageMargins));
  end;
end;

procedure TatStdCtrlsLibrary.__SetTCustomButtonImageMargins(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomButton(CurrentObject).ImageMargins:=TImageMargins(VarToObject(GetInputArg(0)));
  end;
end;

procedure TatStdCtrlsLibrary.__GetTCustomButtonModalResult(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomButton(CurrentObject).ModalResult));
  end;
end;

procedure TatStdCtrlsLibrary.__SetTCustomButtonModalResult(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomButton(CurrentObject).ModalResult:=TModalResult(VarToInteger(GetInputArg(0)));
  end;
end;

procedure TatStdCtrlsLibrary.__GetTCustomButtonPressedImageIndex(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomButton(CurrentObject).PressedImageIndex));
  end;
end;

procedure TatStdCtrlsLibrary.__SetTCustomButtonPressedImageIndex(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomButton(CurrentObject).PressedImageIndex:=VarToInteger(GetInputArg(0));
  end;
end;

procedure TatStdCtrlsLibrary.__GetTCustomButtonSelectedImageIndex(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomButton(CurrentObject).SelectedImageIndex));
  end;
end;

procedure TatStdCtrlsLibrary.__SetTCustomButtonSelectedImageIndex(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomButton(CurrentObject).SelectedImageIndex:=VarToInteger(GetInputArg(0));
  end;
end;

procedure TatStdCtrlsLibrary.__GetTCustomButtonStyle(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomButton(CurrentObject).Style));
  end;
end;

procedure TatStdCtrlsLibrary.__SetTCustomButtonStyle(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomButton(CurrentObject).Style:=GetInputArg(0);
  end;
end;

procedure TatStdCtrlsLibrary.__GetTCustomButtonStylusHotImageIndex(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomButton(CurrentObject).StylusHotImageIndex));
  end;
end;

procedure TatStdCtrlsLibrary.__SetTCustomButtonStylusHotImageIndex(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomButton(CurrentObject).StylusHotImageIndex:=VarToInteger(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomCheckBoxClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TCustomCheckBox(CurrentObject).GetControlsAlignment);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TRadioButtonClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TRadioButton(CurrentObject).GetControlsAlignment);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomListBoxClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomListBox(CurrentObject).AddItem(VarToStr(GetInputArg(0)),TObject(VarToObject(GetInputArg(1))));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomListBox(CurrentObject).CopySelection(TCustomListControl(VarToObject(GetInputArg(0))));
  end;
end;
...
procedure TatStdCtrlsLibrary.__TCustomListBoxGetCount(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(TCustomListBox(CurrentObject).GetCount);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomListBox(CurrentObject).Canvas));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomListBox(CurrentObject).Items));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomListBox(CurrentObject).Items:=TStrings(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TScrollBarClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomStaticTextClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    ...
    DataObjectTemp := ObjectToVar(DataObject);
    if Assigned(Scripter) and (RoutineName > '') then
      Scripter.ExecuteSubroutine(RoutineName, [Control,Index,DataObjectTemp]);
    DataObject := TObject(VarToObject(DataObjectTemp));
    if AssignedMethod(AfterCall) then
...
begin
  ...
  begin
    ...
    ScrollCodeTemp := Integer(ScrollCode);
...
begin
  ...
  begin
    DefineMethod('Create',1,tkClass,TCustomGroupBox,__TCustomGroupBoxCreate,true,0,'AOwner: TComponent');
  end;
  ...
  begin
    DefineMethod('Create',1,tkClass,TCustomLabel,__TCustomLabelCreate,true,0,'AOwner: TComponent');
    DefineProp('Caption',tkVariant,nil,nil,nil,false,0);
    DefineProp('Canvas',tkVariant,nil,nil,nil,false,0);
    DefineProp('GlowSize',tkInteger,__GetTCustomLabelGlowSize,__SetTCustomLabelGlowSize,nil,false,0);
  end;
  ...
  begin
    DefineMethod('Create',1,tkClass,TCustomEdit,__TCustomEditCreate,true,0,'AOwner: TComponent');
    ...
    DefineMethod('DefaultHandler',1,tkNone,nil,__TCustomEditDefaultHandler,false,0,'Message').SetVarArgs([0]);
    DefineMethod('GetControlsAlignment',0,tkEnumeration,nil,__TCustomEditGetControlsAlignment,false,0,'');
    ...
    DefineMethod('SetSelText',1,tkNone,nil,__TCustomEditSetSelText,false,0,'Value: string');
    DefineMethod('SelectAll',0,tkNone,nil,__TCustomEditSelectAll,false,0,'');
    DefineMethod('GetSelTextBuf',2,tkInteger,nil,__TCustomEditGetSelTextBuf,false,0,'Buffer: PChar; BufSize: Integer');
    DefineMethod('SetSelTextBuf',1,tkNone,nil,__TCustomEditSetSelTextBuf,false,0,'Buffer: PChar');
    DefineProp('Alignment',tkEnumeration,__GetTCustomEditAlignment,__SetTCustomEditAlignment,nil,false,0);
    ...
    DefineProp('TextHint',tkVariant,__GetTCustomEditTextHint,__SetTCustomEditTextHint,nil,false,0);
  end;
  ...
  begin
    DefineMethod('Create',1,tkClass,TCustomMemo,__TCustomMemoCreate,true,0,'AOwner: TComponent');
  ...
  begin
    DefineMethod('Create',0,tkClass,TCustomComboBoxStrings,__TCustomComboBoxStringsCreate,true,0,'');
    DefineMethod('Destroy',0,tkNone,nil,__TCustomComboBoxStringsDestroy,false,0,'');
    DefineMethod('Clear',0,tkNone,nil,__TCustomComboBoxStringsClear,false,0,'');
    DefineMethod('Delete',1,tkNone,nil,__TCustomComboBoxStringsDelete,false,0,'Index: Integer');
    DefineMethod('IndexOf',1,tkInteger,nil,__TCustomComboBoxStringsIndexOf,false,0,'S: string');
  end;
  With Scripter.DefineClass(TCustomCombo) do
  begin
    DefineMethod('Create',1,tkClass,TCustomCombo,__TCustomComboCreate,true,0,'AOwner: TComponent');
    DefineMethod('Destroy',0,tkNone,nil,__TCustomComboDestroy,false,0,'');
    DefineMethod('AddItem',2,tkNone,nil,__TCustomComboAddItem,false,0,'Item: String; AObject: TObject');
    ...
    DefineMethod('CopySelection',1,tkNone,nil,__TCustomComboCopySelection,false,0,'Destination: TCustomListControl');
    ...
    DefineMethod('GetCount',0,tkInteger,nil,__TCustomComboGetCount,false,0,'');
  ...
  begin
    DefineMethod('Create',1,tkClass,TCustomComboBox,__TCustomComboBoxCreate,true,0,'AOwner: TComponent');
    ...
    DefineProp('TextHint',tkVariant,__GetTCustomComboBoxTextHint,__SetTCustomComboBoxTextHint,nil,false,0);
  end;
  ...
  begin
    DefineMethod('Create',1,tkClass,TButtonControl,__TButtonControlCreate,true,0,'AOwner: TComponent');
  end;
  With Scripter.DefineClass(TImageMargins) do
  begin
    DefineMethod('Assign',1,tkNone,nil,__TImageMarginsAssign,false,0,'Source: TPersistent');
  end;
  With Scripter.DefineClass(TPushButtonActionLink) do
  begin
  end;
  With Scripter.DefineClass(TCustomButton) do
  begin
    DefineMethod('Create',1,tkClass,TCustomButton,__TCustomButtonCreate,true,0,'AOwner: TComponent');
    DefineMethod('Destroy',0,tkNone,nil,__TCustomButtonDestroy,false,0,'');
    DefineMethod('Click',0,tkNone,nil,__TCustomButtonClick,false,0,'');
    DefineMethod('UseRightToLeftAlignment',0,tkVariant,nil,__TCustomButtonUseRightToLeftAlignment,false,0,'');
    DefineProp('Cancel',tkVariant,__GetTCustomButtonCancel,__SetTCustomButtonCancel,nil,false,0);
    DefineProp('CommandLinkHint',tkVariant,__GetTCustomButtonCommandLinkHint,__SetTCustomButtonCommandLinkHint,nil,false,0);
    DefineProp('Default',tkVariant,__GetTCustomButtonDefault,__SetTCustomButtonDefault,nil,false,0);
    DefineProp('DisabledImageIndex',tkInteger,__GetTCustomButtonDisabledImageIndex,__SetTCustomButtonDisabledImageIndex,nil,false,0);
    DefineProp('DropDownMenu',tkClass,__GetTCustomButtonDropDownMenu,__SetTCustomButtonDropDownMenu,TPopupMenu,false,0);
    DefineProp('ElevationRequired',tkVariant,__GetTCustomButtonElevationRequired,__SetTCustomButtonElevationRequired,nil,false,0);
    DefineProp('HotImageIndex',tkInteger,__GetTCustomButtonHotImageIndex,__SetTCustomButtonHotImageIndex,nil,false,0);
    DefineProp('Images',tkClass,__GetTCustomButtonImages,__SetTCustomButtonImages,TCustomImageList,false,0);
    DefineProp('ImageAlignment',tkEnumeration,__GetTCustomButtonImageAlignment,__SetTCustomButtonImageAlignment,nil,false,0);
    DefineProp('ImageIndex',tkInteger,__GetTCustomButtonImageIndex,__SetTCustomButtonImageIndex,nil,false,0);
    DefineProp('ImageMargins',tkClass,__GetTCustomButtonImageMargins,__SetTCustomButtonImageMargins,TImageMargins,false,0);
    DefineProp('ModalResult',tkEnumeration,__GetTCustomButtonModalResult,__SetTCustomButtonModalResult,nil,false,0);
    DefineProp('PressedImageIndex',tkInteger,__GetTCustomButtonPressedImageIndex,__SetTCustomButtonPressedImageIndex,nil,false,0);
    DefineProp('SelectedImageIndex',tkInteger,__GetTCustomButtonSelectedImageIndex,__SetTCustomButtonSelectedImageIndex,nil,false,0);
    DefineProp('Style',tkEnumeration,__GetTCustomButtonStyle,__SetTCustomButtonStyle,nil,false,0);
    DefineProp('StylusHotImageIndex',tkInteger,__GetTCustomButtonStylusHotImageIndex,__SetTCustomButtonStylusHotImageIndex,nil,false,0);
    DefineProp('TabStop',tkVariant,nil,nil,nil,false,0);
  end;
  ...
  begin
    DefineMethod('Create',1,tkClass,TCustomCheckBox,__TCustomCheckBoxCreate,true,0,'AOwner: TComponent');
  ...
  begin
    DefineMethod('Create',1,tkClass,TRadioButton,__TRadioButtonCreate,true,0,'AOwner: TComponent');
  ...
  begin
    DefineMethod('Create',1,tkClass,TCustomListBox,__TCustomListBoxCreate,true,0,'AOwner: TComponent');
    DefineMethod('Destroy',0,tkNone,nil,__TCustomListBoxDestroy,false,0,'');
    DefineMethod('AddItem',2,tkNone,nil,__TCustomListBoxAddItem,false,0,'Item: String; AObject: TObject');
    ...
    DefineMethod('CopySelection',1,tkNone,nil,__TCustomListBoxCopySelection,false,0,'Destination: TCustomListControl');
    DefineMethod('DeleteSelected',0,tkNone,nil,__TCustomListBoxDeleteSelected,false,0,'');
    DefineMethod('GetCount',0,tkInteger,nil,__TCustomListBoxGetCount,false,0,'');
    DefineMethod('ItemAtPos',2,tkInteger,nil,__TCustomListBoxItemAtPos,false,0,'Pos: TPoint; Existing: Boolean');
    DefineMethod('ItemRect',1,tkVariant,nil,__TCustomListBoxItemRect,false,0,'Index: Integer');
  ...
  begin
    DefineMethod('Create',1,tkClass,TScrollBar,__TScrollBarCreate,true,0,'AOwner: TComponent');
    DefineMethod('SetParams',3,tkNone,nil,__TScrollBarSetParams,false,0,'APosition: Integer; AMin: Integer; AMax: Integer');
  end;
  With Scripter.DefineClass(TCustomStaticText) do
  begin
    DefineMethod('Create',1,tkClass,TCustomStaticText,__TCustomStaticTextCreate,true,0,'AOwner: TComponent');
  end;
  ...
  begin
    ...
    AddConstant('iaBottom',iaBottom);
    AddConstant('iaCenter',iaCenter);
    AddConstant('bsPushButton',bsPushButton);
    AddConstant('bsCommandLink',bsCommandLink);
    AddConstant('bsSplitButton',bsSplitButton);
