...
begin
  with AMachine do
  begin
AResult := WinInet.InternetTimeFromSystemTime(_SYSTEMTIMEWrapper(integer(GetInputArg(0))).ObjToRec,VarToInteger(GetInputArg(1)),PChar(VarToStr(GetInputArg(2))),VarToInteger(GetInputArg(3)));
...
AResult := WinInet.InternetCrackUrl(PChar(VarToStr(GetInputArg(0))),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),Param3);
    ReturnOutputArg(AResult);
...
if not Assigned(Param3Rec) or not (Param3Rec is URL_COMPONENTSWrapper) then 
  Param3Rec := URL_COMPONENTSWrapper.Create(Param3);
Param3 := URL_COMPONENTSWrapper(Param3Rec).ObjToRec;
AResult := WinInet.InternetCrackUrlA(PChar(VarToStr(GetInputArg(0))),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),Param3);
    ReturnOutputArg(AResult);
    SetInputArg(3,integer(URL_COMPONENTSWrapper.Create(Param3)));
  end;
end;
...
AResult := WinInet.InternetCreateUrl(Param0,VarToInteger(GetInputArg(1)),PChar(VarToStr(GetInputArg(2))),Param3);
    ReturnOutputArg(AResult);
...
Param0 := URL_COMPONENTSWrapper(Param0Rec).ObjToRec;
Param3 := VarToInteger(GetInputArg(3));
AResult := WinInet.InternetCreateUrlA(Param0,VarToInteger(GetInputArg(1)),PChar(VarToStr(GetInputArg(2))),Param3);
    ReturnOutputArg(AResult);
    SetInputArg(0,integer(URL_COMPONENTSWrapper.Create(Param0)));
    SetInputArg(3,Integer(Param3));
  end;
...
AResult := WinInet.InternetCanonicalizeUrl(PChar(VarToStr(GetInputArg(0))),PChar(VarToStr(GetInputArg(1))),Param2,VarToInteger(GetInputArg(3)));
    ReturnOutputArg(AResult);
...
begin
  ...
  begin
Param2 := VarToInteger(GetInputArg(2));
AResult := WinInet.InternetCanonicalizeUrlA(PChar(VarToStr(GetInputArg(0))),PChar(VarToStr(GetInputArg(1))),Param2,VarToInteger(GetInputArg(3)));
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
  end;
end;
...
begin
  ...
  begin
Param3 := VarToInteger(GetInputArg(3));
AResult := WinInet.InternetCombineUrl(PChar(VarToStr(GetInputArg(0))),PChar(VarToStr(GetInputArg(1))),PChar(VarToStr(GetInputArg(2))),Param3,VarToInteger(GetInputArg(4)));
    ReturnOutputArg(AResult);
    SetInputArg(3,Integer(Param3));
  end;
end;
...
begin
  ...
  begin
Param3 := VarToInteger(GetInputArg(3));
AResult := WinInet.InternetCombineUrlA(PChar(VarToStr(GetInputArg(0))),PChar(VarToStr(GetInputArg(1))),PChar(VarToStr(GetInputArg(2))),Param3,VarToInteger(GetInputArg(4)));
    ReturnOutputArg(AResult);
    SetInputArg(3,Integer(Param3));
  end;
end;
...
Param2 := VarToInteger(GetInputArg(2));
AResult := WinInet.InternetGetLastResponseInfo(Param0,PChar(VarToStr(GetInputArg(1))),Param2);
    ReturnOutputArg(AResult);
...
Param0 := VarToInteger(GetInputArg(0));
Param2 := VarToInteger(GetInputArg(2));
AResult := WinInet.InternetGetLastResponseInfoA(Param0,PChar(VarToStr(GetInputArg(1))),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(0,Integer(Param0));
    SetInputArg(2,Integer(Param2));
  end;
...
AResult := WinInet.GopherCreateLocator(PChar(VarToStr(GetInputArg(0))),VarToInteger(GetInputArg(1)),PChar(VarToStr(GetInputArg(2))),PChar(VarToStr(GetInputArg(3))),VarToInteger(GetInputArg(4)),PChar(VarToStr(GetInputArg(5))),Param6);
    ReturnOutputArg(AResult);
...
begin
  ...
  begin
Param6 := VarToInteger(GetInputArg(6));
AResult := WinInet.GopherCreateLocatorA(PChar(VarToStr(GetInputArg(0))),VarToInteger(GetInputArg(1)),PChar(VarToStr(GetInputArg(2))),PChar(VarToStr(GetInputArg(3))),VarToInteger(GetInputArg(4)),PChar(VarToStr(GetInputArg(5))),Param6);
    ReturnOutputArg(AResult);
    SetInputArg(6,Integer(Param6));
  end;
end;
...
AResult := WinInet.GopherGetLocatorType(PChar(VarToStr(GetInputArg(0))),Param1);
    ReturnOutputArg(AResult);
...
begin
  ...
  begin
Param1 := VarToInteger(GetInputArg(1));
AResult := WinInet.GopherGetLocatorTypeA(PChar(VarToStr(GetInputArg(0))),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := WinInet.InternetSetCookie(PChar(VarToStr(GetInputArg(0))),PChar(VarToStr(GetInputArg(1))),PChar(VarToStr(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := WinInet.InternetSetCookieA(PChar(VarToStr(GetInputArg(0))),PChar(VarToStr(GetInputArg(1))),PChar(VarToStr(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param3 := VarToInteger(GetInputArg(3));
AResult := WinInet.InternetGetCookie(PChar(VarToStr(GetInputArg(0))),PChar(VarToStr(GetInputArg(1))),PChar(VarToStr(GetInputArg(2))),Param3);
    ReturnOutputArg(AResult);
    SetInputArg(3,Integer(Param3));
  end;
end;
...
begin
  ...
  begin
Param3 := VarToInteger(GetInputArg(3));
AResult := WinInet.InternetGetCookieA(PChar(VarToStr(GetInputArg(0))),PChar(VarToStr(GetInputArg(1))),PChar(VarToStr(GetInputArg(2))),Param3);
    ReturnOutputArg(AResult);
    SetInputArg(3,Integer(Param3));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := WinInet.InternetCheckConnection(PChar(VarToStr(GetInputArg(0))),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := WinInet.InternetCheckConnectionA(PChar(VarToStr(GetInputArg(0))),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := WinInet.InternetCheckConnectionW(PChar(VarToStr(GetInputArg(0))),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(WinInet.InternetConfirmZoneCrossing(VarToInteger(GetInputArg(0)),PChar(VarToStr(GetInputArg(1))),PChar(VarToStr(GetInputArg(2))),GetInputArg(3)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := WinInet.CreateUrlCacheEntry(PChar(VarToStr(GetInputArg(0))),VarToInteger(GetInputArg(1)),PChar(VarToStr(GetInputArg(2))),PChar(VarToStr(GetInputArg(3))),VarToInteger(GetInputArg(4)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := WinInet.CreateUrlCacheEntryA(PChar(VarToStr(GetInputArg(0))),VarToInteger(GetInputArg(1)),PChar(VarToStr(GetInputArg(2))),PChar(VarToStr(GetInputArg(3))),VarToInteger(GetInputArg(4)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param3Buf, Length(VarToStr(GetInputArg(3))) + 1);
AResult := WinInet.CreateUrlCacheEntryW(PChar(VarToStr(GetInputArg(0))),VarToInteger(GetInputArg(1)),PChar(VarToStr(GetInputArg(2))),StringToWideChar(VarToStr(GetInputArg(3)),@Param3Buf[0],Length(Param3Buf)),VarToInteger(GetInputArg(4)));
    ReturnOutputArg(AResult);
  end;
end;
...
Param2 := VarToInteger(GetInputArg(2));
AResult := WinInet.RetrieveUrlCacheEntryFile(PChar(VarToStr(GetInputArg(0))),Param1,Param2,VarToInteger(GetInputArg(3)));
    ReturnOutputArg(AResult);
...
Param1 := INTERNET_CACHE_ENTRY_INFOAWrapper(Param1Rec).ObjToRec;
Param2 := VarToInteger(GetInputArg(2));
AResult := WinInet.RetrieveUrlCacheEntryFileA(PChar(VarToStr(GetInputArg(0))),Param1,Param2,VarToInteger(GetInputArg(3)));
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(INTERNET_CACHE_ENTRY_INFOAWrapper.Create(Param1)));
    SetInputArg(2,Integer(Param2));
  end;
...
Param1 := INTERNET_CACHE_ENTRY_INFOAWrapper(Param1Rec).ObjToRec;
Param2 := VarToInteger(GetInputArg(2));
AResult := WinInet.RetrieveUrlCacheEntryFileW(PChar(VarToStr(GetInputArg(0))),Param1,Param2,VarToInteger(GetInputArg(3)));
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(INTERNET_CACHE_ENTRY_INFOAWrapper.Create(Param1)));
    SetInputArg(2,Integer(Param2));
  end;
...
begin
  with AMachine do
  begin
AResult := WinInet.UnlockUrlCacheEntryFile(PChar(VarToStr(GetInputArg(0))),VarToInteger(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
Param1 := INTERNET_CACHE_ENTRY_INFOAWrapper(Param1Rec).ObjToRec;
Param2 := VarToInteger(GetInputArg(2));
AResult := Integer(WinInet.RetrieveUrlCacheEntryStream(PChar(VarToStr(GetInputArg(0))),Param1,Param2,GetInputArg(3),VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(INTERNET_CACHE_ENTRY_INFOAWrapper.Create(Param1)));
    SetInputArg(2,Integer(Param2));
  end;
...
Param1 := INTERNET_CACHE_ENTRY_INFOAWrapper(Param1Rec).ObjToRec;
Param2 := VarToInteger(GetInputArg(2));
AResult := Integer(WinInet.RetrieveUrlCacheEntryStreamA(PChar(VarToStr(GetInputArg(0))),Param1,Param2,GetInputArg(3),VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(INTERNET_CACHE_ENTRY_INFOAWrapper.Create(Param1)));
    SetInputArg(2,Integer(Param2));
  end;
...
Param1 := INTERNET_CACHE_ENTRY_INFOAWrapper(Param1Rec).ObjToRec;
Param2 := VarToInteger(GetInputArg(2));
AResult := Integer(WinInet.RetrieveUrlCacheEntryStreamW(PChar(VarToStr(GetInputArg(0))),Param1,Param2,GetInputArg(3),VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(INTERNET_CACHE_ENTRY_INFOAWrapper.Create(Param1)));
    SetInputArg(2,Integer(Param2));
  end;
...
Param1 := INTERNET_CACHE_ENTRY_INFOAWrapper(Param1Rec).ObjToRec;
Param2 := VarToInteger(GetInputArg(2));
AResult := WinInet.GetUrlCacheEntryInfo(PChar(VarToStr(GetInputArg(0))),Param1,Param2);
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(INTERNET_CACHE_ENTRY_INFOAWrapper.Create(Param1)));
    SetInputArg(2,Integer(Param2));
  end;
...
Param1 := INTERNET_CACHE_ENTRY_INFOAWrapper(Param1Rec).ObjToRec;
Param2 := VarToInteger(GetInputArg(2));
AResult := WinInet.GetUrlCacheEntryInfoA(PChar(VarToStr(GetInputArg(0))),Param1,Param2);
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(INTERNET_CACHE_ENTRY_INFOAWrapper.Create(Param1)));
    SetInputArg(2,Integer(Param2));
  end;
...
Param1 := INTERNET_CACHE_ENTRY_INFOAWrapper(Param1Rec).ObjToRec;
Param2 := VarToInteger(GetInputArg(2));
AResult := WinInet.GetUrlCacheEntryInfoW(PChar(VarToStr(GetInputArg(0))),Param1,Param2);
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(INTERNET_CACHE_ENTRY_INFOAWrapper.Create(Param1)));
    SetInputArg(2,Integer(Param2));
  end;
...
if not Assigned(Param1Rec) or not (Param1Rec is INTERNET_CACHE_ENTRY_INFOAWrapper) then 
  Param1Rec := INTERNET_CACHE_ENTRY_INFOAWrapper.Create(Param1);
Param1 := INTERNET_CACHE_ENTRY_INFOAWrapper(Param1Rec).ObjToRec;
AResult := WinInet.SetUrlCacheEntryInfo(PChar(VarToStr(GetInputArg(0))),Param1,VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(INTERNET_CACHE_ENTRY_INFOAWrapper.Create(Param1)));
  end;
end;
...
if not Assigned(Param1Rec) or not (Param1Rec is INTERNET_CACHE_ENTRY_INFOAWrapper) then 
  Param1Rec := INTERNET_CACHE_ENTRY_INFOAWrapper.Create(Param1);
Param1 := INTERNET_CACHE_ENTRY_INFOAWrapper(Param1Rec).ObjToRec;
AResult := WinInet.SetUrlCacheEntryInfoA(PChar(VarToStr(GetInputArg(0))),Param1,VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(INTERNET_CACHE_ENTRY_INFOAWrapper.Create(Param1)));
  end;
end;
...
if not Assigned(Param1Rec) or not (Param1Rec is INTERNET_CACHE_ENTRY_INFOAWrapper) then 
  Param1Rec := INTERNET_CACHE_ENTRY_INFOAWrapper.Create(Param1);
Param1 := INTERNET_CACHE_ENTRY_INFOAWrapper(Param1Rec).ObjToRec;
AResult := WinInet.SetUrlCacheEntryInfoW(PChar(VarToStr(GetInputArg(0))),Param1,VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(INTERNET_CACHE_ENTRY_INFOAWrapper.Create(Param1)));
  end;
end;
...
Param1 := INTERNET_CACHE_ENTRY_INFOAWrapper(Param1Rec).ObjToRec;
Param2 := VarToInteger(GetInputArg(2));
AResult := Integer(WinInet.FindFirstUrlCacheEntry(PChar(VarToStr(GetInputArg(0))),Param1,Param2));
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(INTERNET_CACHE_ENTRY_INFOAWrapper.Create(Param1)));
    SetInputArg(2,Integer(Param2));
  end;
...
Param1 := INTERNET_CACHE_ENTRY_INFOAWrapper(Param1Rec).ObjToRec;
Param2 := VarToInteger(GetInputArg(2));
AResult := Integer(WinInet.FindFirstUrlCacheEntryA(PChar(VarToStr(GetInputArg(0))),Param1,Param2));
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(INTERNET_CACHE_ENTRY_INFOAWrapper.Create(Param1)));
    SetInputArg(2,Integer(Param2));
  end;
...
Param1 := INTERNET_CACHE_ENTRY_INFOAWrapper(Param1Rec).ObjToRec;
Param2 := VarToInteger(GetInputArg(2));
AResult := Integer(WinInet.FindFirstUrlCacheEntryW(PChar(VarToStr(GetInputArg(0))),Param1,Param2));
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(INTERNET_CACHE_ENTRY_INFOAWrapper.Create(Param1)));
    SetInputArg(2,Integer(Param2));
  end;
...
begin
  with AMachine do
  begin
AResult := WinInet.DeleteUrlCacheEntry(PChar(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('InternetCrackUrl',4,tkVariant,nil,__InternetCrackUrl,false,0,'lpszUrl: PChar; dwUrlLength: DWORD; dwFlags: DWORD; lpUrlComponents: TURLComponents').SetVarArgs([3]);
    ...
    DefineMethod('InternetCreateUrl',4,tkVariant,nil,__InternetCreateUrl,false,0,'lpUrlComponents: TURLComponents; dwFlags: DWORD; lpszUrl: PChar; dwUrlLength: DWORD').SetVarArgs([0,3]);
    ...
    DefineMethod('InternetCanonicalizeUrl',4,tkVariant,nil,__InternetCanonicalizeUrl,false,0,'lpszUrl: PChar; lpszBuffer: PChar; lpdwBufferLength: DWORD; dwFlags: DWORD').SetVarArgs([2]);
    ...
    DefineMethod('InternetCombineUrl',5,tkVariant,nil,__InternetCombineUrl,false,0,'lpszBaseUrl: PChar; lpszRelativeUrl: PChar; lpszBuffer: PChar; lpdwBufferLength: DWORD; dwFlags: DWORD').SetVarArgs([3]);
    ...
    DefineMethod('InternetGetLastResponseInfo',3,tkVariant,nil,__InternetGetLastResponseInfo,false,0,'lpdwError: DWORD; lpszBuffer: PChar; lpdwBufferLength: DWORD').SetVarArgs([0,2]);
    ...
    DefineMethod('GopherCreateLocator',7,tkVariant,nil,__GopherCreateLocator,false,0,'lpszHost: PChar; nServerPort: INTERNET_PORT; lpszDisplayString: PChar; lpszSelectorString: PChar; dwGopherType: DWORD; lpszLocator: PChar; lpdwBufferLength: DWORD').SetVarArgs([6]);
    ...
    DefineMethod('GopherGetLocatorType',2,tkVariant,nil,__GopherGetLocatorType,false,0,'lpszLocator: PChar; lpdwGopherType: DWORD').SetVarArgs([1]);
    ...
    DefineMethod('InternetSetCookie',3,tkVariant,nil,__InternetSetCookie,false,0,'lpszUrl: PChar; lpszCookieName: PChar; lpszCookieData: PChar');
    ...
    DefineMethod('InternetGetCookie',4,tkVariant,nil,__InternetGetCookie,false,0,'lpszUrl: PChar; lpszCookieName: PChar; lpszCookieData: PChar; lpdwSize: DWORD').SetVarArgs([3]);
    ...
    DefineMethod('InternetCheckConnection',3,tkVariant,nil,__InternetCheckConnection,false,0,'lpszUrl: PAnsiChar; dwFlags: DWORD; dwReserved: DWORD');
    ...
    DefineMethod('InternetCheckConnectionW',3,tkVariant,nil,__InternetCheckConnectionW,false,0,'lpszUrl: PAnsiChar; dwFlags: DWORD; dwReserved: DWORD');
    ...
    DefineMethod('CreateUrlCacheEntry',5,tkVariant,nil,__CreateUrlCacheEntry,false,0,'lpszUrlName: PAnsiChar; dwExpectedFileSize: DWORD; lpszFileExtension: PAnsiChar; lpszFileName: PChar; dwReserved: DWORD');
    ...
    DefineMethod('CreateUrlCacheEntryW',5,tkVariant,nil,__CreateUrlCacheEntryW,false,0,'lpszUrlName: PAnsiChar; dwExpectedFileSize: DWORD; lpszFileExtension: PAnsiChar; lpszFileName: PWideChar; dwReserved: DWORD');
    DefineMethod('RetrieveUrlCacheEntryFile',4,tkVariant,nil,__RetrieveUrlCacheEntryFile,false,0,'lpszUrlName: PAnsiChar; lpCacheEntryInfo: TInternetCacheEntryInfo; lpdwCacheEntryInfoBufferSize: DWORD; dwReserved: DWORD').SetVarArgs([1,2]);
    ...
    DefineMethod('RetrieveUrlCacheEntryFileW',4,tkVariant,nil,__RetrieveUrlCacheEntryFileW,false,0,'lpszUrlName: PAnsiChar; lpCacheEntryInfo: TInternetCacheEntryInfo; lpdwCacheEntryInfoBufferSize: DWORD; dwReserved: DWORD').SetVarArgs([1,2]);
    DefineMethod('UnlockUrlCacheEntryFile',2,tkVariant,nil,__UnlockUrlCacheEntryFile,false,0,'lpszUrlName: LPCSTR; dwReserved: DWORD');
    DefineMethod('RetrieveUrlCacheEntryStream',5,tkInteger,nil,__RetrieveUrlCacheEntryStream,false,0,'lpszUrlName: PAnsiChar; lpCacheEntryInfo: TInternetCacheEntryInfo; lpdwCacheEntryInfoBufferSize: DWORD; fRandomRead: BOOL; dwReserved: DWORD').SetVarArgs([1,2]);
    ...
    DefineMethod('RetrieveUrlCacheEntryStreamW',5,tkInteger,nil,__RetrieveUrlCacheEntryStreamW,false,0,'lpszUrlName: PAnsiChar; lpCacheEntryInfo: TInternetCacheEntryInfo; lpdwCacheEntryInfoBufferSize: DWORD; fRandomRead: BOOL; dwReserved: DWORD').SetVarArgs([1,2]);
    ...
    DefineMethod('GetUrlCacheEntryInfo',3,tkVariant,nil,__GetUrlCacheEntryInfo,false,0,'lpszUrlName: PAnsiChar; lpCacheEntryInfo: TInternetCacheEntryInfo; lpdwCacheEntryInfoBufferSize: DWORD').SetVarArgs([1,2]);
    ...
    DefineMethod('GetUrlCacheEntryInfoW',3,tkVariant,nil,__GetUrlCacheEntryInfoW,false,0,'lpszUrlName: PAnsiChar; lpCacheEntryInfo: TInternetCacheEntryInfo; lpdwCacheEntryInfoBufferSize: DWORD').SetVarArgs([1,2]);
    DefineMethod('SetUrlCacheEntryInfo',3,tkVariant,nil,__SetUrlCacheEntryInfo,false,0,'lpszUrlName: PAnsiChar; lpCacheEntryInfo: TInternetCacheEntryInfo; dwFieldControl: DWORD').SetVarArgs([1]);
    ...
    DefineMethod('SetUrlCacheEntryInfoW',3,tkVariant,nil,__SetUrlCacheEntryInfoW,false,0,'lpszUrlName: PAnsiChar; lpCacheEntryInfo: TInternetCacheEntryInfo; dwFieldControl: DWORD').SetVarArgs([1]);
    DefineMethod('FindFirstUrlCacheEntry',3,tkInteger,nil,__FindFirstUrlCacheEntry,false,0,'lpszUrlSearchPattern: PAnsiChar; lpFirstCacheEntryInfo: TInternetCacheEntryInfo; lpdwFirstCacheEntryInfoBufferSize: DWORD').SetVarArgs([1,2]);
    DefineMethod('FindFirstUrlCacheEntryA',3,tkInteger,nil,__FindFirstUrlCacheEntryA,false,0,'lpszUrlSearchPattern: PAnsiChar; lpFirstCacheEntryInfo: TInternetCacheEntryInfo; lpdwFirstCacheEntryInfoBufferSize: DWORD').SetVarArgs([1,2]);
    DefineMethod('FindFirstUrlCacheEntryW',3,tkInteger,nil,__FindFirstUrlCacheEntryW,false,0,'lpszUrlSearchPattern: PAnsiChar; lpFirstCacheEntryInfo: TInternetCacheEntryInfo; lpdwFirstCacheEntryInfoBufferSize: DWORD').SetVarArgs([1,2]);
    ...
    DefineMethod('FindNextUrlCacheEntryA',3,tkVariant,nil,__FindNextUrlCacheEntryA,false,0,'hEnumHandle: THandle; lpNextCacheEntryInfo: TInternetCacheEntryInfo; lpdwNextCacheEntryInfoBufferSize: DWORD').SetVarArgs([1,2]);
    DefineMethod('FindNextUrlCacheEntryW',3,tkVariant,nil,__FindNextUrlCacheEntryW,false,0,'hEnumHandle: THandle; lpNextCacheEntryInfo: TInternetCacheEntryInfo; lpdwNextCacheEntryInfoBufferSize: DWORD').SetVarArgs([1,2]);
    DefineMethod('FindCloseUrlCache',1,tkVariant,nil,__FindCloseUrlCache,false,0,'hEnumHandle: THandle');
    DefineMethod('DeleteUrlCacheEntry',1,tkVariant,nil,__DeleteUrlCacheEntry,false,0,'lpszUrlName: LPCSTR');
