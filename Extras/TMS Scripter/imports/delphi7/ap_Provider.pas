...
begin
  with AMachine do
  begin
AResult := string(Provider.GetStringProperty(TPersistent(VarToObject(GetInputArg(0))),VarToStr(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
