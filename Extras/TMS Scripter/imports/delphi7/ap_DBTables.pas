...
begin
  with AMachine do
  begin
    TUpdateSQL(CurrentObject).SetParams(TUpdateKind(VarToInteger(GetInputArg(0))));
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('SetParams',1,tkNone,nil,__TUpdateSQLSetParams,false,0,'UpdateKind: TUpdateKind');
