...
begin
  with AMachine do
  begin
Param4 := _IMAGEHLP_STATUS_REASON(VarToInteger(GetInputArg(4)));
...
begin
  ...
  begin
    DefineMethod('MapFileAndCheckSum',3,tkInteger,nil,__MapFileAndCheckSum,false,0,'Filename: PChar; HeaderSum: DWORD; CheckSum: DWORD').SetVarArgs([1,2]);
    ...
    DefineMethod('BindImageEx',5,tkVariant,nil,__BindImageEx,false,0,'Flags: DWORD; ImageName: LPSTR; DllPath: LPSTR; SymbolPath: LPSTR; StatusRoutine: TImagehlpStatusReason').SetVarArgs([4]);
    ...
    DefineMethod('SymLoadModule',6,tkVariant,nil,__SymLoadModule,false,0,'hProcess: THandle; hFile: THandle; ImageName: LPSTR; ModuleName: LPSTR; BaseOfDll: DWORD; SizeOfDll: DWORD');
