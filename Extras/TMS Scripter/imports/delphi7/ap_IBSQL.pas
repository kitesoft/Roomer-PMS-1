...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TIBXSQLVARClass(CurrentClass.ClassRef).Create(TIBXSQLDA(VarToObject(GetInputArg(0))),TIBSQL(VarToObject(GetInputArg(1)))));
...
begin
  with AMachine do
  begin
    TIBXSQLVAR(CurrentObject).Assign(TIBXSQLVAR(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TIBXSQLVAR(CurrentObject).LoadFromFile(VarToStr(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    TIBXSQLVAR(CurrentObject).LoadFromStream(TStream(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TIBXSQLVAR(CurrentObject).SaveToFile(VarToStr(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    TIBXSQLVAR(CurrentObject).SaveToStream(TStream(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TIBXSQLVAR(CurrentObject).AsString));
  end;
end;
...
begin
  with AMachine do
  begin
    TIBXSQLVAR(CurrentObject).AsString:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TIBXSQLVAR(CurrentObject).AsTrimString));
  end;
end;
...
begin
  with AMachine do
  begin
    TIBXSQLVAR(CurrentObject).AsTrimString:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TIBXSQLVAR(CurrentObject).Name));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TIBXSQLDAClass(CurrentClass.ClassRef).Create(TIBSQL(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TIBXSQLDA(CurrentObject).AddName(VarToStr(GetInputArg(0)),VarToInteger(GetInputArg(1)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TIBXSQLDA(CurrentObject).ByName(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TIBXSQLDA(CurrentObject).Names));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TIBXSQLDA(CurrentObject).Vars[VarToInteger(GetArrayIndex(0))]));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TIBXSQLDA(CurrentObject).UniqueRelationName));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TIBBatch(CurrentObject).Columns));
  end;
end;
...
begin
  with AMachine do
  begin
    TIBBatch(CurrentObject).Columns:=TIBXSQLDA(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TIBBatch(CurrentObject).Filename));
  end;
end;
...
begin
  with AMachine do
  begin
    TIBBatch(CurrentObject).Filename:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TIBBatch(CurrentObject).Params));
  end;
end;
...
begin
  with AMachine do
  begin
    TIBBatch(CurrentObject).Params:=TIBXSQLDA(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TIBOutputDelimitedFile(CurrentObject).ColDelimiter));
  end;
end;
...
begin
  with AMachine do
  begin
    TIBOutputDelimitedFile(CurrentObject).ColDelimiter:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TIBOutputDelimitedFile(CurrentObject).RowDelimiter));
  end;
end;
...
begin
  with AMachine do
  begin
    TIBOutputDelimitedFile(CurrentObject).RowDelimiter:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TIBInputDelimitedFile(CurrentObject).ColDelimiter));
  end;
end;
...
begin
  with AMachine do
  begin
    TIBInputDelimitedFile(CurrentObject).ColDelimiter:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TIBInputDelimitedFile(CurrentObject).RowDelimiter));
  end;
end;
...
begin
  with AMachine do
  begin
    TIBInputDelimitedFile(CurrentObject).RowDelimiter:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TIBSQLClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TIBSQL(CurrentObject).BatchInput(TIBBatchInput(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TIBSQL(CurrentObject).Current);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TIBSQL(CurrentObject).FieldByName(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TIBSQL(CurrentObject).Next);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(TIBSQL(CurrentObject).GetUniqueRelationName);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TIBSQL(CurrentObject).ParamByName(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TIBSQL(CurrentObject).Fields[VarToInteger(GetArrayIndex(0))]));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TIBSQL(CurrentObject).FieldIndex[VarToStr(GetArrayIndex(0))]));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TIBSQL(CurrentObject).Params));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TIBSQL(CurrentObject).Plan));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TIBSQL(CurrentObject).SQLType));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TIBSQL(CurrentObject).UniqueRelationName));
  end;
end;
...
begin
  ...
  begin
    DefineMethod('Create',2,tkClass,TIBXSQLVAR,__TIBXSQLVARCreate,true,0,'Parent: TIBXSQLDA; Query: TIBSQL');
    DefineMethod('Assign',1,tkNone,nil,__TIBXSQLVARAssign,false,0,'Source: TIBXSQLVAR');
    DefineMethod('LoadFromFile',1,tkNone,nil,__TIBXSQLVARLoadFromFile,false,0,'FileName: String');
    DefineMethod('LoadFromStream',1,tkNone,nil,__TIBXSQLVARLoadFromStream,false,0,'Stream: TStream');
    DefineMethod('SaveToFile',1,tkNone,nil,__TIBXSQLVARSaveToFile,false,0,'FileName: String');
    DefineMethod('SaveToStream',1,tkNone,nil,__TIBXSQLVARSaveToStream,false,0,'Stream: TStream');
  ...
  begin
    DefineMethod('Create',1,tkClass,TIBXSQLDA,__TIBXSQLDACreate,true,0,'Query: TIBSQL');
    DefineMethod('Destroy',0,tkNone,nil,__TIBXSQLDADestroy,false,0,'');
    DefineMethod('AddName',2,tkNone,nil,__TIBXSQLDAAddName,false,0,'FieldName: String; Idx: Integer');
    DefineMethod('ByName',1,tkClass,TIBXSQLVAR,__TIBXSQLDAByName,false,0,'Idx: String');
  ...
  begin
    ...
    DefineMethod('GetColumn',1,tkInteger,nil,__TIBInputDelimitedFileGetColumn,false,0,'Col: string').SetVarArgs([0]);
  ...
  begin
    DefineMethod('Create',1,tkClass,TIBSQL,__TIBSQLCreate,true,0,'AOwner: TComponent');
    DefineMethod('Destroy',0,tkNone,nil,__TIBSQLDestroy,false,0,'');
    DefineMethod('BatchInput',1,tkNone,nil,__TIBSQLBatchInput,false,0,'InputObject: TIBBatchInput');
    DefineMethod('BatchOutput',1,tkNone,nil,__TIBSQLBatchOutput,false,0,'putObject: TIBBatchOutput').SetVarArgs([0]);
    DefineMethod('Call',2,tkInteger,nil,__TIBSQLCall,false,0,'ErrCode: ISC_STATUS; RaiseError: Boolean');
    ...
    DefineMethod('FieldByName',1,tkClass,TIBXSQLVAR,__TIBSQLFieldByName,false,0,'FieldName: String');
    ...
    DefineMethod('ParamByName',1,tkClass,TIBXSQLVAR,__TIBSQLParamByName,false,0,'Idx: String');
