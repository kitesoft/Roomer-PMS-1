...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TFieldDataLinkClass(CurrentClass.ClassRef).Create);
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TFieldDataLink(CurrentObject).Control));
  end;
end;
...
begin
  with AMachine do
  begin
    TFieldDataLink(CurrentObject).Control:=TComponent(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TFieldDataLink(CurrentObject).Field));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TFieldDataLink(CurrentObject).FieldName));
  end;
end;
...
begin
  with AMachine do
  begin
    TFieldDataLink(CurrentObject).FieldName:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TPaintControlClass(CurrentClass.ClassRef).Create(TWinControl(VarToObject(GetInputArg(0))),VarToStr(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TDBEditClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TDBEdit(CurrentObject).ExecuteAction(TBasicAction(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TDBEdit(CurrentObject).UpdateAction(TBasicAction(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TDBEdit(CurrentObject).Field));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TDBTextClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TDBText(CurrentObject).ExecuteAction(TBasicAction(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TDBText(CurrentObject).UpdateAction(TBasicAction(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TDBText(CurrentObject).Field));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TDBCheckBoxClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TDBCheckBox(CurrentObject).ExecuteAction(TBasicAction(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TDBCheckBox(CurrentObject).UpdateAction(TBasicAction(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TDBCheckBox(CurrentObject).Field));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TDBComboBoxClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TDBComboBox(CurrentObject).ExecuteAction(TBasicAction(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TDBComboBox(CurrentObject).UpdateAction(TBasicAction(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TDBComboBox(CurrentObject).Field));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TDBListBoxClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TDBListBox(CurrentObject).ExecuteAction(TBasicAction(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TDBListBox(CurrentObject).UpdateAction(TBasicAction(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TDBListBox(CurrentObject).Field));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TDBRadioGroupClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TDBRadioGroup(CurrentObject).ExecuteAction(TBasicAction(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TDBRadioGroup(CurrentObject).UpdateAction(TBasicAction(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TDBRadioGroup(CurrentObject).Field));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TDBRadioGroup(CurrentObject).Value));
  end;
end;
...
begin
  with AMachine do
  begin
    TDBRadioGroup(CurrentObject).Value:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TDBMemoClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TDBMemo(CurrentObject).ExecuteAction(TBasicAction(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TDBMemo(CurrentObject).UpdateAction(TBasicAction(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TDBMemo(CurrentObject).Field));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TDBImageClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TDBImage(CurrentObject).ExecuteAction(TBasicAction(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TDBImage(CurrentObject).UpdateAction(TBasicAction(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TDBImage(CurrentObject).Field));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TDBImage(CurrentObject).Picture));
  end;
end;
...
begin
  with AMachine do
  begin
    TDBImage(CurrentObject).Picture:=TPicture(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TDBNavigatorClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TDBNavigator(CurrentObject).BtnClick(TNavigateBtn(VarToInteger(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TNavButton(CurrentObject).Index));
  end;
end;
...
begin
  with AMachine do
  begin
    TNavButton(CurrentObject).Index:=TNavigateBtn(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TNavDataLinkClass(CurrentClass.ClassRef).Create(TDBNavigator(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TDataSourceLinkClass(CurrentClass.ClassRef).Create);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TListSourceLinkClass(CurrentClass.ClassRef).Create);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TDBLookupControlClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TDBLookupControl(CurrentObject).ExecuteAction(TBasicAction(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TDBLookupControl(CurrentObject).UpdateAction(TBasicAction(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TDBLookupControl(CurrentObject).Field));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TDBLookupListBoxClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TDBLookupListBox(CurrentObject).ExecuteAction(TBasicAction(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TDBLookupListBox(CurrentObject).UpdateAction(TBasicAction(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TDBLookupListBox(CurrentObject).SelectedItem));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TPopupDataListClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TDBLookupComboBoxClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TDBLookupComboBox(CurrentObject).ExecuteAction(TBasicAction(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TDBLookupComboBox(CurrentObject).UpdateAction(TBasicAction(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TDBLookupComboBox(CurrentObject).Text));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TDBRichEditClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TDBRichEdit(CurrentObject).ExecuteAction(TBasicAction(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TDBRichEdit(CurrentObject).UpdateAction(TBasicAction(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TDBRichEdit(CurrentObject).Field));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := DBCtrls.OkToChangeFieldAlignment(TField(VarToObject(GetInputArg(0))),TAlignment(VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := DBCtrls.DBUseRightToLeftAlignment(TControl(VarToObject(GetInputArg(0))),TField(VarToObject(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    DefineMethod('Create',2,tkClass,TPaintControl,__TPaintControlCreate,true,0,'AOwner: TWinControl; ClassName: string');
  ...
  begin
    DefineMethod('Create',1,tkClass,TDBEdit,__TDBEditCreate,true,0,'AOwner: TComponent');
    DefineMethod('Destroy',0,tkNone,nil,__TDBEditDestroy,false,0,'');
    DefineMethod('ExecuteAction',1,tkVariant,nil,__TDBEditExecuteAction,false,0,'Action: TBasicAction');
    DefineMethod('UpdateAction',1,tkVariant,nil,__TDBEditUpdateAction,false,0,'Action: TBasicAction');
  ...
  begin
    DefineMethod('Create',1,tkClass,TDBText,__TDBTextCreate,true,0,'AOwner: TComponent');
    DefineMethod('Destroy',0,tkNone,nil,__TDBTextDestroy,false,0,'');
    DefineMethod('ExecuteAction',1,tkVariant,nil,__TDBTextExecuteAction,false,0,'Action: TBasicAction');
    DefineMethod('UpdateAction',1,tkVariant,nil,__TDBTextUpdateAction,false,0,'Action: TBasicAction');
  ...
  begin
    DefineMethod('Create',1,tkClass,TDBCheckBox,__TDBCheckBoxCreate,true,0,'AOwner: TComponent');
    DefineMethod('Destroy',0,tkNone,nil,__TDBCheckBoxDestroy,false,0,'');
    DefineMethod('ExecuteAction',1,tkVariant,nil,__TDBCheckBoxExecuteAction,false,0,'Action: TBasicAction');
    DefineMethod('UpdateAction',1,tkVariant,nil,__TDBCheckBoxUpdateAction,false,0,'Action: TBasicAction');
  ...
  begin
    DefineMethod('Create',1,tkClass,TDBComboBox,__TDBComboBoxCreate,true,0,'AOwner: TComponent');
    DefineMethod('Destroy',0,tkNone,nil,__TDBComboBoxDestroy,false,0,'');
    DefineMethod('ExecuteAction',1,tkVariant,nil,__TDBComboBoxExecuteAction,false,0,'Action: TBasicAction');
    DefineMethod('UpdateAction',1,tkVariant,nil,__TDBComboBoxUpdateAction,false,0,'Action: TBasicAction');
  ...
  begin
    DefineMethod('Create',1,tkClass,TDBListBox,__TDBListBoxCreate,true,0,'AOwner: TComponent');
    DefineMethod('Destroy',0,tkNone,nil,__TDBListBoxDestroy,false,0,'');
    DefineMethod('ExecuteAction',1,tkVariant,nil,__TDBListBoxExecuteAction,false,0,'Action: TBasicAction');
    DefineMethod('UpdateAction',1,tkVariant,nil,__TDBListBoxUpdateAction,false,0,'Action: TBasicAction');
  ...
  begin
    DefineMethod('Create',1,tkClass,TDBRadioGroup,__TDBRadioGroupCreate,true,0,'AOwner: TComponent');
    DefineMethod('Destroy',0,tkNone,nil,__TDBRadioGroupDestroy,false,0,'');
    DefineMethod('ExecuteAction',1,tkVariant,nil,__TDBRadioGroupExecuteAction,false,0,'Action: TBasicAction');
    DefineMethod('UpdateAction',1,tkVariant,nil,__TDBRadioGroupUpdateAction,false,0,'Action: TBasicAction');
  ...
  begin
    DefineMethod('Create',1,tkClass,TDBMemo,__TDBMemoCreate,true,0,'AOwner: TComponent');
    DefineMethod('Destroy',0,tkNone,nil,__TDBMemoDestroy,false,0,'');
    DefineMethod('ExecuteAction',1,tkVariant,nil,__TDBMemoExecuteAction,false,0,'Action: TBasicAction');
    DefineMethod('LoadMemo',0,tkNone,nil,__TDBMemoLoadMemo,false,0,'');
    DefineMethod('UpdateAction',1,tkVariant,nil,__TDBMemoUpdateAction,false,0,'Action: TBasicAction');
  ...
  begin
    DefineMethod('Create',1,tkClass,TDBImage,__TDBImageCreate,true,0,'AOwner: TComponent');
    ...
    DefineMethod('ExecuteAction',1,tkVariant,nil,__TDBImageExecuteAction,false,0,'Action: TBasicAction');
    ...
    DefineMethod('UpdateAction',1,tkVariant,nil,__TDBImageUpdateAction,false,0,'Action: TBasicAction');
  ...
  begin
    DefineMethod('Create',1,tkClass,TDBNavigator,__TDBNavigatorCreate,true,0,'AOwner: TComponent');
    DefineMethod('Destroy',0,tkNone,nil,__TDBNavigatorDestroy,false,0,'');
    DefineMethod('SetBounds',4,tkNone,nil,__TDBNavigatorSetBounds,false,0,'ALeft: Integer; ATop: Integer; AWidth: Integer; AHeight: Integer');
    DefineMethod('BtnClick',1,tkNone,nil,__TDBNavigatorBtnClick,false,0,'Index: TNavigateBtn');
  end;
  ...
  begin
    DefineMethod('Create',1,tkClass,TNavDataLink,__TNavDataLinkCreate,true,0,'ANav: TDBNavigator');
  ...
  begin
    DefineMethod('Create',1,tkClass,TDBLookupControl,__TDBLookupControlCreate,true,0,'AOwner: TComponent');
    DefineMethod('Destroy',0,tkNone,nil,__TDBLookupControlDestroy,false,0,'');
    DefineMethod('ExecuteAction',1,tkVariant,nil,__TDBLookupControlExecuteAction,false,0,'Action: TBasicAction');
    DefineMethod('UpdateAction',1,tkVariant,nil,__TDBLookupControlUpdateAction,false,0,'Action: TBasicAction');
    DefineProp('Field',tkClass,__GetTDBLookupControlField,nil,TField,false,0);
  end;
  With Scripter.DefineClass(TDBLookupListBox) do
  begin
    DefineMethod('Create',1,tkClass,TDBLookupListBox,__TDBLookupListBoxCreate,true,0,'AOwner: TComponent');
    DefineMethod('ExecuteAction',1,tkVariant,nil,__TDBLookupListBoxExecuteAction,false,0,'Action: TBasicAction');
    DefineMethod('UpdateAction',1,tkVariant,nil,__TDBLookupListBoxUpdateAction,false,0,'Action: TBasicAction');
    DefineMethod('UseRightToLeftAlignment',0,tkVariant,nil,__TDBLookupListBoxUseRightToLeftAlignment,false,0,'');
    DefineMethod('SetBounds',4,tkNone,nil,__TDBLookupListBoxSetBounds,false,0,'ALeft: Integer; ATop: Integer; AWidth: Integer; AHeight: Integer');
  ...
  begin
    DefineMethod('Create',1,tkClass,TPopupDataList,__TPopupDataListCreate,true,0,'AOwner: TComponent');
  end;
  With Scripter.DefineClass(TDBLookupComboBox) do
  begin
    DefineMethod('Create',1,tkClass,TDBLookupComboBox,__TDBLookupComboBoxCreate,true,0,'AOwner: TComponent');
    DefineMethod('CloseUp',1,tkNone,nil,__TDBLookupComboBoxCloseUp,false,0,'Accept: Boolean');
    DefineMethod('DropDown',0,tkNone,nil,__TDBLookupComboBoxDropDown,false,0,'');
    DefineMethod('ExecuteAction',1,tkVariant,nil,__TDBLookupComboBoxExecuteAction,false,0,'Action: TBasicAction');
    DefineMethod('SetBounds',4,tkNone,nil,__TDBLookupComboBoxSetBounds,false,0,'ALeft: Integer; ATop: Integer; AWidth: Integer; AHeight: Integer');
    DefineMethod('UpdateAction',1,tkVariant,nil,__TDBLookupComboBoxUpdateAction,false,0,'Action: TBasicAction');
  ...
  begin
    DefineMethod('Create',1,tkClass,TDBRichEdit,__TDBRichEditCreate,true,0,'AOwner: TComponent');
    DefineMethod('Destroy',0,tkNone,nil,__TDBRichEditDestroy,false,0,'');
    DefineMethod('ExecuteAction',1,tkVariant,nil,__TDBRichEditExecuteAction,false,0,'Action: TBasicAction');
    DefineMethod('LoadMemo',0,tkNone,nil,__TDBRichEditLoadMemo,false,0,'');
    DefineMethod('UpdateAction',1,tkVariant,nil,__TDBRichEditUpdateAction,false,0,'Action: TBasicAction');
  ...
  begin
    DefineMethod('OkToChangeFieldAlignment',2,tkVariant,nil,__OkToChangeFieldAlignment,false,0,'AField: TField; Alignment: TAlignment');
    DefineMethod('DBUseRightToLeftAlignment',2,tkVariant,nil,__DBUseRightToLeftAlignment,false,0,'AControl: TControl; AField: TField');
