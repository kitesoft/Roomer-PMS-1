...
begin
  ...
  begin
    ...
    DefineMethod('GetServiceKeyName',4,tkVariant,nil,__GetServiceKeyName,false,0,'hSCManager: SC_HANDLE; lpDisplayName: PChar; lpServiceName: PChar; lpcchBuffer: DWORD').SetVarArgs([3]);
    ...
    DefineMethod('GetServiceDisplayName',4,tkVariant,nil,__GetServiceDisplayName,false,0,'hSCManager: SC_HANDLE; lpServiceName: PChar; lpDisplayName: PChar; lpcchBuffer: DWORD').SetVarArgs([3]);
    ...
    DefineMethod('OpenSCManager',3,tkInteger,nil,__OpenSCManager,false,0,'lpMachineName: PChar; lpDatabaseName: PChar; dwDesiredAccess: DWORD');
    ...
    DefineMethod('OpenService',3,tkInteger,nil,__OpenService,false,0,'hSCManager: SC_HANDLE; lpServiceName: PChar; dwDesiredAccess: DWORD');
    ...
    DefineMethod('StartService',3,tkVariant,nil,__StartService,false,0,'hService: SC_HANDLE; dwNumServiceArgs: DWORD; lpServiceArgVectors: PChar').SetVarArgs([2]);
