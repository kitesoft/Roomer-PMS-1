...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TConvTypeInfoClass(CurrentClass.ClassRef).Create(VarToInteger(GetInputArg(0)),VarToStr(GetInputArg(1))));
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TConvTypeInfo(CurrentObject).Description));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TConvTypeFactorClass(CurrentClass.ClassRef).Create(VarToInteger(GetInputArg(0)),VarToStr(GetInputArg(1)),GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(ConvUtils.ConvUnitCompareValue(GetInputArg(0),VarToInteger(GetInputArg(1)),GetInputArg(2),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(ConvUtils.RegisterConversionType(VarToInteger(GetInputArg(0)),VarToStr(GetInputArg(1)),GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(ConvUtils.RegisterConversionFamily(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := ConvUtils.StrToConvUnit(VarToStr(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
...
AResult := ConvUtils.TryStrToConvUnit(VarToStr(GetInputArg(0)),Param1,Param2);
    ReturnOutputArg(AResult);
...
begin
  with AMachine do
  begin
AResult := string(ConvUtils.ConvUnitToStr(GetInputArg(0),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(ConvUtils.ConvTypeToDescription(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(ConvUtils.ConvFamilyToDescription(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param1 := VarToInteger(GetInputArg(1));
AResult := ConvUtils.DescriptionToConvType(VarToStr(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
begin
  ...
  begin
Param1 := VarToInteger(GetInputArg(1));
AResult := ConvUtils.DescriptionToConvFamily(VarToStr(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,Integer(Param1));
  end;
end;
...
begin
  with AMachine do
  begin
    ConvUtils.RaiseConversionError(VarToStr(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ConvUtils.RaiseConversionRegError(VarToInteger(GetInputArg(0)),VarToStr(GetInputArg(1)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(ConvUtils.GConvUnitToStrFmt));
  end;
end;
...
begin
  with AMachine do
  begin
    ConvUtils.GConvUnitToStrFmt:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  ...
  begin
    DefineMethod('Create',2,tkClass,TConvTypeInfo,__TConvTypeInfoCreate,true,0,'AConvFamily: TConvFamily; ADescription: string');
    DefineMethod('ToCommon',1,tkVariant,nil,__TConvTypeInfoToCommon,false,0,'AValue: Double');
    DefineMethod('FromCommon',1,tkVariant,nil,__TConvTypeInfoFromCommon,false,0,'AValue: Double');
  ...
  begin
    DefineMethod('Create',3,tkClass,TConvTypeFactor,__TConvTypeFactorCreate,true,0,'AConvFamily: TConvFamily; ADescription: string; AFactor: Double');
    DefineMethod('ToCommon',1,tkVariant,nil,__TConvTypeFactorToCommon,false,0,'AValue: Double');
    DefineMethod('FromCommon',1,tkVariant,nil,__TConvTypeFactorFromCommon,false,0,'AValue: Double');
  end;
  With Scripter.DefineClass(TConvTypeProcs) do
  begin
    DefineMethod('ToCommon',1,tkVariant,nil,__TConvTypeProcsToCommon,false,0,'AValue: Double');
    DefineMethod('FromCommon',1,tkVariant,nil,__TConvTypeProcsFromCommon,false,0,'AValue: Double');
  end;
  With Scripter.DefineClass(ClassType) do
  begin
    DefineMethod('Convert',3,tkVariant,nil,__Convert,false,0,'AValue: Double; AFrom: TConvType; ATo: TConvType');
    DefineMethod('ConvertFrom',2,tkVariant,nil,__ConvertFrom,false,0,'AFrom: TConvType; AValue: Double');
    DefineMethod('ConvertTo',2,tkVariant,nil,__ConvertTo,false,0,'AValue: Double; ATo: TConvType');
    DefineMethod('ConvUnitAdd',5,tkVariant,nil,__ConvUnitAdd,false,0,'AValue1: Double; AType1: TConvType; AValue2: Double; AType2: TConvType; AResultType: TConvType');
    DefineMethod('ConvUnitDiff',5,tkVariant,nil,__ConvUnitDiff,false,0,'AValue1: Double; AType1: TConvType; AValue2: Double; AType2: TConvType; AResultType: TConvType');
    DefineMethod('ConvUnitInc',3,tkVariant,nil,__ConvUnitInc,false,0,'AValue: Double; AType: TConvType; AAmountType: TConvType');
    DefineMethod('ConvUnitDec',3,tkVariant,nil,__ConvUnitDec,false,0,'AValue: Double; AType: TConvType; AAmountType: TConvType');
    DefineMethod('ConvUnitWithinPrevious',5,tkVariant,nil,__ConvUnitWithinPrevious,false,0,'AValue: Double; ATest: Double; AType: TConvType; AAmount: Double; AAmountType: TConvType');
    DefineMethod('ConvUnitWithinNext',5,tkVariant,nil,__ConvUnitWithinNext,false,0,'AValue: Double; ATest: Double; AType: TConvType; AAmount: Double; AAmountType: TConvType');
    DefineMethod('ConvUnitCompareValue',4,tkEnumeration,nil,__ConvUnitCompareValue,false,0,'AValue1: Double; AType1: TConvType; AValue2: Double; AType2: TConvType');
    DefineMethod('ConvUnitSameValue',4,tkVariant,nil,__ConvUnitSameValue,false,0,'AValue1: Double; AType1: TConvType; AValue2: Double; AType2: TConvType');
    DefineMethod('RegisterConversionType',3,tkInteger,nil,__RegisterConversionType,false,0,'AFamily: TConvFamily; ADescription: string; AFactor: Double');
    DefineMethod('UnregisterConversionType',1,tkNone,nil,__UnregisterConversionType,false,0,'AType: TConvType');
    DefineMethod('RegisterConversionFamily',1,tkInteger,nil,__RegisterConversionFamily,false,0,'ADescription: string');
    DefineMethod('UnregisterConversionFamily',1,tkNone,nil,__UnregisterConversionFamily,false,0,'AFamily: TConvFamily');
    DefineMethod('CompatibleConversionTypes',2,tkVariant,nil,__CompatibleConversionTypes,false,0,'AFrom: TConvType; ATo: TConvType');
    DefineMethod('CompatibleConversionType',2,tkVariant,nil,__CompatibleConversionType,false,0,'AType: TConvType; AFamily: TConvFamily');
    DefineMethod('StrToConvUnit',2,tkVariant,nil,__StrToConvUnit,false,0,'AText: string; AType: TConvType').SetVarArgs([1]);
    DefineMethod('TryStrToConvUnit',3,tkVariant,nil,__TryStrToConvUnit,false,0,'AText: string; AValue: Double; AType: TConvType').SetVarArgs([1,2]);
    DefineMethod('ConvUnitToStr',2,tkVariant,nil,__ConvUnitToStr,false,0,'AValue: Double; AType: TConvType');
    DefineMethod('ConvTypeToDescription',1,tkVariant,nil,__ConvTypeToDescription,false,0,'AType: TConvType');
    DefineMethod('ConvFamilyToDescription',1,tkVariant,nil,__ConvFamilyToDescription,false,0,'AFamily: TConvFamily');
    DefineMethod('DescriptionToConvType',2,tkVariant,nil,__DescriptionToConvType,false,0,'ADescription: string; AType: TConvType').SetVarArgs([1]);
    DefineMethod('DescriptionToConvFamily',2,tkVariant,nil,__DescriptionToConvFamily,false,0,'ADescription: string; AFamily: TConvFamily').SetVarArgs([1]);
    DefineMethod('ConvTypeToFamily',1,tkInteger,nil,__ConvTypeToFamily,false,0,'AType: TConvType');
    DefineMethod('TryConvTypeToFamily',2,tkVariant,nil,__TryConvTypeToFamily,false,0,'AType: TConvType; AFamily: TConvFamily').SetVarArgs([1]);
    DefineMethod('RaiseConversionError',1,tkNone,nil,__RaiseConversionError,false,0,'AText: string');
    DefineMethod('RaiseConversionRegError',2,tkNone,nil,__RaiseConversionRegError,false,0,'AFamily: TConvFamily; ADescription: string');
