...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TIBCustomSQLMonitorClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
...
begin
  ...
  begin
    DefineMethod('Create',1,tkClass,TIBCustomSQLMonitor,__TIBCustomSQLMonitorCreate,true,0,'AOwner: TComponent');
