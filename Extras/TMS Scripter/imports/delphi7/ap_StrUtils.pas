...
case InputArgCount of
5: AResult := string(StrUtils.SearchBuf(PChar(VarToStr(GetInputArg(0))),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)),VarToStr(GetInputArg(4))));
6: AResult := string(StrUtils.SearchBuf(PChar(VarToStr(GetInputArg(0))),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)),VarToStr(GetInputArg(4)),Param5));
end;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('SearchBuf',6,tkVariant,nil,__SearchBuf,false,1,'Buf: PChar; BufLen: Integer; SelStart: Integer; SelLength: Integer; SearchString: String; Options: TStringSearchOptions = [soDown]');
    DefineMethod('PosEx',3,tkInteger,nil,__PosEx,false,1,'SubStr: string; S: string; Offset: Cardinal = 1');
