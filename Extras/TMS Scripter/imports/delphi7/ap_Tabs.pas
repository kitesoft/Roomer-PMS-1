...
begin
  ...
  begin
    ...
    DefineMethod('ItemAtPos',1,tkInteger,nil,__TTabSetItemAtPos,false,0,'Pos: TPoint');
    DefineMethod('ItemRect',1,tkVariant,nil,__TTabSetItemRect,false,0,'Item: Integer');
