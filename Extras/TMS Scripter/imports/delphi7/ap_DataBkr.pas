...
type
  TatDataBkrLibrary = class(TatScripterLibrary)
    ...
    procedure __GetTRemoteDataModuleProviderCount(AMachine: TatVirtualMachine);
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TRemoteDataModuleClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
...
begin
  with AMachine do
  begin
    TRemoteDataModule(CurrentObject).RegisterProvider(TCustomProvider(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TRemoteDataModule(CurrentObject).UnRegisterProvider(TCustomProvider(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TRemoteDataModule(CurrentObject).Providers[VarToStr(GetArrayIndex(0))]));
  end;
end;

procedure TatDataBkrLibrary.__GetTRemoteDataModuleProviderCount(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TRemoteDataModule(CurrentObject).ProviderCount));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCRemoteDataModuleClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TCRemoteDataModule(CurrentObject).RegisterProvider(TCustomProvider(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TCRemoteDataModule(CurrentObject).UnRegisterProvider(TCustomProvider(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCRemoteDataModule(CurrentObject).GetProvider(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCRemoteDataModule(CurrentObject).Providers[VarToStr(GetArrayIndex(0))]));
  end;
end;
...
begin
  ...
  begin
    Case InputArgCount of
      3: DataBkr.RegisterPooled(VarToStr(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)));
      4: DataBkr.RegisterPooled(VarToStr(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),GetInputArg(3));
    end;
  end;
end;
...
begin
  with AMachine do
  begin
    DataBkr.UnregisterPooled(VarToStr(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    DataBkr.EnableSocketTransport(VarToStr(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    DataBkr.DisableSocketTransport(VarToStr(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    DataBkr.EnableWebTransport(VarToStr(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    DataBkr.DisableWebTransport(VarToStr(GetInputArg(0)));
  end;
end;
...
begin
  ...
  begin
    DefineMethod('Create',1,tkClass,TRemoteDataModule,__TRemoteDataModuleCreate,true,0,'AOwner: TComponent');
    DefineMethod('Destroy',0,tkNone,nil,__TRemoteDataModuleDestroy,false,0,'');
    DefineMethod('RegisterProvider',1,tkNone,nil,__TRemoteDataModuleRegisterProvider,false,0,'Value: TCustomProvider');
    DefineMethod('UnRegisterProvider',1,tkNone,nil,__TRemoteDataModuleUnRegisterProvider,false,0,'Value: TCustomProvider');
    ...
    DefineProp('ProviderCount',tkInteger,__GetTRemoteDataModuleProviderCount,nil,nil,false,0);
  end;
  With Scripter.DefineClass(TCRemoteDataModule) do
  begin
    DefineMethod('Create',1,tkClass,TCRemoteDataModule,__TCRemoteDataModuleCreate,true,0,'AOwner: TComponent');
    DefineMethod('Destroy',0,tkNone,nil,__TCRemoteDataModuleDestroy,false,0,'');
    DefineMethod('RegisterProvider',1,tkNone,nil,__TCRemoteDataModuleRegisterProvider,false,0,'Value: TCustomProvider');
    DefineMethod('UnRegisterProvider',1,tkNone,nil,__TCRemoteDataModuleUnRegisterProvider,false,0,'Value: TCustomProvider');
    ...
    DefineMethod('GetProvider',1,tkClass,TCustomProvider,__TCRemoteDataModuleGetProvider,false,0,'ProviderName: string');
  ...
  begin
    DefineMethod('RegisterPooled',4,tkNone,nil,__RegisterPooled,false,1,'ClassID: string; Max: Integer; Timeout: Integer; Singleton: Boolean = False');
    DefineMethod('UnregisterPooled',1,tkNone,nil,__UnregisterPooled,false,0,'ClassID: string');
    DefineMethod('EnableSocketTransport',1,tkNone,nil,__EnableSocketTransport,false,0,'ClassID: string');
    DefineMethod('DisableSocketTransport',1,tkNone,nil,__DisableSocketTransport,false,0,'ClassID: string');
    DefineMethod('EnableWebTransport',1,tkNone,nil,__EnableWebTransport,false,0,'ClassID: string');
    DefineMethod('DisableWebTransport',1,tkNone,nil,__DisableWebTransport,false,0,'ClassID: string');
  end;
end;
