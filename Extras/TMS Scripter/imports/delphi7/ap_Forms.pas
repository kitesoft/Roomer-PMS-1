...
begin
  with AMachine do
  begin
AResult := ObjectToVar(Forms.GetParentForm(TControl(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(Forms.ValidParentForm(TControl(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    DefineMethod('GetParentForm',1,tkClass,TCustomForm,__GetParentForm,false,0,'Control: TControl');
    DefineMethod('ValidParentForm',1,tkClass,TCustomForm,__ValidParentForm,false,0,'Control: TControl');
