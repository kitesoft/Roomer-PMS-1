...
begin
  with AMachine do
  begin
AResult := TOpenDialog(CurrentObject).Execute;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TSaveDialog(CurrentObject).Execute;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TColorDialog(CurrentObject).Execute;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TFontDialog(CurrentObject).Execute;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TPrinterSetupDialog(CurrentObject).Execute;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TPrintDialog(CurrentObject).Execute;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TPageSetupDialog(CurrentObject).Execute;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TFindDialog(CurrentObject).Execute;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('Execute',0,tkVariant,nil,__TOpenDialogExecute,false,0,'');
  ...
  begin
    DefineMethod('Execute',0,tkVariant,nil,__TSaveDialogExecute,false,0,'');
  end;
  ...
  begin
    ...
    DefineMethod('Execute',0,tkVariant,nil,__TColorDialogExecute,false,0,'');
  end;
  ...
  begin
    ...
    DefineMethod('Execute',0,tkVariant,nil,__TFontDialogExecute,false,0,'');
  end;
  With Scripter.DefineClass(TPrinterSetupDialog) do
  begin
    DefineMethod('Execute',0,tkVariant,nil,__TPrinterSetupDialogExecute,false,0,'');
  end;
  With Scripter.DefineClass(TPrintDialog) do
  begin
    DefineMethod('Execute',0,tkVariant,nil,__TPrintDialogExecute,false,0,'');
  end;
  ...
  begin
    ...
    DefineMethod('Execute',0,tkVariant,nil,__TPageSetupDialogExecute,false,0,'');
  ...
  begin
    ...
    DefineMethod('Execute',0,tkVariant,nil,__TFindDialogExecute,false,0,'');
