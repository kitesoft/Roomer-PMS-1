...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TIBEventsClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
...
begin
  ...
  begin
    DefineMethod('Create',1,tkClass,TIBEvents,__TIBEventsCreate,true,0,'AOwner: TComponent');
    ...
    DefineMethod('SetAutoRegister',1,tkNone,nil,__TIBEventsSetAutoRegister,false,0,'Value: Boolean');
