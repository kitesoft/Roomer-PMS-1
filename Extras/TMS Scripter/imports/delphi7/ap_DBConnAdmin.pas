...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TConnectionAdminClass(CurrentClass.ClassRef).Create);
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TConnectionAdmin(CurrentObject).ConnectionConfig));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TConnectionAdmin(CurrentObject).DriverConfig));
  end;
end;
