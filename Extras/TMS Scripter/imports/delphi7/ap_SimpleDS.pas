...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TSimpleDataSetClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
...
begin
  ...
  begin
    DefineMethod('Create',1,tkClass,TSimpleDataSet,__TSimpleDataSetCreate,true,0,'AOwner: TComponent');
