...
begin
  ...
  begin
    ...
    DefineMethod('DeletePrinterDriver',3,tkVariant,nil,__DeletePrinterDriver,false,0,'pName: PChar; pEnvironment: PChar; pDriverName: PChar');
    ...
    DefineMethod('AddPrintProcessor',4,tkVariant,nil,__AddPrintProcessor,false,0,'pName: PChar; pEnvironment: PChar; pPathName: PChar; pPrintProcessorName: PChar');
    ...
    DefineMethod('DeletePrintProcessor',3,tkVariant,nil,__DeletePrintProcessor,false,0,'pName: PChar; pEnvironment: PChar; pPrintProcessorName: PChar');
    ...
    DefineMethod('DocumentProperties',6,tkInteger,nil,__DocumentProperties,false,0,'hWnd: HWND; hPrinter: THandle; pDeviceName: PChar; pDevModeOutput: TDeviceMode; pDevModeInput: TDeviceMode; fMode: DWORD').SetVarArgs([4]);
    ...
    DefineMethod('DeletePrinterData',2,tkInteger,nil,__DeletePrinterData,false,0,'hPrinter: THandle; pValueName: PChar');
    ...
    DefineMethod('PrinterMessageBox',6,tkInteger,nil,__PrinterMessageBox,false,0,'hPrinter: THandle; Error: DWORD; hWnd: HWND; pText: PChar; pCaption: PChar; dwType: DWORD');
    ...
    DefineMethod('DeleteForm',2,tkVariant,nil,__DeleteForm,false,0,'hPrinter: THandle; pFormName: PChar');
    ...
    DefineMethod('DeleteMonitor',3,tkVariant,nil,__DeleteMonitor,false,0,'pName: PChar; pEnvironment: PChar; pMonitorName: PChar');
    ...
    DefineMethod('AddPort',3,tkVariant,nil,__AddPort,false,0,'pName: PChar; hWnd: HWND; pMonitorName: PChar');
    ...
    DefineMethod('ConfigurePort',3,tkVariant,nil,__ConfigurePort,false,0,'pName: PChar; hWnd: HWND; pPortName: PChar');
    ...
    DefineMethod('DeletePort',3,tkVariant,nil,__DeletePort,false,0,'pName: PChar; hWnd: HWND; pPortName: PChar');
    ...
    DefineMethod('AddPrinterConnection',1,tkVariant,nil,__AddPrinterConnection,false,0,'pName: PChar');
    ...
    DefineMethod('DeletePrinterConnection',1,tkVariant,nil,__DeletePrinterConnection,false,0,'pName: PChar');
    ...
    DefineMethod('DeletePrintProvidor',3,tkVariant,nil,__DeletePrintProvidor,false,0,'pName: PChar; pEnvironment: PChar; pPrintProvidorName: PChar');
