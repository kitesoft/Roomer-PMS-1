...
begin
  with AMachine do
  begin
AResult := Integer(Mapi.MapiSendDocuments(VarToInteger(GetInputArg(0)),PChar(VarToStr(GetInputArg(1))),PChar(VarToStr(GetInputArg(2))),PChar(VarToStr(GetInputArg(3))),VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Mapi.MapiFindNext(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),PChar(VarToStr(GetInputArg(2))),PChar(VarToStr(GetInputArg(3))),VarToInteger(GetInputArg(4)),VarToInteger(GetInputArg(5)),PChar(VarToStr(GetInputArg(6)))));
    ReturnOutputArg(AResult);
  end;
end;
...
if not Assigned(Param2Rec) or not (Param2Rec is MapiMessageWrapper) then 
  Param2Rec := MapiMessageWrapper.Create(Param2);
Param2 := MapiMessageWrapper(Param2Rec).ObjToRec;
AResult := Integer(Mapi.MapiSaveMail(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),Param2,VarToInteger(GetInputArg(3)),VarToInteger(GetInputArg(4)),PChar(VarToStr(GetInputArg(5)))));
    ReturnOutputArg(AResult);
    SetInputArg(2,integer(MapiMessageWrapper.Create(Param2)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Mapi.MapiDeleteMail(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),PChar(VarToStr(GetInputArg(2))),VarToInteger(GetInputArg(3)),VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('MapiSendDocuments',5,tkInteger,nil,__MapiSendDocuments,false,0,'ulUIParam: Cardinal; lpszDelimChar: LPSTR; lpszFilePaths: LPSTR; lpszFileNames: LPSTR; ulReserved: Cardinal');
    DefineMethod('MapiFindNext',7,tkInteger,nil,__MapiFindNext,false,0,'lhSession: LHANDLE; ulUIParam: Cardinal; lpszMessageType: LPSTR; lpszSeedMessageID: LPSTR; flFlags: FLAGS; ulReserved: Cardinal; lpszMessageID: LPSTR');
    DefineMethod('MapiSaveMail',6,tkInteger,nil,__MapiSaveMail,false,0,'lhSession: LHANDLE; ulUIParam: Cardinal; lpMessage: TMapiMessage; flFlags: FLAGS; ulReserved: Cardinal; lpszMessageID: LPSTR').SetVarArgs([2]);
    DefineMethod('MapiDeleteMail',5,tkInteger,nil,__MapiDeleteMail,false,0,'lhSession: LHANDLE; ulUIParam: Cardinal; lpszMessageID: LPSTR; flFlags: FLAGS; ulReserved: Cardinal');
