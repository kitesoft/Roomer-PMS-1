...
begin
  With Scripter.DefineClass(ClassType) do
  begin
    DefineMethod('XSQLDA_LENGTH',1,tkInteger,nil,__XSQLDA_LENGTH,false,0,'n: Long');
    DefineMethod('add_spb_length',2,tkNone,nil,__add_spb_length,false,0,'p: PChar; length: integer').SetVarArgs([0]);
    DefineMethod('add_spb_numeric',2,tkNone,nil,__add_spb_numeric,false,0,'p: PChar; data: integer').SetVarArgs([0]);
  AddConsts1;
  AddConsts2;
  AddConsts3;
  AddConsts4;
