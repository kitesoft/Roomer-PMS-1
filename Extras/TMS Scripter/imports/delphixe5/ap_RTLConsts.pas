...
procedure TatRTLConstsLibrary.Init;
  ...
  begin
    ...
    begin
      ...
      AddConstant('SThreadExternalCheckTerminated',SThreadExternalCheckTerminated);
      AddConstant('SThreadExternalSetReturnValue',SThreadExternalSetReturnValue);
      ...
      AddConstant('SMinimumDateError',SMinimumDateError);
      AddConstant('SLocalTimeInvalid',SLocalTimeInvalid);
      ...
      AddConstant('sArgumentOutOfRange_NeedNonNegValue',sArgumentOutOfRange_NeedNonNegValue);
      AddConstant('sArgumentOutOfRange_OffLenInvalid',sArgumentOutOfRange_OffLenInvalid);
      AddConstant('sInvalidStringAndObjectArrays',sInvalidStringAndObjectArrays);
      ...
      AddConstant('sNamedSyncObjectsNotSupported',sNamedSyncObjectsNotSupported);
      AddConstant('sInvalidInitialSemaphoreCount',sInvalidInitialSemaphoreCount);
      AddConstant('sInvalidMaxSemaphoreCount',sInvalidMaxSemaphoreCount);
      AddConstant('sSemaphoreCanceled',sSemaphoreCanceled);
      AddConstant('sInvalidSemaphoreReleaseCount',sInvalidSemaphoreReleaseCount);
      AddConstant('sSemaphoreReachedMaxCount',sSemaphoreReachedMaxCount);
      AddConstant('sSpinCountOutOfRange',sSpinCountOutOfRange);
      AddConstant('sCountdownEventCanceled',sCountdownEventCanceled);
      AddConstant('sInvalidResetCount',sInvalidResetCount);
      AddConstant('sInvalidInitialCount',sInvalidInitialCount);
      AddConstant('sInvalidDecrementCount',sInvalidDecrementCount);
      AddConstant('sInvalidIncrementCount',sInvalidIncrementCount);
      AddConstant('sInvalidDecrementOperation',sInvalidDecrementOperation);
      AddConstant('sInvalidIncrementOperation',sInvalidIncrementOperation);
      AddConstant('sCountdownAlreadyZero',sCountdownAlreadyZero);
  ...
  begin
    ...
    begin
      ...
      AddConstant('SArgumentNil',SArgumentNil);
      ...
      AddConstant('SSpinLockInvalidOperation',SSpinLockInvalidOperation);
      AddConstant('SSpinLockReEntered',SSpinLockReEntered);
      AddConstant('SSpinLockNotOwned',SSpinLockNotOwned);
      ...
      AddConstant('SInsufficientReadBuffer',SInsufficientReadBuffer);
      AddConstant('SInvalid7BitEncodedInteger',SInvalid7BitEncodedInteger);
      AddConstant('SNoSurrogates',SNoSurrogates);
      AddConstant('SInvalidStringLength',SInvalidStringLength);
      AddConstant('SReadPastEndOfStream',SReadPastEndOfStream);
      AddConstant('SInvalidGuidArray',SInvalidGuidArray);
    end;
  end;
begin
  With Scripter.DefineClass(ClassType) do
