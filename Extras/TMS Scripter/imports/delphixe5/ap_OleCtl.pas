...
begin
  with AMachine do
  begin
Param0 := IDispatch(VarToObject(GetInputArg(0)));
...
begin
  with AMachine do
  begin
AResult := Integer(IPersistStreamInit(CurrentObject).Load(IStream(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(IPersistStreamInit(CurrentObject).Save(IStream(VarToObject(GetInputArg(0))),GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
Param0 := ITypeInfo(VarToObject(GetInputArg(0)));
...
begin
  with AMachine do
  begin
Param0 := IEnumConnectionPoints(VarToObject(GetInputArg(0)));
...
begin
  with AMachine do
  begin
Param1 := IConnectionPoint(VarToObject(GetInputArg(1)));
...
begin
  with AMachine do
  begin
Param0 := IConnectionPointContainer(VarToObject(GetInputArg(0)));
...
AResult := Integer(IConnectionPoint(CurrentObject).Advise(IUnknown(VarToObject(GetInputArg(0))),Param1));
    ReturnOutputArg(AResult);
...
begin
  with AMachine do
  begin
Param0 := IEnumConnections(VarToObject(GetInputArg(0)));
...
AResult := Integer(IClassFactory2(CurrentObject).CreateInstanceLic(IUnknown(VarToObject(GetInputArg(0))),IUnknown(VarToObject(GetInputArg(1))),TGUIDWrapper(integer(GetInputArg(2))).ObjToRec,StringToWideChar(VarToStr(GetInputArg(3)),@Param3Buf[0],Length(Param3Buf)),Param4));
    ReturnOutputArg(AResult);
...
begin
  with AMachine do
  begin
AResult := Integer(IPropertyPage(CurrentObject).SetPageSite(IPropertyPageSite(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(IPropertyPage(CurrentObject).SetObjects(VarToInteger(GetInputArg(0)),IUnknown(VarToObject(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := Integer(IPropertyPage(CurrentObject).Help(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Integer(IFont(CurrentObject).put_Name(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
Param0 := IFont(VarToObject(GetInputArg(0)));
...
begin
  with AMachine do
  begin
AResult := Integer(IFont(CurrentObject).IsEqual(IFont(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param2 := VarToInteger(GetInputArg(2));
AResult := Integer(IPicture(CurrentObject).SaveAsFile(IStream(VarToObject(GetInputArg(0))),GetInputArg(1),Param2));
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
  end;
end;
...
begin
  ...
  begin
Param4 := GetInputArg(4);
AResult := Integer(OleCtl.OleLoadPicture(IStream(VarToObject(GetInputArg(0))),VarToInteger(GetInputArg(1)),GetInputArg(2),TGUIDWrapper(integer(GetInputArg(3))).ObjToRec,Param4));
    ReturnOutputArg(AResult);
    SetInputArg(4,Param4);
  end;
end;
...
begin
  ...
  begin
    DefineMethod('GetControlInfo',1,tkInteger,nil,__IOleControlGetControlInfo,false,0,'ci: TControlInfo').SetVarArgs([0]);
    DefineMethod('OnAmbientPropertyChange',1,tkInteger,nil,__IOleControlOnAmbientPropertyChange,false,0,'dispid: TDispID');
    DefineMethod('FreezeEvents',1,tkInteger,nil,__IOleControlFreezeEvents,false,0,'bFreeze: BOOL');
  end;
  ...
  begin
    ...
    DefineMethod('LockInPlaceActive',1,tkInteger,nil,__IOleControlSiteLockInPlaceActive,false,0,'fLock: BOOL');
    DefineMethod('GetExtendedControl',1,tkInteger,nil,__IOleControlSiteGetExtendedControl,false,0,'disp: IDispatch').SetVarArgs([0]);
    DefineMethod('TransformCoords',3,tkInteger,nil,__IOleControlSiteTransformCoords,false,0,'ptlHimetric: TPoint; ptfContainer: TPointF; flags: Longint').SetVarArgs([0,1]);
    DefineMethod('OnFocus',1,tkInteger,nil,__IOleControlSiteOnFocus,false,0,'fGotFocus: BOOL');
  ...
  begin
    DefineMethod('PreMessageFilter',6,tkInteger,nil,__ISimpleFrameSitePreMessageFilter,false,0,'wnd: HWnd; msg: Integer; wp: Integer; lp: Integer; res: Integer; Cookie: Longint').SetVarArgs([4,5]);
    DefineMethod('PostMessageFilter',6,tkInteger,nil,__ISimpleFrameSitePostMessageFilter,false,0,'wnd: HWnd; msg: Integer; wp: Integer; lp: Integer; res: Integer; Cookie: Longint').SetVarArgs([4]);
  end;
  With Scripter.DefineClass(IPersistStreamInit) do
  begin
    DefineMethod('IsDirty',0,tkInteger,nil,__IPersistStreamInitIsDirty,false,0,'');
    DefineMethod('Load',1,tkInteger,nil,__IPersistStreamInitLoad,false,0,'stm: IStream');
    DefineMethod('Save',2,tkInteger,nil,__IPersistStreamInitSave,false,0,'stm: IStream; fClearDirty: BOOL');
    DefineMethod('GetSizeMax',1,tkInteger,nil,__IPersistStreamInitGetSizeMax,false,0,'cbSize: Largeint').SetVarArgs([0]);
    DefineMethod('InitNew',0,tkInteger,nil,__IPersistStreamInitInitNew,false,0,'');
  end;
  With Scripter.DefineClass(IPropertyNotifySink) do
  begin
    DefineMethod('OnChanged',1,tkInteger,nil,__IPropertyNotifySinkOnChanged,false,0,'dispid: TDispID');
    DefineMethod('OnRequestEdit',1,tkInteger,nil,__IPropertyNotifySinkOnRequestEdit,false,0,'dispid: TDispID');
  end;
  With Scripter.DefineClass(IProvideClassInfo) do
  begin
    DefineMethod('GetClassInfo',1,tkInteger,nil,__IProvideClassInfoGetClassInfo,false,0,'ti: ITypeInfo').SetVarArgs([0]);
  end;
  With Scripter.DefineClass(IConnectionPointContainer) do
  begin
    DefineMethod('EnumConnectionPoints',1,tkInteger,nil,__IConnectionPointContainerEnumConnectionPoints,false,0,'Enum: IEnumConnectionPoints').SetVarArgs([0]);
    DefineMethod('FindConnectionPoint',2,tkInteger,nil,__IConnectionPointContainerFindConnectionPoint,false,0,'iid: TIID; cp: IConnectionPoint').SetVarArgs([1]);
  end;
  With Scripter.DefineClass(IEnumConnectionPoints) do
  begin
    DefineMethod('Skip',1,tkInteger,nil,__IEnumConnectionPointsSkip,false,0,'celt: Longint');
    DefineMethod('Reset',0,tkInteger,nil,__IEnumConnectionPointsReset,false,0,'');
    DefineMethod('Clone',1,tkInteger,nil,__IEnumConnectionPointsClone,false,0,'Enum: IEnumConnectionPoints').SetVarArgs([0]);
  end;
  With Scripter.DefineClass(IConnectionPoint) do
  begin
    DefineMethod('GetConnectionInterface',1,tkInteger,nil,__IConnectionPointGetConnectionInterface,false,0,'iid: TIID').SetVarArgs([0]);
    DefineMethod('GetConnectionPointContainer',1,tkInteger,nil,__IConnectionPointGetConnectionPointContainer,false,0,'cpc: IConnectionPointContainer').SetVarArgs([0]);
    DefineMethod('Advise',2,tkInteger,nil,__IConnectionPointAdvise,false,0,'unkSink: IUnknown; dwCookie: Longint').SetVarArgs([1]);
    DefineMethod('Unadvise',1,tkInteger,nil,__IConnectionPointUnadvise,false,0,'dwCookie: Longint');
    DefineMethod('EnumConnections',1,tkInteger,nil,__IConnectionPointEnumConnections,false,0,'Enum: IEnumConnections').SetVarArgs([0]);
  end;
  With Scripter.DefineClass(IEnumConnections) do
  begin
    DefineMethod('Skip',1,tkInteger,nil,__IEnumConnectionsSkip,false,0,'celt: Longint');
    DefineMethod('Reset',0,tkInteger,nil,__IEnumConnectionsReset,false,0,'');
    DefineMethod('Clone',1,tkInteger,nil,__IEnumConnectionsClone,false,0,'Enum: IEnumConnections').SetVarArgs([0]);
  end;
  With Scripter.DefineClass(IClassFactory2) do
  begin
    DefineMethod('GetLicInfo',1,tkInteger,nil,__IClassFactory2GetLicInfo,false,0,'licInfo: TLicInfo').SetVarArgs([0]);
    DefineMethod('RequestLicKey',2,tkInteger,nil,__IClassFactory2RequestLicKey,false,0,'dwResrved: Longint; bstrKey: TBStr').SetVarArgs([1]);
    DefineMethod('CreateInstanceLic',5,tkInteger,nil,__IClassFactory2CreateInstanceLic,false,0,'unkOuter: IUnknown; unkReserved: IUnknown; iid: TIID; bstrKey: TBStr; vObject').SetVarArgs([4]);
  end;
  With Scripter.DefineClass(ISpecifyPropertyPages) do
  begin
    DefineMethod('GetPages',1,tkInteger,nil,__ISpecifyPropertyPagesGetPages,false,0,'pages: TCAGUID').SetVarArgs([0]);
  end;
  With Scripter.DefineClass(IPerPropertyBrowsing) do
  begin
    DefineMethod('GetDisplayString',2,tkInteger,nil,__IPerPropertyBrowsingGetDisplayString,false,0,'dispid: TDispID; bstr: TBStr').SetVarArgs([1]);
    DefineMethod('MapPropertyToPage',2,tkInteger,nil,__IPerPropertyBrowsingMapPropertyToPage,false,0,'dispid: TDispID; clsid: TCLSID').SetVarArgs([1]);
    DefineMethod('GetPredefinedStrings',3,tkInteger,nil,__IPerPropertyBrowsingGetPredefinedStrings,false,0,'dispid: TDispID; caStringsOut: TCAPOleStr; caCookiesOut: TCALongint').SetVarArgs([1,2]);
    DefineMethod('GetPredefinedValue',3,tkInteger,nil,__IPerPropertyBrowsingGetPredefinedValue,false,0,'dispid: TDispID; dwCookie: Longint; varOut: Variant').SetVarArgs([2]);
  end;
  With Scripter.DefineClass(IPropertyPageSite) do
  begin
    DefineMethod('OnStatusChange',1,tkInteger,nil,__IPropertyPageSiteOnStatusChange,false,0,'flags: Longint');
    DefineMethod('GetLocaleID',1,tkInteger,nil,__IPropertyPageSiteGetLocaleID,false,0,'localeID: TLCID').SetVarArgs([0]);
    DefineMethod('GetPageContainer',1,tkInteger,nil,__IPropertyPageSiteGetPageContainer,false,0,'unk: IUnknown').SetVarArgs([0]);
  end;
  With Scripter.DefineClass(IPropertyPage) do
  begin
    DefineMethod('SetPageSite',1,tkInteger,nil,__IPropertyPageSetPageSite,false,0,'pageSite: IPropertyPageSite');
    DefineMethod('Activate',3,tkInteger,nil,__IPropertyPageActivate,false,0,'hwndParent: HWnd; rc: TRect; bModal: BOOL');
    DefineMethod('Deactivate',0,tkInteger,nil,__IPropertyPageDeactivate,false,0,'');
    DefineMethod('GetPageInfo',1,tkInteger,nil,__IPropertyPageGetPageInfo,false,0,'pageInfo: TPropPageInfo').SetVarArgs([0]);
    DefineMethod('SetObjects',2,tkInteger,nil,__IPropertyPageSetObjects,false,0,'cObjects: Longint; unk: IUnknown');
    DefineMethod('Show',1,tkInteger,nil,__IPropertyPageShow,false,0,'nCmdShow: Integer');
    DefineMethod('Move',1,tkInteger,nil,__IPropertyPageMove,false,0,'rect: TRect');
    ...
    DefineMethod('Help',1,tkInteger,nil,__IPropertyPageHelp,false,0,'pszHelpDir: POleStr');
  end;
  With Scripter.DefineClass(IPropertyPage2) do
  begin
    DefineMethod('EditProperty',1,tkInteger,nil,__IPropertyPage2EditProperty,false,0,'dispid: TDispID');
  end;
  With Scripter.DefineClass(IFont) do
  begin
    DefineMethod('get_Name',1,tkInteger,nil,__IFontget_Name,false,0,'name: TBStr').SetVarArgs([0]);
    DefineMethod('put_Name',1,tkInteger,nil,__IFontput_Name,false,0,'name: TBStr');
    DefineMethod('get_Size',1,tkInteger,nil,__IFontget_Size,false,0,'size: TCurrency').SetVarArgs([0]);
    DefineMethod('put_Size',1,tkInteger,nil,__IFontput_Size,false,0,'size: TCurrency');
    DefineMethod('get_Bold',1,tkInteger,nil,__IFontget_Bold,false,0,'bold: BOOL').SetVarArgs([0]);
    DefineMethod('put_Bold',1,tkInteger,nil,__IFontput_Bold,false,0,'bold: BOOL');
    DefineMethod('get_Italic',1,tkInteger,nil,__IFontget_Italic,false,0,'italic: BOOL').SetVarArgs([0]);
    DefineMethod('put_Italic',1,tkInteger,nil,__IFontput_Italic,false,0,'italic: BOOL');
    DefineMethod('get_Underline',1,tkInteger,nil,__IFontget_Underline,false,0,'underline: BOOL').SetVarArgs([0]);
    DefineMethod('put_Underline',1,tkInteger,nil,__IFontput_Underline,false,0,'underline: BOOL');
    DefineMethod('get_Strikethrough',1,tkInteger,nil,__IFontget_Strikethrough,false,0,'strikethrough: BOOL').SetVarArgs([0]);
    DefineMethod('put_Strikethrough',1,tkInteger,nil,__IFontput_Strikethrough,false,0,'strikethrough: BOOL');
    DefineMethod('get_Weight',1,tkInteger,nil,__IFontget_Weight,false,0,'weight: Smallint').SetVarArgs([0]);
    DefineMethod('put_Weight',1,tkInteger,nil,__IFontput_Weight,false,0,'weight: Smallint');
    DefineMethod('get_Charset',1,tkInteger,nil,__IFontget_Charset,false,0,'charset: Smallint').SetVarArgs([0]);
    DefineMethod('put_Charset',1,tkInteger,nil,__IFontput_Charset,false,0,'charset: Smallint');
    DefineMethod('get_hFont',1,tkInteger,nil,__IFontget_hFont,false,0,'font: HFont').SetVarArgs([0]);
    DefineMethod('Clone',1,tkInteger,nil,__IFontClone,false,0,'font: IFont').SetVarArgs([0]);
    DefineMethod('IsEqual',1,tkInteger,nil,__IFontIsEqual,false,0,'fontOther: IFont');
    DefineMethod('SetRatio',2,tkInteger,nil,__IFontSetRatio,false,0,'cyLogical: Longint; cyHimetric: Longint');
    DefineMethod('QueryTextMetrics',1,tkInteger,nil,__IFontQueryTextMetrics,false,0,'tm: TTextMetricOle').SetVarArgs([0]);
    DefineMethod('AddRefHfont',1,tkInteger,nil,__IFontAddRefHfont,false,0,'font: HFont');
    DefineMethod('ReleaseHfont',1,tkInteger,nil,__IFontReleaseHfont,false,0,'font: HFont');
  end;
  ...
  begin
    DefineMethod('get_Handle',1,tkInteger,nil,__IPictureget_Handle,false,0,'handle: OLE_HANDLE').SetVarArgs([0]);
    DefineMethod('get_hPal',1,tkInteger,nil,__IPictureget_hPal,false,0,'handle: OLE_HANDLE').SetVarArgs([0]);
    DefineMethod('get_Type',1,tkInteger,nil,__IPictureget_Type,false,0,'typ: Smallint').SetVarArgs([0]);
    DefineMethod('get_Width',1,tkInteger,nil,__IPictureget_Width,false,0,'width: OLE_XSIZE_HIMETRIC').SetVarArgs([0]);
    DefineMethod('get_Height',1,tkInteger,nil,__IPictureget_Height,false,0,'height: OLE_YSIZE_HIMETRIC').SetVarArgs([0]);
    DefineMethod('Render',10,tkInteger,nil,__IPictureRender,false,0,'dc: HDC; x: Longint; y: Longint; cx: Longint; cy: Longint; xSrc: OLE_XPOS_HIMETRIC; ySrc: OLE_YPOS_HIMETRIC; cxSrc: OLE_XSIZE_HIMETRIC; cySrc: OLE_YSIZE_HIMETRIC; rcWBounds: TRect');
    DefineMethod('set_hPal',1,tkInteger,nil,__IPictureset_hPal,false,0,'hpal: OLE_HANDLE');
    DefineMethod('get_CurDC',1,tkInteger,nil,__IPictureget_CurDC,false,0,'dcOut: HDC').SetVarArgs([0]);
    DefineMethod('SelectPicture',3,tkInteger,nil,__IPictureSelectPicture,false,0,'dcIn: HDC; hdcOut: HDC; bmpOut: OLE_HANDLE').SetVarArgs([1,2]);
    DefineMethod('get_KeepOriginalFormat',1,tkInteger,nil,__IPictureget_KeepOriginalFormat,false,0,'fkeep: BOOL').SetVarArgs([0]);
    DefineMethod('put_KeepOriginalFormat',1,tkInteger,nil,__IPictureput_KeepOriginalFormat,false,0,'fkeep: BOOL');
    DefineMethod('PictureChanged',0,tkInteger,nil,__IPicturePictureChanged,false,0,'');
    DefineMethod('SaveAsFile',3,tkInteger,nil,__IPictureSaveAsFile,false,0,'stream: IStream; fSaveMemCopy: BOOL; cbSize: Longint').SetVarArgs([2]);
    DefineMethod('get_Attributes',1,tkInteger,nil,__IPictureget_Attributes,false,0,'dwAttr: Longint');
  end;
  ...
  begin
    DefineMethod('OleCreatePropertyFrameIndirect',1,tkInteger,nil,__OleCreatePropertyFrameIndirect,false,0,'Params: TOCPFIParams').SetVarArgs([0]);
    ...
    DefineMethod('OleCreateFontIndirect',3,tkInteger,nil,__OleCreateFontIndirect,false,0,'FontDesc: TFontDesc; iid: TIID; vObject').SetVarArgs([0,2]);
    DefineMethod('OleCreatePictureIndirect',4,tkInteger,nil,__OleCreatePictureIndirect,false,0,'PictDesc: TPictDesc; iid: TIID; fOwn: BOOL; vObject').SetVarArgs([0,3]);
    DefineMethod('OleLoadPicture',5,tkInteger,nil,__OleLoadPicture,false,0,'stream: IStream; lSize: Longint; fRunmode: BOOL; iid: TIID; vObject').SetVarArgs([4]);
