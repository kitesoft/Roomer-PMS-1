...
begin
  ...
  begin
    ...
    AddConstant('sdNewFolder',sdNewFolder);
    AddConstant('sdShowEdit',sdShowEdit);
    AddConstant('sdShowShares',sdShowShares);
    AddConstant('sdNewUI',sdNewUI);
    AddConstant('sdShowFiles',sdShowFiles);
    AddConstant('sdValidateDir',sdValidateDir);
