...
type
  TatDBClientLibrary = class(TatScripterLibrary)
    ...
    procedure __GetTCustomClientDataSetRanged(AMachine: TatVirtualMachine);
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(EDBClientClass(CurrentClass.ClassRef).Create(VarToStr(GetInputArg(0)),VarToInteger(GetInputArg(1))));
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(EReconcileErrorClass(CurrentClass.ClassRef).Create(VarToStr(GetInputArg(0)),VarToStr(GetInputArg(1)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(EReconcileError(CurrentObject).Context));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomRemoteServerClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TConnectionBrokerClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TAggregateClass(CurrentClass.ClassRef).Create(TAggregates(VarToObject(GetInputArg(0))),TCustomClientDataSet(VarToObject(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TAggregate(CurrentObject).Assign(TPersistent(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(TAggregate(CurrentObject).GetDisplayName);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TAggregate(CurrentObject).DataSet));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TAggregate(CurrentObject).DataType));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TAggregatesClass(CurrentClass.ClassRef).Create(TPersistent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TAggregates(CurrentObject).Add);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TAggregates(CurrentObject).Find(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TAggregates(CurrentObject).IndexOf(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TAggregates(CurrentObject).Items[VarToInteger(GetArrayIndex(0))]));
  end;
end;
...
begin
  with AMachine do
  begin
    TAggregates(CurrentObject).Items[VarToInteger(GetArrayIndex(0))]:=TAggregate(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomClientDataSetClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
IntToSet(Param2, VarToInteger(GetInputArg(2)), SizeOf(Param2));
    Case InputArgCount of
      3: TCustomClientDataSet(CurrentObject).AddIndex(VarToStr(GetInputArg(0)),VarToStr(GetInputArg(1)),Param2);
      4: TCustomClientDataSet(CurrentObject).AddIndex(VarToStr(GetInputArg(0)),VarToStr(GetInputArg(1)),Param2,VarToStr(GetInputArg(3)));
      5: TCustomClientDataSet(CurrentObject).AddIndex(VarToStr(GetInputArg(0)),VarToStr(GetInputArg(1)),Param2,VarToStr(GetInputArg(3)),VarToStr(GetInputArg(4)));
      6: TCustomClientDataSet(CurrentObject).AddIndex(VarToStr(GetInputArg(0)),VarToStr(GetInputArg(1)),Param2,VarToStr(GetInputArg(3)),VarToStr(GetInputArg(4)),VarToInteger(GetInputArg(5)));
    end;
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomClientDataSet(CurrentObject).CreateBlobStream(TField(VarToObject(GetInputArg(0))),TBlobStreamMode(VarToInteger(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    Case InputArgCount of
      2: TCustomClientDataSet(CurrentObject).CloneCursor(TCustomClientDataSet(VarToObject(GetInputArg(0))),GetInputArg(1));
      3: TCustomClientDataSet(CurrentObject).CloneCursor(TCustomClientDataSet(VarToObject(GetInputArg(0))),GetInputArg(1),GetInputArg(2));
    end;
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomClientDataSet(CurrentObject).DeleteIndex(VarToStr(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomClientDataSet(CurrentObject).GetIndexInfo(VarToStr(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomClientDataSet(CurrentObject).GetIndexNames(TStrings(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TCustomClientDataSet(CurrentObject).GetOptionalParam(VarToStr(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomClientDataSet(CurrentObject).GotoCurrent(TCustomClientDataSet(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  ...
  begin
IntToSet(Param2, VarToInteger(GetInputArg(2)), SizeOf(Param2));
AResult := TCustomClientDataSet(CurrentObject).Locate(VarToStr(GetInputArg(0)),GetInputArg(1),Param2);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TCustomClientDataSet(CurrentObject).Lookup(VarToStr(GetInputArg(0)),GetInputArg(1),VarToStr(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    Case InputArgCount of
      ...
      1: TCustomClientDataSet(CurrentObject).LoadFromFile(VarToStr(GetInputArg(0)));
    end;
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomClientDataSet(CurrentObject).LoadFromStream(TStream(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  ...
  begin
    Case InputArgCount of
      ...
      1: TCustomClientDataSet(CurrentObject).SaveToFile(VarToStr(GetInputArg(0)));
      2: TCustomClientDataSet(CurrentObject).SaveToFile(VarToStr(GetInputArg(0)),TDataPacketFormat(VarToInteger(GetInputArg(1))));
    end;
  end;
end;
...
begin
  ...
  begin
    Case InputArgCount of
      1: TCustomClientDataSet(CurrentObject).SaveToStream(TStream(VarToObject(GetInputArg(0))));
      2: TCustomClientDataSet(CurrentObject).SaveToStream(TStream(VarToObject(GetInputArg(0))),TDataPacketFormat(VarToInteger(GetInputArg(1))));
    end;
  end;
end;
...
begin
  ...
  begin
    Case InputArgCount of
      2: TCustomClientDataSet(CurrentObject).SetOptionalParam(VarToStr(GetInputArg(0)),GetInputArg(1));
      3: TCustomClientDataSet(CurrentObject).SetOptionalParam(VarToStr(GetInputArg(0)),GetInputArg(1),GetInputArg(2));
    end;
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomClientDataSet(CurrentObject).SetProvider(TComponent(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TCustomClientDataSet(CurrentObject).UpdateStatus);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TCustomClientDataSet(CurrentObject).ProviderName));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomClientDataSet(CurrentObject).ProviderName:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TCustomClientDataSet(CurrentObject).FileName));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomClientDataSet(CurrentObject).FileName:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomClientDataSet(CurrentObject).ConnectionBroker));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomClientDataSet(CurrentObject).ConnectionBroker:=TConnectionBroker(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomClientDataSet(CurrentObject).RemoteServer));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomClientDataSet(CurrentObject).RemoteServer:=TCustomRemoteServer(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomClientDataSet(CurrentObject).ActiveAggs[VarToInteger(GetArrayIndex(0))]));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomClientDataSet(CurrentObject).CloneSource));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TCustomClientDataSet(CurrentObject).XMLData));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomClientDataSet(CurrentObject).XMLData:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomClientDataSet(CurrentObject).IndexFields[VarToInteger(GetArrayIndex(0))]));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomClientDataSet(CurrentObject).IndexFields[VarToInteger(GetArrayIndex(0))]:=TField(VarToObject(GetInputArg(0)));
  end;
end;
...
procedure TatDBClientLibrary.__GetTCustomClientDataSetRanged(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(TCustomClientDataSet(CurrentObject).Ranged);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TClientBlobStreamClass(CurrentClass.ClassRef).Create(TBlobField(VarToObject(GetInputArg(0))),TBlobStreamMode(VarToInteger(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    ...
    Action := TReconcileAction(VarToInteger(ActionTemp));
    if AssignedMethod(AfterCall) then
...
case InputArgCount of
1: AResult := DBClient.PackageParams(TParams(VarToObject(GetInputArg(0))));
2: AResult := DBClient.PackageParams(TParams(VarToObject(GetInputArg(0))),Param1);
end;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    DBClient.UnpackParams(GetInputArg(0),TParams(VarToObject(GetInputArg(1))));
  end;
end;
...
begin
  ...
  begin
    DefineMethod('Create',2,tkClass,EDBClient,__EDBClientCreate,true,0,'Message: string; ErrorCode: DBResult');
    DefineProp('ErrorCode',tkInteger,__GetEDBClientErrorCode,nil,nil,false,0);
  end;
  With Scripter.DefineClass(EReconcileError) do
  begin
    DefineMethod('Create',4,tkClass,EReconcileError,__EReconcileErrorCreate,true,0,'NativeError: string; Context: string; ErrorCode: DBResult; PreviousError: DBResult');
  ...
  begin
    DefineMethod('Create',1,tkClass,TCustomRemoteServer,__TCustomRemoteServerCreate,true,0,'AOwner: TComponent');
  ...
  begin
    DefineMethod('Create',1,tkClass,TConnectionBroker,__TConnectionBrokerCreate,true,0,'AOwner: TComponent');
  end;
  With Scripter.DefineClass(TAggregate) do
  begin
    DefineMethod('Create',2,tkClass,TAggregate,__TAggregateCreate,true,0,'Aggregates: TAggregates; ADataSet: TCustomClientDataSet');
    DefineMethod('Destroy',0,tkNone,nil,__TAggregateDestroy,false,0,'');
    DefineMethod('Assign',1,tkNone,nil,__TAggregateAssign,false,0,'Source: TPersistent');
  ...
  begin
    DefineMethod('Create',1,tkClass,TAggregates,__TAggregatesCreate,true,0,'Owner: TPersistent');
    DefineMethod('Add',0,tkClass,TAggregate,__TAggregatesAdd,false,0,'');
    DefineMethod('Clear',0,tkNone,nil,__TAggregatesClear,false,0,'');
    DefineMethod('Find',1,tkClass,TAggregate,__TAggregatesFind,false,0,'DisplayName: string');
    DefineMethod('IndexOf',1,tkInteger,nil,__TAggregatesIndexOf,false,0,'DisplayName: string');
  ...
  begin
    DefineMethod('Create',1,tkClass,TCustomClientDataSet,__TCustomClientDataSetCreate,true,0,'AOwner: TComponent');
    DefineMethod('Destroy',0,tkNone,nil,__TCustomClientDataSetDestroy,false,0,'');
    DefineMethod('AddIndex',6,tkNone,nil,__TCustomClientDataSetAddIndex,false,3,'Name: string; Fields: string; Options: TIndexOptions; DescFields: string = ''; CaseInsFields: string = ''; GroupingLevel: Integer = 0');
    DefineMethod('AppendData',2,tkNone,nil,__TCustomClientDataSetAppendData,false,0,'Data: OleVariant; HitEOF: Boolean');
    DefineMethod('ApplyRange',0,tkNone,nil,__TCustomClientDataSetApplyRange,false,0,'');
    DefineMethod('ApplyUpdates',1,tkInteger,nil,__TCustomClientDataSetApplyUpdates,false,0,'MaxErrors: Integer');
    ...
    DefineMethod('CreateBlobStream',2,tkClass,TStream,__TCustomClientDataSetCreateBlobStream,false,0,'Field: TField; Mode: TBlobStreamMode');
    DefineMethod('CreateDataSet',0,tkNone,nil,__TCustomClientDataSetCreateDataSet,false,0,'');
    DefineMethod('CloneCursor',3,tkNone,nil,__TCustomClientDataSetCloneCursor,false,1,'Source: TCustomClientDataSet; Reset: Boolean; KeepSettings: Boolean = False');
    DefineMethod('ConstraintsDisabled',0,tkVariant,nil,__TCustomClientDataSetConstraintsDisabled,false,0,'');
    DefineMethod('DataRequest',1,tkVariant,nil,__TCustomClientDataSetDataRequest,false,0,'Data: OleVariant');
    DefineMethod('DeleteIndex',1,tkNone,nil,__TCustomClientDataSetDeleteIndex,false,0,'Name: string');
    ...
    DefineMethod('GetGroupState',1,tkInteger,nil,__TCustomClientDataSetGetGroupState,false,0,'Level: Integer');
    DefineMethod('GetIndexInfo',1,tkNone,nil,__TCustomClientDataSetGetIndexInfo,false,0,'IndexName: string');
    DefineMethod('GetIndexNames',1,tkNone,nil,__TCustomClientDataSetGetIndexNames,false,0,'List: TStrings');
    DefineMethod('GetNextPacket',0,tkInteger,nil,__TCustomClientDataSetGetNextPacket,false,0,'');
    DefineMethod('GetOptionalParam',1,tkVariant,nil,__TCustomClientDataSetGetOptionalParam,false,0,'ParamName: string');
    DefineMethod('GotoCurrent',1,tkNone,nil,__TCustomClientDataSetGotoCurrent,false,0,'DataSet: TCustomClientDataSet');
    ...
    DefineMethod('Locate',3,tkVariant,nil,__TCustomClientDataSetLocate,false,0,'KeyFields: string; KeyValues: Variant; Options: TLocateOptions');
    DefineMethod('Lookup',3,tkVariant,nil,__TCustomClientDataSetLookup,false,0,'KeyFields: string; KeyValues: Variant; ResultFields: string');
    DefineMethod('LoadFromFile',1,tkNone,nil,__TCustomClientDataSetLoadFromFile,false,1,'FileName: string = ''');
    DefineMethod('LoadFromStream',1,tkNone,nil,__TCustomClientDataSetLoadFromStream,false,0,'Stream: TStream');
    ...
    DefineMethod('Reconcile',1,tkVariant,nil,__TCustomClientDataSetReconcile,false,0,'Results: OleVariant');
    DefineMethod('RevertRecord',0,tkNone,nil,__TCustomClientDataSetRevertRecord,false,0,'');
    DefineMethod('SaveToFile',2,tkNone,nil,__TCustomClientDataSetSaveToFile,false,2,'FileName: string = ''; Format: TDataPacketFormat = dfBinary');
    DefineMethod('SaveToStream',2,tkNone,nil,__TCustomClientDataSetSaveToStream,false,1,'Stream: TStream; Format: TDataPacketFormat = dfBinary');
    DefineMethod('SetKey',0,tkNone,nil,__TCustomClientDataSetSetKey,false,0,'');
    DefineMethod('SetOptionalParam',3,tkNone,nil,__TCustomClientDataSetSetOptionalParam,false,1,'ParamName: string; Value: OleVariant; IncludeInDelta: Boolean = False');
    DefineMethod('SetProvider',1,tkNone,nil,__TCustomClientDataSetSetProvider,false,0,'Provider: TComponent');
    ...
    DefineMethod('UndoLastChange',1,tkVariant,nil,__TCustomClientDataSetUndoLastChange,false,0,'FollowChange: Boolean');
    ...
    DefineProp('Ranged',tkVariant,__GetTCustomClientDataSetRanged,nil,nil,false,0);
  end;
  ...
  begin
    DefineMethod('Create',2,tkClass,TClientBlobStream,__TClientBlobStreamCreate,true,0,'Field: TBlobField; Mode: TBlobStreamMode');
    DefineMethod('Destroy',0,tkNone,nil,__TClientBlobStreamDestroy,false,0,'');
    DefineMethod('Write',2,tkInteger,nil,__TClientBlobStreamWrite,false,0,'Buffer; Count: Longint');
  ...
  begin
    DefineMethod('PackageParams',2,tkVariant,nil,__PackageParams,false,1,'Params: TParams; Types: TParamTypes = AllParamTypes');
    DefineMethod('UnpackParams',2,tkNone,nil,__UnpackParams,false,0,'Source: OleVariant; Dest: TParams');
