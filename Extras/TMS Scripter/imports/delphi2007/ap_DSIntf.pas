...
begin
  with AMachine do
  begin
AResult := string(DSIntf.VariantArrayToString(GetInputArg(0)));
...
begin
  with AMachine do
  begin
AResult := DSIntf.StringToVariantArray(VarToStr(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('StringToVariantArray',1,tkVariant,nil,__StringToVariantArray,false,0,'S: string');
