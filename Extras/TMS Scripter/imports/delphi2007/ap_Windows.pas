...
AResult := Windows.CharToOemW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Windows.CharToOemBuffW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('LoadLibrary',1,tkInteger,nil,__LoadLibrary,false,0,'lpLibFileName: PChar');
    DefineMethod('GetCommandLine',0,tkVariant,nil,__GetCommandLine,false,0,'');
    DefineMethod('FindResource',3,tkInteger,nil,__FindResource,false,0,'hModule: HMODULE; lpName: PChar; lpType: PChar');
    DefineMethod('SetCurrentDirectory',1,tkVariant,nil,__SetCurrentDirectory,false,0,'lpPathName: PChar');
    DefineMethod('GetCurrentDirectory',2,tkInteger,nil,__GetCurrentDirectory,false,0,'nBufferLength: DWORD; lpBuffer: PChar');
    DefineMethod('RemoveDirectory',1,tkVariant,nil,__RemoveDirectory,false,0,'lpPathName: PChar');
    DefineMethod('GetFileAttributes',1,tkInteger,nil,__GetFileAttributes,false,0,'lpFileName: PChar');
    DefineMethod('DeleteFile',1,tkVariant,nil,__DeleteFile,false,0,'lpFileName: PChar');
    DefineMethod('FindFirstFile',2,tkInteger,nil,__FindFirstFile,false,0,'lpFileName: PChar; lpFindFileData: TWIN32FindData').SetVarArgs([1]);
    ...
    DefineMethod('CopyFile',3,tkVariant,nil,__CopyFile,false,0,'lpExistingFileName: PChar; lpNewFileName: PChar; bFailIfExists: BOOL');
    DefineMethod('MoveFile',2,tkVariant,nil,__MoveFile,false,0,'lpExistingFileName: PChar; lpNewFileName: PChar');
    ...
    DefineMethod('CopyMetaFile',2,tkInteger,nil,__CopyMetaFile,false,0,'p1: HMETAFILE; p2: PChar');
    DefineMethod('CopyEnhMetaFile',2,tkInteger,nil,__CopyEnhMetaFile,false,0,'p1: HENHMETAFILE; p2: PChar');
    ...
    DefineMethod('GetClipboardFormatName',3,tkInteger,nil,__GetClipboardFormatName,false,0,'format: UINT; lpszFormatName: PChar; cchMaxCount: Integer');
    DefineMethod('CharToOem',2,tkVariant,nil,__CharToOem,false,0,'lpszSrc: PChar; lpszDst: PChar');
    DefineMethod('CharToOemA',2,tkVariant,nil,__CharToOemA,false,0,'lpszSrc: PAnsiChar; lpszDst: PAnsiChar');
    DefineMethod('CharToOemW',2,tkVariant,nil,__CharToOemW,false,0,'lpszSrc: PWideChar; lpszDst: PWideChar');
    DefineMethod('OemToChar',2,tkVariant,nil,__OemToChar,false,0,'lpszSrc: PChar; lpszDst: PChar');
    DefineMethod('CharToOemBuff',3,tkVariant,nil,__CharToOemBuff,false,0,'lpszSrc: PChar; lpszDst: PChar; cchDstLength: DWORD');
    ...
    DefineMethod('CharToOemBuffW',3,tkVariant,nil,__CharToOemBuffW,false,0,'lpszSrc: PWideChar; lpszDst: PWideChar; cchDstLength: DWORD');
    DefineMethod('CharUpper',1,tkVariant,nil,__CharUpper,false,0,'lpsz: PChar');
    ...
    DefineMethod('CharUpperBuff',2,tkInteger,nil,__CharUpperBuff,false,0,'lpsz: PChar; cchLength: DWORD');
    ...
    DefineMethod('CharLower',1,tkVariant,nil,__CharLower,false,0,'lpsz: PChar');
    ...
    DefineMethod('CharLowerBuff',2,tkInteger,nil,__CharLowerBuff,false,0,'lpsz: PChar; cchLength: DWORD');
    ...
    DefineMethod('CharNext',1,tkVariant,nil,__CharNext,false,0,'lpsz: PChar');
    ...
    DefineMethod('CharPrev',2,tkVariant,nil,__CharPrev,false,0,'lpszStart: PChar; lpszCurrent: PChar');
    ...
    DefineMethod('MessageBox',4,tkInteger,nil,__MessageBox,false,0,'hWnd: HWND; lpText: PChar; lpCaption: PChar; uType: UINT');
    DefineMethod('MessageBoxEx',5,tkInteger,nil,__MessageBoxEx,false,0,'hWnd: HWND; lpText: PChar; lpCaption: PChar; uType: UINT; wLanguageId: Word');
    ...
    DefineMethod('FindWindow',2,tkInteger,nil,__FindWindow,false,0,'lpClassName: PChar; lpWindowName: PChar');
    ...
    DefineMethod('LoadString',4,tkInteger,nil,__LoadString,false,0,'hInstance: HINST; uID: UINT; lpBuffer: PChar; nBufferMax: Integer');
    DefineMethod('HtmlHelp',4,tkInteger,nil,__HtmlHelp,false,0,'hWndCaller: HWND; pszFile: PChar; uCommand: UINT; dwData: DWORD');
    ...
    DefineMethod('FoldString',5,tkInteger,nil,__FoldString,false,0,'dwMapFlags: DWORD; lpSrcStr: PChar; cchSrc: Integer; lpDestStr: PChar; cchDest: Integer');
