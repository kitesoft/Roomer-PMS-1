...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomWinSocketClass(CurrentClass.ClassRef).Create(VarToInteger(GetInputArg(0))));
...
begin
  ...
  begin
    Case InputArgCount of
      5: TCustomWinSocket(CurrentObject).Listen(VarToStr(GetInputArg(0)),VarToStr(GetInputArg(1)),VarToStr(GetInputArg(2)),VarToInteger(GetInputArg(3)),VarToInteger(GetInputArg(4)));
      6: TCustomWinSocket(CurrentObject).Listen(VarToStr(GetInputArg(0)),VarToStr(GetInputArg(1)),VarToStr(GetInputArg(2)),VarToInteger(GetInputArg(3)),VarToInteger(GetInputArg(4)),GetInputArg(5));
    end;
  end;
end;
...
begin
  ...
  begin
    Case InputArgCount of
      4: TCustomWinSocket(CurrentObject).Open(VarToStr(GetInputArg(0)),VarToStr(GetInputArg(1)),VarToStr(GetInputArg(2)),VarToInteger(GetInputArg(3)));
      5: TCustomWinSocket(CurrentObject).Open(VarToStr(GetInputArg(0)),VarToStr(GetInputArg(1)),VarToStr(GetInputArg(2)),VarToInteger(GetInputArg(3)),GetInputArg(4));
    end;
  end;
end;
...
begin
  with AMachine do
  begin
AResult := integer(in_addrWrapper.Create(TCustomWinSocket(CurrentObject).LookupName(VarToStr(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TCustomWinSocket(CurrentObject).LookupService(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(TCustomWinSocket(CurrentObject).ReceiveText);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TCustomWinSocket(CurrentObject).SendStream(TStream(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TCustomWinSocket(CurrentObject).SendStreamThenDrop(TStream(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TCustomWinSocket(CurrentObject).SendText(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TCustomWinSocket(CurrentObject).LocalHost));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TCustomWinSocket(CurrentObject).LocalAddress));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TCustomWinSocket(CurrentObject).RemoteHost));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TCustomWinSocket(CurrentObject).RemoteAddress));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomWinSocket(CurrentObject).LookupState));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TClientWinSocket(CurrentObject).ClientType));
  end;
end;
...
begin
  with AMachine do
  begin
    TClientWinSocket(CurrentObject).ClientType:=TClientType(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TServerClientWinSocketClass(CurrentClass.ClassRef).Create(VarToInteger(GetInputArg(0)),TServerWinSocket(VarToObject(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TServerClientWinSocket(CurrentObject).ServerWinSocket));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TServerWinSocketClass(CurrentClass.ClassRef).Create(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TServerWinSocket(CurrentObject).GetClientThread(TServerClientWinSocket(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TServerWinSocket(CurrentObject).Connections[VarToInteger(GetArrayIndex(0))]));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TServerWinSocket(CurrentObject).ServerType));
  end;
end;
...
begin
  with AMachine do
  begin
    TServerWinSocket(CurrentObject).ServerType:=TServerType(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TServerAcceptThreadClass(CurrentClass.ClassRef).Create(GetInputArg(0),TServerWinSocket(VarToObject(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TServerAcceptThread(CurrentObject).ServerSocket));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TServerClientThreadClass(CurrentClass.ClassRef).Create(GetInputArg(0),TServerClientWinSocket(VarToObject(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TServerClientThread(CurrentObject).ClientSocket));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TServerClientThread(CurrentObject).ServerSocket));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TWinSocketStreamClass(CurrentClass.ClassRef).Create(TCustomWinSocket(VarToObject(GetInputArg(0))),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TClientSocketClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TClientSocket(CurrentObject).Socket));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TServerSocketClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TServerSocket(CurrentObject).Socket));
  end;
end;
...
begin
  ...
  begin
    ...
    SocketEventTemp := Integer(SocketEvent);
...
begin
  ...
  begin
    ...
    ErrorEventTemp := Integer(ErrorEvent);
...
begin
  ...
  begin
    ...
    ClientSocketTemp := ObjectToVar(ClientSocket);
    if Assigned(Scripter) and (RoutineName > '') then
      Scripter.ExecuteSubroutine(RoutineName, [Sender,Socket,ClientSocketTemp]);
    ClientSocket := TServerClientWinSocket(VarToObject(ClientSocketTemp));
    if AssignedMethod(AfterCall) then
...
begin
  ...
  begin
    ...
    SocketThreadTemp := ObjectToVar(SocketThread);
    if Assigned(Scripter) and (RoutineName > '') then
      Scripter.ExecuteSubroutine(RoutineName, [Sender,ClientSocket,SocketThreadTemp]);
    SocketThread := TServerClientThread(VarToObject(SocketThreadTemp));
    if AssignedMethod(AfterCall) then
...
begin
  ...
  begin
    DefineMethod('Create',1,tkClass,TCustomWinSocket,__TCustomWinSocketCreate,true,0,'ASocket: TSocket');
    ...
    DefineMethod('DefaultHandler',1,tkNone,nil,__TCustomWinSocketDefaultHandler,false,0,'Message').SetVarArgs([0]);
    ...
    DefineMethod('Listen',6,tkNone,nil,__TCustomWinSocketListen,false,1,'Name: string; Address: string; Service: string; Port: Word; QueueSize: Integer; Block: Boolean = True');
    DefineMethod('Open',5,tkNone,nil,__TCustomWinSocketOpen,false,1,'Name: string; Address: string; Service: string; Port: Word; Block: Boolean = True');
    DefineMethod('Accept',1,tkNone,nil,__TCustomWinSocketAccept,false,0,'Socket: TSocket');
    DefineMethod('Connect',1,tkNone,nil,__TCustomWinSocketConnect,false,0,'Socket: TSocket');
    DefineMethod('Disconnect',1,tkNone,nil,__TCustomWinSocketDisconnect,false,0,'Socket: TSocket');
    DefineMethod('Read',1,tkNone,nil,__TCustomWinSocketRead,false,0,'Socket: TSocket');
    DefineMethod('Write',1,tkNone,nil,__TCustomWinSocketWrite,false,0,'Socket: TSocket');
    DefineMethod('LookupName',1,tkVariant,nil,__TCustomWinSocketLookupName,false,0,'name: string');
    DefineMethod('LookupService',1,tkInteger,nil,__TCustomWinSocketLookupService,false,0,'service: string');
    DefineMethod('ReceiveLength',0,tkInteger,nil,__TCustomWinSocketReceiveLength,false,0,'');
    DefineMethod('ReceiveBuf',2,tkInteger,nil,__TCustomWinSocketReceiveBuf,false,0,'Buf; Count: Integer').SetVarArgs([0]);
    DefineMethod('ReceiveText',0,tkVariant,nil,__TCustomWinSocketReceiveText,false,0,'');
    DefineMethod('SendBuf',2,tkInteger,nil,__TCustomWinSocketSendBuf,false,0,'Buf; Count: Integer').SetVarArgs([0]);
    DefineMethod('SendStream',1,tkVariant,nil,__TCustomWinSocketSendStream,false,0,'AStream: TStream');
    DefineMethod('SendStreamThenDrop',1,tkVariant,nil,__TCustomWinSocketSendStreamThenDrop,false,0,'AStream: TStream');
    DefineMethod('SendText',1,tkInteger,nil,__TCustomWinSocketSendText,false,0,'S: string');
  ...
  begin
    DefineMethod('Connect',1,tkNone,nil,__TClientWinSocketConnect,false,0,'Socket: TSocket');
  ...
  begin
    DefineMethod('Create',2,tkClass,TServerClientWinSocket,__TServerClientWinSocketCreate,true,0,'Socket: TSocket; ServerWinSocket: TServerWinSocket');
  ...
  begin
    DefineMethod('Create',1,tkClass,TServerWinSocket,__TServerWinSocketCreate,true,0,'ASocket: TSocket');
    DefineMethod('Destroy',0,tkNone,nil,__TServerWinSocketDestroy,false,0,'');
    DefineMethod('Accept',1,tkNone,nil,__TServerWinSocketAccept,false,0,'Socket: TSocket');
    DefineMethod('Disconnect',1,tkNone,nil,__TServerWinSocketDisconnect,false,0,'Socket: TSocket');
    DefineMethod('GetClientThread',1,tkClass,TServerClientThread,__TServerWinSocketGetClientThread,false,0,'ClientSocket: TServerClientWinSocket');
  ...
  begin
    DefineMethod('Create',2,tkClass,TServerAcceptThread,__TServerAcceptThreadCreate,true,0,'CreateSuspended: Boolean; ASocket: TServerWinSocket');
  ...
  begin
    DefineMethod('Create',2,tkClass,TServerClientThread,__TServerClientThreadCreate,true,0,'CreateSuspended: Boolean; ASocket: TServerClientWinSocket');
  ...
  begin
    DefineMethod('Create',2,tkClass,TWinSocketStream,__TWinSocketStreamCreate,true,0,'ASocket: TCustomWinSocket; TimeOut: Longint');
    DefineMethod('Destroy',0,tkNone,nil,__TWinSocketStreamDestroy,false,0,'');
    DefineMethod('WaitForData',1,tkVariant,nil,__TWinSocketStreamWaitForData,false,0,'Timeout: Longint');
    DefineMethod('Read',2,tkInteger,nil,__TWinSocketStreamRead,false,0,'Buffer; Count: Longint').SetVarArgs([0]);
    DefineMethod('Write',2,tkInteger,nil,__TWinSocketStreamWrite,false,0,'Buffer; Count: Longint');
    DefineMethod('Seek',2,tkInteger,nil,__TWinSocketStreamSeek,false,0,'Offset: Longint; Origin: Word');
  ...
  begin
    DefineMethod('Create',1,tkClass,TClientSocket,__TClientSocketCreate,true,0,'AOwner: TComponent');
  ...
  begin
    DefineMethod('Create',1,tkClass,TServerSocket,__TServerSocketCreate,true,0,'AOwner: TComponent');
