...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCompressionStreamClass(CurrentClass.ClassRef).Create(TCompressionLevel(VarToInteger(GetInputArg(0))),TStream(VarToObject(GetInputArg(1)))));
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TDecompressionStreamClass(CurrentClass.ClassRef).Create(TStream(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    DefineMethod('Create',2,tkClass,TCompressionStream,__TCompressionStreamCreate,true,0,'CompressionLevel: TCompressionLevel; Dest: TStream');
    DefineMethod('Destroy',0,tkNone,nil,__TCompressionStreamDestroy,false,0,'');
    DefineMethod('Read',2,tkInteger,nil,__TCompressionStreamRead,false,0,'Buffer; Count: Longint').SetVarArgs([0]);
    DefineMethod('Write',2,tkInteger,nil,__TCompressionStreamWrite,false,0,'Buffer; Count: Longint');
    DefineMethod('Seek',2,tkInteger,nil,__TCompressionStreamSeek,false,0,'Offset: Longint; Origin: Word');
  ...
  begin
    DefineMethod('Create',1,tkClass,TDecompressionStream,__TDecompressionStreamCreate,true,0,'Source: TStream');
    DefineMethod('Destroy',0,tkNone,nil,__TDecompressionStreamDestroy,false,0,'');
    DefineMethod('Read',2,tkInteger,nil,__TDecompressionStreamRead,false,0,'Buffer; Count: Longint').SetVarArgs([0]);
    DefineMethod('Write',2,tkInteger,nil,__TDecompressionStreamWrite,false,0,'Buffer; Count: Longint');
    DefineMethod('Seek',2,tkInteger,nil,__TDecompressionStreamSeek,false,0,'Offset: Longint; Origin: Word');
    DefineProp('OnProgress',tkVariant,nil,nil,nil,false,0);
  end;
  ...
  begin
    DefineMethod('deflateInit_',4,tkInteger,nil,__deflateInit_,false,0,'strm: TZStreamRec; level: Integer; version: PChar; recsize: Integer').SetVarArgs([0]);
    DefineMethod('deflate',2,tkInteger,nil,__deflate,false,0,'strm: TZStreamRec; flush: Integer').SetVarArgs([0]);
    DefineMethod('deflateEnd',1,tkInteger,nil,__deflateEnd,false,0,'strm: TZStreamRec').SetVarArgs([0]);
    DefineMethod('inflateInit_',3,tkInteger,nil,__inflateInit_,false,0,'strm: TZStreamRec; version: PChar; recsize: Integer').SetVarArgs([0]);
    DefineMethod('inflate',2,tkInteger,nil,__inflate,false,0,'strm: TZStreamRec; flush: Integer').SetVarArgs([0]);
    DefineMethod('inflateEnd',1,tkInteger,nil,__inflateEnd,false,0,'strm: TZStreamRec').SetVarArgs([0]);
    DefineMethod('inflateReset',1,tkInteger,nil,__inflateReset,false,0,'strm: TZStreamRec').SetVarArgs([0]);
