...
type
  TatActnManLibrary = class(TatScripterLibrary)
    ...
    procedure __TCustomActionManagerAfterConstruction(AMachine: TatVirtualMachine);
...
procedure TatActnManLibrary.__TCustomActionManagerAfterConstruction(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomActionManager(CurrentObject).AfterConstruction;
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('AfterConstruction',0,tkNone,nil,__TCustomActionManagerAfterConstruction,false,0,'');
