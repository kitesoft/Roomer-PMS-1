...
begin
  with AMachine do
  begin
AResult := ShlObj.SHGetSpecialFolderPath(VarToInteger(GetInputArg(0)),PChar(VarToStr(GetInputArg(1))),VarToInteger(GetInputArg(2)),GetInputArg(3));
...
begin
  with AMachine do
  begin
AResult := ShlObj.SHGetSpecialFolderPathA(VarToInteger(GetInputArg(0)),PChar(VarToStr(GetInputArg(1))),VarToInteger(GetInputArg(2)),GetInputArg(3));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  With Scripter.DefineClass(ClassType) do
  begin
    DefineMethod('SHGetSpecialFolderPath',4,tkVariant,nil,__SHGetSpecialFolderPath,false,0,'hwndOwner: HWND; lpszPath: PChar; nFolder: Integer; fCreate: BOOL');
