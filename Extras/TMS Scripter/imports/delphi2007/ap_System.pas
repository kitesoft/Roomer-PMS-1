...
AResult := string(System.WideCharToString(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := string(System.WideCharLenToString(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := WideCharToString(System.StringToWideChar(VarToStr(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(System.UnicodeToUtf8(PChar(VarToStr(GetInputArg(0))),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := Integer(System.Utf8ToUnicode(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),PChar(VarToStr(GetInputArg(1))),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(System.UTF8Encode(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := System.UTF8Decode(VarToStr(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(System.AnsiToUtf8(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(System.Utf8ToAnsi(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
AResult := string(System.OleStrToString(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := WideCharToString(System.StringToOleStr(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := System.StringOfChar(VarToStr(GetInputArg(0))[1],VarToInteger(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('UpCase',1,tkVariant,nil,__UpCase,false,0,'Ch: Char');
    ...
    DefineMethod('WideCharToStrVar',2,tkNone,nil,__WideCharToStrVar,false,0,'Source: PWideChar; Dest: string').SetVarArgs([1]);
    DefineMethod('WideCharLenToStrVar',3,tkNone,nil,__WideCharLenToStrVar,false,0,'Source: PWideChar; SourceLen: Integer; Dest: string').SetVarArgs([2]);
    DefineMethod('StringToWideChar',3,tkVariant,nil,__StringToWideChar,false,0,'Source: string; Dest: PWideChar; DestSize: Integer');
    DefineMethod('UnicodeToUtf8',3,tkInteger,nil,__UnicodeToUtf8,false,0,'Dest: PChar; Source: PWideChar; MaxBytes: Integer');
    DefineMethod('Utf8ToUnicode',3,tkInteger,nil,__Utf8ToUnicode,false,0,'Dest: PWideChar; Source: PChar; MaxChars: Integer');
    DefineMethod('UTF8Encode',1,tkVariant,nil,__UTF8Encode,false,0,'WS: WideString');
    DefineMethod('UTF8Decode',1,tkVariant,nil,__UTF8Decode,false,0,'S: UTF8String');
    DefineMethod('AnsiToUtf8',1,tkVariant,nil,__AnsiToUtf8,false,0,'S: string');
    DefineMethod('Utf8ToAnsi',1,tkVariant,nil,__Utf8ToAnsi,false,0,'S: UTF8String');
    DefineMethod('OleStrToString',1,tkVariant,nil,__OleStrToString,false,0,'Source: PWideChar');
    DefineMethod('OleStrToStrVar',2,tkNone,nil,__OleStrToStrVar,false,0,'Source: PWideChar; Dest: string').SetVarArgs([1]);
    DefineMethod('StringToOleStr',1,tkVariant,nil,__StringToOleStr,false,0,'Source: string');
    ...
    DefineMethod('Pos',2,tkInteger,nil,__Pos,false,0,'substr: AnsiString; str: AnsiString');
