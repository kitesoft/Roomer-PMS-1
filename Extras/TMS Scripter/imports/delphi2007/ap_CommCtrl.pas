...
begin
  with AMachine do
  begin
AResult := Integer(CommCtrl.ImageList_LoadBitmapA(VarToInteger(GetInputArg(0)),PChar(VarToStr(GetInputArg(1))),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)),VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
Param2 := VarToInteger(GetInputArg(2));
AResult := CommCtrl.ComboBox_GetCueBannerText(VarToInteger(GetInputArg(0)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),Param2);
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('ImageList_LoadImage',7,tkInteger,nil,__ImageList_LoadImage,false,0,'Instance: THandle; Bmp: PChar; CX: Integer; Grow: Integer; Mask: TColorRef; pType: Cardinal; Flags: Cardinal');
    ...
    DefineMethod('ImageList_LoadBitmap',5,tkInteger,nil,__ImageList_LoadBitmap,false,0,'Instance: THandle; Bmp: PChar; CX: Integer; Grow: Integer; MasK: TColorRef');
    ...
    DefineMethod('CreateStatusWindow',4,tkInteger,nil,__CreateStatusWindow,false,0,'Style: Longint; lpszText: PChar; hwndParent: HWND; wID: UINT');
    ...
    DefineMethod('ListView_SetUnicodeFormat',2,tkInteger,nil,__ListView_SetUnicodeFormat,false,0,'hwnd: HWND; fUnicode: BOOL');
    ...
    DefineMethod('ListView_GetStringWidth',2,tkInteger,nil,__ListView_GetStringWidth,false,0,'hwndLV: HWND; psz: PChar');
    ...
    DefineMethod('ListView_GetItemText',5,tkInteger,nil,__ListView_GetItemText,false,0,'hwndLV: HWND; i: Integer; iSubItem: Integer; pszText: PChar; cchTextMax: Integer');
    ...
    DefineMethod('ListView_SetItemText',4,tkVariant,nil,__ListView_SetItemText,false,0,'hwndLV: HWND; i: Integer; iSubItem: Integer; pszText: PChar');
    ...
    DefineMethod('ListView_GetISearchString',2,tkVariant,nil,__ListView_GetISearchString,false,0,'hwndLV: HWND; lpsz: PChar');
    ...
    DefineMethod('TreeView_GetISearchString',2,tkVariant,nil,__TreeView_GetISearchString,false,0,'hwndTV: HWND; lpsz: PChar');
    ...
    DefineMethod('DateTime_SetFormat',2,tkVariant,nil,__DateTime_SetFormat,false,0,'hdp: HWND; sz: PChar');
    ...
    DefineMethod('ComboBox_GetCueBannerText',3,tkVariant,nil,__ComboBox_GetCueBannerText,false,0,'hwnd: HWND; lpwText: LPCWSTR; cchText: Integer').SetVarArgs([2]);
