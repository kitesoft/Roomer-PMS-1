...
begin
  with AMachine do
  begin
AResult := string(WideStrUtils.UTF8LowerCase(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(WideStrUtils.UTF8UpperCase(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(WideStrUtils.AnsiToUtf8Ex(VarToStr(GetInputArg(0)),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(WideStrUtils.Utf8ToAnsiEx(VarToStr(GetInputArg(0)),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(WideStrUtils.DetectUTF8Encoding(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := WideStrUtils.IsUTF8String(VarToStr(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := WideStrUtils.HasExtendCharacter(VarToStr(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := WideStrUtils.IsUTF8LeadByte(VarToStr(GetInputArg(0))[1]);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := WideStrUtils.IsUTF8TrailByte(VarToStr(GetInputArg(0))[1]);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(WideStrUtils.UTF8CharSize(VarToStr(GetInputArg(0))[1]));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(WideStrUtils.UTF8CharLength(VarToStr(GetInputArg(0))[1]));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('AnsiToUtf8Ex',2,tkVariant,nil,__AnsiToUtf8Ex,false,0,'S: string; cp: integer');
    DefineMethod('Utf8ToAnsiEx',2,tkVariant,nil,__Utf8ToAnsiEx,false,0,'S: UTF8String; cp: integer');
    DefineMethod('DetectUTF8Encoding',1,tkEnumeration,nil,__DetectUTF8Encoding,false,0,'s: UTF8String');
    DefineMethod('IsUTF8String',1,tkVariant,nil,__IsUTF8String,false,0,'s: UTF8String');
    DefineMethod('HasExtendCharacter',1,tkVariant,nil,__HasExtendCharacter,false,0,'s: UTF8String');
    ...
    DefineMethod('IsUTF8LeadByte',1,tkVariant,nil,__IsUTF8LeadByte,false,0,'Lead: Char');
    DefineMethod('IsUTF8TrailByte',1,tkVariant,nil,__IsUTF8TrailByte,false,0,'Lead: Char');
    DefineMethod('UTF8CharSize',1,tkInteger,nil,__UTF8CharSize,false,0,'Lead: Char');
    DefineMethod('UTF8CharLength',1,tkInteger,nil,__UTF8CharLength,false,0,'Lead: Char');
