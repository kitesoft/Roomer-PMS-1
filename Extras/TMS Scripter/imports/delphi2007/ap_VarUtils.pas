...
1: AResult := ObjectToVar(ESafeArrayErrorClass(CurrentClass.ClassRef).CreateHResult(VarToInteger(GetInputArg(0))));
2: AResult := ObjectToVar(ESafeArrayErrorClass(CurrentClass.ClassRef).CreateHResult(VarToInteger(GetInputArg(0)),VarToStr(GetInputArg(1))));
end;
...
begin
  with AMachine do
  begin
AResult := Integer(VarUtils.VarExceptionToResult(Exception(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    DefineMethod('CreateHResult',2,tkClass,ESafeArrayError,__ESafeArrayErrorCreateHResult,true,1,'AResult: HRESULT; AMessage: string = ''');
  ...
  begin
    DefineMethod('VarExceptionToResult',1,tkInteger,nil,__VarExceptionToResult,false,0,'E: Exception');
    DefineMethod('VariantInit',1,tkNone,nil,__VariantInit,false,0,'V: TVarData').SetVarArgs([0]);
    DefineMethod('VariantClear',1,tkInteger,nil,__VariantClear,false,0,'V: TVarData').SetVarArgs([0]);
    DefineMethod('VariantCopy',2,tkInteger,nil,__VariantCopy,false,0,'Dest: TVarData; Source: TVarData').SetVarArgs([0]);
    DefineMethod('VariantCopyInd',2,tkInteger,nil,__VariantCopyInd,false,0,'Dest: TVarData; Source: TVarData').SetVarArgs([0]);
    DefineMethod('VariantChangeType',4,tkInteger,nil,__VariantChangeType,false,0,'Dest: TVarData; Source: TVarData; wFlags: Word; Type: Word').SetVarArgs([0,3]);
    DefineMethod('SafeArrayCheck',1,tkNone,nil,__SafeArrayCheck,false,0,'AResult: HRESULT');
    DefineMethod('SafeArrayError',1,tkNone,nil,__SafeArrayError,false,0,'AResult: HRESULT');
