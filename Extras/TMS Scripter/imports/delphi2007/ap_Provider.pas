...
begin
  with AMachine do
  begin
AResult := ObjectToVar(EDSWriterClass(CurrentClass.ClassRef).Create(VarToStr(GetInputArg(0)),VarToInteger(GetInputArg(1))));
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomPacketWriterClass(CurrentClass.ClassRef).Create);
    ReturnOutputArg(AResult);
  end;
end;
...
Param2 := GetInputArg(2);
    TDataPacketWriter(CurrentObject).GetDataPacket(TDataSet(VarToObject(GetInputArg(0))),Param1,Param2);
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TPacketDataSetClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TPacketDataSet(CurrentObject).AssignCurValues(TDataSet(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TPacketDataSet(CurrentObject).CreateFromDelta(TPacketDataSet(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TPacketDataSet(CurrentObject).UpdateKind);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomProviderClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TBaseProviderClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TBaseProvider(CurrentObject).Resolver));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TBaseProvider(CurrentObject).UpdateMode));
  end;
end;
...
begin
  with AMachine do
  begin
    TBaseProvider(CurrentObject).UpdateMode:=TUpdateMode(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TDataSetProviderClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TDataSetProvider(CurrentObject).Params));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TUpdateTreeClass(CurrentClass.ClassRef).Create(TUpdateTree(VarToObject(GetInputArg(0))),TCustomResolver(VarToObject(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TUpdateTree(CurrentObject).InitData(TDataSet(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TUpdateTree(CurrentObject).InitDelta(TPacketDataSet(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TUpdateTree(CurrentObject).InitErrorPacket(EUpdateError(VarToObject(GetInputArg(0))),TResolverResponse(VarToInteger(GetInputArg(1))));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TUpdateTree(CurrentObject).Delta));
  end;
end;
...
begin
  with AMachine do
  begin
    TUpdateTree(CurrentObject).Delta:=TPacketDataSet(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TUpdateTree(CurrentObject).Details[VarToInteger(GetArrayIndex(0))]));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TUpdateTree(CurrentObject).ErrorDS));
  end;
end;
...
begin
  with AMachine do
  begin
    TUpdateTree(CurrentObject).ErrorDS:=TPacketDataSet(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TUpdateTree(CurrentObject).Parent));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TUpdateTree(CurrentObject).Resolver));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TUpdateTree(CurrentObject).Source));
  end;
end;
...
begin
  with AMachine do
  begin
    TUpdateTree(CurrentObject).Source:=TDataSet(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomResolverClass(CurrentClass.ClassRef).Create(TBaseProvider(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomResolver(CurrentObject).FreeTreeData(TUpdateTree(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomResolver(CurrentObject).InitKeyFields(TUpdateTree(VarToObject(GetInputArg(0))),TPacketDataSet(VarToObject(GetInputArg(1))));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomResolver(CurrentObject).InitTreeData(TUpdateTree(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomResolver(CurrentObject).InternalBeforeResolve(TUpdateTree(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TCustomResolver(CurrentObject).InternalUpdateRecord(TUpdateTree(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomResolver(CurrentObject).Provider));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomResolver(CurrentObject).UpdateTree));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TDataSetResolverClass(CurrentClass.ClassRef).Create(TDataSetProvider(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TDataSetResolver(CurrentObject).InternalBeforeResolve(TUpdateTree(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TSQLResolverClass(CurrentClass.ClassRef).Create(TDataSetProvider(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TSQLResolver(CurrentObject).FreeTreeData(TUpdateTree(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TSQLResolver(CurrentObject).InitTreeData(TUpdateTree(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TLocalAppServerClass(CurrentClass.ClassRef).Create(TCustomProvider(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    ...
    Response := TResolverResponse(VarToInteger(ResponseTemp));
    if AssignedMethod(AfterCall) then
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(Provider.GetObjectProperty(TPersistent(VarToObject(GetInputArg(0))),VarToStr(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Provider.GetStringProperty(TPersistent(VarToObject(GetInputArg(0))),VarToStr(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Provider.VarArrayFromStrings(TStrings(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Provider.VarArrayFromWideStrings(TWideStrings(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    DefineMethod('Create',2,tkClass,EDSWriter,__EDSWriterCreate,true,0,'ErrMsg: string; Status: Integer');
  ...
  begin
    ...
    DefineMethod('GetDataPacket',3,tkNone,nil,__TDataPacketWriterGetDataPacket,false,0,'DataSet: TDataSet; RecsOut: Integer; Data: OleVariant').SetVarArgs([1,2]);
  ...
  begin
    DefineMethod('Create',1,tkClass,TPacketDataSet,__TPacketDataSetCreate,true,0,'AOwner: TComponent');
    DefineMethod('AssignCurValues',1,tkNone,nil,__TPacketDataSetAssignCurValues,false,0,'Source: TDataSet');
    DefineMethod('CreateFromDelta',1,tkNone,nil,__TPacketDataSetCreateFromDelta,false,0,'Source: TPacketDataSet');
    ...
    DefineMethod('InitAltRecBuffers',1,tkNone,nil,__TPacketDataSetInitAltRecBuffers,false,1,'CheckModified: Boolean = True');
  ...
  begin
    DefineMethod('Create',1,tkClass,TCustomProvider,__TCustomProviderCreate,true,0,'AOwner: TComponent');
    DefineMethod('Destroy',0,tkNone,nil,__TCustomProviderDestroy,false,0,'');
    DefineMethod('ApplyUpdates',3,tkVariant,nil,__TCustomProviderApplyUpdates,false,0,'Delta: OleVariant; MaxErrors: Integer; ErrorCount: Integer').SetVarArgs([2]);
    DefineMethod('GetRecords',3,tkVariant,nil,__TCustomProviderGetRecords,false,0,'Count: Integer; RecsOut: Integer; Options: Integer').SetVarArgs([1]);
    DefineMethod('RowRequest',3,tkVariant,nil,__TCustomProviderRowRequest,false,0,'Row: OleVariant; RequestType: Integer; OwnerData: OleVariant').SetVarArgs([2]);
    DefineMethod('Execute',3,tkNone,nil,__TCustomProviderExecute,false,0,'CommandText: WideString; Params: OleVariant; OwnerData: OleVariant').SetVarArgs([1,2]);
    DefineMethod('GetParams',1,tkVariant,nil,__TCustomProviderGetParams,false,0,'OwnerData: OleVariant').SetVarArgs([0]);
    DefineMethod('DataRequest',1,tkVariant,nil,__TCustomProviderDataRequest,false,0,'Input: OleVariant');
  ...
  begin
    DefineMethod('Create',1,tkClass,TBaseProvider,__TBaseProviderCreate,true,0,'AOwner: TComponent');
  ...
  begin
    DefineMethod('Create',1,tkClass,TDataSetProvider,__TDataSetProviderCreate,true,0,'AOwner: TComponent');
  ...
  begin
    DefineMethod('Create',2,tkClass,TUpdateTree,__TUpdateTreeCreate,true,0,'AParent: TUpdateTree; AResolver: TCustomResolver');
    ...
    DefineMethod('InitData',1,tkNone,nil,__TUpdateTreeInitData,false,0,'ASource: TDataSet');
    DefineMethod('InitDelta',1,tkNone,nil,__TUpdateTreeInitDelta,false,0,'ADelta: TPacketDataSet');
    DefineMethod('InitErrorPacket',2,tkNone,nil,__TUpdateTreeInitErrorPacket,false,0,'E: EUpdateError; Response: TResolverResponse');
    DefineMethod('RefreshData',1,tkNone,nil,__TUpdateTreeRefreshData,false,0,'Options: TFetchOptions');
  ...
  begin
    DefineMethod('Create',1,tkClass,TCustomResolver,__TCustomResolverCreate,true,0,'AProvider: TBaseProvider');
    DefineMethod('Destroy',0,tkNone,nil,__TCustomResolverDestroy,false,0,'');
    DefineMethod('ApplyUpdates',3,tkVariant,nil,__TCustomResolverApplyUpdates,false,0,'Delta: OleVariant; MaxErrors: Integer; ErrorCount: Integer').SetVarArgs([2]);
    DefineMethod('FreeTreeData',1,tkNone,nil,__TCustomResolverFreeTreeData,false,0,'Tree: TUpdateTree');
    DefineMethod('InitKeyFields',2,tkNone,nil,__TCustomResolverInitKeyFields,false,0,'Tree: TUpdateTree; ADelta: TPacketDataSet');
    DefineMethod('InitTreeData',1,tkNone,nil,__TCustomResolverInitTreeData,false,0,'Tree: TUpdateTree');
    DefineMethod('InternalBeforeResolve',1,tkNone,nil,__TCustomResolverInternalBeforeResolve,false,0,'Tree: TUpdateTree');
    DefineMethod('InternalUpdateRecord',1,tkVariant,nil,__TCustomResolverInternalUpdateRecord,false,0,'Tree: TUpdateTree');
    DefineMethod('RowRequest',2,tkVariant,nil,__TCustomResolverRowRequest,false,0,'Row: OleVariant; Options: TFetchOptions');
  ...
  begin
    DefineMethod('Create',1,tkClass,TDataSetResolver,__TDataSetResolverCreate,true,0,'AProvider: TDataSetProvider');
    DefineMethod('InternalBeforeResolve',1,tkNone,nil,__TDataSetResolverInternalBeforeResolve,false,0,'Tree: TUpdateTree');
  end;
  With Scripter.DefineClass(TSQLResolver) do
  begin
    DefineMethod('Create',1,tkClass,TSQLResolver,__TSQLResolverCreate,true,0,'AProvider: TDataSetProvider');
    DefineMethod('Destroy',0,tkNone,nil,__TSQLResolverDestroy,false,0,'');
    DefineMethod('FreeTreeData',1,tkNone,nil,__TSQLResolverFreeTreeData,false,0,'Tree: TUpdateTree');
    DefineMethod('InitTreeData',1,tkNone,nil,__TSQLResolverInitTreeData,false,0,'Tree: TUpdateTree');
  end;
  With Scripter.DefineClass(TLocalAppServer) do
  begin
    DefineMethod('Create',1,tkClass,TLocalAppServer,__TLocalAppServerCreate,true,0,'AProvider: TCustomProvider');
  ...
  begin
    DefineMethod('GetObjectProperty',2,tkClass,TObject,__GetObjectProperty,false,0,'Instance: TPersistent; PropName: string');
    DefineMethod('GetStringProperty',2,tkVariant,nil,__GetStringProperty,false,0,'Instance: TPersistent; PropName: string');
    DefineMethod('VarArrayFromStrings',1,tkVariant,nil,__VarArrayFromStrings,false,0,'Strings: TStrings');
    DefineMethod('VarArrayFromWideStrings',1,tkVariant,nil,__VarArrayFromWideStrings,false,0,'Strings: TWideStrings');
