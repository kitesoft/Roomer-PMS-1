...
begin
  ...
  begin
    ...
    DefineMethod('NextSQLTokenEx',4,tkEnumeration,nil,__NextSQLTokenEx,false,0,'p: PWideChar; Token: WideString; CurSection: TSQLToken; IdOption: IDENTIFIEROption').SetVarArgs([0,1]);
