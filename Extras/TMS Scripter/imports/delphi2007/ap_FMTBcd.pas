...
type
  TatFMTBcdLibrary = class(TatScripterLibrary)
    ...
    procedure __OldCurrToBCD(AMachine: TatVirtualMachine);
    ...
    procedure __OldBCDToCurr(AMachine: TatVirtualMachine);
    ...
    procedure __RoundAt(AMachine: TatVirtualMachine);
...
if not Assigned(Param2Rec) or not (Param2Rec is TBcdWrapper) then 
  Param2Rec := TBcdWrapper.Create(Param2);
Param2 := TBcdWrapper(Param2Rec).ObjToRec;
    FMTBcd.BcdDivide(VarToStr(GetInputArg(0)),VarToStr(GetInputArg(1)),Param2);
    SetInputArg(2,integer(TBcdWrapper.Create(Param2)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := integer(TBcdWrapper.Create(FMTBcd.StrToBcd(VarToStr(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
if not Assigned(Param1Rec) or not (Param1Rec is TBcdWrapper) then 
  Param1Rec := TBcdWrapper.Create(Param1);
Param1 := TBcdWrapper(Param1Rec).ObjToRec;
AResult := FMTBcd.TryStrToBcd(VarToStr(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(TBcdWrapper.Create(Param1)));
  end;
end;
...
procedure TatFMTBcdLibrary.__OldCurrToBCD(AMachine: TatVirtualMachine);
  var
  Param1Rec: TObject;
  Param1: TBcd;
  AResult: variant;
...
Param1 := TBcdWrapper(Param1Rec).ObjToRec;
case InputArgCount of
2: AResult := FMTBcd.OldCurrToBCD(GetInputArg(0),Param1);
3: AResult := FMTBcd.OldCurrToBCD(GetInputArg(0),Param1,VarToInteger(GetInputArg(2)));
4: AResult := FMTBcd.OldCurrToBCD(GetInputArg(0),Param1,VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)));
end;
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(TBcdWrapper.Create(Param1)));
  end;
...
begin
  with AMachine do
  begin
AResult := string(FMTBcd.BcdToStr(TBcdWrapper(integer(GetInputArg(0))).ObjToRec));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatFMTBcdLibrary.__OldBCDToCurr(AMachine: TatVirtualMachine);
  var
  Param1: Currency;
  AResult: variant;
begin
...
AResult := FMTBcd.OldBCDToCurr(TBcdWrapper(integer(GetInputArg(0))).ObjToRec,Param1);
    ReturnOutputArg(AResult);
...
begin
  with AMachine do
  begin
AResult := string(FMTBcd.BcdToStrF(TBcdWrapper(integer(GetInputArg(0))).ObjToRec,TFloatFormat(VarToInteger(GetInputArg(1))),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(FMTBcd.FormatBcd(VarToStr(GetInputArg(0)),TBcdWrapper(integer(GetInputArg(1))).ObjToRec));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatFMTBcdLibrary.__RoundAt(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := string(FMTBcd.RoundAt(VarToStr(GetInputArg(0)),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    DefineMethod('BcdPrecision',1,tkInteger,nil,__BcdPrecision,false,0,'Bcd: TBcd');
    DefineMethod('BcdScale',1,tkInteger,nil,__BcdScale,false,0,'Bcd: TBcd');
    DefineMethod('IsBcdNegative',1,tkVariant,nil,__IsBcdNegative,false,0,'Bcd: TBcd');
    DefineMethod('BcdAdd',3,tkNone,nil,__BcdAdd,false,0,'bcdIn1: TBcd; bcdIn2: TBcd; bcdOut: TBcd').SetVarArgs([2]);
    DefineMethod('BcdSubtract',3,tkNone,nil,__BcdSubtract,false,0,'bcdIn1: TBcd; bcdIn2: TBcd; bcdOut: TBcd').SetVarArgs([2]);
    DefineMethod('NormalizeBcd',4,tkVariant,nil,__NormalizeBcd,false,0,'InBcd: TBcd; OutBcd: TBcd; Prec: Word; Scale: Word').SetVarArgs([1]);
    DefineMethod('BcdMultiply',3,tkNone,nil,__BcdMultiply,false,0,'bcdIn1: TBcd; bcdIn2: TBcd; bcdOut: TBcd').SetVarArgs([2]);
    DefineMethod('BcdDivide',3,tkNone,nil,__BcdDivide,false,0,'Dividend: string; Divisor: string; bcdOut: TBcd').SetVarArgs([2]);
    DefineMethod('VarFMTBcdCreate',2,tkNone,nil,__VarFMTBcdCreate,false,0,'ADest: Variant; ABcd: TBcd').SetVarArgs([0]);
    DefineMethod('VarIsFMTBcd',1,tkVariant,nil,__VarIsFMTBcd,false,0,'AValue: Variant');
    DefineMethod('VarFMTBcd',0,tkInteger,nil,__VarFMTBcd,false,0,'');
    DefineMethod('StrToBcd',1,tkVariant,nil,__StrToBcd,false,0,'AValue: string');
    DefineMethod('TryStrToBcd',2,tkVariant,nil,__TryStrToBcd,false,0,'AValue: string; Bcd: TBcd').SetVarArgs([1]);
    DefineMethod('DoubleToBcd',1,tkVariant,nil,__DoubleToBcd,false,0,'AValue: Double');
    DefineMethod('IntegerToBcd',1,tkVariant,nil,__IntegerToBcd,false,0,'AValue: Integer');
    DefineMethod('VarToBcd',1,tkVariant,nil,__VarToBcd,false,0,'AValue: Variant');
    DefineMethod('CurrToBCD',4,tkVariant,nil,__CurrToBCD,false,2,'Curr: Currency; BCD: TBcd; Precision: Integer = 32; Decimals: Integer = 4').SetVarArgs([1]);
    DefineMethod('OldCurrToBCD',4,tkVariant,nil,__OldCurrToBCD,false,2,'Curr: Currency; BCD: TBcd; Precision: Integer = 32; Decimals: Integer = 4').SetVarArgs([1]);
    DefineMethod('BcdToStr',1,tkVariant,nil,__BcdToStr,false,0,'Bcd: TBcd');
    DefineMethod('BcdToDouble',1,tkVariant,nil,__BcdToDouble,false,0,'Bcd: TBcd');
    DefineMethod('BcdToInteger',2,tkInteger,nil,__BcdToInteger,false,1,'Bcd: TBcd; Truncate: Boolean = False');
    DefineMethod('OldBCDToCurr',2,tkVariant,nil,__OldBCDToCurr,false,0,'BCD: TBcd; Curr: Currency').SetVarArgs([1]);
    DefineMethod('BCDToCurr',2,tkVariant,nil,__BCDToCurr,false,0,'BCD: TBcd; Curr: Currency').SetVarArgs([1]);
    DefineMethod('BcdToStrF',4,tkVariant,nil,__BcdToStrF,false,0,'Bcd: TBcd; Format: TFloatFormat; Precision: Integer; Digits: Integer');
    DefineMethod('FormatBcd',2,tkVariant,nil,__FormatBcd,false,0,'Format: string; Bcd: TBcd');
    DefineMethod('BcdCompare',2,tkInteger,nil,__BcdCompare,false,0,'bcd1: TBcd; bcd2: TBcd');
    DefineMethod('RoundAt',2,tkVariant,nil,__RoundAt,false,0,'Value: string; Position: SmallInt');
    ...
    AddConstant('SizeOfFraction',SizeOfFraction);
    AddConstant('SizeOfTBCD',SizeOfTBCD);
  end;
end;
