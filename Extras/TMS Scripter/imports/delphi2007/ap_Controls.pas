...
begin
  ...
  begin
    ...
    DefineMethod('Perform',3,tkInteger,nil,__TControlPerform,false,0,'Msg: Cardinal; WParam: Longint; LParam: Longint');
  ...
  begin
    ...
    DefineMethod('InitWndProc',4,tkInteger,nil,__InitWndProc,false,0,'HWindow: HWnd; Message: Longint; WParam: Longint; LParam: Longint');
    ...
    AddConstant('CM_CONTROLLISTCHANGING',CM_CONTROLLISTCHANGING);
