...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCommonDialogClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TOpenDialogClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TOpenDialog(CurrentObject).FileEditStyle));
  end;
end;
...
begin
  with AMachine do
  begin
    TOpenDialog(CurrentObject).FileEditStyle:=TFileEditStyle(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TOpenDialog(CurrentObject).Files));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TOpenDialog(CurrentObject).HistoryList));
  end;
end;
...
begin
  with AMachine do
  begin
    TOpenDialog(CurrentObject).HistoryList:=TStrings(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TColorDialogClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TFontDialogClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TPageSetupDialogClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TFindDialogClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TReplaceDialogClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TFileTypeItemClass(CurrentClass.ClassRef).Create(TCollection(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TFileTypeItems(CurrentObject).Add);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TFileTypeItems(CurrentObject).Items[VarToInteger(GetArrayIndex(0))]));
  end;
end;
...
begin
  with AMachine do
  begin
    TFileTypeItems(CurrentObject).Items[VarToInteger(GetArrayIndex(0))]:=TFileTypeItem(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TFavoriteLinkItemsEnumeratorClass(CurrentClass.ClassRef).Create(TFavoriteLinkItems(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TFavoriteLinkItemsEnumerator(CurrentObject).GetCurrent);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TFavoriteLinkItemsEnumerator(CurrentObject).Current));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TFavoriteLinkItems(CurrentObject).Add);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TFavoriteLinkItems(CurrentObject).GetEnumerator);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TFavoriteLinkItems(CurrentObject).Items[VarToInteger(GetArrayIndex(0))]));
  end;
end;
...
begin
  with AMachine do
  begin
    TFavoriteLinkItems(CurrentObject).Items[VarToInteger(GetArrayIndex(0))]:=TFavoriteLinkItem(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomFileDialogClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TCustomFileDialog(CurrentObject).ClientGuid));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomFileDialog(CurrentObject).ClientGuid:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TCustomFileDialog(CurrentObject).DefaultExtension));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomFileDialog(CurrentObject).DefaultExtension:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TCustomFileDialog(CurrentObject).DefaultFolder));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomFileDialog(CurrentObject).DefaultFolder:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomFileDialog(CurrentObject).FavoriteLinks));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomFileDialog(CurrentObject).FavoriteLinks:=TFavoriteLinkItems(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TCustomFileDialog(CurrentObject).FileName));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomFileDialog(CurrentObject).FileName:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TCustomFileDialog(CurrentObject).FileNameLabel));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomFileDialog(CurrentObject).FileNameLabel:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomFileDialog(CurrentObject).Files));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomFileDialog(CurrentObject).FileTypes));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomFileDialog(CurrentObject).FileTypes:=TFileTypeItems(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TCustomFileDialog(CurrentObject).OkButtonLabel));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomFileDialog(CurrentObject).OkButtonLabel:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TCustomFileDialog(CurrentObject).Title));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomFileDialog(CurrentObject).Title:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TTaskDialogProgressBarClass(CurrentClass.ClassRef).Create(TCustomTaskDialog(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TTaskDialogBaseButtonItemClass(CurrentClass.ClassRef).Create(TCollection(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TTaskDialogBaseButtonItem(CurrentObject).ModalResult));
  end;
end;
...
begin
  with AMachine do
  begin
    TTaskDialogBaseButtonItem(CurrentObject).ModalResult:=TModalResult(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TTaskDialogButtonItemClass(CurrentClass.ClassRef).Create(TCollection(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TTaskDialogRadioButtonItemClass(CurrentClass.ClassRef).Create(TCollection(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TTaskDialogButtonsEnumeratorClass(CurrentClass.ClassRef).Create(TTaskDialogButtons(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TTaskDialogButtonsEnumerator(CurrentObject).GetCurrent);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TTaskDialogButtonsEnumerator(CurrentObject).Current));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TTaskDialogButtons(CurrentObject).Add);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TTaskDialogButtons(CurrentObject).FindButton(TModalResult(VarToInteger(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TTaskDialogButtons(CurrentObject).GetEnumerator);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TTaskDialogButtons(CurrentObject).DefaultButton));
  end;
end;
...
begin
  with AMachine do
  begin
    TTaskDialogButtons(CurrentObject).DefaultButton:=TTaskDialogBaseButtonItem(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TTaskDialogButtons(CurrentObject).Items[VarToInteger(GetArrayIndex(0))]));
  end;
end;
...
begin
  with AMachine do
  begin
    TTaskDialogButtons(CurrentObject).Items[VarToInteger(GetArrayIndex(0))]:=TTaskDialogBaseButtonItem(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomTaskDialogClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomTaskDialog(CurrentObject).Button));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomTaskDialog(CurrentObject).Button:=TTaskDialogButtonItem(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomTaskDialog(CurrentObject).Buttons));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomTaskDialog(CurrentObject).Buttons:=TTaskDialogButtons(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TCustomTaskDialog(CurrentObject).Caption));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomTaskDialog(CurrentObject).Caption:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomTaskDialog(CurrentObject).CustomFooterIcon));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomTaskDialog(CurrentObject).CustomFooterIcon:=TIcon(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomTaskDialog(CurrentObject).CustomMainIcon));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomTaskDialog(CurrentObject).CustomMainIcon:=TIcon(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomTaskDialog(CurrentObject).DefaultButton));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomTaskDialog(CurrentObject).DefaultButton:=TTaskDialogCommonButton(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TCustomTaskDialog(CurrentObject).ExpandButtonCaption));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomTaskDialog(CurrentObject).ExpandButtonCaption:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TCustomTaskDialog(CurrentObject).ExpandedText));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomTaskDialog(CurrentObject).ExpandedText:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomTaskDialog(CurrentObject).FooterIcon));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomTaskDialog(CurrentObject).FooterIcon:=TTaskDialogIcon(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TCustomTaskDialog(CurrentObject).FooterText));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomTaskDialog(CurrentObject).FooterText:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomTaskDialog(CurrentObject).MainIcon));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomTaskDialog(CurrentObject).MainIcon:=TTaskDialogIcon(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomTaskDialog(CurrentObject).ModalResult));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomTaskDialog(CurrentObject).ModalResult:=TModalResult(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomTaskDialog(CurrentObject).ProgressBar));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomTaskDialog(CurrentObject).ProgressBar:=TTaskDialogProgressBar(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomTaskDialog(CurrentObject).RadioButton));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomTaskDialog(CurrentObject).RadioButtons));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomTaskDialog(CurrentObject).RadioButtons:=TTaskDialogButtons(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TCustomTaskDialog(CurrentObject).Text));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomTaskDialog(CurrentObject).Text:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TCustomTaskDialog(CurrentObject).Title));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomTaskDialog(CurrentObject).Title:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TCustomTaskDialog(CurrentObject).URL));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TCustomTaskDialog(CurrentObject).VerificationText));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomTaskDialog(CurrentObject).VerificationText:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  ...
  begin
    ...
    ResponseTemp := Integer(Response);
    if Assigned(Scripter) and (RoutineName > '') then
      Scripter.ExecuteSubroutine(RoutineName, [Sender,ResponseTemp]);
    Response := TFileDialogOverwriteResponse(VarToInteger(ResponseTemp));
    if AssignedMethod(AfterCall) then
...
begin
  ...
  begin
    ...
    if Assigned(Scripter) and (RoutineName > '') then
      Scripter.ExecuteSubroutine(RoutineName, [Sender,ResponseTemp]);
    Response := TFileDialogShareViolationResponse(VarToInteger(ResponseTemp));
    if AssignedMethod(AfterCall) then
...
begin
  ...
  begin
    ...
    ModalResultTemp := Integer(ModalResult);
    CanCloseTemp := CanClose;
    if Assigned(Scripter) and (RoutineName > '') then
...
AResult := ObjectToVar(Dialogs.CreateMessageDialog(VarToStr(GetInputArg(0)),TMsgDlgType(VarToInteger(GetInputArg(1))),Param2));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
IntToSet(Param2, VarToInteger(GetInputArg(2)), SizeOf(Param2));
AResult := Integer(Dialogs.MessageDlg(VarToStr(GetInputArg(0)),TMsgDlgType(VarToInteger(GetInputArg(1))),Param2,VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
IntToSet(Param2, VarToInteger(GetInputArg(2)), SizeOf(Param2));
AResult := Integer(Dialogs.MessageDlgPos(VarToStr(GetInputArg(0)),TMsgDlgType(VarToInteger(GetInputArg(1))),Param2,VarToInteger(GetInputArg(3)),VarToInteger(GetInputArg(4)),VarToInteger(GetInputArg(5))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
IntToSet(Param2, VarToInteger(GetInputArg(2)), SizeOf(Param2));
AResult := Integer(Dialogs.MessageDlgPosHelp(VarToStr(GetInputArg(0)),TMsgDlgType(VarToInteger(GetInputArg(1))),Param2,VarToInteger(GetInputArg(3)),VarToInteger(GetInputArg(4)),VarToInteger(GetInputArg(5)),VarToStr(GetInputArg(6))));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := Integer(Dialogs.TaskMessageDlg(VarToStr(GetInputArg(0)),VarToStr(GetInputArg(1)),TMsgDlgType(VarToInteger(GetInputArg(2))),Param3,VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
IntToSet(Param3, VarToInteger(GetInputArg(3)), SizeOf(Param3));
AResult := Integer(Dialogs.TaskMessageDlgPos(VarToStr(GetInputArg(0)),VarToStr(GetInputArg(1)),TMsgDlgType(VarToInteger(GetInputArg(2))),Param3,VarToInteger(GetInputArg(4)),VarToInteger(GetInputArg(5)),VarToInteger(GetInputArg(6))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
IntToSet(Param3, VarToInteger(GetInputArg(3)), SizeOf(Param3));
AResult := Integer(Dialogs.TaskMessageDlgPosHelp(VarToStr(GetInputArg(0)),VarToStr(GetInputArg(1)),TMsgDlgType(VarToInteger(GetInputArg(2))),Param3,VarToInteger(GetInputArg(4)),VarToInteger(GetInputArg(5)),VarToInteger(GetInputArg(6)),VarToStr(GetInputArg(7))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    Dialogs.ShowMessage(VarToStr(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    Dialogs.ShowMessagePos(VarToStr(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(Dialogs.InputBox(VarToStr(GetInputArg(0)),VarToStr(GetInputArg(1)),VarToStr(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := Dialogs.InputQuery(VarToStr(GetInputArg(0)),VarToStr(GetInputArg(1)),Param2);
    ReturnOutputArg(AResult);
...
2: AResult := Dialogs.PromptForFileName(Param0,VarToStr(GetInputArg(1)));
3: AResult := Dialogs.PromptForFileName(Param0,VarToStr(GetInputArg(1)),VarToStr(GetInputArg(2)));
4: AResult := Dialogs.PromptForFileName(Param0,VarToStr(GetInputArg(1)),VarToStr(GetInputArg(2)),VarToStr(GetInputArg(3)));
5: AResult := Dialogs.PromptForFileName(Param0,VarToStr(GetInputArg(1)),VarToStr(GetInputArg(2)),VarToStr(GetInputArg(3)),VarToStr(GetInputArg(4)));
6: AResult := Dialogs.PromptForFileName(Param0,VarToStr(GetInputArg(1)),VarToStr(GetInputArg(2)),VarToStr(GetInputArg(3)),VarToStr(GetInputArg(4)),GetInputArg(5));
end;
    ReturnOutputArg(AResult);
...
begin
  ...
  begin
    DefineMethod('Create',1,tkClass,TCommonDialog,__TCommonDialogCreate,true,0,'AOwner: TComponent');
    ...
    DefineMethod('DefaultHandler',1,tkNone,nil,__TCommonDialogDefaultHandler,false,0,'Message').SetVarArgs([0]);
    DefineProp('Handle',tkInteger,__GetTCommonDialogHandle,nil,nil,false,0);
  end;
  With Scripter.DefineClass(TOpenDialog) do
  begin
    DefineMethod('Create',1,tkClass,TOpenDialog,__TOpenDialogCreate,true,0,'AOwner: TComponent');
    DefineMethod('Destroy',0,tkNone,nil,__TOpenDialogDestroy,false,0,'');
    DefineMethod('Execute',1,tkVariant,nil,__TOpenDialogExecute,false,0,'ParentWnd: HWND');
  ...
  begin
    DefineMethod('Execute',1,tkVariant,nil,__TSaveDialogExecute,false,0,'ParentWnd: HWND');
  end;
  With Scripter.DefineClass(TColorDialog) do
  begin
    DefineMethod('Create',1,tkClass,TColorDialog,__TColorDialogCreate,true,0,'AOwner: TComponent');
    DefineMethod('Destroy',0,tkNone,nil,__TColorDialogDestroy,false,0,'');
    DefineMethod('Execute',1,tkVariant,nil,__TColorDialogExecute,false,0,'ParentWnd: HWND');
  end;
  With Scripter.DefineClass(TFontDialog) do
  begin
    DefineMethod('Create',1,tkClass,TFontDialog,__TFontDialogCreate,true,0,'AOwner: TComponent');
    DefineMethod('Destroy',0,tkNone,nil,__TFontDialogDestroy,false,0,'');
    DefineMethod('Execute',1,tkVariant,nil,__TFontDialogExecute,false,0,'ParentWnd: HWND');
  end;
  With Scripter.DefineClass(TPrinterSetupDialog) do
  begin
    DefineMethod('Execute',1,tkVariant,nil,__TPrinterSetupDialogExecute,false,0,'ParentWnd: HWND');
  end;
  With Scripter.DefineClass(TPrintDialog) do
  begin
    DefineMethod('Execute',1,tkVariant,nil,__TPrintDialogExecute,false,0,'ParentWnd: HWND');
  end;
  With Scripter.DefineClass(TPageSetupDialog) do
  begin
    DefineMethod('Create',1,tkClass,TPageSetupDialog,__TPageSetupDialogCreate,true,0,'AOwner: TComponent');
    DefineMethod('Execute',1,tkVariant,nil,__TPageSetupDialogExecute,false,0,'ParentWnd: HWND');
  ...
  begin
    DefineMethod('Create',1,tkClass,TFindDialog,__TFindDialogCreate,true,0,'AOwner: TComponent');
    ...
    DefineMethod('Execute',1,tkVariant,nil,__TFindDialogExecute,false,0,'ParentWnd: HWND');
  ...
  begin
    DefineMethod('Create',1,tkClass,TReplaceDialog,__TReplaceDialogCreate,true,0,'AOwner: TComponent');
  end;
  ...
  begin
    DefineMethod('Create',1,tkClass,TFileTypeItem,__TFileTypeItemCreate,true,0,'Collection: TCollection');
  ...
  begin
    DefineMethod('Create',1,tkClass,TFavoriteLinkItemsEnumerator,__TFavoriteLinkItemsEnumeratorCreate,true,0,'ACollection: TFavoriteLinkItems');
  ...
  begin
    DefineMethod('Create',1,tkClass,TCustomFileDialog,__TCustomFileDialogCreate,true,0,'AOwner: TComponent');
  ...
  begin
    DefineMethod('Create',1,tkClass,TTaskDialogProgressBar,__TTaskDialogProgressBarCreate,true,0,'AClient: TCustomTaskDialog');
  ...
  begin
    DefineMethod('Create',1,tkClass,TTaskDialogBaseButtonItem,__TTaskDialogBaseButtonItemCreate,true,0,'Collection: TCollection');
  ...
  begin
    DefineMethod('Create',1,tkClass,TTaskDialogButtonItem,__TTaskDialogButtonItemCreate,true,0,'Collection: TCollection');
  ...
  begin
    DefineMethod('Create',1,tkClass,TTaskDialogRadioButtonItem,__TTaskDialogRadioButtonItemCreate,true,0,'Collection: TCollection');
  end;
  With Scripter.DefineClass(TTaskDialogButtonsEnumerator) do
  begin
    DefineMethod('Create',1,tkClass,TTaskDialogButtonsEnumerator,__TTaskDialogButtonsEnumeratorCreate,true,0,'ACollection: TTaskDialogButtons');
  ...
  begin
    ...
    DefineMethod('FindButton',1,tkClass,TTaskDialogBaseButtonItem,__TTaskDialogButtonsFindButton,false,0,'AModalResult: TModalResult');
  ...
  begin
    DefineMethod('Create',1,tkClass,TCustomTaskDialog,__TCustomTaskDialogCreate,true,0,'AOwner: TComponent');
  ...
  begin
    DefineMethod('CreateMessageDialog',3,tkClass,TForm,__CreateMessageDialog,false,0,'Msg: string; DlgType: TMsgDlgType; Buttons: TMsgDlgButtons');
    DefineMethod('MessageDlg',4,tkInteger,nil,__MessageDlg,false,0,'Msg: string; DlgType: TMsgDlgType; Buttons: TMsgDlgButtons; HelpCtx: Longint');
    DefineMethod('MessageDlgPos',6,tkInteger,nil,__MessageDlgPos,false,0,'Msg: string; DlgType: TMsgDlgType; Buttons: TMsgDlgButtons; HelpCtx: Longint; X: Integer; Y: Integer');
    DefineMethod('MessageDlgPosHelp',7,tkInteger,nil,__MessageDlgPosHelp,false,0,'Msg: string; DlgType: TMsgDlgType; Buttons: TMsgDlgButtons; HelpCtx: Longint; X: Integer; Y: Integer; HelpFileName: string');
    DefineMethod('TaskMessageDlg',5,tkInteger,nil,__TaskMessageDlg,false,0,'Title: string; Msg: string; DlgType: TMsgDlgType; Buttons: TMsgDlgButtons; HelpCtx: Longint');
    DefineMethod('TaskMessageDlgPos',7,tkInteger,nil,__TaskMessageDlgPos,false,0,'Title: string; Msg: string; DlgType: TMsgDlgType; Buttons: TMsgDlgButtons; HelpCtx: Longint; X: Integer; Y: Integer');
    DefineMethod('TaskMessageDlgPosHelp',8,tkInteger,nil,__TaskMessageDlgPosHelp,false,0,'Title: string; Msg: string; DlgType: TMsgDlgType; Buttons: TMsgDlgButtons; HelpCtx: Longint; X: Integer; Y: Integer; HelpFileName: string');
    DefineMethod('ShowMessage',1,tkNone,nil,__ShowMessage,false,0,'Msg: string');
    DefineMethod('ShowMessagePos',3,tkNone,nil,__ShowMessagePos,false,0,'Msg: string; X: Integer; Y: Integer');
    DefineMethod('InputBox',3,tkVariant,nil,__InputBox,false,0,'ACaption: string; APrompt: string; ADefault: string');
    DefineMethod('InputQuery',3,tkVariant,nil,__InputQuery,false,0,'ACaption: string; APrompt: string; Value: string').SetVarArgs([2]);
    DefineMethod('PromptForFileName',6,tkVariant,nil,__PromptForFileName,false,5,'AFileName: string; AFilter: string = ''; ADefaultExt: string = ''; ATitle: string = ''; AInitialDir: string = ''; SaveDialog: Boolean = False').SetVarArgs([0]);
