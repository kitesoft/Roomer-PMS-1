...
type
  TatDBGridsLibrary = class(TatScripterLibrary)
    ...
    procedure __GetTGridDataLinkGrid(AMachine: TatVirtualMachine);
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TColumnTitleClass(CurrentClass.ClassRef).Create(TColumn(VarToObject(GetInputArg(0)))));
...
begin
  with AMachine do
  begin
    TColumnTitle(CurrentObject).Assign(TPersistent(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TColumnTitle(CurrentObject).DefaultAlignment);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TColumnTitle(CurrentObject).DefaultColor);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TColumnTitle(CurrentObject).DefaultFont);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(TColumnTitle(CurrentObject).DefaultCaption);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TColumnTitle(CurrentObject).Column));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TColumnClass(CurrentClass.ClassRef).Create(TCollection(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TColumn(CurrentObject).Assign(TPersistent(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TColumn(CurrentObject).DefaultAlignment);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TColumn(CurrentObject).DefaultColor);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TColumn(CurrentObject).DefaultFont);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TColumn(CurrentObject).DefaultImeMode);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(TColumn(CurrentObject).DefaultImeName);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TColumn(CurrentObject).Grid));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TColumn(CurrentObject).Field));
  end;
end;
...
begin
  with AMachine do
  begin
    TColumn(CurrentObject).Field:=TField(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TColumn(CurrentObject).ParentColumn));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TDBGridColumns(CurrentObject).Add);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TDBGridColumns(CurrentObject).LoadFromFile(VarToStr(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    TDBGridColumns(CurrentObject).LoadFromStream(TStream(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TDBGridColumns(CurrentObject).SaveToFile(VarToStr(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    TDBGridColumns(CurrentObject).SaveToStream(TStream(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TDBGridColumns(CurrentObject).State));
  end;
end;
...
begin
  with AMachine do
  begin
    TDBGridColumns(CurrentObject).State:=TDBGridColumnsState(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TDBGridColumns(CurrentObject).Grid));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TDBGridColumns(CurrentObject).Items[VarToInteger(GetArrayIndex(0))]));
  end;
end;
...
begin
  with AMachine do
  begin
    TDBGridColumns(CurrentObject).Items[VarToInteger(GetArrayIndex(0))]:=TColumn(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TGridDataLinkClass(CurrentClass.ClassRef).Create(TCustomDBGrid(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TGridDataLink(CurrentObject).AddMapping(VarToStr(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TGridDataLink(CurrentObject).Fields[VarToInteger(GetArrayIndex(0))]));
  end;
end;
...
procedure TatDBGridsLibrary.__GetTGridDataLinkGrid(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TGridDataLink(CurrentObject).Grid));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TBookmarkListClass(CurrentClass.ClassRef).Create(TCustomDBGrid(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := TBookmarkList(CurrentObject).Find(VarToStr(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
...
begin
  with AMachine do
  begin
AResult := Integer(TBookmarkList(CurrentObject).IndexOf(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TBookmarkList(CurrentObject).Items[VarToInteger(GetArrayIndex(0))]));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomDBGridClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
IntToSet(Param2, VarToInteger(GetInputArg(2)), SizeOf(Param2));
    TCustomDBGrid(CurrentObject).DefaultDrawDataCell(TRectWrapper(integer(GetInputArg(0))).ObjToRec,TField(VarToObject(GetInputArg(1))),Param2);
  end;
end;
...
IntToSet(Param3, VarToInteger(GetInputArg(3)), SizeOf(Param3));
    TCustomDBGrid(CurrentObject).DefaultDrawColumnCell(TRectWrapper(integer(GetInputArg(0))).ObjToRec,VarToInteger(GetInputArg(1)),TColumn(VarToObject(GetInputArg(2))),Param3);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TCustomDBGrid(CurrentObject).ExecuteAction(TBasicAction(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    Case InputArgCount of
      1: TCustomDBGrid(CurrentObject).ShowPopupEditor(TColumn(VarToObject(GetInputArg(0))));
      2: TCustomDBGrid(CurrentObject).ShowPopupEditor(TColumn(VarToObject(GetInputArg(0))),VarToInteger(GetInputArg(1)));
      3: TCustomDBGrid(CurrentObject).ShowPopupEditor(TColumn(VarToObject(GetInputArg(0))),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)));
    end;
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TCustomDBGrid(CurrentObject).UpdateAction(TBasicAction(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomDBGrid(CurrentObject).Fields[VarToInteger(GetArrayIndex(0))]));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomDBGrid(CurrentObject).SelectedField));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomDBGrid(CurrentObject).SelectedField:=TField(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomDBGrid(CurrentObject).DataSource));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomDBGrid(CurrentObject).DataSource:=TDataSource(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  ...
  begin
    DefineMethod('Create',1,tkClass,TColumnTitle,__TColumnTitleCreate,true,0,'Column: TColumn');
    DefineMethod('Destroy',0,tkNone,nil,__TColumnTitleDestroy,false,0,'');
    DefineMethod('Assign',1,tkNone,nil,__TColumnTitleAssign,false,0,'Source: TPersistent');
  ...
  begin
    DefineMethod('Create',1,tkClass,TColumn,__TColumnCreate,true,0,'Collection: TCollection');
    DefineMethod('Destroy',0,tkNone,nil,__TColumnDestroy,false,0,'');
    DefineMethod('Assign',1,tkNone,nil,__TColumnAssign,false,0,'Source: TPersistent');
  ...
  begin
    ...
    DefineMethod('LoadFromFile',1,tkNone,nil,__TDBGridColumnsLoadFromFile,false,0,'Filename: string');
    DefineMethod('LoadFromStream',1,tkNone,nil,__TDBGridColumnsLoadFromStream,false,0,'S: TStream');
    ...
    DefineMethod('SaveToFile',1,tkNone,nil,__TDBGridColumnsSaveToFile,false,0,'Filename: string');
    DefineMethod('SaveToStream',1,tkNone,nil,__TDBGridColumnsSaveToStream,false,0,'S: TStream');
  ...
  begin
    DefineMethod('Create',1,tkClass,TGridDataLink,__TGridDataLinkCreate,true,0,'AGrid: TCustomDBGrid');
    DefineMethod('Destroy',0,tkNone,nil,__TGridDataLinkDestroy,false,0,'');
    DefineMethod('AddMapping',1,tkVariant,nil,__TGridDataLinkAddMapping,false,0,'FieldName: string');
    ...
    DefineProp('Grid',tkClass,__GetTGridDataLinkGrid,nil,TCustomDBGrid,false,0);
  end;
  With Scripter.DefineClass(TBookmarkList) do
  begin
    DefineMethod('Create',1,tkClass,TBookmarkList,__TBookmarkListCreate,true,0,'AGrid: TCustomDBGrid');
    ...
    DefineMethod('Find',2,tkVariant,nil,__TBookmarkListFind,false,0,'Item: TBookmarkStr; Index: Integer').SetVarArgs([1]);
    DefineMethod('IndexOf',1,tkInteger,nil,__TBookmarkListIndexOf,false,0,'Item: TBookmarkStr');
  ...
  begin
    DefineMethod('Create',1,tkClass,TCustomDBGrid,__TCustomDBGridCreate,true,0,'AOwner: TComponent');
    DefineMethod('Destroy',0,tkNone,nil,__TCustomDBGridDestroy,false,0,'');
    DefineMethod('DefaultDrawDataCell',3,tkNone,nil,__TCustomDBGridDefaultDrawDataCell,false,0,'Rect: TRect; Field: TField; State: TGridDrawState');
    DefineMethod('DefaultDrawColumnCell',4,tkNone,nil,__TCustomDBGridDefaultDrawColumnCell,false,0,'Rect: TRect; DataCol: Integer; Column: TColumn; State: TGridDrawState');
    DefineMethod('DefaultHandler',1,tkNone,nil,__TCustomDBGridDefaultHandler,false,0,'Msg').SetVarArgs([0]);
    DefineMethod('ExecuteAction',1,tkVariant,nil,__TCustomDBGridExecuteAction,false,0,'Action: TBasicAction');
    DefineMethod('ShowPopupEditor',3,tkNone,nil,__TCustomDBGridShowPopupEditor,false,2,'Column: TColumn; X: Integer = Low(Integer); Y: Integer = Low(Integer)');
    DefineMethod('UpdateAction',1,tkVariant,nil,__TCustomDBGridUpdateAction,false,0,'Action: TBasicAction');
    DefineMethod('ValidFieldIndex',1,tkVariant,nil,__TCustomDBGridValidFieldIndex,false,0,'FieldIndex: Integer');
