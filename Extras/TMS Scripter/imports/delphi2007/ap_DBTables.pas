...
type
  TatDBTablesLibrary = class(TatScripterLibrary)
    ...
    procedure __TBDEDataSetGetCurrentRecord(AMachine: TatVirtualMachine);
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(EDBEngineErrorClass(CurrentClass.ClassRef).Create(GetInputArg(0)));
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(EDBEngineError(CurrentObject).Errors[VarToInteger(GetArrayIndex(0))]));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TDBErrorClass(CurrentClass.ClassRef).Create(EDBEngineError(VarToObject(GetInputArg(0))),GetInputArg(1),VarToInteger(GetInputArg(2)),PChar(VarToStr(GetInputArg(3)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(TDBError(CurrentObject).ErrorCode);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TDBError(CurrentObject).Message));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TSessionListClass(CurrentClass.ClassRef).Create);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TSessionList(CurrentObject).FindSession(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TSessionList(CurrentObject).GetSessionNames(TStrings(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TSessionList(CurrentObject).OpenSession(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TSessionList(CurrentObject).CurrentSession));
  end;
end;
...
begin
  with AMachine do
  begin
    TSessionList(CurrentObject).CurrentSession:=TSession(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TSessionList(CurrentObject).Sessions[VarToInteger(GetArrayIndex(0))]));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TSessionList(CurrentObject).List[VarToStr(GetArrayIndex(0))]));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TSessionClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TSession(CurrentObject).AddAlias(VarToStr(GetInputArg(0)),VarToStr(GetInputArg(1)),TStrings(VarToObject(GetInputArg(2))));
  end;
end;
...
begin
  with AMachine do
  begin
    TSession(CurrentObject).AddDriver(VarToStr(GetInputArg(0)),TStrings(VarToObject(GetInputArg(1))));
  end;
end;
...
begin
  with AMachine do
  begin
    TSession(CurrentObject).AddStandardAlias(VarToStr(GetInputArg(0)),VarToStr(GetInputArg(1)),VarToStr(GetInputArg(2)));
  end;
end;
...
begin
  with AMachine do
  begin
    TSession(CurrentObject).AddPassword(VarToStr(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    TSession(CurrentObject).CloseDatabase(TDatabase(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TSession(CurrentObject).DeleteAlias(VarToStr(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    TSession(CurrentObject).DeleteDriver(VarToStr(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TSession(CurrentObject).FindDatabase(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TSession(CurrentObject).GetAliasNames(TStrings(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TSession(CurrentObject).GetAliasParams(VarToStr(GetInputArg(0)),TStrings(VarToObject(GetInputArg(1))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(TSession(CurrentObject).GetAliasDriverName(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TSession(CurrentObject).GetConfigParams(VarToStr(GetInputArg(0)),VarToStr(GetInputArg(1)),TStrings(VarToObject(GetInputArg(2))));
  end;
end;
...
begin
  with AMachine do
  begin
    TSession(CurrentObject).GetDatabaseNames(TStrings(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TSession(CurrentObject).GetDriverNames(TStrings(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TSession(CurrentObject).GetDriverParams(VarToStr(GetInputArg(0)),TStrings(VarToObject(GetInputArg(1))));
  end;
end;
...
begin
  with AMachine do
  begin
    TSession(CurrentObject).GetFieldNames(VarToStr(GetInputArg(0)),VarToStr(GetInputArg(1)),TStrings(VarToObject(GetInputArg(2))));
  end;
end;
...
begin
  with AMachine do
  begin
    TSession(CurrentObject).GetTableNames(VarToStr(GetInputArg(0)),VarToStr(GetInputArg(1)),GetInputArg(2),GetInputArg(3),TStrings(VarToObject(GetInputArg(4))));
  end;
end;
...
begin
  with AMachine do
  begin
    TSession(CurrentObject).GetStoredProcNames(VarToStr(GetInputArg(0)),TStrings(VarToObject(GetInputArg(1))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TSession(CurrentObject).IsAlias(VarToStr(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TSession(CurrentObject).ModifyAlias(VarToStr(GetInputArg(0)),TStrings(VarToObject(GetInputArg(1))));
  end;
end;
...
begin
  with AMachine do
  begin
    TSession(CurrentObject).ModifyDriver(VarToStr(GetInputArg(0)),TStrings(VarToObject(GetInputArg(1))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TSession(CurrentObject).OpenDatabase(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TSession(CurrentObject).RemovePassword(VarToStr(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TSession(CurrentObject).Databases[VarToInteger(GetArrayIndex(0))]));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TParamListClass(CurrentClass.ClassRef).Create(TStrings(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TDatabaseClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TDatabase(CurrentObject).FlushSchemaCache(VarToStr(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    TDatabase(CurrentObject).GetFieldNames(VarToStr(GetInputArg(0)),TStrings(VarToObject(GetInputArg(1))));
  end;
end;
...
begin
  ...
  begin
    Case InputArgCount of
      1: TDatabase(CurrentObject).GetTableNames(TStrings(VarToObject(GetInputArg(0))));
      2: TDatabase(CurrentObject).GetTableNames(TStrings(VarToObject(GetInputArg(0))),GetInputArg(1));
    end;
  end;
end;
...
begin
  with AMachine do
  begin
    TDatabase(CurrentObject).ValidateName(VarToStr(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TDatabase(CurrentObject).DataSets[VarToInteger(GetArrayIndex(0))]));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TDatabase(CurrentObject).Directory));
  end;
end;
...
begin
  with AMachine do
  begin
    TDatabase(CurrentObject).Directory:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TDatabase(CurrentObject).Session));
  end;
end;
...
begin
  with AMachine do
  begin
    TDataSetUpdateObject(CurrentObject).Apply(TUpdateKind(VarToInteger(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TBDEDataSetClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TBDEDataSet(CurrentObject).CreateBlobStream(TField(VarToObject(GetInputArg(0))),TBlobStreamMode(VarToInteger(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatDBTablesLibrary.__TBDEDataSetGetCurrentRecord(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := TBDEDataSet(CurrentObject).GetCurrentRecord(PChar(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := TBDEDataSet(CurrentObject).Locate(VarToStr(GetInputArg(0)),GetInputArg(1),Param2);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TBDEDataSet(CurrentObject).Lookup(VarToStr(GetInputArg(0)),GetInputArg(1),VarToStr(GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TBDEDataSet(CurrentObject).UpdateStatus);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TBDEDataSet(CurrentObject).Translate(PChar(VarToStr(GetInputArg(0))),PChar(VarToStr(GetInputArg(1))),GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TBDEDataSet(CurrentObject).UpdateObject));
  end;
end;
...
begin
  with AMachine do
  begin
    TBDEDataSet(CurrentObject).UpdateObject:=TDataSetUpdateObject(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TNestedTableClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TDBDataSetClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TDBDataSet(CurrentObject).CheckOpen(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TDBDataSet(CurrentObject).CloseDatabase(TDatabase(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TDBDataSet(CurrentObject).OpenDatabase);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TDBDataSet(CurrentObject).Database));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TDBDataSet(CurrentObject).DBSession));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TIndexFilesClass(CurrentClass.ClassRef).Create(TTable(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TIndexFiles(CurrentObject).Add(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TIndexFiles(CurrentObject).Insert(VarToInteger(GetInputArg(0)),VarToStr(GetInputArg(1)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TTableClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TTable(CurrentObject).BatchMove(TBDEDataSet(VarToObject(GetInputArg(0))),TBatchMode(VarToInteger(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
IntToSet(Param2, VarToInteger(GetInputArg(2)), SizeOf(Param2));
    Case InputArgCount of
      3: TTable(CurrentObject).AddIndex(VarToStr(GetInputArg(0)),VarToStr(GetInputArg(1)),Param2);
      4: TTable(CurrentObject).AddIndex(VarToStr(GetInputArg(0)),VarToStr(GetInputArg(1)),Param2,VarToStr(GetInputArg(3)));
    end;
  end;
end;
...
begin
  with AMachine do
  begin
    TTable(CurrentObject).CloseIndexFile(VarToStr(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    TTable(CurrentObject).DeleteIndex(VarToStr(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    TTable(CurrentObject).GetDetailLinkFields(TList(VarToObject(GetInputArg(0))),TList(VarToObject(GetInputArg(1))));
  end;
end;
...
begin
  with AMachine do
  begin
    TTable(CurrentObject).GetIndexNames(TStrings(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TTable(CurrentObject).GotoCurrent(TTable(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TTable(CurrentObject).LockTable(TLockType(VarToInteger(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TTable(CurrentObject).OpenIndexFile(VarToStr(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    TTable(CurrentObject).RenameTable(VarToStr(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    TTable(CurrentObject).UnlockTable(TLockType(VarToInteger(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TTable(CurrentObject).IndexFields[VarToInteger(GetArrayIndex(0))]));
  end;
end;
...
begin
  with AMachine do
  begin
    TTable(CurrentObject).IndexFields[VarToInteger(GetArrayIndex(0))]:=TField(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TBatchMoveClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TStoredProcClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TStoredProc(CurrentObject).CopyParams(TParams(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TStoredProc(CurrentObject).ParamByName(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TQueryClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TQuery(CurrentObject).GetDetailLinkFields(TList(VarToObject(GetInputArg(0))),TList(VarToObject(GetInputArg(1))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TQuery(CurrentObject).ParamByName(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TQuery(CurrentObject).Text));
  end;
end;
...
begin
  with AMachine do
  begin
    TQuery(CurrentObject).SQLBinary:=PChar(VarToStr(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TUpdateSQLClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TUpdateSQL(CurrentObject).Apply(TUpdateKind(VarToInteger(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TUpdateSQL(CurrentObject).ExecSQL(TUpdateKind(VarToInteger(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TUpdateSQL(CurrentObject).SetParams(TDataSet(VarToObject(GetInputArg(0))),TUpdateKind(VarToInteger(GetInputArg(1))));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TUpdateSQL(CurrentObject).DatabaseName));
  end;
end;
...
begin
  with AMachine do
  begin
    TUpdateSQL(CurrentObject).DatabaseName:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TUpdateSQL(CurrentObject).Query[TUpdateKind(VarToInteger(GetArrayIndex(0)))]));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TUpdateSQL(CurrentObject).SQL[TUpdateKind(VarToInteger(GetArrayIndex(0)))]));
  end;
end;
...
begin
  with AMachine do
  begin
    TUpdateSQL(CurrentObject).SQL[TUpdateKind(VarToInteger(GetArrayIndex(0)))]:=TStrings(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TUpdateSQL(CurrentObject).SessionName));
  end;
end;
...
begin
  with AMachine do
  begin
    TUpdateSQL(CurrentObject).SessionName:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TBlobStreamClass(CurrentClass.ClassRef).Create(TBlobField(VarToObject(GetInputArg(0))),TBlobStreamMode(VarToInteger(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    DBTables.DbiError(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(DBTables.Session));
  end;
end;
...
begin
  with AMachine do
  begin
    DBTables.Session:=TSession(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(DBTables.Sessions));
  end;
end;
...
begin
  with AMachine do
  begin
    DBTables.Sessions:=TSessionList(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  ...
  begin
    DefineMethod('Create',1,tkClass,EDBEngineError,__EDBEngineErrorCreate,true,0,'ErrorCode: DBIResult');
  ...
  begin
    DefineMethod('Create',4,tkClass,TDBError,__TDBErrorCreate,true,0,'Owner: EDBEngineError; ErrorCode: DBIResult; NativeError: Longint; Message: PChar');
    DefineProp('Category',tkInteger,__GetTDBErrorCategory,nil,nil,false,0);
    DefineProp('ErrorCode',tkVariant,__GetTDBErrorErrorCode,nil,nil,false,0);
  ...
  begin
    ...
    DefineMethod('FindSession',1,tkClass,TSession,__TSessionListFindSession,false,0,'SessionName: string');
    DefineMethod('GetSessionNames',1,tkNone,nil,__TSessionListGetSessionNames,false,0,'List: TStrings');
    DefineMethod('OpenSession',1,tkClass,TSession,__TSessionListOpenSession,false,0,'SessionName: string');
  ...
  begin
    DefineMethod('Create',1,tkClass,TSession,__TSessionCreate,true,0,'AOwner: TComponent');
    DefineMethod('Destroy',0,tkNone,nil,__TSessionDestroy,false,0,'');
    DefineMethod('AddAlias',3,tkNone,nil,__TSessionAddAlias,false,0,'Name: string; Driver: string; List: TStrings');
    DefineMethod('AddDriver',2,tkNone,nil,__TSessionAddDriver,false,0,'Name: string; List: TStrings');
    DefineMethod('AddStandardAlias',3,tkNone,nil,__TSessionAddStandardAlias,false,0,'Name: string; Path: string; DefaultDriver: string');
    DefineMethod('AddPassword',1,tkNone,nil,__TSessionAddPassword,false,0,'Password: string');
    DefineMethod('Close',0,tkNone,nil,__TSessionClose,false,0,'');
    DefineMethod('CloseDatabase',1,tkNone,nil,__TSessionCloseDatabase,false,0,'Database: TDatabase');
    DefineMethod('DeleteAlias',1,tkNone,nil,__TSessionDeleteAlias,false,0,'Name: string');
    DefineMethod('DeleteDriver',1,tkNone,nil,__TSessionDeleteDriver,false,0,'Name: string');
    DefineMethod('DropConnections',0,tkNone,nil,__TSessionDropConnections,false,0,'');
    DefineMethod('FindDatabase',1,tkClass,TDatabase,__TSessionFindDatabase,false,0,'DatabaseName: string');
    DefineMethod('GetAliasNames',1,tkNone,nil,__TSessionGetAliasNames,false,0,'List: TStrings');
    DefineMethod('GetAliasParams',2,tkNone,nil,__TSessionGetAliasParams,false,0,'AliasName: string; List: TStrings');
    DefineMethod('GetAliasDriverName',1,tkVariant,nil,__TSessionGetAliasDriverName,false,0,'AliasName: string');
    DefineMethod('GetConfigParams',3,tkNone,nil,__TSessionGetConfigParams,false,0,'Path: string; Section: string; List: TStrings');
    DefineMethod('GetDatabaseNames',1,tkNone,nil,__TSessionGetDatabaseNames,false,0,'List: TStrings');
    DefineMethod('GetDriverNames',1,tkNone,nil,__TSessionGetDriverNames,false,0,'List: TStrings');
    DefineMethod('GetDriverParams',2,tkNone,nil,__TSessionGetDriverParams,false,0,'DriverName: string; List: TStrings');
    DefineMethod('GetFieldNames',3,tkNone,nil,__TSessionGetFieldNames,false,0,'DatabaseName: string; TableName: string; List: TStrings');
    DefineMethod('GetPassword',0,tkVariant,nil,__TSessionGetPassword,false,0,'');
    DefineMethod('GetTableNames',5,tkNone,nil,__TSessionGetTableNames,false,0,'DatabaseName: string; Pattern: string; Extensions: Boolean; SystemTables: Boolean; List: TStrings');
    DefineMethod('GetStoredProcNames',2,tkNone,nil,__TSessionGetStoredProcNames,false,0,'DatabaseName: string; List: TStrings');
    DefineMethod('IsAlias',1,tkVariant,nil,__TSessionIsAlias,false,0,'Name: string');
    DefineMethod('ModifyAlias',2,tkNone,nil,__TSessionModifyAlias,false,0,'Name: string; List: TStrings');
    DefineMethod('ModifyDriver',2,tkNone,nil,__TSessionModifyDriver,false,0,'Name: string; List: TStrings');
    DefineMethod('Open',0,tkNone,nil,__TSessionOpen,false,0,'');
    DefineMethod('OpenDatabase',1,tkClass,TDatabase,__TSessionOpenDatabase,false,0,'DatabaseName: string');
    DefineMethod('RemoveAllPasswords',0,tkNone,nil,__TSessionRemoveAllPasswords,false,0,'');
    DefineMethod('RemovePassword',1,tkNone,nil,__TSessionRemovePassword,false,0,'Password: string');
  ...
  begin
    DefineMethod('Create',1,tkClass,TParamList,__TParamListCreate,true,0,'Params: TStrings');
  ...
  begin
    DefineMethod('Create',1,tkClass,TDatabase,__TDatabaseCreate,true,0,'AOwner: TComponent');
    ...
    DefineMethod('FlushSchemaCache',1,tkNone,nil,__TDatabaseFlushSchemaCache,false,0,'TableName: string');
    DefineMethod('GetFieldNames',2,tkNone,nil,__TDatabaseGetFieldNames,false,0,'TableName: string; List: TStrings');
    DefineMethod('GetTableNames',2,tkNone,nil,__TDatabaseGetTableNames,false,1,'List: TStrings; SystemTables: Boolean = False');
    ...
    DefineMethod('ValidateName',1,tkNone,nil,__TDatabaseValidateName,false,0,'Name: string');
  ...
  begin
    DefineMethod('Apply',1,tkNone,nil,__TDataSetUpdateObjectApply,false,0,'UpdateKind: TUpdateKind');
  end;
  ...
  begin
    DefineMethod('Create',1,tkClass,TBDEDataSet,__TBDEDataSetCreate,true,0,'AOwner: TComponent');
    ...
    DefineMethod('CreateBlobStream',2,tkClass,TStream,__TBDEDataSetCreateBlobStream,false,0,'Field: TField; Mode: TBlobStreamMode');
    ...
    DefineMethod('GetCurrentRecord',1,tkVariant,nil,__TBDEDataSetGetCurrentRecord,false,0,'Buffer: PChar');
    DefineMethod('GetIndexInfo',0,tkNone,nil,__TBDEDataSetGetIndexInfo,false,0,'');
    DefineMethod('Locate',3,tkVariant,nil,__TBDEDataSetLocate,false,0,'KeyFields: string; KeyValues: Variant; Options: TLocateOptions');
    DefineMethod('Lookup',3,tkVariant,nil,__TBDEDataSetLookup,false,0,'KeyFields: string; KeyValues: Variant; ResultFields: string');
    ...
    DefineMethod('Translate',3,tkInteger,nil,__TBDEDataSetTranslate,false,0,'Src: PChar; Dest: PChar; ToOem: Boolean');
  ...
  begin
    DefineMethod('Create',1,tkClass,TNestedTable,__TNestedTableCreate,true,0,'AOwner: TComponent');
  end;
  With Scripter.DefineClass(TDBDataSet) do
  begin
    DefineMethod('Create',1,tkClass,TDBDataSet,__TDBDataSetCreate,true,0,'AOwner: TComponent');
    DefineMethod('CheckOpen',1,tkVariant,nil,__TDBDataSetCheckOpen,false,0,'Status: DBIResult');
    DefineMethod('CloseDatabase',1,tkNone,nil,__TDBDataSetCloseDatabase,false,0,'Database: TDatabase');
  ...
  begin
    DefineMethod('Create',1,tkClass,TIndexFiles,__TIndexFilesCreate,true,0,'AOwner: TTable');
    DefineMethod('Add',1,tkInteger,nil,__TIndexFilesAdd,false,0,'S: string');
    DefineMethod('Clear',0,tkNone,nil,__TIndexFilesClear,false,0,'');
    DefineMethod('Delete',1,tkNone,nil,__TIndexFilesDelete,false,0,'Index: Integer');
    DefineMethod('Insert',2,tkNone,nil,__TIndexFilesInsert,false,0,'Index: Integer; S: string');
  end;
  With Scripter.DefineClass(TTable) do
  begin
    DefineMethod('Create',1,tkClass,TTable,__TTableCreate,true,0,'AOwner: TComponent');
    DefineMethod('Destroy',0,tkNone,nil,__TTableDestroy,false,0,'');
    DefineMethod('BatchMove',2,tkInteger,nil,__TTableBatchMove,false,0,'ASource: TBDEDataSet; AMode: TBatchMode');
    DefineMethod('AddIndex',4,tkNone,nil,__TTableAddIndex,false,1,'Name: string; Fields: string; Options: TIndexOptions; DescFields: string = ''');
    ...
    DefineMethod('CloseIndexFile',1,tkNone,nil,__TTableCloseIndexFile,false,0,'IndexFileName: string');
    DefineMethod('CreateTable',0,tkNone,nil,__TTableCreateTable,false,0,'');
    DefineMethod('DeleteIndex',1,tkNone,nil,__TTableDeleteIndex,false,0,'Name: string');
    ...
    DefineMethod('GetDetailLinkFields',2,tkNone,nil,__TTableGetDetailLinkFields,false,0,'MasterFields: TList; DetailFields: TList');
    DefineMethod('GetIndexNames',1,tkNone,nil,__TTableGetIndexNames,false,0,'List: TStrings');
    DefineMethod('GotoCurrent',1,tkNone,nil,__TTableGotoCurrent,false,0,'Table: TTable');
    ...
    DefineMethod('LockTable',1,tkNone,nil,__TTableLockTable,false,0,'LockType: TLockType');
    DefineMethod('OpenIndexFile',1,tkNone,nil,__TTableOpenIndexFile,false,0,'IndexName: string');
    DefineMethod('RenameTable',1,tkNone,nil,__TTableRenameTable,false,0,'NewTableName: string');
    ...
    DefineMethod('UnlockTable',1,tkNone,nil,__TTableUnlockTable,false,0,'LockType: TLockType');
  ...
  begin
    DefineMethod('Create',1,tkClass,TBatchMove,__TBatchMoveCreate,true,0,'AOwner: TComponent');
  ...
  begin
    DefineMethod('Create',1,tkClass,TStoredProc,__TStoredProcCreate,true,0,'AOwner: TComponent');
    DefineMethod('Destroy',0,tkNone,nil,__TStoredProcDestroy,false,0,'');
    DefineMethod('CopyParams',1,tkNone,nil,__TStoredProcCopyParams,false,0,'Value: TParams');
    ...
    DefineMethod('ParamByName',1,tkClass,TParam,__TStoredProcParamByName,false,0,'Value: string');
  ...
  begin
    DefineMethod('Create',1,tkClass,TQuery,__TQueryCreate,true,0,'AOwner: TComponent');
    DefineMethod('Destroy',0,tkNone,nil,__TQueryDestroy,false,0,'');
    DefineMethod('ExecSQL',0,tkNone,nil,__TQueryExecSQL,false,0,'');
    DefineMethod('GetDetailLinkFields',2,tkNone,nil,__TQueryGetDetailLinkFields,false,0,'MasterFields: TList; DetailFields: TList');
    DefineMethod('ParamByName',1,tkClass,TParam,__TQueryParamByName,false,0,'Value: string');
  ...
  begin
    DefineMethod('Create',1,tkClass,TUpdateSQL,__TUpdateSQLCreate,true,0,'AOwner: TComponent');
    DefineMethod('Destroy',0,tkNone,nil,__TUpdateSQLDestroy,false,0,'');
    DefineMethod('Apply',1,tkNone,nil,__TUpdateSQLApply,false,0,'UpdateKind: TUpdateKind');
    DefineMethod('ExecSQL',1,tkNone,nil,__TUpdateSQLExecSQL,false,0,'UpdateKind: TUpdateKind');
    DefineMethod('SetParams',2,tkNone,nil,__TUpdateSQLSetParams,false,0,'ADataset: TDataset; UpdateKind: TUpdateKind');
  ...
  begin
    DefineMethod('Create',2,tkClass,TBlobStream,__TBlobStreamCreate,true,0,'Field: TBlobField; Mode: TBlobStreamMode');
    DefineMethod('Destroy',0,tkNone,nil,__TBlobStreamDestroy,false,0,'');
    DefineMethod('Read',2,tkInteger,nil,__TBlobStreamRead,false,0,'Buffer; Count: Longint').SetVarArgs([0]);
    DefineMethod('Write',2,tkInteger,nil,__TBlobStreamWrite,false,0,'Buffer; Count: Longint');
    DefineMethod('Seek',2,tkInteger,nil,__TBlobStreamSeek,false,0,'Offset: Longint; Origin: Word');
  ...
  begin
    DefineMethod('DbiError',1,tkNone,nil,__DbiError,false,0,'ErrorCode: DBIResult');
    DefineMethod('Check',1,tkNone,nil,__Check,false,0,'Status: DBIResult');
