...
begin
  ...
  begin
    ...
    DefineMethod('GetExpandedName',2,tkInteger,nil,__GetExpandedName,false,0,'Source: PChar; Buffer: PChar');
    ...
    DefineMethod('LZOpenFile',3,tkInteger,nil,__LZOpenFile,false,0,'Filename: PChar; ReOpenBuff: TOFStruct; Style: Word').SetVarArgs([1]);
