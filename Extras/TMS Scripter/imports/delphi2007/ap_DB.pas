...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TDefCollection(CurrentObject).Find(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TDefCollection(CurrentObject).GetItemNames(TWideStrings(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TFieldDefClass(CurrentClass.ClassRef).Create(TFieldDefs(VarToObject(GetInputArg(0))),GetInputArg(1),TFieldType(VarToInteger(GetInputArg(2))),VarToInteger(GetInputArg(3)),GetInputArg(4),VarToInteger(GetInputArg(5))));
    ReturnOutputArg(AResult);
  end;
end;
...
3: AResult := ObjectToVar(TFieldDef(CurrentObject).CreateField(TComponent(VarToObject(GetInputArg(0))),TObjectField(VarToObject(GetInputArg(1))),GetInputArg(2)));
4: AResult := ObjectToVar(TFieldDef(CurrentObject).CreateField(TComponent(VarToObject(GetInputArg(0))),TObjectField(VarToObject(GetInputArg(1))),GetInputArg(2),GetInputArg(3)));
end;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TFieldDefList(CurrentObject).FieldByName(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TFieldDefList(CurrentObject).Find(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TFieldList(CurrentObject).Find(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TFields(CurrentObject).FindField(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TFields(CurrentObject).FieldByName(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TStringField(CurrentObject).Value));
  end;
end;
...
begin
  with AMachine do
  begin
    TStringField(CurrentObject).Value:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TBlobField(CurrentObject).Value));
  end;
end;
...
begin
  with AMachine do
  begin
    TBlobField(CurrentObject).Value:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TParam(CurrentObject).AsBlob));
  end;
end;
...
begin
  with AMachine do
  begin
    TParam(CurrentObject).AsBlob:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    TParams(CurrentObject).GetParamList(TList(VarToObject(GetInputArg(0))),GetInputArg(1));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TParams(CurrentObject).FindParam(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TDataSet(CurrentObject).FieldByName(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TDataSet(CurrentObject).FindField(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TDataSet(CurrentObject).GetFieldList(TList(VarToObject(GetInputArg(0))),GetInputArg(1));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TDataSet(CurrentObject).Bookmark));
  end;
end;
...
begin
  with AMachine do
  begin
    TDataSet(CurrentObject).Bookmark:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  ...
  begin
    Case InputArgCount of
      ...
      2: DB.DatabaseError(GetInputArg(0),TComponent(VarToObject(GetInputArg(1))));
    end;
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(DB.GetFieldProperty(TDataSet(VarToObject(GetInputArg(0))),TComponent(VarToObject(GetInputArg(1))),GetInputArg(2)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    DefineMethod('Find',1,tkClass,TNamedItem,__TDefCollectionFind,false,0,'AName: WideString');
    DefineMethod('GetItemNames',1,tkNone,nil,__TDefCollectionGetItemNames,false,0,'List: TWideStrings');
    DefineMethod('IndexOf',1,tkInteger,nil,__TDefCollectionIndexOf,false,0,'AName: WideString');
  ...
  begin
    DefineMethod('Create',6,tkClass,TFieldDef,__TFieldDefCreate,true,0,'Owner: TFieldDefs; Name: WideString; DataType: TFieldType; Size: Integer; Required: Boolean; FieldNo: Integer');
    ...
    DefineMethod('CreateField',4,tkClass,TField,__TFieldDefCreateField,false,3,'Owner: TComponent; ParentField: TObjectField = nil; FieldName: WideString = ''; CreateChildren: Boolean = True');
  ...
  begin
    DefineMethod('FieldByName',1,tkClass,TFieldDef,__TFieldDefListFieldByName,false,0,'Name: WideString');
    DefineMethod('Find',1,tkClass,TFieldDef,__TFieldDefListFind,false,0,'Name: WideString');
  ...
  begin
    ...
    DefineMethod('Find',1,tkClass,TField,__TFieldListFind,false,0,'Name: WideString');
  ...
  begin
    ...
    DefineMethod('CheckFieldName',1,tkNone,nil,__TFieldsCheckFieldName,false,0,'FieldName: WideString');
    DefineMethod('CheckFieldNames',1,tkNone,nil,__TFieldsCheckFieldNames,false,0,'FieldNames: WideString');
    DefineMethod('Clear',0,tkNone,nil,__TFieldsClear,false,0,'');
    DefineMethod('FindField',1,tkClass,TField,__TFieldsFindField,false,0,'FieldName: WideString');
    DefineMethod('FieldByName',1,tkClass,TField,__TFieldsFieldByName,false,0,'FieldName: WideString');
  ...
  begin
    ...
    DefineMethod('GetParamList',2,tkNone,nil,__TParamsGetParamList,false,0,'List: TList; ParamNames: WideString');
    DefineMethod('IsEqual',1,tkVariant,nil,__TParamsIsEqual,false,0,'Value: TParams');
    DefineMethod('ParseSQL',2,tkVariant,nil,__TParamsParseSQL,false,0,'SQL: WideString; DoCreate: Boolean');
    DefineMethod('ParamByName',1,tkClass,TParam,__TParamsParamByName,false,0,'Value: string');
    DefineMethod('FindParam',1,tkClass,TParam,__TParamsFindParam,false,0,'Value: WideString');
  ...
  begin
    ...
    DefineMethod('FieldByName',1,tkClass,TField,__TDataSetFieldByName,false,0,'FieldName: WideString');
    DefineMethod('FindField',1,tkClass,TField,__TDataSetFindField,false,0,'FieldName: WideString');
    ...
    DefineMethod('GetCurrentRecord',1,tkVariant,nil,__TDataSetGetCurrentRecord,false,0,'Buffer: PChar');
    ...
    DefineMethod('GetFieldList',2,tkNone,nil,__TDataSetGetFieldList,false,0,'List: TList; FieldNames: WideString');
    ...
    DefineMethod('Translate',3,tkInteger,nil,__TDataSetTranslate,false,0,'Src: PChar; Dest: PChar; ToOem: Boolean');
  ...
  begin
    ...
    DefineMethod('DatabaseError',2,tkNone,nil,__DatabaseError,false,1,'Message: WideString; Component: TComponent = nil');
    DefineMethod('DisposeMem',2,tkNone,nil,__DisposeMem,false,0,'Buffer; Size: Integer').SetVarArgs([0]);
    DefineMethod('GetFieldProperty',3,tkClass,TField,__GetFieldProperty,false,0,'DataSet: TDataSet; Control: TComponent; FieldName: WideString');
