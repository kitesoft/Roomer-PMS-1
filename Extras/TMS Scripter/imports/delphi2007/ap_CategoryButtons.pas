...
begin
  with AMachine do
  begin
AResult := integer(TRectWrapper.Create(TCategoryButtons(CurrentObject).GetButtonRect(TButtonItem(VarToObject(GetInputArg(0))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := integer(TRectWrapper.Create(TCategoryButtons(CurrentObject).GetCategoryRect(TButtonCategory(VarToObject(GetInputArg(0))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TCategoryButtons(CurrentObject).ScrollIntoView(TButtonItem(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TCategoryButtons(CurrentObject).UpdateButton(TButtonItem(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TCategoryButtons(CurrentObject).SelectedItem:=TButtonItem(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    TCategoryButtons(CurrentObject).FocusedItem:=TButtonItem(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('GetButtonRect',1,tkVariant,nil,__TCategoryButtonsGetButtonRect,false,0,'Button: TButtonItem');
    DefineMethod('GetCategoryRect',1,tkVariant,nil,__TCategoryButtonsGetCategoryRect,false,0,'Category: TButtonCategory');
    ...
    DefineMethod('ScrollIntoView',1,tkNone,nil,__TCategoryButtonsScrollIntoView,false,0,'Button: TButtonItem');
    ...
    DefineMethod('UpdateButton',1,tkNone,nil,__TCategoryButtonsUpdateButton,false,0,'Button: TButtonItem');
