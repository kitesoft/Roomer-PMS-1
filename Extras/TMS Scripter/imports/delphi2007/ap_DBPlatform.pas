...
begin
  with AMachine do
  begin
AResult := TPlatformFieldClass(CurrentClass.ClassRef).AsWideString(TField(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    DefineMethod('CreateRecordBuffer',1,tkVariant,nil,__TPlatformRecordBufferCreateRecordBuffer,true,0,'Length: Integer');
    DefineMethod('Free',1,tkNone,nil,__TPlatformRecordBufferFree,true,0,'Buffer: TRecordBuffer');
    DefineMethod('SetFMTBcd',2,tkNone,nil,__TPlatformRecordBufferSetFMTBcd,true,0,'Buffer: TRecordBuffer; value: TBcd');
    DefineMethod('GetFMTBcd',2,tkNone,nil,__TPlatformRecordBufferGetFMTBcd,true,0,'Buffer: TRecordBuffer; value: TBcd').SetVarArgs([1]);
    DefineMethod('FillChar',3,tkNone,nil,__TPlatformRecordBufferFillChar,true,0,'Buffer: TRecordBuffer; Length: Integer; value: Byte');
  end;
  ...
  begin
    DefineMethod('AsWideString',1,tkVariant,nil,__TPlatformFieldAsWideString,true,0,'Field: TField');
  end;
