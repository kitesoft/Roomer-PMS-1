...
begin
  ...
  begin
    DefineMethod('GetModuleBaseName',4,tkInteger,nil,__GetModuleBaseName,false,0,'hProcess: THandle; hModule: HMODULE; lpBaseName: PChar; nSize: DWORD');
    ...
    DefineMethod('GetModuleFileNameEx',4,tkInteger,nil,__GetModuleFileNameEx,false,0,'hProcess: THandle; hModule: HMODULE; lpFilename: PChar; nSize: DWORD');
