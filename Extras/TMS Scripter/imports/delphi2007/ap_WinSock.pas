...
begin
  ...
  begin
    ...
    DefineMethod('getsockopt',5,tkInteger,nil,__getsockopt,false,0,'s: TSocket; level: Integer; optname: Integer; optval: PChar; optlen: Integer').SetVarArgs([4]);
    ...
    DefineMethod('inet_addr',1,tkInteger,nil,__inet_addr,false,0,'cp: PChar');
    ...
    DefineMethod('setsockopt',5,tkInteger,nil,__setsockopt,false,0,'s: TSocket; level: Integer; optname: Integer; optval: PChar; optlen: Integer');
    ...
    DefineMethod('gethostname',2,tkInteger,nil,__gethostname,false,0,'name: PChar; len: Integer');
    ...
    DefineMethod('WSAAsyncGetServByName',6,tkInteger,nil,__WSAAsyncGetServByName,false,0,'HWindow: HWND; wMsg: u_int; name: PChar; proto: PChar; buf: PChar; buflen: Integer');
    DefineMethod('WSAAsyncGetServByPort',6,tkInteger,nil,__WSAAsyncGetServByPort,false,0,'HWindow: HWND; wMsg: u_int; port: u_int; proto: PChar; buf: PChar; buflen: Integer');
    DefineMethod('WSAAsyncGetProtoByName',5,tkInteger,nil,__WSAAsyncGetProtoByName,false,0,'HWindow: HWND; wMsg: u_int; name: PChar; buf: PChar; buflen: Integer');
    DefineMethod('WSAAsyncGetProtoByNumber',5,tkInteger,nil,__WSAAsyncGetProtoByNumber,false,0,'HWindow: HWND; wMsg: u_int; number: Integer; buf: PChar; buflen: Integer');
    DefineMethod('WSAAsyncGetHostByName',5,tkInteger,nil,__WSAAsyncGetHostByName,false,0,'HWindow: HWND; wMsg: u_int; name: PChar; buf: PChar; buflen: Integer');
    DefineMethod('WSAAsyncGetHostByAddr',7,tkInteger,nil,__WSAAsyncGetHostByAddr,false,0,'HWindow: HWND; wMsg: u_int; addr: PChar; len: Integer; Struct: Integer; buf: PChar; buflen: Integer');
