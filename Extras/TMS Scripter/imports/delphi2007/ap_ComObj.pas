...
begin
  with AMachine do
  begin
AResult := ObjectToVar(EOleSysErrorClass(CurrentClass.ClassRef).Create(VarToStr(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    DefineMethod('Create',3,tkClass,EOleSysError,__EOleSysErrorCreate,true,0,'Message: string; ErrorCode: HRESULT; HelpContext: Integer');
