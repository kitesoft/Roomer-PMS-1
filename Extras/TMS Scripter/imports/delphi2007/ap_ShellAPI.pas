...
begin
  with AMachine do
  begin
AResult := Integer(ShellAPI.DragQueryFile(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),PChar(VarToStr(GetInputArg(2))),VarToInteger(GetInputArg(3))));
...
begin
  with AMachine do
  begin
AResult := Integer(ShellAPI.DragQueryFileA(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),PChar(VarToStr(GetInputArg(2))),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(ShellAPI.ShellExecute(VarToInteger(GetInputArg(0)),PChar(VarToStr(GetInputArg(1))),PChar(VarToStr(GetInputArg(2))),PChar(VarToStr(GetInputArg(3))),PChar(VarToStr(GetInputArg(4))),VarToInteger(GetInputArg(5))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(ShellAPI.ShellExecuteA(VarToInteger(GetInputArg(0)),PChar(VarToStr(GetInputArg(1))),PChar(VarToStr(GetInputArg(2))),PChar(VarToStr(GetInputArg(3))),PChar(VarToStr(GetInputArg(4))),VarToInteger(GetInputArg(5))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(ShellAPI.FindExecutable(PChar(VarToStr(GetInputArg(0))),PChar(VarToStr(GetInputArg(1))),PChar(VarToStr(GetInputArg(2)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(ShellAPI.FindExecutableA(PChar(VarToStr(GetInputArg(0))),PChar(VarToStr(GetInputArg(1))),PChar(VarToStr(GetInputArg(2)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(ShellAPI.ShellAbout(VarToInteger(GetInputArg(0)),PChar(VarToStr(GetInputArg(1))),PChar(VarToStr(GetInputArg(2))),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(ShellAPI.ShellAboutA(VarToInteger(GetInputArg(0)),PChar(VarToStr(GetInputArg(1))),PChar(VarToStr(GetInputArg(2))),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := Integer(ShellAPI.ExtractAssociatedIcon(VarToInteger(GetInputArg(0)),PChar(VarToStr(GetInputArg(1))),Param2));
    ReturnOutputArg(AResult);
...
begin
  ...
  begin
Param2 := VarToInteger(GetInputArg(2));
AResult := Integer(ShellAPI.ExtractAssociatedIconA(VarToInteger(GetInputArg(0)),PChar(VarToStr(GetInputArg(1))),Param2));
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(ShellAPI.ExtractIcon(VarToInteger(GetInputArg(0)),PChar(VarToStr(GetInputArg(1))),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(ShellAPI.ExtractIconA(VarToInteger(GetInputArg(0)),PChar(VarToStr(GetInputArg(1))),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(ShellAPI.DoEnvironmentSubst(PChar(VarToStr(GetInputArg(0))),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(ShellAPI.DoEnvironmentSubstA(PChar(VarToStr(GetInputArg(0))),VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := Integer(ShellAPI.ExtractIconEx(PChar(VarToStr(GetInputArg(0))),VarToInteger(GetInputArg(1)),Param2,Param3,VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
...
Param2 := VarToInteger(GetInputArg(2));
Param3 := VarToInteger(GetInputArg(3));
AResult := Integer(ShellAPI.ExtractIconExA(PChar(VarToStr(GetInputArg(0))),VarToInteger(GetInputArg(1)),Param2,Param3,VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
    SetInputArg(3,Integer(Param3));
  end;
...
begin
  with AMachine do
  begin
AResult := Integer(ShellAPI.SHFileOperation(_SHFILEOPSTRUCTAWrapper(integer(GetInputArg(0))).ObjToRec));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := Integer(ShellAPI.SHGetFileInfo(PChar(VarToStr(GetInputArg(0))),VarToInteger(GetInputArg(1)),Param2,VarToInteger(GetInputArg(3)),VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
...
if not Assigned(Param2Rec) or not (Param2Rec is _SHFILEINFOAWrapper) then 
  Param2Rec := _SHFILEINFOAWrapper.Create(Param2);
Param2 := _SHFILEINFOAWrapper(Param2Rec).ObjToRec;
AResult := Integer(ShellAPI.SHGetFileInfoA(PChar(VarToStr(GetInputArg(0))),VarToInteger(GetInputArg(1)),Param2,VarToInteger(GetInputArg(3)),VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
    SetInputArg(2,integer(_SHFILEINFOAWrapper.Create(Param2)));
  end;
end;
...
AResult := Integer(ShellAPI.SHGetFileInfoW(PChar(VarToStr(GetInputArg(0))),VarToInteger(GetInputArg(1)),Param2,VarToInteger(GetInputArg(3)),VarToInteger(GetInputArg(4))));
    ReturnOutputArg(AResult);
...
begin
  ...
  begin
    DefineMethod('DragQueryFile',4,tkInteger,nil,__DragQueryFile,false,0,'Drop: HDROP; FileIndex: UINT; FileName: PChar; cb: UINT');
    ...
    DefineMethod('ShellExecute',6,tkInteger,nil,__ShellExecute,false,0,'hWnd: HWND; Operation: PChar; FileName: PChar; Parameters: PChar; Directory: PChar; ShowCmd: Integer');
    ...
    DefineMethod('FindExecutable',3,tkInteger,nil,__FindExecutable,false,0,'FileName: PChar; Directory: PChar; Result: PChar');
    ...
    DefineMethod('ShellAbout',4,tkInteger,nil,__ShellAbout,false,0,'Wnd: HWND; szApp: PChar; szOtherStuff: PChar; Icon: HICON');
    ...
    DefineMethod('ExtractAssociatedIcon',3,tkInteger,nil,__ExtractAssociatedIcon,false,0,'hInst: HINST; lpIconPath: PChar; lpiIcon: Word').SetVarArgs([2]);
    ...
    DefineMethod('ExtractIcon',3,tkInteger,nil,__ExtractIcon,false,0,'hInst: HINST; lpszExeFileName: PChar; nIconIndex: UINT');
    ...
    DefineMethod('DoEnvironmentSubst',2,tkInteger,nil,__DoEnvironmentSubst,false,0,'szString: PChar; cbString: UINT');
    ...
    DefineMethod('ExtractIconEx',5,tkInteger,nil,__ExtractIconEx,false,0,'lpszFile: PChar; nIconIndex: Integer; phiconLarge: HICON; phiconSmall: HICON; nIcons: UINT').SetVarArgs([2,3]);
    ...
    DefineMethod('SHGetFileInfo',5,tkInteger,nil,__SHGetFileInfo,false,0,'pszPath: PAnsiChar; dwFileAttributes: DWORD; psfi: TSHFileInfo; cbFileInfo: UINT; uFlags: UINT').SetVarArgs([2]);
    ...
    DefineMethod('SHGetFileInfoW',5,tkInteger,nil,__SHGetFileInfoW,false,0,'pszPath: PAnsiChar; dwFileAttributes: DWORD; psfi: TSHFileInfoW; cbFileInfo: UINT; uFlags: UINT').SetVarArgs([2]);
