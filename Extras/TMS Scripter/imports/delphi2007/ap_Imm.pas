...
begin
  with AMachine do
  begin
AResult := Integer(Imm.ImmInstallIME(PChar(VarToStr(GetInputArg(0))),PChar(VarToStr(GetInputArg(1)))));
...
begin
  with AMachine do
  begin
AResult := Integer(Imm.ImmInstallIMEA(PChar(VarToStr(GetInputArg(0))),PChar(VarToStr(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Imm.ImmGetDescription(VarToInteger(GetInputArg(0)),PChar(VarToStr(GetInputArg(1))),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Imm.ImmGetDescriptionA(VarToInteger(GetInputArg(0)),PChar(VarToStr(GetInputArg(1))),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Imm.ImmGetIMEFileName(VarToInteger(GetInputArg(0)),PChar(VarToStr(GetInputArg(1))),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Imm.ImmGetIMEFileNameA(VarToInteger(GetInputArg(0)),PChar(VarToStr(GetInputArg(1))),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Imm.ImmGetGuideLine(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),PChar(VarToStr(GetInputArg(2))),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Imm.ImmGetGuideLineA(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),PChar(VarToStr(GetInputArg(2))),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Imm.ImmRegisterWord(VarToInteger(GetInputArg(0)),PChar(VarToStr(GetInputArg(1))),VarToInteger(GetInputArg(2)),PChar(VarToStr(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Imm.ImmRegisterWordA(VarToInteger(GetInputArg(0)),PChar(VarToStr(GetInputArg(1))),VarToInteger(GetInputArg(2)),PChar(VarToStr(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Imm.ImmUnregisterWord(VarToInteger(GetInputArg(0)),PChar(VarToStr(GetInputArg(1))),VarToInteger(GetInputArg(2)),PChar(VarToStr(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Imm.ImmUnregisterWordA(VarToInteger(GetInputArg(0)),PChar(VarToStr(GetInputArg(1))),VarToInteger(GetInputArg(2)),PChar(VarToStr(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    DefineMethod('ImmInstallIME',2,tkInteger,nil,__ImmInstallIME,false,0,'lpszIMEFileName: PChar; lpszLayoutText: PChar');
    ...
    DefineMethod('ImmGetDescription',3,tkInteger,nil,__ImmGetDescription,false,0,'hKl: HKL; PChar: PChar; uBufLen: UINT');
    ...
    DefineMethod('ImmGetIMEFileName',3,tkInteger,nil,__ImmGetIMEFileName,false,0,'hKl: HKL; PChar: PChar; uBufLen: UINT');
    ...
    DefineMethod('ImmGetGuideLine',4,tkInteger,nil,__ImmGetGuideLine,false,0,'hImc: HIMC; dwIndex: DWORD; lpBuf: PChar; dwBufLen: DWORD');
    ...
    DefineMethod('ImmRegisterWord',4,tkVariant,nil,__ImmRegisterWord,false,0,'hKl: HKL; lpszReading: PChar; dwStyle: DWORD; lpszRegister: PChar');
    ...
    DefineMethod('ImmUnregisterWord',4,tkVariant,nil,__ImmUnregisterWord,false,0,'hKl: HKL; lpszReading: PChar; dwStyle: DWORD; lpszUnregister: PChar');
