...
type
  TatMenusLibrary = class(TatScripterLibrary)
    ...
    procedure __AnsiSameCaption(AMachine: TatVirtualMachine);
    procedure __IsAltGRPressed(AMachine: TatVirtualMachine);
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TMenuItemEnumeratorClass(CurrentClass.ClassRef).Create(TMenuItem(VarToObject(GetInputArg(0)))));
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TMenuItemEnumerator(CurrentObject).GetCurrent);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TMenuItemEnumerator(CurrentObject).Current));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TMenuItemClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TMenuItem(CurrentObject).Insert(VarToInteger(GetInputArg(0)),TMenuItem(VarToObject(GetInputArg(1))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TMenuItem(CurrentObject).Find(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TMenuItem(CurrentObject).IndexOf(TMenuItem(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TMenuItem(CurrentObject).GetEnumerator);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TMenuItem(CurrentObject).GetImageList);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TMenuItem(CurrentObject).GetParentComponent);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TMenuItem(CurrentObject).GetParentMenu);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TMenuItem(CurrentObject).InsertNewLineBefore(TMenuItem(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TMenuItem(CurrentObject).InsertNewLineAfter(TMenuItem(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TMenuItem(CurrentObject).Add(TMenuItem(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TMenuItem(CurrentObject).Remove(TMenuItem(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TMenuItem(CurrentObject).Items[VarToInteger(GetArrayIndex(0))]));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TMenuItem(CurrentObject).Parent));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TMenuClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TMenu(CurrentObject).CreateMenuItem);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TMenu(CurrentObject).FindItem(VarToInteger(GetInputArg(0)),TFindItemKind(VarToInteger(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TMenu(CurrentObject).GetHelpContext(VarToInteger(GetInputArg(0)),GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TMenu(CurrentObject).Images));
  end;
end;
...
begin
  with AMachine do
  begin
    TMenu(CurrentObject).Images:=TCustomImageList(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TMenu(CurrentObject).AutoHotkeys));
  end;
end;
...
begin
  with AMachine do
  begin
    TMenu(CurrentObject).AutoHotkeys:=TMenuAutoFlag(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TMenu(CurrentObject).AutoLineReduction));
  end;
end;
...
begin
  with AMachine do
  begin
    TMenu(CurrentObject).AutoLineReduction:=TMenuAutoFlag(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TMenu(CurrentObject).BiDiMode));
  end;
end;
...
begin
  with AMachine do
  begin
    TMenu(CurrentObject).BiDiMode:=TBiDiMode(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    TMainMenu(CurrentObject).Merge(TMainMenu(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TMainMenu(CurrentObject).Unmerge(TMainMenu(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TPopupMenuClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TPopupMenu(CurrentObject).PopupComponent));
  end;
end;
...
begin
  with AMachine do
  begin
    TPopupMenu(CurrentObject).PopupComponent:=TComponent(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    TPopupList(CurrentObject).Add(TPopupMenu(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TPopupList(CurrentObject).Remove(TPopupMenu(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TMenuItemStack(CurrentObject).ClearItem(TMenuItem(VarToObject(GetInputArg(0))));
  end;
end;
...
AResult := Integer(Menus.ShortCut(VarToInteger(GetInputArg(0)),Param1));
    ReturnOutputArg(AResult);
  end;
end;
...
VarParam2Set := Param2;
    Menus.ShortCutToKey(TShortCut(VarToInteger(GetInputArg(0))),Param1,Param2);
...
begin
  with AMachine do
  begin
AResult := string(Menus.ShortCutToText(TShortCut(VarToInteger(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Menus.TextToShortCut(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Menus.ShortCutFromMessage(TWMKeyWrapper(integer(GetInputArg(0))).ObjToRec));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(Menus.NewLine);
    ReturnOutputArg(AResult);
  end;
end;
...
IntToSet(Param3, VarToInteger(GetInputArg(3)), SizeOf(Param3));
    Menus.DrawMenuItem(TMenuItem(VarToObject(GetInputArg(0))),TCanvas(VarToObject(GetInputArg(1))),TRectWrapper(integer(GetInputArg(2))).ObjToRec,Param3);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(Menus.StripHotkey(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(Menus.GetHotkey(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatMenusLibrary.__AnsiSameCaption(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Menus.AnsiSameCaption(VarToStr(GetInputArg(0)),VarToStr(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatMenusLibrary.__IsAltGRPressed(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Menus.IsAltGRPressed;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(Menus.PopupList));
  end;
end;
...
begin
  with AMachine do
  begin
    Menus.PopupList:=TPopupList(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(Menus.ShortCutItems));
  end;
end;
...
begin
  with AMachine do
  begin
    Menus.ShortCutItems:=TMenuItemStack(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(Menus.ValidMenuHotkeys));
  end;
end;
...
begin
  with AMachine do
  begin
    Menus.ValidMenuHotkeys:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  ...
  begin
    DefineMethod('Create',1,tkClass,TMenuItemEnumerator,__TMenuItemEnumeratorCreate,true,0,'AMenuItem: TMenuItem');
  ...
  begin
    DefineMethod('Create',1,tkClass,TMenuItem,__TMenuItemCreate,true,0,'AOwner: TComponent');
    ...
    DefineMethod('Insert',2,tkNone,nil,__TMenuItemInsert,false,0,'Index: Integer; Item: TMenuItem');
    DefineMethod('Delete',1,tkNone,nil,__TMenuItemDelete,false,0,'Index: Integer');
    DefineMethod('Clear',0,tkNone,nil,__TMenuItemClear,false,0,'');
    DefineMethod('Click',0,tkNone,nil,__TMenuItemClick,false,0,'');
    DefineMethod('Find',1,tkClass,TMenuItem,__TMenuItemFind,false,0,'ACaption: string');
    DefineMethod('IndexOf',1,tkInteger,nil,__TMenuItemIndexOf,false,0,'Item: TMenuItem');
    ...
    DefineMethod('InsertNewLineBefore',1,tkInteger,nil,__TMenuItemInsertNewLineBefore,false,0,'AItem: TMenuItem');
    DefineMethod('InsertNewLineAfter',1,tkInteger,nil,__TMenuItemInsertNewLineAfter,false,0,'AItem: TMenuItem');
    DefineMethod('Add',1,tkNone,nil,__TMenuItemAdd,false,0,'Item: TMenuItem');
    DefineMethod('Remove',1,tkNone,nil,__TMenuItemRemove,false,0,'Item: TMenuItem');
  ...
  begin
    DefineMethod('Create',1,tkClass,TMenu,__TMenuCreate,true,0,'AOwner: TComponent');
    ...
    DefineMethod('DispatchCommand',1,tkVariant,nil,__TMenuDispatchCommand,false,0,'ACommand: Word');
    DefineMethod('DispatchPopup',1,tkVariant,nil,__TMenuDispatchPopup,false,0,'AHandle: HMENU');
    DefineMethod('FindItem',2,tkClass,TMenuItem,__TMenuFindItem,false,0,'Value: Integer; Kind: TFindItemKind');
    DefineMethod('GetHelpContext',2,tkEnumeration,nil,__TMenuGetHelpContext,false,0,'Value: Integer; ByCommand: Boolean');
    DefineMethod('IsRightToLeft',0,tkVariant,nil,__TMenuIsRightToLeft,false,0,'');
    DefineMethod('IsShortCut',1,tkVariant,nil,__TMenuIsShortCut,false,0,'Message: TWMKey').SetVarArgs([0]);
    DefineMethod('ParentBiDiModeChanged',0,tkNone,nil,__TMenuParentBiDiModeChanged,false,0,'');
    DefineMethod('ProcessMenuChar',1,tkNone,nil,__TMenuProcessMenuChar,false,0,'Message: TWMMenuChar').SetVarArgs([0]);
  ...
  begin
    DefineMethod('Merge',1,tkNone,nil,__TMainMenuMerge,false,0,'Menu: TMainMenu');
    DefineMethod('Unmerge',1,tkNone,nil,__TMainMenuUnmerge,false,0,'Menu: TMainMenu');
    DefineMethod('SetOle2MenuHandle',1,tkNone,nil,__TMainMenuSetOle2MenuHandle,false,0,'Handle: HMENU');
  end;
  With Scripter.DefineClass(TPopupMenu) do
  begin
    DefineMethod('Create',1,tkClass,TPopupMenu,__TPopupMenuCreate,true,0,'AOwner: TComponent');
    DefineMethod('Destroy',0,tkNone,nil,__TPopupMenuDestroy,false,0,'');
    DefineMethod('Popup',2,tkNone,nil,__TPopupMenuPopup,false,0,'X: Integer; Y: Integer');
  ...
  begin
    DefineMethod('Add',1,tkNone,nil,__TPopupListAdd,false,0,'Popup: TPopupMenu');
    DefineMethod('Remove',1,tkNone,nil,__TPopupListRemove,false,0,'Popup: TPopupMenu');
    DefineProp('Window',tkInteger,__GetTPopupListWindow,nil,nil,false,0);
  end;
  With Scripter.DefineClass(TMenuItemStack) do
  begin
    DefineMethod('ClearItem',1,tkNone,nil,__TMenuItemStackClearItem,false,0,'AItem: TMenuItem');
  end;
  ...
  begin
    DefineMethod('ShortCut',2,tkEnumeration,nil,__ShortCut,false,0,'Key: Word; Shift: TShiftState');
    DefineMethod('ShortCutToKey',3,tkNone,nil,__ShortCutToKey,false,0,'ShortCut: TShortCut; Key: Word; Shift: TShiftState').SetVarArgs([1,2]);
    DefineMethod('ShortCutToText',1,tkVariant,nil,__ShortCutToText,false,0,'ShortCut: TShortCut');
    DefineMethod('TextToShortCut',1,tkEnumeration,nil,__TextToShortCut,false,0,'Text: string');
    DefineMethod('ShortCutFromMessage',1,tkEnumeration,nil,__ShortCutFromMessage,false,0,'Message: TWMKey');
    DefineMethod('NewLine',0,tkClass,TMenuItem,__NewLine,false,0,'');
    DefineMethod('DrawMenuItem',4,tkNone,nil,__DrawMenuItem,false,0,'MenuItem: TMenuItem; ACanvas: TCanvas; ARect: TRect; State: TOwnerDrawState');
    DefineMethod('StripHotkey',1,tkVariant,nil,__StripHotkey,false,0,'Text: string');
    DefineMethod('GetHotkey',1,tkVariant,nil,__GetHotkey,false,0,'Text: string');
    DefineMethod('AnsiSameCaption',2,tkVariant,nil,__AnsiSameCaption,false,0,'Text1: string; Text2: string');
    DefineMethod('IsAltGRPressed',0,tkVariant,nil,__IsAltGRPressed,false,0,'');
