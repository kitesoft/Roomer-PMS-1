...
begin
  ...
  begin
    ...
    DefineMethod('GetCurrentRecord',1,tkVariant,nil,__TCustomClientDataSetGetCurrentRecord,false,0,'Buffer: PChar');
    ...
    DefineMethod('SetAltRecBuffers',3,tkNone,nil,__TCustomClientDataSetSetAltRecBuffers,false,0,'Old: PChar; New: PChar; Cur: PChar');
