...
type
  TatFormsLibrary = class(TatScripterLibrary)
    ...
    procedure __Subclass3DWnd(AMachine: TatVirtualMachine);
    procedure __Subclass3DDlg(AMachine: TatVirtualMachine);
    procedure __SetAutoSubClass(AMachine: TatVirtualMachine);
    procedure __DeallocateHWnd(AMachine: TatVirtualMachine);
    procedure __DoneCtl3D(AMachine: TatVirtualMachine);
    procedure __InitCtl3D(AMachine: TatVirtualMachine);
    ...
    procedure __SetCustomFormGlassFrame(AMachine: TatVirtualMachine);
    procedure __GetCustomFormGlassFrame(AMachine: TatVirtualMachine);
    procedure __SetApplicationMainFormOnTaskBar(AMachine: TatVirtualMachine);
    procedure __GetApplicationMainFormOnTaskBar(AMachine: TatVirtualMachine);
  ...
  TCMHintShowWrapper = class(TatRecordWrapper)
  private
    FMsg: Cardinal;
    FReserved: Integer;
    FResult: Integer;
  public
    constructor Create(ARecord: TCMHintShow);
    function ObjToRec: TCMHintShow;
  published
...
constructor TCMHintShowWrapper.Create(ARecord: TCMHintShow);
begin
  inherited Create;
  FMsg := ARecord.Msg;
...
function TCMHintShowWrapper.ObjToRec: TCMHintShow;
begin
  result.Msg := FMsg;
...
begin
  with AMachine do
  begin
    TControlScrollBar(CurrentObject).Assign(TPersistent(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TControlScrollBar(CurrentObject).Kind));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TScrollingWinControlClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TScrollingWinControl(CurrentObject).ScrollInView(TControl(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TScrollBoxClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomFrameClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomFormClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
1: AResult := ObjectToVar(TCustomFormClass(CurrentClass.ClassRef).CreateNew(TComponent(VarToObject(GetInputArg(0)))));
2: AResult := ObjectToVar(TCustomFormClass(CurrentClass.ClassRef).CreateNew(TComponent(VarToObject(GetInputArg(0))),VarToInteger(GetInputArg(1))));
end;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomForm(CurrentObject).DefocusControl(TWinControl(VarToObject(GetInputArg(0))),GetInputArg(1));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomForm(CurrentObject).Dock(TWinControl(VarToObject(GetInputArg(0))),TRectWrapper(integer(GetInputArg(1))).ObjToRec);
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomForm(CurrentObject).FocusControl(TWinControl(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomForm(CurrentObject).GetFormImage);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    Case InputArgCount of
      ...
      1: TCustomForm(CurrentObject).MakeFullyVisible(TMonitor(VarToObject(GetInputArg(0))));
    end;
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomForm(CurrentObject).SendCancelMode(TControl(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TCustomForm(CurrentObject).SetFocusedControl(TWinControl(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := TCustomForm(CurrentObject).WantChildKey(TControl(VarToObject(GetInputArg(0))),Param1);
    ReturnOutputArg(AResult);
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomForm(CurrentObject).ActiveControl));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomForm(CurrentObject).ActiveControl:=TWinControl(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomForm(CurrentObject).ActiveOleControl));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomForm(CurrentObject).ActiveOleControl:=TWinControl(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomForm(CurrentObject).BorderStyle));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomForm(CurrentObject).BorderStyle:=TFormBorderStyle(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomForm(CurrentObject).Canvas));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TCustomForm(CurrentObject).HelpFile));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomForm(CurrentObject).HelpFile:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomForm(CurrentObject).Menu));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomForm(CurrentObject).Menu:=TMainMenu(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomForm(CurrentObject).ModalResult));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomForm(CurrentObject).ModalResult:=TModalResult(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomForm(CurrentObject).Monitor));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomForm(CurrentObject).PopupMode));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomForm(CurrentObject).PopupMode:=TPopupMode(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomForm(CurrentObject).PopupParent));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomForm(CurrentObject).PopupParent:=TCustomForm(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomForm(CurrentObject).WindowState));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomForm(CurrentObject).WindowState:=TWindowState(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomActiveFormClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
if not Assigned(Param1Rec) or not (Param1Rec is TMessageWrapper) then 
  Param1Rec := TMessageWrapper.Create(Param1);
Param1 := TMessageWrapper(Param1Rec).ObjToRec;
AResult := TCustomActiveForm(CurrentObject).WantChildKey(TControl(VarToObject(GetInputArg(0))),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(TMessageWrapper.Create(Param1)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomDockFormClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TScreenClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
case InputArgCount of
1: AResult := ObjectToVar(TScreen(CurrentObject).MonitorFromPoint(TPointWrapper(integer(GetInputArg(0))).ObjToRec));
2: AResult := ObjectToVar(TScreen(CurrentObject).MonitorFromPoint(TPointWrapper(integer(GetInputArg(0))).ObjToRec,TMonitorDefaultTo(VarToInteger(GetInputArg(1)))));
end;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
case InputArgCount of
1: AResult := ObjectToVar(TScreen(CurrentObject).MonitorFromRect(TRectWrapper(integer(GetInputArg(0))).ObjToRec));
2: AResult := ObjectToVar(TScreen(CurrentObject).MonitorFromRect(TRectWrapper(integer(GetInputArg(0))).ObjToRec,TMonitorDefaultTo(VarToInteger(GetInputArg(1)))));
end;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
case InputArgCount of
1: AResult := ObjectToVar(TScreen(CurrentObject).MonitorFromWindow(VarToInteger(GetInputArg(0))));
2: AResult := ObjectToVar(TScreen(CurrentObject).MonitorFromWindow(VarToInteger(GetInputArg(0)),TMonitorDefaultTo(VarToInteger(GetInputArg(1)))));
end;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TScreen(CurrentObject).ActiveControl));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TScreen(CurrentObject).ActiveCustomForm));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TScreen(CurrentObject).ActiveForm));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TScreen(CurrentObject).CustomForms[VarToInteger(GetArrayIndex(0))]));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TScreen(CurrentObject).Cursor));
  end;
end;
...
begin
  with AMachine do
  begin
    TScreen(CurrentObject).Cursor:=TCursor(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TScreen(CurrentObject).DataModules[VarToInteger(GetArrayIndex(0))]));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TScreen(CurrentObject).FocusedForm));
  end;
end;
...
begin
  with AMachine do
  begin
    TScreen(CurrentObject).FocusedForm:=TCustomForm(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TScreen(CurrentObject).SaveFocusedList));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TScreen(CurrentObject).Monitors[VarToInteger(GetArrayIndex(0))]));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TScreen(CurrentObject).HintFont));
  end;
end;
...
begin
  with AMachine do
  begin
    TScreen(CurrentObject).HintFont:=TFont(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TScreen(CurrentObject).IconFont));
  end;
end;
...
begin
  with AMachine do
  begin
    TScreen(CurrentObject).IconFont:=TFont(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TScreen(CurrentObject).MenuFont));
  end;
end;
...
begin
  with AMachine do
  begin
    TScreen(CurrentObject).MenuFont:=TFont(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TScreen(CurrentObject).Fonts));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TScreen(CurrentObject).Forms[VarToInteger(GetArrayIndex(0))]));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TScreen(CurrentObject).Imes));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TScreen(CurrentObject).DefaultIme));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TScreen(CurrentObject).PrimaryMonitor));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TApplicationClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TApplication(CurrentObject).AddPopupForm(TCustomForm(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TApplication(CurrentObject).ControlDestroyed(TControl(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TApplication(CurrentObject).ExecuteAction(TBasicAction(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TApplication(CurrentObject).HandleException(TObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TApplication(CurrentObject).HelpContext(THelpContext(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TApplication(CurrentObject).HelpJump(VarToStr(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TApplication(CurrentObject).HelpKeyword(VarToStr(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
if not Assigned(Param1Rec) or not (Param1Rec is TMessageWrapper) then 
  Param1Rec := TMessageWrapper.Create(Param1);
Param1 := TMessageWrapper(Param1Rec).ObjToRec;
    TApplication(CurrentObject).HintMouseMessage(TControl(VarToObject(GetInputArg(0))),Param1);
    SetInputArg(1,integer(TMessageWrapper.Create(Param1)));
  end;
end;
...
begin
  with AMachine do
  begin
    TApplication(CurrentObject).RemovePopupForm(TCustomForm(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TApplication(CurrentObject).ShowException(Exception(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TApplication(CurrentObject).UpdateAction(TBasicAction(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TApplication(CurrentObject).CurrentHelpFile));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TApplication(CurrentObject).ExeName));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TApplication(CurrentObject).HelpFile));
  end;
end;
...
begin
  with AMachine do
  begin
    TApplication(CurrentObject).HelpFile:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TApplication(CurrentObject).Hint));
  end;
end;
...
begin
  with AMachine do
  begin
    TApplication(CurrentObject).Hint:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TApplication(CurrentObject).HintColor));
  end;
end;
...
begin
  with AMachine do
  begin
    TApplication(CurrentObject).HintColor:=TColor(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TApplication(CurrentObject).Icon));
  end;
end;
...
begin
  with AMachine do
  begin
    TApplication(CurrentObject).Icon:=TIcon(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TApplication(CurrentObject).MainForm));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TApplication(CurrentObject).ModalPopupMode));
  end;
end;
...
begin
  with AMachine do
  begin
    TApplication(CurrentObject).ModalPopupMode:=TPopupMode(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TApplication(CurrentObject).BiDiMode));
  end;
end;
...
begin
  with AMachine do
  begin
    TApplication(CurrentObject).BiDiMode:=TBiDiMode(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TApplication(CurrentObject).BiDiKeyboard));
  end;
end;
...
begin
  with AMachine do
  begin
    TApplication(CurrentObject).BiDiKeyboard:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TApplication(CurrentObject).NonBiDiKeyboard));
  end;
end;
...
begin
  with AMachine do
  begin
    TApplication(CurrentObject).NonBiDiKeyboard:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TApplication(CurrentObject).Title));
  end;
end;
...
begin
  with AMachine do
  begin
    TApplication(CurrentObject).Title:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TGlassFrameClass(CurrentClass.ClassRef).Create(TCustomForm(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TGlassFrame(CurrentObject).Assign(TPersistent(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TGlassFrame(CurrentObject).IntersectsControl(TControl(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    ...
    Action := TCloseAction(VarToInteger(ActionTemp));
...
begin
  ...
  begin
case InputArgCount of
1: AResult := ObjectToVar(Forms.GetParentForm(TControl(VarToObject(GetInputArg(0)))));
2: AResult := ObjectToVar(Forms.GetParentForm(TControl(VarToObject(GetInputArg(0))),GetInputArg(1)));
end;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
case InputArgCount of
1: AResult := ObjectToVar(Forms.ValidParentForm(TControl(VarToObject(GetInputArg(0)))));
2: AResult := ObjectToVar(Forms.ValidParentForm(TControl(VarToObject(GetInputArg(0))),GetInputArg(1)));
end;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Forms.IsAccel(VarToInteger(GetInputArg(0)),VarToStr(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatFormsLibrary.__Subclass3DWnd(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Forms.Subclass3DWnd(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatFormsLibrary.__Subclass3DDlg(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    Forms.Subclass3DDlg(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)));
  end;
end;

procedure TatFormsLibrary.__SetAutoSubClass(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    Forms.SetAutoSubClass(GetInputArg(0));
  end;
end;

procedure TatFormsLibrary.__DeallocateHWnd(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    Forms.DeallocateHWnd(VarToInteger(GetInputArg(0)));
  end;
end;

procedure TatFormsLibrary.__DoneCtl3D(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    Forms.DoneCtl3D;
...
procedure TatFormsLibrary.__InitCtl3D(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    Forms.InitCtl3D;
...
procedure TatFormsLibrary.__SetCustomFormGlassFrame(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    Forms.SetCustomFormGlassFrame(TCustomForm(VarToObject(GetInputArg(0))),TGlassFrame(VarToObject(GetInputArg(1))));
  end;
end;

procedure TatFormsLibrary.__GetCustomFormGlassFrame(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := ObjectToVar(Forms.GetCustomFormGlassFrame(TCustomForm(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatFormsLibrary.__SetApplicationMainFormOnTaskBar(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    Forms.SetApplicationMainFormOnTaskBar(TApplication(VarToObject(GetInputArg(0))),GetInputArg(1));
  end;
end;

procedure TatFormsLibrary.__GetApplicationMainFormOnTaskBar(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Forms.GetApplicationMainFormOnTaskBar(TApplication(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(Forms.Application));
  end;
end;
...
begin
  with AMachine do
  begin
    Forms.Application:=TApplication(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(Forms.Screen));
  end;
end;
...
begin
  with AMachine do
  begin
    Forms.Screen:=TScreen(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  ...
  begin
    DefineMethod('Assign',1,tkNone,nil,__TControlScrollBarAssign,false,0,'Source: TPersistent');
  ...
  begin
    DefineMethod('Create',1,tkClass,TScrollingWinControl,__TScrollingWinControlCreate,true,0,'AOwner: TComponent');
    ...
    DefineMethod('ScrollInView',1,tkNone,nil,__TScrollingWinControlScrollInView,false,0,'AControl: TControl');
  end;
  With Scripter.DefineClass(TScrollBox) do
  begin
    DefineMethod('Create',1,tkClass,TScrollBox,__TScrollBoxCreate,true,0,'AOwner: TComponent');
  end;
  With Scripter.DefineClass(TCustomFrame) do
  begin
    DefineMethod('Create',1,tkClass,TCustomFrame,__TCustomFrameCreate,true,0,'AOwner: TComponent');
  end;
  ...
  begin
    DefineMethod('Create',1,tkClass,TCustomForm,__TCustomFormCreate,true,0,'AOwner: TComponent');
    DefineMethod('CreateNew',2,tkClass,TCustomForm,__TCustomFormCreateNew,true,1,'AOwner: TComponent; Dummy: Integer = 0');
    ...
    DefineMethod('DefaultHandler',1,tkNone,nil,__TCustomFormDefaultHandler,false,0,'Message').SetVarArgs([0]);
    DefineMethod('DefocusControl',2,tkNone,nil,__TCustomFormDefocusControl,false,0,'Control: TWinControl; Removing: Boolean');
    DefineMethod('Dock',2,tkNone,nil,__TCustomFormDock,false,0,'NewDockSite: TWinControl; ARect: TRect');
    DefineMethod('FocusControl',1,tkNone,nil,__TCustomFormFocusControl,false,0,'Control: TWinControl');
    ...
    DefineMethod('IsShortCut',1,tkVariant,nil,__TCustomFormIsShortCut,false,0,'Message: TWMKey').SetVarArgs([0]);
    DefineMethod('MakeFullyVisible',1,tkNone,nil,__TCustomFormMakeFullyVisible,false,1,'AMonitor: TMonitor = nil');
    DefineMethod('MouseWheelHandler',1,tkNone,nil,__TCustomFormMouseWheelHandler,false,0,'Message: TMessage').SetVarArgs([0]);
    DefineMethod('Print',0,tkNone,nil,__TCustomFormPrint,false,0,'');
    DefineMethod('RecreateAsPopup',1,tkNone,nil,__TCustomFormRecreateAsPopup,false,0,'AWindowHandle: HWND');
    DefineMethod('Release',0,tkNone,nil,__TCustomFormRelease,false,0,'');
    DefineMethod('SendCancelMode',1,tkNone,nil,__TCustomFormSendCancelMode,false,0,'Sender: TControl');
    DefineMethod('SetFocus',0,tkNone,nil,__TCustomFormSetFocus,false,0,'');
    DefineMethod('SetFocusedControl',1,tkVariant,nil,__TCustomFormSetFocusedControl,false,0,'Control: TWinControl');
    ...
    DefineMethod('WantChildKey',2,tkVariant,nil,__TCustomFormWantChildKey,false,0,'Child: TControl; Message: TMessage').SetVarArgs([1]);
  ...
  begin
    DefineMethod('Create',1,tkClass,TCustomActiveForm,__TCustomActiveFormCreate,true,0,'AOwner: TComponent');
    DefineMethod('WantChildKey',2,tkVariant,nil,__TCustomActiveFormWantChildKey,false,0,'Child: TControl; Message: TMessage').SetVarArgs([1]);
  ...
  begin
    DefineMethod('Create',1,tkClass,TCustomDockForm,__TCustomDockFormCreate,true,0,'AOwner: TComponent');
  ...
  begin
    DefineMethod('Create',1,tkClass,TScreen,__TScreenCreate,true,0,'AOwner: TComponent');
    ...
    DefineMethod('MonitorFromPoint',2,tkClass,TMonitor,__TScreenMonitorFromPoint,false,1,'Point: TPoint; MonitorDefault: TMonitorDefaultTo = mdNearest');
    DefineMethod('MonitorFromRect',2,tkClass,TMonitor,__TScreenMonitorFromRect,false,1,'Rect: TRect; MonitorDefault: TMonitorDefaultTo = mdNearest');
    DefineMethod('MonitorFromWindow',2,tkClass,TMonitor,__TScreenMonitorFromWindow,false,1,'Handle: THandle; MonitorDefault: TMonitorDefaultTo = mdNearest');
  ...
  begin
    DefineMethod('Create',1,tkClass,TApplication,__TApplicationCreate,true,0,'AOwner: TComponent');
    DefineMethod('Destroy',0,tkNone,nil,__TApplicationDestroy,false,0,'');
    DefineMethod('ActivateHint',1,tkNone,nil,__TApplicationActivateHint,false,0,'CursorPos: TPoint');
    DefineMethod('AddPopupForm',1,tkInteger,nil,__TApplicationAddPopupForm,false,0,'APopupForm: TCustomForm');
    DefineMethod('BringToFront',0,tkNone,nil,__TApplicationBringToFront,false,0,'');
    DefineMethod('ControlDestroyed',1,tkNone,nil,__TApplicationControlDestroyed,false,0,'Control: TControl');
    ...
    DefineMethod('ExecuteAction',1,tkVariant,nil,__TApplicationExecuteAction,false,0,'Action: TBasicAction');
    DefineMethod('HandleException',1,tkNone,nil,__TApplicationHandleException,false,0,'Sender: TObject');
    DefineMethod('HandleMessage',0,tkNone,nil,__TApplicationHandleMessage,false,0,'');
    DefineMethod('HelpCommand',2,tkVariant,nil,__TApplicationHelpCommand,false,0,'Command: Integer; Data: Longint');
    DefineMethod('HelpContext',1,tkVariant,nil,__TApplicationHelpContext,false,0,'Context: THelpContext');
    DefineMethod('HelpJump',1,tkVariant,nil,__TApplicationHelpJump,false,0,'JumpID: string');
    DefineMethod('HelpKeyword',1,tkVariant,nil,__TApplicationHelpKeyword,false,0,'Keyword: string');
    ...
    DefineMethod('HintMouseMessage',2,tkNone,nil,__TApplicationHintMouseMessage,false,0,'Control: TControl; Message: TMessage').SetVarArgs([1]);
    ...
    DefineMethod('MessageBox',3,tkInteger,nil,__TApplicationMessageBox,false,1,'Text: PChar; Caption: PChar; Flags: Longint = MB_OK');
    ...
    DefineMethod('RemovePopupForm',1,tkNone,nil,__TApplicationRemovePopupForm,false,0,'APopupForm: TCustomForm');
    ...
    DefineMethod('ShowException',1,tkNone,nil,__TApplicationShowException,false,0,'E: Exception');
    ...
    DefineMethod('UpdateAction',1,tkVariant,nil,__TApplicationUpdateAction,false,0,'Action: TBasicAction');
  ...
  begin
    DefineMethod('Create',1,tkClass,TGlassFrame,__TGlassFrameCreate,true,0,'Client: TCustomForm');
    DefineMethod('Assign',1,tkNone,nil,__TGlassFrameAssign,false,0,'Source: TPersistent');
    DefineMethod('FrameExtended',0,tkVariant,nil,__TGlassFrameFrameExtended,false,0,'');
    DefineMethod('IntersectsControl',1,tkVariant,nil,__TGlassFrameIntersectsControl,false,0,'Control: TControl');
  end;
  ...
  begin
    DefineMethod('GetParentForm',2,tkClass,TCustomForm,__GetParentForm,false,1,'Control: TControl; TopForm: Boolean = True');
    DefineMethod('ValidParentForm',2,tkClass,TCustomForm,__ValidParentForm,false,1,'Control: TControl; TopForm: Boolean = True');
    DefineMethod('IsAccel',2,tkVariant,nil,__IsAccel,false,0,'VK: Word; Str: string');
    DefineMethod('Subclass3DWnd',1,tkVariant,nil,__Subclass3DWnd,false,0,'Wnd: HWnd');
    DefineMethod('Subclass3DDlg',2,tkNone,nil,__Subclass3DDlg,false,0,'Wnd: HWnd; Flags: Word');
    DefineMethod('SetAutoSubClass',1,tkNone,nil,__SetAutoSubClass,false,0,'Enable: Boolean');
    DefineMethod('DeallocateHWnd',1,tkNone,nil,__DeallocateHWnd,false,0,'Wnd: HWND');
    DefineMethod('DoneCtl3D',0,tkNone,nil,__DoneCtl3D,false,0,'');
    DefineMethod('InitCtl3D',0,tkNone,nil,__InitCtl3D,false,0,'');
    DefineMethod('KeysToShiftState',1,tkInteger,nil,__KeysToShiftState,false,0,'Keys: Word');
    DefineMethod('KeyDataToShiftState',1,tkInteger,nil,__KeyDataToShiftState,false,0,'KeyData: Longint');
    ...
    DefineMethod('SetCustomFormGlassFrame',2,tkNone,nil,__SetCustomFormGlassFrame,false,0,'CustomForm: TCustomForm; GlassFrame: TGlassFrame');
    DefineMethod('GetCustomFormGlassFrame',1,tkClass,TGlassFrame,__GetCustomFormGlassFrame,false,0,'CustomForm: TCustomForm');
    DefineMethod('SetApplicationMainFormOnTaskBar',2,tkNone,nil,__SetApplicationMainFormOnTaskBar,false,0,'Application: TApplication; Value: Boolean');
    DefineMethod('GetApplicationMainFormOnTaskBar',1,tkVariant,nil,__GetApplicationMainFormOnTaskBar,false,0,'Application: TApplication');
