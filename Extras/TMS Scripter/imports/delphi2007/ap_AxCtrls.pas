...
type
  TatAxCtrlsLibrary = class(TatScripterLibrary)
    ...
    procedure __TActiveXControlPropChanged(AMachine: TatVirtualMachine);
    procedure __TActiveXControlPropRequestEdit(AMachine: TatVirtualMachine);
...
procedure TatAxCtrlsLibrary.__TActiveXControlPropChanged(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TActiveXControl(CurrentObject).PropChanged(GetInputArg(0));
  end;
end;

procedure TatAxCtrlsLibrary.__TActiveXControlPropRequestEdit(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := TActiveXControl(CurrentObject).PropRequestEdit(GetInputArg(0));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('PropChanged',1,tkNone,nil,__TActiveXControlPropChanged,false,0,'PropertyName: WideString');
    DefineMethod('PropRequestEdit',1,tkVariant,nil,__TActiveXControlPropRequestEdit,false,0,'PropertyName: WideString');
