...
begin
  ...
  begin
    ...
    DefineMethod('CreateStdAccessibleProxy',5,tkInteger,nil,__CreateStdAccessibleProxy,false,0,'hwnd: THandle; pClassName: PChar; idObject: LongInt; riid: TGUID; ppvObject').SetVarArgs([4]);
