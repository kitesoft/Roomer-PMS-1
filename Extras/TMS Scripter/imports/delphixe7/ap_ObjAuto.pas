...
type
  ...
  published
    ...
    property CallingConvention: TCallConv read FCallingConvention write FCallingConvention;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(ObjAuto.GetInvokeInstance(TMethodWrapper(integer(GetInputArg(0))).ObjToRec));
...
begin
  ...
  begin
    ...
    DefineMethod('GetInvokeInstance',1,tkClass,TObject,__GetInvokeInstance,false,0,'MethodPointer: TMethod');
