...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TPrinterClass(CurrentClass.ClassRef).Create);
...
begin
  with AMachine do
  begin
    TPrinter(CurrentObject).SetPrinter(PChar(VarToStr(GetInputArg(0))),PChar(VarToStr(GetInputArg(1))),PChar(VarToStr(GetInputArg(2))),VarToInteger(GetInputArg(3)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TPrinter(CurrentObject).Canvas));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TPrinter(CurrentObject).Fonts));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TPrinter(CurrentObject).Orientation));
  end;
end;
...
begin
  with AMachine do
  begin
    TPrinter(CurrentObject).Orientation:=TPrinterOrientation(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TPrinter(CurrentObject).Printers));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TPrinter(CurrentObject).Title));
  end;
end;
...
begin
  with AMachine do
  begin
    TPrinter(CurrentObject).Title:=VarToStr(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(Printers.Printer);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(Printers.SetPrinter(TPrinter(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('GetPrinter',4,tkNone,nil,__TPrinterGetPrinter,false,0,'ADevice: PChar; ADriver: PChar; APort: PChar; ADeviceMode: THandle').SetVarArgs([3]);
    DefineMethod('SetPrinter',4,tkNone,nil,__TPrinterSetPrinter,false,0,'ADevice: PChar; ADriver: PChar; APort: PChar; ADeviceMode: THandle');
  ...
  begin
    ...
    DefineMethod('SetPrinter',1,tkClass,TPrinter,__SetPrinter,false,0,'NewPrinter: TPrinter');
