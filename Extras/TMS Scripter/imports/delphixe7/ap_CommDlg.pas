...
type
  ...
  published
    ...
    property FlagsEx: DWORD read FFlagsEx write FFlagsEx;
  end;
...
AResult := Integer(CommDlg.GetFileTitle(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(CommDlg.GetFileTitleA(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),PAnsiChar(AnsiString(VarToStr(GetInputArg(1)))),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(CommDlg.GetFileTitleW(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),VarToInteger(GetInputArg(2))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
    DefineMethod('GetOpenFileName',1,tkVariant,nil,__GetOpenFileName,false,0,'OpenFile: TOpenFilename').SetVarArgs([0]);
    DefineMethod('GetOpenFileNameA',1,tkVariant,nil,__GetOpenFileNameA,false,0,'OpenFile: TOpenFilenameA').SetVarArgs([0]);
    DefineMethod('GetOpenFileNameW',1,tkVariant,nil,__GetOpenFileNameW,false,0,'OpenFile: TOpenFilenameW').SetVarArgs([0]);
    DefineMethod('GetSaveFileName',1,tkVariant,nil,__GetSaveFileName,false,0,'OpenFile: TOpenFilename').SetVarArgs([0]);
    DefineMethod('GetSaveFileNameA',1,tkVariant,nil,__GetSaveFileNameA,false,0,'OpenFile: TOpenFilenameA').SetVarArgs([0]);
    DefineMethod('GetSaveFileNameW',1,tkVariant,nil,__GetSaveFileNameW,false,0,'OpenFile: TOpenFilenameW').SetVarArgs([0]);
    DefineMethod('GetFileTitle',3,tkInteger,nil,__GetFileTitle,false,0,'FileName: PWideChar; Title: PWideChar; TitleSize: Word');
    DefineMethod('GetFileTitleA',3,tkInteger,nil,__GetFileTitleA,false,0,'FileName: PAnsiChar; Title: PAnsiChar; TitleSize: Word');
    DefineMethod('GetFileTitleW',3,tkInteger,nil,__GetFileTitleW,false,0,'FileName: PWideChar; Title: PWideChar; TitleSize: Word');
    DefineMethod('ChooseColor',1,tkVariant,nil,__ChooseColor,false,0,'CC: TChooseColor').SetVarArgs([0]);
    DefineMethod('ChooseColorA',1,tkVariant,nil,__ChooseColorA,false,0,'CC: TChooseColorA').SetVarArgs([0]);
    DefineMethod('ChooseColorW',1,tkVariant,nil,__ChooseColorW,false,0,'CC: TChooseColorW').SetVarArgs([0]);
    DefineMethod('FindText',1,tkInteger,nil,__FindText,false,0,'FindReplace: TFindReplace').SetVarArgs([0]);
    DefineMethod('FindTextA',1,tkInteger,nil,__FindTextA,false,0,'FindReplace: TFindReplaceA').SetVarArgs([0]);
    DefineMethod('FindTextW',1,tkInteger,nil,__FindTextW,false,0,'FindReplace: TFindReplaceW').SetVarArgs([0]);
    DefineMethod('ReplaceText',1,tkInteger,nil,__ReplaceText,false,0,'FindReplace: TFindReplace').SetVarArgs([0]);
    DefineMethod('ReplaceTextA',1,tkInteger,nil,__ReplaceTextA,false,0,'FindReplace: TFindReplaceA').SetVarArgs([0]);
    DefineMethod('ReplaceTextW',1,tkInteger,nil,__ReplaceTextW,false,0,'FindReplace: TFindReplaceW').SetVarArgs([0]);
    DefineMethod('ChooseFont',1,tkVariant,nil,__ChooseFont,false,0,'ChooseFont: TChooseFont').SetVarArgs([0]);
    DefineMethod('ChooseFontA',1,tkVariant,nil,__ChooseFontA,false,0,'ChooseFont: TChooseFontA').SetVarArgs([0]);
    DefineMethod('ChooseFontW',1,tkVariant,nil,__ChooseFontW,false,0,'ChooseFont: TChooseFontW').SetVarArgs([0]);
    DefineMethod('PrintDlg',1,tkVariant,nil,__PrintDlg,false,0,'PrintDlg: TPrintDlg').SetVarArgs([0]);
    DefineMethod('PrintDlgA',1,tkVariant,nil,__PrintDlgA,false,0,'PrintDlg: TPrintDlgA').SetVarArgs([0]);
    DefineMethod('PrintDlgW',1,tkVariant,nil,__PrintDlgW,false,0,'PrintDlg: TPrintDlgW').SetVarArgs([0]);
    DefineMethod('CommDlgExtendedError',0,tkInteger,nil,__CommDlgExtendedError,false,0,'');
    DefineMethod('PageSetupDlg',1,tkVariant,nil,__PageSetupDlg,false,0,'PgSetupDialog: TPageSetupDlg').SetVarArgs([0]);
    DefineMethod('PageSetupDlgA',1,tkVariant,nil,__PageSetupDlgA,false,0,'PgSetupDialog: TPageSetupDlgA').SetVarArgs([0]);
    DefineMethod('PageSetupDlgW',1,tkVariant,nil,__PageSetupDlgW,false,0,'PgSetupDialog: TPageSetupDlgW').SetVarArgs([0]);
    ...
    AddConstant('OFN_DONTADDTORECENT',OFN_DONTADDTORECENT);
    AddConstant('OFN_FORCESHOWHIDDEN',OFN_FORCESHOWHIDDEN);
    AddConstant('OFN_EX_NOPLACESBAR',OFN_EX_NOPLACESBAR);
