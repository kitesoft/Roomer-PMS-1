...
begin
  with AMachine do
  begin
AResult := ObjectToVar(EDBEngineErrorClass(CurrentClass.ClassRef).Create(VarToInteger(GetInputArg(0))));
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TDBErrorClass(CurrentClass.ClassRef).Create(EDBEngineError(VarToObject(GetInputArg(0))),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),VarToStr(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
