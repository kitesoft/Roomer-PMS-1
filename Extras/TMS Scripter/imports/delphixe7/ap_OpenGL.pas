...
begin
  With Scripter.DefineClass(ClassType) do
  begin
    DefineMethod('glAccum',2,tkNone,nil,__glAccum,false,0,'op: GLenum; value: GLfloat');
    DefineMethod('glAlphaFunc',2,tkNone,nil,__glAlphaFunc,false,0,'func: GLenum; ref: GLclampf');
    DefineMethod('glBegin',1,tkNone,nil,__glBegin,false,0,'mode: GLenum');
    DefineMethod('glBlendFunc',2,tkNone,nil,__glBlendFunc,false,0,'sfactor: GLenum; dfactor: GLenum');
    DefineMethod('glCallList',1,tkNone,nil,__glCallList,false,0,'list: GLuint');
    DefineMethod('glClear',1,tkNone,nil,__glClear,false,0,'mask: GLbitfield');
    DefineMethod('glClearAccum',4,tkNone,nil,__glClearAccum,false,0,'red: GLfloat; green: GLfloat; blue: GLfloat; alpha: GLfloat');
    DefineMethod('glClearColor',4,tkNone,nil,__glClearColor,false,0,'red: GLclampf; green: GLclampf; blue: GLclampf; alpha: GLclampf');
    DefineMethod('glClearDepth',1,tkNone,nil,__glClearDepth,false,0,'depth: GLclampd');
    DefineMethod('glClearIndex',1,tkNone,nil,__glClearIndex,false,0,'c: GLfloat');
    DefineMethod('glClearStencil',1,tkNone,nil,__glClearStencil,false,0,'s: GLint');
    DefineMethod('glColor3b',3,tkNone,nil,__glColor3b,false,0,'red: GLbyte; green: GLbyte; blue: GLbyte');
    DefineMethod('glColor3d',3,tkNone,nil,__glColor3d,false,0,'red: GLdouble; green: GLdouble; blue: GLdouble');
    DefineMethod('glColor3f',3,tkNone,nil,__glColor3f,false,0,'red: GLfloat; green: GLfloat; blue: GLfloat');
    DefineMethod('glColor3i',3,tkNone,nil,__glColor3i,false,0,'red: GLint; green: GLint; blue: GLint');
    DefineMethod('glColor3s',3,tkNone,nil,__glColor3s,false,0,'red: GLshort; green: GLshort; blue: GLshort');
    DefineMethod('glColor3ub',3,tkNone,nil,__glColor3ub,false,0,'red: GLubyte; green: GLubyte; blue: GLubyte');
    DefineMethod('glColor3ui',3,tkNone,nil,__glColor3ui,false,0,'red: GLuint; green: GLuint; blue: GLuint');
    DefineMethod('glColor3us',3,tkNone,nil,__glColor3us,false,0,'red: GLushort; green: GLushort; blue: GLushort');
    DefineMethod('glColor4b',4,tkNone,nil,__glColor4b,false,0,'red: GLbyte; green: GLbyte; blue: GLbyte; alpha: GLbyte');
    DefineMethod('glColor4d',4,tkNone,nil,__glColor4d,false,0,'red: GLdouble; green: GLdouble; blue: GLdouble; alpha: GLdouble');
    DefineMethod('glColor4f',4,tkNone,nil,__glColor4f,false,0,'red: GLfloat; green: GLfloat; blue: GLfloat; alpha: GLfloat');
    DefineMethod('glColor4i',4,tkNone,nil,__glColor4i,false,0,'red: GLint; green: GLint; blue: GLint; alpha: GLint');
    DefineMethod('glColor4s',4,tkNone,nil,__glColor4s,false,0,'red: GLshort; green: GLshort; blue: GLshort; alpha: GLshort');
    DefineMethod('glColor4ub',4,tkNone,nil,__glColor4ub,false,0,'red: GLubyte; green: GLubyte; blue: GLubyte; alpha: GLubyte');
    DefineMethod('glColor4ui',4,tkNone,nil,__glColor4ui,false,0,'red: GLuint; green: GLuint; blue: GLuint; alpha: GLuint');
    DefineMethod('glColor4us',4,tkNone,nil,__glColor4us,false,0,'red: GLushort; green: GLushort; blue: GLushort; alpha: GLushort');
    DefineMethod('glColor',3,tkNone,nil,__glColor,false,0,'red: GLbyte; green: GLbyte; blue: GLbyte');
    DefineMethod('glColorMask',4,tkNone,nil,__glColorMask,false,0,'red: GLboolean; green: GLboolean; blue: GLboolean; alpha: GLboolean');
    DefineMethod('glColorMaterial',2,tkNone,nil,__glColorMaterial,false,0,'face: GLenum; mode: GLenum');
    DefineMethod('glCopyPixels',5,tkNone,nil,__glCopyPixels,false,0,'x: GLint; y: GLint; width: GLsizei; height: GLsizei; pixeltype: GLenum');
    DefineMethod('glCullFace',1,tkNone,nil,__glCullFace,false,0,'mode: GLenum');
    DefineMethod('glDeleteLists',2,tkNone,nil,__glDeleteLists,false,0,'list: GLuint; range: GLsizei');
    DefineMethod('glDepthFunc',1,tkNone,nil,__glDepthFunc,false,0,'func: GLenum');
    DefineMethod('glDepthMask',1,tkNone,nil,__glDepthMask,false,0,'flag: GLboolean');
    DefineMethod('glDepthRange',2,tkNone,nil,__glDepthRange,false,0,'zNear: GLclampd; zFar: GLclampd');
    DefineMethod('glDisable',1,tkNone,nil,__glDisable,false,0,'cap: GLenum');
    DefineMethod('glDrawBuffer',1,tkNone,nil,__glDrawBuffer,false,0,'mode: GLenum');
    DefineMethod('glEdgeFlag',1,tkNone,nil,__glEdgeFlag,false,0,'flag: GLboolean');
    DefineMethod('glEnable',1,tkNone,nil,__glEnable,false,0,'cap: GLenum');
    DefineMethod('glEnd',0,tkNone,nil,__glEnd,false,0,'');
    DefineMethod('glEndList',0,tkNone,nil,__glEndList,false,0,'');
    DefineMethod('glEvalCoord1d',1,tkNone,nil,__glEvalCoord1d,false,0,'u: GLdouble');
    DefineMethod('glEvalCoord1f',1,tkNone,nil,__glEvalCoord1f,false,0,'u: GLfloat');
    DefineMethod('glEvalCoord2d',2,tkNone,nil,__glEvalCoord2d,false,0,'u: GLdouble; v: GLdouble');
    DefineMethod('glEvalCoord2f',2,tkNone,nil,__glEvalCoord2f,false,0,'u: GLfloat; v: GLfloat');
    DefineMethod('glEvalCoord',1,tkNone,nil,__glEvalCoord,false,0,'u: GLdouble');
    DefineMethod('glEvalMesh1',3,tkNone,nil,__glEvalMesh1,false,0,'mode: GLenum; i1: GLint; i2: GLint');
    DefineMethod('glEvalMesh2',5,tkNone,nil,__glEvalMesh2,false,0,'mode: GLenum; i1: GLint; i2: GLint; j1: GLint; j2: GLint');
    DefineMethod('glEvalMesh',3,tkNone,nil,__glEvalMesh,false,0,'mode: GLenum; i1: GLint; i2: GLint');
    DefineMethod('glEvalPoint1',1,tkNone,nil,__glEvalPoint1,false,0,'i: GLint');
    DefineMethod('glEvalPoint2',2,tkNone,nil,__glEvalPoint2,false,0,'i: GLint; j: GLint');
    DefineMethod('glEvalPoint',1,tkNone,nil,__glEvalPoint,false,0,'i: GLint');
    DefineMethod('glFinish',0,tkNone,nil,__glFinish,false,0,'');
    DefineMethod('glFlush',0,tkNone,nil,__glFlush,false,0,'');
    DefineMethod('glFogf',2,tkNone,nil,__glFogf,false,0,'pname: GLenum; param: GLfloat');
    DefineMethod('glFogi',2,tkNone,nil,__glFogi,false,0,'pname: GLenum; param: GLint');
    DefineMethod('glFog',2,tkNone,nil,__glFog,false,0,'pname: GLenum; param: GLfloat');
    DefineMethod('glFrontFace',1,tkNone,nil,__glFrontFace,false,0,'mode: GLenum');
    DefineMethod('glFrustum',6,tkNone,nil,__glFrustum,false,0,'left: GLdouble; right: GLdouble; bottom: GLdouble; top: GLdouble; zNear: GLdouble; zFar: GLdouble');
    DefineMethod('glGenLists',1,tkInteger,nil,__glGenLists,false,0,'range: GLsizei');
    DefineMethod('glGetError',0,tkInteger,nil,__glGetError,false,0,'');
    DefineMethod('glGetPolygonStipple',1,tkNone,nil,__glGetPolygonStipple,false,0,'mask: GLubyte').SetVarArgs([0]);
    DefineMethod('glGetString',1,tkVariant,nil,__glGetString,false,0,'name: GLenum');
    DefineMethod('glHint',2,tkNone,nil,__glHint,false,0,'target: GLenum; mode: GLenum');
    DefineMethod('glIndexMask',1,tkNone,nil,__glIndexMask,false,0,'mask: GLuint');
    DefineMethod('glIndexd',1,tkNone,nil,__glIndexd,false,0,'c: GLdouble');
    DefineMethod('glIndexf',1,tkNone,nil,__glIndexf,false,0,'c: GLfloat');
    DefineMethod('glIndexi',1,tkNone,nil,__glIndexi,false,0,'c: GLint');
    DefineMethod('glIndexs',1,tkNone,nil,__glIndexs,false,0,'c: GLshort');
    DefineMethod('glIndex',1,tkNone,nil,__glIndex,false,0,'c: GLdouble');
    DefineMethod('glInitNames',0,tkNone,nil,__glInitNames,false,0,'');
    DefineMethod('glIsEnabled',1,tkVariant,nil,__glIsEnabled,false,0,'cap: GLenum');
    DefineMethod('glIsList',1,tkVariant,nil,__glIsList,false,0,'list: GLuint');
    DefineMethod('glLightModelf',2,tkNone,nil,__glLightModelf,false,0,'pname: GLenum; param: GLfloat');
    DefineMethod('glLightModeli',2,tkNone,nil,__glLightModeli,false,0,'pname: GLenum; param: GLint');
    DefineMethod('glLightModel',2,tkNone,nil,__glLightModel,false,0,'pname: GLenum; param: GLfloat');
    DefineMethod('glLightf',3,tkNone,nil,__glLightf,false,0,'light: GLenum; pname: GLenum; param: GLfloat');
    DefineMethod('glLighti',3,tkNone,nil,__glLighti,false,0,'light: GLenum; pname: GLenum; param: GLint');
    DefineMethod('glLight',3,tkNone,nil,__glLight,false,0,'light: GLenum; pname: GLenum; param: GLfloat');
    DefineMethod('glLineStipple',2,tkNone,nil,__glLineStipple,false,0,'factor: GLint; pattern: GLushort');
    DefineMethod('glLineWidth',1,tkNone,nil,__glLineWidth,false,0,'width: GLfloat');
    DefineMethod('glListBase',1,tkNone,nil,__glListBase,false,0,'base: GLuint');
    DefineMethod('glLoadIdentity',0,tkNone,nil,__glLoadIdentity,false,0,'');
    DefineMethod('glLoadName',1,tkNone,nil,__glLoadName,false,0,'name: GLuint');
    DefineMethod('glLogicOp',1,tkNone,nil,__glLogicOp,false,0,'opcode: GLenum');
    DefineMethod('glMapGrid1d',3,tkNone,nil,__glMapGrid1d,false,0,'un: GLint; u1: GLdouble; u2: GLdouble');
    DefineMethod('glMapGrid1f',3,tkNone,nil,__glMapGrid1f,false,0,'un: GLint; u1: GLfloat; u2: GLfloat');
    DefineMethod('glMapGrid2d',6,tkNone,nil,__glMapGrid2d,false,0,'un: GLint; u1: GLdouble; u2: GLdouble; vn: GLint; v1: GLdouble; v2: GLdouble');
    DefineMethod('glMapGrid2f',6,tkNone,nil,__glMapGrid2f,false,0,'un: GLint; u1: GLfloat; u2: GLfloat; vn: GLint; v1: GLfloat; v2: GLfloat');
    DefineMethod('glMapGrid',3,tkNone,nil,__glMapGrid,false,0,'un: GLint; u1: GLdouble; u2: GLdouble');
    DefineMethod('glMaterialf',3,tkNone,nil,__glMaterialf,false,0,'face: GLenum; pname: GLenum; param: GLfloat');
    DefineMethod('glMateriali',3,tkNone,nil,__glMateriali,false,0,'face: GLenum; pname: GLenum; param: GLint');
    DefineMethod('glMaterial',3,tkNone,nil,__glMaterial,false,0,'face: GLenum; pname: GLenum; param: GLfloat');
    DefineMethod('glMatrixMode',1,tkNone,nil,__glMatrixMode,false,0,'mode: GLenum');
    DefineMethod('glNewList',2,tkNone,nil,__glNewList,false,0,'ListIndex: GLuint; mode: GLenum');
    DefineMethod('glNormal3b',3,tkNone,nil,__glNormal3b,false,0,'nx: GLbyte; ny: GLbyte; nz: GLbyte');
    DefineMethod('glNormal3d',3,tkNone,nil,__glNormal3d,false,0,'nx: GLdouble; ny: GLdouble; nz: GLdouble');
    DefineMethod('glNormal3f',3,tkNone,nil,__glNormal3f,false,0,'nx: GLFloat; ny: GLFloat; nz: GLFloat');
    DefineMethod('glNormal3i',3,tkNone,nil,__glNormal3i,false,0,'nx: GLint; ny: GLint; nz: GLint');
    DefineMethod('glNormal3s',3,tkNone,nil,__glNormal3s,false,0,'nx: GLshort; ny: GLshort; nz: GLshort');
    DefineMethod('glNormal',3,tkNone,nil,__glNormal,false,0,'nx: GLbyte; ny: GLbyte; nz: GLbyte');
    DefineMethod('glOrtho',6,tkNone,nil,__glOrtho,false,0,'left: GLdouble; right: GLdouble; bottom: GLdouble; top: GLdouble; zNear: GLdouble; zFar: GLdouble');
    DefineMethod('glPassThrough',1,tkNone,nil,__glPassThrough,false,0,'token: GLfloat');
    DefineMethod('glPixelStoref',2,tkNone,nil,__glPixelStoref,false,0,'pname: GLenum; param: GLfloat');
    DefineMethod('glPixelStorei',2,tkNone,nil,__glPixelStorei,false,0,'pname: GLenum; param: GLint');
    DefineMethod('glPixelStore',2,tkNone,nil,__glPixelStore,false,0,'pname: GLenum; param: GLfloat');
    DefineMethod('glPixelTransferf',2,tkNone,nil,__glPixelTransferf,false,0,'pname: GLenum; param: GLfloat');
    DefineMethod('glPixelTransferi',2,tkNone,nil,__glPixelTransferi,false,0,'pname: GLenum; param: GLint');
    DefineMethod('glPixelTransfer',2,tkNone,nil,__glPixelTransfer,false,0,'pname: GLenum; param: GLfloat');
    DefineMethod('glPixelZoom',2,tkNone,nil,__glPixelZoom,false,0,'xfactor: GLfloat; yfactor: GLfloat');
    DefineMethod('glPointSize',1,tkNone,nil,__glPointSize,false,0,'size: GLfloat');
    DefineMethod('glPolygonMode',2,tkNone,nil,__glPolygonMode,false,0,'face: GLenum; mode: GLenum');
    ...
    DefineMethod('glPushAttrib',1,tkNone,nil,__glPushAttrib,false,0,'mask: GLbitfield');
    DefineMethod('glPushMatrix',0,tkNone,nil,__glPushMatrix,false,0,'');
    DefineMethod('glPushName',1,tkNone,nil,__glPushName,false,0,'name: GLuint');
    DefineMethod('glRasterPos2d',2,tkNone,nil,__glRasterPos2d,false,0,'x: GLdouble; y: GLdouble');
    DefineMethod('glRasterPos2f',2,tkNone,nil,__glRasterPos2f,false,0,'x: GLfloat; y: GLfloat');
    DefineMethod('glRasterPos2i',2,tkNone,nil,__glRasterPos2i,false,0,'x: GLint; y: GLint');
    DefineMethod('glRasterPos2s',2,tkNone,nil,__glRasterPos2s,false,0,'x: GLshort; y: GLshort');
    DefineMethod('glRasterPos3d',3,tkNone,nil,__glRasterPos3d,false,0,'x: GLdouble; y: GLdouble; z: GLdouble');
    DefineMethod('glRasterPos3f',3,tkNone,nil,__glRasterPos3f,false,0,'x: GLfloat; y: GLfloat; z: GLfloat');
    DefineMethod('glRasterPos3i',3,tkNone,nil,__glRasterPos3i,false,0,'x: GLint; y: GLint; z: GLint');
    DefineMethod('glRasterPos3s',3,tkNone,nil,__glRasterPos3s,false,0,'x: GLshort; y: GLshort; z: GLshort');
    DefineMethod('glRasterPos4d',4,tkNone,nil,__glRasterPos4d,false,0,'x: GLdouble; y: GLdouble; z: GLdouble; w: GLdouble');
    DefineMethod('glRasterPos4f',4,tkNone,nil,__glRasterPos4f,false,0,'x: GLfloat; y: GLfloat; z: GLfloat; w: GLfloat');
    DefineMethod('glRasterPos4i',4,tkNone,nil,__glRasterPos4i,false,0,'x: GLint; y: GLint; z: GLint; w: GLint');
    DefineMethod('glRasterPos4s',4,tkNone,nil,__glRasterPos4s,false,0,'x: GLshort; y: GLshort; z: GLshort; w: GLshort');
    DefineMethod('glRasterPos',2,tkNone,nil,__glRasterPos,false,0,'x: GLdouble; y: GLdouble');
    DefineMethod('glReadBuffer',1,tkNone,nil,__glReadBuffer,false,0,'mode: GLenum');
    DefineMethod('glRectd',4,tkNone,nil,__glRectd,false,0,'x1: GLdouble; y1: GLdouble; x2: GLdouble; y2: GLdouble');
    DefineMethod('glRectf',4,tkNone,nil,__glRectf,false,0,'x1: GLfloat; y1: GLfloat; x2: GLfloat; y2: GLfloat');
    DefineMethod('glRecti',4,tkNone,nil,__glRecti,false,0,'x1: GLint; y1: GLint; x2: GLint; y2: GLint');
    DefineMethod('glRects',4,tkNone,nil,__glRects,false,0,'x1: GLshort; y1: GLshort; x2: GLshort; y2: GLshort');
    DefineMethod('glRect',4,tkNone,nil,__glRect,false,0,'x1: GLdouble; y1: GLdouble; x2: GLdouble; y2: GLdouble');
    DefineMethod('glRenderMode',1,tkInteger,nil,__glRenderMode,false,0,'mode: GLenum');
    DefineMethod('glRotated',4,tkNone,nil,__glRotated,false,0,'angle: GLdouble; x: GLdouble; y: GLdouble; z: GLdouble');
    DefineMethod('glRotatef',4,tkNone,nil,__glRotatef,false,0,'angle: GLfloat; x: GLfloat; y: GLfloat; z: GLfloat');
    DefineMethod('glRotate',4,tkNone,nil,__glRotate,false,0,'angle: GLdouble; x: GLdouble; y: GLdouble; z: GLdouble');
    DefineMethod('glScaled',3,tkNone,nil,__glScaled,false,0,'x: GLdouble; y: GLdouble; z: GLdouble');
    DefineMethod('glScalef',3,tkNone,nil,__glScalef,false,0,'x: GLfloat; y: GLfloat; z: GLfloat');
    DefineMethod('glScale',3,tkNone,nil,__glScale,false,0,'x: GLdouble; y: GLdouble; z: GLdouble');
    DefineMethod('glScissor',4,tkNone,nil,__glScissor,false,0,'x: GLint; y: GLint; width: GLsizei; height: GLsizei');
    DefineMethod('glShadeModel',1,tkNone,nil,__glShadeModel,false,0,'mode: GLenum');
    DefineMethod('glStencilFunc',3,tkNone,nil,__glStencilFunc,false,0,'func: GLenum; ref: GLint; mask: GLuint');
    DefineMethod('glStencilMask',1,tkNone,nil,__glStencilMask,false,0,'mask: GLuint');
    DefineMethod('glStencilOp',3,tkNone,nil,__glStencilOp,false,0,'fail: GLenum; zfail: GLenum; zpass: GLenum');
    DefineMethod('glTexCoord1d',1,tkNone,nil,__glTexCoord1d,false,0,'s: GLdouble');
    DefineMethod('glTexCoord1f',1,tkNone,nil,__glTexCoord1f,false,0,'s: GLfloat');
    DefineMethod('glTexCoord1i',1,tkNone,nil,__glTexCoord1i,false,0,'s: GLint');
    DefineMethod('glTexCoord1s',1,tkNone,nil,__glTexCoord1s,false,0,'s: GLshort');
    DefineMethod('glTexCoord2d',2,tkNone,nil,__glTexCoord2d,false,0,'s: GLdouble; t: GLdouble');
    DefineMethod('glTexCoord2f',2,tkNone,nil,__glTexCoord2f,false,0,'s: GLfloat; t: GLfloat');
    DefineMethod('glTexCoord2i',2,tkNone,nil,__glTexCoord2i,false,0,'s: GLint; t: GLint');
    DefineMethod('glTexCoord2s',2,tkNone,nil,__glTexCoord2s,false,0,'s: GLshort; t: GLshort');
    DefineMethod('glTexCoord3d',3,tkNone,nil,__glTexCoord3d,false,0,'s: GLdouble; t: GLdouble; r: GLdouble');
    DefineMethod('glTexCoord3f',3,tkNone,nil,__glTexCoord3f,false,0,'s: GLfloat; t: GLfloat; r: GLfloat');
    DefineMethod('glTexCoord3i',3,tkNone,nil,__glTexCoord3i,false,0,'s: GLint; t: GLint; r: GLint');
    DefineMethod('glTexCoord3s',3,tkNone,nil,__glTexCoord3s,false,0,'s: GLshort; t: GLshort; r: GLshort');
    DefineMethod('glTexCoord4d',4,tkNone,nil,__glTexCoord4d,false,0,'s: GLdouble; t: GLdouble; r: GLdouble; q: GLdouble');
    DefineMethod('glTexCoord4f',4,tkNone,nil,__glTexCoord4f,false,0,'s: GLfloat; t: GLfloat; r: GLfloat; q: GLfloat');
    DefineMethod('glTexCoord4i',4,tkNone,nil,__glTexCoord4i,false,0,'s: GLint; t: GLint; r: GLint; q: GLint');
    DefineMethod('glTexCoord4s',4,tkNone,nil,__glTexCoord4s,false,0,'s: GLshort; t: GLshort; r: GLshort; q: GLshort');
    DefineMethod('glTexCoord',1,tkNone,nil,__glTexCoord,false,0,'s: GLdouble');
    DefineMethod('glTexEnvf',3,tkNone,nil,__glTexEnvf,false,0,'target: GLenum; pname: GLenum; param: GLfloat');
    DefineMethod('glTexEnvi',3,tkNone,nil,__glTexEnvi,false,0,'target: GLenum; pname: GLenum; param: GLint');
    DefineMethod('glTexEnv',3,tkNone,nil,__glTexEnv,false,0,'target: GLenum; pname: GLenum; param: GLfloat');
    DefineMethod('glTexGend',3,tkNone,nil,__glTexGend,false,0,'coord: GLenum; pname: GLenum; param: GLdouble');
    DefineMethod('glTexGenf',3,tkNone,nil,__glTexGenf,false,0,'coord: GLenum; pname: GLenum; param: GLfloat');
    DefineMethod('glTexGeni',3,tkNone,nil,__glTexGeni,false,0,'coord: GLenum; pname: GLenum; param: GLint');
    DefineMethod('glTexGen',3,tkNone,nil,__glTexGen,false,0,'coord: GLenum; pname: GLenum; param: GLdouble');
    DefineMethod('glTexParameterf',3,tkNone,nil,__glTexParameterf,false,0,'target: GLenum; pname: GLenum; param: GLfloat');
    DefineMethod('glTexParameteri',3,tkNone,nil,__glTexParameteri,false,0,'target: GLenum; pname: GLenum; param: GLint');
    DefineMethod('glTexParameter',3,tkNone,nil,__glTexParameter,false,0,'target: GLenum; pname: GLenum; param: GLfloat');
    DefineMethod('glTranslated',3,tkNone,nil,__glTranslated,false,0,'x: GLdouble; y: GLdouble; z: GLdouble');
    DefineMethod('glTranslatef',3,tkNone,nil,__glTranslatef,false,0,'x: GLfloat; y: GLfloat; z: GLfloat');
    DefineMethod('glTranslate',3,tkNone,nil,__glTranslate,false,0,'x: GLdouble; y: GLdouble; z: GLdouble');
    DefineMethod('glVertex2d',2,tkNone,nil,__glVertex2d,false,0,'x: GLdouble; y: GLdouble');
    DefineMethod('glVertex2f',2,tkNone,nil,__glVertex2f,false,0,'x: GLfloat; y: GLfloat');
    DefineMethod('glVertex2i',2,tkNone,nil,__glVertex2i,false,0,'x: GLint; y: GLint');
    DefineMethod('glVertex2s',2,tkNone,nil,__glVertex2s,false,0,'x: GLshort; y: GLshort');
    DefineMethod('glVertex3d',3,tkNone,nil,__glVertex3d,false,0,'x: GLdouble; y: GLdouble; z: GLdouble');
    DefineMethod('glVertex3f',3,tkNone,nil,__glVertex3f,false,0,'x: GLfloat; y: GLfloat; z: GLfloat');
    DefineMethod('glVertex3i',3,tkNone,nil,__glVertex3i,false,0,'x: GLint; y: GLint; z: GLint');
    DefineMethod('glVertex3s',3,tkNone,nil,__glVertex3s,false,0,'x: GLshort; y: GLshort; z: GLshort');
    DefineMethod('glVertex4d',4,tkNone,nil,__glVertex4d,false,0,'x: GLdouble; y: GLdouble; z: GLdouble; w: GLdouble');
    DefineMethod('glVertex4f',4,tkNone,nil,__glVertex4f,false,0,'x: GLfloat; y: GLfloat; z: GLfloat; w: GLfloat');
    DefineMethod('glVertex4i',4,tkNone,nil,__glVertex4i,false,0,'x: GLint; y: GLint; z: GLint; w: GLint');
    DefineMethod('glVertex4s',4,tkNone,nil,__glVertex4s,false,0,'x: GLshort; y: GLshort; z: GLshort; w: GLshort');
    DefineMethod('glVertex',2,tkNone,nil,__glVertex,false,0,'x: GLdouble; y: GLdouble');
    DefineMethod('glViewport',4,tkNone,nil,__glViewport,false,0,'x: GLint; y: GLint; width: GLsizei; height: GLsizei');
    DefineMethod('gluErrorString',1,tkVariant,nil,__gluErrorString,false,0,'errCode: GLenum');
    DefineMethod('gluErrorUnicodeStringEXT',1,tkVariant,nil,__gluErrorUnicodeStringEXT,false,0,'errCode: GLenum');
    DefineMethod('gluGetString',1,tkVariant,nil,__gluGetString,false,0,'name: GLenum');
    DefineMethod('gluLookAt',9,tkNone,nil,__gluLookAt,false,0,'eyex: GLdouble; eyey: GLdouble; eyez: GLdouble; centerx: GLdouble; centery: GLdouble; centerz: GLdouble; upx: GLdouble; upy: GLdouble; upz: GLdouble');
    DefineMethod('gluOrtho2D',4,tkNone,nil,__gluOrtho2D,false,0,'left: GLdouble; right: GLdouble; bottom: GLdouble; top: GLdouble');
    DefineMethod('gluPerspective',4,tkNone,nil,__gluPerspective,false,0,'fovy: GLdouble; aspect: GLdouble; zNear: GLdouble; zFar: GLdouble');
  AddConsts1;
  AddConsts2;
  end;
end;
