...
type
  TatTlHelp32Library = class(TatScripterLibrary)
    ...
    procedure __Process32FirstA(AMachine: TatVirtualMachine);
    procedure __Process32NextA(AMachine: TatVirtualMachine);
    ...
    procedure __Module32FirstA(AMachine: TatVirtualMachine);
    procedure __Module32NextA(AMachine: TatVirtualMachine);
  ...
  tagPROCESSENTRY32AWrapper = class(TatRecordWrapper)
  private
    FdwSize: DWORD;
    FcntUsage: DWORD;
    Fth32ProcessID: DWORD;
    ...
    FdwFlags: DWORD;
  public
    constructor Create(ARecord: tagPROCESSENTRY32A);
    function ObjToRec: tagPROCESSENTRY32A;
  published
    property dwSize: DWORD read FdwSize write FdwSize;
  ...
  tagMODULEENTRY32AWrapper = class(TatRecordWrapper)
  private
    FdwSize: DWORD;
    Fth32ModuleID: DWORD;
    Fth32ProcessID: DWORD;
    ...
    FhModule: HMODULE;
  public
    constructor Create(ARecord: tagMODULEENTRY32A);
    function ObjToRec: tagMODULEENTRY32A;
  published
    property dwSize: DWORD read FdwSize write FdwSize;
    property th32ModuleID: DWORD read Fth32ModuleID write Fth32ModuleID;
    property th32ProcessID: DWORD read Fth32ProcessID write Fth32ProcessID;
...
constructor tagPROCESSENTRY32AWrapper.Create(ARecord: tagPROCESSENTRY32A);
begin
  inherited Create;
  FdwSize := ARecord.dwSize;
...
function tagPROCESSENTRY32AWrapper.ObjToRec: tagPROCESSENTRY32A;
begin
  result.dwSize := FdwSize;
...
constructor tagMODULEENTRY32AWrapper.Create(ARecord: tagMODULEENTRY32A);
begin
  inherited Create;
  FdwSize := ARecord.dwSize;
  Fth32ModuleID := ARecord.th32ModuleID;
...
function tagMODULEENTRY32AWrapper.ObjToRec: tagMODULEENTRY32A;
begin
  result.dwSize := FdwSize;
  result.th32ModuleID := Fth32ModuleID;
  result.th32ProcessID := Fth32ProcessID;
...
procedure TatTlHelp32Library.__Process32FirstA(AMachine: TatVirtualMachine);
  var
  Param1Rec: TObject;
  Param1: TProcessEntry32A;
  AResult: variant;
begin
  with AMachine do
  begin
Param1Rec := TObject(integer(GetInputArg(1)));
if not Assigned(Param1Rec) or not (Param1Rec is tagPROCESSENTRY32AWrapper) then 
  Param1Rec := tagPROCESSENTRY32AWrapper.Create(Param1);
Param1 := tagPROCESSENTRY32AWrapper(Param1Rec).ObjToRec;
AResult := TlHelp32.Process32FirstA(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(tagPROCESSENTRY32AWrapper.Create(Param1)));
  end;
end;

procedure TatTlHelp32Library.__Process32NextA(AMachine: TatVirtualMachine);
  var
  Param1Rec: TObject;
  Param1: TProcessEntry32A;
  AResult: variant;
...
if not Assigned(Param1Rec) or not (Param1Rec is tagPROCESSENTRY32AWrapper) then 
  Param1Rec := tagPROCESSENTRY32AWrapper.Create(Param1);
Param1 := tagPROCESSENTRY32AWrapper(Param1Rec).ObjToRec;
AResult := TlHelp32.Process32NextA(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(tagPROCESSENTRY32AWrapper.Create(Param1)));
  end;
end;
...
procedure TatTlHelp32Library.__Module32FirstA(AMachine: TatVirtualMachine);
  var
  Param1Rec: TObject;
  Param1: TModuleEntry32A;
  AResult: variant;
begin
  with AMachine do
  begin
Param1Rec := TObject(integer(GetInputArg(1)));
if not Assigned(Param1Rec) or not (Param1Rec is tagMODULEENTRY32AWrapper) then 
  Param1Rec := tagMODULEENTRY32AWrapper.Create(Param1);
Param1 := tagMODULEENTRY32AWrapper(Param1Rec).ObjToRec;
AResult := TlHelp32.Module32FirstA(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(tagMODULEENTRY32AWrapper.Create(Param1)));
  end;
end;

procedure TatTlHelp32Library.__Module32NextA(AMachine: TatVirtualMachine);
  var
  Param1Rec: TObject;
  Param1: TModuleEntry32A;
  AResult: variant;
...
if not Assigned(Param1Rec) or not (Param1Rec is tagMODULEENTRY32AWrapper) then 
  Param1Rec := tagMODULEENTRY32AWrapper.Create(Param1);
Param1 := tagMODULEENTRY32AWrapper(Param1Rec).ObjToRec;
AResult := TlHelp32.Module32NextA(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(tagMODULEENTRY32AWrapper.Create(Param1)));
  end;
end;
...
begin
  ...
  begin
    DefineMethod('CreateToolhelp32Snapshot',2,tkInteger,nil,__CreateToolhelp32Snapshot,false,0,'dwFlags: DWORD; th32ProcessID: DWORD');
    DefineMethod('Heap32ListFirst',2,tkVariant,nil,__Heap32ListFirst,false,0,'hSnapshot: THandle; lphl: THeapList32').SetVarArgs([1]);
    DefineMethod('Heap32ListNext',2,tkVariant,nil,__Heap32ListNext,false,0,'hSnapshot: THandle; lphl: THeapList32').SetVarArgs([1]);
    DefineMethod('Heap32First',3,tkVariant,nil,__Heap32First,false,0,'lphe: THeapEntry32; th32ProcessID: DWORD; th32HeapID: DWORD').SetVarArgs([0]);
    DefineMethod('Heap32Next',1,tkVariant,nil,__Heap32Next,false,0,'lphe: THeapEntry32').SetVarArgs([0]);
    DefineMethod('Process32FirstA',2,tkVariant,nil,__Process32FirstA,false,0,'hSnapshot: THandle; lppe: TProcessEntry32A').SetVarArgs([1]);
    DefineMethod('Process32NextA',2,tkVariant,nil,__Process32NextA,false,0,'hSnapshot: THandle; lppe: TProcessEntry32A').SetVarArgs([1]);
    DefineMethod('Process32FirstW',2,tkVariant,nil,__Process32FirstW,false,0,'hSnapshot: THandle; lppe: TProcessEntry32W').SetVarArgs([1]);
    DefineMethod('Process32NextW',2,tkVariant,nil,__Process32NextW,false,0,'hSnapshot: THandle; lppe: TProcessEntry32W').SetVarArgs([1]);
    DefineMethod('Process32First',2,tkVariant,nil,__Process32First,false,0,'hSnapshot: THandle; lppe: TProcessEntry32').SetVarArgs([1]);
    DefineMethod('Process32Next',2,tkVariant,nil,__Process32Next,false,0,'hSnapshot: THandle; lppe: TProcessEntry32').SetVarArgs([1]);
    DefineMethod('Thread32First',2,tkVariant,nil,__Thread32First,false,0,'hSnapshot: THandle; lpte: TThreadEntry32').SetVarArgs([1]);
    DefineMethod('Thread32Next',2,tkVariant,nil,__Thread32Next,false,0,'hSnapshot: THandle; lpte: TThreadENtry32').SetVarArgs([1]);
    DefineMethod('Module32FirstA',2,tkVariant,nil,__Module32FirstA,false,0,'hSnapshot: THandle; lpme: TModuleEntry32A').SetVarArgs([1]);
    DefineMethod('Module32NextA',2,tkVariant,nil,__Module32NextA,false,0,'hSnapshot: THandle; lpme: TModuleEntry32A').SetVarArgs([1]);
    DefineMethod('Module32FirstW',2,tkVariant,nil,__Module32FirstW,false,0,'hSnapshot: THandle; lpme: TModuleEntry32W').SetVarArgs([1]);
    DefineMethod('Module32NextW',2,tkVariant,nil,__Module32NextW,false,0,'hSnapshot: THandle; lpme: TModuleEntry32W').SetVarArgs([1]);
    DefineMethod('Module32First',2,tkVariant,nil,__Module32First,false,0,'hSnapshot: THandle; lpme: TModuleEntry32').SetVarArgs([1]);
    DefineMethod('Module32Next',2,tkVariant,nil,__Module32Next,false,0,'hSnapshot: THandle; lpme: TModuleEntry32').SetVarArgs([1]);
