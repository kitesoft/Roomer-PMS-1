...
type
  TatControlsLibrary = class(TatScripterLibrary)
    ...
    procedure __GetTDragDockObjectEraseDockRect(AMachine: TatVirtualMachine);
    procedure __SetTDragDockObjectEraseDockRect(AMachine: TatVirtualMachine);
    procedure __GetTDragDockObjectEraseWhenMoving(AMachine: TatVirtualMachine);
    ...
    procedure __TMarginsCreate(AMachine: TatVirtualMachine);
    procedure __TMarginsSetControlBounds(AMachine: TatVirtualMachine);
    procedure __TMarginsSetBounds(AMachine: TatVirtualMachine);
    procedure __GetTMarginsControlLeft(AMachine: TatVirtualMachine);
    procedure __GetTMarginsControlTop(AMachine: TatVirtualMachine);
    procedure __GetTMarginsControlWidth(AMachine: TatVirtualMachine);
    procedure __GetTMarginsControlHeight(AMachine: TatVirtualMachine);
    procedure __GetTMarginsExplicitLeft(AMachine: TatVirtualMachine);
    procedure __GetTMarginsExplicitTop(AMachine: TatVirtualMachine);
    procedure __GetTMarginsExplicitWidth(AMachine: TatVirtualMachine);
    procedure __GetTMarginsExplicitHeight(AMachine: TatVirtualMachine);
    procedure __GetTCustomGestureCollectionItemDeviation(AMachine: TatVirtualMachine);
    procedure __SetTCustomGestureCollectionItemDeviation(AMachine: TatVirtualMachine);
    procedure __GetTCustomGestureCollectionItemErrorMargin(AMachine: TatVirtualMachine);
    procedure __SetTCustomGestureCollectionItemErrorMargin(AMachine: TatVirtualMachine);
    procedure __GetTCustomGestureCollectionItemGestureID(AMachine: TatVirtualMachine);
    procedure __SetTCustomGestureCollectionItemGestureID(AMachine: TatVirtualMachine);
    procedure __GetTCustomGestureCollectionItemGestureType(AMachine: TatVirtualMachine);
    procedure __GetTCustomGestureCollectionItemOptions(AMachine: TatVirtualMachine);
    procedure __SetTCustomGestureCollectionItemOptions(AMachine: TatVirtualMachine);
    procedure __GetTCustomGestureCollectionItemName(AMachine: TatVirtualMachine);
    procedure __SetTCustomGestureCollectionItemName(AMachine: TatVirtualMachine);
    procedure __GetTCustomGestureCollectionItemAction(AMachine: TatVirtualMachine);
    procedure __SetTCustomGestureCollectionItemAction(AMachine: TatVirtualMachine);
    procedure __TCustomGestureCollectionAddGesture(AMachine: TatVirtualMachine);
    procedure __TCustomGestureCollectionFindGesture(AMachine: TatVirtualMachine);
    procedure __TCustomGestureCollectionGetUniqueGestureID(AMachine: TatVirtualMachine);
    procedure __TCustomGestureCollectionRemoveGesture(AMachine: TatVirtualMachine);
    procedure __GetTCustomGestureCollectionGestureManager(AMachine: TatVirtualMachine);
    procedure __GetTCustomGestureCollectionItems(AMachine: TatVirtualMachine);
    procedure __SetTCustomGestureCollectionItems(AMachine: TatVirtualMachine);
    procedure __TCustomGestureManagerAddRecordedGesture(AMachine: TatVirtualMachine);
    procedure __TCustomGestureManagerFindCustomGesture(AMachine: TatVirtualMachine);
    procedure __TCustomGestureManagerFindGesture(AMachine: TatVirtualMachine);
    procedure __TCustomGestureManagerRegisterControl(AMachine: TatVirtualMachine);
    procedure __TCustomGestureManagerRemoveRecordedGesture(AMachine: TatVirtualMachine);
    procedure __TCustomGestureManagerSelectGesture(AMachine: TatVirtualMachine);
    procedure __TCustomGestureManagerUnregisterControl(AMachine: TatVirtualMachine);
    procedure __TCustomGestureManagerUnselectGesture(AMachine: TatVirtualMachine);
    procedure __GetTCustomGestureManagerStandardGestures(AMachine: TatVirtualMachine);
    procedure __SetTCustomGestureManagerStandardGestures(AMachine: TatVirtualMachine);
    procedure __TCustomGestureEngineCreate(AMachine: TatVirtualMachine);
    procedure __TCustomGestureEngineNotification(AMachine: TatVirtualMachine);
    procedure __TCustomGestureEngineSupported(AMachine: TatVirtualMachine);
    procedure __GetTCustomGestureEngineActive(AMachine: TatVirtualMachine);
    procedure __SetTCustomGestureEngineActive(AMachine: TatVirtualMachine);
    procedure __TCustomTouchManagerCreate(AMachine: TatVirtualMachine);
    procedure __TCustomTouchManagerDestroy(AMachine: TatVirtualMachine);
    procedure __TCustomTouchManagerChangeNotification(AMachine: TatVirtualMachine);
    procedure __TCustomTouchManagerFindGesture(AMachine: TatVirtualMachine);
    procedure __TCustomTouchManagerRemoveChangeNotification(AMachine: TatVirtualMachine);
    procedure __TCustomTouchManagerSelectGesture(AMachine: TatVirtualMachine);
    procedure __TCustomTouchManagerUnselectGesture(AMachine: TatVirtualMachine);
    procedure __GetTCustomTouchManagerGestureEngine(AMachine: TatVirtualMachine);
    procedure __SetTCustomTouchManagerGestureEngine(AMachine: TatVirtualMachine);
    procedure __GetTCustomTouchManagerGestureManager(AMachine: TatVirtualMachine);
    procedure __SetTCustomTouchManagerGestureManager(AMachine: TatVirtualMachine);
    procedure __GetTCustomTouchManagerInteractiveGestures(AMachine: TatVirtualMachine);
    procedure __SetTCustomTouchManagerInteractiveGestures(AMachine: TatVirtualMachine);
    procedure __GetTCustomTouchManagerInteractiveGestureOptions(AMachine: TatVirtualMachine);
    procedure __SetTCustomTouchManagerInteractiveGestureOptions(AMachine: TatVirtualMachine);
    procedure __GetTCustomTouchManagerParentTabletOptions(AMachine: TatVirtualMachine);
    procedure __SetTCustomTouchManagerParentTabletOptions(AMachine: TatVirtualMachine);
    procedure __GetTCustomTouchManagerStandardGestures(AMachine: TatVirtualMachine);
    procedure __SetTCustomTouchManagerStandardGestures(AMachine: TatVirtualMachine);
    procedure __GetTCustomTouchManagerTabletOptions(AMachine: TatVirtualMachine);
    procedure __SetTCustomTouchManagerTabletOptions(AMachine: TatVirtualMachine);
    ...
    procedure __TControlSetDesignVisible(AMachine: TatVirtualMachine);
    procedure __TControlSetParentComponent(AMachine: TatVirtualMachine);
    ...
    procedure __GetTControlExplicitLeft(AMachine: TatVirtualMachine);
    procedure __GetTControlExplicitTop(AMachine: TatVirtualMachine);
    procedure __GetTControlExplicitWidth(AMachine: TatVirtualMachine);
    procedure __GetTControlExplicitHeight(AMachine: TatVirtualMachine);
    ...
    procedure __GetTControlTouch(AMachine: TatVirtualMachine);
    procedure __SetTControlTouch(AMachine: TatVirtualMachine);
    ...
    procedure __TWinControlGetTextLen(AMachine: TatVirtualMachine);
    ...
    procedure __TWinControlGetTabControlList(AMachine: TatVirtualMachine);
    ...
    procedure __TWinControlSetDesignVisible(AMachine: TatVirtualMachine);
    ...
    procedure __GetTWinControlMouseInClient(AMachine: TatVirtualMachine);
    ...
    procedure __GetTWinControlPadding(AMachine: TatVirtualMachine);
    procedure __SetTWinControlPadding(AMachine: TatVirtualMachine);
    procedure __GetTWinControlParentDoubleBuffered(AMachine: TatVirtualMachine);
    procedure __SetTWinControlParentDoubleBuffered(AMachine: TatVirtualMachine);
    ...
    procedure __TCustomTransparentControlCreate(AMachine: TatVirtualMachine);
    procedure __TCustomTransparentControlInvalidate(AMachine: TatVirtualMachine);
    procedure __GetTCustomTransparentControlInterceptMouse(AMachine: TatVirtualMachine);
    procedure __SetTCustomTransparentControlInterceptMouse(AMachine: TatVirtualMachine);
    ...
    procedure __TCustomPanningWindowGetIsPanning(AMachine: TatVirtualMachine);
    procedure __TCustomPanningWindowStartPanning(AMachine: TatVirtualMachine);
    procedure __TCustomPanningWindowStopPanning(AMachine: TatVirtualMachine);
    ...
    procedure __TMouseCreatePanningWindow(AMachine: TatVirtualMachine);
    ...
    procedure __GetTMouseIsPanning(AMachine: TatVirtualMachine);
    procedure __GetTMousePanningWindow(AMachine: TatVirtualMachine);
    procedure __SetTMousePanningWindow(AMachine: TatVirtualMachine);
    ...
    procedure __TCustomListControlCreate(AMachine: TatVirtualMachine);
    ...
    procedure __TCustomListControlGetCount(AMachine: TatVirtualMachine);
    ...
    procedure __TCustomHintWindowCreate(AMachine: TatVirtualMachine);
    procedure __TCustomHintWindowAutoSize(AMachine: TatVirtualMachine);
    procedure __TCustomHintWindowPositionAt(AMachine: TatVirtualMachine);
    procedure __TCustomHintWindowPositionAtCursor(AMachine: TatVirtualMachine);
    procedure __GetTCustomHintWindowHintParent(AMachine: TatVirtualMachine);
    procedure __SetTCustomHintWindowHintParent(AMachine: TatVirtualMachine);
    procedure __GetTCustomHintWindowPopAbove(AMachine: TatVirtualMachine);
    procedure __GetTCustomHintWindowTitle(AMachine: TatVirtualMachine);
    procedure __GetTCustomHintWindowDescription(AMachine: TatVirtualMachine);
    procedure __GetTCustomHintWindowImageIndex(AMachine: TatVirtualMachine);
    procedure __TCustomHintShowHideThreadCreate(AMachine: TatVirtualMachine);
    procedure __TCustomHintShowHideThreadDestroy(AMachine: TatVirtualMachine);
    procedure __TCustomHintShowHideThreadResumeWork(AMachine: TatVirtualMachine);
    procedure __TCustomHintShowHideThreadExecute(AMachine: TatVirtualMachine);
    procedure __TCustomHintShowHideThreadHideHint(AMachine: TatVirtualMachine);
    procedure __TCustomHintCreate(AMachine: TatVirtualMachine);
    procedure __TCustomHintDestroy(AMachine: TatVirtualMachine);
    procedure __TCustomHintShowHint(AMachine: TatVirtualMachine);
    procedure __TCustomHintHideHint(AMachine: TatVirtualMachine);
    procedure __TCustomHintPaintHint(AMachine: TatVirtualMachine);
    procedure __TCustomHintNCPaintHint(AMachine: TatVirtualMachine);
    procedure __TCustomHintSetHintSize(AMachine: TatVirtualMachine);
    procedure __GetTCustomHintShowingHint(AMachine: TatVirtualMachine);
    procedure __GetTCustomHintTitle(AMachine: TatVirtualMachine);
    procedure __SetTCustomHintTitle(AMachine: TatVirtualMachine);
    procedure __GetTCustomHintDescription(AMachine: TatVirtualMachine);
    procedure __SetTCustomHintDescription(AMachine: TatVirtualMachine);
    procedure __GetTCustomHintImageIndex(AMachine: TatVirtualMachine);
    procedure __SetTCustomHintImageIndex(AMachine: TatVirtualMachine);
    procedure __TBalloonHintPaintHint(AMachine: TatVirtualMachine);
    procedure __TBalloonHintSetHintSize(AMachine: TatVirtualMachine);
    ...
    procedure __IsVCLControl(AMachine: TatVirtualMachine);
    ...
    procedure __PerformBufferedPrintClient(AMachine: TatVirtualMachine);
    procedure __MouseOriginToShiftState(AMachine: TatVirtualMachine);
    ...
    procedure __Imm32SetCompositionFont(AMachine: TatVirtualMachine);
  ...
  EGestureExceptionClass = class of EGestureException;
  TCustomGestureCollectionItemClass = class of TCustomGestureCollectionItem;
  TCustomGestureCollectionClass = class of TCustomGestureCollection;
  TCustomGestureManagerClass = class of TCustomGestureManager;
  TCustomGestureEngineClass = class of TCustomGestureEngine;
  TCustomTouchManagerClass = class of TCustomTouchManager;
  TTouchManagerClass = class of TTouchManager;
  ...
  TCustomTransparentControlClass = class of TCustomTransparentControl;
  ...
  TCustomPanningWindowClass = class of TCustomPanningWindow;
  ...
  TCustomHintWindowClass = class of TCustomHintWindow;
  TCustomHintShowHideThreadClass = class of TCustomHintShowHideThread;
  TCustomHintClass = class of TCustomHint;
  TBalloonHintClass = class of TBalloonHint;
  ...
  TControlListItemWrapper = class(TatRecordWrapper)
  private
    FControl: TControl;
    FParent: TWinControl;
  public
    constructor Create(ARecord: TControlListItem);
    function ObjToRec: TControlListItem;
  published
    property Control: TControl read FControl write FControl;
    property Parent: TWinControl read FParent write FParent;
  end;
  
  TCMControlListChangingWrapper = class(TatRecordWrapper)
  private
    FMsg: Cardinal;
    FInserting: LongBool;
    FResult: Longint;
  public
    constructor Create(ARecord: TCMControlListChanging);
    function ObjToRec: TCMControlListChanging;
  published
    property Msg: Cardinal read FMsg write FMsg;
    property Inserting: LongBool read FInserting write FInserting;
    property Result: Longint read FResult write FResult;
  ...
  THintInfoWrapper = class(TatRecordWrapper)
  private
    ...
    FHintStr: string;
  public
    constructor Create(ARecord: THintInfo);
    function ObjToRec: THintInfo;
  published
    property HintControl: TControl read FHintControl write FHintControl;
    property HintMaxWidth: Integer read FHintMaxWidth write FHintMaxWidth;
    ...
    property HintStr: string read FHintStr write FHintStr;
  end;
  
  TCMParentFontChangedWrapper = class(TatRecordWrapper)
  private
    FMsg: Cardinal;
    FWParam: WPARAM;
    FLParam: LPARAM;
    ...
    FResult: LRESULT;
  public
    constructor Create(ARecord: TCMParentFontChanged);
    function ObjToRec: TCMParentFontChanged;
  published
    property Msg: Cardinal read FMsg write FMsg;
  ...
  published
    ...
    property MsgWParam: WPARAM read FMsgWParam write FMsgWParam;
    property MsgLParam: LPARAM read FMsgLParam write FMsgLParam;
  end;
  ...
  TGestureEventInfoWrapper = class(TatRecordWrapper)
  private
    FGestureID: TGestureID;
    FFlags: TInteractiveGestureFlags;
    FAngle: Double;
    FDistance: Integer;
  public
    constructor Create(ARecord: TGestureEventInfo);
    function ObjToRec: TGestureEventInfo;
  published
    property GestureID: TGestureID read FGestureID write FGestureID;
    property Flags: TInteractiveGestureFlags read FFlags write FFlags;
    property Angle: Double read FAngle write FAngle;
    property Distance: Integer read FDistance write FDistance;
  end;
  
  TCMGestureWrapper = class(TatRecordWrapper)
  private
    FMsg: Cardinal;
    FReserved: Integer;
    FResult: Longint;
  public
    constructor Create(ARecord: TCMGesture);
    function ObjToRec: TCMGesture;
  published
    property Msg: Cardinal read FMsg write FMsg;
...
constructor TControlListItemWrapper.Create(ARecord: TControlListItem);
begin
  inherited Create;
  FControl := ARecord.Control;
  FParent := ARecord.Parent;
end;

function TControlListItemWrapper.ObjToRec: TControlListItem;
begin
  result.Control := FControl;
  result.Parent := FParent;
end;

constructor TCMControlListChangingWrapper.Create(ARecord: TCMControlListChanging);
begin
  inherited Create;
  FMsg := ARecord.Msg;
  FInserting := ARecord.Inserting;
...
function TCMControlListChangingWrapper.ObjToRec: TCMControlListChanging;
begin
  result.Msg := FMsg;
  result.Inserting := FInserting;
  result.Result := FResult;
...
constructor THintInfoWrapper.Create(ARecord: THintInfo);
begin
  inherited Create;
  FHintControl := ARecord.HintControl;
  FHintMaxWidth := ARecord.HintMaxWidth;
  FHintColor := ARecord.HintColor;
  FReshowTimeout := ARecord.ReshowTimeout;
  FHideTimeout := ARecord.HideTimeout;
  FHintStr := ARecord.HintStr;
end;

function THintInfoWrapper.ObjToRec: THintInfo;
begin
  result.HintControl := FHintControl;
  result.HintMaxWidth := FHintMaxWidth;
  result.HintColor := FHintColor;
  result.ReshowTimeout := FReshowTimeout;
  result.HideTimeout := FHideTimeout;
  result.HintStr := FHintStr;
end;

constructor TCMParentFontChangedWrapper.Create(ARecord: TCMParentFontChanged);
begin
  inherited Create;
  FMsg := ARecord.Msg;
...
function TCMParentFontChangedWrapper.ObjToRec: TCMParentFontChanged;
begin
  result.Msg := FMsg;
...
constructor TGestureEventInfoWrapper.Create(ARecord: TGestureEventInfo);
begin
  inherited Create;
  FGestureID := ARecord.GestureID;
  FFlags := ARecord.Flags;
  FAngle := ARecord.Angle;
  FDistance := ARecord.Distance;
end;

function TGestureEventInfoWrapper.ObjToRec: TGestureEventInfo;
begin
...
constructor TCMGestureWrapper.Create(ARecord: TCMGesture);
begin
  inherited Create;
  FMsg := ARecord.Msg;
...
function TCMGestureWrapper.ObjToRec: TCMGesture;
begin
  result.Msg := FMsg;
...
begin
  with AMachine do
  begin
    TDragObject(CurrentObject).Assign(TDragObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(TDragObject(CurrentObject).GetName);
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TBaseDragControlObjectClass(CurrentClass.ClassRef).Create(TControl(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TBaseDragControlObject(CurrentObject).Assign(TDragObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TBaseDragControlObject(CurrentObject).Control));
  end;
end;
...
begin
  with AMachine do
  begin
    TBaseDragControlObject(CurrentObject).Control:=TControl(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TDragDockObjectClass(CurrentClass.ClassRef).Create(TControl(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TDragDockObject(CurrentObject).Assign(TDragObject(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TDragDockObject(CurrentObject).Brush));
  end;
end;
...
begin
  with AMachine do
  begin
    TDragDockObject(CurrentObject).Brush:=TBrush(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TDragDockObject(CurrentObject).DropAlign));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TDragDockObject(CurrentObject).DropOnControl));
  end;
end;

procedure TatControlsLibrary.__GetTDragDockObjectEraseDockRect(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(integer(TRectWrapper.Create(TDragDockObject(CurrentObject).EraseDockRect)));
  end;
end;

procedure TatControlsLibrary.__SetTDragDockObjectEraseDockRect(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TDragDockObject(CurrentObject).EraseDockRect:=TRectWrapper(integer(GetInputArg(0))).ObjToRec;
  end;
end;

procedure TatControlsLibrary.__GetTDragDockObjectEraseWhenMoving(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(TDragDockObject(CurrentObject).EraseWhenMoving);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TControlCanvas(CurrentObject).Control));
  end;
end;
...
begin
  with AMachine do
  begin
    TControlCanvas(CurrentObject).Control:=TControl(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomControlAction(CurrentObject).DropdownMenu));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomControlAction(CurrentObject).DropdownMenu:=TPopupMenu(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomControlAction(CurrentObject).PopupMenu));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomControlAction(CurrentObject).PopupMenu:=TPopupMenu(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TSizeConstraintsClass(CurrentClass.ClassRef).Create(TControl(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatControlsLibrary.__TMarginsCreate(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := ObjectToVar(TMarginsClass(CurrentClass.ClassRef).Create(TControl(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatControlsLibrary.__TMarginsSetControlBounds(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    Case InputArgCount of
      4: TMargins(CurrentObject).SetControlBounds(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)));
      5: TMargins(CurrentObject).SetControlBounds(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)),GetInputArg(4));
    end;
  end;
end;

procedure TatControlsLibrary.__TMarginsSetBounds(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TMargins(CurrentObject).SetBounds(VarToInteger(GetInputArg(0)),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)),VarToInteger(GetInputArg(3)));
  end;
end;

procedure TatControlsLibrary.__GetTMarginsControlLeft(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TMargins(CurrentObject).ControlLeft));
  end;
end;

procedure TatControlsLibrary.__GetTMarginsControlTop(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TMargins(CurrentObject).ControlTop));
  end;
end;

procedure TatControlsLibrary.__GetTMarginsControlWidth(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TMargins(CurrentObject).ControlWidth));
  end;
end;

procedure TatControlsLibrary.__GetTMarginsControlHeight(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TMargins(CurrentObject).ControlHeight));
  end;
end;

procedure TatControlsLibrary.__GetTMarginsExplicitLeft(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TMargins(CurrentObject).ExplicitLeft));
  end;
end;

procedure TatControlsLibrary.__GetTMarginsExplicitTop(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TMargins(CurrentObject).ExplicitTop));
  end;
end;

procedure TatControlsLibrary.__GetTMarginsExplicitWidth(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TMargins(CurrentObject).ExplicitWidth));
  end;
end;

procedure TatControlsLibrary.__GetTMarginsExplicitHeight(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TMargins(CurrentObject).ExplicitHeight));
  end;
end;

procedure TatControlsLibrary.__GetTCustomGestureCollectionItemDeviation(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomGestureCollectionItem(CurrentObject).Deviation));
  end;
end;

procedure TatControlsLibrary.__SetTCustomGestureCollectionItemDeviation(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomGestureCollectionItem(CurrentObject).Deviation:=VarToInteger(GetInputArg(0));
  end;
end;

procedure TatControlsLibrary.__GetTCustomGestureCollectionItemErrorMargin(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomGestureCollectionItem(CurrentObject).ErrorMargin));
  end;
end;

procedure TatControlsLibrary.__SetTCustomGestureCollectionItemErrorMargin(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomGestureCollectionItem(CurrentObject).ErrorMargin:=VarToInteger(GetInputArg(0));
  end;
end;

procedure TatControlsLibrary.__GetTCustomGestureCollectionItemGestureID(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomGestureCollectionItem(CurrentObject).GestureID));
  end;
end;

procedure TatControlsLibrary.__SetTCustomGestureCollectionItemGestureID(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomGestureCollectionItem(CurrentObject).GestureID:=TGestureID(VarToInteger(GetInputArg(0)));
  end;
end;

procedure TatControlsLibrary.__GetTCustomGestureCollectionItemGestureType(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomGestureCollectionItem(CurrentObject).GestureType));
  end;
end;

procedure TatControlsLibrary.__GetTCustomGestureCollectionItemOptions(AMachine: TatVirtualMachine);
var
PropValueSet: TGestureOptions;
begin
  with AMachine do
  begin
    PropValueSet := TCustomGestureCollectionItem(CurrentObject).Options;
    ReturnOutputArg(IntFromSet(PropValueSet, SizeOf(PropValueSet)));
  end;
end;

procedure TatControlsLibrary.__SetTCustomGestureCollectionItemOptions(AMachine: TatVirtualMachine);
  var
  TempVar: TGestureOptions;
begin
  with AMachine do
  begin
    IntToSet(TempVar, VarToInteger(GetInputArg(0)), SizeOf(TempVar));
    TCustomGestureCollectionItem(CurrentObject).Options:=TempVar;
  end;
end;

procedure TatControlsLibrary.__GetTCustomGestureCollectionItemName(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TCustomGestureCollectionItem(CurrentObject).Name));
  end;
end;

procedure TatControlsLibrary.__SetTCustomGestureCollectionItemName(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomGestureCollectionItem(CurrentObject).Name:=VarToStr(GetInputArg(0));
  end;
end;

procedure TatControlsLibrary.__GetTCustomGestureCollectionItemAction(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomGestureCollectionItem(CurrentObject).Action));
  end;
end;

procedure TatControlsLibrary.__SetTCustomGestureCollectionItemAction(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomGestureCollectionItem(CurrentObject).Action:=TBasicAction(VarToObject(GetInputArg(0)));
  end;
end;

procedure TatControlsLibrary.__TCustomGestureCollectionAddGesture(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomGestureCollection(CurrentObject).AddGesture);
    ReturnOutputArg(AResult);
  end;
end;

procedure TatControlsLibrary.__TCustomGestureCollectionFindGesture(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomGestureCollection(CurrentObject).FindGesture(TGestureID(VarToInteger(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatControlsLibrary.__TCustomGestureCollectionGetUniqueGestureID(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(TCustomGestureCollection(CurrentObject).GetUniqueGestureID);
    ReturnOutputArg(AResult);
  end;
end;

procedure TatControlsLibrary.__TCustomGestureCollectionRemoveGesture(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomGestureCollection(CurrentObject).RemoveGesture(TGestureID(VarToInteger(GetInputArg(0))));
  end;
end;

procedure TatControlsLibrary.__GetTCustomGestureCollectionGestureManager(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomGestureCollection(CurrentObject).GestureManager));
  end;
end;

procedure TatControlsLibrary.__GetTCustomGestureCollectionItems(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomGestureCollection(CurrentObject).Items[VarToInteger(GetArrayIndex(0))]));
  end;
end;

procedure TatControlsLibrary.__SetTCustomGestureCollectionItems(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomGestureCollection(CurrentObject).Items[VarToInteger(GetArrayIndex(0))]:=TCustomGestureCollectionItem(VarToObject(GetInputArg(0)));
  end;
end;

procedure TatControlsLibrary.__TCustomGestureManagerAddRecordedGesture(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(TCustomGestureManager(CurrentObject).AddRecordedGesture(TCustomGestureCollectionItem(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatControlsLibrary.__TCustomGestureManagerFindCustomGesture(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomGestureManager(CurrentObject).FindCustomGesture(TGestureID(VarToInteger(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatControlsLibrary.__TCustomGestureManagerFindGesture(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomGestureManager(CurrentObject).FindGesture(TControl(VarToObject(GetInputArg(0))),TGestureID(VarToInteger(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatControlsLibrary.__TCustomGestureManagerRegisterControl(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomGestureManager(CurrentObject).RegisterControl(TControl(VarToObject(GetInputArg(0))));
  end;
end;

procedure TatControlsLibrary.__TCustomGestureManagerRemoveRecordedGesture(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomGestureManager(CurrentObject).RemoveRecordedGesture(TGestureID(VarToInteger(GetInputArg(0))));
  end;
end;

procedure TatControlsLibrary.__TCustomGestureManagerSelectGesture(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := TCustomGestureManager(CurrentObject).SelectGesture(TControl(VarToObject(GetInputArg(0))),TGestureID(VarToInteger(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatControlsLibrary.__TCustomGestureManagerUnregisterControl(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomGestureManager(CurrentObject).UnregisterControl(TControl(VarToObject(GetInputArg(0))));
  end;
end;

procedure TatControlsLibrary.__TCustomGestureManagerUnselectGesture(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomGestureManager(CurrentObject).UnselectGesture(TControl(VarToObject(GetInputArg(0))),TGestureID(VarToInteger(GetInputArg(1))));
  end;
end;

procedure TatControlsLibrary.__GetTCustomGestureManagerStandardGestures(AMachine: TatVirtualMachine);
var
PropValueSet: TStandardGestures;
begin
  with AMachine do
  begin
    PropValueSet := TCustomGestureManager(CurrentObject).StandardGestures[TControl(VarToObject(GetArrayIndex(0)))];
    ReturnOutputArg(IntFromSet(PropValueSet, SizeOf(PropValueSet)));
  end;
end;

procedure TatControlsLibrary.__SetTCustomGestureManagerStandardGestures(AMachine: TatVirtualMachine);
  var
  TempVar: TStandardGestures;
begin
  with AMachine do
  begin
    IntToSet(TempVar, VarToInteger(GetInputArg(0)), SizeOf(TempVar));
    TCustomGestureManager(CurrentObject).StandardGestures[TControl(VarToObject(GetArrayIndex(0)))]:=TempVar;
  end;
end;

procedure TatControlsLibrary.__TCustomGestureEngineCreate(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomGestureEngineClass(CurrentClass.ClassRef).Create(TWinControl(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatControlsLibrary.__TCustomGestureEngineNotification(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomGestureEngine(CurrentObject).Notification(TMessageWrapper(integer(GetInputArg(0))).ObjToRec);
  end;
end;

procedure TatControlsLibrary.__TCustomGestureEngineSupported(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := TCustomGestureEngineClass(CurrentClass.ClassRef).Supported;
    ReturnOutputArg(AResult);
  end;
end;

procedure TatControlsLibrary.__GetTCustomGestureEngineActive(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(TCustomGestureEngine(CurrentObject).Active);
  end;
end;

procedure TatControlsLibrary.__SetTCustomGestureEngineActive(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomGestureEngine(CurrentObject).Active:=GetInputArg(0);
  end;
end;

procedure TatControlsLibrary.__TCustomTouchManagerCreate(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomTouchManagerClass(CurrentClass.ClassRef).Create(TControl(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatControlsLibrary.__TCustomTouchManagerDestroy(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomTouchManager(CurrentObject).Destroy;
  end;
end;

procedure TatControlsLibrary.__TCustomTouchManagerChangeNotification(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomTouchManager(CurrentObject).ChangeNotification(TControl(VarToObject(GetInputArg(0))));
  end;
end;

procedure TatControlsLibrary.__TCustomTouchManagerFindGesture(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomTouchManager(CurrentObject).FindGesture(TGestureID(VarToInteger(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatControlsLibrary.__TCustomTouchManagerRemoveChangeNotification(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomTouchManager(CurrentObject).RemoveChangeNotification(TControl(VarToObject(GetInputArg(0))));
  end;
end;

procedure TatControlsLibrary.__TCustomTouchManagerSelectGesture(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := TCustomTouchManager(CurrentObject).SelectGesture(TGestureID(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatControlsLibrary.__TCustomTouchManagerUnselectGesture(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomTouchManager(CurrentObject).UnselectGesture(TGestureID(VarToInteger(GetInputArg(0))));
  end;
end;

procedure TatControlsLibrary.__GetTCustomTouchManagerGestureEngine(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomTouchManager(CurrentObject).GestureEngine));
  end;
end;

procedure TatControlsLibrary.__SetTCustomTouchManagerGestureEngine(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomTouchManager(CurrentObject).GestureEngine:=TCustomGestureEngine(VarToObject(GetInputArg(0)));
  end;
end;

procedure TatControlsLibrary.__GetTCustomTouchManagerGestureManager(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomTouchManager(CurrentObject).GestureManager));
  end;
end;

procedure TatControlsLibrary.__SetTCustomTouchManagerGestureManager(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomTouchManager(CurrentObject).GestureManager:=TCustomGestureManager(VarToObject(GetInputArg(0)));
  end;
end;

procedure TatControlsLibrary.__GetTCustomTouchManagerInteractiveGestures(AMachine: TatVirtualMachine);
var
PropValueSet: TInteractiveGestures;
begin
  with AMachine do
  begin
    PropValueSet := TCustomTouchManager(CurrentObject).InteractiveGestures;
    ReturnOutputArg(IntFromSet(PropValueSet, SizeOf(PropValueSet)));
  end;
end;

procedure TatControlsLibrary.__SetTCustomTouchManagerInteractiveGestures(AMachine: TatVirtualMachine);
  var
  TempVar: TInteractiveGestures;
begin
  with AMachine do
  begin
    IntToSet(TempVar, VarToInteger(GetInputArg(0)), SizeOf(TempVar));
    TCustomTouchManager(CurrentObject).InteractiveGestures:=TempVar;
  end;
end;

procedure TatControlsLibrary.__GetTCustomTouchManagerInteractiveGestureOptions(AMachine: TatVirtualMachine);
var
PropValueSet: TInteractiveGestureOptions;
begin
  with AMachine do
  begin
    PropValueSet := TCustomTouchManager(CurrentObject).InteractiveGestureOptions;
    ReturnOutputArg(IntFromSet(PropValueSet, SizeOf(PropValueSet)));
  end;
end;

procedure TatControlsLibrary.__SetTCustomTouchManagerInteractiveGestureOptions(AMachine: TatVirtualMachine);
  var
  TempVar: TInteractiveGestureOptions;
begin
  with AMachine do
  begin
    IntToSet(TempVar, VarToInteger(GetInputArg(0)), SizeOf(TempVar));
    TCustomTouchManager(CurrentObject).InteractiveGestureOptions:=TempVar;
  end;
end;

procedure TatControlsLibrary.__GetTCustomTouchManagerParentTabletOptions(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(TCustomTouchManager(CurrentObject).ParentTabletOptions);
  end;
end;

procedure TatControlsLibrary.__SetTCustomTouchManagerParentTabletOptions(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomTouchManager(CurrentObject).ParentTabletOptions:=GetInputArg(0);
  end;
end;

procedure TatControlsLibrary.__GetTCustomTouchManagerStandardGestures(AMachine: TatVirtualMachine);
var
PropValueSet: TStandardGestures;
begin
  with AMachine do
  begin
    PropValueSet := TCustomTouchManager(CurrentObject).StandardGestures;
    ReturnOutputArg(IntFromSet(PropValueSet, SizeOf(PropValueSet)));
  end;
end;

procedure TatControlsLibrary.__SetTCustomTouchManagerStandardGestures(AMachine: TatVirtualMachine);
  var
  TempVar: TStandardGestures;
begin
  with AMachine do
  begin
    IntToSet(TempVar, VarToInteger(GetInputArg(0)), SizeOf(TempVar));
    TCustomTouchManager(CurrentObject).StandardGestures:=TempVar;
  end;
end;

procedure TatControlsLibrary.__GetTCustomTouchManagerTabletOptions(AMachine: TatVirtualMachine);
var
PropValueSet: TTabletOptions;
begin
  with AMachine do
  begin
    PropValueSet := TCustomTouchManager(CurrentObject).TabletOptions;
    ReturnOutputArg(IntFromSet(PropValueSet, SizeOf(PropValueSet)));
  end;
end;

procedure TatControlsLibrary.__SetTCustomTouchManagerTabletOptions(AMachine: TatVirtualMachine);
  var
  TempVar: TTabletOptions;
begin
  with AMachine do
  begin
    IntToSet(TempVar, VarToInteger(GetInputArg(0)), SizeOf(TempVar));
    TCustomTouchManager(CurrentObject).TabletOptions:=TempVar;
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TControlClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
2: AResult := integer(TPointWrapper.Create(TControl(CurrentObject).ClientToParent(TPointWrapper(integer(GetInputArg(0))).ObjToRec,TWinControl(VarToObject(GetInputArg(1))))));
end;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TControl(CurrentObject).Dock(TWinControl(VarToObject(GetInputArg(0))),TRectWrapper(integer(GetInputArg(1))).ObjToRec);
  end;
end;
...
begin
  with AMachine do
  begin
    TControl(CurrentObject).DragDrop(TObject(VarToObject(GetInputArg(0))),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TControl(CurrentObject).GetControlsAlignment);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TControl(CurrentObject).GetParentComponent);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
case InputArgCount of
1: AResult := TControl(CurrentObject).ManualDock(TWinControl(VarToObject(GetInputArg(0))));
2: AResult := TControl(CurrentObject).ManualDock(TWinControl(VarToObject(GetInputArg(0))),TControl(VarToObject(GetInputArg(1))));
3: AResult := TControl(CurrentObject).ManualDock(TWinControl(VarToObject(GetInputArg(0))),TControl(VarToObject(GetInputArg(1))),TAlign(VarToInteger(GetInputArg(2))));
end;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TControl(CurrentObject).ReplaceDockedControl(TControl(VarToObject(GetInputArg(0))),TWinControl(VarToObject(GetInputArg(1))),TControl(VarToObject(GetInputArg(2))),TAlign(VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
2: AResult := integer(TPointWrapper.Create(TControl(CurrentObject).ParentToClient(TPointWrapper(integer(GetInputArg(0))).ObjToRec,TWinControl(VarToObject(GetInputArg(1))))));
end;
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatControlsLibrary.__TControlSetDesignVisible(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TControl(CurrentObject).SetDesignVisible(GetInputArg(0));
  end;
end;

procedure TatControlsLibrary.__TControlSetParentComponent(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TControl(CurrentObject).SetParentComponent(TComponent(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TControl(CurrentObject).Action));
  end;
end;
...
begin
  with AMachine do
  begin
    TControl(CurrentObject).Action:=TBasicAction(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TControl(CurrentObject).Align));
  end;
end;
...
begin
  with AMachine do
  begin
    TControl(CurrentObject).Align:=TAlign(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TControl(CurrentObject).BiDiMode));
  end;
end;
...
begin
  with AMachine do
  begin
    TControl(CurrentObject).BiDiMode:=TBiDiMode(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TControl(CurrentObject).Constraints));
  end;
end;
...
begin
  with AMachine do
  begin
    TControl(CurrentObject).Constraints:=TSizeConstraints(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TControl(CurrentObject).DockOrientation));
  end;
end;
...
begin
  with AMachine do
  begin
    TControl(CurrentObject).DockOrientation:=TDockOrientation(VarToInteger(GetInputArg(0)));
  end;
end;

procedure TatControlsLibrary.__GetTControlExplicitLeft(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TControl(CurrentObject).ExplicitLeft));
  end;
end;

procedure TatControlsLibrary.__GetTControlExplicitTop(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TControl(CurrentObject).ExplicitTop));
  end;
end;

procedure TatControlsLibrary.__GetTControlExplicitWidth(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TControl(CurrentObject).ExplicitWidth));
  end;
end;

procedure TatControlsLibrary.__GetTControlExplicitHeight(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TControl(CurrentObject).ExplicitHeight));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TControl(CurrentObject).HostDockSite));
  end;
end;
...
begin
  with AMachine do
  begin
    TControl(CurrentObject).HostDockSite:=TWinControl(VarToObject(GetInputArg(0)));
  end;
end;
...
procedure TatControlsLibrary.__GetTControlTouch(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TControl(CurrentObject).Touch));
  end;
end;

procedure TatControlsLibrary.__SetTControlTouch(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TControl(CurrentObject).Touch:=TTouchManager(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TControl(CurrentObject).Parent));
  end;
end;
...
begin
  with AMachine do
  begin
    TControl(CurrentObject).Parent:=TWinControl(VarToObject(GetInputArg(0)));
  end;
end;

procedure TatControlsLibrary.__TWinControlGetTextLen(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(TWinControl(CurrentObject).GetTextLen);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TWinControlClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TWinControlClass(CurrentClass.ClassRef).CreateParented(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TWinControlClass(CurrentClass.ClassRef).CreateParentedControl(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := TWinControl(CurrentObject).ContainsControl(TControl(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
case InputArgCount of
2: AResult := ObjectToVar(TWinControl(CurrentObject).ControlAtPos(TPointWrapper(integer(GetInputArg(0))).ObjToRec,GetInputArg(1)));
3: AResult := ObjectToVar(TWinControl(CurrentObject).ControlAtPos(TPointWrapper(integer(GetInputArg(0))).ObjToRec,GetInputArg(1),GetInputArg(2)));
4: AResult := ObjectToVar(TWinControl(CurrentObject).ControlAtPos(TPointWrapper(integer(GetInputArg(0))).ObjToRec,GetInputArg(1),GetInputArg(2),GetInputArg(3)));
end;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TWinControl(CurrentObject).DockDrop(TDragDockObject(VarToObject(GetInputArg(0))),VarToInteger(GetInputArg(1)),VarToInteger(GetInputArg(2)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TWinControl(CurrentObject).FindChildControl(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatControlsLibrary.__TWinControlGetTabControlList(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TWinControl(CurrentObject).GetTabControlList(TList(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TWinControl(CurrentObject).GetTabOrderList(TList(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TWinControl(CurrentObject).InsertControl(TControl(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    TWinControl(CurrentObject).RemoveControl(TControl(VarToObject(GetInputArg(0))));
  end;
end;
...
procedure TatControlsLibrary.__TWinControlSetDesignVisible(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TWinControl(CurrentObject).SetDesignVisible(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TWinControl(CurrentObject).DockClients[VarToInteger(GetArrayIndex(0))]));
  end;
end;
...
procedure TatControlsLibrary.__GetTWinControlMouseInClient(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(TWinControl(CurrentObject).MouseInClient);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TWinControl(CurrentObject).Brush));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TWinControl(CurrentObject).Controls[VarToInteger(GetArrayIndex(0))]));
  end;
end;
...
procedure TatControlsLibrary.__GetTWinControlPadding(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TWinControl(CurrentObject).Padding));
  end;
end;

procedure TatControlsLibrary.__SetTWinControlPadding(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TWinControl(CurrentObject).Padding:=TPadding(VarToObject(GetInputArg(0)));
  end;
end;

procedure TatControlsLibrary.__GetTWinControlParentDoubleBuffered(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(TWinControl(CurrentObject).ParentDoubleBuffered);
  end;
end;

procedure TatControlsLibrary.__SetTWinControlParentDoubleBuffered(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TWinControl(CurrentObject).ParentDoubleBuffered:=GetInputArg(0);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TWinControl(CurrentObject).TabOrder));
  end;
end;
...
begin
  with AMachine do
  begin
    TWinControl(CurrentObject).TabOrder:=TTabOrder(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TGraphicControlClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomControlClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatControlsLibrary.__TCustomTransparentControlCreate(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomTransparentControlClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatControlsLibrary.__TCustomTransparentControlInvalidate(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomTransparentControl(CurrentObject).Invalidate;
  end;
end;

procedure TatControlsLibrary.__GetTCustomTransparentControlInterceptMouse(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(TCustomTransparentControl(CurrentObject).InterceptMouse);
  end;
end;

procedure TatControlsLibrary.__SetTCustomTransparentControlInterceptMouse(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomTransparentControl(CurrentObject).InterceptMouse:=GetInputArg(0);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(THintWindowClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    THintWindow(CurrentObject).ActivateHint(TRectWrapper(integer(GetInputArg(0))).ObjToRec,VarToStr(GetInputArg(1)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TDragImageList(CurrentObject).DragCursor));
  end;
end;
...
begin
  with AMachine do
  begin
    TDragImageList(CurrentObject).DragCursor:=TCursor(VarToInteger(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TDockZoneClass(CurrentClass.ClassRef).Create(TDockTree(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TDockZone(CurrentObject).FirstVisibleChild);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TDockZone(CurrentObject).NextVisible);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TDockZone(CurrentObject).PrevVisible);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TDockZone(CurrentObject).ChildControl));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TDockTreeClass(CurrentClass.ClassRef).Create(TWinControl(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatControlsLibrary.__TCustomPanningWindowGetIsPanning(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := TCustomPanningWindow(CurrentObject).GetIsPanning;
    ReturnOutputArg(AResult);
  end;
end;

procedure TatControlsLibrary.__TCustomPanningWindowStartPanning(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := TCustomPanningWindow(CurrentObject).StartPanning(VarToInteger(GetInputArg(0)),TControl(VarToObject(GetInputArg(1))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatControlsLibrary.__TCustomPanningWindowStopPanning(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomPanningWindow(CurrentObject).StopPanning;
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TMouseClass(CurrentClass.ClassRef).Create);
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatControlsLibrary.__TMouseCreatePanningWindow(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := ObjectToVar(TMouse(CurrentObject).CreatePanningWindow);
    ReturnOutputArg(AResult);
  end;
end;
...
procedure TatControlsLibrary.__GetTMouseIsPanning(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(TMouse(CurrentObject).IsPanning);
  end;
end;

procedure TatControlsLibrary.__GetTMousePanningWindow(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TMouse(CurrentObject).PanningWindow));
  end;
end;

procedure TatControlsLibrary.__SetTMousePanningWindow(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TMouse(CurrentObject).PanningWindow:=TCustomPanningWindow(VarToObject(GetInputArg(0)));
  end;
end;
...
procedure TatControlsLibrary.__TCustomListControlCreate(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomListControlClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomListControl(CurrentObject).AddItem(VarToStr(GetInputArg(0)),TObject(VarToObject(GetInputArg(1))));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomListControl(CurrentObject).CopySelection(TCustomListControl(VarToObject(GetInputArg(0))));
  end;
end;
...
procedure TatControlsLibrary.__TCustomListControlGetCount(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(TCustomListControl(CurrentObject).GetCount);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomListControl(CurrentObject).MoveSelection(TCustomListControl(VarToObject(GetInputArg(0))));
  end;
end;
...
procedure TatControlsLibrary.__TCustomHintWindowCreate(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomHintWindowClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatControlsLibrary.__TCustomHintWindowAutoSize(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomHintWindow(CurrentObject).AutoSize;
  end;
end;

procedure TatControlsLibrary.__TCustomHintWindowPositionAt(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomHintWindow(CurrentObject).PositionAt(TPointWrapper(integer(GetInputArg(0))).ObjToRec);
  end;
end;

procedure TatControlsLibrary.__TCustomHintWindowPositionAtCursor(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomHintWindow(CurrentObject).PositionAtCursor;
  end;
end;

procedure TatControlsLibrary.__GetTCustomHintWindowHintParent(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TCustomHintWindow(CurrentObject).HintParent));
  end;
end;

procedure TatControlsLibrary.__SetTCustomHintWindowHintParent(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomHintWindow(CurrentObject).HintParent:=TCustomHint(VarToObject(GetInputArg(0)));
  end;
end;

procedure TatControlsLibrary.__GetTCustomHintWindowPopAbove(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(TCustomHintWindow(CurrentObject).PopAbove);
  end;
end;

procedure TatControlsLibrary.__GetTCustomHintWindowTitle(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TCustomHintWindow(CurrentObject).Title));
  end;
end;

procedure TatControlsLibrary.__GetTCustomHintWindowDescription(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TCustomHintWindow(CurrentObject).Description));
  end;
end;

procedure TatControlsLibrary.__GetTCustomHintWindowImageIndex(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomHintWindow(CurrentObject).ImageIndex));
  end;
end;

procedure TatControlsLibrary.__TCustomHintShowHideThreadCreate(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomHintShowHideThreadClass(CurrentClass.ClassRef).Create(TCustomHintWindow(VarToObject(GetInputArg(0))),TCustomHint(VarToObject(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatControlsLibrary.__TCustomHintShowHideThreadDestroy(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomHintShowHideThread(CurrentObject).Destroy;
  end;
end;

procedure TatControlsLibrary.__TCustomHintShowHideThreadResumeWork(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomHintShowHideThread(CurrentObject).ResumeWork;
  end;
end;

procedure TatControlsLibrary.__TCustomHintShowHideThreadExecute(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomHintShowHideThread(CurrentObject).Execute;
  end;
end;

procedure TatControlsLibrary.__TCustomHintShowHideThreadHideHint(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomHintShowHideThread(CurrentObject).HideHint;
  end;
end;

procedure TatControlsLibrary.__TCustomHintCreate(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := ObjectToVar(TCustomHintClass(CurrentClass.ClassRef).Create(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatControlsLibrary.__TCustomHintDestroy(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomHint(CurrentObject).Destroy;
  end;
end;

procedure TatControlsLibrary.__TCustomHintShowHint(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomHint(CurrentObject).ShowHint;
  end;
end;

procedure TatControlsLibrary.__TCustomHintHideHint(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomHint(CurrentObject).HideHint;
  end;
end;

procedure TatControlsLibrary.__TCustomHintPaintHint(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomHint(CurrentObject).PaintHint(TCustomHintWindow(VarToObject(GetInputArg(0))));
  end;
end;

procedure TatControlsLibrary.__TCustomHintNCPaintHint(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomHint(CurrentObject).NCPaintHint(TCustomHintWindow(VarToObject(GetInputArg(0))),VarToInteger(GetInputArg(1)));
  end;
end;

procedure TatControlsLibrary.__TCustomHintSetHintSize(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomHint(CurrentObject).SetHintSize(TCustomHintWindow(VarToObject(GetInputArg(0))));
  end;
end;

procedure TatControlsLibrary.__GetTCustomHintShowingHint(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(TCustomHint(CurrentObject).ShowingHint);
  end;
end;

procedure TatControlsLibrary.__GetTCustomHintTitle(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TCustomHint(CurrentObject).Title));
  end;
end;

procedure TatControlsLibrary.__SetTCustomHintTitle(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomHint(CurrentObject).Title:=VarToStr(GetInputArg(0));
  end;
end;

procedure TatControlsLibrary.__GetTCustomHintDescription(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(string(TCustomHint(CurrentObject).Description));
  end;
end;

procedure TatControlsLibrary.__SetTCustomHintDescription(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomHint(CurrentObject).Description:=VarToStr(GetInputArg(0));
  end;
end;

procedure TatControlsLibrary.__GetTCustomHintImageIndex(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomHint(CurrentObject).ImageIndex));
  end;
end;

procedure TatControlsLibrary.__SetTCustomHintImageIndex(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TCustomHint(CurrentObject).ImageIndex:=VarToInteger(GetInputArg(0));
  end;
end;

procedure TatControlsLibrary.__TBalloonHintPaintHint(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TBalloonHint(CurrentObject).PaintHint(TCustomHintWindow(VarToObject(GetInputArg(0))));
  end;
end;

procedure TatControlsLibrary.__TBalloonHintSetHintSize(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    TBalloonHint(CurrentObject).SetHintSize(TCustomHintWindow(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  ...
  begin
    ...
    ShiftTempSet := Shift;
    ShiftTemp := IntFromSet(ShiftTempSet, SizeOf(ShiftTempSet));
    MouseActivateTemp := Integer(MouseActivate);
    if Assigned(Scripter) and (RoutineName > '') then
      Scripter.ExecuteSubroutine(RoutineName, [Sender,ButtonTemp,ShiftTemp,X,Y,HitTest,MouseActivateTemp]);
    MouseActivate := TMouseActivate(VarToInteger(MouseActivateTemp));
    if AssignedMethod(AfterCall) then
...
begin
  ...
  begin
    ...
    DragObjectTemp := ObjectToVar(DragObject);
    if Assigned(Scripter) and (RoutineName > '') then
      Scripter.ExecuteSubroutine(RoutineName, [Sender,DragObjectTemp]);
    DragObject := TDragObject(VarToObject(DragObjectTemp));
    if AssignedMethod(AfterCall) then
...
begin
  ...
  begin
    ...
    if Assigned(Scripter) and (RoutineName > '') then
      Scripter.ExecuteSubroutine(RoutineName, [Sender,DragObjectTemp]);
    DragObject := TDragDockObject(VarToObject(DragObjectTemp));
    if AssignedMethod(AfterCall) then
...
begin
  with AMachine do
  begin
AResult := Controls.IsPositiveResult(TModalResult(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Controls.IsNegativeResult(TModalResult(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Controls.IsAbortResult(TModalResult(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Controls.IsAnAllResult(TModalResult(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Controls.StripAllFromResult(TModalResult(VarToInteger(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Controls.IsDragObject(TObject(VarToObject(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatControlsLibrary.__IsVCLControl(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Controls.IsVCLControl(VarToInteger(GetInputArg(0)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(Controls.FindControl(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(Controls.FindVCLWindow(TPointWrapper(integer(GetInputArg(0))).ObjToRec));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(Controls.FindDragTarget(TPointWrapper(integer(GetInputArg(0))).ObjToRec,GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(Controls.GetCaptureControl);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    Controls.SetCaptureControl(TControl(VarToObject(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(Controls.CursorToString(TCursor(VarToInteger(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(Controls.StringToCursor(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := Controls.IdentToCursor(VarToStr(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
...
begin
  with AMachine do
  begin
AResult := string(Controls.GetShortHint(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := string(Controls.GetLongHint(VarToStr(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    Controls.PerformEraseBackground(TControl(VarToObject(GetInputArg(0))),VarToInteger(GetInputArg(1)));
  end;
end;

procedure TatControlsLibrary.__PerformBufferedPrintClient(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    Controls.PerformBufferedPrintClient(VarToInteger(GetInputArg(0)),TRectWrapper(integer(GetInputArg(1))).ObjToRec);
  end;
end;

procedure TatControlsLibrary.__MouseOriginToShiftState(AMachine: TatVirtualMachine);
  var
...
begin
  with AMachine do
  begin
AResultSet := Controls.MouseOriginToShiftState;
...
begin
  with AMachine do
  begin
Param0 := TAlignment(VarToInteger(GetInputArg(0)));
...
begin
  with AMachine do
  begin
    Controls.SetImeMode(VarToInteger(GetInputArg(0)),TImeMode(VarToInteger(GetInputArg(1))));
  end;
end;
...
begin
  with AMachine do
  begin
    Controls.SetImeName(VarToStr(GetInputArg(0)));
  end;
end;
...
procedure TatControlsLibrary.__Imm32SetCompositionFont(AMachine: TatVirtualMachine);
  var
  Param1Rec: TObject;
  Param1: LOGFONT;
  AResult: variant;
...
if not Assigned(Param1Rec) or not (Param1Rec is tagLOGFONTWWrapper) then 
  Param1Rec := tagLOGFONTWWrapper.Create(Param1);
Param1 := tagLOGFONTWWrapper(Param1Rec).ObjToRec;
AResult := Controls.Imm32SetCompositionFont(VarToInteger(GetInputArg(0)),Param1);
    ReturnOutputArg(AResult);
    SetInputArg(1,integer(tagLOGFONTWWrapper.Create(Param1)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(Controls.Mouse));
  end;
end;
...
begin
  with AMachine do
  begin
    Controls.Mouse:=TMouse(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(Controls.CreationControl));
  end;
end;
...
begin
  with AMachine do
  begin
    Controls.CreationControl:=TWinControl(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  ...
  begin
    DefineMethod('Assign',1,tkNone,nil,__TDragObjectAssign,false,0,'Source: TDragObject');
  ...
  begin
    DefineMethod('Create',1,tkClass,TBaseDragControlObject,__TBaseDragControlObjectCreate,true,0,'AControl: TControl');
    DefineMethod('Assign',1,tkNone,nil,__TBaseDragControlObjectAssign,false,0,'Source: TDragObject');
  ...
  begin
    DefineMethod('Create',1,tkClass,TDragDockObject,__TDragDockObjectCreate,true,0,'AControl: TControl');
    DefineMethod('Destroy',0,tkNone,nil,__TDragDockObjectDestroy,false,0,'');
    DefineMethod('Assign',1,tkNone,nil,__TDragDockObjectAssign,false,0,'Source: TDragObject');
    ...
    DefineProp('EraseDockRect',tkVariant,__GetTDragDockObjectEraseDockRect,__SetTDragDockObjectEraseDockRect,nil,false,0);
    DefineProp('EraseWhenMoving',tkVariant,__GetTDragDockObjectEraseWhenMoving,nil,nil,false,0);
  ...
  begin
    DefineMethod('Create',1,tkClass,TSizeConstraints,__TSizeConstraintsCreate,true,0,'Control: TControl');
  end;
  With Scripter.DefineClass(TMargins) do
  begin
    DefineMethod('Create',1,tkClass,TMargins,__TMarginsCreate,true,0,'Control: TControl');
    DefineMethod('SetControlBounds',5,tkNone,nil,__TMarginsSetControlBounds,false,1,'ALeft: Integer; ATop: Integer; AWidth: Integer; AHeight: Integer; Aligning: Boolean = False');
    DefineMethod('SetBounds',4,tkNone,nil,__TMarginsSetBounds,false,0,'ALeft: Integer; ATop: Integer; ARight: Integer; ABottom: Integer');
    DefineProp('ControlLeft',tkInteger,__GetTMarginsControlLeft,nil,nil,false,0);
    DefineProp('ControlTop',tkInteger,__GetTMarginsControlTop,nil,nil,false,0);
    DefineProp('ControlWidth',tkInteger,__GetTMarginsControlWidth,nil,nil,false,0);
    DefineProp('ControlHeight',tkInteger,__GetTMarginsControlHeight,nil,nil,false,0);
    DefineProp('ExplicitLeft',tkInteger,__GetTMarginsExplicitLeft,nil,nil,false,0);
    DefineProp('ExplicitTop',tkInteger,__GetTMarginsExplicitTop,nil,nil,false,0);
    DefineProp('ExplicitWidth',tkInteger,__GetTMarginsExplicitWidth,nil,nil,false,0);
    DefineProp('ExplicitHeight',tkInteger,__GetTMarginsExplicitHeight,nil,nil,false,0);
  end;
  With Scripter.DefineClass(TPadding) do
  begin
  end;
  With Scripter.DefineClass(EGestureException) do
  begin
  end;
  With Scripter.DefineClass(TCustomGestureCollectionItem) do
  begin
    DefineProp('Deviation',tkInteger,__GetTCustomGestureCollectionItemDeviation,__SetTCustomGestureCollectionItemDeviation,nil,false,0);
    DefineProp('ErrorMargin',tkInteger,__GetTCustomGestureCollectionItemErrorMargin,__SetTCustomGestureCollectionItemErrorMargin,nil,false,0);
    DefineProp('GestureID',tkEnumeration,__GetTCustomGestureCollectionItemGestureID,__SetTCustomGestureCollectionItemGestureID,nil,false,0);
    DefineProp('GestureType',tkEnumeration,__GetTCustomGestureCollectionItemGestureType,nil,nil,false,0);
    DefineProp('Options',tkInteger,__GetTCustomGestureCollectionItemOptions,__SetTCustomGestureCollectionItemOptions,nil,false,0);
    DefineProp('Name',tkVariant,__GetTCustomGestureCollectionItemName,__SetTCustomGestureCollectionItemName,nil,false,0);
    DefineProp('Action',tkClass,__GetTCustomGestureCollectionItemAction,__SetTCustomGestureCollectionItemAction,TBasicAction,false,0);
  end;
  With Scripter.DefineClass(TCustomGestureCollection) do
  begin
    DefineMethod('AddGesture',0,tkClass,TCustomGestureCollectionItem,__TCustomGestureCollectionAddGesture,false,0,'');
    DefineMethod('FindGesture',1,tkClass,TCustomGestureCollectionItem,__TCustomGestureCollectionFindGesture,false,0,'AGestureID: TGestureID');
    DefineMethod('GetUniqueGestureID',0,tkEnumeration,nil,__TCustomGestureCollectionGetUniqueGestureID,false,0,'');
    DefineMethod('RemoveGesture',1,tkNone,nil,__TCustomGestureCollectionRemoveGesture,false,0,'AGestureID: TGestureID');
    DefineProp('GestureManager',tkClass,__GetTCustomGestureCollectionGestureManager,nil,TCustomGestureManager,false,0);
    DefaultProperty := DefineProp('Items',tkClass,__GetTCustomGestureCollectionItems,__SetTCustomGestureCollectionItems,TCustomGestureCollectionItem,false,1);
  end;
  With Scripter.DefineClass(TCustomGestureManager) do
  begin
    DefineMethod('AddRecordedGesture',1,tkEnumeration,nil,__TCustomGestureManagerAddRecordedGesture,false,0,'Item: TCustomGestureCollectionItem');
    DefineMethod('FindCustomGesture',1,tkClass,TCustomGestureCollectionItem,__TCustomGestureManagerFindCustomGesture,false,0,'AGestureID: TGestureID');
    DefineMethod('FindGesture',2,tkClass,TCustomGestureCollectionItem,__TCustomGestureManagerFindGesture,false,0,'AControl: TControl; AGestureID: TGestureID');
    DefineMethod('RegisterControl',1,tkNone,nil,__TCustomGestureManagerRegisterControl,false,0,'AControl: TControl');
    DefineMethod('RemoveRecordedGesture',1,tkNone,nil,__TCustomGestureManagerRemoveRecordedGesture,false,0,'AGestureID: TGestureID');
    DefineMethod('SelectGesture',2,tkVariant,nil,__TCustomGestureManagerSelectGesture,false,0,'AControl: TControl; AGestureID: TGestureID');
    DefineMethod('UnregisterControl',1,tkNone,nil,__TCustomGestureManagerUnregisterControl,false,0,'AControl: TControl');
    DefineMethod('UnselectGesture',2,tkNone,nil,__TCustomGestureManagerUnselectGesture,false,0,'AControl: TControl; AGestureID: TGestureID');
    DefineProp('StandardGestures',tkInteger,__GetTCustomGestureManagerStandardGestures,__SetTCustomGestureManagerStandardGestures,nil,false,1);
  end;
  With Scripter.DefineClass(TCustomGestureEngine) do
  begin
    DefineMethod('Create',1,tkClass,TCustomGestureEngine,__TCustomGestureEngineCreate,true,0,'AControl: TWinControl');
    DefineMethod('Notification',1,tkNone,nil,__TCustomGestureEngineNotification,false,0,'Message: TMessage');
    DefineMethod('Supported',0,tkVariant,nil,__TCustomGestureEngineSupported,true,0,'');
    DefineProp('Active',tkVariant,__GetTCustomGestureEngineActive,__SetTCustomGestureEngineActive,nil,false,0);
  end;
  With Scripter.DefineClass(TCustomTouchManager) do
  begin
    DefineMethod('Create',1,tkClass,TCustomTouchManager,__TCustomTouchManagerCreate,true,0,'AControl: TControl');
    DefineMethod('Destroy',0,tkNone,nil,__TCustomTouchManagerDestroy,false,0,'');
    DefineMethod('ChangeNotification',1,tkNone,nil,__TCustomTouchManagerChangeNotification,false,0,'AControl: TControl');
    DefineMethod('FindGesture',1,tkClass,TCustomGestureCollectionItem,__TCustomTouchManagerFindGesture,false,0,'AGestureID: TGestureID');
    DefineMethod('RemoveChangeNotification',1,tkNone,nil,__TCustomTouchManagerRemoveChangeNotification,false,0,'AControl: TControl');
    DefineMethod('SelectGesture',1,tkVariant,nil,__TCustomTouchManagerSelectGesture,false,0,'AGestureID: TGestureID');
    DefineMethod('UnselectGesture',1,tkNone,nil,__TCustomTouchManagerUnselectGesture,false,0,'AGestureID: TGestureID');
    DefineProp('GestureEngine',tkClass,__GetTCustomTouchManagerGestureEngine,__SetTCustomTouchManagerGestureEngine,TCustomGestureEngine,false,0);
    DefineProp('GestureManager',tkClass,__GetTCustomTouchManagerGestureManager,__SetTCustomTouchManagerGestureManager,TCustomGestureManager,false,0);
    DefineProp('InteractiveGestures',tkInteger,__GetTCustomTouchManagerInteractiveGestures,__SetTCustomTouchManagerInteractiveGestures,nil,false,0);
    DefineProp('InteractiveGestureOptions',tkInteger,__GetTCustomTouchManagerInteractiveGestureOptions,__SetTCustomTouchManagerInteractiveGestureOptions,nil,false,0);
    DefineProp('ParentTabletOptions',tkVariant,__GetTCustomTouchManagerParentTabletOptions,__SetTCustomTouchManagerParentTabletOptions,nil,false,0);
    DefineProp('StandardGestures',tkInteger,__GetTCustomTouchManagerStandardGestures,__SetTCustomTouchManagerStandardGestures,nil,false,0);
    DefineProp('TabletOptions',tkInteger,__GetTCustomTouchManagerTabletOptions,__SetTCustomTouchManagerTabletOptions,nil,false,0);
  end;
  With Scripter.DefineClass(TTouchManager) do
  begin
  end;
  With Scripter.DefineClass(TControl) do
  begin
    DefineMethod('Create',1,tkClass,TControl,__TControlCreate,true,0,'AOwner: TComponent');
    DefineMethod('Destroy',0,tkNone,nil,__TControlDestroy,false,0,'');
    DefineMethod('BeginDrag',2,tkNone,nil,__TControlBeginDrag,false,1,'Immediate: Boolean; Threshold: Integer = -1');
    DefineMethod('BringToFront',0,tkNone,nil,__TControlBringToFront,false,0,'');
    DefineMethod('ClientToScreen',1,tkVariant,nil,__TControlClientToScreen,false,0,'Point: TPoint');
    DefineMethod('ClientToParent',2,tkVariant,nil,__TControlClientToParent,false,1,'Point: TPoint; AParent: TWinControl = nil');
    DefineMethod('Dock',2,tkNone,nil,__TControlDock,false,0,'NewDockSite: TWinControl; ARect: TRect');
    DefineMethod('Dragging',0,tkVariant,nil,__TControlDragging,false,0,'');
    DefineMethod('DragDrop',3,tkNone,nil,__TControlDragDrop,false,0,'Source: TObject; X: Integer; Y: Integer');
    DefineMethod('DrawTextBiDiModeFlags',1,tkInteger,nil,__TControlDrawTextBiDiModeFlags,false,0,'Flags: Longint');
    DefineMethod('DrawTextBiDiModeFlagsReadingOnly',0,tkInteger,nil,__TControlDrawTextBiDiModeFlagsReadingOnly,false,0,'');
    DefineMethod('EndDrag',1,tkNone,nil,__TControlEndDrag,false,0,'Drop: Boolean');
    ...
    DefineMethod('MouseWheelHandler',1,tkNone,nil,__TControlMouseWheelHandler,false,0,'Message: TMessage').SetVarArgs([0]);
    DefineMethod('IsRightToLeft',0,tkVariant,nil,__TControlIsRightToLeft,false,0,'');
    DefineMethod('ManualDock',3,tkVariant,nil,__TControlManualDock,false,2,'NewDockSite: TWinControl; DropControl: TControl = nil; ControlSide: TAlign = alNone');
    DefineMethod('ManualFloat',1,tkVariant,nil,__TControlManualFloat,false,0,'ScreenPos: TRect');
    DefineMethod('Perform',3,tkInteger,nil,__TControlPerform,false,0,'Msg: Cardinal; WParam: WPARAM; LParam: LPARAM');
    DefineMethod('Refresh',0,tkNone,nil,__TControlRefresh,false,0,'');
    DefineMethod('Repaint',0,tkNone,nil,__TControlRepaint,false,0,'');
    DefineMethod('ReplaceDockedControl',4,tkVariant,nil,__TControlReplaceDockedControl,false,0,'Control: TControl; NewDockSite: TWinControl; DropControl: TControl; ControlSide: TAlign');
    DefineMethod('ScreenToClient',1,tkVariant,nil,__TControlScreenToClient,false,0,'Point: TPoint');
    DefineMethod('ParentToClient',2,tkVariant,nil,__TControlParentToClient,false,1,'Point: TPoint; AParent: TWinControl = nil');
    DefineMethod('SendToBack',0,tkNone,nil,__TControlSendToBack,false,0,'');
    DefineMethod('SetBounds',4,tkNone,nil,__TControlSetBounds,false,0,'ALeft: Integer; ATop: Integer; AWidth: Integer; AHeight: Integer');
    DefineMethod('SetDesignVisible',1,tkNone,nil,__TControlSetDesignVisible,false,0,'Value: Boolean');
    DefineMethod('SetParentComponent',1,tkNone,nil,__TControlSetParentComponent,false,0,'Value: TComponent');
    ...
    DefineMethod('DefaultHandler',1,tkNone,nil,__TControlDefaultHandler,false,0,'Message').SetVarArgs([0]);
    DefineMethod('GetTextBuf',2,tkInteger,nil,__TControlGetTextBuf,false,0,'Buffer: PChar; BufSize: Integer');
    DefineMethod('GetTextLen',0,tkInteger,nil,__TControlGetTextLen,false,0,'');
    DefineMethod('SetTextBuf',1,tkNone,nil,__TControlSetTextBuf,false,0,'Buffer: PChar');
    ...
    DefineProp('ExplicitLeft',tkInteger,__GetTControlExplicitLeft,nil,nil,false,0);
    DefineProp('ExplicitTop',tkInteger,__GetTControlExplicitTop,nil,nil,false,0);
    DefineProp('ExplicitWidth',tkInteger,__GetTControlExplicitWidth,nil,nil,false,0);
    DefineProp('ExplicitHeight',tkInteger,__GetTControlExplicitHeight,nil,nil,false,0);
    ...
    DefineProp('Touch',tkClass,__GetTControlTouch,__SetTControlTouch,TTouchManager,false,0);
  ...
  begin
    DefineMethod('GetTextLen',0,tkInteger,nil,__TWinControlGetTextLen,false,0,'');
    DefineMethod('Create',1,tkClass,TWinControl,__TWinControlCreate,true,0,'AOwner: TComponent');
    DefineMethod('CreateParented',1,tkClass,TWinControl,__TWinControlCreateParented,true,0,'ParentWindow: HWnd');
    DefineMethod('CreateParentedControl',1,tkClass,TWinControl,__TWinControlCreateParentedControl,true,0,'ParentWindow: HWND');
    DefineMethod('Destroy',0,tkNone,nil,__TWinControlDestroy,false,0,'');
    DefineMethod('Broadcast',1,tkNone,nil,__TWinControlBroadcast,false,0,'Message').SetVarArgs([0]);
    DefineMethod('CanFocus',0,tkVariant,nil,__TWinControlCanFocus,false,0,'');
    DefineMethod('ContainsControl',1,tkVariant,nil,__TWinControlContainsControl,false,0,'Control: TControl');
    DefineMethod('ControlAtPos',4,tkClass,TControl,__TWinControlControlAtPos,false,2,'Pos: TPoint; AllowDisabled: Boolean; AllowWinControls: Boolean = False; AllLevels: Boolean = False');
    DefineMethod('DefaultHandler',1,tkNone,nil,__TWinControlDefaultHandler,false,0,'Message').SetVarArgs([0]);
    DefineMethod('DisableAlign',0,tkNone,nil,__TWinControlDisableAlign,false,0,'');
    DefineMethod('DockDrop',3,tkNone,nil,__TWinControlDockDrop,false,0,'Source: TDragDockObject; X: Integer; Y: Integer');
    DefineMethod('EnableAlign',0,tkNone,nil,__TWinControlEnableAlign,false,0,'');
    DefineMethod('FindChildControl',1,tkClass,TControl,__TWinControlFindChildControl,false,0,'ControlName: string');
    DefineMethod('FlipChildren',1,tkNone,nil,__TWinControlFlipChildren,false,0,'AllLevels: Boolean');
    DefineMethod('Focused',0,tkVariant,nil,__TWinControlFocused,false,0,'');
    DefineMethod('GetTabControlList',1,tkNone,nil,__TWinControlGetTabControlList,false,0,'List: TList');
    DefineMethod('GetTabOrderList',1,tkNone,nil,__TWinControlGetTabOrderList,false,0,'List: TList');
    ...
    DefineMethod('InsertControl',1,tkNone,nil,__TWinControlInsertControl,false,0,'AControl: TControl');
    DefineMethod('Invalidate',0,tkNone,nil,__TWinControlInvalidate,false,0,'');
    DefineMethod('PaintTo',3,tkNone,nil,__TWinControlPaintTo,false,0,'DC: HDC; X: Integer; Y: Integer');
    DefineMethod('PreProcessMessage',1,tkVariant,nil,__TWinControlPreProcessMessage,false,0,'Msg: TMsg').SetVarArgs([0]);
    DefineMethod('RemoveControl',1,tkNone,nil,__TWinControlRemoveControl,false,0,'AControl: TControl');
    ...
    DefineMethod('ScaleBy',2,tkNone,nil,__TWinControlScaleBy,false,0,'M: Integer; D: Integer');
    DefineMethod('ScrollBy',2,tkNone,nil,__TWinControlScrollBy,false,0,'DeltaX: Integer; DeltaY: Integer');
    DefineMethod('SetBounds',4,tkNone,nil,__TWinControlSetBounds,false,0,'ALeft: Integer; ATop: Integer; AWidth: Integer; AHeight: Integer');
    DefineMethod('SetDesignVisible',1,tkNone,nil,__TWinControlSetDesignVisible,false,0,'Value: Boolean');
    ...
    DefineProp('MouseInClient',tkVariant,__GetTWinControlMouseInClient,nil,nil,false,0);
    ...
    DefineProp('Padding',tkClass,__GetTWinControlPadding,__SetTWinControlPadding,TPadding,false,0);
    DefineProp('ParentDoubleBuffered',tkVariant,__GetTWinControlParentDoubleBuffered,__SetTWinControlParentDoubleBuffered,nil,false,0);
  ...
  begin
    DefineMethod('Create',1,tkClass,TGraphicControl,__TGraphicControlCreate,true,0,'AOwner: TComponent');
    DefineMethod('Destroy',0,tkNone,nil,__TGraphicControlDestroy,false,0,'');
  end;
  With Scripter.DefineClass(TCustomControl) do
  begin
    DefineMethod('Create',1,tkClass,TCustomControl,__TCustomControlCreate,true,0,'AOwner: TComponent');
    DefineMethod('Destroy',0,tkNone,nil,__TCustomControlDestroy,false,0,'');
  end;
  With Scripter.DefineClass(TCustomTransparentControl) do
  begin
    DefineMethod('Create',1,tkClass,TCustomTransparentControl,__TCustomTransparentControlCreate,true,0,'AOwner: TComponent');
    DefineMethod('Invalidate',0,tkNone,nil,__TCustomTransparentControlInvalidate,false,0,'');
    DefineProp('InterceptMouse',tkVariant,__GetTCustomTransparentControlInterceptMouse,__SetTCustomTransparentControlInterceptMouse,nil,false,0);
  end;
  With Scripter.DefineClass(THintWindow) do
  begin
    DefineMethod('Create',1,tkClass,THintWindow,__THintWindowCreate,true,0,'AOwner: TComponent');
    DefineMethod('ActivateHint',2,tkNone,nil,__THintWindowActivateHint,false,0,'Rect: TRect; AHint: string');
    DefineMethod('IsHintMsg',1,tkVariant,nil,__THintWindowIsHintMsg,false,0,'Msg: TMsg').SetVarArgs([0]);
  ...
  begin
    DefineMethod('BeginDrag',3,tkVariant,nil,__TDragImageListBeginDrag,false,0,'Window: HWND; X: Integer; Y: Integer');
    DefineMethod('DragLock',3,tkVariant,nil,__TDragImageListDragLock,false,0,'Window: HWND; XPos: Integer; YPos: Integer');
    DefineMethod('DragMove',2,tkVariant,nil,__TDragImageListDragMove,false,0,'X: Integer; Y: Integer');
    ...
    DefineMethod('SetDragImage',3,tkVariant,nil,__TDragImageListSetDragImage,false,0,'Index: Integer; HotSpotX: Integer; HotSpotY: Integer');
  ...
  begin
    DefineMethod('Create',1,tkClass,TDockZone,__TDockZoneCreate,true,0,'Tree: TDockTree');
    DefineMethod('ExpandZoneLimit',1,tkNone,nil,__TDockZoneExpandZoneLimit,false,0,'NewLimit: Integer');
  ...
  begin
    DefineMethod('Create',1,tkClass,TDockTree,__TDockTreeCreate,true,0,'DockSite: TWinControl');
    DefineMethod('Destroy',0,tkNone,nil,__TDockTreeDestroy,false,0,'');
    DefineMethod('PaintSite',1,tkNone,nil,__TDockTreePaintSite,false,0,'DC: HDC');
  end;
  With Scripter.DefineClass(TCustomPanningWindow) do
  begin
    DefineMethod('GetIsPanning',0,tkVariant,nil,__TCustomPanningWindowGetIsPanning,false,0,'');
    DefineMethod('StartPanning',2,tkVariant,nil,__TCustomPanningWindowStartPanning,false,0,'AHandle: THandle; AControl: TControl');
    DefineMethod('StopPanning',0,tkNone,nil,__TCustomPanningWindowStopPanning,false,0,'');
  end;
  ...
  begin
    ...
    DefineMethod('SettingChanged',1,tkNone,nil,__TMouseSettingChanged,false,0,'Setting: Integer');
    DefineMethod('CreatePanningWindow',0,tkClass,TCustomPanningWindow,__TMouseCreatePanningWindow,false,0,'');
    ...
    DefineProp('IsPanning',tkVariant,__GetTMouseIsPanning,nil,nil,false,0);
    DefineProp('PanningWindow',tkClass,__GetTMousePanningWindow,__SetTMousePanningWindow,TCustomPanningWindow,false,0);
  ...
  begin
    DefineMethod('Create',1,tkClass,TCustomListControl,__TCustomListControlCreate,true,0,'AOwner: TComponent');
    DefineMethod('AddItem',2,tkNone,nil,__TCustomListControlAddItem,false,0,'Item: String; AObject: TObject');
    ...
    DefineMethod('CopySelection',1,tkNone,nil,__TCustomListControlCopySelection,false,0,'Destination: TCustomListControl');
    DefineMethod('DeleteSelected',0,tkNone,nil,__TCustomListControlDeleteSelected,false,0,'');
    DefineMethod('GetCount',0,tkInteger,nil,__TCustomListControlGetCount,false,0,'');
    DefineMethod('MoveSelection',1,tkNone,nil,__TCustomListControlMoveSelection,false,0,'Destination: TCustomListControl');
  ...
  With Scripter.DefineClass(TCustomHintWindow) do
  begin
    DefineMethod('Create',1,tkClass,TCustomHintWindow,__TCustomHintWindowCreate,true,0,'AOwner: TComponent');
    DefineMethod('AutoSize',0,tkNone,nil,__TCustomHintWindowAutoSize,false,0,'');
    DefineMethod('PositionAt',1,tkNone,nil,__TCustomHintWindowPositionAt,false,0,'Point: TPoint');
    DefineMethod('PositionAtCursor',0,tkNone,nil,__TCustomHintWindowPositionAtCursor,false,0,'');
    DefineProp('HintParent',tkClass,__GetTCustomHintWindowHintParent,__SetTCustomHintWindowHintParent,TCustomHint,false,0);
    DefineProp('PopAbove',tkVariant,__GetTCustomHintWindowPopAbove,nil,nil,false,0);
    DefineProp('Title',tkVariant,__GetTCustomHintWindowTitle,nil,nil,false,0);
    DefineProp('Description',tkVariant,__GetTCustomHintWindowDescription,nil,nil,false,0);
    DefineProp('ImageIndex',tkInteger,__GetTCustomHintWindowImageIndex,nil,nil,false,0);
  end;
  With Scripter.DefineClass(TCustomHintShowHideThread) do
  begin
    DefineMethod('Create',2,tkClass,TCustomHintShowHideThread,__TCustomHintShowHideThreadCreate,true,0,'Hint: TCustomHintWindow; HintObject: TCustomHint');
    DefineMethod('Destroy',0,tkNone,nil,__TCustomHintShowHideThreadDestroy,false,0,'');
    DefineMethod('ResumeWork',0,tkNone,nil,__TCustomHintShowHideThreadResumeWork,false,0,'');
    DefineMethod('Execute',0,tkNone,nil,__TCustomHintShowHideThreadExecute,false,0,'');
    DefineMethod('HideHint',0,tkNone,nil,__TCustomHintShowHideThreadHideHint,false,0,'');
  end;
  With Scripter.DefineClass(TCustomHint) do
  begin
    DefineMethod('Create',1,tkClass,TCustomHint,__TCustomHintCreate,true,0,'AOwner: TComponent');
    DefineMethod('Destroy',0,tkNone,nil,__TCustomHintDestroy,false,0,'');
    DefineMethod('ShowHint',0,tkNone,nil,__TCustomHintShowHint,false,0,'');
    DefineMethod('HideHint',0,tkNone,nil,__TCustomHintHideHint,false,0,'');
    DefineMethod('PaintHint',1,tkNone,nil,__TCustomHintPaintHint,false,0,'HintWindow: TCustomHintWindow');
    DefineMethod('NCPaintHint',2,tkNone,nil,__TCustomHintNCPaintHint,false,0,'HintWindow: TCustomHintWindow; DC: HDC');
    DefineMethod('SetHintSize',1,tkNone,nil,__TCustomHintSetHintSize,false,0,'HintWindow: TCustomHintWindow');
    DefineProp('ShowingHint',tkVariant,__GetTCustomHintShowingHint,nil,nil,false,0);
    DefineProp('Title',tkVariant,__GetTCustomHintTitle,__SetTCustomHintTitle,nil,false,0);
    DefineProp('Description',tkVariant,__GetTCustomHintDescription,__SetTCustomHintDescription,nil,false,0);
    DefineProp('ImageIndex',tkInteger,__GetTCustomHintImageIndex,__SetTCustomHintImageIndex,nil,false,0);
  end;
  With Scripter.DefineClass(TBalloonHint) do
  begin
    DefineMethod('PaintHint',1,tkNone,nil,__TBalloonHintPaintHint,false,0,'HintWindow: TCustomHintWindow');
    DefineMethod('SetHintSize',1,tkNone,nil,__TBalloonHintSetHintSize,false,0,'HintWindow: TCustomHintWindow');
  end;
  ...
  begin
    DefineMethod('IsPositiveResult',1,tkVariant,nil,__IsPositiveResult,false,0,'AModalResult: TModalResult');
    DefineMethod('IsNegativeResult',1,tkVariant,nil,__IsNegativeResult,false,0,'AModalResult: TModalResult');
    DefineMethod('IsAbortResult',1,tkVariant,nil,__IsAbortResult,false,0,'AModalResult: TModalResult');
    DefineMethod('IsAnAllResult',1,tkVariant,nil,__IsAnAllResult,false,0,'AModalResult: TModalResult');
    DefineMethod('StripAllFromResult',1,tkEnumeration,nil,__StripAllFromResult,false,0,'AModalResult: TModalResult');
    DefineMethod('IsDragObject',1,tkVariant,nil,__IsDragObject,false,0,'Sender: TObject');
    DefineMethod('IsVCLControl',1,tkVariant,nil,__IsVCLControl,false,0,'Handle: HWND');
    DefineMethod('FindControl',1,tkClass,TWinControl,__FindControl,false,0,'Handle: HWND');
    DefineMethod('FindVCLWindow',1,tkClass,TWinControl,__FindVCLWindow,false,0,'Pos: TPoint');
    DefineMethod('FindDragTarget',2,tkClass,TControl,__FindDragTarget,false,0,'Pos: TPoint; AllowDisabled: Boolean');
    DefineMethod('GetCaptureControl',0,tkClass,TControl,__GetCaptureControl,false,0,'');
    DefineMethod('SetCaptureControl',1,tkNone,nil,__SetCaptureControl,false,0,'Control: TControl');
    DefineMethod('CancelDrag',0,tkNone,nil,__CancelDrag,false,0,'');
    DefineMethod('CursorToString',1,tkVariant,nil,__CursorToString,false,0,'Cursor: TCursor');
    DefineMethod('StringToCursor',1,tkEnumeration,nil,__StringToCursor,false,0,'S: string');
    DefineMethod('CursorToIdent',2,tkVariant,nil,__CursorToIdent,false,0,'Cursor: Longint; Ident: string').SetVarArgs([1]);
    DefineMethod('IdentToCursor',2,tkVariant,nil,__IdentToCursor,false,0,'Ident: string; Cursor: Longint').SetVarArgs([1]);
    DefineMethod('GetShortHint',1,tkVariant,nil,__GetShortHint,false,0,'Hint: string');
    DefineMethod('GetLongHint',1,tkVariant,nil,__GetLongHint,false,0,'Hint: string');
    DefineMethod('PerformEraseBackground',2,tkNone,nil,__PerformEraseBackground,false,0,'Control: TControl; DC: HDC');
    DefineMethod('PerformBufferedPrintClient',2,tkNone,nil,__PerformBufferedPrintClient,false,0,'Handle: HWND; Rect: TRect');
    DefineMethod('MouseOriginToShiftState',0,tkInteger,nil,__MouseOriginToShiftState,false,0,'');
    DefineMethod('InitWndProc',4,tkInteger,nil,__InitWndProc,false,0,'HWindow: HWND; Msg: UINT; WParam: WPARAM; LParam: LPARAM');
    DefineMethod('ChangeBiDiModeAlignment',1,tkNone,nil,__ChangeBiDiModeAlignment,false,0,'Alignment: TAlignment').SetVarArgs([0]);
    DefineMethod('SendAppMessage',3,tkInteger,nil,__SendAppMessage,false,0,'Msg: Cardinal; WParam: Longint; LParam: Longint');
    DefineMethod('MoveWindowOrg',3,tkNone,nil,__MoveWindowOrg,false,0,'DC: HDC; DX: Integer; DY: Integer');
    DefineMethod('SetImeMode',2,tkNone,nil,__SetImeMode,false,0,'hWnd: HWND; Mode: TImeMode');
    DefineMethod('SetImeName',1,tkNone,nil,__SetImeName,false,0,'Name: TImeName');
    DefineMethod('Win32NLSEnableIME',2,tkVariant,nil,__Win32NLSEnableIME,false,0,'hWnd: HWND; Enable: Boolean');
    DefineMethod('Imm32GetContext',1,tkInteger,nil,__Imm32GetContext,false,0,'hWnd: HWND');
    DefineMethod('Imm32ReleaseContext',2,tkVariant,nil,__Imm32ReleaseContext,false,0,'hWnd: HWND; hImc: HIMC');
    DefineMethod('Imm32GetConversionStatus',3,tkVariant,nil,__Imm32GetConversionStatus,false,0,'hImc: HIMC; Conversion: DWORD; Sentence: DWORD').SetVarArgs([1,2]);
    DefineMethod('Imm32SetConversionStatus',3,tkVariant,nil,__Imm32SetConversionStatus,false,0,'hImc: HIMC; Conversion: DWORD; Sentence: DWORD');
    DefineMethod('Imm32SetOpenStatus',2,tkVariant,nil,__Imm32SetOpenStatus,false,0,'hImc: HIMC; fOpen: Boolean');
    DefineMethod('Imm32SetCompositionFont',2,tkVariant,nil,__Imm32SetCompositionFont,false,0,'hImc: HIMC; lpLogfont: LOGFONT').SetVarArgs([1]);
    DefineMethod('Imm32IsIME',1,tkVariant,nil,__Imm32IsIME,false,0,'hKl: HKL');
    DefineMethod('Imm32NotifyIME',4,tkVariant,nil,__Imm32NotifyIME,false,0,'hImc: HIMC; dwAction: DWORD; dwIndex: DWORD; dwValue: DWORD');
    DefineMethod('DragDone',1,tkNone,nil,__DragDone,false,0,'Drop: Boolean');
    ...
    AddConstant('gfBegin',gfBegin);
    AddConstant('gfInertia',gfInertia);
    AddConstant('gfEnd',gfEnd);
    AddConstant('igZoom',igZoom);
    AddConstant('igPan',igPan);
    AddConstant('igRotate',igRotate);
    AddConstant('igTwoFingerTap',igTwoFingerTap);
    AddConstant('igPressAndTap',igPressAndTap);
    AddConstant('igoPanSingleFingerHorizontal',igoPanSingleFingerHorizontal);
    AddConstant('igoPanSingleFingerVertical',igoPanSingleFingerVertical);
    AddConstant('igoPanInertia',igoPanInertia);
    AddConstant('igoPanGutter',igoPanGutter);
    AddConstant('igoParentPassthrough',igoParentPassthrough);
    ...
    AddConstant('sgLeft',sgLeft);
    AddConstant('sgRight',sgRight);
    AddConstant('sgUp',sgUp);
    AddConstant('sgDown',sgDown);
    AddConstant('sgUpLeft',sgUpLeft);
    AddConstant('sgUpRight',sgUpRight);
    AddConstant('sgDownLeft',sgDownLeft);
    AddConstant('sgDownRight',sgDownRight);
    AddConstant('sgLeftUp',sgLeftUp);
    AddConstant('sgLeftDown',sgLeftDown);
    AddConstant('sgRightUp',sgRightUp);
    AddConstant('sgRightDown',sgRightDown);
    AddConstant('sgUpDown',sgUpDown);
    AddConstant('sgDownUp',sgDownUp);
    AddConstant('sgLeftRight',sgLeftRight);
    AddConstant('sgRightLeft',sgRightLeft);
    AddConstant('sgUpLeftLong',sgUpLeftLong);
    AddConstant('sgUpRightLong',sgUpRightLong);
    AddConstant('sgDownLeftLong',sgDownLeftLong);
    AddConstant('sgDownRightLong',sgDownRightLong);
    AddConstant('sgScratchout',sgScratchout);
    AddConstant('sgTriangle',sgTriangle);
    AddConstant('sgSquare',sgSquare);
    AddConstant('sgCheck',sgCheck);
    AddConstant('sgCurlicue',sgCurlicue);
    AddConstant('sgDoubleCurlicue',sgDoubleCurlicue);
    AddConstant('sgCircle',sgCircle);
    AddConstant('sgDoubleCircle',sgDoubleCircle);
    AddConstant('sgSemiCircleLeft',sgSemiCircleLeft);
    AddConstant('sgSemiCircleRight',sgSemiCircleRight);
    AddConstant('sgChevronUp',sgChevronUp);
    AddConstant('sgChevronDown',sgChevronDown);
    AddConstant('sgChevronLeft',sgChevronLeft);
    AddConstant('sgChevronRight',sgChevronRight);
    AddConstant('toPressAndHold',toPressAndHold);
    AddConstant('toPenTapFeedback',toPenTapFeedback);
    AddConstant('toPenBarrelFeedback',toPenBarrelFeedback);
    AddConstant('toTouchUIForceOn',toTouchUIForceOn);
    AddConstant('toTouchUIForceOff',toTouchUIForceOff);
    AddConstant('toTouchSwitch',toTouchSwitch);
    AddConstant('toFlicks',toFlicks);
    AddConstant('toSmoothScrolling',toSmoothScrolling);
    AddConstant('toFlickFallbackKeys',toFlickFallbackKeys);
    AddConstant('gtStandard',gtStandard);
    AddConstant('gtRecorded',gtRecorded);
    AddConstant('gtRegistered',gtRegistered);
    AddConstant('gtNone',gtNone);
    AddConstant('goUniDirectional',goUniDirectional);
    AddConstant('goSkew',goSkew);
    AddConstant('goEndpoint',goEndpoint);
    AddConstant('goRotate',goRotate);
    AddConstant('tpInteractiveGestures',tpInteractiveGestures);
    AddConstant('tpInteractiveGestureOptions',tpInteractiveGestureOptions);
    AddConstant('tpParentTabletOptions',tpParentTabletOptions);
    AddConstant('tpTabletOptions',tpTabletOptions);
    ...
    AddConstant('bhInfo',bhInfo);
    AddConstant('bhWarning',bhWarning);
    AddConstant('bhError',bhError);
    AddConstant('bhsNormal',bhsNormal);
    AddConstant('bhsLarge',bhsLarge);
    AddConstant('bhsSmall',bhsSmall);
    AddConstant('bhsStandard',bhsStandard);
    AddConstant('bhsBalloon',bhsBalloon);
    AddConstant('CM_BASE',CM_BASE);
    AddConstant('CM_CLROFFSET',CM_CLROFFSET);
    ...
    AddConstant('CM_UPDATEACTIONS',CM_UPDATEACTIONS);
    ...
    AddConstant('CM_BUFFEREDPRINTCLIENT',CM_BUFFEREDPRINTCLIENT);
    AddConstant('CM_UNTHEMECONTROL',CM_UNTHEMECONTROL);
    AddConstant('CM_DOUBLEBUFFEREDCHANGED',CM_DOUBLEBUFFEREDCHANGED);
    AddConstant('CM_PARENTDOUBLEBUFFEREDCHANGED',CM_PARENTDOUBLEBUFFEREDCHANGED);
    AddConstant('CM_THEMECHANGED',CM_THEMECHANGED);
    AddConstant('CM_GESTURE',CM_GESTURE);
    AddConstant('CM_CUSTOMGESTURESCHANGED',CM_CUSTOMGESTURESCHANGED);
    AddConstant('CM_GESTUREMANAGERCHANGED',CM_GESTUREMANAGERCHANGED);
    AddConstant('CM_STANDARDGESTURESCHANGED',CM_STANDARDGESTURESCHANGED);
    AddConstant('CM_INPUTLANGCHANGE',CM_INPUTLANGCHANGE);
    AddConstant('CM_TABLETOPTIONSCHANGED',CM_TABLETOPTIONSCHANGED);
    AddConstant('CM_PARENTTABLETOPTIONSCHANGED',CM_PARENTTABLETOPTIONSCHANGED);
    ...
    AddConstant('sgiNoGesture',sgiNoGesture);
    AddConstant('sgiLeft',sgiLeft);
    AddConstant('sgiRight',sgiRight);
    AddConstant('sgiUp',sgiUp);
    AddConstant('sgiDown',sgiDown);
    AddConstant('sgiUpLeft',sgiUpLeft);
    AddConstant('sgiUpRight',sgiUpRight);
    AddConstant('sgiDownLeft',sgiDownLeft);
    AddConstant('sgiDownRight',sgiDownRight);
    AddConstant('sgiLeftUp',sgiLeftUp);
    AddConstant('sgiLeftDown',sgiLeftDown);
    AddConstant('sgiRightUp',sgiRightUp);
    AddConstant('sgiRightDown',sgiRightDown);
    AddConstant('sgiUpDown',sgiUpDown);
    AddConstant('sgiDownUp',sgiDownUp);
    AddConstant('sgiLeftRight',sgiLeftRight);
    AddConstant('sgiRightLeft',sgiRightLeft);
    AddConstant('sgiUpLeftLong',sgiUpLeftLong);
    AddConstant('sgiUpRightLong',sgiUpRightLong);
    AddConstant('sgiDownLeftLong',sgiDownLeftLong);
    AddConstant('sgiDownRightLong',sgiDownRightLong);
    AddConstant('sgiScratchout',sgiScratchout);
    AddConstant('sgiTriangle',sgiTriangle);
    AddConstant('sgiSquare',sgiSquare);
    AddConstant('sgiCheck',sgiCheck);
    AddConstant('sgiCurlicue',sgiCurlicue);
    AddConstant('sgiDoubleCurlicue',sgiDoubleCurlicue);
    AddConstant('sgiCircle',sgiCircle);
    AddConstant('sgiDoubleCircle',sgiDoubleCircle);
    AddConstant('sgiSemiCircleLeft',sgiSemiCircleLeft);
    AddConstant('sgiSemiCircleRight',sgiSemiCircleRight);
    AddConstant('sgiChevronUp',sgiChevronUp);
    AddConstant('sgiChevronDown',sgiChevronDown);
    AddConstant('sgiChevronLeft',sgiChevronLeft);
    AddConstant('sgiChevronRight',sgiChevronRight);
    AddConstant('sgiFirst',sgiFirst);
    AddConstant('sgiLast',sgiLast);
    AddConstant('cgiFirst',cgiFirst);
    AddConstant('cgiLast',cgiLast);
    AddConstant('rgiFirst',rgiFirst);
    AddConstant('rgiLast',rgiLast);
    AddConstant('igiFirst',igiFirst);
    AddConstant('igiLast',igiLast);
    AddConstant('igiBegin',igiBegin);
    AddConstant('igiEnd',igiEnd);
    AddConstant('igiZoom',igiZoom);
    AddConstant('igiPan',igiPan);
    AddConstant('igiRotate',igiRotate);
    AddConstant('igiTwoFingerTap',igiTwoFingerTap);
    AddConstant('igiPressAndTap',igiPressAndTap);
    AddConstant('gcnRefreshAll',gcnRefreshAll);
    AddConstant('gcnAdded',gcnAdded);
    AddConstant('gcnRemoved',gcnRemoved);
    AddConstant('gcnModified',gcnModified);
    AddConstant('cImageMargin',cImageMargin);
    AddConstant('cTextVerticalMargin',cTextVerticalMargin);
    AddConstant('cTextHorizontalMargin',cTextHorizontalMargin);
    AddConstant('cBalloonStemHeight',cBalloonStemHeight);
    AddConstant('cEdgeRadius',cEdgeRadius);
