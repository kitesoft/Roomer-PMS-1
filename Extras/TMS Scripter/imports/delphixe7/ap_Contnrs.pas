...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TObjectListClass(CurrentClass.ClassRef).Create);
...
begin
  with AMachine do
  begin
AResult := Integer(TObjectList(CurrentObject).Add(TObject(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TObjectList(CurrentObject).Extract(TObject(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TObjectList(CurrentObject).ExtractItem(TObject(VarToObject(GetInputArg(0))),GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TObjectList(CurrentObject).Remove(TObject(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TObjectList(CurrentObject).RemoveItem(TObject(VarToObject(GetInputArg(0))),GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TObjectList(CurrentObject).IndexOf(TObject(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TObjectList(CurrentObject).IndexOfItem(TObject(VarToObject(GetInputArg(0))),GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TObjectList(CurrentObject).Insert(VarToInteger(GetInputArg(0)),TObject(VarToObject(GetInputArg(1))));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TObjectList(CurrentObject).First);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TObjectList(CurrentObject).Last);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TObjectList(CurrentObject).Items[VarToInteger(GetArrayIndex(0))]));
  end;
end;
...
begin
  with AMachine do
  begin
    TObjectList(CurrentObject).Items[VarToInteger(GetArrayIndex(0))]:=TObject(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TComponentList(CurrentObject).Add(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TComponentList(CurrentObject).Extract(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TComponentList(CurrentObject).ExtractItem(TComponent(VarToObject(GetInputArg(0))),GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TComponentList(CurrentObject).Remove(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TComponentList(CurrentObject).RemoveItem(TComponent(VarToObject(GetInputArg(0))),GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TComponentList(CurrentObject).IndexOf(TComponent(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := Integer(TComponentList(CurrentObject).IndexOfItem(TComponent(VarToObject(GetInputArg(0))),GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TComponentList(CurrentObject).First);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TComponentList(CurrentObject).Last);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TComponentList(CurrentObject).Insert(VarToInteger(GetInputArg(0)),TComponent(VarToObject(GetInputArg(1))));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TComponentList(CurrentObject).Items[VarToInteger(GetArrayIndex(0))]));
  end;
end;
...
begin
  with AMachine do
  begin
    TComponentList(CurrentObject).Items[VarToInteger(GetArrayIndex(0))]:=TComponent(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TOrderedListClass(CurrentClass.ClassRef).Create);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TObjectStack(CurrentObject).Push(TObject(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TObjectStack(CurrentObject).Pop);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TObjectStack(CurrentObject).Peek);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TObjectQueue(CurrentObject).Push(TObject(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TObjectQueue(CurrentObject).Pop);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TObjectQueue(CurrentObject).Peek);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomBucketList(CurrentObject).Assign(TCustomBucketList(VarToObject(GetInputArg(0))));
  end;
end;
...
0: AResult := ObjectToVar(TBucketListClass(CurrentClass.ClassRef).Create);
1: AResult := ObjectToVar(TBucketListClass(CurrentClass.ClassRef).Create(TBucketListSizes(VarToInteger(GetInputArg(0)))));
end;
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TObjectBucketList(CurrentObject).Add(TObject(VarToObject(GetInputArg(0))),TObject(VarToObject(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := ObjectToVar(TObjectBucketList(CurrentObject).Remove(TObject(VarToObject(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(ObjectToVar(TObjectBucketList(CurrentObject).Data[TObject(VarToObject(GetArrayIndex(0)))]));
  end;
end;
...
begin
  with AMachine do
  begin
    TObjectBucketList(CurrentObject).Data[TObject(VarToObject(GetArrayIndex(0)))]:=TObject(VarToObject(GetInputArg(0)));
  end;
end;
...
begin
  ...
  begin
    ...
    DefineMethod('Add',1,tkInteger,nil,__TObjectListAdd,false,0,'AObject: TObject');
    DefineMethod('Extract',1,tkClass,TObject,__TObjectListExtract,false,0,'Item: TObject');
    DefineMethod('ExtractItem',2,tkClass,TObject,__TObjectListExtractItem,false,0,'Item: TObject; Direction: TList.TDirection');
    DefineMethod('Remove',1,tkInteger,nil,__TObjectListRemove,false,0,'AObject: TObject');
    DefineMethod('RemoveItem',2,tkInteger,nil,__TObjectListRemoveItem,false,0,'AObject: TObject; ADirection: TList.TDirection');
    DefineMethod('IndexOf',1,tkInteger,nil,__TObjectListIndexOf,false,0,'AObject: TObject');
    DefineMethod('IndexOfItem',2,tkInteger,nil,__TObjectListIndexOfItem,false,0,'AObject: TObject; ADirection: TList.TDirection');
    DefineMethod('Insert',2,tkNone,nil,__TObjectListInsert,false,0,'Index: Integer; AObject: TObject');
    DefineMethod('First',0,tkClass,TObject,__TObjectListFirst,false,0,'');
    DefineMethod('Last',0,tkClass,TObject,__TObjectListLast,false,0,'');
  ...
  begin
    ...
    DefineMethod('Add',1,tkInteger,nil,__TComponentListAdd,false,0,'AComponent: TComponent');
    DefineMethod('Extract',1,tkClass,TComponent,__TComponentListExtract,false,0,'Item: TComponent');
    DefineMethod('ExtractItem',2,tkClass,TComponent,__TComponentListExtractItem,false,0,'Item: TComponent; Direction: TList.TDirection');
    DefineMethod('Remove',1,tkInteger,nil,__TComponentListRemove,false,0,'AComponent: TComponent');
    DefineMethod('RemoveItem',2,tkInteger,nil,__TComponentListRemoveItem,false,0,'AComponent: TComponent; ADirection: TList.TDirection');
    DefineMethod('IndexOf',1,tkInteger,nil,__TComponentListIndexOf,false,0,'AComponent: TComponent');
    DefineMethod('IndexOfItem',2,tkInteger,nil,__TComponentListIndexOfItem,false,0,'AComponent: TComponent; ADirection: TList.TDirection');
    ...
    DefineMethod('Insert',2,tkNone,nil,__TComponentListInsert,false,0,'Index: Integer; AComponent: TComponent');
  ...
  begin
    ...
    DefineMethod('AtLeast',1,tkVariant,nil,__TOrderedListAtLeast,false,0,'ACount: Integer');
  end;
  ...
  begin
    DefineMethod('Push',1,tkClass,TObject,__TObjectStackPush,false,0,'AObject: TObject');
  ...
  begin
    DefineMethod('Push',1,tkClass,TObject,__TObjectQueuePush,false,0,'AObject: TObject');
  ...
  begin
    ...
    DefineMethod('Assign',1,tkNone,nil,__TCustomBucketListAssign,false,0,'AList: TCustomBucketList');
  end;
  With Scripter.DefineClass(TBucketList) do
  begin
    DefineMethod('Create',1,tkClass,TBucketList,__TBucketListCreate,true,1,'ABuckets: TBucketListSizes = bl16');
  end;
  With Scripter.DefineClass(TObjectBucketList) do
  begin
    DefineMethod('Add',2,tkClass,TObject,__TObjectBucketListAdd,false,0,'AItem: TObject; AData: TObject');
    DefineMethod('Remove',1,tkClass,TObject,__TObjectBucketListRemove,false,0,'AItem: TObject');
    DefaultProperty := DefineProp('Data',tkClass,__GetTObjectBucketListData,__SetTObjectBucketListData,TObject,false,1);
  end;
  With Scripter.DefineClass(TIntegerBucketList) do
  begin
    DefineMethod('Add',2,tkInteger,nil,__TIntegerBucketListAdd,false,0,'AItem: Integer; AData: Integer');
    DefineMethod('Remove',1,tkInteger,nil,__TIntegerBucketListRemove,false,0,'AItem: Integer');
