...
//function HTMLToRTF(s:string; DefFont: TFont; ScrRTFEng: TRTFEngine): String;
...
procedure HTMLToRTFEx(s:string; FImages: TCustomImageList; ShadowOffset: Integer;
                    ...
                    ResFactor:Double;
                    URLColor,HoverColor,HoverFontColor,ShadowColor:TColor; DefFont: TFont; ScrRTFEng: TRTFEngine);
var
  su: string;
  Align: TAlignment;
      ...
      begin
        ...
        begin
          ...
          'A':begin
                if Anchor then
                begin
                  ScrRTFEng.AddHyperLink(LastAnchor, AnchorText, URLFont);
                  ScrRTFEng.AddFont(DefFont);
                  ScrRTFEng.AddForeColor(DefFont.Color);
                  if ScrRTFEng.FonSize <> DefFont.Size*2 then
                    ScrRTFEng.AddFontSize(DefFont.Size*2);
                  Anchor := False;
                end;
          ...
          'B':begin
                 if (s[4] <> '>') and (ScrRTFEng.ForeColor <> clBlack) then
                  ScrRTFEng.AddForeColor(DefFont.Color)
                else
                  ScrRTFEng.AddBold(False);
              end;
          'S':begin
                TagChar := UpCase(s[4]);
          ...
          'I':begin
                ScrRTFEng.AddItalic(False);
              end;
          'L':begin
                LineBreak := True;
                ScrRTFEng.AddNewLine;
              end;
          'P':begin
                LineBreak := True;
                if not Calc then
        ...
        begin
          ...
          'U':begin
                ...
                begin
                  Inc(ListIndex);
                  LineBreak := True;
                  ScrRTFEng.StartBullet;
                  FrstBullet := True;
                end
                else
                  ScrRTFEng.AddUnderLine(True);
              end;
          'P':begin
        ...
        'F':begin
              ...
              begin
                ...
                begin
                  ...
                  begin
                    if Prop[1] = '#' then
                      ...
                      ScrRTFEng.AddForeColor(Hex2Color(Prop))
                    else
                      ScrRTFEng.AddForeColor(Text2Color(AnsiLowerCase(prop)));//Canvas.Font.Color := Text2Color(AnsiLowerCase(prop));
                  end;
                ...
                begin
                  ...
                  1:ScrRTFEng.AddFontSize(8*2);
                  2:ScrRTFEng.AddFontSize(10*2);
                  3:ScrRTFEng.AddFontSize(12*2);
                  4:ScrRTFEng.AddFontSize(14*2);
                  5:ScrRTFEng.AddFontSize(16*2);
                  else
                    ScrRTFEng.AddFontSize(IStrToInt(Prop)*2);
                  end;
                end;
              end;
            end;
...
procedure HTMLToRTF(s:string; DefFont: TFont; ScrRTFEng: TRTFEngine);
begin
  HTMLToRTFEx(S, ScrRTFEng.Images, 0, False, False,False,False,False, False, 0, clBlue, clRed, clYellow, clGray, DefFont, ScrRTFEng);
end;
