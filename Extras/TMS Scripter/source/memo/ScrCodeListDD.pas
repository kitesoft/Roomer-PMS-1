...
type
  ...
  TAdvCodeListDropTarget = class (TInterfacedObject, IDropTarget)
  ...
  TAdvCodeListDropSource = class (TInterfacedObject, IDropSource)
  private
    fNoAccept:boolean;
  public
...
constructor TAdvCodeListDropTarget.Create;
begin
 inherited Create;
end;

function TAdvCodeListDropTarget.DragEnter (const DataObj: IDataObject; grfKeyState: Longint; pt: TPoint; var dwEffect: Longint): HResult;
begin
...
function TAdvCodeListDropTarget.DragOver (grfKeyState: Longint; pt: TPoint; var dwEffect: Longint): HResult;
var
 allow:boolean;
begin
  if FOk then
...
function TAdvCodeListDropTarget.DragLeave: HResult;
begin
  Result := NOERROR
end;

function TAdvCodeListDropTarget.Drop (const DataObj: IDataObject; grfKeyState: Longint; pt: TPoint; var dwEffect: Longint): HResult;
begin
  if FOk then
  begin
    with TEnumFormats.Create(DataObj) do
...
procedure TAdvCodeListDropTarget.DropText(pt:tpoint;s:string);
begin
end;

procedure TAdvCodeListDropTarget.DropRTF(pt:tpoint;s:string);
begin
end;

procedure TAdvCodeListDropTarget.DropFiles(pt:tpoint;files:tstrings);
begin
end;

procedure TAdvCodeListDropTarget.DragMouseMove(pt: TPoint; var Allow: boolean);
begin
 allow:=true;
end;
...
function TAdvCodeListDropSource.QueryContinueDrag(fEscapePressed: BOOL; grfKeyState: Longint): HResult;
//-------------------------------------------------------
Begin
  Result := S_OK;
...
function TAdvCodeListDropSource.GiveFeedback(dwEffect: Longint): HResult;
Begin
