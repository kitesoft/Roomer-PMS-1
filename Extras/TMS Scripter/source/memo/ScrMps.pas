...
type
  ...
  {$ENDIF}
  TScrPascalMemoStyler = class(TScrCustomMemoStyler)
  private
    FVersion: string;
  public
...
constructor TScrPascalMemoStyler.Create(AOwner: TComponent);
var
  itm:TElementStyle;
begin
  inherited;
...
procedure TScrPascalMemoStyler.LoadFromDelphiSettings;
var
  r: TRegistry;
  fg,bk: string;
  rkey: string;
