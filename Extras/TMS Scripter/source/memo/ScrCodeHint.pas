...
uses
  Windows, Classes, Controls, Forms, Messages, Graphics, SysUtils, ScrCodeListLib,
  ScrMemo, Types;
...
procedure SetActiveStyler(AStyler: TScrCustomMemoStyler);
...
var
  ...
  ST: TStringList;
  i, allb: integer;
  InternalStyles: TScrCustomMemoStyler; //TScrPascalMemoStyler;
  ...
  function FindAdvCodeListControl: TScrCodeList;
  var
    I: Integer;
  begin
    Result := nil;
    ...
    for I := 0 to ComponentCount-1 do
      if Components[I] is TScrCodeList then
      begin
        Result := TScrCodeList(Components[I]);
        Break;
      end;
  end;
