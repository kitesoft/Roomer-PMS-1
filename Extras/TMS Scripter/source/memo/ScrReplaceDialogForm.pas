...
type
  ...
  TScrReplaceDlgForm = class(TForm)
    Label1: TLabel;
    ComboBox1: TComboBox;
  ...
  protected
    ...
    function CreateDialogForm(AOwner: TComponent): TScrReplaceDlgForm; virtual;
    function InitDialog: TCustomForm; virtual;
  public
    procedure Execute; virtual;
    constructor Create(AOwner: TComponent); override;
    destructor Destroy; override;
    property Form: TScrReplaceDlgForm read Frm;
  published
...
var
  ReplaceDialogForm: TScrReplaceDlgForm;
  More: Boolean;
  FPrevCap: String;
...
function TAdvReplaceDialog.CreateDialogForm(
  AOwner: TComponent): TScrReplaceDlgForm;
begin
  Result := TScrReplaceDlgForm.Create(AOwner);
end;
...
var
  frm: TScrReplaceDlgForm;
begin
  frm := InitDialog as TScrReplaceDlgForm;
...
procedure TScrReplaceDlgForm.abCharacter1Click(Sender: TObject);
begin
  ComboBox1.Text := ComboBox1.Text + '\t';
end;

procedure TScrReplaceDlgForm.aggedExpression1Click(Sender: TObject);
begin
  ComboBox1.Text := ComboBox1.Text + '()';
end;

procedure TScrReplaceDlgForm.AnyCharacter1Click(Sender: TObject);
begin
  ComboBox1.Text := ComboBox1.Text + '.';
end;

procedure TScrReplaceDlgForm.BeginningofLine1Click(Sender: TObject);
begin
  ComboBox1.Text := ComboBox1.Text + '^';
end;

procedure TScrReplaceDlgForm.FindBtnClick(Sender: TObject);
begin
  if Assigned(OnFind) then
    OnFind(Self);
end;

procedure TScrReplaceDlgForm.ReplaceBtnClick(Sender: TObject);
begin
  if Assigned(OnReplace) then
    OnReplace(Self);
end;

procedure TScrReplaceDlgForm.ReplaceAllBtnClick(Sender: TObject);
begin
  if Assigned(OnReplaceAll) then
    OnReplaceAll(Self);
end;

procedure TScrReplaceDlgForm.CloseBtnClick(Sender: TObject);
begin
  Close;
end;

procedure TScrReplaceDlgForm.MoreBtnClick(Sender: TObject);
var
...
procedure TScrReplaceDlgForm.CharacterinRange1Click(Sender: TObject);
begin
  ComboBox1.Text := ComboBox1.Text + '[]';
end;

procedure TScrReplaceDlgForm.CharacternotinRange1Click(Sender: TObject);
begin
  ComboBox1.Text := ComboBox1.Text + '[^]';
end;

procedure TScrReplaceDlgForm.CheckBox1Click(Sender: TObject);
begin
...
procedure TScrReplaceDlgForm.CheckBox2Click(Sender: TObject);
begin
...
procedure TScrReplaceDlgForm.CheckBox4Click(Sender: TObject);
begin
...
procedure TScrReplaceDlgForm.CheckBox5Click(Sender: TObject);
begin
...
procedure TScrReplaceDlgForm.ComboBox1Change(Sender: TObject);
var
  s: string;
begin
  s := ComboBox1.Text;
...
procedure TScrReplaceDlgForm.ComboBox2Change(Sender: TObject);
var
  s: string;
begin
  s := ComboBox2.Text;
...
procedure TScrReplaceDlgForm.DoFindEditChange(var AText: string);
begin
  if Assigned(FOnFindEditChange) then
    FOnFindEditChange(Self, AText);
end;

procedure TScrReplaceDlgForm.DoReplaceEditChange(var AText: string);
begin
  if Assigned(FOnReplaceEditChange) then
    FOnReplaceEditChange(Self, AText);
end;

procedure TScrReplaceDlgForm.EnableButtons;
begin
...
procedure TScrReplaceDlgForm.EndofLine1Click(Sender: TObject);
begin
  ComboBox1.Text := ComboBox1.Text + '$';
end;

procedure TScrReplaceDlgForm.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  if Assigned(OnClose) then
    OnClose(Self);
end;

procedure TScrReplaceDlgForm.FormCreate(Sender: TObject);
var
  DialogUnits: TPoint;
begin
  More := False;
...
procedure TScrReplaceDlgForm.FormShow(Sender: TObject);
begin
...
function TScrReplaceDlgForm.GetFindText: String;
begin
  if not More then
...
function TScrReplaceDlgForm.GetReplaceText: String;
begin
  if not More then
...
procedure TScrReplaceDlgForm.Memo1Change(Sender: TObject);
var
  s: string;
begin
  s := Memo1.Lines.Text;
...
procedure TScrReplaceDlgForm.N0or1matches1Click(Sender: TObject);
begin
  ComboBox1.Text := ComboBox1.Text + '*';
end;

procedure TScrReplaceDlgForm.N0or1Matches2Click(Sender: TObject);
begin
  ComboBox1.Text := ComboBox1.Text + '?';
end;

procedure TScrReplaceDlgForm.N1orMoreMatches1Click(Sender: TObject);
begin
  ComboBox1.Text := ComboBox1.Text + '+';
end;

procedure TScrReplaceDlgForm.NewLine1Click(Sender: TObject);
begin
  ComboBox1.Text := ComboBox1.Text + '\n';
end;

procedure TScrReplaceDlgForm.Or1Click(Sender: TObject);
begin
  ComboBox1.Text := ComboBox1.Text + '|';
end;

procedure TScrReplaceDlgForm.RangeGroupClick(Sender: TObject);
begin
...
procedure TScrReplaceDlgForm.SetFindText(const Value: String);
begin
  if not More then
...
procedure TScrReplaceDlgForm.SetReplaceText(const Value: String);
begin
  if not More then
...
procedure TScrReplaceDlgForm.SpeedButton1Click(Sender: TObject);
var
   p : TPoint;
begin
