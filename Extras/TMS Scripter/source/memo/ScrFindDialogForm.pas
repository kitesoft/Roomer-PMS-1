...
type
  ...
  protected
    ...
    function CreateDialogForm(AOwner: TComponent): TScrFindDlgForm; virtual;
  ...
  public
    ...
    procedure Assign(Source: TPersistent); override;
    property Form: TScrFindDlgForm read Frm;
  published
...
var
  FindDialogForm: TScrFindDlgForm;
  More: Boolean;
...
function TAdvFindDialog.CreateDialogForm(AOwner: TComponent): TScrFindDlgForm;
begin
  Result := TScrFindDlgForm.Create(AOwner);
end;
...
var
  frm: TScrFindDlgForm;
begin
  frm := InitDialog as TScrFindDlgForm;
...
procedure TScrFindDlgForm.abCharacter1Click(Sender: TObject);
begin
...
procedure TScrFindDlgForm.aggedExpression1Click(Sender: TObject);
begin
  ComboBox1.Text := ComboBox1.Text + '()';
end;
...
procedure TScrFindDlgForm.AnyCharacter1Click(Sender: TObject);
begin
  ComboBox1.Text := ComboBox1.Text + '.';
end;
...
procedure TScrFindDlgForm.BeginningofLine1Click(Sender: TObject);
begin
  ComboBox1.Text := ComboBox1.Text + '^';
end;
...
procedure TScrFindDlgForm.FindBtnClick(Sender: TObject);
begin
  if Assigned(OnFind) then
    OnFind(Self);
...
procedure TScrFindDlgForm.PrevBtnClick(Sender: TObject);
begin
  if Assigned(OnFindPrevious) then
    OnFindPrevious(Self);
end;
...
procedure TScrFindDlgForm.MarkerClick(Sender: TObject);
begin
  if Assigned(OnSetMarker) then
    OnSetMarker(Self);
end;
...
procedure TScrFindDlgForm.Memo1Change(Sender: TObject);
var
  s: string;
begin
  s := Memo1.Lines.Text;
...
procedure TScrFindDlgForm.CloseBtnClick(Sender: TObject);
begin
  Close;
end;
...
procedure TScrFindDlgForm.UpdateMoreButton(const AValue: string);
begin
...
procedure TScrFindDlgForm.MoreBtnClick(Sender: TObject);
var
...
procedure TScrFindDlgForm.CharacterinRange1Click(Sender: TObject);
begin
  ComboBox1.Text := ComboBox1.Text + '[]';
end;
...
procedure TScrFindDlgForm.CharacternotinRange1Click(Sender: TObject);
begin
  ComboBox1.Text := ComboBox1.Text + '[^]';
end;
...
procedure TScrFindDlgForm.CheckBox1Click(Sender: TObject);
begin
...
procedure TScrFindDlgForm.CheckBox2Click(Sender: TObject);
begin
...
procedure TScrFindDlgForm.CheckBox3Click(Sender: TObject);
begin
  if CheckBox3.Checked then
...
procedure TScrFindDlgForm.CheckBox4Click(Sender: TObject);
begin
...
procedure TScrFindDlgForm.CheckBox5Click(Sender: TObject);
begin
...
procedure TScrFindDlgForm.CheckBox6Click(Sender: TObject);
begin
...
procedure TScrFindDlgForm.ComboBox1Change(Sender: TObject);
var
  s: string;
begin
  s := ComboBox1.Text;
...
procedure TScrFindDlgForm.EnableButtons;
begin
...
procedure TScrFindDlgForm.DirGroupClick(Sender: TObject);
begin
...
procedure TScrFindDlgForm.DoFindEditChange(var AText: string);
begin
  if Assigned(FOnFindEditChange) then
    FOnFindEditChange(Self, AText);
end;
...
procedure TScrFindDlgForm.EndofLine1Click(Sender: TObject);
begin
  ComboBox1.Text := ComboBox1.Text + '$';
end;
...
procedure TScrFindDlgForm.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  if Assigned(OnClose) then
    OnClose(Self);
end;
...
procedure TScrFindDlgForm.FormCreate(Sender: TObject);
begin
  More := False;
end;
...
procedure TScrFindDlgForm.FormShow(Sender: TObject);
begin
...
function TScrFindDlgForm.GetFindText: String;
begin
  if not More then
...
procedure TScrFindDlgForm.N0or1matches1Click(Sender: TObject);
begin
  ComboBox1.Text := ComboBox1.Text + '*';
end;
...
procedure TScrFindDlgForm.N0or1Matches2Click(Sender: TObject);
begin
  ComboBox1.Text := ComboBox1.Text + '?';
end;
...
procedure TScrFindDlgForm.N1orMoreMatches1Click(Sender: TObject);
begin
  ComboBox1.Text := ComboBox1.Text + '+';
end;
...
procedure TScrFindDlgForm.NewLine1Click(Sender: TObject);
begin
  ComboBox1.Text := ComboBox1.Text + '\n';
end;
...
procedure TScrFindDlgForm.Or1Click(Sender: TObject);
begin
  ComboBox1.Text := ComboBox1.Text + '|';
end;
...
procedure TScrFindDlgForm.SetFindText(const Value: String);
begin
  if not More then
...
procedure TScrFindDlgForm.SpeedButton1Click(Sender: TObject);
var
   p : TPoint;
begin
