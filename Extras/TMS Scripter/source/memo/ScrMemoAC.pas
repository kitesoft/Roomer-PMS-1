...
procedure TACMemo.StringGrid1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TACMemo.SpeedButton1Click(Sender: TObject);
begin
  StringGrid1.RowCount := StringGrid1.RowCount + 1;

end;

procedure TACMemo.SpeedButton2Click(Sender: TObject);
begin
...
procedure TACMemo.FormCreate(Sender: TObject);
begin
