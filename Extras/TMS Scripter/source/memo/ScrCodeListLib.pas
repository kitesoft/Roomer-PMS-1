...
uses
  Windows,Graphics, Classes, SysUtils, ScrMemo, Types
  {$IFDEF DELPHIXE3_LVL}
  , System.UITypes
  {$ENDIF}
  ;
...
procedure DrawCustomLine(ACanvas: TCanvas; Caption: String; var style: TStyle;DM: TDrawMode; PR: TRect; InternalStyles: TScrCustomMemoStyler; Delimiters, NoStart, NoHex, tmpNo: String);
