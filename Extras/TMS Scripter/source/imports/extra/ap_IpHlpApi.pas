...
{$IFDEF ENABLE_IMPORT}
  ...
  {$ELSE}
    ...
    {$IF CompilerVersion >= 28}
      {$I ..\..\..\imports\delphixe7\ap_IpHlpApi.pas}
    {$ELSEIF CompilerVersion >= 27}
      {$I ..\..\..\imports\delphixe6\ap_IpHlpApi.pas}
    {$ELSEIF CompilerVersion >= 26}
      {$I ..\..\..\imports\delphixe5\ap_IpHlpApi.pas}
    {$ELSEIF CompilerVersion >= 25}
      {$I ..\..\..\imports\delphixe4\ap_IpHlpApi.pas}
    {$ELSEIF CompilerVersion >= 24}
      {$I ..\..\..\imports\delphixe3\ap_IpHlpApi.pas}
    {$ELSEIF CompilerVersion >= 23}
      {$I ..\..\..\imports\delphixe2\ap_IpHlpApi.pas}
    {$ELSEIF CompilerVersion >= 22}
      {$I ..\..\..\imports\delphi2011\ap_IpHlpApi.pas}
