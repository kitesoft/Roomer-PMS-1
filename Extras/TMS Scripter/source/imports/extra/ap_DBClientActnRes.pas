...
{$IFDEF ENABLE_IMPORT}
  {$IFDEF VER150}
    {$I ..\..\..\imports\delphi7\ap_DBClientActnRes.pas}
  {$ELSE}
    ...
    {$ELSEIF CompilerVersion >= 21}
      {$I ..\..\..\imports\delphi2010\ap_DBClientActnRes.pas}
    {$ELSEIF CompilerVersion >= 20}
      {$I ..\..\..\imports\delphi2009\ap_DBClientActnRes.pas}
    {$ELSEIF CompilerVersion >= 18.5}
      {$I ..\..\..\imports\delphi2007\ap_DBClientActnRes.pas}
    {$IFEND}
  {$ENDIF}
{$ELSE}
  interface implementation end.
