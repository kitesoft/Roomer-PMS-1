...
type
  ...
  public
    ...
    ///  The instance of the object which holds the property.
    /// </param>
    ///  <param name="APropData">
    ///  The TCustomPropData object which will be used to emulate a custom virtual property.
    /// </param>
    ///  <param name="ARoot">
    ///  The root object of the property. Usually the owner form of the component instance. See Root property.
    /// </param>
    ///  <param name="APropInfo">
    ///  The RTTI prop info of the property. If this parameter is not provided, the property will be considered as emulated.
    /// </param>
    ///  <param name="AOwner">
    ///  The TPropertyList object which owns this TProperty object
    /// </param>
    ...
    ///  </summary>
    ///  <param name="Source">
    ///  The source property from which the values will be copied. 
    /// </param>
    ...
    ///  </summary>
    ///  <param name="Value">
    ///  The string value which will be set to the property.
    /// </param>
    ///  <remarks>
    ...
    ///  </summary>
    ///  <param name="AObject">
    ///  The object which will be checked for compatibility with the property.
    /// </param>
    ///  <remarks>
    ...
    ///  </summary>
    ///  <param name="AObject">
    ///  The type which will be checked for compatibility with the property.
    /// </param>
    ///  <remarks>
    ...
    ///  </summary>
    ///  <param name="ATypeInfo">
    ///  The type info for which the property will be checked to be the same type
    /// </param>
    ///  <remarks>
    ...
    ///  </summary>
    ///  <param name="P">
    ///  The property which will be checked to be compatible with this one.
    /// </param>
    ///  <remarks>
    ...
    ///    1. the one created internally by the property list, and the ones that were registered by the application as virtual properties,
    ///    using RegisterCustomProperty method. This can be verified using the Custom property.
    /// 
    ///    2. The emulated properties created internally are for example the subproperties for variant and set properties.
  ...
  ///  </summary>
  ///  <param name="P1">
  ///  First property to be compared.
  /// </param>
  ///  <param name="P2">
  ///  Second property to be compared.
  /// </param>
  ///  <returns>
  ...
  public
    ...
    ///  </summary>
    ///  <param name="APropInfo">
    ///  the RTTI PPropInfo of the property. If nil, then you must provide the custom data to create a custom property.
    /// </param>
    ///  <param name="APropData">
    ///  The TCustomPropData used to create a Custom property.
    /// </param>
    ///  <remarks>
    ...
    ///  </summary>
    ///  <param name="P">
    ///  The property ot be checked for filtering.
    /// </param>
    ///  <returns>
...
///  </summary>
///  <param name="AGetProc">
///  A reference to a procedure that will implement the property Getter.
/// </param>
///  <param name="ADescendants">
///  If true, the new property will appear in objects of the specified class, and also objects descending of
...
/// </param>
///  <param name="APropType">
///  The PTypeInfo information about the property. This will hold the actual data type of the property.
/// </param>
///  <param name="APropName">
///  The name of the new property.
/// </param>
///  <param name="ASetProc">
///  A reference to a procedure that will implement the property Setter.
/// </param>
///  <param name="AInstanceType">
///  The class for which the custom property will be registered.
/// </param>
///  <remarks>
...
///  </summary>
///  <param name="APropName">
///  The name of registered property.
/// </param>
///  <param name="AInstanceType">
///  The class reference for which the custom property will be checked.
/// </param>
///  <returns>
...
/// </param>
///  <param name="AInstanceType">
///  The class reference for which the property has been registered.
/// </param>
...
const
  ModalResults: array[mrNone..mrYesToAll] of TIdentMapEntry = (
    ...
    (Value: mrHelp; Name: 'mrHelp'),
    (Value: mrTryAgain; Name: 'mrTryAgain'),
    (Value: mrContinue; Name: 'mrContinue'),
    {$ENDIF}
...
begin
  ...
  begin
    ...
    {$IFDEF DELPHIXE2_LVL}
    if TypeKind=tkClass then SetOrdProp(Instance,FPropInfo,NativeInt(Value));
    {$ELSE}
...
begin
  ...
  begin
    ...
    {$IFDEF DELPHIXE2_LVL}
    Result := IntToStr(NativeInt(Value));
    {$ELSE}
...
begin
  ...
  if (not IsType(TypeInfo(TMenuItem))) or (Uppercase(Name) = 'WINDOWMENU') then
    ...
    begin
      ...
      result := TObject(Pointer(StrToInt64(Value)));
end;
...
//    {$IFNDEF CPUX64}
//    {$IFNDEF DELPHIXE7_LVL}
//    if (Instance is TDataSet) and IsPublishedProp(Instance, 'DatabaseName') then
