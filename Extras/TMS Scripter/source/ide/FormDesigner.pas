...
type
  ...
  public
    ...
    /// </param>
    ///  <param name="ADesigner">
    ///  The form designer that will use the container.
    /// </param>
    ///  <param name="AOwner">
    ///  Specifies the control's owner.
    /// </param>
    ///  <param name="AComponent">
    ///  The component to be represented by the TComponentContainer.
    /// </param>
    ///  <remarks>
  ...
  public
    ...
    ///  </summary>
    ///  <param name="MustHide">
    ///  If true, all grab handles will become invisible. If false, then the visibility of handles will depend on the designer state.   
    /// </param>
    ///  <remarks>
    ...
    ///  </summary>
    ///  <param name="AHandle">
    ///  Window handle of the grab handle control.
    /// </param>
    ///  <remarks>
    ...
    ///  </summary>
    ///  <param name="AControl">
    ///  The control that will be verified to be a grab handle.
    /// </param>
    ///  <remarks>
  ...
  ///  The reference to the TControl object. Please note that the control can be a TComponentContainer, in this case
  ...
  ///  The reference to the TComponent object.
  /// </param>
  ///  <param name="Sender">
  ///  Object firing the event.
  /// </param>
  ...
  ///  </summary>
  ///  <param name="Msg">
  ///  Record containg the message to be handle.
  /// </param>
  ///  <param name="Sender">
  ///  Object firing the event.
  /// </param>
  ...
  ///  </summary>
  ///  <param name="TheControl">
  ///  The control object being moved. Be sure to check if the control is a TComponentContainer.
  /// </param>
  ///  <param name="LimitRect">
  ///  Set this parameter to provide the rectangle in which the control can be moved.
  /// </param>
  ///  <param name="Sender">
  ///  Object firing the event.
  /// </param>
  ...
  ///  </summary>
  ///  <param name="MaxSize">
  ///  Set this parameter to provide the maximum width (X) and height (Y) for the control.
  /// </param>
  ///  <param name="Sender">
  ///  Object firing the event.
  /// </param>
  ///  <param name="MinSize">
  ///  Set this parameter to provide the minimum width (X) and height (Y) for the control.
  /// </param>
  ///  <param name="TheControl">
  ///  The control object being resized. Be sure to check if the control is a TComponentContainer.
  /// </param>
  ///  <remarks>
  ...
  ///  </summary>
  ///  <param name="VisibleGrabs">
  ///  Set this parameter to specify which grab handles will be visible in the form designer. 
  /// </param>
  ///  <param name="EnabledGrabs">
  ///  Set this parameter to specify which grab handles will be enabled in the form designer.
  /// </param>
  ///  <param name="Sender">
  ///  Object firing the event.
  /// </param>
  ...
  ///  </summary>
  ///  <param name="Text">
  ///  Must receive the text associated with the component.
  /// </param>
  ///  <param name="TheComponent">
  ///  The TComponent object for which the text will be associated.
  /// </param>
  ///  <param name="Sender">
  ///  Object firing the event.
  /// </param>
  ...
  ///  </summary>
  ///  <param name="Bitmap">
  ///  The bitmap object associated with the component. You don't need to create/destroy the bitmap, just update its content. 
  /// </param>
  ///  <param name="TheComponent">
  ///  The component for which the bitmap will be associated.
  /// </param>
  ///  <param name="Sender">
  ///  Object firing the event.
  /// </param>
  TComponentBitmapEvent = procedure(Sender: TObject; TheComponent: TComponent; const Bitmap: TBitmap;
  ...
  ///  </summary>
  ///  <param name="Editable">
  ///  Set this parameter to specify if the non-visual component can be edited (is visible) in the form designer. 
  /// </param>
  ///  <param name="TheComponent">
  ///  A reference for the non-visual component belonging to the form.
  /// </param>
  ///  <param name="Sender">
  ///  Object firing the event.
  /// </param>
  ...
  ///  </summary>
  ///  <param name="TheComponent">
  ///  The TComponent object being copied or pasted.
  /// </param>
  ///  <param name="Sender">
  ///  Object firing the event.
  /// </param>
  ...
  ///  </summary>
  ///  <param name="Handled">
  ///  Set Handled to true if you have performed your custom operation and don't want the default popup menu to 
  ...
  ///  Must receive the desired edit behaviour for the component.
  /// </param>
  ///  <param name="TheComponent">
  ///  The component object which edit behavior will be set.
  /// </param>
  ///  <param name="Sender">
  ///  Object firing the event.
  /// </param>
  ...
  ///  <summary>
  ///    Events of this type allows the programmer to provide a self created component of TComponentClass
  ///    or to do something before the component is created.
  ///  </summary>
  ///  <param name="AComponentClass">
  ///  The needed component class.
  /// </param>
  ///  <param name="Sender">
  ///  Object firing the event.
  /// </param>
  TCreateComponentClassEvent = procedure(Sender: TObject; AComponentClass: TComponentClass; var AComponent: TComponent) of object;
  ...
  private
    ...
    FOnCreateComponentClass: TCreateComponentClassEvent;
    ...
    procedure PerformComponentPlacing(AParentControl: TWinControl;
      APlacingRect: TRect);
  protected
    procedure DoCopyComponent(Writer: TWriter; Comp: TComponent); virtual;
    procedure DoPasteComponent(Stream: TStream; Comp: TComponent); virtual;
    procedure DoComponentBitmap(Comp: TComponent; ABitmap: TBitmap; var Handled: boolean); virtual;
    ///  <summary>
    ///    Retrieves the TIDEComponentEditor object (if any) registered for a component being edited.
    ///  </summary>
    ///  <param name="AComp">
    ///  The component for which the component editor will be provided.
    /// </param>
    ///  <remarks>
    ...
    ///  </returns>
    function GetIDEComponentEditor(AComp: TComponent): TIDEComponentEditor; virtual;
    ...
    ///  <summary>
    ///    NotifyChange method is called when the form content has changed (a control was moved, resized, deleted, etc.).
    ///    The AOperationName indicate the operation performed in the designer (move, paste, etc.)
    ///  </summary>
    procedure NotifyChange(AOperationName: string); virtual;
    ...
    ///  </summary>
    ///  <param name="AControl">
    ///  The control which has been added to the selection.
    /// </param>
    ...
    ///  </summary>
    ///  <param name="AControl">
    ///  The control which has been removed from the selection.
    /// </param>
    ...
    ///  </summary>
    ///  <param name="AControl">
    ///  The control which has been double clicked.
    /// </param>
    ...
    ///  </summary>
    ///  <param name="AComponent">
    ///  the component that is about to be placed in the form.
    /// </param>
    ...
    ///  </summary>
    ///  <param name="AComponent">
    ///  the component that has been placed in the form.
    /// </param>
    ...
    ///  </summary>
    ///  <param name="AControl">
    ///  the control for which the edit behavior will be retrieved.
    /// </param>
    ///  <returns>
    ...
    ///  <summary>
    ///    This event is fired when a component class is needed and has to be created. If the event does not return a result
    ///    the component is created internally.
    ///  </summary>
    property OnCreateComponentClass: TCreateComponentClassEvent read FOnCreateComponentClass write FOnCreateComponentClass;
  ...
  public
    ...
    ///  If true, the method returns the next control. If false, the method returns the previous control.
    /// </param>
    ///  <returns>
    ...
    ///  </summary>
    ///  <param name="P">
    ///  The position in which the control will be searched. This value must be in parent's coordinates, (0, 0) being the
    ///        the upper left of the specified control.
    /// </param>
    ///  <param name="AParent">
    ///  Specifies the parent control containing the controls to be searched. The method will only look "inside"
    ...
    ///  </summary>
    ///  <param name="AComponent">
    ///  The non-visual component for which we want to find the component container.
    /// </param>
    ///  <returns>
    ...
    /// </param>
    ///  <param name="DFMFormat">
    ///  Indicates the file format, binary or text.
    /// </param>
    ...
    ///  </summary>
    ///  <param name="Stream">
    ///  The stream used to save the component to.
    /// </param>
    ///  <param name="Component">
    ///  The component to be saved to the stream.
    /// </param>
    ///  <param name="DFMFormat">
    ///  The format of content to be saved to stream.
    /// </param>
    ...
    ///  </summary>
    ///  <param name="Stream">
    ///  The stream used to load the component from.
    /// </param>
    ///  <param name="Component">
    ///  The component to be loaded from the stream.
    /// </param>
    ///  <param name="DFMFormat">
    ///  The format of content to be loaded from the stream.
    /// </param>
    ...
    ///  </summary>
    ///  <param name="Stream">
    ///  The stream object where the form will be saved to.
    /// </param>
    ///  <param name="DFMFormat">
    ///  Indicates the content format, binary or text.
    /// </param>
    ...
    ///  </summary>
    ///  <param name="Stream">
    ///  The stream object where the form will be loaded from.
    /// </param>
    ///  <param name="DFMFormat">
    ///  Indicates the content format, binary or text.
    /// </param>
    ...
    ///  </summary>
    ///  <param name="AComponent">
    ///  The component to be converted to a string.
    /// </param>
    ///  <returns>
    ...
    ///  </summary>
    ///  <param name="Props">
    ///  A string containing the component properties previously saved.
    /// </param>
    ///  <param name="AComponent">
    ...
    ///  </summary>
    ///  <param name="TheControl">
    ///  Control to be aligned to the grid.
    /// </param>
    ...
    ///  </summary>
    ///  <param name="Ver">
    ///  Alignment rule for vertical alignment.
    /// </param>
    ///  <param name="Hor">
    ///  Alignment rule for horizontal alignment.
    /// </param>
    ...
    ///  </summary>
    ///  <param name="WValue">
    ///  Value of the new width, used only if WMode is smValue.
    /// </param>
    ///  <param name="HMode">
    ///  Resize rule for height.
    /// </param>
    ///  <param name="WMode">
    ///  Resize rule for width.
    /// </param>
    ///  <param name="HValue">
    ///  Value of the new height, used only if HMode is smValue.
    /// </param>
    ...
    ///  </summary>
    ///  <param name="AComponent">
    ///  The component to be unselected.
    /// </param>
    ///  <remarks>
    ...
    ///  </summary>
    ///  <param name="AControl">
    ///  The control for which the index will be returned.
    /// </param>
    ///  <remarks>
    ...
    ///  </summary>
    ///  <param name="Canvas">
    ///  The canvas where the grab handles show be drawn.
    /// </param>
    ///  <param name="R">
    ///  The rect position/size of the grab handles.
    /// </param>
    ///  <param name="GrabType">
    ///  The current type/state of the grab handle.
    /// </param>
    ///  <remarks>
    ...
    ///  name of the class of the component to be created.
    /// </param>
    ///  <returns>
    ///    The instantiated component.
    ///  </returns>
    ...
    ///  </summary>
    ///  <param name="AComponentClass">
    ///  the class of the component to be placed when the placing operation is finished. The
    ...
    ///    Starts a component placing operation in the designer.
    ///  </summary>
    ///  <param name="AComponentClassName">
    ///  the name of the class of the component to be placed when the placing operation is finished. The
    ///                          component is only instantiated when the place operation is performed.
    /// </param>
    ///  <remarks>
    ...
    ///  </summary>
    ///  <param name="AComponent">
    ///  The component for which the hint will be displayed.
    /// </param>
    ///  <returns>
    ...
    ///  </summary>
    ///  <param name="AComponent">
    ///  The component for which the caption will be displayed.
    /// </param>
    ///  <returns>
    ...
    property GridStepPixel: Integer read FGridStepPixel write FGridStepPixel default 1;
  ...
  published
    ...
    property OnCreateComponentClass;
  end;
  ...
  protected
    ...
    ///  </summary>
    ///  <param name="Index">
    ///  The index of the menu item clicked by the end-user.
    /// </param>
    ...
    ///  </summary>
    ///  <param name="Index">
    ///  the index of the menu item for which the caption will be provided.
    /// </param>
    ///  <returns>
...
///  The class of the component editor to be registered for the specified component.
/// </param>
///  <param name="ComponentClass">
///  The class of the component for which the component editor will be registered.
/// </param>
///  <remarks>
...
begin
  ...
  begin
    ...
    if Assigned(FDesigner) then
      FDesigner.DoComponentBitmap(FComponent, FBitmap, Handled);
    if not Handled then
      Handle:=LoadBitmap(HInstance,PChar(AnsiUpperCase(AComponent.ClassName)));
...
procedure TFDReader.SetName(Component: TComponent; var Name: string);
  ...
  begin
    ...
    begin
      ...
      if not AComponent.InheritsFrom(TFrame) then
        with AComponent do
...
begin
  FControl:=Value;
  if Assigned(FControl) and not (csDestroying in FControl.ComponentState) and FEnabled then
    Update(False)
  else
  begin
    FEnabled:=False;
      ...
      if Assigned(FItems[GP]) then
        with FItems[GP] do
          ...
          begin
            ...
            if Assigned(FControl.Parent) and not (csDestroying in FControl.Parent.ComponentState) and not (FControl.Parent is TToolBar) then
...
begin
  ...
  begin
    ...
    {$IFDEF DELPHIXE2_LVL}
    if Assigned(FDefaultProc) then SetWindowLong(ParentForm.Handle,GWL_WNDPROC,NativeInt(FDefaultProc));
    {$ELSE}
    ...
    {$IFDEF DELPHIXE2_LVL}
    if Assigned(FWinProc) then SetWindowLong(ParentForm.Handle,GWL_WNDPROC,NativeInt(FWinProc));
    {$ELSE}
...
//  i: Integer;
  ...
  begin
    Result := Assigned(ParentForm) and not Application.Terminated;
    if Result then
...
(******)
    ...
    begin
      ...
      {$WARNINGS ON}
      {$IFDEF DELPHIXE2_LVL}
      SetWindowLong(ParentForm.Handle,GWL_WNDPROC,NativeInt(FWinProc));
      {$ELSE}
    ...
    begin
      if ParentFormOK and Assigned(FDefaultProc) then
        {$IFDEF DELPHIXE2_LVL}
        SetWindowLong(ParentForm.Handle,GWL_WNDPROC,NativeInt(FDefaultProc));
        {$ELSE}
...
begin
  ...
  if Assigned(ParentForm) then
    ...
    begin
      ...
      try
        AOffset.X:=FDragRect.Left-Control.Left;
        AOffset.Y:=FDragRect.Top-Control.Top;
        ...
        begin
          ...
          begin
            ...
            OffsetRect(DR,AOffset.X,AOffset.Y);
          end;
          with FAlignRect do
          begin
        ...
        begin
          ...
          begin
            if (FDragHandle in [gpNone,gpLeftMiddle,gpLeftTop,gpLeftBottom]) and
              (lpLeft in FAlignmentLines) and GetAlignment(lpLeft,AOffset) then
            begin
              Pen.Color:=FAlignmentColorLeft xor FormColor;
              MoveTo(Left-2,AOffset.X);
              LineTo(Left-2,Pred(AOffset.Y));
            end;
            if (FDragHandle in [gpNone,gpLeftTop,gpMiddleTop,gpRightTop]) and
              (lpTop in FAlignmentLines) and GetAlignment(lpTop,AOffset) then
            begin
              Pen.Color:=FAlignmentColorTop xor FormColor;
              MoveTo(AOffset.X,Top-2);
              LineTo(Pred(AOffset.Y),Top-2);
            end;
            if (FDragHandle in [gpNone,gpRightTop,gpRightMiddle,gpRightBottom]) and
              (lpRight in FAlignmentLines) and GetAlignment(lpRight,AOffset) then
            begin
              Pen.Color:=FAlignmentColorRight xor FormColor;
              MoveTo(Right+1,AOffset.X);
              LineTo(Right+1,Pred(AOffset.Y));
            end;
            if (FDragHandle in [gpNone,gpLeftBottom,gpMiddleBottom,gpRightBottom]) and
              (lpBottom in FAlignmentLines) and GetAlignment(lpBottom,AOffset) then
            begin
              Pen.Color:=FAlignmentColorBottom xor FormColor;
              MoveTo(AOffset.X,Bottom+1);
              LineTo(Pred(AOffset.Y),Bottom+1);
            end;
          end;
        end;
      finally
    ...
    if ((FShowMoveSizeHint and (Mode<>hmCustom)) or (FShowComponentHint and (Mode=hmCustom))) and (AHint<>'') then
      ...
      begin
        ...
        with Self.FControls do
          if Count>1 then
            for AOffset :=0 to Pred(Count) do DrawMultiSelect(Self.Controls[AOffset]);
      ...
      with ParentForm do
        for i:=0 to Pred(ComponentCount) do
          if not (Components[i] is TControl) and
            ...
            not (Components[i] is TField) and
...
procedure TAdvCustomFormDesigner.UpdateControlsVisibility;
    ...
    begin
      for i:=0 to Pred(ComponentCount) do
        ...
        begin
          ...
          if (ParentForm.Components[i] is TWinControl) and
            TWinControl(Components[i]).HandleAllocated then
            with TWinControl(ParentForm.Components[i]) do
            begin
              if FActive then
              begin
...
begin
  with Message do
    case Msg of
      ...
      begin
        Result:=CallDefault;
        if Assigned(ParentForm) then UpdateGrabs;
        FModified:=True;
      end;
...
procedure TAdvCustomFormDesigner.NotifyChange(AOperationName: string);
begin
  DoChange;
end;
    ...
    try
      ...
      begin
        for i:=0 to Pred(Count) do
          if Items[i] is TControl then
            AddControl(TControl(Items[i]))
          else
...
begin
  ...
  begin
    ...
    try
      ...
      BinStream:=TMemoryStream.Create;
      try
        W := TWriter.Create(BinStream,BufSize);
        with W do
        try
          Root:=ParentForm;
          for i:=0 to Pred(ControlCount) do
          ...
          with ComponentList do
            ...
            begin
              ...
              DoCopyComponent(W, TComponent(Items[i]));
              if Assigned(FOnCopyComponent) then
      ...
      try
        ...
        try
          ...
          begin
            ...
            BinStream.Seek(0,soFromBeginning);
            Reader := TFDReader.Create(BinStream,Self);
            with Reader do
            try
              BeginReferences;
              try
            ...
            DoPasteComponent(StringStream, NewComponent);
          end;
        finally
          BinStream.Free;
        end;
...
begin
  Result := nil;
  if assigned(FOnCreateComponentClass) then begin
    FOnCreateComponentClass(self, AComponentClass, Result);
  end;
...
begin
  if not Assigned(DesignControl) and Assigned(ParentForm) and ParentForm.HandleAllocated then
    {$IFDEF DELPHIXE2_LVL}
    if GetWindowLong(ParentForm.Handle,GWL_WNDPROC)<>NativeInt(FWinProc) then
    begin
      SetWindowLong(ParentForm.Handle,GWL_WNDPROC,NativeInt(FDefaultProc));
      FDefaultProc := TFarProc(GetWindowLong(ParentForm.Handle,GWL_WNDPROC));
      SetWindowLong(ParentForm.Handle,GWL_WNDPROC,NativeInt(FWinProc));
            ...
            case MouseAction of
              ...
              begin
                ...
                if FAlignmentLines<>[] then
                  ParentForm.Invalidate;
//                else
//                  SendMessage(ParentForm.Handle, WM_ERASEBKGND, ParentForm.Canvas.Handle, 0);
              end;
              maSelecting:
              begin
                FMouseAction:=maNone;
            ...
            begin
              ...
              case FMouseAction of
                ...
                maSelecting:
                  ...
                  begin
                    if FSelectCounter>1 then DrawSelectRect;
...
procedure TAdvCustomFormDesigner.DoComponentBitmap(Comp: TComponent;
  ABitmap: TBitmap; var Handled: boolean);
begin
  if Assigned(FOnComponentBitmap) then
    FOnComponentBitmap(Self, Comp, ABitmap, Handled);
end;
...
procedure TAdvCustomFormDesigner.DoCopyComponent(Writer: TWriter;
  Comp: TComponent);
begin
end;
...
procedure TAdvCustomFormDesigner.DoPasteComponent(Stream: TStream;
  Comp: TComponent);
begin
