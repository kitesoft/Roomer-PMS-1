...
uses
  ...
  StdCtrls, dxCore, dxMessages, cxControls, cxLookAndFeels, dxSpellChecker;
...
type
  ...
  protected
    procedure ApplyChanges(const AWordRange: TdxSpellCheckerAutoCorrectWordRange);
...
begin
  ...
  begin
    ...
    AWordCapitalization := GetWordCapitalizationType(AWord);
...
procedure TdxSpellCheckerAutoCorrectManager.ApplyChanges(const AWordRange: TdxSpellCheckerAutoCorrectWordRange);
begin
