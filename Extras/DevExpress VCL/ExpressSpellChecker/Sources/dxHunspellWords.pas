...
type
  ...
  private
    ...
    function GetItem(Index: Integer): Word; {$IFDEF DELPHI9} inline; {$ENDIF}
  ...
  private
    function GetItem(Index: Integer): TdxHunspellFlags; {$IFDEF DELPHI9} inline; {$ENDIF}
  public
  ...
  private
    ...
    function GetCompound: Boolean; {$IFDEF DELPHI9} inline; {$ENDIF}
    function GetCompoundBegin: Boolean; {$IFDEF DELPHI9} inline; {$ENDIF}
    function GetCompoundEnd: Boolean; {$IFDEF DELPHI9} inline; {$ENDIF}
    function GetCompoundMiddle: Boolean; {$IFDEF DELPHI9} inline; {$ENDIF}
    function GetCompoundRoot: Boolean; {$IFDEF DELPHI9} inline; {$ENDIF}
    function GetForbidden: Boolean; {$IFDEF DELPHI9} inline; {$ENDIF}
    function GetInCompoundOnly: Boolean; {$IFDEF DELPHI9} inline; {$ENDIF}
    function GetKeepCase: Boolean; {$IFDEF DELPHI9} inline; {$ENDIF}
    function GetMorphologyAliases: Boolean; {$IFDEF DELPHI9} inline; {$ENDIF}
    function GetMorphologyPhone: Boolean; {$IFDEF DELPHI9} inline; {$ENDIF}
    function GetNeedAffix: Boolean; {$IFDEF DELPHI9} inline; {$ENDIF}
    function GetNoSuggest: Boolean; {$IFDEF DELPHI9} inline; {$ENDIF}
    function GetUpcaseOnly: Boolean; {$IFDEF DELPHI9} inline; {$ENDIF}
  ...
  public
    ...
    destructor Destroy; override;
    function IsCompatibleWithFlag(AFlag: Word; CompatibleIfNull: Boolean = False): Boolean; {$IFDEF DELPHI9} inline; {$ENDIF}
