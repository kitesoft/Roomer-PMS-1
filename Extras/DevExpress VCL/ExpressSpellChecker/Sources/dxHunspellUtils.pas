...
procedure StrFreeAndNil(var S: PWideChar); {$IFDEF DELPHI9}inline;{$ENDIF}
...
uses
  StrUtils, Dialogs, dxCore, dxSpellCheckerUtils;
...
const
  LangMap: array[0..23] of TLangRec = (
    (ShortName: 'ar'; LanguageID: 1025), // Arabic
    (ShortName: 'az'; LanguageID: 1068), // Azerbaijani
    (ShortName: 'bg'; LanguageID: 1026), // Bulgarian
    (ShortName: 'ca'; LanguageID: 1027), // Catalan
    (ShortName: 'cs'; LanguageID: 1029), // Czech
    (ShortName: 'da'; LanguageID: 1030), // Danish
    (ShortName: 'de'; LanguageID: 1031), // German
    (ShortName: 'el'; LanguageID: 1032), // Greek
    (ShortName: 'en'; LanguageID: 1033), // English (US)
    (ShortName: 'es'; LanguageID: 1034), // Spanish
    (ShortName: 'eu'; LanguageID: 1069), // Basque
    (ShortName: 'gl'; LanguageID: 1110), // Galician
    (ShortName: 'fr'; LanguageID: 1036), // French
    (ShortName: 'hr'; LanguageID: 1050), // Croatian
    (ShortName: 'hu'; LanguageID: 1038), // Hungarian
    (ShortName: 'it'; LanguageID: 1040), // Italian
//  (ShortName: 'la'; LanguageID: LANG_la),
    (ShortName: 'lv'; LanguageID: 1062), // Latvian
    (ShortName: 'nl'; LanguageID: 1043), // Dutch
    (ShortName: 'pl'; LanguageID: 1045), // Polish
    (ShortName: 'pt'; LanguageID: 2070), // Portuguese
    (ShortName: 'sv'; LanguageID: 1053), // Swedish
    (ShortName: 'tr'; LanguageID: 1055), // Turkish
    (ShortName: 'ru'; LanguageID: 1049), // Russian
    (ShortName: 'uk'; LanguageID: 1058));// Ukrainian
var
  I: Integer;
begin
  Result := LanguageNone;
  for I := 0 to High(LangMap) do
    if StrLComp(ALanguage, LangMap[I].ShortName, 2) = 0 then
    Result := LangMap[I].LanguageID;
end;
