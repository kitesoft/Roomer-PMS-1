...
type
  ...
  private
    ...
    function GetWordStemManager: TdxHunspellWordStemManager; {$IFDEF DELPHI9} inline; {$ENDIF}
  public
  ...
  private
    ...
    function GetData: PdxAffixItemArray; {$IFDEF DELPHI9} inline; {$ENDIF}
    function GetItem(Index: Integer): TdxAffixItem; {$IFDEF DELPHI9} inline; {$ENDIF}
  ...
  private
    ...
    function GetData: PdxPWideCharArray; {$IFDEF DELPHI9} inline; {$ENDIF}
  ...
  private
    ...
    function GetData: PdxCompoundForbidPatternArray; {$IFDEF DELPHI9} inline; {$ENDIF}
    function GetItem(Index: Integer): TdxCompoundForbidPattern; {$IFDEF DELPHI9} inline; {$ENDIF}
  protected
    function AddDataPiece(const APiece: PWideChar; ADataIndex,
      APieceIndex: Integer): Boolean; override;
    procedure FreeDataItems; override;
  ...
  private
    function GetData: PdxCompoundFlagArray; {$IFDEF DELPHI9} inline; {$ENDIF}
    function GetItem(Index: Integer): TdxCompoundFlag; {$IFDEF DELPHI9} inline; {$ENDIF}
  ...
  private
    function GetData: PdxMapArray; {$IFDEF DELPHI9} inline; {$ENDIF}
    function GetItem(Index: Integer): TdxMapTableItem; {$IFDEF DELPHI9} inline; {$ENDIF}
  protected
    function AddDataPiece(const APiece: PWideChar; ADataIndex,
      APieceIndex: Integer): Boolean; override;
    procedure FreeDataItems; override;
  ...
  private
    function GetData: PdxReplaceArray; {$IFDEF DELPHI9} inline; {$ENDIF}
    function GetItem(Index: Integer): TdxReplaceTableItem; {$IFDEF DELPHI9} inline; {$ENDIF}
  protected
    function AddDataPiece(const APiece: PWideChar; ADataIndex,
      APieceIndex: Integer): Boolean; override;
    procedure FreeDataItems; override;
  ...
  protected
    ...
    function GetCircumfix: Boolean; {$IFDEF DELPHI9} inline; {$ENDIF}
    function GetCompoundEnd: Boolean; {$IFDEF DELPHI9} inline; {$ENDIF}
    function GetCompoundForbid: Boolean; {$IFDEF DELPHI9} inline; {$ENDIF}
    function GetCompoundMiddle: Boolean; {$IFDEF DELPHI9} inline; {$ENDIF}
    function GetCompoundPermit: Boolean; {$IFDEF DELPHI9} inline; {$ENDIF}
    function GetInCompoundOnly: Boolean; {$IFDEF DELPHI9} inline; {$ENDIF}
    function GetNeedAffix: Boolean; {$IFDEF DELPHI9} inline; {$ENDIF}
    function GetPrefixSuffixUnion: Boolean; {$IFDEF DELPHI9} inline; {$ENDIF}
  protected
  ...
  public
    ...
    function IsLeadingSubset(ASubset: PWideChar; ASet: PWideChar): Boolean; {$IFDEF DELPHI9} inline; {$ENDIF}
    ...
    property SugsWithDots: Boolean read FSugsWithDots;
...
uses
  dxCore, dxSpellCheckerUtils, Windows;
...
type
  ...
  TNoSplitSugsReader = class(TdxAffixFileAttributeReader)
  protected
    function GetDataIdentifier: PWideChar; override;
    function Process(ALine: PWideChar; AReader: TdxHunspellReader): Boolean; override;
  end;
  ...
  TSugsWithDotsReader = class(TdxAffixFileAttributeReader)
  protected
    function GetDataIdentifier: PWideChar; override;
    function Process(ALine: PWideChar; AReader: TdxHunspellReader): Boolean; override;
  end;
  ...
  begin
    ...
    begin
      ...
      if AWordCursor - AWord + AReplaceLength +
        Integer(StrLen(AWordCursor + AInitialLength)) > dxMaxLineLength then
        Break;
      ATemp := AChangedWord;
...
begin
  ...
  FIsHungarian := Language = LanguageHu;
end;
...
var
  ACharIndex, J, AFoundLetters, ARuleIndex, APiority, z, k0, n0, p0, z0: Integer;
  AChar, C0: WideChar;
  S: PWideChar;
  ATempWord: array[0..dxMaxPhonetLength] of WideChar;
begin
  Result := 0;
  AFoundLetters := 0;
  p0 := -333;
  ...
  if ALength > dxMaxPhonetLength then
    Exit;
        ...
        begin
          ...
          begin
            ...
            begin
              ...
              begin
                if (k0 = AFoundLetters) or (p0 < APiority) then
                begin
                  Inc(n0, 2);
                  Continue;
                end;
            ...
            if (p0 >= APiority) and (Rules[n0]^ = C0) then
            begin
              Inc(ARuleIndex, 2);
              Continue;
            end;
...
var
  ACount, I, AIndex, AMatcnLen, AWordLen: Cardinal;
...
begin
  ...
  begin
    ...
    AMatcnLen := Match(AWord + I, AIndex);
    if AMatcnLen <> 0 then
    begin
...
function TNoSplitSugsReader.GetDataIdentifier: PWideChar;
begin
  Result := diNoSplitSugs;
end;

function TNoSplitSugsReader.Process(ALine: PWideChar;
  AReader: TdxHunspellReader): Boolean;
begin
  Result := True;
  AffixManager.FNoSplitSugs := True;
end;
...
function TSugsWithDotsReader.GetDataIdentifier: PWideChar;
begin
  Result := diSugsWithDots;
end;

function TSugsWithDotsReader.Process(ALine: PWideChar;
  AReader: TdxHunspellReader): Boolean;
begin
  Result := True;
  AffixManager.FSugsWithDots := True;
end;
...
function TKeepCaseReader.Process(ALine: PWideChar;
  AReader: TdxHunspellReader): Boolean;
begin
