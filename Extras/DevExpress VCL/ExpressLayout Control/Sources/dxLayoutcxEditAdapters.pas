...
uses
  Classes, dxLayoutContainer, cxEdit, cxLookAndFeelPainters;
...
type
  ...
  public
    constructor Create(AItem: TdxLayoutItem); override;
...
constructor TdxLayoutcxEditAdapter.Create(AItem: TdxLayoutItem);
begin
  inherited;
  TcxCustomEditAccess(Control).SupportsTouchMode := True;
end;

destructor TdxLayoutcxEditAdapter.Destroy;
begin
  TcxCustomEditAccess(Control).SupportsTouchMode := False;
  inherited;
end;
