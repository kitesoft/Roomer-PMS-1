...
const
  dxLayoutDragImageBackgroundColor: TColor = $EDC8A3;
...
procedure TdxSelectionLayer.Paint;
  ...
  begin
    ...
    try
      ASkipList.Add(Pointer(Handle));
      cxPaintTo(AParent, ABitmap.cxCanvas, cxPointInvert(AOffset), cxGetWindowBounds(AParent), ASkipList);
    finally
      ASkipList.Free;
    end;
  end;
