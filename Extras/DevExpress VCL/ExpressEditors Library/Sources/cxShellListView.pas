...
type
  ...
  protected
    ...
    property Sorting: Boolean read GetSorting write SetSorting;
...
begin
  ...
  AParentIFolder.ParseDisplayName(0, nil, PWideChar({$IFNDEF DELPHI14}WideString{$ENDIF}(ADisplayName)),
