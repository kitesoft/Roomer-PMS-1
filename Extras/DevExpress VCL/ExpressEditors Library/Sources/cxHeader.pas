...
begin
  ...
  try
    ...
    ALookAndFeel.Painter.DrawHeaderControlSection(ACanvas, AHeaderItemInfo.Rect, ATextRect, ANeighbors,
      cxBordersAll, AHeaderItemInfo.State, AHeaderItemInfo.SectionAlignment, vaCenter, False, True,
      AHeaderItemInfo.Text, ACanvas.Font, ACanvas.Font.Color, ACanvas.Brush.Color);
...
begin
  ...
  AContentHeight := cxTextHeight(Canvas.Handle);
...
begin
  ...
  PatBlt(FLineDC, Left + XPos - GetSplitLineOffset, 1, 1, Parent.Height - 1, DSTINVERT);
end;
