...
uses
  Windows, Classes, Controls, Graphics, SysUtils, dxCore, cxClasses,
...
const
  cxSysColorPrefix: Cardinal = clSystemColor;
...
function TcxSolidBrushCache.GetBrush(ABrushColor: TColor): TBrushHandle;
  ...
  begin
    ...
    begin
      ...
      begin
        ACount := (FDepth - ARarestColorIndex) * SizeOf(TdxNativeInt);
    ...
    begin
      ACount := (FDepth - AIndex) * SizeOf(TdxNativeInt);
