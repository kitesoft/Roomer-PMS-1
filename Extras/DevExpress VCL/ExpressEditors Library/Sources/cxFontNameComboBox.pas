...
uses
  ...
  Printers, SysUtils,
  dxCoreClasses, cxClasses, cxContainer, cxControls, cxGraphics, cxButtons,
...
begin
  ...
  AButtonSize.cx := cxTextWidth(FBoldButton.Font, 'B') + 8;
  AButtonSize.cy := cxTextHeight(FBoldButton.Font) + 2;
...
procedure TcxCustomFontNameComboBoxViewData.Calculate(ACanvas: TcxCanvas;
  ...
  begin
    Result.Y := (cxRectHeight(AClientRect) - FTrueTypeFontBitmap.Height) div 2;
    if IsInplace then
