...
type
  ...
  private
    ...
    function GetProperiesField: TField;
  ...
  protected
    ...
    property ProperiesField: TField read GetProperiesField;
  public
...
begin
  Result := inherited GetIsDataAvailable and cxDB.IsDataAvailable(Field) and cxDB.IsDataAvailable(ProperiesField);
end;
...
function TcxDBEditDataBinding.GetProperiesField: TField;
begin
