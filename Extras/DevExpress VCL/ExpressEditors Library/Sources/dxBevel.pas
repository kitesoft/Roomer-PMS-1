...
uses
  ...
  cxLookAndFeels, cxLookAndFeelPainters, cxGraphics;

type

  { TdxCustomBevel }

  TdxCustomBevel = class(TGraphicControl, IcxLookAndFeelContainer, IdxSkinSupport)
  private
    FcxCanvas: TcxCanvas;
...
procedure TdxCustomBevel.LookAndFeelChangeHandler(
...
begin
  ...
  begin
    ...
    if AutoSize then
    begin
      if CanAutoHeight(APrevShape) and CanAutoWidth(Shape) or
         CanAutoWidth(APrevShape) and CanAutoHeight(Shape)
      then
