...
type
  ...
  protected
    ...
    procedure SetNodeParent(ANewNode, ANewParent: TdxTreeCustomNode; AMode: TdxTreeNodeAddMode);
...
procedure TdxTreeCustomNode.ReadData(AStream: TStream);
var
  I, AChildsCount: Integer;
begin
  DeleteChildren;
  AStream.ReadBuffer(FImageIndex, SizeOf(FImageIndex));
  AStream.ReadBuffer(AChildsCount, SizeOf(AChildsCount));
  for I := 0 to AChildsCount - 1 do
    AddChild.ReadData(AStream);
end;
