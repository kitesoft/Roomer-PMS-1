...
__published:	// IDE-managed Components
	...
	TdxZoomTrackBar *ztbZoom;
	TcxLabel *lbZoom;
	TPaintBox *pbMain;
	TdxColorEdit *ceBackColor;
	TcxLabel *lbBackColor;
	TcxButton *sbResize;
	...
	void __fastcall sbHidePanelClick(TObject *Sender);
	void __fastcall sbInfoClick(TObject *Sender);
	void __fastcall miFiveColumnsClick(TObject *Sender);
	void __fastcall ztbZoomPropertiesChange(TObject *Sender);
	void __fastcall pbMainPaint(TObject *Sender);
	void __fastcall ceBackColorPropertiesChange(TObject *Sender);
...
private:	// User declarations
	...
	void CalculateRect(TRect &ARect);
