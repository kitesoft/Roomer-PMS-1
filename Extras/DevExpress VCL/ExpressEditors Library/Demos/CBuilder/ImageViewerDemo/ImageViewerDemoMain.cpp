...
void TImageViewerDemoMainForm::CalculateRect(TRect &ARect)
{
  ARect = cxNullRect;
  ARect.Right = div(FGlyph->Width * ztbZoom->Position, 100).quot;
  ARect.Bottom = div(FGlyph->Height * ztbZoom->Position, 100).quot;
...
void __fastcall TImageViewerDemoMainForm::sbHidePanelClick(TObject *Sender)
{
  if (gbRightPanel->Visible) {
...
void __fastcall TImageViewerDemoMainForm::ztbZoomPropertiesChange(TObject *Sender)
{
...
void __fastcall TImageViewerDemoMainForm::pbMainPaint(TObject *Sender)
{
  Draw();
}
//---------------------------------------------------------------------------

void __fastcall TImageViewerDemoMainForm::ceBackColorPropertiesChange(TObject *Sender)
{
  pbMain->Invalidate();
}
//---------------------------------------------------------------------------
