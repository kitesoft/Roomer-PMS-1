...
uses
  ConvUtils, StrUtils, cxClasses, dxCore, Variants;
...
function TdxServerModeMSSQLAdapter.GetSelectSQLString(const AFields, AFrom,
  AWhere, AGroup, ASortInfo: string; ATopRecords, ASkipRecords: Integer): string;
var
...
procedure TdxServerModeMySQLAdapter.CheckParams(AParams: TParams; var ACommandText: string);
begin
...
procedure TdxServerModeMySQLAdapter.CheckRepeatedParams(AParams: TParams; var ACommandText: string);
var
  I: Integer;
  APos: Integer;
  ANewName: string;
...
procedure TdxServerModeMySQLAdapter.RenameParams(AParams: TParams; var ACommandText: string);
var
  I: Integer;
...
procedure TdxServerModeFirebirdAdapter.CheckParams(AParams: TParams; var ACommandText: string);
begin
  CheckRepeatedParams(AParams, ACommandText);
  SortParams(AParams, ACommandText);
  RenameParams(AParams, ACommandText);
...
procedure TdxServerModeFirebirdAdapter.CheckRepeatedParams(AParams: TParams; var ACommandText: string);
var
  I: Integer;
  APos: Integer;
  ANewName: string;
...
procedure TdxServerModeFirebirdAdapter.RenameParams(AParams: TParams; var ACommandText: string);
var
  I: Integer;
  AParamName, ANewName: string;
begin
...
procedure TdxServerModeOracleAdapter.CheckParams(AParams: TParams; var ACommandText: string);
begin
  CheckRepeatedParams(AParams, ACommandText);
  SortParams(AParams, ACommandText);
  RenameParams(AParams, ACommandText);
...
procedure TdxServerModeOracleAdapter.CheckRepeatedParams(AParams: TParams; var ACommandText: string);
var
  I: Integer;
  APos: Integer;
  ANewName: string;
...
procedure TdxServerModeOracleAdapter.RenameParams(AParams: TParams; var ACommandText: string);
var
  I: Integer;
  AParamName: string;
begin
...
begin
  ...
  begin
    if ATopRecords > 0 then
      Result := Format('SELECT * FROM (SELECT %s FROM %s %s %s %s) WHERE RowNum <= %d', [AFields, AFrom, AWhere, AGroup, ASortInfo, ATopRecords])
    else
      Result := Format('SELECT %s FROM %s %s %s %s', [AFields, AFrom, AWhere, AGroup, ASortInfo]);
    Exit;
  end
  else
  begin
     Result := Format('SELECT %0:s FROM(SELECT %0:s, RowNum rNum FROM(SELECT %0:s FROM %1:s %2:s %3:s %4:s)) WHERE rNum > %5:d', [AFields, AFrom, AWhere, AGroup, ASortInfo, ASkipRecords]);
    if ATopRecords > 0 then
...
procedure TdxServerModePostgreSQLAdapter.CheckParams(AParams: TParams; var ACommandText: string);
begin
  CheckRepeatedParams(AParams, ACommandText);
  SortParams(AParams, ACommandText);
  RenameParams(AParams, ACommandText);
...
procedure TdxServerModePostgreSQLAdapter.CheckRepeatedParams(AParams: TParams; var ACommandText: string);
var
  I: Integer;
  APos: Integer;
  ANewName: string;
...
procedure TdxServerModePostgreSQLAdapter.RenameParams(AParams: TParams; var ACommandText: string);
var
  I: Integer;
  AParamName, ANewName: string;
begin
...
procedure TdxServerModeAdvantageAdapter.CheckParams(AParams: TParams; var ACommandText: string);
begin
  CheckRepeatedParams(AParams, ACommandText);
  SortParams(AParams, ACommandText);
  RenameParams(AParams, ACommandText);
...
procedure TdxServerModeAdvantageAdapter.CheckRepeatedParams(AParams: TParams; var ACommandText: string);
var
  I: Integer;
  APos: Integer;
  ANewName: string;
...
procedure TdxServerModeAdvantageAdapter.RenameParams(AParams: TParams; var ACommandText: string);
var
  I: Integer;
  AParamName, ANewName: string;
begin
...
procedure TdxServerModeMSAccessAdapter.CheckParams(AParams: TParams; var ACommandText: string);
begin
  CheckRepeatedParams(AParams, ACommandText);
  SortParams(AParams, ACommandText);
  RenameParams(AParams, ACommandText);
...
procedure TdxServerModeMSAccessAdapter.CheckRepeatedParams(AParams: TParams; var ACommandText: string);
var
  I: Integer;
  APos: Integer;
  ANewName: string;
...
procedure TdxServerModeMSAccessAdapter.RenameParams(AParams: TParams; var ACommandText: string);
var
  I: Integer;
  AParamName, ANewName: string;
begin
...
procedure TdxServerModeSQLiteAdapter.CheckParams(AParams: TParams; var ACommandText: string);
begin
  CheckRepeatedParams(AParams, ACommandText);
  SortParams(AParams, ACommandText);
  RenameParams(AParams, ACommandText);
...
procedure TdxServerModeSQLiteAdapter.CheckRepeatedParams(AParams: TParams; var ACommandText: string);
var
  I: Integer;
  APos: Integer;
  ANewName: string;
...
procedure TdxServerModeSQLiteAdapter.RenameParams(AParams: TParams; var ACommandText: string);
var
  I: Integer;
  AParamName, ANewName: string;
begin
