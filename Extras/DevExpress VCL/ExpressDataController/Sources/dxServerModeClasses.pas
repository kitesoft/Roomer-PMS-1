...
type
  ...
  private
    ...
    function GetCount: Integer; {$IFDEF DELPHI9} inline; {$ENDIF}
    function GetFirst: TdxLoadedRecordsBlock; {$IFDEF DELPHI9} inline; {$ENDIF}
    function GetItem(Index: Integer): TdxLoadedRecordsBlock; {$IFDEF DELPHI9} inline; {$ENDIF}
    function GetLast: TdxLoadedRecordsBlock; {$IFDEF DELPHI9} inline; {$ENDIF}
  protected
...
function TdxServerModeGroupInfo.IsEqual(const AValue: Variant; AHash: Cardinal): Boolean;
  ...
  function CanUseHash(VType1, VType2: TVarType): Boolean; {$IFDEF DELPHI9} inline; {$ENDIF}
  begin
