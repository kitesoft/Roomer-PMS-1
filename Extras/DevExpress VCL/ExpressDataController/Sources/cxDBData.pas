...
{$IFDEF DELPHI9}
  Windows,
{$ENDIF}
  TypInfo, RTLConsts, Contnrs, cxDataConsts, dxCoreClasses;
  ...
  begin
    case AField.DataType of
      ftString, ftMemo, ftFmtMemo, ftFixedChar:
        Result := TcxStringValueType;
      ftWideString {$IFDEF DELPHI11}, ftWideMemo, ftFixedWideChar {$ENDIF}:
        Result := {$IFDEF DELPHI12}TcxStringValueType{$ELSE}TcxWideStringValueType{$ENDIF};
      ftSmallint:
