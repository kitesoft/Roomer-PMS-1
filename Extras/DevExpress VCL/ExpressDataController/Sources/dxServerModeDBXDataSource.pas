...
{$IFNDEF DELPHI8}
  CheckSQLAdapter;
  if TSQLDataSet(DataSet).SQLConnection = nil then
    InitializeDataSet;
  ACommand := GetSQLQuerySchemaNames;
...
procedure TdxServerModeDBXDataSourceHelper.CheckParamValue(var AParam: TParam);
begin
  inherited;
