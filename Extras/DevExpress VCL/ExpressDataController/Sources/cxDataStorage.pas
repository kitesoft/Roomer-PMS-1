...
uses
  ...
  {$IFNDEF NONDB},FMTBcd, SqlTimSt{$ENDIF} {$IFDEF DELPHI12}, AnsiStrings{$ENDIF};
...
{$ENDIF}
  ...
  protected
    ...
    function GetDataFromBuffer(ABuffer: PAnsiChar): PAnsiChar; {$IFDEF DELPHI9} inline; {$ENDIF}
    ...
    function IsNullValue(ABuffer: PAnsiChar): Boolean; {$IFDEF DELPHI9} inline; {$ENDIF}
    function IsNullValueEx(ABuffer: PAnsiChar): Boolean; {$IFDEF DELPHI9} inline; {$ENDIF}
