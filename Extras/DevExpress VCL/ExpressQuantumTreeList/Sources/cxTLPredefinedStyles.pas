...
uses
  Windows, Classes, cxStyles, cxClasses, cxTL, Forms;
...
type
  TcxTreeListPredefinedStyleSheets = class(TcxPredefinedStyleSheets)
  private
    FData: TcxdmTreeListPredefinedStyles;
  protected
...
{ TcxTreeListPredefinedStyleSheets }

constructor TcxTreeListPredefinedStyleSheets.Create;
begin
  inherited Create;
  FData := TcxdmTreeListPredefinedStyles.Create(nil);
  AddStyleSheets;
end;

destructor TcxTreeListPredefinedStyleSheets.Destroy;
begin
  FData.Free;
  inherited Destroy;
end;

procedure TcxTreeListPredefinedStyleSheets.AddStyleSheets;
var
  I: Integer;
begin
...
initialization
  RegisterPredefinedStyleSheets(TcxTreeListPredefinedStyleSheets);

finalization
  UnregisterPredefinedStyleSheets(TcxTreeListPredefinedStyleSheets);
