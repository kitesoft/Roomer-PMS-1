...
type                                                    
  TfrmRealtorWorld = class(TForm)
    ...
    procedure tlDeactivateDetail(Sender: TdxTileControlItem);
...
begin
  ...
  TfrmBase(Sender.DetailOptions.DetailControl).AddLookAndFeelListener;
end;

procedure TfrmRealtorWorld.tlDeactivateDetail(Sender: TdxTileControlItem);
begin
  TfrmBase(Sender.DetailOptions.DetailControl).RemoveLookAndFeelListener;
end;
