...
type
  ...
  public
    ...
    procedure AddLookAndFeelListener; override;
    procedure RemoveLookAndFeelListener; override;
  end;
...
constructor TfrmListing.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);
  imgHomePlan.Properties.Center := False;
  TcxImageAccess(imgHomePlan).Scalable := True;
  TcxImageAccess(imgHomePlan).Scale := 30;
end;
...
procedure TfrmListing.AddLookAndFeelListener;
begin
  reFeatures.Style.LookAndFeel.AddChangeListener(Self);
end;

procedure TfrmListing.MasterLookAndFeelChanged(Sender: TcxLookAndFeel; AChangedValues: TcxLookAndFeelValues);
begin
  InitializeFeatures;
end;

procedure TfrmListing.RemoveLookAndFeelListener;
begin
  reFeatures.Style.LookAndFeel.RemoveChangeListener(Self);
end;
