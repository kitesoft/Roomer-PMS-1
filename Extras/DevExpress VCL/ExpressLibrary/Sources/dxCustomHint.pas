...
type
  ...
  protected
    ...
    procedure DoShowHint(var AHintStr: string; var ACanShow: Boolean;
      var AHintInfo: THintInfo); virtual;
...
//    property HintStyle: TcxCustomHintStyle read FHintStyle write SetHintStyle;
  ...
  protected
    ...
    function GetHintWindowRect(const AHintAreaBounds, ATextRect: TRect;
      const AText: string; AIsHintMultiLine: Boolean): TRect; virtual;
...
begin
  ...
  if HasWindowRegion and FHasAnimation then
    RedrawWindow(Handle, nil, 0, RDW_INVALIDATE or RDW_FRAME or RDW_ERASE or RDW_UPDATENOW)
  else
    Invalidate;
end;
...
begin
  ...
  with GetHintWinControl.ClientToScreen(ATextRect.TopLeft) do
