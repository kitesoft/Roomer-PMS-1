...
uses
  ...
  cxDesignWindows, ExtDlgs, StrUtils, DesignIntf, StdActns;
...
uses
  Math, cxLookAndFeels, cxLookAndFeelPainters, cxGraphics, cxGeometry,
...
begin
  ...
  begin
    ...
    try
      ...
      begin
        ABitmap := cxGetAsBitmap(APicture.Graphic);
        try
          ABand.Glyph := ABitmap;
        finally
          ABitmap.Free;
