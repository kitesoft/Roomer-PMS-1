...
uses
  ...
  dxCore, dxCoreClasses, cxGraphics, dxGDIPlusClasses, dxGDIPlusApi, cxClasses,
  cxLookAndFeelPainters;

const
  dxFadeInDefaultAnimationFrameCount = 4;
  dxFadeInDefaultAnimationFrameDelay = 15;
  dxFadeOutDefaultAnimationFrameCount = 12;
  dxFadeOutDefaultAnimationFrameDelay = 20;
...
type
  ...
  published
    property FadeInFrameCount: Integer read FFadeInFrameCount write SetFadeInFrameCount default dxFadeInDefaultAnimationFrameCount;
    property FadeInFrameDelay: Integer read FFadeInFrameDelay write SetFadeInFrameDelay default dxFadeInDefaultAnimationFrameDelay;
    property FadeOutFrameCount: Integer read FFadeOutFrameCount write SetFadeOutFrameCount default dxFadeOutDefaultAnimationFrameCount;
    property FadeOutFrameDelay: Integer read FFadeOutFrameDelay write SetFadeOutFrameDelay default  dxFadeOutDefaultAnimationFrameDelay;
  end;
  ...
  protected
    ...
    procedure CorrectAlphaChannel(var AColors: TRGBColors);
...
begin
  ...
  try
    ...
    begin
      ATempColor^.rgbBlue := Round(AColor1^.rgbBlue * AAlpha1 + AColor2^.rgbBlue * AAlpha2);
      ATempColor^.rgbGreen := Round(AColor1^.rgbGreen * AAlpha1 + AColor2^.rgbGreen * AAlpha2);
      ATempColor^.rgbRed := Round(AColor1^.rgbRed * AAlpha1 + AColor2^.rgbRed * AAlpha2);
      ATempColor^.rgbReserved := Round(AColor1^.rgbReserved * AAlpha1 + AColor2^.rgbReserved * AAlpha2);
      Inc(ATempColor);
      Inc(AColor1);
      Inc(AColor2);
    end;
...
procedure TdxFadingElement.CorrectAlphaChannel(var AColors: TRGBColors);
var
  I: Integer;
  Q: PRGBQuad;
begin
