...
{$IFDEF DELPHI16}
  System.UITypes,
{$ENDIF}
  Types, Windows, dxCore, dxUxTheme, dxThemeManager, Classes, Graphics,
  Controls, ImgList,
...
type
  ...
  protected
    ...
    procedure DrawFilterSmartTagGlyph(ACanvas: TcxCanvas; const R: TRect;
      AState: TcxFilterSmartTagState; AIsFilterActive: Boolean); virtual;
  ...
  public
    ...
    procedure DrawCommandLinkBackground(ACanvas: TcxCanvas; R: TRect; AState: TcxButtonState; AColor: TColor = clDefault); virtual;
    procedure DrawCommandLinkGlyph(ACanvas: TcxCanvas; const AGlyphPos: TPoint; AState: TcxButtonState); virtual;
    ...
    function ExpandButtonAreaSize: Integer; virtual;
    ...
    procedure DrawSummarySortingMark(ACanvas: TcxCanvas; const R: TRect; AAscendingSorting: Boolean); virtual; // abstract;
    ...
    function SummarySortingMarkSize: TPoint; virtual; // abstract;
    // Grid
    ...
    procedure DrawFilterPanel(ACanvas: TcxCanvas; const ARect: TRect;
      ATransparent: Boolean; ABackgroundColor: TColor; const ABackgroundBitmap: TBitmap); virtual;
    procedure DrawFilterSmartTag(ACanvas: TcxCanvas; R: TRect; AState: TcxFilterSmartTagState; AIsFilterActive: Boolean); virtual; // abstract;
    ...
    function FilterSmartTagSize: TSize; virtual;
    //
    ...
    // Slider
    function SliderButtonSize(ADirection: TcxArrowDirection): TSize; virtual;
    procedure DrawSliderButton(ACanvas: TcxCanvas; const ARect: TRect;
      ADirection: TcxArrowDirection; AState: TcxButtonState); virtual;
    // SmallCloseButton
    function SmallCloseButtonSize: TSize; virtual;
    procedure DrawSmallButton(ACanvas: TcxCanvas; R: TRect; AState: TcxButtonState); virtual;
    ...
    procedure DrawMonthHeader(ACanvas: TcxCanvas; const ABounds: TRect;
      ...
      AArrows: TcxArrowDirections; ASideWidth: Integer; AOnDrawBackground: TcxDrawBackgroundEvent = nil); virtual;
    ...
    procedure DrawSchedulerGroupSeparator(ACanvas: TcxCanvas; const ABounds: TRect;
      ABackgroundColor: TColor; AOnDrawBackground: TcxDrawBackgroundEvent = nil); virtual;
    ...
    procedure DrawEditorButton(ACanvas: TcxCanvas; const ARect: TRect;
      AButtonKind: TcxEditBtnKind; AState: TcxButtonState; APosition: TcxEditBtnPosition = cxbpRight); virtual;
    ...
    // Clock
    function ClockSize: TSize; virtual;
    procedure DrawClock(ACanvas: TcxCanvas; const ARect: TRect;
      ADateTime: TDateTime; ABackgroundColor: TColor); virtual;
    // ZoomButtons
    function GetZoomInButtonSize: TSize; virtual;
    function GetZoomOutButtonSize: TSize; virtual;
    ...
    procedure DrawNavigatorButton(ACanvas: TcxCanvas; R: TRect;
      AState: TcxButtonState; ABackgroundColor: TColor); virtual;
    ...
    function NavigatorButtonGlyphPadding: TRect; virtual;
    function NavigatorButtonGlyphSize: TSize; virtual;
    function NavigatorButtonPressedGlyphOffset: TPoint; virtual;
    function NavigatorButtonMinSize: TSize; virtual;
    // ProgressBar
    ...
    // CheckBox
    function CheckButtonAreaSize: TSize; virtual;
    ...
    procedure DrawCheck(ACanvas: TcxCanvas; const R: TRect; AState: TcxButtonState;
      AChecked: Boolean; AColor: TColor); overload; virtual;
    procedure DrawCheck(ACanvas: TcxCanvas; const R: TRect; AState: TcxButtonState;
      ACheckState: TcxCheckBoxState; AColor: TColor); overload; virtual;
    ...
    function BreadcrumbEditButtonAreaSeparatorSize: Integer; virtual;
    function BreadcrumbEditButtonContentOffsets(AIsFirst, AIsLast: Boolean): TRect; virtual;
    function BreadcrumbEditDropDownButtonOriginalWidth: Integer; virtual;
    function BreadcrumbEditDropDownButtonWidth: Integer; virtual;
    function BreadcrumbEditIsFadingSupports: Boolean; virtual;
    function BreadcrumbEditNodeDelimiterSize: Integer; virtual;
    function BreadcrumbEditNodeTextColor(AState: TdxBreadcrumbEditButtonState): TColor; virtual;
    function BreadcrumbEditNodeTextOffsets: TRect; virtual;
    function BreadcrumbEditProgressChunkOverlaySize: TSize; virtual;
    function BreadcrumbEditProgressChunkPadding: TRect; virtual;
    procedure DrawBreadcrumbEditBorders(ACanvas: TcxCanvas;
      const ARect: TRect; ABorders: TcxBorders; AState: TdxBreadcrumbEditState); virtual;
    procedure DrawBreadcrumbEditButtonAreaSeparator(
      ACanvas: TcxCanvas; const ARect: TRect; AState: TdxBreadcrumbEditState); virtual;
    procedure DrawBreadcrumbEditButton(ACanvas: TcxCanvas;
      const ARect: TRect; AState: TdxBreadcrumbEditButtonState; AIsFirst, AIsLast: Boolean); virtual;
    procedure DrawBreadcrumbEditDropDownButton(ACanvas: TcxCanvas;
      const ARect: TRect; AState: TdxBreadcrumbEditButtonState; AIsInEditor: Boolean); virtual;
    procedure DrawBreadcrumbEditDropDownButtonGlyph(ACanvas: TcxCanvas;
      const ARect: TRect; AState: TdxBreadcrumbEditButtonState; AIsInEditor: Boolean); virtual;
    procedure DrawBreadcrumbEditNode(ACanvas: TcxCanvas;
      const R: TRect; AState: TdxBreadcrumbEditButtonState; AHasDelimiter: Boolean); virtual;
    procedure DrawBreadcrumbEditNodeDelimiter(ACanvas: TcxCanvas;
      const R: TRect; AState: TdxBreadcrumbEditButtonState); virtual;
    procedure DrawBreadcrumbEditNodeDelimiterGlyph(ACanvas: TcxCanvas;
      const R: TRect; AState: TdxBreadcrumbEditButtonState); virtual;
    procedure DrawBreadcrumbEditNodeMoreButtonGlyph(
      ACanvas: TcxCanvas; const R: TRect; AState: TdxBreadcrumbEditButtonState); virtual;
    procedure DrawBreadcrumbEditProgressChunk(ACanvas: TcxCanvas; const R: TRect); virtual;
    procedure DrawBreadcrumbEditProgressChunkOverlay(ACanvas: TcxCanvas; const R: TRect); virtual;
    // CustomMenu
    procedure DrawDropDownListBoxBackground(ACanvas: TcxCanvas; const ARect: TRect; AHasBorders: Boolean); virtual;
    procedure DrawDropDownListBoxGutterBackground(ACanvas: TcxCanvas; const ARect: TRect); virtual;
    procedure DrawDropDownListBoxSelection(ACanvas: TcxCanvas; const ARect, AGutterRect: TRect); virtual;
    procedure DrawDropDownListBoxSeparator(ACanvas: TcxCanvas; const ARect, AGutterRect: TRect); virtual;
    function DropDownListBoxBordersSize: Integer; virtual;
    function DropDownListBoxItemImageOffsets: TRect; virtual;
    function DropDownListBoxItemTextColor(ASelected: Boolean): TColor; virtual;
    function DropDownListBoxItemTextOffsets: TRect; virtual;
    function DropDownListBoxSeparatorSize: Integer; virtual;
    // AlertWindow
    function AlertWindowButtonContentOffsets(AKind: TdxAlertWindowButtonKind): TRect; virtual;
    function AlertWindowButtonGlyphSize(AKind: TdxAlertWindowButtonKind): TSize; virtual;
    function AlertWindowContentOffsets: TRect; virtual;
    ...
    procedure DrawAlertWindowBackground(ACanvas: TcxCanvas; const ABounds: TRect); virtual;
    procedure DrawAlertWindowButton(ACanvas: TcxCanvas; const ABounds: TRect;
      AState: TcxButtonState; AKind: TdxAlertWindowButtonKind; ADown: Boolean = False); virtual;
    procedure DrawAlertWindowNavigationPanel(ACanvas: TcxCanvas; const ABounds: TRect); virtual;
    // Gallery
    function GetGalleryGroupHeaderContentOffsets: TRect; virtual;
  ...
  public
    ...
    procedure DrawBreadcrumbEditButton(ACanvas: TcxCanvas;
      const ARect: TRect; AState: TdxBreadcrumbEditButtonState; AIsFirst, AIsLast: Boolean); override;
    procedure DrawBreadcrumbEditDropDownButton(ACanvas: TcxCanvas; const ARect: TRect;
      AState: TdxBreadcrumbEditButtonState; AIsInEditor: Boolean); override;
    // Bevel
  ...
  public
    ...
    procedure DrawDropDownListBoxBackground(ACanvas: TcxCanvas; const ARect: TRect; AHasBorders: Boolean); override;
    procedure DrawDropDownListBoxGutterBackground(ACanvas: TcxCanvas; const ARect: TRect); override;
    procedure DrawDropDownListBoxSelection(ACanvas: TcxCanvas;
      const ARect: TRect; const AGutterRect: TRect); override;
    procedure DrawDropDownListBoxSeparator(ACanvas: TcxCanvas;
      const ARect: TRect; const AGutterRect: TRect); override;
    //AlertWindow
  ...
  protected
    procedure DrawBreadcrumbEditNodePart(ACanvas: TcxCanvas;
      const R: TRect; AState: TdxBreadcrumbEditButtonState; ABorders: TcxBorders); virtual;
    ...
    function NativeZoomButtonDraw(ACanvas: TcxCanvas;
      const R: TRect; AState: TcxButtonState; AGlyph: TBitmap): Boolean;
    function NativeZoomButtonGetMinSize(AGlyph: TBitmap; out ASize: TSize): Boolean;
  ...
  public
    ...
    procedure DrawCommandLinkBackground(ACanvas: TcxCanvas; R: TRect; AState: TcxButtonState; AColor: TColor = clDefault); override;
    procedure DrawCommandLinkGlyph(ACanvas: TcxCanvas; const AGlyphPos: TPoint; AState: TcxButtonState); override;
    function GetCommandLinkGlyphSize: TSize; override;
    function GetCommandLinkMargins: TRect; override;
    ...
    procedure DrawCheck(ACanvas: TcxCanvas; const R: TRect; AState: TcxButtonState;
      ACheckState: TcxCheckBoxState; AColor: TColor); override;
    procedure DrawCheckBorder(ACanvas: TcxCanvas; R: TRect; AState: TcxButtonState); override;
    // RadioGroup
    procedure DrawRadioButton(ACanvas: TcxCanvas; X, Y: Integer;
    ...
    function NavigatorButtonMinSize: TSize; override;
    // DropDownListBox
    function DropDownListBoxItemTextColor(ASelected: Boolean): TColor; override;
    ...
    procedure DrawBreadcrumbEditButtonAreaSeparator(
      ACanvas: TcxCanvas; const ARect: TRect; AState: TdxBreadcrumbEditState); override;
    procedure DrawBreadcrumbEditButton(ACanvas: TcxCanvas;
      const ARect: TRect; AState: TdxBreadcrumbEditButtonState; AIsFirst, AIsLast: Boolean); override;
    procedure DrawBreadcrumbEditDropDownButton(ACanvas: TcxCanvas; const ARect: TRect;
      AState: TdxBreadcrumbEditButtonState; AIsInEditor: Boolean); override;
    ...
    // Bevel
    function GetBevelMinimalShapeSize(AShape: TdxBevelShape): TSize; override;
    procedure DrawBevelFrame(ACanvas: TcxCanvas; const R: TRect;
      AColor1, AColor2: TColor; ABoxStyle: Boolean); override;
    procedure DrawBevelLine(ACanvas: TcxCanvas; const R: TRect;
      AColor1, AColor2: TColor; AIsVertical: Boolean); override;
  end;
...
procedure dxAdjustToTouchableSize(var AElementSizeDimension: Integer); overload;
procedure dxAdjustToTouchableSize(var AElementSize: TSize); overload;
function dxElementSizeFitsForTouch(AElementSizeDimension: Integer): Boolean;
function cxTextRect(const R: TRect): TRect;
function cxGetSchedulerGroupPolygon(const R: TRect): TPointArray;
function cxGetSchedulerMilestonePolygon(const R: TRect): TPointArray;
...
procedure TcxWinXPLookAndFeelPainter.DrawCommandLinkBackground(
...
begin
  ATheme := OpenTheme(totButton);
  if (ATheme <> 0) and IsWinVistaOrLater then
    DrawThemeBackground(ATheme, ACanvas.Handle, BP_COMMANDLINK,
      BtnStateToXPBtnState(AState), R, nil)
  else
    cxLookAndFeelPaintersManager.GetPainter(lfsFlat).DrawButton(
      ACanvas, R, '', AState, (AState = cxbsHot) or (AState = cxbsPressed), AColor);
end;

procedure TcxWinXPLookAndFeelPainter.DrawCommandLinkGlyph(ACanvas: TcxCanvas;
  const AGlyphPos: TPoint; AState: TcxButtonState);
var
  ATheme: TdxTheme;
  ARect: TRect;
begin
  ...
  if (ATheme <> 0) and IsWinVistaOrLater then
  begin
    ARect := cxRectSetOrigin(cxRect(GetCommandLinkGlyphSize), AGlyphPos);
    DrawThemeBackground(ATheme, ACanvas.Handle, BP_COMMANDLINKGLYPH,
      BtnStateToXPBtnState(AState), ARect);
  end
  else
    inherited DrawCommandLinkGlyph(ACanvas, AGlyphPos, AState);
end;

function TcxWinXPLookAndFeelPainter.GetCommandLinkGlyphSize: TSize;
var
  ATheme: TdxTheme;
begin
  ATheme := OpenTheme(totButton);
  if (ATheme <> 0) and IsWinVistaOrLater then
    ...
    Result := inherited GetCommandLinkGlyphSize;
end;

function TcxWinXPLookAndFeelPainter.GetCommandLinkMargins: TRect;

  function ConverMarginsToRect(AMargins: TdxMargins): TRect;
  begin
    Result := Rect(AMargins.cxLeftWidth, AMargins.cyTopHeight,
      AMargins.cxRightWidth, AMargins.cyBottomHeight);
  end;
...
begin
  ...
  begin
    ...
    Result := ConverMarginsToRect(AMargins);
  end
  else
    Result := inherited GetCommandLinkMargins;
end;
...
procedure TcxWinXPLookAndFeelPainter.DrawSmallButton(ACanvas: TcxCanvas; R: TRect; AState: TcxButtonState);
begin
...
procedure TcxWinXPLookAndFeelPainter.DrawCheck(ACanvas: TcxCanvas; const R: TRect;
  AState: TcxButtonState; ACheckState: TcxCheckBoxState; AColor: TColor);

  function GetCheckNativeState(AState: TcxButtonState; ACheckState: TcxCheckBoxState): Integer;
  const
    ANativeCheckStateMap: array[TcxCheckBoxState, TcxButtonState] of Integer = (
  ...
  begin
    Result := ANativeCheckStateMap[ACheckState, AState];
  end;
...
begin
  ATheme := OpenTheme(totButton);
  if ATheme <> 0 then
    DrawThemeBackground(ATheme, ACanvas.Handle, BP_CHECKBOX, GetCheckNativeState(AState, ACheckState), R)
  else
    inherited;
end;
...
begin
  ...
  DrawHeader(ACanvas, ABounds, ATextAreaBounds, [nRight], ABorders,
...
procedure TcxWinXPLookAndFeelPainter.DrawSummarySortingMark(
  ACanvas: TcxCanvas; const R: TRect; AAscendingSorting: Boolean);
begin
  DrawSummarySortingArrow(ACanvas, R, clBtnShadow, clBtnShadow, AAscendingSorting);
end;
...
procedure TcxWinXPLookAndFeelPainter.DrawMonthHeader(
  ...
  AArrows: TcxArrowDirections; ASideWidth: Integer;
  AOnDrawBackground: TcxDrawBackgroundEvent = nil);
begin
...
function TcxWinXPLookAndFeelPainter.GetZoomInButtonSize: TSize;
begin
  if not NativeZoomButtonGetMinSize(ZoomInButtonGlyph, Result) then
    Result := inherited GetZoomInButtonSize;
end;

function TcxWinXPLookAndFeelPainter.GetZoomOutButtonSize: TSize;
begin
  if not NativeZoomButtonGetMinSize(ZoomOutButtonGlyph, Result) then
    Result := inherited GetZoomOutButtonSize;
end;

procedure TcxWinXPLookAndFeelPainter.DrawZoomInButton(
  ACanvas: TcxCanvas; const R: TRect; AState: TcxButtonState);
begin
  if not NativeZoomButtonDraw(ACanvas, R, AState, ZoomInButtonGlyph) then
    inherited DrawZoomInButton(ACanvas, R, AState);
end;

procedure TcxWinXPLookAndFeelPainter.DrawZoomOutButton(
  ACanvas: TcxCanvas; const R: TRect; AState: TcxButtonState);
begin
  if not NativeZoomButtonDraw(ACanvas, R, AState, ZoomOutButtonGlyph) then
...
begin
  ...
  begin
    DrawThemeBackground(ATheme, ACanvas.Handle,
      TrackBarThumbThemeParts[ATicks, AHorizontal], StateMap[AState], ARect);
  end
  else
    inherited DrawTrackBarThumb(ACanvas, ARect, AState, AHorizontal, ATicks, AThumbColor);
end;
...
begin
  ...
  begin
    DrawThemeBackground(ATheme, ACanvas.Handle, BP_PUSHBUTTON, BtnStateToXPBtnState(AState), R);
    cxDrawImage(ACanvas, R, AGlyph, nil, -1, ifmNormal);
  end;
end;

function TcxWinXPLookAndFeelPainter.NativeZoomButtonGetMinSize(AGlyph: TBitmap; out ASize: TSize): Boolean;
var
  AMargins: TdxMargins;
  ATheme: TdxTheme;
begin
...
function TcxWinXPLookAndFeelPainter.NavigatorButtonMinSize: TSize;
begin
  Result := Size(18, 19);
end;
...
function TcxWinXPLookAndFeelPainter.DropDownListBoxSeparatorSize: Integer;
var
  ASize: TSize;
  ATheme: TdxTheme;
begin
...
procedure TcxWinXPLookAndFeelPainter.DrawDropDownListBoxGutterBackground(
...
procedure TcxWinXPLookAndFeelPainter.DrawDropDownListBoxSelection(
  ACanvas: TcxCanvas; const ARect: TRect; const AGutterRect: TRect);
var
  ATheme: TdxTheme;
begin
  ATheme := OpenTheme(totMenu);
...
procedure TcxWinXPLookAndFeelPainter.DrawDropDownListBoxSeparator(
  ACanvas: TcxCanvas; const ARect: TRect; const AGutterRect: TRect);
var
  ASize: TSize;
  ATheme: TdxTheme;
...
function TcxWinXPLookAndFeelPainter.BreadcrumbEditProgressChunkPadding: TRect;
begin
  Result := cxNullRect;
end;

function TcxWinXPLookAndFeelPainter.BreadcrumbEditProgressChunkOverlaySize: TSize;
var
  ATheme: TdxTheme;
begin
  ATheme := OpenTheme(totProgress);
  if not (IsWinVistaOrLater and (ATheme <> 0) and
    (GetThemePartSize(ATheme, 0, PP_MOVEOVERLAY, 0, nil, TS_TRUE, @Result) = S_OK))
  then
...
function TcxWinXPLookAndFeelPainter.BreadcrumbEditButtonContentOffsets(AIsFirst, AIsLast: Boolean): TRect;
var
  ATheme: TdxTheme;
  AMargins: TdxMargins;
begin
  ...
  begin
    GetThemeMargins(ATheme, 0, BP_PUSHBUTTON, 0, TMT_CONTENTMARGINS, nil, AMargins);
    Result := cxRect(AMargins.cxLeftWidth, AMargins.cyTopHeight,
      AMargins.cxRightWidth, AMargins.cyBottomHeight);
  end
  else
...
procedure TcxWinXPLookAndFeelPainter.DrawBreadcrumbEditButtonAreaSeparator(
  ACanvas: TcxCanvas; const ARect: TRect; AState: TdxBreadcrumbEditState);
begin
end;

procedure TcxWinXPLookAndFeelPainter.DrawBreadcrumbEditButton(
  ...
  begin
    Result := BreadcrumbEditButtonContentOffsets(AIsFirst, AIsLast);
    Result.Left := 1;
    Result.Right := 1;
  end;
  ...
  if ATheme = 0 then
    ...
    begin
      ...
      try
        ACanvas.IntersectClipRect(ARect);
        DrawThemeBackground(ATheme, ACanvas.Handle, BP_PUSHBUTTON,
          StateMap[AState], cxRectInflate(ARect, GetContentMargins));
      finally
        ACanvas.RestoreClipRegion;
      end;
    end;
...
procedure TcxWinXPLookAndFeelPainter.DrawBreadcrumbEditDropDownButton(
  ACanvas: TcxCanvas; const ARect: TRect; AState: TdxBreadcrumbEditButtonState;
  AIsInEditor: Boolean);
begin
  DrawBreadcrumbEditButton(ACanvas, ARect, AState, True, True);
end;

procedure TcxWinXPLookAndFeelPainter.DrawBreadcrumbEditNode(ACanvas: TcxCanvas;
...
begin
  if OpenTheme(totButton) = 0 then
    ...
    DrawBreadcrumbEditNodePart(ACanvas, R, AState, BordersMap[AHasDelimiter]);
end;

procedure TcxWinXPLookAndFeelPainter.DrawBreadcrumbEditNodeDelimiter(
...
begin
  if OpenTheme(totButton) = 0 then
    ...
    DrawBreadcrumbEditNodePart(ACanvas, R, AState, [bLeft, bRight]);
end;

procedure TcxWinXPLookAndFeelPainter.DrawBreadcrumbEditNodePart(ACanvas: TcxCanvas;
  const R: TRect; AState: TdxBreadcrumbEditButtonState; ABorders: TcxBorders);
const
  StateMap: array[TdxBreadcrumbEditButtonState] of Integer =
    (-1, PBS_NORMAL, PBS_HOT, PBS_PRESSED, -1);
var
...
begin
  ...
  begin
    ...
    try
      ...
      AContentExtends := BreadcrumbEditButtonContentOffsets(True, True);
      if bLeft in ABorders then AContentExtends.Left := 1;
      if bBottom in ABorders then AContentExtends.Bottom := 1;
      if bRight in ABorders then AContentExtends.Right := 1;
      if bTop in ABorders then AContentExtends.Top := 1;
...
procedure TcxWinXPLookAndFeelPainter.DrawBreadcrumbEditNodeDelimiterGlyph(
  ACanvas: TcxCanvas; const R: TRect; AState: TdxBreadcrumbEditButtonState);
const
  ArrowDirections: array[Boolean] of TcxArrowDirection = (adRight, adDown);
begin
  DrawArrow(ACanvas, cxRectInflate(R, -1, -1), ArrowDirections[AState = dxbcbsPressed],
    BreadcrumbEditNodeTextColor(AState));
end;

procedure TcxWinXPLookAndFeelPainter.DrawBreadcrumbEditNodeMoreButtonGlyph(
  ACanvas: TcxCanvas; const R: TRect; AState: TdxBreadcrumbEditButtonState);
begin
  DrawCollapseArrow(ACanvas, R, BreadcrumbEditNodeTextColor(AState), cxGetValueCurrentDPI(2));
end;

procedure TcxWinXPLookAndFeelPainter.DrawBreadcrumbEditProgressChunk(ACanvas: TcxCanvas; const R: TRect);
var
  ATheme: TdxTheme;
begin
  ATheme := OpenTheme(totProgress);
...
procedure TcxWinXPLookAndFeelPainter.DrawBreadcrumbEditProgressChunkOverlay(ACanvas: TcxCanvas; const R: TRect);
var
  ATheme: TdxTheme;
begin
  ATheme := OpenTheme(totProgress);
...
function TcxWinXPLookAndFeelPainter.GetBackButtonSize: TSize;
var
  ATheme: TdxTheme;
begin
...
procedure TcxWinXPLookAndFeelPainter.DrawBackButton(
  ACanvas: TcxCanvas; const R: TRect; AState: TcxButtonState);
const
...
begin
  ATheme := OpenTheme(totNavigation);
  if ATheme <> 0 then
    DrawThemeBackground(ATheme, ACanvas.Handle, NAV_BACKBUTTON, StatesMap[AState], R)
  else
    inherited DrawBackButton(ACanvas, R, AState);
end;

procedure TcxWinXPLookAndFeelPainter.DrawBevelFrame(ACanvas: TcxCanvas;
  const R: TRect; AColor1, AColor2: TColor; ABoxStyle: Boolean);
var
  ATheme: TdxTheme;
begin
  ATheme := OpenTheme(totButton);
...
procedure TcxWinXPLookAndFeelPainter.DrawBevelLine(ACanvas: TcxCanvas;
...
procedure TcxUltraFlatLookAndFeelPainter.DrawSummarySortingMark(ACanvas: TcxCanvas;
  const R: TRect; AAscendingSorting: Boolean);
begin
  DrawSummarySortingArrow(ACanvas, R, clBtnShadow, clBtnShadow, AAscendingSorting);
end;
...
function TcxUltraFlatLookAndFeelPainter.SummarySortingMarkSize: TPoint;
begin
  Result := Point(7, 9);
end;
...
procedure TcxUltraFlatLookAndFeelPainter.DrawNavigatorButton(ACanvas: TcxCanvas;
...
begin
  ...
  begin
    if AState in [cxbsDisabled, cxbsNormal] then
      ...
      FrameRect(R, BorderHighlightColor);
...
procedure TcxUltraFlatLookAndFeelPainter.DrawDropDownListBoxSelection(
...
procedure TcxUltraFlatLookAndFeelPainter.DrawDropDownListBoxSeparator(
  ACanvas: TcxCanvas; const ARect, AGutterRect: TRect);
var
  R: TRect;
begin
...
procedure TcxUltraFlatLookAndFeelPainter.DrawDropDownListBoxGutterBackground(
  ACanvas: TcxCanvas; const ARect: TRect);
begin
...
function TcxUltraFlatLookAndFeelPainter.BreadcrumbEditButtonAreaSeparatorSize: Integer;
begin
  Result := 1;
end;

function TcxUltraFlatLookAndFeelPainter.BreadcrumbEditButtonContentOffsets(
  AIsFirst, AIsLast: Boolean): TRect;
begin
  Result := cxGetValueCurrentDPI(cxRect(3 - Ord(AIsFirst), 3, 3 - Ord(AIsLast), 3));
end;
...
procedure TcxUltraFlatLookAndFeelPainter.DrawBreadcrumbEditButtonAreaSeparator(
  ACanvas: TcxCanvas; const ARect: TRect; AState: TdxBreadcrumbEditState);
begin
...
procedure TcxUltraFlatLookAndFeelPainter.DrawBreadcrumbEditButton(
  ACanvas: TcxCanvas; const ARect: TRect; AState: TdxBreadcrumbEditButtonState;
  AIsFirst, AIsLast: Boolean);
var
  ABorders: TcxBorders;
...
procedure TcxUltraFlatLookAndFeelPainter.DrawBreadcrumbEditDropDownButton(
  ACanvas: TcxCanvas; const ARect: TRect; AState: TdxBreadcrumbEditButtonState;
  AIsInEditor: Boolean);
begin
...
procedure TcxStandardLookAndFeelPainter.DrawSummarySortingMark(ACanvas: TcxCanvas;
  const R: TRect; AAscendingSorting: Boolean);
begin
  DrawSummarySortingArrow(ACanvas, R, clBtnShadow, clBtnHighlight, AAscendingSorting);
end;
...
function TcxStandardLookAndFeelPainter.SummarySortingMarkSize: TPoint;
begin
  Result := Point(8, 8);
end;
...
procedure TcxStandardLookAndFeelPainter.DrawBreadcrumbEditButton(
  ACanvas: TcxCanvas; const ARect: TRect; AState: TdxBreadcrumbEditButtonState;
  AIsFirst, AIsLast: Boolean);
begin
...
procedure TcxCustomLookAndFeelPainter.DrawFilterSmartTagGlyph(ACanvas: TcxCanvas;
  const R: TRect; AState: TcxFilterSmartTagState; AIsFilterActive: Boolean);
type
  TGlyphPoints = array[0..12] of TPoint;
const
  GlyphPattern: TGlyphPoints = (
    (X: 0; Y: 0), (X: 5; Y: 0), (X: 5; Y: 2), (X: 4; Y: 2), (X: 4; Y: 3), (X: 3; Y: 3),
    (X: 3; Y: 5), (X: 2; Y: 5), (X: 2; Y: 3), (X: 1; Y: 3), (X: 1; Y: 2), (X: 0; Y: 2),
    (X: 0; Y: 0));
var
  Points: TGlyphPoints;
  I: Integer;
  R1: TRect;
begin
  R1 := cxRectCenter(R, 6, 6);
  for I := Low(Points) to High(Points) do
    Points[I] := cxPoint(GlyphPattern[I].X + R1.Left, GlyphPattern[I].Y + R1.Top);
  ACanvas.Pen.Color := GetFilterSmartTagColor(AState, AIsFilterActive);
  ACanvas.Canvas.Polyline(Points);
end;
...
begin
  ...
  X := (R.Left + R.Right - cxIndicatorImages.Width) div 2;
  Y := (R.Top + R.Bottom - cxIndicatorImages.Height) div 2;
  cxIndicatorImages.Draw(ACanvas.Canvas, X, Y, Ord(AKind) - 1);
end;

procedure TcxCustomLookAndFeelPainter.DrawMonthHeaderArrows(
  ACanvas: TcxCanvas; const ABounds: TRect; AArrows: TcxArrowDirections;
...
begin
  Sign := 2 * Byte(AAscendingSorting) - 1;
  with SummarySortingMarkSize do
  begin
    AWidth := X;
    AHeight := Y;
  end;
...
begin
  DrawHeader(ACanvas, ABounds, cxNullRect, [], cxBordersAll, cxbsNormal,
    taLeftJustify, vaCenter, False, True, '', nil, clNone, DefaultHeaderColor);
end;
...
begin
  Result := cxSize(BackButton.Width, BackButton.Height div 4);
end;

procedure TcxCustomLookAndFeelPainter.DrawBackButton(
  ACanvas: TcxCanvas; const R: TRect; AState: TcxButtonState);
const
...
var
  ASourceRect: TRect;
begin
  ASourceRect := cxRectSetHeight(BackButton.ClientRect, GetBackButtonSize.cy);
  ASourceRect := cxRectOffset(ASourceRect, 0, OffsetMap[AState] * GetBackButtonSize.cy);
...
procedure TcxCustomLookAndFeelPainter.DrawBevelFrame(
  ACanvas: TcxCanvas; const R: TRect; AColor1, AColor2: TColor;
  ABoxStyle: Boolean);
var
  ARect: TRect;
begin
  if AColor2 = clNone then
    ...
    if ABoxStyle then
      ACanvas.DrawComplexFrame(R, AColor1, AColor2)
    else
    begin
      ARect := cxRectInflate(R, -1, -1, 0, 0);
      ACanvas.FrameRect(ARect, AColor2);
      ACanvas.FrameRect(cxRectOffset(ARect, -1, -1), AColor1);
    end;
end;
...
function TcxCustomLookAndFeelPainter.DefaultCommandLinkTextColor(
  AState: TcxButtonState; ADefaultColor: TColor): TColor;
begin
...
procedure TcxCustomLookAndFeelPainter.DrawCommandLinkBackground(
  ACanvas: TcxCanvas; R: TRect; AState: TcxButtonState; AColor: TColor = clDefault);
begin
  DrawButton(ACanvas, R, '', AState, True, AColor);
end;

procedure TcxCustomLookAndFeelPainter.DrawCommandLinkGlyph(ACanvas: TcxCanvas;
  const AGlyphPos: TPoint; AState: TcxButtonState);
var
  ADestRect: TRect;
  ASrcRect: TRect;
...
begin
  ...
  try
    ...
    ASrcRect := cxRect(GetCommandLinkGlyphSize);
    ADestRect := cxRectSetOrigin(ASrcRect, AGlyphPos);
    if AState = cxbsHot then
      ASrcRect := cxRectSetOrigin(ASrcRect, Point(0, GetCommandLinkGlyphSize.cy));

    ACommandLinkGlyphs.StretchDraw(ACanvas.Handle, ADestRect, ASrcRect, 255);
  finally
    FreeAndNil(ACommandLinkGlyphs);
  end;
end;
...
begin
  DrawCheck(ACanvas, R, AState, CheckStatesMap[AChecked], AColor);
end;
...
begin
  ...
  DrawCheck(ACanvas, R, AState, ACheckState,
...
procedure TcxCustomLookAndFeelPainter.DrawSummarySortingMark(ACanvas: TcxCanvas;
  const R: TRect; AAscendingSorting: Boolean);
begin
end;
...
begin
  if cxIsTouchModeEnabled then
    Result := Point(SortingTouchableMarkAreaWidth, SortingMarkSize.Y)
  else
...
procedure TcxCustomLookAndFeelPainter.DrawFilterCloseButton(ACanvas: TcxCanvas;
  R: TRect; AState: TcxButtonState);
begin
  DrawSmallButton(ACanvas, R, AState);
...
begin
  ...
  ACanvas.Pen.Color := GetFilterSmartTagColor(AState, AIsFilterActive);
  ACanvas.Rectangle(R);
  DrawFilterSmartTagGlyph(ACanvas, R, AState, AIsFilterActive);
  ACanvas.Brush.Style := bsSolid;
end;
...
procedure TcxCustomLookAndFeelPainter.DrawZoomInButton(
  ACanvas: TcxCanvas; const R: TRect; AState: TcxButtonState);
const
  PlusSignIndent = 3;
begin
  DrawZoomOutButton(ACanvas, R, AState);
  ACanvas.MoveTo((R.Left + R.Right) div 2, R.Top + PlusSignIndent);
  ACanvas.LineTo((R.Left + R.Right) div 2, R.Bottom - PlusSignIndent);
end;

procedure TcxCustomLookAndFeelPainter.DrawZoomOutButton(
  ACanvas: TcxCanvas; const R: TRect; AState: TcxButtonState);
const
  MinusSignIndent = 3;
var
...
begin
  ...
  if AState <> cxbsDisabled then
    ...
    ACanvas.Pen.Color := clBtnShadow;
  ACanvas.MoveTo(R.Left + MinusSignIndent, (R.Top + R.Bottom) div 2);
  ACanvas.LineTo(R.Right - MinusSignIndent, (R.Top + R.Bottom) div 2);
end;
...
begin
  ...
  begin
    ...
    try
      ...
      DrawSizeGrip(ABitmap.cxCanvas, ABitmap.ClientRect, clNone, AGripCorner);
...
begin
  dxRotateSizeGrip(ACanvas, ARect, ABackgroundColor, ACorner, DoDrawSizeGrip);
end;
...
procedure TcxCustomLookAndFeelPainter.DrawSliderButton(ACanvas: TcxCanvas; const ARect: TRect;
  ADirection: TcxArrowDirection; AState: TcxButtonState);
const
  APart: array[Boolean] of TcxScrollBarPart = (sbpLineUp, sbpLineDown);
begin
  DrawScrollBarPart(ACanvas, ADirection in [adLeft, adRight],
    ARect, APart[ADirection in [adRight, adDown]], AState);
end;
...
procedure TcxCustomLookAndFeelPainter.DrawSmallCloseButton(ACanvas: TcxCanvas;
  R: TRect; AState: TcxButtonState);
begin
...
begin
  DrawHeader(ACanvas, ABounds, ABounds, [nRight, nLeft], cxBordersAll, cxbsNormal,
    taLeftJustify, vaCenter, False, False, '', nil, clNone, ABackgroundColor, AOnDrawBackground);
end;
...
procedure TcxCustomLookAndFeelPainter.DrawNavigatorButtonGlyph(ACanvas: TcxCanvas;
...
function TcxCustomLookAndFeelPainter.GroupBoxCaptionTailSize(
  ACaptionPosition: TcxGroupBoxCaptionPosition): Integer;
begin
  Result := 0;
end;
...
begin
  Result := Size(ZoomButtonWidth, ZoomButtonHeight);
end;
...
function TcxCustomLookAndFeelPainter.BreadcrumbEditButtonContentOffsets(
  AIsFirst, AIsLast: Boolean): TRect;
begin
  Result := cxGetValueCurrentDPI(cxRect(3, 3, 3, 3));
end;

function TcxCustomLookAndFeelPainter.BreadcrumbEditDropDownButtonOriginalWidth: Integer;
begin
...
begin
  Result := BreadcrumbEditDropDownButtonOriginalWidth;
  dxAdjustToTouchableSize(Result);
end;
...
begin
  Result := cxGetValueCurrentDPI(16);
end;
...
begin
  Result := cxGetValueCurrentDPI(cxRect(4, 4, 4, 4));
end;
...
begin
  if not (AState in [dxbcbsNormal, dxbcbsDisabled]) then
    DrawButton(ACanvas, ARect, '', BreadcrumbButtonStateToButtonState[AState]);
end;
...
procedure TcxCustomLookAndFeelPainter.DrawBreadcrumbEditDropDownButtonGlyph(
  ...
  AIsInEditor: Boolean);
begin
  DrawButtonArrow(ACanvas, cxRectInflate(ARect, -cxTextOffset, -cxTextOffset),
...
procedure TcxCustomLookAndFeelPainter.DrawBreadcrumbEditNode(ACanvas: TcxCanvas;
  const R: TRect; AState: TdxBreadcrumbEditButtonState; AHasDelimiter: Boolean);
begin
  DrawBreadcrumbEditButton(ACanvas, R, AState, False, AHasDelimiter);
end;

procedure TcxCustomLookAndFeelPainter.DrawBreadcrumbEditNodeDelimiter(
  ACanvas: TcxCanvas; const R: TRect; AState: TdxBreadcrumbEditButtonState);
begin
  DrawBreadcrumbEditButton(ACanvas, R, AState, False, False);
end;
...
procedure TcxCustomLookAndFeelPainter.DrawBreadcrumbEditNodeMoreButtonGlyph(
  ACanvas: TcxCanvas; const R: TRect; AState: TdxBreadcrumbEditButtonState);
begin
  DrawBreadcrumbEditNodeDelimiterGlyph(ACanvas, R, AState);
end;

procedure TcxCustomLookAndFeelPainter.DrawBreadcrumbEditProgressChunk(
  ACanvas: TcxCanvas; const R: TRect);
begin
  ACanvas.FillRect(R, $AAA8A4);
end;

procedure TcxCustomLookAndFeelPainter.DrawBreadcrumbEditProgressChunkOverlay(
  ACanvas: TcxCanvas; const R: TRect);
begin
end;
...
procedure TcxCustomLookAndFeelPainter.DrawDropDownListBoxSelection(
  ACanvas: TcxCanvas; const ARect, AGutterRect: TRect);
begin
  ACanvas.FillRect(ARect, clMenuHighlight);
end;

procedure TcxCustomLookAndFeelPainter.DrawDropDownListBoxSeparator(
  ACanvas: TcxCanvas; const ARect, AGutterRect: TRect);
begin
  ACanvas.DrawComplexFrame(cxRectCenterVertically(ARect, 2),
    clBtnShadow, clBtnHighlight, [bTop, bBottom]);
end;

procedure TcxCustomLookAndFeelPainter.DrawDropDownListBoxGutterBackground(
  ACanvas: TcxCanvas; const ARect: TRect);
begin
end;
...
begin
  Result := cxGetValueCurrentDPI(cxRect(5, 3, 5, 3));
end;
...
begin
  Result := cxGetValueCurrentDPI(cxRect(5, cxTextOffset, 5, cxTextOffset));
end;

function TcxCustomLookAndFeelPainter.DropDownListBoxSeparatorSize: Integer;
begin
  Result := cxGetValueCurrentDPI(8);
end;
...
function TcxCustomLookAndFeelPainter.AlertWindowButtonContentOffsets(
  AKind: TdxAlertWindowButtonKind): TRect;
begin
  Result := cxRect(3, 3, 3, 3);
end;

function TcxCustomLookAndFeelPainter.AlertWindowButtonGlyphSize(
  AKind: TdxAlertWindowButtonKind): TSize;
begin
...
procedure TcxCustomLookAndFeelPainter.DrawAlertWindowButton(ACanvas: TcxCanvas;
...
begin
  if ADown then
    AState := cxbsPressed;
  DrawButton(ACanvas, ABounds, '', AState);
  R := cxRectContent(ABounds, AlertWindowButtonContentOffsets(AKind));
  case AKind of
    awbkClose:
      DrawButtonCross(ACanvas, R, ButtonSymbolColor(AState), AState);
    awbkPin:
...
procedure TcxCustomLookAndFeelPainter.DrawAlertWindowNavigationPanel(
  ACanvas: TcxCanvas; const ABounds: TRect);
begin
  ACanvas.FrameRect(ABounds, clBtnShadow, 1, cxBordersAll);
end;

procedure TcxCustomLookAndFeelPainter.DrawPin(ACanvas: TcxCanvas;
  const ABounds: TRect; AColor: TColor; APinned: Boolean);
...
procedure dxAdjustToTouchableSize(var AElementSizeDimension: Integer);
begin
  if cxIsTouchModeEnabled and (AElementSizeDimension > 0) then
    AElementSizeDimension := Max(AElementSizeDimension, cxGetValueCurrentDPI(cxTouchElementMinSize));
end;

procedure dxAdjustToTouchableSize(var AElementSize: TSize);
begin
  dxAdjustToTouchableSize(AElementSize.cx);
  dxAdjustToTouchableSize(AElementSize.cy);
end;

function dxElementSizeFitsForTouch(AElementSizeDimension: Integer): Boolean;
begin
  Result := AElementSizeDimension >= cxGetValueCurrentDPI(cxTouchElementMinSize);
end;
...
procedure TcxFlatLookAndFeelPainter.DrawSummarySortingMark(ACanvas: TcxCanvas;
  const R: TRect; AAscendingSorting: Boolean);
begin
  DrawSummarySortingArrow(ACanvas, R, clBtnShadow, clBtnHighlight, AAscendingSorting);
end;
...
function TcxFlatLookAndFeelPainter.SummarySortingMarkSize: TPoint;
begin
  Result := Point(8, 8);
end;
...
procedure TcxOffice11LookAndFeelPainter.DrawSummarySortingMark(ACanvas: TcxCanvas;
  const R: TRect; AAscendingSorting: Boolean);
begin
  DrawSummarySortingArrow(ACanvas, R, HeaderDarkEdgeColor, HeaderHighlightEdgeColor, AAscendingSorting);
end;
...
function TcxOffice11LookAndFeelPainter.ScrollBarMinimalThumbSize(AVertical: Boolean): Integer;
var
  APainter: TcxCustomLookAndFeelPainter;
begin
  if cxLookAndFeelPaintersManager.GetPainter(lfsNative, APainter) then
    Result := APainter.ScrollBarMinimalThumbSize(AVertical)
  else
    Result := inherited ScrollBarMinimalThumbSize(AVertical);
end;
...
begin
  ...
  begin
    ...
    FillTubeGradientRect(ACanvas.Handle, R, AColor1, AColor2, False);
...
procedure TcxOffice11LookAndFeelPainter.DrawDropDownListBoxSelection(
  ACanvas: TcxCanvas; const ARect: TRect; const AGutterRect: TRect);
begin
...
procedure TcxOffice11LookAndFeelPainter.DrawDropDownListBoxSeparator(
  ACanvas: TcxCanvas; const ARect: TRect; const AGutterRect: TRect);
var
  R: TRect;
begin
...
procedure TcxOffice11LookAndFeelPainter.DrawDropDownListBoxGutterBackground(
  ACanvas: TcxCanvas; const ARect: TRect);
begin
  FillTubeGradientRect(ACanvas.Handle, ARect,
...
begin
  ...
  ACanvas.FrameRect(R, dxOffice11ControlBorderColor);
  InflateRect(R, -1, -1);
  FillGradientRect(ACanvas.Handle, R, dxOffice11DockColor2,
    dxOffice11DockColor1, False);
end;
