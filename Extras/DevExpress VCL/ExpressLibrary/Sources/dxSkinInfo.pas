...
uses
  ...
  cxGeometry, cxLookAndFeelPainters, dxSkinsCore, dxSkinsStrs, dxCoreClasses;
...
type
  ...
  public
    ...
    RibbonFormButtonAutoHideMode: TdxSkinElement;
    ...
    begin
      ...
      begin
        FormFrames[AStandard, ASide] :=
          GetElementByName(GroupForm, FormFrameMap[AStandard, ASide]);
...
begin
  ...
  GroupExpandButton := GetElementByName(GroupCommon, sdxGroupExpandButton);
  ...
  begin
    ...
    GroupBoxCaptionTailSizes[APosition] := GetIntPropertyByName(GroupBoxCaptionElements[APosition], sdxGroupPanelCaptionTailSize);
    GroupBoxCaptionTextPadding[APosition] := GetIntPropertyByName(GroupBoxCaptionElements[APosition], sdxGroupPanelCaptionTextPadding);
  end;
end;
...
begin
  ...
  if Assigned(GroupNavPane) then
    NavPaneOffsetGroupBorders := GroupNavPane.GetPropertyByName(
...
begin
  ...
  RibbonCaptionText[False] := GetElementColorProperty(RibbonFormCaption, sdxTextColorInactive);
  ...
  RibbonContextualTabHeaderText[True] :=  GetElementColorProperty(RibbonContextualTabHeader, sdxTextColorSelected);
  RibbonContextualTabHeaderText[False] := GetElementTextColor(RibbonContextualTabHeader);
  RibbonContextualTabHeaderTextHot := GetElementColorProperty(RibbonContextualTabHeader, sdxTextColorHot);
  RibbonDocumentNameTextColor[True] := GetElementColorProperty(RibbonFormCaption, sdxRibbonDocumentNameTextColor);
  RibbonDocumentNameTextColor[False] := RibbonCaptionText[False];
  RibbonStatusBarTextSelected := GetElementColorProperty(RibbonStatusBarButton, sdxTextColorSelected);

  RibbonButtonText[False] := GetElementTextColor(RibbonSmallButton);
  RibbonButtonText[True] := GetElementColorProperty(GroupRibbon, sdxRibbonButtonDisabledText);
end;
...
begin
  ...
  RibbonFormButtonAutoHideMode := GetElementByName(GroupRibbon, sdxRibbonFormButtonAutoHideMode);
  ...
  RibbonTabPanelBottomIndent := GetIntPropertyByName(RibbonTabPanel, sdxRibbonTabPanelBottomIndent);
...
begin
  ...
  RibbonSpaceBetweenTabGroups := GetIntPropertyByName(GroupRibbon, sdxRibbonSpaceBetweenTabGroups);
  RibbonTabHeaderDownGrowIndent := GetIntPropertyByName(GroupRibbon, sdxRibbonTabHeaderDownGrowIndent);
...
begin
  ...
  begin
    ...
    LayoutViewRecordCaptionTailSizes[ACaptionPosition] := GetIntPropertyByName(
    ...
    LayoutViewRecordCaptionTextPadding[ACaptionPosition] :=
      GetIntPropertyByName(GroupBoxCaptionElements[ACaptionPosition], sdxGroupPanelCaptionTextPadding);
  end;
end;
