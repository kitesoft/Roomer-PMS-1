...
const
  ...
  crdxLayoutControlDrag = dxLayoutControlCursorBase + 1; // for ver. 1
  crdxLayoutControlNoDrop = dxLayoutControlCursorBase + 2; // for ver. 2
  crdxLayoutControlRemove = dxLayoutControlCursorBase + 3; // for ver. 2
