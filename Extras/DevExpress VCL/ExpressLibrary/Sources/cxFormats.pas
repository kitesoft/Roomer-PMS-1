...
type
  ...
  private
    ...
    procedure SetCurrencyString(const AValue: string); {$IFDEF DELPHI9} inline; {$ENDIF}
    procedure SetDateSeparator(AValue: Char); {$IFDEF DELPHI9} inline; {$ENDIF}
    procedure SetDecimalSeparator(AValue: Char); {$IFDEF DELPHI9} inline; {$ENDIF}
    procedure SetLongDayNames(AIndex: Integer; const Value: string); {$IFDEF DELPHI9} inline; {$ENDIF}
    procedure SetLongMonthNames(AIndex: Integer; const Value: string); {$IFDEF DELPHI9} inline; {$ENDIF}
    procedure SetShortDateFormat(const AValue: string); {$IFDEF DELPHI9} inline; {$ENDIF}
    procedure SetShortDayNames(AIndex: Integer; const AValue: string); {$IFDEF DELPHI9} inline; {$ENDIF}
    procedure SetShortMonthNames(AIndex: Integer; const AValue: string); {$IFDEF DELPHI9} inline; {$ENDIF}
...
begin
  ...
  begin
    SetLength(Result, dxFormatSettings.CurrencyDecimals);
    dxFillChar(Result[1], Length(Result), '0');
  end
  else
    Result := '';
  Result := ',0.' + Result;
        ...
        dtikMonth:
          begin
            ...
            if AUseLongMonthNames then
              AddString(S, dxFormatSettings.LongMonthNames[1])
            else
            ...
            begin
              S := S + '|';
              if AUseLongMonthNames then
                AddString(S, dxFormatSettings.LongMonthNames[I])
              else
