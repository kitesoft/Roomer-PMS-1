...
uses
  ...
  cxControls, ImgList, cxClasses, cxGraphics, cxLookAndFeelPainters, cxGeometry;
...
constructor TfrmPropertiesStoreEditor.Create(AOwner: TComponent);
  ...
  begin
    ...
    try
      ...
      cxLookAndFeelPaintersManager.GetPainter(lfsNative).DrawCheckButton(ACheck.cxCanvas, cxRectCenter(ACheck.ClientRect, ACheck.Width - 3, ACheck.Height - 3), cxbsNormal, ACheckState);
