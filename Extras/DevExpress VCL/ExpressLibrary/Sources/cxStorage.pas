...
begin
  ...
  AResult := Registry.CreateKey(AKeyName) and FRegistry.OpenKey(AKeyName, False);
  APath := Registry.CurrentPath;
  if AResult then
  begin
    AResult := Registry.CreateKey('[ClassName]') and Registry.OpenKey('[ClassName]', False);
    if AResult then
    begin
...
begin
  ...
  begin
    if not Registry.CreateKey(GenRegistryPath(FStorageName)) then
  ...
  begin
    if not Registry.OpenKey(GenRegistryPath(FStorageName), False) then
