...
uses
  ...
  DesignIntf, DesignEditors, DBConsts, DB, dxCoreReg;

const
  dxDBTreeProductName = 'ExpressDBTreeView';
  dxDBTreeProductPage = 'ExpressDBTree';
...
uses
  dxtree, dxDBTree, dxDBTrel, ShellAPI;

type
  TdxDBTreeViewEditor = class(TdxComponentEditor)
  protected
    function GetProductName: string; override;
  end;

function TdxDBTreeViewEditor.GetProductName: string;
begin
  Result := dxDBTreeProductName;
end;
...
{$ENDIF}
  RegisterComponents(dxDBTreeProductPage, [TdxTreeView, TdxDBTreeView, TdxTreeViewEdit, TdxDBTreeViewEdit,
    TdxLookUpTreeView, TdxDBLookUpTreeView]);

  RegisterComponentEditor(TdxTreeView, TdxDBTreeViewEditor);
  RegisterComponentEditor(TdxDBTreeView, TdxDBTreeViewEditor);
  RegisterComponentEditor(TdxTreeViewEdit, TdxDBTreeViewEditor);
  RegisterComponentEditor(TdxDBTreeViewEdit, TdxDBTreeViewEditor);
  RegisterComponentEditor(TdxLookUpTreeView, TdxDBTreeViewEditor);
  RegisterComponentEditor(TdxDBLookUpTreeView, TdxDBTreeViewEditor);
