...
{$IFDEF DELPHI16}
  System.UITypes,
{$ENDIF}
  Classes, Windows, Graphics, Controls, StdCtrls, ImgList, dxCore, dxPSCore, dxPSGlbl,
...
{$ENDIF} 
  ...
  public
    ...
    procedure AddHorizontalPageBreak(AColumn: Integer); overload;
...
uses
  Forms, SysUtils, Math,
  cxClasses, dxPSUtl, dxPSImgs, cxGraphics;
...
begin
  ...
  try
    ...
    for I := 0 to ColCount - 1 do 
      ...
      begin
        R2 := Bounds(OffsetX + I * W, OffsetY + J * H, W, H);
        ...
        begin
          ...
          cxPaintCanvas.DrawComplexFrame(R2, clBtnHighlight,
            RightBottomInnerBorderColorMap[AReportLink.Soft3D], TcxBorders(Sides));
