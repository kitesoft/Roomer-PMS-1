...
type
  ...
  protected
    ...
    procedure InternalFillRectByBrushBitmap(const R: TRect; ABackColor: TColor;
      AForeColor: TColor; APattern: TdxPSFillPatternClass; ABrush: TBrush);
    //
...
uses
  Math, Types, dxPSUtl, dxPSCore, dxPSEdgePatterns;
...
procedure TdxPSReportRenderCustomCanvas.DoFillEdge(
  ARegion: TcxRegionHandle; ABackColor, AEdgeColor: TColor;
  AIsVerticalOrientation: Boolean; AEdgePattern: TClass{TdxPSEdgePatternClass});
const
...
procedure TdxPSReportRenderCanvas.InternalFillRectByBrushBitmap(const R: TRect;
  ABackColor, AForeColor: TColor; APattern: TdxPSFillPatternClass; ABrush: TBrush);
    ...
    try
      ...
      begin
        ...
        try
          ...
          InternalFillRectByBrushBitmap(R, ABackColor, AForeColor, APattern, APatternBrush);
        finally
          RestoreClipRgn;
        end;
      end;
...
function TdxPSReportRenderCanvas.IsSolidFillPattern(
  APattern: TdxPSFillPatternClass; APatternBrush: TBrush): Boolean;
begin
