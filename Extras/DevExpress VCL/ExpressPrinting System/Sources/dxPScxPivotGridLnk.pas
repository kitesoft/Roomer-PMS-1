...
{$ENDIF}
  ...
  cxPC, cxCheckBox, cxButtons, cxLabel, dxPSReportRenderCanvas, cxGeometry, cxDataUtils;
...
begin
  ...
  LoadCaption(lblOnEveryPage, @sdxOnEveryPage);
  LoadCaption(chbxColumnHeadersOnEveryPage, @sdxColumnHeadersOnEveryPage);
  LoadCaption(chbxRowHeadersOnEveryPage, @sdxRowHeadersOnEveryPage);
  LoadCaption(chbxFilterBarOnEveryPage, @sdxFilterBar);
