...
{$IFDEF DELPHI16}
  System.UITypes,
{$ENDIF}
  Types, Windows, Classes, Messages, CommCtrl, Graphics, Controls, ExtCtrls,
  ComCtrls, Forms, dxPSCore, cxTreeView, ImgList;
...
begin
  with Control.ScreenToClient(Mouse.CursorPos) do 
...
begin
  Result := PtInRect(ScrollAreaBounds[ScrollArea], ScreenToClient(Mouse.CursorPos));
end;
...
begin
  ...
  TreeView.LookAndFeel.MasterLookAndFeel := dxPSEngine.DialogsLookAndFeel;
end;
