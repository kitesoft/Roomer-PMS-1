...
uses
  Classes, Graphics, Controls, ExtCtrls, StdCtrls, Buttons,
  {$IFDEF DELPHI16} UITypes,{$ENDIF} dxPSForm, cxLookAndFeelPainters, cxControls,
  cxContainer, cxEdit, cxGroupBox, cxLabel, Menus, cxButtons, cxGraphics,
  cxTextEdit, cxMaskEdit, cxDropDownEdit, cxColorComboBox;
...
uses
  SysUtils, dxPSUtl, cxClasses, dxExtCtrls, dxPSRes;
...
begin
  ...
  begin
    ...
    Parent := GroupBox;
    ShowStyleName := True;
    Properties.OnChange := ccbxStyleChange;
  end;
