...
type
  ...
  protected
    ...
    function DefaultHintValue: string; virtual;
    function DefaultTemplateStringValue: string; virtual;
  public
    constructor Create; virtual;
  ...
  protected
    ...
    function DefaultHintValue: string; override;
    function DefaultTemplateStringValue: string; override;
  public
...
function TdxHFCustomFunction.DefaultHintValue: string;
begin
  Result := '';
end;

function TdxHFCustomFunction.DefaultTemplateStringValue: string;
begin
  Result := '';
end;
...
function TdxHFPageNumberFunction.DefaultHintValue: string;
begin
  Result := cxGetResourceString(@sdxHFFunctionHintPageNumber);
end;

function TdxHFPageNumberFunction.DefaultTemplateStringValue: string;
begin
...
function TdxHFTotalPagesFunction.DefaultHintValue: string;
begin
  Result := cxGetResourceString(@sdxHFFunctionHintTotalPages);
end;

function TdxHFTotalPagesFunction.DefaultTemplateStringValue: string;
begin
...
function TdxHFPageOfPagesFunction.DefaultHintValue: string;
begin
  Result := cxGetResourceString(@sdxHFFunctionHintPageOfPages);
end;

function TdxHFPageOfPagesFunction.DefaultTemplateStringValue: string;
begin
...
function TdxHFMachineNameFunction.DefaultHintValue: string;
begin
  Result := cxGetResourceString(@sdxHFFunctionHintMachineName);
end;

function TdxHFMachineNameFunction.DefaultTemplateStringValue: string;
begin
...
function TdxHFUserNameFunction.DefaultHintValue: string;
begin
  Result := cxGetResourceString(@sdxHFFunctionHintUserName);
end;

function TdxHFUserNameFunction.DefaultTemplateStringValue: string;
begin
...
function TdxHFDateTimeFunction.DefaultHintValue: string;
begin
  Result := cxGetResourceString(@sdxHFFunctionHintDateTime);
end;

function TdxHFDateTimeFunction.DefaultTemplateStringValue: string;
begin
...
function TdxHFDateFunction.DefaultHintValue: string;
begin
  Result := cxGetResourceString(@sdxHFFunctionHintDate);
end;

function TdxHFDateFunction.DefaultTemplateStringValue: string;
begin
...
function TdxHFTimeFunction.DefaultHintValue: string;
begin
  Result := cxGetResourceString(@sdxHFFunctionHintTime);
end;

function TdxHFTimeFunction.DefaultTemplateStringValue: string;
begin
...
function TdxHFImageFunction.DefaultHintValue: string;
begin
  Result := cxGetResourceString(@sdxHFFunctionHintImage);
end;

function TdxHFImageFunction.DefaultTemplateStringValue: string;
begin
