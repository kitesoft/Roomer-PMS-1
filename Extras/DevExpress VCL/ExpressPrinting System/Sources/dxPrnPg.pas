...
begin
  case GetInnerMeasurementUnits of
    muInches:
      R := cxRectScale(Rect_InchToMM(R), 1, 100, 1, 100);
    muMillimeters:
...
begin
  case GetInnerMeasurementUnits of
    muInches:
      Result := cxRectScale(Rect_InchToMM(Margins.Rect), 1, 100, 1, 100);
    else {muMillimeters}
...
begin
  case GetInnerMeasurementUnits of
    muInches:
      Result := cxRectScale(Rect_InchToMM(MinMargins.Rect), 1, 100, 1, 100);
    else {muMillimeters}
...
begin
  Result := cxRectScale(PaintRectLoMetric, Screen.PixelsPerInch, 254, Screen.PixelsPerInch, 254);
end;
