...
uses
  ...
  dxCore, cxGeometry, cxLookAndFeelPainters,
  cxEdit, cxColorComboBox, cxCheckBox, cxCheckGroup,
  dxPSCore, dxPScxCommon, dxPSReportRenderCanvas;
...
class function TdxPSProgressBarDataMap.GetValue(
  AProperties: TcxCustomEditProperties; const AValue: TcxEditValue): Integer;
var
  AFloatValue: Double;
