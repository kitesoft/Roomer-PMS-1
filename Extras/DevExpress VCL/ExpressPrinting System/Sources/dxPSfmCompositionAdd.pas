...
uses
  ...
  dxPSForm, dxPSCore, cxControls, cxContainer, cxListView, cxEdit, IniFiles,
...
type
  ...
  TdxfmCompositionAddItems = class(TCustomdxPSForm)
    ...
    tshItems: TcxTabSheet;
    chbxHideIncludedItems: TcxCheckBox;
    lvItems: TcxListView;
    pnlNoItems: TcxLabel;
    gpOptions: TcxGroupBox;
...
uses
  Graphics, Registry, Math, cxClasses, dxPSGlbl, dxPSUtl, dxPSRes, dxPSPopupMan;
