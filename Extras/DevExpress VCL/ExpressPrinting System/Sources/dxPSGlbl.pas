...
begin
  ...
  try
    ...
    try
      ...
      begin
        Self.CustomColors.Add(AStrings[I] + '=' +
          AIniFile.ReadString(sdxPSRegPathCustomColors, AStrings[I], ''));
      end;
    finally
      AStrings.Free;
    end;
...
begin
  ...
  try
    ...
    begin
      AIniFile.WriteString(sdxPSRegPathCustomColors,
        CustomColors.Names[I], CustomColors.ValueFromIndex[I]);
    end;
  finally
    dxPSStoringManager.EndStoring(AIniFile);
  end;
