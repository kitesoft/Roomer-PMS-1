...
uses
  ...
  dxPSBaseGridLnk, dxPSGrLnks, cxControls, cxContainer, cxEdit, cxCheckBox,
  Menus, cxLookAndFeelPainters, cxButtons, cxTextEdit, cxLabel, cxPC,
  cxGraphics, cxMaskEdit, cxDropDownEdit, cxColorComboBox, cxLookAndFeels,
  cxImageComboBox;
...
uses
  CommCtrl, cxClasses, dxExtCtrls, dxPSRes, dxPrnDev, dxPSUtl, dxPSImgs;
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        Inc(R.Left);
        ilPreview.Draw(ACanvas, R.Left, R.Top + (dY - ilPreview.Height) div 2, 0);
