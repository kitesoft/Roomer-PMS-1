...
{$ENDIF}
  ...
  cxColorComboBox, dxPSReportRenderCanvas;
...
type
  ...
  TdxfmTreeListReportLinkDesignWindow = class(TdxfmCustomcxControlReportLinkDesignWindow)
    ...
    lblSize: TcxLabel;
    lblSeparatorsThickness: TcxLabel;
    lblSeparatorsColor: TcxLabel;
...
uses
 ...
 {$ENDIF} Forms, Registry, dxThemeManager, cxDataStorage, cxDataUtils,
  cxImage, dxPSGlbl, dxPSRes, dxPSImgs, cxDrawTextUtils, dxPSPopupMan, 
...
procedure TcxTreeListAdapter.DoGetLevelImages(ALevel: Integer;
...
procedure TcxTreeListCustomReportLink.ConstructReport(AReportCells: TdxReportCells);
  ...
  begin
    Result := (CustomTreeList_GetVisibleColumnCount(TreeList) <> 0) and (TreeList.Count <> 0);
  end;
...
begin
  ...
  dxSetupPreviewControlLookAndFeel(PreviewTreeList.LookAndFeel,
    ReportLink.OptionsFormatting.LookAndFeelKind, ReportLink.TreeList);
