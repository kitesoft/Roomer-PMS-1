...
uses
  ...
  ExtCtrls, Forms, Menus, ImgList, IniFiles,{$IFDEF DELPHI16} UITypes,{$ENDIF}
  ...
  dxBarApplicationMenu, cxLookAndFeelPainters, dxRibbonSkins;
...
begin
  ...
  try
    ...
    SetBarItemVisibility(bbLargePrintDialog, Preview.IsVisible(pvoPrint));
