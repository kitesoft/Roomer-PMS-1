...
uses
  ...
  cxContainer, cxEdit, cxMemo, cxTextEdit, cxCheckBox, dxCheckGroupBox, cxRadioGroup, cxBlobEdit, 
  ...
  cxLookAndFeelPainters, cxDrawTextUtils, dxPSReportRenderCanvas;
...
uses
  Variants, SysUtils, dxThemeConsts, dxUxTheme, cxVariants, dxPSUtl,
  dxPScxEditorLnks, dxPScxListBoxLnk;
