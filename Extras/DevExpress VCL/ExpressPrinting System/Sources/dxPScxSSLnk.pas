...
uses
  Types, Windows, Classes, Graphics, Controls, StdCtrls, ExtCtrls, ComCtrls, Dialogs,
...
uses                             
  SysUtils, Forms, Math,
  cxSSUtils, cxClasses, dxPSRes, dxPSUtl, dxExtCtrls, dxPrnDev, dxPSImgs;
...
begin
  ...
  ACanvas.FillEdge(ARegion, Item.BordersBkColor,
    ABorder.Color, ASide in [csLeft, csRight], ABorder.Pattern);
...
function TCustomdxSpreadSheetReportLink.IsEmptyRow(ARow: Integer): Boolean;
var
...
procedure TfmdxSpreadSheetDesignWindow.LoadGroupsIcons;
begin
  inherited LoadGroupsIcons;
  dxLoadIconFromResourceEx(imgGrid, IDB_DXPSGROUPICON_SHOW);
  dxLoadIconFromResourceEx(Image5, IDB_DXPSGROUPICON_FRAMING);
