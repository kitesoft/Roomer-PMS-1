...
uses
  Windows, Messages, Classes, Graphics, Controls, Forms, StdCtrls, ImgList, 
  Menus, ExtCtrls, ComCtrls, dxPSCore, cxLookAndFeelPainters, cxButtons,
  cxControls, cxContainer, cxListView, cxPC, cxEdit, cxLabel, cxGraphics,
  cxLookAndFeels, IniFiles, cxGroupBox, cxCheckBox;
...
uses
  SysUtils, CommCtrl, Math, cxClasses, dxPSRes, dxPSGlbl, dxPSUtl, dxPSForm, 
  dxPSPopupMan, dxPSfmCompositionAdd, dxPSImgs;
...
procedure TdxfmCompositionDesignWindow.FormResize(Sender: TObject);
const
  BtnOffsetY = 12;
  BtnOffsetX = 6;
var
...
procedure TdxfmCompositionDesignWindow.tbsItemsResize(Sender: TObject);
var
  R: TRect;  
begin
