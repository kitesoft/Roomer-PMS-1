...
{$ENDIF}
  ...
  dxMessages, dxCore, cxClasses, cxControls, cxGraphics, cxButtons, cxGeometry,
...
const
  ...
  dxDefaultPreviewVisibleOptions = [pvoPageBackground, pvoPageSetup,
...
type
  ...
  private
    ...
    function GetHeaderCornerBounds: TRect;
    ...
    function GetRowHeaderBounds: TRect;
  ...
  public
    ...
    property HeaderCornerBounds: TRect read GetHeaderCornerBounds;
    ...
    property RowHeaderBounds: TRect read GetRowHeaderBounds;
  ...
  TdxPSReportRenderInfo = class(TObject)
  private
  ...
  protected
    ...
    function GetCompositionInfo(APageIndex: Integer; out ARowInfo: TdxPSCompositionReportRenderRowInfo): Boolean;
...
{$ENDIF}
  ...
  private
    FCacheBitmap: TcxBitmap;
    FRenderer: TdxPSReportRenderer;
    FSourceGraphic: TGraphic;
  protected
    ...
    procedure PrepareByGraphic(AGraphic: TGraphic;
      ABackgroundColor: TColor; AIsTransparent: Boolean);
    procedure PrepareByImageList(AImageList: TCustomImageList;
      AImageIndex: Integer; ABackgroundColor: TColor; AIsTransparent: Boolean);
    procedure SaveModeInfo;
    //
    property CacheBitmap: TcxBitmap read FCacheBitmap;
    property Renderer: TdxPSReportRenderer read FRenderer;
  public
    constructor Create(ARenderer: TdxPSReportRenderer); virtual;
    destructor Destroy; override;
    procedure Clear;
    procedure PrepareImage(AGraphic: TGraphic; AImageList: TCustomImageList;
      AImageIndex: Integer; ABackgroundColor: TColor; AIsTransparent: Boolean);
  end;
  ...
  protected
    ...
    procedure RenderPageOverlay(AOverlayIndex: Integer;
      AOverlay: TdxPageOverlayIndexes; const OriginRect: TRect); virtual;
    ...
    procedure RenderPageHeaderOrFooter(AHeaderOfFooter: TCustomdxPageObject;
    ...
    procedure RenderPageHeaderOrFooterContentPart(ATitlePart: TdxPageTitlePart;
      AStrings: TStrings; ATextAlignY: TcxTextAlignY;
  ...
  public
    ...
    procedure DrawGraphicEx(ACanvas: TdxPSReportRenderCustomCanvas; R: TRect;
      ...
      AActualImageBuffering: TdxCellImageActualBuffering = cibAlways); virtual;
    ...
    procedure DrawTextEx(ACanvas: TdxPSReportRenderCustomCanvas; var R: TRect;
      AMaxLineCount: Integer; const AText: string; AFont: TFont; AFormat: Cardinal;
      const AIndents: TRect); overload;
  ...
  protected
    ...
    procedure DoExcludeFromClipRgn(ACanvas: TdxPSReportRenderCustomCanvas;
      const R: TRect; var AResult: Integer);
  ...
  protected
    ...
    function GetAbsoluteEffectiveBounds(ACanvas: TdxPSReportRenderCustomCanvas;
      AStage: TdxPSRenderStages): TRect; virtual;    
    ...
    function IsDrawingNeeded(ACanvas: TdxPSReportRenderCustomCanvas;
      AStage: TdxPSRenderStages; const ARect: TRect): Boolean; virtual;
  ...
  protected
    ...
    procedure MakeDelimiters(AReportCells: TdxReportCells;
      AHorzDelimiters, AVertDelimiters: TList); virtual;
    ...
    procedure DoCustomDrawPageFootnotes(ACanvas: TCanvas; R: TRect;
      var ATextAlignX: TcxTextAlignX; var ATextAlignY: TcxTextAlignY;
    ...
    procedure DoParentCustomDrawReportFootnotes(ACanvas: TCanvas; R: TRect;
      var ATextAlignX: TcxTextAlignX; var ATextAlignY: TcxTextAlignY;
  ...
  public
    ...
    procedure ExportToPDF(const AFileName: string; ACanShowDialog: Boolean = True;
      ASettings: TdxPSPDFReportExportOptions = nil); overload;
    ...
    function SupportsFootnotes: Boolean; virtual;
  ...
  private
   ...
   protected
    ...
    function FindRowInfo(APageIndex: Integer; out ARowInfo: TdxPSCompositionReportRenderRowInfo): Boolean;
    function GetItems: TdxCompositionLinkItemList;

    procedure DoCalculate; override;
    procedure Refresh; override;

    function GetCompositionInfo(AReportLink: TBasedxReportLink;
  ...
  public
    ...
    function SupportsFootnotes: Boolean; override;
  ...
  protected
    FIsFormPositionAssigned: Boolean;
   {$IFDEF OLEDRAGANDDROP}
    { IDropTarget }
    ...
    function IDropTarget_Drop(const DataObj: IDataObject; grfKeyState: Longint;
      Pt: TPoint; var dwEffect: Longint): HRESULT;  stdcall; 
   {$ENDIF}
  ...
  public
    ...
    procedure Show(AModal: Boolean); virtual;
  ...
  private
    ...
    function GetPreviewWindow: TdxPSCustomPreviewWindow;
    function GetPreviewWindowForm: TForm;
    ...
    property HasPreviewWindow: Boolean read GetHasPreviewWindow;
    property PreviewWindow: TdxPSCustomPreviewWindow read GetPreviewWindow;
    property PreviewWindowForm: TForm read GetPreviewWindowForm;
  protected
    procedure DefineProperties(Filer: TFiler); override;
  ...
  TCustomdxComponentPrinter = class(TcxCustomComponent)
  private
    ...
    function CreatePreviewWindow(AReportLink: TBasedxReportLink): TdxPSCustomPreviewWindow;
    ...
    procedure SetupPreviewProperties(APreviewWindow: TdxPSCustomPreviewWindow);
  ...
  protected
    ...
    procedure DoCustomDrawReportFootnotes(AReportLink: TBasedxReportLink; ACanvas: TCanvas;
    ...
    procedure DoPreviewWindowDestroyed(APreviewWindow: TdxPSCustomPreviewWindow); virtual;
  ...
  public
    ...
    function FindPreviewDialogStyleInfoByName(const AName: string;
      out AInfoClass: TdxPSPreviewDialogStyleInfoClass): Boolean;
...
var  
  ...
  FSmoothlyStretchImages: Boolean = False;
...
procedure dxPSScaleFont(AFont: TFont; AFontSize, AUnitsPerInch: Integer);
implementation
                  
uses
  Themes, UxTheme, Variants, dxPSCPDsg,
 {$IFDEF USEJPEGIMAGE}
  Jpeg,
 {$ENDIF}
...
procedure dxPSScaleFont(AFont: TFont; AFontSize, AUnitsPerInch: Integer);
begin
  AFont.Height := -MulDiv(AFontSize, AUnitsPerInch, PtPerInch);
end;
...
function CheckPSVersion(const AVersion: TdxPSVersion; AMajor, AMinor: Integer): Boolean;
begin
...
begin
  ...
  try
    ...
    begin
      ...
      if not AExcludeInactive or (ComponentClass = nil) or (Buffer.IndexOf(ComponentClass) = -1) then
      begin
        LinkClass := Item.LinkClass;
        if AClassList.IndexOf(LinkClass) = -1 then 
          AClassList.Add(LinkClass);
        if AExcludeInactive and (ComponentClass <> nil) then
...
begin
  Result := not IsRectEmpty(FooterBounds) and
    (RenderInfo.CanUseHFOnEveryPageMode or IsBottomPage);
end;
...
begin
  Result := not IsRectEmpty(HeaderBounds) and
    (RenderInfo.CanUseHFOnEveryPageMode or IsTopPage);
end;
...
begin
  Result := not IsRectEmpty(RowHeaderBounds) and
    (RenderInfo.CanUseHFOnEveryPageMode or IsTopPage);
end;
...
begin
  ...
  AContentHeight := MulDiv(RenderInfo.PaintSize.Y, 100, RenderInfo.ScaleFactor);
  if HasTitle then
...
procedure TdxPSPageRenderInfo.CalculateOffsets;
  ...
  begin
    ...
    begin
      AOffset := Max(RenderInfo.PaintSize.X - cxRectWidth(R), 0) div 2;
  ...
  begin
    ...
    begin
      APaintSize := RenderInfo.PaintSize.Y;
      if HasTitle then
...
function TdxPSPageRenderInfo.GetHeaderCornerBounds: TRect;
begin
  Result := RenderInfo.HeaderCornerBounds;
end;
...
function TdxPSPageRenderInfo.GetRowHeaderBounds: TRect;
begin
  Result := RenderInfo.RowHeaderBounds;
end;
...
function TdxPSReportRenderInfo.CalculateActualScaleFactor: Integer;
  ...
  begin
    Result := ReportWidth + RowHeaderWidth;
  end;

//  function CalculateActualReportHeight: Integer;
//  begin
//    CalculateHeaderAndFooterBounds;
//    Result := ReportHeight + HeaderHeight + FooterHeight;
...
begin
  Result := MulDiv(CalculateActualContentPaintAreaSize.X, 100, CalculateActualReportWidth) - 1;
end;
...
var
  AInfo: TdxPSPageRenderInfo;
  I: Integer;
begin
  for I := 0 to VirtualPageCount - 1 do
  begin
    AInfo := CreatePageRenderInfo(I);
    AInfo.Calculate;
  end;
end;
  ...
  begin
    ...
    try
      ...
      try
        ...
        Result := 4 + Windows.DrawText(DC, PChar(AText), ATextLength, R,
...
begin
  ...
  if (Result = 0) and (ReportCells <> nil) and
     (ReportCells.HeaderCellCount <> 0) and (ReportCells.FooterCellCount <> 0)
  then
    Result := 1;
end;
...
begin
  Result.X := MulDiv(cxRectWidth(PrinterPage.PaintRectLoMetric), UnitsPerInch, 254);
  Result.Y := MulDiv(cxRectHeight(PrinterPage.PaintRectLoMetric), UnitsPerInch, 254);
end;
...
begin
  ...
  try
    ...
    Duplicates.Sort(dxCompareValues);
    AList.Clear;
    dxCopyList(Duplicates, AList);
  finally
    Duplicates.Free;
  end;
end;
...
procedure TdxPSReportRenderInfo.GetDelimiters;
  ...
  begin
    ...
    TrancateDelimiters(List, AValue);
  end;
...
function TdxPSReportRenderInfo.GetCompositionInfo(APageIndex: Integer;
  out ARowInfo: TdxPSCompositionReportRenderRowInfo): Boolean;
begin
  Result := (ReportLink.CurrentComposition <> nil) and
    ReportLink.CurrentComposition.RenderInfo.GetCompositionInfo(ReportLink, APageIndex, ARowInfo);
end;
...
class procedure TdxPSCellBorderPainter.DrawFrame(
  ACanvas: TdxPSReportRenderCustomCanvas; R: TRect; ASides: TdxCellSides;
  ATopLeftColor, ARightBottomColor: TColor; ALineThickness: Integer;
  AThickness: Integer = 1);
begin
  ACanvas.DrawFrame(R, ATopLeftColor, ARightBottomColor,
    AThickness * ALineThickness, dxCellSidesToBorders(ASides));
end;
...
begin
  dxPSScaleFont(Font, OriginalSize, AUnitsPerInch);
end;
...
begin
  inherited Create;
  FRenderer := ARenderer;
  FCacheBitmap := TcxBitmap.CreateSize(0, 0, pf24bit);
end;
...
procedure TdxPSCachedGraphicInfo.PrepareImage(
  AGraphic: TGraphic; AImageList: TCustomImageList; AImageIndex: Integer;
  ABackgroundColor: TColor; AIsTransparent: Boolean);
begin
  if Assigned(AImageList) then
    PrepareByImageList(AImageList, AImageIndex, ABackgroundColor, AIsTransparent)
  else
    if (FSourceGraphic <> AGraphic) or not CheckRendererModeInfo or
       (AGraphic.Width <> CacheBitmap.Width) or (AGraphic.Height <> CacheBitmap.Height) or
       (CacheBitmap.Transparent <> AIsTransparent)
    then
    begin
      PrepareByGraphic(AGraphic, ABackgroundColor, AIsTransparent);
      FSourceGraphic := AGraphic;
      SaveModeInfo;
    end;
end;

procedure TdxPSCachedGraphicInfo.PrepareByGraphic(
  AGraphic: TGraphic; ABackgroundColor: TColor; AIsTransparent: Boolean);
var
  ASavedTransparent: Boolean;
begin
  ASavedTransparent := AGraphic.Transparent;
  try
    AGraphic.Transparent := AIsTransparent;
    CacheBitmap.SetSize(AGraphic.Width, AGraphic.Height);
    CacheBitmap.cxCanvas.FillRect(CacheBitmap.ClientRect, ABackgroundColor);
    CacheBitmap.Canvas.Draw(0, 0, AGraphic);
    CacheBitmap.Transparent := AIsTransparent;
  finally
    AGraphic.Transparent := ASavedTransparent;
  end;
end;

procedure TdxPSCachedGraphicInfo.PrepareByImageList(
  AImageList: TCustomImageList; AImageIndex: Integer;
  ABackgroundColor: TColor; AIsTransparent: Boolean);
begin
  CacheBitmap.SetSize(AImageList.Width, AImageList.Height);
  CacheBitmap.cxCanvas.FillRect(CacheBitmap.ClientRect, ABackgroundColor);
  AImageList.Draw(CacheBitmap.Canvas, 0, 0, AImageIndex, dsNormal, itImage);
  CacheBitmap.TransparentColor := ABackgroundColor;
  CacheBitmap.Transparent := AIsTransparent;
end;
...
begin
  ...
  begin
    ...
    try
      ...
      ARect.Bottom := ARect.Top + 3 * LineThickness * dxTextSpace +
...
function TdxPSReportRenderer.CalcTextWidth(ACanvas: TdxPSReportRenderCustomCanvas;
  const AText: string; AFont: TFont = nil): Integer;
var
  R: TRect;
begin
  R := cxRect(0, 0, 10, 10);
  ACanvas.DeviceToLogicalCoordinates(R);
  R := Rect(0, 0, cxRectWidth(R), cxRectHeight(R));
  ACanvas.CalculateTextRect(AText, R, dxCalcFormat[False], AFont);
...
begin
  ACanvas.DrawCheckBox(R, AChecked, AEnabled, AIsRadio,
    AEdgeStyle, MarlettFont10, LineThickness, ABorderColor);
end;
...
procedure TdxPSReportRenderer.DrawGraphicEx(ACanvas: TdxPSReportRenderCustomCanvas;
  R: TRect; const AClipRect: TRect; AImageList: TCustomImageList; AImageIndex: Integer;
  AGraphic: TGraphic; AGraphicTransparent, ATransparent: Boolean; AColor, ABkColor: TColor;
  APattern: TdxPSFillPatternClass; AActualImageBuffering: TdxCellImageActualBuffering = cibAlways);
  ...
  procedure GetActualImageSize(const R: TRect; var W, H: Integer);
  var
    AScalePair: TdxWindowScalePair;
  begin
    AScalePair := RenderInfo.WindowScalePair;
    W := MulDiv(cxRectWidth(R), PixelsDenominator, PixelsNumerator);
    H := MulDiv(cxRectHeight(R), PixelsDenominator, PixelsNumerator);
    W := MulDiv(W, AScalePair.Denominator, AScalePair.Numerator);
    H := MulDiv(H, AScalePair.Denominator, AScalePair.Numerator);
  end;

  function CanUseSmoothResizing(W, H: Integer; AImage: TcxBitmap): Boolean;
  begin
    Result := FSmoothlyStretchImages and ((W <> AImage.Width) or (H <> AImage.Height));
  end;

  procedure InternalDrawImage(AImage: TGraphic; const R: TRect);
  begin
    ACanvas.DrawPicture(AImage, R, ppmStretch, PixelsNumerator, PixelsDenominator);
  end;

  procedure DoDrawImage(AImage: TcxBitmap; const R: TRect);
  var
    ATempBitmap: TcxBitmap;
    W, H: Integer;
  begin
    GetActualImageSize(R, W, H);
    if CanUseSmoothResizing(W, H, AImage) then
    begin
      ATempBitmap := TcxBitmap.CreateSize(W, H);
      try
        cxSmoothResizeBitmap(AImage, ATempBitmap);
        ATempBitmap.TransparentColor := AImage.TransparentColor;
        ATempBitmap.TransparentMode := AImage.TransparentMode;
        ATempBitmap.Transparent := AImage.Transparent;
        InternalDrawImage(ATempBitmap, R);
      finally
        ATempBitmap.Free;
      end;
    end
    else
      InternalDrawImage(AImage, R);
  end;

begin
  ACanvas.SaveClipRgn;
  try
    if (cxRectWidth(R) > cxRectWidth(AClipRect)) or
       (cxRectHeight(R) > cxRectHeight(AClipRect))
    then
    ...
    begin
      if Assigned(AGraphic) and AGraphic.InheritsFrom(TMetafile) then
        InternalDrawImage(AGraphic, R)
      else
      begin
        CachedGraphicInfo.PrepareImage(AGraphic, AImageList,
          AImageIndex, ABkColor, IsImageTransparent(AGraphic));
        DoDrawImage(CachedGraphicInfo.CacheBitmap, R);
      end;
    end;
  finally
...
procedure TdxPSReportRenderer.DrawTextEx(ACanvas: TdxPSReportRenderCustomCanvas;
  var R: TRect; AMaxLineCount, ALeftIndent, ARightIndent: Integer;
  const AText: string; AFont: TFont; AFormat: DWORD);
begin
  DrawTextEx(ACanvas, R, AMaxLineCount, AText,
    AFont, AFormat, Rect(ALeftIndent, 0, ARightIndent, 0));
end;

procedure TdxPSReportRenderer.DrawTextEx(ACanvas: TdxPSReportRenderCustomCanvas;
  var R: TRect; AMaxLineCount: Integer; const AText: string; AFont: TFont;
  AFormat: Cardinal; const AIndents: TRect);
  ...
  function AdjustTextRect(const R: TRect): TRect;
  begin
    if EqualRect(AIndents, cxNullRect) then
      Result := R
    else
      Result := cxRectContent(R, ConvertRect(AIndents));
  end;

var
  ARect: TRect;
begin
  ARect := AdjustTextRect(R);
  ACanvas.DrawText(ARect, AText, AFont, AFormat, GetTextColor, AMaxLineCount);
end;
...
procedure TdxPSReportRenderer.FillRoundRectEx(
  ACanvas: TdxPSReportRenderCustomCanvas; const R: TRect;
  AEllipseWidth, AEllipseHeight: Integer; AForeColor, ABackColor: TColor;
...
procedure TdxPSReportRenderer.FillRgn(
  ACanvas: TdxPSReportRenderCustomCanvas; Rgn: TcxRegionHandle; AColor: TColor);
begin
...
begin
  ACanvas.FillRegion(Rgn, ABackColor, AForeColor,
    APattern, GetPatternBrush(APattern, AForeColor));
end;
...
begin
  ...
  begin
    ReportLink.ReportTitle.Draw(Self,
      cxRectOffset(RenderInfo.TitleBounds, PageRenderInfo.TitleOffset));
  end;
  ...
  begin
    ReportLink.ReportFootnotes.Draw(Self,
      cxRectOffset(RenderInfo.FootnotesBounds, PageRenderInfo.FootnotesOffset));
  end;
end;
...
begin
  ...
  begin
    ADelimX := RenderInfo.DelimitersX[I];
    Canvas.FillRect(
      Bounds(ADelimX, 0, 2 * LineThickness, 20 * LineThickness),
      clHighlight);
  end;
end;
...
begin
  ...
  begin
    ...
    if ABackground.IsNeedDrawBackground then
      Canvas.FillRect(R, clWhite);
    ABackground.PaintEx(Canvas, R, PixelsNumerator * 100, PixelsDenominator * RenderInfo.ScaleFactor);
  end;
end;
...
procedure TdxPSReportRenderer.RenderPageHeaderOrFooter(
  AHeaderOfFooter: TCustomdxPageObject; APageIndex: Integer; ARect: TRect);
const
...
var
  ...
  ASavedFontSize: Integer;
begin
  ASavedFontSize := AHeaderOfFooter.Font.Size;
  try
    PrepareFont(AHeaderOfFooter.Font, False);
    Canvas.Font.Assign(AHeaderOfFooter.Font);
    if not ReportLink.IsHeaderOrFooterCustomDrawn(AHeaderOfFooter) then
    begin
      RenderPageHeaderOrFooterContent(
        AHeaderOfFooter, APageIndex, ARect, [tpLeft..tpRight], True);
    end
    else
    begin
      ACustomDrawCanvas := Canvas.BeginCustomDraw(ARect, AHeaderOfFooter.Font, clDefault);
      try
        ADefaultDrawText := True;
        ADefaultDrawBackground := True;
        ReportLink.DoCustomDrawPageHeaderOrFooter(
          AHeaderOfFooter, ACustomDrawCanvas, APageIndex, ARect,
          ADefaultDrawText, ADefaultDrawBackground);
        if ADefaultDrawText or ADefaultDrawBackground then
        begin
          RenderPageHeaderOrFooterContent(AHeaderOfFooter, APageIndex,
    ...
    AHeaderOfFooter.Font.Size := ASavedFontSize;
  end;
end;
...
procedure TdxPSReportRenderer.RenderPageHeaderOrFooterContent(
  HF: TCustomdxPageObject; APageIndex: Integer; ARect: TRect;
  ATitleParts: TdxPageTitleParts; ADrawBackground: Boolean);
var
...
begin
  ...
  begin
    HF.Background.PaintEx(Canvas, ARect,
      PixelsNumerator * 100, PixelsDenominator * RenderInfo.ScaleFactor);
  end;
  if ATitleParts <> [] then
  begin
...
procedure TdxPSReportRenderer.RenderPageContent;
  ...
  begin
    Result := PageRenderInfo.ContentBounds;
  ...
  procedure RenderFixedPageHeader(AHeaderCell: TdxReportCell; AAnchors: TAnchors;
    const AOriginRect: TRect; AOriginOffsetX, AOriginOffsetY: Integer);
  begin
    RenderPageContentPart(AHeaderCell, 0, -1,
      cxRectOffset(AOriginRect, AOriginOffsetX, AOriginOffsetY));
    Canvas.ExcludeClipRect(AdjustFixedPageHeaderClipRect(AOriginRect, AAnchors));
  end;

  procedure RenderPageHeaders(const ADetailsPosition: TPoint);
  begin
    if PageRenderInfo.HasHeaderCorner then
      RenderFixedPageHeader(ReportCells.HeaderCornerCells, [akLeft, akTop],
        PageRenderInfo.HeaderCornerBounds, 0, 0);
    if PageRenderInfo.HasHeader then
      RenderFixedPageHeader(ReportCells.HeaderCells, [akLeft, akTop, akRight],
        PageRenderInfo.HeaderBounds, ADetailsPosition.X, 0);
    if PageRenderInfo.HasRowHeader then
      RenderFixedPageHeader(ReportCells.RowHeaderCells, [akLeft, akTop, akBottom],
        PageRenderInfo.RowHeaderBounds, 0, ADetailsPosition.Y);
  end;

  procedure RenderPageDetails(const ADetailsPosition: TPoint; out AOffset: Integer);
  var
    ASaveOrg: TPoint;
  ...
  begin
    ...
    try
      ...
      try
        RenderPageHeaders(ADetailsPosition);
        Canvas.IntersectClipRgn(GetPageDetailsClipRect);
        Canvas.OffsetWindowOrg(cxPoint(
          -cxRectWidth(PageRenderInfo.RowHeaderBounds),
          -cxRectHeight(PageRenderInfo.HeaderBounds)));
  ...
  procedure RenderPageFooter(ADetailsOffset: Integer);
  begin
...
begin
  APrevWindowOrg := Canvas.OffsetWindowOrg(cxPointInvert(
    cxPointOffset(PageRenderInfo.DataOffset, LineThickness, LineThickness)));
  try
    Canvas.SaveState;
    try
      Canvas.IntersectClipRgn(GetPageContentClipRect);
      RenderPageDetails(PageRenderInfo.DetailBounds.TopLeft, ADetailsOffset);
      RenderPageFooter(ADetailsOffset);
    finally
      Canvas.RestoreState;
    end;
  finally
...
begin
  dxPSScaleFont(AFont, AFont.Size, GetUnitsPerInchEx(AAdjustOnScale));
end;
...
const
  MappingMode: array[Boolean] of TdxPSReportRenderCanvasMappingMode =
    (rrmmDefault, rrmmIsotropic);
begin
  Canvas.SetCanvasExts(RenderInfo.PageSize, MappingMode[FUseIsotropicMode],
    RenderInfo.WindowScalePair.Numerator, RenderInfo.WindowScalePair.Denominator,
    ViewPortRect);
end;
...
begin
  ...
  R := Rect(0, 0, 1, 1);
  Canvas.DeviceToLogicalCoordinates(R);
  UnitsPerPixel := Max(0, R.Right - R.Left);
  UnitsPerPt := MulDiv(UnitsPerPixel, PixelsPerInch, PtPerInch);
  LineThickness := Canvas.CalculateLineThickness(UnitsPerPixel, UnitsPerPt);
...
function TdxReportVisualItem.MeasureContentHeight(
  ACanvas: TdxPSReportRenderCustomCanvas): Integer;
begin
  Result := 0;
end;

function TdxReportVisualItem.MeasureContentWidth(
  ACanvas: TdxPSReportRenderCustomCanvas): Integer;
begin
  Result := 0;
end;

function TdxReportVisualItem.MeasureFontHeight(
  ACanvas: TdxPSReportRenderCustomCanvas): Integer;
begin
  Result := Height;
end;
...
function TdxReportVisualItem.GetBackgroundBounds(
  ACanvas: TdxPSReportRenderCustomCanvas): TRect;
begin
...
procedure TdxReportCell.DrawItself(ACanvas: TdxPSReportRenderCustomCanvas;
...
begin
  ...
  begin
    ACell := Cells[I];
    if ACell.Visible and IntersectRect(R, ACell.GetAbsoluteRect, OriginRect) then
    begin
      DrawRect := ACell.BoundsRect;
      P := ACanvas.OffsetWindowOrg(cxPointInvert(DrawRect.TopLeft));
      try
        OffsetRect(DrawRect, -DrawRect.Left, -DrawRect.Top);
        ACell.DrawContent(ACanvas, DrawRect, OriginRect, AStage);
      finally
        ACanvas.WindowOrg := P;
      end;
    end;
...
procedure TdxPSReportGroupLookAndFeelPainter.DrawCaptionText(
  ACanvas: TdxPSReportRenderCustomCanvas);
...
begin
  Result := MulDiv(dxPSGlbl.CheckWidth, PixelsNumerator, PixelsDenominator);
end;
...
procedure TdxPSReportGroupStandardLookAndFeelPainter.Paint(
  ACanvas: TdxPSReportRenderCustomCanvas);
begin
...
procedure TdxPSReportGroupStandardLookAndFeelPainter.DrawBorders(
  ACanvas: TdxPSReportRenderCustomCanvas);
begin
  Group.InternalDrawBorders(ACanvas);
end;

procedure TdxPSReportGroupStandardLookAndFeelPainter.DrawCaptionRestSpace(
  ACanvas: TdxPSReportRenderCustomCanvas);
...
begin
  ...
  begin
    ...
    FCaptionTextWidth := Renderer.CalcTextWidth(ACanvas, CaptionText, F);
...
begin
  ...
  if CheckPSVersion(AReader.PSVersion, 4, 48) then
  begin
    if AReader.ReadBoolean then
...
begin
  ...
  if CheckPSVersion(AWriter.PSVersion, 4, 48) then
  begin
...
function TAbstractdxReportCellData.MeasureContentHeight(
  ACanvas: TdxPSReportRenderCustomCanvas): Integer;
begin
  Result := Height;
end;

function TAbstractdxReportCellData.MeasureContentWidth(
  ACanvas: TdxPSReportRenderCustomCanvas): Integer;
begin
  Result := Width;
end;

function TAbstractdxReportCellData.CustomDraw(
...
begin
  Result := CheckPSVersion(AVersion, 4, 20110104);
end;
...
procedure TdxReportCellText.DrawContent(
  ACanvas: TdxPSReportRenderCustomCanvas; AStage: TdxPSRenderStages);
begin
  DrawBackground(ACanvas);
  if IsTextDrawn then
...
procedure TdxReportCellText.DrawText(ACanvas: TdxPSReportRenderCustomCanvas);
  ...
  function GetTextWidth(AFont: TFont; const S: string): Integer;
  begin
    ACanvas.Font := AFont;
    Result := ACanvas.TextSize(S).cx;
  end;

  procedure AdjustFontSize(AFont: TFont; const R: TRect; const S: string);
  var
    ALastSuitableSize: Integer;
    ASavedFontSize: Integer;
    ATextWidth: Integer;
    L, H: Integer;
  begin
    ATextWidth := GetTextWidth(AFont, S);
    if ATextWidth > cxRectWidth(R) then
    begin
      ASavedFontSize := AFont.Size;
      ALastSuitableSize := -1;
      H := AFont.Size;
      L := MulDiv(H, 2, 3);
      while L <= H do
      begin
        AFont.Size := (L + H) div 2;
        ATextWidth := GetTextWidth(AFont, S);
        if ATextWidth > cxRectWidth(R) then
          H := AFont.Size - 1
        else
      ...
      begin
        if ALastSuitableSize > 0 then
          AFont.Size := ALastSuitableSize
        else
          AFont.Size := ASavedFontSize;
      end;
    end;
  end;
...
begin
  ...
  begin
    ...
    if Multiline or not AdjustFont then
      Renderer.DrawTextEx(ACanvas, R, 0, S, AFont, DTFormat, Indents.Rect)
    else
    begin
      ACanvas.SaveState;
      try
        ...
        begin
          ...
          try
            ...
            AdjustFontSize(ATempFont, cxPrepareRect(R, ATextParams, 0, 0), S);
            Renderer.DrawTextEx(ACanvas, R, 0, S, ATempFont, DTFormat, Indents.Rect);
          finally
            ATempFont.Free;
          end;
        end;
...
function TdxReportCellText.CalculateLineCount(
  ACanvas: TdxPSReportRenderCustomCanvas): Integer;
begin
  Result := Renderer.CalcTextLineCount(
    ACanvas, Text, Font, Width - Indents.Left - Indents.Right);
end;
...
var
  R: TRect;
begin
  R := Rect(0, 0, cxRectWidth(GetTextBounds(ACanvas)) - Indents.Left - Indents.Right, 5);
  Result := Max(Renderer.CalcTextRect(ACanvas, Text, R,
    GetDTFormat or CXTO_CALCROWCOUNT or CXTO_AUTOINDENTS, Font) +
    Indents.Top + Indents.Bottom, SortMarkRegionSize);
  if Result > 0 then
  begin
    if csTop in CellSides then
...
begin
  if Multiline then
    Result := inherited MeasureContentWidth(ACanvas)
  else
    Result := Renderer.CalcTextWidth(ACanvas, Text, Font);

  Inc(Result, SortMarkRegionSize + Indents.Left + Indents.Right);
  if csLeft in CellSides then
...
begin
  ...
  Inc(Result, Indents.Bottom + Indents.Top);
end;
...
procedure TdxReportCellText.ReadData(AReader: TdxPSDataReader);
  ...
  function Decode(AFlags: Integer; var AAdjustFont: Boolean): Integer;
  begin
    AAdjustFont := AFlags and dxFormatTextAdjustFont <> 0;
    Result := AFlags and not dxFormatTextAdjustFont;
  end;

begin
  inherited ReadData(AReader);
  Indents.Rect := cxNullRect;
  Indents.Left := Decode(AReader.ReadInteger, FAdjustFont);
...
begin
  ...
  Renderer.DrawCheckBox(ACanvas, R, Checked,
    Enabled, IsRadio, ButtonEdgeStyle, BorderColor);
end;
...
function TdxCustomReportCellCheck.MeasureContentHeight(
  ACanvas: TdxPSReportRenderCustomCanvas): Integer;
begin
  Result := Max(1 + CheckHeight + 1, inherited MeasureContentHeight(ACanvas));
end;
  
function TdxCustomReportCellCheck.MeasureContentWidth(
  ACanvas: TdxPSReportRenderCustomCanvas): Integer;
begin
...
function TdxCustomReportCellCheck.GetCheckBounds(
  ACanvas: TdxPSReportRenderCustomCanvas): TRect;
var
  W, H: Integer;
begin
...
function TdxCustomReportCellCheck.GetImageAreaBounds(
  ACanvas: TdxPSReportRenderCustomCanvas): TRect;
var
  W, H: Integer;
begin
...
function TdxCustomReportCellCheck.GetImageBounds(
  ACanvas: TdxPSReportRenderCustomCanvas): TRect;
begin
...
function TdxCustomReportCellCheck.GetTextBounds(
  ACanvas: TdxPSReportRenderCustomCanvas): TRect;
begin
  if CheckPos <> ccpCenter then
  begin
...
procedure TdxCustomReportCellCheckImage.DrawCheckGlyph(
  ACanvas: TdxPSReportRenderCustomCanvas);
var
  R: TRect;
begin
...
procedure TCustomdxReportCellImageContainer.DrawImage(
  ...
  begin
    Renderer.DrawGraphicEx(ACanvas, GetImageBounds(ACanvas),
      ...
      ContentBkColor, ContentPattern, ActualImageBuffering);
  end;
  ...
  begin
    if (AImageList <> nil) and (AImageIndex <> -1) then
      Renderer.DrawGraphicEx(ACanvas, GetImageBounds(ACanvas),
        ...
        True, True, clNone, clNone, ContentPattern, ActualImageBuffering);
  end;
...
begin
  ...
  Result := Result and (IsTextBackgroundDrawn or IsImageBackgroundDrawn or not
    dxCanPrintTransparentImages(Renderer.Canvas));
end;
...
begin
  Result := Assigned(ImageList) and (ImageIndex >= 0) and (ImageIndex < ImageList.Count);
end;
...
function TdxReportCellImage.MeasureContentHeight(
  ACanvas: TdxPSReportRenderCustomCanvas): Integer;
begin
  ...
  if ImageLayout in [ilImageTopLeft, ilImageCenterLeft, ilImageBottomLeft,
...
function TdxReportCellImage.MeasureContentWidth(
  ACanvas: TdxPSReportRenderCustomCanvas): Integer;
begin
...
function TdxReportCellGraphic.MeasureContentHeight(
  ACanvas: TdxPSReportRenderCustomCanvas): Integer;
begin
  if ImageList <> nil then
    ...
    begin
      ...
      if RealStretch and (Result > 0) and (Image.Width > 0) then
        Result := Round(Result * Min(1, Width / Image.Width));
    end
    else
      Result := 0;
end;
  
function TdxReportCellGraphic.MeasureContentWidth(
  ACanvas: TdxPSReportRenderCustomCanvas): Integer;
begin
  if ImageList <> nil then
...
function TdxReportCellGraphic.GetImageBounds(
  ACanvas: TdxPSReportRenderCustomCanvas): TRect;
var
  W, H: Integer;
begin
...
begin
  ...
  try
    ARenderer.Canvas.Font.Assign(Font);
    ARenderer.PrepareFont(ARenderer.Canvas.Font, AdjustOnReportScale);
    if IsCustomDrawn then
      InternalCustomDraw(ARenderer.Canvas, R)
    else
      DoDrawNoteText(ARenderer.Canvas, R, Color, ARenderer.Canvas.Font, TextAlignX, TextAlignY);
  finally
...
procedure TBasedxReportLink.LoadFromIniFile(
...
begin
  ...
  if AIniFile.ReadBool(ASection, sdxAssignedPageNumberFormat, False) then
    PageNumberFormat := TdxPageNumberFormat(
      AIniFile.ReadInteger(ASection, sdxPageNumberFormat, Ord(PageNumberFormat)));
...
procedure TBasedxReportLink.SaveToIniFile(
  AIniFile: TCustomIniFile; const ASection: string);
begin
...
function TBasedxReportLink.Print(
  AShowDialog: Boolean; APPrintDlgData: PdxPrintDlgData): Boolean;
begin
  Result := False;
...
begin
  ...
  if Result then
  begin
    if (ComponentPrinter <> nil) and AData.SetPageNumberFormatAsDefault then
...
begin
  Result := SupportsFootnotes and not IsAggregated and (DataSource = rldsComponent) and
...
function TBasedxReportLink.SupportsFootnotes: Boolean;
begin
  Result := True;
end;
...
begin
  ComponentPrinter.DoCustomDrawEntirePage(Self, ACanvas, ARealPageIndex, R,
    MulDiv(Denominator, cxRectWidth(R), MulDiv(RenderInfo.PageSize.X, PixelsDenominator, PixelsNumerator)),
    Denominator);
end;
...
begin
  Result :=
    Assigned(ComponentPrinter.FOnCustomDrawReportFootnotes) or
    Assigned(FOnCustomDrawReportLinkFootnotes);
end;
...
begin
  ...
  begin
    ...
    try
      ...
      try
        RealPrinterPage.ScaleMode := ScaleModeMap[Value];
      finally
...
begin
  ...
  begin
    if FFontPool = nil then
      FFontPool := TdxPSReportFontPool.Create;
    Result := FFontPool;
  end;
end;
...
begin
  ...
  if W > MaxReportWidth then 
    ...
    begin
      ...
      UnitsPerInch := Max(UnitsPerInch, MinFactor * Screen.PixelsPerInch);
    end;
end;
...
begin
  ...
  begin
    if FComponentPrinter <> nil then
      FComponentPrinter.RemoveLink(Self);
    if Value <> nil then
...
begin
  ...
  AHeight := MulDiv(APageInfo.RenderInfo.PaintSize.Y, FUnitsPerInch, APageInfo.RenderInfo.UnitsPerInch) - AOffset;
...
begin
  ...
  for I := 0 to RowInfoCount - 1 do
    if RowInfo[I].ContainsPage(APageIndex) then
    begin
      ARowInfo := RowInfo[I];
      Break;
    end;
...
function TdxCompositionReportLink.SupportsFootnotes: Boolean;
begin
  Result := False;
end;
...
begin
  ...
  if not (csDestroying in ComponentState) and (AOperation = opRemove) and
    (AComponent is TBasedxReportLink) then
  begin                              
    List := TList.Create;
    try
...
const
  ...
  procedure PlaceButton(X, AWidth, AHeight, AOffsetY: Integer; AButton: TcxButton);
  begin
    AButton.SetBounds(X, ClientHeight - AOffsetY - AHeight, AWidth, AHeight);
  end;

var
  AWidth, AHeight, ALargeWidth, AOffsetX, AOffsetY, AFirstOffsetX: Integer;
begin
  AFirstOffsetX := cxGetValueCurrentDPI(btnFirstOffsetX);
  ALargeWidth := cxGetValueCurrentDPI(btnLargeWidth);
  AOffsetX := cxGetValueCurrentDPI(btnOffsetX);
  AOffsetY := cxGetValueCurrentDPI(btnOffsetY);
  AWidth := cxGetValueCurrentDPI(btnWidth);
  AHeight := cxGetValueCurrentDPI(btnHeight);

  if btnHelp.Visible then
  begin
    PlaceButton(ClientWidth - AFirstOffsetX - AWidth, AWidth, AHeight, AOffsetY, btnHelp);
    PlaceButton(btnHelp.Left - AOffsetX - AWidth, AWidth, AHeight, AOffsetY, btnApply);
  end    
  else
    PlaceButton(ClientWidth - AFirstOffsetX - AWidth, AWidth, AHeight, AOffsetY, btnApply);

  PlaceButton(btnApply.Left - AOffsetX - AWidth, AWidth, AHeight, AOffsetY, btnCancel);
  PlaceButton(btnCancel.Left - AOffsetX - AWidth, AWidth, AHeight, AOffsetY, btnOK);
  PlaceButton(AFirstOffsetX, ALargeWidth, AHeight, AOffsetY, btnRestoreOriginal);
  PlaceButton(btnRestoreOriginal.BoundsRect.Right + AOffsetX, ALargeWidth, AHeight, AOffsetY, btnRestoreDefaults);
  PlaceButton(AFirstOffsetX, ALargeWidth, AHeight, AOffsetY, btnTitleProperties);
  PlaceButton(btnTitleProperties.BoundsRect.Right + AOffsetX, ALargeWidth, AHeight, AOffsetY, btnFootnoteProperties);
end;

procedure TStandarddxReportLinkDesignWindow.CreateStdButtons;
begin
  btnHelp := TcxButton.Create(Self);
  try
  ...
  btnApply := TcxButton.Create(Self);
  ...
  btnRestoreOriginal := TcxButton.Create(Self);
  ...
  btnRestoreDefaults := TcxButton.Create(Self);
  ...
  btnTitleProperties := TcxButton.Create(Self);
  btnTitleProperties.Parent := Self;
  btnTitleProperties.OnClick := TitlePropertiesClick;
  btnTitleProperties.TabOrder := btnOK.TabOrder;

  btnFootnoteProperties := TcxButton.Create(Self);
  btnFootnoteProperties.Parent := Self;
  btnFootnoteProperties.OnClick := FootnotesPropertiesClick;
  btnFootnoteProperties.TabOrder := btnOK.TabOrder;
end;
...
begin
  ...
  btnFootnoteProperties.Visible := btnFootnoteProperties.Visible and
    ReportLink.CanChangeFootnotes and not ReportLink.IsDesigning;
  btnTitleProperties.Visible := btnTitleProperties.Visible and
    ReportLink.CanChangeTitle and not ReportLink.IsDesigning;
  AStartTabOrder := 0;
  if ReportLink.IsDesigning then
  begin
    btnRestoreOriginal.TabOrder := 0;
    btnRestoreDefaults.TabOrder := 1;
    Inc(AStartTabOrder, 2);
  end
  else
  begin
    if ReportLink.CanChangeTitle then
    begin
      btnTitleProperties.TabOrder := AStartTabOrder;
      Inc(AStartTabOrder);
    end;
    if ReportLink.CanChangeFootnotes then
    begin
      btnFootnoteProperties.TabOrder := AStartTabOrder;
      Inc(AStartTabOrder);
    end;
  end;
      
  btnOk.TabOrder := AStartTabOrder;
  btnCancel.TabOrder := AStartTabOrder + 1;
  btnApply.TabOrder := AStartTabOrder + 2;
  btnHelp.TabOrder := AStartTabOrder + 3;
end;
...
begin
  Result := (ReportLink <> nil) and ReportLink.DataProviderPresent and 
    ReportLink.PreviewExists and Modified and not (Applyed or ReportLink.IsAggregated);
end;
...
var
  ...
  PS: TPaintStruct;
begin
  if cxIsVCLThemesEnabled and (Message.Msg = WM_PAINT) then
  begin
    Control := PreviewHost;
    ...
    try
      ...
      cxStyleServices.DrawElement(DC, Details, Control.Parent.ClientRect);

      Details := cxStyleServices.GetElementDetails(teEditTextNormal);
      dxDrawThemeEdge(DC, Details, R, BDR_SUNKENOUTER, BF_RECT or BF_FLAT);
      InflateRect(R, -1, -1);
      dxDrawThemeEdge(DC, Details, R, BDR_RAISEDINNER, BF_RECT or BF_FLAT);
    finally
...
begin
  inherited Create(AOwner);
  LookAndFeel.MasterLookAndFeel := dxPSEngine.DialogsLookAndFeel;
end;

destructor TdxPSCustomPreviewWindow.Destroy;
begin
  if Assigned(ComponentPrinter) then
    ComponentPrinter.DoPreviewWindowDestroyed(Self);
  inherited Destroy;
end;
...
procedure TdxPSCustomPreviewWindow.LoadFromIniFile(
  AIniFile: TCustomIniFile; const ASectionName: string);
begin
  FIsFormPositionAssigned := dxPSEngine.SaveFormsPosition and
    dxPSFormLoadPositionFromIniFile(Form, AIniFile, ASectionName);
end;
...
procedure TdxPSCustomPreviewWindow.SaveToIniFile(
  AIniFile: TCustomIniFile; const ASectionName: string);
begin
  if dxPSEngine.SaveFormsPosition then
    dxPSFormSavePositionToIniFile(Form, AIniFile, ASectionName);
end;
...
procedure TdxPSCustomPreviewWindow.CreationComplete;
begin
end;
...
procedure TdxPSCustomPreviewWindow.ReleaseForm;
begin
  Form.Free;
end;

procedure TdxPSCustomPreviewWindow.Show(AModal: Boolean);
const
  Flags: array[Boolean] of UINT = (SW_SHOW, SW_RESTORE or SW_SHOWNORMAL);
var
  AWindowPlacement: TWindowPlacement;
begin
  if Form.HandleAllocated and Form.Visible then
  begin
    AWindowPlacement.Length := SizeOf(AWindowPlacement);
    GetWindowPlacement(Form.Handle, @AWindowPlacement);
    ShowWindow(Form.Handle, Flags[AWindowPlacement.ShowCmd = SW_SHOWMINIMIZED]);
...
function TdxPSCustomPreviewWindow.GetShowExplorer: Boolean;
begin
  Result := False;
end;

function TdxPSCustomPreviewWindow.GetShowThumbnails: Boolean;
begin
  Result := False;
end;
...
procedure TdxPSCustomPreviewWindow.SetShowExplorer(Value: Boolean);
begin
end;

procedure TdxPSCustomPreviewWindow.SetShowThumbnails(Value: Boolean);
begin
end;
...
procedure TdxPSCustomPreviewWindow.PaintPage(
...
function TdxPSCustomPreviewWindow.GetOwnerForm: TForm;
begin
...
begin
  ...
  if HasPreviewWindow then
    PreviewWindowForm.HelpFile := Value;
end;
...
begin
  ...
  begin
    FShowExplorer := Value;
    if HasPreviewWindow then
      PreviewWindow.ShowExplorer := ShowExplorer;
  end;
end;
...
begin
  FWindowState := Value;
  if HasPreviewWindow then
    PreviewWindowForm.WindowState := FWindowState;
end;
...
function TdxPreviewOptions.GetHasPreviewWindow: Boolean;
begin
  Result := (ComponentPrinter <> nil) and not ComponentPrinter.IsDesigning and
    ComponentPrinter.PreviewExists;
end;

function TdxPreviewOptions.GetPreviewWindow: TdxPSCustomPreviewWindow;
begin
  Result := ComponentPrinter.PreviewWindow;
end;

function TdxPreviewOptions.GetPreviewWindowForm: TForm;
begin
  if Assigned(PreviewWindow) then
    Result := ComponentPrinter.PreviewWindow.Form
  else
    Result := nil;
end;
...
function TCustomdxComponentPrinter.BeginPrintPages(
  const Source: string; out APageIndexes: TdxPSPageIndexes): Boolean;
begin
...
function TCustomdxComponentPrinter.CreatePreviewWindow(AReportLink: TBasedxReportLink): TdxPSCustomPreviewWindow;
begin
  Result := dxPSPreviewDialogManager.CreatePreviewWindow;
  try
    Result.BeginUpdate;
    try
      Result.ComponentPrinter := Self;
...
var
  APreviewWindow: TdxPSCustomPreviewWindow;
begin
  if FPreviewWindow <> nil then
  begin
    APreviewWindow := FPreviewWindow;
    FPreviewWindow := nil;
    APreviewWindow.ReleaseForm;
  end;
end;
...
function TCustomdxComponentPrinter.DoBeforeExportToPDF(
  AReportLink: TBasedxReportLink; const AFileName: string;
...
begin
  if not IsLoading then
  begin
    if Assigned(FOnDeleteReportLink) then
...
procedure TCustomdxComponentPrinter.DoMeasureReportFootnotes(
...
procedure TCustomdxComponentPrinter.DoMeasureReportTitle(
  AReportLink: TBasedxReportLink; var AHeight: Integer);
begin
...
begin
  Done := False;
  if Assigned(FOnPrintDeviceBusy) then
    FOnPrintDeviceBusy(Self, Done);
  if not Done then
...
begin
  if Assigned(FOnPageSetup) then
    FOnPageSetup(Self, AReportLink, ADone);
end;

procedure TCustomdxComponentPrinter.DoPreviewWindowDestroyed(
  APreviewWindow: TdxPSCustomPreviewWindow);
begin
  Exclude(FState, cpsPreviewing);
  if not FModalPreview then
    DoAfterPreview(APreviewWindow.ReportLink);
  FPreviewWindow := nil;
end;

procedure TCustomdxComponentPrinter.DoProgress(
  AReportLink: TBasedxReportLink; const PercentDone: Double);
...
procedure TCustomdxComponentPrinter.SetupPreviewProperties(APreviewWindow: TdxPSCustomPreviewWindow);
  ...
  procedure PreparePreviewWindowForm(AForm: TForm; AIsFormPositionAssigned: Boolean);
  begin
  {$IFDEF DELPHI9}
    AForm.PopupMode := pmAuto;
  {$ENDIF}
    AForm.HelpContext := PreviewOptions.HelpContext;
    AForm.HelpFile := PreviewOptions.HelpFile;
    AForm.Icon := PreviewOptions.Icon;
    AForm.Caption := GetCaption;
    if not AIsFormPositionAssigned then
    begin
      AForm.Position := poDesigned;
      AForm.BoundsRect := PreviewOptions.Rect;
      AForm.WindowState := PreviewOptions.WindowState;
    end;
  end;
...
begin
  if not IsDesigning then
  begin
    PreparePreviewWindowForm(APreviewWindow.Form, APreviewWindow.FIsFormPositionAssigned);
...
procedure TCustomdxComponentPrinter.Preview(
  AModal: Boolean = True; AReportLink: TBasedxReportLink = nil);
  ...
  begin
    Result := True;
    if not (AReportLink.DataProviderPresent and (IsDesigning or IsRebuildBeforePreview)) then
    begin
      if AutoUpdateDateTime then
        AReportLink.DateTime := Now;
    end
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        if IsExplorerMode and Assigned(PreviewWindow) then
...
procedure TCustomdxComponentPrinter.PrintPage(
  AReportLink: TBasedxReportLink; APageIndex: Integer);
var
  R: TRect;
begin
...
procedure TCustomdxComponentPrinter.PrintPagesEx(
  const APageIndexes: TdxPSPageIndexes; APageNums: TdxPageNumbers;
  ...
  begin
    ...
    AReportLink.RealPrinterPage.ApplyToPrintDevice;
        ...
        begin
          ...
          begin
            ...
            if CanPrintPage(I, APageIndex) then
              DoPrintPage(ACurrentPage, APageIndex);
...
begin
  ...
  TimeFormat := AIniFile.ReadInteger(ASection, sdxTimeFormat, TimeFormat);
  PageNumberFormat := TdxPageNumberFormat(
    AIniFile.ReadInteger(ASection, sdxPageNumberFormat, Ord(TimeFormat)));
  dxLoadStrings(AIniFile, dxValidatePath(ASection) +
