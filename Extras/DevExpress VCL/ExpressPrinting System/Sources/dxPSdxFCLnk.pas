...
uses
  ...
  dxFlChrt, dxPSGraphicLnk, dxPSCore, ImgList, cxPC, cxControls,
  cxContainer, cxEdit, cxLabel, cxGraphics, cxTextEdit, cxMaskEdit,
  cxDropDownEdit, cxColorComboBox, cxCheckBox, cxLookAndFeels,
