...
begin
  case Index of
    0: AItem.Enabled := TBasedxReportLink(Component).CheckToDesign;
    1: AItem.Enabled := not TBasedxReportLink(Component).IsCurrentLink;
    10: AItem.Enabled := TBasedxReportLink(Component).DataProviderPresent;
    11: AItem.Enabled := TBasedxReportLink(Component).DataProviderPresent;
  end;
end;
...
begin
  ...
  RegisterNoIcon([TBasedxReportLink, TdxCompositionReportLink, TdxCustomContainerReportLink, TdxPSPreviewWindow]);
  RegisterNoIcon([TdxPictureReportLink, TdxTextReportLink]);
  RegisterNoIcon([TBasedxPrintStyle, TdxPSPrintStyle]);
  RegisterClasses([TdxPSPreviewWindow]);
