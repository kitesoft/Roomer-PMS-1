...
{$ENDIF}
  ...
  dxPSReportRenderCanvas, cxGeometry, cxLookAndFeels, cxScrollBox;
...
type
  ...
  TdxCustomContainerReportLink = class(TBasedxReportLink, IUnknown, IdxReportLinkController) 
  private
...
uses
  SysUtils, Math,
  dxCore, cxClasses, dxPSGlbl, dxPSUtl, dxPSRes, dxPSPopupMan, dxPSImgs;
