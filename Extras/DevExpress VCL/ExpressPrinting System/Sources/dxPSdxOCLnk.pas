...
uses
  ...
  dxOrgChr, dxPSCore, dxPSGraphicLnk, cxLabel, cxControls, cxContainer,
  cxEdit, cxCheckBox, cxGraphics, cxTextEdit, cxMaskEdit, cxDropDownEdit,
  cxColorComboBox, cxPC, cxLookAndFeels, cxLookAndFeelPainters;
...
begin
  inherited;
  ccbxColor.Visible := not ReportLink.UseMetafile;
