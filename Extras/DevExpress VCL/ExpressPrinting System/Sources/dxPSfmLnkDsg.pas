...
uses
  ...
  dxCore, cxGraphics, cxControls, cxContainer, cxLookAndFeels, cxLookAndFeelPainters,
  cxButtons, cxEdit, cxGroupBox, cxListBox,
  dxPSCore, dxPSfmLnkAdd, dxPSDsgProxies, dxPSGlbl;
...
uses
  ...
  dxPSCompsProvider, dxPSEngn, dxPSImgs;
