...
begin
  ...
  try
    ...
    Dialog.btnDefault.Visible := AFormatsDlgData.ShowAsDefaultButton;
...
begin
  ...
  FseStartAt.Parent := Self;
  FseStartAt.TabOrder := rbtnStartAt.TabOrder + 1;
  FseStartAt.BoundsRect := bvlStartAtHolder.BoundsRect;
