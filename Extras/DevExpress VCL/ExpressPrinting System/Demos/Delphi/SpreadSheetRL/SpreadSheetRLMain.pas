...
uses
  ...
  Dialogs, StdCtrls, ExtCtrls, ComCtrls,  ToolWin, Menus, ImgList,
  ...
  cxLookAndFeels, cxLookAndFeelPainters, dxPSPrVwAdv, dxPSPrVwRibbon,
  dxmdaset, DB;
...
type
  TSpreadSheetRLForm = class(TDemoBasicMainForm)
    ...
    edtCellEdit: TEdit;
    MemData: TdxMemData;
    MemDataCO_NAME: TStringField;
    MemDataSHARES: TFloatField;
    MemDataCUR_PRICE: TFloatField;
    MemDataYRL_HIGH: TFloatField;
    MemDataYRL_LOW: TFloatField;
    MemDataPUR_PRICE: TFloatField;
    MemDataPUR_DATE: TDateField;
...
begin
  ...
  Try
    ...
    With MemData do                                          // and using our database query
    begin
      Open;                                                // open the data
...
begin
  inherited;
  MemData.LoadFromBinaryFile('..\..\Data\SpreadSheet.dat');
  MemData.Open;
  FSaveSpreadSheet := False;
