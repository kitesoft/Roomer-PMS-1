...
Controls::TWinControl* __fastcall TFormHelper::GetTreeContainerParent(void)
{
...
TWinControl* __fastcall TfmMain::GetTreeContainerParent()
{
...
void __fastcall TfmMain::CreateExplorerTree()
{
  ...
  ExplorerContextCommands = (IdxPSExplorerContextCommands*)Explorer;
  ExplorerContextCommands->BuildCommandSet(
    (IdxPSExplorerContextCommandBuilder*)FFormHelper);
}
//---------------------------------------------------------------------------
