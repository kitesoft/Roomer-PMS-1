inherited SpreadSheetRLForm: TSpreadSheetRLForm
  ...
  object MemData: TdxMemData
    Indexes = <>
    Persistent.Data = {
      
      41544500}
    SortOptions = []
    Left = 480
    Top = 96
    object MemDataCO_NAME: TStringField
      FieldName = 'CO_NAME'
    end
    object MemDataSHARES: TFloatField
      FieldName = 'SHARES'
    end
    object MemDataCUR_PRICE: TFloatField
      FieldName = 'CUR_PRICE'
    end
    object MemDataYRL_HIGH: TFloatField
      FieldName = 'YRL_HIGH'
    end
    object MemDataYRL_LOW: TFloatField
      FieldName = 'YRL_LOW'
    end
    object MemDataPUR_PRICE: TFloatField
      FieldName = 'PUR_PRICE'
    end
    object MemDataPUR_DATE: TDateField
      FieldName = 'PUR_DATE'
    end
  end
end
