...
__published:	// IDE-managed Components
  ...
  TdxMemData *MemData;
  TStringField *MemDataCO_NAME;
  TFloatField *MemDataSHARES;
  TFloatField *MemDataCUR_PRICE;
  TFloatField *MemDataYRL_HIGH;
  TFloatField *MemDataYRL_LOW;
  TFloatField *MemDataPUR_PRICE;
  TDateField *MemDataPUR_DATE;
