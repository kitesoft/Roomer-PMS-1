...
uses
  Classes, DesignIntf, dxSkinsDesignHelperReg, dxBar, dxDockControl, dxStatusBar, 
  dxSkinsdxBarPainter, dxSkinsdxStatusBarPainter, dxSkinsdxDockControlPainter;
...
initialization
  dxSkinsAdditionalUnits.Add(TdxBarManager, 'dxSkinsdxBarPainter');

finalization
  dxSkinsAdditionalUnits.Remove(TdxBarManager, 'dxSkinsdxBarPainter');
end.
