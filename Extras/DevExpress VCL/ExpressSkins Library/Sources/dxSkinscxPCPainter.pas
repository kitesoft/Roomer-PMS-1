...
begin
  ...
  begin
    ...
    if AElement.IsAlphaUsed then
      DrawParentBackground(ACanvas, ARect);
    AElement.Draw(ACanvas.Handle, ARect, 0,
      ButtonStates[AButtonInfo.State]);
  end;
end;
...
begin
  Result := (ViewInfo.GetLookAndFeel.SkinPainter <> nil) and
    ViewInfo.GetLookAndFeel.SkinPainter.GetPainterData(AData);
end;
