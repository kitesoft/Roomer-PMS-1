...
{$ENDIF}
  ...
  Dialogs, ToolsApi, CheckLst, ExtCtrls, Menus, IniFiles,
  Registry, StdCtrls,
  dxCoreClasses, cxLookAndFeels, cxLookAndFeelPainters, cxClasses;
...
type
  ...
  TdxSkinsUnitStateList = class(TObject)
  private
    FList: TcxObjectList;
...
uses
  dxSkinsLookAndFeelPainter, dxSkinsStrs, dxDesignHelpers;
...
begin
  ...
  begin
    ...
    if APainter.LookAndFeelStyle = lfsSkin then
      UnitStateList.AddItem(cxGetUnitName(APainter.ClassType), APainter.LookAndFeelName);
  end;
end;
