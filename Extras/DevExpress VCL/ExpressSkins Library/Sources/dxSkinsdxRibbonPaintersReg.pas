...
uses
  ...
  dxRibbon, dxRibbonReg, dxRibbonSkins, dxSkinsdxRibbonPainter;
...
type
  ...
  protected
    function CanAddSkin(ASkin: TdxCustomRibbonSkin): Boolean; override;
  end;
...
function TdxSkinsdxRibbonColorSchemeNameProperty.CanAddSkin(ASkin: TdxCustomRibbonSkin): Boolean;
begin
