...
uses
  Types, DesignIntf,
  Windows, Classes, SysUtils, TypInfo, cxPivotGridChartConnection, dxCoreReg, cxPivotGridReg;
...
procedure Register;
begin
  RegisterComponents(dxCoreLibraryProductPage, [TcxPivotGridChartConnection]);
