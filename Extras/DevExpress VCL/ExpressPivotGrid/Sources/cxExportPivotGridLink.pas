...
procedure cxExportPivotGridToXLSX(const AFileName: string;
  APivotGrid: TcxCustomPivotGrid; AExpand: Boolean = True;
  AUseNativeFormat: Boolean = True;
...
uses
  ...
  cxDataUtils, cxDataStorage, cxExport, cxXLSExport, dxXLSXExport, cxHtmlXmlTxtExport,
  cxDBPivotGrid;
...
procedure cxExportPivotGridToXLSX(const AFileName: string;
  ...
  const AFileExt: string = 'xlsx');
begin
  cxExportPivotGridToFile(AFileName, APivotGrid, cxExportToXlsx, AExpand,
    AUseNativeFormat, [], AFileExt);
end;
