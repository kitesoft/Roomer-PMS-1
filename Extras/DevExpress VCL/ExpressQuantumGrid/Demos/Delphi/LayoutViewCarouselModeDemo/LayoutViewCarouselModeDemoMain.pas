...
uses
  ...
  cxTrackBar, DBClient, cxExtEditRepositoryItems;
...
begin
  Inc(FLockCount);
  try
    cbAutoPitchAngle.Checked := LayoutView.OptionsView.CarouselMode.AutoPitchAngle;
...
begin
  ...
  Inc(FLockCount);
  try
    LayoutView.OptionsView.CarouselMode.AutoPitchAngle := cbAutoPitchAngle.Checked;
  ...
  liPitchAngle.Enabled := not cbAutoPitchAngle.Checked;
end;
