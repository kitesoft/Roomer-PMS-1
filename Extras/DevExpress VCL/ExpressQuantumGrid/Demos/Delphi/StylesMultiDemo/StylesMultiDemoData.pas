...
uses
  SysUtils, Forms, Classes, DB, cxStyles, cxEdit, cxDBEditRepository,
  cxGridTableView, cxClasses, DemoUtils, DBClient;

type
  TStylesMultiDemoMainDM = class(TDataModule)
    strepUserDefined: TcxStyleRepository;
    tblProjects: TClientDataSet;
    dsProjects: TDataSource;
    tblTeam: TClientDataSet;
    dsTeam: TDataSource;
    tblProjectsID: TAutoIncField;
    tblProjectsNAME: TStringField;
    tblProjectsMANAGERID: TIntegerField;
    tblTeamID: TAutoIncField;
    tblTeamPROJECTID: TIntegerField;
    tblTeamUSERID: TIntegerField;
    tblTeamFUNCTION: TStringField;
...
var
  StylesMultiDemoMainDM: TStylesMultiDemoMainDM;
...
procedure TStylesMultiDemoMainDM.tblUsersCalcFields(DataSet: TDataSet);
begin
  SetStringFieldValue(tblUsersFullName, Format('%s %s %s', [tblUsersFName.Value,
    tblUsersMName.Value, tblUsersLName.Value]));
end;
...
procedure TStylesMultiDemoMainDM.DataModuleCreate(Sender: TObject);
var
  APath: string;
begin
