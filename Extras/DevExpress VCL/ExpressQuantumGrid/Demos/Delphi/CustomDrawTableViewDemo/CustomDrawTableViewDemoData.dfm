object CustomDrawTableViewDemoMainDM: TCustomDrawTableViewDemoMainDM
  ...
  object cdsCars: TClientDataSet
    ...
    Left = 120
    Top = 56
    object cdsCarsID: TAutoIncField
      FieldName = 'ID'
      ReadOnly = True
    end
    object cdsCarsTrademark: TStringField
      FieldName = 'Trademark'
      Size = 50
    end
    object cdsCarsModel: TStringField
      FieldName = 'Model'
      Size = 50
    end
    object cdsCarsHP: TSmallintField
      FieldName = 'HP'
    end
    object cdsCarsLiter: TFloatField
      FieldName = 'Liter'
    end
    object cdsCarsCyl: TSmallintField
      FieldName = 'Cyl'
    end
    object cdsCarsTransmissSpeedCount: TSmallintField
      FieldName = 'TransmissSpeedCount'
    end
    object cdsCarsTransmissAutomatic: TStringField
      FieldName = 'TransmissAutomatic'
      Size = 3
    end
    object cdsCarsMPG_City: TSmallintField
      FieldName = 'MPG_City'
    end
    object cdsCarsMPG_Highway: TSmallintField
      FieldName = 'MPG_Highway'
    end
    object cdsCarsCategory: TStringField
      FieldName = 'Category'
      Size = 7
    end
    object cdsCarsDescription: TMemoField
      FieldName = 'Description'
      BlobType = ftMemo
      Size = 10
    end
    object cdsCarsHyperlink: TStringField
      FieldName = 'Hyperlink'
      Size = 50
    end
    object cdsCarsPicture: TBlobField
      FieldName = 'Picture'
      Size = 10
    end
    object cdsCarsPrice: TFloatField
      FieldName = 'Price'
    end
    object cdsCarsCar: TStringField
      FieldName = 'Car'
      ReadOnly = True
      Size = 100
    end
