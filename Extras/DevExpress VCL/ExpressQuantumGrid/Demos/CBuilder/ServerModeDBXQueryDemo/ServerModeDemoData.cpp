...
//---------------------------------------------------------------------------
String GetCaption(){
  return "ExpressQuantumGrid dbExpress Server Mode Query Demo";
}
//---------------------------------------------------------------------------
...
String GetDescription(){
  return "This demo shows a grid control's capabilities when bound to a large amount of data in Server Mode via a dbExpress connection. The data is retrieved using a dbExpress query.";
}
//---------------------------------------------------------------------------
