...
uses
  ...
  cxGridCustomTableView, cxGridTableView, cxGridHeaderPopupMenuItems,
  cxGridFooterPopupMenuItems, cxGridGroupRowPopupMenuItems;
...
procedure TcxGridStdPopupMenu.MeasureItem(Sender: TObject; ACanvas: TCanvas;
