...
{$ENDIF}
  ...
  cxChartViewEditor, cxGridPredefinedStyles, cxGridStyleSheetsPreview, cxGridExportLink, ColnEdit;

{ TGridEditor }

const
  GridEditorVerbs: array [0..2] of string = ('Editor...', 'Import...', 'Structure Navigator');
  AddOnInsertPosition = 3;
