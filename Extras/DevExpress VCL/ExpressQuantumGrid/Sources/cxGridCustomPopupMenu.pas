...
uses
  Windows, Messages, Classes, SysUtils, Controls, Menus, dxCore, cxGridCustomView, cxClasses;
...
type
  ...
  TcxGridViewHitType = (gvhtGridNone, gvhtGridTab, gvhtNone, gvhtTab, gvhtCell,
    ...
    gvhtBand, gvhtBandHeader, gvhtRowCaption, gvhtSeparator, gvhtGroupSummary);
...
const
  cxGridViewHitCodes: array[TcxGridViewHitType] of Integer = (htNone + cxhtGridBase,
    ...
    htRowCaption, htSeparator, htGroupSummary);
begin
...
function TcxPopupMenuInfos.IsMenuInfoShortCut(
  AMenuInfo: TcxPopupMenuInfo; var Message: TWMKey): Boolean;
begin
