...
uses
  ...
  cxEdit, cxImageComboBox, cxLookAndFeels, cxGridCustomTableView, cxGridTableView,
  cxControls, cxGridCustomView, cxClasses, cxGridLevel, cxGrid, Menus, StdCtrls,
  ExtCtrls, cxTextEdit, cxMaskEdit, cxDropDownEdit, cxContainer, cxGroupBox,
  cxLookAndFeelPainters, cxButtons, cxCalendar, ImgList, cxNavigator;
...
procedure TfmImageComboBoxItemsEditor.PopulateValueTypeNames;
  ...
  procedure AddValueTypeToDropDownMenu(AValuetypeName: string; AValue: Integer);
  var
    AMenuItem: TMenuItem;
  begin
  ...
  procedure AddValueTypeToValueTypeColumn(AValuetypeName: string; AValue: Integer);
  var
