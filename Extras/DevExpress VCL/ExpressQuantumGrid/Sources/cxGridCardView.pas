...
type
  ...
  protected
    ...
    function CalculateWidth: Integer; override;
    class procedure CheckHeight(ACardViewInfoClass: TcxGridCardViewInfoClass;
      ARow: TcxGridCardViewRow; ARowViewInfo: TcxGridCardRowViewInfo;
      ALookAndFeelPainter: TcxCustomLookAndFeelPainter; var AHeight: Integer); virtual;
    ...
    class function GetExpandButtonAreaSize(ALookAndFeelPainter: TcxCustomLookAndFeelPainter): Integer; virtual;
  ...
  protected
    class procedure CheckHeight(ACardViewInfoClass: TcxGridCardViewInfoClass;
      ARow: TcxGridCardViewRow; ARowViewInfo: TcxGridCardRowViewInfo;
      ALookAndFeelPainter: TcxCustomLookAndFeelPainter; var AHeight: Integer); override;
  ...
  published
    ...
    property CategoryRowCaptionInRowAlternateCaption: Boolean read FCategoryRowCaptionInRowAlternateCaption
      write SetCategoryRowCaptionInRowAlternateCaption default False;
    property CategorySeparatorWidth: Integer read FCategorySeparatorWidth
      write SetCategorySeparatorWidth default cxGridCardDefaultCategorySeparatorWidth;
    ...
    property LayerSeparatorWidth: Integer read FLayerSeparatorWidth write SetLayerSeparatorWidth
      default cxGridCardDefaultLayerSeparatorWidth;
    ...
    property ShowRowFilterButtons: TcxGridShowItemFilterButtons read GetShowRowFilterButtons
      write SetShowRowFilterButtons default sfbWhenSelected;
  end;
  ...
  TcxGridCardRowChangingEvent = procedure(Sender: TcxGridCardView; ARow: TcxGridCardViewRow;
...
begin
  Result := TcxGridCardRowCaptionViewInfo.GetCellHeight(cxTextHeight(Canvas.Handle),
    LookAndFeelPainter);
end;
...
begin
  ADefaultCaptionHeight := GetCellHeight(ACanvas.FontHeight(AFont), ARow.GridView.LookAndFeelPainter);
  dxAdjustToTouchableSize(ADefaultCaptionHeight);
...
begin
  ...
  dxAdjustToTouchableSize(ADefaultCellHeight);
...
begin
  ...
  CheckHeight(TcxGridCardViewInfoClass(ARow.GridView.ViewInfo.RecordsViewInfo.GetItemViewInfoClass), ARow,
...
class procedure TcxGridCardRowViewInfo.CheckHeight(ACardViewInfoClass: TcxGridCardViewInfoClass;
  ARow: TcxGridCardViewRow; ARowViewInfo: TcxGridCardRowViewInfo;
  ALookAndFeelPainter: TcxCustomLookAndFeelPainter; var AHeight: Integer);
begin
...
class function TcxGridCardRowViewInfo.GetExpandButtonAreaSize(ALookAndFeelPainter: TcxCustomLookAndFeelPainter): Integer;
begin
...
class function TcxGridCardRowViewInfo.GetExpandButtonSize(ALookAndFeelPainter: TcxCustomLookAndFeelPainter): Integer;
begin
