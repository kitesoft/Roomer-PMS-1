...
type
  ...
  {$ENDIF}
    ...
    property OnPrepareLockedStateImage: TcxGridPrepareLockedStateImageEvent
      read FOnPrepareLockedStateImage write FOnPrepareLockedStateImage;
