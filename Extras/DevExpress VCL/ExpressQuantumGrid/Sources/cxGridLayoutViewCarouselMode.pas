...
type
  ...
  private
    ...
    function GetControllerHelper: TcxGridLayoutViewControllerCarouselHelper;{$IFDEF DELPHI9} inline;{$ENDIF}
...
function cxTouchPointDatasEqual(const P1, P2: TcxTouchPointData): Boolean;
begin
...
function TcxGridLayoutViewCarouselModeRecordViewInfo.CanGetHitTest: Boolean;
begin
...
begin
  if not cxTouchPointDatasEqual(TouchPoint, cxInvalidTouchPointData) then
...
var
  Angle: Double;
begin
  if not cxTouchPointDatasEqual(TouchPoint, Value)  then
  begin
