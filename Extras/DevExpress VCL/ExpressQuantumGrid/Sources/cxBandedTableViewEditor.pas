...
uses
  Types, Variants, SysUtils, Classes, Graphics, Controls, Forms, Dialogs, Menus,
  ExtCtrls, StdCtrls, ComCtrls,
  cxGridCustomView, cxGridBandedTableView, cxGridCustomTableView,
  cxViewEditor, cxCustomTableViewEditor, cxTableViewEditor,
  cxLookAndFeelPainters, cxButtons, cxPC, cxControls, cxGraphics, cxLookAndFeels;
...
type
  ...
  protected
    procedure DrawListBoxItem(AListBox: TWinControl; AIndex: Integer; R: TRect;
      AParentBand: TcxGridBand); reintroduce;
