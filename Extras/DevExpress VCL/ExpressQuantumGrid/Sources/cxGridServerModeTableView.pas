...
type
  ...
  TcxGridServerModeColumnOptions = class(TcxCustomGridTableItemOptions)
  private
...
constructor TcxGridServerModeColumnOptions.Create(AItem: TcxCustomGridTableItem);
begin
  inherited;
  FGroupFooters := True;
  FHorzSizing := True;
...
function TcxGridServerModeColumnOptions.GetGridView: TcxGridServerModeTableView;
begin
  Result := TcxGridServerModeTableView(inherited GridView);
end;

procedure TcxGridServerModeColumnOptions.SetCellMerging(Value: Boolean);
begin
...
procedure TcxGridServerModeColumnOptions.SetGroupFooters(Value: Boolean);
begin
...
procedure TcxGridServerModeColumnOptions.SetHorzSizing(Value: Boolean);
begin
...
procedure TcxGridServerModeColumnOptions.Assign(Source: TPersistent);
begin
  if Source is TcxGridServerModeColumnOptions then
    with TcxGridServerModeColumnOptions(Source) do
    begin
