...
{$ENDIF}
  ...
  cxSchedulerHolidays, cxSchedulerGanttView, cxLookAndFeelPainters;
...
uses
  cxClasses,Variants, DateUtils,cxSchedulerDialogs, AboutDemoForm, cxSchedulerOutlookExchange,
  DemoUtils;
