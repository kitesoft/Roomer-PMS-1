...
var
  I: Integer;
begin
  if (AStorage <> nil) and (AStorage.EventCount = 0) then Exit;
...
begin
  if (AIsRemoved or IsDestroining or CanRefresh or (AEvent <> nil)) then
...
begin
  ...
  try
    ...
    RemoveStorageEvents(TcxCustomSchedulerStorage(Sender));
    Changed;
  finally
    EndUpdate;
  end;
