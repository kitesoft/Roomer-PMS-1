...
{$ENDIF}
  ...
  cxLookAndFeelPainters, cxEdit, cxTextEdit, cxMaskEdit, cxDropDownEdit, cxLabel;
...
begin
  CheckColumnCount;
  SetupCaptions;
  lbEventCaption.Style.Font.Style := lbEventCaption.Style.Font.Style + [fsBold];
  inherited DoShow;
...
procedure TcxSchedulerReminderForm.UpdateSelectionCaptions;
  ...
  begin
    ...
    try
      Font.Assign(lbEventCaption.Style.Font);
