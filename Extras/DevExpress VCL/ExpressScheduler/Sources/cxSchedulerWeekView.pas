...
uses
  Types, Windows, Forms, Classes, cxClasses, SysUtils, Graphics, DateUtils, Math,
  StdCtrls, dxCore, cxGraphics, cxDateUtils, Controls, cxControls, cxSchedulerCustomControls,
  cxLookAndFeelPainters, cxGeometry, cxStyles, cxSchedulerStorage, cxSchedulerUtils,
    ...
    begin
      ...
      begin
        ...
        while (I < Events.AbsoluteCount) and ((Events.AbsoluteItems[I] = nil) or
          AEvent.IsDayEvent(Trunc(Events.AbsoluteItems[I].Start))) do Inc(I);
      end;
    end;
  finally
