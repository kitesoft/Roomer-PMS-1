...
uses
  ...
  dxCoreClasses, cxClasses, cxControls, cxCustomData, cxDataStorage, cxVariants,
...
begin
  ...
  try
    ...
    Items.AddColor(clNone, cxGetResourceString(@scxEventLabelNone));
    for I := 1 to EventLabels.Count - 1 do
      Items.AddColor(EventLabels[I].Color, EventLabels[I].Caption);
    DefaultColor := clNone;
