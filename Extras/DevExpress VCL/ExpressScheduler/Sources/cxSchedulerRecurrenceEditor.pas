...
uses
  Variants, DateUtils, cxSchedulerStrs, cxClasses, cxFormats, cxSchedulerDialogs;
  ...
  try
    ...
    try
      ...
      begin
        ...
        SetDateWithoutChangeEvent(deEndBy, dxDateOf(Info.Finish));
