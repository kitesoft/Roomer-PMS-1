...
uses
  dxCore, cxLibraryConsts, cxSchedulerDialogs, cxVariants;
...
procedure TcxSchedulerGanttViewLinkViewInfo.InitializeFinishParams(
  ...
  begin
    ...
    InflateRect(R, 2 * LinkLineOffset, 0);
  ...
  begin
    ATargetX := Max(ATargetX, AStartRect.Right + LinkLineOffset);
    if ATargetX >= R.Right then
      ...
      begin
        ...
        InflateRect(R, 0, 2 * LinkLineOffset);
...
begin
  ...
  InflateRect(AStartRect, LinkLineOffset, LinkLineOffset);
