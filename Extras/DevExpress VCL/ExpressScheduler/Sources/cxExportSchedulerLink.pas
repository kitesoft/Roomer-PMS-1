...
uses
  ...
  dxXLSXExport, cxHtmlXmlTxtExport, Forms, Menus, cxLookAndFeelPainters, Controls,
  cxControls, cxContainer, cxEdit, cxTextEdit, cxMaskEdit, cxDropDownEdit, cxCalendar,
  StdCtrls, cxButtons, cxLookAndFeels, cxDateUtils, cxLabel, ComCtrls, dxCore;
...
procedure cxExportSchedulerToXLSX(const AFileName: string; AScheduler: TcxCustomScheduler; AsTable: Boolean = False;
  AShowDialog: Boolean = False; const AHeader: string = 'Event %d'; const AStart: TDateTime = NullDate;
  const AFinish: TDateTime = NullDate; const AFileExt: string = 'xlsx');
...
begin
  cxExportSchedulerToFile(AFileName, AScheduler, AsTable, AShowDialog, AHeader,
    AStart, AFinish, cxExportToXlsx, [], AFileExt);
end;
