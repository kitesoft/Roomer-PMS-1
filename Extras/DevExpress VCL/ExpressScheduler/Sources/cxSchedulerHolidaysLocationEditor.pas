...
type
  TfmHolidaysLocationEditor = class(TForm)
    btnOK: TcxButton;
    btnCancel: TcxButton;
    teName: TcxTextEdit;
    lbName: TcxLabel;
  ...
  public
    ...
    property Location: TcxSchedulerHolidaysLocation read
      FLocation write SetLocation;
...
uses
  cxSchedulerStrs, cxClasses, cxSchedulerDialogs, cxSchedulerUtils;
...
procedure TfmHolidaysLocationEditor.SetLocation(
  const AValue: TcxSchedulerHolidaysLocation);
begin
  FLocation := AValue;
end;
