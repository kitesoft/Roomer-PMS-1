...
uses
  Types, Windows, Messages, Classes, Controls, Forms, dxMessages, dxCoreClasses,
...
type
  ...
  TdxWizardControlForm = class(TForm)
  private
...
uses
  cxDWMApi, SysUtils, cxGeometry, cxControls, Math, dxUxTheme;
...
begin
  ...
  begin
    ...
    begin
      AMonitor := Screen.MonitorFromWindow(Form.Handle);
      if AMonitor <> nil then
      begin
        AScreenArea := AMonitor.WorkareaRect;
