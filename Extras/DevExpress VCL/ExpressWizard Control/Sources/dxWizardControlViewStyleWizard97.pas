...
begin
  inherited Calculate;
  FPageArea := cxRectContent(PageArea, dxWizardViewStyleWizard97OffsetFromBorders);
end;
...
begin
  ...
  FBackButtonViewInfo := AddButtonCell(Buttons.Back, TdxWizardControlBackButtonViewInfo);
end;
...
begin
  ...
  if AlignButtonToRightSide(BackButtonViewInfo, ABounds) then
    Dec(ABounds.Right, dxWizardViewStyleWizard97IndentBetweenElementsInGroup);
end;
...
begin
  Result := dxWizardViewStyleWizard97OffsetFromBorders;
...
begin
  Result := dxWizardViewStyleWizard97IndentBetweenElementsInGroup;
end;

function TdxWizardControlViewStyleWizard97CommandAreaViewInfo.GetIndentBetweenGroups: Integer;
begin
  Result := dxWizardViewStyleWizard97IndentBetweenGroups;
end;
...
begin
  Result := WatermakVisibility <> wcevAlwaysHidden;
end;
...
function TdxWizardControlViewStyleWizard97HeaderViewInfo.GetIndentBetweenElemenets: Integer;
begin
  Result := dxWizardViewStyleWizard97IndentBetweenElementsInGroup;
end;
