...
uses
  ...
  cxDesignWindows, dxRibbonGalleryDesigner;
...
begin
  FDesigner := ShowFormEditorClass(Designer, GetComponent(0) as TdxRibbonGalleryItem, TfrmRibbonGalleryDesigner);
end;
...
begin
  ...
  HideClassProperties(TdxRibbonGalleryOptions, ['CanCollapse', 'Collapsed',
    ...
    'EqualItemSizeInAllGroups', 'RowCount', 'ShowScrollBar', 'SubMenuResizing']);
