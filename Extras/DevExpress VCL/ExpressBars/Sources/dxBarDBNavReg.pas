...
{       ExpressBars DB Navigator registring unit                    }
{                                                                   }
...
{$ENDIF}
  ...
  RegisterPropertyEditor(TypeInfo(TdxBarDBNavigator), TdxBarDBNavButton,
    'BarDBNavigator', nil);
  RegisterPropertyEditor(TypeInfo(TdxBarDBCheckLinks), TdxBarDBNavigator,
    'DBCheckLinks', TdxBarDBCheckLinksPropertyEditor);
end;
