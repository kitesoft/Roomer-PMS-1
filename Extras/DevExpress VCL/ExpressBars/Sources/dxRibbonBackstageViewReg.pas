...
{$ELSE}
  DsgnIntf,
{$ENDIF}
  TypInfo, Windows, Classes, SysUtils, Messages, Controls, Graphics, Math, Forms, StdCtrls, cxGraphics, cxGeometry,
  cxControls, cxClasses, dxBar, dxRibbon, dxRibbonSkins, dxRibbonBackstageView, dxCoreReg, dxBarReg, cxDesignWindows,
  cxComponentCollectionEditor, dxRibbonBackstageViewGalleryControl, dxGalleryDesigner, cxLibraryReg;
...
procedure TdxRibbonBackstageViewComponentEditor.PrepareItem(
  Index: Integer; const AItem: TDesignMenuItem);
begin
  if Index = 1 then
