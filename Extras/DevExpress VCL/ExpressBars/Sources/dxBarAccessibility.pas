...
{$IFDEF DELPHI6}
  Types,
{$ENDIF}
  Windows, Forms, Classes, SysUtils, dxCore, cxAccessibility, cxClasses, dxBar;
...
begin
  with TdxBarSubMenuControlAccess(BarControl) do
    AKeyTipInfo.BasePoint.X := ClientOrigin.X + BarRect.Right + BandSize div 2;
  with GetItemScreenBounds(AItemLinkHelper) do
    AKeyTipInfo.BasePoint.Y := (Top + Bottom) div 2;
