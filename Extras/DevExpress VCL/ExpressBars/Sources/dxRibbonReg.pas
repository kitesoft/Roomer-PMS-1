...
uses
  ...
  dxRibbonMiniToolbar, dxBarPopupMenuEd, dxRibbonRadialMenu;
...
begin
  Result := ASkin.Style = TdxRibbon(GetComponent(0)).Style;
end;
...
function TdxRibbonRadialMenuEditor.IsAssignable: Boolean;
begin
  Result := True;
end;

procedure TdxRibbonRadialMenuEditor.DoAssign(AObject: TObject);
var
...
function TdxRibbonRadialMenuEditor.GetAssignItemCaption: string;
begin
  Result := 'Assign ItemLinks From';
end;

function TdxRibbonRadialMenuEditor.GetAssignTypeClass: TClass;
begin
