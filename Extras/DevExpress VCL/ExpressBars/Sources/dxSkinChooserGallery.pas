...
uses
  Windows, Classes, SysUtils, Graphics, dxRibbonGallery, cxLookAndFeelPainters,
  dxSkinsCore, cxClasses, cxLookAndFeels;
...
uses
  dxBar, cxGraphics, dxGDIPlusClasses, dxSkinsStrs, dxBarStrs;
...
begin
  ...
  try
    ...
    Result.GlyphInDropDown := ABitmapInDropDown;
