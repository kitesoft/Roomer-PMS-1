...
uses
  Windows, Classes, Types, cxGraphics;
...
type
  ...
  private
    ...
    class procedure QSplineCalcPart(var P0, P1, P2: TPoint; AIsLast: Boolean;
      var ASplinePoints: TPointArray; var ASplinePointsCount: Integer);
  public
    ...
    class procedure QSpline(APoints: PdxFCPointArray; ACount: Integer; out ASplinePoints: TPointArray);
  end;
...
class procedure TdxFcLinesHelper.QSpline(
  APoints: PdxFCPointArray; ACount: Integer; out ASplinePoints: TPointArray);
var
  I, AIndex: Integer;
  P0, P1, P2: TPoint;
begin
...
class procedure TdxFcLinesHelper.QSplineCalcPart(var P0, P1, P2: TPoint;
  AIsLast: Boolean; var ASplinePoints: TPointArray; var ASplinePointsCount: Integer);
