...
uses
  ...
  dxCore, dxCoreClasses, dxNavBarBase, dxNavBarStyles, cxAccessibility,
  cxControls, cxClasses, Themes;
...
begin
  ...
  begin
    ...
    if AItem <> nil then
      (AItem as TdxNavBarGroup).DestroyAccessibilityHelpers;
  end;
end;
...
procedure TdxNavBarItems.Notify(AItem: TcxComponentCollectionItem;
  AAction: TcxComponentCollectionNotification);
begin
