...
uses
  ...
  dxSkinsCore, dxSkinInfo, cxLookAndFeelPainters, dxCoreClasses;
...
var
  AElement: TdxSkinElement;
begin
  AElement := GetSkinHelper.NavPaneItem([sSelected, sPressed] * State <> []);
...
begin
  ...
  if not DrawSkinElement(FSkinBasedPainterHelper.NavPaneItem(
    [sSelected, sPressed] * ALinkViewInfo.State <> []), Canvas,
    ALinkViewInfo.SelectionRect, 0, AState)
  then
    inherited;
end;
