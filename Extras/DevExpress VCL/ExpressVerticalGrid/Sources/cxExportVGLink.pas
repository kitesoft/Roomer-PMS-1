...
procedure cxExportVGToXLSX(const AFileName: string;
  AVerticalGrid: TcxCustomVerticalGrid; AExpand: Boolean = True;
  AUseNativeFormat: Boolean = True;
  ARecordPerBand: Integer = 8; const AFileExt: string = 'xlsx');
...
{$ENDIF}
  ...
  cxDataUtils, cxExport, cxXLSExport, dxXLSXExport, cxHtmlXmlTxtExport, cxVGridViewInfo,
...
procedure cxExportVGToXLSX(const AFileName: string;
  ...
  ARecordPerBand: Integer = 8; const AFileExt: string = 'xlsx');
begin
  cxExportVGToFile(AFileName, AVerticalGrid, cxExportToXlsx, AExpand,
    AUseNativeFormat, [], ARecordPerBand, AFileExt);
end;
