...
uses
  Types, Classes, Graphics, Windows, Controls,
...
begin
  AValuesWidth := cxRectWidth(ClientRect) - ViewHeaderWidth - DividerWidth - VertLineWidth;
  ...
  Result := AValuesWidth div AFullValueWidth;
  if Result * AFullValueWidth < AValuesWidth then
    Inc(Result);
end;
