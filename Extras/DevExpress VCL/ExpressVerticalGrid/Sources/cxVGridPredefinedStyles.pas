...
{$IFNDEF DELPHI6}
  Forms,
{$ENDIF}
  SysUtils, Classes, cxStyles, cxVGrid, cxClasses;

type
  TcxdmVerticalGridPredefinedStyles = class(TDataModule)
...
var
  cxdmVerticalGridPredefinedStyles: TcxdmVerticalGridPredefinedStyles;
...
uses
  cxStyleSheetsLoad, Dialogs;

type
  TcxVerticalGridPredefinedStyleSheets = class(TcxPredefinedStyleSheets)
  private
    FData: TcxdmVerticalGridPredefinedStyles;
  protected
...
{ TcxVerticalGridPredefinedStyleSheets }

constructor TcxVerticalGridPredefinedStyleSheets.Create;
begin
  inherited Create;
  FData := TcxdmVerticalGridPredefinedStyles.Create(nil);
  AddStyleSheets;
end;

destructor TcxVerticalGridPredefinedStyleSheets.Destroy;
begin
  FData.Free;
  inherited Destroy;
end;

procedure TcxVerticalGridPredefinedStyleSheets.AddStyleSheets;
var
  I: Integer;
begin
  with FData.StyleRepository do
    for I := 0 to StyleSheetCount - 1 do
      AddStyleSheet(StyleSheets[I]);
end;

initialization
  RegisterPredefinedStyleSheets(TcxVerticalGridPredefinedStyleSheets);

finalization
  UnregisterPredefinedStyleSheets(TcxVerticalGridPredefinedStyleSheets);
