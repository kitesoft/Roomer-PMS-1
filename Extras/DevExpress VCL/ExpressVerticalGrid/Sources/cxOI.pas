...
uses
  ...
  cxColorComboBox, cxOIStringsEd, cxOIPictureEd, cxOICollectionEd, cxVGridConsts;
...
begin
  if (Index = vgs_Content) and AContentInfo.EditorRowProperties.EditProperties.ReadOnly then
