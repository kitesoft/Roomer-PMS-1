...
{$IFDEF DELPHI16}
  System.UITypes,
{$ENDIF}
  Types, Classes, SysUtils, Windows, Messages, Graphics, Controls, Forms,
  Dialogs, Grids, StdCtrls, Buttons, ExtCtrls, ComCtrls,
  dxCore, cxLookAndFeels, cxLookAndFeelPainters,
  cxSSheet, cxSSStyles, cxControls, cxClasses, cxGraphics, cxSSCtrls, cxSSColorBox,
...
begin
  ...
  begin
    ...
    begin
      ...
      Line(AVertex, ALineStyle, orHorizontal, GetNativeColor(clWindow), clBlack);
    EndPaint;
  end;
end;
  ...
  try
    ...
    for I := 0 to FHorzCount - 1 do
     ...
     begin
       ...
       FCanvasWrapper.Line(ARect, Style, orHorizontal,
    ...
    for I := 0 to FHorzCount do
     with FVertBorders[I] do
       FCanvasWrapper.Line([InflateVertex(FVertVertex[I], Style, False)], Style,
         orVertical, cplPatColor.SelectedColor, Color, False);
  finally
