...
type
  ...
  private
    ...
    function GetOriginalSize(AIndex: Integer): Integer;
    ...
    procedure SetOriginalSize(AIndex: Integer; const Value: Integer);
  ...
  public
    ...
    property OriginalSize[AIndex: Integer]: Integer read GetOriginalSize write SetOriginalSize;
...
function TcxSSHeader.GetOriginalSize(AIndex: Integer): Integer;
begin
  Result := GetItem(AIndex).OriginalSize;
end;
...
procedure TcxSSHeader.SetOriginalSize(AIndex: Integer; const Value: Integer);
var
  AItem: TcxSSHeaderElement;
begin
  AItem := GetItem(AIndex);
  AItem.OriginalSize := Value;
  SetItem(AIndex, AItem);
end;
