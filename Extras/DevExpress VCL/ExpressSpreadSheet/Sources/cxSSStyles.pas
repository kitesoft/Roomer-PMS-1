...
{$ENDIF}
  ...
  dxCore, dxCoreClasses, cxGraphics, cxClasses, cxControls, cxExcelConst, cxSSTypes,
...
uses
  Types, cxSSheet, cxSSData, cxSSHeaders;
...
begin
  ...
  try
    ...
    Result := ACanvas.TextExtent(dxMeasurePattern);
  finally
    ACanvas.Free;
  end;
end;
...
begin
  ...
  begin
    ...
    with ALogFont do
    begin
      lfHeight := -MulDiv(Size, cxGetCurrentDPI, 72);
