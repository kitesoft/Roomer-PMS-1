...
uses
  Types, SysUtils, TypInfo, Windows, Messages, Graphics, Controls, Forms, Classes;
...
procedure Office11DrawLargeItemArrow(ADC: HDC; R: TRect; ADownArrow: Boolean;
  ASize: Integer; ASelected, AEnabled, AFlat: Boolean);
...
var
  ...
  GradientFill: function (ADC: THandle; AVertex: PTriVertex; ANumVertex: Integer;
    AMesh: PGradientRect; ANumMesh: Integer; AMode: DWORD): LongBool; stdcall;
