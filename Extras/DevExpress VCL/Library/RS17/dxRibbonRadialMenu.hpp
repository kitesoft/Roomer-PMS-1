...
// (DO NOT EDIT: machine generated header) 'dxRibbonRadialMenu.pas' rev: 24.00 (Win32)
...
protected:
	...
	void __fastcall DrawRadialItemBackGround(Cxgraphics::TcxCanvas* ACanvas, Dxgdiplusclasses::TdxGPGraphics* AGPGraphics, Dxbar::TdxBarItem* AItem, const Cxgeometry::TdxSector &ASector);
	void __fastcall DrawRadialItemContent(Cxgraphics::TcxCanvas* ACanvas, Dxgdiplusclasses::TdxGPGraphics* AGPGraphics, Dxbar::TdxBarItem* AItem, const System::Types::TRect &ARect);
