...
// (DO NOT EDIT: machine generated header) 'cxSchedulerYearView.pas' rev: 24.00 (Win32)
...
protected:
	...
	Cxschedulercustomresourceview::TcxSchedulerWeekDayHeaderCellViewInfo* __fastcall AddWeekDayHeader(int AWeekDay, const System::Types::TRect &ARect);
	TcxSchedulerYearViewContentCellViewInfo* __fastcall AddYearViewContentCell(const System::Types::TRect &ARect, System::TDate ADate, bool ASelected, const Cxgraphics::TcxViewParams &AParams, int AColIndex);
