...
// (DO NOT EDIT: machine generated header) 'cxSSheet.pas' rev: 24.00 (Win32)
...
protected:
	...
	virtual void __fastcall OnDeleteCells(TcxSSBookSheet* Sender, const System::Types::TRect &ACellRect, Cxsstypes::TcxSSModifyType AModifyType);
	virtual void __fastcall OnHistoryChanged(System::TObject* Sender);
	virtual void __fastcall OnInsertCells(TcxSSBookSheet* Sender, const System::Types::TRect &ACellRect, Cxsstypes::TcxSSModifyType AModifyType);
	virtual void __fastcall OnMergeCells(TcxSSBookSheet* Sender, const System::Types::TRect &ACellRect, bool AIsMerge, bool &CanMerge);
	...
	virtual void __fastcall UpdateAfterChanged(TcxSSBookSheet* Sender, const System::Types::TRect &ACellRect);
...
private:
	...
	void __fastcall SetBoundsRect(const System::Types::TRect &ARect);
...
private:
	...
	void __fastcall SetSelectionRect(const System::Types::TRect &Value);
