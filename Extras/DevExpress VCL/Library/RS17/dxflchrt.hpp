...
// (DO NOT EDIT: machine generated header) 'dxflchrt.pas' rev: 24.00 (Win32)
...
protected:
	...
	virtual HRGN __fastcall UserRegion(const System::Types::TRect &R);
...
private:
	...
	void __fastcall SetPoint(int AIndex, const System::Types::TPoint &AValue);
...
protected:
	...
	virtual void __fastcall FontChanged(void);
	void __fastcall InternalInsertPoint(int AIndex, const System::Types::TPoint &P);
	virtual void __fastcall Invalidate(void);
	virtual void __fastcall Load(System::Classes::TStream* Stream, bool AIsUnicode);
	virtual void __fastcall Save(System::Classes::TStream* Stream);
	virtual void __fastcall SetText(System::UnicodeString Value);
...
protected:
	...
	virtual void __fastcall DefaultDrawObject(TdxFcObject* AObject, const System::Types::TRect &R);
	virtual void __fastcall DefineProperties(System::Classes::TFiler* Filer);
	virtual void __fastcall Delete(TdxFcItem* Item);
	virtual void __fastcall DoDrawObject(TdxFcObject* AObject, const System::Types::TRect &R);
