...
// (DO NOT EDIT: machine generated header) 'cxDBTL.pas' rev: 24.00 (Win32)
...
protected:
	...
	virtual bool __fastcall IsExistKeyRoot(const System::Variant &AParentValue);
	void __fastcall LoadLevel(TcxDBTreeListNode* ANode, const System::Variant &AParentValue, System::Classes::TList* ANewNodes);
	void __fastcall LoadLevelBack(const System::Variant &AParentValue);
