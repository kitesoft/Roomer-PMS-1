...
// (DO NOT EDIT: machine generated header) 'cxSSDesigner.pas' rev: 24.00 (Win32)
...
__published:
	...
	void __fastcall drwgLineStyleDrawCell(System::TObject* Sender, int ACol, int ARow, const System::Types::TRect &Rect, Vcl::Grids::TGridDrawState State);
...
protected:
	...
	HIDESBASE void __fastcall SetBorderStyle(const System::Types::TRect &AVertex, Cxsstypes::TcxSSEdgeStyleRec &ABorder, Cxsstypes::TcxSSEdgeLineStyle AStyle, System::Word AColor, bool SetAlways = false);
