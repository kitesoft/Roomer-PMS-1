...
// (DO NOT EDIT: machine generated header) 'dxdbtree.pas' rev: 24.00 (Win32)
...
protected:
	...
	void __fastcall SetKeyFieldValue(const System::Variant &Value);
	void __fastcall SetParentFieldValue(const System::Variant &Value);
	void __fastcall UpdateImages(void);
	__property TdxDBTreeNode* Parent = {read=GetParent};
	
public:
	__fastcall TdxDBTreeNode(TdxDBTreeNodes* AOwner, const System::Variant &Value)/* overload */;
...
protected:
	...
	bool __fastcall FindNearest(const System::Variant &Value, int &Index);
	void __fastcall Clear(void);
	void __fastcall Delete(TdxDBTreeNode* ADBTreeNode);
	void __fastcall NodeChangeParent(Vcl::Comctrls::TTreeNode* ATreeNode, const System::Variant &Value);
...
public:
	...
	TdxDBTreeNode* __fastcall GetDBTreeNode(const System::Variant &Value);
	Vcl::Comctrls::TTreeNode* __fastcall GetTreeNode(const System::Variant &Value);
...
private:
	...
	void __fastcall DeleteDBNode(const System::Variant &AKeyValue);
...
protected:
	...
	bool __fastcall LockedLocate(const System::UnicodeString AFieldName, const System::Variant &AValue, Data::Db::TLocateOptions AOptions);
...
public:
	...
	void __fastcall GotoKeyFieldValue(const System::Variant &Value);
