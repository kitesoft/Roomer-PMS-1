...
// (DO NOT EDIT: machine generated header) 'cxListView.pas' rev: 24.00 (Win32)
...
public:
	...
	Vcl::Comctrls::TListItem* __fastcall GetNearestItem(const System::Types::TPoint &Point, Vcl::Comctrls::TSearchDirection Direction);
