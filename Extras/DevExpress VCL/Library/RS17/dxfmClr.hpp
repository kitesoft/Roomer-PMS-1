...
// (DO NOT EDIT: machine generated header) 'dxfmClr.pas' rev: 24.00 (Win32)
...
protected:
	...
	virtual void __fastcall Initialize(Dxbkgnd::TdxBackground* ABackground, const System::Types::TPoint &APosition, const TdxBackgroundDlgData &AData);
...
extern PACKAGE bool __fastcall dxChooseBackgroundDlg(Dxbkgnd::TdxBackground* ABackground, const System::Types::TPoint &APosition, const TdxBackgroundDlgData &AParams)/* overload */;
