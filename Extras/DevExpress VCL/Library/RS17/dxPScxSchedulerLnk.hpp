...
// (DO NOT EDIT: machine generated header) 'dxPScxSchedulerLnk.pas' rev: 24.00 (Win32)
...
protected:
	...
	virtual void __fastcall CreateControlsOnFirstPage(int APageIndex, Dxpscore::TdxReportCell* ASite, Dxpscore::TdxReportCell* AHeader, const System::Types::TRect &ABounds);
	virtual void __fastcall CreateControlsOnSecondPage(int APageIndex, Dxpscore::TdxReportCell* ASite, Dxpscore::TdxReportCell* AHeader, const System::Types::TRect &ABounds);
...
protected:
	...
	virtual void __fastcall CreateSchedulingAreaWithHeader(Dxpscore::TdxReportCell* ASite, const System::Types::TRect &ABounds);
	virtual TcxSchedulerReportCommonCellsProducer* __fastcall CreateSchedulingCellsProducer(TcxSchedulerReportSchedulingAreaCell* ASite);
	virtual void __fastcall FillDatesForPage(Cxschedulerutils::TcxSchedulerDateList* ADateList, int APageIndex, int APeriodIndex, int ASubIndex);
	virtual Cxschedulercustomresourceview::TcxSchedulerCustomResourceView* __fastcall GetCorrespondedView(void);
	virtual int __fastcall GetGlyphIndex(void);
...
private:
	...
	void __fastcall SetPrintStyleResourceCountPerPageByIndex(int AnIndex, const System::Variant &AValue);
...
protected:
	...
	virtual void __fastcall PreviewDrawPageContent(Vcl::Graphics::TCanvas* ACanvas, const System::Types::TRect &ABounds);
...
public:
	...
	virtual void __fastcall DrawContent(Dxpsreportrendercanvas::TdxPSReportRenderCustomCanvas* ACanvas, const System::Types::TRect &DrawRect, const System::Types::TRect &OriginRect, Dxpscore::TdxPSRenderStages AStage);
...
protected:
	...
	void __fastcall DrawCellState(Dxpsreportrendercanvas::TdxPSReportRenderCustomCanvas* ACanvas, const System::Types::TRect &R, int AState, Cxgraphics::TcxBorders ABorders = Cxgraphics::TcxBorders() , System::Uitypes::TColor ABorderColor = (System::Uitypes::TColor)(0x0));
...
protected:
	...
	virtual void __fastcall CreateDataItems(void);
	virtual void __fastcall DoInitializeFromViewInfo(Cxschedulercustomresourceview::TcxSchedulerEventCellViewInfo* AEventViewInfo);
	virtual Cxgraphics::TPointArray __fastcall GetPolygone(const System::Types::TRect &ABounds);
...
static const System::Extended NotesAreaWidth = 3.333333E-01;
static const System::Extended SchedulerHeaderMinHeight = 1.000000E-01;
static const System::Extended SchedulerHeaderMaxHeight = 2.500000E-01;
static const System::Extended SchedulerHeaderSmallHeight = 5.555556E-02;
