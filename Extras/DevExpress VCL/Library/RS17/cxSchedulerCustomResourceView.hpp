...
// (DO NOT EDIT: machine generated header) 'cxSchedulerCustomResourceView.pas' rev: 24.00 (Win32)
...
protected:
	...
	virtual void __fastcall InitHitTest(TcxSchedulerCustomResourceViewHitTest* AHitTest);
	void __fastcall TextOut(Cxgraphics::TcxCanvas* ACanvas, const System::UnicodeString AText, const System::Types::TRect &R);
...
protected:
	...
	void __fastcall DrawCurrentTime(const System::TDateTime AStart, const System::Types::TRect &ABounds);
...
public:
	...
	virtual void __fastcall DrawEventAsProgressText(TcxSchedulerEventCellViewInfo* AViewInfo, const System::Types::TRect &AContent, const System::Types::TRect &AProgressRect, const System::UnicodeString AText);
...
private:
	...
	void __fastcall AddContentNavigationIntervalItem(const System::Variant &AResourceIndex);
	void __fastcall ClearContentNavigationIntervals(void);
	Cxschedulerstorage::TcxSchedulerEventList* __fastcall GetClones(void);
	int __fastcall GetCorrectColumnHeight(const System::Types::TRect &AColumnRect);
...
protected:
	...
	virtual TcxSchedulerMoreEventsButtonViewInfo* __fastcall AddButton(const System::Types::TRect &ABounds, const System::TDateTime ADateTime, bool AIsDown, Cxschedulerstorage::TcxSchedulerEvent* AEvent);
	...
	void __fastcall CalculateNavigationButtonParams(const System::Types::TRect &AColumnRect, TcxSchedulerContentNavigationButtonKind AKind, /* out */ int &AButtonWidth);
...
protected:
	...
	void __fastcall InternalShowHint(const System::Types::TPoint &P, const System::UnicodeString AHintText);
