...
// (DO NOT EDIT: machine generated header) 'dxRibbonStatusBar.pas' rev: 24.00 (Win32)
...
protected:
	...
	virtual void __fastcall DrawContent(Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &R, Dxstatusbar::TdxStatusBarPainterClass APainter);
