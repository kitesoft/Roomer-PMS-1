...
// (DO NOT EDIT: machine generated header) 'cxSSTypes.pas' rev: 24.00 (Win32)
...
typedef System::StaticArray<PcxSSCellRec, 89478485> TcxSSCellsArray;
...
typedef System::StaticArray<TcxSSColumn, 268435455> TcxSSColumns;
