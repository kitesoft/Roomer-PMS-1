...
// (DO NOT EDIT: machine generated header) 'cxProgressBar.pas' rev: 24.00 (Win32)
...
private:
	...
	void __fastcall PaintBarBevelOuter(Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &ABBORect);
	void __fastcall DrawBarBitmap(Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &ARect);
