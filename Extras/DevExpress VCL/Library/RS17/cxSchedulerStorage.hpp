...
// (DO NOT EDIT: machine generated header) 'cxSchedulerStorage.pas' rev: 24.00 (Win32)
...
public:
	...
	void __fastcall ShareWithResource(const System::Variant &AResourceID)/* overload */;
	bool __fastcall IsSharedWithResource(TcxSchedulerStorageResourceItem* AResourceItem)/* overload */;
	bool __fastcall IsSharedWithResource(const System::Variant &AResourceID)/* overload */;
	void __fastcall UnshareWithResource(TcxSchedulerStorageResourceItem* AResourceItem)/* overload */;
	void __fastcall UnshareWithResource(const System::Variant &AResourceID)/* overload */;
	void __fastcall ReplaceResourceID(const System::Variant &AResourceID);
...
protected:
	...
	void __fastcall Init(TcxCustomSchedulerStorage* AStorage, bool AExceptEventsWithoutResources, const System::Variant &AResourceID, const System::TDateTime AStart, const System::TDateTime AFinish);
...
public:
	...
	__fastcall virtual TcxSchedulerEventConflictsInfo(TcxCustomSchedulerStorage* AStorage, bool AExceptEventsWithoutResources, const System::TDateTime AStart, const System::TDateTime AFinish, const System::Variant &AResourceID, TcxSchedulerEvent* AExcludedEvent)/* overload */;
...
protected:
	...
	virtual void __fastcall CreateHolidayEvent(const System::UnicodeString ACaption, const System::TDateTime ADate, const System::Variant &AResourceID);
...
public:
	...
	bool __fastcall FindAvailableAllDay(System::TDateTime &AStart, System::TDateTime &AFinish, const System::Variant &AResourceID, bool AExceptEventsWithoutResources, System::TDateTime ADuration = 0.000000E+00);
	bool __fastcall FindAvailableTime(System::TDateTime &AStart, System::TDateTime &AFinish, bool AllDay, const System::Variant &AResourceID, bool AExceptEventsWithoutResources, System::TDateTime ADuration = 0.000000E+00, TcxSchedulerEvent* AExcludedEvent = (TcxSchedulerEvent*)(0x0))/* overload */;
...
public:
	...
	__fastcall TcxSchedulerContentNavigationInfo(const System::Variant &AResourceID);
public:
