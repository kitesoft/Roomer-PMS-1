...
// (DO NOT EDIT: machine generated header) 'dxPSPDFExportCore.pas' rev: 24.00 (Win32)
...
public:
	...
	void __fastcall BeginPaint(HRGN AClipRegion = (HRGN)(0x0))/* overload */;
	...
	void __fastcall DrawText(const System::Types::TRect &ARect, const System::WideString AText, Cxgraphics::TcxRotationAngle ADirection = (Cxgraphics::TcxRotationAngle)(0x0), double ACharsSpacing = 0.000000E+00, double AWordSpacing = 0.000000E+00);
