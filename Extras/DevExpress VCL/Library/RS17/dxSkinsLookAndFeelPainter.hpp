...
// (DO NOT EDIT: machine generated header) 'dxSkinsLookAndFeelPainter.pas' rev: 24.00 (Win32)
...
public:
	...
	virtual void __fastcall DrawButton(Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &R, const System::UnicodeString ACaption, Cxlookandfeelpainters::TcxButtonState AState, bool ADrawBorder = true, System::Uitypes::TColor AColor = (System::Uitypes::TColor)(0x20000000), System::Uitypes::TColor ATextColor = (System::Uitypes::TColor)(0x20000000), bool AWordWrap = false, bool AIsToolButton = false);
	...
	virtual void __fastcall DrawScrollBarPart(Cxgraphics::TcxCanvas* ACanvas, bool AHorizontal, const System::Types::TRect &R, Cxlookandfeelpainters::TcxScrollBarPart APart, Cxlookandfeelpainters::TcxButtonState AState);
	...
	virtual void __fastcall DrawSmallButton(Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &R, Cxlookandfeelpainters::TcxButtonState AState);
	virtual void __fastcall DrawSmallCloseButton(Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &R, Cxlookandfeelpainters::TcxButtonState AState);
	...
	virtual void __fastcall DrawCheckButton(Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &R, Cxlookandfeelpainters::TcxButtonState AState, Cxlookandfeelpainters::TcxCheckBoxState ACheckState)/* overload */;
	...
	virtual void __fastcall DrawNavigatorButton(Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &R, Cxlookandfeelpainters::TcxButtonState AState, System::Uitypes::TColor ABackgroundColor);
	...
	virtual void __fastcall DrawFilterCloseButton(Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &R, Cxlookandfeelpainters::TcxButtonState AState);
	virtual void __fastcall DrawFilterDropDownButton(Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &R, Cxlookandfeelpainters::TcxButtonState AState, bool AIsFilterActive);
	...
	virtual void __fastcall DrawFilterSmartTag(Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &R, Cxlookandfeelpainters::TcxFilterSmartTagState AState, bool AIsFilterActive);
	...
	virtual void __fastcall DrawSchedulerNavigatorButton(Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &R, Cxlookandfeelpainters::TcxButtonState AState);
	...
	virtual void __fastcall DrawGalleryItemSelection(Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &R, const Cxlookandfeelpainters::TdxGalleryItemViewState &AViewState);
...
public:
	inline void __fastcall  DrawCheckButton(Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &R, Cxlookandfeelpainters::TcxButtonState AState, bool AChecked){ Cxlookandfeelpainters::TcxCustomLookAndFeelPainter::DrawCheckButton(ACanvas, R, AState, AChecked); }
