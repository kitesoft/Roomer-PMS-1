...
// (DO NOT EDIT: machine generated header) 'dxSkinChooserGallery.pas' rev: 24.00 (Win32)
...
public:
	...
	__property NativeUInt SkinResInstance = {read=FSkinResInstance, write=FSkinResInstance, nodefault};
