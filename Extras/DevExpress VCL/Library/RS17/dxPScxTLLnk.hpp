...
// (DO NOT EDIT: machine generated header) 'dxPScxTLLnk.pas' rev: 24.00 (Win32)
...
private:
	...
	void __fastcall CustomDrawFooter(Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &R, Cxtl::TcxTreeListFooterCellViewInfo* AViewInfo);
	void __fastcall CustomDrawHeader(Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &R, Cxtl::TcxTreeListHeaderCellViewInfo* AViewInfo);
	void __fastcall CustomDrawTextRect(Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &R, const System::UnicodeString AText, System::Classes::TAlignment AnAlignmentHorz, Cxclasses::TcxAlignmentVert AnAlignmentVert, const Cxgraphics::TcxViewParams &AParams);
