...
// (DO NOT EDIT: machine generated header) 'dxLayoutDragAndDrop.pas' rev: 24.00 (Win32)
...
public:
	...
	System::Types::TRect __fastcall GetInsertionZoneBounds(const System::Types::TRect &ABounds, const System::Types::TRect &AContentBounds, TdxLayoutItemInsertionKind AInsertionKind)/* overload */;
