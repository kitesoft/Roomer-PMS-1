...
// (DO NOT EDIT: machine generated header) 'dxSkinLilian.pas' rev: 24.00 (Win32)
...
public:
	...
	/* TdxSkinLookAndFeelPainter.Destroy */ inline __fastcall virtual ~TdxSkinLilianPainter(void) { }
