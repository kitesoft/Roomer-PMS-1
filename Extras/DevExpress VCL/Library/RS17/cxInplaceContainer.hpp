...
// (DO NOT EDIT: machine generated header) 'cxInplaceContainer.pas' rev: 24.00 (Win32)
...
protected:
	...
	__property HRGN WindowRegion = {read=FWindowRegion, write=SetWindowRegion, nodefault};
	
public:
	__fastcall virtual TcxPlaceArrows(System::Uitypes::TColor AColor, System::Uitypes::TColor ABorderColor);
	HIDESBASE bool __fastcall MoveTo(const System::Types::TRect &ARect, Cxgraphics::TcxBorder ASide);
public:
