...
// (DO NOT EDIT: machine generated header) 'cxShellControls.pas' rev: 24.00 (Win32)
...
protected:
	...
	HIDESBASE void __fastcall GetDropTarget(const System::Types::TPoint &pt, /* out */ bool &New);
	...
	HRESULT __stdcall IDropTargetDragOver(int grfKeyState, const System::Types::TPoint pt, int &dwEffect);
...
protected:
	...
	HIDESBASE void __fastcall GetDropTarget(/* out */ bool &ANew, const System::Types::TPoint &APoint);
...
//-- var, const, procedure ---------------------------------------------------
extern PACKAGE void __fastcall cxShellGetNotifyParams(const Winapi::Messages::TMessage &Message, /* out */ int &AEventID, /* out */ Winapi::Shlobj::PItemIDList &APidl1, /* out */ Winapi::Shlobj::PItemIDList &APidl2);
