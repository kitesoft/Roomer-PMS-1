...
// (DO NOT EDIT: machine generated header) 'dxBarCustomCustomizationForm.pas' rev: 24.00 (Win32)
...
protected:
	...
	__classmethod virtual void __fastcall DrawEditContent(Vcl::Graphics::TCanvas* ACanvas, const System::Types::TRect &AItemRect, Dxbar::TdxCustomBarEdit* AItem, bool ASelected, bool ADrawArrowButton);
	...
	__classmethod virtual void __fastcall InternalDrawEditContent(Vcl::Graphics::TCanvas* ACanvas, const System::Types::TRect &AItemRect, Dxbar::TdxCustomBarEdit* AItem, bool ASelected);
	...
	__classmethod virtual void __fastcall DrawButtonOrSubItemArrowBackground(Vcl::Graphics::TCanvas* ACanvas, const System::Types::TRect &R, Dxbar::TdxBarItem* AItem, bool Selected);
	...
	__classmethod virtual void __fastcall DrawButtonOrSubItemGlyph(Vcl::Graphics::TCanvas* ACanvas, const System::Types::TRect &R, Dxbar::TdxBarItem* AItem, bool ASelected);
	__classmethod void __fastcall DrawButtonOrSubItemText(Vcl::Graphics::TCanvas* ACanvas, const System::Types::TRect &R, Dxbar::TdxBarItem* AItem, const System::UnicodeString ACaption, bool Selected);
	__classmethod virtual void __fastcall DrawSubItemArrow(Vcl::Graphics::TCanvas* ACanvas, int X, int Y, bool ASelected);
	
public:
	__classmethod virtual void __fastcall DrawButtonOrSubItem(Vcl::Graphics::TCanvas* ACanvas, const System::Types::TRect &ARect, Dxbar::TdxBarItem* AItem, System::UnicodeString ACaption, bool Selected);
	__classmethod virtual void __fastcall DrawCheckBox(Vcl::Graphics::TCanvas* ACanvas, const System::Types::TRect &R, bool AChecked, bool AEnabled);
	__classmethod virtual void __fastcall DrawComboBoxButton(Vcl::Graphics::TCanvas* ACanvas, Dxbar::TdxBarItem* AItem, const System::Types::TRect &ARect, bool ASelected);
	__classmethod virtual void __fastcall DrawEdit(Vcl::Graphics::TCanvas* ACanvas, const System::Types::TRect &ARect, Dxbar::TdxCustomBarEdit* AItem, bool Selected, bool ADrawArrowButton);
	__classmethod virtual void __fastcall DrawFocusedRect(Vcl::Graphics::TCanvas* ACanvas, const System::Types::TRect &ARect, Dxbar::TdxBarItem* AItem);
