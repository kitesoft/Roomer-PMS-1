...
// (DO NOT EDIT: machine generated header) 'cxSSData.pas' rev: 24.00 (Win32)
...
public:
	...
	virtual void __fastcall ClearCells(const System::Types::TRect &ARect, bool SetDefaultStyle = false);
	...
	virtual void __fastcall DeleteCells(const System::Types::TRect &ACells, Cxsstypes::TcxSSCellsModify ACellsModify);
	bool __fastcall HasCell(int ACol, int ARow);
	virtual void __fastcall InsertCells(const System::Types::TRect &ACells, Cxsstypes::TcxSSCellsModify ACellsModify);
...
protected:
	...
	void __fastcall CheckAfterClear(const System::Types::TRect &ARect);
	...
	void __fastcall UpdateOnInsertCells(const System::Types::TRect &ARect, Cxsstypes::TcxSSCellsModify AShift);
	void __fastcall UpdateOnDeleteCells(const System::Types::TRect &ARect, Cxsstypes::TcxSSCellsModify AShift);
