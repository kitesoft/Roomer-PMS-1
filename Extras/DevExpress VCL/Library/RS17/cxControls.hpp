...
// (DO NOT EDIT: machine generated header) 'cxControls.pas' rev: 24.00 (Win32)
...
extern PACKAGE HWND __fastcall cxWindowFromPoint(const System::Types::TPoint &P);
extern PACKAGE void __fastcall dxSetZOrder(NativeUInt AHandle, NativeUInt AWndAfter = (NativeUInt)(0xffffffff), bool AActivate = false, unsigned AFlags = (unsigned)(0x0));
