...
// (DO NOT EDIT: machine generated header) 'cxGridPopupMenu.pas' rev: 24.00 (Win32)
...
private:
	...
	bool __fastcall TryPopupAsIcxPopupMenuIntf(System::Classes::TComponent* APopupMenu, Cxgridcustomview::TcxCustomGridHitTest* AHitTest, const System::Types::TPoint &APoint);
	bool __fastcall TryPopupAsIDoPopupIntf(System::Classes::TComponent* APopupMenu, Cxgridcustomview::TcxCustomGridHitTest* AHitTest, const System::Types::TPoint &APoint);
	bool __fastcall TryPopupAsVCLPopupMenu(System::Classes::TComponent* APopupMenu, Cxgridcustomview::TcxCustomGridHitTest* AHitTest, const System::Types::TPoint &APoint);
