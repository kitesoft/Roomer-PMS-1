...
// (DO NOT EDIT: machine generated header) 'dxPSBaseGridLnk.pas' rev: 24.00 (Win32)
...
extern PACKAGE void __fastcall dxPSDrawGridPreview(Vcl::Graphics::TCanvas* ACanvas, const System::Types::TRect &R, TAbstractdxGridReportLink* AReportLink, bool AShowFixedColumn = true, bool AShowFixedRow = true);
}	/* namespace Dxpsbasegridlnk */
