...
// (DO NOT EDIT: machine generated header) 'dxdborgc.pas' rev: 24.00 (Win32)
...
private:
	...
	bool __fastcall FindNearest(const System::Variant &AKey, int &AIndex);
	TdxDbOcNode* __fastcall GetNodeByKey(const System::Variant &AKey);
	void __fastcall AddToKeyList(TdxDbOcNode* ANode);
	void __fastcall DelFromKeyList(TdxDbOcNode* ANode);
	int __fastcall FindIndex(const System::Variant &AKey, TdxDbOcNode* AParent);
	...
	TdxDbOcNode* __fastcall CreateDBNode(const System::Variant &AKey, TdxDbOcNode* AParent);
