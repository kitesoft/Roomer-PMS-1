...
// (DO NOT EDIT: machine generated header) 'dxSkinBlack.pas' rev: 24.00 (Win32)
...
public:
	...
	/* TdxSkinLookAndFeelPainter.Destroy */ inline __fastcall virtual ~TdxSkinBlackPainter(void) { }
