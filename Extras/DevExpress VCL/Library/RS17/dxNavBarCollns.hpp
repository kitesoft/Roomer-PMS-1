...
// (DO NOT EDIT: machine generated header) 'dxNavBarCollns.pas' rev: 24.00 (Win32)
...
public:
	...
	__property NativeInt Data = {read=FData, write=FData, nodefault};
...
public:
	...
	virtual void __fastcall AdjustControl(const System::Types::TRect &ARect, bool AVisible);
