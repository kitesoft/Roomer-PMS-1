...
// (DO NOT EDIT: machine generated header) 'cxLookAndFeelPainters.pas' rev: 24.00 (Win32)
...
public:
	...
	void __fastcall CalculateArrowPoints(const System::Types::TRect &R, System::Types::TPoint *P, TcxArrowDirection AArrowDirection, bool AProportional, int AArrowSize = 0x0);
	...
	virtual void __fastcall DrawScrollBarArrow(Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &R, TcxButtonState AState, TcxArrowDirection AArrowDirection);
	...
	virtual void __fastcall DoDrawSeparator(Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &R, bool AIsVertical);
	...
	virtual System::Types::TRect __fastcall ButtonFocusRect(Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &R);
	...
	virtual void __fastcall DrawCommandLinkBackground(Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &R, TcxButtonState AState, System::Uitypes::TColor AColor = (System::Uitypes::TColor)(0x20000000));
	...
	virtual void __fastcall DrawButtonBorder(Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &R, TcxButtonState AState);
	...
	virtual void __fastcall DrawSmallExpandButton(Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &R, bool AExpanded, System::Uitypes::TColor ABorderColor, System::Uitypes::TColor AColor = (System::Uitypes::TColor)(0x20000000));
	...
	virtual void __fastcall DrawFilterActivateButton(Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &R, TcxButtonState AState, bool AChecked);
	virtual void __fastcall DrawFilterCloseButton(Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &R, TcxButtonState AState);
	virtual void __fastcall DrawFilterDropDownButton(Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &R, TcxButtonState AState, bool AIsFilterActive);
	...
	virtual void __fastcall DrawFilterSmartTag(Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &R, TcxFilterSmartTagState AState, bool AIsFilterActive);
	...
	virtual void __fastcall DrawTab(Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &R, Cxgraphics::TcxBorders ABorders, const System::UnicodeString AText, TcxButtonState AState, bool AVertical, Vcl::Graphics::TFont* AFont, System::Uitypes::TColor ATextColor, System::Uitypes::TColor ABkColor, bool AShowPrefix = false);
	virtual void __fastcall DrawTabBorder(Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &R, Cxgraphics::TcxBorder ABorder, Cxgraphics::TcxBorders ABorders, bool AVertical);
	...
	virtual void __fastcall DrawScrollBarPart(Cxgraphics::TcxCanvas* ACanvas, bool AHorizontal, const System::Types::TRect &R, TcxScrollBarPart APart, TcxButtonState AState);
	...
	virtual void __fastcall DrawSmallButton(Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &R, TcxButtonState AState);
	virtual void __fastcall DrawSmallCloseButton(Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &R, TcxButtonState AState);
	virtual void __fastcall CalculateSchedulerNavigationButtonRects(bool AIsNextButton, bool ACollapsed, const System::Types::TSize &APrevButtonTextSize, const System::Types::TSize &ANextButtonTextSize, System::Types::TRect &ABounds, /* out */ System::Types::TRect &ATextRect, /* out */ System::Types::TRect &AArrowRect);
	...
	virtual void __fastcall DrawSchedulerEventProgress(Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &ABounds, const System::Types::TRect &AProgress, const Cxgraphics::TcxViewParams &AViewParams, bool ATransparent);
	...
	virtual void __fastcall DrawSchedulerNavigatorButton(Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &R, TcxButtonState AState);
	...
	virtual void __fastcall DrawNavigatorBorder(Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &R, bool ASelected);
	virtual void __fastcall DrawNavigatorButton(Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &R, TcxButtonState AState, System::Uitypes::TColor ABackgroundColor);
	...
	virtual void __fastcall DrawProgressBarBorder(Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &ARect, bool AVertical);
	virtual void __fastcall DrawProgressBarChunk(Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &ARect, bool AVertical);
	...
	virtual void __fastcall DrawGroupBoxContent(Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &ABorderRect, TcxGroupBoxCaptionPosition ACaptionPosition, Cxgraphics::TcxBorders ABorders = (Cxgraphics::TcxBorders() << Cxgraphics::TcxBorder::bLeft << Cxgraphics::TcxBorder::bTop << Cxgraphics::TcxBorder::bRight << Cxgraphics::TcxBorder::bBottom ));
	...
	virtual void __fastcall DrawCheckBorder(Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &R, TcxButtonState AState);
	virtual void __fastcall DrawCheckButton(Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &R, TcxButtonState AState, bool AChecked)/* overload */;
	virtual void __fastcall DrawCheckButton(Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &R, TcxButtonState AState, TcxCheckBoxState ACheckState)/* overload */;
	...
	virtual void __fastcall DrawGalleryItemSelection(Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &R, const TdxGalleryItemViewState &AViewState);
	...
	virtual void __fastcall DrawColorGalleryItemSelection(Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &R, const TdxGalleryItemViewState &AViewState);
...
protected:
	...
	virtual void __fastcall DrawSchedulerNavigationButtonContent(Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &ARect, const System::Types::TRect &AArrowRect, bool AIsNextButton, TcxButtonState AState);
	void __fastcall DrawThemedTab(Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &R, Cxgraphics::TcxBorders ABorders, const System::UnicodeString AText, NativeUInt ATheme, int AState, bool AVertical, Vcl::Graphics::TFont* AFont, System::Uitypes::TColor ATextColor, System::Uitypes::TColor ABkColor, bool AShowPrefix = false);
...
public:
	...
	virtual System::Uitypes::TColor __fastcall DefaultSchedulerViewContentColor(void);
	virtual void __fastcall DrawMonthHeader(Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &ABounds, const System::UnicodeString AText, TcxNeighbors ANeighbors, const Cxgraphics::TcxViewParams &AViewParams, TcxArrowDirections AArrows, int ASideWidth, TcxDrawBackgroundEvent AOnDrawBackground = 0x0);
	virtual void __fastcall DrawSchedulerEventProgress(Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &ABounds, const System::Types::TRect &AProgressChunk, const Cxgraphics::TcxViewParams &AViewParams, bool ATransparent);
	virtual void __fastcall DrawSchedulerNavigatorButton(Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &R, TcxButtonState AState);
	virtual void __fastcall DrawSchedulerSplitterBorder(Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &R, const Cxgraphics::TcxViewParams &AViewParams, bool AIsHorizontal);
	virtual System::Types::TRect __fastcall SchedulerEventProgressOffsets(void);
	virtual System::Types::TSize __fastcall SizeGripSize(void);
