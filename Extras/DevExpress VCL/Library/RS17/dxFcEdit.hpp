...
// (DO NOT EDIT: machine generated header) 'dxFcEdit.pas' rev: 24.00 (Win32)
...
private:
	...
	void __fastcall DrawDrag(const System::Types::TPoint &P1, const System::Types::TPoint &P2, int Mode);
	void __fastcall InitializeMenuImageIndexes(void);
	void __fastcall MultiSelect(bool ResetOldSelected, const System::Types::TRect &SelectRect);
