...
// (DO NOT EDIT: machine generated header) 'dxPrnDev.pas' rev: 24.00 (Win32)
...
public:
	...
	__property NativeUInt HDeviceMode = {read=GetHDeviceMode, nodefault};
...
extern PACKAGE void __fastcall dxDrawPrinter(Vcl::Graphics::TCanvas* ACanvas, const System::Types::TRect &ARect, const System::UnicodeString AText, Vcl::Imglist::TCustomImageList* AImageList, int AImageIndex, bool ADrawBackground = true);
