...
// (DO NOT EDIT: machine generated header) 'cxHtmlXmlTxtExport.pas' rev: 24.00 (Win32)
...
private:
	...
	HIDESBASE System::UnicodeString __fastcall GetStyle(const Cxexport::TcxCacheCellStyle &AStyle);
...
private:
	...
	System::UnicodeString __fastcall GetBorderStyle(const Cxexport::TcxCacheCellStyle &AStyle);
