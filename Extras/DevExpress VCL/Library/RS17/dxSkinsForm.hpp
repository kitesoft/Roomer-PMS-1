...
// (DO NOT EDIT: machine generated header) 'dxSkinsForm.pas' rev: 24.00 (Win32)
...
protected:
	...
	virtual void __fastcall DrawWindowBorder(HDC DC = (HDC)(0x0));
	virtual void __fastcall DrawWindowScrollArea(HDC DC = (HDC)(0x0));
...
public:
	...
	int __fastcall GetHitTest(const System::Types::TPoint &AHitPoint, int AHitTest = 0x0);
	...
	__property HICON SysMenuIcon = {read=FSysMenuIcon, nodefault};
	__property System::Types::TRect SystemBorderWidths = {read=GetSystemBorderWidths};
	__property HMENU SystemMenu = {read=FSystemMenu, nodefault};
	...
	__property HRGN UpdateRgn = {read=FUpdateRgn, write=SetUpdateRgn, nodefault};
...
protected:
	...
	virtual void __fastcall DrawCaptionText(HDC DC, const System::Types::TRect &R, const System::UnicodeString AText);
	...
	virtual void __fastcall DrawWindowCaptionText(HDC DC, const System::Types::TRect &R);
...
public:
	...
	void __fastcall BeginPaint(HDC ADestDC = (HDC)(0x0));
...
public:
	...
	virtual void __fastcall Draw(HDC DC = (HDC)(0x0));
