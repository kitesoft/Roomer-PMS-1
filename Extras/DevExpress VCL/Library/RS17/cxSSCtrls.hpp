...
// (DO NOT EDIT: machine generated header) 'cxSSCtrls.pas' rev: 24.00 (Win32)
...
protected:
	...
	void __fastcall OnDrawStyleItem(Vcl::Controls::TWinControl* Control, int Index, const System::Types::TRect &Rect, Winapi::Windows::TOwnerDrawState State);
