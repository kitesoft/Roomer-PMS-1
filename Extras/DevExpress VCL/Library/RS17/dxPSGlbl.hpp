...
// (DO NOT EDIT: machine generated header) 'dxPSGlbl.pas' rev: 24.00 (Win32)
...
extern PACKAGE int __fastcall ComparePSVersions(const TdxPSVersion &V1, const TdxPSVersion &V2);
}	/* namespace Dxpsglbl */
