...
// (DO NOT EDIT: machine generated header) 'dxPSPrVw.pas' rev: 24.00 (Win32)
...
protected:
	...
	void __fastcall SavePreferences(const Dxpsprvwopt::TdxPreviewOptionsDlgData &AData);
...
public:
	...
	virtual bool __fastcall PanelFromPoint(const System::Types::TPoint &APoint, TdxPSStatusBarPanel* &APanel);
