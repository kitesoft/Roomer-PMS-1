...
// (DO NOT EDIT: machine generated header) 'cxCheckBox.pas' rev: 24.00 (Win32)
...
extern PACKAGE void __fastcall DrawCheckBoxText(Cxgraphics::TcxCanvas* ACanvas, System::UnicodeString AText, Vcl::Graphics::TFont* AFont, System::Uitypes::TColor ATextColor, const System::Types::TRect &ATextRect, int ADrawTextFlags, bool AEnabled);
