...
// (DO NOT EDIT: machine generated header) 'dxRibbonBackstageView.pas' rev: 24.00 (Win32)
...
public:
	...
	virtual void __fastcall DrawTabButton(Dxbar::TdxBarButtonLikeControlDrawParams* const ADrawParams, const System::Types::TRect &R);
	virtual void __fastcall DrawTabButtonBackground(HDC DC, const System::Types::TRect &R, int AState);
...
protected:
	...
	virtual void __fastcall NCPaint(HDC DC);
	void __fastcall MakeFullyVisible(const System::Types::TRect &R);
