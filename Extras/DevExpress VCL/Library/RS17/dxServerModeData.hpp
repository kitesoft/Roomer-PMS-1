...
// (DO NOT EDIT: machine generated header) 'dxServerModeData.pas' rev: 24.00 (Win32)
...
protected:
	...
	TdxServerModeCriteria* __fastcall GetFetchRowByKeyCondition(const System::Variant &AKey);
...
protected:
	...
	int __fastcall GetRowIndexByKey(const System::Variant &AKey);
