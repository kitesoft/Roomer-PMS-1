...
// (DO NOT EDIT: machine generated header) 'dxNavBar.pas' rev: 24.00 (Win32)
...
protected:
	...
	void __fastcall DrawSolidFocusRect(const System::Types::TRect &ARect, System::Uitypes::TColor AColor);
...
public:
	...
	virtual void __fastcall DrawGroupControl(Vcl::Graphics::TCanvas* ACanvas, const System::Types::TRect &ARect, TdxNavBarGroupViewInfo* AGroupViewInfo);
...
private:
	...
	void __fastcall SetHotPart(const TdxNavBarPart &APart);
	void __fastcall SetPressedPart(const TdxNavBarPart &APart);
