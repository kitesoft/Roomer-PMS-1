...
// (DO NOT EDIT: machine generated header) 'dxPSUtl.pas' rev: 24.00 (Win32)
...
extern PACKAGE void __fastcall DrawSizeGrip(HDC DC, const System::Types::TRect &R);
...
extern PACKAGE void __fastcall dxDrawThemeEdge(HDC ADC, const Vcl::Themes::TThemedElementDetails &ADetails, const System::Types::TRect &R, unsigned AEdge, unsigned AFlags, System::Types::PRect AContentRect = (System::Types::PRect)(0x0));
...
extern PACKAGE void __fastcall dxLoadImageListFromResources(Cxgraphics::TcxImageList* AImageList, const System::UnicodeString AResourceName, NativeUInt AInstance = (NativeUInt)(0x0));
