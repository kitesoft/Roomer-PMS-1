...
// (DO NOT EDIT: machine generated header) 'dxPSLVLnk.pas' rev: 24.00 (Win32)
...
protected:
	...
	void __fastcall AddExtraImage(Dxpscore::TdxReportCell* AParent, int ACol, int ARow, const System::Types::TRect &R);
	...
	virtual Dxpscore::TAbstractdxReportCellData* __fastcall PlaceInternalItem(Dxpscore::TdxReportCell* AParent, int ACol, int ARow, const System::Types::TRect &R);
	...
	__property NativeUInt ListViewHandle = {read=GetListViewHandle, write=SetListViewHandle, nodefault};
...
protected:
	...
	DYNAMIC void __fastcall DoCustomDrawHeader(Vcl::Graphics::TCanvas* ACanvas, const System::Types::TRect &ARect, int AHeaderIndex, Dxpscore::TdxReportCellImage* AnItem, bool &ADone);
	DYNAMIC void __fastcall DoCustomDrawItem(Vcl::Graphics::TCanvas* ACanvas, const System::Types::TRect &ARect, Vcl::Comctrls::TListItem* AListItem, int ASubItem, Dxpscore::TdxReportCellImage* AnItem, bool &ADone);
