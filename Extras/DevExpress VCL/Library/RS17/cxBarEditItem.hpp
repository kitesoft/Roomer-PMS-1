...
// (DO NOT EDIT: machine generated header) 'cxBarEditItem.pas' rev: 24.00 (Win32)
...
private:
	...
	void __fastcall DrawEditBackground(Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &ARect, System::Uitypes::TColor AColor);
	...
	void __fastcall InternalDrawComboBoxDropDownButton(Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &R);
...
protected:
	...
	void __fastcall CalculateEditViewInfo(const System::Types::TRect &ABounds, const System::Types::TPoint &P, bool AIsMouseEvent, Cxedit::TcxCustomEditViewInfo* AEditViewInfo = (Cxedit::TcxCustomEditViewInfo*)(0x0), bool AFull = true);
