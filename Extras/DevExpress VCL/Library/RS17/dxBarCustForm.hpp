...
// (DO NOT EDIT: machine generated header) 'dxBarCustForm.pas' rev: 24.00 (Win32)
...
__published:
	...
	void __fastcall LAllCommandsDrawItem(Vcl::Controls::TWinControl* Control, int Index, const System::Types::TRect &Rect, Winapi::Windows::TOwnerDrawState State);
	...
	void __fastcall lbGroupsDrawItem(Vcl::Controls::TWinControl* Control, int Index, const System::Types::TRect &Rect, Winapi::Windows::TOwnerDrawState State);
