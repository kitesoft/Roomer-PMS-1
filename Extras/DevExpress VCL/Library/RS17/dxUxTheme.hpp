...
// (DO NOT EDIT: machine generated header) 'dxUxTheme.pas' rev: 24.00 (Win32)
...
extern PACKAGE HRESULT __fastcall HitTestThemeBackground(NativeUInt hTheme, HDC DC, int iPartId, int iStateId, unsigned dwOptions, System::Types::PRect pRect, HRGN hRgn, const System::Types::TPoint &ptTest, /* out */ System::Word &wHitTestCode);
...
extern PACKAGE bool __fastcall dxUpdatePanningFeedback(NativeUInt AWindow, const System::Types::TPoint &AOverpan, bool AIsInertia);
