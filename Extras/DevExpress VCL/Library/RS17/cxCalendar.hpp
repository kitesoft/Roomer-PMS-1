...
// (DO NOT EDIT: machine generated header) 'cxCalendar.pas' rev: 24.00 (Win32)
...
private:
	...
	bool __fastcall IsMouseInMonthOrYearRegion(const System::Types::TPoint &AMousePos);
...
protected:
	...
	virtual double __fastcall PosToDateTime(const System::Types::TPoint &P);
