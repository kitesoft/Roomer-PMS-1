...
// (DO NOT EDIT: machine generated header) 'dxSkinsdxBarPainter.pas' rev: 24.00 (Win32)
...
private:
	...
	void __fastcall DrawFloatingBarCaptionButton(HDC DC, const System::Types::TRect &ARect, int AContentType, Dxbar::TdxBarMarkState AState);
	void __fastcall InternalDrawDockedBarBackground(Dxbar::TdxBarControl* ABarControl, Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &R, bool AClientArea);
...
protected:
	...
	virtual void __fastcall DrawGlyphEmptyImage(Dxbar::TdxBarItemControl* ABarItemControl, HDC DC, const System::Types::TRect &R, Dxbar::TdxBarPaintType APaintType, bool ADown);
	virtual void __fastcall DrawGlyphBorder(Dxbar::TdxBarItemControl* ABarItemControl, HDC DC, HBRUSH ABrush, bool NeedBorder, const System::Types::TRect &R, Dxbar::TdxBarPaintType PaintType, bool IsGlyphEmpty, bool Selected, bool Down, bool DrawDowned, bool ADroppedDown, bool IsSplit);
	...
	virtual void __fastcall BarDrawGrip(Dxbar::TdxBarControl* ABarControl, HDC DC, const System::Types::TRect &R, HBRUSH AToolbarBrush);
...
public:
	...
	virtual void __fastcall DrawItemBackgroundInSubMenu(Dxbar::TdxBarButtonLikeControlDrawParams* const ADrawParams, const System::Types::TRect &R);
	...
	virtual void __fastcall BarCaptionFillBackground(Dxbar::TdxBarControl* ABarControl, HDC DC, const System::Types::TRect &R, HBRUSH AToolbarBrush);
	virtual void __fastcall BarDrawBeginGroup(Dxbar::TCustomdxBarControl* ABarControl, HDC DC, const System::Types::TRect &ABeginGroupRect, HBRUSH AToolbarBrush, bool AHorz);
	virtual void __fastcall BarDrawCloseButton(Dxbar::TdxBarControl* ABarControl, HDC DC, const System::Types::TRect &R);
	virtual void __fastcall BarDrawDockedBarBorder(Dxbar::TdxBarControl* ABarControl, HDC DC, const System::Types::TRect &R, HBRUSH AToolbarBrush);
	virtual void __fastcall BarDrawFloatingBarBorder(Dxbar::TdxBarControl* ABarControl, HDC DC, const System::Types::TRect &R, const System::Types::TRect &CR, HBRUSH AToolbarBrush);
	virtual void __fastcall BarDrawFloatingBarCaption(Dxbar::TdxBarControl* ABarControl, HDC DC, const System::Types::TRect &R, const System::Types::TRect &CR, HBRUSH AToolbarBrush);
	virtual void __fastcall BarDrawMDIButton(Dxbar::TdxBarControl* ABarControl, Dxbar::TdxBarMDIButton AButton, int AState, HDC DC, const System::Types::TRect &R);
	virtual void __fastcall BarDrawStatusBarBorder(Dxbar::TdxBarControl* ABarControl, HDC DC, const System::Types::TRect &R, HBRUSH AToolbarBrush);
	...
	virtual void __fastcall StatusBarFillBackground(Dxbar::TdxBarControl* ABarControl, HDC DC, const System::Types::TRect &ADestR, const System::Types::TRect &ASourceR, const System::Types::TRect &AWholeR, HBRUSH ABrush, System::Uitypes::TColor AColor);
	...
	virtual void __fastcall DockControlFillBackground(Dxbar::TdxDockControl* ADockControl, HDC DC, const System::Types::TRect &ADestR, const System::Types::TRect &ASourceR, const System::Types::TRect &AWholeR, HBRUSH ABrush, System::Uitypes::TColor AColor);
	...
	virtual void __fastcall BarDrawDockedBackground(Dxbar::TdxBarControl* ABarControl, HDC DC, const System::Types::TRect &ADestR, const System::Types::TRect &ASourceR, HBRUSH ABrush, System::Uitypes::TColor AColor);
	virtual void __fastcall BarDrawFloatingBackground(Dxbar::TCustomdxBarControl* ABarControl, HDC DC, const System::Types::TRect &ADestR, const System::Types::TRect &ASourceR, HBRUSH ABrush, System::Uitypes::TColor AColor);
	...
	virtual void __fastcall SubMenuControlDrawBorder(Dxbar::TdxBarSubMenuControl* ABarSubMenuControl, HDC DC, const System::Types::TRect &R);
	...
	virtual void __fastcall SubMenuControlDrawBackground(Dxbar::TdxBarSubMenuControl* ABarSubMenuControl, Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &ARect, HBRUSH ABrush, System::Uitypes::TColor AColor);
	virtual void __fastcall SubMenuControlDrawDetachCaption(Dxbar::TdxBarSubMenuControl* ABarSubMenuControl, HDC DC, const System::Types::TRect &R);
	virtual void __fastcall SubMenuControlDrawMarkContent(Dxbar::TdxBarSubMenuControl* ABarSubMenuControl, HDC DC, const System::Types::TRect &R, bool ASelected);
	...
	virtual void __fastcall BarDrawMark(Dxbar::TdxBarControl* ABarControl, HDC DC, const System::Types::TRect &MarkR);
	virtual void __fastcall BarDrawMarkElements(Dxbar::TdxBarControl* ABarControl, HDC DC, const System::Types::TRect &ItemRect);
	...
	virtual void __fastcall ColorComboDrawCustomButton(Dxbar::TdxBarColorComboControlDrawParams* const ADrawParams, const System::Types::TRect &ARect);
	virtual void __fastcall ColorComboDrawCustomButtonAdjacentZone(Dxbar::TdxBarColorComboControlDrawParams* const ADrawParams, const System::Types::TRect &ARect);
	...
	__classmethod virtual void __fastcall CustomComboDrawItem(Dxbar::TdxBarCustomCombo* ABarCustomCombo, Vcl::Graphics::TCanvas* ACanvas, int AIndex, const System::Types::TRect &ARect, Winapi::Windows::TOwnerDrawState AState, bool AInteriorIsDrawing);
	...
	virtual void __fastcall DateNavigatorDrawButton(Dxbar::TdxBarItem* ABarItem, HDC DC, const System::Types::TRect &R, const System::UnicodeString ACaption, bool APressed);
	...
	virtual void __fastcall InPlaceSubItemControlDrawBackground(Dxbar::TdxBarInPlaceSubItemControlDrawParams* const ADrawParams, const System::Types::TRect &ARect);
	...
	virtual void __fastcall SpinEditControlDrawButton(Dxbar::TdxBarSpinEditDrawParams* const ADrawParams, const System::Types::TRect &ARect, int AButtonIndex);
	...
	virtual void __fastcall DrawStaticBackground(Dxbar::TdxBarStaticLikeControlDrawParams* const ADrawParams, const System::Types::TRect &ARect);
