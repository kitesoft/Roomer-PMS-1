...
// (DO NOT EDIT: machine generated header) 'dxmdaset.pas' rev: 24.00 (Win32)
...
private:
	...
	void * __fastcall AllocBufferForFieldValue(const System::Variant &AValue, Data::Db::TField* AField);
...
public:
	...
	virtual int __fastcall GetRecNoByFieldValue(const System::Variant &Value, System::UnicodeString FieldName);
	...
	int __fastcall GetValueCount(System::UnicodeString AFieldName, const System::Variant &AValue);
...
extern PACKAGE bool __fastcall VariantToMemDataValue(const System::Variant &AValue, void * AMemDataValue, Data::Db::TField* AField);
}	/* namespace Dxmdaset */
