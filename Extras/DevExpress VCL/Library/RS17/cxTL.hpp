...
// (DO NOT EDIT: machine generated header) 'cxTL.pas' rev: 24.00 (Win32)
...
private:
	...
	void __fastcall SetFooterSummaryValue(int AIndex, const System::Variant &AValue);
...
protected:
	...
	HIDESBASE bool __fastcall MoveTo(const System::Types::TPoint &APosition);
...
protected:
	void __fastcall CalculateTreeLines(const System::Types::TPoint &ACenter);
	virtual void __fastcall DoCalculate(void);
	virtual void __fastcall DoDraw(Cxgraphics::TcxCanvas* ACanvas);
...
protected:
	...
	TcxTreeListBandCellViewInfo* __fastcall AddBandPart(TcxTreeListBandPart APart, TcxTreeListBand* ABand, TcxTreeListNode* ANode, TcxTreeListNode* AAttachNode, const System::Types::TRect &ABounds, const System::Types::TRect &AClipRect);
	...
	TcxTreeListEditCellViewInfo* __fastcall AddEditCell(TcxTreeListNodeViewData* AViewData, TcxTreeListColumn* AColumn, const System::Types::TRect &ABounds, const System::Types::TRect &AClipRect, Cxinplacecontainer::TcxEditCellViewInfoClass AClass);
	...
	void __fastcall AddFixedSeparators(const System::Types::TRect &ABounds, TcxTreeListNode* AAttachNode);
...
protected:
	...
	virtual void __fastcall DoDrawItem(Cxlistbox::TcxListBox* AControl, Cxgraphics::TcxCanvas* ACanvas, int AIndex, const System::Types::TRect &ARect, Winapi::Windows::TOwnerDrawState AState);
	void __fastcall DoDrawItemEx(Vcl::Controls::TWinControl* Control, int Index, const System::Types::TRect &Rect, Winapi::Windows::TOwnerDrawState State);
...
protected:
	...
	System::Types::TPoint __fastcall GetDragInfoImagePosition(const System::Types::TPoint &APoint);
