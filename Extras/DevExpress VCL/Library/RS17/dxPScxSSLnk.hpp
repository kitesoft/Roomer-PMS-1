...
// (DO NOT EDIT: machine generated header) 'dxPScxSSLnk.pas' rev: 24.00 (Win32)
...
private:
	...
	void __fastcall SetBorder(Dxpscore::TdxCellSide ASide, const TdxPSCellBorder &Value);
...
protected:
	...
	bool __fastcall IsDoubleLineBorderPattern(const TdxPSCellBorder &ABorder)/* overload */;
...
protected:
	void __fastcall ClipItemBounds(Dxpsreportrendercanvas::TdxPSReportRenderCustomCanvas* ACanvas, const System::Types::TRect &AOuterRect);
...
private:
	...
	void __fastcall SetPrintArea(const System::Types::TRect &Value);
...
protected:
	...
	bool __fastcall OnlyLeftEdgeIsAssigned(const Cxsstypes::TcxSSCellRec &ACell);
	bool __fastcall OnlyTopEdgeIsAssigned(const Cxsstypes::TcxSSCellRec &ACell);
