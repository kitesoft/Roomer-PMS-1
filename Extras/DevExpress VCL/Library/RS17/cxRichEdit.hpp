...
// (DO NOT EDIT: machine generated header) 'cxRichEdit.pas' rev: 24.00 (Win32)
...
public:
	__fastcall TcxOleUILinkInfo(TcxRichInnerEdit* AOwner, const TReObject &AReObject);
...
public:
	__fastcall TcxOleUIObjInfo(TcxRichInnerEdit* AOwner, const TReObject &AReObject);
