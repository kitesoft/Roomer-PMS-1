...
// (DO NOT EDIT: machine generated header) 'dxPScxGridLnk.pas' rev: 24.00 (Win32)
...
private:
	...
	void __fastcall CustomDrawFooter(Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &R, Cxgridcustomview::TcxCustomGridCellViewInfo* AViewInfo);
	void __fastcall CustomDrawHeader(Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &R, Cxgridcustomview::TcxCustomGridCellViewInfo* AViewInfo);
	void __fastcall CustomDrawTextRect(Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &R, Cxgridcustomview::TcxCustomGridCellViewInfo* AViewInfo, Vcl::Graphics::TBitmap* ABackgroundBitmap);
