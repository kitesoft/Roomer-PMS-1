...
// (DO NOT EDIT: machine generated header) 'cxSchedulerGanttView.pas' rev: 24.00 (Win32)
...
protected:
	...
	virtual void __fastcall Calculate(const System::Types::TRect &AStartRect, const System::Types::TRect &AFinishRect);
