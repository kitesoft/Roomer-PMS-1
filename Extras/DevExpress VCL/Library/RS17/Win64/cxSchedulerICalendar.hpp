...
// (DO NOT EDIT: machine generated header) 'cxSchedulerICalendar.pas' rev: 24.00 (Win64)
...
protected:
	...
	__classmethod virtual bool __fastcall ToString(TcxSchedulerICalendarCustomProperty* AProperty, System::Variant &AValue, /* out */ System::UnicodeString &ATranslateValue);
public:
...
private:
	System::TDateTime __fastcall InternalSystemTimeToDateTime(_SYSTEMTIME &ADate);
