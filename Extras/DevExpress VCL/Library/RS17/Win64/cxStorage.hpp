...
// (DO NOT EDIT: machine generated header) 'cxStorage.pas' rev: 24.00 (Win64)
...
private:
	...
	void __fastcall SetPropertyValue(const System::UnicodeString AName, System::Variant &AValue);
...
public:
	...
	void __fastcall SetStream(System::Classes::TStream* AStream);
	virtual void __fastcall WriteProperty(const System::UnicodeString AObjectName, const System::UnicodeString AClassName, const System::UnicodeString AName, System::Variant &AValue);
	__property bool ReCreate = {read=FReCreate, write=FReCreate, nodefault};
	__property System::UnicodeString StorageName = {read=FStorageName};
	__property System::Classes::TStream* StorageStream = {read=FStorageStream};
public:
