...
// (DO NOT EDIT: machine generated header) 'cxStyleSheetEditor.pas' rev: 24.00 (Win64)
...
__published:
	...
	void __fastcall lbStylesDrawItem(Vcl::Controls::TWinControl* Control, int Index, System::Types::TRect &Rect, Winapi::Windows::TOwnerDrawState State);
