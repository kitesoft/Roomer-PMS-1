...
// (DO NOT EDIT: machine generated header) 'dxSkinsdxStatusBarPainter.pas' rev: 24.00 (Win64)
...
public:
	...
	__classmethod virtual void __fastcall DrawEmptyPanel(Dxstatusbar::TdxCustomStatusBar* AStatusBar, Cxgraphics::TcxCanvas* ACanvas, System::Types::TRect &R);
