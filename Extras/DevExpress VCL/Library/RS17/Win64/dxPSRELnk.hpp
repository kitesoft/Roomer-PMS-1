...
// (DO NOT EDIT: machine generated header) 'dxPSRELnk.pas' rev: 24.00 (Win64)
...
protected:
	...
	__property NativeUInt REHandle = {read=GetREHandle};
...
public:
	...
	__property NativeUInt REHandle = {read=GetRichEditHandle};
