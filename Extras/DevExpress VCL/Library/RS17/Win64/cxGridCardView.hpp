...
// (DO NOT EDIT: machine generated header) 'cxGridCardView.pas' rev: 24.00 (Win64)
...
public:
	...
	void __fastcall SetCoordinates(TcxGridCardViewRow* ARow, TcxGridCardRowCoordinates ACoordinates)/* overload */;
