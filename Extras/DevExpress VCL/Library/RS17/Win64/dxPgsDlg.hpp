...
// (DO NOT EDIT: machine generated header) 'dxPgsDlg.pas' rev: 24.00 (Win64)
...
__published:
	...
	void __fastcall lbxPaperTypeDrawItem(Cxlistbox::TcxListBox* AControl, Cxgraphics::TcxCanvas* ACanvas, int AIndex, System::Types::TRect &ARect, Winapi::Windows::TOwnerDrawState AState);
...
private:
	...
	void __fastcall DrawBackgroundBitmapContent(Cxgraphics::TcxCanvas* ACanvas, System::Types::TRect &R, Dxbkgnd::TdxBackground* ABackground);
	...
	void __fastcall PreviewDrawPageContent(System::TObject* Sender, Vcl::Graphics::TCanvas* ACanvas, System::Types::TRect &ABounds, int APageIndex);
...
extern PACKAGE void __fastcall dxPSDrawStyleItem(TBasedxPrintStyle* AStyle, Vcl::Stdctrls::TListBox* AListBox, int Index, Winapi::Windows::TOwnerDrawState State, System::Types::TRect &ABounds, bool AMultiline, bool ABoldedCurrent);
extern PACKAGE void __fastcall dxPSDefaultDrawPagePreview(TBasedxPrintStyle* APrintStyle, Vcl::Graphics::TCanvas* ACanvas, System::Types::TRect &APageBounds, System::Types::TRect &AContentBounds, System::Types::TRect &AHeaderBounds, System::Types::TRect &AFooterBounds);
