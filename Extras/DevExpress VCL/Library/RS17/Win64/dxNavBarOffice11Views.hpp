...
// (DO NOT EDIT: machine generated header) 'dxNavBarOffice11Views.pas' rev: 24.00 (Win64)
...
private:
	...
	void __fastcall DoDrawItem(System::TObject* Sender, Vcl::Graphics::TCanvas* ACanvas, System::Types::TRect &ARect, bool Selected);
...
public:
	...
	__property TdxNavBarNavigationPanePainter* Painter = {read=GetPainter};
	__property Dxnavbarbase::_di_IdxNavBarAccessibilityHelper NavPanePartIAccessibilityHelpers[const Dxnavbar::TdxNavBarPart APart] = {read=GetNavPanePartIAccessibilityHelper};
...
private:
	...
	void __fastcall SetDroppedDownPart(Dxnavbar::TdxNavBarPart APart);
