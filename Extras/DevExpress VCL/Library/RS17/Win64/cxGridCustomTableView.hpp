...
// (DO NOT EDIT: machine generated header) 'cxGridCustomTableView.pas' rev: 24.00 (Win64)
...
protected:
	...
	virtual void __fastcall DrawItemContent(Cxgraphics::TcxCanvas* ACanvas, int AIndex, System::Types::TRect &ARect, Winapi::Windows::TOwnerDrawState AState);
...
protected:
	...
	System::Types::TRect __fastcall CellEditBoundsToEditBounds(System::Types::TRect &ACellEditBounds);
...
public:
	...
	virtual void __fastcall DrawDragImage(Cxgraphics::TcxCanvas* ACanvas, System::Types::TRect &R);
...
protected:
	...
	System::Types::TSize __fastcall GetEditSize(Cxedit::TcxEditSizeProperties &AEditSizeProperties);
...
private:
	...
	void __fastcall CopyForEachRowProc(int ARowIndex, Cxcustomdata::TcxRowInfo &ARowInfo);
