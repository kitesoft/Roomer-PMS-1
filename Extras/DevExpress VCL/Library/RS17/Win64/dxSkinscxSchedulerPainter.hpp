...
// (DO NOT EDIT: machine generated header) 'dxSkinscxSchedulerPainter.pas' rev: 24.00 (Win64)
...
private:
	void __fastcall DrawClippedElement(Cxgraphics::TcxCanvas* ACanvas, Dxskinscore::TdxSkinElement* AElement, Cxgraphics::TcxBorders ABorders, System::Types::TRect &R);
...
public:
	...
	virtual void __fastcall DrawEventAsProgressText(Cxschedulercustomresourceview::TcxSchedulerEventCellViewInfo* AViewInfo, System::Types::TRect &AContent, System::Types::TRect &AProgressRect, const System::UnicodeString AText);
