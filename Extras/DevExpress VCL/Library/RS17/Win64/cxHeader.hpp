...
// (DO NOT EDIT: machine generated header) 'cxHeader.pas' rev: 24.00 (Win64)
...
protected:
	...
	System::Types::TRect __fastcall GetSectionContentBounds(System::Types::TRect &ASectionBounds, Cxlookandfeelpainters::TcxButtonState AState);
