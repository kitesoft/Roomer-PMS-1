...
// (DO NOT EDIT: machine generated header) 'dxPSPopupMan.pas' rev: 24.00 (Win64)
...
protected:
	...
	bool __fastcall TryShowPopup(Vcl::Controls::TControl* AControl, System::Types::TPoint Pt);
