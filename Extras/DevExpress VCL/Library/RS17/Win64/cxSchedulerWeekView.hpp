...
// (DO NOT EDIT: machine generated header) 'cxSchedulerWeekView.pas' rev: 24.00 (Win64)
...
protected:
	...
	virtual void __fastcall CalculateWeekDisplayRectsHorz(const System::TDateTime AStartDate, int AResourceID, System::Types::TRect &ABounds, bool AIsTopWeek, bool AIsLastWeek);
