...
// (DO NOT EDIT: machine generated header) 'dxColorGallery.pas' rev: 24.00 (Win64)
...
private:
	...
	void __fastcall InternalSetEditValue(System::Variant &AValue, bool ANeedSynchronizeSelectedItems);
	...
	void __fastcall SetEditValue(System::Variant &AValue);
