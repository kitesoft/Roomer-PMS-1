...
// (DO NOT EDIT: machine generated header) 'dxFEFDlg.pas' rev: 24.00 (Win64)
...
__published:
	...
	void __fastcall dgTextureDrawCell(System::TObject* Sender, int Col, int Row, System::Types::TRect &Rect, Vcl::Grids::TGridDrawState State);
	void __fastcall dgPatternDrawCell(System::TObject* Sender, int Col, int Row, System::Types::TRect &Rect, Vcl::Grids::TGridDrawState State);
...
private:
	...
	void __fastcall DrawSelectedFrame(Vcl::Grids::TDrawGrid* ADrawGrid, System::Types::TRect &Rect);
