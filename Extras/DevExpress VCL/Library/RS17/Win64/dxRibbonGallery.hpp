...
// (DO NOT EDIT: machine generated header) 'dxRibbonGallery.pas' rev: 24.00 (Win64)
...
protected:
	...
	void __fastcall CorrectItemWidth(System::Types::TRect &ABounds);
	...
	System::Types::TRect __fastcall GetHeaderBounds(System::Types::TRect &AGroupBounds);
...
protected:
	...
	virtual int __fastcall InternalGetScrollBarWidth(void);
	virtual void __fastcall Changed(void);
	void __fastcall SetGroupItemDescriptionRect(int AGroupIndex, int AnItemIndex, System::Types::TRect &ARect);
...
public:
	...
	void __fastcall SubMenuControlDrawBorder(Dxbar::TdxBarSubMenuControl* ABarSubMenuControl, HDC DC, System::Types::TRect &R);
