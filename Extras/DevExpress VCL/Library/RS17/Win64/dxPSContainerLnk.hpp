...
// (DO NOT EDIT: machine generated header) 'dxPSContainerLnk.pas' rev: 24.00 (Win64)
...
__published:
	...
	void __fastcall lbxAvailableLinksDrawItem(Cxlistbox::TcxListBox* AControl, Cxgraphics::TcxCanvas* ACanvas, int AIndex, System::Types::TRect &ARect, Winapi::Windows::TOwnerDrawState AState);
