...
// (DO NOT EDIT: machine generated header) 'dxNavBarXPViews.pas' rev: 24.00 (Win64)
...
public:
	__classmethod bool __fastcall DrawObject(Vcl::Graphics::TCanvas* ACanvas, System::Types::TRect &ARect, Dxthememanager::TdxThemedObjectType AObject, int iPartId, int iStateId);
	__classmethod bool __fastcall DrawText(Vcl::Graphics::TCanvas* ACanvas, System::Types::TRect &ARect, System::UnicodeString ACaption, int ADrawTextFlag, Dxthememanager::TdxThemedObjectType AObject, int iPartId, int iStateId);
public:
