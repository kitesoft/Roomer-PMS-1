...
// (DO NOT EDIT: machine generated header) 'dxSkinsdxDockControlPainter.pas' rev: 24.00 (Win64)
...
protected:
	...
	bool __fastcall DrawCaptionButton(Cxgraphics::TcxCanvas* ACanvas, int AGlyphIndex, System::Types::TRect &ARect, Dxskinscore::TdxSkinElementState AState);
...
public:
	...
	virtual void __fastcall DrawHideBarButtonText(Cxgraphics::TcxCanvas* ACanvas, Dxdockcontrol::TdxCustomDockControl* AControl, System::Types::TRect &ARect, Dxdockcontrol::TdxAutoHidePosition APosition);
