...
// (DO NOT EDIT: machine generated header) 'dxBkGnd.pas' rev: 24.00 (Win64)
...
protected:
	...
	virtual void __fastcall DoPaint(Dxpsreportrendercanvas::TdxPSReportRenderCustomCanvas* ACanvas, System::Types::TRect &Rect, TdxPaintSequence Sequence, bool &ADone);
	virtual bool __fastcall DoPaintEx(Dxpsreportrendercanvas::TdxPSReportRenderCustomCanvas* ACanvas, System::Types::TRect &Rect, TdxPaintSequence Sequence, int PixelsNumerator, int PixelsDenominator);
