...
// (DO NOT EDIT: machine generated header) 'cxPCPainters.pas' rev: 24.00 (Win64)
...
protected:
	...
	virtual System::Types::TPoint __fastcall GetGoDialogPosition(System::Types::TSize ASize);
	...
	void __fastcall DrawButtonContent(Cxgraphics::TcxCanvas* ACanvas, Cxpc::TcxPCNavigatorButton AButton, const TcxPCNavigatorButtonContentParameters &AParameters, System::Types::TPoint AContentRectLeftTopCorner);
	...
	virtual void __fastcall InternalDrawFocusRect(Cxgraphics::TcxCanvas* ACanvas, int TabVisibleIndex, System::Types::TRect &R);
	...
	virtual void __fastcall PaintFrameBorder(Cxgraphics::TcxCanvas* ACanvas, System::Types::TRect &R);
...
protected:
	...
	virtual void __fastcall DrawTabBackground(Cxgraphics::TcxCanvas* ACanvas, System::Types::TRect &ARect, int ATabVisibleIndex);
	virtual void __fastcall DrawFocusRect(Cxgraphics::TcxCanvas* ACanvas, int ATabVisibleIndex);
...
protected:
	...
	void __fastcall DrawGradientBackground(Cxgraphics::TcxCanvas* ACanvas, System::Types::TRect &ARect, int ATabVisibleIndex, bool AHorizontal, bool AInverse);
	virtual Cxlookandfeelpainters::TcxCustomLookAndFeelPainter* __fastcall GetLookAndFeelPainter(void);
	virtual bool __fastcall UseLookAndFeelTabButton(void);
...
private:
	int FCutValue;
	System::Types::TRect __fastcall GetTabsLineRect(Cxpc::TcxPCIndexInterval ATabIndexInterval, bool AFullRect);
...
protected:
	...
	HIDESBASE virtual void __fastcall DrawBackground(Cxgraphics::TcxCanvas* ACanvas, System::Types::TRect &R, int ATabVisibleIndex, bool AHorizontalGradient, bool AInverseGradient);
