...
// (DO NOT EDIT: machine generated header) 'dxCore.pas' rev: 24.00 (Win64)
...
typedef System::Set<char, char(0), char(255)>  TdxAnsiCharSet;
...
extern PACKAGE NativeInt __fastcall dxPointToLParam(System::Types::TPoint P);
