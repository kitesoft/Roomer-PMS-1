...
// (DO NOT EDIT: machine generated header) 'dxSkinFoggy.pas' rev: 24.00 (Win64)
...
public:
	...
	/* TdxSkinLookAndFeelPainter.Destroy */ inline __fastcall virtual ~TdxSkinFoggyPainter(void) { }
