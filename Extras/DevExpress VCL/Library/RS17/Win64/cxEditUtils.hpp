...
// (DO NOT EDIT: machine generated header) 'cxEditUtils.pas' rev: 24.00 (Win64)
...
extern PACKAGE void __fastcall DrawArrow(Cxgraphics::TcxCanvas* ACanvas, int AArrowSize, System::Types::TRect &AContentRect, Cxlookandfeelpainters::TcxArrowDirection AArrowDirection, bool AIsDoubleArrow, bool AOffsetContent, System::Uitypes::TColor AColor);
...
extern PACKAGE bool __fastcall cxOffsetRect(System::Types::TRect &ARect, System::Types::TPoint AOffset);
