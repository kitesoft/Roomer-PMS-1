...
// (DO NOT EDIT: machine generated header) 'cxGridCustomView.pas' rev: 24.00 (Win64)
...
protected:
	...
	virtual void __fastcall DrawBorder(Vcl::Graphics::TCanvas* ACanvas, System::Types::TRect &R);
...
public:
	...
	virtual void __fastcall PaintItem(Cxgraphics::TcxCanvas* ACanvas, System::Types::TRect &R, int AIndex, bool AFocused) = 0 ;
