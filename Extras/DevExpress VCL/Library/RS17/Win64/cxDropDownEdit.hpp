...
// (DO NOT EDIT: machine generated header) 'cxDropDownEdit.pas' rev: 24.00 (Win64)
...
protected:
	virtual void __fastcall DoCustomDraw(Cxgraphics::TcxCanvas* ACanvas, System::Types::TRect &ARect);
