...
// (DO NOT EDIT: machine generated header) 'dxPSPDFMetaFileParser.pas' rev: 24.00 (Win64)
...
protected:
	...
	void __fastcall EmfEllipse(System::Types::TRect &R);
	...
	void __fastcall EmfRectangle(System::Types::TRect &R);
	void __fastcall EmfRestoreState(void);
	void __fastcall EmfRoundRect(System::Types::TRect &R, System::Types::TSize ACorners);
