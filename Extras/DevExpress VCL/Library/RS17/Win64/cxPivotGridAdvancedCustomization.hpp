...
// (DO NOT EDIT: machine generated header) 'cxPivotGridAdvancedCustomization.pas' rev: 24.00 (Win64)
...
private:
	void __fastcall DrawItem(System::TObject* Sender, Vcl::Graphics::TCanvas* ACanvas, System::Types::TRect &ARect, Winapi::Windows::TOwnerDrawState State);
