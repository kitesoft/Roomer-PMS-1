...
// (DO NOT EDIT: machine generated header) 'dxBarExtItems.pas' rev: 24.00 (Win64)
...
protected:
	...
	virtual void __fastcall DrawInterior(System::Types::TRect &ARect);
...
protected:
	...
	virtual void __fastcall DrawItem(Dxbar::TdxBarPainter* APainter, int AIndex, System::Types::TRect &ARect, Winapi::Windows::TOwnerDrawState AState);
...
protected:
	...
	virtual System::TDateTime __fastcall PosToDateTime(System::Types::TPoint P) = 0 ;
...
protected:
	...
	virtual System::TDateTime __fastcall PosToDateTime(System::Types::TPoint P);
	virtual void __fastcall CreateParams(Vcl::Controls::TCreateParams &Params);
	virtual void __fastcall CreateWnd(void);
...
protected:
	...
	DYNAMIC void __fastcall KeyDown(System::Word &Key, System::Classes::TShiftState Shift);
	DYNAMIC void __fastcall MouseUp(System::Uitypes::TMouseButton Button, System::Classes::TShiftState Shift, int X, int Y);
	void __fastcall UpdateSizeGripCorner(System::Types::TPoint ADropDownPosition);
	__property Dxbar::TdxBarPainter* Painter = {read=GetPainter};
...
protected:
	...
	virtual void __fastcall DrawInterior(Dxbar::TdxBarEditControl* ABarEditControl, Vcl::Graphics::TCanvas* ACanvas, System::Types::TRect &R, Dxbar::TdxBarItemLink* ItemLink);
	DYNAMIC void __fastcall DropDown(int X, int Y);
	virtual HWND __fastcall GetDropDownWindow(void);
...
private:
	...
	void __fastcall DialogListBoxDrawItem(Vcl::Controls::TWinControl* Control, int Index, System::Types::TRect &Rect, Winapi::Windows::TOwnerDrawState State);
