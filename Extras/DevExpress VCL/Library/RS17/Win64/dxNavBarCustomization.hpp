...
// (DO NOT EDIT: machine generated header) 'dxNavBarCustomization.pas' rev: 24.00 (Win64)

#ifndef DxnavbarcustomizationHPP
#define DxnavbarcustomizationHPP
...
namespace Dxnavbarcustomization
{
//-- type declarations -------------------------------------------------------
class DELPHICLASS TdxNavBarCustomizationForm;
class PASCALIMPLEMENTATION TdxNavBarCustomizationForm : public Dxnavbar::TdxNavBarCustomCustomizationForm
{
...
__published:
	...
	Vcl::Extctrls::TPanel* gbGroupsIndent;
	Vcl::Comctrls::TTreeView* tvGroups;
	Vcl::Stdctrls::TGroupBox* gbItems;
	Vcl::Extctrls::TPanel* gbItemsIndent;
	Vcl::Comctrls::TTreeView* tvItems;
	Vcl::Extctrls::TSplitter* cxSplitter1;
...
public:
	__fastcall virtual TdxNavBarCustomizationForm(System::Classes::TComponent* AOwner);
public:
	/* TdxNavBarCustomCustomizationForm.Destroy */ inline __fastcall virtual ~TdxNavBarCustomizationForm(void) { }
	
public:
	/* TCustomForm.CreateNew */ inline __fastcall virtual TdxNavBarCustomizationForm(System::Classes::TComponent* AOwner, int Dummy) : Dxnavbar::TdxNavBarCustomCustomizationForm(AOwner, Dummy) { }
	
public:
	/* TWinControl.CreateParented */ inline __fastcall TdxNavBarCustomizationForm(HWND ParentWindow) : Dxnavbar::TdxNavBarCustomCustomizationForm(ParentWindow) { }
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DXNAVBARCUSTOMIZATION)
using namespace Dxnavbarcustomization;
#endif
#pragma pack(pop)
#pragma option pop
...
//-- end unit ----------------------------------------------------------------
#endif	// DxnavbarcustomizationHPP
