...
// (DO NOT EDIT: machine generated header) 'dxSkinsCore.pas' rev: 24.00 (Win64)
...
private:
	...
	void __fastcall InitCache(System::Types::TRect &R);
	void __fastcall InitOpaqueCache(System::Types::TRect &R);
