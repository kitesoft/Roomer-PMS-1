...
// (DO NOT EDIT: machine generated header) 'cxAccessibility.pas' rev: 24.00 (Win64)
...
private:
	...
	bool __fastcall GetSimpleChildElementID(System::OleVariant &AChildID, /* out */ TcxAccessibleSimpleChildElementID &ASimpleChildElementID, /* out */ HRESULT &AErrorCode);
...
public:
	...
	__property HWND OwnerObjectWindow = {read=GetOwnerObjectWindow};
