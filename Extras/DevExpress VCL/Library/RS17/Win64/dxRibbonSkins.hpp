...
// (DO NOT EDIT: machine generated header) 'dxRibbonSkins.pas' rev: 24.00 (Win64)
...
public:
	...
	void __fastcall LoadFourStateArray(void * ABitmap, System::Types::TRect &R, const System::Types::TRect &Fixed, int *AStateArray, int AStartID, bool AIsVerticalLayout = true, int AInterpolationMode = 0x0);
	void __fastcall LoadThreeStateArray(void * ABitmap, System::Types::TRect &R, const System::Types::TRect &Fixed, int *AStateArray, int AStartID, bool AIsVerticalLayout = true, int AInterpolationMode = 0x0);
	...
	virtual void __fastcall DrawInRibbonGalleryScrollBarButtonGlyph(HDC DC, System::Types::TRect &R, TdxInRibbonGalleryScrollBarButtonKind AButtonKind, int AState, TdxRibbonColorSchemeAccent AColorSchemeAccent);
