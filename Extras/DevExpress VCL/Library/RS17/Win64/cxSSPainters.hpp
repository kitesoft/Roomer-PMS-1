...
// (DO NOT EDIT: machine generated header) 'cxSSPainters.pas' rev: 24.00 (Win64)
...
public:
	virtual void __fastcall Paint(Cxsspainterwrapper::TcxCanvasWrapper* ACanvas, Cxssviewinfo::TcxSSBookCaptionViewInfo &AViewInfo);
public:
