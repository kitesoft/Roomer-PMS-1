...
// (DO NOT EDIT: machine generated header) 'cxDateUtils.pas' rev: 24.00 (Win64)
...
protected:
	...
	bool __fastcall IsNotValid(TcxDateTime &ADate, /* out */ System::TDateTime &AResult);
	void __fastcall YearToGregorianYear(unsigned &AYear, int AEra);
	
public:
	__fastcall virtual TcxCustomCalendarTable(void);
	__fastcall virtual ~TcxCustomCalendarTable(void);
	virtual System::TDateTime __fastcall AddDays(TcxDateTime &ADate, int ACountDays)/* overload */;
	virtual System::TDateTime __fastcall AddMonths(System::TDateTime ADate, int ACountMonths)/* overload */;
	virtual System::TDateTime __fastcall AddMonths(TcxDateTime &ADate, int ACountMonths)/* overload */;
	virtual System::TDateTime __fastcall AddYears(System::TDateTime ADate, int ACountYears)/* overload */;
	virtual System::TDateTime __fastcall AddYears(TcxDateTime &ADate, int ACountYears)/* overload */;
	virtual System::TDateTime __fastcall AddWeeks(System::TDateTime ADate, int ACountWeeks)/* overload */;
	virtual System::TDateTime __fastcall AddWeeks(TcxDateTime &ADate, int ACountWeeks)/* overload */;
	...
	virtual unsigned __fastcall GetDayOfYear(TcxDateTime &ADate)/* overload */;
	...
	virtual TcxDateTime __fastcall GetFirstDayOfWeek(TcxDateTime &ADate)/* overload */;
	virtual TcxDateTime __fastcall GetFirstDayOfWeek(TcxDateTime &ADate, TDay AStartDayOfWeek)/* overload */;
	...
	virtual unsigned __fastcall GetYear(TcxDate &ADate)/* overload */;
	virtual unsigned __fastcall GetYear(TcxDateTime &ADate)/* overload */;
	virtual System::Byte __fastcall GetWeekDay(System::TDateTime ADate)/* overload */;
	virtual System::Byte __fastcall GetWeekDay(TcxDateTime &ADate)/* overload */;
	...
	virtual unsigned __fastcall GetWeekNumber(TcxDateTime &ADate, TDay AStartOfWeek, TcxFirstWeekOfYear AFirstWeekOfYear) = 0 /* overload */;
	...
	virtual System::TDateTime __fastcall ToDateTime(TcxDate &ADate)/* overload */;
	...
	virtual System::TDateTime __fastcall ToDateTime(TcxDateTime &ADateTime) = 0 /* overload */;
