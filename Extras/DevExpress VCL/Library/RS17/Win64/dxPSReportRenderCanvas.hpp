...
// (DO NOT EDIT: machine generated header) 'dxPSReportRenderCanvas.pas' rev: 24.00 (Win64)
...
public:
	...
	virtual void __fastcall FillRoundRect(System::Types::TRect &R, int AEllipseWidth, int AEllipseHeight, System::Uitypes::TColor ABackColor, System::Uitypes::TColor AForeColor, Dxpsfillpatterns::TdxPSFillPatternClass APattern, Vcl::Graphics::TBrush* APatternBrush) = 0 ;
...
public:
	...
	virtual void __fastcall DrawExpandButton(System::Types::TRect &R, TdxCheckButtonEdgeStyle AEdgeStyle, Vcl::Graphics::TFont* AMarlettFont, Vcl::Graphics::TFont* ASymbolFont, bool AExpanded, bool AShadow, bool AFillInterior, System::Uitypes::TColor ABorderColor, System::Uitypes::TColor ABackgroundColor, int ALineThickness);
