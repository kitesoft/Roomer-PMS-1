...
// (DO NOT EDIT: machine generated header) 'cxCustomData.pas' rev: 24.00 (Win64)
...
private:
	...
	void __fastcall SetFooterSummaryValue(int Index, System::Variant &Value);
...
protected:
	...
	virtual int __fastcall CompareRecords(int ARecordIndex1, int ARecordIndex2, TcxDataSortInfo &ASortInfo, TcxDataControllerComparisonMode AMode = (TcxDataControllerComparisonMode)(0x2));
