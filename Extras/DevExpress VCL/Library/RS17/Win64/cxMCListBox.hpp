...
// (DO NOT EDIT: machine generated header) 'cxMCListBox.pas' rev: 24.00 (Win64)
...
private:
	...
	bool FIsSorting;
	System::Types::TRect __fastcall CalcCellTextRect(System::Types::TRect &AApproximateRect, int AItemIndex, int AColumnIndex);
	void __fastcall DrawCellTextEx(System::Types::TRect &ARect, int AFlags, int AItemIndex, int AColumnIndex);
	void __fastcall DrawCellText(System::Types::TRect &ARect, int AItemIndex, int AColumnIndex);
	...
	void __fastcall DrawItem(Vcl::Controls::TWinControl* Control, int Index, System::Types::TRect &ARect, Winapi::Windows::TOwnerDrawState State);
