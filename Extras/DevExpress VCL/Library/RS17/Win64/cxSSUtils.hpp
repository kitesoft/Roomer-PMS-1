...
// (DO NOT EDIT: machine generated header) 'cxSSUtils.pas' rev: 24.00 (Win64)
...
public:
	...
	__classmethod virtual bool __fastcall IntersectRange(Cxsstypes::TRange &AOutRect, Cxsstypes::TRange &ARect1, Cxsstypes::TRange &ARect2);
