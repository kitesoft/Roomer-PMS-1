...
// (DO NOT EDIT: machine generated header) 'cxSSFormulas.pas' rev: 24.00 (Win64)
...
protected:
	...
	Cxsstypes::TcxStackItem __fastcall StackUnion(Cxsstypes::TcxStackItem &ASrc1, Cxsstypes::TcxStackItem &ASrc2);
...
public:
	...
	__fastcall virtual ~TcxTokensStack(void);
	void __fastcall Clear(void);
	__classmethod Cxsstypes::TcxStackItem __fastcall Clone(Cxsstypes::TcxStackItem &AItem);
