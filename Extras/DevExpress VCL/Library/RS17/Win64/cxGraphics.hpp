...
// (DO NOT EDIT: machine generated header) 'cxGraphics.pas' rev: 24.00 (Win64)
...
public:
	...
	void __fastcall Rectangle(System::Types::TRect &R, const TcxViewParams &AParams, const TcxBorders ABorders = TcxBorders() , System::Uitypes::TColor ABorderColor = (System::Uitypes::TColor)(0x20000000), int ALineWidth = 0x1, bool AExcludeRect = false)/* overload */;
	...
	void __fastcall DrawDesignSelection(System::Types::TRect &ARect, int AWidth = 0x2);
	...
	void __fastcall DrawTexT(const System::UnicodeString Text, System::Types::TRect &R, int Flags, bool Enabled = true)/* overload */;
	void __fastcall DrawTexT(const System::UnicodeString Text, System::Types::TRect &R, int Flags, bool Enabled, TcxRotationAngle ARotationAngle)/* overload */;
	void __fastcall DrawTexT(const System::UnicodeString Text, System::Types::TRect &R, System::Classes::TAlignment AAlignmentHorz, Cxclasses::TcxAlignmentVert AAlignmentVert, bool AMultiLine, bool AShowEndEllipsis)/* overload */;
	...
	void __fastcall GetTextStringsBounds(System::UnicodeString Text, System::Types::TRect &R, int Flags, bool Enabled, TRectArray &ABounds);
...
typedef bool __fastcall (*TcxDrawImageProc)(Vcl::Graphics::TCanvas* ACanvas, Vcl::Imglist::TCustomImageList* AImages, int AImageIndex, Vcl::Graphics::TBitmap* AGlyph, System::Types::TRect &ARect, TcxImageDrawMode ADrawMode);
...
extern PACKAGE void __fastcall cxDrawImage(NativeUInt ADC, System::Types::TRect &AGlyphRect, System::Types::TRect &ABackgroundRect, Vcl::Graphics::TBitmap* AGlyph, Vcl::Imglist::TCustomImageList* AImages, int AImageIndex, TcxImageDrawMode ADrawMode, bool ASmoothImage = false, NativeUInt ABrush = (NativeUInt)(0ULL), System::Uitypes::TColor ATransparentColor = (System::Uitypes::TColor)(0x1fffffff), bool AUseLeftBottomPixelAsTransparent = true)/* overload */;
...
extern PACKAGE void __fastcall cxDrawImageList(NativeUInt AImageListHandle, int AImageIndex, HDC ADC, System::Types::TPoint APoint, Vcl::Imglist::TDrawingStyle ADrawingStyle, Vcl::Imglist::TImageType AImageType);
...
extern PACKAGE void __fastcall cxAlphaBlend(Vcl::Graphics::TBitmap* ASource, System::Types::TRect &ARect, const System::Uitypes::TColor ASelColor, System::Byte Alpha = (System::Byte)(0xaa))/* overload */;
...
extern PACKAGE int __fastcall cxDrawText(Vcl::Graphics::TCanvas* ACanvas, const System::UnicodeString AText, System::Types::TRect &ARect, unsigned AFormat, System::Uitypes::TColor ATextColor = (System::Uitypes::TColor)(0x20000000))/* overload */;
...
extern PACKAGE void __fastcall cxDrawTransparentControlBackground(Vcl::Controls::TWinControl* AControl, TcxCanvas* ACanvas, System::Types::TRect &ARect, bool APaintParentWithChildren = true)/* overload */;
...
extern PACKAGE void __fastcall cxAdvancedDrawPopupMenuItem(Vcl::Menus::TMenuItem* AMenuItem, Vcl::Graphics::TCanvas* ACanvas, System::Types::TRect &ARect, Winapi::Windows::TOwnerDrawState AState, Vcl::Imglist::TCustomImageList* AExternalImages = (Vcl::Imglist::TCustomImageList*)(0x0));
