...
// (DO NOT EDIT: machine generated header) 'cxLabel.pas' rev: 24.00 (Win64)
...
protected:
	virtual void __fastcall InternalDrawBackground(Cxgraphics::TcxCanvas* ACanvas, Cxgraphics::TcxCanvas* ASource, const System::Types::TRect &R, System::Types::TPoint AParentBackgroundOffset);
