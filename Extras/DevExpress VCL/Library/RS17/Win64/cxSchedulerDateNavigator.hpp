...
// (DO NOT EDIT: machine generated header) 'cxSchedulerDateNavigator.pas' rev: 24.00 (Win64)
...
protected:
	...
	virtual void __fastcall Calculate(int ACol, int ARow, Cxdateutils::TcxDateTime &ADate);
