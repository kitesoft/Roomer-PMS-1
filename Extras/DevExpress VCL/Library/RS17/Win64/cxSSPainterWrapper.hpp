...
// (DO NOT EDIT: machine generated header) 'cxSSPainterWrapper.pas' rev: 24.00 (Win64)
...
protected:
	...
	virtual void __fastcall SplitToTextBricks(const System::UnicodeString AText, System::Types::TRect &ARect, Cxsstypes::TcxHorzTextAlign HAlign, Cxsstypes::TcxVertTextAlign VAlign, Cxsstypes::TWordExtents &ATextBricks);
...
public:
	...
	bool __fastcall RectIsVisible(System::Types::TRect &ARect);
	...
	__property HDC Handle = {read=FPainterHandle};
