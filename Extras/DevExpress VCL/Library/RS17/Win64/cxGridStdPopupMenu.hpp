...
// (DO NOT EDIT: machine generated header) 'cxGridStdPopupMenu.pas' rev: 24.00 (Win64)
...
protected:
	...
	virtual void __fastcall AdvancedDrawItem(System::TObject* Sender, Vcl::Graphics::TCanvas* ACanvas, System::Types::TRect &ARect, Winapi::Windows::TOwnerDrawState State);
