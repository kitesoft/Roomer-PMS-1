...
// (DO NOT EDIT: machine generated header) 'dxPSStdGrLnk.pas' rev: 24.00 (Win32)
...
protected:
	...
	virtual void __fastcall DoCustomDrawCell(int ACol, int ARow, Vcl::Graphics::TCanvas* ACanvas, const System::Types::TRect &ABoundsRect, const System::Types::TRect &AClientRect, System::UnicodeString &AText, Vcl::Graphics::TFont* AFont, System::Uitypes::TColor &AColor, Cxdrawtextutils::TcxTextAlignX &ATextAlignX, Cxdrawtextutils::TcxTextAlignY &ATextAlignY, bool &ADone);
...
protected:
	...
	virtual void __fastcall SetDrawMode(Dxpsbasegridlnk::TdxGridDrawMode Value);
	virtual void __fastcall CustomDraw(Dxpscore::TAbstractdxReportCellData* AItem, Vcl::Graphics::TCanvas* ACanvas, const System::Types::TRect &ABoundsRect, const System::Types::TRect &AClientRect, bool &ADone);
	virtual void __fastcall DoCustomDrawCell(int ACol, int ARow, Vcl::Graphics::TCanvas* ACanvas, const System::Types::TRect &ABoundsRect, const System::Types::TRect &AClientRect);
	virtual void __fastcall DoCustomDrawCellEx(int ACol, int ARow, Vcl::Graphics::TCanvas* ACanvas, Vcl::Graphics::TFont* AFont, const System::Types::TRect &ABoundsRect, const System::Types::TRect &AClientRect);
	__classmethod virtual bool __fastcall IsDrawGridLink();
	virtual bool __fastcall IsSupportedCustomDraw(Dxpscore::TAbstractdxReportCellData* Item);
