...
// (DO NOT EDIT: machine generated header) 'dxPSTVLnk.pas' rev: 24.00 (Win32)
...
protected:
	...
	__property NativeUInt TreeViewHandle = {read=GetTreeViewHandle, write=SetTreeViewHandle, nodefault};
...
protected:
	...
	virtual void __fastcall DoCustomDrawNode(Vcl::Comctrls::TTreeNode* ANode, Vcl::Graphics::TCanvas* ACanvas, const System::Types::TRect &ABoundsRect, const System::Types::TRect &AClientRect, System::UnicodeString &AText, Vcl::Graphics::TFont* AFont, System::Uitypes::TColor &AColor, Cxdrawtextutils::TcxTextAlignX &ATextAlignX, Cxdrawtextutils::TcxTextAlignY &ATextAlignY, bool &ADone);
