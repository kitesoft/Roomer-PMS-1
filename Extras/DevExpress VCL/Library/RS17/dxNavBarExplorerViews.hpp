...
// (DO NOT EDIT: machine generated header) 'dxNavBarExplorerViews.pas' rev: 24.00 (Win32)
...
protected:
	__classmethod void __fastcall PrepareBitmap(Vcl::Graphics::TCanvas* ACanvas, const System::Types::TRect &ARect, Vcl::Graphics::TBitmap* ABitmap, System::Uitypes::TColor AForeColor, Dxnavbar::TdxNavBarObjectStates AState);
	__classmethod virtual void __fastcall InternalDrawSign(Vcl::Graphics::TCanvas* ACanvas, const System::Types::TRect &ARect, System::Uitypes::TColor AForeColor, System::Uitypes::TColor ABackColor1, System::Uitypes::TColor ABackColor2, Dxnavbar::TdxNavBarObjectStates AState);
public:
