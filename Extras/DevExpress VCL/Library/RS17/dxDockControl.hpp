...
// (DO NOT EDIT: machine generated header) 'dxDockControl.pas' rev: 24.00 (Win32)
...
public:
	...
	virtual void __fastcall DrawResizingSelection(HDC DC, const System::Types::TPoint &pt);
...
protected:
	...
	virtual bool __fastcall CanResizeAtPos(const System::Types::TPoint &pt);
	void __fastcall DoStartResize(const System::Types::TPoint &pt);
	void __fastcall DoEndResize(const System::Types::TPoint &pt);
	void __fastcall DoResizing(const System::Types::TPoint &pt);
	void __fastcall DrawResizingSelection(TdxZone* AZone, const System::Types::TPoint &pt, bool Erasing);
	virtual void __fastcall StartResize(const System::Types::TPoint &pt);
	virtual void __fastcall Resizing(const System::Types::TPoint &pt);
	virtual void __fastcall EndResize(const System::Types::TPoint &pt, bool Cancel);
	...
	void __fastcall DoCanDocking(TdxCustomDockControl* Source, const System::Types::TPoint &pt, TdxZone* TargetZone, bool &Accept);
	void __fastcall DoDocking(const System::Types::TPoint &pt, TdxZone* TargetZone, bool &Accept);
	...
	virtual void __fastcall StoreDockPosition(const System::Types::TPoint &pt);
	virtual void __fastcall RestoreDockPosition(const System::Types::TPoint &pt);
	...
	void __fastcall CheckTempCanvas(const System::Types::TRect &ARect);
...
public:
	...
	virtual TdxZone* __fastcall GetDockZoneAtPos(TdxCustomDockControl* AControl, const System::Types::TPoint &APoint);
	virtual TdxZone* __fastcall GetResizeZoneAtPos(const System::Types::TPoint &APoint);
...
protected:
	...
	TdxCustomDockControl* __fastcall GetControlAtPos(const System::Types::TPoint &pt, TdxCustomDockControl* &SubControl);
	TdxDockSiteHideBar* __fastcall GetHideBarAtPos(const System::Types::TPoint &pt);
...
protected:
	...
	__classmethod void __fastcall DrawColorEdge(Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &ARect, System::Uitypes::TColor AColor, TdxEdgesType AEdgesType, TdxEdgePositions AEdgePositios);
	__classmethod void __fastcall DrawImage(Cxgraphics::TcxCanvas* ACanvas, Vcl::Imglist::TCustomImageList* AImageList, int AImageIndex, const System::Types::TRect &R);
	__classmethod bool __fastcall RectInRect(const System::Types::TRect &R1, const System::Types::TRect &R2);
...
public:
	...
	virtual void __fastcall DrawHideBar(Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &ARect, TdxAutoHidePosition APosition);
	...
	virtual void __fastcall DrawHideBarButtonImage(Cxgraphics::TcxCanvas* ACanvas, TdxCustomDockControl* AControl, const System::Types::TRect &ARect);
	virtual void __fastcall DrawHideBarButtonText(Cxgraphics::TcxCanvas* ACanvas, TdxCustomDockControl* AControl, const System::Types::TRect &ARect, TdxAutoHidePosition APosition);
...
protected:
	...
	bool __fastcall DoCustomDrawResizingSelection(TdxCustomDockControl* ASender, HDC DC, TdxZone* AZone, const System::Types::TPoint &pt, bool Erasing);
	bool __fastcall DoCustomDrawDockingSelection(TdxCustomDockControl* ASender, HDC DC, TdxZone* AZone, const System::Types::TRect &R, bool Erasing);
	...
	void __fastcall CheckTempBitmap(const System::Types::TRect &ARect);
...
public:
	...
	TdxCustomDockControl* __fastcall GetDockControlForWindow(HWND AWnd, HWND ADockWindow = (HWND)(0x0));
