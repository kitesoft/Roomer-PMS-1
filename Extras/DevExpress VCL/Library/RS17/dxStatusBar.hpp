...
// (DO NOT EDIT: machine generated header) 'dxStatusBar.pas' rev: 24.00 (Win32)
...
protected:
	...
	virtual void __fastcall DrawContent(Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &R, TdxStatusBarPainterClass APainter);
...
public:
	...
	__classmethod virtual void __fastcall DrawEmptyPanel(TdxCustomStatusBar* AStatusBar, Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &R);
	__classmethod virtual void __fastcall DrawPanel(TdxCustomStatusBar* AStatusBar, TdxStatusBarPanel* APanel, Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &R);
	...
	__classmethod virtual void __fastcall DrawSimplePanel(TdxCustomStatusBar* AStatusBar, const System::UnicodeString AText, Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &R);
	__classmethod virtual void __fastcall DrawSizeGrip(TdxCustomStatusBar* AStatusBar, Cxgraphics::TcxCanvas* ACanvas, const System::Types::TRect &R);
