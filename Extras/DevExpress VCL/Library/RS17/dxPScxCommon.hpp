...
// (DO NOT EDIT: machine generated header) 'dxPScxCommon.pas' rev: 24.00 (Win32)
...
protected:
	...
	void __fastcall PerformStyleSheetDrawItem(Vcl::Graphics::TCanvas* ACanvas, int AnIndex, const System::Types::TRect &R, Winapi::Windows::TOwnerDrawState AState, bool AEnabled);
...
protected:
	...
	virtual void __fastcall DrawStyle(const System::Types::TRect &R);
...
extern PACKAGE void __fastcall dxPSDrawStyleBar(Vcl::Graphics::TCanvas* ACanvas, const System::Types::TRect &R, const TdxStyleBarViewInfo &AViewInfo);
