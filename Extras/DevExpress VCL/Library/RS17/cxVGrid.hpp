...
// (DO NOT EDIT: machine generated header) 'cxVGrid.pas' rev: 24.00 (Win32)
...
public:
	/* TcxDragImageHelper.Create */ inline __fastcall virtual TcxvgDragImageHelper(Cxinplacecontainer::TcxEditingControl* AControl, const System::Types::TPoint &ADragPos) : Cxinplacecontainer::TcxDragImageHelper(AControl, ADragPos) { }
...
protected:
	void __fastcall AddRectValueLines(const System::Types::TRect &R, bool ALast, bool ABottomLineNeeded);
...
public:
	...
	virtual void __fastcall DrawLines(Cxvgridutils::TLineInfoList* ALinesInfo, const System::Types::TRect &R);
