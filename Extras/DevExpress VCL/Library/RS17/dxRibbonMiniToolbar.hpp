...
// (DO NOT EDIT: machine generated header) 'dxRibbonMiniToolbar.pas' rev: 24.00 (Win32)
...
public:
	...
	void __fastcall Popup(const System::Types::TPoint &P, Dxbar::TdxBarCustomPopupMenu* AContextMenu = (Dxbar::TdxBarCustomPopupMenu*)(0x0))/* overload */;
public:
