...
uses
  ...
  {$ENDIF}
  {$IFDEF DELPHIXE2_LVL}
  , AdvChartToolBarPopup, AdvChartGraphics, AdvChartToolBar
  {$ENDIF}
  ;
...
const
  ...
  BLD_VER = 3; // Build nr.
  ZOOMMIN = 0.000000001;
  DATE_VER = 'JANUARY, 2017'; // Month version
          ...
          begin
            ...
            begin
              ...
              begin
                ...
                with TCrackedChartSerie(Series[j]) do
                begin
                  Text.Add('H:' + Format(ValueFormat,[MaximumValue]));
                  Text.Add('O:' + Format(ValueFormat,[MaximumValue]));
                  Text.Add('C:' + Format(ValueFormat,[MaximumValue]));
                  Text.Add('L:' + Format(ValueFormat,[MaximumValue]));
                end;
              end;
            end
            else
                  ...
                  begin
                    ...
                    begin
                      ...
                      begin
                        ...
                        TextColor := Font.Color;
                        Text.Add(LegendText+': ');
                        Text.Add('H:' + Format(Series[J].ValueFormat,[Series[J].GetChartPoint(point.Point).HighValue]));
                        Text.Add('O:' + Format(Series[J].ValueFormat,[Series[J].GetChartPoint(point.Point).OpenValue]));
                        Text.Add('C:' + Format(Series[J].ValueFormat,[Series[J].GetChartPoint(point.Point).CloseValue]));
                        Text.Add('L:' + Format(Series[J].ValueFormat,[Series[J].GetChartPoint(point.Point).LowValue]));
                      end;
                    end
                    else
                    begin
