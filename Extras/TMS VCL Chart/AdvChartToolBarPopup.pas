...
uses
  ...
  AdvChartGraphics, AdvCToolBarPopup, Types
  {$IFNDEF LCLLIB}
  ,AdvChartTypes
  {$ENDIF}
  ;
...
begin
  ...
  FChartFill.Bitmaps.AddBitmapFromResource('TAdvChartToolBarPopupFill');
  ...
  FChartStroke.Bitmaps.AddBitmapFromResource('TAdvChartToolBarPopupLine');
  ...
  FChartType.Bitmaps.AddBitmapFromResource('TAdvChartToolBar');

  it := FChartType.Items.Add;
  it.Bitmap.LoadFromResource('TAdvChartToolBarPopupChartLine');
  it.Hint := 'Line';
  it.BitmapSize := it.Bitmap.Width;

  it := FChartType.Items.Add;
  it.Bitmap.LoadFromResource('TAdvChartToolBarPopupChartArea');
  it.Hint := 'Area';
  it.BitmapSize := it.Bitmap.Width;

  it := FChartType.Items.Add;
  it.Bitmap.LoadFromResource('TAdvChartToolBarPopupChartBar');
  it.Hint := 'Bar';
  it.BitmapSize := it.Bitmap.Width;

  it := FChartType.Items.Add;
  it.Bitmap.LoadFromResource('TAdvChartToolBarPopupChartLineBar');
  it.Hint := 'Line Bar';
  it.BitmapSize := it.Bitmap.Width;

  it := FChartType.Items.Add;
  it.Bitmap.LoadFromResource('TAdvChartToolBarPopupChartHistogram');
  it.Hint := 'Histogram';
  it.BitmapSize := it.Bitmap.Width;

  it := FChartType.Items.Add;
  it.Bitmap.LoadFromResource('TAdvChartToolBarPopupChartLineHistogram');
  it.Hint := 'Line Histogram';
  it.BitmapSize := it.Bitmap.Width;

  it := FChartType.Items.Add;
  it.Bitmap.LoadFromResource('TAdvChartToolBarPopupChartCandleStick');
  it.Hint := 'CandleStick';
  it.BitmapSize := it.Bitmap.Width;

  it := FChartType.Items.Add;
  it.Bitmap.LoadFromResource('TAdvChartToolBarPopupChartLineCandleStick');
  it.Hint := 'Line CandleStick';
  it.BitmapSize := it.Bitmap.Width;

  it := FChartType.Items.Add;
  it.Bitmap.LoadFromResource('TAdvChartToolBarPopupChartOHLC');
  it.Hint := 'OHLC';
  it.BitmapSize := it.Bitmap.Width;

  it := FChartType.Items.Add;
  it.Bitmap.LoadFromResource('TAdvChartToolBarPopupChartMarker');
  it.Hint := 'Markers';
  it.BitmapSize := it.Bitmap.Width;

  it := FChartType.Items.Add;
  it.Bitmap.LoadFromResource('TAdvChartToolBarPopupChartStackedBar');
  it.Hint := 'Stacked Bar';
  it.BitmapSize := it.Bitmap.Width;

  it := FChartType.Items.Add;
  it.Bitmap.LoadFromResource('TAdvChartToolBarPopupChartStackedArea');
  it.Hint := 'Stacked Area';
  it.BitmapSize := it.Bitmap.Width;

  it := FChartType.Items.Add;
  it.Bitmap.LoadFromResource('TAdvChartToolBarPopupChartStackedAreaPerc');
  it.Hint := 'Stacked Area (%)';
  it.BitmapSize := it.Bitmap.Width;

  it := FChartType.Items.Add;
  it.Bitmap.LoadFromResource('TAdvChartToolBarPopupChartStackedBarPerc');
  it.Hint := 'Stacked Bar (%)';
  it.BitmapSize := it.Bitmap.Width;

  it := FChartType.Items.Add;
  it.Bitmap.LoadFromResource('TAdvChartToolBarPopupChartError');
  it.Hint := 'Error';
  it.BitmapSize := it.Bitmap.Width;

  it := FChartType.Items.Add;
  it.Bitmap.LoadFromResource('TAdvChartToolBarPopupChartArrow');
  it.Hint := 'Arrow';
  it.BitmapSize := it.Bitmap.Width;

  it := FChartType.Items.Add;
  it.Bitmap.LoadFromResource('TAdvChartToolBarPopupChartScaledArrow');
  it.Hint := 'Scaled Arrow';
  it.BitmapSize := it.Bitmap.Width;

  it := FChartType.Items.Add;
  it.Bitmap.LoadFromResource('TAdvChartToolBarPopupChartBubble');
  it.Hint := 'Bubble';
  it.BitmapSize := it.Bitmap.Width;

  it := FChartType.Items.Add;
  it.Bitmap.LoadFromResource('TAdvChartToolBarPopupChartScaledBubble');
  it.Hint := 'Scaled Bubble';
  it.BitmapSize := it.Bitmap.Width;

  it := FChartType.Items.Add;
  it.Bitmap.LoadFromResource('TAdvChartToolBarPopupChartPie');
  it.Hint := 'Pie';
  it.BitmapSize := it.Bitmap.Width;

  it := FChartType.Items.Add;
  it.Bitmap.LoadFromResource('TAdvChartToolBarPopupChartHalfPie');
  it.Hint := 'Half Pie';
  it.BitmapSize := it.Bitmap.Width;

  it := FChartType.Items.Add;
  it.Bitmap.LoadFromResource('TAdvChartToolBarPopupChartDonut');
  it.Hint := 'Donut';
  it.BitmapSize := it.Bitmap.Width;

  it := FChartType.Items.Add;
  it.Bitmap.LoadFromResource('TAdvChartToolBarPopupChartHalfDonut');
  it.Hint := 'HalfDonut';
  it.BitmapSize := it.Bitmap.Width;

  it := FChartType.Items.Add;
  it.Bitmap.LoadFromResource('TAdvChartToolBarPopupChartBand');
  it.Hint := 'Band';
  it.BitmapSize := it.Bitmap.Width;

  it := FChartType.Items.Add;
  it.Bitmap.LoadFromResource('TAdvChartToolBarPopupChartSpider');
  it.Hint := 'Spider';
  it.BitmapSize := it.Bitmap.Width;

  it := FChartType.Items.Add;
  it.Bitmap.LoadFromResource('TAdvChartToolBarPopupChartHalfSpider');
  it.Hint := 'Half Spider';
  it.BitmapSize := it.Bitmap.Width;

  it := FChartType.Items.Add;
  it.Bitmap.LoadFromResource('TAdvChartToolBarPopupChartVarRadiusPie');
  it.Hint := 'Variable Radius Pie';
  it.BitmapSize := it.Bitmap.Width;

  it := FChartType.Items.Add;
  it.Bitmap.LoadFromResource('TAdvChartToolBarPopupChartVarRadiusHalfPie');
  it.Hint := 'Variable Radius Half Pie';
  it.BitmapSize := it.Bitmap.Width;

  it := FChartType.Items.Add;
  it.Bitmap.LoadFromResource('TAdvChartToolBarPopupChartVarRadiusDonut');
  it.Hint := 'Variable Radius Donut';
  it.BitmapSize := it.Bitmap.Width;

  it := FChartType.Items.Add;
  it.Bitmap.LoadFromResource('TAdvChartToolBarPopupChartVarRadiusHalfDonut');
  it.Hint := 'Variable Radius Half Donut';
  it.BitmapSize := it.Bitmap.Width;

  it := FChartType.Items.Add;
  it.Bitmap.LoadFromResource('TAdvChartToolBarPopupChartSizedPie');
  it.Hint := 'Sized Pie';
  it.BitmapSize := it.Bitmap.Width;

  it := FChartType.Items.Add;
  it.Bitmap.LoadFromResource('TAdvChartToolBarPopupChartSizedHalfPie');
  it.Hint := 'Sized Half Pie';
  it.BitmapSize := it.Bitmap.Width;

  it := FChartType.Items.Add;
  it.Bitmap.LoadFromResource('TAdvChartToolBarPopupChartSizedDonut');
  it.Hint := 'Sized Donut';
  it.BitmapSize := it.Bitmap.Width;

  it := FChartType.Items.Add;
  it.Bitmap.LoadFromResource('TAdvChartToolBarPopupChartSizedHalfDonut');
  it.Hint := 'Sized Half Donut';
  it.BitmapSize := it.Bitmap.Width;

  it := FChartType.Items.Add;
  it.Bitmap.LoadFromResource('TAdvChartToolBarPopupChartDigitalLine');
  it.Hint := 'DigitalLine';
  it.BitmapSize := it.Bitmap.Width;

  it := FChartType.Items.Add;
  it.Bitmap.LoadFromResource('TAdvChartToolBarPopupChartXYDigitalLine');
  it.Hint := 'XY DigitalLine';
  it.BitmapSize := it.Bitmap.Width;

  it := FChartType.Items.Add;
  it.Bitmap.LoadFromResource('TAdvChartToolBarPopupChartBoxPlot');
  it.Hint := 'Boxplot';
  it.BitmapSize := it.Bitmap.Width;

  it := FChartType.Items.Add;
  it.Bitmap.LoadFromResource('TAdvChartToolBarPopupChartRenko');
  it.Hint := 'Renko';
  it.BitmapSize := it.Bitmap.Width;

  it := FChartType.Items.Add;
  it.Bitmap.LoadFromResource('TAdvChartToolBarPopupChartXYLine');
  it.Hint := 'XY Line';
  it.BitmapSize := it.Bitmap.Width;

  it := FChartType.Items.Add;
  it.Bitmap.LoadFromResource('TAdvChartToolBarPopupChartXYMarker');
  it.Hint := 'XY Markers';
  it.BitmapSize := it.Bitmap.Width;

  it := FChartType.Items.Add;
  it.Bitmap.LoadFromResource('TAdvChartToolBarPopupChartGantt');
  it.Hint := 'Gantt';
  it.BitmapSize := it.Bitmap.Width;

  it := FChartType.Items.Add;
  it.Bitmap.LoadFromResource('TAdvChartToolBarPopupChartFunnel');
  it.Hint := 'Funnel';
  it.BitmapSize := it.Bitmap.Width;
  ...
  it := FChartLineStyle.Items.Add;
  it.Bitmap.LoadFromResource('TAdvChartToolBarPopupLineSolid');
  it.Hint := 'Solid';
  it.BitmapSize := it.Bitmap.Width;

  it := FChartLineStyle.Items.Add;
  it.Bitmap.LoadFromResource('TAdvChartToolBarPopupLineDot');
  it.Hint := 'Dot';
  it.BitmapSize := it.Bitmap.Width;

  it := FChartLineStyle.Items.Add;
  it.Bitmap.LoadFromResource('TAdvChartToolBarPopupLineDash');
  it.Hint := 'Dash';
  it.BitmapSize := it.Bitmap.Width;

  it := FChartLineStyle.Items.Add;
  it.Bitmap.LoadFromResource('TAdvChartToolBarPopupLineDashDot');
  it.Hint := 'Dash Dot';
  it.BitmapSize := it.Bitmap.Width;

  it := FChartLineStyle.Items.Add;
  it.Bitmap.LoadFromResource('TAdvChartToolBarPopupLineDashDotDot');
  ...
  it := FChartMarker.Items.Add;
  it.Bitmap.LoadFromResource('TAdvChartToolBarPopupMarkerEllipse');
  it.Hint := 'Ellipse';
  it.Text := 'Ellipse';
  it.BitmapSize := it.Bitmap.Width;
  ...
  it := FChartMarker.Items.Add;
  it.Bitmap.LoadFromResource('TAdvChartToolBarPopupMarkerTriangle');
  it.Hint := 'Triangle';
  it.Text := 'Triangle';
  it.BitmapSize := it.Bitmap.Width;
  it.BitmapAlign := baLeft;
  ...
  it := FChartMarker.Items.Add;
  it.Bitmap.LoadFromResource('TAdvChartToolBarPopupMarkerSquare');
  it.Hint := 'Square';
  it.Text := 'Square';
  it.BitmapSize := it.Bitmap.Width;
  it.BitmapAlign := baLeft;
  ...
  it := FChartMarker.Items.Add;
  it.Bitmap.LoadFromResource('TAdvChartToolBarPopupMarkerDiamond');
  it.Hint := 'Diamond';
  it.Text := 'Diamond';
  it.BitmapSize := it.Bitmap.Width;
  it.BitmapAlign := baLeft;
  ...
  FChartMarkerFill.Bitmaps.AddBitmapFromResource('TAdvChartToolBarPopupMarkerFill');
  ...
  FChartLabels.Bitmaps.AddBitmapFromResource('TAdvChartToolBarPopupDataLabels');
