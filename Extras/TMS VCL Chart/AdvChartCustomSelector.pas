...
uses
  Classes, AdvChartTypes, AdvChartGraphics,
...
type
  ...
  TAdvChartCustomSelectorItems = class(TOwnedCollection)
  private
    FOwner: TAdvChartCustomSelector;
  ...
  TAdvChartCustomSelectorDisplayList = TList<TAdvChartCustomSelectorDisplayItem>;
  ...
  protected
    ...
    function GetDisplayItem(AItemIndex: Integer): TAdvChartCustomSelectorDisplayItem;
...
uses
  Math, AdvChartUtils, AdvChartStyles;
  ...
  begin
    ...
    begin
      if it.Separator then
        AGraphics.DrawLine(PointF(r.Left, r.CenterPoint.Y), PointF(r.Right, r.CenterPoint.Y))
      else
      begin
...
begin
  ...
  begin
    ...
    FFont.Assign((Source as TAdvChartCustomSelectorAppearance).Font);
  end;
end;
