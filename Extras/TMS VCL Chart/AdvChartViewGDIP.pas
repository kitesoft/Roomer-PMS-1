...
type
  ...
  protected
    ...
    procedure DrawPieSlice(Canvas: TCanvas; Center:  TPoint; Radius, centerh, centerv, indent: integer; StartAngle, SweepAngle: Double; PointIndex: integer; ScaleX, ScaleY: Double); override;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          r := Bounds(x, y, tw, th);
          DrawText(Canvas.Handle, pchar(str), Length(str), r, DT_SINGLELINE or DT_END_ELLIPSIS or DT_VCENTER)
        end;
      end;
    end;
    ft.Free;
...
procedure TAdvGDIPChartSerie.DrawPieSlice(Canvas: TCanvas; Center:  TPoint; Radius, centerh, centerv,
...
begin
  ...
  case ChartType of
    ...
    begin
      ...
      g.fillEllipse(b, xk1 - size / 2, yk1 - size / 2, size, size);
      g.DrawEllipse(p, xk1 - size / 2, yk1 - size / 2, size, size);

      g.fillEllipse(b, xk2 - size / 2, yk2 - size / 2, size, size);
      g.DrawEllipse(p, xk2 - size / 2, yk2 - size / 2, size, size);
