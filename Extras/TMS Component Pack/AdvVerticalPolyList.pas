...
type
  ...
  {$ENDIF}
  TAdvVerticalPolyList = class(TCustomItemsContainer)
  public
...
constructor TAdvVerticalPolyList.Create(AOwner: TComponent);
begin
  inherited;
  Columns := 1;
  Rows := 0;
