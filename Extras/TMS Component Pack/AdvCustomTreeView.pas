...
uses
  ...
  Windows,
  {$ENDIF}
  Classes, AdvPopupEx, AdvGraphics, AdvTypes,
  AdvTreeViewData, AdvTreeViewBase, SysUtils
  {$IFNDEF LCLLIB}
  ...
  ,Types
  {$IFDEF CMNLIB}
  ,Graphics, ExtCtrls, Controls, StdCtrls
  {$ENDIF}
  {$IFDEF DELPHIXE2_LVL}
  ,UITypes
  {$ENDIF}
  {$IFDEF FMXLIB}
  ,Graphics, UIConsts, FMX.Objects, Controls,
  FMX.Types, FMX.ListBox, FMX.Platform
  {$ENDIF}
  ;
...
type
  ...
  private
    ...
    FSortIndicatorColor: TAdvTreeViewColor;
    ...
    procedure SetSortIndicatorColor(const Value: TAdvTreeViewColor);
  protected
    procedure Changed(Sender: TObject);
  public
    constructor Create(ATreeView: TAdvCustomTreeView);
  ...
  published
    ...
    property SortIndicatorColor: TAdvTreeViewColor read FSortIndicatorColor write SetSortIndicatorColor default TAdvTreeViewColorSelection;
  end;
  ...
  TAdvTreeViewBeforeDrawSortIndicatorEvent = procedure(Sender: TObject; ACanvas: TCanvas; ARect: TRectF; AColumn: Integer; ASortIndex: Integer; ASortKind: TAdvTreeViewNodesSortKind; var ADefaultDraw: Boolean) of object;
  TAdvTreeViewAfterDrawSortIndicatorEvent = procedure(Sender: TObject; ACanvas: TCanvas; ARect: TRectF; AColumn: Integer; ASortIndex: Integer; ASortKind: TAdvTreeViewNodesSortKind) of object;
  ...
  TAdvTreeViewRect = TRectF;
  {$ENDIF}
  {$IFDEF CMNLIB}
  TAdvTreeViewInplaceEditor = TWinControl;
  TAdvTreeViewRect = TRect;
  {$ENDIF}
  ...
  TAdvTreeViewGetInplaceEditorRectEvent = procedure(Sender: TObject; ANode: TAdvTreeViewVirtualNode; AColumn: Integer; AInplaceEditor: TAdvTreeViewInplaceEditor; var AInplaceEditorRect: TAdvTreeViewRect) of object;
  ...
  TAdvTreeViewAfterOpenInplaceEditorEvent = procedure(Sender: TObject; ANode: TAdvTreeViewVirtualNode; AColumn: Integer; AInplaceEditor: TAdvTreeViewInplaceEditor; AInplaceEditorRect: TAdvTreeViewRect) of object;
  ...
  TAdvTreeViewBeforeReorderNode = procedure(Sender: TObject; AFromNode, AToNode: TAdvTreeViewVirtualNode; var ACanReorder: Boolean) of object;
  TAdvTreeViewAfterReorderNode = procedure(Sender: TObject; AFromNode, AToNode: TAdvTreeViewVirtualNode) of object;
  TAdvTreeViewBeforeDropNode = procedure(Sender: TObject; AFromNode, AToNode: TAdvTreeViewVirtualNode; var ACanDrop: Boolean) of object;
  TAdvTreeViewAfterDropNode = procedure(Sender: TObject; AFromNode, AToNode: TAdvTreeViewVirtualNode) of object;
  TAdvTreeViewBeforeCopyToClipboard = procedure(Sender: TObject; var ACanCopy: Boolean) of object;
  TAdvTreeViewBeforeCutToClipboard = procedure(Sender: TObject; var ACanCut: Boolean) of object;
  TAdvTreeViewBeforePasteFromClipboard = procedure(Sender: TObject; var ACanPaste: Boolean) of object;
  TAdvTreeViewAfterCopyToClipboard = procedure(Sender: TObject) of object;
  TAdvTreeViewAfterCutToClipboard = procedure(Sender: TObject) of object;
  TAdvTreeViewAfterPasteFromClipboard = procedure(Sender: TObject) of object;
  ...
  private
    ...
    FDragBitmap: TImage;
    FReorderMode, FDragMode: Boolean;
    FSortColumn: Integer;
    FClosing: Boolean;
    ...
    FSizeColumn, FDownColumn, FDownColumnFilter: Integer;
    ...
    FOnBeforeReorderNode: TAdvTreeViewBeforeReorderNode;
    FOnAfterReorderNode: TAdvTreeViewAfterReorderNode;
    FOnAfterDropNode: TAdvTreeViewAfterDropNode;
    FOnBeforeDropNode: TAdvTreeViewBeforeDropNode;
    FOnAfterCutToClipboard: TAdvTreeViewAfterCutToClipboard;
    FOnBeforePasteFromClipboard: TAdvTreeViewBeforePasteFromClipboard;
    FOnBeforeCopyToClipboard: TAdvTreeViewBeforeCopyToClipboard;
    FOnAfterPasteFromClipboard: TAdvTreeViewAfterPasteFromClipboard;
    FOnBeforeCutToClipboard: TAdvTreeViewBeforeCutToClipboard;
    FOnAfterCopyToClipboard: TAdvTreeViewAfterCopyToClipboard;
  ...
  protected
    ...
    procedure DoBeforeDrawSortIndicator(ACanvas: TCanvas; ARect: TRectF; AColumn: Integer; ASortIndex: Integer; ASortKind: TAdvTreeViewNodesSortKind; var ADefaultDraw: Boolean);
    procedure DoAfterDrawSortIndicator(ACanvas: TCanvas; ARect: TRectF; AColumn: Integer; ASortIndex: Integer; ASortKind: TAdvTreeViewNodesSortKind);
    ...
    procedure DoAfterOpenInplaceEditor(ANode: TAdvTreeViewVirtualNode; AColumn: Integer; AInplaceEditor: TAdvTreeViewInplaceEditor; AInplaceEditorRect: TAdvTreeViewRect); virtual;
    ...
    procedure HandleDragOver(const Source: TObject; const Point: TPointF; var Accept: Boolean); virtual;
    procedure HandleDragDrop(const Source: TObject; const Point: TPointF); virtual;
    ...
    {$IFDEF FMXLIB}
    function GetDragObjectScreenShot: TBitmap; virtual;
    ...
    function GetInplaceEditorRect(ANode: TAdvTreeViewVirtualNode; AColumn: Integer): TAdvTreeViewRect;
    ...
    property OnBeforeCutToClipboard: TAdvTreeViewBeforeCutToClipboard read FOnBeforeCutToClipboard write FOnBeforeCutToClipboard;
    property OnBeforeCopyToClipboard: TAdvTreeViewBeforeCopyToClipboard read FOnBeforeCopyToClipboard write FOnBeforeCopyToClipboard;
    property OnBeforePasteFromClipboard: TAdvTreeViewBeforePasteFromClipboard read FOnBeforePasteFromClipboard write FOnBeforePasteFromClipboard;
    property OnAfterCutToClipboard: TAdvTreeViewAfterCutToClipboard read FOnAfterCutToClipboard write FOnAfterCutToClipboard;
    property OnAfterCopyToClipboard: TAdvTreeViewAfterCopyToClipboard read FOnAfterCopyToClipboard write FOnAfterCopyToClipboard;
    property OnAfterPasteFromClipboard: TAdvTreeViewAfterPasteFromClipboard read FOnAfterPasteFromClipboard write FOnAfterPasteFromClipboard;

    property OnBeforeReorderNode: TAdvTreeViewBeforeReorderNode read FOnBeforeReorderNode write FOnBeforeReorderNode;
    property OnAfterReorderNode: TAdvTreeViewAfterReorderNode read FOnAfterReorderNode write FOnAfterReorderNode;
    property OnBeforeDropNode: TAdvTreeViewBeforeDropNode read FOnBeforeDropNode write FOnBeforeDropNode;
    property OnAfterDropNode: TAdvTreeViewAfterDropNode read FOnAfterDropNode write FOnAfterDropNode;
  ...
  public
    ...
    function XYToColumn(X, Y: Single): Integer; virtual;
...
uses
  Math{$IFNDEF LCLLIB}, Rtti{$ENDIF}
  {$IFDEF FMXLIB}
  ,FMX.Styles.Objects, FMX.Edit, FMX.Memo, Forms, Character
  {$ENDIF}
  {$IFDEF CMNLIB}
  ,Forms, PngImage, Clipbrd
  {$ENDIF}
  ;
...
function TAdvCustomTreeView.LocalToScreenEx(APoint: TPointF): TPointF;
{$IFDEF CMNLIB}
var
  pt: TPoint;
{$ENDIF}
...
{$IFDEF FMXLIB}
function GetParentForm(AControl: TFMXObject): TCustomForm;
var
  c: TFMXObject;
begin
  Result := nil;
...
begin
  ...
  if TPlatformServices.Current.SupportsPlatformService(IFMXScreenService, IInterface(ScreenSvc)) then
    Result := ScreenSvc.GetScreenScale > 1;
  {$ENDIF}
  {$IFDEF CMNLIB}
  {$IFNDEF LCLLIB}
  if Assigned(Application.MainForm) and Assigned(Application.MainForm.Canvas) then
    Result := CalculateDPIScale(Application.MainForm, Application.MainForm.Canvas.Handle) > 1;
  {$ENDIF}
  {$ENDIF}
end;
...
begin
  ...
  if Assigned(Result) and IsVirtualNodeSelectable(Result) and AAutoSelect then
  begin
    if AAutoExpand then
    begin
      n := Result.GetParent;
...
begin
  {$IFDEF FMXLIB}
  if not FClipboardSvc.GetClipboard.IsEmpty then
  begin
    s := FClipboardSvc.GetClipboard.AsString;
  {$ENDIF}
  {$IFDEF CMNLIB}
  ...
  try
    ...
    begin
      ...
      if Assigned(FClipboardSvc) then
        FClipboardSvc.SetClipboard(CLP_FMT + s);
      {$ENDIF}
      {$IFDEF CMNLIB}
      ClipBoard.AsText := CLP_FMT + s;
      {$ENDIF}
    end;
  finally
    cl.Free;
...
begin
  ...
  {$IFDEF FMXLIB}
  {$IFDEF DELPHIXE6_LVL}
  while ABuffer[Pos{$IFDEF DELPHI_LLVM}-1{$ENDIF}].IsInArray([' ', #9]) do
  {$ELSE}
  while (CharInSet(ABuffer[Pos{$IFDEF DELPHI_LLVM}-1{$ENDIF}], [' ', #9])) do
  {$ENDIF}
  {$ENDIF}
  {$IFDEF CMNLIB}
  {$IFDEF LCLLIB}
  while (ABuffer[Pos{$IFDEF DELPHI_LLVM}-1{$ENDIF}] in [' ', #9]) do
  {$ELSE}
  while (CharInSet(ABuffer[Pos{$IFDEF DELPHI_LLVM}-1{$ENDIF}], [' ', #9])) do
  {$ENDIF}
  {$ENDIF}
...
procedure TAdvCustomTreeView.DoAfterDrawSortIndicator(
  ACanvas: TCanvas; ARect: TRectF; AColumn: Integer; ASortIndex: Integer;
  ASortKind: TAdvTreeViewNodesSortKind);
begin
  if Assigned(OnAfterDrawSortIndicator) then
    OnAfterDrawSortIndicator(Self, ACanvas, ARect, AColumn, ASortIndex, ASortKind);
end;
...
procedure TAdvCustomTreeView.DoAfterOpenInplaceEditor(
  ...
  AInplaceEditor: TAdvTreeViewInplaceEditor; AInplaceEditorRect: TAdvTreeViewRect);
begin
...
begin
  if Assigned(OnBeforeDrawSortIndicator) then
    OnBeforeDrawSortIndicator(Self, ACanvas, ARect, AColumn, ASortIndex, ASortKind, ADefaultDraw);
end;
...
begin
  ...
  begin
    ...
    if (FY >= contentr.Top + contentr.Height) then
    begin
      FDragRow := FDragRow + 1;
...
begin
  ...
  for I := SelectedVirtualNodeCount - 1 downto 0 do
    RemoveVirtualNode(SelectedVirtualNodes[I]);
  EndUpdate;
end;
    ...
    begin
      ...
      begin
        ...
        if ACol <= Length(v.BitmapRects) - 1 then
          rcalc.Width := rcalc.Width + v.BitmapRects[ACol].Right + hs - colps + 3;
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        CreateDragBitmap;
        {$IFDEF FMXLIB}
        FSaveDragY := FDragBitmap.Position.Y;
        {$ELSE}
  ...
  begin
    {$IFDEF FMXLIB}
    if TPlatformServices.Current.SupportsPlatformService(IFMXDragDropService, IInterface(Svc)) then
    begin
      ...
      try
        ...
        Svc.BeginDragDrop(GetParentForm(Self), DragData, DragImage);
      finally
        DragImage.Free;
      end;
    end;
...
begin
  ...
  begin
    ...
    if (newposy <= r.Top + r.Height - FDragBitmap.Height) and (newposy >= r.Top) then
    begin
      {$IFDEF FMXLIB}
      FDragBitmap.Position.Y := Round(Max(r.Top, Min(r.Top + r.Height - FDragBitmap.Height, newposy)));
      FSaveDragY := FDragBitmap.Position.Y;
      {$ENDIF}
      {$IFDEF CMNLIB}
      FDragBitmap.Top := Round(Max(r.Top, Min(r.Top + r.Height - FDragBitmap.Height, newposy)));
      FSaveDragY := FDragBitmap.Top;
      {$ENDIF}
      FDragTimer.Enabled := False;
      if (newposy > r.Top) and (newposy < r.Top + r.Width) then
      begin
        n := XYToNode(r.Width / 2, newposy);
        if Assigned(n) then
          FDragRow := n.Row;
      end;
    end
    else if (newposy > r.Top + r.Height - FDragBitmap.Height) then
    begin
      {$IFDEF FMXLIB}
      FDragBitmap.Position.Y := Round(r.Top + r.Height - FDragBitmap.Height);
      {$ENDIF}
      {$IFDEF CMNLIB}
      FDragBitmap.Top := Round(r.Top + r.Height - FDragBitmap.Height);
      {$ENDIF}
      FSaveDragY := newposy;
    ...
    begin
      {$IFDEF FMXLIB}
      FDragBitmap.Position.Y := Round(r.Top);
      {$ENDIF}
      {$IFDEF CMNLIB}
...
begin
  ...
  else if not FReorderMode and not FDragMode then
  begin
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            begin
              if not (ssCtrl in Shift) and not (ssCommand in Shift) and (FSelectedNodes.Count > 0) then
                UnSelectVirtualNode(FDownNode);

              HandleSelectNode(FDownNode, True, False, {$IFNDEF FMXMOBILE}((ssCtrl in Shift) or (ssCommand in Shift)) and {$ENDIF} Interaction.MultiSelect);
            end;
          end;
...
begin
  ...
  FDragBitmap := TImage.Create(Self);
  FDragBitmap.Width := Round(dr.Width - NodesAppearance.ExpandWidth - 4) + 2;
  FDragBitmap.Height := Round(dr.Height) + 2;
  {$IFDEF FMXLIB}
  FDragBitmap.HitTest := False;
  FDragBitmap.Position.X := Round(dr.Left + NodesAppearance.ExpandWidth + 4);
  FDragBitmap.Position.Y := Round(dr.Top);
  {$ENDIF}
  {$IFDEF CMNLIB}
  FDragBitmap.Left := Round(dr.Left + NodesAppearance.ExpandWidth + 4);
  FDragBitmap.Top := Round(dr.Top);
  {$ENDIF}

  g := TAdvGraphics.CreateBitmapCanvas(Round(FDragBitmap.Width), Round(FDragBitmap.Height));
  g.PictureContainer := PictureContainer;
  bmp := MakeScreenshot;
  try
    g.BeginScene;
    g.DrawRectangle(0, 0, FDragBitmap.Width, FDragBitmap.Height);
    {$IFDEF FMXLIB}
    g.DrawBitmapPart(FDragBitmap.Position.X, FDragBitmap.Position.Y, FDragBitmap.Position.X + FDragBitmap.Width - 2, FDragBitmap.Position.Y + FDragBitmap.Height - 2, 0, 0, FDragBitmap.Width, FDragBitmap.Height, BitmapToDrawBitmap(bmp));
    {$ENDIF}
    {$IFDEF CMNLIB}
    g.DrawBitmapPart(FDragBitmap.Left, FDragBitmap.Top, FDragBitmap.Left + FDragBitmap.Width - 2, FDragBitmap.Top + FDragBitmap.Height - 2, 0, 0, FDragBitmap.Width, FDragBitmap.Height, BitmapToDrawBitmap(bmp));
    {$ENDIF}
    g.EndScene;
    {$IFDEF FMXLIB}
    FDragBitmap.Bitmap.Assign(g.Bitmap);
    {$ENDIF}
    {$IFDEF CMNLIB}
    FDragBitmap.Picture.Assign(g.Bitmap);
    {$ENDIF}
  finally
    bmp.Free;
    g.Free;
...
begin
  ...
  if Assigned(c) then
  begin
    if not XYToNodeExpand(c, pf.X, pf.Y) then
    begin
      FDownNode := c;
      if Assigned(FDownNode) then
      begin
        ...
        begin
          ext := False;
          DoIsNodeExtended(FDownNode, ext);
          if ((ext and Interaction.ExtendedSelectable and Interaction.ExtendedEditable) or not ext) and (Interaction.MouseEditMode = tmemDoubleClick) and not Interaction.ReadOnly then
          begin
...
begin
  ...
  begin
    ...
    begin
      ...
      szd := 15;
      fr := RectF(Round(r.Right - szd - 4), Round(r.Top + (r.Height - szd) / 2), Round(r.Right - 4), Round(r.Top + (r.Height - szd) / 2 + szd));

      pt := LocalToScreenEx(PointF(fr.Left + fr.Width - 17, fr.Top + (fr.Height + 15) / 2));
...
begin
  ...
  begin
    ...
    begin
      ...
      if (dn <> dragn) and Assigned(dragn.Node) then
      begin
        b := True;
...
{$IFDEF FMXLIB}
function TAdvCustomTreeView.GetDragObjectScreenShot: TBitmap;
begin
  CreateDragBitmap;
  Result := TBitmap.Create;
  if Assigned(FDragBitmap) then
  begin
    Result.Assign(FDragBitmap.Bitmap);
    FDragBitmap.Free;
    FDragBitmap := nil;
  end;
end;
...
function TAdvCustomTreeView.GetInplaceEditorRect(
  ANode: TAdvTreeViewVirtualNode; AColumn: Integer): TAdvTreeViewRect;
var
  cr, r: TRectF;
begin
  {$IFDEF CMNLIB}
...
procedure TAdvCustomTreeView.Sort(AColumn: Integer = 0; ARecurse: Boolean = False; ACaseSensitive: Boolean = True;
    ...
    begin
      ...
      begin
        ...
        begin
         ...
         HandleSelectNode(sel, True, True, {$IFNDEF DELPHI_LLVM}((ssCtrl in Shift) or (ssCommand in Shift)) and {$ENDIF} Interaction.MultiSelect);
    end
    else if spc then
...
procedure TAdvCustomTreeView.SetSelectedNode(const Value: TAdvTreeViewNode);
begin
...
function TAdvCustomTreeView.XYToColumn(X, Y: Single): Integer;
var
  I: Integer;
  topr: TRectF;
  r: TRectF;
...
begin
  FTreeView := ATreeView;
  FLayouts := [tclTop];
  FSortIndicatorColor := TAdvTreeViewColorSelection;
