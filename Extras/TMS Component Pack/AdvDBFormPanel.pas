...
const
  ...
  // v1.0.1.2 : Fixed : Issue with dataset post after closing editing
  // v1.0.1.3 : Fixed : Issue with BorderColor = clNone
  // v1.0.2.0 : New : dcEditComboBox control type added
...
uses
  ...
  AdvDatetimePicker, DBAdvEd, DBAdvSp, AdvDBDateTimePicker, DBAdvGDIPPicture, DBAdvLabel, AdvDBFormComboBox;
...
procedure TAdvDBFormPanel.LabelCreated(Sender: TObject; ALayoutItem: TLayoutItem; AControl: TControl;
...
begin
  ...
  FLayouter.LabelClass := TStaticText;
  InitClassMap(dbsTMS);
  ...
  case ControlSet of
    dbsTMS:
      begin
        ...
        FLayouter.AddClassMap(dcEditComboBox, TDBComboBox);
      end;
    dbsVCL:
      begin
        FLayouter.ClearClassMap;
...
procedure TAdvDBFormBox.DoPanelLabelCreated(Sender: TObject;
