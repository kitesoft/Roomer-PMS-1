...
const
  ...
  // 1.3.3.11: Fixed : Issue when using VCL Themes and changing themes at runtime
  // 1.3.3.12: Improved : Handling of high DPI mode
...
implementation
uses
  CommCtrl, Shellapi, SysUtils, ShlObj, ActiveX, ImgList, Math, Variants;
...
procedure TParamTreeview.CreateSubControls;
begin
...
procedure TParamTreeview.DestroySubControls;
begin
  FParamPopup.Free;
  FParamList.Free;
...
procedure TParamTreeview.DestroyWnd;
begin
  DestroySubControls;
  inherited;
end;
