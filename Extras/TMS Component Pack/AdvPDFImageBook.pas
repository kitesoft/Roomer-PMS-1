...
type
  ...
  TAdvPDFImageBookPageInfoEvent = procedure(Sender: TObject; PageIndex: integer; var Header, Footer: string) of object;
  ...
  protected
    procedure DoGetPageInfo(PageIndex: integer; var Header, Footer: string); virtual;
  ...
  public
    ...
    property PageNumberFormat: string read FPageNumberFormat write FPageNumberFormat;
