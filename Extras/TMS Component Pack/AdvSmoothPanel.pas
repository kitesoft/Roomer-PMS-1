...
const
  ...
  // v1.5.2.0 : New : OnAnchorHint event
  // v1.5.2.1 : Fixed : Issue with new Anchor hint implementation
...
type
  ...
  TAdvSmoothPanelAnchorHintEvent = procedure (Sender: TObject; var Anchor: string) of object;
  ...
  private
    ...
    FOnAnchorHint: TAdvSmoothPanelAnchorHintEvent;
    FAnchorHint: Boolean;
  ...
  public
    ...
    function GetCaptionHeight: Single;
  ...
  published
    ...
    property OnAnchorHint: TAdvSmoothPanelAnchorHintEvent read FOnAnchorHint write FOnAnchorHint;
...
Begin
  ...
  if FAnchorHint then
  begin
    anchor := GetAnchorAt(hi^.cursorPos.x, hi^.cursorpos.y, False);
    if (anchor <> '') then
    begin
...
function TAdvSmoothPanel.GetCaptionHeight: Single;
var
  r,tr: TGPRectF;
  th, tw, x, y: Integer;
  ff: TGPFontFamily;
...
begin
  ...
  begin
    ...
    if FAnchorHint and (a <> FOldAnchor) then
