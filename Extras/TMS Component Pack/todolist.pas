...
{$ENDIF}
  ...
  // 1.5.3.0 : New : Event OnDrawItemProp added
...
//    procedure WMPaint(var Message: TWMPaint); message WM_PAINT;
  ...
  TDrawItemPropEvent = procedure(Sender: TObject; Index,Col: integer; ABrush: TBrush; APen: TPen; AFont: TFont) of object;
...
{$ENDIF}
  ...
  protected
    ...
    procedure Notification(AComponent: TComponent; AOperation: TOperation); override;
    procedure DoDrawItemProp(Index,Col: integer; ABrush: TBrush; APen: TPen; AFont: TFont);
...
*)
  ...
  begin
    ...
    FOwner.DoDrawItemProp(Index,Col, ACanvas.Brush, ACanvas.Pen, ACanvas.Font);
...
procedure TCustomTodoList.DoDrawItemProp(Index, Col: integer; ABrush: TBrush;
  APen: TPen; AFont: TFont);
begin
  if Assigned(OnDrawItemProp) then
    OnDrawItemProp(Self, Index, Col, ABrush, APen, AFont);
end;
...
function TCustomTodoList.GetComponentStyle: TTMSStyle;
begin
  Result := FStyle;
end;
