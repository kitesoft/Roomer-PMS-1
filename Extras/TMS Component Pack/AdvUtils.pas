...
uses
  ...
  Windows,
  {$ENDIF}
  Classes, SysUtils, Types, AdvTypes, Controls,
  Graphics, Forms
  {$IFDEF FMXLIB}
...
class function TAdvUtils.SaveFile(var AFileName: string; const AFilter: string = ''): Boolean;
{$IFNDEF DELPHI_LLVM}
var
  s: TSaveDialog;
  ext: string;
...
class function TAdvUtils.SelectFile(var AFileName: string; const ADefaultFolder: string = ''; const AFilter: string = ''): Boolean;
{$IFNDEF DELPHI_LLVM}
var
  o: TOpenDialog;
{$ENDIF}
...
class function TAdvUtils.MessageDlg(const AMessage: string; const ADialogType: TMsgDlgType; const AButtons: TMsgDlgButtons; const AHelpContext: LongInt): Integer;
begin
  {$IFDEF DELPHI_LLVM}
  Result := mrOk;
  {$ELSE}
...
class function TAdvUtils.GetDPIScale: Single;
{$IFDEF FMXLIB}
var
...
class procedure TAdvUtils.OpenFile(AFile: string);
{$IFDEF ANDROID}
var
  i: JIntent;
  t: string;
