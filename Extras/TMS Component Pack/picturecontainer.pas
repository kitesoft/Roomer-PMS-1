...
type
  ...
  public
    ...
    function FindBitmap(s: string): TPicture; virtual;
  published
    { Published declarations }
...
procedure TPictureContainer.Changed;
var
  i: integer;
  ctrl: TControl;
begin
  ...
  begin
    ctrl := TControl(FControls.Items[i]);
    ctrl.Invalidate;
  end;
...
function TPictureContainer.FindBitmap(s: string): TPicture;
var
  i: Integer;
begin
  Result := nil;
  ...
  begin
    ...
    begin
      ...
      Result := FPicture;
      Result.Assign(Items.Items[i - 1].Picture as TGraphic);
      Break;
    end;
    Inc(i);
  end;
...
begin
  ...
  begin
    ...
    begin
      Result := Items[i - 1].Picture as TGraphic;
      Break;
    end;
    Inc(i);
  end;
...
procedure TPictureContainer.Notification(AComponent: TComponent;
...
begin
  ...
  begin
    ...
    begin
      if TControl(FControls.Items[i]) = AComponent then
        FControls.Delete(i);
    end;
  end;
end;

procedure TPictureContainer.RegisterControl(AControl: TControl);
begin
  FControls.Add(Pointer(AControl));
end;
