...
const
  ...
  // v3.4.1.0 : New : DisabledTextColor property added in TAdvEdit
...
type
  ...
  protected
    ...
    function CreateLabel: TAdvEditLabel;
  ...
  public
    ...
    property EditLabel: TAdvEditLabel read FLabel;
...
class function TAdvEdit.HexToInt(s: string): Integer;
var
  i: Integer;
  r, m: Integer;
...
function TAdvEdit.CreateLabel: TAdvEditLabel;
begin
  Result := TAdvEditLabel.Create(self);
...
begin
  ...
  Height := Round(FLoadedHeight * CalculateDPIScale);
...
procedure TAdvEdit.SetDisabledTextColor(const Value: TColor);
begin
...
function TAdvEdit.GetValue: variant;
begin
...
procedure TAdvEdit.SetValue(const Value: variant);
begin
  Text := Value;
end;
...
procedure TAdvEditLabel.CMEnabledChanged(var Msg: TMessage);
begin
  inherited;
