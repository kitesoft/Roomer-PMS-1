...
const
  ...
  // v1.9.0.1 : Fixed : Issue with transparent background drawing
  // v1.9.0.2 : Fixed : Performance issues with transparent background drawing
...
begin
  chk := (Appearance.Transparent = false) and (Appearance.BackGroundFill.Opacity = 255) and (Appearance.BackGroundFill.OpacityTo = 255)
    and (Appearance.BackGroundFill.OpacityMirror = 255) and (Appearance.BackGroundFill.OpacityMirrorTo = 255) and (Appearance.BackGroundFill.Rounding = 0);
