    ...
    begin
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            begin
              HotSpot := True;
              if (YPos > cr.Top) and (YPos < cr.Top + h + 5) then
              begin
      ...
      begin
        ...
        begin
          ...
          'H':begin
                if not Calc and (Upcase(s[4]) = 'I') then
                begin
...
begin
  ...
  begin
    repeat
      ...
      if TagReplacestring('&acirc;','â',s) then Foundtag := True;
      if TagReplacestring('&agrave;','à',s) then Foundtag := True;
      if TagReplacestring('&eacute;','é',s) then Foundtag := True;
      if TagReplacestring('&ecirc;','ê',s) then Foundtag := True;
      if TagReplacestring('&egrave;','è',s) then Foundtag := True;
      if TagReplacestring('&euml;','ë',s) then Foundtag := True;
      if TagReplacestring('&icirc;','î',s) then Foundtag := True;
      if TagReplacestring('&iuml;','ï',s) then Foundtag := True;
      if TagReplacestring('&ocirc;','ô',s) then Foundtag := True;
      if TagReplacestring('&oelig;','œ',s) then Foundtag := True;
      if TagReplacestring('&ucirc;','û',s) then Foundtag := True;
      if TagReplacestring('&ugrave;','ù',s) then Foundtag := True;
      if TagReplacestring('&uuml;','ü',s) then Foundtag := True;
      if TagReplacestring('&ccedil;','ç',s) then Foundtag := True;
