...
uses
  Windows, Classes, Graphics, Forms, Controls, Messages, ImgList, Math, Types
  {$IFDEF DELPHIXE2_LVL}
  , System.UITypes
  {$ENDIF}
  ;
...
type
  ...
  private
    ...
    function CalcTabPositions(Start, Stop: Integer; Canvas: TCanvas; First: Integer): Integer;
...
//------------------------------------------------------------------------------
procedure TAdvCustomTabSet.ActiveFontChanged(Sender: TObject);
begin
  Invalidate;
end;
