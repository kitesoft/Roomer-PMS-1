...
uses
  Classes, Types, AdvGraphics, PictureContainer, AdvTypes, Graphics
  {$IFNDEF LCLLIB}
...
{$ENDIF}
  ...
  public
    ...
    function FinishContentStream(APageContentLengthReference: String): TStringStream;
...
function TAdvPDFGraphicsLibOutputWriter.FinishContentStream(APageContentLengthReference: String): TStringStream;
var
  ls: Integer;
begin
  Result := nil;
  ...
  begin
    ...
    try
      ...
      FContentStream.Free;
      FContentStream := nil;
      ReplaceString(APageContentLengthReference, '/Length ' + IntToStr(ls) + '/Filter/FlateDecode');
    finally
    end;
  end
  else if Assigned(FStream) then
    ReplaceString(APageContentLengthReference, '');
end;
