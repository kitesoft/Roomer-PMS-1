...
const
  ...
  // 1.3.3.5 : Fixed : Issue when using VCL Themes and changing themes at runtime
  // 1.3.3.6 : Improved : Handling of high DPI mode
...
type
  ...
  protected
    ...
    procedure ControlUpdateInt(Sender: TObject; Param,Text:string); virtual;
  ...
  public
    ...
    procedure ControlUpdate(Param, Text: string);
...
uses
  Consts, Shellapi, ShlObj, ActiveX, ImgList, CommCtrl, Variants;
...
procedure TParamCheckList.CreateSubControls;
begin
...
procedure TParamCheckList.DestroySubControls;
begin
  FParamPopup.Free;
  FParamList.Free;
...
begin
  ...
  begin
    ...
    begin
      ...
      FParamlist.OnUpdate := ControlUpdateInt;
  ...
  begin
    ...
    FParamDatePicker.OnUpdate := ControlUpdateInt;
  ...
  begin
    ...
    FParamSpinEdit.OnUpdate := ControlUpdateInt;
  ...
  begin
    ...
    FParamEdit.OnUpdate := ControlUpdateInt;
  ...
  begin
    ...
    FParamMaskEdit.OnUpdate := ControlUpdateInt;
...
procedure TParamCheckList.ControlUpdate(Param, Text: string);
begin
  ControlUpdateInt(Self, Param, Text);
end;


procedure TParamCheckList.ControlUpdateInt(Sender: TObject; Param,
  Text: string);
var
  s: string;
begin
