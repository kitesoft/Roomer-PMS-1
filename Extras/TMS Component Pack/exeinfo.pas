...
const
  ...
  // 1.3.4.1 : Fixed : Issue with Windows 10 anniversary edition detection
  // 1.4.0.0 : New : LinkerDateTime function added
...
type
  ...
  public
    ...
    function LinkerDateTime: TDateTime;
...
function TExeInfo.LinkerDateTime: TDateTime;
var
  LI: TLoadedImage;
  s: ansistring;
begin
  s := ansistring(Application.ExeName);
  Win32Check(MapAndLoad(PAnsiChar(s), nil, @LI, False, True));
