...
const
  ...
  // 1.2.0.1 : Fixed : Issue with gradient drawing
  // 1.2.0.2 : Fixed : Issue with roundrect shape and gradients
...
begin
  ...
  begin
    ...
    begin
      ...
      ri := Round((i + 1) * rstepw) + 1;

      if Direction then
      begin
        Rectangle(le - 1, R.Top, ri, R.Bottom);
        le := ri;
      end
      else
      begin
        Rectangle(R.Left, le, R.Right, ri);
        le := ri;
      end;
    end;
  end;
