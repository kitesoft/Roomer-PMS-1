...
uses
  ...
  ,AdvPDFRichTextLib, AdvPDFCoreLibBase, AdvPDFGraphicsLibHTMLEngine, AdvGraphics, AdvUtils,
  PictureContainer
  {$IFNDEF LCLLIB}
  ,Types
  {$HINTS OFF}
...
type
  ...
  protected
    ...
    procedure DrawImageWithName(ABitmapName: string; Point: TPointF; ImageType: TAdvPDFGraphicsLibImageType = itOriginal; Quality: Single = 1.0); overload;
    procedure DrawImageWithName(ABitmapName: string; Rect: TRectF; Stretch: Boolean = True; AspectRatio: Boolean = True; ImageType: TAdvPDFGraphicsLibImageType = itOriginal; Quality: Single = 1.0); overload;
    procedure DrawImage(ABitmap: TAdvBitmap; Point: TPointF; ImageType: TAdvPDFGraphicsLibImageType = itOriginal; Quality: Single = 1.0); overload;
    procedure DrawImage(ABitmap: TAdvBitmap; Rect: TRectF; Stretch: Boolean = True; AspectRatio: Boolean = True; ImageType: TAdvPDFGraphicsLibImageType = itOriginal; Quality: Single = 1.0); overload;
    procedure DrawImageFromFile(AFileName: String; Point: TPointF; ImageType: TAdvPDFGraphicsLibImageType = itOriginal; Quality: Single = 1.0); overload;
    procedure DrawImageFromFile(AFileName: String; Rect: TRectF; Stretch: Boolean = True; AspectRatio: Boolean = True; ImageType: TAdvPDFGraphicsLibImageType = itOriginal; Quality: Single = 1.0); overload;
    procedure DrawImageWithName(ABitmapName: string; ABackgroundColor: TAdvGraphicsColor; Point: TPointF; ImageType: TAdvPDFGraphicsLibImageType = itOriginal; Quality: Single = 1.0); overload;
    procedure DrawImageWithName(ABitmapName: string; ABackgroundColor: TAdvGraphicsColor; Rect: TRectF; Stretch: Boolean = True; AspectRatio: Boolean = True; ImageType: TAdvPDFGraphicsLibImageType = itOriginal; Quality: Single = 1.0); overload;
    procedure DrawImage(ABitmap: TAdvBitmap; ABackgroundColor: TAdvGraphicsColor; Point: TPointF; ImageType: TAdvPDFGraphicsLibImageType = itOriginal; Quality: Single = 1.0); overload;
    procedure DrawImage(ABitmap: TAdvBitmap; ABackgroundColor: TAdvGraphicsColor; Rect: TRectF; Stretch: Boolean = True; AspectRatio: Boolean = True; ImageType: TAdvPDFGraphicsLibImageType = itOriginal; Quality: Single = 1.0); overload;
    procedure DrawImageFromFile(AFileName: String; ABackgroundColor: TAdvGraphicsColor; Point: TPointF; ImageType: TAdvPDFGraphicsLibImageType = itOriginal; Quality: Single = 1.0); overload;
    procedure DrawImageFromFile(AFileName: String; ABackgroundColor: TAdvGraphicsColor; Rect: TRectF; Stretch: Boolean = True; AspectRatio: Boolean = True; ImageType: TAdvPDFGraphicsLibImageType = itOriginal; Quality: Single = 1.0); overload;
...
procedure TAdvGeneralPDFGraphicsLib.DrawImageFromFile(AFileName: String; ABackgroundColor: TAdvGraphicsColor; Point: TPointF; ImageType: TAdvPDFGraphicsLibImageType = itOriginal; Quality: Single = 1.0);
var
  bmp: TAdvBitmap;
begin
...
procedure TAdvGeneralPDFGraphicsLib.DrawImage(ABitmap: TAdvBitmap; ABackgroundColor: TAdvGraphicsColor; Point: TPointF; ImageType: TAdvPDFGraphicsLibImageType; Quality: Single);
var
  br: String;
  pt: TPointF;
  sz: TSizeF;
...
procedure TAdvGeneralPDFGraphicsLib.DrawImage(ABitmap: TAdvBitmap; ABackgroundColor: TAdvGraphicsColor; Rect: TRectF; Stretch, AspectRatio: Boolean; ImageType: TAdvPDFGraphicsLibImageType; Quality: Single);
var
  br: String;
  pt: TPointF;
  sz: TSizeF;
...
procedure TAdvGeneralPDFGraphicsLib.DrawImage(ABitmap: TAdvBitmap;
  Point: TPointF; ImageType: TAdvPDFGraphicsLibImageType; Quality: Single);
begin
  DrawImage(ABitmap, gcWhite, Point, ImageType, Quality);
end;

procedure TAdvGeneralPDFGraphicsLib.DrawImage(ABitmap: TAdvBitmap;
  Rect: TRectF; Stretch, AspectRatio: Boolean;
  ImageType: TAdvPDFGraphicsLibImageType; Quality: Single);
begin
  DrawImage(ABitmap, gcWhite, Rect, Stretch, AspectRatio, ImageType, Quality);
end;

procedure TAdvGeneralPDFGraphicsLib.DrawImageFromFile(AFileName: String;
  Rect: TRectF; Stretch, AspectRatio: Boolean;
  ImageType: TAdvPDFGraphicsLibImageType; Quality: Single);
begin
  DrawImageFromFile(AFileName, gcWhite, Rect, Stretch, AspectRatio, ImageType, Quality);
end;

procedure TAdvGeneralPDFGraphicsLib.DrawImageFromFile(AFileName: String;
  Point: TPointF; ImageType: TAdvPDFGraphicsLibImageType; Quality: Single);
begin
  DrawImageFromFile(AFileName, gcWhite, Point, ImageType, Quality);
end;

procedure TAdvGeneralPDFGraphicsLib.DrawImageFromFile(AFileName: String; ABackgroundColor: TAdvGraphicsColor; Rect: TRectF; Stretch: Boolean = True; AspectRatio: Boolean = True; ImageType: TAdvPDFGraphicsLibImageType = itOriginal; Quality: Single = 1.0);
var
  bmp: TAdvBitmap;
begin
  bmp := TAdvBitmap.Create;
...
procedure TAdvGeneralPDFGraphicsLib.DrawImageWithName(ABitmapName: string; ABackgroundColor: TAdvGraphicsColor; Point: TPointF; ImageType: TAdvPDFGraphicsLibImageType = itOriginal; Quality: Single = 1.0);
var
  bmp: TAdvBitmap;
begin
...
procedure TAdvGeneralPDFGraphicsLib.DrawImageWithName(ABitmapName: string; ABackgroundColor: TAdvGraphicsColor; Rect: TRectF; Stretch, AspectRatio: Boolean; ImageType: TAdvPDFGraphicsLibImageType; Quality: Single);
var
  bmp: TAdvBitmap;
begin
  if not Assigned(PictureContainer) then
...
procedure TAdvGeneralPDFGraphicsLib.DrawImageWithName(ABitmapName: string;
  Rect: TRectF; Stretch, AspectRatio: Boolean;
  ImageType: TAdvPDFGraphicsLibImageType; Quality: Single);
begin
  DrawImageWithName(ABitmapName, gcWhite, Rect, Stretch, AspectRatio, ImageType, Quality);
end;

procedure TAdvGeneralPDFGraphicsLib.DrawImageWithName(ABitmapName: string;
  Point: TPointF; ImageType: TAdvPDFGraphicsLibImageType; Quality: Single);
begin
  DrawImageWithName(ABitmapName, gcWhite, Point, ImageType, Quality);
end;
...
begin
  FPDFLib := IAdvCustomPDFLib(APDFLib);
end;
