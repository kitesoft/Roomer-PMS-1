...
type
  ...
  published
    ...
    property DialogResizable: boolean read FDialogResizable write FDialogResizable default true;
...
begin
  ...
  begin
    ...
    begin
      ...
      // initialize according to presets
      ...
      // pick up the new setting via the dialog to be used for the Print command
