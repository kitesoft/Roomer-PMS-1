...
type
  ...
  protected
    procedure SetOfficePagerStyle(const Value: TOfficePagerStyle); virtual;
    procedure SetOfficePagerStyleAndAppColor(const Value: TOfficePagerStyle; AppColor: TColor); virtual;
