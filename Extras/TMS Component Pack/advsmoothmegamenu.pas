...
const
  ...
  // v1.4.1.0 : New : StayOnTop property for menus that are placed on forms with FormStyle := fsStayOnTop
  // v1.4.1.1 : Fixed : Issue with calculation when shadowoffset is > 0
  // v1.4.1.2 : Fixed : Issue with calculation of text with icons
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            f := ItemAppearance.MenuItemFillHover;
          ...
          begin
            ...
            f := ItemAppearance.MenuItemFillSelected;
        ...
        begin
          cf.Assign(ItemAppearance.MenuItemFontDisabled);
            f := ItemAppearance.MenuItemFillDisabled;
          ...
          begin
            ...
            begin
              case AutoSize of
                ...
                begin
                  FItemRect.Y := itemtop;
                  itemtop := itemtop + sizeRect.Height + 10 + ItemAppearance.MenuItemSpacing + f.ShadowOffset;
          ...
          begin
            ...
            begin
              case AutoSize of
                ...
                begin
                  FItemRect.X := itemleft;
                  itemleft := itemleft + sizeRect.Width + 10 + ItemAppearance.MenuItemSpacing + wir + wil + f.ShadowOffset;
                  FItemRect.Width := sizeRect.Width + 10 + wir + wil + f.ShadowOffset;
                  FItemRect.Y := InsideRect.Top + ItemAppearance.Margin.Top;
                  FItemRect.Height := h;
                end;
                asCustom:
        ...
        if Caption <> '' then
          FCaptionRect := MakeRect(FItemRect.X + s + (wil / 2) + 2 - f.ShadowOffset div 2, FItemRect.Y + 2, sizerect.Width, FItemRect.Height - 4)
        else
          FCaptionRect := MakeRect(FItemRect.X + s + (wil / 2) - f.ShadowOffset div 2, FItemRect.Y + 2, sizerect.Width, FItemRect.Height - 4);

        FCaptionRect.Height := FCaptionRect.Height - f.ShadowOffset;
        if FCaptionRect.X + FCaptionRect.Width > FItemRect.X + FItemRect.Width - f.ShadowOffset then
          FCaptionRect.Width := FCaptionRect.Width - f.ShadowOffset;
      end;
    end;
  end;
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            if Self.Caption <> '' then
              picl.GDIPDraw(g, Bounds(Round(FCaptionRect.x - w) - 4, Round(FItemRect.Y + (FItemRect.Height - h - fl.ShadowOffset)/ 2), w, h))
            else
            begin
              if Assigned(picr) then
                picl.GDIPDraw(g, Bounds(Round(FItemRect.x - fl.ShadowOffset div 2 + (FItemRect.Width / 2) - w - 2), Round(FItemRect.Y + (FItemRect.Height - h - fl.ShadowOffset)/ 2), w, h))
              else
                picl.GDIPDraw(g, Bounds(Round(FItemRect.x - fl.ShadowOffset div 2 + ((FItemRect.Width - w) / 2)), Round(FItemRect.Y + (FItemRect.Height - h - fl.ShadowOffset)/ 2), w, h))
            end;
          end;
          ...
          begin
            ...
            h := picr.Height;
            if Self.Caption <> '' then
              picr.GDIPDraw(g, Bounds(Round(FCaptionRect.X + FCaptionRect.Width) + 4, Round(FItemRect.Y  + (FItemRect.Height - h - fl.ShadowOffset)/ 2), w, h))
            else
            begin
              if Assigned(picl) then
                picr.GDIPDraw(g, Bounds(Round(FItemRect.x - fl.ShadowOffset div 2 + (FItemRect.Width / 2) + 2), Round(FItemRect.Y  + (FItemRect.Height - h - fl.ShadowOffset)/ 2), w, h))
              else
                picr.GDIPDraw(g, Bounds(Round(FItemRect.x - fl.ShadowOffset div 2 + ((FItemRect.Width - w) / 2)), Round(FItemRect.Y  + (FItemRect.Height - h - fl.ShadowOffset)/ 2), w, h))
            end;
          end;
        end;
        ...
        begin
          ...
          begin
            ...
            begin
              if Assigned(bmpr) then
                ca.Draw(Round(FItemRect.x - fl.ShadowOffset div 2 + (FItemRect.Width / 2) - w - 2), Round(FItemRect.Y  + (FItemRect.Height - h - fl.ShadowOffset)/ 2), bmpl)
              else
                ca.Draw(Round(FItemRect.x - fl.ShadowOffset div 2 + ((FItemRect.Width - w) / 2)), Round(FItemRect.Y  + (FItemRect.Height - h - fl.ShadowOffset)/ 2), bmpl);
            end;
          end;
          ...
          begin
            ...
            h := bmpr.Height;
            if Self.Caption <> '' then
              ca.Draw(Round(FCaptionRect.X + FCaptionRect.Width + 4), Round(FItemRect.Y  + (FItemRect.Height - h - fl.ShadowOffset)/ 2), bmpr)
            else
            begin
              if Assigned(bmpl) then
                ca.Draw(Round(FItemRect.x - fl.ShadowOffset div 2 + (FItemRect.Width / 2) + 2), Round(FItemRect.Y  + (FItemRect.Height - h - fl.ShadowOffset)/ 2), bmpr)
              else
                ca.Draw(Round(FItemRect.x - fl.ShadowOffset div 2 + ((FItemRect.Width - w) / 2)), Round(FItemRect.Y  + (FItemRect.Height - h - fl.ShadowOffset)/ 2), bmpr);
            end;
          end;
        ...
        begin
          ...
          if (Assigned(Picr) and not picr.Empty) or (Assigned(picl) and not picl.Empty) or (Assigned(bmpl) and not bmpl.Empty) or (Assigned(bmpr) and not bmpr.Empty) then
            ...
            DrawMenuItemHTMLText(g, cf, Fcap, CaptionLocation, MakeRect(FItemRect.X, FItemRect.Y, FItemRect.Width - fl.ShadowOffset, FItemRect.Height - fl.ShadowOffset), htmlr, FCaption);
        end;
