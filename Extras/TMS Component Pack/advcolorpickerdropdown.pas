...
uses
  Classes, Windows, Graphics, Controls, Messages, ExtCtrls, SysUtils, Forms, Math,
  AdvDropDown, AdvStyleIF, Types
...
type
  ...
  private
    ...
    function GetCubeCellColor(i: integer): TColor;
    procedure SetCubeCellColor(i: integer; const Value: TColor);
  protected
  ...
  public
    ...
    destructor Destroy; override;
    property CubeCellColor[i: integer]: TColor read GetCubeCellColor write SetCubeCellColor;
  published
  ...
  private
    ...
    procedure SetColorBoxBorderColor(const Value: TColor);
  protected
    procedure CreateItemListPanel; virtual;
    procedure CreateColorCubePanel; virtual;
    procedure CreateSpectrumPanel; virtual;
    procedure CreateColorSelectorPanel; virtual;
  ...
  public
    ...
    procedure EndUpdate;
    property CubePanel: TAdvColorCubePanel read FColorCubePanel;
    property SpectrumPanel: TAdvColorSpectrumPanel read FSpectrumPanel;
  published
    ...
    property ColorBoxBorderColor: TColor read FColorBoxBorderColor write SetColorBoxBorderColor default clBlack;
...
procedure TAdvColorCubePanel.SetCubeCellColor(i: integer; const Value: TColor);
begin
  FCubeCells[i].Color := Value;
end;
...
function TAdvColorCubePanel.GetCubeCellColor(i: integer): TColor;
begin
  Result := FCubeCells[i].Color;
end;
...
begin
  ...
  try
    ...
    begin
      ...
      Canvas.Pen.Color := ColorBoxBorderColor;
      Canvas.Brush.Color := FSelectedColor;
      Canvas.Rectangle(R1);
      ...
      begin
        ...
        if pos('</',s) > 0 then
        begin
          DrawHTMLEX(Canvas,s,R1,nil,true,Handle);
        end
        else
...
procedure TAdvColorPickerDropDown.SetColorBoxBorderColor(const Value: TColor);
begin
  if (FColorBoxBorderColor <> Value) then
  begin
    FColorBoxBorderColor := Value;
    Invalidate;
  end;
end;
