...
uses
  Classes, AdvGraphics, Types, Graphics, AdvTypes, PictureContainer
  {$IFDEF CMNLIB}
  , ImgList
  {$ENDIF}
  {$IFNDEF LCLLIB}
...
begin
  ...
  begin
    repeat
      ...
      if TAdvUtils.TagReplacestring('&sect;','§',s) then Foundtag := True;
      if TAdvUtils.TagReplacestring('&permil;','®‰',s) then Foundtag := True;
      if TAdvUtils.TagReplacestring('&reg;','®',s) then Foundtag := True;

      if TAdvUtils.TagReplacestring('&copy;','©',s) then Foundtag := True;
      if TAdvUtils.TagReplacestring('&para;','¶',s) then Foundtag := True;

      if TAdvUtils.TagReplacestring('&trade;','™',s) then Foundtag := True;
      if TAdvUtils.TagReplacestring('&euro;','€',s) then Foundtag := True;
