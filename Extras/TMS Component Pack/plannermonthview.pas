...
const
  ...
  BLD_VER = 3; // Build nr.
  DATE_VER = 'Sep, 2016'; // Month version
  ...
  // 3.1.0.1 : Fixed : Issue with causing application level exceptions during item size & move
  // 3.1.0.2 : Improved : Avoid full refresh when doing a simple dataset scroll in TDBPlannerMonthView
  // 3.1.0.3 : Fixed : Issue with painting when TPlannerMonthView is used on a TScrollBox
