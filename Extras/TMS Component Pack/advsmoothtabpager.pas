...
const
  ...
  // v1.4.0.1 : Fixed : Issue with using Show and using ActiveTabIndex simultaneously
  // v1.4.0.2 : Fixed : Issue with Show changing incorrect ActiveTab at designtime
  // v1.4.0.3 : Fixed : Issue with transparency when drawing button icons
...
{$IFDEF DELPHI_UNICODE}
procedure TAdvSmoothTabPage.ChangeScale(M, D: Integer);
begin
  inherited;
  TabAppearance.Appearance.Font.Size := MulDiv(TabAppearance.Appearance.Font.Size, M, D);
end;
{$ENDIF}

{$IFDEF DELPHIXE10_LVL}
procedure TAdvSmoothTabPage.ChangeScale(M, D: Integer; isDpiChange: Boolean);
begin
  inherited;
  TabAppearance.Appearance.Font.Size := MulDiv(TabAppearance.Appearance.Font.Size, M, D);
end;
