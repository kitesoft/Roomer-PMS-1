...
var
  ...
  function HTMLDrawLine(Canvas: TCanvas;var s:string;r: TRect;Calc:Boolean;
                        ...
                        XPos,YPos:Integer;var Hotspot,ImageHotSpot:Boolean; var floatrect: TRect; var txtfloat: TFloatStyle): string;
  var
    ...
    imgalign,imgoffs, imgth, txth: integer;
                    ...
                    begin
                      ...
                      begin
                        ...
                        if not Calc and not Print then
                          FImages.Draw(Canvas,flr.Left,flr.Top,IStrToInt(Prop),True);

                        if not Calc and Print then
                        begin
                          flr.Right := flr.Left + Round(ResFactor * FImages.Width);
                          flr.Bottom := flr.Top + Round(ResFactor * FImages.Height);

                          ABitmap := TBitmap.Create;
                          FImages.GetBitmap(IStrToInt(Prop),ABitmap);
                          PrintBitmap(Canvas,flr,ABitmap);
                          ABitmap.Free;
// {changed}               cr := r;
                        end;
                      end;
                    ...
                    begin
                      Delete(Prop,1,5);
                      IMGSize := SysImage(Canvas,flr.Left,flr.Top,Prop,False,not Calc,Print,ResFactor);
                    ...
                    begin
                      Delete(Prop,1,5);
                      IMGsize := SysImage(Canvas,flr.Left,flr.Top,Prop,True,not Calc,Print,ResFactor);
                        ...
                        begin
                          ...
                          begin
                            ...
                            begin
                              ...
                              Canvas.StretchDraw(Rect(flr.Left,flr.Top,flr.Left + imgw,flr.Top + imgh),bmp)
                            end
                            else
                            begin
                              ...
                              begin
                                ...
                                begin
                                  ...
                                  Canvas.Rectangle(flr.Left,flr.Top,flr.Left + (bmp as THTMLPicture).MaxWidth,flr.Top + (bmp as THTMLPicture).MaxHeight);
                                end;

                                Canvas.Draw(flr.Left + (bmp as THTMLPicture).FrameXPos,flr.Top + (bmp as THTMLPicture).FrameYPos,bmp);
                              end
                              else
                                Canvas.Draw(flr.Left,flr.Top,bmp);
                            end;
                          end;
...
begin
  ...
  fr.Left := fr.Left + 1;  {required to add offset for DrawText problem with first capital W letter}
  r := fr;
  ...
  begin
    ...
    su := HTMLDrawLine(Canvas,s,r,True,HtmlWidth,HtmlHeight,subh,suph,imgali,Align,PIndent,XPos,YPos,HotSpot,ImageHotSpot,floatrect,txtfloat);
    ...
    begin
      ...
      HTMLDrawLine(Canvas,su,dr,CheckHotSpot,HtmlWidth,HtmlHeight,subh,suph,ImgAli,Align,PIndent,XPos,YPos,HotSpot,ImageHotspot,floatrect,txtfloat);
      ...
      if dr.Top > fr.Top + floatrect.bottom then
      begin
        floatrect.Left := 0;
        floatrect.Right := 0;
        r.Left := fr.Left;
