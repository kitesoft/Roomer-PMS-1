{*************************************************************************}
{ TMS Metro Replace Dialog component                                      }
...
unit AdvMetroReplaceDialog;

interface

uses
  Windows, Messages, SysUtils, Variants, Classes, Graphics,
  Controls, Forms, StdCtrls, AdvReplaceDialogForm, AdvStyleIF, AdvGlowButton, Types;
...
type
  ...
  {$ENDIF}
  TAdvMetroReplaceDialog = class(TAdvReplaceDialog, ITMSTones)
  private
    FTones: TColorTones;
    function GetVersion: string;
    procedure SetVersion(const Value: string);
  protected
    function CreateDialogForm(AOwner: TComponent): TReplaceDialogForm; override;
  ...
  TMetroReplaceDialogForm = class(TReplaceDialogForm, ITMSTones)
  private
  ...
  public
    ...
    ReplaceBtnAGB: TAdvGlowButton;
    ReplaceAllBtnAGB: TAdvGlowButton;
...
var
  MetroReplaceDialogForm: TMetroReplaceDialogForm;
  More: Boolean;
...
{ TAdvMetroReplaceDialog }

function TAdvMetroReplaceDialog.CloneButton(btn: TButton): TAdvGlowButton;
begin
...
constructor TAdvMetroReplaceDialog.Create(AOwner: TComponent);
begin
  inherited;
...
destructor TAdvMetroReplaceDialog.Destroy;
begin
  inherited;
end;
...
function TAdvMetroReplaceDialog.CreateDialogForm(
  AOwner: TComponent): TReplaceDialogForm;
begin
  Result := TMetroReplaceDialogForm.Create(AOwner);
end;

//------------------------------------------------------------------------------

procedure TAdvMetroReplaceDialog.Execute;
begin
  inherited;
end;

function TAdvMetroReplaceDialog.GetVersion: string;
var
  vn: Integer;
begin
  vn := GetVersionNr;
...
function TAdvMetroReplaceDialog.GetVersionNr: integer;
begin
  Result := MakeLong(MakeWord(BLD_VER, REL_VER), MakeWord(MIN_VER, MAJ_VER));
end;

function TAdvMetroReplaceDialog.InitDialog: TCustomForm;
var
  frm: TMetroReplaceDialogForm;
begin
  frm := (inherited InitDialog) as TMetroReplaceDialogForm;
  ...
  frm.ReplaceBtnAGB := CloneButton(frm.ReplaceBtn);
  frm.ReplaceBtnAGB.SetColorTones(FTones);

  frm.ReplaceAllBtnAGB := CloneButton(frm.ReplaceAllBtn);
  frm.ReplaceAllBtnAGB.SetColorTones(FTones);
  ...
  frm.Label3.Font.Color := FTones.Background.TextColor;
  frm.Label4.Font.Color := FTones.Background.TextColor;
  ...
  frm.RangeGroup.Font.Color := FTones.Background.TextColor;
  frm.DirGroup.Font.Color := FTones.Background.TextColor;

  frm.ComboBox1.Font.Color := clWindowText;
  frm.ComboBox2.Font.Color := clWindowText;
end;

procedure TAdvMetroReplaceDialog.SetColorTones(ATones: TColorTones);
begin
  FTones := ATones;
end;

procedure TAdvMetroReplaceDialog.SetVersion(const Value: string);
begin
...
constructor TMetroReplaceDialogForm.Create(AOwner: TComponent);
begin
  inherited;
...
constructor TMetroReplaceDialogForm.CreateNew(AOwner: TComponent; Dummy: Integer);
begin
  inherited;
  {$IFNDEF DELPHI_UNICODE}
  Initialize;
...
{$IFDEF DELPHI_UNICODE}
procedure TMetroReplaceDialogForm.InitializeNewForm;
begin
  inherited;
  Initialize;
end;
...
destructor TMetroReplaceDialogForm.Destroy;
begin
  FAppearance.Free;
  inherited;
end;
...
procedure TMetroReplaceDialogForm.CreateParams(var Params: TCreateParams);
const
...
procedure TMetroReplaceDialogForm.OnAppearanceChanged(Sender: TObject);
begin
  Invalidate;
end;
...
procedure TMetroReplaceDialogForm.Activate;
begin
  inherited;
  FixSysShadowOrder;
end;
...
procedure TMetroReplaceDialogForm.AdjustClientRect(var Rect: TRect);
begin
...
procedure TMetroReplaceDialogForm.AlignControls(AControl: TControl; var ARect: TRect);
begin
  inherited;
...
function TMetroReplaceDialogForm.GetClientRect: TRect;
begin
...
procedure TMetroReplaceDialogForm.Loaded;
var
  i, ch: Integer;
begin
  inherited;
...
function TMetroReplaceDialogForm.GetCaptionHeight: Integer;
begin
...
function TMetroReplaceDialogForm.GetCaptionRect: TRect;
begin
  Result := ClientRect;
...
function TMetroReplaceDialogForm.GetSysRectWidth: Integer;
begin
  Result := 0;
...
function TMetroReplaceDialogForm.HasMaximize: boolean;
begin
...
function TMetroReplaceDialogForm.HasMinimize: boolean;
begin
...
function TMetroReplaceDialogForm.GetSysIconRect(SysIcon: TSysIcon): TRect;
begin
  Result := Rect(-1, -1, -1, -1);
...
function TMetroReplaceDialogForm.PtOnIcon(pt: TPoint): TSysIcon;
var
  R: TRect;
begin
  Result := siNone;
...
procedure TMetroReplaceDialogForm.MouseDown(Button: TMouseButton; Shift: TShiftState; X,
  Y: Integer);
begin
  inherited;
...
procedure TMetroReplaceDialogForm.MouseMove(Shift: TShiftState; X, Y: Integer);
var
  si, Oldsi: TSysIcon;
begin
  inherited;
...
procedure TMetroReplaceDialogForm.MouseUp(Button: TMouseButton; Shift: TShiftState; X,
  Y: Integer);
var
  si, Oldsi: TSysIcon;
begin
...
procedure TMetroReplaceDialogForm.CMMouseEnter(var Msg: TMessage);
begin
  inherited;
...
procedure TMetroReplaceDialogForm.CMMouseLeave(var Message: TMessage);
var
  si: TSysIcon;
begin
  inherited;
...
procedure TMetroReplaceDialogForm.SysIconClick(SysIcon: TSysIcon);
begin
...
procedure TMetroReplaceDialogForm.Paint;
var
  R: TRect;
begin
  inherited;
...
procedure TMetroReplaceDialogForm.DrawCaption;
var
  R, TxtR: TRect;
...
procedure TMetroReplaceDialogForm.DrawSysIcons(ACanvas: TCanvas; SysIcon: TSysIcon);
...
procedure TMetroReplaceDialogForm.EnableButtons;
begin
  inherited;
  FindBtnAGB.Enabled := (Dialog.FindText <> '') and (fdoFindEnabled in Dialog.Options);
  ReplaceBtnAGB.Enabled := (Dialog.FindText <> '') and (fdoReplaceEnabled in Dialog.Options);
  ReplaceAllBtnAGB.Enabled := (Dialog.FindText <> '') and (fdoReplaceAllEnabled in Dialog.Options);
end;

//------------------------------------------------------------------------------

procedure TMetroReplaceDialogForm.InvalidateIcon(SysIcon: TSysIcon);
var
  R: TRect;
begin
...
procedure TMetroReplaceDialogForm.SetAppearance(const Value: TFormAppearance);
begin
...
procedure TMetroReplaceDialogForm.SetColorTones(ATones: TColorTones);
begin
  FTones := ATones;
  ...
  if Assigned(FindBtnAGB) then
    FindBtnAGB.SetColorTones(ATones);
  {
  ReplaceBtn.SetColorTones(ATones);
  ReplaceAllBtn.SetColorTones(ATones);
  CloseBtn.SetColorTones(ATones);
  MoreBtn.SetColorTones(ATones);
  }
end;

//------------------------------------------------------------------------------

procedure TMetroReplaceDialogForm.SetText(const Value: string);
begin
  if (FText <> Value) then
  begin
    FText := Value;
...
procedure TMetroReplaceDialogForm.WMActivate(var Msg: TMessage);
begin
  inherited;
  FixSysShadowOrder;
  Repaint;
...
procedure TMetroReplaceDialogForm.WMEraseBkGnd(var Msg: TWMEraseBkgnd);
begin
  inherited;
end;
...
procedure TMetroReplaceDialogForm.WMGetMinMaxInfo(var Msg: TMessage);
var
  info: ^TMinMaxInfo;
  rc: TRect;
  mi: TMonitorInfo;
...
procedure TMetroReplaceDialogForm.WMWindowPosChanged(var Message: TWMWindowPosChanged);
begin
  inherited;
  FixSysShadowOrder;
end;
...
procedure TMetroReplaceDialogForm.WMWindowPosChanging(var Message: TWMWindowPosChanging);
const
...
procedure TMetroReplaceDialogForm.WMNCActivate(var Msg: TMessage);
begin
  inherited;
  FixSysShadowOrder;
end;
...
procedure TMetroReplaceDialogForm.WMNCHitTest(var Message: TWMNCHitTest);
var
  pt: TPoint;
begin
  inherited;
...
function TMetroReplaceDialogForm.IsFullMaximized: Boolean;
var
  mon: TMonitor;
  P: TPoint;
  R: TRect;
...
procedure TMetroReplaceDialogForm.WMSize(var Message: TWMSize);
begin
  inherited;
  Invalidate;
  FixSysShadowOrder;
...
procedure TMetroReplaceDialogForm.FixSysShadowOrder;

  function FindSysShadowOrderProc(WindowHandle: HWND; // handle to window
    Form: TMetroReplaceDialogForm // application-defined value, 32-bit
    ): BOOL; stdcall;
  var
