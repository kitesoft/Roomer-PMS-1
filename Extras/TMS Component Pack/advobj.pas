...
uses
  Windows, Controls, Types, Graphics, ExtCtrls, Dialogs, Classes, Messages,
...
type
  ...
  TSortStyle = (ssAutomatic, ssAlphabetic, ssNumeric, ssDate, ssAlphaNoCase,
    ...
    {$ENDIF}
    , ssDateTime, ssTime
    , ssAlphaNumeric, ssAlphaNumericNoCase, ssNatural, ssVarDate
    );
...
type
  ...
  private
    ...
    procedure SetShowResults(const Value: Boolean);
  protected
    procedure Changed;
  public
    ...
    property ResultPos: integer read FResultPos write FResultPos;
    property ResultTot: integer read FResultTot write FResultTot;
  published
    ...
    property IgnoreHTML: boolean read FIgnoreHTML write FIgnoreHTML default true;
    ...
    property SearchErrorColor: TColor read FSearchErrorColor write FSearchErrorColor default clRed;
    ...
    property ShowResults: Boolean read FShowResults write SetShowResults default false;
  ...
  TToggleTriStateCheck = (tsAllStates, tsCheckUnCheck);
  ...
  private
    ...
    FToggleTriStateCheck: TToggleTriStateCheck;
    FMoveRowOnScroll: Boolean;
  ...
  published
    ...
    property MoveRowOnScroll: Boolean read FMoveRowOnScroll write FMoveRowOnScroll default False;
    ...
    property ToggleTriStateCheck: TToggleTriStateCheck read FToggleTriStateCheck write FToggleTriStateCheck default tsAllStates;
  end;
  ...
  private
    ...
    FDisjunctColSelectNoCtrl: Boolean;
    FOnChange: TNotifyEvent;
  ...
  published
    ...
    property DisjunctColSelectNoCtrl: Boolean read FDisjunctColSelectNoCtrl write FDisjunctColSelectNoCtrl default False;
...
procedure TControlList.ClearControls;
var
  i: Integer;
  ci: TControlItem;
begin
...
begin
  ...
  begin
    ...
    FSearchErrorColor := (Source as TSearchFooter).SearchErrorColor;
    FShowResults := (Source as TSearchFooter).ShowResults;
    FResultFormat := (Source as TSearchFooter).ResultFormat;
    FIgnoreHTML := (Source as TSearchFooter).IgnoreHTML;
    FIgnoreAccents := (Source as TSearchFooter).IgnoreAccents;
  end;
end;
...
begin
  ...
  FSearchErrorColor := clRed;
  FResultFormat := '(%d of %d)';
...
procedure TSearchFooter.SetShowResults(const Value: Boolean);
begin
  if (FShowResults <> Value) then
  begin
    FShowResults := Value;
    Changed;
  end;
...
begin
  ...
  begin
    ...
    FToggleTriStateCheck := (Source as TNavigation).ToggleTriStateCheck;
    FMoveRowOnScroll := (Source as TNavigation).MoveRowOnScroll;
  end;
end;
...
begin
  ...
  begin
    ...
    FDisjunctColSelectNoCtrl := (Source as TMouseActions).DisjunctColSelectNoCtrl;
  end;
end;
