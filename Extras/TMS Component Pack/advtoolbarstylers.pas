...
begin
  ...
  begin
    ...
    rgb := ColorToRGB(AAppColor);
    r := rgb and $FF;
    g := (rgb and $FF00) shr 8;
    b := (rgb and $FF0000) shr 16;

    if (r > $7F) or (g > $7F) or (b > $7F) then
      AppColor.AppButtonHoverColor := ChangeColorPerc(AAppColor, -30)
    else
      AppColor.AppButtonHoverColor := ChangeColorPerc(AAppColor, +30);
  end;
...
//  if FToolBarStyle <> Value then
  begin
    ...
    GlowButtonAppearance.TextColorChecked := clBlack; 
    GlowButtonAppearance.TextColorHot := clBlack;     
    GlowButtonAppearance.TextColorDown := clBlack;    
   ...
   bsOffice2003Classic:
    ...
    bsOffice2016White:
      begin
        ...
        GlowButtonAppearance.TextColorChecked := $505050;
        GlowButtonAppearance.TextColorHot := $505050;     
        GlowButtonAppearance.TextColorDown := $505050;    
    ...
    bsOffice2016Gray:
      begin
        ...
        begin
          ...
          FTones.Tab := ATones;
          FTones.Tab.Hover.BrushColor := $B2B2B2; //$454545;
          FTones.Tab.Hover.BorderColor := $B2B2B2;
          FTones.Tab.Hover.TextColor := $F0F0F0;
        ...
        GlowButtonAppearance.TextColorChecked := $424242; 
        GlowButtonAppearance.TextColorHot := $424242;     
        GlowButtonAppearance.TextColorDown := $424242;    
    ...
    bsOffice2016Black:
      begin
        ...
        GlowButtonAppearance.TextColorChecked := $C8C8C8; 
        GlowButtonAppearance.TextColorHot := $A6A6A6;     
        GlowButtonAppearance.TextColorDown := $A6A6A6;    
