...
type
  ...
  TAdvStringGridSelectionEditor = class(TSelectionEditor)
  public
...
begin
  ...
  0:begin
      {$I COMPILERTEXT.INC}
      MessageDlg(Component.ClassName+' version '+(Component as TAdvStringGrid).VersionString+' for '+compiler+#13#10'© 1997-2017 by TMS software', mtinformation,[mbok],0);
    end;
  1:begin
...
{ TAdvStringGridSelectionEditor }

procedure TAdvStringGridSelectionEditor.RequiresUnits(Proc: TGetStrProc);
begin
  inherited;
  Proc('AdvUtil');
end;
