...
begin
  ...
  try
    ...
    try
      ...
      DoValueAppearance(AItem, ap, Selected);
      ...
      begin
        ...
        gpPen := TGPPen.Create(ColorToARGB(clWhite),2);
...
begin
  ...
  begin
    ...
    begin
      ...
      try
        LDetails := LStyle.GetElementDetails(teBackgroundNormal);
        ...
        LStyle.DrawElement(Canvas.Handle, LDetails, Rect(0,0,Width + 1, Height + 1));
  ...
  if (BorderStyle = bsSingle) and not FUsedVCLStyles then
  begin
    R := ClientRect;
    Canvas.Brush.Style := bsClear;
