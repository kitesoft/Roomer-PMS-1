...
uses
  Classes, Controls, Types, Windows, Messages, SysUtils, StdCtrls, AdvEdit,
...
const
  ...
  // v1.1.5.2 : Fixed : Issue with setting cursor
  // v1.1.5.3 : Fixed : Issue with VCL styles
...
type
  ...
  private
    ...
    procedure CMSetCursor(var Message: TMessage); message CM_CURSORCHANGED;
...
procedure TAdvListBox.CMSetCursor(var Message: TMessage);
begin
  inherited;
  FListBox.Cursor := Cursor;
  FSearchEdit.Cursor := Cursor;
  FInsertEdit.Cursor := Cursor;
end;
...
begin
  ...
  begin
    ...
    begin
      if LStyle.GetElementColor(LStyle.GetElementDetails(tgCellNormal), ecFillColor, clr) then
      begin
