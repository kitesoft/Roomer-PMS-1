...
uses
  Classes, Messages, Graphics, AdvGraphics, Forms, Controls, SysUtils, Types
  {$IFDEF VCLLIB}
  , uxTheme, Windows
  {$ENDIF}
  {$IFDEF DELPHIXE5_LVL}
...
type
  ...
  protected
    ...
    procedure GetWordAndIndexAtCaret(var AValue: string; var AIndex: integer); virtual; abstract;
    procedure UpdateWordAndIndexAtCaret(AValue: string; AIndex: integer); virtual; abstract;
