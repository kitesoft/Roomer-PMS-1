...
const
  ...
  // v1.3.0.0 : New : ControlCount property added
  //          : New : Controls[Index], ControlIDs[Index] properties added
...
type
  ...
  private
    ...
    function GetControls(Index: integer): string;
    procedure SetControls(Index: integer; const Value: string);
    function GetControlIDs(Index: integer): string;
  protected
  ...
  public
    ...
    property Controls[Index: integer]: string read GetControls write SetControls;
    property ControlIDs[Index: integer]: string read GetControlIDs;
  published
...
procedure THTMLForm.SetControls(Index: integer; const Value: string);
var
  lp,i: Integer;
...
begin
  ...
  begin
    ...
    if (i = Index) then
    begin
      SetControlValue(html,CID,Value);
      break;
    end;
    inc(i);
  end;
...
function THTMLForm.GetControlCount: integer;
var
  lp: Integer;
  Tag,CType,CID,CV,CW,CH,CP,CL: string;
  html: string;
...
function THTMLForm.GetControlIDs(Index: integer): string;
var
  lp,i: Integer;
  Tag,CType,CID,CV,CW,CH,CP,CL: string;
  html: string;
...
function THTMLForm.GetControls(Index: integer): string;
var
  lp,i: Integer;
  Tag,CType,CID,CV,CW,CH,CP,CL: string;
  html: string;
