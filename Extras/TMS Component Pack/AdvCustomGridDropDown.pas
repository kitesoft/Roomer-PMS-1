...
const
  ...
  // 6.0.2.2 : Fixed : Issue with OnGridClickSort event
...
begin
  ...
  begin
    ...
    InternalGrid.SetComponentStyle(GetComponentStyle);
    {
     ...
     InternalGrid.SelectionColor := SelectionColor;
     InternalGrid.SelectionColorTo := SelectionColorTo;
     InternalGrid.SelectionTextColor := SelectionTextColor;
...
begin
  ...
  begin
    ...
    if Assigned(OnGridClickSort) then
      OnGridClickSort(Self, ACol);
  end;
...
begin
  ...
  if AutoShowDropDown and (Msg.CharCode <> 0) then
  begin
    ShowDropDown;
  end;
end;
