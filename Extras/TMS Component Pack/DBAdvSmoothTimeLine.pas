...
type
  ...
  private
    ...
    procedure SetIndicatorHint(const Value: string);
  protected
    procedure Changed;
  ...
  published
    ...
    property IndicatorHint: string read FIndicatorHint write SetIndicatorHint;
...
var
  ...
  indh, indan, seccap, sechint: String;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        indh := '';
        if DataBinding.IndicatorHint <> '' then
          indh := DataSource.DataSet.FieldByName(DataBinding.IndicatorHint).AsString;
...
procedure TDBAdvSmoothTimeLineDataBinding.SetIndicatorHint(const Value: string);
begin
  if FIndicatorHint <> Value then
  begin
    FIndicatorHint := Value;
    Changed;
  end;
end;
