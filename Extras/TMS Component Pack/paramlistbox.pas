...
const
  ...
  // 1.3.3.5 : Fixed : Issue with <Z> tag processing
  // 1.3.3.6 : Fixed : Issue when using VCL Themes and changing themes at runtime
  // 1.3.3.7 : Improved : Handling of high DPI mode
  // 1.3.3.8 : Fixed : Issue with mask edit based parameter editing
  // 1.3.3.9 : Fixed : Issue with VCL styles and popup list
...
uses
  CommCtrl, ShellApi, Forms,  ShlObj, ActiveX, ImgList, Variants;
...
procedure TParamListBox.CreateSubControls;
begin
...
procedure TParamListBox.CreateWnd;
begin
  inherited;
  CreateSubControls;
end;
...
procedure TParamListBox.DestroySubControls;
begin
  FParamPopup.Free;
  FParamList.Free;
...
procedure TParamListBox.DestroyWnd;
begin
  DestroySubControls;
  inherited;
end;
