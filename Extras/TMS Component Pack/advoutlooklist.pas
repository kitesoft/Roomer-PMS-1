...
const
  ...
  // 1.7.10.0: New : Exposed OnMouseLeave/OnMouseEnter events
  // 1.7.10.1: Fixed: Issue with OnMouseLeave/OnMouseEnter events
...
type
  ...
  protected
    ...
    procedure ListMouseEnter(Sender: TObject);
    {$ENDIF}
  ...
  public
    ...
    property MouseInClient: Boolean read FMouseInCli;
...
begin
  ...
  FList.OnMouseEnter := ListMouseEnter;
  {$ENDIF}
  FList.TabStop := False;
...
procedure TAdvOutlookList.ListMouseLeave(Sender: TObject);
begin
  FMouseInCli := false;
...
procedure TAdvOutlookList.ListMouseEnter(Sender: TObject);
begin
  FMouseInCli := true;
