...
const
  ...
  // 1.3.1.0 : Added SelectedBrushStyle, SelectedPenStyle properties in AdvBrushStyleSelector & AdvPenStyleSelector
  ...
  // 1.3.6.0 : Improved : painting with button Enabled = false
  // 1.4.0.0 : New : ColorSelectionDown(To), ColorSelectionHot(To) added to set hot & down colors in selection dropdown panel
...
type
  ...
  published
    property SelectorPanel: TAdvCustomSelectorPanel read FSelectorPanel write FSelectorPanel;
  end;

  TDrawToolEvent = procedure(Sender: TObject; Canvas: TCanvas; ItemIndex: integer; R: TRect) of object;

  TAdvCustomSelector = class(TCustomControl)
  private
  ...
  {$ENDIF}
  TAdvToolSelector = class(TAdvCustomSelector)
  private
  protected
  public
  ...
  published
    ...
    property ColorSelectionDown;
    property ColorSelectionDownTo;
    property ColorSelectionHot;
    property ColorSelectionHotTo;
  ...
  [ComponentPlatformsAttribute(pidWin32 or pidWin64)]
  {$ENDIF}
  TAdvPenStyleSelector = class(TAdvCustomSelector)
  private
  ...
  [ComponentPlatformsAttribute(pidWin32 or pidWin64)]
  {$ENDIF}
  TAdvPenWidthSelector = class(TAdvCustomSelector)
  private
    procedure Initialize;
  protected
    procedure SetSelectorPanel; override;
  ...
  [ComponentPlatformsAttribute(pidWin32 or pidWin64)]
  {$ENDIF}
  TAdvBrushStyleSelector = class(TAdvCustomSelector)
  private
    FSelectionType: TSelectionType;
    procedure Initialize;
  ...
  [ComponentPlatformsAttribute(pidWin32 or pidWin64)]
  {$ENDIF}
  TAdvShadowSelector = class(TAdvCustomSelector)
  private
    procedure Initialize;
  protected
    procedure Loaded; override;
  ...
  [ComponentPlatformsAttribute(pidWin32 or pidWin64)]
  {$ENDIF}
  TAdvTableBorderSelector = class(TAdvCustomSelector)
  private
    procedure Initialize;
  protected
    procedure SetSelectorPanel; override;
  ...
  [ComponentPlatformsAttribute(pidWin32 or pidWin64)]
  {$ENDIF}
  TAdvGradientDirectionSelector = class(TAdvCustomSelector)
  private
    FStartColor: TColor;
    FEndColor: TColor;
  ...
  TAdvCustomColorSelector = class(TAdvCustomSelector)
  private
  ...
  [ComponentPlatformsAttribute(pidWin32 or pidWin64)]
  {$ENDIF}
  TAdvTextColorSelector = class(TAdvCustomColorSelector)
  protected
    procedure Initialize; override;
  public
  published
  ...
  TAdvCustomTableSelector = class(TAdvCustomSelector)
  private
  ...
  [ComponentPlatformsAttribute(pidWin32 or pidWin64)]
  {$ENDIF}
  TAdvTableSelector = class(TAdvCustomTableSelector)
  protected
  public
  ...
  [ComponentPlatformsAttribute(pidWin32 or pidWin64)]
  {$ENDIF}
  TAdvCharacterSelector = class(TAdvCustomSelector)
  private
    FOnSelect: TNotifyEvent;
    FCharacters: string;
    FSelectedChar: char;
...
destructor TAdvCustomSelector.Destroy;
begin
  FGlyph.Free;
  FGlyphHot.Free;
  FGlyphDown.Free;
...
procedure TAdvCustomSelector.Click;
begin
  inherited Click;
end;
...
procedure TAdvCustomSelector.CMFontChanged(var Message: TMessage);
begin
  Invalidate;
end;
...
procedure TAdvCustomSelector.CMMouseEnter(var Message: TMessage);
begin
  inherited;
...
procedure TAdvCustomSelector.CMMouseLeave(var Message: TMessage);
begin
  inherited;
...
procedure TAdvCustomSelector.CMTextChanged(var Message: TMessage);
begin
  Invalidate;
end;
...
procedure TAdvCustomSelector.Loaded;
begin
  inherited Loaded;
...
procedure TAdvCustomSelector.MouseDown(Button: TMouseButton;
...
procedure TAdvCustomSelector.MouseMove(Shift: TShiftState; X, Y: Integer);
begin
...
procedure TAdvCustomSelector.MouseUp(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
...
procedure TAdvCustomSelector.Notification(AComponent: TComponent;
...
function TAdvCustomSelector.DrawGlyph(aGlyph: TBitMap; aRect: TRect): integer;
var
  aP: TPoint;
begin
  Result := 0;
...
procedure TAdvCustomSelector.DrawGlyphAndCaption(aGlyph: TBitmap;
  R: TRect);
var
  CapR: TRect;
  tbmp: TBitmap;
...
procedure TAdvCustomSelector.DrawButton;
var
...
procedure TAdvCustomSelector.Paint;
begin
  if Style in [ssButton {, ssCheck}] then
  begin
...
procedure TAdvCustomSelector.SetAutoThemeAdapt(const Value: Boolean);
begin
...
procedure TAdvCustomSelector.ThemeAdapt;
var
...
procedure TAdvCustomSelector.WndProc(var Message: TMessage);
begin
...
procedure TAdvCustomSelector.SetAllowAllUp(const Value: Boolean);
begin
...
procedure TAdvCustomSelector.SetBorderColor(const Value: TColor);
begin
  FBorderColor := Value;
  Invalidate;
end;
...
procedure TAdvCustomSelector.SetColorChecked(const Value: TColor);
begin
  FColorChecked := Value;
  Invalidate;
end;
...
procedure TAdvCustomSelector.SetColorCheckedTo(const Value: TColor);
begin
...
procedure TAdvCustomSelector.SetColorTo(const Value: TColor);
begin
  FColorTo := Value;
  Invalidate;
end;
...
procedure TAdvCustomSelector.SetDown(const Value: Boolean);
begin
...
procedure TAdvCustomSelector.SetDropDownButton(const Value: Boolean);
begin
...
procedure TAdvCustomSelector.SetFlat(const Value: Boolean);
begin
  if Value <> FFlat then
  begin
    FFlat := Value;
...
procedure TAdvCustomSelector.SetGlyph(const Value: TBitmap);
var
  x, y: Integer;
  PxlColor: TColor;
  c: byte;
...
procedure TAdvCustomSelector.SetGlyphDisabled(const Value: TBitmap);
begin
  FGlyphDisabled.Assign(Value);
end;
...
procedure TAdvCustomSelector.SetGlyphDown(const Value: TBitmap);
begin
...
procedure TAdvCustomSelector.SetGlyphHot(const Value: TBitmap);
begin
...
procedure TAdvCustomSelector.SetImages(const Value: TCustomImageList);
begin
...
procedure TAdvCustomSelector.SetShaded(const Value: Boolean);
begin
  FShaded := Value;
...
procedure TAdvCustomSelector.SetGroupIndex(const Value: Integer);
begin
...
procedure TAdvCustomSelector.GlyphChanged(Sender: TObject);
begin
  Invalidate;
end;
...
procedure TAdvCustomSelector.SetAppearanceStyle(
...
procedure TAdvCustomSelector.ButtonDown;
begin
...
procedure TAdvCustomSelector.DoDropDown;
var
  R: TRect;
  P: TPoint;
begin
...
procedure TAdvCustomSelector.HideDropDown;
begin
  FDropDownWindow.Visible := false;
end;
...
procedure TAdvCustomSelector.PopupBtnDown;
begin
  DoDropDown;
end;
...
procedure TAdvCustomSelector.SetColorDropDown(const Value: TColor);
begin
...
procedure TAdvCustomSelector.SetColorDropDownTo(const Value: TColor);
begin
...
procedure TAdvCustomSelector.SetSelectorPanelItems;
var
  i: integer;
begin
...
procedure TAdvCustomSelector.SetSelectorPanel;
begin
...
procedure TAdvCustomSelector.SetDropDownCount(const Value: integer);
begin
...
procedure TAdvCustomSelector.SetTGradientDirection(
...
procedure TAdvCustomSelector.OnDropDownWindowHide(Sender: TObject);
begin
  State := absUp;
  Invalidate;
end;
...
function TAdvCustomSelector.GetCaption: string;
begin
...
procedure TAdvCustomSelector.SetCaption(const Value: string);
begin
...
procedure TAdvCustomSelector.OnDropDownPanelShouldHide(Sender: TObject);
begin
  HideDropDown;
end;
...
function TAdvCustomSelector.GetSelectedIndex: integer;
begin
...
procedure TAdvCustomSelector.SetSelectedIndex(const Value: integer);
begin
...
procedure TAdvCustomSelector.SetTools(const Value: TAdvSelectorItems);
begin
  FTools := Value;
end;
...
procedure TAdvCustomSelector.OnDropDownPanelSelect(Sender: TObject);
begin
...
procedure TAdvCustomSelector.SetButtonsPerRow(const Value: TNoOfButtons);
begin
...
procedure TAdvCustomSelector.OnDropDownPanelHotTool(Sender: TObject;
...
procedure TAdvCustomSelector.OnToolSelect;
begin
  if Assigned(FOnSelect) then
    FOnSelect(Self, FSelectorPanel.ItemIndex, Tools[FSelectorPanel.ItemIndex]);
end;
...
procedure TAdvCustomSelector.OnDropDownPanelDrawTool(Sender: TObject;
...
function TAdvCustomSelector.GetVersionNr: Integer;
begin
...
function TAdvCustomSelector.GetVersion: string;
var
  vn: Integer;
begin
  vn := GetVersionNr;
...
procedure TAdvCustomSelector.SetVersion(const Value: string);
begin
...
procedure TAdvCustomSelector.KeyDown(var Key: Word; Shift: TShiftState);
begin
  inherited;
...
procedure TAdvCustomSelector.ShowDropDown;
begin
  DoDropDown;
end;
...
procedure TAdvCustomSelector.SetTwoColorImages(const Value: Boolean);
begin
...
procedure TAdvCustomSelector.ChangeImagesColor(ForeGColor,
  BkGColor: TColor);
var
  I: Integer;
  bmp: TBitMap;
...
procedure TAdvCustomSelector.SetForeGroundImageColor(const Value: TColor);
begin
...
procedure TAdvCustomSelector.SetStretchImageDraw(const Value: Boolean);
begin
  ...
  begin
    ...
    begin
      ...
      begin
        DR := FItems.Items[Index].ItemRect;
        DR.Right := DR.Right - 1;
        DrawGradient(Canvas, ColorSelected, ColorSelectedTo, 16, DR, true);
        DR.Right := DR.Right + 1;
      end
      else
      begin
...
begin
  inherited;
  if (Key in [VK_ESCAPE, VK_RETURN, DROPDOWN_KEY]) and (FOwner is TSelectorDropDownWindow) then
  begin
    if Assigned(FOnShouldHide) then
      FOnShouldHide(self);
  end;
...
procedure TAdvSelectorItem.SetImageIndex(const Value: TImageIndex);
begin
...
begin
  ...
  tbmp := TBitmap.Create;
  tbmp.LoadFromResourceName(HInstance, 'SPECTRUM');
  ...
  Screen.Cursors[crTMSCur1] := LoadCursor(HInstance, 'TMS_CUR1');
...
constructor TAdvPenStyleSelector.Create(AOwner: TComponent);
begin
  inherited;
  //if not (csDesigning in ComponentState) then
  begin
    ...
    FImages.Width := 99;
    FImages.Height := 9;
    FImages.ResInstLoad(HInstance, rtBitmap, 'PENSTYLE0', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'PENSTYLE1', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'PENSTYLE2', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'PENSTYLE3', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'PENSTYLE4', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'PENSTYLE5', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'PENSTYLE6', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'PENSTYLE7', clWhite);
...
destructor TAdvPenStyleSelector.Destroy;
begin
...
procedure TAdvPenStyleSelector.Initialize;
begin
  Tools.Clear;
...
procedure TAdvPenStyleSelector.Loaded;
begin
  inherited;
end;
...
procedure TAdvPenStyleSelector.SetSelectorPanel;
begin
...
function TAdvPenStyleSelector.GetSelectedPenStyle: TPenStyle;
begin
...
procedure TAdvPenStyleSelector.SetSelectedPenStyle(const Value: TPenStyle);
begin
...
procedure TAdvPenStyleSelector.SetSelectionType(
...
function TAdvPenStyleSelector.GetPenColor: TColor;
begin
...
procedure TAdvPenStyleSelector.SetPenColor(const Value: TColor);
begin
...
function TAdvPenStyleSelector.GetPenStyleAtIndex(
...
function TAdvPenStyleSelector.GetIndexOfStyle(
...
constructor TAdvBrushStyleSelector.Create(AOwner: TComponent);
begin
  inherited;
  //if not (csDesigning in ComponentState) then
  begin
    ...
    FImages.Width := 102;
    FImages.Height := 14;
    FImages.ResInstLoad(HInstance, rtBitmap, 'BRUSHSTYLE0', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'BRUSHSTYLE1', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'BRUSHSTYLE2', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'BRUSHSTYLE3', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'BRUSHSTYLE4', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'BRUSHSTYLE5', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'BRUSHSTYLE6', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'BRUSHSTYLE7', clWhite);

    // stBorland
    FImages.ResInstLoad(HInstance, rtBitmap, 'BRUSHSTYLE8', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'BRUSHSTYLE9', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'BRUSHSTYLE10', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'BRUSHSTYLE11', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'BRUSHSTYLE12', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'BRUSHSTYLE13', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'BRUSHSTYLE14', clWhite);
  end;
...
destructor TAdvBrushStyleSelector.Destroy;
begin
  //if not (csDesigning in ComponentState) and Assigned(FImages) then
  begin
    FImages.Free;
...
function TAdvBrushStyleSelector.GetBrushColor: TColor;
begin
  Result := ForeGroundImageColor;
end;
...
function TAdvBrushStyleSelector.GetBrushStyleAtIndex(
...
function TAdvBrushStyleSelector.GetIndexOfBrushStyle(
...
function TAdvBrushStyleSelector.GetSelectedBrushStyle: TBrushStyle;
begin
...
procedure TAdvBrushStyleSelector.Initialize;
begin
  Tools.Clear;
...
procedure TAdvBrushStyleSelector.Loaded;
begin
  inherited;
...
procedure TAdvBrushStyleSelector.SetBrushColor(const Value: TColor);
begin
  ForeGroundImageColor := Value;
  Invalidate;
end;
...
procedure TAdvBrushStyleSelector.SetSelectedBrushStyle(
...
procedure TAdvBrushStyleSelector.SetSelectionType(
  const Value: TSelectionType);
begin
  if FSelectionType <> Value then
  begin
...
procedure TAdvBrushStyleSelector.SetSelectorPanel;
begin
  //self.TwoColorImages := True;
  inherited;
  FSelectorPanel.Images := Fimages;
...
constructor TAdvShadowSelector.Create(AOwner: TComponent);
begin
  inherited;
  //if not (csDesigning in ComponentState) then
  begin
    ...
    FImages.Width := 20;
    FImages.Height := 20;
    FImages.ResInstLoad(HInstance, rtBitmap, 'SHADOW0', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'SHADOW1', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'SHADOW2', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'SHADOW3', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'SHADOW4', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'SHADOW5', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'SHADOW6', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'SHADOW7', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'SHADOW8', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'SHADOW9', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'SHADOW10', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'SHADOW11', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'SHADOW12', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'SHADOW13', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'SHADOW14', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'SHADOW15', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'SHADOW16', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'SHADOW17', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'SHADOW18', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'SHADOW19', clWhite);
  end;
  Initialize;
end;
...
destructor TAdvShadowSelector.Destroy;
begin
  //if not (csDesigning in ComponentState) and Assigned(FImages) then
  begin
    FImages.Free;
...
procedure TAdvShadowSelector.Initialize;
begin
  Tools.Clear;
...
procedure TAdvShadowSelector.Loaded;
begin
  inherited;
...
procedure TAdvShadowSelector.SetSelectorPanel;
begin
  inherited;
  FSelectorPanel.Images := Fimages;
...
constructor TAdvTableBorderSelector.Create(AOwner: TComponent);
begin
  inherited;
  //if not (csDesigning in ComponentState) then
  begin
    ...
    FImages.Width := 15;
    FImages.Height := 15;
    FImages.ResInstLoad(HInstance, rtBitmap, 'TABLE0', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'TABLE1', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'TABLE2', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'TABLE3', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'TABLE4', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'TABLE5', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'TABLE6', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'TABLE7', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'TABLE8', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'TABLE9', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'TABLE10', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'TABLE11', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'TABLE12', clWhite);
  end;
  Initialize;
end;
...
destructor TAdvTableBorderSelector.Destroy;
begin
  //if not (csDesigning in ComponentState) and Assigned(FImages) then
  begin
    FImages.Free;
...
procedure TAdvTableBorderSelector.Initialize;
begin
  Tools.Clear;
...
procedure TAdvTableBorderSelector.SetSelectorPanel;
begin
  inherited;
  FSelectorPanel.Images := Fimages;
...
constructor TAdvGradientDirectionSelector.Create(AOwner: TComponent);
begin
  inherited;
{  if not (csDesigning in ComponentState) then
  begin
...
destructor TAdvGradientDirectionSelector.Destroy;
begin
 { if not (csDesigning in ComponentState) and Assigned(FImages) then
  begin
    FImages.Free;
...
procedure TAdvGradientDirectionSelector.DrawGlyphAndCaption(
...
procedure TAdvGradientDirectionSelector.Initialize;
begin
  Tools.Clear;
...
procedure TAdvGradientDirectionSelector.SelectorPanelOnDrawItem(Sender: TObject;
...
procedure TAdvGradientDirectionSelector.SetEndColor(const Value: TColor);
begin
  FEndColor := Value;
  Invalidate;
end;
...
procedure TAdvGradientDirectionSelector.SetSelectorPanel;
begin
  inherited;
...
procedure TAdvGradientDirectionSelector.SetShowSelectedGradient(
  const Value: boolean);
begin
...
procedure TAdvGradientDirectionSelector.SetStartColor(const Value: TColor);
begin
  FStartColor := Value;
  Invalidate;
end;
...
constructor TAdvPenWidthSelector.Create(AOwner: TComponent);
begin
  inherited;
  //if not (csDesigning in ComponentState) then
  begin
    ...
    FImages.Width := 97;
    FImages.Height := 10;
    FImages.ResInstLoad(HInstance, rtBitmap, 'PENWIDTH0', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'PENWIDTH1', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'PENWIDTH2', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'PENWIDTH3', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'PENWIDTH4', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'PENWIDTH5', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'PENWIDTH6', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'PENWIDTH7', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'PENWIDTH8', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'PENWIDTH9', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'PENWIDTH10', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'PENWIDTH11', clWhite);
    FImages.ResInstLoad(HInstance, rtBitmap, 'PENWIDTH12', clWhite);
  end;
  Initialize;
end;
...
destructor TAdvPenWidthSelector.Destroy;
begin
  //if not (csDesigning in ComponentState) and Assigned(FImages) then
  begin
    FImages.Free;
...
procedure TAdvPenWidthSelector.Initialize;
begin
  Tools.Clear;
...
procedure TAdvPenWidthSelector.SetSelectorPanel;
begin
  inherited;
  FSelectorPanel.Images := Fimages;
  FSelectorPanel.SetItemsPosition;
...
destructor TAdvCustomColorSelector.Destroy;
begin
  if not (csDesigning in ComponentState) then
  begin
...
procedure TAdvCustomColorSelector.Initialize;
begin
end;

procedure TAdvColorSelector.Initialize;
begin
  Tools.Clear;
...
procedure TAdvCustomColorSelector.SetSelectorPanel;
var
  i: integer;
begin
  ...
  begin
    ...
    begin
      FColorCubePanel := TAdvColorCubePanel.Create(FDropDownWindow);
  ...
  begin
    ...
    begin
      FSpectrumPanel := TAdvColorSpectrumPanel.Create(FDropDownWindow);
...
procedure TAdvCustomColorSelector.SetColorSelectionStyle(
...
procedure TAdvCustomColorSelector.Loaded;
begin
  inherited;
...
procedure TAdvCustomColorSelector.DrawGlyphAndCaption(aGlyph: TBitmap; R: TRect);
var
  CapR: TRect;
  clr: TColor;
begin
...
procedure TAdvCustomColorSelector.SetShowSelectedColor(const Value: Boolean);
begin
...
procedure TAdvCustomColorSelector.CubePanelOnSelect(Sender: TObject);
begin
...
procedure TAdvCustomColorSelector.SpectrumPanelOnSelect(Sender: TObject);
begin
...
procedure TAdvCustomColorSelector.SetSelectedColor(const Value: TColor);
begin
  FSelectedColor := Value;
  Invalidate;
end;
...
function TAdvCustomColorSelector.GetSelectedColor: TColor;
begin
...
procedure TAdvCustomColorSelector.OnToolSelect;
begin
...
procedure TAdvTextColorSelector.Initialize;
begin
  Tools.Clear;
...
{ TAdvCustomTableSelector }

constructor TAdvCustomTableSelector.Create(AOwner: TComponent);
begin
  inherited;
  FDefaultColCount := 5;
  FDefaultRowCount := 4;
...
destructor TAdvCustomTableSelector.Destroy;
begin
  if not (csDesigning in ComponentState) then
  begin
...
procedure TAdvCustomTableSelector.Loaded;
begin
  inherited;
...
procedure TAdvCustomTableSelector.MouseMove(Shift: TShiftState; X,
  Y: Integer);
begin
  inherited;
...
procedure TAdvCustomTableSelector.SetDefaultColCount(const Value: integer);
begin
...
procedure TAdvCustomTableSelector.SetDefaultRowCount(const Value: integer);
begin
  if (Value > 0) and (Value <= 60) then
...
procedure TAdvCustomTableSelector.SetSelectorPanel;
begin
...
procedure TAdvCustomTableSelector.TableSelectorOnSelect(Sender: TObject);
begin
...
constructor TAdvCharacterSelector.Create(AOwner: TComponent);
begin
  inherited;
  FCharacters := '';
  FSelectedChar := #0;
...
destructor TAdvCharacterSelector.Destroy;
begin
  FCharFont.Free;
  inherited;
end;
...
procedure TAdvCharacterSelector.AddItemsFromChars;
var
  i: integer;
begin
  Tools.Clear;
...
procedure TAdvCharacterSelector.LoadCharFromFont;
var
  i: integer;
begin
  if FAutoLoad then
...
procedure TAdvCharacterSelector.Loaded;
begin
  inherited;
end;
...
procedure TAdvCharacterSelector.OnToolSelect;
begin
  if SelectedIndex >= 0 then
...
procedure TAdvCharacterSelector.SetAutoLoad(const Value: boolean);
begin
...
procedure TAdvCharacterSelector.SetCharacters(const Value: string);
begin
  if AutoLoad then
...
procedure TAdvCharacterSelector.SetCharFont(const Value: TFont);
begin
...
procedure TAdvCharacterSelector.SetSelectedChar(const Value: char);
begin
  FSelectedChar := Value;
  Invalidate;
end;
...
procedure TAdvCharacterSelector.SetSelectorPanel;
//var
  //i, j: integer;
begin
{
...
procedure TAdvCharacterSelector.DrawGlyphAndCaption(aGlyph: TBitmap;
  R: TRect);
var
  CapR: TRect;
