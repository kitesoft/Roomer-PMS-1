object FAdvMemoDemo04: TFAdvMemoDemo04
  Left = 0
  Top = 0
  Caption = 'TMS TAdvMemo Demo 4 - Region definitions / code folding'
  ClientHeight = 443
  ClientWidth = 1029
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object Panel2: TPanel
      ...
      object Label1: TLabel
        ...
        Width = 190
        Height = 13
        Caption = 'List of region definitions currently used:'
      end
      object BExpand: TButton
        Left = 14
        Top = 8
        Width = 80
        Height = 25
      ...
      object BAutoFold: TButton
        Left = 290
        Top = 8
        Width = 80
        Height = 25
        Caption = 'AutoCodeFold'
        TabOrder = 3
        OnClick = BAutoFoldClick
      end
    end
    object SGRegions1: TStringGrid
      Left = 0
      Top = 57
      Width = 409
      Height = 386
      ...
      TabOrder = 1
      OnClick = SGRegions1Click
      OnKeyPress = SGRegions1KeyPress
    end
  end
