...
uses
  ...
  AdvSmoothCalendar, Math, DateUtils
  ;
...
procedure TAdvSmoothCalendarGroup.DefineProperties(Filer: TFiler);
begin
  inherited;
...
function TAdvSmoothCalendarGroup.GetComponentStyle: TTMSStyle;
begin
  Result := FTMSStyle;
end;
...
procedure TAdvSmoothCalendarGroup.ReadTMSStyle(Reader: TReader);
begin
...
procedure TAdvSmoothCalendarGroup.WriteTMSStyle(Writer: TWriter);
begin
