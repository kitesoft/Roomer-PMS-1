...
uses
  ...
  AdvRichEditorPic, AdvRichEditorBase, AdvRichEditorRTF, AdvGraphics, AdvUtils, AdvScrollControl,{%H-}AdvToolBarRes
  {$IFDEF VCLLIB}
...
const
  ...
  BLD_VER = 0; // Build nr.
  DATE_VER = 'Jan, 2017'; // Month version
...
{$ENDIF}
  ...
  TImageNotFoundEvent = procedure(Sender: TObject; ImageName: string) of object;
...
{$ENDIF}
    ...
    procedure DoImageNotFound(ImageName: string); virtual;
    ...
    begin
      ...
      begin
        ...
        case IndexText(TagName, ['B', '/B', 'STRONG', '/STRONG', 'I', '/I',
                                  ...
                                  'XML','/XML','!--','STYLE','/STYLE','BODY','/BODY','TITLE','/TITLE']) of
...
//                 SetSelectionAttribute(mParAlign);
             ...
             begin
               ...
               begin
                 ...
                 begin
                   ...
                   fsi := 1;
                   while IsCharAlpha(CharInStr(fsize,fsi)) do
                     inc(fsi);
      ...
      begin
        ...
        begin
          ...
          if not (LowerCase(TagName) = 'quot;') then
            TagName := '&' + TagName;
...
procedure TAdvRichEditor.DoImageNotFound(ImageName: string);
begin
  if Assigned(OnImageNotFound) then
    OnImageNotFound(Self, ImageName);
end;
...
begin
  ...
  //outputdebugstring(pchar(caret.Element.Text+';'+inttostr(caret.CharIndex)+';'+inttostr(caret.XY.X)+':'+inttostr(caret.XY.Y)));
...
begin
  ...
  AddPopupItem(FPopupMenu, SREClear,FClearAction,-1,'',pmClear, ShortCut(KEY_DELETE, [ssShift]));
