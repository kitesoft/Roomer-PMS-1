...
uses
  Classes, AdvPDFCoreLibBase, AdvPDFRichTextLib,
  AdvGraphics, AdvTypes, PictureContainer
  {$IFNDEF LCLLIB}
...
type
  ...
  ['{EDB1C5AC-6E2B-4B0C-BA5C-884837A6DFF2}']
    ...
    procedure DrawImageWithName(AName: string; Point: TPointF; ImageType: TAdvPDFGraphicsLibImageType = itOriginal; Quality: Single = 1.0); overload;
    procedure DrawImageWithName(AName: string; Rect: TRectF; Stretch: Boolean = True; AspectRatio: Boolean = True; ImageType: TAdvPDFGraphicsLibImageType = itOriginal; Quality: Single = 1.0); overload;
    ...
    procedure DrawImageWithName(AName: string; ABackgroundColor: TAdvGraphicsColor; Point: TPointF; ImageType: TAdvPDFGraphicsLibImageType = itOriginal; Quality: Single = 1.0); overload;
    procedure DrawImageWithName(AName: string; ABackgroundColor: TAdvGraphicsColor; Rect: TRectF; Stretch: Boolean = True; AspectRatio: Boolean = True; ImageType: TAdvPDFGraphicsLibImageType = itOriginal; Quality: Single = 1.0); overload;
