...
const
  ...
  // 1.1.0.6   : Fixed : Conflict with TAdvEdit lookup functionality
...
begin
  ...
  WM_SIZE:
     begin
       if Assigned(FocusHelper.Owner) and (HookStruct.hwnd = (FocusHelper.Owner as TWinControl).Handle) then
       begin
