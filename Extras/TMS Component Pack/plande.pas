...
uses
  ...
  , PlanPropPref, DesignIntf, DesignEditors;
...
begin
  ...
  0:begin
      {$I COMPILERTEXT.INC}
      MessageDlg(Component.ClassName+' version '+ (Component as TCustomPlanner).VersionString + ' for ' + compiler + #13#10#13#10'© 1999-2017 by TMS software'#13#10'http://www.tmssoftware.com',
