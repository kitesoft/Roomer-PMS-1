...
const
  ...
  // 1.3.0.0 : New : Methods StepUp/StepDown added
  // 1.3.0.1 : Improved : Drawing when ShowBorder = false
...
begin
  ...
  if not Settings.ShowBorder then
    InflateRect(R,1,1);
...
procedure TAdvProgressBar.StepDown;
begin
  if Position > Min then
    Position := Position - 1;
end;

procedure TAdvProgressBar.StepUp;
begin
