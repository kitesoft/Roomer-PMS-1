...
begin
  ...
  if r.KeyExists('Software\Embarcadero\BDS\18.0\Editor\Highlight') then
    rkey := 'Software\Embarcadero\BDS\18.0\Editor\Highlight\'
  else
  if r.KeyExists('Software\Embarcadero\BDS\17.0\Editor\Highlight') then
    rkey := 'Software\Embarcadero\BDS\17.0\Editor\Highlight\'
  else
