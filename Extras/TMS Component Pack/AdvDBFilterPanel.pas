...
const
  ...
  // v1.0.3.4 : Improved : More date format conversions allowed for filter building
  // v1.0.4.0 : New : Automatic removal of dataset filter
  ...
  try
    ...
    begin
      ...
      begin
        ...
        if (UPos('WHERE', FQueryString, P) > 0) then
        begin
          FInternalActivate := true;

          FQueryString := Copy(FQueryString, 1, P - 1);
