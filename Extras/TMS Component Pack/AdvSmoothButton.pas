...
const
  ...
  // v2.1.1.0 : Exposed OnDragDrop and OnDragOver events
  // v2.1.1.1 : Fixed : Issue with ControlStyle set to capture mouse events outside control
  // v2.1.1.2 : Improved : Glow drawing
  // v2.1.1.3 : Fixed : Issue with wordwrapping calculation
  // v2.1.1.4 : Fixed : Issue with setting modal result when programmatically calling Click
  // v2.1.1.5 : Fixed : Issue setting modal result when clicking button due to previous fix on programmatically calling Click
