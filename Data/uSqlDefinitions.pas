...
//  s := s+'  order by room, adate '#10;
  ...
  s := s+'       (  ({roomreservation} = 0 and rr.Reservation={reservation}) or  -- for groupinvoice: all records from reservation ' +#10;
  ...
  s := s+'          (rd.RoomReservation IN (SELECT DISTINCT rd2.RoomReservation ' +#10;
