object FrmBackupInvoice: TFrmBackupInvoice
  Left = 0
  Top = 0
  Caption = 'Backup Invoice'
  ClientHeight = 542
  ClientWidth = 924
  Color = clBtnFace
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object sgInvoice: TAdvStringGrid
    Left = 0
    Top = 0
    Width = 924
    Height = 542
    ...
    OnGetCellColor = sgInvoiceGetCellColor
    OnGetCellPrintColor = sgInvoiceGetCellPrintColor
    OnGetCellPrintBorder = sgInvoiceGetCellPrintBorder
    OnGetCellBorder = sgInvoiceGetCellBorder
    OnGetCellBorderProp = sgInvoiceGetCellBorderProp
    OnGetAlignment = sgInvoiceGetAlignment
    ...
    PrintSettings.TitleSpacing = 100
    PrintSettings.PagePrefix = 'Pg'
