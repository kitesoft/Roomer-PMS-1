...
type
  TfrmGuestProfiles = class(TForm)
    ...
    pnlHolder: TsPanel;
    m_Title: TWideStringField;
    m_Firstname: TWideStringField;
    m_Lastname: TWideStringField;
    m_CustomerCode: TWideStringField;
    m_CompanyName: TWideStringField;
    m_City: TWideStringField;
    m_Country: TWideStringField;
    m_MaleFemale: TWideStringField;
    m_Nationality: TWideStringField;
    m_DateOfBirth: TDateField;
    m_PassportNumber: TWideStringField;
    m_PassportExpiry: TDateField;
    m_SpouseName: TWideStringField;
    m_SpouseBirthdate: TDateField;
    m_CarLicensePlate: TWideStringField;
    m_ContactPerson: TWideStringField;
    m_Profession: TWideStringField;
    m_Address1: TWideStringField;
    m_Address2: TWideStringField;
    m_Zip: TWideStringField;
    m_TelLandLine: TWideStringField;
    m_TelMobile: TWideStringField;
    m_Email: TWideStringField;
    m_Website: TWideStringField;
    m_Twitter: TWideStringField;
    m_LinkedIn: TWideStringField;
    m_State: TWideStringField;
    ...
    m_SocialSecurityNumber: TWideStringField;
    m_FacebookLink: TWideStringField;
    m_TripadvisorAccount: TWideStringField;
    m_CompVATNumber: TWideStringField;
    m_CompFax: TWideStringField;
