...
{$REGION 'TaxTypeType xsd definition'}
  ...
  //    </simpleType>
{$ENDREGION}
  TxsdTaxTypeType = (VAT, CITYTAX);
  TxsdTaxTypeTypeHelper = record helper for TxsdTaxTypeType
    class function FromString(const aString: string): TxsdTaxTypeType; static;
    function AsString: String;
  end;
...
{$ENDREGION}
  ...
  published
    ...
    property TaxTypeType: TxsdTaxTypeType read FTaxTypeType write FTaxTypeType;
...
begin
  ...
  FDescription := aNode.Attributes['description'];
  FAmount.SetPropertiesFromXMLNode(aNode);
  FTaxTypeType := TxsdTaxTypeType.FromString(aNode.Attributes['taxTypeType']);
end;

{ TxsdTaxTypeTypeHelper }

function TxsdTaxTypeTypeHelper.AsString: String;
begin
  Result := GetEnumName(TypeInfo(TxsdTaxTypeType), ord(Self));
end;

class function TxsdTaxTypeTypeHelper.FromString(const aString: string): TxsdTaxTypeType;
begin
  Result := TxsdTaxTypeType( GetEnumValue(TypeInfo(TxsdTaxTypeType), aString));
end;
