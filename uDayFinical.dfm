object frmDayFinical: TfrmDayFinical
  ...
  object grPrinter: TdxComponentPrinter
    ...
    object grPrinterSums2: TdxGridReportLink
      ...
      ReportDocument.CreationDate = 42905.689234305560000000
    ...
    object grPrinterSums: TdxGridReportLink
      ...
      PrinterPage._dxMeasurementUnits_ = 0
      PrinterPage._dxLastMU_ = 2
      ReportDocument.CreationDate = 42905.689234340280000000
      AssignedFormatValues = [fvDate, fvTime, fvPageNumber]
      BuiltInReportLink = True
    end
    ...
    object grPrinterItemSale: TdxGridReportLink
      ...
      PrinterPage._dxLastMU_ = 2
      ReportDocument.Caption = 'Sums2'
      ReportDocument.CreationDate = 42905.689234363420000000
      AssignedFormatValues = [fvDate, fvTime, fvPageNumber]
      BuiltInReportLink = True
    end
    object grPrinterItemTypeSale: TdxGridReportLink
      ...
      PrinterPage._dxLastMU_ = 2
      ReportDocument.Caption = 'Sums2'
      ReportDocument.CreationDate = 42905.689234398140000000
      AssignedFormatValues = [fvDate, fvTime, fvPageNumber]
      BuiltInReportLink = True
    end
    object grPrinterItemVATsale: TdxGridReportLink
      ...
      PrinterPage._dxLastMU_ = 2
      ReportDocument.Caption = 'Sums2'
      ReportDocument.CreationDate = 42905.689234432870000000
      AssignedFormatValues = [fvDate, fvTime, fvPageNumber]
      BuiltInReportLink = True
    end
    object grPrinterPaymentGroups: TdxGridReportLink
      ...
      PrinterPage._dxLastMU_ = 2
      ReportDocument.Caption = 'Sums2'
      ReportDocument.CreationDate = 42905.689234444440000000
      AssignedFormatValues = [fvDate, fvTime, fvPageNumber]
      BuiltInReportLink = True
    end
    ...
    object grPrinterPaymentType: TdxGridReportLink
      ...
      PrinterPage._dxLastMU_ = 2
      ReportDocument.Caption = 'Sums2'
      ReportDocument.CreationDate = 42905.689234456020000000
      AssignedFormatValues = [fvDate, fvTime, fvPageNumber]
      BuiltInReportLink = True
    end
