...
type
  TFrmTelLog = class(TForm)
    ...
    mTelLogAuthCode: TWideStringField;
    mTelLogUserCharged: TWideStringField;
    mTelLogCallCharge: TFloatField;
    mTelLogCurrency: TWideStringField;
    ...
    mTelLogExternalTargetingCause: TWideStringField;
    mTelLogExternalTargeterId: TWideStringField;
    mTelLogExternalTargetedNumber: TWideStringField;
    mTelLogRecordSource: TWideStringField;
    mTelLogConnectedTimeSec: TIntegerField;
    mTelLogAuthValid: TBooleanField;
    mTelLogInvoiceNumber: TIntegerField;
    mTelLogDescription: TWideStringField;
